...
{ 
	...
	$cbo_bill_section=str_replace("'","",$cbo_bill_section); 
	...
	if ($cbo_body_part_search==1) {$cbo_body_part = " AND B.BODY_PART_ID not in (2,3)"; $cbo_body_part_type = ""; }
	if ($cbo_body_part_search==2) { $cbo_body_part_type = " AND C.BODY_PART_TYPE in (40,50)"; }
	if ($cbo_body_part_search==3) {$cbo_body_part = " AND B.BODY_PART_ID in (46)"; $cbo_body_part_type = ""; }
	if ($cbo_body_part_search==0 || $cbo_body_part_search=='') $cbo_body_part_search_cond =""; else $cbo_body_part_search_cond =$cbo_body_part;
	//--------------------------------
	$bill = $txt_bill_no;
	...
	if ($cbo_bill_section==0 || $cbo_bill_section=='') $cbo_bill_section_cond ="and a.bill_section=0"; else $cbo_bill_section_cond =" and a.bill_section=$cbo_bill_section ";
	//echo $cbo_bill_section_cond."<BR><BR>";//die;
	if($db_type==0)
	{
	...
	$Self_sqls_2 = "SELECT A.ID,  A.BILL_NO,  A.COMPANY_ID,  A.LOCATION_ID,  A.BILL_DATE,  A.PARTY_ID,  A.BILL_FOR,  A.PROCESS_ID,  B.DELIVERY_QTY,  B.RATE,  B.AMOUNT,  B.REMARKS,  B.CURRENCY_ID,  B.DELIVERY_QTYPCS,
	B.COLLER_CUFF_MEASUREMENT,  B.DELIVERY_ID,  B.FEBRIC_DESCRIPTION_ID,  B.BODY_PART_ID 
	FROM SUBCON_INBOUND_BILL_MST A INNER JOIN SUBCON_INBOUND_BILL_DTLS B ON A.ID  = B.MST_ID
	WHERE B.STATUS_ACTIVE = 1 AND A.STATUS_ACTIVE   = 1 $cbo_company_cond $location_id $buyer_name_cond $cbo_process_cond $prod_date_cond $txt_bill_cond $cbo_search_by_cond $cbo_body_part_search_cond";
	
	$Self_sqls_1="SELECT A.ID,  A.BILL_NO,  A.COMPANY_ID,  A.LOCATION_ID,  A.BILL_DATE,  A.PARTY_ID,  A.BILL_FOR,  A.PROCESS_ID,  B.DELIVERY_QTY,  B.RATE,  B.AMOUNT,
	B.REMARKS,  B.CURRENCY_ID,  B.DELIVERY_QTYPCS,  B.COLLER_CUFF_MEASUREMENT,  B.DELIVERY_ID,  B.FEBRIC_DESCRIPTION_ID,  B.BODY_PART_ID,  C.BODY_PART_TYPE
	FROM SUBCON_INBOUND_BILL_MST A INNER JOIN SUBCON_INBOUND_BILL_DTLS B ON A.ID = B.MST_ID INNER JOIN LIB_BODY_PART C
	ON C.ID = B.BODY_PART_ID WHERE B.STATUS_ACTIVE = 1 AND A.STATUS_ACTIVE = 1 $cbo_company_cond $location_id $buyer_name_cond $cbo_process_cond $prod_date_cond $txt_bill_cond $cbo_search_by_cond $cbo_body_part_search_cond $cbo_body_part_type $cbo_bill_section_cond";
	...
	?>
<div style="width:1110px;" align="center">
		<fieldset style="width:100%;">
			<table align="center" cellpadding="0" width="100%" class="rpt_table" id="table_header_1" rules="all" border="1">
				<tr><td colspan="11" align="center"><strong> Date Wise Details Report </strong></td></tr>
				<tr><td colspan="11" align="center"><strong> Report Date<?  echo "   ".$date_from." To. ". $date_to; ?> <? 
		...
		<div style="width:1110px;" align="center">	
            <table align="center" width="1100px" cellpadding="0" width="100%" class="rpt_table" id="table_header_1" rules="all" border="1">
                <thead>
                	<tr>
                    	<th width="30">SL</th>
						<th width="100">BILL_NO</th>
						<th width="80">BILL_DATE</th>
						<th width="170">COMPANY_ID</th>
						<th width="150">PARTY</th>
						<th width="70">DEL(KG)</th>
						<th width="70">DEL(PCS)</th>
						<th width="60">RATE</th>
						<th width="80">AMOUNT</th>
						<th style="word-wrap: break-word;word-break: break-all;" width="300">BODY PART</th>
						<th width="100">MEASUREMENT</th>
                    </tr>
				</thead>
			</table>
		</div>
		<div style="width:1110px;" align="center" style="max-height:500px; overflow-y:scroll;" id="scroll_body">	
			<table width="1100px" align="center"  class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
				<tbody>
				<?  
				$sl=0;
											...
											foreach($bfval as $did => $dval)
											{
												foreach($dval as $fbfid => $dr)
												{
													...
													<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $sl; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $sl;?>">
														...
														<td width="100"><? echo $dr[csf('BILL_NO')];?>	</td>
														<td width="80"><? echo $dr[csf('BILL_DATE')];?></td>
														<td width="170"><? echo $company_library[$dr[csf('COMPANY_ID')]];?></td>														
														...
														<td style="word-wrap: break-word;word-break: break-all;" width="300"><? echo $dr[csf('BODY_PART_ID')];?></td>
														<td width="100"><? echo $dr[csf('COLLER_CUFF_MEASUREMENT')];?></td>
													</tr>
													<?
													$sl++;
				...
				<tfoot>
					<tr>
						...
						<td style="word-wrap: break-word;word-break: break-all;" width="300"></td>
						<td width="100"></td>
					</tr>
				</tfoot>
			</table>
...
{ 
	...
	if ($cbo_company_id==0 || $cbo_company_id=='') $cbo_company_cond =""; else $cbo_company_cond =" and A.COMPANY_ID=$cbo_company_id ";
	if ($cbo_search_by==0 || $cbo_search_by=='') $cbo_search_by_cond =""; else $cbo_search_by_cond =" and A.BILL_FOR=$cbo_search_by ";
	if ($cbo_bill_section==0 || $cbo_bill_section=='') $cbo_bill_section_cond =""; else $cbo_bill_section_cond =" and a.bill_section=$cbo_bill_section ";
	...
	B.REMARKS,  B.CURRENCY_ID,  B.DELIVERY_QTYPCS,  B.COLLER_CUFF_MEASUREMENT,  B.DELIVERY_ID,  B.FEBRIC_DESCRIPTION_ID,  B.BODY_PART_ID,  C.BODY_PART_TYPE
	FROM SUBCON_INBOUND_BILL_MST A INNER JOIN SUBCON_INBOUND_BILL_DTLS B ON A.ID = B.MST_ID INNER JOIN LIB_BODY_PART C
	ON C.ID = B.BODY_PART_ID WHERE B.STATUS_ACTIVE = 1 AND A.STATUS_ACTIVE = 1 $cbo_company_cond $location_id $buyer_name_cond $cbo_process_cond $prod_date_cond $txt_bill_cond $cbo_search_by_cond $cbo_body_part_search_cond $cbo_body_part_type";
	...
	?>
		...
		<fieldset style="width:100%;">
			<table align="center" cellpadding="0" width="100%" class="rpt_table" id="table_header_1" rules="all" border="1">
				<tr><td colspan="9"  align="center"><strong> Date Wise Summery Report </strong></td></tr>
				<tr><td colspan="9"  align="center"><strong> Report Date<?  echo "   ".$date_from." To. ". $date_to; ?> <? 
						if ($cbo_body_part_search==1) $cbo_body_part = "Without Collar N Cuff";
						if ($cbo_body_part_search==2) $cbo_body_part = "Collar N Cuff";
						if ($cbo_body_part_search==3) $cbo_body_part = "Drawstring";
						echo " ".$cbo_body_part;
            ...
            <table align="center" width="1200px" cellpadding="0" width="100%" class="rpt_table" id="table_header_1" rules="all" border="1">
                <thead>
                	<tr>
						...
						<th width="80">AMOUNT</th>
						<th style="word-wrap: break-word;word-break: break-all;">BODY PART</th>
								...
								foreach($dval as $pid => $pval)
								{
									foreach($pval as $bfid => $dr)
									{
													...
													<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $sl; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $sl;?>">
														...
														<td style="word-wrap: break-word;word-break: break-all;"  align="right"><? echo $dr[csf('BODY_PART_ID')];?></td>
													</tr>
													<?
													$sl++;
													$tot_del+= $dr[csf('DELIVERY_QTY')];
...
<div style="width:1210px;" align="center">
	<fieldset style="width:100%;">
		<table align="center"  width="100%">
				<tr><td colspan="10"  align="center"><strong> Date And Bill Number Wise Summery Report </strong></td></tr>
								<tr><td  colspan="10" align="center"><strong> Report Date<?  echo "   ".$date_from." To. ". $date_to; ?> <? 
						if ($cbo_body_part_search==1) $cbo_body_part = "Without Collar N Cuff";
						if ($cbo_body_part_search==2) $cbo_body_part = "Collar N Cuff";
						if ($cbo_body_part_search==3) $cbo_body_part = "Drawstring";
						echo " ".$cbo_body_part;
								...
								foreach($blval as $pid => $pval)
								{
									foreach($pval as $bfid => $dr)
									{
													...
													<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $sl; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $sl;?>">
														...
														<td width="100" align="center"><? echo $dr[csf('AMOUNT')]/($dr[csf('DELIVERY_QTY')]+$dr[csf('DELIVERY_QTYPCS')]);?></td>
														<td  width="80" align="right"><?  echo $dr[csf('AMOUNT')];?></td>
														<td align="right"><?  echo $dr[csf('BODY_PART_ID')];?></td>
													</tr>
													<?
													$sl++;
													$tot_del+= $dr[csf('DELIVERY_QTY')];
