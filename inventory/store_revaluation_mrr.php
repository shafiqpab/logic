...
function fn_store_revaluation()
{
	...
	var mrr_trans_type=$('#mrr_trans_type').val();
	
	
	var data="action=store_revaluation&prod_id="+prod_id+"&item_category_id="+item_category_id+"&avg_rate="+avg_rate+"&effective_date="+effective_date+"&txt_mrr_no="+txt_mrr_no+"&txt_received_id="+txt_received_id+"&mrr_trans_type="+mrr_trans_type;
	freeze_window(3);
	http.open("POST","requires/store_revaluation_mrr_controller.php",true);
...
function openmypage()
{
	...
	var item_category_id=$('#cbo_item_category_id').val();
	var page_link='requires/store_revaluation_mrr_controller.php?action=item_desc_popup&item_category_id='+item_category_id;
...
function open_mrrpopup()
{
	...
	var page_link='requires/store_revaluation_mrr_controller.php?action=mrr_popup&company='+company+'&item_category_id='+item_category_id+'&txt_product_id='+txt_product_id; 
	...
	emailwindow.onclose=function()
	{
		...
		$("#mrr_trans_type").val(mrrNumber[2]);
	}
}
            ...
            <table class="rpt_table" width="950" cellpadding="0" cellspacing="0" border="1" rules="all">
                ...
                <tr class="general">
                    ...
                    <td>
                        ...
                        <input type="hidden" name="mrr_trans_type" id="mrr_trans_type" readonly />
