...
<script>
	...
	function fnc_grey_fabric_receive(operation)
	{
		...
		else if(operation==0 || operation==1 || operation==2)
		{
			...
			if( form_validation('cbo_company_id*cbo_receive_basis*txt_receive_date*cbo_store_name*cbo_knitting_source*cbo_knitting_company*cbo_body_part*txt_fabric_description*txt_receive_qnty','Company*Receive Basis*Production Date*Store Name*Knitting Source*Knitting Com*Body Part*Fabric Description*Grey Receive Qnty')==false )
			{
				return;
			}
	...
	function fnc_grey_fabric_receive_Reply_info()
	{
		...
		if(http.readyState == 4) 
		{
			...
			if((reponse[0]==0 || reponse[0]==1))
			{
				...
				reset_form('greyreceive_1','','','','','update_id*txt_recieved_id*cbo_company_id*cbo_receive_basis*txt_receive_date*txt_receive_chal_no*txt_booking_no*txt_booking_no_id*cbo_buyer_name*cbo_store_name*cbo_knitting_source*cbo_knitting_company*cbo_location_name*txt_yarn_issue_challan_no*txt_job_no*txt_remarks*roll_maintained*booking_without_order');
			}

			set_button_status(reponse[3], permission, 'fnc_grey_fabric_receive',1,1);	
			release_freezing();	
		}
	}
	...
	function grey_receive_popup()
	{
		...
		{ 	
			...
			emailwindow.onclose=function()
			{
				...
				{
					freeze_window(5);
					reset_form('greyreceive_1','list_container_knitting*list_fabric_desc_container','','','','roll_maintained');
    	...
    	<div style="width:950px; float:left;" align="center">        
            ...
            <table cellpadding="0" cellspacing="2" width="100%">
                ...
                <tr>
                    ...
                    <td> 
                    	<input type="text" name="txt_yarn_issue_challan_no" id="txt_yarn_issue_challan_no" class="text_boxes" style="width:140px">
                    </td> 
                    <td>Job No</td>
                    <td>
            ...
            <table cellpadding="0" cellspacing="1" width="935" border="0">
                        ...
                        <legend>New Entry</legend>
                            <table cellpadding="0" cellspacing="2" width="100%">
                                <tr>
                                    ...
                                    <td>
										<?
                                            echo create_drop_down( "cbo_uom", 130, $unit_of_measurement,"", 0, "", '12', "",1,12 );
                                        ?>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td colspan="3">
                                        <input type="text" name="txt_fabric_description" id="txt_fabric_description" class="text_boxes" style="width:392px" onDblClick="openmypage_fabricDescription()" placeholder="Double Click To Search" disabled="disabled" readonly/>
                ...
                <tr>
                    <td colspan="6" align="center" class="button_container">
						<? 
                            echo load_submit_buttons($permission, "fnc_grey_fabric_receive", 0,1,"reset_form('greyreceive_1','list_container_knitting*list_fabric_desc_container','','cbo_receive_basis,0','disable_enable_fields(\'cbo_company_id\');set_receive_basis();')",1);
                        ?>
