...
function popuppage_fabbook()
{
	...
	var page_link='requires/woven_grey_fabric_issue_controller.php?action=fabbook_popup&company='+company+'&cbo_basis='+cbo_basis+'&issue_purpose='+issue_purpose+'&update_id='+update_id+'&dtls_tbl_id='+dtls_tbl_id;
	...
	emailwindow.onclose=function()
	{
		...
		{ 
			...
			/*if(bookingNumber[5]!="")
			{
				get_php_form_data(bookingNumber[5], "populate_display_from_data", "requires/woven_grey_fabric_issue_controller");	
			}*/
			...
			if(issue_purpose==8)
			{
				load_drop_down( 'requires/woven_grey_fabric_issue_controller', bookingNumber[1]+'_'+$('#cbo_issue_purpose').val()+'_'+color_id+'_'+cbo_basis+'_'+$('#hidden_order_id').val(), 'load_drop_down_color', 'color_td' );
			...
			if(issue_purpose==8)
			{
				load_drop_down( 'requires/woven_grey_fabric_issue_controller', bookingNumber[1]+'_'+$('#cbo_issue_purpose').val()+'_'+color_id+'_'+cbo_basis+'_'+$('#hidden_order_id').val()+'_'+is_sales, 'load_drop_down_color', 'color_td' );
				set_multiselect('cbo_color_id','0','0','','0');
			}
...
function openmypage_order() 
{
	...
	{
		var title = 'PO Info';	
		var page_link = 'requires/woven_grey_fabric_issue_controller.php?cbo_company_id='+cbo_company_id+'&hidden_order_id='+hidden_order_id+'&buyer_name='+buyer_name+'&action=po_search_popup';
...
function put_country_data(color_id,po_id,data)
{
	var data = data.split('**');
	...
	var balance = data[3];
	$('#hidden_order_id').val(po_id);
	load_drop_down( 'requires/woven_grey_fabric_issue_controller',po_id+'_'+$("#cbo_issue_purpose").val()+'_'+color_id+'_'+$("#cbo_basis").val()+'_'+po_id+'_'+1, 'load_drop_down_color','color_td');
	set_multiselect('cbo_color_id','0','0','','0');
}
...
function openpopup_batch()
{
	...
	var page_link = 'requires/woven_grey_fabric_issue_controller.php?cbo_company_id='+cbo_company_id+'&action=batch_popup';
...
function openroll_popup() 	 
{
	...
	var title = 'Roll Info';	
	var page_link = 'requires/woven_grey_fabric_issue_controller.php?cbo_company_id='+cbo_company_id+'&hidden_roll_id='+hidden_roll_id+'&hidden_roll_qnty='+hidden_roll_qnty+'&txt_batch_id='+txt_batch_id+'&action=roll_popup';
	...
	emailwindow.onclose=function()
	{
		...
		var issueQnty=this.contentDoc.getElementById("txt_issue_qnty").value;
 		...
 		//show_list_view(rollTableId+"**"+issueQnty,'populate_child_from_data','td_item_list','requires/woven_grey_fabric_issue_controller','');		
		get_php_form_data(rollTableId+"**"+issueQnty, "populate_child_from_data", "requires/woven_grey_fabric_issue_controller");		
	}
}
...
function openDescription_popup() 	 
{
	...
	var page_link = 'requires/woven_grey_fabric_issue_controller.php?cbo_company_id='+cbo_company_id+'&action=itemDescription_popup'+'&txt_booking_no='+txt_booking_no+'&cbo_basis='+cbo_basis+'&cbo_issue_purpose='+cbo_issue_purpose+'&txt_booking_id='+txt_booking_id+'&hidden_order_id='+hidden_order_id+'&isRackBalance='+isRackBalance+'&cbo_store_name='+cbo_store_name;
	...
	emailwindow.onclose=function()
	{
		...
		if(cbo_issue_purpose==8 && cbo_basis==3) 
		{
			...
			get_php_form_data(txt_booking_id+"**"+data[0], "populate_data_about_sample", "requires/woven_grey_fabric_issue_controller" );
		}
...
function issueQntyPopup() //issue quantity
{
	...
	var title = 'PO Info';	
	var page_link = 'requires/woven_grey_fabric_issue_controller.php?receive_basis='+receive_basis+'&cbo_company_id='+cbo_company_id+'&booking_no='+booking_no+'&all_po_id='+all_po_id+'&save_data='+save_data+'&issueQnty='+issueQnty+'&distribution_method='+distribution_method+'&isRoll='+isRoll+'&prod_id='+prod_id+'&hidden_order_id='+hidden_order_id+'&program_no='+program_no+'&store_id='+cbo_store_name+'&floor_id='+cbo_floor_hidden+'&room_id='+cbo_room_hidden+'&rack_id='+txt_rack_hidden+'&self_id='+txt_shelf_hidden+'&dtls_tbl_id='+dtls_tbl_id+'&action=po_popup';
	...
	emailwindow.onclose=function()
	{
		...
		/*if(receive_basis==2)
		{
			get_php_form_data(all_po_id+"**"+prod_id, "populate_data_about_order", "requires/woven_grey_fabric_issue_controller" );
		}*/
		
		get_php_form_data(all_po_id+"**"+prod_id+"**"+cbo_company_id+"**"+program_no+"**"+receive_basis+"**"+cbo_store_name+"**"+cbo_floor_hidden+"**"+cbo_room_hidden+"**"+txt_rack_hidden+"**"+txt_shelf_hidden, "populate_data_about_order", "requires/woven_grey_fabric_issue_controller" );
		load_drop_down( 'requires/woven_grey_fabric_issue_controller', all_po_id+'_'+$('#cbo_issue_purpose').val()+'_'+color_id+'_'+cbo_basis+'_'+$('#hidden_order_id').val(), 'load_drop_down_color', 'color_td' );
...
{
	window.open("requires/woven_grey_fabric_issue_controller.php?data=" + data+'&action='+action, true );
}
...
function fnc_grey_fabric_issue_entry(operation)
{
	...
	if(operation==4 || operation==6 || operation==7 || operation==9)
	{
		...
		{			
			...
			window.open("requires/woven_grey_fabric_issue_controller.php?data=" + $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+$('#txt_system_no').val()+'*'+report_title+'*'+print_with_vat+'*'+operation+'*'+show_item+'&action=grey_fabric_issue_print', true );
		}
			
		else if(operation==7)
		{
			generate_report_file( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+$('#txt_system_no').val()+'*'+report_title+'*'+print_with_vat+'*'+operation+'*'+show_item,'grey_fabric_issue_print_7','requires/woven_grey_fabric_issue_controller');
		}
		else if(operation==9)
		{
			...
			generate_report_file( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+$('#txt_system_no').val()+'*'+report_title+'*'+print_with_vat+'*'+operation+'*'+show_item,'grey_fabric_issue_print_9','requires/woven_grey_fabric_issue_controller');
		}
		else
		{
			...
			generate_report_file( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+$('#txt_system_no').val()+'*'+report_title+'*'+print_with_vat+'*'+operation+'*'+show_item+'*'+$('#hidden_is_sales').val(),'grey_fabric_issue_print','requires/woven_grey_fabric_issue_controller');
		}

		/*print_report( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+report_title, "grey_fabric_issue_print", "requires/woven_grey_fabric_issue_controller" ) */
		return;
	}
	else if(operation==5)
	{
		...
		var report_title=$( "div.form_caption" ).html();
		generate_report_file( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+$('#txt_system_no').val()+'*'+report_title+'*'+print_with_vat,'grey_fabric_issue_print','requires/woven_grey_fabric_issue_controller');
		/*print_report( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+report_title, "grey_fabric_issue_print", "requires/woven_grey_fabric_issue_controller" ) */
		return;
	}
	else if(operation==8)
	{
		...
		var print_with_vat=0;
		var report_title=$( "div.form_caption" ).html();
		generate_report_file( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+$('#txt_system_no').val()+'*'+report_title+'*'+print_with_vat,'grey_fabric_issue_print_8','requires/woven_grey_fabric_issue_controller');
		/*print_report( $('#cbo_company_id').val()+'*'+$('#hidden_system_id').val()+'*'+report_title, "grey_fabric_issue_print", "requires/woven_grey_fabric_issue_controller" ) */
		return;
	}
	else if(operation==0 || operation==1)
	{
		...
		if( form_validation('cbo_company_id*txt_issue_date*cbo_basis*cbo_issue_purpose*cbo_dyeing_company*cbo_store_name*txtItemDescription*txtIssueQnty','Company Name*Issue Date*Basis*Issue Purpose*Dyeing Company*Store Name*Item Description*Issue Quantity')==false )
		{
			return;
		}
...
{	
	...
	{	  		
		...
		else if(reponse[0]==0 || reponse[0]==1) //insert
		{
			...
			show_list_view(reponse[2],'show_dtls_list_view','list_view_container','requires/woven_grey_fabric_issue_controller','');
...
function open_mrrpopup()
{
	...
	var company = $("#cbo_company_id").val();	
	var page_link='requires/woven_grey_fabric_issue_controller.php?action=mrr_popup&company='+company; 
	...
	emailwindow.onclose=function()
	{
		...
		get_php_form_data(hidden_id, "populate_data_from_data", "requires/woven_grey_fabric_issue_controller");	 
		//list view call here
		show_list_view($("#hidden_system_id").val(),'show_dtls_list_view','list_view_container','requires/woven_grey_fabric_issue_controller','');
 		$("#child_tbl").find('input,select').val('');
		$("#display").find('input,select').val('');
		...
		show_list_view(document.getElementById('cbo_basis').value+'**'+company+'**'+document.getElementById('hidden_sales_orde_requisition_id').value+'**'+document.getElementById('txt_sales_orde_requisition').value,'show_color_listview','list_color','requires/woven_grey_fabric_issue_controller','');
...
function openmypage_service_booking(page_link,title)
{
	...
	//var fabric_booking_id  = $("#txt_booking_id").val();
	//+'&fabric_booking_id='+fabric_booking_id
	...
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe',  page_link+'&company='+company, title, 'width=995px,height=450px,center=1,resize=1,scrolling=0','../')
	emailwindow.onclose=function()
	{
		var theform=this.contentDoc.forms[0];
...
function openSalesOrderRequisition(page_link)
{
	var company=$("#cbo_company_id").val() * 1;
	var cbo_basis  = $("#cbo_basis").val() * 1;
	var title = 'Requisition Popup';
	if(cbo_basis == 4) title = 'Sales Order Popup';
	if( form_validation('cbo_company_id*cbo_basis','Company Name*Issue Basis')==false )
	{
		return;
	}
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe',  page_link+'&company='+company+'&cbo_basis='+cbo_basis, title, 'width=760px,height=450px,center=1,resize=1,scrolling=0','../')
	emailwindow.onclose=function()
	{
		var theform=this.contentDoc.forms[0];
		var selected_system_no=this.contentDoc.getElementById("selected_system_no").value;
		var selected_system_id=this.contentDoc.getElementById("selected_system_id").value;
		if (selected_system_no!="")
		{
			$('#txt_sales_orde_requisition').val(selected_system_no);
			$('#hidden_sales_orde_requisition_id').val(selected_system_id);
			show_list_view(cbo_basis+'**'+company+'**'+selected_system_id+'**'+selected_system_no,'show_color_listview','list_color','requires/woven_grey_fabric_issue_controller','');
		}
	}
}
...
function func_multiple_issue_no_print()
{
	...
	var page_link='requires/woven_grey_fabric_issue_controller.php?action=multiple_issue_no_popup&company='+company+'&issue_basis='+issue_basis+'&issue_purpose='+issue_purpose+'&dyeing_source='+dyeing_source; 
	...
	emailwindow.onclose=function()
	{
		...
		var report_title=$( "div.form_caption" ).html();
		print_report( issue_id +'*'+$('#cbo_company_id').val(), 'multiple_issue_no_print', 'requires/woven_grey_fabric_issue_controller' );
		return;
	}
}
	                ...
	                <fieldset style="width:950px;">                                       
	                    <table  width="950" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
	                        <tr>
	                        	...
	                        	<td width="120" align="left"><b>Issue No&nbsp;</b></td>
	                            <td >
	                       ...
	                       <tr>
	                            <td  width="120" align="left" class="must_entry_caption">Company Name
	                            </td>
	                            <td width="170">
	                                <?  		 
	                                 echo create_drop_down( "cbo_company_id", 170, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 and comp.core_business not in(3)  $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "get_php_form_data(this.value, 'is_roll_maintain', 'requires/woven_grey_fabric_issue_controller');reset_form('','','txt_booking_no*txt_batch_no*txt_batch_id*cbo_buyer_name*txt_order_no','','','');enable_disable();$('#child_tbl').find('input,select').val('');load_drop_down( 'requires/woven_grey_fabric_issue_controller', this.value, 'load_drop_down_store', 'store_td' );get_php_form_data( this.value, 'company_wise_report_button_setting','requires/woven_grey_fabric_issue_controller' );" );
	                                 //load_room_rack_self_bin('requires/woven_grey_fabric_issue_controller*13', 'store','store_td', this.value);
	                            ...
	                            <td width="120" align="left" class="must_entry_caption">Issue Date</td>
	                            <td width="160">
	                            	<input type="text" name="txt_issue_date" id="txt_issue_date" class="datepicker" style="width:160px;" value="<? echo date('d-m-Y'); ?>" placeholder="Select Date"/>
	                            </td>
	                            <td width="120" align="left" class="must_entry_caption">Issue Basis</td>

	                            <td width="" id="issue_purpose_td">
									<? 
										$grey_issue_basis=array(1=>"Booking",2=>"Independent",3=>"Knitting Plan",4=>"Sales Order",5=>"Requisition");
	                        ...
	                        <tr>                           
	                            <td width="120" align="left" class="must_entry_caption">Issue Purpose </td>
	                            <td width="170">
									<? 
	                            ...
	                            <td width="120" align="left" >Dyeing Source</td>
	                            <td width="160">
	                            	<?
	                                    echo create_drop_down( "cbo_dyeing_source", 172, $knitting_source, "", 1, "-- Select --", $selected, "load_drop_down( 'requires/woven_grey_fabric_issue_controller', this.value+'**'+$('#cbo_company_id').val()+'**'+$('#cbo_issue_purpose').val(), 'load_drop_down_knit_com', 'dyeing_company_td' );","","1,3" );
	                                ?>
	                            </td>
	                            <td width="120" class="must_entry_caption" align="left">Dyeing Company</td>
	                        ...
	                        <tr>                          
	                            <td width="120" align="left" id="knit_source">Fabric Booking</td>
	                            <td width="170">
	                                ...
	                                <input type="hidden" name="txt_batch_no" id="txt_batch_no" class="text_boxes"  onDblClick="openpopup_batch()" />

	                                <input type="hidden" id="txt_batch_id" />
	                            </td>
	                            <td width="120" align="left">Buyer Name</td>
	                            ...
	                            <td width="120" align="left" >Style Reference</td>
	                            <td width="160">
	                        ...
	                        <tr>
	                           <td  width="120" align="left" >Challan No</td>
	                           <td width="170">
	                           ...
	                           <td>
	                           		<input type="text" name="txt_fabric_color_id" id="txt_fabric_color_id" class="text_boxes" style="width:160px" placeholder="Entry" >

	                           		<input type="hidden"  onDblClick="openmypage_service_booking('requires/woven_grey_fabric_issue_controller.php?action=service_booking_popup','Service Booking Search')"  name="txt_service_booking_no" id="txt_service_booking_no" />

	                            	<input type="hidden" name="txt_order_no" id="txt_order_no"  />
	                                <input type="hidden" id="hidden_order_id" />
	                                <input type="hidden" name="hidden_is_sales" id="hidden_is_sales" value="1" />
	                           </td>
	                           <td>
	                           		Sales Order / Requisition
	                           </td>
	                           <td>
	                           		<input type="text" class="text_boxes" style="width:160px"  onDblClick="openSalesOrderRequisition('requires/woven_grey_fabric_issue_controller.php?action=sales_requisition_popup')"  name="txt_sales_orde_requisition" id="txt_sales_orde_requisition" />
	                           		
	                           		<input type="hidden"  id="hidden_sales_orde_requisition_id"  />
	                           </td>
	                      	</tr>
	                    </table>
	                </fieldset> 
	                	...
	                	<table width="400" cellspacing="2" cellpadding="0" border="0" id="child_tbl" > 
	                        ...
	                        <tr  style="display:none;">
	                            ...
	                            <td>
									...
									?>
	                                	...
	                                	<input  type="hidden" name="txtYarnLot" id="txtYarnLot"  />
							...
							<tr>
								...
								<td id="room_td">
	                                ...
	                                <input type="hidden" name="cbo_room_hidden" id="cbo_room_hidden">
								</td>
							</tr> 
	                        <tr>
	                        	<td>Rack</td>
	                            <td id="rack_td">
	                                ...
	                                <input type="hidden" name="txt_rack_hidden" id="txt_rack_hidden" >
	                            </td>
	                        </tr>
	                        <tr>
	                        	<td>Shelf</td>
	                            <td id="shelf_td">
	                                ...
	                                <input type="hidden" name="txt_shelf_hidden" id="txt_shelf_hidden" >
	                            </td>
	                        </tr>
	                        <tr>
	                            <td>Remarks</td>
	             	...
	             	<fieldset style="width:450px; float:left; margin-left:30px">  
	                    ...
	                    <div id="list_color" width="420"></div>
	                </fieldset>   
	                    ...
	                    <tr>
	                        <td align="center" colspan="6" valign="middle" class="button_container">
	                             ...
	                             <input type="button" name="print_1" id="print_1" value="Print" onClick="fnc_grey_fabric_issue_entry(4)" style="width:100px; display:none" class="formbutton" />
	                              ...
	                              <input type="button" name="print_7" id="print_7" value="Print 3" onClick="fnc_grey_fabric_issue_entry(7)" style="width:100px;display:none" class="formbutton" />
	                              <input type="button" name="print_8" id="print_8" value="Print 4" onClick="fnc_grey_fabric_issue_entry(8)" style="width:100px;display:none" class="formbutton" />
	                             <input type="button" name="print_vat" id="print_vat" value="Print With VAT" onClick="fnc_grey_fabric_issue_entry(5)" style="width:100px;display:none" class="formbutton" />
	                              <input type="button" name="print_9" id="print_9" value="Print SB" onClick="fnc_grey_fabric_issue_entry(9)" style="width:100px;display:none" class="formbutton" />
								  <input type="button" name="multiple_issue_no_print" value="Print Multi Issue No" id="multiple_issue_no_print" class="formbutton" style="width: 120px;" onClick="func_multiple_issue_no_print()" /> 
