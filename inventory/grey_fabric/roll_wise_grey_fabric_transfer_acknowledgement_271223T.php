...
<script>
	...
	function fn_load_room(floor_id, sequenceNo)
	{
		...
		if(copy_color_wise && copy_lot_wise && copy_stitch_length && $('#floorIds').is(':checked'))
		{
			for(var i=sequenceNo; i>=1; i--)
			{
	...
	function fn_load_rack(room_id, sequenceNo)
	{
		...
		if(copy_color_wise && copy_lot_wise && copy_stitch_length && $('#roomIds').is(':checked'))
		{
			for(var i=sequenceNo; i>=1; i--)
			{
	...
	function fn_load_shelf(rack_id, sequenceNo)
	{
		...
		if(copy_color_wise && copy_lot_wise && copy_stitch_length && $('#rackIds').is(':checked'))
		{
			for(var i=sequenceNo; i>=1; i--)
			{
	...
	function fn_load_bin(shelf_id, sequenceNo)
	{
		...
		if(copy_color_wise && copy_lot_wise && copy_stitch_length && $('#shelfIds').is(':checked'))
		{
			for(var i=sequenceNo; i>=1; i--)
			{
	...
	{		
		...
		for(var k=first_tr; k>=1; k--)
		{
			...
			//Bin
			if(copy_color_wise && copy_lot_wise && copy_stitch_length && $('#binIds').is(':checked'))
	        {
	            if (txtColor == txtColor_check && txtLot == txtLot_check && txtStitchLength == txtStitchLength_check)
	            {
