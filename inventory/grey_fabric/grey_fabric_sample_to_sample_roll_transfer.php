...
function openmypage_systemId()
{
	...
	var page_link = 'requires/grey_fabric_sample_to_sample_roll_transfer_controller.php?cbo_company_id='+cbo_company_id+'&action=sampleToSampleTransfer_popup';
	...
	emailwindow.onclose=function()
	{
		...
		get_php_form_data(transfer_id, "populate_data_from_transfer_master", "requires/grey_fabric_sample_to_sample_roll_transfer_controller" );
		show_list_view(transfer_id+"**"+$('#txt_trans_from_sam_book_id').val(),'show_transfer_listview','tbl_details','requires/grey_fabric_sample_to_sample_roll_transfer_controller','');
		disable_enable_fields("txt_trans_from_sam_book_no*txt_trans_to_sam_book_no",1);
	}
}
...
function fn_trans_from_open_semple(type)
{
	...
	var page_link = 'requires/grey_fabric_sample_to_sample_roll_transfer_controller.php?cbo_company_id='+cbo_company_id+'&type='+type+'&action=transfer_from_sample_popup';
...
function fn_trans_to_open_semple()
{
	...
	var title = 'Sample Information';	
	var page_link = 'requires/grey_fabric_sample_to_sample_roll_transfer_controller.php?cbo_company_id='+cbo_company_id+'&action=transfer_to_sample_popup';
	...
	emailwindow.onclose=function()
	{
		...
		var samp_booking_dtls_id = sample_arr[1];
 		...
 		get_php_form_data(samp_booking_dtls_id, "populate_data_to_sample_transfer_to", "requires/grey_fabric_sample_to_sample_roll_transfer_controller" );
	}
}
...
function fnc_grey_transfer_entry(operation) 
{
	if(operation==4)
	{
		...
		print_report( $('#cbo_company_id').val()+'*'+$('#update_id').val()+'*'+report_title, "grey_fabric_sample_to_sample_transfer_print", "requires/grey_fabric_sample_to_sample_roll_transfer_controller" ) 
		return;
	}
	else if(operation==0 || operation==1 || operation==2)
	{
		...
		var txt_trans_from_sam_book_dtls_id = $("#txt_trans_from_sam_book_dtls_id").val();    
		var txt_trans_to_sam_book_dtls_id = $("#txt_trans_to_sam_book_dtls_id").val(); 
		...
		'&txt_trans_from_sam_book_dtls_id='+txt_trans_from_sam_book_dtls_id+
		'&txt_trans_to_sam_book_dtls_id='+txt_trans_to_sam_book_dtls_id+
		'&update_id='+update_id+
		...
		http.open("POST","requires/grey_fabric_sample_to_sample_roll_transfer_controller.php",true);
...
{	
	...
	{	  		
		...
		if(reponse[0]==0 || reponse[0]==1)
		{
			...
			show_list_view(reponse[1]+"**"+$('#txt_from_order_id').val(),'show_transfer_listview','tbl_details','requires/grey_fabric_sample_to_sample_roll_transfer_controller','');
...
function openmypage_orderInfo(type)
{
	...
	var page_link = 'requires/grey_fabric_sample_to_sample_roll_transfer_controller.php?txt_order_no='+txt_order_no+'&txt_order_id='+txt_order_id+'&type='+type+'&action=orderInfo_popup';
...
<div align="center" style="width:100%;">
    ...
    <form name="transferEntry_1" id="transferEntry_1" autocomplete="off" >
        ...
        <legend>Roll Wise Grey Fabric Sample To Sample Transfer Entry</legend>
        <br>
                            ...
                            <table id="to_order_info"  cellpadding="0" cellspacing="1" width="100%" >	
                            	<tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="txt_trans_from_sam_book_dtls_id" id="txt_trans_from_sam_book_dtls_id" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Booking Qnty.</td>
                            ...
                            <table id="to_order_info"  cellpadding="0" cellspacing="1" width="100%" >	
                            	<tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="hidden" name="txt_trans_to_sam_book_dtls_id" id="txt_trans_to_sam_book_dtls_id" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Booking Qnty.</td>
