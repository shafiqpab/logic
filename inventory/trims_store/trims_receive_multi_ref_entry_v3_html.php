...
<script>
	...
	function openmypage_wo_pi_popup()
	{
		...
		{ 	
			...
			emailwindow.onclose=function()
			{
				...
				var exchange_rate = $('#txt_exchange_rate').val()*1;
				//alert(exchange_rate);
				show_list_view_post(booking_no_pi_id+"**"+rcv_basis+"**"+booking_without_order+"**"+cbo_company_id+"**"+data[2]+"**"+exchange_rate+"**"+hid_booking_type+"**"+theemail, 'show_fabric_desc_listview', 'list_fabric_desc_container', 'requires/trims_receive_multi_ref_entry_v3_controller', 'setFilterGrid("list_fabric_desc_container",-1)' ) ;
	...
	function fn_pament_over(str,pay_val,seq_no)
	{
		...
		var trall=$("#list_fabric_desc_container tbody tr").length-1;
	...
	{		
		...
		var tbl_length=$('#list_fabric_desc_container tbody tr').length;
	...
	{
		var numRow=$('#list_fabric_desc_container tbody tr').length;
                    ...
                    <? $i=1; ?>
                    	<table class="rpt_table" width="100%" cellspacing="0" cellpadding="0" border="1" rules="all" id="tbl_fabric_desc_item">
                        	<thead>
								...
								<tr>
									...
									<th width="60"><input type="checkbox" checked id="paymentOverRcv" name="paymentOverRcv"/><br>Payment For Over Rcv.Qty.</th>
								</tr>
                            </thead>
                        </table>
                        ...
                        <table class="rpt_table" width="100%" cellspacing="0" cellpadding="0" border="1" rules="all" id="list_fabric_desc_container_footer">
                            <tfoot>
                                ...
                                <th width="70"><input type="text" id="tot_rcv_qnty" name="tot_rcv_qnty" style="width:50px;" class="text_boxes_numeric" readonly disabled /></th>
                                <th width="70">&nbsp;</th>
                                <th width="70">&nbsp;</th>
                                <th width="70">&nbsp;</th>
                                <th width="70">&nbsp;</th>
                 ...
                 <table width="100%">
                    <tr>
                        <td width="80%" align="center"> 
                            ...
                            echo load_submit_buttons($permission, "fnc_trims_receive", 0,0,"reset_form('trimsreceive_1','list_container_trims*list_fabric_desc_container','','','set_receive_basis(1);','')",1);
                            ?>
