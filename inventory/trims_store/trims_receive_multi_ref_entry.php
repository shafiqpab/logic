...
<script>
	...
	{
		var recieve_basis=$('#cbo_receive_basis').val();
		var txt_booking_pi_id=$('#txt_booking_pi_id').val();
		...
		{		
			...
			show_list_view(booking_no_pi_id+"**"+recieve_basis+"**"+booking_without_order+"**"+txt_booking_pi_id,'show_fabric_desc_listview','list_fabric_desc_container','requires/trims_receive_multi_ref_entry_controller','setFilterGrid(\'tbl_list_search\',-1);');
		}
	}
