...
<script>
	...
	function fnc_grey_delivery_roll_wise(operation)
	{
		...
		$("#scanning_tbl").find('tbody tr').each(function()
		{
			...
			var gsm=$(this).find("td:eq(12)").text();
			var dia=$(this).find("td:eq(13)").text();
			var jobNo=$(this).find("td:eq(19)").text();
			var systemId=$(this).find("td:eq(23)").text();
        ...
        <form name="rollscanning_1" id="rollscanning_1"  autocomplete="off"  >
			...
			<fieldset style="width:1390px;text-align:left">
				...
				<table cellpadding="0" width="1700" cellspacing="0" border="1" id="scanning_tbl_top" class="rpt_table" rules="all">
                 ...
                 <div style="width:1720px; max-height:250px; overflow-y:scroll" align="left">
