...
function exchange_rate(currency_id)
{
	...
	else
	{
		...
		var response=return_global_ajax_value( currency_id+"**"+recv_date, 'check_conversion_rate', '', 'requires/woven_finish_fabric_receive_controller').split("_");
...
function fnResetForm()
{
	...
	disable_enable_fields( 'cbo_company_id*cbo_receive_basis*cbo_store_name', 0, "", "" );
...
function check_exchange_rate()
{
	...
	var response=return_global_ajax_value( cbo_currercy+"**"+receive_date, 'check_conversion_rate', '', 'requires/woven_finish_fabric_receive_controller');
								...
								<td width="49%" valign="top" >
									...
									<table width="220" cellspacing="2" cellpadding="0" border="0" style="float:left;">
										<tr>    
											...
											<td>
												<?
												echo create_drop_down( "cbo_body_part", 152, $body_part,"", 1, "-- Select Body Part --", 0, "","1" );
												?>
											</td>
										</tr> 
										<!--
										...
										<tr>
											...
											<td colspan="3">
												<input type="text" name="txt_fabric_description" id="txt_fabric_description" class="text_boxes" style="width:140px; height:40px" onDblClick="openmypage_fabricDescription()" placeholder="Double Click To Search"  readonly disabled/>
										...
										<tr>   
											...
											<td id="color_td_id">
												<input type="text" name="txt_color" id="txt_color" class="text_boxes" style="width:140px;" maxlength="20" title="Maximum 20 Character" disabled />
										...
										<tr>    
											...
											<td><input type="text" name="txt_width" id="txt_width" class="text_boxes" style="width:140px;" /></td>
										</tr> 

										<tr>    
											<td align="right">Weight</td>
											<td><input type="text" name="txt_weight" id="txt_weight" class="text_boxes_numeric" style="width:140px;" /></td>
										</tr>
										...
										<tr>
											...
											<td width="130">
												<input type="text" name="txt_batch_lot" id="txt_batch_lot" class="text_boxes" style="width:140px;" />
										...
										<tr>
											...
											<td width=""><input class="text_boxes"  name="txt_prod_code" id="txt_prod_code" type="text" style="width:140px;" readonly  disabled /></td>
										</tr> 
                                       ...
                                       // echo create_drop_down( "cbo_uom", 152, $unit_of_measurement,"", 0, "--Select--", 27, "",1,27 );
												echo create_drop_down( "cbouom", 152, $unit_of_measurement,"", 0, "-Uom-", 27, "","1,12,23,27" );
												?>
											</td>
										</tr>
										<tr>    
											...
											<td>
												<input name="txt_receive_qty" id="txt_receive_qty"  class="text_boxes_numeric" type="text" style="width:140px;" onClick="openmypage_po()" placeholder="Single Click" onFocus="fn_calile()" readonly />
										...
										<tr>    
											...
											<td >
												<input name="txt_rate" id="txt_rate" class="text_boxes_numeric" type="text" style="width:140px;" onBlur="fn_calile()" value="0" disabled />
											</td>
										</tr>
										...
										<tr>   
											...
											<td >
												<input name="txt_ile" id="txt_ile" class="text_boxes_numeric" type="text" style="width:140px;" placeholder="ILE COST" readonly disabled />
											</td>
										</tr>  
									...
									<table width="220" cellspacing="2" cellpadding="0" border="0" style="float:left">
										...
										<tr> 
											...
											<td><input type="text" name="txt_amount" id="txt_amount" class="text_boxes_numeric" style="width:140px;" readonly disabled /></td>
										</tr>
										<tr> 
											<td align="right">Book Currency.</td>
											<td>
												<input type="text" name="txt_book_currency" id="txt_book_currency" class="text_boxes_numeric" style="width:140px;" readonly disabled />
											</td>
										</tr>
										<tr> 
											<td align="right">Balance PI/ WO </td>
											<td><input class="text_boxes_numeric"  name="txt_bla_order_qty" id="txt_bla_order_qty" type="text" style="width:140px;" readonly disabled /></td>
										</tr>
										...
										<tr>    
											...
											<td >
												<input name="txt_roll" id="txt_roll" class="text_boxes_numeric" type="text" style="width:140px;" />
											</td>
										</tr>
										...
										<tr>
											...
											<td >
												<?
												echo create_drop_down( "cbo_cutting_unit_no", 152, "select id,floor_name from lib_prod_floor where status_active =1 and is_deleted=0 and production_process=1 order by floor_name","id,floor_name", 1, "-- Select Floor --", $selected, "",0 );
												?>
											</td>
										</tr>
										<tr> 
					...
					<table cellpadding="0" cellspacing="1" width="100%">
						...
						<tr>
							<td align="center" colspan="6" valign="middle" class="button_container">
								...
								<? echo load_submit_buttons( $permission, "fnc_woben_finish_fab_receive_entry", 0,1,"fnResetForm()",1);?>
