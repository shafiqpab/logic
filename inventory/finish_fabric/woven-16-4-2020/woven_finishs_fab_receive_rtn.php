...
function openmypage_rtn_qty()
{
	...
	var page_link = 'requires/woven_finish_fab_receive_rtn_controller.php?cbo_company_id='+cbo_company_id+'&txt_received_id='+txt_received_id+'&txt_prod_id='+txt_prod_id+'&hidden_receive_trans_id='+hidden_receive_trans_id+'&txt_break_qnty='+txt_break_qnty+'&txt_break_roll='+txt_break_roll+'&update_id='+update_id+'&action=return_po_popup';
...
function fnc_yarn_receive_return_entry(operation)
{
	...
	else
	{
		...
		var dataString = "txt_return_no*cbo_company_id*txt_return_date*txt_received_id*txt_mrr_no*cbo_return_to*txt_pi_no*pi_id*txt_item_description*txt_prod_id*txt_return_qnty*cbo_uom*txt_break_qnty*txt_break_roll*txt_order_id_all*txt_remarks*txt_roll*hidden_receive_trans_id*before_prod_id*update_id*issue_mst_id*prev_return_qnty*before_receive_trans_id*txt_global_stock*hidden_batch_id*cbo_body_part*cbo_store_name*cbo_floor*cbo_room*cbo_bin*txt_rack*txt_shelf*txt_batch_no";
