					...
					<fieldset style="width:880px;">                                       
						<table width="870" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
							...
							<tr>
								...
								<td width="170">
									<? 
									echo create_drop_down( "cbo_company_id", 160, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "rcv_basis_reset();load_drop_down( 'requires/woven_finish_fabric_receive_controller', this.value, 'load_drop_down_supplier', 'supplier' );load_drop_down( 'requires/woven_finish_fabric_receive_controller', this.value, 'load_drop_down_location', 'location_td');load_drop_down( 'requires/woven_finish_fabric_receive_controller', this.value, 'load_drop_down_buyer', 'buyer_td');load_room_rack_self_bin('requires/woven_finish_fabric_receive_controller*3', 'store','store_td', this.value);get_php_form_data( this.value, 'company_wise_report_button_setting','requires/woven_finish_fabric_receive_controller' );get_php_form_data(this.value,'roll_maintained','requires/woven_finish_fabric_receive_controller' );independence_basis_controll_function(this.value);" );
							...
							<tr>
                                ...
                                <td width="160" id="buyer_td"><? echo create_drop_down( "cbo_buyer_name", 160, $blank_array,"", 1, "-- Select Buyer --", $selected, "" ); ?></td>
                              	<td align="right">file</td> 
                               	<td> <input type="button" class="image_uploader" style="width:160px" value="CLICK TO ADD FILE" id="btn_fileadd"onClick="file_uploader ( '../../', document.getElementById('txt_mrr_no').value,'', 'woven_finish_fabric_receive', 2 ,1)"> </td>
							</tr>
							<tr>
								<td></td>
								<td></td>
								<td width="100" align="right">Addi. Info</td>
                                <td width="160">
