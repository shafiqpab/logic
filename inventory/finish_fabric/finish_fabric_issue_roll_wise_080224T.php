        ...
        <form name="rollscanning_1" id="rollscanning_1"  autocomplete="off"  >
         ...
         <div style="float:left; " align="center">
			...
			<fieldset style="width:1620px;text-align:left; margin-top:20px;">
				...
				<table cellpadding="0" width="1925" cellspacing="0" border="1" id="scanning_tbl_top" class="rpt_table" rules="all">
                    <thead>
                    	<th width="35">SL</th>
                 ...
                 <div style="width:1943px; max-height:250px; overflow-y:scroll" align="left">
                 	<table cellpadding="0" cellspacing="0" width="1925" border="1" id="scanning_tbl" rules="all" class="rpt_table">
                    	<tbody>
