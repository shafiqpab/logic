...
<script>
	...
	function fnc_shrinkage_shade_entry(operation){
		...
		if (form_validation('cbo_company_id*txt_job_no*txt_consigment','Company Name*Job No*Consigment')==false)
		{
			...
			for(var i=0;i<totalRows;i++){
				var dtlsData='dtlsID_'+i+'*cclNo_'+i+'*intellocutRollNo_'+i+'*lengthYDS_'+i+'*width_'+i+'*shade_'+i+'*beforeWashLengthCM_'+i+'*beforeWashWidthCM_'+i+'*afterWashLengthCM_'+i+'*afterWashWidthCM_'+i+'*beforeWashGSM_'+i+'*afterWashGSM_'+i+'*barcodeNo_'+i+'*grnDtlsId_'+i+'*bookingId_'+i+'*bookingNo_'+i;
	...
	function fn_open_sys_popup(){
		...
		emailwindow.onclose = function ()
		{
			...
			get_php_form_data(job_id, "populate_sys_data", "requires/woven_shrinkage_and_shade_controller");
			set_button_status(1, permission, 'fnc_shrinkage_shade_entry',1);
		}
            ...
            <tbody id="mst_dtls_part">
                <tr>
                   ...
                   <!--  <td><input type="text" id="rollNo_0" value="" class="text_boxes" style="width:60px;"></td> -->
                    <td><input type="text" id="lengthYDS_0" value="" class="text_boxes" style="width:60px;"></td>
