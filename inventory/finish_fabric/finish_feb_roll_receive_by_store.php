  ...
  function generate_report_file(data,action)
	...
	function fnc_grey_receive_roll_wise( operation )
	{
		...
		$("#scanning_tbl").find('tbody tr').each(function()
		{
			...
			var rejectQty=$(this).find("td:eq(13)").text();
			...
			//+ '&rack_' + j + '=' + rack			 
			var systemId=trim($(this).find("td:eq(25)").text());
    ...
    <form name="rollscanning_1" id="rollscanning_1"  autocomplete="off"  >
            ...
            <br/>
              <fieldset style="width:1510px;text-align:left">
				...
				<table cellpadding="0" width="1700" cellspacing="0" border="1" id="scanning_tbl_top" class="rpt_table" rules="all">
                    <thead>
                 ...
                 <div style="width:1730px; max-height:250px; overflow-y:scroll" align="left">
                 	<table cellpadding="0" cellspacing="0" width="1700" border="1" id="scanning_tbl" rules="all" class="rpt_table">
                    	<tbody id="list_view_container">
                        	<tr id="tr_1" align="center" valign="middle">
                                ...
                                <td width="120" id="comps_1" style="word-break:break-all;" align="left"></td>
