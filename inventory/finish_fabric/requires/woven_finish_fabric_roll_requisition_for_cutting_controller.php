...
if($action=="create_fabric_search_list_view")
{
	...
	{ 
		...
		and c.is_deleted=0 and c.entry_form=564 and c.trans_type=1  and a.company_name=$company_id  $job_no_cond $year_cond $po_cond $int_ref_cond $style_ref_cond $brand_no_cond $season_no_cond $season_year_cond
		...
		$sql_data="select a.buyer_name,a.job_no, a.job_no_prefix_num,TO_CHAR(a.insert_date,'YYYY') as year ,a.style_ref_no,b.grouping,f.item_number_id as item_id,e.body_part_id,e.original_gsm as gsm_weight,e.original_width as dia_width,e.gsm as actual_weight,e.fabric_description_id as lib_yarn_count_deter_id,e.color_id,c.qnty as quantity,e.uom,d.fabric_shade as shade ,b.job_id,c.booking_no,g.source
		from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown f,PRO_ROLL_DETAILS c, pro_finish_fabric_rcv_dtls e,inv_transaction d,inv_receive_master g where a.id=b.job_id and b.id=f.po_break_down_id and f.job_id=c.job_id and c.mst_id=e.mst_id and c.dtls_id=e.id and d.id=e.trans_id and d.mst_id=e.mst_id and e.mst_id=g.id and d.receive_basis=1 and d.item_category=3 and d.transaction_type=1 and a.status_active=1 and c.entry_form=564 and g.entry_form=564 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and a.company_name=$company_id  $job_no_cond $year_cond $int_ref_cond $style_ref_cond $brand_no_cond $season_no_cond $season_year_cond
		group by a.buyer_name,a.job_no,a.job_no_prefix_num,a.insert_date,a.style_ref_no,b.grouping,f.item_number_id,e.body_part_id,e.original_gsm,e.original_width,e.gsm,e.fabric_description_id,e.color_id,c.qnty,e.uom,d.fabric_shade ,b.job_id,c.booking_no,g.source";
		...
		foreach($sql as $row)
		{
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['buyer_name']=$row[csf('buyer_name')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['job_no']=$row[csf('job_no')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['style_ref_no']=$row[csf('style_ref_no')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['grouping']=$row[csf('grouping')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['body_part_id']=$row[csf('body_part_id')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['gsm_weight']=$row[csf('gsm_weight')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['actual_weight']=$row[csf('actual_weight')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['dia_width']=$row[csf('dia_width')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['lib_yarn_count_deter_id']=$row[csf('lib_yarn_count_deter_id')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['color_id']=$row[csf('color_id')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['item_id']=$row[csf('item_id')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['uom']=$row[csf('uom')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['shade']=$row[csf('shade')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['quantity']+=$row[csf('quantity')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['year']=$row[csf('year')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['job_no_prefix_num']=$row[csf('job_no_prefix_num')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['po_id']=$row[csf('po_id')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['po_number']=$row[csf('po_number')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['job_id']=$row[csf('job_id')];
			$mainArr[$row[csf('buyer_name')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('style_ref_no')]][$row[csf('grouping')]][$row[csf('body_part_id')]][$row[csf('actual_weight')]][$row[csf('gsm_weight')]][$row[csf('dia_width')]][$row[csf('lib_yarn_count_deter_id')]][$row[csf('color_id')]][$row[csf('item_id')]][$row[csf('uom')]][$row[csf('shade')]]['source']=$row[csf('source')];
			...
			$job_id_array2[$row[csf('job_id')]] = $row[csf('job_id')];
		}
		...
		$job_nos=chop(implode(",",array_unique(explode(",",$jobNos))),",");
		$jobIDss = implode(",", $job_id_array2);
	...
	if($hdn_variable_setting_status==1)// style wise
	{
		if($hdn_variable_colorSize_status==2)// color level
		{
			...
			foreach($sql_po_wise as $row)
			{
				...
				from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c, wo_pre_cos_fab_co_avg_con_dtls d, wo_pre_cost_fabric_cost_dtls e,wo_booking_dtls f
				where a.id=b.job_id and b.id=c.po_break_down_id and c.po_break_down_id=d.po_break_down_id and c.color_number_id=d.color_number_id and c.size_number_id=d.gmts_sizes and d.pre_cost_fabric_cost_dtls_id=e.id and c.job_no_mst=e.job_no and c.item_number_id=e.item_number_id and a.is_deleted=0 and a.status_active=1 and b.is_confirmed=1 and a.company_name=$company_id  $job_no_cond $year_cond $po_cond $int_ref_cond $batch_cond $style_ref_cond $brand_no_cond $season_no_cond $season_year_cond and e.job_no=f.job_no and d.pre_cost_fabric_cost_dtls_id=f.pre_cost_fabric_cost_dtls_id and c.color_number_id=f.fabric_color_id and  e.gsm_weight=f.gsm_weight and d.dia_width=f.dia_width and f.po_break_down_id=b.id and f.is_deleted=0 and f.status_active=1 and c.color_number_id in($recvColorIDS) and a.id in($jobIDss) and e.lib_yarn_count_deter_id in($recvDeterminationIds) and e.body_part_id in($recvBodyPartIds)
		...
		//echo "<pre>";
		//print_r($budgetQntyInfoArr);
		
		$determination_info_sql = sql_select("SELECT b.body_part_id,b.lib_yarn_count_deter_id,b.uom, b.gsm_weight, a.booking_no as wopi_number, a.dia_width, a.fabric_color_id as color_id,c.rd_no,c.fabric_ref,b.gsm_weight_type as weight_type,d.item_size as cutable_width  from wo_booking_dtls a, wo_pre_cost_fabric_cost_dtls b  join wo_pre_cos_fab_co_avg_con_dtls d on b.id=d.pre_cost_fabric_cost_dtls_id,lib_yarn_count_determina_mst c where a.pre_cost_fabric_cost_dtls_id=b.id and b.lib_yarn_count_deter_id=c.id and a.job_no in($job_nos) and b.lib_yarn_count_deter_id in($recvDeterminationIds) and b.body_part_id in($recvBodyPartIds) and a.fabric_color_id in($recvColorIDS)
			and a.job_no=b.job_no and a.status_active=1 and a.is_deleted=0 group by b.body_part_id,a.booking_no, b.lib_yarn_count_deter_id,b.gsm_weight, a.dia_width, a.fabric_color_id,b.uom,c.rd_no,c.fabric_ref,b.gsm_weight_type,d.item_size"); 
		//,c.weight_type
	...
	foreach ($result as $val) 
	{
		...
		$job_id_array[$val[csf('job_id')]] = $val[csf('job_id')];
		
	}

	//$poIDs = implode(",", $po_id_array);
	$jobIDs = implode(",", $job_id_array);
	...
	if(count($job_id_array))
	{
		...
		$job_id_cond_wvn_recv=where_con_using_array($job_id_array,0,"c.job_id");
		$job_id_cond_prev_req=where_con_using_array($job_id_array,0,"b.job_id");
	}
	if($hdn_variable_setting_status==1) // po to style
	{
		if($hdn_variable_colorSize_status==2) // color wise
		{
			$sqlPrev="SELECT b.id, buyer_id, b.job_no, b.item_id, b.body_part, b.determination_id,b.actual_weight, b.gsm, b.dia, b.color_id, b.reqn_qty,b.cons,b.shade,b.booking_no from pro_fab_reqn_for_cutting_mst a, pro_fab_reqn_for_cutting_dtls b where a.id=b.mst_id and  a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and a.entry_form=619 $job_id_cond_prev_req";
			// echo $sqlPrev;die();
			$resultPrev=sql_select($sqlPrev);
			$prevRcvQntyArr = array();
			foreach ($resultPrev as $val) 
			{
				if($val[csf('cons')]<0){ $val[csf('cons')]= sprintf('%.2f', $val[csf('cons')]);}

				$prevRcvQntyArr[$val[csf('buyer_id')]][$val[csf('job_no')]][$val[csf('booking_no')]][$val[csf('item_id')]][$val[csf('body_part')]][$val[csf('determination_id')]][$val[csf('actual_weight')]][$val[csf('gsm')]][$val[csf('dia')]][$val[csf('color_id')]][$val[csf('cons')]][$val[csf('shade')]]+=$val[csf('reqn_qty')];
			}
		}
	...
	/*$wvn_recv_sql="select x.buyer_id,a.mst_id,a.fabric_description_id,a.original_gsm,a.original_width,b.body_part_id, b.fabric_ref,b.rd_no,b.cutable_width,b.weight_type,c.po_breakdown_id,c.color_id,c.quantity from inv_receive_master x, pro_finish_fabric_rcv_dtls a,inv_transaction b,order_wise_pro_details c where x.id=b.mst_id and a.trans_id=b.id and c.trans_id=b.id and c.entry_form=564 and b.item_category=3 and b.transaction_type=1 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $job_id_cond_wvn_recv";*/

   $wvn_recv_sql="select x.buyer_id,a.mst_id,a.fabric_description_id,a.gsm as actual_weight,a.original_gsm,a.original_width,b.body_part_id, b.fabric_ref,b.rd_no,b.cutable_width,b.weight_type,b.fabric_shade,a.color_id,c.qnty as quantity,c.booking_no from inv_receive_master x, pro_finish_fabric_rcv_dtls a,inv_transaction b,PRO_ROLL_DETAILS c where x.id=b.mst_id and a.trans_id=b.id and b.mst_id=c.mst_id and a.id=c.dtls_id and c.entry_form=564 and x.entry_form=564 and b.item_category=3 and b.transaction_type=1 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $job_id_cond_wvn_recv";
	...
	foreach($wvn_recv_sql_rslt as $rows)
	{
		if($hdn_variable_setting_status==1) // style wise
		{
			...
			$wvn_recv_qnty_array[$rows[csf('booking_no')]][$rows[csf('buyer_id')]][$rows[csf('fabric_description_id')]][$rows[csf('body_part_id')]][$rows[csf('actual_weight')]][$rows[csf('original_gsm')]][$rows[csf('original_width')]][$rows[csf('fabric_ref')]][$rows[csf('rd_no')]][$rows[csf('cutable_width')]][$rows[csf('weight_type')]][$rows[csf('color_id')]][$rows[csf('fabric_shade')]]['wvn_recv_qty']+=$rows[csf('quantity')];
			$wvn_recv_qnty_array[$rows[csf('booking_no')]][$rows[csf('buyer_id')]][$rows[csf('fabric_description_id')]][$rows[csf('body_part_id')]][$rows[csf('actual_weight')]][$rows[csf('original_gsm')]][$rows[csf('original_width')]][$rows[csf('fabric_ref')]][$rows[csf('rd_no')]][$rows[csf('cutable_width')]][$rows[csf('weight_type')]][$rows[csf('color_id')]][$rows[csf('fabric_shade')]]['shrinkage_cutable_width']=$rows[csf('cutable_width')];
		}
	...
	?>
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1645" class="rpt_table">
		<thead>
			...
			<th style="word-wrap: break-word;word-break: break-all;" width="100">Booking No</th>
			<? 
			if($hdn_variable_setting_status!=1)
			{
				?>
			...
			<th style="word-wrap: break-word;word-break: break-all;" width="40">Actual Weight</th>
			...
			<th style="word-wrap: break-word;word-break: break-all;" width="75">Recv Qty</th>
	...
	<div style="width:1665px; max-height:250px; overflow-y:scroll" id="list_container_batch" align="left">	 
		<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1645" class="rpt_table" id="tbl_list_search">  
		<? 
			$i=1;
			...
			{  
				...
				{
					foreach ($job_noData as $bookingNo => $booking_noData) 
					{
						foreach ($booking_noData as $style_ref_no => $style_ref_noData) 
						{
							foreach ($style_ref_noData as $grouping => $groupingData) 
							{
								foreach ($groupingData as $body_part_id => $body_part_idData) 
								{
									foreach ($body_part_idData as $actual_weight => $actual_weightData) 
									{
										foreach ($actual_weightData as $gsm_weight => $gsm_weightData) 
										{
																...
																foreach ($uomData as $shade => $row) 
																{
																	...
																	if($hdn_variable_setting_status==1) // po to style wise
																	{
																		...
																		{	
																			...
																			/*if($avg_cons<0)
																			{
																				number_format($avg_cons, 2, '.', '0');
																			}*/
																			//echo $row['buyer_name']."=".$row['job_no']."=".$bookingNo."=".$row['item_id']."=".$row['body_part_id']."=".$row['lib_yarn_count_deter_id']."=".$row['actual_weight']."=".$row['gsm_weight']."=".$row['dia_width']."=".$row['color_id']."=".$avg_cons."=".$row['shade']."<br/>";

																			

																			$prevRcvQnty=$prevRcvQntyArr[$row['buyer_name']][$row['job_no']][$bookingNo][$row['item_id']][$row['body_part_id']][$row['lib_yarn_count_deter_id']][$row['actual_weight']][$row['gsm_weight']][$row['dia_width']][$row['color_id']][$avg_cons][$row['shade']];
																	...
																	//echo $row['job_no']."=".$row['color_id']."=".$fab_color_id."=".$row['body_part_id']."=".$row['lib_yarn_count_deter_id']."=".$row['gsm_weight']."=".$row['dia_width']."=".$row['source']."=".$uom;
																	$budgteQnty=$fabric_req_arr['woven']['grey'][$row['job_no']][$row['color_id']][$fab_color_id][$row['body_part_id']][$row['lib_yarn_count_deter_id']][$row['gsm_weight']][$row['dia_width']][$row['source']][$uom];
																	//echo $budget_qty."<br/>";
																	...
																	if($hdn_variable_setting_status==1) // style wise
																	{
																		...
																		if($cutable_width==""){$cutable_width=0;}else{$cutable_width=$cutable_width;}
																		//echo $bookingNo.'='.$row['buyer_name'].'='.$row['lib_yarn_count_deter_id'].'='.$row['body_part_id'].'='.$row['gsm_weight'].'='.$row['dia_width'].'='.$fabric_ref.'='.$rd_no.'='.$cutable_width.'='.$weight_type.'='.$fab_color_id."<br/>";
																		
																		$wvn_rcv_qnty=$wvn_recv_qnty_array[$bookingNo][$row['buyer_name']][$row['lib_yarn_count_deter_id']][$row['body_part_id']][$row['actual_weight']][$row['gsm_weight']][$row['dia_width']][$fabric_ref][$rd_no][$cutable_width][$weight_type][$fab_color_id][$row['shade']]['wvn_recv_qty'];
																		//echo $wvn_rcv_qnty;

																		$wvn_rcv_shrinkage_cutable=$wvn_recv_qnty_array[$bookingNo][$row['buyer_name']][$row['lib_yarn_count_deter_id']][$row['body_part_id']][$row['actual_weight']][$row['gsm_weight']][$row['dia_width']][$fabric_ref][$rd_no][$cutable_width][$weight_type][$fab_color_id][$row['shade']]['shrinkage_cutable_width'];
																		//echo $wvn_rcv_shrinkage_cutable."<br/>";


																		$balance_qty=$wvn_rcv_qnty-$prevRcvQnty;
																	...
																	<tr title="<?//=$row['COLOR_SIZE_SENSITIVE'];?>" bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" id="search<? echo $i; ?>" onClick="js_set_value(<? echo $i; ?>,<? echo $row['buyer_name'];?>,<? //echo $row[csf('budget_qty')];?>)"> 
																		...
																		<td style="word-wrap: break-word;word-break: break-all;" width="100" ><p>&nbsp;&nbsp;<? echo $bookingNo; ?></p></td>
																		<? 
																		if($hdn_variable_setting_status!=1)
																		{
																			?>
																		...
																		<td style="word-wrap: break-word;word-break: break-all;" width="40"><p><? echo $row['actual_weight']; ?></p></td>
																		...
																		<td style="word-wrap: break-word;word-break: break-all;" width="75" align="right"><p><? echo number_format($wvn_rcv_qnty,2,'.',''); ?></p>
																			<input type="hidden" name="trWvnRecvQnty[]" id="trWvnRecvQnty<? echo $i; ?>" value="<? echo $wvn_rcv_qnty; ?>"/>
																		</td>
	...
	<table width="1570" cellspacing="0" cellpadding="0" border="1" align="center">
		<tr>
...
if ($action=="save_update_delete")
{
	...
	{ 	
		...
		if($hdn_variable_setting_status==1)
		{
			$field_array_dtls="id, mst_id, buyer_id, po_id, job_no, item_id, body_part, determination_id, gsm,actual_weight, dia, color_id,fab_color_id, size_id,fabric_ref,weight_type,cutable_width,rd_no,style_ref_no,cons,shade,reqn_qty,booking_no,job_id, inserted_by, insert_date";
			for($j=1;$j<=$tot_row;$j++)
			{ 
				...
				//{
					...
					$data_array_dtls.="(".$dtls_id.",".$id.",".$$buyerId.",'".$hdnPoAndQtyArr[0]."','".$$jobNo."','".$$itemId."','".$$bodyPartId."','".$$deterId."','".$$gsm."','".$$actualWeight."','".$$dia."','".$$colorId."','".$$fabColorId."','".$$sizeId."','".$$fabricRef."','".$$weightType."','".$$cutableWidth."','".$$rdNo."','".$$styleRef."','".$$cons."','".$$shade."','".$$reqsnQty."','".$$bookingNo."','".$$jobId."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
					$dtls_id = $dtls_id+1;
		...
		{
			$field_array_dtls="id, mst_id, buyer_id, po_id, job_no, item_id, body_part, determination_id, gsm,actual_weight, dia, color_id,fab_color_id, size_id,style_ref_no,cons,shade,reqn_qty,booking_no,job_id, inserted_by, insert_date";
			for($j=1;$j<=$tot_row;$j++)
			{ 
				$buyerId="buyerId".$j;
				$jobNo="jobNo".$j;
				...
				if($data_array_dtls!="") $data_array_dtls.=",";
				$data_array_dtls.="(".$dtls_id.",".$id.",".$$buyerId.",'".$$poId."','".$$jobNo."','".$$itemId."','".$$bodyPartId."','".$$deterId."','".$$gsm."','".$$actualWeight."','".$$dia."','".$$colorId."','".$$fabColorId."','".$$sizeId."','".$$styleRef."','".$$cons."','".$$shade."','".$$reqsnQty."','".$$bookingNo."','".$$jobId."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
				$dtls_id = $dtls_id+1;
			}
		}
	...
	else if ($operation==1)   // Update Here
	{
		...
		if($hdn_variable_setting_status==1)
		{
			$field_array_dtls="id, mst_id, buyer_id, po_id, job_no, item_id, body_part, determination_id,style_ref_no,cons,shade, gsm,actual_weight, dia, color_id,fab_color_id, size_id,fabric_ref,weight_type,cutable_width,rd_no, reqn_qty,booking_no,job_id, inserted_by, insert_date";
			...
			{ 
				...
				//{
					...
					{
						if($data_array_dtls!="") $data_array_dtls.=",";
						$data_array_dtls.="(".$dtls_id.",".$update_id.",".$$buyerId.",'".$hdnPoAndQtyArr[0]."','".$$jobNo."','".$$itemId."','".$$bodyPartId."','".$$deterId."','".$$styleRef."','".$$cons."','".$$shade."','".$$gsm."','".$$actualWeight."','".$$dia."','".$$colorId."','".$$fabColorId."','".$$sizeId."','".$$fabricRef."','".$$weightType."','".$$cutableWidth."','".$$rdNo."','".$$reqsnQty."','".$$bookingNo."','".$$jobId."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
						$dtls_id = $dtls_id+1;	
					}
				//}
			}
		...
		{
			$field_array_dtls="id, mst_id, buyer_id, po_id, job_no, item_id, body_part, determination_id,style_ref_no,cons,shade, gsm,actual_weight, dia, color_id,fab_color_id, size_id,reqn_qty,booking_no,job_id, inserted_by, insert_date";
			for($j=1;$j<=$tot_row;$j++)
			{ 	
				$buyerId="buyerId".$j;
				$jobNo="jobNo".$j;
				...
				{
					if($data_array_dtls!="") $data_array_dtls.=",";
					$data_array_dtls.="(".$dtls_id.",".$update_id.",".$$buyerId.",'".$$poId."','".$$jobNo."','".$$itemId."','".$$bodyPartId."','".$$deterId."','".$$styleRef."','".$$cons."','".$$shade."','".$$gsm."','".$$shade."','".$$actualWeight."','".$$dia."','".$$colorId."','".$$fabColorId."','".$$sizeId."','".$$reqsnQty."','".$$bookingNo."','".$$jobId."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
					$dtls_id = $dtls_id+1;	
				}
			}
		}
...
{	
	...
	foreach ($result as $row)
	{
		...
		$all_job_id_arr[$row[csf('job_id')]]=$row[csf('job_id')];
		$bookingNos.="'".$row[csf('booking_no')]."',";
		$jobNos.="'".$row[csf('job_no')]."',";
	}
	$all_job_id=implode(",", $all_job_id_arr);
	$all_po_id=implode(",", $all_po_arr);
	$bookingNos=chop(implode(",",array_unique(explode(",",$bookingNos))),",");
	$jobNos=chop(implode(",",array_unique(explode(",",$jobNos))),",");

	/*$wvn_recv_sql= "select x.buyer_id,a.mst_id,a.fabric_description_id,a.original_gsm,a.original_width,b.body_part_id, b.fabric_ref,b.rd_no,b.cutable_width,b.weight_type,c.po_breakdown_id,c.color_id,c.quantity from inv_receive_master x, pro_finish_fabric_rcv_dtls a,inv_transaction b,order_wise_pro_details c where x.id=b.mst_id and a.trans_id=b.id and c.trans_id=b.id and c.entry_form=564 and b.item_category=3 and b.transaction_type=1 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and c.po_breakdown_id in($all_po_id)"; */

	$wvn_recv_sql="select x.buyer_id,a.mst_id,a.fabric_description_id,a.original_gsm,a.original_width,b.body_part_id, b.fabric_ref,b.rd_no,b.cutable_width,b.weight_type,a.color_id,c.qnty as quantity,c.booking_no from inv_receive_master x, pro_finish_fabric_rcv_dtls a,inv_transaction b,PRO_ROLL_DETAILS c where x.id=b.mst_id and a.trans_id=b.id and b.mst_id=c.mst_id and a.id=c.dtls_id and c.entry_form=564 and x.entry_form=564 and b.item_category=3 and b.transaction_type=1 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and c.job_id in($all_job_id)";
	...
	foreach ($wvn_recv_sql_rslt as $rows)
	{
		if($data[1]==1)
		{
			...
			$wvn_recv_qnty_array[$rows[csf('booking_no')]][$rows[csf('buyer_id')]][$rows[csf('fabric_description_id')]][$rows[csf('body_part_id')]][$rows[csf('original_gsm')]][$rows[csf('original_width')]][$rows[csf('fabric_ref')]][$rows[csf('rd_no')]][$rows[csf('cutable_width')]][$rows[csf('weight_type')]][$rows[csf('color_id')]]['wvn_recv_qty']+=$rows[csf('quantity')];
			$wvn_recv_qnty_array[$rows[csf('booking_no')]][$rows[csf('buyer_id')]][$rows[csf('fabric_description_id')]][$rows[csf('body_part_id')]][$rows[csf('original_gsm')]][$rows[csf('original_width')]][$rows[csf('fabric_ref')]][$rows[csf('rd_no')]][$rows[csf('cutable_width')]][$rows[csf('weight_type')]][$rows[csf('color_id')]]['shrinkage_cutable_width']=$rows[csf('cutable_width')];
		}
	...
	if($data[1]==1)
	{
		if($data[2]==2)
		{
			$sqlPrev="SELECT  buyer_id, LISTAGG(po_id,',') WITHIN GROUP (ORDER BY po_id) as po_id, job_no, item_id, body_part, determination_id, gsm, dia, color_id,fabric_ref,rd_no,cutable_width,weight_type, sum(reqn_qty) as reqn_qty,cons,shade,booking_no from pro_fab_reqn_for_cutting_dtls where status_active=1 and is_deleted=0 and booking_no in($bookingNos) and job_id in($all_job_id) and mst_id not in($data[0]) group by buyer_id,job_no, item_id, body_part, determination_id, gsm, dia, color_id,fabric_ref,rd_no,cutable_width,weight_type,cons,shade";
			//echo $sqlPrev; //die();
			$resultPrev=sql_select($sqlPrev);
			//$prevRcvQntyArr = array();
			foreach ($resultPrev as $val) 
			{
				$prevRcvQntyArr[$val[csf('buyer_id')]][$val[csf('job_no')]][$val[csf('booking_no')]][$val[csf('item_id')]][$val[csf('body_part')]][$val[csf('determination_id')]][$val[csf('gsm')]][$val[csf('dia')]][$val[csf('color_id')]][$val[csf('fabric_ref')]][$val[csf('rd_no')]][$val[csf('cutable_width')]][$val[csf('weight_type')]][$val[csf('cons')]][$val[csf('shade')]]+=$val[csf('reqn_qty')];
			}
        }
	...
	foreach($result as $row)
	{
		...
		if($data[1]==1)
		{
			...
			if($data[2]==2)
			{
				...
				//echo $row[csf('buyer_id')]."=".$row[csf('job_no')]."=".$row[csf('item_id')]."=".$row[csf('body_part')]."=".$row[csf('determination_id')]."=".$row[csf('gsm')]."=".$row[csf('dia')]."=".$row[csf('color_id')]."=".$row['CONS']."<br/>";
                ...
                $prevRcvQnty = $prevRcvQntyArr[$row[csf('buyer_id')]][$row[csf('job_no')]][$row[csf('booking_no')]][$row[csf('item_id')]][$row[csf('body_part')]][$row[csf('determination_id')]][$row[csf('gsm')]][$row[csf('dia')]][$row[csf('color_id')]][$row[csf('fabric_ref')]][$row[csf('rd_no')]][$row[csf('cutable_width')]][$row[csf('weight_type')]][$row[csf('cons')]][$row[csf('shade')]];
            }
			...
			$cutable_width=$row[csf('cutable_width')];
			if($cutable_width==""){$cutable_width=0;}else{$cutable_width=$cutable_width;}
			$wvn_rcv_qnty= $wvn_recv_qnty_array[$row[csf('booking_no')]][$row[csf('buyer_id')]][$row[csf('determination_id')]][$row[csf('body_part')]][$row[csf('gsm')]][$row[csf('dia')]][$row[csf('fabric_ref')]][$row[csf('rd_no')]][$cutable_width][$row[csf('weight_type')]][$row[csf('color_id')]]['wvn_recv_qty'];
		...
		<tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>"> 
            ...
            <td width="50" style="word-break:break-all;"><p><? echo $year; ?></p></td>
            <td width="60" style="word-break:break-all;"><p><? echo $job_prefix; ?></p></td>
            <td width="100" style="word-break:break-all;"><p><? echo $row[csf('booking_no')]; ?></p></td>
 			<?
	            if($data[1]==1)
				{
					?>
	  				 <td width="100" style="word-break:break-all;" title="PO No: <? echo $poNO; ?>"><p><? echo $style_ref_no; ?></p></td>
					<?
				}
	            if($data[1]!=1)
				{
			...
			?>
            <td width="60" style="word-break:break-all;" id="actualWeight<? echo $i; ?>"><? echo $row[csf('actual_weight')]; ?></td>
			...
			{
				?>
  				<td width="60" style="word-break:break-all;"><? echo $sizeArr[$row[csf('size_id')]]; ?></td>
				<?
			}
            ?>
            <td width="80" style="word-break:break-all;" align="center" title="id=<? echo $uomData;?>"><? echo $unit_of_measurement[$uomData]; ?></td>
            <td width="80" style="word-break:break-all;" align="center"><? echo $fabric_shade[$row[csf('shade')]]; ?></td>
            <td width="80" style="word-break:break-all;" align="right"><? echo $avg_cons; ?></td>
            <td width="80" style="word-break:break-all;" align="right"><? echo number_format($budget_qty,2,'.',''); ?></td>
            <td width="80" style="word-break:break-all;" align="right"><? echo number_format($wvn_rcv_qnty,2,'.',''); ?></td>
            ...
            <td width="80" style="word-break:break-all;" align="right"><? echo number_format($prevRcvQnty,2,'.',''); ?></td>
            <td align="center" width="100">
            	<input type="text" class="text_boxes_numeric" style="width:80px" id="reqsnQty<? echo $i; ?>" name="reqsnQty[]" value="<? echo number_format($row[csf('reqn_qty')],2,'.',''); ?>" onBlur="fn_check_qnty(this.id,this.value,'<? echo number_format($wvn_rcv_qnty,2,'.',''); ?>',<? echo $i; ?>)"/>
                ...
                <input type="hidden" value="<? echo number_format($wvn_rcv_qnty,2,'.',''); ?>" id="hdnWvnRecvQty<? echo $i; ?>" name="hdnWvnRecvQty[]"/>
                ...
                <input type="hidden" value="<? echo $row[csf('booking_no')]; ?>" id="bookingNo<? echo $i; ?>" name="bookingNo[]"/>
                <input type="hidden" value="<? echo $row[csf('job_id')]; ?>" id="jobId<? echo $i; ?>" name="jobId[]"/>
                <input type="hidden" value="<? echo $row[csf('gsm')]; ?>" id="gsm<? echo $i; ?>" name="gsm[]"/>
            </td> 
        </tr>
		<?		
		$i++;
...
//PRINT BUTTON 5
if($action=="woven_finish_fabric_roll_requisition_for_cutting_5")
{
    extract($_REQUEST);
	$data=explode('*',$data);
	// var_dump($data);
	...
	$sql="SELECT id, company_id, reqn_date, reqn_number , working_company, production_floor, location_id from pro_fab_reqn_for_cutting_mst where reqn_number='$data[1]' and is_deleted=0 and status_active=1";
	$dataArray=sql_select($sql);
	// echo $sql;die;
	$dataArray=sql_select($sql);
	$dtls_sql = "SELECT a.id,a.reqn_number,a.company_id,a.reqn_date,b.job_no, b.buyer_id, b.body_part, b.determination_id, b.color_id, b.reqn_qty, b.fabric_ref, b.rd_no, b.style_ref_no, b.shade
	from pro_fab_reqn_for_cutting_mst a,pro_fab_reqn_for_cutting_dtls b where a.reqn_number='$data[1]' and b.mst_id=a.id and a.is_deleted=0 and a.status_active=1 "; 
	// echo $dtls_sql;die;
	...
	{
			$fabric_desc=$lib_body_part_arr[$row[csf('body_part')]].', '.$composition_arr[$row[csf('determination_id')]];
			$data_array[$buyer_library[$row[csf("buyer_id")]]][$row[csf("style_ref_no")]][$lib_body_part_arr[$row[csf("body_part")]]][$fabric_desc][$row[csf("fabric_ref")]][$row[csf("rd_no")]][$color_arr[$row[csf("color_id")]]][$fabric_shade[$row[csf("shade")]]]['reqn_qty'] += $row[csf("reqn_qty")];
	}
	...
	<div style="width:1030px; float: left;">
	    <table width="1030" cellspacing="0" >
	        ...
	        <tr>
	            <td colspan="6" align="center" style="font-size:x-large"><strong><u>Woven Finish Fabric Roll Requisition for Cutting</u></strong></td>
	        </tr>
	    </table>
	        <br>
	        <table cellspacing="0" width="1020"  border="1" rules="all" class=""  style="margin-bottom: 10px;">
	        <tr>
	        	<td width="280"><strong>Requisition No:</strong>&nbsp; <? echo $dataArray[0][csf('reqn_number')]; ?></td>
	            <td width="230"><strong>Requisition Date:</strong>&nbsp; <? echo change_date_format($dataArray[0][csf('reqn_date')]); ?></td>
				<td width="280"><strong>Wo. Com.:</strong>&nbsp; <? echo $company_library[$dataArray[0][csf('working_company')]]; ?></td>
	            <td width="230"><strong>WC. Loc.:</strong>&nbsp;  <? echo $location_arr[$dataArray[0][csf('location_id')]]; ?> </td>
	        </tr>
	        <tr>
	            <td><strong>Floor/Cutting Unit:</strong>&nbsp; <? echo $data[3]; ?></td>
	...
	<table cellspacing="0" width="1020"  border="1" rules="all" class="rpt_table" style="margin-bottom: 10px;" >
		...
		<tbody>
			...
			foreach($data_array as $buyer => $row1)
			{
				foreach($row1 as $style => $row2)
				{
					foreach($row2 as $body => $row3)
					{
						foreach($row3 as $fabric_desc => $row4)
						{
							foreach($row4 as $fabric_ref => $row5)
							{
								foreach($row5 as $rd => $row6)
								{
									foreach($row6 as $color => $row7)
									{
										foreach($row7 as $shade => $row)
										{
												...
												if($k ==""){$k = $style;}
													if($k != $style)
													{
														?>
															<tr bgcolor="#E8E8E8">
																<td align="right" colspan="9"><? echo "<strong>Style Total:</strong>"; ?></td>
												...
												<tr bgcolor="<? echo $bgcolor; ?>">
													...
													<td align="center"><? echo $row['reqn_qty']; $recv_sum += $row['reqn_qty']; ?></td>
