...
if ($action == "populate_data_from_barcode") 
{
	...
	$sql_data="SELECT a.id,a.entry_form, a.company_id, a.recv_number, a.receive_basis, a.receive_date, a.booking_no, a.knitting_source, a.knitting_company, a.knitting_location_id, b.id as dtls_id,b.prod_id,b.color_id ,b.batch_id, b.fabric_description_id,b.body_part_id,b.dia_width_type, b.gsm,b.production_qty, b.width, c.barcode_no, c.roll_id as roll_id, c.roll_no, c.po_breakdown_id, c.qnty,c.reject_qnty,c.qc_pass_qnty, c.dtls_id as dtlsid,c.reprocess,c.roll_id as previous_roll_id,c.is_sales,c.booking_without_order,c.booking_no, c.qc_pass_qnty_pcs, c.coller_cuff_size 
	from inv_receive_master a, pro_finish_fabric_rcv_dtls b,pro_roll_details c 
	where a.id=b.mst_id and b.id=c.dtls_id and a.entry_form=$entry and c.entry_form=$entry and c.status_active=1 and c.is_deleted=0 and c.barcode_no in (" . $nbarcode . ") $issued_barcode_cond";
	...
	if(count($issue_barcode_arr)>0)
	{
		...
		SELECT a.id, a.entry_form, a.company_id , a.recv_number, a.receive_basis,a.receive_date, a.booking_no, a.knitting_source, a.knitting_company, a.knitting_location_id, b.id as dtls_id, b.prod_id,b.color_id,b.batch_id,b.fabric_description_id, b.body_part_id,b.dia_width_type,  b.gsm,c.qnty  as production_qty,b.width, c.barcode_no, c.id as roll_id, c.roll_no, c.po_breakdown_id,c.qnty,c.reject_qnty,c.qc_pass_qnty, c.dtls_id as dtlsid,max(c.reprocess) reprocess,c.roll_id as previous_roll_id,c.is_sales,c.booking_without_order,c.booking_no, c.qc_pass_qnty_pcs, c.coller_cuff_size 
		FROM inv_receive_master a, pro_finish_fabric_rcv_dtls b, pro_roll_details c 
		WHERE a.id=b.mst_id and b.id=c.dtls_id and b.trans_id<>0 and a.entry_form in(37,7,68) and c.entry_form in(37,7,68) and c.status_active=1 and c.is_deleted=0 and c.barcode_no in(".$issuebarcode.") 
		group by a.id, a.entry_form, a.company_id , a.recv_number, a.receive_basis,a.receive_date, a.booking_no, a.knitting_source, a.knitting_company, a.knitting_location_id, b.id, b.prod_id,b.color_id,b.batch_id,b.fabric_description_id, b.body_part_id,b.dia_width_type,  b.gsm,c.qnty,b.width, c.barcode_no, c.id,c.roll_id, c.roll_no, c.po_breakdown_id,c.qnty,c.reject_qnty, c.qc_pass_qnty,c.dtls_id,c.is_sales, c.booking_without_order,c.booking_no, c.qc_pass_qnty_pcs, c.coller_cuff_size";
	}
	// echo $sql_data;die;
	$data_array = sql_select($sql_data);
	//echo "alert(".count($data_array).");\n";die;
...
if ($action == "populate_data_update_barcode") 
{
	...
	if(count($issue_barcode_arr)>0)
	{
		...
		$sql_data.="SELECT a.id, a.entry_form, a.company_id , a.recv_number, a.receive_basis,a.receive_date, a.booking_no, a.knitting_source, a.knitting_company, a.knitting_location_id, b.id as dtls_id, b.prod_id,b.color_id,b.batch_id,b.fabric_description_id, b.body_part_id,b.dia_width_type,  b.gsm,c.qnty  as production_qty,b.width, c.barcode_no, c.id as roll_id, c.roll_no, c.po_breakdown_id, c.is_sales, c.qnty,c.reject_qnty,c.qc_pass_qnty, c.dtls_id as dtlsid,max(c.reprocess) reprocess,c.roll_id as previous_roll_id,c.is_sales,c.booking_without_order,c.booking_no, c.qc_pass_qnty_pcs, c.coller_cuff_size FROM inv_receive_master a, pro_finish_fabric_rcv_dtls b, pro_roll_details c WHERE a.id=b.mst_id and b.id=c.dtls_id and b.trans_id<>0 and a.entry_form in(37,7,68) and c.entry_form in(37,7,68) and c.status_active=1 and c.is_deleted=0 and c.barcode_no in(".$issuebarcode.")
		group by a.id, a.entry_form, a.company_id , a.recv_number, a.receive_basis,a.receive_date, a.booking_no, a.knitting_source, a.knitting_company,a.knitting_location_id, b.id, b.prod_id,b.color_id,b.batch_id,b.fabric_description_id, b.body_part_id,b.dia_width_type,  b.gsm,c.qnty,b.width, c.barcode_no, c.id,c.roll_id,c.roll_no, c.po_breakdown_id,c.is_sales,c.qnty,c.reject_qnty,c.qc_pass_qnty, c.dtls_id,c.booking_without_order,c.booking_no, c.qc_pass_qnty_pcs, c.coller_cuff_size";
	}
	//echo $sql_data;die;
	$data_array = sql_select($sql_data);
	$poIDs="";
		...
		foreach ($data_array as $row)
		{
			...
			if($self_scnned[$row[csf("barcode_no")]]['reprocess']==$barcode_process)
			{
				...
				<tr id="tr_<? echo $i; ?>" align="center" valign="middle">
                    ...
                    <td width="60" align="right" id="greyQntyPcs_<? echo $i; ?>" style="word-break:break-all;"><? echo $row[csf("qc_pass_qnty_pcs")];?></td>
                    <td width="60" id="collerCuffSize_<? echo $i; ?>" style="word-break:break-all;"><? echo $row[csf("coller_cuff_size")];?></td>
                    ...
                    <td width="40" id="button_<? echo $i; ?>" align="center">
                        ...
                        <input type="hidden" value="<? echo $row[csf("qc_pass_qnty_pcs")];?>" name="hddGreyQntyPcs[]" id="hddGreyQntyPcs_<? echo $i; ?>"/>
                        <input type="hidden" value="<? echo $row[csf("coller_cuff_size")];?>" name="hddCollerCuffSize[]" id="hddCollerCuffSize_<? echo $i; ?>"/>
                    </td>
                </tr>
...
if ($action == "save_update_delete") {
	...
	if ($operation == 0)  // Insert Here
	{
		...
		$field_array_roll = "id, barcode_no, mst_id, dtls_id, po_breakdown_id, entry_form, qnty, reject_qnty, qc_pass_qnty, roll_no, roll_id,prev_reprocess,reprocess, inserted_by, insert_date, is_sales, booking_without_order, booking_no, qc_pass_qnty_pcs, coller_cuff_size";
		...
		for ($j = 1; $j <= $tot_row; $j++) {
			...
			$data_array_roll .= "(" . $id_roll . ",'" . $$barcodeNo . "'," . $id . "," . $dtls_id . ",'" . $$orderId . "',67,'" . $$currentDelivery . "','" . $$rejectQnty . "','" . $$currentDelivery . "','" . $$rollNo . "','" . $$rollId . "','" . $$preReprocess . "','" . $$reProcess . "'," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "','" . $$IsSalesId . "','".$$bookingWithoutOrder. "','".$$bookingNumber."','".$$greyQntyPcs."','".$$collerCuffSize."')";
	...
	else if ($operation == 1)   // Update Here
	{
		...
		for ($j = 1; $j <= $tot_row; $j++) {
			...
			else
			{
				...
				$id_roll = return_next_id_by_sequence("PRO_ROLL_DTLS_PK_SEQ", "pro_roll_details", $con);
				if ($data_array_roll != "") $data_array_roll .= ",";
				$data_array_roll .= "(" . $id_roll . ",'" . $$barcodeNo . "'," . $update_id . "," . $dtls_id_for_roll . ",'" . $$orderId . "',67,'" . $$currentDelivery . "','" . $$rejectQnty . "','" . $$currentDelivery . "','" . $$rollNo . "','" . $$rollId . "','" . $$preReprocess . "','" . $$reProcess . "'," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "','" . $$IsSalesId . "','".$$bookingWithoutOrder. "','".$$bookingNumber."','".$$greyQntyPcs."','".$$collerCuffSize."')";
			}
		}
		$rID2 = true;
		$rID3 = true;
