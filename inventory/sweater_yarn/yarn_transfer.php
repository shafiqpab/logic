...
function fnc_yarn_transfer_entry(operation)
{
	...
	else if(operation==0 || operation==1 || operation==2)
	{
		...
		var dataString = "txt_system_id*cbo_transfer_criteria*cbo_company_id*cbo_company_id_to*txt_transfer_date*txt_challan_no*cbo_item_category*cbo_store_name*cbo_floor*cbo_room*txt_rack*txt_shelf*cbo_store_name_to*cbo_floor_to*cbo_room_to*txt_rack_to*txt_shelf_to*txt_yarn_lot*txt_transfer_qnty*txt_yarn_brand*txt_rate*txt_transfer_value*cbo_uom*txt_no_of_bag*txt_no_of_cone*txt_weight_per_bag*update_id*hide_brand_id*hidden_product_id*update_dtls_id*update_trans_issue_id*update_trans_recv_id*previous_from_prod_id*previous_to_prod_id*hidden_transfer_qnty*txt_item_desc*origin_product_id*txt_btb_lc_id*txt_remarks";
...
{	
	...
	{	  
		...
		if(reponse[0]==0 || reponse[0]==1)
		{
			...
			reset_form('transferEntry_1','','','','','update_id*txt_system_id*cbo_transfer_criteria*cbo_company_id*cbo_company_id_to*txt_transfer_date*txt_challan_no*txt_remarks*cbo_store_name*cbo_store_name_to');
