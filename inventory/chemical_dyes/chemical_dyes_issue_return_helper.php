...
function open_item()
{
	...
	//var page_link='requires/general_item_issue_return_controller.php?action=return_number_popup&company='+company; 
 	var page_link='requires/chemical_dyes_issue_return_controller.php?action=itemdesc_popup&company='+company; 
	...
	emailwindow.onclose=function()
	{
		...
		get_php_form_data(mrrNumber, "populate_data_from_data", "requires/chemical_dyes_issue_return_controller");
		show_list_view(mrrNumber,'populate_independent_data','item_description_list','requires/chemical_dyes_issue_return_controller','');  		
 	}
}
...
function open_returnpopup()
{
	...
	var company = $("#cbo_company_name").val();	
	var page_link='requires/chemical_dyes_issue_return_controller.php?action=return_number_popup&company='+company; 
	...
	{ 
        ...
        get_php_form_data(returnNumber, "populate_master_from_data", "requires/chemical_dyes_issue_return_controller"); 
		if(parseInt(data[3])==5)
		    {
				$("#item_description_list").show('fast');
	         show_list_view(company+"**"+data[0]+"**"+data[1]+"**"+data[2]+"**"+data[3],'populate_batch_no_data_update','item_description_list','requires/chemical_dyes_issue_return_controller','');
			 disable_enable_fields( 'cbo_company_name*cbo_issue_basis*txt_item_description*txt_batch_name', 1, '', '' );
		    }
	     else
			{
			 disable_enable_fields( 'cbo_company_name*cbo_issue_basis*txt_batch_name', 1, '', '' );
			// $('#item_description_list').html();
			  $("#item_description_list").hide('fast');
			}
		show_list_view(returnNumber,'show_dtls_list_view','list_container_dyes','requires/chemical_dyes_issue_return_controller','');
	...
	if(operation==4)
	 {
		...
		print_report( $('#cbo_company_name').val()+'*'+$('#txt_return_no').val()+'*'+report_title,"general_item_issue_return_print", "requires/chemical_dyes_issue_return_controller")
		 return;
	 }
	else if(operation==0 || operation==1 || operation==2)
	{
		if( form_validation('cbo_company_name*cbo_location*cbo_issue_basis*txt_return_date*txt_item_description*txt_return_qnty','Company *Location*Issue Basis*Return Date*Item Description*Return Quantity')==false )
		{
			return;
		}	
		...
		var dataString = "txt_return_no*cbo_company_name*cbo_location*txt_return_date*txt_return_challan_no*txt_item_description*txt_return_date*cbo_issue_basis*cbo_item_group*txt_return_qnty*total_issue*txt_batch_name*txt_remarks*txt_reject_qnty*cbo_uom*cbo_store_name*cbo_item_category*update_id*txt_prod_id*before_prod_id*txt_batch_id*hidden_issue_id";
		var data="action=save_update_delete&operation="+operation+get_submitted_data_string(dataString,"../../");
		//alert(data);return;
		//freeze_window(operation);
		http.open("POST","requires/chemical_dyes_issue_return_controller.php",true);
...
{	
	...
	// alert(http.responseText); 		
		...
		if(reponse[0]==0 || reponse[0]==1)
		{
			...
			if(issue_basis==4)
			    {
 			      disable_enable_fields( 'cbo_company_name*cbo_issue_basis*txt_batch_name', 1, "", "" ); // disable true
		        }
		   else
		      {
				disable_enable_fields( 'cbo_company_name*cbo_issue_basis*txt_item_description', 1, "", "" ); // disable true  
			  }
		}
		if(reponse[0]==50)
		{
		...
		show_list_view(reponse[1],'show_dtls_list_view','list_container_dyes','requires/chemical_dyes_issue_return_controller','');		
		set_button_status(0, permission, 'fnc_chemical_issue_return_entry',1,1);
		reset_form('','','txt_item_description*cbo_item_group*cbo_uom*txt_return_qnty*txt_reject_qnty*cbo_item_category*txt_remarks','','','');
		//release_freezing();
	}
}
...
function check_data(id)
{
	...
	{
		$('#txt_reject_qnty').val(0);
		alert("Reject quantity over the issue quantity not allowed");
	}
...
function openmypage_batchNo()
	{
		...
		{ 	
			...
			var page_link = 'requires/chemical_dyes_issue_return_controller.php?cbo_company_id='+cbo_company_id+'&cbo_issue_basis='+cbo_issue_basis+'&action=batch_popup';
			...
			emailwindow.onclose=function()
			 {
		        ...
		        show_list_view(cbo_issue_basis+"**"+cbo_company_id+"**"+batch_id+"**"+mst_id,'populate_batch_no_data','item_description_list','requires/chemical_dyes_issue_return_controller','');
				freeze_window(5);
...
<div style="width:100%;" align="center">
    ...
    <table width="1300" cellpadding="0" cellspacing="2" align="left">
     	<tr>
                ...
                <fieldset style="width:800px;">                                       
                    <table  width="100%" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                      ...
                      <tr>
                            ...
                            <td width="145">
                                <? 
                                    echo create_drop_down( "cbo_company_name", 140, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/chemical_dyes_issue_return_controller', this.value, 'load_drop_down_location', 'location_td' );load_drop_down( 'requires/chemical_dyes_issue_return_controller', this.value, 'load_drop_down_store', 'store_td' );" );
                                ?>
                            </td>
                      ...
                      <tr>
                        ...
                        <td align="right" >Batch/Requisition</td>
                                ...
                                <legend>Return Item Info</legend>                                     
                                  <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                    <tr>
                                     ...
                                     <tr>
                                        <td  align="right" width="100">Lot</td>
                                        <td >
                                             <input class="text_boxes_numeric" type="text" name="txt_lot"  id="txt_lot" style="width:70px;"   /> 
                                        </td>
                                    ...
                                    <tr>
                                        <td  align="right"><span class="must_entry_caption">Returned Qnty</span></td>
                                        <td>
                                        	<input class="text_boxes"  onKeyUp="check_data('#txt_return_qnty')" type="text" name="txt_return_qnty" id="txt_return_qnty" style="width:70px;" />
                                        </td>
                                         <td align="right" class="must_entry_caption"> Store</td>
                                         <td width="160" id="store_td">
                                                <?
                                                 echo create_drop_down( "cbo_store_name", 140, $blank_array,"", 1, "-- Select Store --", $storeName, "" ); 
                                                ?>
                                         </td>
                                      </tr>
                                      <tr>
                                ...
                                <legend>Display</legend>                                     
                                  <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                    <tr>
                                       ...
                                       <td width="100" >
                                            <input class="text_boxes" type="text" name="txt_issue_qty" id="txt_issue_qty" style="width:100px;" placeholder="Display"  readonly  />
                                        </td>
                                    </tr>
                                     ...
                                     <tr>
                                       ...
                                       <td  >
                                            <input class="text_boxes" type="text" name="txt_rate" id="txt_rate" style="width:100px;" placeholder="Display"  readonly  />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<input class="text_boxes"   type="text" name="txt_return_qnty" id="txt_return_qnty" style="width:120px;" placeholder="Display"  readonly/>
                                        </td>
                                         <td align="right" > Amount</td>
                                        <td width="" id="store_td">
                                            <input class="text_boxes"   type="text" name="txt_amount_qnty" id="txt_amount_qnty" style="width:100px;" placeholder="Display"  readonly/>
                                        </td>
                                      </tr>
                                      <tr>
           ...
           <div id="item_description_list" style="margin-left:20px"></div>
