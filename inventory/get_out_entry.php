...
function fnc_getout_entry_reponse()
{
	if(http.readyState == 4) 
	{
		...
		{
			document.getElementById('txt_gate_pass').value='';
			document.getElementById('list_container_gate_out_dtls').innerHTML='<p class="bang" style="background:#CCC; padding:0 5px;font-size:20px"><span style="color:#FF0000;"></span> দুঃখিত, '+response[1]+' ঘণ্টার পর Gate out করতে হলে আপনাকে অনুমতি নিতে হবে। </p><p class="eng" style=" background:#CCC; padding:0 5px;font-size:20px"><span style="color:#FF0000;"></span>After '+response[1]+' hours Gate Out Not Allowed, Please contract autority.</p>';
			$('#txt_gate_pass').focus(); 
		}
