<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Returnable Item Receive Report
...
<script>
	...
	function openmypage_gate()
	{
		...
		var page_link='requires/returnable_item_receive_report_controller.php?action=gatePass_search&company='+company+'&category='+category;
	...
	function  generate_report(type)
	{
		...
		freeze_window(3);
		http.open("POST","requires/returnable_item_receive_report_controller.php",true);
	...
	{
		page_link='requires/returnable_item_receive_report_controller.php?action=return_qnty_data&cbo_company='+cbo_company+'&gate_pass_id='+gate_pass_id+'&gate_in_id='+gate_in_id+'&item_description='+item_description;
        ...
        <fieldset style="width:970px;">
             <table class="rpt_table" width="970" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
                ...
                <tr class="general">
                    ...
                    <td>
                        <?
                        echo create_drop_down( "cbo_company_name", 150, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "getLocationName(); load_drop_down( 'requires/returnable_item_receive_report_controller',this.value, 'load_drop_down_com_department', 'com_department_td' );" );
                        ?>                          
                    </td>
					<td id="location_td" >
