...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
    ...
    var tableFilters2 = 
	{
		//col_16: "none",
		col_operation: {
		id: ["value_total_opening_td","value_total_opening_value_td","value_total_receive_td","value_total_issue_return_td","value_total_receive_balance_td","value_total_receive_value_td","value_total_issue_td","value_total_receive_return_td","value_total_issue_balance_td","value_total_issue_value_td","value_total_closing_stock_td","value_total_closing_amnt"],
		col: [6,7,8,10,11,12,13,15,16,17,18,20],
	...
	function openmypage_item_description()
	{
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/trims_closing_stock_controller.php?action=item_description_popup&data='+data,'Item Description Popup', 'width=470px,height=400px,center=1,resize=0','../../')
                ...
                <fieldset style="width:1110px;">
                    <table class="rpt_table" width="1110" cellpadding="0" cellspacing="0" border="1" rules="all">
                        ...
                        <tr class="general">
                            <td>
								<? 
                                	echo create_drop_down( "cbo_company_name", 120, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/trims_closing_stock_controller',this.value, 'load_drop_down_store', 'store_td' );" );
                                ?>                            
                            </td>
                            <td> 
								<?
                        ...
                        <tr>
                            <td colspan="12" align="center">
                                ...
                                <input type="button" name="search3" id="search3" value="Total Value G.A" onClick="fnc_generate_report(4)" style="width:70px" class="formbutton" />
