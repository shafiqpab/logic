...
{ 
	...
	if($cbo_search_by==1)  
	{
		...
		$sql="Select e.buyer_name, e.style_ref_no ,e.season_buyer_wise, b.prod_id, b.store_id, a.item_category_id, a.item_group_id, a.avg_rate_per_unit, a.item_color, a.item_size, b.cons_uom as unit_of_measure, 
		...
		group by e.buyer_name,e.style_ref_no,e.season_buyer_wise, b.store_id, b.prod_id, a.item_category_id, a.item_group_id, a.avg_rate_per_unit, a.item_color, a.item_size, b.cons_uom
	...
	elseif($cbo_search_by==2)  
	{
		...
		$sql="Select b.prod_id, b.store_id,e.style_ref_no,e.season_buyer_wise, a.item_category_id, a.item_group_id, a.avg_rate_per_unit,  a.item_color, a.item_size, b.cons_uom as unit_of_measure, 
		sum(case when b.transaction_date<'".$select_from_date."' and b.transaction_type in (1,4,5) and c.trans_type in (1,4,5)  then c.quantity else 0 end) as opening_total_receive,
		sum(case when b.transaction_date<'".$select_from_date."' and b.transaction_type in (1,4,5) and c.trans_type in (1,4,5)  then (c.quantity*c.order_rate) else 0 end) as opening_rcv_amt,
		sum(case when b.transaction_date<'".$select_from_date."' and b.transaction_type in (2,3,6) and c.trans_type in (2,3,6)  then c.quantity else 0 end) as opening_total_issue,
		sum(case when b.transaction_date<'".$select_from_date."' and b.transaction_type in (2,3,6) and c.trans_type in (2,3,6)  then (c.quantity*c.order_rate) else 0 end) as opening_issue_amt,
		...
		from product_details_master a, inv_transaction b, order_wise_pro_details c, wo_po_break_down d, wo_po_details_master e
		where a.id=b.prod_id and b.id=c.trans_id and c.po_breakdown_id=d.id and d.job_no_mst=e.job_no and b.transaction_type in (1,2,3,4,5,6) and c.trans_type in (1,2,3,4,5,6) and b.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and c.entry_form in(24,25,49,73,78,112) and b.transaction_date<='".$select_to_date."'  $str_cond $zero_cond
		group by  b.store_id, b.prod_id ,e.style_ref_no,e.season_buyer_wise, a.item_category_id, a.item_group_id, a.avg_rate_per_unit, a.item_color, a.item_size, b.cons_uom";
	} 
	...
	elseif($cbo_search_by==4)  
	{
		...
		$sql="Select b.store_id, b.prod_id, a.item_category_id, a.item_group_id, a.avg_rate_per_unit, b.cons_uom as unit_of_measure, a.item_color, a.item_size,
		...
		group by b.store_id, b.prod_id, a.item_category_id, a.item_group_id, a.avg_rate_per_unit, b.cons_uom, a.item_color, a.item_size
		
		union all
		
		Select b.store_id, b.prod_id, a.item_category_id, a.item_group_id, a.avg_rate_per_unit, b.cons_uom as unit_of_measure, a.item_color, a.item_size,
	...
	$company_data_arr=explode(",",$cbo_company_name);

	$companies="";
	foreach($company_data_arr as $row){
		$Company = $companyArr[$row];
		$companies .= $Company.", ";
	}
        ...
        <table style="width:<? echo $table_width; ?>px" border="0">
            ...
            <tr style="border:none;">
                <td colspan="20" align="center" style="border:none; font-size:14px;">
                   <b>Company Name : <? echo rtrim($companies,", ") ; ?></b>                               
                </td> 
            </tr>
            ...
            <tr style="border:none;">
                ...
                {
					?>
                    <table style="width:<? echo $table_width; ?>px" border="1" cellpadding="0" cellspacing="0" class="rpt_table" id="table_header_1" rules="all" align="center"> 
                        <thead> 				
                            <tr>
                                <th width="40">SL</th>
                                ...
                                <th width="60">UOM</th>
                                <th  style="word-break: break-all;" width="140">Opening Stock</th>
                                
                                <th width="80">Receive</th>
          
                                
                                <th width="80">Issue</th>
                                <th width="120">Closing Stock</th>
                                <th width="80">Avg Rate</th>
                                <th  width="150" style="word-break: break-all;" >Closing Amount</th>
                            </tr>  
                        </thead>
					</table>
					...
					foreach($result as $row)
					{
						...
						if($value_with ==1 && (number_format($openingStockQty,2,".","") >0 || number_format($totalReceive,2,".","") >0 || number_format($totalIssue,2,".","") >0 || number_format($closingStock,2,".","") >0) && $get_up_qnty_check==1 )
						{
							...
							$grandAvarageRate+= number_format($closingStockAmount/$closingStock,4);
							$grandClosingAmmount+=$closingStockAmount;
                            ...
                            <tr bgcolor="<? echo $bgcolor; ?>" <? echo $stylecolor; ?> onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">    
                                ...
                                <? } ?>
                                <td width="100" style="word-break: break-all;"><p><? echo  $season_arr[$row[csf("season_buyer_wise")]]; ?></p></td>
                                ...
                                <td width="140" align="right"  style="word-break: break-all;" title="<? echo $openingStockQty."ja"; ?>"><p><? echo number_format($openingStockQty,2); ?></p></td>                   
                                <td width="80" align="right"  style="word-break: break-all;" ><p><? echo number_format($row[csf("receive")]*$conversion_factor_arr[$row[csf('item_group_id')]],2); ?></p></td> 
                            
                                <td width="80" align="right"  style="word-break: break-all;"><p><? echo number_format($row[csf("issue")]*$conversion_factor_arr[$row[csf('item_group_id')]],2); ?></p></td>  
                                <td  width="120" align="right"  style="word-break: break-all;"><p><a href='##' onclick="openmypage_stock('<? echo $row[csf('prod_id')];?>','<? echo $row[csf('store_id')]; ?>','<? echo $select_from_date; ?>','<? echo $select_to_date; ?>','<? echo $row[csf("unit_of_measure")]; ?>','<? echo $row[csf("buyer_name")]; ?>','stock_popup_details')"><? echo number_format($closingStock,2); ?></a></p></td>    
                                <td width="80"  style="word-break: break-all;" align="right"><p><? echo number_format($closingStockAmount/$closingStock,2); ?></p></td>  

                                <td  align="right" width="150"  style="word-break: break-all;"><p><? echo number_format($closingStockAmount,2); ?></p></td>  
						...
						else if($value_with ==0)
						{
							...
							if($get_up_qnty_check==1)
							{
								...
								<tr bgcolor="<? echo $bgcolor; ?>" <? echo $stylecolor; ?> onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">    
									...
									<td width="140" align="right"  style="word-break: break-all;"><p><? echo number_format($openingStockQty,2); ?></p></td>                     
									<td width="80" align="right"  style="word-break: break-all;"><p><? echo number_format($row[csf("receive")]*$conversion_factor_arr[$row[csf('item_group_id')]],2); ?></p></td> 
								
                                    <td width="80" align="right"  style="word-break: break-all;"><p><? echo number_format($row[csf("issue")]*$conversion_factor_arr[$row[csf('item_group_id')]],2); ?></p></td>  
                                    <td width="120" align="right"><p><? echo number_format($closingStock,2); ?></p></td>                                   
                                    <td width="80" align="right"  style="word-break: break-all;"><p><? echo number_format($closingStockAmount/$closingStock,2); ?></p></td>                                   
                                    <td align="right" width="150"  style="word-break: break-all;"><p><? echo number_format($closingStockAmount,2); ?></p></td>                                   
								</tr>
								<? 												
								$i++;
					...
					<tr bgcolor="#CCCCCC" style="font-weight:bold">           	
                        ...
                        <td align="right"  style="word-break: break-all;"><? echo number_format($grandTotalOpeningStockQty,2); ?></td>
                        <td align="right"  style="word-break: break-all;"><? echo number_format($grandTotalReceive,2); ?></td>
                        <td align="right"  style="word-break: break-all;"><? echo number_format($grandTotalIssue,2); ?></td>
                        <td align="right"  style="word-break: break-all;"><? echo number_format($grandTotalClosingStock,2); ?></td>  
                        <td align="right"  style="word-break: break-all;"><? echo number_format($grandAvarageRate,4); ?></td>  
                        <td align="right"  style="word-break: break-all;"><? echo number_format($grandClosingAmmount,2); ?></td>  
					</tr>  
					</table>
					</div> 
					<? 
				...
				else if($cbo_search_by==4) 
                {
					...
					foreach($general_ac_data as $item_val)
					{
						foreach($item_val as $row)
						{
							...
							if($value_with ==1 && (number_format($openingStockQty,2,".","") >0 || number_format($totalReceive,2,".","") >0 || number_format($totalIssue,2,".","") >0 || number_format($closingStock,2,".","") >0) && $get_up_qnty_check==1 )
							{
								...
								$grandTotalClosingStock +=$closingStock;
								$grandTotalClosingStockAmount +=$closingStockAmount;
								$grandAvarageRate+=$closingStockAmount/$closingStock;
                                ...
                                <tr bgcolor="<? echo $bgcolor; ?>" <? echo $stylecolor; ?> onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">    
                                    ...
                                    <td width="80" align="right"><p><? echo number_format($closingStock,2); ?></p></td>                                  
                                    <td width="80" align="right"><p><? echo number_format($closingStockAmount/$closingStock,2); ?></p></td>                                  
                                    <td  align="right"><p><? echo number_format($closingStockAmount,2); ?></p></td>                                  
                                </tr>
                                <? 												
                                $i++;
							}
					...
					?>
					<tr bgcolor="#CCCCCC" style="font-weight:bold">           	
                        <td colspan="<? if($cbo_search_by==1) {echo $colspan = 7;}else {echo $colspan=4;} ?>" align="right"><strong>Grand Total</strong></td>
                        ...
                        <td align="right"><? echo number_format($grandAvarageRate,2); ?></td> 
                        <td align="right"><? echo number_format($grandTotalClosingStockAmount,2); ?></td> 
					</tr>  
					</table>
					</div> 
					<? 
...
if ($action[0]=="stock_popup_details") 
{
    ...
    <div style="width:670px;" style="float: center;">
        <div id="report_container" style="float: center;"></div>
    </div>
	<?
        ob_start();
    ?>
	<div style="width:1033px;" id="report_div">
		<fieldset style="width:1033px">
			<legend></legend>
			<table width="1015" border="1" cellpadding="2" cellspacing="0" class="rpt_table" rules="all">
				<thead>
					<th width="50">SL</th>
					<th width="120">Buyer</th>
			...
			<div style="width:1033px; overflow-y:scroll; max-height:300px" id="scroll_body">
				<table width="1015" border="1" cellpadding="2" cellspacing="0" class="rpt_table" rules="all" id="table_body">
					<?
					$i = 1;
					$tot_recv_qnty = '';
					...
					$sql = "select c.id as po_id, d.buyer_name, d.style_ref_no, d.job_no, d.season_matrix, d.season_buyer_wise, c.po_number,e.item_description,e.unit_of_measure,
					...
					from inv_transaction a, order_wise_pro_details b, wo_po_break_down c, wo_po_details_master d,product_details_master e
					where a.id=b.trans_id and b.po_breakdown_id=c.id and c.job_no_mst=d.job_no and  e.id=a.prod_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and a.prod_id=$prod_id and b.prod_id=$prod_id $store_cond $uom_cond $buyer_cond
					group by c.id , d.buyer_name, d.style_ref_no, d.job_no, d.season_matrix, d.season_buyer_wise,e.item_description,e.unit_of_measure, c.po_number";
					// echo $sql;die;
					$result = sql_select($sql);
					foreach ($result as $row) {
						if ($i % 2 == 0)
						...
						<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
							...
							<td width="80"><p><? echo $unit_of_measurement[$row[csf("unit_of_measure")]]; ?>&nbsp;</p></td>
