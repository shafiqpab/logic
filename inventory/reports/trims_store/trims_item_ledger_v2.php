...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function openmypage_item()
	{
		...
		var page_link='requires/trims_item_ledger_v2_controller.php?action=item_description_search&company='+company+'&txt_produc_no='+txt_produc_no+'&txt_produc_id='+txt_produc_id+'&txt_product='+txt_product; */
		var page_link='requires/trims_item_ledger_v2_controller.php?action=item_description_search&company='+company; 
	...
	function generate_report(operation)
	{
		...
		var dataString = "&cbo_company_name="+cbo_company_name+"&txt_product_id="+txt_product_id+"&cbo_method="+cbo_method+"&from_date="+from_date+"&to_date="+to_date+"&report_title="+report_title+"&cbo_store_name="+cbo_store_name;
		var data="action=generate_report"+dataString;
		freeze_window(operation);
		http.open("POST","requires/trims_item_ledger_v2_controller.php",true);
...
<div style="width:100%;" align="center">
    ...
    <div id="content_search_panel" style="width:100%;" align="center">
        <fieldset style="width:880px;">
			<table class="rpt_table" width="880" cellpadding="0" cellspacing="0">
                <thead>
                    <tr>
                ...
                <tr class="general" align="center">
                    <td>
                            <? 
                               echo create_drop_down( "cbo_company_name", 150, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/trims_item_ledger_v2_controller', this.value, 'load_drop_down_store', 'store_td' );" );
                            ?>                            
                    </td>
                    <td align="center">
