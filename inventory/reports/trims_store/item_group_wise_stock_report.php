<?
/*-------------------------------------------- Comments
Purpose     :   This form will create Item Group Wise Stock Report
              
Functionality : 
JS Functions  :
Created by    : Wayasel Ahmmed
Creation date   :   09-8-2023
Updated by    :     
Update date   :        
QC Performed BY :   
QC Date     : 
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Item Group Wise Stock Report","../../../", 1, 1, $unicode,1,''); 
...
function generate_report(operation)
{
  ...
  var txt_qnty = $("#txt_qnty").val();
    ...
    http.open("POST","requires/item_group_wise_stock_report_controller.php",true);
...
function openmypage_itemgroup()
{
    ...
    var page_link='requires/item_group_wise_stock_report_controller.php?action=item_group_such_popup&company='+company+'&cbo_item_category_id='+cbo_item_category_id+'&txt_item_group='+txt_item_group+'&txt_item_group_id='+txt_item_group_id+'&txt_item_group_no='+txt_item_group_no;
...
function openmypage_itemaccount()
{
    ...
    var page_link='requires/item_group_wise_stock_report_controller.php?action=item_account_such_popup&company='+company+'&cbo_item_category_id='+cbo_item_category_id+'&txt_item_acc='+txt_item_acc+'&txt_item_account_id='+txt_item_account_id+'&txt_item_acc_no='+txt_item_acc_no;
    var title="Search Item Popup";
...
function openmypage_stock(prod_id,store_id,date_form,date_to,uom,buyer,action)
{
  ...
  var page_link='requires/item_group_wise_stock_report_controller.php?prod_id='+prod_id+'&store_id='+store_id+'&date_form='+date_form+'&date_to='+date_to+'&uom='+uom+'&buyer='+buyer+'&action='+action;
  //alert(page_link);
    var title="Stock Details";
  emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=1065px,height=350px,center=1,resize=0,scrolling=0','../../');
}
