...
<script>
	...
	function generate_report(rpt_type)
	{
		...
		//alert (data);
		freeze_window(3);
		http.open("POST","requires/order_wise_grey_fabric_stock_consolidated_controller.php",true);
	...
	function openmypage_job()
	{
		...
		var page_link='requires/order_wise_grey_fabric_stock_consolidated_controller.php?action=job_no_popup&companyID='+companyID+'&buyer_name='+buyer_name+'&cbo_year_id='+cbo_year_id;
	...
	{ 
		 emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/order_wise_grey_fabric_stock_consolidated_controller.php?action='+action+'&po_id='+po_id, 'Booking Details Info', 'width=900px,height=370px,center=1,resize=0,scrolling=0','../../');
	}
                    ...
                    <tr class="general">
                        ...
                        <td>
                            <?   
                                ...
                                echo create_drop_down( "cbo_value_with", 102, $valueWithArr,"",0,"",1,"","","");
                            ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="hidden" name="search" id="search" value="Show" onClick="generate_report(1)" style="width:45px" class="formbutton" />
                            <input type="button" name="search" id="search" value="Order Wise" onClick="generate_report(2)" style="width:70px" class="formbutton" />
                            <input type="hidden" name="search" id="search" value="Order Wise 2" onClick="generate_report(3)" style="width:75px" class="formbutton" />
                        </td>
                    </tr>
                </table> 
            </fieldset> 
