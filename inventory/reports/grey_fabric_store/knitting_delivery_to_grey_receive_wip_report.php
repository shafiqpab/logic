...
function fn_report_generated(operation)
{
	...
	http.open("POST","requires/knitting_delivery_to_grey_receive_wip_report_controller.php",true);
...
function new_window()
	...
	/*function fsoNumber()
	{
	 	...
	 	else
	 	{
 			...
 			var page_link = 'requires/knitting_delivery_to_grey_receive_wip_report_controller.php?cbo_company_id=' + cbo_company_id + '&action=FSO_No_popup';
 	...
 	function delivery_roll_popup(delivery_id, fso_id, dtls_id, action)
    {
        ...
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', 'requires/knitting_delivery_to_grey_receive_wip_report_controller.php?delivery_id=' + delivery_id + '&action=' + action + '&fso_id=' + fso_id + '&dtls_id=' + dtls_id, 'Detail Veiw', 'width=' + popup_width + ', height=300px,center=1,resize=0,scrolling=0', '../../');
    }
...
<body onLoad="set_hotkey();">
	...
	<? echo load_freeze_divs ("../../../",''); ?>
         ...
         <h3 style="width:770px; margin-top:10px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')">-Search Panel</h3>
                 ...
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        ...
                        <tbody>
                            <tr class="general">
                                ...
                                <td>
                                    <input type="text"  name="fso_number_show" id="fso_number_show" class="text_boxes" style="width:100px;" tabindex="1" placeholder="Browse" onDblClick="fsoNumber();" readonly>
                                    <input type="hidden" name="fso_number" id="fso_number">
                                </td>
                                <td>
                                	<?
                                		// $based_on = array('1' => 'Transaction Date', '2' => 'Insert Date' );
                                		$based_on = array('1' => 'Knitting Delivery', '2' => 'Grey Receive', '3' => 'Knitting Insert Date', '4' => 'Grey Insert Date' );
