            ...
            <table width="570" cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr>
                        ...
                        <td align="center">
                        	<input type="button" name="button" class="formbutton" value="Show" onClick="show_list_view ('<? echo $companyID; ?>'+'**'+document.getElementById('cbo_buyer_name').value+'**'+document.getElementById('cbo_search_by').value+'**'+document.getElementById('txt_search_common').value+'**'+'<? echo $cbo_year_id; ?>'+'**'+'<? echo $cbo_month_id; ?>', 'create_job_no_search_list_view', 'search_div', 'order_wise2_grey_fabric_stock_controller', 'setFilterGrid(\'tbl_list_search\',-1)');" style="width:100px;" />
                    </td>
                    </tr>
            	</tbody>
           	</table>
...
?>	
 ...
 <?
	...
	echo  create_list_view("list_view", "Job No,Buyer,Style Ref.,Order No", "110,110,150,180","610","350",0, $sql, "js_set_value", "id,po_number", "", 1, "0,buyer_name,0,0,0", $arr , "job_no_prefix_num,buyer_name,style_ref_no,po_number", "order_wise2_grey_fabric_stock_controller",'setFilterGrid("list_view",-1);','0,0,0,0,0','') ;
	disconnect($con);
	exit();
}
...
{ 
	...
	if($rpt_type==1)
	{
							...
							<?
								...
								foreach($dataProd as $prodId)
								{
									...
									<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr<? echo $i;?>','<? echo $bgcolor;?>')" id="tr<? echo $i;?>">
                                       ...
                                       <?php /*?> <td width="90" align="right"><a href="##" onClick="openpage('recv_popup','<? echo $dataP; ?>')"><? echo number_format($recv_qty,2,'.',''); ?></a></td><?php */?>
										<td width="90" align="right"><a href="##" onClick="openpage('recv_popup','<? echo $dataP; ?>');"><? echo number_format($recv_qty,2); ?></a></td>
										<td width="90" align="right"><a href="#" onClick="fnc_iss_ret_qty();"><? echo number_format($iss_ret_qty,2); ?></a></td>
										<td width="90" align="right" title="<? echo $row[csf('id')]."**".$prodId; ?>"><a href="#" onClick="fnc_trans_in_qty();"><? echo number_format($trans_in_qty,2); ?></a></td>
										<td width="90" align="right"><a href="#" onClick="fnc_recv_tot_qty();"><? echo number_format($recv_tot_qty,2); ?></a></td>
										<td width="90" align="right"><a href="#" onClick="fnc_iss_qty();"><? echo number_format($iss_qty,2); ?></a></p></td>
										<td width="90" align="right"><a href="#" onClick="fnc_recv_ret_qty();"><? echo number_format($recv_ret_qty,2); ?></p></a></td>
										<td width="90" align="right"><a href="#" onClick="fnc_trans_out_qty();"><? echo number_format($trans_out_qty,2); ?></a></td>
										<td width="90" align="right"><a href="#" onClick="fnc_iss_tot_qty();"><? echo number_format($iss_tot_qty,2); ?></a></td>
										<td width="90" align="right"><a href="#" onClick="fnc_stock_qty();"><? echo number_format($stock_qty,2); ?></a></td>
										<?
											$daysOnHand=datediff("d",change_date_format($transaction_date_array[$prodId]['max_date'],'','',1),date("Y-m-d"));
										?>
										<td align="center"><a href="#" onClick="fnc_daysOnHand();"><? if($stock_qty>0) echo $daysOnHand; ?>&nbsp;</a></td>
									</tr>
		...
		else if(str_replace("'","",$cbo_presentation)==2)
		{
			...
			$sql_retn="select b.po_breakdown_id, a.prod_id, a.yarn_count, a.batch_lot, a.rack, a.self, sum(case when a.transaction_type=4 and b.trans_type=4 and b.entry_form=51 then b.quantity end) as iss_rtn_qty, sum(case when a.transaction_type=3 and b.trans_type=3 and b.entry_form=45 then b.quantity end) as rcv_rtn_qty 
			from inv_transaction a, order_wise_pro_details b, wo_po_break_down c 
			where a.id=b.trans_id and b.po_breakdown_id=c.id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and a.item_category=13 and b.entry_form in(45,51) and a.company_id=$cbo_company_id and a.transaction_type in(3,4) and b.trans_type in (3,4) $return_order_cond 
					...
					<?
						...
						foreach ($nameArray as $row)
						{
										...
										if($po_id==$prev_order_id)
										{
											...
											?>
												<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr<? echo $i;?>','<? echo $bgcolor;?>')" id="tr<? echo $i;?>">
													...
													<td width="80" align="right"><p><? $rec_bal=$trnsfer_in_qty+$issue_retn; echo number_format($rec_bal,2); $tot_rec_bal+=$rec_bal;?>&nbsp;</p></td>
													...
													<td width="80" align="right"><p><? $issue_bal=$issue_qty+$trnsfer_out_qty+$recv_retn; echo number_format($issue_bal,2); $tot_issue_bal+=$issue_bal; ?></p></td>
													<td width="60" align="right"><? $iss_roll=$issue_roll-$trnsfer_out_roll; echo $iss_roll; $tot_issue_roll+=$iss_roll; ?>&nbsp;</td>
													<td width="80" align="right"><p><? $stock=$rec_bal-$issue_bal; echo number_format($stock,2); $tot_stock+=$stock; ?>&nbsp;</p></td>
										...
										if($po_id==$prev_order_id)
										{
											...
											?>
												<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr<? echo $i;?>','<? echo $bgcolor;?>')" id="tr<? echo $i;?>">
                                                    ...
                                                    <td width="80" align="right"><p><? echo number_format($issue_retn,2);$tot_iss_retn_qty+=$issue_retn;?>&nbsp;</p></td>
													<td width="80" align="right"><p>&nbsp;</p></td>
													<td width="80" align="right"><p><? $rec_bal=$issue_retn; echo number_format($rec_bal,2);$tot_rec_bal+=$rec_bal;?>&nbsp;</p></td>
													<td width="60" align="right"><p>&nbsp;</p></td> 
													<td width="80" align="right"><p><? echo number_format($issue_qty,2); $tot_issue_qty+=$issue_qty; ?>&nbsp;</p></td>
                                                    <td width="80" align="right"><p>&nbsp;</p></td>
													<td width="80" align="right"><p><? echo number_format($trnsfer_out_qty,2); $tot_transfer_out_qty+=$trnsfer_out_qty;?>&nbsp;</p></td>
													<td width="80" align="right"><p><? $issue_bal=$issue_qty+$trnsfer_out_qty; echo number_format($issue_bal,2); $tot_issue_bal+=$issue_bal; ?></p></td>
													<td width="60" align="right"><? $iss_roll=$issue_roll-$trnsfer_out_roll; echo $iss_roll; $tot_issue_roll+=$iss_roll; ?>&nbsp;</td>
													<td width="80" align="right"><p><? $stock=$rec_bal-$issue_bal; echo number_format($stock,2); $tot_stock+=$stock; ?>&nbsp;</p></td>
										...
										if($po_id==$prev_order_id)
										{
											...
											?>
												<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr<? echo $i;?>','<? echo $bgcolor;?>')" id="tr<? echo $i;?>">
                                                    ...
                                                    <td width="80"><p><? echo number_format($recv_retn,2);$tot_recv_retn_qty+=$recv_retn;?>&nbsp;</p></td>
													<td width="80" align="right"><p>&nbsp;</p></td>
													<td width="80" align="right"><p><? $issue_bal=$recv_retn; echo number_format($issue_bal,2); $tot_issue_bal+=$issue_bal; ?></p></td>
							...
							<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr<? echo $i;?>','<? echo $bgcolor;?>')" id="tr<? echo $i;?>">
								...
								<td width="80" align="right"><p><? echo number_format($issue_retn,2); $tot_iss_retn_qty+=$issue_retn; ?>&nbsp;</p></td>
                                <td width="80" align="right"><p><? echo number_format($trnsfer_in_qty,2); $tot_transfer_in_qty+=$trnsfer_in_qty; ?>&nbsp;</p></td>
								<td width="80" align="right"><p><? $rec_bal=$row[csf('quantity')]+$trnsfer_in_qty+$issue_retn; echo number_format($rec_bal,2); $tot_rec_bal+=$rec_bal; ?>&nbsp;</p></td>
...
?>
	...
	<fieldset style="width:1190px">
        ...
        <table cellpadding="0" width="550" class="rpt_table" rules="all" border="1">
            <thead>
                <th width="40">SL</th>
        ...
        <div style="width:550px; max-height:250px; overflow-y:scroll">
			...
			<?
               ...
               //echo $sql."<br>";//die;
				...
				$trans_sql="select b.mst_id, c.barcode_no, c.roll_no, c.qnty 
				from order_wise_pro_details a,  inv_item_transfer_dtls b,  pro_roll_details c where a.trans_id=b.to_trans_id and b.id=c.dtls_id and c.entry_form=83 and c.status_active=1 and c.is_deleted=0 
and c.barcode_no in($barcode_nos) and a.po_breakdown_id in($po_ids)";
				//echo $trans_sql."<br>";
        ...
        <table cellpadding="0" width="530" class="rpt_table" rules="all" border="1">
            <tfoot>
                <th colspan="4">Roll Total :</th>
                <th width="80" style="text-align:center"><? echo $i; ?></th>
                <th width="83"><? echo number_format($tot_qnty,2); ?></th>
            </tfoot>
        </table>
    </fieldset>
...
//2
if ($action=="iss_ret_qty_details_history"){
	echo load_html_head_contents("Issue Return Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//3
if ($action=="trans_in_qty_details_history"){
	echo load_html_head_contents("Transfer in Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//4
if (action=="recv_tot_qty_details_history"){
	echo load_html_head_contents("Receive Total Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//5
if ($action=="iss_qty_details_history"){
...
//6
if ($action=="recv_ret_qty_details_history"){
	echo load_html_head_contents("Receive Return Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//7
if ($action=="trans_out_qty_details_history"){
	echo load_html_head_contents("Transfer Out Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//8
if ($action=="iss_tot_qty_details_history"){
	echo load_html_head_contents("Total Issue Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//9
if ($action=="stock_qty_details_history"){
	echo load_html_head_contents("Stock Quantity Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
...
//10
if ($action=="daysOnHand_details_history"){
	echo load_html_head_contents("Days On Hand Details", "../../../../", 1, 1,$unicode,'','');
	extract($_REQUEST);	
	?>
