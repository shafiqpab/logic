...
if($action=="generate_report_receive")
{
	...
	<div style="width:3560px" id="main_body">
		...
		<br />
		<table width="3530" border="1" cellpadding="0" cellspacing="0" class="rpt_table" rules="all" id="table_header_1" align="left">
			<thead>
				<tr>
					<th width="30">SL</th>
					<th width="80">Trans. Date</th>
					<th width="120">Trans. Ref.</th>
					<th width="80">Receive Challan</th>
		...
		<div style="width:3550px; overflow-y: scroll; max-height:250px; float: left;" id="scroll_body">
			<table width="3530" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body" align="left">
				<tbody>
					<?
							...
							foreach($sales_data as $rcv_date => $rcv_data)
							{
								foreach($rcv_data as $refStr => $row)
								{
									...
									<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
										...
										<td width="120"><p class="word_wrap_break"><? echo $refString[0];?></p></td>
										<td width="80"><p class="word_wrap_break"><? echo $refString[1];?></p></td>
										<td width="80"><p class="word_wrap_break"><? echo $refString[4];?></p></td>
		                                ...
		                                <td width="80"><p class="word_wrap_break"><? echo $refString[34];?></p></td>
		                                ...
		                                <td width="120"><? echo $sales_no;?></td>
		                                <td width="80"><? echo $refString[14];?></td>
		                                <td width="70"><? echo $refString[15];?></td>
		                                <td width="80">
		                                	<?
		                                ...
		                                <td width="50"><? echo $refString[24];?></td>
		                                <td width="50"><? echo $refString[25];?></td>
		                                <td width="50"><? echo $refString[26];?></td>
		                                <td width="50"><? echo $machine_array[$refString[29]];?></td>
		                                <td width="50"><? echo $refString[27];?></td>
		                                <td width="50"><? echo $refString[28];?></td>
		                                ...
		                                <td width="50" align="right"><a href="##" onclick="open_mypage_roll('<? echo $barcode_nos;?>');"><? echo $row["no_of_roll"];?></a></td>
		...
		<table width="3530" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all"  align="left">
			<tfoot>
				<tr>
					<th width="30"></th>
					<th width="80"></th>
					...
					<th width="50" id="value_total_no_of_roll" align="right"><? echo $total_no_of_roll;?></th>
					<th width="80"></th>
					<th width="80"></th>
					<th width="150"></th>
				</tr>
...
if($action=="generate_report_issue")
{
	...
	$issue_sql=sql_select("select a.issue_date, a.issue_number, a.knit_dye_source, a.knit_dye_company, b.store_name as store_id,  d.po_breakdown_id, a.inserted_by,a.insert_date,d.barcode_no, d.qnty as issue_qnty, e.within_group, e.job_no, e.sales_booking_no,e.buyer_id,e.po_job_no, e.po_buyer,e.season_id,e.delivery_date, e.booking_type, e.booking_without_order, e.booking_entry_form, e.booking_id,e.style_ref_no,a.remarks 
							...
							foreach($sales_data as $rcv_date => $rcv_data)
							{
								foreach($rcv_data as $refStr => $row)
								{
									...
									<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
										<td width="30"><? echo $i;?></td>
										<td width="80"><? echo $rcv_date;?></td>
										<td width="120"><? echo $refString[0];?></td>
										<td width="80"><p class="word_wrap_break"><? echo $store_arr[$refString[5]];?></p></td>
										<td width="100"><p class="word_wrap_break"><? echo $refString[8];?></p></td>
										<td width="70"><p class="word_wrap_break"><? echo $buyer_arr[$refString[7]];?></p></td>
										<td width="100"><p class="word_wrap_break"><? echo $refString[9];?></p></td>
		                                ...
		                                <td width="80" align="center"><? echo $user_array[$refString[31]];?></td>
		                                <td width="80"><? echo date("d-M-Y",strtotime($refString[32]))."&\n " .date("h:i",strtotime($refString[32]));?></td>
		                                <td width="150"><p><? echo $refString[30];?></p></td>
