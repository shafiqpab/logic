...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Grey Fabric Item Ledger","../../../", 1, 1, $unicode,1,1); 
?>	
<script>
...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function openmypage_item()
	{
		...
		var page_link='requires/grey_fabric_item_ledger_controller.php?action=item_description_search&company='+company; 
	...
	function generate_report(rpt_type)
	{
		...
		freeze_window(3);
		http.open("POST","requires/grey_fabric_item_ledger_controller.php",true);
	...
	function openmypage(trans_id,prod_id,trans_type,action)
	{
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/grey_fabric_item_ledger_controller.php?trans_id='+trans_id+'&prod_id='+prod_id+'&trans_type='+trans_type+'&action='+action, page_title, 'width='+width_pop+'px,height=400px,center=1,resize=0,scrolling=0','../../');
	}
