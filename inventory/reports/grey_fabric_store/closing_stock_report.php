...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function openmypage_item_account()
	{
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/closing_stock_report_controller.php?action=item_account_popup&data='+data,'Item Account Popup', 'width=500px,height=370px,center=1,resize=0','../../')
            ...
            <fieldset>
                <table class="rpt_table" width="1330" cellpadding="0" cellspacing="0" border="1" rules="all">
                    <thead>
                        ...
                        <th colspan="3"><input type="reset" name="res" id="res" value="Reset" style="width:100px" class="formbutton" onClick="reset_form('closingstock_1','report_container*report_container2','','','')" /></th>
                    </thead>
                    <tbody>
                        <tr class="general">
                            <td>
                           ...
                           <td>
								<?
									echo create_drop_down( "cbo_item_category_id", 150,$item_category,"", 1, "-- Select Category--", $selected, "load_drop_down( 'requires/closing_stock_report_controller', document.getElementById('cbo_company_name').value+'_'+this.value, 'load_drop_down_store', 'store_td' );","","13,14","","","");
                                ?>
                          </td>
                            <td>
                           ...
                           <td id="store_td">
                            ...
                            <td  align="center">
                            	<input type="button" name="search" id="search" value="Report-2" onClick="generate_report(4)" style="width:80px" class="formbutton" />
                            </td>
                            <td  align="center">
                            	<input type="button" name="search" id="search" value="Unifill" onClick="generate_report(6)" style="width:80px" class="formbutton" />
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
                        <tr>
                            ...
                            <td colspan="3" align="right"><input type="button" name="search" id="search" value="Buyer Wise Summary" onClick="generate_report(5)" style="width:130px" class="formbutton" /></td>
                        </tr>
                    </tfoot>
                </table>
            </fieldset>
