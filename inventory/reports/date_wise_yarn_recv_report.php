	...
	var tableFilters = 
	 ...
	 var tableFilters11 = 
	 {
		 ...
		 col_operation: {
			 ...
			 col: [34,35,36,37,38,39,40,41,42,44],
	 ...
	 var tableFilters2 = 
	 {
		col_30: "none",
		col_operation: {
		id: ["value_total_receive","value_total_ret_receive","value_total_trans_in","value_total_issue","value_total_ret_issue","value_total_trans_out"],
	   col: [23,24,25,26,27,28],
...
function  generate_report(rptType)
{
	...
	freeze_window(5);
	http.open("POST","requires/date_wise_yarn_recv_report_controller.php",true);
        ...
        <fieldset style="width:1100px;">
                ...
                <thead>
                    <tr>                    	
                        ...
                        <th width="170" class="must_entry_caption">Transaction Date Range</th>
                ...
                <tr class="general">               	
                    <td>
                        <?
							...
							// "load_drop_down( 'requires/date_wise_yarn_recv_report_controller',this.value+'**1', 'load_drop_down_store', 'store_td' );"
                        ?>                          
                    </td>
                    <td id="store_td"><? 
...
<script>
	...
	set_multiselect('cbo_receive_purpose','0','0','','0');
