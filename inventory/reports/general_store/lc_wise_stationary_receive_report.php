<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create LC Wise Stationary Receive Report
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("LC Wise Stationary Receive Report","../../../", 1, 1, $unicode,1,1);
?>
    ...
    <script>
        ...
        function generate_report()
        {
            ...
            freeze_window(3);
            http.open("POST","requires/lc_wise_stationary_receive_report_controller.php",true);
        ...
        function openmypage_btbLc()
        {
            ...
            var page_link='requires/lc_wise_stationary_receive_report_controller.php?action=btbLc_popup&companyID='+companyID;
            var title='BTB LC NO';
        ...
        function openmypage_pinumber()
        {
            ...
            var page_link='requires/lc_wise_stationary_receive_report_controller.php?action=pinumber_popup&companyID='+companyID;
...
<body onLoad="set_hotkey()">
    ...
    <form name="lc_wise_stationary_rcv_rpt" id="lc_wise_stationary_rcv_rpt" autocomplete="off" >
            ...
            <legend>Search Panel</legend>
                <table class="rpt_table" width="690" cellpadding="0" cellspacing="0" border="1" rules="all">
                    ...
                    <tr align="center">
                        <td>
                            <?
                               echo create_drop_down( "cbo_company_name", 150, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "reset_form('','','txt_btbLc_no*btbLc_id','','',''); load_drop_down( 'requires/lc_wise_stationary_receive_report_controller', this.value, 'load_drop_down_store', 'store_td' );" );

                            ?>
                        </td>
                        <!-- <td id="store_td"> 
                            <?
                               // echo create_drop_down( "cbo_store_name", 140, $blank_array,"", 1, "-- Select Store --", 0, "" );
                            ?>
                        </td> -->
                        <td>
