...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("File Wise Yarn Issue","../../../", 1, 1, $unicode,1,1); 
...
function fn_file_no()
{
	...
	var page_link='requires/file_wise_yarn_issue_controller.php?action=file_search&company_id='+company_id+'&file_year='+file_year;
...
function generate_report()
{
	...
	freeze_window(3);
	http.open("POST","requires/file_wise_yarn_issue_controller.php",true);
...
<div style="width:100%;" align="center">
    ...
    <h3 style="width:625px;" align="center" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
            ...
            <legend>Search Panel</legend> 
                <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all">
                    ...
                    <tr align="center">
                        <td>
                            <? 
                               echo create_drop_down( "cbo_company_name", 150, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/file_wise_yarn_issue_controller', this.value, 'load_drop_down_file_year', 'td_file_year' );" );
                            ?>                            
                        </td>
                        <td id="td_file_year">
