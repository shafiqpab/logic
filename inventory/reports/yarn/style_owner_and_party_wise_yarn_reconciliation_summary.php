<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Style Owner and Party Wise Yarn Reconciliation Summary
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Style Owner and Party Wise Yarn Reconciliation Summary","../../../", 1, 1, $unicode,0,0);
...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function generate_report(type)
	{
		...
		if(job_no!="" || booking_no!="" || internal_ref!="" )
		{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_knitting_source*txt_knitting_com_id*txt_job_no*txt_booking_no*txt_internal_ref*txt_date_from*txt_date_to*txt_job_id*hide_booking_id*hide_booking_type*cbo_year*cbo_style_owner',"../../../")+'&report_title='+report_title+'&type='+type;
		//alert(data);
		freeze_window(3);
		http.open("POST","requires/style_owner_and_party_wise_yarn_reconciliation_summary_controller.php",true);
	...
	function openmypage_job()
	{
		...
		var page_link='requires/style_owner_and_party_wise_yarn_reconciliation_summary_controller.php?action=job_no_popup&companyID='+companyID+'&cbo_knitting_source='+cbo_knitting_source+'&txt_knitting_com_id='+txt_knitting_com_id+'&cbo_year='+cbo_year;
	...
	function openmypage_booking()
	{
		...
		var txt_knitting_com_id = $("#txt_knitting_com_id").val();
		var cbo_year = $("#cbo_year").val();
		var page_link='requires/style_owner_and_party_wise_yarn_reconciliation_summary_controller.php?action=booking_no_popup&companyID='+companyID+'&cbo_knitting_source='+cbo_knitting_source+'&txt_knitting_com_id='+txt_knitting_com_id+'&cbo_year='+cbo_year;
	...
	function openmypage_party()
	{
		...
		var page_link='requires/style_owner_and_party_wise_yarn_reconciliation_summary_controller.php?action=party_popup&companyID='+companyID+'&cbo_knitting_source='+cbo_knitting_source+'&txt_knit_comp_id='+txt_knit_comp_id;
	...
	function print_button_setting() //Report Settins
	{
		...
		$('#data_panel').html('');
		get_php_form_data($('#cbo_company_name').val(),'print_button_variable_setting','requires/style_owner_and_party_wise_yarn_reconciliation_summary_controller' );
	}
            ...
            <legend>Search Panel</legend>
                <table class="rpt_table" width="1090" cellpadding="0" cellspacing="0" border="1" rules="all">
                    ...
                    <tr class="general">
                        ...
                        <input type="button" name="search" id="search" value="Summary" onClick="generate_report(1)" style="width:60px" class="formbutton" title="Sales Order is not address on this button" />
