<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Create Buyer Wise Daily Yarn Stock Report[Sales].
Functionality	:	
JS Functions	:
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Buyer Wise Daily Yarn Stock Report[Sales]", "../../../", 1, 1, '', 1, 1);
?>
<script>
    ...
    function fn_report_generated(presentationType)
	{
        ...
        var data = "action=report_generate" + get_submitted_data_string('cbo_company_name*cbo_buyer_id*txt_sales_no*txt_booking_no*txt_date_from*txt_date_to*cbo_based_on', "../../../") + '&presentationType=' + presentationType;
        //alert(data);
        freeze_window(3);
        http.open("POST", "requires/buyer_wise_daily_yarn_stock_report_controller.php", true);
    ...
    function fn_report_generated_reponse()
	{
        if (http.readyState == 4)
		{
            ...
            get_php_form_data( company_id, 'company_wise_report_button_setting','requires/buyer_wise_daily_yarn_stock_report_controller' );
            show_msg('3');
            release_freezing();
        }
    }
    ...
    function openmypage_booking()
	{
        ...
        var page_link = 'requires/buyer_wise_daily_yarn_stock_report_controller.php?action=booking_no_search_popup&companyID=' + companyID;
    ...
    function openmypage_sales_no()
	{
        ...
        var companyID = $("#cbo_company_name").val();
        var page_link = 'requires/buyer_wise_daily_yarn_stock_report_controller.php?action=job_no_search_popup&companyID=' + companyID;
...
<body onLoad="set_hotkey();">
    ...
    <div style="width:100%;" align="center">
        ...
        <h3 style="width:980px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')">-Search Panel</h3>
            ...
            <fieldset style="width:980px;">
                <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    ...
                    <tr class="general">
                        ...
                        <td id="buyer_td">
							<?
							echo create_drop_down("cbo_buyer_id", 130, "select id, buyer_name from lib_buyer where status_active=1 and is_deleted=0  group by id, buyer_name order by buyer_name", "id,buyer_name", 1, "- All Buyer -", $selected, "", 0, "");
							?>
                        </td>
                        <td>
                        ...
                        <td>
                            <input type="text" name="txt_booking_no" id="txt_booking_no" class="text_boxes" style="width:130px" placeholder="Write/Browse" onDblClick="openmypage_booking();" autocomplete="off">
                        </td>
                        <td>
							<?
							$based_on_arr = array(1 => "Booking", 2 => "Sales Order");
							echo create_drop_down("cbo_based_on", 130, $based_on_arr, "", 0, "", 2, '', 0);
							?>
                        </td>
                        <td align="center">
