...
{ 
 	...
 	if($template==1)
	{
		...
		{
			if ($start_date=="" && $end_date=="") $date_search_cond=""; else $date_search_cond="and b.po_received_date between '$start_date' and '$end_date'";	
		}
		...
		$dataArrayTrans=sql_select("select po_breakdown_id, 
								sum(CASE WHEN entry_form in (2) THEN quantity ELSE 0 END) AS grey_receive,
								...
								sum(CASE WHEN entry_form in(51,84) and trans_type=4 THEN quantity ELSE 0 END) AS grey_issue_return,
								...
								sum(CASE WHEN entry_form ='83' and trans_type=5 THEN quantity ELSE 0 END) AS trans_in_ordroll_knit,
								sum(CASE WHEN entry_form ='83' and trans_type=6 THEN quantity ELSE 0 END) AS trans_out_ordroll_knit
								from order_wise_pro_details where status_active=1 and is_deleted=0 and entry_form in(2,11,13,16,45,51,58,61,80,81,83,84) $trans_po_cond group by po_breakdown_id");
		foreach($dataArrayTrans as $row)
		{
			...
			$trans_qnty_arr[$row[csf('po_breakdown_id')]]['knit_trans']=($row[csf('transfer_in_qnty_knit')]+$row[csf('trans_in_sample_knit')]+$row[csf('trans_in_ordroll_knit')])-($row[csf('transfer_out_qnty_knit')]+$row[csf('trans_out_sample_knit')]+$row[csf('trans_out_ordroll_knit')]);
		...
		//print_r($grey_issue_return_qnty_arr);
		...
		$dataArrayTransfin=sql_select("select po_breakdown_id, color_id, 
		...
		foreach($dataArrayTransfin as $row)
		{
			$trans_qnty_fin_arr[$row[csf('po_breakdown_id')]][$row[csf('color_id')]]['trans_in']=$row[csf('transfer_in_qnty')]-$row[csf('transfer_out_qnty')];
			$finish_receive_qnty_arr[$row[csf('po_breakdown_id')]][$row[csf('color_id')]]=$row[csf('finish_receive')]+$row[csf('finish_receive_rollwise')];
			$finish_purchase_qnty_arr[$row[csf('po_breakdown_id')]][$row[csf('color_id')]]['purchase']=$row[csf('finish_purchase')];
		...
		if($type==1 || $type==3)
		{
			$table_width="6530"; $colspan="19";
		}
		else
		{
			$table_width="6270"; $colspan="16";
		}
		...
		<!--<div> Report Under QC.</div>-->
            <table class="rpt_table" border="1" rules="all" width="<? echo $table_width; ?>" cellpadding="0" cellspacing="0" id="table_header_1" style=" <?php echo $table_display; ?> ">
                <thead>
                    ...
                    <tr>
                        ...
                        <th width="100">Net Transfer</th>
                        <th width="100" title="G. Prod. Qty + G. Purchase Qty + Net Trans Knit+G. Net Return;">Fabric Available</th>
			...
			$html_short="<table width='1540'>
							 <tr>
								<th colspan='16' align='center'>".$company_library[$company_name]."</th>
							 </tr>
							 <tr>
								<th colspan='16' align='center'>From ". change_date_format($start_date). " To ". change_date_format($end_date)."</th>
							 </tr>
						</table>
								...
								?>
									<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $k; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $k; ?>">
										...
										<? if($country_ship_qty>0)
									   {
                                        ...
                                        <td width="100" align="right">
											<? 
												if($z==1)
												{
													echo number_format($receive_by_batch_qnt,2,'.','');
                                       ...
                                       <? 
											...
											$fab_rec_return=$finish_recv_rtn_qnty_arr[$po_id][$key];
											...
											$fab_production_qnty=$finish_purchase_qnty_arr[$po_id][$key]['production'];
											$fab_purchase_qnty=$finish_purchase_qnty_arr[$po_id][$key]['purchase'];
                                       ...
                                       <td width="100" align="right">
                                        ...
                                        <td width="100" align="right" bgcolor="<? echo $fin_prod_color_td; ?>">
											...
											<?
												...
												//$fin_fab_recei_array[$buyer_name]+=$fab_recv_qnty;
                                        ...
                                        <td width="100" align="right" >
											<? 
												$net_trans_finish=$trans_qnty_fin_arr[$po_id][$key]['trans_in'];
                                       ...
                                       <? $html.="</td><td>"; ?>
										...
										<td width="100" align="right">
											<?
												...
												foreach($job_po_id as $val)
												{
													$net_trans_finish+=$trans_qnty_fin_arr[$val][$key]['trans_in'];
												} 
											?>
                ...
                <tr>
                    ...
                    <td valign="top">
                        ...
                        <div id="buyer_summary" style="border:none">
                            <table width="1920" class="rpt_table" border="0" rules="all" align="center">
                                <thead>
                                    <tr align="center" id="company_id_td" style="visibility:hidden; border:none">
                                        <th colspan="19" style="border:none">
                                    ...
                                    <tr align="center" id="date_td" style="visibility:hidden;border:none">
                                         <th colspan="19" style="border:none"><font size="3"><? echo "From ". change_date_format($start_date). " To ". change_date_format($end_date);?></font></th>
                                    </tr>
                                    <tr align="center">
                                ...
                                {
                                    if ($b_sl%2==0) $bgcolor="#E9F3FF";
                                    else $bgcolor="#FFFFFF";	
                                    
                                    $batch_bl=$grey_issue_array[$key]-$batch_qnty_array[$key];
                                    $dye_bl=$batch_qnty_array[$key]-$dye_qnty_array[$key];//$order_qty_array[$key]
									$yet_to_batch=0;
                                    $yet_to_batch=$receive_by_batch_array[$key]-$batch_qnty_array[$key];
                                    $html.="<tr bgcolor='$bgcolor'>
                                            <td align='right'>".$b_sl."</td>
                                            <td align='right'>".$value."</td>
											<td align='right'>".number_format($country_order_qty_array[$key],2)."</td>
                                    ...
                                    <tr bgcolor="<? echo $bgcolor; ?>">
                                        ...
                                        <td width="100" align="right"><? echo number_format($country_order_qty_array[$key],2); $order_qty_array_tot+=$country_order_qty_array[$key]; ?></td>
                                        ...
                                        <td width="100" align="right"><? echo number_format($receive_by_batch_array[$key],2);$receive_by_batch_array_tot+=$receive_by_batch_array[$key]; ?></td>
                                        <td width="100" align="right"><? echo number_format($batch_qnty_array[$key],2);$batch_qnty_array_tot+=$batch_qnty_array[$key]; ?></td>
                                        <td width="100" align="right" title="Receive By Batch-Batch Quantity"><? echo number_format($yet_to_batch,2);$yet_to_batch_tot+=$yet_to_batch; ?></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th width="100" align="right"><? echo number_format($yet_to_batch_tot,2) ;?></th>
...
if($action=="grey_purchase")
{
	...
	$sqlWO="select a.fabric_source,b.po_break_down_id,a.booking_no from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and a.item_category in(2,13) and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 and b.po_break_down_id in ($order_id[0])";
	 $resultWo=sql_select($sqlWO);
	 $fab_source_ids="";
		foreach($resultWo as $woRow)
		{
...
if($action=="batch_qnty")
{
	...
	$sqlWO="select a.fabric_source,b.po_break_down_id,a.booking_no from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and a.item_category in(2,13) and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 and b.po_break_down_id in ($ex_data[0])";
	 $resultWo=sql_select($sqlWO);
	 $fab_source_ids="";
		foreach($resultWo as $woRow)
		{
	...
	<fieldset style="width:670px; margin-left:7px">
		<div id="report_container">
			<table border="1" class="rpt_table" rules="all" width="650" cellpadding="0" cellspacing="0">
                ...
                <?
                $i=1; $total_trans_in_qnty=0;
				$sql="select a.transfer_system_id, a.transfer_date, a.challan_no, a.from_order_id, b.from_prod_id, sum(c.quantity) as transfer_qnty, d.product_name_details from inv_item_transfer_mst a, inv_item_transfer_dtls b, order_wise_pro_details c, product_details_master d where a.id=b.mst_id and b.id=c.dtls_id and c.prod_id=d.id and a.item_category=13 and c.trans_type=5 and c.entry_form in (13,81,83) and c.po_breakdown_id in ($order_id) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 group by a.id, c.prod_id, a.transfer_system_id, a.transfer_date, a.challan_no, a.from_order_id, b.from_prod_id, d.product_name_details";// and a.transfer_criteria=4
                $result=sql_select($sql);
				foreach($result as $row)
				{
					if ($i%2==0)  
                ...
                <?
                $total_trans_out_qnty=0;
				$sql="select a.transfer_system_id, a.transfer_date, a.challan_no, a.to_order_id, b.from_prod_id, d.product_name_details, sum(c.quantity) as transfer_qnty from inv_item_transfer_mst a, inv_item_transfer_dtls b, order_wise_pro_details c, product_details_master d where a.id=b.mst_id and b.id=c.dtls_id and c.prod_id=d.id and a.item_category=13 and c.trans_type=6 and c.entry_form in (13,80,83) and c.po_breakdown_id in ($order_id) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 group by a.id, c.prod_id, a.transfer_system_id, a.transfer_date, a.challan_no, a.to_order_id, b.from_prod_id, d.product_name_details";// and a.transfer_criteria=4
                $result=sql_select($sql);
				foreach($result as $row)
				{
					if ($i%2==0)  
