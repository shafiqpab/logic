...
<script>
	...
	{
		col_operation: {
		id: ["value_booking_quantity","value_opening_stock","value_opening_amount","value_rcv_qnty","value_inside_iss_return","value_out_iss_return","value_trans_in","value_total_rcv","value_total_issue","value_issue_amount","value_stock_qnty","value_stock_amount"],
		
		col: [29,32,33,34,35,36,37,38, 48,50,51,53],
