<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Create Dailly Finished Fabric Delivery to Garments FSO Report.
Functionality	:
JS Functions	:
Created by		:	Kaiyum
Creation date 	: 	12-9-2021
Updated by 		:
Update date		:
QC Performed BY	:
QC Date			:
...
<script>
	...
	function fn_report_generated(type)
	{
		...
		{
			var report_action= "report_generate_2";
		}
		...
		freeze_window(3);
		http.open("POST","requires/daily_finished_fabric_delivery_to_garments_fso_report_controller.php",true);
	...
	function openmypage_fsoNo()
	{
		...
		{ 	
			...
			var page_link = 'requires/daily_finished_fabric_delivery_to_garments_fso_report_controller.php?action=fsoNo_popup&cbo_company_id='+cbo_company_id+'&cbo_within_group='+cbo_within_group;
	...
	function openPopupBatch()
	{
		...
		var page_link='requires/daily_finished_fabric_delivery_to_garments_fso_report_controller.php?action=batch_popup&companyID='+companyID+'&buyer_name='+buyer_name;
	...
	function openPopupBooking()
	{
		...
		var page_link='requires/daily_finished_fabric_delivery_to_garments_fso_report_controller.php?action=booking_popup&companyID='+companyID+'&buyer_name='+buyer_name;
	...
	function openmypage_roll_qnty(ref_data,action)
	{
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/daily_finished_fabric_delivery_to_garments_fso_report_controller.php?companyID='+companyID+'&ref_data='+ref_data+'&action='+action, 'Details Veiw', 'width='+popup_width+', height=350px,center=1,resize=0,scrolling=0','../../');
	}
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
            	...
            	<tbody>
                    <tr align="center" class="general">
                        ...
                        <td>
							<?php
							echo create_drop_down("cbo_within_group", 70, array(1 => "Yes", 2 => "No"), "", 1, "-- Select --", 0,"load_drop_down( 'requires/daily_finished_fabric_delivery_to_garments_fso_report_controller',this.value+'**'+$('#cbo_company_id').val(), 'load_drop_down_party_type', 'buyer_td' );",0 );
							?>
						</td>
                        <td id="buyer_td">
							<?php
