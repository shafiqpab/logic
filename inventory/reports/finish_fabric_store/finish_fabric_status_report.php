...
<script>
	...
	function openmypage_job()
	{
		...
		var page_link='requires/finish_fabric_status_report_controller.php?action=job_no_popup&companyID='+companyID+'&cbo_type='+cbo_type;
	...
	function openmypage_style()
	{
		...
		var companyID = $("#cbo_company_name").val();
		var cbo_type = $("#cbo_type").val();
		var page_link='requires/finish_fabric_status_report_controller.php?action=style_no_popup&companyID='+companyID+'&cbo_type='+cbo_type;
	...
	function openmypage_booking()
	{
		...
		var companyID = $("#cbo_company_name").val();
		var cbo_type = $("#cbo_type").val();
		var page_link='requires/finish_fabric_status_report_controller.php?action=booking_no_popup&companyID='+companyID+'&cbo_type='+cbo_type;
	...
	function openmypage_order()
	{
		...
		var companyID = $("#cbo_company_name").val();
		var cbo_type = $("#cbo_type").val();
		var page_link='requires/finish_fabric_status_report_controller.php?action=order_no_popup&companyID='+companyID+'&cbo_type='+cbo_type;
	...
	function fn_report_generated(operation)
	{
		...
		if (form_validation('cbo_company_name*cbo_type*cbo_report_criteria'+validate_id,'Comapny Name*Type*Report Criteria'+validate_msg)==false)
		{
			return;
		}
		...
		freeze_window(5);
	 	...
	 	var data="action=generated_report&operation="+operation+get_submitted_data_string('cbo_company_name*cbo_year*cbo_type*txt_job_no*txt_job_id*txt_style_no*hidden_style*txt_booking_no*hidden_booking_id*txt_order_no*hidden_order_id*cbo_stock_for*cbo_get_upto*txt_days*cbo_get_upto_qnty*txt_qnty*cbo_report_criteria*txt_date_from*txt_date_to',    "../../../");

	 	// alert(data);release_freezing();return;

		http.open("POST","requires/finish_fabric_status_report_controller.php",true);
...
<body onLoad="set_hotkey();">
	...
	<? echo load_freeze_divs ("../../../",''); ?>
         ...
         <h3 style="width:1428px; margin-top:10px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')">-Search Panel</h3>
         <div id="content_search_panel" >
             <fieldset style="width:1428px;">
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        ...
                        <tbody>
                            <tr class="general">
		                        ...
		                        <td>
		                            <?
		                            	$report_criteria_arr = array('1' => 'Receive Issue and Stock', '2' => 'Date Wise Receive Issue and Stock', '3' => 'Compact Report');
		                                echo create_drop_down( "cbo_report_criteria", 80, $report_criteria_arr,"", 0, "- All -", 1, "",0 );
		                            ?>
		                        </td>
                                <td align="center">
