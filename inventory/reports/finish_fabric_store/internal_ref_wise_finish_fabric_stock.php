...
<div style="width:100%;" align="center">
    ...
    <h3 style="width:1280px; margin-top:20px;" align="" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
                ...
                <table class="rpt_table" width="1280" cellpadding="0" cellspacing="0" border="1" rules="all">
                    <thead>
                        <tr>
                            ...
                            <th width="100" id="td_search">Enter Ref</th>
                    ...
                    <tr align="center" class="general">
                        ...
                        <td>
                            <?
                                ...
                                echo create_drop_down( "cbo_report_type", 115, $report_arr, "", 0, "--  --", 1, "load_drop_down( 'requires/internal_ref_wise_finish_fabric_stock_controller', document.getElementById('cbo_company_id').value+'_'+this.value, 'load_drop_down_store', 'store_td' );", "", "1,2");
                            ?>
                        </td>
                        <td>
                            <?
                        ...
                        <td>
                            <?
                                ...
                                echo create_drop_down( "cbo_search_by", 90, $search_by,"", 0, "--Select--", 5, "change_caption(this.value);",0 );
                            ?>
                        </td>
                        <td>
                        ...
                        <td>
							<span id="button_data_panel"><input title="Only for Knit" type="button" name="search" id="search" value="Show" onClick="generate_report(7)" style="width:70px" class="formbutton" /></span>
                        </td>
                    </tr>
                </table>
            </fieldset>
