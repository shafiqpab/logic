...
if($action=="report_generate")
{
	...
	<div>
        <table cellpadding="0" cellspacing="0" width="1650">
		...
		<table cellspacing="0" cellpadding="0" border="1" class="rpt_table" width="1650" rules="all" id="table_header" >
			<thead>
				<tr>
					<th width="30">Sl No</th>
					<th width="110">Projetion Order Entry date</th>
		...
		<div style="max-height:320px; overflow-y:scroll; width:1668px;" id="scroll_body">
			<table cellspacing="0" cellpadding="0" border="1" class="rpt_table"  width="1650" rules="all" id="table_body">
				<tbody>
					<?
					...
					a.buyer_name, a.style_ref_no, a.season, b.sample_name, c.color_id as sample_color, d.lib_yarn_count_deter_id,b.delivery_date,b.fabric_description,e.booking_date,b.remarks_ra,e.id booking_id,e.booking_no
...
//echo $query;die;
					...
					foreach ($sql as $key => $value)
					{
						...
						<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_2nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_2nd<? echo $i; ?>">
							<?  if(!in_array($value[csf('booking_id')], $book_check_arr))
							{
									...
									<td width="260" style="word-break:break-all"  rowspan="<? echo $book_rowspan; ?>"><? echo implode(",",$sample_names); ?></td>
								...
								?>
								<td width="110" style="word-break:break-all"><? echo  $value[csf('fabric_description')] ; ?></td>
								...
								<td width="80" style="word-break:break-all" align="center"><? echo $date_diff_1=datediff( "d", $value[csf('booking_date')] , $value[csf('delivery_date')]); ?></td>
								<td  style="word-break:break-all" align="center"><? echo $date_diff_2=datediff( "d", $value[csf('delivery_date')] , $recv_arr[$booking_no][$value[csf("lib_yarn_count_deter_id")]][$value[csf("sample_color")]]["receive_date"]); ?></td>
                 ...
                 <table width="1650" border="1" cellpadding="0" cellspacing="0" rules="all"> 
                 <tr class="tbl_bottom">
					<td width="30">&nbsp;</td>
					<td width="110">&nbsp;</td>
					<td width="100">&nbsp;</td>
