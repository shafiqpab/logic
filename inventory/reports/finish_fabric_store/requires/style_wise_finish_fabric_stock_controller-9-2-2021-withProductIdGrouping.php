...
if($action=="report_generate")
{
	...
	{
		$product_array=array();
		$sql_product="select id, color, detarmination_id,dia_width,weight from product_details_master where item_category_id=3 and status_active=1 and is_deleted=0";
		...
		foreach( $sql_product_result as $row )
		{
			...
			$product_array[$row[csf('id')]]['weight']=$row[csf('weight')];
			$product_array[$row[csf('id')]]['yarn_did']=$row[csf('detarmination_id')];
		}
		...
		<fieldset style="width:1450px;">
			...
			<div style="width:1440px; max-height:350px; overflow-y:scroll;" id="scroll_body">
				<table width="1420" cellpadding="0" cellspacing="0" border="1" rules="all" class="rpt_table" id="table_body" >
					...
					$sql_query="SELECT a.company_name, a.job_no_prefix_num, a.job_no, a.buyer_name, a.style_ref_no, b.id as po_id, b.po_number as po_no,d.color_id,d.prod_id,c.balance_qnty, $select_fld,
					...
					from  wo_po_details_master a, wo_po_break_down b,inv_transaction c,  order_wise_pro_details d
					where a.job_no=b.job_no_mst and d.po_breakdown_id=b.id and  d.trans_id=c.id and d.entry_form in (17,19,258,209,202) and d.trans_id!=0 and d.entry_form in (17,19,258,209,202)  and c.item_category=3 and d.status_active=1 and d.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and a.company_name=$cbo_company_id $receive_date $buyer_id_cond $search_cond $year_cond
					order by a.job_no,d.color_id,c.transaction_date";
					// echo $sql_query;
					...
					{
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['job_no']=$row[csf('job_no')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['job_no_pre']=$row[csf('job_no_prefix_num')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['year']=$row[csf('year')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['buyer_name']=$row[csf('buyer_name')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['style_ref_no']=$row[csf('style_ref_no')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['po_id'].=$row[csf('po_id')].',';
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['po_no'].=$row[csf('po_no')].',';
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['receive_qnty']+=$row[csf('receive_qnty')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['rec_trns_qnty']+=$row[csf('rec_trns_qnty')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['issue_qnty']+=$row[csf('issue_qnty')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['issue_rtn']+=$row[csf('issue_rtn')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['recv_rtn']+=$row[csf('recv_rtn')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['issue_trns_qnty']+=$row[csf('issue_trns_qnty')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['balance_qnty']+=$row[csf('balance_qnty')];

						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_receive_qnty']+=$row[csf('today_receive_qnty')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_issue_qnty']+=$row[csf('today_issue_qnty')];

						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_trans_in']+=$row[csf('today_trans_in')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_trans_out']+=$row[csf('today_trans_out')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_issue_rtn']+=$row[csf('today_issue_rtn')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_recv_rtn']+=$row[csf('today_recv_rtn')];

						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['finish_fabric_transfer_in']+=$row[csf('finish_fabric_transfer_in')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['finish_fabric_transfer_out']+=$row[csf('finish_fabric_transfer_out')];
					}
			...
			<div style="width:1920px; max-height:350px; overflow-y:scroll;" id="scroll_body">
				<table width="1900" cellpadding="0" cellspacing="0" border="1" rules="all" class="rpt_table" id="table_body" >
					...
					foreach ($nameArray as $row)
					{
						...
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['receive_amount']+=$row[csf('receive_amount')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['transfer_in_amount']+=$row[csf('transfer_in_amount')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['issue_rtn_amount']+=$row[csf('issue_rtn_amount')];

						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['issue_amount']+=$row[csf('issue_amount')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['transfer_out_amount']+=$row[csf('transfer_out_amount')];
						$style_wise_arr[$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['recv_rtn_amount']+=$row[csf('recv_rtn_amount')];
					}
		...
		<fieldset style="width:1740px;">
			...
			<div style="width:1730px; max-height:350px; overflow-y:scroll;" id="scroll_body">
				<table width="1710" cellpadding="0" cellspacing="0" border="1" rules="all" class="rpt_table" id="table_body" >
					...
					$sql_query="
						Select
							a.company_name, a.job_no_prefix_num, a.job_no, a.buyer_name, a.style_ref_no, b.id as po_id, b.po_number as po_no,d.color_id,d.prod_id, c.order_rate, $select_fld,
						...
						where
							...
							and a.company_name = ".$cbo_company_id." $receive_date $buyer_id_cond $search_cond $year_cond
						order by a.job_no,d.color_id";
					...
					foreach ($nameArray as $row)
					{
						...
						$style_wise_arr[$uomFromProductArr[$row[csf('prod_id')]]][$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['today_issue_rtn_qnty']+=$row[csf('today_issue_rtn_qnty')];
						
						$style_wise_arr[$uomFromProductArr[$row[csf('prod_id')]]][$row[csf('job_no')]][$row[csf('color_id')]][$row[csf('prod_id')]]['receive_amount']+=($row[csf('receive_qnty')]*$row[csf('order_rate')]);
	...
	<fieldset style="width:1195px; margin-left:3px">
		...
		<div id="scroll_body" align="center">
			...
			/*	echo	$mrr_sql_trnsf="select a.recv_number,a.knitting_source,a.booking_no,a.knitting_company,a.challan_no, a.receive_date,c.color_id, b.prod_id,b.rack, sum(c.quantity) as quantity from  inv_receive_master a, inv_transaction b, order_wise_pro_details c
					...
					from inv_item_transfer_mst a, inv_item_transfer_dtls d, inv_transaction b, order_wise_pro_details c 
					where a.id=d.mst_id and d.to_trans_id=b.id
					and a.id=b.mst_id and b.id=c.trans_id and b.transaction_type=5 and c. trans_type=5 and a.entry_form in (258) and c.entry_form in (258) and a.item_category=3 
					and a.is_deleted=0 and a.status_active=1 
					and b.status_active=1 and b.is_deleted=0
					and c.po_breakdown_id in($po_id) and a.to_company='$companyID' and c.prod_id=$prod_id and c.color_id='$color'
	...
	<div id="scroll_body" align="center">
		...
		<table border="1" class="rpt_table" rules="all" width="1235" cellpadding="0" cellspacing="0" align="center">
			...
			<tbody>
				...
				and a.id=b.mst_id and b.id=c.trans_id and b.transaction_type=5 and c. trans_type=5 and a.entry_form in (258) and c.entry_form in (258) and a.item_category=3 
				and a.is_deleted=0 and a.status_active=1 
				and b.status_active=1 and b.is_deleted=0 and c.po_breakdown_id in($po_id) and a.to_company='$companyID' and c.prod_id=$prod_id and c.color_id='$color' $today_receive_date  group by a.transfer_system_id, a.challan_no, a.transfer_date,c.color_id, b.prod_id,b.rack, b.order_rate";
		...
		<div id="report_id" align="center">
			...
			<table border="1" class="rpt_table" rules="all" width="1110" cellpadding="0" cellspacing="0" align="left">
                ...
                <tbody>
                    ...
                    from  inv_issue_master a, inv_transaction b, order_wise_pro_details c
                    where a.id=b.mst_id and b.id=c.trans_id and a.entry_form=19 and c.entry_form=19 and a.item_category=3 and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 and c.po_breakdown_id in ($po_id) and a.company_id='$companyID' and c.prod_id=$prod_id and c.color_id='$color' and b.transaction_date <='$from_date'  
					union all  
					...
					from inv_item_transfer_mst a, inv_item_transfer_dtls d, inv_transaction b, order_wise_pro_details c 
					where a.id=d.mst_id and d.trans_id=b.id and a.id=b.mst_id and b.id=c.trans_id and b.transaction_type=6 and c. trans_type=6 and a.entry_form in (258) and c.entry_form in (258) 
					...
					and a.company_id='$companyID' and c.prod_id=$prod_id  and c.color_id='$color' and b.transaction_date<='$from_date'  
            ...
            <table border="1" class="rpt_table" rules="all" width="1110" cellpadding="0" cellspacing="0" align="left">
                ...
                <tbody>
                    ...
                    from  inv_issue_master a, inv_transaction b, order_wise_pro_details c
                    where a.id=b.mst_id and b.id=c.trans_id and a.entry_form=202 and c.entry_form=202 and a.item_category=3 and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 and c.po_breakdown_id in ($po_id) and a.company_id='$companyID' and c.prod_id=$prod_id and c.color_id='$color'";
		...
		<div id="scroll_body" align="center">
			...
			<table border="1" class="rpt_table" rules="all" width="1130" cellpadding="0" cellspacing="0" align="center">
				...
				<tbody>
					...
					from inv_issue_master a, inv_transaction b, order_wise_pro_details c
					where a.id=b.mst_id and b.id=c.trans_id and a.entry_form=202 and c.entry_form=202 and a.item_category=3 and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 and c.po_breakdown_id in ($po_id) and a.company_id='$companyID' and c.prod_id=$prod_id and c.color_id='$color' $today_issue_date 
					union all 
					select a.company_id, a.transfer_system_id as issue_number, a.challan_no,a. transfer_date as issue_date, b.prod_id, c.quantity,c.color_id,c.prod_id,b.rack 
					from inv_item_transfer_mst a, inv_item_transfer_dtls d, inv_transaction b, order_wise_pro_details c 
					where a.id=d.mst_id and d.trans_id=b.id and a.id=b.mst_id and b.id=c.trans_id and b.transaction_type=6 and c. trans_type=6 and a.entry_form in (258) and c.entry_form in (258) 
					and a.item_category=3 and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 and c.po_breakdown_id in ($po_id) 
					and a.company_id='$companyID' and c.prod_id=$prod_id and c.color_id='$color' $today_issue_date 
					group by a.company_id, a.transfer_system_id, a.challan_no, a.transfer_date,c.color_id,c.prod_id,b.rack , c.quantity,b.prod_id";
		...
		<div id="scroll_body" align="center">
			...
			<table border="1" class="rpt_table" rules="all" width="550" cellpadding="0" cellspacing="0" align="center">
				...
				<tbody>
					...
					unset($sql_rec_ret);
					$mrr_sql="SELECT e.id as batch_id, e.batch_no, c.prod_id, c.rack,c.store_id,
					...
					group by e.id, e.batch_no, c.prod_id,c.rack,c.store_id";
			...
			<table border="1" class="rpt_table" rules="all" width="850" cellpadding="0" cellspacing="0" align="center">
				...
				<tbody>
					...
					$mrr_sql="
						...
						where
							b.id=c.trans_id and c.entry_form in(17,19,258,209,202) and b.item_category=3 and c.is_deleted=0 and c.status_active=1 and b.status_active=1 and b.is_deleted=0 and c.po_breakdown_id in (".$po_id.") and c.color_id='".$color."' and c.prod_id=".$prod_id."  and b.transaction_date <='$from_date' 
						group by
