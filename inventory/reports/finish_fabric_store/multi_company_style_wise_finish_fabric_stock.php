...
<script>
	...
	function generate_report(type)
	{
		...
		else if(type == "2")
		{
			...
			if( form_validation('txt_no_col*txt_range','No of Col*Range')==false )
			{
				return;
			}
			var data="action=report_generate2"+get_submitted_data_string('cbo_company_id*txt_date_from*cbo_buyer_id*cbo_year*cbo_report_type*cbo_search_by*cbo_value_range_by*txt_search_comm*cbo_store_id*cbo_location_id*cbo_uom*txt_no_col*txt_range',"../../../")+'&report_title='+report_title;
			btn_type=2;
		}
		else if(type == "6")
		{
	...
	function generate_report_reponse()
	{
		if(http.readyState == 4)
		{
			...
			{
				var ids="['total_stock_td'";var cols="[15";var operations="['sum'";var write_methods="['innerHTML'";var i=1;
				for(i;i<reponse[3]*1;i++){
					ids+=",'age_"+i+"'";
					cols+=","+(15+i);
					operations+=",'sum'";
					write_methods+=",'innerHTML'";
				}
				//ids+=",'total_amount_id']";cols+=","+(i+16)+"]";operations+=",'sum']";write_methods+=",'innerHTML']";
				ids+="]";cols+="]";operations+="]";write_methods+="]";
					var tableFilters = 
					{
						col_operation: {
						id: eval(ids),
...
<div style="width:100%;" align="center">
    ...
    <h3 style="width:1820px; margin-top:20px;" align="" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
                ...
                <table class="rpt_table" width="1820" cellpadding="0" cellspacing="0" border="1" rules="all">
                    <thead>
                        <tr>
                            ...
                            <th width="75">Date</th>
							<th width="30" title="This field for Ageing button">No. of Col.</th>
                            <th width="30"  title="This field for Ageing button">Range</th>
                    ...
                    <tr align="center" class="general">
                        ...
                        <td>
							...
							<input type="button" name="search" id="search" value="Ageing Report" onClick="generate_report(2)" style="width:80px" class="formbutton" />
                        </td>
                    </tr>
                </table>
            </fieldset>
