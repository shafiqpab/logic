             ...
             <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
               <thead>
                ...
                <tr class="general">
                    ...
                    <td align="center">
                        <input name="txt_style_ref_number" id="txt_style_ref_number"ondblclick="openmypage_style()" onKeyUp="fnc_chng_jobNo(this.value)" class="text_boxes" placeholder="Browse or Write" style="width:70px"  />
                    </td>
