...
if($action=='create_product_search_list_view')
{
	...
	$sql="SELECT a.id, a.company_id, a.supplier_id, a.product_name_details, a.lot, a.current_stock, a.brand, sum((case when b.transaction_type in(1,4,5) then b.cons_quantity else 0 end)-(case when b.transaction_type in(2,3,6) then b.cons_quantity else 0 end)) as balance_quantity, b.store_id, b.floor_id, b.room, b.rack, b.self, b.bin_box
	...
	group by a.id, a.company_id, a.supplier_id, a.product_name_details, a.lot, a.current_stock, a.brand, b.store_id, b.floor_id, b.room, b.rack, b.self, b.bin_box
...
if($action=='populate_data_from_product_master')
{
	...
	$data_string = $data_ref[0];
	//$store_id=$data_ref[1];

	$data_pro_ref=explode("_",$data_string);
	...
	$data_array=sql_select("SELECT a.product_name_details, a.lot, a.current_stock, a.avg_rate_per_unit, a.brand, sum((case when b.transaction_type in(1,4,5) then b.cons_quantity else 0 end)-(case when b.transaction_type in(2,3,6) then b.cons_quantity else 0 end)) as balance_quantity, b.store_id, b.company_id, b.floor_id, b.room, b.rack, b.self, b.bin_box  
	from product_details_master a, inv_transaction b 
	where a.id=b.prod_id and a.id=$prod_id and b.store_id=$store_id and a.status_active=1 and b.status_active=1 $sqlCon
	group by a.product_name_details, a.lot, a.current_stock, a.avg_rate_per_unit, a.brand, b.company_id, b.store_id, b.floor_id, b.room, b.rack, b.self, b.bin_box");
