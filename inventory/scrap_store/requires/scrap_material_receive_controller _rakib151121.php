...
if($action=="create_item_description_search_list_view")
{
	...
	$batch_arr = return_library_array( "select id, batch_no from pro_batch_create_mst where status_active=1",'id','batch_no');
	...
	if($receive_basis == 1) //scrap receive basis -> Receive-Reject
	{
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_reject_qnty as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, $selet_lot_cond as LOT, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.recv_number as SYSTEM_ID
		from inv_receive_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id $transaction_type_cond $company $system_id_cond $category_cond $transaction_date_cond $store_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 		
	...
	elseif ($receive_basis == 2) //scrap receive basis -> Issue Damage
	{
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, $selet_lot_cond as LOT, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.issue_number as SYSTEM_ID
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose in (26) $transaction_type_cond $company $system_id_cond $category_cond  $transaction_date_cond $store_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by c.issue_number desc";
	} 
	elseif ($receive_basis == 3) //scrap receive basis -> Issue Scrap store
	{
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_quantity as CONS_QNTY,a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, $selet_lot_cond as LOT, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.issue_number as SYSTEM_ID
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose=31 $transaction_type_cond $company $system_id_cond $category_cond  $transaction_date_cond $store_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by c.issue_number desc ";
	}   
	//echo $sql;
	...
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1100" class="rpt_table" id="html_search">
		...
		<tbody id="list_view">
			...
			foreach ($description_resutl as $value) 
			{
				...
				?>
				<tr bgcolor="<?= $bgcolor; ?>" style="cursor:pointer;" onClick='js_set_value("<? echo $value["MST_ID"]."__".$value["TRANS_ID"]."__".$value["PROD_ID"]; ?>")'>
					<td width="40" align="center"><?= $i;?></td>
					<td width="80" align="center"><p><?= $value["PROD_ID"]; ?></p></td>
					<td width="100" align="center"><?= $value["SYSTEM_ID"]; ?></td>
...
if($action=="show_product_listview")
{
	...
	//$system_id = $data[6];
	if ($company_id!=0) $company=" and a.company_id=$company_id"; else $company="";
	if ($cbo_category_id!=0) $category_cond=" and a.item_category=$cbo_category_id"; else $category_cond="";
	//if ($data[4]!=0) $store_cond=" and a.store_id='$data[4]'"; else $store_cond="";
	...
	if($receive_basis == 1) //scrap receive basis -> Receive-Reject
	{
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_reject_qnty as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.recv_number as SYSTEM_ID
		from inv_receive_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and a.mst_id=$mst_id $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by b.id desc";  //b.LOT,
	} 
	elseif ($receive_basis == 2) //scrap receive basis -> Issue Damage
	{
		$transaction_type_cond = "  and a.transaction_type in(2,3,6) ";
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.issue_number as SYSTEM_ID
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose in (26) and a.mst_id=$mst_id $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by b.id desc";
	} 
	elseif ($receive_basis == 3) //scrap receive basis -> Issue Scrap store
	{
		$transaction_type_cond = "  and a.transaction_type in(2,3,6)";
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.issue_number as SYSTEM_ID
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose=31 and a.mst_id=$mst_id $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by b.id desc";
	}   
    	...
    	<table class="rpt_table" border="1" cellpadding="2" cellspacing="0" rules="all" width="290">
            ...
            <tbody>
            	...
            	foreach($sql_res as $row)
            	{
					...
					?>
                	<tr bgcolor="<? echo $bgcolor; ?>" onClick='get_php_form_data("<? echo $row["TRANS_ID"]."**".$row["PROD_ID"]."**".$receive_basis; ?>","populate_data_from_product_list_view","requires/scrap_material_receive_controller")' style="cursor:pointer" >
...
if($action=="show_product_listview_aftersave")
{
	...
	if($receive_basis == 1) //scrap receive basis -> Receive-Reject
	{
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_reject_qnty as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.recv_number as SYSTEM_ID
		from inv_receive_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and a.mst_id in($mst_id) $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by b.id desc";  //b.LOT,
	} 
	elseif ($receive_basis == 2) //scrap receive basis -> Issue Damage
	{
		$transaction_type_cond = "  and a.transaction_type in(2,3,6) ";
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.issue_number as SYSTEM_ID
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose=26 and a.mst_id in($mst_id) $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by b.id desc";
	} 
	elseif ($receive_basis == 3) //scrap receive basis -> Issue Scrap store
	{
		$transaction_type_cond = "  and a.transaction_type in(2,3,6)";
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.issue_number as SYSTEM_ID
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose=31 and a.mst_id in($mst_id) $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by b.id desc";
	}   
...
if($action=="populate_data_from_product_list_view")
{
	...
	if ($receive_basis==1) //scrap receive basis -> Receive-Reject
	{
		$transaction_type_cond = "  and a.transaction_type in(1,4,5)";	
		$reject_qnty_cond = " and a.cons_reject_qnty > 0";
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_reject_qnty, a.cons_reject_qnty as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, c.recv_number as SYSTEM_ID, $selet_lot_cond as LOT
		from inv_receive_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and a.id=$trans_id $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by b.id desc";
	}
	else if ($receive_basis==2) //scrap receive basis -> Issue Damage
	{
		$transaction_type_cond = "  and a.transaction_type in(2,3,6) ";
		$reject_qnty_cond = " and a.cons_quantity > 0";
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_reject_qnty, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, C.ISSUE_NUMBER as SYSTEM_ID, $selet_lot_cond as LOT
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose in (26) and a.id=$trans_id $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by b.id desc";
	}
	if ($receive_basis==3) //scrap receive basis -> Issue Scrap store
	{
		...
		$sql= "SELECT a.id as TRANS_ID, a.MST_ID, a.STORE_ID, a.TRANSACTION_DATE, a.cons_reject_qnty, a.cons_quantity as CONS_QNTY, a.TRANSACTION_TYPE, a.BODY_PART_ID, a.PI_WO_BATCH_NO, b.id as PROD_ID, b.ITEM_GROUP_ID, b.ITEM_CATEGORY_ID, b.PRODUCT_NAME_DETAILS, b.UNIT_OF_MEASURE, b.CURRENT_STOCK, b.COLOR, b.ITEM_COLOR, b.GSM, b.BRAND, b.DIA_WIDTH, b.ITEM_SIZE, b.AVG_RATE_PER_UNIT, C.ISSUE_NUMBER as SYSTEM_ID, $selet_lot_cond as LOT
		from inv_issue_master c, inv_transaction a, product_details_master b
		where c.id=a.mst_id and a.prod_id=b.id and c.issue_purpose=31 and a.id=$trans_id $transaction_type_cond $company $category_cond $reject_qnty_cond $previous_scrap_received_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by b.id desc";
	}
	...
	foreach ($nameArray as $row)
	{
		...
		echo "document.getElementById('txt_color').value		 = '".$row["COLOR"]."';\n";
...
if($action=="create_scrap_receive_independent_search_list_view")
{
	...
	$sql_cond = '';
	if(trim($txt_item_description) != '')
	{
			$sql_cond= " and product_name_details LIKE '%$txt_item_description%'";
	} 
	if(trim($cbo_item_group) !=0)
	{
			$sql_cond= " and ITEM_GROUP_ID='$cbo_item_group'";
	} 
	if(trim($txt_prod_id) != '')
	{
			 $sql_cond= " and id LIKE '%$txt_prod_id%'";
	}  
	if(trim($txt_item_size) != '')
	{
			 $sql_cond= " and item_size LIKE '%$txt_item_size%'";
	}   
	
 	$sql = "select id,item_category_id,item_group_id,sub_group_name,item_description as product_name_details,item_code,item_number,item_size,unit_of_measure,current_stock,color,item_color,gsm,brand,dia_width,avg_rate_per_unit from product_details_master where company_id=$company and item_category_id=$cbo_item_cat and item_description is not null $sql_cond and status_active=1 and is_deleted=0";
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)  // Insert Here
	{
		...
		if(str_replace("'","",$update_id)=="")
		{
			...
			$field_array="id, receive_no_prefix,receive_no_prefix_num,sys_receive_no,company_id,item_category_id,location,store_id,from_store_id,entry_form,receive_date,receive_basis,currency,exchange_rate,challan_no,mst_id,remarks,inserted_by,insert_date,status_active,is_deleted";

			$data_array="(".$id.",'".$new_system_id[1]."',".$new_system_id[2].",'".$new_system_id[0]."',".$cbo_company_name.",".$cbo_category_id.",".$cbo_location.",".$cbo_store.",".$cbo_from_store.",0,".$txt_receive_date.",".$cbo_receive_basis.",".$cbo_currency.",".$txt_exchange_rate.",".$txt_system_challan_no.",".$txt_mst_id.",".$txt_remarks_mst.",".$user_id.",'".$pc_date_time."',1,0)";
...
if($action=="show_dtls_list_view")
{
	...
	<div style="width:max-height:180px;" id="scrap_list_view" align="left">
		...
		<?
			$i=1;
			/*$sql_list_view = "SELECT a.ID, b.MST_ID, sum(b.receive_qnty) as RECEIVE_QNTY, b.RATE, sum(b.amount) as AMOUNT, b.REMARKS, b.BODY_PART, b.DIA_TYPE, b.BOOK_CURRENCY, b.NO_OF_BAGS, b.TRANS_ID, b.ITEM_GROUP_ID, c.id as PRODUCT_ID, c.PRODUCT_NAME_DETAILS, c.UNIT_OF_MEASURE, c.COLOR, b.LOT, c.GSM, c.DIA_WIDTH  from  inv_scrap_receive_mst a, inv_scrap_receive_dtls b, product_details_master c	where a.id=b.mst_id and b.product_id = c.id and b.mst_id='$data' and b.status_active=1 and b.is_deleted=0 and a.status_active=1 group by a.id, b.mst_id, b.rate, b.remarks, b.body_part, b.dia_type, b.book_currency, b.no_of_bags, b.trans_id, b.item_group_id, c.id, c.product_name_details, c.unit_of_measure, c.color, b.lot, c.gsm, c.dia_width";*/

			$sql_list_view = "SELECT a.ID, b.MST_ID, sum(b.receive_qnty) as RECEIVE_QNTY, b.RATE, sum(b.amount) as AMOUNT, b.REMARKS, b.BODY_PART, b.DIA_TYPE, b.BOOK_CURRENCY, b.NO_OF_BAGS, b.TRANS_ID, b.ITEM_GROUP_ID, c.id as PRODUCT_ID, c.PRODUCT_NAME_DETAILS, c.UNIT_OF_MEASURE, c.COLOR, b.LOT, c.GSM, c.DIA_WIDTH, B.TRANS_REF, B.MATERIAL_PLACEMENT, B.BUYER_ID, B.SUPPLIER_ID
			from  inv_scrap_receive_mst a, inv_scrap_receive_dtls b, product_details_master c	where a.id=b.mst_id and b.product_id = c.id and b.mst_id='$sys_id' and b.status_active=1 and b.is_deleted=0 and a.status_active=1
			group by a.id, b.mst_id, b.rate, b.remarks, b.body_part, b.dia_type, b.book_currency, b.no_of_bags, b.trans_id, b.item_group_id, c.id, c.product_name_details, c.unit_of_measure, c.color, b.lot, c.gsm, c.dia_width, B.TRANS_REF, B.MATERIAL_PLACEMENT, B.BUYER_ID, B.SUPPLIER_ID";
			// echo $sql_list_view;
			...
			foreach($sqlResult as $row)
			{
				if ($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
				?>
                <tr bgcolor="<?= $bgcolor; ?>" style="text-decoration:none; cursor:pointer" onClick="get_php_form_data('<? echo $row['ID'].'__'.$row['PRODUCT_ID']; ?>','populate_scrap_dtls_form_data','requires/scrap_material_receive_controller');" >
...
if ($action=="populate_scrap_dtls_form_data")
{
	...
	$color_arr=return_library_array("select id, color_name from lib_color where status_active=1 and is_deleted=0",'id','color_name');
	$sql_name_array = "SELECT a.ID, b.id as DTLS_ID, b.MST_ID, b.RECEIVE_QNTY, b.RATE, b.AMOUNT, b.FROM_STORE_ID, b.REMARKS, b.BODY_PART,BODY_PART_ID, b.DIA_TYPE, b.BOOK_CURRENCY, b.NO_OF_BAGS, c.ITEM_GROUP_ID, c.id as PRODUCT_ID, c.PRODUCT_NAME_DETAILS, c.UNIT_OF_MEASURE, c.COLOR, b.LOT, c.GSM, c.DIA_WIDTH, B.COUNT, B.ITEM_SIZE, B.BUYER_ID, B.SUPPLIER_ID, B.MATERIAL_PLACEMENT, B.TRANS_REF, A.RECEIVE_BASIS
	from inv_scrap_receive_mst a, inv_scrap_receive_dtls b, product_details_master c
	where a.id=b.mst_id and b.product_id=c.id and a.id='$data[0]' and b.product_id='$data[1]' and b.status_active=1 and b.status_active=1 and a.status_active=1 and c.status_active=1 and c.is_deleted=0 order by id desc";
	// echo $sql_name_array;
...
if($action=="create_mrr_scrap_receive_search_list_view")
{
    ...
    $sql= "SELECT a.ID, a.SYS_RECEIVE_NO, a.COMPANY_ID, a.ITEM_CATEGORY_ID, a.LOCATION, a.STORE_ID, a.RECEIVE_DATE, a.RECEIVE_BASIS, sum(b.receive_qnty) as RECEIVE_QNTY, b.PRODUCT_ID, b.LOT
