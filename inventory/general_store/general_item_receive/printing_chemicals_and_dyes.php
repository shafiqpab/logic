...
<?
if($_SESSION['logic_erp']['mandatory_field'][599]!="")
{
	$mandatory_field_arr= json_encode( $_SESSION['logic_erp']['mandatory_field'][599] );
...
function fnc_general_item_receive_entry(operation)
{
	...
	else if(operation==0 || operation==1 || operation==2)
	{
		...
		if( form_validation('cbo_company_name*cbo_receive_basis*txt_receive_date*cbo_store_name*cbo_currency*cbo_source*cbo_item_category*cbo_item_group*txt_item_desc*txt_receive_qty*txt_rate','Company Name*Receive Basis*Receive Date*Store Name*Currency*Source*Item Category*Item Group*Item Description*Receive Quantity*Rate')==false )
		{
			return;
		}
		...
		if('<? echo implode('*',$_SESSION['logic_erp']['mandatory_field'][599]); ?>') 
		{
			if (form_validation('<? echo implode('*',$_SESSION['logic_erp']['mandatory_field'][599]); ?>','<? echo implode('*',$_SESSION['logic_erp']['mandatory_message'][599]); ?>')==false) {release_freezing();return;}
		}
		...
		var dataString = "txt_mrr_no*hidden_mrr_id*cbo_company_name*cbo_receive_basis*txt_receive_date*cbo_receive_purpose*txt_challan_no*cbo_loan_party*txt_lc_no*hidden_lc_id*cbo_store_name*cbo_supplier*cbo_currency*txt_exchange_rate*cbo_pay_mode*cbo_source*txt_wo_pi_req*txt_wo_pi_req_id*txt_remarks*cbo_item_category*cbo_item_group*txt_item_desc*txt_serial_no*txt_serial_qty*cbo_uom*txt_receive_qty*txt_rate*txt_ile*txt_amount*txt_book_currency*txt_order_qty*txt_warranty_date*cbo_floor*txt_room*txt_rack*txt_self*txt_binbox*current_prod_id*txt_prod_id*update_id*txt_sup_ref*txt_referance*txt_addi_info*txt_manufac_date*txt_lot*txt_boe_mushak_challan_no*txt_boe_mushak_challan_date";
...
function open_mrrpopup()
{
	...
	var company = $("#cbo_company_name").val();
	var page_link='requires/general_item_receive_controller.php?action=mrr_popup&company='+company+'&item_category=22';
	...
	emailwindow.onclose=function()
	{
		...
		{
			show_list_view($("#cbo_receive_basis").val()+"**"+$("#txt_wo_pi_req_id").val()+"**22",'show_product_listview','list_product_container','requires/general_item_receive_controller','');
		}
		set_button_status(0, permission, 'fnc_general_item_receive_entry',1,1);
 	}
}
...
function independence_basis_controll_function(data)
{
    ...
    var data='cbo_company_id='+data+'&item_category=22&action=upto_variable_settings';
    ...
    xmlhttp.onreadystatechange = function() 
    {
        if (this.readyState == 4 && this.status == 200) 
		{
            ...
            document.getElementById("store_update_upto").value = response[0];
			document.getElementById("variable_lot").value = response[1];				
        }
    }
                 	...
                 	<fieldset style="width:900px;">
                        <table  width="880" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                           ...
                           <tr>
                                ...
                                <td width="170">
                                <?
                                echo create_drop_down( "cbo_company_name", 170, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond $company_credential_cond order by company_name","id,company_name", 1, "-- Select --", $selected, "load_drop_down( 'requires/general_item_receive_controller', this.value, 'load_drop_down_supplier', 'supplier' );load_drop_down( 'requires/general_item_receive_controller', this.value+'_'+22, 'load_drop_down_store', 'store_td' );load_drop_down( 'requires/general_item_receive_controller', this.value, 'load_drop_down_loan_party', 'loan_party_td'); independence_basis_controll_function(this.value);" );
                                ?>
                            ...
                            <tr>
                            	<td  width="120" >Receive Purpose </td>
                                <td width="170">
                                    <?
                                      echo create_drop_down( "cbo_receive_purpose", 170, $yarn_issue_purpose,"", 1, "-- Select Purpose --", 0, "", "","0");
                                    ?>
                                </td>
                                <td>Loan Party </td>
                                <td id="loan_party_td">
                            ...
                            <tr>
                                ...
                                <td ><input class="text_boxes"  type="text" name="txt_wo_pi_req" id="txt_wo_pi_req" onDblClick="openmypage('xx','Order Search','22')"  placeholder="Double Click" style="width:160px;"  readonly disabled />
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="txt_addi_popup" name="txt_addi_popup" class="text_boxes" style="width:160px;" onDblClick="open_additional_info_popup()" placeholder="Double Click" readonly >
                    ...
                    <td width="49%" valign="top">
                        ...
                        <table width="250" cellspacing="2" cellpadding="0" border="0" style="float:left">
                                <tr>
                                        ...
                                        <td width="130">
                                            <?
                                                echo create_drop_down( "cbo_item_category", 130, $item_category,"", 1, "-- Select --", 0, "load_drop_down( 'requires/general_item_receive_controller', this.value, 'load_drop_down_itemgroup', 'item_group_td' );", 0,"22" );
                                            ?>
                                        </td>
                                </tr>
                                <tr>
