...
function popup_description()
{
	...
	var cbo_store_name = $("#cbo_store_name").val();
 	var page_link="requires/general_item_issue_controller.php?action=item_description_popup&company_id="+company_id+"&cbo_store_name="+cbo_store_name+'&item_cat=11';
...
{	
	if(http.readyState == 4) 
	{
		...
		reset_form('','','txt_item_desc*txt_buyer_order*txt_order_id*cbo_floor*cbo_room*cbo_item_category*cbo_rack*cbo_item_group*txt_serial_no*txt_serial_id*cbo_self*hidden_p_issue_qnty*txt_issue_qnty*txt_current_stock*cbo_binbox*cbo_machine_category*cbo_issue_floor*cbo_machine_name*txt_return_qty','','','');   
...
function open_mrrpopup()
{
	...
	var company = $("#cbo_company_name").val();	
	var page_link='requires/general_item_issue_controller.php?action=mrr_popup&company='+company+'&item_cat=11';
...
{
   var status = return_global_ajax_value(company, 'chk_issue_requisition_variabe', '', 'requires/general_item_issue_controller').trim();
   status = status.split("**");
   if(status[0] == 1)
   {
...
function fnc_items_sys_popup()
{
    ...
    var page_link='requires/general_item_issue_controller.php?cbo_company_name='+cbo_company_name+'&action=item_issue_requisition_popup_search&item_category_id=11';
    ...
    emailwindow.onclose=function()
    {
        ...
        if(trim(hidden_item_issue_id)!="")
        {
			...
			show_list_view(data[0]+'__11','show_item_issue_listview','item_issue_listview','requires/general_item_issue_controller','../');
        }
        //release_freezing();
    }
}
                 	...
                 	<fieldset style="width:950px;">                                       
                        <table  width="950" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                           ...
                           <tr>
                                    ...
                                    <td width="170">
                                        <? 
                                         echo create_drop_down( "cbo_company_name", 170, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond $company_credential_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/general_item_issue_controller', this.value, 'load_drop_down_location', 'location_td' );load_drop_down( 'requires/general_item_issue_controller', this.value+'__'+11, 'load_drop_down_store', 'store_td' );load_drop_down( 'requires/general_item_issue_controller', this.value, 'load_drop_down_department', 'department_td' );chk_issue_requisition_variabe(this.value);" );
                                        ?>
                                    </td>
                                    <td width="120" class="must_entry_caption">Issue Purpose</td>
                                    <td width="160"><? 
                                         echo create_drop_down( "cbo_issue_purpose", 170, $general_issue_purpose,"", 1, "-- Select Purpose --", $selected, "","" );
                                        ?></td>
                                    <td width="120" class="must_entry_caption">Issue Date</td>
                                    <td width="" id="issue_purpose_td"><input type="text" name="txt_issue_date" id="txt_issue_date" class="datepicker" style="width:160px;" value="<? echo date("d-m-Y",time());?>"  placeholder="Select Date" readonly /></td>
                            </tr>
                            <tr>                           
                            ...
                            <tr>
                                ...
                                <td width="" colspan="3"><input type="text" name="txt_remarks" id="txt_remarks" class="text_boxes" style="width:455px"  placeholder="Entry" /></td>
                            </tr>
                            <tr>
                        ...
                        <legend>New Issue Item</legend>                                     
                            <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<?
                                                echo create_drop_down( "cbo_item_category", 150, $item_category,"", 1, "-- Select --", 0, "load_drop_down( 'requires/general_item_issue_controller', this.value, 'load_drop_down_itemgroup', 'item_group_td' );", 1,"11" );
                                            ?>
                                    </td>
                                    <td >UOM</td>
                                    <td id="uom_td"><?
                                        ...
                                        ?></td>
                                    <td>Buyer Order</td>
                                    <td><input type="text" name="txt_buyer_order" id="txt_buyer_order" class="text_boxes" style="width:110px;" placeholder="Double Click" onDblClick="fn_order()"  />
