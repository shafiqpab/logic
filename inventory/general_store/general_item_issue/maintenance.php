...
function popup_description()
{
	...
	var cbo_store_name = $("#cbo_store_name").val();
 	var page_link="requires/general_item_issue_controller.php?action=item_description_popup&company_id="+company_id+"&cbo_store_name="+cbo_store_name+'&item_cat=16';
...
{	
	if(http.readyState == 4) 
	{
		...
		reset_form('','','txt_item_desc*txt_buyer_order*txt_order_id*cbo_floor*cbo_room*cbo_item_category*cbo_rack*cbo_item_group*txt_serial_no*txt_serial_id*cbo_self*hidden_p_issue_qnty*txt_issue_qnty*txt_current_stock*cbo_binbox*cbo_machine_category*cbo_issue_floor*cbo_machine_name*txt_return_qty*cbo_use_for','','','');   
...
function open_mrrpopup()
{
	...
	var company = $("#cbo_company_name").val();	
	var page_link='requires/general_item_issue_controller.php?action=mrr_popup&company='+company+'&item_cat=16';
...
function fnc_items_sys_popup()
{
    ...
    var page_link='requires/general_item_issue_controller.php?cbo_company_name='+cbo_company_name+'&action=item_issue_requisition_popup_search&item_category_id=16';
    ...
    emailwindow.onclose=function()
    {
        ...
        if(trim(hidden_item_issue_id)!="")
        {
			...
			show_list_view(data[0]+'__16','show_item_issue_listview','item_issue_listview','requires/general_item_issue_controller','');
        }
        release_freezing();
    }
}
                        ...
                        <legend>New Issue Item</legend>                                     
                            <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<?
                                                echo create_drop_down( "cbo_item_category", 150, $item_category,"", 1, "-- Select --", 0, "load_drop_down( 'requires/general_item_issue_controller', this.value, 'load_drop_down_itemgroup', 'item_group_td' );", 1,"16" );
                                            ?>
                                    </td>
                                    <td >UOM</td>
                                    <td id="uom_td"><?
                                ...
                                <tr>
                                    ...
                                    <td>
									<? 
                                    echo create_drop_down( "cbo_use_for", 150, $use_for,"", 1, "-- Select --", "", "" );
                                    ?>
                                    </td>
                                    ...
                                    <td>Brand</td>
                                    <td>
                                        <input type="text" name="txt_brand" id="txt_brand" class="text_boxes"  style="width:120px;" readonly disabled/>
                                    </td>
                                    <td>Origin</td>
                                    <td><?
                                   ...
                                   <td>Model</td>
                                    <td>
                                        <input type="text" name="txt_model" id="txt_model" class="text_boxes"  style="width:100px;" readonly disabled/>
                                    </td>
                                    <td colspan="6"></td>
                                </tr>
                                <tr>
