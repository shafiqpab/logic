...
function popup_description()
{
	...
	var cbo_store_name = $("#cbo_store_name").val();
 	var page_link="requires/general_item_issue_controller.php?action=item_description_popup&company_id="+company_id+"&cbo_store_name="+cbo_store_name+'&item_cat=15'; 
...
function open_mrrpopup()
{
	...
	var company = $("#cbo_company_name").val();	
	var page_link='requires/general_item_issue_controller.php?action=mrr_popup&company='+company+'&item_cat=15';
...
function fnc_items_sys_popup()
{
    ...
    var page_link='requires/general_item_issue_controller.php?cbo_company_name='+cbo_company_name+'&action=item_issue_requisition_popup_search&item_category_id=15';
    ...
    emailwindow.onclose=function()
    {
        ...
        if(trim(hidden_item_issue_id)!="")
        {
			...
			show_list_view(data[0]+'__15','show_item_issue_listview','item_issue_listview','requires/general_item_issue_controller','');
        }
        release_freezing();
    }
}
                        ...
                        <legend>New Issue Item</legend>                                     
                            <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<?
                                                echo create_drop_down( "cbo_item_category", 150, $item_category,"", 1, "-- Select --", 0, "load_drop_down( 'requires/general_item_issue_controller', this.value, 'load_drop_down_itemgroup', 'item_group_td' );", 1,"15" );
                                            ?>
                                    </td>
                                    <td >UOM</td>
                                    <td id="uom_td"><?
