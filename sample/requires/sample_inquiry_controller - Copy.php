...
{
		$purpose=array(1=>"Presentation",2=>"Buyer Selected",3=>"Unknown and  Adjustment");
		$history=sql_select("SELECT a.id,a.pos_re_date,a.issue_date,a.gifted_to,a.issue_purpose,b.receive_date from sample_issue_mst a,sample_receive_mst b  where a.id=b.id and   item_barcode='$data'   order by issue_date Asc");
	?>
    <table border="1" cellspacing="0" class="rpt_table" rules="all" width="720" >
		<tr>
