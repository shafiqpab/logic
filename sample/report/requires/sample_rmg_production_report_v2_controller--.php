...
$reqId_cond3=where_con_using_array($reqIdArr,0,'a.sample_development_id');
    ...
    $all_data_arr=array(); 
          $prod_sql="SELECT a.sample_development_id as smp_dev_id,a.company_id, b.sample_dtls_row_id, b.sample_name, b.item_number_id, b.embel_name, b.sewing_date, b.entry_form_id, b.qc_pass_qty as qc_pass_qty, b.reject_qty as reject,c.color_id 
            ...
            group by  a.sample_development_id,a.company_id, b.sample_dtls_row_id, b.sample_name, b.item_number_id, b.embel_name, b.sewing_date, b.entry_form_id, b.qc_pass_qty, b.reject_qty,c.color_id";
    ...
    foreach($prod_sql_data as $val)
    {
        ...
        unset($prod_sql2_data);
            ...
            ?>
       <div>
        <table cellspacing="0" cellpadding="0" border="1" class="rpt_table" width="3300" rules="all" id="table_header" >
            <thead>
                <tr>
                    <th width="30">SL </th>
                    ...
                    <th width="100">Finish Fabric required qty</th>
        ...
        <div style="max-height:320px; overflow-y:scroll; width:3320px;" id="scroll_body">
        <table cellspacing="0" cellpadding="0" border="1" class="rpt_table"  width="3300" rules="all" id="table_body">
            <tbody>
            <?
            ...
            foreach ($req_wise_data_arr as $req_key => $sample_data)
            {
                foreach ($sample_data as $sample_key => $gmts_data)
                {
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_2nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_2nd<? echo $i; ?>">
                        ...
                        <td width="95" align="center" rowspan="<?=$rowspan;?>" title="<?=$value['id'];?>"><? echo  $req_id_arr[$req_key]; ?></td>
                        <td width="110" style="word-break:break-all" rowspan="<?=$rowspan;?>" title="<?='Sample Stage id='.$value['sample_stage_id'];?>"><? echo $sample_name_arr[$sample_key]; ?></td>
                        ...
                        <td width="100" style="word-break:break-all" rowspan="<?=$rowspan;?>" align="right"><?  echo $sample_req_data_arr[$req_key][$sample_key]['fin_fab_req_qty']; ?></td>
                        ...
                        <td width="120" style="word-break:break-all" title="<?=$color_key;?>"><? echo $color_arr[$color_key]; ?></td>
       ...
       <table cellspacing="0" cellpadding="0" border="1" rules="all" width="3300" class="rpt_table" id="report_table_footer">
		 <tfoot>
...
if($action=="details_view")
{
  ...
  <fieldset>
    ...
    if($entry_form==396){
        ...
        $sql= "SELECT a.sample_development_id as smp_dev_id,a.company_id,b.sewing_date, b.sample_dtls_row_id, b.sample_name, b.item_number_id, b.embel_name,c.color_id , b.entry_form_id, b.qc_pass_qty, b.reject_qty 
        ...
        group by a.sample_development_id ,a.company_id,b.sewing_date, b.sample_dtls_row_id, b.sample_name, b.item_number_id, b.embel_name,c.color_id ,b.entry_form_id, b.qc_pass_qty, b.reject_qty";
    }
	//echo  $sql;
