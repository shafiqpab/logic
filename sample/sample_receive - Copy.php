...
<fieldset style="width:850px;">
    <form name="samplereceive_1" id="samplereceive_1">	
                     ...
                     <fieldset style="width:350px; float:left;">
                        ...
                        <table cellpadding="0" cellspacing="1" width="300" align="center" id="sample_re">
                            ...
                            <tr>
                                ...
                                <td valign="top">
                                    <input type="text"  name="txt_item" id="txt_item" class="text_boxes" style="width:200px" 
                                    placeholder="Write">
                                </td>			
                            </tr>
                            <tr>
                    ...
                    <fieldset style="height:200px; float:left;" >
                        ...
                        <table cellpadding="0" cellspacing="1" width="300"  align="center">
                            <tr>
                                ...
                                <td colspan="3">
                                    <? 
                                    echo create_drop_down( "cbo_fabric_natu", 212, $item_category,"", 1, "-- Select --", 1,$onchange_func, 
                                    $is_disabled, '2,3');		
                                    ?>						
                                </td>
                            </tr>	
                            <tr>
                                ...
                                <td>
                                    <input type="text" id="txt_construction" name="txt_construction" class="text_boxes" style="width:200px"
                                    placeholder="Write" onFocus="add_auto_complete(1)" />
                                </td>
                            </tr>
                            <tr>
                                <td  align="right">Composition</td>
                                <td >
                                    <input type="text" id="txt_Composition" name="txt_Composition" class="text_boxes" style="width:200px" 
                                    placeholder="Write" onFocus="add_auto_complete(1)" />
                                </td>			
                            </tr>
                            <tr>
                                ...
                                <td valign="top">
                                    <input type="text" id="txt_gsm" name="txt_gsm" class="text_boxes_numeric" style="width:200px" 
                                    placeholder="Write">
                                </td>			
                            </tr>
                            <tr>
...
<!--<fieldset style="width:300px;margin-top:10px;">
    ...
    <div style="width:810px; margin-top:10px;" id="sample_list_view" align="left">
        <? /*
            ...
            $arr=array (1=>$sample_category,3=>$sample_source,4=>$supplier_name);
        
        echo  create_list_view ( "list_view", "Receive Date,Category,Item,Source,Supplier,Designer,Quantity", "100,100,150,100,100,100","800","220",0, "select id,receive_date,category_id,item_id,source_id,produced_by_id,designer,quantity from sample_receive_mst where is_deleted=0", "get_php_form_data", "id", "'load_php_data_to_form'", 1, "0,category_id,0,source_id,produced_by_id", $arr , "receive_date,category_id,item_id,source_id,produced_by_id,designer,quantity", "requires/sample_receive_controller", 'setFilterGrid("list_view",-1);','3,0,0,0') ;*/
        ?>
    </div>
</fieldset>	-->
</form>	
...
<!--<script type="text/javascript">show_list_view('', 'search_list_view', 'sample_list_view', 'requires/sample_receive_controller', 'setFilterGrid("list_view",-1)');	
</script>-->
</html>