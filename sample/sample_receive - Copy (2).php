            ...
            <tr>
                <td>
                     <fieldset style="width:350px; float:left;">
                    	...
                    	<input type="button" class="image_uploader" style="width:192px" value="CLICK TO ADD/VIEW IMAGE" onClick="file_uploader ( '../', document.getElementById('update_id').value,'', 'sample_receive', 0 ,1)">
                    		</td>
