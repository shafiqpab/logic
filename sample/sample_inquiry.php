    ...
    <form name="sampleissue_1" id="sampleissue_1">	
        ...
        <table cellpadding="0" cellspacing="1" width="650" align="center">
            <tr>
                ...
                <td>
                <div style="border:1px solid gray; width:188px; height:188px;box-shadow:5px 5px 5px gray;">
...
<fieldset style="width:850px; margin-top:10px">
		...
		<form>
			<div style="width:850px; margin-top:10px" id="search_list_view" align="left">
