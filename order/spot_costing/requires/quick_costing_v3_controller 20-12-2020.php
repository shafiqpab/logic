...
if($action=="rate_details_popup")
{
	...
	$sqlFab="select id, type, yarn_lib_id, fab_des from qc_fab_yarn_conv where qc_no='$qc_no' and body_part_id='$body_part_id' and type=1 and status_active=1 and is_deleted=0";
    ...
    <script>
		...
		function fnc_cons_amt(str)
		{
			...
			if(valstr[1]==1)
			{
				...
				$('#txtfabtotcons_'+id).val( number_format(totfabCons,2,'.','') );
				
				$('#txtfabamt_'+id).val( number_format(fabAmt,2,'.','') );
			}
			else if(valstr[1]==2)
			{
				...
				$('#txtyarnamt_'+id).val( number_format(yarnAmt,2,'.','') );
			}
			else if(valstr[1]==3)
			{
				...
				$('#txtconvamt_'+id).val( number_format(convAmt,2,'.','') );
			}
		...
		function fnc_total_rate(type)
		{
			if(type==1)
			{
				...
				$('#txt_tot_cons').val( number_format(consTot,2,'.','') );
				$('#txt_tot_tot_cost').val( number_format(totconsTot,2,'.','') );
				$('#txt_tot_amt').val( number_format(amtTot,2,'.','') );
			}
			else if(type==2)
			{
				...
				$('#txt_tot_yarncons').val( number_format(consYarnTot,2,'.','') );
				$('#txt_tot_yarnamt').val( number_format(amtYarnTot,2,'.','') );
			}
			else if(type==3)
			{
				...
				$('#txt_tot_convcons').val( number_format(consConvTot,2,'.','') );
				$('#txt_tot_convamt').val( number_format(amtConvTot,2,'.','') );
			}
			var totCost=totAmount=0;
			var totCost=($('#txt_tot_amt').val()*1)+($('#txt_tot_yarnamt').val()*1)+($('#txt_tot_convamt').val()*1);
			
			$('#txtamount').val( number_format(totCost,2,'.','') );
			...
			$('#txttotamount').val( number_format(totAmount,2,'.','') );
		}
        ...
        {
            //alert(row)
            emailwindow=dhtmlmodal.open('EmailBox', 'iframe','quick_costing_v3_controller.php?action='+action,'Details Popup', 'width=580px,height=300px,center=1,resize=0','../../');
			...
			if(strval[1]==1)
			{
				...
				if(z==1)
				{
					$('#tbl_fab tbody').append(
						...
						+ '<td><input style="width:208px;" type="text" class="text_boxes" name="txtFabricDtls_'+counter+'" id="txtFabricDtls_'+counter+'" placeholder="Br. Fabric" onClick="" readonly /><input type="hidden" class="text_boxes" name="hidLibid_'+counter+'" id="hidLibid_'+counter+'" value=""/><input type="hidden" class="text_boxes" name="txtYarnDtls_'+counter+'" id="txtYarnDtls_'+counter+'" value=""/><input type="hidden" class="text_boxes" name="hidupid_'+counter+'" id="hidupid_'+counter+'" value=""/></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabcons_'+counter+'" id="txtfabcons_'+counter+'" placeholder="Write" onChange="fnc_cons_amt('+"'"+counter+"_1'"+');" onKeyUp="append_row('+"'"+counter+"_1'"+');"/></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabex_'+counter+'" id="txtfabex_'+counter+'" placeholder="Write" onChange="fnc_cons_amt('+"'"+counter+"_1'"+');" /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabtotcons_'+counter+'" id="txtfabtotcons_'+counter+'" placeholder="Display" readonly /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabrate_'+counter+'" id="txtfabrate_'+counter+'" onChange="fnc_cons_amt('+"'"+counter+"_1'"+');" /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabamt_'+counter+'" id="txtfabamt_'+counter+'" placeholder="Display" /></td>'+ '</tr>'
					);
			...
			else if(strval[1]==2)
			{
				...
				if(y==1)
				{
					$('#tbl_yarn tbody').append(
						...
						+ '<td><?=create_drop_down( "cbocount_'+counter+'", 60, $yarnCountArr, "",1,"-Count-", $selected, "","","" ); ?><input type="hidden" class="text_boxes" name="hidfabid_'+counter+'" id="hidfabid_'+counter+'" value=""/><input type="hidden" class="text_boxes" name="hidyarnupid_'+counter+'" id="hidyarnupid_'+counter+'" value=""/></td><td><?=create_drop_down( "cbocompone_'+counter+'", 100, $composition,"", 1, "-Select-", $selected, "","","","","" ); ?></td><td><input type="text" id="txtpercentone_'+counter+'"  name="txtpercentone_'+counter+'" class="text_boxes" style="width:38px" value="" readonly/></td><td><? echo create_drop_down( "cbotype_'+counter+'", 110, $yarn_type,"", 1, "-Select-", $selected, "","","","","","" ); ?></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtyarncons_'+counter+'" id="txtyarncons_'+counter+'" placeholder="Write" onChange="fnc_cons_amt('+"'"+counter+"_2'"+');" onKeyUp="append_row('+"'"+counter+"_2'"+');" value="" /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtyarnrate_'+counter+'" id="txtyarnrate_'+counter+'" onChange="fnc_cons_amt('+"'"+counter+"_2'"+');" value="" /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtyarnamt_'+counter+'" id="txtyarnamt_'+counter+'" placeholder="Display" readonly value="" /></td>'+ '</tr>'
					);
				}
			}
			else if(strval[1]==3)
			{
				...
				if(c==1)
				{
					$('#tbl_conv tbody').append(
						...
						+ '<td><?=create_drop_down( "cbofab_'+counter+'", 250, $fab_description, "",1,"-Select-", $selected, "","","" ); ?><input type="hidden" class="text_boxes" name="hidconvupid_'+counter+'" id="hidconvupid_'+counter+'" value=""/></td><td><?=create_drop_down( "cboprocess_'+counter+'", 100, $conversion_cost_head_array,"", 1, "-Select-", $selected, "","","","","" ); ?></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtconvcons_'+counter+'" id="txtconvcons_'+counter+'" placeholder="Write" onChange="fnc_cons_amt('+"'"+counter+"_3'"+');" onKeyUp="append_row('+"'"+counter+"_3'"+');" value="" /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtconvrate_'+counter+'" id="txtconvrate_'+counter+'" onChange="fnc_cons_amt('+"'"+counter+"_3'"+');" value="" /></td><td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtconvamt_'+counter+'" id="txtconvamt_'+counter+'" placeholder="Display" readonly value="" /></td>'+ '</tr>'
					);
				}
			}
			...
			if(type==1)
			{
				...
				for(var i=1; i<=counter; i++)
				{
					...
					$("#tbl_fab tbody tr:eq("+index+")").each(function(){
						...
						$('#txtfabcons_'+i).removeAttr("onKeyUp").attr("onKeyUp","append_row('"+i+"_1')");
			...
			else if(type==2)
			{
				...
				for(var i=1; i<=counter; i++)
				{
					...
					$("#tbl_yarn tbody tr:eq("+index+")").each(function(){
						...
						$('#txtyarncons_'+i).removeAttr("onKeyUp").attr("onKeyUp","append_row('"+i+"_2')");
			...
			else if(type==3)
			{
				...
				for(var i=1; i<=counter; i++)
				{
					...
					$("#tbl_conv tbody tr:eq("+index+")").each(function(){
						...
						$('#txtconvcons_'+i).removeAttr("onKeyUp").attr("onKeyUp","append_row('"+i+"_3')");
        ...
        function fnc_fabric_entry(operation)
        {
            ...
            var data="action=save_update_delete_fabric&operation="+operation+'&numRowFabric='+z+get_submitted_data_string('hid_qc_no*hid_bodypart_id*hid_body_cons*txtamount*txtprocessloss*txttotamount',"../../../")+dataAll;
		...
		function fnc_yarn_entry(operation)
        {
            ...
            var data="action=save_update_delete_yarn&operation="+operation+'&numRowYarn='+z+get_submitted_data_string('hid_qc_no*hid_bodypart_id*hid_body_cons*txtamount*txtprocessloss*txttotamount',"../../../")+dataAll;
		...
		function fnc_conv_entry(operation)
        {
            ...
            var data="action=save_update_delete_conv&operation="+operation+'&numRowConv='+z+get_submitted_data_string('hid_qc_no*hid_bodypart_id*hid_body_cons*txtamount*txtprocessloss*txttotamount',"../../../")+dataAll;
                ...
                <table cellspacing="0" cellpadding="0" border="1" rules="all" width="510" class="rpt_table" id="list_view">
                    <tbody>
						...
						foreach($sql_data as $row)
						{
							if ($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
							$yarnBreak="";
							if($row[csf('fab_nature_id')]==2) $yarnBreak=$yarn_descriptionArr[$row[csf('id')]]; else $yarnBreak="";
							?>
...
if($action=="save_update_delete_fabric")
{
    ...
    if ($operation==0)  // Insert Here
    {
		...
		$field_array="id, qc_no, body_part_id, type, yarn_lib_id, count, composition, percent, yarn_type, fab_id, process, fab_des, cons, exper, tot_cons, rate, value, yarn_break_down, conv_break_down, inserted_by, insert_date, status_active, is_deleted";
        ...
        for($i=1; $i<=$numRowFabric; $i++) 
        {
			...
			if((str_replace("'",'',$$txtfabtotcons)*1)!=0)
			{
				...
				$data_array .="(".$id.",".$hid_qc_no.",".$hid_bodypart_id.",1,".$$hidLibid.",0,0,0,0,0,0,".$$txtFabricDtls.",".$$txtfabcons.",".$$txtfabex.",".$$txtfabtotcons.",".$$txtfabrate.",".$$txtfabamt.",".$$txtYarnDtls.",".$$txtConvDtls.",'".$user_id."','".$pc_date_time."',1,0)";
				$fabid=$id;
				$id++; $add_comma++;
				...
				if(str_replace("'",'',$$txtYarnDtls)!="")//Yarn Data
				{
					...
					for($y=0; $y< count($yarnbreckdown_array); $y++)
					{
						...
						if ($add_comma!=0) $data_array .=","; $add_comma=0;
						$data_array .="(".$id.",".$hid_qc_no.",".$hid_bodypart_id.",2,0,'".$yarnbreckdownarr[0]."','".$yarnbreckdownarr[1]."','".$yarnbreckdownarr[4]."','".$yarnbreckdownarr[3]."','".$fabid."',0,'','".$cons."',0,0,'".$yarnbreckdownarr[5]."','".$yarnamt."','','','".$user_id."','".$pc_date_time."',1,0)";
						$id++; $add_comma++;
					}
				}
				...
				if(str_replace("'",'',$$txtConvDtls)!="")//Conv Data
				{
					...
					for($c=0; $c< count($convbreakdownArr); $c++)
					{
						...
						if ($add_comma!=0) $data_array .=","; $add_comma=0;
						$data_array .="(".$id.",".$hid_qc_no.",".$hid_bodypart_id.",3,0,0,0,0,0,'".$fabid."','".$convbreakarr[0]."','','".$convCons."',0,0,'".$convbreakarr[1]."','".$convamt."','','','".$user_id."','".$pc_date_time."',1,0)";
		...
		$rIDMst=execute_query("update qc_cons_rate_dtls set fab_cost=".$txtamount.", process_loss=".$txtprocessloss.", totfab_cost=".$txttotamount." where mst_id =".$hid_qc_no." and body_part_id =".$hid_bodypart_id." and type=1");
    ...
    else if ($operation==1)   // Update Here
    {
		...
		$flag=1;
		$fycRid=execute_query("delete from qc_fab_yarn_conv where qc_no =".$hid_qc_no." and body_part_id =".$hid_bodypart_id." and type in (1,2,3)",1);
...
if($action=="populate_confirm_fabric_data")
{
	...
	$sqlConsRate=sql_select("select fab_cost, process_loss, totfab_cost from qc_cons_rate_dtls where mst_id=".$qc_no." and body_part_id =".$body_part_id." and type=1");
	...
	?>
    <table width="500" cellspacing="0" border="1" class="rpt_table" id="tbl_fab" rules="all">
        <thead>
            <td colspan="6" align="center" bgcolor="#99FFCC"><b>Fabric Charge Details</b></td>
        </thead>
        <thead>
            <th width="220">Fabric Details</th>
            <th width="50">Cons</th>
            <th width="50">Ex %</th>
        ...
        <tbody id="fabtbody">
			<?
            $sqlFab="select id, type, yarn_lib_id, fab_des, count, composition, percent, yarn_type, process, fab_id, cons, exper, tot_cons, rate, value, yarn_break_down, conv_break_down from qc_fab_yarn_conv where qc_no='$qc_no' and body_part_id='$body_part_id' and status_active=1 and is_deleted=0";
            ...
            foreach($sqlFabData as $row)
            {
                if($row[csf("type")]==1)
                {
                    ...
                    ?>
                    <tr id="fabtr_<?=$i; ?>">
                        <td><input style="width:208px;" type="text" class="text_boxes" name="txtFabricDtls_<?=$i; ?>" id="txtFabricDtls_<?=$i; ?>" placeholder="Br. Fabric" onClick="fnc_details_popup('<?=$i; ?>','fabric_popup','<?=$i; ?>');" value="<?=$row[csf("fab_des")]; ?>" readonly />
                        ...
                        <td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabcons_<?=$i; ?>" id="txtfabcons_<?=$i; ?>" placeholder="Write" onChange="fnc_cons_amt('<?=$i.'_1'; ?>');" onKeyUp="append_row('<?=$i.'_1'; ?>');" value="<?=$row[csf("cons")]; ?>" /></td>
            ...
            ?>
            <tr id="fabtr_<?=$i; ?>">
                <td><input style="width:208px;" type="text" class="text_boxes" name="txtFabricDtls_<?=$i; ?>" id="txtFabricDtls_<?=$i; ?>" placeholder="Br. Fabric" onClick="fnc_details_popup('<?=$i; ?>','fabric_popup','<?=$i; ?>');" value="" readonly />
                ...
                <td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtfabcons_<?=$i; ?>" id="txtfabcons_<?=$i; ?>" placeholder="Write" onChange="fnc_cons_amt('<?=$i.'_1'; ?>');" onKeyUp="append_row('<?=$i.'_1'; ?>');" value="" /></td>
        ...
        <tfoot>
            <tr bgcolor="#CCCCAA">
                <td align="right">Total Fabric Cost=</td>
    ...
    <table width="500" cellspacing="0" border="1" class="rpt_table" id="tbl_yarn" rules="all">
        <thead>
            <td colspan="7" align="center" bgcolor="#99FFCC"><b>Yarn Charge Details</b></td>
        </thead>
        <thead>
        ...
        <tbody id="yarntbody">
			<?
            $sqlFab="select id, type, yarn_lib_id, fab_des, count, composition, percent, yarn_type, process, fab_id, cons, exper, tot_cons, rate, value from qc_fab_yarn_conv where qc_no='$qc_no' and body_part_id='$body_part_id' and status_active=1 and is_deleted=0";
            ...
            foreach($sqlFabData as $row)
            {
                if($row[csf("type")]==2)
                {
                    ...
                    <tr id="yarntr_<?=$y; ?>">
                        ...
                        <td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtyarncons_<?=$y; ?>" id="txtyarncons_<?=$y; ?>" placeholder="Write" onChange="fnc_cons_amt('<?=$y.'_2'; ?>');" onKeyUp="append_row('<?=$y.'_2'; ?>');" value="<?=$row[csf("cons")]; ?>" /></td>
            ...
            <tr id="yarntr_<?=$y; ?>">
                ...
                <td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtyarncons_<?=$y; ?>" id="txtyarncons_<?=$y; ?>" placeholder="Write" onChange="fnc_cons_amt('<?=$y.'_2'; ?>');" onKeyUp="append_row('<?=$y.'_2'; ?>');" value="" /></td>
        ...
        <tfoot>
            <tr bgcolor="#CCCCAA">
                <td colspan="4" align="right">Total Yarn Cost=</td>
        ...
        <tbody id="convbody">
            ...
            foreach($sqlFabData as $row)
            {
                if($row[csf("type")]==3)
                {
                    ?>
                    <tr id="convtr_<?=$y; ?>">
                        <td><? echo create_drop_down( "cbofab_".$c, 250, $fab_description, "",1,"-Select-", $row[csf("fab_id")], "","","" ); ?>
                        ...
                        <td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtconvcons_<?=$c; ?>" id="txtconvcons_<?=$c; ?>" placeholder="Write" onChange="fnc_cons_amt('<?=$c.'_3'; ?>');" onKeyUp="append_row('<?=$c.'_3'; ?>');" value="<?=$row[csf("cons")]; ?>" /></td>
            ...
            ?>
           <tr id="convtr_<?=$y; ?>">
                <td><? echo create_drop_down( "cbofab_".$c, 250, $fab_description, "",1,"-Select-", $selected, "","","" ); ?>
                    <input type="hidden" class="text_boxes" name="hidconvupid_<?=$c; ?>" id="hidconvupid_<?=$c; ?>" value=""/>
                </td>
                <td><? echo create_drop_down( "cboprocess_".$c, 100, $conversion_cost_head_array,"", 1, "-Select-", $selected, "","","","","" ); ?></td>
                <td><input style="width:38px;" type="text" class="text_boxes_numeric" name="txtconvcons_<?=$c; ?>" id="txtconvcons_<?=$c; ?>" placeholder="Write" onChange="fnc_cons_amt('<?=$c.'_3'; ?>');" onKeyUp="append_row('<?=$c.'_3'; ?>');" /></td>
                <td><input style="width:28px;" type="text" class="text_boxes_numeric" name="txtconvrate_<?=$c; ?>" id="txtconvrate_<?=$c; ?>" onChange="fnc_cons_amt('<?=$c.'_3'; ?>');" /></td>
...
if($action=="save_update_delete_yarn")
{
    ...
    if ($operation==0)  // Insert Here
    {
        ...
        $id=return_next_id( "id", "qc_fab_yarn_conv", 1);
		$field_array="id, qc_no, body_part_id, type, fab_id, count, composition, percent, yarn_type, cons, rate, value, inserted_by, insert_date, status_active, is_deleted";
        ...
        for($i=1; $i<=$numRowYarn; $i++) 
        {
			...
			{
				if ($add_comma!=0) $data_array .=","; $add_comma=0;
				$data_array .="(".$id.",".$hid_qc_no.",".$hid_bodypart_id.",2,".$$hidfabid.",".$$cbocount.",".$$cbocompone.",".$$txtpercentone.",".$$cbotype.",".$$txtyarncons.",".$$txtyarnrate.",".$$txtyarnamt.",'".$user_id."','".$pc_date_time."',1,0)";
				$id++; $add_comma++;
			}
        }
    ...
    else if ($operation==1)   // Update Here
    {
		...
		$flag=1;
		$fycRid=execute_query( "delete from qc_fab_yarn_conv where qc_no =".$hid_qc_no." and body_part_id =".$hid_bodypart_id." and type=2",1);
		if($fycRid==1 && $flag==1) $flag=1; else  $flag=0;
		$rID=sql_insert("qc_fab_yarn_conv",$field_array,$data_array,0);
		if($rID==1 && $flag==1) $flag=1; else  $flag=0;
...
if($action=="save_update_delete_conv")
{
    ...
    if ($operation==0)  // Insert Here
    {
        ...
        $id=return_next_id( "id", "qc_fab_yarn_conv", 1);
		$field_array="id, qc_no, body_part_id, type, fab_id, process, cons, rate, value, inserted_by, insert_date, status_active, is_deleted";
        ...
        for($i=1; $i<=$numRowConv; $i++) 
        {
			...
			{
				if ($add_comma!=0) $data_array .=","; $add_comma=0;
				$data_array .="(".$id.",".$hid_qc_no.",".$hid_bodypart_id.",3,".$$cbofab.",".$$cboprocess.",".$$txtconvcons.",".$$txtconvrate.",".$$txtconvamt.",'".$user_id."','".$pc_date_time."',1,0)";
				$id++; $add_comma++;
			}
        }
    ...
    else if ($operation==1)   // Update Here
    {
		...
		$flag=1;
		$fycRid=execute_query( "delete from qc_fab_yarn_conv where qc_no =".$hid_qc_no." and body_part_id =".$hid_bodypart_id." and type=3",1);
		if($fycRid==1 && $flag==1) $flag=1; else  $flag=0;
		$rID=sql_insert("qc_fab_yarn_conv",$field_array,$data_array,0);
		if($rID==1 && $flag==1) $flag=1; else  $flag=0;
...
if($action=="save_update_delete")
{
	...
	where  b.team_id in (select id from lib_marketing_team a where user_tag_id='$user_id' and a.status_active=1 and a.is_deleted=0 ) and b.status_active=1 and b.is_deleted=0");
		...
		$data_array_mst="(".$mst_id.",".$mst_id.",'".$autoCostSheetNo."',".$cbo_temp_id.",".$txt_temp_id.",".$txt_inquery_id.",'".strtoupper(str_replace("'","",$txt_styleRef))."',".$cbo_buyer_id.",".$cbouom.",".$cbo_cons_basis_id.",".$cbo_season_id.",".$cbo_season_year.",".$cbo_brand.",'".strtoupper(str_replace("'","",$txt_styleDesc))."',".$cbo_product_department.",".$txt_product_code.",".$cbo_subDept_id.",".$txt_delivery_date.",".$txt_exchangeRate.",".$txt_offerQty.",".$txt_quotedPrice.",".$txt_tgtPrice.",".$txtmarign.",".$cbo_stage_id.",".$txt_costingDate.",'".$update_id."','".$revise_no."','".$option_id."','".strtoupper($txt_costing_remarks)."','".strtoupper($txt_option_remarks)."',".$txt_article.",'".$qcno."',458,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',1,0)";
		...
		$field_array_consrate="id, mst_id, item_id, type, particular_type_id, consumption, ex_percent, tot_cons, is_calculation, rate, value, fab_id, description, body_part_id, supp_ref, remarks, inserted_by, insert_date, status_active, is_deleted";
		...
		foreach($temp_id as $item_id)
		{
			...
			foreach($ex_itemConsRateData as $item_wise_consRateData)
			{
				if($item_wise_consRateData!="")
				{
					...
					$bodypartid=$cons=$exPer=$totCons=$ratePop=$rate=$fabAmt=$fabRemarks=0;
					...
					$data_array_cons_rate .="(".$cons_rate_id.",".$qcno.",'".$item_id."',1,0,'".$cons."','".$exPer."','".$totCons."','".$ratePop."','".$rate."','".$fabAmt."',0,'','".$bodypartid."','','".$fabRemarks."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',1,0)";
			...
			foreach($ex_specialData as $item_wise_specialData)
			{
				...
				if ($add_comma_cons_rate!=0) $data_array_cons_rate .=",";
				$data_array_cons_rate .="(".$cons_rate_id.",".$qcno.",'".$item_id."',2,'".$speciaOperation_id."','".$spConsumtion."','".$spExper."','".$totSpCons."',0,'".$spRate."','".$spValue."','".$speciaTypeId."','','".$spbodypartid."','','".$spRemarks."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',1,0)";
			...
			foreach($ex_washData as $item_wise_washData)
			{
				...
				if ($add_comma_cons_rate!=0) $data_array_cons_rate .=",";
				$data_array_cons_rate .="(".$cons_rate_id.",".$qcno.",'".$item_id."',3,'".$washTypeId."','".$wConsumtion."','".$wExper."','".$totwCons."',0,'".$wRate."','".$wValue."',0,'','".$wbodypartid."','','".$wRemarks."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',1,0)";
			...
			foreach($ex_itemAccData as $item_wise_itemAccData)
			{
				...
				$accessories_id=$accDescription=$accBandRef=$acConsumtion=$acExPer=$totAccCons=$acRate=$acVal=$acRemarks=0;
				...
				if ($add_comma_cons_rate!=0) $data_array_cons_rate .=",";
				$data_array_cons_rate .="(".$cons_rate_id.",".$qcno.",'".$item_id."',4,'".$accessories_id."','".$acConsumtion."','".$acExPer."','".$totAccCons."',0,'".$acRate."','".$acVal."',0,'".$accDescription."',0,'".$accBandRef."','".$acRemarks."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',1,0)";
		...
		$field_array_item_tot=" id, mst_id, item_id, fabric_cost, sp_operation_cost, wash_cost, accessories_cost, cpm, smv, efficiency, cm_cost, frieght_cost, lab_test_cost, miscellaneous_cost, other_cost, commission_cost, fob_pcs, rmg_ratio, inserted_by, insert_date";
		...
		foreach($ex_item_wise_tot_data as $item_wise_tot)
		{
			...
			$tot_item_id=trim($ex_item_tot[16]);
			
			if ($add_comma_item_tot!=0) $data_array_item_tot .=",";
			$data_array_item_tot .="(".$item_cost_id.",".$qcno.",'".$tot_item_id."','".$fab_td."','".$spOpe_td."','".$wash_td."','".$acc_td."','".$txtCpm."','".$txtSmv."','".$txtEff."','".$txtCmCost."','".$txtFriCost."','".$txtLtstCost."','".$txtMissCost."','".$txtOtherCost."','".$txtCommCost."','".$fobT_td."','".$txtRmgQty."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
...
if($action=="style_popup")
{
	...
	{
		show_list_view (document.getElementById('cbo_buyer_id').value+'**'+document.getElementById('cbo_season_id').value+'**'+document.getElementById('cbo_subDept_id').value+'**'+document.getElementById('txt_search_common').value+'**'+document.getElementById('txt_cost_sheet_no').value+'**'+document.getElementById('hide_dataType').value+'**'+document.getElementById('cbo_approval_type').value, 'style_ref_search_list_view', 'search_div', 'quick_costing_v3_controller', 'setFilterGrid(\'tbl_list_search\',-1)');
		set_all();
	}
    ...
    <div align="center">
		...
		<fieldset>
            <table cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr class="general">
                        <td><? echo create_drop_down( "cbo_buyer_id", 130, "select buy.id, buy.buyer_name from lib_buyer buy where buy.status_active =1 and buy.is_deleted=0 $buyer_cond and buy.id in (select  buyer_id from  lib_buyer_party_type where party_type in (1,3,21,90)) order by buyer_name","id,buyer_name",1, "-- All Buyer--",$buyerId,"load_drop_down( 'quick_costing_v3_controller', this.value, 'load_drop_down_season', 'season_td'); load_drop_down( 'quick_costing_v3_controller',this.value, 'load_drop_down_sub_dep', 'sub_td' );",0 ); ?></td>                 
...
if($action=="populate_style_details_data")
{
	...
	$data_array=sql_select("select id, cost_sheet_id, cost_sheet_no, temp_id, lib_item_id, inquery_id, style_ref, buyer_id, uom, cons_basis, season_id, season_year, brand_id, style_des, prod_dept, prod_code, department_id, delivery_date, exchange_rate, offer_qty, quoted_price, tgt_price, margin, stage_id, costing_date, revise_no, option_id, buyer_remarks, article, option_remarks, inserted_by, meeting_no, qc_no from qc_mst where status_active=1 and is_deleted=0 and cost_sheet_no='$cost_sheet_no' $rev_no_cond $option_id_cond");//$starting_row_cond and inserted_by='$cond_user'  qc_no='$cost_sheet_id'   
	...
	foreach ($data_array as $row)
	{
		...
		echo "load_drop_down('requires/quick_costing_v3_controller', '".trim($row[csf("lib_item_id")])."', 'load_drop_down_tempItem', 'item_td'); \n";
	...
	$sql_cons_rate="select id, mst_id, item_id, type, particular_type_id, consumption, ex_percent, tot_cons, is_calculation, rate, value, fab_id, description, body_part_id, supp_ref, remarks from qc_cons_rate_dtls where mst_id=$cond_data and status_active=1 and is_deleted=0 order by id asc";
	...
	foreach ($sql_result_cons_rate as $rowConsRate)
	{
		...
		{
			$cons_rate_fab_arr[$rowConsRate[csf("item_id")]].=$body_part[$rowConsRate[csf("body_part_id")]].'_'.$rowConsRate[csf("body_part_id")].'_'.$rowConsRate[csf("consumption")].'_'.$rowConsRate[csf("ex_percent")].'_'.$rowConsRate[csf("tot_cons")].'_'.$rowConsRate[csf("is_calculation")].'_'.$rowConsRate[csf("rate")].'_'.$rowConsRate[csf("value")].'_'.$rowConsRate[csf("remarks")].'##';
		}
		...
		{
			$cons_rate_ac_arr[$rowConsRate[csf("item_id")]].=$itemGroupArr[$rowConsRate[csf("particular_type_id")]].'_'.$rowConsRate[csf("particular_type_id")].'_'.$rowConsRate[csf("description")].'_'.$rowConsRate[csf("supp_ref")].'_'.$rowConsRate[csf("consumption")].'_'.$rowConsRate[csf("ex_percent")].'_'.$rowConsRate[csf("tot_cons")].'_'.$rowConsRate[csf("rate")].'_'.$rowConsRate[csf("value")].'_'.$rowConsRate[csf("remarks")].'##';
		}
	...
	$sql_item_summ="select item_id, fabric_cost, sp_operation_cost, wash_cost, accessories_cost, cpm, smv, efficiency, cm_cost, frieght_cost, lab_test_cost, miscellaneous_cost, other_cost, commission_cost, fob_pcs, rmg_ratio from qc_item_cost_summary where mst_id='$cond_data' and status_active=1 and is_deleted=0";
...
if($action=="copy_cost_sheet")
{
	...
	{	
		...
		$data_array_tot_cost="(".$tc_sum_id.",".$qcno.",'".$cbo_buyer_agent."','".$cbo_agent_location."','".$txt_noOfPack."',0,'".$cmPop."','".$txt_lumSum_cost."','".$txt_commPer."','".$totFab_td."','".$totSpc_td."','".$totWash_td."','".$totAcc_td."','".$totCm_td."','".$totFriCst_td."','".$totLbTstCst_td."','".$totMissCst_td."','".$totOtherCst_td."','".$totCommCst_td."','".$totCost_td."','".$totalFob_td."','".$totalRmg_td."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
		//echo $data_array_tot_cost; die;
		$sql_item_tot=sql_select("select id, mst_id, item_id, fabric_cost, sp_operation_cost, wash_cost, accessories_cost, cpm, smv, efficiency, cm_cost, frieght_cost, lab_test_cost, miscellaneous_cost, other_cost, commission_cost, fob_pcs, rmg_ratio from qc_item_cost_summary where mst_id='$hid_qc_no' order by id ASC");
		...
		foreach($sql_item_tot as $rowItem_tot)
		{
			...
			if ($add_comma_item_tot!=0) $data_array_item_tot .=",";
			$data_array_item_tot .="(".$item_cost_id.",".$qcno.",'".$tot_item_id."','".$fab_td."','".$spOpe_td."','".$wash_td."','".$acc_td."','".$txtCpm."','".$txtSmv."','".$txtEff."','".$txtCmCost."','".$txtFriCost."','".$txtLtstCost."','".$txtMissCost."','".$txtOtherCost."','".$txtCommCost."','".$fobT_td."','".$rmg_ratio."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
    ...
    <script>
		...
		function fnc_bom_data_load()
		{
			...
			if(job_no!="")
			{
				...
				if(qcCons_from==1)
				{
					var bomTotCost=(number_format(fab_amount,2)*1)+(number_format(sp_oparation_amount,2)*1)+(number_format(acc_amount,2)*1)+(number_format(fright_amount,2)*1)+(number_format(lab_amount,2)*1)+(number_format(misce_amount,2)*1)+(number_format(other_amount,2)*1)+(number_format(comm_amount,2)*1);
	...
	?>
		...
		<table class="rpt_table" border="1" cellpadding="1" cellspacing="1" style="width:950px; margin-top: 10px; margin-bottom: 10px" rules="all">
			...
			<tr>
				...
				<td align="right"><? echo number_format($embel_cost,2,'.','')  ?></td>
				<td align="right"><? echo number_format($other_cost_value,2,'.',''); ?></td>
    ...
    <div align="center" style="width:100%;" >
        <form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
            <table width="910" cellspacing="0" cellpadding="0" border="1" class="rpt_table" align="center" rules="all">
                ...
                <tr class="general">
                    <td><? echo create_drop_down( "cbo_company_mst", 140, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name","id,company_name",1, "-- Select Company --", '',"load_drop_down( 'quick_costing_v3_controller', this.value, 'load_drop_down_buyer', 'buyer_td');" ); ?><input type="hidden" id="selected_id"></td>
...
if($action=="bodyPart_washType_ItemGroup_popup")
{
	...
	<body>
        ...
        <? } else if($type==5) {
			$accessories_arr=sql_select("select id, item_name from lib_item_group where item_category=4 and status_active =1 and is_deleted=0 order by item_name");
			?>
        <table width="420" cellspacing="0" class="rpt_table" border="0" rules="all">
            <thead>
            	<th width="40">SL</th><th width="300">Item Group</th>
            </thead>
        </table>
        <table width="420" cellspacing="0" class="rpt_table" border="0" rules="all" id="item_table">
            <tbody>
                ...
                foreach($accessories_arr as $row)
                {
                    if($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
                    ?>
                    <tr onClick="js_set_value(<?=$row[csf('id')]; ?>,'<?=$row[csf('item_name')]; ?>');" bgcolor="<?=$bgcolor; ?>">
                        <td width="40"><?=$i; ?></td>
