...
if ($action=="report_generate")
{
	...
	$hdColspan="27"; $width='2100px'; $inner_width='2082px';
    ...
    <table width="<?=$width; ?>px" cellspacing="0">
        ...
        <table width="<?=$width; ?>" cellspacing="0" border="1" class="rpt_table" rules="all">
            <thead>
                <tr style="font-size:13px">
                    ...
                    <th width="80" style="word-wrap: break-word;word-break:break-all;">Cost <br>Sheet No</th>
                    <th width="100" style="word-wrap: break-word;word-break:break-all;">Buyer</th>
                    <th width="30" style="word-wrap: break-word;word-break:break-all;">Rv.</th>   
                    <th width="100" style="word-wrap: break-word;word-break:break-all;">Style Desc.</th>
                    <th width="100" style="word-wrap: break-word;word-break:break-all;">Style Ref.</th>
                    <th width="80" style="word-wrap: break-word;word-break:break-all;">Season</th>
                    <th width="80" style="word-wrap: break-word;word-break:break-all;" title="Offer Qty">Initial Qty</th>
                    <th width="60" style="word-wrap: break-word;word-break:break-all;">UOM</th>
                    
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">FOB Price</th>
                   
                    <th width="80" style="word-wrap: break-word;word-break:break-all;">Amount</th>   
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Delivery<br>Date</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Costing<br>Date</th>
                    <th width="80" style="word-wrap: break-word;word-break:break-all;">Insert By</th>
                    <th width="80" style="word-wrap: break-word;word-break:break-all;l">Status</th>
                    
                    <th width="30" style="word-wrap: break-word;word-break:break-all;">Op.</th>
                    <th width="130" style="word-wrap: break-word;word-break:break-all;">Approved By</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Days to<br>Confirm</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Fabric Cost<br> /Pcs</th>
                    
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Trims Cost<br> /Pcs</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;l">Print /Emb.<br>Cost /Pcs</th>   
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Wash. Cost<br>/Pcs</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;l">Other Cost<br>/Pcs</th>

                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Commercial Cost</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">LC Charge</th>
                    <th width="70" style="word-wrap: break-word;word-break:break-all;">Commission</th>

                    <th width="70" style="word-wrap: break-word;word-break:break-all;">CM Cost /Pcs</th>
                    <th  style="word-wrap: break-word;word-break:break-all;">Total FOB Cost<br>/Pcs</th>
                    
                 </tr>
            </thead>
        </table>
        <div style="width:<?=$width; ?>; max-height:300px; overflow-y:scroll" id="scroll_body"> 
            <table width="<?=$inner_width; ?>" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_body">
            <?
           

            $sql_item_summ="select mst_id, tot_fob_cost, tot_fab_cost, tot_accessories_cost, tot_cm_cost, tot_other_cost, tot_cost,tot_commission_cost,lc_cost,commercial_cost,tot_fob_cost,tot_sp_operation_cost,tot_wash_cost from qc_tot_cost_summary where status_active=1 and is_deleted=0";
            ...
            foreach($sql_result_item_summ as $rowItemSumm)
            {
                ...
                $summary_cost_arr[$rowItemSumm[csf("mst_id")]]['comm_cost']=$rowItemSumm[csf("tot_commission_cost")];
                $summary_cost_arr[$rowItemSumm[csf("mst_id")]]['lc_cost']=$rowItemSumm[csf("lc_cost")];
                $summary_cost_arr[$rowItemSumm[csf("mst_id")]]['commercial_cost']=$rowItemSumm[csf("commercial_cost")];
                $summary_cost_arr[$rowItemSumm[csf("mst_id")]]['tot_sp_operation_cost']=$rowItemSumm[csf("tot_sp_operation_cost")];
                $summary_cost_arr[$rowItemSumm[csf("mst_id")]]['tot_wash_cost']=$rowItemSumm[csf("tot_wash_cost")];
            }
            ...
            {
				$sql_mst="select a.id, a.qc_no, a.cost_sheet_no, a.lib_item_id, a.buyer_id, a.style_des, a.style_ref, a.season_id, a.department_id, a.offer_qty, a.uom, a.delivery_date, a.costing_date, a.inserted_by, a.approved, a.approved_by, a.approved_date, a.revise_no, a.option_id, a.exchange_rate, a.entry_form,a.company_id from qc_mst a, qc_confirm_mst b where a.qc_no=b.cost_sheet_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $buyerCond $seasonCond $deptCond $styleCond $costSheetNoCond $dateCond order by a.cost_sheet_no asc";// and a.revise_no=0 and a.option_id=0 
				$sql_result=sql_select($sql_mst);
				//echo $sql_mst;
				foreach($sql_result as $row)
				{
					$rowData_arr[$row[csf('cost_sheet_no')]][$row[csf('qc_no')]]=$row[csf('cost_sheet_no')].'***'.$row[csf('costing_date')].'***'.$row[csf('buyer_id')].'***'.$row[csf('style_ref')].'***'.$row[csf('style_des')].'***'.$row[csf('lib_item_id')].'***'.$row[csf('offer_qty')].'***'.$row[csf('delivery_date')].'***'.$row[csf('department_id')].'***'.$row[csf('uom')].'***'.$row[csf('approved')].'***'.$row[csf('inserted_by')].'***'.$row[csf('season_id')].'***'.$row[csf('department_id')].'***1'.'***'.$row[csf('approved_by')].'***'.$row[csf('approved_date')].'***'.$row[csf('exchange_rate')].'***'.$row[csf('entry_form')]."***".$row[csf('revise_no')]."***".$row[csf('option_id')]."***".$row[csf('company_id')];
                    $qc_no_ar[$row[csf('qc_no')]]=$row[csf('qc_no')];
				}
				unset($sql_result);
            }
            else if($costingstage_id==2)
            {
				...
				$sql_mst="select a.id, a.qc_no, a.cost_sheet_no, a.costing_date, a.buyer_id, a.style_ref, a.style_des, a.lib_item_id, a.offer_qty, a.delivery_date, a.season_id, a.department_id, a.uom, a.inserted_by, a.season_id, a.department_id, a.approved, a.approved_by, a.approved_date, a.revise_no, a.option_id, a.entry_form, c.buyer_agent_id, a.exchange_rate,a.company_id from qc_mst a, qc_tot_cost_summary c where a.qc_no=c.mst_id and a.status_active=1 and a.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $buyerCond $seasonCond $deptCond $styleCond $costSheetNoCond $date_cond $confirmidCond order by a.cost_sheet_no asc";
				//echo $sql_mst;
				$sql_result=sql_select($sql_mst);
				foreach($sql_result as $row)
				{
                    $rowData_arr[$row[csf('cost_sheet_no')]][$row[csf('qc_no')]]=$row[csf('cost_sheet_no')].'***'.$row[csf('costing_date')].'***'.$row[csf('buyer_id')].'***'.$row[csf('style_ref')].'***'.$row[csf('style_des')].'***'.$row[csf('lib_item_id')].'***'.$row[csf('offer_qty')].'***'.$row[csf('delivery_date')].'***'.$row[csf('department_id')].'***'.$row[csf('uom')].'***'.$row[csf('approved')].'***'.$row[csf('inserted_by')].'***'.$row[csf('season_id')].'***'.$row[csf('department_id')].'***2'.'***'.$row[csf('approved_by')].'***'.$row[csf('approved_date')].'***'.$row[csf('exchange_rate')].'***'.$row[csf('entry_form')]."***".$row[csf('revise_no')]."***".$row[csf('option_id')]."***".$row[csf('company_id')];
                    $qc_no_ar[$row[csf('qc_no')]]=$row[csf('qc_no')];
				}
				unset($sql_result);
            }
            else if($costingstage_id==0 )
            {
                
                $sql_mst="select a.id, a.qc_no, a.cost_sheet_no, a.costing_date, a.buyer_id, a.style_ref, a.style_des, a.lib_item_id, a.offer_qty, a.delivery_date, a.season_id, a.department_id, a.uom, a.inserted_by, a.season_id, a.department_id, a.approved, a.approved_by, a.approved_date, a.revise_no, a.option_id, a.entry_form, c.buyer_agent_id, a.exchange_rate,a.company_id from qc_mst a, qc_tot_cost_summary c where a.qc_no=c.mst_id and a.status_active=1 and a.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $buyerCond $seasonCond $deptCond $styleCond $costSheetNoCond $date_cond  order by a.cost_sheet_no asc";
                //echo $sql_mst;
                $sql_result=sql_select($sql_mst);
                foreach($sql_result as $row)
                {
            ...
            $qc_cond=where_con_using_array($qc_no_ar,0,"cost_sheet_id");
            $sql_qc="SELECT cost_sheet_id, ship_date from qc_confirm_mst WHERE status_active
            =1 $qc_cond";
            $res_qc=sql_select($sql_qc);
            $qc_data=array();
            foreach($res_qc as $row)
            {
                $qc_data[$row[csf('cost_sheet_id')]]['qc']=$row[csf('cost_sheet_id')];
                $qc_data[$row[csf('cost_sheet_id')]]['ship_date']=$row[csf('ship_date')];
            }
            ...
            {
                foreach($costdata as $qc_no=>$optiondata)
                {
                         
                    $exData=explode("***",$optiondata);
                    ...
                    $printEmb=$summary_cost_arr[$qc_no]['tot_sp_operation_cost'];
                    $wash=$summary_cost_arr[$qc_no]['tot_wash_cost'];
                    $cm=$summary_cost_arr[$qc_no]['cm'];
                    $other=$summary_cost_arr[$qc_no]['other'];
                    $totCost=$summary_cost_arr[$qc_no]['tot_cost'];
                    $fobPcs=$totCost/12;

                    $isconfirm=$qc_data[$qc_no]['qc'];
                    
                    //if($isConfirm[$row[csf("qc_no")]]!="") $status="Confirm"; else $status="";
                    $cstatus="";
                    if(!empty($isconfirm)) $cstatus="Confirm"; else $cstatus="Pending";
                    ...
                    $data_binding[$costSheetNo][$qc_no]['marging']=$qc_margin_arr[$qc_no]['margin_percent'];
                    $data_binding[$costSheetNo][$qc_no]['cost_sheet_no']=$cost_sheet_no;
                    $data_binding[$costSheetNo][$qc_no]['qc_no']=$qc_no;
                    $data_binding[$costSheetNo][$qc_no]['buyer']=$buyerArr[$buyer_id];
                    $data_binding[$costSheetNo][$qc_no]['buyer_id']=$buyer_id;
                    $data_binding[$costSheetNo][$qc_no]['style_des']=$style_des;
                    $data_binding[$costSheetNo][$qc_no]['style_ref']=$style_ref;
                    $data_binding[$costSheetNo][$qc_no]['season']=$season_arr[$season_id];
                    $data_binding[$costSheetNo][$qc_no]['department']=$department_arr[$department_id];
                    $data_binding[$costSheetNo][$qc_no]['offer_qty']=$offer_qty;
                    $data_binding[$costSheetNo][$qc_no]['itemUom']=$itemUom;
                    $data_binding[$costSheetNo][$qc_no]['fobPrice']=$fobPrice;
                    $data_binding[$costSheetNo][$qc_no]['avl_min']=$qc_margin_arr[$qc_no]['avl_min'];
                    $data_binding[$costSheetNo][$qc_no]['amount']=$amount;
                    $data_binding[$costSheetNo][$qc_no]['delivery_date']=$qc_data[$qc_no]['ship_date'];
                    $data_binding[$costSheetNo][$qc_no]['costing_date']=$costing_date;
                    $data_binding[$costSheetNo][$qc_no]['inserted_by']=$user_arr[$inserted_by];
                    $data_binding[$costSheetNo][$qc_no]['cstatus']=$cstatus;
                    $data_binding[$costSheetNo][$qc_no]['revise_no']=$revise_no;
                    $data_binding[$costSheetNo][$qc_no]['option_id']=$option_id;
                    $data_binding[$costSheetNo][$qc_no]['approvedby_time']=$approvedby_time;
                    $data_binding[$costSheetNo][$qc_no]['daysToHand']=$qc_data[$qc_no]['ship_date'];
                    $data_binding[$costSheetNo][$qc_no]['fabCost']=$fabCost;
                    $data_binding[$costSheetNo][$qc_no]['trimCost']=$trimCost;
                    $data_binding[$costSheetNo][$qc_no]['printEmb']=$printEmb;
                    $data_binding[$costSheetNo][$qc_no]['wash']=$wash;
                    $data_binding[$costSheetNo][$qc_no]['cm']=$cm;
                    $data_binding[$costSheetNo][$qc_no]['other']=$other;
                    $data_binding[$costSheetNo][$qc_no]['totCost']=$totCost;
                    $data_binding[$costSheetNo][$qc_no]['fobPcs']=$fobPcs;
                    $data_binding[$costSheetNo][$qc_no]['exchange_rate']=$exchange_rate;
					$data_binding[$costSheetNo][$qc_no]['entryForm']=$entryForm;
                    $data_binding[$costSheetNo][$qc_no]['commercial_cost']=$summary_cost_arr[$qc_no]['commercial_cost'];
                    $data_binding[$costSheetNo][$qc_no]['lc_cost']=$summary_cost_arr[$qc_no]['lc_cost'];
                    $data_binding[$costSheetNo][$qc_no]['comm_cost']=$summary_cost_arr[$qc_no]['comm_cost'];
                    $data_binding[$costSheetNo][$qc_no]['company_id']=$company_id;
                    $costSpanArr[$costSheetNo]++;
                }
            }
            ...
            <tbody>
                <? 
    			foreach($data_binding as $costSheetNo=>$costSheetData)
                {
                    $costSeetSpan=0;
                    foreach($costSheetData as $qc_no=>$optiondata)
                    {
    				
        				if($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
        				$cost_sheet_no=$costSheetNo;
        				$tdcolor="";
                        if($optiondata['cstatus']=='Confirm') $tdcolor="#00FF00";
        				?>
        				<tr bgcolor="<?=$bgcolor;?>" onClick="change_color('tr_<?=$i; ?>','<?=$bgcolor;?>')" id="tr_<?=$i; ?>">
                            ...
                            ?>
                            <?php if ($costSeetSpan==0): ?>
                                <td style="word-break:break-all;vertical-align: middle;;text-align: center;justify-content: center;" rowspan="<?=$costSpanArr[$costSheetNo]; ?>" width="80" title="<?=$qc_no; ?>"><?=$optiondata['cost_sheet_no']; ?></td>
                                <td rowspan="<?=$costSpanArr[$costSheetNo]; ?>" width="100" style="word-break:break-all;vertical-align: middle;;text-align: center;justify-content: center;"><?=$optiondata['buyer']; ?></td>
                            <?php endif ?>
        					
                            <td  width="30" style="word-break:break-all; text-align:center">
                                <a href="##" onClick="fnc_revise_details('<?=$cost_sheet_no;?>','<?=$qc_no;?>','<?=$optiondata['company_id'];?>','<?=$optiondata['revise_no'];?>','quick_costing_print3')"><?=$optiondata['revise_no']; ?></a>
                            </td>
                            <?php if ($costSeetSpan==0): ?>
                                <td rowspan="<?=$costSpanArr[$costSheetNo]; ?>" width="100" style="word-break:break-all;vertical-align: middle;;text-align: center;justify-content: center;"><?=$optiondata['style_des']; ?></td>
                                <td rowspan="<?=$costSpanArr[$costSheetNo]; ?>" width="100" style="word-break:break-all;vertical-align: middle;;text-align: center;justify-content: center;"><?=$optiondata['style_ref']; ?></td>
                            
                                <td rowspan="<?=$costSpanArr[$costSheetNo]; ?>" width="80" style="word-break:break-all;vertical-align: middle;;text-align: center;justify-content: center;"><?=$optiondata['season']; ?></td>
                            <?php endif ?>
        					
        					<td style="word-break:break-all" width="80" align="right"><?=number_format($optiondata['offer_qty'],0); ?></td>

                            <?php if ($costSeetSpan==0): ?>
                                <td style="word-break:break-all;vertical-align: middle;text-align: center;justify-content: center;" rowspan="<?=$costSpanArr[$costSheetNo]; ?>" width="60"><?=$optiondata['itemUom'];//$unit_of_measurement[$row[csf("uom")]]; ?></td>
                            <?php endif ?>
        					
                            
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['fobPrice'],4); ?></td>
                            
        					<td width="80" align="right" style="word-break:break-all"><?=number_format($optiondata['amount'],4); ?></td>
        					<td style="word-break:break-all" width="70"><?=change_date_format($optiondata['delivery_date']); ?></td>
        					<td style="word-break:break-all" width="70"><?=change_date_format($optiondata['costing_date']); ?></td>
        					<td width="80" style="word-break:break-all"><?=$optiondata['inserted_by']; ?></td>
        					
        					<td width="80" style="word-break:break-all" bgcolor="<?=$tdcolor;?>"><?=$optiondata['cstatus']; ?></td>
        					...
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['fabCost'],4); ?></td>
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['trimCost'],4); ?></td>
        					
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['printEmb'],4); ?></td>
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['wash'],4); ?></td>
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['other'],4); ?></td>
                            <td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['commercial_cost'],4); ?></td>
                            <td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['lc_cost'],4); ?></td>
                            <td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['comm_cost'],4); ?></td>
        					<td style="word-break:break-all" width="70" align="right"><?=number_format($optiondata['cm'],4); ?></td>
        					<td style="word-break:break-all" bgcolor="<?=$tdcolor;?>" align="right" ><?=number_format($optiondata['fobPrice'],4); ?></td>
                        ...
                        $grand_commercial+=$optiondata['commercial'];
                        $grand_commission+=$optiondata['comm_cost'];
                        $grand_lc+=$optiondata['lc_cost'];
        				$grand_totCost+=$optiondata['fobPrice'];
        ...
        <table width="<?=$width; ?>" cellspacing="0" border="1" class="tbl_bottom" rules="all">
            <tr style="font-size:13px">
                ...
                <td width="70" align="right" id="value_td_commercial"><?=number_format($grand_commercial,2); ?></td>
                <td width="70" align="right" id="value_td_lc"><?=number_format($grand_lc,2); ?></td>
                <td width="70" align="right" id="value_td_commission"><?=number_format($grand_commission,2); ?></td>
                <td width="70" align="right" id="value_td_cm"><?=number_format($grand_cm,2); ?></td>
                <td  align="right" id="value_td_fob"><?=number_format($grand_totCost,2); ?></td>
