...
if($action=="report_generate")
{
	...
	if(str_replace("'","",$cbo_search_by)==1) //Order Wise
	{
		if($template==1)
		{
			...
			<table style="margin-left:1400px; margin-top:5px" id="table_notes">
				<tr>
			...
			<div style="width:3400px; max-height:400px; overflow-y:scroll" id="scroll_body">
			<table class="rpt_table" width="3380" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
			<? 
	...
	else if(str_replace("'","",$cbo_search_by)==2) //Style Wise
	{
		...
		if($template==1)
		{
			...
			<fieldset style="width:100%;">
                ...
                <table class="rpt_table" width="3220" cellpadding="0" cellspacing="0" border="1" rules="all">
                    <thead>
                        <th width="30">SL</th>
                        <th width="50">Buyer</th>
                        <th width="50">Season</th>
                ...
                <div style="width:3240px; max-height:400px; overflow-y:scroll" id="scroll_body">
                <table class="rpt_table" width="3223" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
			<?
        ...
        <td align="center" colspan="9"><strong>WO Summary</strong> </td>
			...
			<table border="1" class="rpt_table" rules="all" width="850" cellpadding="0" cellspacing="0" align="center">
				...
				$print_report_format=return_field_value("format_id","lib_report_template","template_name ='".$cbo_company_name."' and module_id=2 and report_id in(5,6) and is_deleted=0 and status_active=1");
					...
					$print_report_format2=return_field_value("format_id","lib_report_template","template_name ='".$cbo_company_name."' and module_id=2 and report_id in(219) and is_deleted=0 and status_active=1");
				...
				// $print_report_format=return_field_value("format_id","lib_report_template","template_name ='".$cbo_company_name."' and module_id=2 and report_id in(219) and is_deleted=0 and status_active=1");
				...
				foreach($dtlsArray as $row)
				{
					...
					<tr bgcolor="<? echo  $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
						...
						<!-- <td width="100" title="Multiple Job WiseTrim Booking"><p><a href="#" onClick="generate_trim_report('<? echo $reporAction;?>','<? echo $row[csf('booking_no')]; ?>',<? echo $cbo_company_name; ?>,<? echo $row[csf('is_approved')]; ?>,<? echo $row[csf('is_short')]; ?>,<? echo $report;?>)"><? echo $row[csf('booking_no')]; ?></a></p></td> -->
