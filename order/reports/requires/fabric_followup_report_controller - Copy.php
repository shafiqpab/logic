	...
	?>
        <div style="width:100%">
             <table width="<? echo $tbl_width;?>">
                <tr>
                    <td align="center" width="100%" colspan="44" class="form_caption"><? echo $report_title.'<br>'.$company_library[str_replace("'","",$cbo_company_name)].'<br/>';
									...
									?>
								 	<tr bgcolor = "<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>" style="font-size:13px">
				                        ...
				                        if($j==1)
										{
					                        ...
					                        <td width="110" valign="middle" rowspan="<? echo $job_wise_arr[$job_no]; ?>"><? echo $buyer_arr[$val["buyer_name"]]; ?></td>
					                        <td width="100" valign="middle" align="center" rowspan="<? echo $job_wise_arr[$job_no]; ?>"><? echo $val["job_no_prefix_num"]; ?></td>
					                        <td width="100" valign="middle" rowspan="<? echo $job_wise_arr[$job_no]; ?>" align="center"><div style="word-wrap:break-word:100px;"><? echo $val["style_ref_no"]; ?></div></td>
					                        <td width="70" valign="middle" rowspan="<? echo $job_wise_arr[$job_no]; ?>" align="center"> <div style="word-wrap:break-word:70px;"><?  $ref_no=rtrim($val["ref_no"],",");echo implode(', ',array_unique(explode(",",$ref_no)));?></div></td>
					                        <td width="70" valign="middle" rowspan="<? echo $job_wise_arr[$job_no]; ?>" align="center" bgcolor="#FFFFCC"><div style="word-wrap:break-word:70px;"><?  $file_no=rtrim($job_wise_po_file[$job_no]["file_no"],",");$file_nos=implode(',',array_unique(explode(",",$file_no))); echo $file_nos;//number_format($tot_po_qnty); ?></div></td>
					                        <td align="center" valign="middle" style="" rowspan="<? echo $job_wise_arr[$job_no]; ?>" width="100"><div style="word-wrap:break-word:100px;"><? $po_no=rtrim($job_wise_po_file[$job_no]["po_number"],',');$po_nos=implode(", ",array_unique(explode(",",$po_no)));echo $po_nos; ?></div></td>
										...
										?>
				                        <td align="center" rowspan="<? echo $body_wise_arr[$job_no][$bprat_id]; ?>" width="100"><div style="word-wrap:break-word:100px;"><? echo $body_part[$bprat_id]; ?></div></td>
				                       <?
				                        }
										 if($f==1)
										 {
				                        ...
				                        <td align="center" width="100" style="word-break:break-all" title="Gmts Color=<? echo $gmt_color;?>"><div style="word-wrap:break-word:100px;"><? echo $color_library[$gmt_color]; ?></div></td>
				                        ...
				                        <td align="right" width="80" title="Woven Fin Recv"><a href="javascript:open_wo_popup('<? echo implode(',',array_unique(explode(",",$po_id)));?>','<? echo $bprat_id;?>','<? echo $deter_id;?>','<? echo $gmt_color;?>','<? echo $job_no;?>','Fin Recv Info','fin_recv_popup')"><? echo number_format($kniting_prod_recv,2); ?></a></td>
				                        ...
				                        <td align="right" width="80" title="Fin Issue"><a href="javascript:open_wo_popup('<? echo implode(',',array_unique(explode(",",$po_id)));?>','<? echo $bprat_id;?>','<? echo $deter_id;?>','<? echo $gmt_color;?>','<? echo $job_no;?>','Fin Issue Info','fin_issue_popup')"><?   echo number_format($kniting_prod_issue,2); ?></a></td>
