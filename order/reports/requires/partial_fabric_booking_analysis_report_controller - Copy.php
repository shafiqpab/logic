...
if($txt_search_common!="" && $cbo_search_type!=6)
{
	...
	?>
		...
		<fieldset style="width:100%;">	
			...
			<table width="2930">
				<tr class="form_caption">
					<td colspan="33" align="center"><? echo $report_title;?></td>
				</tr>
				<tr class="form_caption">
					<td colspan="33" align="center"><? echo $company_library[$company_name]; ?></td>
				</tr>
			</table>
			<table class="rpt_table" width="2930" cellpadding="0" cellspacing="0" border="1" rules="all">
				<thead>
					<th width="30">SL</th>
                    <th width="100">Buyer</th>
					<th width="100">Style</th>
			...
			<div style="width:2930px;" id="scroll_body">
			<table class="rpt_table" width="2930" cellpadding="0" cellspacing="0"  border="1" rules="all" id="table_body_2">
			<?	 
			$print_report_format_par=return_field_value("format_id"," lib_report_template","template_name =".$company_name."  and module_id=2 and report_id=35 and is_deleted=0 and status_active=1");
			///echo $print_report_format_par;
			$print_report_format_part=explode(",",$print_report_format_par);
			...
			$yarn_booking_data=sql_select("SELECT  a.id,a.requ_prefix_num,b.job_no FROM  inv_purchase_requisition_mst a, inv_purchase_requisition_dtls b WHERE a.id=b.mst_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0");
			$req_num_id=array();
			foreach($yarn_booking_data as $row)
			{
			...
			foreach($result_fab_data as $row)
			{
			   ...
			   $sql_booking="SELECT a.id as booking_id,a.booking_no_prefix_num, a.booking_no,a.entry_form,a.item_category,a.pay_mode,a.remarks,a.fabric_source,a.is_approved,MAX(d.approved_date) as approved_date, a.booking_date,a.delivery_date,a.supplier_id, a.buyer_id,b.pre_cost_fabric_cost_dtls_id as fab_cost_dtls_id,b.fabric_color_id,b.color_type,b.uom,b.gmts_color_id,b.construction,b.copmposition,b.dia_width,b.gsm_weight,b.pre_cost_remarks as pre_remark,b.remark, b.fin_fab_qnty as fin_fab_qnty, b.grey_fab_qnty as grey_fab_qnty, b.job_no,b.po_break_down_id as po_id,c.process_loss_percent as process_loss_percent from  wo_booking_dtls b ,wo_pre_cos_fab_co_avg_con_dtls c,wo_booking_mst a left join approval_history d on a.id=d.mst_id and d.entry_form = 7 where a.booking_no=b.booking_no and b.po_break_down_id=c.po_break_down_id and c.color_number_id=b.gmts_color_id and b.dia_width=c.dia_width and b.pre_cost_fabric_cost_dtls_id=c.pre_cost_fabric_cost_dtls_id and a.company_id=$company_name and a.entry_form=108  and a.booking_type in(1) and a.is_short in(2) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $search_booking_cond $buyer_id_cond2 $booking_date_cond $po_cond_in group by a.id ,a.booking_no_prefix_num, a.booking_no,a.entry_form,a.item_category,a.pay_mode,a.remarks,a.fabric_source,a.is_approved, a.booking_date,a.delivery_date,a.supplier_id, a.buyer_id,b.pre_cost_fabric_cost_dtls_id ,b.fabric_color_id,b.color_type,b.uom,b.gmts_color_id,b.construction,b.copmposition,b.dia_width,b.gsm_weight,b.pre_cost_remarks,b.remark, b.fin_fab_qnty , b.grey_fab_qnty, b.job_no,b.po_break_down_id ,c.process_loss_percent order by a.booking_no,b.job_no";
			 ...
			 //	print_r($req_qty_arr);
				...
				<table class="rpt_table" width="2930" cellpadding="0" cellspacing="0" border="1" rules="all">
					...
					<th width="100"></th>
					<th width="100"></th>
					<th width="80" id="total_fin_fab_qty" align="right"><? echo number_format($total_fin_fab_qnty,2); ?></th>
                    <th width="80"></th>
					<th width="80" id="total_grey_fab_qty" align="right"><? echo number_format($total_grey_fab_qnty,2); ?></th>
       ...
       <table  width="100%" class="rpt_table"   border="1" cellpadding="0" cellspacing="0" rules="all">
            ...
            foreach($unapprove_data_array as $row)
            {
                ...
                <tr style="border:1px solid black;">
                    ...
                    <!-- <td width="45%" style="border:1px solid black; text-align:center"><? echo 'Yes';?></td> -->
                ...
                if($un_approved_date!="")
                {
                    ...
                    <tr style="border:1px solid black;">
                        ...
                        <td width="80%" style="border:1px solid black;text-align:center"><? if($row[csf('un_approved_date')]!="") echo date ("d-m-Y h:i:s",strtotime($row[csf('un_approved_date')])); else echo "";?></td>
                    </tr>
