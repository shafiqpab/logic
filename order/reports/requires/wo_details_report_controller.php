...
if($action=="company_wise_report_button_setting")
{
	...
	if($print_report_format != "")
	{
		foreach($print_report_format_arr as $id)
		{
			...
			if($id==712){echo "$('#show_button5').show();\n";}						
		}
	}
	exit();	
}
...
if ($action=="create_wo_search_list_view")
{
	...
	if ($data[5]==5) $wo_type_cond_additional="  and booking_type in(8,9)"; else $wo_type_cond_additional="";
	...
	if($data[5]==0)
	{
		$sql= "select id, booking_no, $year, booking_no_prefix_num, booking_date, buyer_id, booking_type, is_short, 0 as type from wo_booking_mst where status_active=1 and is_deleted=0 $company_id $buyer_id $year_id_cond $search_wo $category_id_cond $wo_type_cond $wo_type_cond_sam $wo_type_cond_additional
		union all
            ...
            <?
				...
				foreach ($nameArray as $selectResult)
				{
					...
					if ($selectResult[csf("type")]==0)
					{
						...
						else if($selectResult[csf("booking_type")]==4)
						{
							$wo_type="Sample With Order";
						}
						else if($selectResult[csf("booking_type")]==8 || $selectResult[csf("booking_type")]==9)
						{
							$wo_type="Additional Booking";
						}
					}
					else
					{
...
if ($action=="report_generate_bk")
{
	...
	if($cbo_category==4) //Accessories
	{
		if($wo_type==0)
		{
			...
			where a.booking_no=b.booking_no and a.booking_type in(2,5,8) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1
...
if ($action=="report_generate")
{
	...
	if($cbo_category==4) //Accessories
	{
		...
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate,c.item_color, sum(c.cons) as cons, b.brand_supplier
			from wo_booking_mst a, wo_booking_dtls b,wo_trim_book_con_dtls c
			where a.booking_no=b.booking_no and b.id= c.wo_trim_booking_dtls_id and a.booking_type in(8,9) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1
		 	and b.is_deleted=0 $po_idCond $item_id $sql_cond $booking_date_cond $within_cond
			group by a.id,a.is_approved,a.update_date,a.pay_mode, a.booking_no, a.booking_date, b.delivery_date, a.booking_type, a.is_short, a.supplier_id, a.buyer_id, a.item_category, a.remarks,a.inserted_by, b.id, b.po_break_down_id, b.pre_cost_fabric_cost_dtls_id, b.trim_group, b.construction, b.copmposition, b.uom, b.wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end),c.item_color,  b.brand_supplier
			order by a.id";
		} 
		else
		{
		...
		<fieldset>
			...
			<div style="max-height:350px; overflow-y:scroll; width:2960px" id="scroll_body" >
				...
				foreach($sql_result as $row)
				{
					...
					else if($row[csf("wo_type")]==8 || $row[csf("wo_type")]==9)
					{
						$wo_type="Additional Booking";
						$wo_typw_id=5;
					}
...
if ($action=="report_generate_2")
{
	...
	if($cbo_category==4) //Accessories
	{
		...
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate
			from wo_booking_mst a, wo_booking_dtls b
			where a.booking_no=b.booking_no and a.booking_type in(8,9) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1
		 and b.is_deleted=0 $po_idCond $item_id $sql_cond $booking_date_cond $within_cond
			order by a.id";
		}
		else
			...
			<div style="max-height:350px; overflow-y:scroll; width:3060px" id="scroll_body" >
				...
				?>
					...
					<tfoot>
						...
						<th align="right"><? echo number_format($tot_wo_value,4) ;?></th>
						<th >&nbsp;</th>
						<th align="right"><? echo number_format($total_precost_value,2) ;?></th>
						<th align="right"><? echo number_format($total_deference,2) ;?></th>
						<th align="right"><? echo number_format(($total_deference/$total_precost_value)*100,2) ;?></th>
						<th align="right"><? echo number_format($total_ontime_rcv,2) ;?></th>
						<th >&nbsp;</th>
						<th align="right"><? echo number_format($tot_receive_qnty,2) ;?></th>
						<th align="right"><? echo number_format($tot_receive_value,2) ;?></th>
						<th align="right"><? echo number_format($tot_rcv_balance,2) ;?></th>
						<th >&nbsp;</th>
						<th >&nbsp;</th>
						<th >&nbsp;</th>
...
if ($action=="report_generate_4")
{
	...
	if($cbo_category==4) //Accessories
	{
		if($wo_type==0)
		{
			...
			from wo_booking_mst a, wo_booking_dtls b,wo_trim_book_con_dtls c
			where a.booking_no=b.booking_no and b.id=c.wo_trim_booking_dtls_id and a.booking_type in(2,5,8) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and c.is_deleted=0 and c.status_active=1
		 and b.is_deleted=0  $po_idCond $item_id $sql_cond $booking_date_cond $within_cond
			union all
		...
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, c.requirment as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate,c.item_color,  (c.cons) as cons
			from wo_booking_mst a, wo_booking_dtls b,wo_trim_book_con_dtls c
			where a.booking_no=b.booking_no and b.id= c.wo_trim_booking_dtls_id and a.booking_type in(8,9) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1
		 	and b.is_deleted=0 $po_idCond $item_id $sql_cond $booking_date_cond $within_cond
...
if ($action=="report_generate_5")
{
	...
	if ($wo_no!="")  $sql_cond.=" and a.booking_no like '%$wo_no%'";
	if ($cbo_supplier>0)  $sql_cond.=" and a.supplier_id=$cbo_supplier";
	if ($wo_no!="")  $booking_recv_cond=" and c.booking_no like '%$wo_no%'"; else $booking_recv_cond="";
	if ($wo_no!="")  $booking_dtls_cond=" and booking_no like '%$wo_no%'"; else $booking_dtls_cond="";
	...
	if($cbo_category==4) //Accessories
	{
		if($wo_type==0)
		{
			...
			/* $sql="select a.id as book_mst_id, a.is_approved, a.update_date, a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty,(case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate, 1 as type, b.brand_supplier from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and a.booking_type in(2,5,8) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  $po_idCond $item_id $sql_cond $booking_date_cond $within_cond
			union all
			select a.id as book_mst_id, a.is_approved,a.update_date,a.pay_mode,a.booking_no as booking_no, a.booking_date as wo_date, a.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, null as remarks,0 as inserted_by, b.id as dtls_id, 0 as po_id, 0 as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.composition as copmposition, b.uom as wo_uom, b.trim_qty as wo_qnty,  (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate, 2 as type, b.barnd_sup_ref as brand_supplier from wo_non_ord_samp_booking_mst a, wo_non_ord_samp_booking_dtls b where a.booking_no=b.booking_no and a.booking_type in(2,3)  and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  $item_id $sql_cond $booking_date_cond $within_cond order by book_mst_id ,po_id";// and b.po_break_down_id=33350 */
			$sql="select a.id as book_mst_id, a.is_approved, a.update_date, a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty,(case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate, 1 as type
			from wo_booking_mst a, wo_booking_dtls b
			where a.booking_no=b.booking_no and a.booking_type in(2,5,8) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1
		 and b.is_deleted=0  $po_idCond $item_id $sql_cond $booking_date_cond $within_cond
			...
			from wo_non_ord_samp_booking_mst a, wo_non_ord_samp_booking_dtls b
			where a.booking_no=b.booking_no and a.booking_type in(2,3)  and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1
		 and b.is_deleted=0  $item_id $sql_cond $booking_date_cond $within_cond order by book_mst_id ,po_id";
		}
		else if ($wo_type==1 || $wo_type==2)
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks, a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate,c.item_color, 1 as type, sum(c.cons) as cons, b.brand_supplier from wo_booking_mst a, wo_booking_dtls b,wo_trim_book_con_dtls c where a.booking_no=b.booking_no and b.id= c.wo_trim_booking_dtls_id and a.booking_type in(2) and a.is_short=$wo_type and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $po_idCond $sql_cond $item_id $booking_date_cond $within_cond group by a.id,a.is_approved,a.update_date,a.pay_mode, a.booking_no, a.booking_date, b.delivery_date, a.booking_type, a.is_short, a.supplier_id, a.buyer_id, a.item_category, a.remarks, a.inserted_by, b.id, b.po_break_down_id, b.pre_cost_fabric_cost_dtls_id, b.trim_group, b.construction, b.copmposition, b.uom, b.wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end), c.item_color, 1 as type, b.brand_supplier order by a.id";
		}
		else if ($wo_type==3)
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate,c.item_color, 1 as type, sum(c.cons) as cons, b.brand_supplier from wo_booking_mst a, wo_booking_dtls b,wo_trim_book_con_dtls c where a.booking_no=b.booking_no and b.id= c.wo_trim_booking_dtls_id and a.booking_type in(5) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $po_idCond $item_id $sql_cond $booking_date_cond $within_cond group by a.id,a.is_approved,a.update_date,a.pay_mode, a.booking_no, a.booking_date, b.delivery_date, a.booking_type, a.is_short, a.supplier_id, a.buyer_id, a.item_category, a.remarks,a.inserted_by, b.id, b.po_break_down_id, b.pre_cost_fabric_cost_dtls_id, b.trim_group, b.construction, b.copmposition, b.uom, b.wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end),c.item_color, 1 as type, b.brand_supplier order by a.id";
		}
		 else if ($wo_type==5)
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom, b.wo_qnty as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate,c.item_color, sum(c.cons) as cons, b.brand_supplier from wo_booking_mst a, wo_booking_dtls b,wo_trim_book_con_dtls c where a.booking_no=b.booking_no and b.id= c.wo_trim_booking_dtls_id and a.booking_type in(8,9) and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $po_idCond $item_id $sql_cond $booking_date_cond $within_cond group by a.id,a.is_approved,a.update_date,a.pay_mode, a.booking_no, a.booking_date, b.delivery_date, a.booking_type, a.is_short, a.supplier_id, a.buyer_id, a.item_category, a.remarks,a.inserted_by, b.id, b.po_break_down_id, b.pre_cost_fabric_cost_dtls_id, b.trim_group, b.construction, b.copmposition, b.uom, b.wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end),c.item_color,  b.brand_supplier order by a.id";
		} 
		else
		{
			$sql="select a.id as book_mst_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, a.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, null as remarks, b.id as dtls_id, 0 as po_id, 0 as pre_cost_fabric_cost_dtls_id, b.trim_group as trim_group, b.construction as construction, b.composition as copmposition, b.uom as wo_uom, b.trim_qty as wo_qnty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate,b.gmts_color , 2 as type from wo_non_ord_samp_booking_mst a, wo_non_ord_samp_booking_dtls b where a.booking_no=b.booking_no and a.booking_type in(2,3)  and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $item_id $sql_cond $booking_date_cond $within_cond group by a.id,a.is_approved,a.update_date,a.pay_mode, a.booking_no, a.booking_date, a.delivery_date, a.booking_type, a.is_short, a.supplier_id, a.buyer_id, a.item_category, null, b.id, 0, 0, b.trim_group, b.construction, b.composition, b.uom , b.trim_qty, (case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end),b.gmts_color, 2 as type";
		}
	}
	else if($cbo_category==25) //Emblishmnet
	{
		if($wo_type==0)
		{
			$sql="select a.id as book_mst_id,a.currency_id, a.is_approved, a.update_date, a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks,a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.emblishment_name,b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom,b.gmts_color_id, b.wo_qnty as wo_qnty,b.rate,a.exchange_rate,(case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate, 1 as type, b.trim_group as trim_group, b.brand_supplier from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and a.booking_type in(6) and b.wo_qnty>0 and a.item_category=$cbo_category and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0   $po_idCond  $sql_cond $booking_date_cond $within_cond";
		}
		else if ($wo_type==1 || $wo_type==2)
		{
			$sql="select a.id as book_mst_id,a.currency_id,a.is_approved,a.update_date,a.pay_mode, a.booking_no as booking_no, a.booking_date as wo_date, b.delivery_date, a.booking_type as wo_type, a.is_short, a.supplier_id as supplier_id, a.buyer_id as buyer_id, a.item_category as item_category, a.remarks as remarks, a.inserted_by as inserted_by, b.id as dtls_id, b.po_break_down_id as po_id, b.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.emblishment_name, b.construction as construction, b.copmposition as copmposition, b.uom as wo_uom,b.gmts_color_id, b.wo_qnty as wo_qnty,b.rate,a.exchange_rate,(case when a.exchange_rate>0 then (b.rate/a.exchange_rate) else b.rate end) as wo_rate, 1 as type,, b.trim_group as trim_group, b.brand_supplier from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and a.booking_type in(6) and b.wo_qnty>0 and a.is_short=$wo_type and a.item_category=$cbo_category and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  $po_idCond  $sql_cond   $booking_date_cond $within_cond order by a.id";
		}
	}
	...
	if($cbo_category==4) //Accessories
	{
		...
		?>
		<fieldset>
			<table width="1790"  cellspacing="0" >
				<tr class="form_caption" style="border:none;">
				...
				<tr class="form_caption" style="border:none;">
					<td align="center" style="border:none;font-size:12px; font-weight:bold"  colspan="19"> <? echo "From ".change_date_format($date_from)." To ".change_date_format($date_to);?></td>
				</tr>
			</table>
			<table width="1750" cellspacing="0" border="1" class="rpt_table" rules="all">
				<thead>
					<th width="40">SL</th>
					<th width="110">WO No</th>
					<th width="70">WO Date</th>
			...
			<div style="max-height:350px; overflow-y:scroll; width:1770px" id="scroll_body" >
				<table cellspacing="0" cellpadding="0" border="1" class="rpt_table"  width="1750" rules="all" id="table_body" >
				<?
				...
				foreach($sql_result as $row)
				{
					...
					?>
					<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>">
						<td align="center" width="40" align="center"><? echo $i;?></td>
						<td align="center" width="110"><p><? echo $row[csf("booking_no")]; ?></td>
						<td align="center" width="70" align="center"><p><? echo change_date_format($row[csf("wo_date")]); ?>&nbsp;</p></td>
						<td align="center" width="100"><p><? echo $supplier_com; ?>&nbsp;</p></td>
						<td align="center" width="100"><p><? echo $buyerArr[$row[csf("buyer_id")]]; ?>&nbsp;</p></td>
						<td align="center" width="100"><p><? echo $order_data_arr[$row[csf("po_id")]]["style_ref_no"]; ?>&nbsp;</p></td>
						<td align="right"  width="100"><p><? echo $order_data_arr[$row[csf("po_id")]]["order_qty"];$order_qty_total +=$order_data_arr[$row[csf("po_id")]]["order_qty"];?>&nbsp;</p></td>
						<td align="center" width="120"><p><? echo $trimsGroupArr[$row[csf("trim_group")]]; ?>&nbsp;</p></td>
						<td align="center" width="150" style="word-break:break-all"><p>
						<?
						$desc_trim=chop($description_arr[$row[csf("dtls_id")]]["description"],'__');
						$desc_trims=implode(",",array_unique(explode(",",$desc_trim)));
						echo $desc_trims; 
						?>&nbsp;</p></td>
						<td align="center" width="60"><p><? echo $unit_of_measurement[$row[csf("wo_uom")]]; ?>&nbsp;</p></td>
						<td width="80" align="right"><p><? echo number_format($row[csf("wo_qnty")],2,'.',''); ?></p></td>
						<td width="70" align="right"><p><? echo number_format($row[csf("wo_rate")],4,'.',''); ?>&nbsp;</p></td>
						<td width="80" align="right"><p><? $wo_value=$row[csf("wo_qnty")]*$row[csf("wo_rate")]; echo number_format($wo_value,4,'.',''); ?></p></td>
						<td width="70" align="right"><p><? echo number_format($pre_cost_data_arr[$row[csf("po_id")]][$row[csf("trim_group")]],4,'.',''); ?></p></td>
						<td width="80" align="right"><p><? $precost_value=$row[csf("wo_qnty")]*$pre_cost_data_arr[$row[csf("po_id")]][$row[csf("trim_group")]]; echo number_format($precost_value,4); ?></p></td>
						<td width="80" align="right"><p><? $deference = $precost_value-$wo_value; echo number_format($deference,2,'.',''); ?></p></td>
						<td align="center"  width="120"><p><? echo $lib_team_member_arr[$order_data_arr[$row[csf("po_id")]]['dealing_marchant']]; ?></p></td>
						<td align="center"  width="120"><p><? echo $lib_team_leader_name_arr[$order_data_arr[$row[csf("po_id")]]['team_leader']] ; ?></p></td>
				...
				?>
					<tfoot>
						...
						<th >&nbsp;</th>
						<th >Total:</th>
						<th ><? echo number_format($order_qty_total,2) ;?>&nbsp;</th>
						<th >&nbsp;</th>
						<th >&nbsp;</th>
						<th >&nbsp;</th>
						<th align="right"><? echo number_format($tot_wo_qnty,2) ;?></th>
			...
			<table cellspacing="0" cellpadding="0" border="0" width="1750" rules="all">
				<tr>
					<td valign="top">
						...
						<table cellspacing="0" cellpadding="0" border="1" class="rpt_table"  width="650" rules="all">
	
							<thead>
								<tr bgcolor="#CCCCCC">
									<td colspan="5" align="center" style="font-size:16px; font-weight:bold;">Item Group Wise Summary</td>
								</tr>
								<tr>
									<th width="50">SL</th>
									<th width="150">Item Name</th>
									<th width="150">Precost value</th>
									<th width="150">Total Rcv Qty</th>
									<th width="150">Rcv Balance</th>
								</tr>
							</thead>
							<tbody>
								<?
							...
							<tbody>
								...
								foreach($supplier_wise_sammary as $val)
								{
									...
									<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>">
										...
										<td align="right"><? echo number_format($val["wo_value"],4); ?></td>
										<td align="right"><? echo number_format($val["pre_value"],2); ?></td>
										<td align="right"><? $different=$val["pre_value"]-$val["wo_value"];echo number_format((($different/$val["pre_value"])*100),2); ?></td>
										<td align="right"><? echo number_format($val["ontimeRcv"],2); ?></td>
										<td align="right"><? echo number_format($val["rcv_qnty"],2); ?></td>
										<td align="right"><? echo number_format($rcv_bal,2); ?></td>
										<td align="right"><? echo number_format($val["otd"],2); ?></td>
