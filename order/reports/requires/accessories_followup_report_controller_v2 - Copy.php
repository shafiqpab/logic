...
if($action=="report_generate3")
{
	...
	<div style="width:1320px">
		...
		from order_wise_pro_details c, product_details_master d
		where c.prod_id=d.id and c.entry_form in(24,25,49,73) and d.entry_form=24 and c.status_active=1 and c.is_deleted=0 $order_cond";
		//echo $trims_sql;//die;
