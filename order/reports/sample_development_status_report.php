...
<script>
	...
	function fn_report_generated()
	{
		...
		{	
			...
			freeze_window(3);
			http.open("POST","requires/sample_development_status_report_controller.php",true);
	...
	function openImageWindow(id)
	{
		...
		var page_link = 'requires/sample_development_status_report_controller.php?&action=image_view_popup&id='+id;
                ...
                <table class="rpt_table" width="1050" cellpadding="1" cellspacing="2">
                   <thead>                    
                    ...
                    <tr class="general">
                        <td> 
                            <?
                               echo create_drop_down( "cbo_company_name", 170, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/sample_development_status_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                            ?>
                        </td>
                        <td id="buyer_td">
                            <? 
