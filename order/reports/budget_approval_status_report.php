...
<script>
	...
	function fn_report_generated(operation)
	{
		...
		var txt_unapproval_date_from=document.getElementById('txt_unapproval_date_from').value;
		var txt_unapproval_date_to=document.getElementById('txt_unapproval_date_to').value;
		
		
		
		// if( (trim(txt_unapproval_date_from)=="" || trim(txt_unapproval_date_to)=="") && (trim(txt_date_from)=="" || trim(txt_date_to)=="") || cbo_company==0 || ){
		...
		{	 
			...
			//alert(txt_date_from+'_'+txt_date_to+'_'+txt_unapproval_date_from+'_'+txt_unapproval_date_to+'_'+cbo_company); return;
			var report_title=$( "div.form_caption" ).html();
			var data="action=report_generate"+get_submitted_data_string('cbo_company_id*txt_job_no*txt_style_ref*txt_order_no*txt_date_from*txt_date_to*txt_unapproval_date_from*txt_unapproval_date_to',"../../")+'&report_title='+report_title;
			
			freeze_window(3);
			http.open("POST","requires/budget_approval_status_report_controller.php",true);
        ...
        <div id="content_search_panel" style="width:850px" > 		 
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                <thead>                    
                    ...
                    <th width="140" colspan="2">Job Incert  Date Range</th>
                    <th width="140" colspan="2">Last unapproved date Range</th>
                ...
                <tbody>
                    <tr class="general">
						...
						<td><input name="txt_order_no" id="txt_order_no" class="text_boxes" style="width:100px"/></td>
                        ...
                        <td><input name="txt_unapproval_date_from" id="txt_unapproval_date_from" class="datepicker" style="width:50px" placeholder="From Date"/></td>
                        <td><input name="txt_unapproval_date_to" id="txt_unapproval_date_to" class="datepicker" style="width:50px"  placeholder="To Date" /></td>
