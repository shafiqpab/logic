...
if($action=="report_generate2")
{
	...
	$pi_number_data=sql_select("SELECT f.style_ref_no,d.pi_number,f.job_no,i.job_id, i.lib_yarn_count_deter_id, c.amount, c.color_id as color_id from wo_booking_dtls b left join  wo_pre_cost_fabric_cost_dtls i on   b.job_no = i.job_no,com_pi_item_details c , com_pi_master_details d ,wo_po_details_master f	where b.booking_no=c.work_order_no   and b.job_no = f.job_no and d.id=c.pi_id and b.status_active=1 and b.is_deleted=0 	and c.status_active=1 and c.is_deleted=0 and d.pi_basis_id in (1,2) and d.status_active=1 and d.is_deleted=0 and d.importer_id in (1)  $jobid_cond4 and d.entry_form=166	group by f.style_ref_no,d.pi_number,f.job_no ,i.job_id, i.lib_yarn_count_deter_id, c.amount, c.color_id");
//	echo "SELECT f.style_ref_no,d.pi_number,f.job_no,i.job_id, i.lib_yarn_count_deter_id, c.amount, c.color_id as color_id from wo_booking_dtls b left join  wo_pre_cost_fabric_cost_dtls i on   b.job_no = i.job_no,com_pi_item_details c , com_pi_master_details d ,wo_po_details_master f	where b.booking_no=c.work_order_no   and b.job_no = f.job_no and d.id=c.pi_id and b.status_active=1 and b.is_deleted=0 	and c.status_active=1 and c.is_deleted=0 and d.pi_basis_id in (1,2) and d.status_active=1 and d.is_deleted=0 and d.importer_id in (1)  $jobid_cond4 and d.entry_form=166	group by f.style_ref_no,d.pi_number,f.job_no ,i.job_id, i.lib_yarn_count_deter_id, c.amount, c.color_id";
	...
	foreach ($pi_number_data_lc as $row) {
