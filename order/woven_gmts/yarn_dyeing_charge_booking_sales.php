...
//--------------------------------------------------------------------------------------------------------------------
    ...
    function fnc_yarn_dyeing_response() {
        if (http.readyState == 4) {
            ...
            reset_form('', '', 'txt_yern_color*cbo_color_range*txt_wo_qty*txt_dyeing_charge*txt_amount*txt_bag*txt_cone*txt_min_req_cone*txt_ref_no*txt_remarks*txt_budget_wo_qty*dtls_update_id*txt_lot*txt_pro_balance*txt_pro_id*txt_original_pro_id', '', '', '');
        }
    }
    ...
    function openmypage_lot() {
        ...
        var page_link = "requires/yarn_dyeing_charge_booking_sales_controller.php?action=lot_info_popup&companyID=" + company + "&job_no=" + job_no;
        var title = 'Lot Info';
    ...
    //            var job_no = $("#txt_job_no").val();
    //            //alert(job_no);
    //            page_link = 'requires/yarn_dyeing_charge_booking_sales_controller.php?action=lot_search_popup&company=' + company + '&job_no=' + job_no;
    ...
    function check_exchange_rate() {
        ...
        var response = return_global_ajax_value(cbo_currercy + "**" + booking_date, 'check_conversion_rate', '', 'requires/yarn_dyeing_charge_booking_sales_controller');
...
<body onLoad="set_hotkey();check_exchange_rate();">
        ...
        <fieldset style="width:1200px;">
            ...
            <table width="1200" cellspacing="2" cellpadding="0" border="0">
                <tr>
                    ...
                    <td width="120" height="" align="right" class="must_entry_caption"> Yarn Dyeing Wo No</td>
                    <!-- 11-00030  -->
                    <td width="130">
                        <input class="text_boxes" type="text" style="width:160px" onDblClick="openmypage_booking()"
                        readonly placeholder="Double Click for Booking" name="txt_booking_no"
                        id="txt_booking_no"/>
                    </td>
                    <td align="" width="120">&nbsp;</td>
                    <td align="" width="130">&nbsp;</td>
                ...
                <tr>
                    ...
                    echo create_drop_down("cbo_company_name", 140, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name", "id,company_name", 1, "-- Select Company --", $selected, "chack_variable(this.value);load_drop_down( 'requires/yarn_dyeing_charge_booking_sales_controller',this.value, 'load_drop_down_supplier', 'supplier_td' );", 0);
                    ?></td>
                  ...
                  <td><input class="datepicker" type="text" style="width:130px" name="txt_booking_date"
                     id="txt_booking_date" onChange="check_exchange_rate();" value="<? echo date("d-m-Y") ?>"
                     disabled/></td>
                     <td align="right">Attention</td>
                     <td><input class="text_boxes" type="text" style="width:130px;" name="txt_attention"
                         id="txt_attention"/></td>
                     </tr>
                     <tr>
                    ...
                    <td><input style="width:130px;" type="text" class="text_boxes_numeric" name="txt_exchange_rate"
                     id="txt_exchange_rate" readonly/></td>
                 ...
                 <tr>
                    ...
                    <td><input class="datepicker" type="text" style="width:130px" name="txt_delivery_date"
                     id="txt_delivery_date"/></td>
                     <td align="right">G/Y Issue End</td>
                     <td height="10"><input class="datepicker" type="text" style="width:130px" name="txt_delivery_end"
                         id="txt_delivery_end"/></td>
                         <td align="right">D/Y Delivery Start</td>
                         <td height="10"><input class="datepicker" type="text" style="width:130px" name="dy_delevery_start"
                             id="dy_delevery_start"/></td>
                             <td align="right">D/Y Delivery End</td>
                             <td height="10"><input class="datepicker" type="text" style="width:130px" name="dy_delevery_end"
                                 id="dy_delevery_end"/></td>
                             </tr>
                             <tr>
                        ...
                        <tr>
                            <td height="25" align="right" colspan="2">
                                ...
                                <input type="button" class="image_uploader" style="width:192px" value="CLICK TO ADD/VIEW IMAGE"
                                onClick="file_uploader ( '../../', document.getElementById('update_id').value,'', 'yarn_dyeing_wo_sales_order', 0 ,1)">
                            </td>
                            <td align="center" height="10" colspan="2">
                                <input type="button" id="set_button" class="image_uploader" style="width:160px;"
                                value="Terms & Condition/Notes" onClick="open_terms_condition_popup( 'requires/yarn_dyeing_charge_booking_sales_controller.php?action=terms_condition_popup','Terms Condition'
                                )"/>
                        ...
                        <tr>
                            <td colspan="8">
                                ...
                                <thead>
                                    <tr>
                                        <th width="120" class="must_entry_caption">Sales Order No</th>
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            ...
                                            placeholder="Double Click for Sales Order" readonly style="width:120px;"
    ...
    <tr>
        <td align="center" colspan="8" valign="middle" class="button_container">
          ...
          <input type="button" value="Print" onClick="generate_report()" style="width: 80px;" name="print"
          id="print" class="formbutton"/>
