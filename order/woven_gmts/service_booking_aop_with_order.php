...
function fnc_trims_booking_reponse(){
	if(http.readyState == 4) 
	{
		 ...
		 if(reponse[0]==2)
		 {
			show_msg(trim(reponse[0]));
			set_button_status(0, permission, 'fnc_trims_booking',1);
			reset_form('','data_panel','txt_booking_no*cbo_company_name*cbo_buyer_name*cbo_currency*txt_exchange_rate*txt_booking_date*txt_delivery_date*cbo_pay_mode*cbo_source*cbo_supplier_name*txt_attention','txt_booking_date,<? echo date("d-m-Y"); ?>'); 
		 }
...
function check_exchange_rate()
	{
		...
		var response=return_global_ajax_value( cbo_currercy+"**"+booking_date, 'check_conversion_rate', '', 'requires/service_booking_aop_with_order_controller');
            ...
            <fieldset style="width:950px;">
                ...
                <table  width="900" cellspacing="2" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td  width="170" >
                        <input class="text_boxes" type="text" style="width:160px" onDblClick="openmypage_booking('requires/service_booking_aop_with_order_controller.php?action=service_booking_popup','Service Booking Search')" readonly placeholder="Double Click for Booking" name="txt_booking_no" id="txt_booking_no"/>
                        </td>
                        <td align=""></td>
                        <td align=""></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <input type="hidden" class="image_uploader" style="width:162px" value="Lab DIP No" onClick="openmypage('requires/service_booking_aop_with_order_controller.php?action=lapdip_no_popup','Lapdip No','lapdip')">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td align="right"></td>
                        <td align="center" height="10" ><input type="button" id="set_button" class="image_uploader" style="width:160px;" value="Terms & Condition/Notes" onClick="open_terms_condition_popup('requires/service_booking_aop_with_order_controller.php?action=terms_condition_popup','Terms Condition')" /></td>
                    </tr>
                    <tr>
