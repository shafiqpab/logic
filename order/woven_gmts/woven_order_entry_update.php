...
function openmypage(page_link,title)
{
	...
	emailwindow.onclose=function()
	{
		...
		if (theemail.value!="")
		{
			...
			show_list_view(theemail.value,'show_po_active_listview','po_list_view','../woven_order/requires/woven_order_entry_controller_update','');
...
{ 
		...
		var page_link="requires/woven_order_entry_controller_update.php?txt_job_no="+trim(txt_job_no)+"&action=open_set_list_view&set_breck_down="+set_breck_down+"&tot_set_qnty="+tot_set_qnty+'&unit_id='+unit_id+'&tot_smv_qnty='+tot_smv_qnty+'&precostfound='+data[0]+'&cbo_company_name='+cbo_company_name;
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, pcs_or_set, 'width=720px,height=300px,center=1,resize=1,scrolling=0','../')
		emailwindow.onclose=function()
		{
...
function pp_meeting_po()
{
	...
	var page_link='requires/woven_order_entry_controller_update.php?action=all_po_ppMeeting&update_id='+update_id;
	var title='PP Meeting Info';
            		...
            		<table  width="900" cellspacing="2" cellpadding="0" border="0">
                       <tr>
                            <td  width="130" height="" align="right">Job No</td>              <!-- 11-00030  -->
                                <td  width="170" >
                                <input style="width:160px;" type="text" title="Double Click to Search" onDblClick="openmypage('requires/woven_order_entry_controller_update.php?action=order_popup','Job/Order Selection Form')" class="text_boxes" placeholder="New Job No" name="txt_job_no" id="txt_job_no" readonly />                               
                                </td>
                                ...
                                <td width="170">
									...
									//echo "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name";
							   			echo create_drop_down( "cbo_company_name", 172, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'load_drop_down_location', 'location' ); load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'load_drop_down_buyer', 'buyer_td' ); load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'load_drop_down_agent', 'agent_td' );publish_shipment_date( this.value ); load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'load_drop_down_party_type', 'party_type_td' );publish_shipment_date( this.value ) " );
							   		?> 
                                 </td>
                        ...
                        <tr>
                        	...
                        	<td>
                            	<input class="text_boxes" type="text" style="width:160px" placeholder="Double Click for Quotation" name="txt_style_ref" id="txt_style_ref" onDblClick="open_qoutation_popup('requires/woven_order_entry_controller_update.php?action=quotation_id_popup','Quotation ID Selection Form')" readonly/>	
                            </td>
                            <td align="right">
                               Style Description
                            </td>
                        ...
                        <tr>
                                ...
                                <td > <input style="width:160px;"  class="text_boxes"  name="txt_repeat_no" id="txt_repeat_no" readonly  />
                                </td>
                        ...
                        <tr>
    						...
    						<td>
                             <?  //load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'cbo_factory_merchant', 'div_marchant_factory' )
							  	echo create_drop_down( "cbo_team_leader", 172, "select id,team_leader_name from lib_marketing_team where project_type=2 and status_active =1 and is_deleted=0 order by team_leader_name","id,team_leader_name", 1, "-- Select Team --", $selected, "load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'cbo_dealing_merchant', 'div_marchant' );load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'cbo_factory_merchant', 'div_marchant_factory' )  " );
								?>		
                            </td>
                           ...
                           <td align="right" class="must_entry_caption">Factory Merchant</td>   
    						<td id="div_marchant_factory" > 
                            <? 
							  	echo create_drop_down( "cbo_factory_merchant", 172, $blank_array,"", 1, "-- Select Team Member --", $selected, "" );
								?>	
                           </td>
                        ...
                        <tr>
                            ...
                            <td>	
                                <input class="text_boxes" type="text" style="width:160px;"  name="txt_bhmerchant" id="txt_bhmerchant"/>
                            </td>
                        	<td align="right">
                               Remarks
                            </td>
                        ...
                        <tr>
                          ...
                          <td id="agent_td">
                           ...
                           <td id="season_td">
                         <? echo create_drop_down( "cbo_season_name", 172, $blank_array,"", 1, "-- Select Season --", $selected, "" ); ?>                       	
                        ...
                        <tr>
                            ...
                            <td align="right"></td>
                        	<td>
                            <input type="button" value="Booking Meeting Date" class="image_uploader" style="width:170px" onClick="booking_meeting_date()"/>	
                            </td>
            	...
            	<form id="orderdetailsentry_2" autocomplete="off">
                    ...
                    <thead class="form_table_header">
                        ...
                        <tr>
                                ...
                                <td height="22" >
                                    <?  echo create_drop_down( "cbo_order_status", 100, $order_status, 0, "", $selected, "","","" ); ?>
                            ...
                            <tr>
                             ...
                             <td align="right"><strong>Packing</strong> </td>
                                ...
                                <td align="right"><input type="button" value="Actual Po No" class="image_uploader" style="width:80px" onClick="pop_entry_actual_po()"/></td>
                                   <td align="right" colspan="2"><input type="button" value="PP Meeting" class="image_uploader" style="width:80px" onClick="pp_meeting_po()"/></td> 	
                        	</tr>
                                <tr>
