...
<script type="text/javascript">
	...
	function fnc_copy_job()
	{
		...
		if (form_validation('txt_job_no*cbo_company_id*tot_smv_qnty','Job No*Company Name*SMV')==false)
		{
			return;
		}
		else
		{
			...
			var data="action=save_update_delete_copy_job"+get_submitted_data_string('txt_job_no*cbo_company_id*cbo_new_company_id*cbo_new_buyer_id*cbo_season_id*txt_new_style_ref*item_id*cbo_gmtsItem_id*tot_smv_qnty*set_breck_down*cbo_order_uom*txt_po_id*txt_costing_date*hiddn_wsdata*cbo_season_year',"../../");
			freeze_window(0);
                            ...
                            <td width="100%" align="center" valign="top" colspan="8">
                               ...
                               <fieldset style="width:950px;">
                                    <table cellpadding="5" cellspacing="5">
                                        ...
                                        <tr>
                                            <td align="right"><b>New Style Ref.</b></td>
                                            ...
                                            <td><? echo create_drop_down( "cbo_order_uom",50, $unit_of_measurement, "",0, "", 1, "","","1,58" );
                                                echo create_drop_down( "cbo_gmtsItem_id", 100, get_garments_item_array(3), 0, 1, "--Select Item--", $data,"",'',$data); ?>
                                            </td>
                                            ...
                                            <td>Season Year</td>
                                    		<td><?=create_drop_down( "cbo_season_year", 140, create_year_array(),"", 1,"-Year-", 1, "",0,"" ); ?></td>
                                        </tr>
                                    </table>
                                 </fieldset>
                            </td>
