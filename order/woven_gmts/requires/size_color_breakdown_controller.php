...
if($action=="populate_size_color_breakdown_pop_up")
{
	...
	var hidd_po_poQty= '<? echo $txt_po_quantity; ?>';
	var cbo_order_status= '<? echo $cbo_order_status; ?>';
	//alert(permission);
                    ...
                    <table  width="950" cellspacing="2" cellpadding="0" border="0">
                        <tr style="visibility:hidden">
                            ...
                            <td width="170">
								...
								<input type="hidden" id="hidd_job_id" name="hidd_job_id" readonly />
...
//============================================================================================
	...
	else if ($operation==1)   // Update Here
	{
		...
		//echo "10**".$hidd_order_status_id;die;
		...
		if($isapproved==1 && $hidd_order_status_id==1)
		{
...
//============================================================================================
	...
	else if ($operation==2)   // Delete Here
	{
		...
		//$sql_samp_data=sql_select("select po_break_down_id from wo_po_sample_approval_info where po_break_down_id='$order_id' and is_deleted=0 and status_active=1");
		//execute_query( "update  wo_po_sample_approval_info set status_active=0,is_deleted=1  where  po_break_down_id =$order_id and job_no_mst='".$txt_job_no."' ",1);
		//execute_query( "update  wo_po_lapdip_approval_info set status_active=0,is_deleted=1  where  po_break_down_id =$order_id and job_no_mst='".$txt_job_no."' ",1);
		execute_query( "update  wo_booking_mst set is_apply_last_update=2  where  job_no ='".$txt_job_no."' and booking_type=1 and is_short=2 ",1);
		if($db_type==0)
		{
			if($rID ){
