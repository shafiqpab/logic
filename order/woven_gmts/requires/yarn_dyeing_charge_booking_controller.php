...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)
	{
		...
		$field_array_dts="id,mst_id,job_no,product_id,job_no_id,entry_form,count,yarn_description,yarn_color,color_range,uom,yarn_wo_qty,dyeing_charge,amount,no_of_bag,no_of_cone,min_require_cone,file_no,internal_ref_no,remarks,referance_no,status_active,is_deleted";
		$data_array_dts="(".$dtlsid.",".$id.",'".$txt_job_no."','".$txt_pro_id."',".$txt_job_id.",41,'".$cbo_count."','".$txt_item_des."',".$txt_yern_color.",'".$cbo_color_range."',".$cbo_uom.",".$txt_wo_qty.",".$txt_dyeing_charge.",".$txt_amount.",".$txt_bag.",".$txt_cone.",".$txt_min_req_cone.",".$txt_file_no.",".$txt_int_ref_no.",".$txt_remarks.",'".$txt_ref_no."',1,0)";
	...
	else if ($operation==1) // Update Here----------------------------------------------------------
	{
		...
		$field_array_dtls = "job_no*product_id*job_no_id*count*yarn_description*yarn_color*color_range*uom*yarn_wo_qty*dyeing_charge*amount*no_of_bag*no_of_cone*min_require_cone*file_no*internal_ref_no*remarks*referance_no";
		$data_array_dtls = "'".$txt_job_no."'*'".$txt_pro_id."'*".$txt_job_id."*".$cbo_count."*'".$txt_item_des."'*".$txt_yern_color."*".$cbo_color_range."*".$cbo_uom."*".$txt_wo_qty."*".$txt_dyeing_charge."*".$txt_amount."
...
if($action=="show_dtls_list_view")
{
	...
	if($db_type==0)
	{
		$sql = "select a.id, a.mst_id, a.job_no, a.product_id, a.job_no_id, a.count, a.yarn_description, a.yarn_color, a.color_range, a.uom, a.yarn_wo_qty, a.dyeing_charge, a.amount, a.no_of_bag, a.no_of_cone, a.min_require_cone, a.remarks, a.referance_no, group_concat(b.file_no) as file_no, group_concat(b.grouping) as internal_ref_no
		from wo_yarn_dyeing_dtls a, wo_po_break_down b
		where a.job_no=b.job_no_mst and a.id='$data'
		group by a.id, a.mst_id, a.job_no, a.product_id, a.job_no_id, a.count, a.yarn_description, a.yarn_color, a.color_range, a.uom, a.yarn_wo_qty, a.dyeing_charge, a.amount, a.no_of_bag, a.no_of_cone, a.min_require_cone, a.remarks, a.referance_no";
	}
	else
	{
		$sql = "select a.id, a.mst_id, a.job_no, a.product_id, a.job_no_id, a.count, a.yarn_description, a.yarn_color, a.color_range, a.uom, a.yarn_wo_qty, a.dyeing_charge, a.amount, a.no_of_bag, a.no_of_cone, a.min_require_cone, a.remarks, a.referance_no, listagg(cast(b.file_no as varchar(4000)), ',') within group(order by b.file_no) as file_no, listagg(cast(b.grouping as varchar(4000)), ',') within group(order by b.grouping) as internal_ref_no
		from wo_yarn_dyeing_dtls a, wo_po_break_down b
		where a.job_no=b.job_no_mst and a.id='$data'
		group by a.id, a.mst_id, a.job_no, a.product_id, a.job_no_id, a.count, a.yarn_description, a.yarn_color, a.color_range, a.uom, a.yarn_wo_qty, a.dyeing_charge, a.amount, a.no_of_bag, a.no_of_cone, a.min_require_cone, a.remarks, a.referance_no";
	}
						...
						<tr>
							<td align="center" style="font-size:14px">
								...
								foreach ($nameArray as $result)
								{
									...
									Email Address __ susu: <? echo $result[csf('email')];?>
									Website No: <? echo $result[csf('website')];
								}
