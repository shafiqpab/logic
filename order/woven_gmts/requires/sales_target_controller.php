...
if ($action=="generate_list_view")
{
	...
	{
		$m=$row[csf("month_id")]; $y=$row[csf("year_id")];
		$mmyy=$m.','.$y;
                ...
                if ($k<13)
                {
                    ...
                    <tr>                       	 
                         ...
                         <? if($mst_id=="")
						 {
							 ...
							 ?>
                             <input type="text" name="mint_<? echo $month.$yy; ?>" id="mint_<? echo $month.$yy; ?>"  onkeyup="fn_calculate()" class="text_boxes_numeric" value="<?  echo $cur_trg_mint_1* $cur_trg_mint_2/100; ?>" />
                          <?
						 }
						 else
						 {
						...
						echo $prv_data_arr['mint'.$month.($yy-1)];
						 //echo $pre_arr_al_prcnt_arr[$month]*$pre_arr_capacity_arr[$month]/100;
						 //$pre_tot_alo_prcnt_val+=$pre_arr_al_prcnt_arr[$month]*$pre_arr_capacity_arr[$month]/100;
