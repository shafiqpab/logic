...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)  // Insert Here
	{
		...
		$field_array="id, booking_type, is_short, booking_month, booking_year, booking_no_prefix, booking_no_prefix_num, booking_no, company_id, buyer_id, job_no, 	item_category, supplier_id, currency_id, exchange_rate, booking_date, delivery_date, pay_mode, source, attention, remarks, item_from_precost, entry_form, inserted_by, insert_date";
		 ...
		 $data_array ="(".$id.",2,2,".$cbo_booking_month.",".$cbo_booking_year.",'".$new_booking_no[1]."',".$new_booking_no[2].",'".$new_booking_no[0]."',".$cbo_company_name.",".$cbo_buyer_name.",".$txt_job_no.",4,".$cbo_supplier_name.",".$cbo_currency.",".$txt_exchange_rate.",".$txt_booking_date.",".$txt_delivery_date.",".$cbo_pay_mode.",".$cbo_source.",".$txt_attention.",".$txt_remarks.",".$cbo_item_from_precost.",87,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
		 ...
		 $field_array1="id, pre_cost_fabric_cost_dtls_id, po_break_down_id, job_no, booking_no, booking_type, is_short, trim_group, uom, sensitivity, wo_qnty, exchange_rate, rate, amount, delivery_date, cons_break_down, country_id_string, inserted_by, insert_date";
		...
		$field_array2="id, wo_trim_booking_dtls_id, booking_no, job_no, po_break_down_id, color_number_id, gmts_sizes, description, brand_supplier, item_color, item_size, cons, process_loss_percent, requirment, rate, amount, pcs, color_size_table_id";
		 ...
		 for ($i=1;$i<=$total_row;$i++)
		 {
			...
			// $txtcuwoq="txtcuwoq_".$i;
			 ...
			 $txtjob_id="txtjob_".$i;
			 //if ($i!=1) $data_array1 .=",";
			 $data_array1 ="(".$id_dtls.",".$$txttrimcostid.",".$$txtpoid.",".$$txtjob_id.",'".$new_booking_no[0]."',2,2,".$$txttrimgroup.",".$$txtuom.",".$$cbocolorsizesensitive.",".$$txtwoq.",".$$txtexchrate.",".$$txtrate.",".$$txtamount.",".$$txtddate.",".$$consbreckdown.",".$$txtcountry.",".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
	...
	else if ($operation==1)   // Update Here
	{
		 ...
		 $field_array_up="booking_month*booking_year*buyer_id*job_no*item_category*supplier_id*currency_id*exchange_rate*booking_date*delivery_date*pay_mode*source*attention*remarks*item_from_precost*entry_form*updated_by*update_date"; 
		 
		 $data_array_up ="".$cbo_booking_month."*".$cbo_booking_year."*".$cbo_buyer_name."*".$txt_job_no."*4*".$cbo_supplier_name."*".$cbo_currency."*".$txt_exchange_rate."*".$txt_booking_date."*".$txt_delivery_date."*".$cbo_pay_mode."*".$cbo_source."*".$txt_attention."*".$txt_remarks."*".$cbo_item_from_precost."*87*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'";
		...
		// if  ( check_table_status( $_SESSION['menu_id'], 1 )==0 ) { echo "15**1"; die;}		
		 ...
		 for ($i=1;$i<=$total_row;$i++)
		 {
			...
			{
				 //if ($i!=1) $data_array1 .=",";
				 $data_array1 ="(".$id_dtls.",".$$txttrimcostid.",".$$txtpoid.",".$$txtjob_id.",".$txt_booking_no.",2,2,".$$txttrimgroup.",".$$txtuom.",".$$cbocolorsizesensitive.",".$$txtwoq.",".$$txtexchrate.",".$$txtrate.",".$$txtamount.",".$$txtddate.",".$$consbreckdown.",".$$txtcountry.",".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
				//	CONS break down===============================================================================================	
					if(str_replace("'",'',$$consbreckdown) !='')
					{
						//$data_array_up2="";
			...
			//$rID2=1;
			//echo '10**'.$data_array_up2; 
			//echo "INSERT INTO wo_trim_book_con_dtls (".$field_array_up2.") VALUES ".$data_array_up2; 
			
			
			//echo $rID2.'<br>';
		 }
		// echo '10**'."INSERT INTO wo_trim_book_con_dtls (".$field_array_up2.") VALUES ".$data_array_up2;  die;
		 if($data_array_up2 !="")
			{
...
if ($action=="create_booking_search_list_view"){
	...
	$sql="select min(a.id) as id, a.booking_no_prefix_num, a.booking_no, a.company_id, a.supplier_id, a.booking_date, a.delivery_date,c.style_ref_no,d.po_number from wo_booking_mst a,wo_booking_dtls b, wo_po_details_master c,wo_po_break_down d  where a.booking_no=b.booking_no and b.job_no=c.job_no and b.job_no=d.job_no_mst and a.booking_type=2 and a.entry_form=87 
	and  a.status_active =1 and a.is_deleted=0  and  b.status_active =1 and b.is_deleted=0 $company  $buyer  $supplier_id $booking_date $booking_cond $style_cond $order_cond group by a.booking_no_prefix_num, a.booking_no, a.company_id, a.supplier_id, a.booking_date, a.delivery_date,c.style_ref_no,d.po_number  order by id";
...
{
	$job_no="";
	 $sql= "select booking_no,booking_date,company_id,buyer_id, 	job_no,currency_id,exchange_rate,pay_mode,booking_month,supplier_id,attention,remarks,item_from_precost,delivery_date,source,booking_year,is_approved from wo_booking_mst  where booking_no='$data'";     
	 $data_array=sql_select($sql);
	 foreach ($data_array as $row)
	 {
