...
if ($action=="save_update_delete")
{
	...
	else if ($operation==1)   // Update Here
	{
		 ...
		 $data_array_up ="".$cbo_booking_month."*".$cbo_booking_year."*".$cbo_company_name."*".$cbo_buyer_name."*".$txt_job_no."*4*".$cbo_supplier_name."*".$cbo_currency."*".$txt_exchange_rate."*".$txt_booking_date."*".$txt_delivery_date."*".$cbo_pay_mode."*".$cbo_source."*".$txt_attention."*".$txt_remarks."*".$cbo_item_from_precost."*45*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'";
