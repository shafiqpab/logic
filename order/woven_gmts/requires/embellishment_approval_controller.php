...
<div align="center" style="width:100%;" >
    <form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
        <table width="1050" cellspacing="0" cellpadding="0" border="0" class="rpt_table" align="center">
            <tr>
                <td align="center" width="100%">
                    <table  cellspacing="0" cellpadding="0" border="0" class="rpt_table" align="center">
                        ...
                        <td><input name="txt_date_from" id="txt_date_from" class="datepicker" style="width:70px" readonly>
                          <input name="txt_date_to" id="txt_date_to" class="datepicker" style="width:70px" readonly>
                         </td> 
                         <td align="center">
                         <input type="button" name="button2" class="formbutton" value="Show" onClick="show_list_view ( document.getElementById('cbo_company_name').value+'_'+document.getElementById('cbo_buyer_name').value+'_'+document.getElementById('chk_job_wo_po').value+'_'+document.getElementById('txt_date_from').value+'_'+document.getElementById('txt_date_to').value+'_'+<? echo $garments_nature; ?>+'_'+document.getElementById('txt_job_prifix').value+'_'+document.getElementById('cbo_year_selection').value+'_'+document.getElementById('txt_order_search').value+'_'+document.getElementById('txt_style').value+'_'+document.getElementById('cbo_string_search_type').value, 'create_po_search_list_view', 'search_div', 'embellishment_approval_controller', 'setFilterGrid(\'list_view\',-1)')" style="width:100px;" /></td>
                    </tr>
                 </table>
              </td>
            </tr>
...
if($action=="load_drop_down_embellishment_type")
{
	...
	if($db_type==2 || $db_type==1)
	{
		...
		$embell_type=return_field_value("listagg(embellishment_type_id,',') within group (order by embellishment_type_id) as embl_id ","wo_po_embell_approval","job_no_mst='$job_no' and embellishment_id='$embell_id' and is_deleted=0 and status_active=1");//i have to check

	}
	
	$embType=array();
	$sql=sql_select("select emb_type  from wo_pre_cost_embe_cost_dtls where job_no='$job_no' and emb_name='$embell_id'");
	foreach($sql as $row){
...
if($action=="embell_approval_list_view_edit")
{
	...
	$gmts_item_array=return_library_array( "select job_no, gmts_item_id from wo_po_details_master",'job_no','gmts_item_id');
