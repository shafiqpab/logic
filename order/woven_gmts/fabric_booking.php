...
function openmypage_order(page_link,title)
{
	...
	else
	{
		if(txt_booking_no=="")
		{
		page_link=page_link+get_submitted_data_string('cbo_company_name*cbo_buyer_name*cbo_booking_month*cbo_booking_year*garments_nature','../../');
...
function fnc_generate_booking()
{
	...
	{
		var data="action=generate_fabric_booking"+get_submitted_data_string('txt_job_no*txt_order_no_id*cbo_fabric_natu*cbo_fabric_source*txt_booking_percent*cbo_company_name*cbo_buyer_name*cbouom',"../../");
...
function fnc_fabric_booking( operation )
{
	...
	//alert(month_set_id);
	if (form_validation('txt_order_no_id*txt_booking_date*txt_delivery_date*cbo_source','Order No*Booking Date*Delivery Date*Source')==false)
	{
		release_freezing();
		return;
	}
	...
	{
		var data="action=save_update_delete&operation="+operation+get_submitted_data_string('txt_order_no_id*cbo_company_name*cbo_buyer_name*txt_job_no*update_id*txt_booking_no*cbo_fabric_natu*cbo_fabric_source*cbo_currency*txt_exchange_rate*cbo_pay_mode*txt_booking_date*cbo_booking_month*cbo_supplier_name*txt_attention*txt_delivery_date*cbo_source*cbo_booking_year*txt_booking_percent*txt_colar_excess_percent*txt_cuff_excess_percent*cbo_ready_to_approved*processloss_breck_down*txt_fabriccomposition*txt_intarnal_ref*txt_file_no*cbouom',"../../");
		//freeze_window(operation);
		http.open("POST","requires/fabric_booking_controller.php",true);
		http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
		http.send(data);
     ...
     <? echo load_freeze_divs ("../../",$permission);  ?>
                ...
                <table  width="900" cellspacing="2" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                        <? 
                        	echo create_drop_down( "cbo_company_name", 172, "select id,company_name from lib_company  comp where status_active=1 and is_deleted=0 $company_cond order by company_name", "id,company_name",1, "-- Select Company --", "", "load_drop_down( 'requires/fabric_booking_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );check_month_setting();validate_suplier();",0,"" );
                        ?>
                        </td>
                        ...
                        <td><input style="width:160px;"  class="text_boxes"  name="txt_job_no" id="txt_job_no" disabled  /> </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="right"><span class="must_entry_caption">Booking Date</span></td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input style="width:160px;" type="text" class="text_boxes_numeric"  name="txt_booking_percent" id="txt_booking_percent" value="100" /></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <!--<input type="button" id="cuf_button" class="image_uploader" style="width:160px;" value="Size Wise Cuff Excess %" onClick="open_size_wise_cuff_popup('requires/fabric_booking_controller.php?action=size_wise_cuff_popup','Size Wise Cuff Excess %')" />
                        <input type="button" id="cuf_button" class="image_uploader" style="width:160px;" value="Size Wise Cuff Excess %" onClick="open_size_wise_colur_popup('requires/fabric_booking_controller.php?action=size_wise_colar_popup','Size Wise Colar Excess %')" />-->
                        </td>
                        <td>&nbsp;</td>
                        <td colspan="2">&nbsp;</td>
                    </tr>
