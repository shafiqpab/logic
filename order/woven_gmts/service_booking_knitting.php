...
function openmypage_programs(page_link,title)
{
    ...
    else
    {
        ...
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', page_link+"&orderNo="+orderNo+"&jobNo="+jobNo+"&supplier_id="+supplier_id+"&order_id="+orderId, title, 'width=900px,height=450px,center=1,resize=1,scrolling=0','../')
        emailwindow.onclose=function()
        {           
            var theform = this.contentDoc.forms[0];
        ...
        <legend>Service Booking</legend>
            <table  width="900" cellspacing="2" cellpadding="0" border="0" style="">
                ...
                <tr>
                    ...
                    <td>
						<? 
                            echo create_drop_down( "cbo_company_name", 172, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name", "id,company_name",1, "-- Select Company --", $selected, "load_drop_down( 'requires/service_booking_knitting_controller', this.value, 'load_drop_down_buyer', 'buyer_td' )","","" );
                        ?>	  
                    </td>
                    <td>Buyer Name</td>   
                    <td id="buyer_td"> 
                ...
                <tr>
                    ...
                    <td>
						<?
                            echo create_drop_down( "cbo_supplier_name", 172, "select id,supplier_name from lib_supplier where status_active =1 and is_deleted=0 order by supplier_name","id,supplier_name", 1, "-- Select Supplier --", $selected, "get_php_form_data( this.value, 'load_drop_down_attention', 'requires/service_booking_knitting_controller');",0 );
                        ?> 
                    </td> 
                    <td>Attention</td>   
                    <td colspan="3">
                ...
                <tr>
                    <td align="center" colspan="6" height="10">
                        ...
                        <input type="button" value="Print Booking2" onClick="generate_trim_report('show_trim_booking_report2')"  style="width:100px" name="print_booking2" id="print_booking2" class="formbutton" />  
                         ...
                         <input type="button" value="Print Booking3" onClick="generate_trim_report('show_trim_booking_report3')"  style="width:100px" name="print_booking2" id="print_booking2" class="formbutton" />  
                    </td>
                </tr>
            </table>
        </fieldset>
