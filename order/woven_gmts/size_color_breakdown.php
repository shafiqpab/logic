...
function set_ship_date() {
	...
	/*function updatepo()
	{
		    var order_id=(document.getElementById('order_id').value)*1;
		    var tot_set_qnty=(document.getElementById('tot_set_qnty').value)*1;
		    var cbo_order_uom=document.getElementById('cbo_order_uom').value;
			...
			var tot_row=return_global_ajax_value(order_id+'_'+txt_avg_price+'_'+txt_plan_cut+'_'+txt_amount+'_'+txt_excess_cut, 'update_po', '', 'requires/size_color_breakdown_controller');
	}*/
