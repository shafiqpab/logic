<?
/*-------------------------------------------- Comments ----------------------------------------
Purpose			: 	This form will create Short Fabric Requisition[WVN]
Functionality	:	
JS Functions	:
Created by		:	Kausar 
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Short Fabric Requisition[WVN]", "../../", 1, 1,$unicode,1,'');
?>
<script>
	...
	function fnc_short_fabric_requisition_dtls( operation )
	{
		...
		if (form_validation('txt_order_no_id*txt_reqsn_date*txt_reqsn_no*cbo_order_id*cbo_fabricdescription_id*cbo_garmentscolor_id*cbo_fabriccolor_id*cbo_garmentssize_id*txt_dia_width*txt_finish_qnty*txt_fabric_weight','Order No*Requisition Date*Requisition No*Po No*Fabric Description*Garments Color*Fabric color*Garments Size*Dia Width*Finish Qty*Fabric Weight')==false)
		{
			release_freezing();
			return;
		}
...
<div style="width:100%;" align="center">
	<? echo load_freeze_divs ("../../",$permission);  ?>
        <form name="fabricreqsn_1"  autocomplete="off" id="fabricreqsn_1">
            ...
            <legend>Short Fabric Requisition[WVN]</legend>
        ...
        <form name="orderdetailsentry_2"  autocomplete="off" id="orderdetailsentry_2">
            ...
            <table width="1010" cellspacing="2" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td width="150"><input name="txt_fabric_ref" id="txt_fabric_ref" class="text_boxes_numeric" type="text" style="width:120px" /></td>
                    <td width="100">Fabric Weight</td>
                ...
                <tr>
                    ...
                    <td>Process loss </td>
                    <td><input name="txt_process_loss" id="txt_process_loss" class="text_boxes_numeric" type="text" onChange="calculate_requirement();" style="width:120px" disabled="" /></td>
                    <td>Gray Fabric</td>
