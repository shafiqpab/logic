...
<script>
	...
	function openmypage_sizeinfo()
	{
		...
		else
		{
			...
			var data=document.getElementById('hidden_size_id').value+"_"+document.getElementById('hidden_qnty').value+"_"+document.getElementById('hidden_tbl_size_id').value+"_"+document.getElementById('hidden_bhqnty').value;
			//alert( data);
			var title = 'Size Info';	
...
function quotation_inquery_popup()
	{
		...
		emailwindow.onclose=function()
		{
			...
			//$("#txt_style_name").val(mrrNumber[0]);
                        ...
                        <div align="center">  		
                            <form name="sampledevelopment_1" id="sampledevelopment_1" autocomplete="off">
                                <table align="center" width="900">
                                    <tr>
                                        <td width="130">Style ID</td>                          
                                        <td width="150">
                                            <Input name="txt_style_id" class="text_boxes" ID="txt_style_id" style="width:145px" placeholder="Double Click to Search" onDblClick="openmypage()" maxlength="50" title="Maximum 50 Character" readonly>
                                        </td>
                                        <td width="130" class="must_entry_caption">Company Name</td>                          
                                        <td width="150">
                                            <?
                                                echo create_drop_down( "cbo_company_name", 157, "select comp.id,comp.company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/sample_development_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );load_drop_down( 'requires/sample_development_controller', this.value, 'load_drop_down_agent', 'agent_td' );color_from_library( this.value )" );
												//load_drop_down( 'requires/sample_development_controller', this.value, 'load_drop_down_season_com', 'season_td');
                                            ?>
                                        </td>
                                        <td width="130" class="must_entry_caption">Buyer Name</td>                          
                                        <td id="buyer_td" width="150">
                                            <? 
                                                ...
                                                echo create_drop_down( "cbo_buyer_name", 157, $blank_array,"", 1, "-- Select Buyer --", $selected, "" );
                                           ?>	  
                                        </td>   
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <Input name="txt_style_name" class="text_boxes" ID="txt_style_name" onDblClick="quotation_inquery_popup()" placeholder="Double Click to Quotation" style="width:145px" maxlength="50" title="Maximum 50 Character">
                                        ...
                                        <td>
                                            <?
                                                echo create_drop_down( "cbo_product_department", 100, $product_dept, "", 1, "-- Select prod. Dept--", $selected, "", "", "" );
                                            ?>
                                        ...
                                        <td >
                                            <input name="txt_article_no" class="text_boxes" ID="txt_article_no" style="width:145px" maxlength="50" title="Maximum 50 Character">
                                        </td> 
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <? 
                                                echo create_drop_down( "cbo_item_name", 157, $garments_item, "",1," -- Select Item --", $selected, "",'','' ); 
                                            ?>
                                        </td> 
                                        <td>Product Category</td>                          
                                        <td>
                                            <?
                                                echo create_drop_down( "txt_item_catgory", 157, $product_category,"", 1, "-- Select Product Category --", $selected, "","","" );
                                            ?>
                                        </td>
                                        <td>Region</td>                          
                                        <td>
                                            <? 
                                                echo create_drop_down( "cbo_region", 157, $region, 1, "-- Select Region --", $selected, "" );
                                            ?>
                                        </td> 
                                    </tr>
                                    <tr>
                                        ...
                                        <td id="agent_td">
                                            <?	 
                                                echo create_drop_down( "cbo_agent", 157, $blank_array,"", 1, "-- Select Agent --", $selected, "" );
                                             ?>
                                        </td>
                                        <td class="must_entry_caption">Team Leader</td>   
                                        <td>
                                            <?  
                                                echo create_drop_down( "cbo_team_leader", 157, "select id,team_leader_name from lib_marketing_team where status_active =1 and is_deleted=0 order by team_leader_name","id,team_leader_name", 1, "-- Select Team --", $selected, "load_drop_down( 'requires/sample_development_controller', this.value, 'cbo_dealing_merchant', 'div_marchant' ) " );
                                            ?>		
                                        </td>
                                        <td class="must_entry_caption">Dealing Merchant</td>   
                                        <td id="div_marchant" > 
                                        <? 
                                            echo create_drop_down( "cbo_dealing_merchant", 157, $blank_array,"", 1, "-- Select Team Member --", $selected, "" );
                                            ?>	
                                       </td>
                                    </tr>
                                    <tr>
                                        <td> BH Merchant</td>
                                        <td>	
                                            <input class="text_boxes" type="text" style="width:145px;"  name="txt_bhmerchant" id="txt_bhmerchant"/>
                                        </td>
                                        <td>Est. Ship Date</td>                          
                                        <td>
                                            <input name="txt_est_ship_date" id="txt_est_ship_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        
                                        
                                        <td>Season</td>
                                        <td id="season_td">	
                                           <!-- <input class="text_boxes" type="text" style="width:145px;" name="txt_season" id="txt_season"/>-->
                                             <? echo create_drop_down( "cbo_season_name", 158, $blank_array,"", 1, "-- Select Season --", $selected, "" ); ?>
                                        </td> 
                                    </tr>
                                    <tr>
                                    <td>Remarks/Desc.</td>                          
                                        <td colspan="5">
                                            <Input name="txt_remarks" class="text_boxes" ID="txt_remarks" style="width:590px" maxlength="50" title="Maximum 50 Character">
                                        </td>
                                    ...
                                    <tr>
                                        <td >Images</td>
                                        <td>
                                            <input type="button" class="image_uploader" style="width:157px" value="CLICK ADD/VIEW IMAGE" onClick="file_uploader ( '../../', document.getElementById('txt_style_id').value,'', 'sample_development', 0 ,1)">
                                        </td>
                                         <td >&nbsp;&nbsp;File</td>
                                        <td align="left"> <input type="button" id="image_button" class="image_uploader" style="width:135px" value="CLICK TO ADD FILE" onClick="file_uploader( '../../', document.getElementById('txt_style_id').value,'', 'sample_development', 2 ,1)" /></td>
                            ...
                            <form name="sampledevelopment_2" id="sampledevelopment_2" autocomplete="off" >
                                <table align="center" width="900">
                                    <tr>
                                        ...
                                        <td width="150" id="sampletd">
                                            <?
                                                echo create_drop_down( "cbo_sample_type", 157, "select sample_name,id from lib_sample where is_deleted=0 and status_active=1 order by sample_name","id,sample_name", '1', "--Select--", '', "",'','' );
                                            ?>
                                        </td>
                                        <td width="150" class="must_entry_caption">Sample Color</td>                          
                                        <td width="150">
                                            <Input name="txt_sample_color" class="text_boxes" ID="txt_sample_color" style="width:74px" maxlength="50" title="Maximum 50 Character">
                                            <input type="button" class="image_uploader" style="width:65px" value="Size Dtls" onClick="openmypage_sizeinfo();">
                                        </td>
                                        <td width="150">Rcv. Date From Buyer</td>                          
                                        <td width="150">
                                            <input name="txt_receive_date_from_buyer" id="txt_receive_date_from_buyer" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>TF Receive Date</td>                          
                                        <td>
                                            <input name="txt_tf_receive_date" id="txt_tf_receive_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        <td>Buyer Dead Line</td>                          
                                        <td>
                                            <input name="txt_buyer_dead_line_date" id="txt_buyer_dead_line_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        <td>Working Factory</td>                          
                                        <td>
                                            <Input name="txt_working_factory" class="text_boxes" ID="txt_working_factory" style="width:145px" maxlength="50" title="Maximum 50 Character">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Sent To Smpl Dept.</td>                          
                                        <td>
                                            <input name="txt_sent_to_factory_date" id="txt_sent_to_factory_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        <td>Dead Line</td>                          
                                        <td>
                                            <input name="txt_factory_dead_line_date" id="txt_factory_dead_line_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        <td>Rcv.From Smpl Dept.</td>                          
                                        <td>
                                            <input name="txt_receive_date_from_factory" id="txt_receive_date_from_factory" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Fabrication</td>                          
                                        <td>
                                            <Input name="txt_fabrication" class="text_boxes" ID="txt_fabrication" style="width:145px" maxlength="100" title="Maximum 100 Character">
                                        </td>
                                        
                                        <td>Fabric Source</td>                          
                                        <td>
                                           <?
                                             echo create_drop_down( "cbo_fabric_sorce", 157, $fabric_source, "", 1, "-- Select Fabric Source--", $selected, "", "", "" );
                                            ?>
                                        </td>
                                        ...
                                        <td>Sent to Buyer</td>                          
                                        <td>
                                            <input name="txt_sent_to_buyer_date" id="txt_sent_to_buyer_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Key Point/Val Drive</td>                          
                                        <td>
                                            <Input name="txt_key_point" class="text_boxes" ID="txt_key_point" style="width:145px" maxlength="50" title="Maximum 50 Character">
                                        </td>
                                        <td>Department</td>                          
                                        <td>
                                            <Input name="txt_department" class="text_boxes" ID="txt_department" style="width:145px" maxlength="50" title="Maximum 50 Character">
                                        </td>
                                        <td>Approval Status</td>
                                        <td>
                                            <?
                                            echo create_drop_down( "cbo_approval_status", 157, $approval_status,"", 1, "-----   -----", "", "","",'' );
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Status Date</td>                          
                                        <td>
                                            <input name="txt_status_date" id="txt_status_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        <td>Buyer Meeting</td>                          
                                        <td>
                                            <input name="txt_buyer_meeting_date" id="txt_buyer_meeting_date" class="datepicker" type="text" value="" style="width:145px; text-align:left"  />
                                        </td>
                                        <td>Sample Charge</td>                          
                                        <td>
                                            <input name="txt_sample_charge" id="txt_sample_charge" class="text_boxes_numeric" type="text" value="" style="width:50px;"  />
                                            <?
                                                echo create_drop_down( "cbo_curency", 90, $currency,"", 1, "--Select-- ", "", "","",'' );
                                            ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Buyer Req. No</td>                          
                                        <td>
                                            <input name="txt_buyer_request_no" id="txt_buyer_request_no" class="text_boxes" type="text" title="Maximum 100 Character" maxlength="100" value="" style="width:145px;"  />
                                        </td>
                                        <td>Comments</td>                          
                                        <td colspan="3">
                                            <Input name="txt_comments" class="text_boxes" ID="txt_comments" style="width:455px" maxlength="">
                                        </td>	
                                    </tr>    
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="6"  height="40" valign="bottom" align="center" class="button_container">
                                            <? 
                                                echo load_submit_buttons( $permission, "fnc_sample_development_details_info", 0,1,"reset_form('sampledevelopment_2','','')",2);
                                            ?>
                                    ...
                                    <tr>
                                        <td colspan="6" id="sample_development_list_view" align="center"></td>
                                    </tr>
                                </table>
                            </form>
                        </fieldset>
