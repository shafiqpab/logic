<?
/*--- ----------------------------------------- Comments
Purpose			: 	This form will create Knit Garments Order Import V2
Functionality	:	
JS Functions	:
Created by		:	Kausar 
        ...
        <table width="900" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
            ...
            <tr class="general">
                <td> 
					...
					<? echo create_drop_down( "cbo_company_mst", 130, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 and core_business not in(3) $company_cond order by company_name","id,company_name",1, "--Select Company--", $selected,"load_drop_down( 'order_import_v2', this.value, 'load_drop_down_buyer_pop', 'buyer_pop_td' );",'' ); ?>
                </td>
...
<!-- Important Field outside Form -->  
    <? echo load_freeze_divs ("../../",$permission);  ?>
            ...
            <fieldset style="width:500px;">
                <form name="excelImport_1" id="excelImport_1" action="excel_order_import_v2.php" enctype="multipart/form-data" method="post"> 
				<table width="500" cellspacing="0" cellpadding="0" border="1" class="rpt_table" rules="all">
                <tr>
                	<input style="width:110px;" type="hidden" title="Double Click to Search" onDblClick="openmypage_job('order_import_v2.php?action=job_popup','Job/Order Selection Form')" class="text_boxes" placeholder="New Job No" name="txt_job_no" id="txt_job_no" readonly /></td>
