	...
	if($operation==0)  // Insert Here
	{
		...
		if($color_id=='ec')
		{
			...
			if(str_replace("'","",$color_id_ec_1)!="")
			{
				...
				{
					$color_new_id = return_id( str_replace("'","",$color_id_ec_1), $color_arr, "lib_size", "id,lib_color","79");
