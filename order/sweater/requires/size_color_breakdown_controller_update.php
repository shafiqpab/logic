...
function copy_avg_price()
{
	...
	if(avg_rate_access_field==1)
	{
		alert("Access is denied. You may not have the appropriate permissions to change the rate");
		return;
	}
...
<body onLoad="set_hotkey()">
    <div style="width:100%;" align="center">
       ...
       <fieldset style="width:1180px">
            ...
            <input type="hidden" id="avg_rate_access_field" value="<? echo $avg_rate_access_field ?>"/> 
            </td>
            <td>
             New Color: 
            </td>
            ...
            <td>
            <input name="txt_avg_price" id="txt_avg_price" class="text_boxes_numeric" type="text" value=""  style="width:150px " <? echo $access; ?>  />
            </td>
            <td align="right">
            Copy Excess Cut %
            </td>
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)  //Insert Here
	{
		 ...
		 $field_array="id,po_break_down_id,job_id,job_no_mst,color_mst_id, size_mst_id, item_mst_id, article_number, item_number_id,country_id,cutup_date,cutup,country_remarks,country_ship_date, size_number_id, color_number_id, order_quantity, order_rate, order_total,excess_cut_perc,plan_cut_qnty,is_deleted,status_active,inserted_by,insert_date";
