<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Sweater Garments Sample Approval
Functionality	:	
JS Functions	:
Created by		:	Kausar 
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Sweater Garments Sample Approval", "../../", 1, 1,$unicode,'','');
?>	
...
function show_hide_content(row, id) 
{
	$('#row_'+row).toggle('fast', function() {
		 //get_php_form_data( id, 'set_php_form_data', 'requires/sample_approval_controller' );
	});
}
...
function fnc_sample_approval_reponse()
{
	...
	if(http.readyState == 4) 
	{
		...
		// show_list_view(document.getElementById('txt_job_no').value,'show_sample_approval_list','accordion_container','requires/sample_approval_controller','');
...
function load_form (sample_type)
{
	...
	{
		//alert(sample_type)
		show_list_view(document.getElementById('txt_job_no').value+'_'+sample_type,'show_sample_approval_list_form','po_list_view','requires/sample_approval_controller','');
	}
