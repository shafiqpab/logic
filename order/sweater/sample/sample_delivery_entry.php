...
function openmypage(page_link,title)
{
		...
		emailwindow.onclose=function()
		{
			...
			if (smp_id!="")
			{
				...
				get_php_form_data(smp_id+"**1", "populate_data_from_search_popup", "requires/sample_delivery_entry_controller" );
...
function put_sample_item_data(sample_dtls_part_tbl_id,smp_id,gmts)
{
	...
	//freeze_window(5);
 	get_php_form_data(sample_dtls_part_tbl_id+'**'+smp_id+'**'+req_id+'**'+gmts, "color_and_size_level", "requires/sample_delivery_entry_controller" ); 
    set_button_status(0, permission, 'fnc_sample_delivery_entry',1,0);
	//release_freezing();
}
