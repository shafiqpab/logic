...
if ($action=="save_update_delete")
{
	...
	if ($operation==0) // Insert part----------------------------------------------------------
	{
		...
		if($mst_update_id=='')
		{
			...
			$data_array_mst="(".$mst_id.",'".$new_mrr_number[1]."','".$new_mrr_number[2]."','".$new_mrr_number[0]."',".$cbo_company_name.",".$cbo_location_name.",".$cbo_delivery_to.",".$txt_gp_no.",".$txt_final_destination.",".$txt_received_by.",".$user_id.",'".$pc_date_time."','1','0','544')";
 		 // Details part--------------------------------------------------------------;
