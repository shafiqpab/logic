...
<script>
	...
	function fnc_short_trims_req_dtls( operation ){
		...
		for (var i=1; i<=row_num; i++){
			...
			//data_all=data_all+get_submitted_data_string('txtbookingid_'+i+'*txtpoid_'+i+'*txtcountry_'+i+'*txttrimcostid_'+i+'*txttrimgroup_'+i+'*txtuom_'+i+'*cbocolorsizesensitive_'+i+'*txtwoq_'+i+'*txtrate_'+i+'*txtamount_'+i+'*txtddate_'+i+'*consbreckdown_'+i+'*txtexchrate_'+i+'*txtjob_'+i+'*txtreqqnty_'+i+'*txtdescid_'+i+'*jsondata_'+i,"../../",i);
...
<div style="width:100%;" align="center">
    ...
    <form name="trimsreq_1" autocomplete="off" id="trimsreq_1">
        <fieldset style="width:1050px;">
            <legend>Multi Job Wise Short Trims Requisition[Sweater] &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   <font id="app_sms" style="color:#F00"></font></legend>
