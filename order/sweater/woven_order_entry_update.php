...
Converted by             :  
Converted Date           : 
Purpose			         : 	This form will create sweater Garments Order update
Functionality	         :	
JS Functions	         :
...
QC Performed BY	         :		
QC Date			         :	
Comments		         : This page copy from Knit gmts folder
----------------------------------------------------------------------*/
session_start();
...
function fnc_on_submit_reponse()
{
	if(http.readyState == 4) 
	{
		 ...
		 show_msg(trim(reponse[0]));
		 show_list_view(document.getElementById('txt_job_no').value,'show_po_active_listview','po_list_view','requires/woven_order_entry_controller_update','');
		 show_list_view(document.getElementById('txt_job_no').value,'show_deleted_po_active_listview','deleted_po_list_view','requires/woven_order_entry_controller_update','');
...
function copy_rate_access(company_id)
{
	$.each( field_level_data[company_id], function( key, value ) {
		if(key == 'txt_avg_price')
		{
			if(value['is_disable']==1)
			{
				$("#avg_rate_access_field").val(1);
			}
		}
	});
}
                ...
                <form name="orderentry_1" id="orderentry_1" autocomplete="off">
                    <table width="900" cellspacing="2" cellpadding="0" border="0">
                        <tr>
                            ...
                            <td width="150"><input style="width:140px;" type="text" title="Double Click to Search" onDblClick="openmypage('requires/woven_order_entry_controller_update.php?action=order_popup','Job/Order Selection Form')" class="text_boxes" placeholder="Update Job No" name="txt_job_no" id="txt_job_no" readonly /> <input type="hidden" name="hidd_job_id" id="hidd_job_id" style="width:30px;" /></td>
                        ...
                        <tr>
                            ...
                            <td><? echo create_drop_down( "cbo_team_leader", 150, "select id,team_leader_name from lib_marketing_team where status_active =1 and is_deleted=0 order by team_leader_name","id,team_leader_name", 1, "-- Select Team --", $selected, "load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'cbo_dealing_merchant', 'div_marchant' );load_drop_down( 'requires/woven_order_entry_controller_update', this.value, 'cbo_factory_merchant', 'div_marchant_factory' ) " ); ?>		
                            </td>
                        ...
                        <tr>
                            <td align="center" colspan="6" height="15" valign="middle">
                                ...
                                <input type="hidden" id="avg_rate_access_field" />  
                            </td>
                        </tr>
                        <tr>
            	...
            	<form id="orderdetailsentry_2" autocomplete="off">
                    ...
                    <thead class="form_table_header">
                        ...
                        <tr>
                              ...
                              <input  name="txt_org_shipment_date" id="txt_org_shipment_date" class="datepicker" type="text" value=""  style="width:80px; display: none;" onChange="set_pub_ship_date()" readonly/>
                              </td>
                              ...
                              <td >
							  <?php
                              echo create_drop_down( "cbo_status", 85, $row_status, 0, "", 1, "","",0 ); 
							  ?>
                              </td>
                            ...
                            <tr>
                             ...
                             <td align="right"><strong>Packing</strong> </td>
                                ...
                                <td><input type="button" value="Extended Ship Date" id="txt_extended_ship_date" class="image_uploader" style="width:100px" onClick="pp_meeting_po(2)"/></td> 	
                        	</tr>
                                <tr>
