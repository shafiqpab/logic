            ...
            <fieldset style="width:840px;">
                ...
                <table width="820" cellspacing="2" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td class="must_entry_caption">Packing </td>
                   ...
                   <tr>
                        ...
                        <td>Yarn Quality</td>
                        <td colspan="3"><input class="text_boxes" type="text" style="width:412px;" name="txt_yarn_quality" id="txt_yarn_quality"/></td>
                    </tr>
                    <tr>
                        <td>Remarks/Instructions</td>
                        <td colspan="5"><input class="text_boxes" type="text" style="width:685px;" name="txt_remarks" id="txt_remarks"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
