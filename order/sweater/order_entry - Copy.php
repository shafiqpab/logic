...
<script>
	...
	*/
	...
	function reorder_size_color()
	{
		...
		{
			emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/order_entry_controller.php?action=reorder_size_color&txt_job_no='+txt_job_no, 'Color Size Ordering', 'width=600px,height=400px,center=1,resize=1,scrolling=0','../')
		}
	}
    ...
    <table width="100%" cellpadding="0" cellspacing="2" align="center" >
        <tr>
            ...
            <tr>
                ...
                <td width="150">
                    <? 
					echo create_drop_down( "cbo_company_name", 150, "select id, company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/order_entry_controller', this.value, 'load_drop_down_location', 'location'); location_select(); load_drop_down( 'requires/order_entry_controller', this.value, 'load_drop_down_buyer', 'buyer_td'); load_drop_down( 'requires/order_entry_controller', this.value, 'load_drop_down_agent', 'agent_td'); load_drop_down( 'requires/order_entry_controller', this.value, 'load_drop_down_party_type', 'party_type_td'); fnc_variable_settings_check(this.value);"); //set_smv_check(this.value);
                    ?>
             ...
             <td class="must_entry_caption">Style Ref.</td>
                        <td>
                        	<input class="text_boxes" type="text" style="width:140px" placeholder="Browse/Write" name="txt_style_ref" id="txt_style_ref" onDblClick="open_qoutation_popup('requires/order_entry_controller.php?action=quotation_id_popup','Quotation ID Selection Form')" readonly/>
            </td>  
            </tr>
                    <tr>
                    ...
                    <tr>
						<td>Season &nbsp;&nbsp;<?=create_drop_down("cbo_season_year",60,create_year_array(),"",1,"-Year-", $selected, "" ); ?><input type="hidden" name="is_season_must" id="is_season_must" style="width:50px;" class="text_boxes" /></td>
                        <td id="season_td"><?=create_drop_down( "cbo_season_id", 150, $blank_array,'', 1, "-- Select Season--",$selected, "" ); ?></td>
                        <td>Region</td>
                        ...
                        <td><? echo create_drop_down( "txt_item_catgory", 150, $product_category,"", 1, "-- Select Product Category --", 3, "","","" ); ?></td>
                    </tr>
                    <tr>
                        <td class="must_entry_caption">Team Leader</td>
                        <td id="leader_td"><? echo create_drop_down( "cbo_team_leader", 150, "select id,team_leader_name from lib_marketing_team where project_type=6 and status_active =1 and is_deleted=0 order by team_leader_name","id,team_leader_name", 1, "-- Select Team --", $selected, "load_drop_down( 'requires/order_entry_controller', this.value, 'cbo_dealing_merchant', 'div_marchant' );load_drop_down( 'requires/order_entry_controller', this.value, 'cbo_factory_merchant', 'div_marchant_factory' ) " );
                        ?></td>
                    ...
                    <tr>
                        <td>Repeat No</td>
                        <td><input style="width:100px;" class="text_boxes_numeric" name="txt_repeat_no" id="txt_repeat_no" />&nbsp;&nbsp;
                    ...
                    <tr>
                        ...
                        <td><? echo create_drop_down( "cbo_gauge", 150, $gauge_arr,"", 1, "--Gauge--", $selected, "" ); ?></td>
                    ...
                    <tr>
                       ...
                       <td>Quality Label</td>
                        <td><? echo create_drop_down( "cbo_qltyLabel", 150, $quality_label,"", 1, "--Quality Label--", $selected, "" ); ?></td>
                         ...
                         <td>Yarn Quality</td>
                        <td ><input class="text_boxes" type="text" style="width:200px;" name="txt_yarn_quality" id="txt_yarn_quality"/></td>
                    ...
                    <tr>
                       <td class="must_entry_caption">Order Uom</td>
                        ...
                        <td colspan="3"><input class="text_boxes" type="text" style="width:420px;" name="txt_remarks" id="txt_remarks"/></td>
                    </tr>
                    <tr>
                    		<td colspan="6">
                    			<?
		...
		<form id="setdetails_1" autocomplete="off">
			...
			<table width="840" cellspacing="0" class="rpt_table" border="0" id="tbl_set_details" rules="all">
				<thead>
					<tr>
						<th width="100">Product</th><th width="20">Set Ratio</th><th width="20">Knitting SMV/ Pcs</th><th width="20">Linking SMV/ Pcs</th><th width="20">Fin SMV/ Pcs</th><th width="60">Complexity</th><th width="90">Print</th><th width="80">Embro</th><th width="80">Wash</th><th width="80">SP. Works</th><th width="80">Gmts Dyeing</th><th></th>
					</tr>
				</thead>
				<tbody>
					<?
			...
			<!--<table width="950" cellspacing="0" class="" border="0">
				<tr>
                    ...
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><input type="button" id="set_button" class="image_uploader" style="width:150px;" value="Internal Ref" onClick="open_terms_condition_popup('requires/order_entry_controller.php?action=terms_condition_popup','Terms Condition')" /></td>
                    </tr>
                   <!-- <tr>
                    	<td class="must_entry_caption">Fabric Composition</td>
                        <td>
						<? //echo create_drop_down( "cbo_fabric_composition", 150, $quality_label,"", 1, "-- Fabric Composition--", $selected, "" ); ?>
                        </td>
                    </tr>-->
                    <tr>
                    ...
                    <tr>
                        ...
                        <td height="50" valign="middle" align="center" class="button_container">
                            ...
                            <input type="hidden" id="txt_user_id" />
                            	<? echo load_submit_buttons( $permission, "fnc_order_entry_details", 0,0 ,"reset_form('orderentry_2','','','','fnc_resetPoDtls();fnc_load_color_popup()');",2); ?>
