...
<!-- Important Field outside Form -->  
    <? echo load_freeze_divs ("../../",$permission);  ?>
            ...
            <fieldset style="width:500px;">
                ...
                <tr>
                    <td width="190" class="must_entry_caption"><b>Select File</b><input style="width:110px;" type="hidden" title="Double Click to Search" onDblClick="openmypage_job('order_import_v2.php?action=job_popup','Job/Order Selection Form')" class="text_boxes" placeholder="New Job No" name="txt_job_no" id="txt_job_no" readonly /></td>
                    <td width="200">
