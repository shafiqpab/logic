...
function openmypage(page_link,title) 
{
	...
	emailwindow.onclose=function(){
		...
		if (theemail.value!=""){
			...
			get_php_form_data(theemail_po_id.value+"_save_"+cbo_company_name+"_"+cbo_pay_mode+"_"+trim_type, "set_delivery_date_from_tna", "requires/trims_booking_controller_v3" );
			var tna_date=$('#txt_tna_date').val();
            compare_date(2);
			if(cbo_item_from_precost==1){
				load_drop_down( 'requires/trims_booking_controller_v3', theemail.value+'_'+document.getElementById('cbo_supplier_name').value, 'load_drop_down_trim_precost_id', 'trim_group_td' )
			}
			load_drop_down( 'requires/trims_booking_controller_v3', theemail.value, 'load_drop_down_gmt_item', 'gmt_item_td' );
...
function set_precost_data(trim_precost_id,type)
{
	...
	get_php_form_data(trim_precost_id+"_"+txt_po_id+"_"+txt_country+"_"+cbo_gmt_item_id+"_"+cbo_currency+"_"+type+"_"+cbo_item_from_precost, "set_precost_data", "requires/trims_booking_controller_v3" );
}
...
function openmypage_booking(page_link,title)
{
	...
	emailwindow.onclose=function(){
		...
		if (theemail.value!=""){
			...
			get_php_form_data( theemail.value, "populate_data_from_search_popup", "requires/trims_booking_controller_v3" );
...
function fnc_trims_booking( operation )
{
	...
	var data_all="";
	if (form_validation('cbo_company_name*cbo_buyer_name*txt_booking_date*cbo_pay_mode*cbo_trim_type','Company Name*Buyer Name*Booking Date*Pay Mode*Trim Type')==false){
		return;
	}	
	else{
		 data_all=data_all+get_submitted_data_string('txt_booking_no*txt_job_no*cbo_company_name*cbo_buyer_name*cbo_supplier_name*cbo_currency*txt_exchange_rate*txt_booking_date*txt_delivery_date*cbo_pay_mode*cbo_source*txt_attention*cbo_isshort*txt_remarks*cbo_ready_to_approved*cbo_trim_type*cbo_item_from_precost',"../../")+"&delete_type="+delete_type;
	}
...
function fnc_trims_booking_dtls( operation )
{
	...
	var booking_qnty_and_amount_trim_group=return_global_ajax_value(txt_po_id+"_"+txt_trim_group_id+"_"+cbo_trim_precost_id, 'booking_qnty_and_amount_trim_group', '', 'requires/trims_booking_controller_v3');
	...
	if(amount_exceed_level==1){
		...
		var booking_amount_and_budget_amount_po_level=return_global_ajax_value(txt_po_id+"_"+txt_trim_group_id+"_"+cbo_trim_precost_id, 'booking_amount_and_budget_amount_po_level', '', 'requires/trims_booking_controller_v3');
...
function fnc_trims_booking_dtls_reponse()
{
	if(http.readyState == 4) 
	{
		...
		if(trim(reponse[0])=='pi1'){
		 ...
		 if(trim(reponse[0])==0 || trim(reponse[0])==1 || trim(reponse[0])==3)
		 {
			reset_form('','booking_list_view','cbo_trim_precost_id*txt_trim_group_id*cbo_colorsizesensitive*cbo_uom*txt_delevary_date*txt_req_quantity*txt_exchange_rate_dtls*txt_quantity*txt_avg_price*txt_amount*txt_req_amt*txt_update_dtls_id','','','')
...
{
	get_php_form_data( booking_dtls_id, "populate_data_dtls_from", "requires/trims_booking_controller_v3" );
     ...
     <? echo load_freeze_divs ("../../",$permission);  ?>
                ...
                <legend title="V3">Trims Booking &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;   <font id="app_sms" style="color:#F00"></font></legend>
                    ...
                    <tr>
                        ...
                        <td align="" valign="top" width="170">
                        </td>
                        <td  width="130" height="" align="right" class="must_entry_caption">Booking No </td>              
                        <td  width="170" >
                            <input class="text_boxes" type="text" style="width:160px" onDblClick="openmypage_booking('requires/trims_booking_controller_v3.php?action=trims_booking_popup','Trims Booking Search')" readonly placeholder="Double Click for Booking" name="txt_booking_no" id="txt_booking_no"/>
                        </td>
                        <td align="" width="130" >
                    ...
                    <tr>
                        ...
                        <td>
                        <? 
                        echo create_drop_down( "cbo_company_name", 172, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond order by company_name", "id,company_name",1, "-- Select Company --", $selected, "get_php_form_data( this.value, 'populate_variable_setting_data', 'requires/trims_booking_controller_v3' );","","" );
                        ?>	
                        ...
                        <td>
                        <?
                        echo create_drop_down( "cbo_pay_mode", 172, $pay_mode,"", 1, "-- Select Pay Mode --", $selected, "load_drop_down( 'requires/trims_booking_controller_v3', this.value, 'load_drop_down_supplier', 'supplier_td' )","" );
                        ?> 
                        </td>
        ...
        <form name="trimsbooking_2"  autocomplete="off" id="trimsbooking_2">
            ...
            <legend title="V3">Trims Booking Dtls &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </legend>
                ...
                <table style="border:none" cellpadding="0" cellspacing="2" border="0">
                    ...
                    <tr>
                        <td>
                            <input class="text_boxes" name="txt_po_no" id="txt_po_no" type="text" value=""  style="width:100px"  onDblClick="openmypage('requires/trims_booking_controller_v3.php?action=order_popup','Job/Order Selection Form')" placeholder="Browse" readonly />
                        ...
                        <td>
                            <input name="txt_country_name" id="txt_country_name" onDblClick="open_country_popup('requires/trims_booking_controller_v3.php?action=open_country_popup','Country')" class="text_boxes" type="text"  style="width:100px"  placeholder="Dbl. Click"/>
                    ...
                    <tr>
                    	<td align="center" colspan="12" id="listview_dtls"></td>
                    </tr>
                </table>
            </fieldset>
        </form>
