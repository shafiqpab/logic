<?
/*--- ----------------------------------------- Comments
Purpose			: 	This form will create Knit Garments Order Import PCS/Set
Functionality	:	
JS Functions	:
Created by		:	Kausar 
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Order Import V3","../../", 1, 1, $unicode,1,'');
...
<!-- Important Field outside Form -->  
    <? echo load_freeze_divs ("../../",$permission);  ?>
            ...
            <fieldset style="width:500px;">
                <form name="excelImport_1" id="excelImport_1" action="excel_order_import_v3.php" enctype="multipart/form-data" method="post"> 
