...
?>
	...
	function fnc_fabric_booking_dtls( operation )
	{
		...
		var data_all=get_submitted_data_string('txt_booking_no*txt_job_no*txt_order_no_id*cbo_gmt_item*cbo_booking_natu*cbo_pay_mode*cbo_is_short*cbo_supplier_name*hidden_supplier_id',"../../");
		...
		for (var i=1; i<=row_num; i++)
		{
			...
			data_all=data_all+get_submitted_data_string('txtbookingdtlasid_'+i+'*txtpoid_'+i+'*txtitemnumberid_'+i+'*txtembcostid_'+i+'*txtcolorid_'+i+'*txtwoq_'+i+'*txtrate_'+i+'*txtamount_'+i+'*txtddate_'+i+'*description_'+i+'*txtreqqty_'+i+'*txtcountryid_'+i,"../../",i);
		}
    ...
    <legend>Embellishment Work Order</legend>
        <table width="900" cellspacing="2" cellpadding="0" border="0">
            ...
            <tr>
                ...
                <td>
                <input style="width:160px;" type="text" class="text_boxes"  name="txt_job_no" id="txt_job_no" onDblClick="openmypage('requires/print_booking_urmi_controller.php?action=order_popup','Job/Order Selection Form')" placeholder="Double Click" readonly/> 
                </td>
                <td  align="right">Company Name</td>
                <td>
                <? 
                echo create_drop_down( "cbo_company_name", 172, "select id,company_name from lib_company where status_active=1 and is_deleted=0 and core_business not in(3) order by company_name", "id,company_name",1, "-- Select Company --", $selected, "load_drop_down( 'requires/print_booking_urmi_controller', this.value, 'load_drop_down_buyer', 'buyer_td' )",1,"" );
                ?>	  
                </td>
            ...
            <tr>
               ...
               <td class="must_entry_caption" align="right">Pay Mode</td>
                <td>
                <?
				//load_drop_down( 'requires/print_booking_urmi_controller', this.value, 'load_drop_down_supplier', 'supplier_td' )
                echo create_drop_down( "cbo_pay_mode", 172, $pay_mode,"", 1, "-- Select Pay Mode --", 1, "supplier_empty_check()","" );
                ?> 
                </td>
                  <td  align="right"  class="must_entry_caption">Supplier Name</td>
                <td id="">
                <input type="text" name="cbo_supplier_name" id="cbo_supplier_name" class="text_boxes supplier_name" onFocus="auto_completesupplier()" style="width:170px;" placeholder="Write"  />
            ...
            <tr>
                ...
                <!-- <input type="button" id="set_button" class="image_uploader" style="width:160px;" value="Terms & Condition/Notes" onClick="open_terms_condition_popup('requires/print_booking_urmi_controller.php?action=terms_condition_popup','Terms Condition')" /> -->
            ...
            <tr>
                ...
                <input class="text_boxes" type="text" style="width:98%;"  name="txt_attention" id="txt_attention" />
                </td>
               
            </tr>
            <tr>
                <td style="" align="right">Calculation Basis</td>   
                <td align="left" style="">
               <?
           ...
           <!-- <tr>
            ...
            <tr>
            	...
            	<td align="left">
            		<input style="width:160px;" type="text" class="text_boxes"  name="txt_season" id="txt_season" disabled /> 
            	</td>
            </tr>
