...
if($action == 'print_button_variable_setting'){
	$buttonIdArr = ['3#Print_b2', '6#Print_b3'];
	$print_report_format_arr = get_report_button_array($data, 2, 314, $user_id,$buttonIdArr);
}
...
if ($action=="save_update_delete_dtls")
{
	...
	if ($operation==0)  // Insert Here
	{
		...
		if (str_replace("'","",$copy_id)==2)
		{
			...
			//echo "10**".$update_id_details.'='.$rID.'='.$rID1.'='.$flag; oci_rollback($con); disconnect($con); die;
