...
if ($action=="populate_size_color_breakdown")
{
	...
	<fieldset style="width:1090px;">
        ...
        <table width="1080px" border="1" cellspacing="0" cellpadding="0" class="rpt_table" id="size_color_break_down_list" rules="all">
            <thead>
                <tr>
					...
					<th width="60">Actual Qty</th>
                    <th width="60">Order Rate</th>
					<th width="60">Actual Rate</th>
            ...
            <tbody id="data_form">
                <tr id="break_1"><!--onClick="tr_index(this)"-->
                    ...
                    <td><input type="text" id="txtarticleno_1" name="txtarticleno_1" onChange="check_duplicate(1,this.id);" class="text_boxes" style="width:70px" gmtsitem="" countryid="" articleno="" gmtscolor="" gmtssize=""/></td>
                    <td><input type="text" id="txtcolor_1" onChange="check_duplicate(1,this.id);" name="txtcolor_1" class="text_boxes" style="width:90px" <?=$readonly." ".$onClick." ".$plachoder; ?> /></td>
                    <td><input type="text" id="txtsize_1" name="txtsize_1" onChange="check_duplicate(1,this.id);" class="text_boxes" style="width:70px" /></td>
                    <td><input type="text" id="txtorderquantity_1" name="txtorderquantity_1" onBlur="set_excess_cut(this.value,document.getElementById('txtorderexcesscut_1').value, 1);" class="text_boxes_numeric" style="width:50px" onChange="validate_po_qty_co_si(1);"/></td>
                    <td><input type="text" id="txtactquantity_1" name="txtactquantity_1" class="text_boxes_numeric" style="width:50px" disabled/></td>
                    <td><input type="text" id="txtorderrate_1" onBlur="calculate_total_amnt(1);" value="<?=$unit_price; ?>"  name="txtorderrate_1"  class="text_boxes_numeric" style="width:50px" /></td>
                    <td><input type="text" id="txtactrate_1" value=""  name="txtactrate_1"  class="text_boxes_numeric" style="width:50px" disabled/></td>
                    <td><input type="text" id="txtorderamount_1" name="txtorderamount_1" readonly class="text_boxes_numeric" style="width:50px" /></td>
                    <td><input type="text" id="txtorderexcesscut_1" onBlur="set_excess_cut(document.getElementById('txtorderquantity_1').value, this.value, 1);" value="<?=$excess_cut; ?>" name="txtorderexcesscut_1" class="text_boxes_numeric" style="width:40px" <?=$disabled_ex_cut; ?> /></td>
                    <td><input type="text" id="txtorderplancut_1"    name="txtorderplancut_1" class="text_boxes_numeric" style="width:50px" readonly /></td>
        ...
        <table width="1090px" border="0" cellspacing="0" cellpadding="0" class="rpt_table" rules="all">
            <tr style="text-align:right">
                <td width="40">&nbsp;</td>
                <td width="140">&nbsp;</td>
                <td width="80">&nbsp;</td>
                <td width="100"><input type="text" id="txt_total_order_item_qnty"  name="txt_total_order_item_qnty"  class="text_boxes" style="width:90px;text-align:right;" disabled /></td>
                ...
                <td width="60"><input type="text" id="txt_total_order_qnty" name="txt_total_order_qnty" value="<? //echo $total_qnty; ?>"    class="text_boxes" style="width:48px;text-align:right;" disabled></td>
                <td width="60"><input type="text" id="txt_avg_rate"  name="txt_avg_rate" value="<? //echo $total_amount/$total_qnty; ?>" class="text_boxes" style="width:50px;text-align:right;" disabled></td>
                <td width="60"><input type="text" id="txt_total_amt"  name="txt_total_amt" value="<? //echo $total_amount; ?>"   class="text_boxes" style="width:50px;text-align:right;" disabled></td>
                <td width="50"><input type="text" id="txt_avg_excess_cut"  name="txt_avg_excess_cut" value="<? //echo number_format(((($total_plan_cut-$total_qnty)/$total_qnty)*100),2); ?>"  class="text_boxes" style="width:40px;text-align:right;" disabled></td>
                <td width="60"><input type="text" id="txt_total_plan_cut"  name="txt_total_plan_cut" value="<? //echo $total_plan_cut; ?>" class="text_boxes" style="width:50px;text-align:right;" disabled></td>
                <td width="60">&nbsp;</td>
                <td width="60">&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr>
                <td align="center" colspan="15" id="country_po_active_listview11">
                <?
                ...
                ?>
                    <table width="1090px" border="0" cellspacing="0" cellpadding="0" class="rpt_table" rules="all">
                        ...
                        foreach($data_array as $row)
                        {
							...
							//echo $prod_cutting.'d';
							$onlick_data=$row[csf("id")]."_".$row[csf("country_id")]."_".change_date_format($row[csf("country_ship_date")],"dd-mm-yyyy","-")."_".change_date_format($row[csf("cutup_date")],"dd-mm-yyyy","-")."_".$row[csf("cutup")]."_".$row[csf("country_remarks")]."_".$row[csf("country_type")]."_".$row[csf("packing")]."_".$prod_cutting;
							...
							<tr style="cursor:pointer">
                                ...
                                <td align="center"><input type="button" style="width:30px" class="formbutton" value="-" onClick="fn_delete_county_po('<? echo $row[csf("job_no")]; ?>',<? echo $row[csf("id")]; ?>, <? echo $row[csf("country_id")]; ?>, <? echo $row[csf("job_id")]; ?>);" /></td>
							</tr>
							<?
                        }
...
if($action=="populate_size_color_breakdown_with_data")
{
	...
	$sql_check=sql_select("select b.order_id, a.country_id, b.gmt_item_id, a.color_id, a.size_id, sum(a.marker_qty) as marker_qnty from ppl_cut_lay_size a, ppl_cut_lay_dtls b where b.id=a.dtls_id and  b.order_id='$data[0]' and a.country_id='$data[1]' and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 group by b.order_id, a.country_id, b.gmt_item_id, a.color_id, a.size_id");
	//echo "select a.order_id, a.country_id, b.gmt_item_id, a.color_id, a.size_id from ppl_cut_lay_size a, ppl_cut_lay_dtls b where b.id=a.dtls_id and  a.order_id='$data[0]' and a.country_id='$data[1]' and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 "; die;
	if(count($sql_check)>0)
	{
		foreach($sql_check as $dts)
		{
			...
			$prod_size_arr[$dts[csf("order_id")]][$dts[csf("country_id")]][$dts[csf("gmt_item_id")]][$color_library[$dts[csf("color_id")]]][$size_library[$dts[csf("size_id")]]]=$dts[csf("marker_qnty")];
			$is_production_found=0;
		}
		unset($sql_check);
	}

	$po_break_down_data=sql_select("select a.excess_cut, a.po_quantity, a.po_number, a.unit_price, b.company_name, b.buyer_name, b.gmts_item_id, b.order_uom, b.total_set_qnty, b.job_no from wo_po_break_down a, wo_po_details_master b where a.job_id=b.id and a.id='$data[0]'");
	list($po_break_down_data_array )=$po_break_down_data;
	$gmt_item_id=$po_break_down_data_array[csf(gmts_item_id)];
	$company_name=$po_break_down_data_array[csf(company_name)];
	$buyer_name=$po_break_down_data_array[csf(buyer_name)];
	...
	$sql=sql_select("select variable_list, copy_quotation, color_from_library, excut_source, editable from variable_order_tracking where company_name='$company_name' and variable_list in (23,45,78,101) order by id");
	 
	$poEntryControlWithBomApproval=2; $color_from_library=2; $excess_variable=0; $editable_id=0; $batch_color_vari=0;
	foreach($sql as $vrow)
	{
		...
		if($vrow[csf('variable_list')]==45) 
		{
			...
			if($excess_variable==2) //slap
			{
				$editable_id=$vrow[csf('editable')];
			}
			else $editable_id=1;
		}
		
		if($vrow[csf('variable_list')]==78) $poEntryControlWithBomApproval=$vrow[csf('copy_quotation')];
		if($vrow[csf('variable_list')]==101) 
		{
			//$batch_color_vari=$vrow[csf('editable')];
		}
		
	}
	//echo $batch_color_vari.'=A'; // NO need
	// if($batch_color_vari==1)// Yes
	// {
	// 	$sql_batch=sql_select("select b.color_id,b.id as poid from pro_batch_create_mst b,pro_batch_create_dtls c,wo_po_break_down a where b.id=c.mst_id and c.po_id=a.id  and a.id='$data[0]' and a.status_active=1 and b.status_active=1 and c.status_active=1");
	// 	// echo "select b.color_id,b.id as poid from pro_batch_create_mst b,pro_batch_create_dtls c,wo_po_break_down a where b.id=c.mst_id and c.po_id=a.id  and a.id='$data[0]' and a.status_active=1 and b.status_active=1 and c.status_active=1";
	// 	foreach($sql_batch as $row)
	// 	{
	// 		$batch_color=$row[csf('color_id')];
	// 	}
	// }
	...
	$break_data=sql_select("select * from wo_po_color_size_breakdown where po_break_down_id='$data[0]' and country_id=$data[1] and is_deleted=0 and status_active=1 order by item_number_id,color_order,size_order,id");
	foreach($break_data as $row)
	{
		...
		$prod_size=""; $prod_size_val="";
		$prod_size=$prod_size_arr[$data[0]][$data[1]][$row[csf("item_number_id")]][$color_number_id][$size_number_id];
		if($prod_size=="" || $prod_size==0) $prod_size_val=""; else  { $prod_size_val=$prod_size;}
		
		$disabled_ex_cut=0; $title=""; $fld_disable="";
		if(($prod_size*1)>0)
		{
			$disabled_ex_cut=1; $title='Cutting QC Found'; $fld_disable="disabled";
			$production_quantity_arr[$row[csf("id")]]=($prod_size*1);
		}
		else
		{
		...
		<tr id="break_<?=$k; ?>" ><!--onClick="tr_index(this)"-->
            <td width="40" align="center"><input type="checkbox" name="checktr_<?=$k; ?>" id="checktr_<?=$k; ?>" onClick="tr_check(<?=$k; ?>,event);" <?=$fldDisable; ?> ></td>
            <td width="140"><?=create_drop_down( "cbogmtsitem_".$k, 140, $garments_item,"", 0, "",$item_number_id, "calculate_total_amnt(".$k." ); check_duplicate(".$k.",this.id)","$cboDisable",$gmt_item_id,""); ?></td>
            <td width="80"><input type="text" id="txtarticleno_<?=$k; ?>" name="txtarticleno_<?=$k; ?>" value="<?=$article_number; ?>" onChange="check_duplicate(1,this.id)" class="text_boxes" style="width:70px" gmtsitem="<?=$item_number_id; ?>" countryid="<?=$data[1]; ?>" articleno="<?=$article_number; ?>" gmtscolor="<?=$color_number_id; ?>"gmtssize="<?=$size_number_id; ?>" <?=$fldDisable; ?>></td>
            <td width="100"><input type="text" id="txtcolor_<?=$k; ?>" onChange="check_duplicate(<?=$k; ?> ,this.id);"name="txtcolor_<?=$k; ?>" value="<?=$color_number_id; ?>"  class="text_boxes" style="width:90px" <?=$readonly." ".$onClick ?> <?=$fld_disable; ?> title="<?=$title; ?>" <?=$fldDisable; ?>/></td>
            <td width="80"><input type="text" id="txtsize_<?=$k; ?>" name="txtsize_<?=$k; ?>" onChange="check_duplicate(<?=$k; ?>,this.id);" value="<?=$size_number_id; ?>"  class="text_boxes" style="width:70px" <?=$fld_disable; ?> title="<?=$title; ?>" <?=$fldDisable; ?>/></td>
            <td width="60"><input type="text" id="txtorderquantity_<?=$k; ?>" name="txtorderquantity_<?=$k; ?>" onBlur="set_excess_cut(this.value,document.getElementById('txtorderexcesscut_<?=$k; ?>').value, <?=$k; ?>);" value="<?=$order_quantity; ?>" saved_po_quantity="<?=$order_quantity; ?>" production_quantity="<?=$production_quantity_arr[$id]; ?>" onChange="validate_po_qty_co_si(<?=$k; ?>);" class="text_boxes_numeric" style="width:50px"></td>
			<td width="60"><input type="text" id="txtactquantity_<?=$k; ?>" name="txtactquantity_<?=$k; ?>"  class="text_boxes_numeric" value="<?=$actual_qty; ?>" style="width:50px; <?=$actualqtycolor; ?>" readonly disabled></td>
            <td width="60"><input type="text" id="txtorderrate_<?=$k; ?>" onBlur="calculate_total_amnt(<?=$k; ?>);" value="<?=$order_rate; ?>" name="txtorderrate_<?=$k; ?>"  class="text_boxes_numeric" style="width:50px" <?=$fldDisable; ?>></td>			
			<td width="60"><input type="text" id="txtactrate_<?=$k; ?>" name="txtactrate_<?=$k; ?>"  class="text_boxes_numeric" value="<?=$actual_rate; ?>" style="width:50px; <?=$actualratecolor; ?>" readonly disabled></td>
            <td width="60"><input type="text" id="txtorderamount_<? echo $k; ?>" name="txtorderamount_<? echo $k; ?>"  value="<? echo $order_total; ?>" readonly class="text_boxes_numeric" style="width:50px" <?=$fldDisable; ?>></td>
            <td width="50"><input type="text" id="txtorderexcesscut_<?=$k; ?>" onBlur="set_excess_cut(document.getElementById('txtorderquantity_<?=$k; ?>').value, this.value, <?=$k; ?>);" name="txtorderexcesscut_<?=$k; ?>" value="<?=$excess_cut_perc; ?>" class="text_boxes_numeric" style="width:38px" <?=$excess_fld_disable; ?> title="<?=$title;  ?>" <?=$fldDisable; ?>/></td>
            <td width="60"><input type="text" id="txtorderplancut_<?=$k; ?>" name="txtorderplancut_<?=$k; ?>" value="<?=$plan_cut_qnty; ?>" class="text_boxes_numeric" style="width:50px" readonly <?=$fldDisable; ?>/></td>
            <td width="60"><?=create_drop_down( "cbostatus_".$k, 60, $row_status, 0, "", 1, $status_active,"","$cboDisable" ); ?></td>
            <td width="60"><input type="checkbox" name="checkbarcode" id="checkbarcode_<?=$k; ?>" style="width:50px" value="2" onClick="fnc_checkbarcode(<?=$k; ?>);"></td>
            <td>
...
if($action=="check_country")
{
	...
	$sql="Select country_id from wo_po_color_size_breakdown where po_break_down_id=$data[0] and country_id=$data[1] and is_deleted =0 and status_active=1 $itemCond";
	$data_array=sql_select($sql);
...
if($action=="populate_size_color_breakdown_pop_up")
{
	...
	function fn_delete_county_po(txt_job_no, order_id,country_id,hidd_job_id){
		...
		var cutting_qty=return_global_ajax_value(order_id+"_"+country_id, 'get_cutting_qty_country', '', 'size_color_breakdown_controller');
		if(cutting_qty>0){
		...
		if(po_id && txt_job_no)
		{
			var shipping_status = trim(return_global_ajax_value(txt_job_no+'***'+po_id, 'check_po_shipping_status_po_id', '', 'woven_order_entry_controller'));
	...
	function fnc_size_color_breakdown( operation )
	{
		...
		for (var i=1; i<=row_num; i++)
		{
			...
			eval(get_submitted_variables('txt_job_no*hidd_job_id*order_id*txt_tot_avg_rate*txt_tot_amount*cbo_order_uom*tot_set_qnty*txt_tot_excess_cut*txt_tot_plancut*cbo_po_country*txt_country_ship_date*hiddenid_'+i+'*cbogmtsitem_'+i+'*txtarticleno_'+i+'*txtcolor_'+i+'*txtsize_'+i+'*txtorderquantity_'+i+'*txtorderrate_'+i+'*txtorderamount_'+i+'*txtorderexcesscut_'+i+'*txtorderplancut_'+i+'*cbostatus_'+i+'*hidbarcode_'+i));
	...
	function check_country(country_id)
	{
		...
		//alert(item_id);
		var country=return_global_ajax_value(po_id+"_"+country_id+"_"+item_id, 'check_country', '', 'size_color_breakdown_controller');
	...
	function set_ship_date()
	{
		...
		{
			$("#txt_country_ship_date").attr("disabled",false);
			$("#cbo_cut_up").attr("disabled",false);
			//return;
		}
    ...
    <script>
		get_php_form_data(<?=$data; ?>, "populate_data_from_search_popup", "size_color_breakdown_controller" );
		show_list_view('<?=$data; ?>','populate_size_color_breakdown','size_color_breakdown','size_color_breakdown_controller','');
                    ...
                    <tr>
                        <td valign="top">
                            <table id="color_order" class="rpt_table" border="1" rules="all">
                                ...
                                <tbody>
                                    <? $sql_data=sql_select("select min(id) as id, color_number_id,min(color_order) as color_order from wo_po_color_size_breakdown where job_no_mst='$txt_job_no' and status_active!=0 and is_deleted=0 group by color_number_id order by color_order ASC ");
                                    $i=1;
                        ...
                        <td valign="top">
                            <table id="size_order" class="rpt_table" border="1" rules="all">
                                ...
                                <tbody>
									<? $sql_data=sql_select("select min(id) as id, size_number_id,min(size_order) as size_order from wo_po_color_size_breakdown where job_no_mst='$txt_job_no' and status_active!=0 and is_deleted=0 group by size_number_id order by size_order ASC ");
                                    $i=1;
                                    foreach($sql_data as $sql_row)
                                    {
										?>
...
if ($action=="save_update_delete")
{
	...
	$btn_mood=1;
	//echo "10**";
	$sql= sql_select("select id from wo_po_color_size_breakdown where job_no_mst='$txt_job_no' and is_deleted=0 and status_active=1 ");
	if(count($sql)>0) $btn_mood=2; else $btn_mood=1;
	//echo "select id from wo_po_color_size_breakdown where po_break_down_id='$txt_job_no' and is_deleted=0 and status_active=1 ";
	//echo $btn_mood;
	//die;
	$cu_country_id=str_replace("'","",$cbo_po_country);
	$color_size_prev_sql="select sum(order_total) as tot_amount from wo_po_color_size_breakdown where status_active=1 and is_deleted=0 and po_break_down_id=$order_id and country_id<>$cu_country_id";
	$color_size_prev_sql_res=sql_select($color_size_prev_sql);
	$color_size_prev_amt=$color_size_prev_sql_res[0][csf("tot_amount")];
	$cu_country_amt=0;
	for ($i=1;$i<=$total_row;$i++)
	{
		$txtorderamount="txtorderamount_".$i;
		$cu_country_amt+=str_replace("'","",$$txtorderamount);
	}
	$tot_country_amount=$color_size_prev_amt+$cu_country_amt;
	//echo "16** $color_size_prev_sql = $color_size_prev_amt = $cu_country_amt";die;
	...
	//contract_no
	$sql_attach="select a.contract_no  as lc_no,(b.attached_value) as order_attach_value from com_sales_contract a,com_sales_contract_order_info b where a.id = b.com_sales_contract_id and  b.status_active=1 and b.is_deleted=0 and b.wo_po_break_down_id=$order_id 
	union all 
	select a.export_lc_no as lc_no,(b.attached_value) as order_attach_value from com_export_lc_order_info b,com_export_lc a 
	where  a.id = b.wo_po_break_down_id and b.status_active=1 and b.is_deleted=0 and b.wo_po_break_down_id=$order_id";
	$sql_attach_result=sql_select($sql_attach);
	$tot_attach_value=0;$tot_attach_no='';
	foreach($sql_attach_result as $row)
	{
		if($row[csf("order_attach_value")]>0)
		{
			$tot_attach_value+=$row[csf("order_attach_value")];
			$all_attach_no.=$row[csf("lc_no")].',';
		}
	}
	$all_attach_nos=implode(',',array_unique(explode(',',$all_attach_no)));
	
	if($tot_country_amount<$tot_attach_value)
	{
		if($tot_attach_value-$tot_country_amount>0.99)
		{
			echo "16**Order Value Not Allowed Less Then Attach Value. $tot_country_amount = $tot_attach_value, "." SC/LC No=".$all_attach_nos;disconnect($con);die;
		}
	...
	{	
		...
		if($w_buyer_allocation_maintain==1){
		$sql_allowcat="SELECT  b.buyer_id, b.allocation_percentage FROM lib_capacity_allocation_mst a,lib_capacity_allocation_dtls b where a.id=b.mst_id AND a.company_id=$cbo_working_company_id   AND a.month_id=$month AND a.year_id=$year  and b.allocation_percentage is not null and b.status_active=1 and b.is_deleted=0 $w_capaBuyerCond";
		...
		if(str_replace("'","",$is_po_levelqty_update)!=0){
			$w_sql_po=sql_select("SELECT sum(c.plan_cut_qnty) as po_quantity, b.set_smv from wo_po_break_down a join wo_po_details_master b on a.job_id=b.id join wo_po_color_size_breakdown c on a.id=c.po_break_down_id where b.style_owner=$cbo_working_company_id $w_poBuyerCond $allocat_buyer_cond  and a.t_month=$month and  a.t_year=$year  and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and c.po_break_down_id!=$update_id_details and c.country_id!=$country_id and b.working_location_id = $cbo_working_location_id $pub_date_upto group by b.set_smv");
	...
	if ($operation==0)  //Insert Here
	{
		 ...
		 //echo "10**select a.size_number_id,b.id,b.size_name from wo_po_color_size_breakdown a, lib_size b where b.id=a.size_number_id and a.po_break_down_id=$order_id"; die;
		...
		if($excess_variable==2 && $excess_per_level==1){
			...
			$item_details=sql_select("SELECT gmts_item_id, printdiff,embrodiff,washdiff,spwdiff from wo_po_details_mas_set_details where job_id=$hidd_job_id");
		...
		// print_r($slab_plan_cut); die;
		 ...
		 for ($i=1;$i<=$total_row;$i++)
		 {
			...
			if ($i!=1) $data_array .=",";
			$data_array .="(".$id.",".$order_id.",".$hidd_job_id.",'".$txt_job_no."','".$color_mst_id."','".$size_mst_id."','".$item_mst_id."','".$txtarticleno."',".$$cbogmtsitem.",".$cbo_po_country.",".$txt_cutup_date.",".$cbo_cut_up.",".$txt_country_ship_date.",".$size_id.",".$color_id.",".$$txtorderquantity.",".$$txtorderrate.",".$$txtorderamount.",".$orderexcesscut.",".$orderplancut.",".$txt_country_remarks.",".$cbo_po_country_type.",".$cbo_packing_country_level.",0,".$$cbostatus.",".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."','".$barcode_suffix_no."','".$barcode_year."','".$barcode_no."')";
			$id=$id+1;
		 }
		 //echo "10**insert into wo_po_color_size_breakdown (".$field_array.") values ".$data_array;die;
		 ...
		 update_color_size_sequence("'".$txt_job_no."'",$btn_mood);
		 //echo "10**";
		 // $rID
		...
		execute_query("update wo_pre_cost_mst set isorder_change='$bom_sync_msg' where job_no ='".$txt_job_no."' and status_active=1 and is_deleted=0 and isorder_change=0",1);
	...
	else if ($operation==1)   // Update Here
	{
		...
		$is_produced=0;
		$sql_check=sql_select("select a.country_id, b.order_id, b.gmt_item_id, a.color_id, a.size_id,sum(a.marker_qty) as marker_qnty from ppl_cut_lay_size a, ppl_cut_lay_dtls b where b.id=a.dtls_id and b.order_id=$order_id and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 group by a.country_id, b.order_id, b.gmt_item_id, a.color_id,a.size_id");
		foreach($sql_check as $dts)
		{
		...
		$PrevData=sql_select("select id, color_number_id, size_number_id, country_ship_date, order_quantity, country_ship_date_prev, color_number_id_prev, plan_cut_qnty from wo_po_color_size_breakdown where po_break_down_id=".$order_id);
		//echo "10**select id, color_number_id, size_number_id, country_ship_date, order_quantity, country_ship_date_prev, color_number_id_prev, plan_cut_qnty from wo_po_color_size_breakdown where po_break_down_id=".$order_id; die;
		...
		for ($i=1;$i<=$total_row;$i++)
		{
			...
			$txtarticleno=str_replace("'","",$$txtarticleno);
			if($txtarticleno=="") $txtarticleno="no article";
			...
			if(str_replace("'",'',$$hiddenid)!="")
			{
				...
				$PrevColorNumberId=$pre_color_date_arr[str_replace("'",'',$$hiddenid)]['color_id'];
				$PrevCountryShipDate=$pre_color_date_arr[str_replace("'",'',$$hiddenid)]['ship_date'];

				$pre_color_id=$pre_color_date_arr[str_replace("'",'',$$hiddenid)]['precolor_id'];
				$pre_country_date=$pre_color_date_arr[str_replace("'",'',$$hiddenid)]['country_ship_date_prev'];
				...
				if( ($prod_array[str_replace("'",'',$order_id)][str_replace("'",'',$cbo_po_country)][str_replace("'",'',$$cbogmtsitem)][str_replace("'",'',$color_id)][str_replace("'",'',$size_id)]*1) <=str_replace("'",'',$$txtorderquantity))
				{
					$color_size_Qty=str_replace("'",'',$$txtorderquantity);
					$color_size_planQty=str_replace("'",'',$orderplancut);
					$prod_id[]=str_replace("'",'',$$hiddenid);
				}
				else
				{
					$color_size_Qty=$pre_color_date_arr[str_replace("'",'',$$hiddenid)]['qty'];
					$color_size_planQty=$pre_color_date_arr[str_replace("'",'',$$hiddenid)]['plan_cut_qnty'];
					$tmpIds[]=str_replace("'",'',$$hiddenid);
					$check_prod=1;
				}
				...
				if($poEntryControlWithBomApproval==3 && $bomApproved==1)//issue id ISD-21-19965
				{
					...
					$data_array="'".$color_size_Qty."'*".$$txtorderamount."*'".$color_size_planQty."'*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'";
				...
				else
				{
					...
					$data_array="'".$txt_job_no."'*'".$color_mst_id."'*'".$size_mst_id."'*'".$item_mst_id."'*'".$txtarticleno."'*".$$cbogmtsitem."*".$cbo_po_country."*".$txt_cutup_date."*".$cbo_cut_up."*".$txt_country_ship_date."*".$size_id."*".$color_id."*'".$color_size_Qty."'*".$$txtorderrate."*".$$txtorderamount."*".$orderexcesscut."*'".$color_size_planQty."'*".$txt_country_remarks."*".$cbo_po_country_type."*".$cbo_packing_country_level."*'".$pre_colorid."'*'".$pre_countryship_date."'*0*".$$cbostatus."*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'";
					$rID=sql_update("wo_po_color_size_breakdown",$field_array,$data_array,"id","".$$hiddenid."",1);
				}
			}
		...
		if(str_replace("'","",$is_po_levelqty_update)==1)
		{
		 ...
		 if($bomApproved!=1) update_cost_sheet("'".$txt_job_no."'");
		 //die;
		//============================================================================================
		 if($db_type==0) $sequNullCheck="IFNULL(sequ,0)";
		 else if($db_type==2) $sequNullCheck="nvl(sequ,0)";
	...
	else if ($operation==2)   // Delete Here
	{
		...
		foreach($sql_check as $dts)
		{
			echo "16**Cutting QC Found, Any Change will be not allowed.";
			$is_produced=1;
			disconnect($con);die;
		}
		...
		if($is_produced==0)
		{
			...
			foreach($sql_check as $dts)
			{
				echo "16**Cutting QTY Found, Any Change will be not allowed.";
				$is_produced=1;
				disconnect($con);die;
			}
			unset($sql_check);
...
{
	$sql_data=sql_select("SELECT job_no_mst from wo_po_break_down where id='$data' and is_deleted=0 and status_active=1");
	$job_no=$sql_data[0][csf("job_no_mst")];
	echo trim($job_no);
	die;
}
...
{
	$data=explode("*",$data);
	$sql= "select id, po_number, po_received_date, pub_shipment_date, po_quantity,plan_cut, status_active, is_confirmed from wo_po_break_down where is_deleted=0 and job_no_mst='$data[0]' order by id ASC";
	$data_array=sql_select($sql);
	?>
