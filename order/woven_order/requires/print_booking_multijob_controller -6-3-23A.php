...
if ($action == "save_update_delete_dtls") {
	...
	if ($operation == 0) {
		...
		for ($i = 1; $i <= $total_row; $i++) {
			...
			$data_array1 = "(" . $id_dtls . "," . $booking_mst_id . "," . $$txtembcostid . "," . $$txtpoid . "," . $$txtjob_id . "," . $$txtgmtitemid . "," . $txt_booking_no . ",6,2," . $$txtuom . "," . $$cbocolorsizesensitive . "," . $$txtwoq . "," . $$txtexchrate . "," . $$txtrate . "," . $$txtamount . "," . $$txtddate . "," . $$txtcountry . "," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "')";
	...
	if ($operation == 0) {
		...
		for ($i = 1; $i <= $total_row; $i++) {
			...
			foreach ($strdata->$job->$embcostid->$gmtitemid->po_id as $poId) {
				...
				$amount = $wqQty * $rate;
				$data_array1 = "(" . $id_dtls . "," . $booking_mst_id . "," . $$txtembcostid . "," . $poId . "," . $$txtjob_id . "," . $$txtgmtitemid . "," . $txt_booking_no . ",6,2," . $$txtuom . "," . $$cbocolorsizesensitive . "," . $wqQty . "," . $$txtexchrate . "," . $$txtrate . "," . $amount . "," . $$txtddate . "," . $$txtcountry . "," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "')";
