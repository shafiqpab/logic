				...
				foreach($color_size_data as $color_val=>$size_data)
				{
					...
					foreach($size_data as $size_val=>$extra_data)
					{
						foreach($extra_data as $ex_val=>$sizeqty)
						{
							...
							//if($add_colSiz!=0) //$data_colSiz.=",";
							$break_down[$idColSiz]="(".$idColSiz.",'".$job_id."',".$idPo.",'".$new_job_no_arr[$style_ref][0]."',0,0,0,".$cbo_gmtsItem_id.",'".$cboDeliveryCountry."','".$codeId."','".$cboCountryId."','".$countryCode."','".$countryShipDate."','".$color_id."','".$size_id."','".$countryQty."','".$countryRate."',0,'".$article_number."','".$countryAmt."','".$countryQty."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
