...
if ($action=="order_listview")
{
	...
	{//and supplier_id='$data[4]' for 2497
		$sqlbh="select ID, PO_NUMBER, PO_RECEIVED_DATE, PUB_SHIPMENT_DATE, PO_QUANTITY, PLAN_CUT, STATUS_ACTIVE, PO_UNIT_PRICE as UNIT_PRICE from bh_wo_po_break_down where is_deleted=0 and job_id='$data[3]'  order by id DESC"; //
