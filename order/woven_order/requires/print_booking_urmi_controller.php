...
Affected Code    :
DB Script        :
Updated by 		 : shariar 15/07/2023
Update date		 :
QC Performed BY	 :
QC Date			 :
Comments		 : From this version oracle conversion is start update in job level for lariz
*/
...
//and b.po_break_down_id in($txt_order_no_id)
	 	 ...
	 	 $sql="select a.total_set_qnty, b.exchange_rate,b.costing_per, c.id as embe_cost_dtls_id, c.job_no, c.emb_name, c.emb_type, c.cons_dzn_gmts, c.rate, c.amount, d.id as po_id, d.po_number, d.pub_shipment_date, d.grouping, d.plan_cut, e.item_number_id, e.color_number_id, e.country_id, sum(e.plan_cut_qnty) as plan_cut_qnty, sum(e.order_quantity) as order_quantity
		...
		group by
		a.total_set_qnty, b.exchange_rate,b.costing_per, c.id, c.job_no, c.emb_name, c.emb_type, c.cons_dzn_gmts, c.rate, c.amount, d.id, d.po_number, d.pub_shipment_date, d.grouping, d.plan_cut, e.item_number_id, e.color_number_id,e.country_id order by d.id ASC";// and d.id=32936
		//echo $sql;die;
		$job_level=array();
		...
		foreach ($nameArray as $selectResult)
		{
			...
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['booking_dtls_id'][$po_id]=$booking_dtls_id;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['country_id'][$po_id]=$selectResult[csf('country_id')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['po_id'][$po_id]=$po_id;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['po_number'][$po_id]=$selectResult[csf('po_number')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['item_number_id'][$po_id]=$selectResult[csf('item_number_id')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['embe_cost_dtls_id'][$po_id]=$selectResult[csf('embe_cost_dtls_id')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['emb_name'][$po_id]=$selectResult[csf('emb_name')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['emb_type'][$po_id]=$selectResult[csf('emb_type')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['color_number_id'][$po_id]=$selectResult[csf('color_number_id')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['order_quantity'][$po_id]=$selectResult[csf('order_quantity')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['plan_cut_qnty'][$po_id]=$selectResult[csf('plan_cut_qnty')];
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['description'][$po_id]=$description;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['req_qnty'][$po_id]=$req_qnty;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['cu_woq'][$po_id]=$cu_woq;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['bal_woq'][$po_id]=$bal_woq;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['bal_amount'][$po_id]=$blaamount;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['wo_qnty_pre'][$po_id]=$wo_qnty_pre;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['wo_qnty_new'][$po_id]=$wo_qnty_new;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['rate'][$po_id]=$rate;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['amount'][$po_id]=$amount;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['preCostRate'][$po_id]=$preCostRate;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['preCostAmount'][$po_id]=$preCostAmount;
			$job_level[$selectResult[csf('embe_cost_dtls_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('country_id')]]['delv_date'][$po_id]=$delv_date;
			$job_exchane_rate_arr[$selectResult[csf('job_no')]]=$selectResult[csf('exchange_rate')];
		}
		//echo '<pre>';print_r($job_level);die;
		$i=1;
		if($cbo_level==1)
		{
			foreach ($nameArray as $selectResult)
				...
				if($req_qnty>0 && $is_short==2 && $tot_bal>0)
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" id="search<? echo $i;?>" onClick="change_color('search<? echo $i; ?>','<? echo $bgcolor; ?>')">
                        ...
                        <td width="50" align="right">
                            <input type="text"  style="width:100%; font-family:Verdana, Geneva, sans-serif; font-size:11px;  text-align:right; background-color:<? echo $bgcolor; ?>" id="txtrate_<? echo $i;?>" value="<?  if($rate>0){ echo def_number_format($rate,4,"");}else {echo 0;}?>" onChange="calculate_amount(<? echo $i; ?>)" />
                            <input type="hidden" id="txtrate_precost_<? echo $i;?>" value="<? echo def_number_format($preCostRate,4,"");?>" />
                        </td>
                        <td width="60" align="right">
		...
		if($cbo_level==2)
		{
			...
			{
				foreach($color_idarray as $country_idarray)
				{
					foreach($country_idarray as $colorid)
				{
					if ($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
					...
					$country_ids=implode(",",array_unique($colorid['country_id']));
					...
					$wash_req_qty=$wash_short_qty_arr[$txt_job_no];
					$embl_req_qty=number_format(($emblishment_req_qty+$wash_req_qty),2,'.','');
					//echo $req_qnty.'='.$cu_woq.'='.$tot_bal.'='.$is_short.'<br> ';
					$tot_bal=$req_qnty-$cu_woq;
				 //echo $booking_previQty.'='.$embl_req_qty.'<br>';
				...
				//if($req_qnty>0 && ($booking_previQty>=$embl_req_qty)  && $is_short==1)
					...
					if($req_qnty>0 && $is_short==2 && $tot_bal>0)
					{
						...
						<tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" id="search<? echo $i;?>" onClick="change_color('search<? echo $i; ?>','<? echo $bgcolor; ?>')">
                            ...
                            <td width="100"><p><? echo $country_name_library[$country_ids];?> </p><input type="hidden" id="txtcountryid_<? echo $i;?>" value="<? echo $country_ids;?>" /></td>
...
if ($action=="show_print_booking")
{
   ...
   <table cellspacing="0" cellpadding="0" border="1" rules="all" width="1047" class="rpt_table" >
	   ...
	   ?>
                    ...
                    <td width="50" align="right">
                    <input type="text"  style="width:100%; font-family:Verdana, Geneva, sans-serif; font-size:11px;  text-align:right; background-color:<? echo $bgcolor; ?>" id="txtrate_<? echo $i;?>" value="<? echo  def_number_format($rate,4,"");?>" onChange="calculate_amount(<? echo $i; ?>)" />
	...
	if ($operation==0)  // Insert Here
	{
		...
		if($row_msg>0)
		{
		 ...
		 for ($i=1;$i<=$total_row;$i++)
		 {
			 ...
			 $countryid=str_replace("'","",$$txtcountryid);
             $reqqnty=str_replace("'","",$$txtreqqty);
			 $woq=str_replace("'","",$$txtwoq);
			 $rate=str_replace("'","",$$txtrate);

			 foreach($jason_data->$embcostid->$colorid->$countryid->po_id as $poId){
				 if ($j!=1) $data_array1 .=",";
				 if(str_replace("'","",$cbo_is_short)==2)
				 {
					 //$wqQty=($jason_data->$embcostid->$colorid->req_qnty->$poId/$reqqnty)*$woq;
					 if($woq>0) $wqQty=($jason_data->$embcostid->$colorid->$countryid->req_qnty->$poId/$reqqnty)*$woq; else $wqQty=0;
				 }
				 else
				 {
					$wqQty=$woq;
		 ...
		 for ($i=1;$i<=$total_row;$i++)
		 {
			...
			if(str_replace("'",'',$$txtbookingdtlasid)!="")
			{
				foreach($jason_data->$embcostid->$colorid->$countryid->po_id as $poId){
					...
					$amount=$wqQty*$rate;
					$id_arr[]=str_replace("'",'',$jason_data->$embcostid->$colorid->$countryid->booking_dtls_id->$poId);
					$data_array_up1[str_replace("'",'',$jason_data->$embcostid->$colorid->$countryid->booking_dtls_id->$poId)] =explode("*",("".$$txtembcostid."*".$poId."*".$txt_job_no."*6*".$cbo_gmt_item."*".$cbo_booking_natu."*".$$txtcolorid."*".$wqQty."*".$rate."*".$amount."*".$$txtddate."*".$$description."*".$$txtcountryid."*".$$uom_id."*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'*1*0"));
					}
			}
...
<div style="width:1100px;" align="center">
 ...
 <table width="1100" cellspacing="0" align="center" border="1" rules="all" class="rpt_table" >
      ...
      <?
				   ...
				   foreach($sql_booking_cu as $sql_booking_row_cu )
				   {
					  $booking_data_array_cu[$sql_booking_row_cu[csf('po_break_down_id')]][$sql_booking_row_cu[csf('country_id_string')]][$sql_booking_row_cu[csf('gmt_item')]][$sql_booking_row_cu[csf('pre_cost_fabric_cost_dtls_id')]][$sql_booking_row_cu[csf('emb_name')]][$sql_booking_row_cu[csf('emb_type')]][$sql_booking_row_cu[csf('gmts_color_id')]]['cu_woq']=$sql_booking_row_cu[csf('cu_woq')];
				   }
				 $sql="select
					...
					where a.job_no=b.job_no and a.job_no=c.job_no and a.job_no=d.job_no_mst  and a.job_no=e.job_no_mst  and a.job_no=f.job_no  and c.id=f.pre_cost_fabric_cost_dtls_id  and d.id=e.po_break_down_id and d.id=f.po_break_down_id and f.gmt_item=e.item_number_id and  f.gmts_color_id=e.color_number_id and f.country_id_string = e.country_id and f.booking_no='$txt_booking_no' and a.is_deleted=0 and  a.status_active=1 and b.is_deleted=0 and b.status_active=1 and c.is_deleted=0 and c.status_active=1 and d.is_deleted=0 and d.status_active=1 and e.is_deleted=0 and e.status_active=1 and f.is_deleted=0 and f.status_active=1 and f.wo_qnty>0 and f.entry_form_id=161
					...
					foreach ($nameArray as $selectResult)
					{
						...
						if($selectResult[csf('emb_name')]==3) {
						 ...
						 if($cbo_level==1)
							...
							{
								$emb_req_qty=$emblishmentqty_arr[$selectResult[csf('po_id')]][$selectResult[csf('country_id')]][$selectResult[csf('item_number_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('wo_pre_cost_embe_cost_dtls')]];
								$req_qnty=($emblishmentqty_arr[$selectResult[csf('po_id')]][$selectResult[csf('country_id')]][$selectResult[csf('item_number_id')]][$selectResult[csf('color_number_id')]][$selectResult[csf('wo_pre_cost_embe_cost_dtls')]]+$wash_qty);
							}
							

						$wo_qnty1=$selectResult[csf('wo_qnty')];
						//$wo_qnty=def_number_format($wo_qnty1,5,"");
						$cu_woq=$booking_data_array_cu[$selectResult[csf('po_id')]][$selectResult[csf('country_id')]][$selectResult[csf('item_number_id')]][$selectResult[csf('wo_pre_cost_embe_cost_dtls')]][$selectResult[csf('emb_name')]][$selectResult[csf('emb_type')]][$selectResult[csf('color_number_id')]]['cu_woq'];
...
$sql="select id from electronic_approval_setup where company_id=$cbo_company_name and page_id in(1257) and is_deleted=0";
