				...
				<form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
					<table  cellspacing="0" cellpadding="0" border="0" class="rpt_table" align="center" style="">
						...
						<tr>
							...
							<td align="center">
								<input type="button" name="button2" class="formbutton" value="Show"   onClick="show_list_view (document.getElementById('cbo_supplier').value+'**'+document.getElementById('cbo_count').value+'**'+document.getElementById('txt_desc').value+'**'+document.getElementById('cbo_type').value+'**'+document.getElementById('txt_lot_no').value+'**'+'<? echo $company; ?>'+'**'+'<? echo $job_no; ?>'+'**'+'<? echo $is_sales_order; ?>'+'**'+'<? echo $cbo_service_type; ?>'+'**'+'<? echo $cbo_with_order; ?>', 'create_lot_search_list_view', 'search_div', 'yarn_service_work_order_controller', 'setFilterGrid(\'table_charge\',-1)');" style="width:70px;"/>
							</td>
						</tr>
					</table>
					<br>
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)
	{
		...
		$field_array_dts="id,mst_id,job_no,job_no_id,entry_form,product_id,count,yarn_description,uom,yarn_wo_qty,dyeing_charge,amount,no_of_bag,no_of_cone,min_require_cone,remarks,status_active,is_deleted";
		$dtls_ids="";
		...
		for($j=0; $j<$tot_row; $j++)
		{
			...
			$data_array_dts.="(".$dtlsid.",".$id.",'".$$txt_job_no."','".$$txt_job_id."',94,'".$$txt_pro_id."','".$$cbo_count."','".$$txt_item_des."',".$$cbo_uom.",'".$$txt_wo_qty."','".$$txt_rate."','".$$txt_amount."','".$$txt_bag."','".$$txt_cone."','".$$txt_min_req_cone."','".$$txt_remarks."',1,0)";
			$dtls_ids.=$dtlsid.",";
			$dtlsid=$dtlsid+1;
			$job_no = $$txt_job_no;
			$pro_id = $$txt_pro_id;
	...
	else if ($operation==1) // Update Here----------------------------------------------------------
	{
		...
		for($j=0; $j<$tot_row; $j++)
		{
			...
			if($data_array_dts!="") $data_array_dts.=",";
			$data_array_dts.="(".$dtlsid.",".$update_id.",'".$$txt_job_no."','".$$txt_job_id."',94,'".$$txt_pro_id."','".$$cbo_count."','".$$txt_item_des."',".$$cbo_uom.",'".$$txt_wo_qty."','".$$txt_rate."','".$$txt_amount."','".$$txt_bag."','".$$txt_cone."','".$$txt_min_req_cone."','".$$txt_remarks."',1,0)";
