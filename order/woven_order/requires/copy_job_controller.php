            	...
            	<table  cellspacing="0" cellpadding="0" border="0" class="rpt_table" align="center">
        			...
        			<tr>
                    	<td> <input type="hidden" id="selected_job">
							<? 
								echo create_drop_down( "cbo_company_mst", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 and core_business not in(3) $company_cond order by company_name","id,company_name",1, "-- Select Company --", '',"load_drop_down( 'copy_job_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );" );
							?>
                    </td>
                   	<td id="buyer_td">
                     <? 
...
if($action=="save_update_delete_copy_job")
{
	...
	foreach($sql_se_set as $row_se_set)
	{
		...
		$sql_insert_set="insert into  wo_po_details_mas_set_details(id,job_no,job_id,gmts_item_id,set_item_ratio,smv_pcs,smv_set,smv_pcs_precost,smv_set_precost) 
		select $id_set,'".$new_job_no[0]."',".$id.",gmts_item_id,set_item_ratio,smv_pcs,smv_set,smv_pcs_precost,smv_set_precost from  wo_po_details_mas_set_details where job_no=$txt_job_no and id=".$row_se_set[csf('id')]."";
...
$sql_insert_po="insert into  wo_po_break_down(id,job_no_mst,job_id,po_number,pub_shipment_date,excess_cut,po_received_date,po_quantity,unit_price,plan_cut,country_name,po_total_price, 	shipment_date,pp_meeting_date,factory_received_date,original_avg_price,	t_year,	t_month, is_deleted, is_confirmed, details_remarks, delay_for, packing, grouping,projected_po_id,tna_task_from_upto,original_po_qty,inserted_by,insert_date,status_active,shiping_status) 
		select $id_po,'".$new_job_no[0]."',".$id.",po_number,pub_shipment_date,excess_cut,po_received_date,po_quantity,unit_price,plan_cut,country_name,po_total_price, 	shipment_date,pp_meeting_date,factory_received_date,original_avg_price,	t_year,	t_month, is_deleted, is_confirmed, details_remarks, delay_for, packing, grouping,projected_po_id,tna_task_from_upto,original_po_qty,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',status_active,shiping_status from  wo_po_break_down where job_no_mst=$txt_job_no and id=".$row_se_po[csf('id')]."";
		...
		//=========================================================================PO END======================================
		 ...
		 $field_array="id,po_break_down_id,job_no_mst,job_id,color_mst_id, size_mst_id, item_mst_id, article_number, item_number_id,country_id,cutup_date,cutup,country_ship_date, size_number_id, color_number_id, order_quantity, order_rate, order_total,excess_cut_perc,plan_cut_qnty,country_remarks,is_deleted,status_active,inserted_by,insert_date";
...
$sql_insert_fabric="insert into  wo_pre_cost_fabric_cost_dtls(id, job_no,job_id, item_number_id, body_part_id, fab_nature_id, color_type_id,lib_yarn_count_deter_id,construction,composition, fabric_description, gsm_weight,color_size_sensitive,	color, avg_cons, fabric_source, rate, amount,avg_finish_cons,	avg_process_loss, inserted_by, insert_date, status_active, is_deleted, company_id, costing_per,consumption_basis,process_loss_method,cons_breack_down,msmnt_break_down,color_break_down,yarn_breack_down,marker_break_down,width_dia_type,avg_cons_yarn,gsm_weight_yarn,plan_cut_qty,job_plan_cut_qty) 
  ...
  $sql_insert_fabric_color="insert into  wo_pre_cos_fab_co_color_dtls(id,pre_cost_fabric_cost_dtls_id,job_no,job_id,gmts_color_id,gmts_color,contrast_color_id) 
		select $wo_pre_cos_fab_co_color_dtls_id,".$fabric_cost_id_maping[$row_se_fabric_color[csf('pre_cost_fabric_cost_dtls_id')]].",'".$new_job_no[0]."',".$id.",gmts_color_id,gmts_color,contrast_color_id from  wo_pre_cos_fab_co_color_dtls where job_no=$txt_job_no and id=".$row_se_fabric_color[csf('id')]."";
  ...
  $sql_insert_fabric_yarn_b="insert into  wo_pre_cost_fab_yarnbreakdown(id,fabric_cost_dtls_id,job_no,job_id,count_id,copm_one_id,percent_one,type_id,cons_ratio,cons_qnty,avg_cons_qnty,inserted_by,insert_date,status_active,is_deleted) 
  ...
  $sql_insert_fabric_conver="insert into  wo_pre_cost_fab_conv_cost_dtls(id,job_no,job_id,fabric_description,cons_process,req_qnty,avg_req_qnty,charge_unit,amount,color_break_down,charge_lib_id,inserted_by,insert_date,status_active,is_deleted) 
		select $wo_pre_cost_fab_conv_cost_dtls_id,'".$new_job_no[0]."',".$id.",".$fabric_cost_id_maping[$row_se_fabric_conver[csf('fabric_description')]].",cons_process,req_qnty,avg_req_qnty,charge_unit,amount,color_break_down,charge_lib_id,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',status_active,is_deleted from  wo_pre_cost_fab_conv_cost_dtls where job_no=$txt_job_no and id=".$row_se_fabric_conver[csf('id')]."";
	...
	foreach($sql_se_trim as $row_se_trim)
	{
        ...
        $sql_insert_fabric_trim="insert into  wo_pre_cost_trim_cost_dtls(id, job_no,job_id, trim_group,description,brand_sup_ref, cons_uom, cons_dzn_gmts, rate, amount, apvl_req, nominated_supp,cons_breack_down, inserted_by, insert_date, status_active,	is_deleted) 
		select $wo_pre_cost_trim_cost_dtls_id, '".$new_job_no[0]."',".$id.", trim_group,description,brand_sup_ref, cons_uom, cons_dzn_gmts, rate, amount, apvl_req, nominated_supp,cons_breack_down, ".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."', status_active,	is_deleted from  wo_pre_cost_trim_cost_dtls where job_no=$txt_job_no and id=".$row_se_trim[csf('id')]."";
	...
	foreach($sql_se_trim_cons as $row_se_trim_cons)
	{
		$wo_pre_cost_trim_co_cons_dtls_id=return_next_id( "id", "wo_pre_cost_trim_co_cons_dtls", 1 ) ;
         ...
         $sql_insert_fabric_trim_avg="insert into  wo_pre_cost_trim_co_cons_dtls(id, wo_pre_cost_trim_cost_dtls_id, job_no,job_id, po_break_down_id,item_size, cons, place, pcs,country_id) 
		select $wo_pre_cost_trim_co_cons_dtls_id, ".$trim_table_id_maping[$row_se_trim_cons[csf('wo_pre_cost_trim_cost_dtls_id')]].", '".$new_job_no[0]."',".$id.", ".$po_id_maping_array[$row_se_trim_cons[csf('po_break_down_id')]].",item_size, cons, place, pcs,country_id from  wo_pre_cost_trim_co_cons_dtls where job_no=$txt_job_no and id=".$row_se_trim_cons[csf('id')]."";
	...
	foreach($sql_se_embe_wash as $row_se_embe_wash)
	{
		$wo_pre_cost_embe_cost_dtls_id=return_next_id( "id", "wo_pre_cost_embe_cost_dtls", 1 ) ;
         ...
         $sql_insert_embe_wash="insert into  wo_pre_cost_embe_cost_dtls(id,job_no,job_id,emb_name,emb_type,cons_dzn_gmts,rate,amount,inserted_by,insert_date,status_active,is_deleted) select $wo_pre_cost_embe_cost_dtls_id,'".$new_job_no[0]."',".$id.",emb_name,emb_type,cons_dzn_gmts,rate,amount,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',status_active,is_deleted from  wo_pre_cost_embe_cost_dtls where job_no=$txt_job_no and id=".$row_se_embe_wash[csf('id')]."";
	...
	foreach($sql_se_commercial as $row_se_commercial)
	{
        ...
        $sql_insert_commercial="insert into  wo_pre_cost_comarci_cost_dtls(id,job_no,job_id,item_id,rate,amount,inserted_by,insert_date,status_active,is_deleted) select $wo_pre_cost_comarci_cost_dtls_id,'".$new_job_no[0]."',".$id.",item_id,rate,amount,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',status_active,is_deleted from  wo_pre_cost_comarci_cost_dtls where job_no=$txt_job_no and id=".$row_se_commercial[csf('id')]."";
	...
	foreach($sql_se_commision as $row_se_commision)
	{
        ...
        $sql_insert_commision="insert into  wo_pre_cost_commiss_cost_dtls(id,job_no,job_id,particulars_id,commission_base_id,commision_rate,commission_amount,inserted_by,insert_date,status_active,is_deleted) 
		select $wo_pre_cost_commiss_cost_dtls_id,'".$new_job_no[0]."',".$id.",particulars_id,commission_base_id,commision_rate,commission_amount,".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',status_active,is_deleted from  wo_pre_cost_commiss_cost_dtls where job_no=$txt_job_no and id=".$row_se_commision[csf('id')]."";
