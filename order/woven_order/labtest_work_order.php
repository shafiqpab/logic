...
function fnc_fabric_booking_dtls( operation )
{
	...
	data_all=get_submitted_data_string('txt_job_no*cbo_test_for*txt_remarks*txt_transaction_ref*txt_color*txt_test_item*txt_amount*txt_delivery_charge*txt_discount*txt_wo_value*update_dtls_id*txt_party_type_id*txt_party_type_name*update_id*txt_vat_amount*txt_wo_value_with_vat*cbo_pay_mode*txt_workorder_no*txt_order_id*save_qty_break_data*exchange_rate',"../../");
...
<legend>Details</legend>
    <form id="printbooking_2" name="printbooking_2" autocomplete="off">
       <br>
        <table class="rpt_table" width="1080" cellspacing="0" cellpadding="0" border="1" rules="all">
            <thead>
                <tr>
            ...
            <tbody class="" id="dtls_part">
                <tr>
                    ...
                    <td>
                     ...
                     <td>
                        <input class="text_boxes_numeric" type="text" style="width:80px" name="txt_amount" id="txt_amount"/>
                     </td>
                     <td>
