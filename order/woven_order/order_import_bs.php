<?
/*--- ----------------------------------------- Comments
Purpose			: 	This form will create Knit Garments Order Import Bestseller Buyer
Functionality	:	
JS Functions	:
Created by		:	Kausar 
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Order Import Bestseller","../../", 1, 1, $unicode,1,'');
        ...
        <table width="900" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
            ...
            <tr class="general">
                <td> 
					...
					<? echo create_drop_down( "cbo_company_mst", 130, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 and core_business not in(3) $company_cond order by company_name","id,company_name",1, "--Select Company--", $selected,"load_drop_down( 'order_import_bs', this.value, 'load_drop_down_buyer_pop', 'buyer_pop_td' );",'' ); ?>
                </td>
...
<!-- Important Field outside Form -->  
    <? echo load_freeze_divs ("../../",$permission);  ?>
            ...
            <fieldset style="width:500px;">
                <form name="excelImport_1" id="excelImport_1" action="excel_order_import_bs.php" enctype="multipart/form-data" method="post"> 
