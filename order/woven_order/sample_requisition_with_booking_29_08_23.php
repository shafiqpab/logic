...
$fabric_dia=0;
if (array_search('txt_fabric_Dia', $_SESSION['logic_erp']['mandatory_field'][203]) !== false) {
    $fabric_dia=1;
}
...
?>
  	...
  	function fnc_sample_requisition_mst_info( operation )
	{
		...
		// freeze_window(operation);
 		...
 		if(operation==4 || operation==5 || operation==6 || operation==7 || operation==8 || operation==9 || operation==10 || operation==11)
		{
			...
			else if(operation==10) var action="sample_requisition_print10";else if(operation==11) var action="sample_requisition_print11";
...
//Remarks
	...
	function openmypage_color_size(page_link,title,type,inc)
	{
		...
		if(sampleStage==1 || sampleStage==2 || sampleStage==3)
		{
			...
			{
				var page_link = page_link + "&style_db_id="+style_db_id+ "&cbo_buyer_name="+cbo_buyer_name;
								...
								<table cellpadding="0" cellspacing="0" width="1450" class="rpt_table" border="1" rules="all" id="tbl_sample_details">
									...
									<tbody id="sample_details_container">
										<tr id="tr_1" style="height:10px;" class="general">
											...
											<td width="70">
												<input type="button" id="increase_1" name="increase_1" style="width:30px" class="formbuttonplasminus" value="+" onClick="add_break_down_tr(1,this)" />
