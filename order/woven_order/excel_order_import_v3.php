	...
	if (move_uploaded_file($source, $targetzip)) 
	{
        ...
        <script>
			...
			function fnc_excel_import(operation)
			{
				...
				http.open("POST","requires/excel_order_import_v3_controller.php",true);
        ...
        <!-- Important Field outside Form -->  
            ...
            <fieldset style="width:1300px;">
              ...
              <tbody>
              	<tr>
                	<td><?=create_drop_down( "cbo_company_id", 130, "select id, company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-Select Company-", $selected, "load_drop_down( 'requires/excel_order_import_set_controller', this.value, 'load_drop_down_location', 'location_td'); load_drop_down( 'requires/excel_order_import_set_controller', this.value, 'load_drop_down_buyer', 'buyer_td'); fnc_style_owner(this.value);"); ?></td>
