...
?>
  	...
  	function fnc_generate_booking() 
  	{
		...
		//alert(req_id+'='+sample_stage);
  		if(sample_stage!=1)
  		{
  			...
  			alert("Booking not allowed for sample Stage After Order Place");
  			release_freezing();	
  			return;
  		}
  	}
  	...
  	function fnc_sample_requisition_mst_info( operation )
	{
		...
		// freeze_window(operation);
 		...
 		if(operation==4 || operation==5 || operation==6 || operation==7 || operation==8 || operation==9)
		{
			...
			if(operation==4) var action="sample_requisition_print"; else if(operation==5) var action="sample_requisition_print1"; else if(operation==6) var action="sample_requisition_print6"; else if(operation==7) var action="sample_requisition_print7";
			else if(operation==8) var action="sample_requisition_print8"; else if(operation==9) var action="sample_requisition_print9";
	...
	function fnc_sample_details_info( operation )
	{
		...
		else
		{
			...
			for (var i=1; i<=row_num; i++)
			{
				...
				data_all=data_all+get_submitted_data_string('cboSampleName_'+i+'*cboGarmentItem_'+i+'*txtSmv_'+i+'*txtArticle_'+i+'*txtColor_'+i+'*txtSampleProdQty_'+i+'*txtSubmissionQty_'+i+'*txtDelvStartDate_'+i+'*txtDelvEndDate_'+i+'*txtBuyerSubDate_'+i+'*txtRemarks_'+i+'*txtChargeUnit_'+i+'*cboCurrency_'+i+'*updateidsampledtl_'+i+'*hiddenColorid_'+i+'*txtAllData_'+i+'*hiddenadditionalvaluedata_'+i,"../../");
			}
	...
	function fn_deleteRow_old(rowNo)
	{
...
//Remarks
	...
	function get_buyer_config(buyer_id)
	{
		...
		load_drop_down( 'requires/sample_requisition_with_booking_controller', buyer_id+'*'+1, 'load_drop_down_brand', 'brand_td');
	}
...
<body onLoad="set_hotkey(); btn_load_acknowledge();check_exchange_rate();">
	<div style="width:100%;">
				...
				<div style="width:1050px; float:left;" align="center">
                    <table cellpadding="1" cellspacing="2" width="1050">
                        ...
                        <tr>
                            ...
                            <td width="150"><?=create_drop_down( "cbo_company_name", 130, "select comp.id,comp.company_name from lib_company comp where status_active =1 and is_deleted=0 and core_business not in(3) $company_credential_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/sample_requisition_with_booking_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );load_drop_down( 'requires/sample_requisition_with_booking_controller', this.value, 'load_drop_down_agent', 'agent_td' );load_drop_down( 'requires/sample_requisition_with_booking_controller', this.value, 'load_drop_down_location', 'location_td' );get_php_form_data( this.value, 'company_wise_report_button_setting','requires/sample_requisition_with_booking_controller' );load_drop_down( 'requires/sample_requisition_with_booking_controller', this.value, 'load_drop_down_party_type', 'party_type_td' );" ); ?></td>
                        ...
                        <tr>
                        	<td>&nbsp;</td>
							<td>&nbsp;</td>
                            <td align="left"> <input type="button" id="image_button" class="image_uploader" style="width:110px" value="ADD FILE" onClick="file_uploader( '../../', document.getElementById('update_id').value,'', 'sample_requisition_1', 2 ,1)" /></td>
                            <td align="left"> <input type="button" id="image_button" class="image_uploader" style="width:130px" value="ADD IMAGE" onClick="file_uploader( '../../', document.getElementById('update_id').value,'', 'sample_requisition_2', 0 ,1)" /></td>
							<td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
                            <td>&nbsp;</td>
				...
				<div style="width:1050px; float:left;" align="center">
                    <table cellpadding="1" cellspacing="2" width="1050">
                        ...
                        <tr>
                            ...
                            <td><? echo create_drop_down( "cbo_pay_mode", 130, $pay_mode,"", 1, "-- Select Pay Mode --", 3, "load_drop_down( 'requires/sample_requisition_with_booking_controller', this.value, 'load_drop_down_suplier', 'sup_td' )","","1,2,3,5" ); ?></td>
                            <td>Supplier Name </td>
                        ...
                        <tr>
                            ...
                            <td>Ready To App.</td>
                            <td><?=create_drop_down( "cbo_ready_to_approved_book", 130, $yes_no,"", 1, "-- Select--", 2, "get_php_form_data( this.value+'_'+document.getElementById('txt_booking_no').value, 'check_dtls_part', 'requires/sample_requisition_with_booking_controller');","","" ); ?>
                        ...
                        <tr>
                        	<td colspan="8" align="center"><input type="button" id="set_button" class="image_uploader" style="width:150px;" value="Terms & Condition/Notes" onClick="open_terms_condition_popup('requires/sample_requisition_with_booking_controller.php?action=terms_condition_popup','Terms Condition')" /></td>
                        </tr>
        ...
        <br/>
		<h3 align="left" class="accordion_h" onClick="show_hide_content('sample_details', ''); fnc_load_tr(document.getElementById('update_id').value,1); hide_others_section('sd');" style="width:1450px;"> +Sample Details </h3>
							...
							<td align="center" valign="top" id="po_list_views">
								...
								<table cellpadding="0" cellspacing="0" width="1450" class="rpt_table" border="1" rules="all" id="tbl_sample_details">
							     ...
							     //   $sql="select id,item_name from  lib_garment_item where status_active=1 and is_deleted=0";
											...
											<td align="center" id="buyer_sub_date_1">
												<input style="width:85px;" type="text" class="datepicker" placeholder="Select Date" autocomplete="off" name="txtBuyerSubDate_1" id="txtBuyerSubDate_1" />
											</td>
		...
		<h3 align="left" class="accordion_h" onClick="show_hide_content('required_fabric', ''); fnc_load_tr(document.getElementById('update_id').value,2); hide_others_section('rf');" style="width:1500px;"> +Required Fabric </h3>
					...
					<table width="100%" cellpadding="0" cellspacing="2" align="center" >
						<tr>
							<td align="center" valign="top" id="po_list_view">
								...
								<table cellpadding="0" cellspacing="0" width="1500" class="rpt_table" border="1" rules="all" id="tbl_required_fabric">
									...
									<tbody id="required_fabric_container">
										<tr id="tr_1" style="height:10px;" class="general">
                                            ...
                                            <td id="rf_fab_1"><?=create_drop_down( "cboRfFabricSource_1", 70, $fabric_source,'', '', "",'',"","","1,4" ); ?></td>
                                ...
                                <table>
                                    <tr>
                                        <td colspan="21" valign="bottom" align="center" class="">
...
<h3 align="left" class="accordion_h" onClick="show_hide_content('required_accessories', ''); fnc_load_tr(document.getElementById('update_id').value,3); hide_others_section('acc');" style="width: 1450px;"> +Required Accessories </h3>
<div id="content_required_accessories" style="display:none;">
	<form name="required_accessories_1" id="required_accessories_1">
					...
					<td align="center" valign="top" id="po_list_view">
						...
						<table cellpadding="0" cellspacing="0" width="1450" class="rpt_table" border="1" rules="all" id="tbl_required_accessories">
							<thead>
								...
								<th class="">Acc. Del. Date</th>
								<th class="">Acc. Source</th>
								<th>Remarks</th>
								<th class="">Image</th>
								<th class=""></th>
							</thead>
							...
							<tbody id="required_accessories_container">
								<tr class="" id="tr_1" style="height:10px;"  class="general">
									...
									<td align="center" id="ra_req_dzn_1" width="100">
										<input style="width:100px;" type="text" class="text_boxes_numeric"  name="txtRaReqDzn_1" id="txtRaReqDzn_1" placeholder="Write" />
										<? //onBlur="calculate_required_qty('2','1');"		?>
									</td>
									<td align="center" id="ra_req_qty_1" width="100">
										<input style="width:100px;" type="text" class="text_boxes_numeric"  name="txtRaReqQty_1" id="txtRaReqQty_1" placeholder="Write" />
                                        <input type="hidden" class="text_boxes"  name="txtMemoryDataRa_1" id="txtMemoryDataRa_1" />
									</td>
									<td id="deliveryraDateid_1"><input style="width:85px;" type="text" class="datepicker" placeholder="Select Date" autocomplete="off" name="accDate_1" id="accDate_1" /></td>
									<td align="center" id="ra_fab_1" width="80">
										<?
										echo create_drop_down( "cboRaFabricSource_1", 80, $fabric_source,'', '', "",'',"","","2,4" );
										?>
									</td>
									<td align="center" id="ra_remarks_1" width="70">
										<input style="width:70px;" type="text" class="text_boxes"  name="txtRaRemarks_1" id="txtRaRemarks_1" placeholder="Click"  readonly="" onClick="openmypage_remarks('requires/sample_requisition_with_booking_controller.php?action=all_remarks_popup','Remarks','3','1');" />
									</td>
						...
						<table>
							<tr>
								<td colspan="13" height="40" valign="bottom" align="center">
									<?
		...
		<h3 align="left" class="accordion_h" onClick="show_hide_content('required_embellishment',''); fnc_load_tr(document.getElementById('update_id').value,4); hide_others_section('emb');" style="width: 1360px;"> +Required Embellishment </h3>
						...
						<tr>
							<td align="center" valign="top" id="po_list_view">
									...
									<tbody id="required_embellishment_container">
										<tr id="tr_1" style="height:10px;" class="general">
                                            ...
                                            <td align="center" id="re_rate_1">
												<input style="width:40px;" type="text" class="text_boxes"  name="txtReRate_1" id="txtReRate_1" placeholder="Rate"  readonly="" />

											</td>
                                              <td align="center" id="re_amount_1">
												<input style="width:50px" type="text" class="text_boxes" name="txtReAmount_1" id="txtReAmount_1" placeholder="Amount" readonly />
											</td>
                                            <td align="center" id="re_remarks_1">
												<input style="width:90px;" type="text" class="text_boxes"  name="txtReRemarks_1" id="txtReRemarks_1" placeholder="Click"  readonly="" onClick="openmypage_remarks('requires/sample_requisition_with_booking_controller.php?action=all_remarks_popup','Remarks','4','1');"/>

											</td>
											<td align="center" id="deliveryDateid_1">
												<input style="width:70px;" type="text" class="datepicker" placeholder="Select Date" autocomplete="off" name="deliveryDate_1" id="deliveryDate_1" />
											</td>
											<td id="re_image_1"><input type="button" class="image_uploader" name="reTxtFile_1" id="reTxtFile_1" onClick="file_uploader ( '../../',document.getElementById('updateidRequiredEmbellishdtl_1').value,'', 'required_embellishment_1', 0 ,1);" style="width:120px;" value="ADD/VIEW IMAGE"></td>
								...
								<table style="">
									...
									<tr >
										<td colspan="10" height="40" valign="bottom" align="center" class="">
											<?
