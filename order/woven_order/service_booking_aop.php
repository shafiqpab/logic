...
function fnc_service_booking_dtls( operation )
{
	...
	data_all=data_all+get_submitted_data_string('cbo_process*cbo_colorsizesensitive*txt_job_no*txt_booking_no*txt_all_update_id*booking_mst_id',"../../");
...
function fnc_service_booking_dtls_reponse()
{
	if(http.readyState == 4) 
	{
		...
		if(trim(reponse[0])=='issueQty'){
			alert("Wo Qty is not less then Issue Qty.")
		    release_freezing();
		    return;
		}
		show_msg(trim(reponse[0]));
...
function check_exchange_rate()
{
	...
	var response=return_global_ajax_value( cbo_currercy+"**"+booking_date+"**"+cbo_company_name, 'check_conversion_rate', '', 'requires/service_booking_aop_controller');
            ...
            <fieldset style="width:1000px;">
                ...
                <table  width="1000" cellspacing="2" cellpadding="0" border="0">
                    <tr>
                        ...
                        <td colspan="4"><input class="text_boxes" type="text" style="width:160px" onDblClick="openmypage_booking('requires/service_booking_aop_controller.php?action=service_booking_popup','Service Booking Search')" readonly placeholder="Double Click for Booking" name="txt_booking_no" id="txt_booking_no"/>
                    ...
                    <tr>
                        ...
                        <td width="140"><?=create_drop_down( "cbo_company_name", 130, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 and core_business not in(3) $company_cond order by company_name", "id,company_name",1, "-- Select Company --", $selected, "load_drop_down( 'requires/woven_order_entry_controller', this.value, 'load_drop_down_buyer', 'buyer_td' ); check_exchange_rate();","","" ); ?></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <input class="text_boxes" type="text" style="width:370px;" placeholder="Double click for Order"  onDblClick="openmypage_order('requires/service_booking_aop_controller.php?action=order_search_popup','Order Search')"   name="txt_order_no" id="txt_order_no"/>
                    ...
                    <tr>
                        ...
                        <td><?=create_drop_down( "cbo_pay_mode", 130, $pay_mode,"", 1, "-- Select Pay Mode --", "", "load_drop_down( 'requires/service_booking_aop_controller', this.value, 'load_drop_down_supplier', 'supplier_td' );","" ); ?></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            ...
                            <input type="hidden" class="image_uploader" style="width:120px" value="Lab DIP No" onClick="openmypage('requires/service_booking_aop_controller.php?action=lapdip_no_popup','Lapdip No','lapdip')">
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td> 
                        <td valign="middle"><input type="button" class="image_uploader" style="width:130px" value="ADD/VIEW IMAGE" onClick="file_uploader ( '../../', document.getElementById('txt_booking_no').value,'', 'service_booking', 0 ,1)"></td>
                        <td>&nbsp;</td>
                        <td>
							<?
                            include("../../terms_condition/terms_condition.php");
                            terms_condition(361,'txt_booking_no','../../');
                            ?>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <input type="button" value="Print" onClick="generate_trim_report('show_trim_booking_report');" style="width:70px" name="print_booking" id="print_booking" class="formbutton" />
                        <input type="button" value="Print B1" onClick="generate_trim_report('show_trim_booking_report1');" style="width:70px" name="print_booking1" id="print_booking1" class="formbutton" /> 
                        <input type="button" value="Print B2" onClick="generate_trim_report('show_sb_booking_report2');" style="width:70px" name="print_booking2" id="print_booking2" class="formbutton" />  
                        </td>
                    </tr>
                </table>
            </fieldset>
