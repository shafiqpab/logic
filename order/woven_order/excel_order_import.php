	...
	if (move_uploaded_file($source, $targetzip)) 
	{
        ...
        <script>
			...
			function fnc_excel_import(operation)
			{
				...
				var data="action=save_update_delete&operation="+operation+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_buyer_id*cbo_style_owner_id*cbo_product_department*cbo_currercy_id*cbo_season_id*cbo_prod_catgory*cbo_team_leader*cbo_dealing_merchant*cbo_factory_merchant*cbo_order_uom*cbo_gmtsItem_id*tot_smv_qty*cbo_packing*txt_job_no*hid_ws_id',"../../");
