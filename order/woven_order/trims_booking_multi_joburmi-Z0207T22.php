...
?>
	...
	function call_print_button_for_mail(mail_address,mail_body,type){
		...
		else if(report_id[0]==174) generate_trim_report('show_trim_booking_report7',1,'1___'+mail_address);
...
$cbo_company_name      = create_drop_down( "cbo_company_name", 172, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 and core_business not in(3) $company_cond order by company_name", "id,company_name",1, "-- Select Company --", $selected, "get_php_form_data( this.value, 'populate_variable_setting_data', 'requires/trims_booking_multi_job_controllerurmi' );","","" );
...
$cbo_pay_mode          = create_drop_down( "cbo_pay_mode", 172, $pay_mode,"", 1, "-- Select Pay Mode --", "", "load_drop_down( 'requires/trims_booking_multi_job_controllerurmi', this.value+'_'+document.getElementById('cbo_buyer_name').value+'_'+document.getElementById('cbo_company_name').value, 'load_drop_down_supplier', 'supplier_td' )","" );
    ...
    <form name="trimsbooking_1"  autocomplete="off" id="trimsbooking_1">
        <fieldset style="width:950px;">
            ...
            <table  width="900" cellspacing="2" cellpadding="0" border="0">
                ...
                <tr>
                    <td align="right">Shipment Month</td>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                    <textarea id="delivery_address" class="text_area" style="width:160px; height:40px;" placeholder="Delivery Address" ></textarea>
                    </td>
                    ...
                    <td align="left" height="10">
                     ...
                     <td align="right">file</td>
                                   <td> <input type="button" class="image_uploader" style="width:160px" value="CLICK TO ADD FILE" onClick="file_uploader ( '../../', document.getElementById('txt_booking_no').value,'', 'multiple_job_wise_trims_booking_v2', 2 ,1)"> </td>
...
function openmypage_booking(page_link,title){
	...
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=1070px,height=455px,center=1,resize=1,scrolling=0','../')
	emailwindow.onclose=function(){
		var theform=this.contentDoc.forms[0];
...
function print_report_button_setting(report_ids)
{
	...
	for (var k=0; k<report_id.length; k++)
	{
		...
		else if(report_id[k]==174) $("#print_booking7").show();
