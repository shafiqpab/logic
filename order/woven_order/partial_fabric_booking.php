...
?>
	...
	function fnc_fabric_booking_dtls( operation ){
		...
		var data_all=""; var z=1;var dataAll2="";
		for (var i=1; i<=row_num; i++){
			...
			var txtcomposition=encodeURIComponent("'"+$('#txtcompositi_'+i).val()+"'");
			
			data_all+="&txtjob_" + z + "='" + $('#txtjob_'+i).val()+"'"+"&txtpoid_" + z + "='" + $('#txtpoid_'+i).val()+"'"+"&txtgmtcolor_" + z + "='" + $('#txtgmtcolor_'+i).val()+"'"+"&txtitemcolor_" + z + "='" + $('#txtitemcolor_'+i).val()+"'"+"&txtbalqnty_" + z + "='" + $('#txtbalqnty_'+i).val()+"'"+"&txtreqqnty_" + z + "='" + $('#txtreqqnty_'+i).val()+"'"+"&txtfinreqqnty_" + z + "='" + $('#txtfinreqqnty_'+i).val()+"'"+"&txtwoq_" + z + "='" + $('#txtwoq_'+i).val()+"'"+"&txtrate_" + z + "='" + $('#txtrate_'+i).val()+"'"+"&txtamount_" + z + "='" + $('#txtamount_'+i).val()+"'"+"&txtadj_" + z + "='" + $('#txtadj_'+i).val()+"'"+"&txtremark_" + z + "='" + $('#txtremark_'+i).val()+"'"+"&bookingid_" + z + "='" + $('#bookingid_'+i).val()+"'"+"&txtpre_cost_fabric_cost_dtls_id_" + z + "='" + $('#txtpre_cost_fabric_cost_dtls_id_'+i).val()+"'"+"&txtcolortype_" + z + "='" + $('#txtcolortype_'+i).val()+"'"+"&txtconstruction_" + z + "='" + $('#txtconstruction_'+i).val()+"'"+"&txtitrmref_" + z + "='" + $('#txtitrmref_'+i).val()+"'"+"&txtgsm_weight_" + z + "='" + $('#txtgsm_weight_'+i).val()+"'"+"&txtdia_" + z + "='" + $('#txtdia_'+i).val()+"'"+"&txtacwoq_" + z + "='" + $('#txtacwoq_'+i).val()+"'"+"&process_" + z + "='" + $('#process_'+i).val()+"'"+"&hscode_" + z + "='" + $('#txthscode_'+i).val()+"'"+"&preconskg_" + z + "='" + $('#preconskg_'+i).val()+"'";
			dataAll2+="&txtcompositi_" + z + "=" +txtcomposition+"";
			//+"'"+"&txtcompositi_" + z + "='" + $('#txtcompositi_'+i).val()
			z++;
		}
		var cbo_level=document.getElementById('cbo_level').value;
		var json_data=document.getElementById('json_data').value;
		if(cbo_level==1){
			var data="action=save_update_delete_dtls&operation="+operation+'&total_row='+row_num+get_submitted_data_string('cbo_company_name*cbo_fabric_description*txt_booking_no*update_id*cbo_pay_mode*lib_tna_intregrate',"../../")+data_all+dataAll2;
			
			//var data="action=save_update_delete_dtls&operation="+operation+'&total_row='+row_num+data_all+"&delete_cause="+delete_cause;
		}
		if(cbo_level==2){
			var data="action=save_update_delete_dtls_job_level&operation="+operation+'&total_row='+row_num+get_submitted_data_string('cbo_company_name*cbo_fabric_description*txt_booking_no*update_id*cbo_pay_mode*lib_tna_intregrate',"../../")+data_all+dataAll2+'&json_data='+json_data+"&delete_cause="+delete_cause;
	...
	function fnc_show_booking(){
		if (form_validation('txt_booking_no','Booking No')==false){
			...
			freeze_window(5);
			var data="action=show_fabric_booking"+get_submitted_data_string('txt_booking_no*txt_order_no_id*cbo_fabric_natu*cbo_fabric_source*cbo_company_name*cbo_buyer_name*cbouom*cbo_fabric_description*cbo_currency*txt_booking_date*cbo_level',"../../");
			http.open("POST","requires/partial_fabric_booking_controller.php",true);
			http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
			http.send(data);
	...
	function open_terms_condition_popup(page_link,title){
		...
		if (txt_booking_no==""){
			...
			page_link=page_link+get_submitted_data_string('txt_booking_no','../../','','<?=$cbo_buyer_name; ?>');
	...
	function generate_fabric_report(type,mail_send_data,mail_body){
		if ( form_validation('txt_booking_no','Booking No')==false ){
			...
			if(type=='print_booking_21')
			{
				var r=confirm("Press  \"OK\"  to Show Color Size Breakdown \nPress  \" Cancel\"  to Show Color Size Breakdown");
				if (r==true) show_yarn_rate="1"; else show_yarn_rate="0";
			}
		
			if(type!="print_booking_12" && type!=="print_booking_18" && type!=="print_booking_19" && type!=="print_booking_21")
			{
				...
				{
					var r=confirm("Press  \"Cancel\"  to hide  Buyer,Style Name and Fabric Rate\nPress  \"OK\"  to Show Buyer,Style Name and Fabric Rate");
			...
			var data="action="+type+get_submitted_data_string('txt_booking_no*cbo_company_name*txt_order_no_id*cbo_fabric_natu*cbo_fabric_source*id_approved_id*cbo_template_id',"../../")+'&report_title='+report_title+'&show_yarn_rate='+show_yarn_rate+'&mail_send_data='+mail_send_data+'&mail_body='+mail_body+'&path=../../';
			//alert(data);
			freeze_window(5);
			http.open("POST","requires/partial_fabric_booking_controller.php",true);
			http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
	...
	function call_print_button_for_mail(mail_address,mail_body,type){
		...
		else if(report_id[0]==425){generate_fabric_report('print_booking_21','1___'+mail_address,mail_body);}
    ...
    <div style="width:100%;" align="center">
            ...
            <legend>Fabric Booking </legend>
                <table  width="1000" cellspacing="2" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <td><input type="button" class="image_uploader" style="width:70px" value="ADD FILE" onClick="file_uploader ( '../../', document.getElementById('update_id').value,'', 'partial_fabric_booking', 2 ,1)"></td>
                        <td>
                        	<?
                            include("../../terms_condition/terms_condition.php");
                            terms_condition(108,'txt_booking_no','../../','', 'cbo_buyer_name');
                            ?>
						...
						<td>Fabric Start Date</td>
                        <td><input class="datepicker" type="text" style="width:130px" name="txt_fabric_start_date" id="txt_fabric_start_date" /></td>
                    </tr>
                    <tr>
        ...
        <form name="servicebookingknitting_2"  autocomplete="off" id="servicebookingknitting_2">
			...
			<div id="print_list">
				...
				<input type="button" value="Print B21" onClick="generate_fabric_report('print_booking_21')"  style="width:100px; display:none;" name="print_21" id="print_21" class="formbutton" />
			</div>
            </fieldset>
        </form>
