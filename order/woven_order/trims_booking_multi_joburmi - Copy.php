...
$cbo_material_source   = create_drop_down( "cbo_material_source", 150, $fabric_source,"", 1, "-- Select Source --", "2", "","","","","","1,4" );
$cbo_level             = create_drop_down( "cbo_level", 150, $level_arr,"", 0, "", 2, "","","" );
$cbo_ready_to_approved = create_drop_down( "cbo_ready_to_approved", 150, $yes_no,"", 1, "-- Select--", 2, "","","" );
        ...
        <fieldset style="width:950px;">
            ...
            <table  width="900" cellspacing="2" cellpadding="0" border="0">
                ...
                <tr>
                    ...
                    <td> <input type="button" class="image_uploader" style="width:150px" value="CLICK TO ADD FILE" onClick="file_uploader ( '../../', document.getElementById('txt_booking_no').value,'', 'multiple_job_wise_trims_booking_v2', 2 ,1)"> </td>
					<td align="right">&nbsp;</td>
                    <td>
                      <?
