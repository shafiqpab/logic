...
<script>
	...
	function calculate_yarn_consumption_ratio(i,precost_rate)
	{
		...
		if(rate>precost_rate && wo_basis==1 && txt_job != ""  && ( basis==1 || basis==5 || basis==0) && req_variable_setting ==1 ){
    ...
    function print_to_html_report(type)
	{
		...
		//alert(report_title);
		if(type == 1){
        	window.open("requires/yarn_work_order_controller.php?data=" + $('#cbo_company_name').val()+'*'+$('#update_id').val()+'*'+report_title+'*'+type+'*'+$('#ref_closed_sts').val()+'*'+$('#is_approved_id').val()+'&action='+"print_to_html_report", true );
        }else if(type == 4){
	...
	function openmypage_wo()
	{
		...
		var title = "Order Search";
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=1120px,height=390px,center=1,resize=0,scrolling=0','../')
		emailwindow.onclose=function()
		{
			freeze_window(5);
			var theform=this.contentDoc.forms[0];
			...
			<form name="yarnWorkOrder_1" id="yarnWorkOrder_1" method="" >
				<table cellpadding="0" cellspacing="2" width="900" align="center">
					<tr>
					  ...
					  <td align="right">WO Number</td><input type="hidden" name="is_approved_id" id="is_approved_id" value="">
					...
					<tr>
						<td align="right" width="100" class="must_entry_caption">Company</td>
						<td width="170">
                        	<?
                        ...
                        <td align="right" width="130" class="must_entry_caption">Item Category</td>
						<td width="170">
                        	<?
							   	echo create_drop_down( "cbo_item_category", 170, $item_category,"", 1, "-- Select --", 1, "",1 );
 							?>
                        </td>
						<td align="right" width="130" class="must_entry_caption">Supplier</td>
					...
					<tr>
						<td align="right" width="" class="must_entry_caption">WO Date</td>
						<td width="">
							<input type="text" name="txt_wo_date" id="txt_wo_date" value="<? echo date("d-m-Y")?>" class="datepicker" style="width:159px"/>
 						</td>
						<td align="right" width="" class="must_entry_caption">Currency</td>
						<td width="">
                         	<?
							   	echo create_drop_down( "cbo_currency", 170, $currency,"", 1, "-- Select --", 2, "",0 );
 							?>
                        </td>
                        <td align="right" width="" class="must_entry_caption">WO Basis</td>
						<td width="">
                        	<?
					...
					<tr>
                    	<td align="right" width="" >Buyer PO</td>
						...
						<td align="right" width="" class="must_entry_caption">Pay Mode</td>
						<td width=""><?
							   	echo create_drop_down( "cbo_pay_mode", 170, $pay_mode,"", 1, "-- Select --", 0, "",0 );
 							?></td>
						<td align="right" width="" class="must_entry_caption">Source</td>
						<td width=""><?
							   	echo create_drop_down( "cbo_source", 170, $source,"", 1, "-- Select --", 0, "",0 );
 							?></td>
					</tr>
					<tr>
                    	<td align="right" width="" >Requisition</td>
						...
						<td align="right" width=""><span class="must_entry_caption">Target Delivery Date</span></td>
						<td width=""><input type="text" name="txt_delivery_date"  id="txt_delivery_date" class="datepicker"  style="width:159px" /></td>
						<td align="right" width="">Attention</td>
						<td width=""><input type="text" name="txt_attention"  id="txt_attention" style="width:159px " class="text_boxes" /></td>
					</tr>
                    <tr>
						<td align="right" width="">Buyer Name</td>
                    	<td width="">
                        <!--<input type="text" name="txt_buyer_name"  id="txt_buyer_name" style="width:159px " class="text_boxes" disabled />-->
                            <?
                                echo create_drop_down( "txt_buyer_name", 170, "select id,buyer_name from lib_buyer where status_active =1 and is_deleted=0 order by buyer_name","id,buyer_name", 0, "-- All Buyer --", $selected, "",1,"" );
                            ?>
                        </td>
						<td align="right" width="">Style</td>
						<td width=""><!-- END -->
                    ...
                    <tr>
                        ...
                        <td align="right" class="must_entry_caption">Pay Term</td>
                ...
                <br/>
                <div style="width:1365px" id="details_container" align="left"></div>
