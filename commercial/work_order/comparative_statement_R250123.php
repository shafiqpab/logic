...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../../logout.php";  
    ...
    function fnc_comparative_statement(operation) 
    {
        if(operation==4){
            var form_caption=$( "div.form_caption" ).html();
	 	    print_report( $('#update_id').val()+'*'+form_caption, "comparative_statement_print", "requires/comparative_statement_controller" )
	 	    return;
        }
        ...
        for (var i=1; i<=row_num; i++)
		{
            ...
            for (var m=0; m<col_num; m++)
            {
                ...
                data_supplier += '&txtsuppier_' + i + '_' + mm + '=' + mm + '&txtquoted_' + i + '_' + mm + '=' + $('#txtquoted_'+i+'_'+mm).val() + '&txtneg_' + i + '_' + mm + '=' + $('#txtneg_'+i+'_'+mm).val()+ '&txtcon_' + i + '_' + mm + '=' + $('#txtcon_'+i+'_'+mm).val() + '&txtbrand_' + i + '_' + mm + '=' + $('#txtbrand_'+i+'_'+mm).val() + '&txtmodel_' + i + '_' + mm + '=' + $('#txtmodel_'+i+'_'+mm).val() + '&txtPayTerm_' + i + '_' + mm + '=' + $('#txtPayTerm_'+i+'_'+mm).val() + '&txtTenor_' + i + '_' + mm + '=' + $('#txtTenor_'+i+'_'+mm).val() + '&txtorigin_' + i + '_' + mm + '=' + $('#txtorigin_'+i+'_'+mm).val();
    ...
    function fn_report_generate(type)
    {
		...
		{	
		    ...
		    var form_caption=$( "div.form_caption" ).html();			
            print_report( $('#update_id').val()+'*'+form_caption+'*'+$('#txt_system_id').val()+'*'+zero_value, "print_report_generate", "requires/comparative_statement_controller" );
            show_msg( "3" );
		}
        else if (type==2)
        {
            var form_caption=$( "div.form_caption" ).html();			
            print_report( $('#update_id').val()+'*'+form_caption+'*'+$('#txt_system_id').val(), "print_report_estimated_price", "requires/comparative_statement_controller" );
            show_msg( "3" );
        }
    }
