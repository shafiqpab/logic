...
function openmypage_LcSc()
{
	...
	emailwindow.onclose=function()
	{
		...
		if(trim(lcSc_id)!="")
		{
			...
			get_php_form_data(lcSc_id+"**"+is_lcSc, "populate_data_from_lcSc", "requires/export_information_entry_controller" );//+"**"+invoice_id
			release_freezing();
		}
...
function openmypage_Invoice()
{
	...
	emailwindow.onclose=function()
	{
		...
		if(trim(invoice_id)!="")
		{
			...
			get_php_form_data(lcSc_id+"**"+is_lcSc+"**"+invoice_id, "populate_data_from_lcSc", "requires/export_information_entry_controller" );
			release_freezing();
		}
...
function fnc_export_information_entry_shipping_info(operation)
{
	...
	var data="action=save_update_delete_dtls&operation="+operation+get_submitted_data_string('update_id*bl_no*bl_date*bl_rev_date*doc_handover*forwarder_name*etd*feeder_vessel*mother_vessel*etd_destination*ic_recieved_date*inco_term*inco_term_place*shipping_bill_no*shipping_mode*total_carton_qnty*port_of_entry*port_of_loading*port_of_discharge*actual_shipment_date*ex_factory_date*freight_amnt_supplier*freight_amnt_buyer*txt_category_no*txt_hs_code*ship_bl_date*txt_advice_date*txt_advice_amnt*txt_paid_amnt*txt_gsp_co*txt_gsp_co_date*cbo_incentive',"../../");
	//alert(data);return;
	freeze_window(operation);
...
function calculate_value_rate(i)
{
	...
	var total_discount  = (discount*1)+(bonus*1)+(claim*1)+(commission*1);
	...
	<div style="width:100%;" align="center">																	
        ...
        <fieldset style="width:1220px; margin-bottom:10px;">
            ...
            <form name="exportInformationFrm_1" id="exportInformationFrm_1" autocomplete="off" method="POST"  >
                ...
                <br/>
                <table width="1320" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" id="tbl_order_list_top">
                    <thead>
                    	<tr>
                ...
                <div style="width:1320px; max-height:300px; overflow-y:scroll" id="scroll_body">
                    <table width="1302" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" id="tbl_order_list">                   
            ...
            <form name="exportInformationFrm_2" id="exportInformationFrm_2" autocomplete="off" method="POST"  >
                <table cellpadding="0" cellspacing="1" width="1100">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="etd_destination" id="etd_destination" class="datepicker" style="width:150px" />
                        </td>
                    </tr>			
                    <tr>
