                ...
                <table cellpadding="0" cellspacing="1" width="100%" id="exportlc_tbl">
                    ...
                    <tr><td height="5" colspan="6"></td></tr>
                  	<tr>
                        ...
                        <td>
                        	<?
							   	echo create_drop_down( "cbo_beneficiary_name", 162, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 and comp.core_business in(1,3) $company_cond order by comp.company_name","id,company_name", 1, "-- Select Beneficiary --", 0, "load_drop_down( 'requires/export_lc_controller', this.value, 'load_drop_down_buyer', 'buyer_td_id' );load_drop_down( 'requires/export_lc_controller', this.value, 'load_drop_down_applicant_name', 'applicant_name_td' );load_drop_down( 'requires/export_lc_controller', this.value, 'load_drop_down_notifying_party', 'notifying_party_td' );load_drop_down( 'requires/export_lc_controller', this.value, 'load_drop_down_consignee', 'consignee_td' );get_php_form_data( this.value, 'get_btb_limit', 'requires/export_lc_controller' );get_php_form_data( this.value, 'eval_multi_select', 'requires/export_lc_controller' );get_php_form_data( this.value, 'file_write_mathod', 'requires/export_lc_controller' );" );
							?>                          
                        </td>
