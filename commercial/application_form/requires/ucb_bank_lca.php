...
if($action=="btb_application_form")
{
    ...
    $is_lc_sc_sql=sql_select("SELECT lc_sc_id, is_lc_sc from com_btb_export_lc_attachment where import_mst_id=$btb_id and is_deleted=0 and status_active=1");
	...
	?>
   	...
   	<style>
        body{margin:0;padding:0; font-size: 90%;
            background: url("../application_form/form_image/image/ucb_lca.jpg") ;
            background-size:21.59cm 30.56cm;
            background-repeat: no-repeat;
        }
        #position1{position: absolute;margin-top: 30px;margin-left: 170px;}
        /* #position2{position: absolute;margin-top: 110px;margin-left: 570px;} */
        #position3{position: absolute;margin-top: 130px;margin-left: 300px;}
        #position4{position: absolute;margin-top: 145px;margin-left: 300px;}
        #position5{position: absolute;margin-top: 180px;margin-left: 180px;}
        #position6{position: absolute;margin-top: 180px;margin-left: 510px;}
        #position7{position: absolute;margin-top: 200px;margin-left: 200px;}
        #position8{position: absolute;margin-top: 350px;margin-left: 450px;}
        #position9{position: absolute;margin-top: 370px;margin-left: 300px;}
        #position10{position: absolute;margin-top: 390px;margin-left: 200px;}
        #position11{position: absolute;margin-top: 520px;margin-left: 100px; width:250px;}
        #position12{position: absolute;margin-top: 520px;margin-left: 400px;}    
    </style>
    ...
    <body>
        ...
        <div id="position6"><? echo $renewal_year; ?></div>
		...
		<div id="position10"><?=($show_item==1)? '('.number_to_words(number_format($data_array[0][csf('lc_value')],2), $mcurrency, $dcurrency).')':"" ;?> </div>
