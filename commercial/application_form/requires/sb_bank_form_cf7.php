...
if($action=="btb_application_form")
{
	...
	$address = sql_select("SELECT id,plot_no,level_no,road_no,block_no,country_id,city,zip_code,irc_no,bin_no,tin_number from lib_company where id = ".$data_array[0][csf('importer_id')]."");
	foreach($address as $row){
		...
		$company_add[$row[csf('id')]]['tin'] = $row[csf('tin_number')];
	}
	//print_r($company_add);
    ...
    <style>
        body{margin:0;padding:0; font-size: 90%;
            background: url("../application_form/form_image/image/sb_cf7.jpg");
            background-size:21.59cm 30.56cm;
            background-repeat: no-repeat;
        }
        #position1{position: absolute;margin-top: 60px;margin-left: 10px;}
        #position2{position: absolute;margin-top: 120px; margin-left: 190px;width:450px;}
        #position3a{position: absolute;margin-top: 160px;margin-left: 220px;}
        #position3{position: absolute;margin-top: 160px;margin-left: 360px;}
        #position4{position: absolute; margin-top: 180px;margin-left: 210px;}
        #position5{position: absolute; margin-top:160px;margin-left: 490px;}
        #position6{position: absolute;margin-top: 285px;margin-left: 300px;}
        #position7{position: absolute; margin-top: 285px;margin-left: 470px;}
        #position8{position: absolute;margin-top: 285px;margin-left: 640px;}
        #position9{position: absolute;margin-top: 318px;margin-left: 500px;}
        #position10{position: absolute; margin-top: 318px;margin-left: 680px;}
        #position11{position: absolute;margin-top: 325px;margin-left: 260px;}
        #position12{position: absolute;margin-top: 385px;margin-left: 280px;}
        #position13{position: absolute;margin-top: 440px;margin-left: 210px;width:220px;}
        #position14{position: absolute;margin-top: 440px; margin-left: 550px; }
        #position15{position: absolute;margin-top: 510px; margin-left: 210px;}
        #position16{position: absolute;margin-top: 550px;margin-left: 210px;}
        #position16a{position: absolute;margin-top: 570px;margin-left: 280px; }
        #position17{position: absolute;margin-top: 570px;margin-left: 650px;}
        #position18{position: absolute;margin-top: 590px;margin-left: 580px;}
        #position19{position: absolute;margin-top: 615px;margin-left: 300px;}
        #position20{position: absolute;margin-top: 615px;margin-left: 580px;}
        #position21{position: absolute;margin-top: 635px;margin-left: 350px;}
        #position22{position: absolute;margin-top: 730px;margin-left: 235px; }
        #position23{position: absolute;margin-top: 775px; margin-left: 330px;}
        #position24{position: absolute;margin-top: 775px;margin-left: 630px; }
        #position25{position: absolute;margin-top: 965px;margin-left: 190px; }
    ...
    <body>
        <div class="template clear">
			...
			<div id="position2">
				<? echo $company_name;?>,
				<? echo "<br>".$company_add[$data_array[0][csf("importer_id")]]['plot_no'].",".$company_add[$data_array[0][csf("importer_id")]]['level_no'].", ".$company_add[$data_array[0][csf("importer_id")]]['road_no'].", ".$company_add[$data_array[0][csf("importer_id")]]['city'].", ".$country_array[$company_add[$data_array[0][csf("importer_id")]]['country_id']]; ?>
			</div>
			<div id="position3a">
				<? echo $company_add[$data_array[0][csf("importer_id")]]['tin'];?>
			</div>
			<div id="position3">
			...
			<div id="position4">
				<? echo $supplier_name;?>,
				<? echo "<br>".$supplier_add;?>
			</div>
			<div id="position5">
				<? echo $company_add[$data_array[0][csf("importer_id")]]['bin_no'];?>
			</div>
			<div id="position6">
			...
			<div id="position10">
				<? echo $data_array[0][csf("tolerance")];?>
			</div>
			<div id="position11">
			...
			<div id="position12">
				<?
					if($data_array[0][csf("payterm_id")]==2){echo $data_array[0][csf("tenor")];}
				?>
			</div>
			<div id="position13">
			...
			<div id="position15">
				<? echo $pi_category;?>
				For 100% Export Oriented <? echo $business_nature; ?> Readymade Garments 
			</div>
			<div id="position16">
				<? echo $pi_number.' '.$pi_date;?>
			</div>
			<div id="position16a">
				<? echo $hs_code;?>
			</div>
			...
			<div id="position18">
				<? echo $data_array[0][csf("lcaf_no")];?>
			</div>
			<div id="position19">
				<? echo $data_array[0][csf("cover_note_no")];?>
			</div>
			<div id="position20">
				<? echo $cover_note_date;?>
			</div>
			<div id="position21">
				<? echo $data_array[0][csf("insurance_company_name")];?>
			</div>
			<div id="position22">
				<? echo $data_array[0][csf("doc_presentation_days")];?>
			</div>
			<div id="position23">
				<? echo $lc_sc_no;?>
			</div>
