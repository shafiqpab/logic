...
if($action=="btb_application_form")
{
	 ...
	 $sql = "SELECT	importer_id,issuing_bank_id,lc_value,lc_date,currency_id,tenor,supplier_id,item_category_id,pi_id,port_of_loading,port_of_discharge,delivery_mode_id,last_shipment_date,lc_expiry_date,lc_type_id,inco_term_place,doc_presentation_days,origin,inco_term_id,insurance_company_name,cover_note_no,cover_note_date,payterm_id,tolerance,lca_no,lc_number,lc_date,btb_system_id,pi_id,partial_shipment,transhipment from com_btb_lc_master_details where id='$data'";
	 // echo $sql;
...
//--------------lib
    ...
    <style>
        body {
            ...
            padding: 0;
            font-size: 90%;
			background: url("../application_form/form_image/image/ebl_lca.jpg");
...
<body>
    ...
    <div id="position10">
	<? echo $item_category[$data_array[0][csf("item_category_id")]]." FOR 100% ORIENTED READYMADE ".$business_nature."Industry";?> 
    </div>
    <div id="position11">
