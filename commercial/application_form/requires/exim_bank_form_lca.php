...
if($action=="btb_application_form")
{
	...
	<style>
		body{
			...
			padding:0;  
			font-size:90%;
			background: url("../application_form/form_image/image/exim_lca.jpg");
			background-size:21.59cm 30.56cm;
			background-repeat: no-repeat;
		}

		#position1{position: absolute;margin-top: 50px;margin-left: 350px;}
		#position2{position: absolute;margin-top: 110px;margin-left: 640px;}
		#position3{position: absolute;margin-top: 148px;margin-left: 300px;}
		#position4{position: absolute;margin-top: 210px;margin-left: 180px;}
		#position5{position: absolute;margin-top: 210px;margin-left: 500px;}
		#position6{position: absolute;margin-top: 230px;margin-left: 200px;}
		#position7{position: absolute;margin-top: 360px;margin-left: 400px;}
		#position8{position: absolute;margin-top: 378px;margin-left: 300px;}
		#position9{position: absolute;margin-top: 388px;margin-left: 210px;}
		#position10{position: absolute;margin-top: 540px;margin-left: 140px;}
		#position11{position: absolute;margin-top: 540px;margin-left: 500px;}
	...
	<body>
		...
		<div id="position3">
			<? echo $company_name."<br>".$company_add[$data_array[0][csf("importer_id")]]['city'];?>
		</div>
		<div id="position4">
		<?= $irc_no;?>
		</div>
		...
		<div id="position6">
		<!-- For Sector of Industry-->  100% Export Oriented Knit Readymade <? echo $business_nature;?>  Industry
		</div>
		<div id="position7">
		<!-- For LC Type -->
		<?
			$lc_type = $data_array[0][csf("lc_type_id")];
			if($lc_type==1){echo "BTB LC";}
			elseif($lc_type==2){echo "Margin LC";}
			elseif($lc_type==3){echo "Fund Building";}
			elseif($lc_type==4){echo "TT";}
			elseif($lc_type==5){echo "FTT";}
			elseif($lc_type==6){echo "FDD";}
		?>
		</div>
		<div id="position8">
			<?
			...
			?>
			<b> US <? echo $currency_sign.' '.number_format($data_array[0][csf('lc_value')],2);?></b>
		</div>
		<div id="position9">
			<b><? echo number_to_words(number_format($data_array[0][csf('lc_value')],2), $mcurrency, $dcurrency);?></b>
		</div>
		<div id="position10"><? echo $item_category[$data_array[0][csf("item_category_id")]];?></div>
		<div id="position11">H.S CODE: <? echo $hs_code;?></div>
