...
if($action=="btb_application_form")
{
    ...
    <style>
        body{margin:0;padding:0; font-size: 90%;
            background: url("../application_form/form_image/image/premier_cf7.jpg");
    ...
    <body>
        <div class="template clear">
			...
			<div id="position1">
				<? echo $company_name;?>,
				<? echo "<br>".$company_add[$data_array[0][csf("importer_id")]]['plot_no'].",".$company_add[$data_array[0][csf("importer_id")]]['level_no'].", ".$company_add[$data_array[0][csf("importer_id")]]['road_no'].",<br/> ".$company_add[$data_array[0][csf("importer_id")]]['city'].", ".$country_array[$company_add[$data_array[0][csf("importer_id")]]['country_id']]; ?>
			</div>
			<div id="position2">
				<? echo $supplier_name;?>,
			...
			<div id="position4">
				<? echo $data_array[0][csf("inco_term_place")];?>
			</div>
			<div id="position5">
				<? echo $lc_expiry_date;?>
			</div>
			...
			<div id="position11">
				<? echo $company_add[$data_array[0][csf("importer_id")]]['bang_bank_reg_no'];?>
			</div>
			<div id="position12">
