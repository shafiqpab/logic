...
if($action=="btb_application_form")
{
	...
	?>
   	...
   	<style>
        body{margin:0;padding:0; font-size: 90%;
            background: url("../application_form/form_image/image/dbbl_lca.jpg") ;
            background-size:21.59cm 30.56cm;
            background-repeat: no-repeat;
        }
        #position1{position: absolute;margin-top: 18px;margin-left: 270px;}
        #position2{position: absolute;margin-top: 110px;margin-left: 570px;}
        #position3{position: absolute;margin-top: 150px;margin-left: 310px;}
        #position4{position: absolute;margin-top: 165px;margin-left: 150px;}
        #position5{position: absolute;margin-top: 190px;margin-left: 200px;}
        #position6{position: absolute;margin-top: 190px;margin-left: 510px;}
        #position7{position: absolute;margin-top: 210px;margin-left: 200px;}
        #position8{position: absolute;margin-top: 355px;margin-left: 450px;}
        #position9{position: absolute;margin-top: 375px;margin-left: 300px;}
        #position10{position: absolute;margin-top: 525px;margin-left: 20px; width:250px;}
        #position11{position: absolute;margin-top: 525px;margin-left: 280px;}    
    </style>
    ...
    <body>
		...
		<div id="position9"><? echo $currency_sign.' '.number_format($data_array[0][csf('lc_value')],2).' ('. number_to_words(number_format($data_array[0][csf('lc_value')],2), $mcurrency, $dcurrency).')';?> </div>
        <div id="position10"><? echo $pi_category;?> For 100% Export Oriented Knit Readymade <? echo  chop($business_nature_info,',');?> Industry</div>
        <div id="position11"> <? echo "H.S CODE : ". $hs_code;?> </div>
		<??>
    </body>
    <?
	exit();
