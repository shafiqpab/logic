<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create for MUTUAL TRUST BANK LIMITED LCA Form
Functionality	:
JS Functions	:
Created by		:	Nayem
Creation date 	: 	13-9-2022
Updated by 		: 	
Update date		: 	
QC Performed BY	:
QC Date			:
...
if($action=="btb_application_form")
{
	...
	<style>
		body{
			...
			padding:0;  
			font-size:90%;
			background: url("../application_form/form_image/image/mtbl_lca.jpg");
			background-size:21.59cm 30.56cm;
			background-repeat: no-repeat;
		}
		#position1{ position: absolute; margin-top: 40px; margin-left: 340px; }
		#position2{ position: absolute; margin-top: 105px; margin-left: 210px; }
		#position3{ position: absolute; margin-top: 105px; margin-left: 460px; }
		#position4{ position: absolute; margin-top: 140px; margin-left: 310px; }
		#position5{ position: absolute; margin-top: 162px; margin-left: 170px; }
		#position6{ position: absolute; margin-top: 165px; margin-left: 500px; }
		#position7{ position: absolute; margin-top: 190px; margin-left: 180px; }
		#position8{ position: absolute; margin-top: 330px; margin-left: 400px; }
		#position9{ position: absolute; margin-top: 350px; margin-left: 400px; }
		#position10{ position: absolute; margin-top: 365px; margin-left: 200px; }
		#position11{ position: absolute; margin-top: 530px; margin-left: 40px; width:300px; }
		#position12{ position: absolute; margin-top: 530px; margin-left: 400px; }
    </style>
	...
	<body>
		...
		<!-- <div id="position7">
			100% Export Oriented Readymade <? echo chop($item_description,', ');//$business_nature;?>  Industry
		</div> -->
		<div id="position8">
			<!-- For LC Type -->
			<?
		...
		<div id="position11">
			<? echo $pi_category;?> 100% Export Oriented Readymade <? echo chop($item_description,', ');//$business_nature;?>  Industry as per <br> PI NO: <?=$pi_numbers;?><br> PI DT: <?=$pi_date;?>
		</div>
		<div id="position12">
			H.S CODE: <br><? echo chop($hs_code,', ');?>
		</div>
		<?*/?>
	</body>
    <?
