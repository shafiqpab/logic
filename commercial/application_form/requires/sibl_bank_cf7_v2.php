...
?>
    ...
    <style>
        ...
        *{font-weight: bold;}
        #position1{position: absolute;margin-top: 78px;margin-left: 270px;}
        #position2{position: absolute;margin-top: 290px;margin-left: 70px;}
        #position3{position: absolute;margin-top: 260px;margin-left: 330px; width:360px;}
        #position4{position: absolute;margin-top: 340px;margin-left: 70px;}
        #position5{position: absolute;margin-top: 320px;margin-left: 330px; width:360px;}
        #position6{position: absolute;margin-top: 370px;margin-left: 150px;}
        /* #position7{position: absolute;margin-top: 380px;margin-left: 150px;} */
        #position8{position: absolute;margin-top: 440px;margin-left: 70px; width:450px;}
        #position9{position: absolute;margin-top: 455px;margin-left: 70px; width:450px;}
        #position10{position: absolute;margin-top: 465px;margin-left: 530px;}
        ...
        #position18{position: absolute;margin-top: 855px;margin-left: 80px;}  
        #position19{position: absolute;margin-top: 855px;margin-left: 280px;}  
        /* #position20{position: absolute;margin-top: 860px;margin-left: 550px;}   */
    ...
    <body>
        ...
        <div id="position8"><? echo "Item: " . $pi_category;?> For 100% Export Oriented <? echo  chop($business_nature_info,',');?> Ready made Garments Industry</div>
        ...
        <!-- <div id="position12"><? echo $bang_bank_reg_no; ?></div> -->
        <div id="position13"><? echo $data_array[0][csf("port_of_loading")]; ?></div>
        <div id="position14"><? echo $data_array[0][csf("port_of_discharge")]; ?></div>
        <!-- <div id="position15"><? echo $data_array[0][csf("cover_note_no")]; ?></div>
        <div id="position16"><? echo $data_array[0][csf("cover_note_date")]; ?></div>
        ...
        <!-- <div id="position20"><? echo $data_array[0][csf("doc_presentation_days")]; ?></div> -->
        <!-- <div id="position21">
            Export Contract No.  <? echo implode(', ', $export_lc_sc_no_arr); ?> </br>IRC # <?= $company_add[$data_array[0][csf("importer_id")]]['irc_no']; ?>, H.S. CODE: <?= $hs_code; ?>, BIN # <?= $company_add[$data_array[0][csf("importer_id")]]['bin_no']; ?>, TIN # <?= $company_add[$data_array[0][csf("importer_id")]]['tin_number']; ?>
        </div> -->
        <div id="position22">* PI NO- <? echo $pi_numbers; ?><br>* Export L/C No.  <? echo implode(', ', $export_lc_sc_no_arr); ?></div>
    </body>
<?
    exit();
}
