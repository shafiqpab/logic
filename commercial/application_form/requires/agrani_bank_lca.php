...
if($action=="btb_application_form")
{
   ...
   <style>
        body{margin:0;padding:0; font-size: 90%;
            background: url("../application_form/form_image/image/agrani_lca.jpg") ;
            background-size:21.59cm 30.56cm;
            background-repeat: no-repeat;
        }
        #position1{position: absolute;margin-top: 70px;margin-left: 420px;}
        #position2{position: absolute;margin-top: 125px;margin-left: 520px;}
        #position3{position: absolute;margin-top: 170px;margin-left: 320px;}
        #position4{position: absolute;margin-top: 218px;margin-left: 180px;}
        #position5{position: absolute;margin-top: 218px;margin-left: 500px;}
        #position6{position: absolute;margin-top: 240px;margin-left: 210px;}
        #position7{position: absolute;margin-top: 415px;margin-left: 450px;}
        #position8{position: absolute;margin-top: 440px;margin-left: 340px;}
        #position9{position: absolute;margin-top: 465px;margin-left: 270px;}
        #position10{position: absolute;margin-top: 580px;margin-left: 90px;}
        #position11{position: absolute;margin-top: 580px;margin-left: 410px;}        
    </style>
    ...
    <body>
        ...
        <div id="position3">
            <? echo $company_name;?>
            <? echo "<br>".$company_add[$data_array[0][csf("importer_id")]]['city'];?>
        </div>
        <div id="position4"> <? echo $irc_no;?></div>
        <div id="position5"><? echo $irc_year; ?></div>
        <div id="position6">100% Export Oriented Knit Readymade <? echo chop($business_nature_info,',');?> Industry</div>
        <div id="position7">
            <?
        ...
        For 100% Export Oriented Knit Readymade <? echo  chop($business_nature_info,',');?> Industry
        </div>
        <div id="position11">
