<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Report Will Create export statement summery Report fro bpkw.
Functionality	:	
JS Functions	:
Created by		:	Jahid
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Export Statement Management Report", "../../", 1, 1,'','','');
?>	
...
<script>
	...
	function generate_report()
	{
		...
		var data="action=report_generate"+get_submitted_data_string("cbo_company_name*cbo_lein_bank","../../")+'&report_title='+report_title;
		//alert(data);return;
		freeze_window(3);
		http.open("POST","requires/export_statement_management_report_controller.php",true);
	...
	function openmypage_source()
	{
		...
		var page_link='requires/export_statement_management_report_controller.php?action=source_surch&company_id='+company_id+'&import_source='+import_source+'&txt_lc_category='+txt_lc_category+'&txt_serial_no='+txt_serial_no;  
	...
	function openmypage(btb_id,year_val,month_val,type,title)
	{
		...
		page_link='requires/export_statement_management_report_controller.php?action='+action+'&btb_id='+btb_id+'&year_val='+year_val+'&month_val='+month_val+'&type='+type;
	...
	{
		page_link='requires/export_statement_management_report_controller.php?action=btb_paid_details'+'&inv_id='+inv_id+'&year_val='+year_val+'&month_val='+month_val+'&type='+type;
	...
	{
		page_link='requires/export_statement_management_report_controller.php?action=btb_open_details'+'&btb_id='+btb_id+'&year_val='+year_val+'&month_val='+month_val+'&type='+type;
...
<body onLoad="set_hotkey();">
 <div style="width:100%" align="center">
    <form id="file_wise_explort_import_status" action="" autocomplete="off" method="post">
        ...
        <div id="content_search_panel" style="width:700px;"> 

    	<fieldset style="width:100%" >
        <table class="rpt_table" cellspacing="0" cellpadding="0" border="1" rules="all" align="center" width="700">
            <thead>
