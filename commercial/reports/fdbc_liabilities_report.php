...
function generate_report()
	{
		...
		var data="action=report_generate"+get_submitted_data_string("cbo_company_name*cbo_buyer_name*cbo_lien_bank*cbo_search_by*txt_exchange_rate","../../")+'&report_title='+report_title;
		freeze_window(3);
...
<div style="width:1100px;" align="center">
    ...
    <fieldset style="width:900px;">
        <table class="rpt_table" cellspacing="0" cellpadding="0" width="900">
            <thead>
            ...
            <tbody>
                <tr >
                    ...
                    <td>
                    <?
                    echo create_drop_down( "cbo_lien_bank", 150, "select bank_name,id from lib_bank where is_deleted=0 and status_active=1 and lien_bank=1 order by bank_name","id,bank_name", 1, "-- All Lien Bank --", 0, "" );
                    ?>
                    </td>
                    <td>	
                    <?
