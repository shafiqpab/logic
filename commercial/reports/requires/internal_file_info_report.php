...
<? if($report_type == 1) : ?>
    ...
    <div id="report_container">
        <div align="center" style="height:30px; width:1900px; font-size:18px; border:hidden" class="form_caption">Cost Sheet Analysis Knit</div>
        <div style="width:1900px">
            <table width="1895" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" style="font-size:12px">
                <thead style="width:100%;" class="table_header" >
                    ...
                    <tr height="100">
                        ...
                        <th colspan="33" width="1030" height="100">
                            <table width="100%" height="100" border="0" cellpadding="0" cellspacing="0" rules="all">
                                <tr>
                                    <th colspan="4" width="122" align="center" style="height: 50px;">Yarn</th>
                                    <th colspan="2" width="62" align="center" style="height: 50px;">Access.</th>
                                    ...
                                    <th colspan="2" width="62" align="center" style="height: 50px;">Insp.</th>
                ...
                <tbody class="table_body" id="scroll_body" width="1883">
                <? 
                    ...
                    //echo "<pre>";print_r($fabricQntyArrayClass);die;
                    ...
                    foreach ($nameArray as $selectResult)
                    {
                        ...
                        {
                            $query="select d.company_name, d.style_ref_no, d.agent_name, d.order_uom, c.id as po_id, c.po_number, c.pub_shipment_date as shipment_date, c.job_no_mst, c.po_quantity,(d.total_set_qnty*c.po_quantity) as po_qnty_in_pcs, c.unit_price, b.attached_qnty, b.attached_rate, b.attached_value, d.total_set_qnty from com_export_lc_order_info b, wo_po_break_down c, wo_po_details_master d where b.com_export_lc_id='".$selectResult[csf('id')]."' and b.wo_po_break_down_id=c.id and c.job_no_mst=d.job_no and b.status_active=1 and b.is_deleted=0 order by d.company_name";
                        }
                        else
                        {
                            $query="select d.company_name, d.style_ref_no, d.agent_name, d.order_uom, c.id as po_id, c.po_number, c.pub_shipment_date as shipment_date, c.job_no_mst, c.po_quantity,(d.total_set_qnty*c.po_quantity) as po_qnty_in_pcs, c.unit_price, b.attached_qnty, b.attached_rate, b.attached_value, d.total_set_qnty from com_sales_contract_order_info b, wo_po_break_down c, wo_po_details_master d where b.com_sales_contract_id='".$selectResult[csf('id')]."' and b.wo_po_break_down_id=c.id and c.job_no_mst=d.job_no and b.status_active=1 and b.is_deleted=0 order by d.company_name";
                        }
                        ...
                        foreach ($result as $row)
                        {
                            ...
                            $yarn_avg_qnty=$yarnQntyArray[$row[csf('po_id')]];
                            $yarn_cost=$yarncostArray[$row[csf('po_id')]];
                            $yarn_cost_perc=($yarn_cost/$order_val)*100;
                                ...
                                else
                                {
                                    ...
                                    if($cons_process==35 || $cons_process==36 || $cons_process==37 || $cons_process==40)
                                    {
                                        if($cost_details[$row[csf('company_name')]][35]==1)
                                        {
                                            ...
                                            $aop_cost+=($order_quantity/$dzn_qnty)*$amnt;
                                        }
                                    }
                                    else
                                    {
                            ...
                            ?>
                                <tr height="90" bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_l<? echo $c; ?>','<? echo $bgcolor; ?>')" id="tr_l<? echo $c; ?>">
                                    ...
                                    <td width="30" valign="bottom" align="center">
                                        <div class="r90">
                                            <? 
                                                ...
                                                echo fn_number_format($yarn_avg_qnty,2,'.',''); $tot_yarn_qnty+=$yarn_avg_qnty;
                                    ...
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($yarn_cost,2,'.',''); $tot_yarn_cost+=$yarn_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($yarn_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center" title="<? echo $trims_cost_total; ?>"><div class="r90"><? echo "<a href='#report_details' style='text-decoration:none' onclick= \"openmypage_trims('$job_no','$po_id','$po_no','$order_quantity','trims_info','Trims Info');\">".fn_number_format($trims_cost,2,'.','')."</a>"; $tot_trims_cost+=$trims_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($trims_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knitt_cost,2,'.',''); $tot_knitt_cost+=$knitt_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knitt_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($dye_cost,2,'.',''); $tot_dye_cost+=$dye_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($dye_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($finish_cost,2,'.',''); $tot_finish_cost+=$finish_cost;?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($finish_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($print_embro_cost,2,'.',''); $tot_print_embro_cost+=$print_embro_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($print_embro_cost_percent,2,'.',''); ?></div></td>
                                    
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($aop_cost,2,'.',''); $tot_aop_cost+=$aop_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($aop_cost_percent,2,'.',''); ?></div></td>
                                    
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($wash_cost,2,'.',''); $tot_wash_cost+=$wash_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($wash_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($test_cost,2,'.',''); $tot_test_cost+=$test_cost; ?></div></td>
                                    <td  width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($test_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($inspection_cost,2,'.',''); $tot_inspection_cost+=$inspection_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($inspection_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knit_purc_qnty,2,'.','');$tot_knit_purc_qnty+=$knit_purc_qnty; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? $knit_purc_rate=$knit_purc_cost/$knit_purc_qnty; echo fn_number_format($knit_purc_rate,2,'.','');?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knit_purc_cost,2,'.','');$tot_knit_purc_cost+=$knit_purc_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knit_purc_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($woven_purc_qnty,2,'.',''); $tot_woven_purc_qnty+=$woven_purc_qnty; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? $woven_purc_rate+=$woven_purc_cost/$woven_purc_qnty; echo fn_number_format($woven_purc_rate,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($woven_purc_cost,2,'.',''); $tot_woven_purc_cost+=$woven_purc_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($woven_purc_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($cm_cost,2,'.',''); $tot_cm_cost+=$cm_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($cm_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($cm_per_dzn,2,'.',''); ?></div></td>
                                </tr>
                            <?
                            }
                            else
                            ...
                            ?>
                                <tr height="90" bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_l<? echo $c; ?>','<? echo $bgcolor; ?>')" id="tr_l<? echo $c;?>">
                                    ...
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($yarn_cost,2,'.',''); $tot_yarn_cost+=$yarn_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($yarn_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo "<a href='#report_details' style='text-decoration:none' onclick= \"openmypage_trims('$job_no','$po_id','$po_no','$order_quantity','trims_info','Trims Info');\">".fn_number_format($trims_cost,2,'.','')."</a>"; $tot_trims_cost+=$trims_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($trims_cost_perc,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knitt_cost,2,'.',''); $tot_knitt_cost+=$knitt_cost; ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($knitt_cost_percent,2,'.',''); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($dye_cost,2,'.',''); $tot_dye_cost+=$dye_cost; ?></div></td>
                        ...
                        if($tot_rows>0)
                        {
                            ...
                            <tr bgcolor="#CCCCCC" height="90">
                                ...
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_commercial_cost,2,'.',''); $gr_tot_commercial_cost+=$tot_commercial_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_freight_cost,2,'.',''); $gr_tot_freight_cost+=$tot_freight_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_commission_cost,2,'.',''); $gr_tot_commission_cost+=$tot_commission_cost; ?></div></td>
                                ...
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_yarn_cost,2,'.',''); $gr_tot_yarn_cost+=$tot_yarn_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_yarn_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_trims_cost,2,'.',''); $gr_tot_trims_cost+=$tot_trims_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_trims_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_knitt_cost,2,'.',''); $gr_tot_knitt_cost+=$tot_knitt_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_knitt_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_dye_cost,2,'.',''); $gr_tot_dye_cost+=$tot_dye_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_dye_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_finish_cost,2,'.','');$gr_tot_finish_cost+=$tot_finish_cost;?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_finish_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_print_embro_cost,2,'.',''); $gr_tot_print_embro_cost+=$tot_print_embro_cost;?></div></td>
                                ...
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_wash_cost,2,'.',''); $gr_tot_wash_cost+=$tot_wash_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_wash_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_test_cost,2,'.',''); $gr_tot_test_cost+=$tot_test_cost; ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format(($tot_test_cost/$tot_order_val)*100,2,'.',''); ?></div></td>
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_inspection_cost,2,'.',''); $gr_tot_inspection_cost+=$tot_inspection_cost; ?></div></td>
                                ...
                                <td valign="bottom" align="center"><div class="r90"><? echo fn_number_format($tot_knit_purc_cost,2,'.',''); $gr_tot_knit_purc_cost+=$tot_knit_purc_cost; ?></div></td>
                    ...
                    <tr bgcolor="#E9F3FF" height="90">
                        ...
                        <td valign="bottom" align="center"><b><div class="r90"><? echo fn_number_format($gr_tot_yarn_cost,2,'.',''); ?></div></b></td>
            ...
            <table width="1480">
                ...
                <tr>
                    <td width="610" valign="top">
                        ...
                        <table width="100%" class="rpt_table" cellpadding="0" cellspacing="0" rules="all" border="1"> 
                            ...
                            <tr bgcolor="#E9F3FF">
                                ...
                                <td align="right"><b><? echo fn_number_format($tot_cost_heads,2); ?></b></td>
                            ...
                            <tr bgcolor="#FFFFFF">
                                ...
                                <td align="right"><b><? echo fn_number_format($gr_tot_cm_cost,2); ?></b></td>
                    ...
                    <td valign="bottom" width="400" style="font-size:14px; padding-left:30px" align="left">
                        ...
                        <b>Average Unit Price (Pcs):&nbsp;&nbsp;<? echo fn_number_format($gr_tot_order_val/$gr_tot_order_qnty,2); ?></b><br />
                        <b>Average CM Per Dzn:&nbsp;&nbsp;<? echo fn_number_format(($gr_tot_cm_cost/$gr_tot_order_qnty)*12,2); ?></b>
                    </td>
                    <td width="470" valign="top">
                        ...
                        <table class="rpt_table" cellpadding="0" cellspacing="0" rules="all" border="1"> 
                            ...
                            <tr bgcolor="#FFFFFF">
                                <td>Knit Fabric Purchase</td>
                                <td align="right"><? echo fn_number_format($cost_heads_knit_purchase,2); $tot_charge+=$cost_heads_knit_purchase; ?></td>
...
<? else: ?>
    <fieldset style="width:100%; border:hidden">
    <div id="report_container">
        <div align="center" style="height:30px; width:1625px; font-size:18px; border:hidden" class="form_caption">Cost Sheet Analysis Woven</div>
        <div style="width:1625px">
            <table width="1620" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" style="font-size:12px">
                <thead style="width:100%;" class="table_header" >
                    <tr bgcolor="#CCCCCC" height="30">
                        <td colspan="57" style="font-size:16px; border:none" width="100%"><b>File No: <?=$file_no; ?>, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Buyer name: <?=$buyer_details[$file_info[1]]; ?>, &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Applicant name: <?=$buyer_details[$file_info[2]]; ?></b><span id="agent_name"></span>
                        </td>
                    </tr>
                    <tr height="100">
                        <th width="20" valign="middle">SL</th>
                ...
                <? 
                    ...
                    if($all_order_id!="")
                    {
                        ...
                        foreach($job_sql as $row)
                        {
                            if($job_check[$row[csf("job_id")]]=="")
                            {
                                $job_check[$row[csf("job_id")]]=$row[csf("job_id")];
                                $all_job.="'".$row[csf("job_no_mst")]."',";
                                $all_job_id.=$row[csf("job_id")].',';
                            }
                        }
                    ...
                    foreach ($nameArray as $selectResult)
                    {
                        ...
                        foreach ($result as $row)
                        {
                            ...
                            $unit_price=$row[csf('unit_price')];
                            //$order_quantity=$row[csf('attached_qnty')]; 
                            $order_quantity=$row[csf('po_quantity')];

                            // $order_val=$row[csf('attached_qnty')]*$unit_price;
                            $order_val=$row[csf('po_quantity')]*$unit_price;
                            ...
                            {
                            ?>
                                <tr height="90" bgcolor="<?=$bgcolor; ?>" onClick="change_color('tr_l<?=$c; ?>','<?=$bgcolor; ?>')" id="tr_l<?=$c; ?>">
                                    <td rowspan="<?=$tot_rows; ?>" width="20"><?=$i; ?></td>	
                                    <td rowspan="<?=$tot_rows; ?>" width="100" align="center">
                                        <p>
                                            <?
                                                if($selectResult[csf('type')]==1)
                                                {
                                    ...
                                    <td width="70" style="word-break:break-all"><?=$row[csf('style_ref_no')]; ?></td>
                                    <td width="50" style="word-break:break-all"><?=$company_short_details[$row[csf('company_name')]]; ?></td>
                                    <td width="60" style="word-break:break-all"><?=$row[csf('po_number')]; ?></td>
                                    <td width="70" style="word-break:break-all"><? $fabric_desc=explode(",",$fabric_desc); echo implode(",<br>",$fabric_desc); ?></td>
                                    <td width="30" valign="bottom" align="center">
                                        <div class="r90">
                                            <? 
                                                echo fn_number_format($row[csf('po_qnty_in_pcs')],0,'.',''); 
                            ...
                            ?>
                                <tr height="90" bgcolor="<?=$bgcolor; ?>" onClick="change_color('tr_l<?=$c; ?>','<?=$bgcolor; ?>')" id="tr_l<?=$c;?>">
                                    ...
                                    <td width="30" valign="bottom" align="center"><div class="r90"><?=change_date_format($row[csf('shipment_date')]); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo change_date_format($exfactory_arr[$row[csf("po_id")]]['exfactdate']); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($exfactory_arr[$row[csf("po_id")]]['exfactqty']); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo fn_number_format($exfactory_arr[$row[csf("po_id")]]['exfactqty']*$unit_price,2); ?></div></td>
                                    <td width="30" valign="bottom" align="center"><div class="r90"><? echo "<a href='#report_details' style='text-decoration:none' onclick= \"openmypage_trims('$job_no','$po_id','$po_no','$order_quantity','trims_info','Trims Info');\">".fn_number_format($trims_cost,2,'.','')."</a>"; $tot_trims_cost+=$trims_cost; ?></div></td>
                    ...
                    <td width="470" valign="top">
                        ...
                        <table class="rpt_table" cellpadding="0" cellspacing="0" rules="all" border="1"> 
                            ...
                            <tr bgcolor="#E9F3FF">
                                <td>Accessories</td>
                                <td align="right"><? echo fn_number_format($gr_tot_trims_cost,2); $tot_charge+=$gr_tot_trims_cost; ?></td>
                                <td align="right" title="<?=$gr_tot_trims_cost.'/'.$gr_tot_net_cs_val; ?>"><? echo fn_number_format(($gr_tot_trims_cost/$gr_tot_net_cs_val)*100,4); $tot_charge_perc+=($gr_tot_trims_cost/$gr_tot_net_cs_val)*100; ?></td>
                            </tr>
                            <tr bgcolor="#FFFFFF">
                                <td>Printing & Embroidery</td>
                                <td align="right"><? echo fn_number_format($print_embro_charge,2); $tot_charge+=$print_embro_charge; ?></td>
	...
	<? endif; ?>
    <script> show_agent('<? echo "<b>,&nbsp;&nbsp;&nbsp;Agent Name: ".$agent_name."</b>"; ?>'); </script>
    <?
    exit();
}
