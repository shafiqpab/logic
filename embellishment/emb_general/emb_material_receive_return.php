...
function open_mrrpopup()
{
	...
	var page_link='requires/emb_material_receive_return_controller.php?action=mrr_popup&company='+company; 
	...
	emailwindow.onclose=function()
	{
		...
		get_php_form_data(mrrNumber, "populate_data_from_data", "requires/emb_material_receive_return_controller");  		
...
function fnc_general_receive_return_entry(operation)
{
	if(operation==4)
	{
		...
		print_report( $('#cbo_company_id').val()+'*'+$('#txt_mrr_retrun_id').val()+'*'+report_title, "general_item_receive_return_print", "requires/emb_material_receive_return_controller" ) 
		return;
	}
	...
	//alert(data); //return;
	http.open("POST","requires/emb_material_receive_return_controller.php",true);
...
{	
	...
	{	  		
		...
		if(reponse[0]==0)
		{
			...
			show_list_view(reponse[1]+'**'+reponse[2],'show_dtls_list_view','list_container_general','requires/emb_material_receive_return_controller','');
			$("#tbl_child").find('input,select').val('');
			set_button_status(0, permission, 'fnc_general_receive_return_entry',1,1);
			release_freezing();
		}
...
function open_returnpopup()
{
	...
	var company = $("#cbo_company_id").val();	
	var page_link='requires/emb_material_receive_return_controller.php?action=return_number_popup&company='+company; 
	...
	emailwindow.onclose=function()
	{
		...
		get_php_form_data(returnNumber[1], "populate_master_from_data", "requires/emb_material_receive_return_controller");  		
		show_list_view(returnNumber[0]+"**"+returnNumber[1],'show_dtls_list_view','list_container_general','requires/emb_material_receive_return_controller','');
		set_button_status(0, permission, 'fnc_general_receive_return_entry',1,1);
		$("#tbl_child").find('input,select').val('');
...
function popup_serial()
{
	...
	var page_link="requires/emb_material_receive_return_controller.php?action=serial_popup&serialStringNo="+serialStringNo+"&serialStringID="+serialStringID+"&current_prod_id="+current_prod_id+"&txt_received_id="+txt_received_id; 
    ...
    <table width="880" cellpadding="0" cellspacing="2" align="left">
     	<tr>
        	<td width="80%" align="center" valign="top">   
                ...
                <legend>Embroidery Item Receive Return</legend>
                <br />
                    ...
                    <input type="hidden" id="transaction_id" name="transaction_id" />                                      
                        <table  width="800" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                           ...
                           <tr>
                               ...
                               <td width="160">
                                    <? 
                                     echo create_drop_down( "cbo_company_id", 160, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0 $company_cond $company_credential_cond order by company_name","id,company_name", 1, "-- Select --", $selected, "load_drop_down( 'requires/emb_material_receive_return_controller', this.value, 'load_drop_down_store', 'store_td' );;" );
                                     //load_room_rack_self_bin('requires/emb_material_receive_return_controller*4_8_9_10_11_15_16_17_18_19_20_21_22_32_33_34_35_36_37_38_39_40_41_44_45_46_47_48_49_50_51_52_53_54_55_56_57_58_59_60_61_62_63_64_65_66_67_68_69_70_89_90_91_92_93_94_99', 'store','store_td', this.value);
                                    ?>
                               </td>
