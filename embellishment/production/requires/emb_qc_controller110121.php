        ...
        <table width="680" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
            ...
            <tbody>
                <tr class="general">
                    ...
                    <td>
						<?
                            $search_by_arr=array(1=>"Emb. Job No",2=>"W/O No",3=>"Buyer Job",4=>"Buyer Po",5=>"Buyer Style");
...
if($action=="create_production_search_list_view")
{
	...
	if($search_type==1)
	{
		if($search_str!="")  //b.buyer_po_no,b. buyer_style_ref
		{
			...
			if ($search_by==3) $search_com_cond=" and a.job_no_prefix_num = '$search_str' ";
			//else if ($search_by==4) $po_cond=" and b.po_number = '$search_str' ";
			//else if ($search_by==5) $style_cond=" and a.style_ref_no = '$search_str' ";
	...
	else if($search_type==4 || $search_type==0)
	{
		if($search_str!="")
		{
			...
			if ($search_by==3) $search_com_cond=" and a.job_no_prefix_num like '%$search_str%'";  
				...
				<form name="searchprocessfrm_1" id="searchprocessfrm_1" autocomplete="off">
					...
					<div style="width:1070px; overflow-y:scroll; max-height:300px;">
						<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1050" class="rpt_table" id="list_view" >
							<?
							$sql= "SELECT  a.id, a.job_no_prefix_num, a.embellishment_job, a.party_id, a.within_group, b.id as order_id, b.order_no, b.buyer_po_id, b.main_process_id, b.gmts_item_id, b.embl_type, b.body_part, c.color_id, sum(c.qnty) as qty, e.id as production_id, e.prefix_no_num, e.sys_no,b.buyer_po_no,b. buyer_style_ref from subcon_ord_mst a, subcon_ord_dtls b, subcon_ord_breakdown c, subcon_embel_production_mst e where a.id=b.mst_id and b.id=c.mst_id and a.embellishment_job=e.job_no and b.job_no_mst=c.job_no_mst and a.status_active =1 and a.is_deleted =0 and b.status_active =1 and b.is_deleted =0 and e.status_active =1 and e.is_deleted =0 				
