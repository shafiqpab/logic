...
<script>
	...
	function fnc_chemical_dyes_issue_entry(operation)
	{
		if(operation==4)
		{
			...
			print_report( $('#cbo_company_name').val()+'*'+$('#update_id').val()+'*'+report_title+'*'+$('#txt_mrr_no').val(),'chemical_dyes_issue_print','requires/chemical_dyes_issue_controller');
                    ...
                    <table  width="950" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                            <? 
                            echo create_drop_down( "cbo_issue_purpose", 170, $yarn_issue_purpose,"", 1, "-- Select Purpose --", 53, "", "","3,5,26,30,32,33,40,53");
                            ?>
                            </td>
