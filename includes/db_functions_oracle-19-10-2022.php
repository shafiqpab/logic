...
{ 
	...
	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//192.168.11.27:1521/XE');
	 //$con = oci_connect('LOGIC3RD', 'logic3rd', '//192.168.11.20:1521/ORCL');
	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//192.168.11.250:1521/orcl');
	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//59.152.60.147:15252/orcl');
	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//192.168.11.250:1521/orcl');
	 //$con = oci_pconnect('PLATFORMERPV3', 'PLATFORMERPV3', '//localhost:1521/logicdb');
	 $con = oci_pconnect('PLATFORMERPV3', 'PLATFORMERPV3', '//59.152.60.146:1535/logicdb');
	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//127.0.0.1/xe');

	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//127.0.0.1/ORCL');
	//$con = oci_connect('LOGICV3RD', 'LOGICV3RD', '//192.168.11.20:1521/ORCL');//Aziz IP
	//$con = oci_connect('LOGIC3RD', 'logic3rd', '//192.168.11.20:1521/ORCL');
	//$con = oci_connect('BPG_ERP', 'BPG_ERP', 'localhost:1521/ORCL');
	//$con = oci_pconnect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '(DESCRIPTION = (ADDRESS = (PROTOCOL = TCP)(HOST = 192.168.11.250)(PORT = 1521)) (CONNECT_DATA = (SERVICE_NAME = ORCL) (SID = ORCL)))');
	//db2_autocommit($con, false);
	//$con = oci_connect('LOGIC3RDVERSION', 'LOGIC3RDVERSION', '//192.168.11.29:1521/XE');
	if(!$con)
	{
