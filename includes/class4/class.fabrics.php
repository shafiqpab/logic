...
class fabric extends report{
	...
	private $_By_JobAndGmtsFabcolor='By_JobAndGmtsFabcolor';
	...
	private function _setQty_knitAndwoven_greyAndfinish($level){
		...
		foreach($this->_dataArray as $row)
		{
			...
			elseif($level==$this->_By_JobAndGmtsFabcolor){  //Job no and gmt/Fabric color 
				if($fabNatureId==2){
					if(isset($Qty[$this->_knit][$this->_finish][$jobNo][$fabricColorId][$uom])){
						$Qty[$this->_knit][$this->_finish][$jobNo][$fabricColorId][$uom]+=$reqqnty_finish;
					}
					else{
						$Qty[$this->_knit][$this->_finish][$jobNo][$fabricColorId][$uom]=$reqqnty_finish;
					}
					if(isset($Qty[$this->_knit][$this->_grey][$jobNo][$fabricColorId][$uom])){
						$Qty[$this->_knit][$this->_grey][$jobNo][$fabricColorId][$uom]+=$reqqnty_grey;
					}
					else{
						$Qty[$this->_knit][$this->_grey][$jobNo][$fabricColorId][$uom]=$reqqnty_grey;
					}
				...
				elseif($fabNatureId==3){
					if(isset($Qty[$this->_woven][$this->_finish][$jobNo][$fabricColorId][$uom])){
						$Qty[$this->_woven][$this->_finish][$jobNo][$fabricColorId][$uom]+=$reqqnty_finish;
					}
					else{
						$Qty[$this->_woven][$this->_finish][$jobNo][$fabricColorId][$uom]=$reqqnty_finish;
					}
					if(isset($Qty[$this->_woven][$this->_grey][$jobNo][$fabricColorId][$uom])){
						$Qty[$this->_woven][$this->_grey][$jobNo][$fabricColorId][$uom]+=$reqqnty_grey;
					}
					else{
						$Qty[$this->_woven][$this->_grey][$jobNo][$fabricColorId][$uom]=$reqqnty_grey;
					}
				...
				elseif($fabNatureId==100){
					if(isset($Qty[$this->_sweater][$this->_finish][$jobNo][$fabricColorId][$uom])){
						$Qty[$this->_sweater][$this->_finish][$jobNo][$fabricColorId][$uom]+=$reqqnty_finish;
					}
					else{
						$Qty[$this->_sweater][$this->_finish][$jobNo][$fabricColorId][$uom]=$reqqnty_finish;
					}
					if(isset($Qty[$this->_sweater][$this->_grey][$jobNo][$fabricColorId][$uom])){
						$Qty[$this->_sweater][$this->_grey][$jobNo][$fabricColorId][$uom]+=$reqqnty_grey;
					}
					else{
						$Qty[$this->_sweater][$this->_grey][$jobNo][$fabricColorId][$uom]=$reqqnty_grey;
					}
	...
	private function _setAmount_knitAndwoven_greyAndfinish($level){
		...
		foreach($this->_dataArray as $row)
		{
			...
			elseif($level==$this->_By_JobAndGmtsFabcolor){
				if($fabNatureId==2){
					if(isset($Amount[$this->_knit][$this->_finish][$jobNo][$fabricColorId][$uom])){
						$Amount[$this->_knit][$this->_finish][$jobNo][$fabricColorId][$uom]+=$amount_finish;
					}
					else{
						$Amount[$this->_knit][$this->_finish][$jobNo][$fabricColorId][$uom]=$amount_finish;
					}
					if(isset($Amount[$this->_knit][$this->_grey][$jobNo][$fabricColorId][$uom])){
						$Amount[$this->_knit][$this->_grey][$jobNo][$fabricColorId][$uom]+=$amount_grey;
					} 
					else{
						$Amount[$this->_knit][$this->_grey][$jobNo][$fabricColorId][$uom]=$amount_grey;
					}
				...
				elseif($fabNatureId==3){
					if(isset($Amount[$this->_woven][$this->_finish][$jobNo][$fabricColorId][$uom])){
						$Amount[$this->_woven][$this->_finish][$jobNo][$fabricColorId][$uom]+=$amount_finish;
					}
					else{
						$Amount[$this->_woven][$this->_finish][$jobNo][$fabricColorId][$uom]=$amount_finish;
					}
					if(isset($Amount[$this->_woven][$this->_grey][$jobNo][$fabricColorId][$uom])){
						$Amount[$this->_woven][$this->_grey][$jobNo][$fabricColorId][$uom]+=$amount_grey;
					}
					else{
						$Amount[$this->_woven][$this->_grey][$jobNo][$fabricColorId][$uom]=$amount_grey;
					}
				...
				elseif($fabNatureId==100){
					if(isset($Amount[$this->_sweater][$this->_finish][$jobNo][$fabricColorId][$uom])){
						$Amount[$this->_sweater][$this->_finish][$jobNo][$fabricColorId][$uom]+=$amount_finish;
					}
					else{
						$Amount[$this->_sweater][$this->_finish][$jobNo][$fabricColorId][$uom]=$amount_finish;
					}
					if(isset($Amount[$this->_sweater][$this->_grey][$jobNo][$fabricColorId][$uom])){
						$Amount[$this->_sweater][$this->_grey][$jobNo][$fabricColorId][$uom]+=$amount_grey;
					}
					else{
						$Amount[$this->_sweater][$this->_grey][$jobNo][$fabricColorId][$uom]=$amount_grey;
					}
	...
	//JobNo Gmt/Fab Color
	public function getQtyArray_by_JobAndGmtsFabcolor_knitAndwoven_greyAndfinish(){
		$Qty=$this->_setQty_knitAndwoven_greyAndfinish($this->_By_JobAndGmtsFabcolor);
		return $Qty;
	}
	public function getAmountArray_by_JobAndGmtsFabcolor_knitAndwoven_greyAndfinish(){
		$Amount=$this->_setAmount_knitAndwoven_greyAndfinish($this->_By_JobAndGmtsFabcolor);
		return $Amount;
	}	
