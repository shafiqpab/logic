...
class emblishment extends report{
	...
	private function _setQty($level){
		...
		while($row=oci_fetch_assoc($this->_dataArray))
		{
			...
			//echo $planPutQnty.",".$costingPerQty.",".$total_set_qnty.",".$req_qnty."<br/>";
