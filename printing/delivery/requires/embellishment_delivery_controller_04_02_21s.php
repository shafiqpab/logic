...
{	
	...
	$po_sql="select distinct a.subcon_job, a.within_group, a.party_id, b.id, b.order_no, b.order_quantity, b.buyer_po_id,b.buyer_po_no, b.buyer_style_ref, b.buyer_buyer
   from subcon_ord_mst a, subcon_ord_dtls b, subcon_embel_production_mst c, subcon_embel_production_dtls d
   where a.id = b.mst_id and b.id = c.order_id and c.id=d.mst_id and a.entry_form = 204 and c.entry_form=223 and d.qcpass_qty > 0 and a.status_active = 1 and a.is_deleted = 0 and b.status_active = 1 and b.is_deleted = 0 and c.is_deleted = 0 and c.status_active = 1 and d.is_deleted = 0 and d.status_active = 1";
	...
	if($order_ids != '') {
		$order_id_where_cond = " and b.id not in ($order_ids)";
	}
	...
	from subcon_ord_mst a, subcon_ord_dtls b, subcon_ord_breakdown c, subcon_embel_production_dtls d
	where a.entry_form=204 and a.embellishment_job=b.job_no_mst and b.job_no_mst=c.job_no_mst and d.job_no = a.embellishment_job and a.id=b.mst_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $order_rcv_date $company $buyer $withinGroup $search_com_cond $po_idsCond  and b.id=c.mst_id $order_id_where_cond 
...
if($action=="load_php_dtls_form")
{
   ...
   b.buyer_buyer from subcon_ord_mst a, subcon_ord_dtls b where a.embellishment_job=b.job_no_mst and a.entry_form=204  and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0";
	...
	$sql_job="SELECT a.id, a.embellishment_job, a.job_no_prefix_num, a.order_id, a.order_no, a.delivery_date, b.id as po_id, b.buyer_po_id, b.gmts_item_id, b.embl_type, b.body_part, b.main_process_id, b.order_uom, b.wastage, c.id as breakdown_id, c.description, c.color_id, c.size_id, c.qnty
		...
		where a.entry_form=204 and a.embellishment_job=b.job_no_mst  and c.job_no_mst=b.job_no_mst and c.qnty>0 and a.id=b.mst_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and b.id=c.mst_id and a.embellishment_job='$jobno' order by c.id ASC";
	//echo $sql_job;
