...
<script>
	...
	function fnc_chemical_dyes_issue_requisition(operation)
	{
		...
		else if(operation==0 || operation==1 || operation==2)
		{
			...
			var mst_data=get_submitted_data_string('txt_req_no*update_id*cbo_company_name*cbo_location_name*txt_requisition_date*cbo_receive_basis*txt_recipe_id*cbo_store_name*txt_order_id*txt_job_no*is_apply_last_update*txtbuyerPoId*cbo_color_id',"../../");
            ...
            <legend>Dyes And Chemical Issue Requisition</legend>
                <table width="810" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                    ...
                    <tr>
                        ...
                        <td width="155"><? echo create_drop_down( "cbo_company_name", 150, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-Select Company-", $selected, "rcv_basis_reset(); load_drop_down( 'requires/yd_dyes_chem_issue_requisition_controller', this.value, 'load_drop_down_location', 'location_td')",""); ?>
                        </td>
                   ...
                   <tr>
                         ...
                         <td><? echo create_drop_down( "cbo_color_id", 150, "SELECT id,color_name from lib_color where status_active =1 and is_deleted=0","id,color_name", 1, "-- Select --", $storeName, "",1 ); ?></td>
                    	<td></td>
                        <td></td>
                        <td></td>
                    	<td></td>
