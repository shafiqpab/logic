<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Create Date Wise Printing Delivery Report.
Functionality	:	
JS Functions	:
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Wise Printing Delivery Report", "../../", 1, 1,$unicode,1,1);
?>	
<script>
	...
	{
		col_operation: {
		   id: ["good_delivery","fr_delivary","total_qty"],
		   col: [8,9,10],
	...
	function fn_report_generated(type)
	{
		...
		freeze_window(3);
		http.open("POST","requires/date_wise_printing_delivery_report_controller.php",true);
	...
	function job_search_popup(page_link,title)
	{
		...
		else
		{
			...
			page_link='requires/date_wise_printing_delivery_report_controller.php?action=job_popup&data='+data
	...
	{ 
		...
		var page_link="requires/date_wise_printing_delivery_report_controller.php?action=style_no_popup&data="+data;
	...
	{ 
		...
		var page_link="requires/date_wise_printing_delivery_report_controller.php?action=int_ref_popup&data="+data;
	...
	{ 
		...
		var page_link="requires/date_wise_printing_delivery_report_controller.php?action="+action+"&type="+type+"&data="+arg;		
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr >
                    	...
                    	<td>
							<?php echo create_drop_down( "cbo_within_group", 100, $yes_no,"", 1, "-- Select --", $selected, "load_drop_down( 'requires/date_wise_printing_delivery_report_controller',document.getElementById('cbo_company_id').value+'_'+this.value, 'load_drop_down_party', 'party_td' );"); ?>
						</td>
                        <td id="party_td">
                        	<? 
                        ...
                        <td>
                            <input name="txt_style_ref" id="txt_style_ref" class="text_boxes" style="width:100px" placeholder="Write" onDblClick="openmypage_style22();" >
                        </td>
