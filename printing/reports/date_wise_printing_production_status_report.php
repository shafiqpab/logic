...
<script>
	...
	{
		col_operation: {
		   id: ["tot_job_qty","tot_job_val","tot_job_val2","tot_mat_rcv","tot_mat_issue","tot_prod_qty","tot_qc_qty","tot_del_qty","tot_rej_qty","tot_bill_qty","tot_bill_amt"],
	...
	function fn_report_generated(type)
	{
		...
		if(type==1){
			var action_scr = "report_generate";
		}else{
			var action_scr = "report_generate_2";
		}
		
		var data="action="+action_scr+get_submitted_data_string('cbo_company_id*cbo_within_group*cbo_party_id*txt_job_no*txt_style_ref*txt_int_ref*cbo_shift_name*txt_date_from*txt_date_to',"../../")+'&report_title='+report_title;			
		
		freeze_window(3);
		http.open("POST","requires/date_wise_printing_production_status_report_controller.php",true);
	...
	function job_search_popup(page_link,title)
	{
		...
		else
		{
			...
			page_link='requires/date_wise_printing_production_status_report_controller.php?action=job_popup&data='+data
	...
	{ 
		...
		var page_link="requires/date_wise_printing_production_status_report_controller.php?action=style_no_popup&data="+data;
	...
	{ 
		...
		var page_link="requires/date_wise_printing_production_status_report_controller.php?action=int_ref_popup&data="+data;
	...
	{ 
		...
		var page_link="requires/date_wise_printing_production_status_report_controller.php?action="+action+"&type="+type+"&data="+arg;		
         ...
         <fieldset style="width:1070px;">
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                <thead>                    
                    ...
                    <th colspan="2" width="130" class="must_entry_caption">Transaction Date</th>
                ...
                <tbody>
                    <tr >
                    	...
                    	<td>
							<?php echo create_drop_down( "cbo_within_group", 100, $yes_no,"", 1, "-- Select --", $selected, "load_drop_down( 'requires/date_wise_printing_production_status_report_controller',document.getElementById('cbo_company_id').value+'_'+this.value, 'load_drop_down_party', 'party_td' );" ); ?>
						</td>
                        <td id="party_td">
                        	<? 
                        ...
                        <td>
                        	<? 
								$manual_shift_arr = array(1=> "Day shift", 2=> "Night shift");
                        		echo create_drop_down("cbo_shift_name", 60, $manual_shift_arr, "", 1, "--All Shift--", "", "", 0, "", "", "", "", "");
	                        ?>
                        </td>
