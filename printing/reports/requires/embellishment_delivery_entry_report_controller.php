				...
				<tfoot>
					<tr>
						<td colspan="10" align="center">
							<input type="button" name="search" id="search" value="Print" onClick="print_formet()" style="width:80px" class="formbutton" />
						</td>
					</tr>
				</tfoot>
			</table>
        ...
        <div style="width:100%;">
            <table align="center" cellspacing="0" width="1230" border="1" rules="all" class="rpt_table" style="font-size:12px">
				...
				foreach($sql_res as $row)
		        {
		       	 	...
		       	 	$date_array[$row[csf('mst_id')]][$row[csf('order_id')]][$row[csf('gmts_item_id')]][$row[csf('main_process_id')]][$row[csf('color_id')]]['within_group']=$row[csf('within_group')];
            ...
            <br>
            	<? echo signature_table(154, $com_id, "1230px"); ?>
        </div>
    </div>
	<?
	exit();
