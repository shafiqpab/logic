...
if($action=='action_user_data')
{
	...
	else
	{
        ...
        <tr>
            <td align="center" id="fieldtd">
              <? echo create_drop_down("cboFieldId_".$i,200,$field_arr,"",1,"----Select----","","set_hide_data(this.value+'**'+1);set_drop_dwon_data(this.value+'**'+$i)","","","","","","",""); ?>
            </td>
            <td align="center">
			...
			if($page_id==108)
			{
				echo create_drop_down("setDefaultVal_".$i,150,"","",1,"----Select----", "","","","","","","","","");
			}
			else
			{
			?>
