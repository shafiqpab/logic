...
{	
	...
	fclose($myfile); //echo implode(',',$readfile['lib_mktdtls']); die;
	if($db_type==0)
	{
	...
	$field_arr_template="id, temp_id, item_id1, ratio1, item_id2, ratio2, lib_item_id, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
	
	$field_arr_stage="id, stage_name, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
	
	$field_arr_lib_agent_loc="id, type, agent_location, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
	...
	$field_arr_cons_rate="id, mst_id, item_id, type, particular_type_id, formula, consumption, unit, is_calculation, rate, rate_data, value, ex_percent, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
	...
	$field_arr_item_summ="id, mst_id, item_id, fabric_cost, sp_operation_cost, accessories_cost, smv, efficiency, cm_cost, frieght_cost, lab_test_cost, miscellaneous_cost, other_cost, commission_cost, fob_pcs, rmg_ratio, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
	
	$field_arr_confirmmst="id, cost_sheet_id, lib_item_id, confirm_style, confirm_order_qty, confirm_fob, deal_merchant, ship_date, job_id, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
	
	$field_arr_confirmdtls="id, mst_id, cost_sheet_id, item_id, fab_cons_kg, fab_cons_yds, fab_amount, sp_oparation_amount, acc_amount, fright_amount, lab_amount, misce_amount, other_amount, comm_amount, fob_amount, cm_amount, rmg_ratio, inserted_by, insert_date, updated_by, update_date, status_active, is_deleted";
