...
<script language="javascript">
    ...
    function fnc_test_employee(operation)
    {
        ...
        } else
        {
            ...
            http.open("POST", "requires/test_employee_reaz_controller.php", true);
    ...
    function fnc_on_submit_reponse()
    {
        if (http.readyState == 4)
        {
            ...
            show_list_view('', 'test', 'list_view', 'requires/test_employee_reaz_controller', 'setFilterGrid("list_view",-1)');
