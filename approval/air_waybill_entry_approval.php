...
$approval_setup=is_duplicate_field( "entry_form", "electronic_approval_setup", "entry_form=87 and is_deleted=0" );
...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_bill_no*cbo_approval_type*txt_currier_no*txt_date_from*txt_date_to*txt_alter_user_id',"../");
		///alert(data);
		http.open("POST","requires/air_way bill_entry_approval_controller.php",true);
...
function generate_fabric_report_reponse()
	...
	function change_user()
	{
		...
		var page_link = 'requires/air_way bill_entry_approval_controller.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
                 ...
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    ...
                    <tbody>
                        <tr class="general">
                            <td> 
                                <?
                                    echo create_drop_down( "cbo_company_name", 160, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/air_way bill_entry_approval_controller',this.value, 'load_drop_down_buyer', 'buyer_td_id' );" );
                                ?>
                            </td>
                            <td id="buyer_td_id"> 
                                <?
                            ...
                            <td>
                            	<input type="text" name="txt_currier_no" id="txt_currier_no" value="" class="text_boxes" style="width:100px" /> 
                            </td>  
