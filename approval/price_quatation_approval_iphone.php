...
$menu_id=$_SESSION['menu_id']; //$menu_id=427;
//--------------------------------------------------------------------------------------------------------------------
...
<script>
	...
	function fn_report_generated()
	{
		...
		http.open("POST","requires/price_quatation_approval_controller_iphone.php",true);
	...
	{
		var page_link='requires/price_quatation_approval_controller_iphone.php?action='+action+'&id='+id;
	...
	function change_user()
	{
		...
		var page_link = 'requires/price_quatation_approval_controller_iphone.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
		...
		emailwindow.onclose=function()
		{
			...
			load_drop_down( 'requires/price_quatation_approval_controller_iphone',$("#cbo_company_name").val()+"_"+data_arr[0], 'load_drop_down_buyer_new_user', 'buyer_td_id' );
...
?>
                        ...
                        <tbody>
                            <tr class="general">
                                <td>
                                    <?
                                        echo create_drop_down( "cbo_company_name", 160, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/price_quatation_approval_controller_iphone',this.value, 'load_drop_down_buyer', 'buyer_td_id' );" );
                                    ?>
                                </td>
                                <td id="buyer_td_id">
									<?
