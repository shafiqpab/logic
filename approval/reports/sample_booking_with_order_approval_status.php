...
function fn_report_generated()
{
	...
	freeze_window(3);
	http.open("POST","requires/sample_booking_with_order_approval_status_controller.php",true);
...
function openmypage()
{
	...
	var page_link='requires/sample_booking_with_order_approval_status_controller.php?action=search_popup&companyID='+companyID+'&buyerID='+buyerID;
         ...
         <table class="rpt_table" width="930" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr>
                        <td> 
                            <?
                                echo create_drop_down( "cbo_company_name", 140, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/sample_booking_with_order_approval_status_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                            ?>
                        </td>
                        <td id="buyer_td">
                            <? 
