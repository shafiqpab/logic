...
function fn_report_generated()
{
	...
	var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_req_no*hide_req_id*cbo_type*txt_date_from*txt_date_to*txt_app_date',"../../")+'&report_title='+report_title;
	freeze_window(3);
	http.open("POST","requires/yarn_purchase_req_approval_status_report_controller.php",true);
...
function openmypage(type)
{
	...
	var page_link='requires/yarn_purchase_req_approval_status_report_controller.php?action=req_popup&companyID='+companyID+'&buyerID='+buyerID+'&type='+type;
...
{
	var page_link='requires/yarn_purchase_req_approval_status_report_controller.php?action='+action+'&job_no='+job_no;
        ...
        <? echo load_freeze_divs ("../../",''); ?>
         ...
         <fieldset style="width:770px;">
             <table class="rpt_table" width="770" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr class="general">
                        <td><? echo create_drop_down( "cbo_company_name", 130, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/yarn_purchase_req_approval_status_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" ); ?></td>
                        <td id="buyer_td"><? echo create_drop_down( "cbo_buyer_name", 130, $blank_array,"", 1, "-- All Buyer --", $selected, "",0,"" ); ?></td>
                        <td>
                            <input type="text" name="txt_req_no" id="txt_req_no" class="text_boxes" style="width:90px" placeholder="Browse" onDblClick="openmypage(1);" readonly>
