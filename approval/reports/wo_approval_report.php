<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Create WO Approval Report.
Functionality	:	
JS Functions	:
...
echo load_html_head_contents("WO Approval Report", "../../", 1, 1, '', 1, 1);
?>
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_supplier*txt_date_from*txt_date_to*cbo_item_category_id*cbo_year*txt_wo_no',"../../")+'&report_title='+report_title;
		freeze_window(3);
