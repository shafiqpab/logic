...
<script>
	...
	function fn_report_generated()
	{
		...
		http.open("POST","requires/yarn_requisition_approval_controller.php",true);
	...
	function change_user()
	{
		...
		var page_link = 'requires/yarn_requisition_approval_controller.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
	...
	function submit_approved(total_tr,type)
	{
		...
		var data="action=approve&operation="+operation+'&approval_type='+type+'&req_nos='+req_nos+'&requisition_id='+requisition_id+'&cbo_company_name='+cbo_company_name+'&txt_alter_user_id='+txt_alter_user_id;
