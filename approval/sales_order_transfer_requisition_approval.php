...
Purpose			: 	This form will create Sales Order Transfer Requisition Approval
...
//-------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Sales Order Transfer Requisition Approval", "../", 1, 1,'','','');
...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate&previous_approved="+previous_approved+get_submitted_data_string('cbo_company_name*cbo_get_upto*txt_date*cbo_approval_type*txt_requisition_id*txt_bar_code*txt_alter_user_id',"../");
		// alert(data);return;
		
		http.open("POST","requires/sales_order_transfer_requisition_approval_controller.php",true);
	...
	function change_user()
	{
		...
		var title = 'Sales Order Transfer Requisition Approval';	
		var page_link = 'requires/sales_order_transfer_requisition_approval_controller.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
