...
$approval_setup=is_duplicate_field( "entry_form", "electronic_approval_setup", "entry_form=28 and is_deleted=0" );
...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_internal_ref*cbo_approval_type*txt_booking_no*txt_date_from*txt_date_to*txt_alter_user_id',"../");
		//alert(data);
		http.open("POST","requires/work_order_for_aop_approval_controller_v2.php",true);
...
function generate_fabric_report_reponse()
	...
	function change_user()
	{
		...
		var page_link = 'requires/work_order_for_aop_approval_controller_v2.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
                 ...
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    <thead>                        	
                        ...
                        <tr>
                            ...
                            <th>Booking No</th>
							<th>Internal Ref.</th>
                            <th colspan="2">Work Order Date.</th>
                    ...
                    <tbody>
                        <tr class="general">
                            <td> 
                                <?
                                    echo create_drop_down( "cbo_company_name", 160, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/work_order_for_aop_approval_controller_v2',this.value, 'load_drop_down_buyer', 'buyer_td_id' );" );
                                ?>
                            </td>
                            <td id="buyer_td_id"> 
                                <?
