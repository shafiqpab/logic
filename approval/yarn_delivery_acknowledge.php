...
Purpose			: 	This form will create yarn delivary Acknowledgement 
...
//-------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Yanr Delivary Acknowledgement", "../", 1, 1,'','','');
...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate&previous_approved="+previous_approved+get_submitted_data_string('cbo_company_name*cbo_issue_purpose*cbo_get_upto*txt_date*cbo_approval_type*txt_issue_id*txt_bar_code*txt_alter_user_id',"../");
		// alert(data);return;
		
		http.open("POST","requires/yarn_delivery_acknowledge_controller.php",true);
                            ...
                            <tr class="general">
                                ...
                                <td> 
                                    <?
                                        ...
                                        echo create_drop_down( "cbo_approval_type", 130, $acknowledge_type_arr,"", 0, "", $selected,"","", "" );
                                    ?>
                                </td>
