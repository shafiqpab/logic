...
<script>
	...
	{		
		...
		// alert(data);return;
		freeze_window(3);
		http.open("POST","requires/gate_pass_entry_approval_group_by_controller.php",true);
	...
	function change_user()
	{
		...
		var page_link = 'requires/gate_pass_entry_approval_group_by_controller.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
	...
	{
		var page_link='requires/gate_pass_entry_approval_group_by_controller.php?action='+action+'&id='+id;
