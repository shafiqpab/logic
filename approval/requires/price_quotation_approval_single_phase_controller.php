...
if($action=="report_generate")
{
    ...
    <form name="requisitionApproval_2" id="requisitionApproval_2">
        <fieldset style="width:980px; margin-top:10px">
            ...
            <div style="width:980px; overflow-y:scroll; max-height:330px;" id="buyer_list_view" align="center">
            ...
            <table cellspacing="0" cellpadding="0" border="0" rules="all" width="980" class="rpt_table">
				<tfoot>
