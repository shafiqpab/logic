...
if($action=="report_generate")
{
	...
	if($approval_type==0)
	{
		...
		{
			$sql="select a.id, a.booking_no, a.item_category, a.fabric_source, a.company_id, a.booking_type, a.is_short, a.buyer_id, a.supplier_id, a.delivery_date, a.booking_date, '0' as approval_id, a.job_no,a.is_approved, a.po_break_down_id from wo_non_ord_samp_booking_mst a where company_id=$company_name and a.item_category in(2,13) and a.is_deleted=0 and a.status_active=1 and $orderBy_cond(a.is_approved,0)=$approval_type and a.ready_to_approved=1 $buyer_id_cond order by $orderBy_cond(a.update_date, a.insert_date) desc";
		}
		else if($sequence_no=="")
		{
			if($db_type==0)
			{
				...
				$booking_id=return_field_value("group_concat(distinct(mst_id)) as booking_id","wo_non_ord_samp_booking_mst a, approval_history b","a.id=b.mst_id and a.company_id=$company_name and a.item_category in(2,13) and b.sequence_no in ($sequence_no_by) and b.entry_form=9 and b.current_approval_status=1","booking_id");
				
				$booking_id_app_byuser=return_field_value("group_concat(distinct(mst_id)) as booking_id","wo_non_ord_samp_booking_mst a, approval_history b","a.id=b.mst_id and a.company_id=$company_name and a.item_category in(2,13) and b.sequence_no=$user_sequence_no and b.entry_form=9 and b.current_approval_status=1","booking_id");
			}
			else
			{
				...
				$booking_id=return_field_value("LISTAGG(mst_id, ',') WITHIN GROUP (ORDER BY mst_id) as booking_id","wo_non_ord_samp_booking_mst a, approval_history b","a.id=b.mst_id and a.company_id=$company_name and a.item_category in(2,13) and b.sequence_no in ($sequence_no_by) and b.entry_form=9 and b.current_approval_status=1","booking_id");
				$booking_id=implode(",",array_unique(explode(",",$booking_id)));
				
				$booking_id_app_byuser=return_field_value("LISTAGG(mst_id, ',') WITHIN GROUP (ORDER BY mst_id) as booking_id","wo_non_ord_samp_booking_mst a, approval_history b","a.id=b.mst_id and a.company_id=$company_name and a.item_category in(2,13) and b.sequence_no=$user_sequence_no and b.entry_form=9 and b.current_approval_status=1","booking_id");
			...
			$sql="select a.id, a.booking_no, a.item_category, a.fabric_source, a.company_id, a.booking_type, a.is_short, a.buyer_id, a.supplier_id, a.delivery_date, a.booking_date, '0' as approval_id, a.job_no, a.is_approved, a.po_break_down_id from wo_non_ord_samp_booking_mst a, wo_non_ord_samp_booking_dtls b where a.booking_no=b.booking_no and a.company_id=$company_name and a.item_category in(2,13) and a.is_deleted=0 and a.status_active=1 and b.status_active=1 and b.is_deleted=0 and $orderBy_cond(a.is_approved,0)=$approval_type and a.ready_to_approved=1 $booking_id_cond $buyer_id_cond  group by a.id, a.booking_no, a.item_category, a.fabric_source, a.company_id, a.booking_type, a.is_short, a.buyer_id, a.supplier_id, a.delivery_date, a.booking_date, a.job_no, a.is_approved, a.po_break_down_id,a.insert_date order by $orderBy_cond(a.update_date, a.insert_date) desc";
		}
		...
		else
		{
			...
			$sql="select a.id, a.booking_no, a.item_category, a.fabric_source, a.company_id, a.booking_type, a.is_short, a.buyer_id, a.supplier_id, a.delivery_date, a.booking_date, a.job_no, a.po_break_down_id, b.id as approval_id ,a.is_approved, b.sequence_no, b.approved_by from wo_non_ord_samp_booking_mst a, approval_history b where a.id=b.mst_id and b.entry_form=9 and a.company_id=$company_name and a.item_category in(2,13) and a.status_active=1 and a.is_deleted=0 and b.current_approval_status=1 and a.ready_to_approved=1 and a.is_approved=1 $buyer_id_cond $sequence_no_cond order by $orderBy_cond(a.update_date, a.insert_date) desc";
		}
	}
	else
	{
		$sequence_no_cond=" and b.sequence_no='$user_sequence_no'";
		 $sql="select a.id, a.booking_no, a.item_category, a.fabric_source, a.company_id, a.booking_type, a.is_short, a.buyer_id, a.supplier_id, a.delivery_date, a.booking_date, a.job_no, a.po_break_down_id, b.id as approval_id ,a.is_approved, b.sequence_no, b.approved_by from wo_non_ord_samp_booking_mst a, approval_history b where a.id=b.mst_id and b.entry_form=9 and a.company_id=$company_name and a.item_category in(2,13) and a.status_active=1 and a.ready_to_approved=1 and a.is_deleted=0 and b.current_approval_status=1 and a.is_approved=1 $buyer_id_cond $sequence_no_cond order by $orderBy_cond(a.update_date, a.insert_date) desc";
	}
                            ...
                            foreach ($nameArray as $row)
                            {
								...
								if($print_cond==1)
								{
                                    ...
                                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>"> 
                                        ...
                                        <td width="130">
                                            <p><a href='##' style='color:#000' onclick="generate_worder_report('<? echo $row[csf('booking_no')]; ?>',<? echo $row[csf('company_id')]; ?>,<? echo $row[csf('is_approved')]; ?>)"><? echo $row[csf('booking_no')]; ?></a></p>
                                        </td>
