...
<script>
	...
	function fn_report_generated()
	{
		...
		http.open("POST","requires/quick_costing_approval_v2_controller.php",true);
	...
	{
		var page_link='requires/quick_costing_approval_v2_controller.php?action='+action+'&id='+id;
	...
	function fnc_load_cm_compulsory(data)
	{
		...
		var cm_compulsory = return_global_ajax_value( data, 'populate_cm_compulsory', '', 'requires/quick_costing_approval_v2_controller');
	...
	function change_user()
	{
		...
		var page_link = 'requires/quick_costing_approval_v2_controller.php?action=user_popup';
	...
	function fnc_confirm_style(qc_no,update_id)
	{
		...
		var page_link='requires/quick_costing_approval_v2_controller.php?action=confirmStyle_popup';
         ...
         <div id="content_search_panel"> 
             ...
             <fieldset style="width:1000px;">
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        ...
                        <tbody>
                            <tr class="general">
                                <td id="buyer_td_id"><?=create_drop_down( "cbo_buyer_name", 140, "select buy.id, buy.buyer_name from lib_buyer buy, lib_buyer_tag_company b where buy.status_active =1 and buy.is_deleted=0 and b.buyer_id=buy.id  $buyer_cond and buy.id in (select buyer_id from lib_buyer_party_type where party_type in (1,3,21,90)) group by buy.id, buy.buyer_name order by buy.buyer_name","id,buyer_name", 1, "-- All Buyer --", $selected, "load_drop_down( 'requires/quick_costing_approval_v2_controller', this.value, 'load_drop_down_brand', 'brand_td'); load_drop_down('requires/quick_costing_approval_v2_controller', this.value, 'load_drop_down_season', 'season_td');" ); ?></td>
