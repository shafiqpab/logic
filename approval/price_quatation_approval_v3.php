...
Purpose			: 	This form will create Price Quotation Approval V3
Functionality	:			
JS Functions	:
...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate&previous_approved="+previous_approved+get_submitted_data_string('cbo_company_name*cbo_buyer_name*cbo_get_upto*txt_date*txt_team_member*txt_price_quotation_id*cbo_approval_type*txt_alter_user_id',"../");
		
		http.open("POST","requires/price_quatation_approval_v3_controller.php",true);
	...
	{
		var data="action=top_botton_report&type="+type+		            
	...
	{
		var page_link='requires/price_quatation_approval_v3_controller.php?action='+action+'&id='+id;
	...
	function change_user()
	{
		...
		var page_link = 'requires/price_quatation_approval_v3_controller.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
		...
		emailwindow.onclose=function()
		{
			...
			load_drop_down( 'requires/price_quatation_approval_v3_controller',$("#cbo_company_name").val()+"_"+data_arr[0], 'load_drop_down_buyer_new_user', 'buyer_td_id' );
         ...
         <div id="content_search_panel">      
             <fieldset style="width:1100px;">
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        <thead>
                        	<tr> 
                            	<th colspan="3" align="right">Barcode Scan: <input type="text" id="txt_bar_code" name="txt_bar_code" class="text_boxes"  /></th>
                        ...
                        <tbody>
                            <tr class="general">
                                <td> 
                                    <?
                                        echo create_drop_down( "cbo_company_name", 160, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/price_quatation_approval_v3_controller',this.value, 'load_drop_down_buyer', 'buyer_td_id' );" );
                                    ?>
                                </td>
                                <td id="buyer_td_id"> 
									<?
                                ...
                                <td><input type="text" placeholder="Select Date" name="txt_date" id="txt_date" class="datepicker" readonly style="width:80px"/></td>
