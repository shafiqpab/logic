<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Gate Pass Approval
Functionality	:	
JS Functions	:
Created by		:	Rakib 
...
<script>
	...
	{		
		...
		var data="action=report_generate&previous_approved="+previous_approved+get_submitted_data_string('cbo_company_name*cbo_basis*txt_system_id*txt_date_from*txt_date_to*cbo_approval_type*txt_alter_user_id',"../");
		// alert(data);return;
		freeze_window(3);
		http.open("POST","requires/gate_pass_entry_approval_controller.php",true);
	...
	function change_user()
	{
		...
		var page_link = 'requires/gate_pass_entry_approval_controller.php?action=user_popup'+get_submitted_data_string('cbo_company_name',"../");
	...
	{
		var page_link='requires/gate_pass_entry_approval_controller.php?action='+action+'&id='+id;
                ...
                <table class="rpt_table" width="1000" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                	...
                	<tbody>
                    	<tr class="general">
							...
							<td> 
								<? 
								echo create_drop_down("cbo_basis", 170,$get_pass_basis,"", 1,"-- Select Basis --","0","","","");
								?>
							</td>
