...
http://localhost/platform_v3.5/printing/reports/printing_hourly_production_display_report2.php?url=Fashion Apparel Ltd./
http://116.193.218.254/trims_erp//printing/reports/printing_hourly_production_display_report2.php?url=Tahmid%20n%20Twalha%20Accessories%20and%20Printing%20Ltd./
*/
...
<script> 
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/printing_hourly_production_display_report_controller2.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'";
        //alert(data);
        http.open("POST","requires/printing_hourly_production_display_report_controller2.php",true);
