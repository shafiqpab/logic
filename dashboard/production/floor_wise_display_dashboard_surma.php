...
http://103.147.56.98/nzerp/dashboard/production/floor_wise_display_dashboard.php?url=N.A.Z. Bangladesh Ltd./BK Bari/1st Floor-Sewing U-2
*/
...
<script>
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/floor_wise_display_dashboard_controller_surma.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&cbo_location_name='"+cbo_location_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_floor='"+cbo_floor+"'";
        //alert(data);
        http.open("POST","requires/floor_wise_display_dashboard_controller_surma.php",true);
