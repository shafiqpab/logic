...
/* -------------------------------------------- Comments -----------------------
  ...
  QC Performed BY   :
  QC Date           :
  Comments          :   URL: http://localhost/platform-v3.5/dashboard\production\location_wise_finish_stock_display_board.php
 */
...
<script>
  ...
  {   
      ...
      {*/
        ...
        // freeze_window(3);
        http.open("POST","requires/location_wise_finish_stock_display_board_controller.php",true);
               ...
               <div class="menu_icon" id="menu_icon"> Open </div>
                <div id="searchPanel">
                    <div id="searchPanelInner">
                        ...
                        <p>Company:</p>
                        <? 
                            echo create_drop_down( "cbo_company_id", "", "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", 0, "load_drop_down('requires/location_wise_finish_stock_display_board_controller', this.value, 'load_drop_down_location_lc', 'location_td' );load_drop_down( 'requires/location_wise_finish_stock_display_board_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );",0 );
                            ?>
                        <p>Location:</p>
                        <div id="location_td">
                            <? 
