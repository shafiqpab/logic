...
<script>
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/line_wise_display_dashboard_controller_aukotex.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&cbo_location_name='"+cbo_location_name+"'"+"&cbo_floor='"+cbo_floor+"'"+"&txt_date='"+txt_date+"'"+"&cbo_line='"+cbo_line+"'";
        //alert(data);
        http.open("POST","requires/line_wise_display_dashboard_controller_aukotex.php",true);
