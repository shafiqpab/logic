<?
/*--- ----------------------------------------- Comments
Purpose         :   This form will create Hourly Production from URL Input                   
Functionality   :   
JS Functions    :
Created by      :   Rakib
...
QC Date         :   
Comments        :
http://192.168.100.4/fakirfashion_erp/production/reports/unit.php?url=Fakir Fashion Ltd./Unit-10 Sewing/
*/
...
<script> 
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/unit_controller.php',
                data:data,
                beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },
    ...
    {  
        ...
        var data="action=report_generate"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_floor='"+cbo_floor+"'";
        //alert(data);
        http.open("POST","requires/unit_controller.php",true);
