 ...
 */
// http://localhost/platform-v3.5/dashboard/production/dyeing_production_display_board_controller.php
...
<script>
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
          var cbo_company_name = $("#cbo_company_id").val();
          var txt_date = $("#txt_date").val();
          var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_source='"+cbo_source+"'";
            $.ajax({
                type:'POST',
                url:'requires/dyeing_production_display_board_controller.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    function fn_report_generated()
    {
        ...
        {*/
            ...
            var data="action=report_generate&cbo_company_name="+cbo_company_name+"&txt_date="+txt_date+"&page_width="+page_width+"&page_height="+page_height+"&cbo_source="+cbo_source;
            // freeze_window(3);
            http.open("POST","requires/dyeing_production_display_board_controller.php",true);
    ...
    {    
        if(http.readyState == 4) 
        {
            ...
            // release_freezing();
            //setTimeout(fn_report_generated,refresh_time); // comment
            //setTimeout(refreshTimer,refresh_time); // comment
        }    
    }
                ...
                <div id="searchPanel">
                    <div id="searchPanelInner">
                        ...
                        <? 
                            ...
                            ?>
                        <? 
                        $sourceArray = array(1=> "Inhouse Production", 2=> "Inbound Production");
                        echo create_drop_down( "cbo_source", "", $sourceArray, "", 1, "-- Select --", 0, "",0 );
                        ?>
                        <p>Production Date:</p>
