...
<script>
    ...
    {   
        ...
        {*/    
            ...
            var data="action=report_generate&cbo_company_name="+cbo_company_name+"&txt_date="+txt_sewing_date+"&hidden_line_id="+cbo_line_id+"&cbo_floor_id="+floorIds+"&page_width="+page_width+"&page_height="+page_height+'&cbo_buyer_name='+cbo_buyer_name;
            // freeze_window(3);
            http.open("POST","requires/display_board_axis_controller.php",true);
    ...
    function get_sewing_line()
    {
        ...
        // alert(floor_ids.join(", "));
        var floorIds = floor_ids.join(",");
        load_drop_down( 'requires/display_board_axis_controller',floorIds+'_'+document.getElementById('cbo_company_id').value+'_'+document.getElementById('txt_sewing_date').value, 'load_drop_down_sewing_line_floor', 'sewing_line' );
        get_php_form_data( floorIds, 'eval_multi_select', 'requires/display_board_axis_controller' );
    }
    ...
    function openmypage_line() // For Line
    {
        ...
        var page_link='requires/display_board_axis_controller.php?action=line_search_popup&wo_company_name='+wo_company_name+'&floor_name='+floorIds+'&date_from='+date_from;  
