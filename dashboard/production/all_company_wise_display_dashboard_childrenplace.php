...
http://192.168.4.152/erp/dashboard/production/all_company_wise_display_dashboard.php?url=all company/
*/
        ...
        var ajax_call = function(){
            $.ajax({
                ...
                success:function(response){
                    ...
                    //if (numSuccessfullAjaxCallCount%2 == 1)  $("#secondtime").css('display','block');                       
                    //else $("#firsttime").css('display','block');                        
