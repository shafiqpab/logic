...
/* -------------------------------------------- Comments -----------------------
  ...
  QC Performed BY   :
  QC Date           :
  Comments          :   URL: http://localhost/platform-v3.5/dashboard\production\location_wise_accessories_stock_display_board_controller.php
 */
...
<script type="text/javascript">
    <? 
        ...
        $storeArr = return_library_array("select a.id, a.store_name from lib_store_location a, lib_store_location_category b where a.id=b.store_location_id and b.category_type=4 and a.status_active=1 and a.is_deleted=0","id","store_name"); 
...
<script>
  ...
  {   
      ...
      {*/
          ...
          var scroll_speed_control = $("#scroll_speed_control").val(); 
          // =====================================
        ...
        var data="action=report_generate&cbo_company_name="+cbo_company_name+"&cbo_location="+cbo_location+"&cbo_store_name="+cbo_store_name+"&cbo_floor_id="+cbo_floor_id+"&cbo_room_id="+cbo_room_id+"&cbo_rack_id="+cbo_rack_id+"&cbo_shelf_id="+cbo_shelf_id+'&cbo_buyer_name='+cbo_buyer_name+"&scroll_speed_control="+scroll_speed_control+"&page_width="+page_width+"&page_height="+page_height;
        // freeze_window(3);
        http.open("POST","requires/location_wise_accessories_stock_display_board_controller.php",true);
               ...
               <div class="menu_icon" id="menu_icon"> Open </div>
                <div id="searchPanel">
                    <div id="searchPanelInner">
                        <p>Date</p>
                        <input type="text"  autocomplete="off" value="<?=date('d-m-Y');?>" name="txt_today_date" id="txt_today_date"  readonly >
                        <div id="currentDate" data-start="<?php date('d-m-Y');?>"></div>
                        <p>Clock</p>
                        ...
                        <span>Scroll Speed Control(s) : <input type="number" name="scroll_speed_control" id="scroll_speed_control" value="50" style="width: 70px;"></span>
                ...
                <div style="padding: 0; margin:0;">
                    <div style="padding: 0; margin:0;"> 
                        <div style="font-size:24px;color:#FFFFFF;background:#000000;width:100%;z-index:-1;">
                            <div>
                                <div style="font-size:25px;color:#FFFFFF;text-align: center;">Accessories Stock</div>
