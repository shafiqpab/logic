...
http://localhost/platform-v3.5/dashboard/production/sewing_group_wise_display_dashboard.php?url=company name/location/floor/group/
http://172.16.78.4/erp/dashboard/production/sewing_group_wise_display_dashboard.php?url=Knit Asia Ltd./Ratanpur/SF/SBU-8/
*/
...
<script>
    ...
    $(document).ready(function() {
        ...
        var cbo_sewing_group = '<? echo $url_sewing_group; ?>';
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&cbo_location_name='"+cbo_location_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_floor='"+cbo_floor+"'"+"&cbo_sewing_group='"+cbo_sewing_group+"'";

        var numSuccessfullAjaxCallCount = 0;
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/sewing_group_wise_display_dashboard_controller.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&cbo_location_name='"+cbo_location_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_floor='"+cbo_floor+"'"+"&cbo_sewing_group='"+cbo_sewing_group+"'";
        //alert(data);
        http.open("POST","requires/sewing_group_wise_display_dashboard_controller.php",true);
