...
{ 	
	...
	$trend=$totalProdQnty/$count_hour*16;
	...
	$efficiency=(($totalProdQnty*$total_smv_avg)/(($operator+$helper)*$count_hour*60))*100;
    ...
    //$data_array = sql_select("select image_location  from common_photo_library where master_tble_id=$cbo_company_id and form_name='company_details' and is_deleted=0 and file_type=1");
     ...
     $group_name=return_field_value("COMPANY_NAME", "LIB_COMPANY", "status_active=1 and is_deleted=0");
	...
	<div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="firsttime">
		<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" rules="all" cellpadding="0" cellspacing="0">
			<tr style="height: 8%;">
    			...
    			<td style="width: 31%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $group_name; ?> </td>
			...
			<tr style="height: 8%;">
    			<td colspan="2" style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
    				<p style="font-size: 1.7vw; text-align: center; "><span>Total Line:</span>&nbsp;<span style="font-weight:900;"><?= $countLineNumber; ?>,</span>&nbsp;<span>SMV Avg:</span>&nbsp;<span style="font-weight:900;"><?= number_format($lineWiseTotalSmv/$countLineNumber,2); ?></span></p>
    			</td>
    ...
    <div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="secondtime">
    	...
    	<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" border="1" rules="all" cellpadding="0" cellspacing="0">
    		<tr style="height: 8%;">
    			...
    			<td colspan="6" style="width: 46%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $group_name; ?> </td>
			...
			<tr style="height: 7%;">
    			...
    			<td style="width: 6%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle;">Defective%</td>
			</tr>
			<?
			...
			foreach ($production_data as $line_name => $row)
			{
				...
				$total_trend+=($row['totalProdQnty']/$count_hour*16);
