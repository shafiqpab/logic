...
{ 	
	...
	//echo $total_count_hour.'**'.$hourly_target.'**'.$working_hour;

	$ws_smv_result = sql_select("select max(id) id,style_ref,gmts_item_id,total_smv from ppl_gsd_entry_mst where style_ref in(".$style_ref_nos.") and gmts_item_id in($item_number_ids) and bulletin_type=4 and status_active=1 and is_deleted=0 group by id,style_ref,gmts_item_id,total_smv  order by id desc");
	$total_smv_min=$total_order_qnty=0;
	foreach ($ws_smv_result as $row)
	{
		//echo $style_item_qnty_arr[$row[csf('style_ref')]][$row[csf('gmts_item_id')]]."*".$row[csf('total_smv')]."<br />";
		$total_smv_min += $style_item_qnty_arr[$row[csf('style_ref')]][$row[csf('gmts_item_id')]]*$row[csf('total_smv')];
		$total_order_qnty += $style_item_qnty_arr[$row[csf('style_ref')]][$row[csf('gmts_item_id')]];
	}

	$smv_average=($total_smv_min/$total_order_qnty)*1;

	//$smv_average=$total_smv/$totalProdQnty; COMMENTED BY JAHID HASAN FOR AUKI TEX
	...
	//echo $totalProdQnty.'**'.$smv_average.'**'.$operator.'**'.$helper.'**'.$total_count_hour;
	...
	<style type="text/css">
		...
		.track .text {
		-webkit-animation: marquee 10000ms linear infinite;
	...
	<div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="firsttime">
		<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" rules="all" cellpadding="0" cellspacing="0">
			<tr style="height: 8%;">    			
    			<td style="width: 30%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">Buyer: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? echo $buyer_name; ?></marquee></td>
    			<td style="width: 20%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
				Style: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? if (strlen($style_ref_no)>12) echo substr($style_ref_no,0,10).'..'; else echo $style_ref_no; ?></marquee>
			
			</td>
    			<td style="width: 15%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">Floor: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? echo $cbo_floor_name; ?></marquee></td>
				<td style="width: 15%; color: yellow; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">Line: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? echo $cbo_line_name; ?></marquee></td>
    			<td style="width: 9%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle;">Time Past:
				<?				
    			...
    			<td style="width: 11%; color: white; font-size: 2.3vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= date('h:i A', time()); ?></td>
			</tr>
			...
			<tr style="height: 5%;">
    			...
    			<td rowspan="3" colspan="3" style="color: white; font-size: 2vw; font-weight:bold; width: 33%; height: 75%;">
    				<table style="width: 100%;height: 100%;">
    					<tr>
    						<td colspan="3" style="border:0; width: 100%; font-size: 2vw;" align="left" >&nbsp Efficiency</td>
    					</tr>
    					<tr>	
    						<td colspan="3" style="border:0;" align="center">
    							<canvas id="canvas" style="width:100%; max-width:100%"></canvas>
    							<input type="hidden" id="efficiency" value="<?= fn_number_format(floor($efficiency),0,'','','0'); ?>">
    						</td>    						
    					</tr>
    					<tr>
    						<td colspan="3" style="border:0; text-align: center; width: 100%" align="center" ><div style="font-size: 2vw; text-align: center; vertical-align: middle;"><span>Planned</span>&nbsp;<span style="font-weight:900;"><?= fn_number_format($planned/$countLineNumber,2,'.','','0.00'); ?>%</span></div>
    						</td>
    					</tr>
    				</table> 					
    			</td>
			...
			<tr style="height: 23%; width: 100%;">
    			<td style="color: white; font-weight:bold;">
    				<div style="font-size: 2vw; height: 20%; text-align: left;  width: 100%;">&nbsp Target</div>
			...
			<tr style="height: 23%;">
    			<td style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
					<div style="height: 20%;">
						<div style="font-size: 2vw; text-align: left; float:left;">&nbsp Actual</div>						    				
    				<?
			...
			<tr style="height: 23%;">
    			<td style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
					<div style="height: 20%;">	
    					<div style="font-size: 2vw; text-align: left; float:left;">&nbsp Variance</div>
    				<?
	        		if ($varriance < 0)
	        		{
	        			?>
    			...
    			<td colspan="2" style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
    				...
    				<div style="font-size:6vw; height: 80%; text-align: right; color: red; font-weight:900;"><?= fn_number_format(round($dhu,'-'),2,'.','','0'); ?>%&nbsp;</div>
    			</td>
			...
			<tr style="height: 6%;">
				<td style="color: white; font-size: 2.2vw; font-weight:bold; text-align: left; vertical-align: middle;">
    				<div style="font-weight: 900;">&nbsp SMV Avg:&nbsp;<?= fn_number_format($smv_average,2,'.','','0'); ?></div>
    			</td>
    			<td colspan="5" style="color: white; font-size: 2.2vw; font-weight:bold; text-align: center; vertical-align: middle; background-color: #FF0000;">
			...
			<tr style="height: 3%;">
				<td colspan="6" style="color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle;">
				<div class="marquee">
					<div class="track">
						<span class="text -r">&nbsp;&nbsp;<img src="../../images/logic/logic_logo_new.png" id="logininfo" width="220" height="30"> &nbsp;&nbsp;  Logic Software Limited || </span>
						<span class="text -r">&nbsp;&nbsp;<img src="../../images/logic/logic_logo_new.png" id="logininfo" width="220" height="30"> &nbsp;&nbsp;  Logic Software Limited || </span>
						<span class="text -r">&nbsp;&nbsp;<img src="../../images/logic/logic_logo_new.png" id="logininfo" width="220" height="30"> &nbsp;&nbsp;  Logic Software Limited || </span>
						<span class="text -r">&nbsp;&nbsp;<img src="../../images/logic/logic_logo_new.png" id="logininfo" width="220" height="30"> &nbsp;&nbsp;  Logic Software Limited || </span>
						<span class="text -r">&nbsp;&nbsp;<img src="../../images/logic/logic_logo_new.png" id="logininfo" width="220" height="30"> &nbsp;&nbsp;  Logic Software Limited || </span>
	...
	<div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none; background-color: #262626;" id="secondtime">
    	<table style="width: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" border="1" rules="all" cellpadding="0" cellspacing="0">
    		<tr style="height: 10%;">    			
    			<td colspan="2" style="width: 26%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">Buyer: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? echo $buyer_name; ?></marquee></td>
    			<td style="width: 18%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
				Style: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? if (strlen($style_ref_no)>12) echo substr($style_ref_no,0,10).'..'; else echo $style_ref_no; ?></marquee></td>
    			<td style="width: 18%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">Floor: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? echo $cbo_floor_name; ?></marquee></td>
				<td style="width: 14%; color: yellow; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">Line: <marquee width=85% behavior="scroll" scrolldelay="200" direction="left" onmouseover="this.stop();" onmouseleave="this.start();"><? echo $cbo_line_name; ?></marquee></td>
    			<td style="width: 12%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle;">Time Past:
					<?
					if ($count_hour == 0) $time='0'.$count_hour.':'.date('i', time());
					else if (date('G')==13) $time='0'.$count_hour.':00';
					else if ($count_hour==$working_hour && $count_hour < 10) $time='0'.$count_hour.':00';
    			...
    			<td style="width: 14%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><? echo date('h:i A', time()); ?></td>
			</tr>

			<tr style="height: 10%;">
				<td style="width: 4%;color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">Hour</td>
				<td style="width: 18%; color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">Hourly (Pcs) Actual/Plan</td>
				<td style="width: 18%; color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">Cum. (Pcs) Actual/Plan</td>
				<td style="width: 18%; color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">Variance (Pcs) Hourly/Cum.</td>
				<td style="width: 14%; color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">DHU%</td>
				<td style="width: 12%; color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">Actual Eff. %</td>
				<td style="width: 14%; color: white; font-size: 1.3vw; font-weight:bold; text-align: center; vertical-align: middle;">Eff. Variance %</td>   			
			</tr>
			<?
			$hour_count=1;
			...
			foreach($production_data as $line => $row)
			{
				for($h=$hour; $h<=$last_hour; $h++)
				{
					...
					<tr id="tr_<?= $h; ?>"style="height: 7%;" >
						...
						{			    				
							?>
							<td style="width: 18%; color: white; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><span style="color: red;"><?= number_format($row[$prod_hour],0); ?></span><span><?= '/'.$hourly_target; ?></span></td>
							<?
						}
						else
						{
							?>
							<td style="width: 18%; color: white; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><span style="color: green;"><?= $row[$prod_hour]; ?></span><span><?= '/'.$hourly_target; ?></span></td>
							<?
						}
						?>
						...
						{
							?>
							<td style="width: 18%; color: white; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><span style="color: red;"><?= $tot_good_qty; ?></span><span><?= '/'.$tot_hourly_target; ?></span></td>
							<?
						}
						else
						{
							?>
							<td style="width: 18%; color: white; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><span style="color: green;"><?= $tot_good_qty; ?></span><span><?= '/'.$tot_hourly_target; ?></span></td>
							<?
						}
						?>
						...
						if ( $varriancePcsHourly > 0)
						{
							...
							?>
							<td style="width: 20%; color: white; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><span style="color: green;"><?= $varriancePcsHourly; ?></span><span><?= '/'.trim($varriancePcsCum,'-'); ?></span></td>
							<?
						}
						else
						{
							$varriancePcsCum+=$varriancePcsHourly;
							?>
							<td style="width: 20%; color: white; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><span style="color: red;"><?= trim($varriancePcsHourly,'-'); ?></span><span><?= '/'.trim($varriancePcsCum,'-'); ?></span></td>
							<?
						}	
						?>	
						<td style="width: 10%; color: red; font-size: 2vw; font-weight:bold; text-indent:30%; vertical-align: middle;"><? if (is_nan($hourlyDhu)) echo "0.00%"; else echo trim(number_format($hourlyDhu,2),'-').'%'; ?></td>
						<td style="width: 12%; color: white; font-size: 2vw; font-weight:bold; text-indent:20%; vertical-align: middle;"><?= fn_number_format($actual_efficiency,2,'.','','0.00'); ?>%</td>
						<?			    			
						...
						{
							?>
							<td style="width: 12%; color: red; font-size: 2vw; font-weight:bold;text-indent:20%;vertical-align: middle;">
							<?= fn_number_format(trim($efficiency_variance,'-'),2,'.','','0.00'); ?>%
							</td>
							<?
						}
						else
						{
							?>
							<td style="width: 12%; color: green; font-size: 2vw; font-weight:bold;text-indent:20%; vertical-align: middle;">
							<?= fn_number_format(trim($efficiency_variance,'-'),2,'.','','0.00'); 
							?>%</td>
							<?
						}	
