...
{ 	
	...
	$sql="SELECT a.company_id as lc_company, a.prod_reso_allo, a.production_date, a.floor_id, a.item_number_id, a.po_break_down_id as po_id, a.sewing_line, sum(a.production_quantity) as good_qnty, b.job_no, b.style_ref_no, b.buyer_name, b.set_break_down as smv_pcs_set, c.po_number, c.grouping, ";
	$first=1;
	...
	$sql.=" FROM pro_garments_production_mst a, wo_po_details_master b, wo_po_break_down c
		...
		group by a.company_id, a.prod_reso_allo, a.production_date, a.floor_id, a.item_number_id, a.po_break_down_id, a.sewing_line, b.job_no, b.style_ref_no, b.buyer_name, b.set_break_down, c.po_number,c.grouping
