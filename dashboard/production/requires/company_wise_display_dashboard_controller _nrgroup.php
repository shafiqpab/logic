...
{ 	
	...
	if ($order_ids != "")
	{
		$sql_defect = "SELECT b.defect_qty as defect_qty FROM pro_garments_production_mst a, pro_gmts_prod_dft b WHERE a.id=b.mst_id and b.production_type=5 and b.po_break_down_id in($order_ids) $company_cond $txt_date_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0";
		...
		<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" rules="all" cellpadding="0" cellspacing="0">
			...
			<tr style="height: 5%;">
    			...
    			<td rowspan="3" colspan="2" style="color: white; font-size: 2vw; font-weight:bold; width: 33%; height: 75%;">
    				<table style="width: 100%;height: 100%;">
    					...
    					<tr>
    						<td colspan="2" style="border:0; text-align: center; width: 100%" align="center" ><div style="font-size: 2vw; text-align: center; vertical-align: middle;"><span>Planned</span>&nbsp;<span style="font-weight:900;"><?= number_format($planned/$countLineNumber,2); ?>%</span></div>
    						</td>
    					</tr>
    				</table> 					
    			</td>
			...
			<tr style="height: 25%; width: 100%;">
    			<td style="color: white; font-weight:bold;">
    				...
    				<div style="font-size:6vw; height: 80%; font-weight:900; text-align: right;"><span style="width: 80%; text-align: right;"><?=  $current_target; ?></span><span style="width: 20%; text-align: right;">&nbsp;&nbsp;</span></div>
    			</td>    			
			</tr>
			<tr style="height: 25%;">
    ...
    <div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none; background-color: #262626;" id="secondtime">
    	<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" border="1" rules="all" cellpadding="0" cellspacing="0">
    		<tr style="height: 8%;">    			
    			...
    			<td colspan="3" style="width: 10%; color: white; font-size: 2vw; font-weight:900; text-align: center; vertical-align: middle;">
				<?
				if ($count_hour == 0) $time='0'.$count_hour.':'.date('i', time());
				else if (date('G')==13) $time='0'.$count_hour.':00';
				else if ($count_hour==$highest_working_hour && $count_hour < 10) $time='0'.$count_hour.':00';
    			...
    			<td colspan="4" style="width: 14%; color: white; font-size: 2vw; font-weight:900; text-align: center; vertical-align: middle;"><?= date('h:i A', time()); ?></td>
			</tr>
			...
			foreach ($production_data as $line_name => $row) 
			{
				...
				$line_wise_smv_avg=$row['line_wise_total_smv']/$row['line_wise_total_order_qty'];
				...
				$line_wise_efficiency=(($row['totalProdQnty']*$line_wise_smv_avg)/(($row['man_power'])*$avg_count_hour*60))*100;
