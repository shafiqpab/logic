...
{ 	
	...
	// echo $totalProdQnty."/".$count_hour."*10";die;
	...
	$efficiency=(($totalProdQnty*$total_smv_avg)/(($operator+$helper)*($count_hour+$current_hour)*60))*100;
	...
	if($db_type==0)
	{
		...
		WHERE a.po_break_down_id=d.id and d.job_no_mst=c.job_no and a.status_active=1 and c.status_active=1 and d.status_active=1 and a.production_type in(4,5) and d.shiping_status!=3 
	...
	<div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="firsttime">
		<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" rules="all" cellpadding="0" cellspacing="0">
			<tr style="height: 8%;">
    			...
    			<td style="width: 31%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">JK Group Of Industries</td>
			...
			<tr style="height: 25%;">
    			...
    			<td style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
    				...
    				<p style="font-size: 6vw; height: 80%; text-align: right; font-weight:900;"><?= round($trend); ?>&nbsp;</p>
    			</td>
			</tr>
			<tr style="height: 25%;">
    			...
    			<td style="color: white; font-size: 2vw; font-weight:bold; text-align: right; vertical-align: middle;">
    				...
    				<p style="font-size: 6vw; height: 80%; text-align: right; color: red; font-weight:900;"><?= trim(number_format($dhu,2),'-'); ?>%&nbsp;</p>
    			</td>
			...
			<tr style="height: 8%;">
    			<td colspan="2" style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
    				<p style="font-size: 1.5vw; text-align: center; "><span>Total Line:</span>&nbsp;<span style="font-weight:900;"><?= $countLineNumber; ?>,</span>&nbsp;<span>SMV Avg:</span>&nbsp;<span style="font-weight:900;"><?= number_format($lineWiseTotalSmv/$countLineNumber,2); ?></span></p>
    			</td>
    ...
    <div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="secondtime">
    	<input type="hidden" name="idi" id="idi" value="1">
    	<input type="hidden" name="total_row" id="total_row" value="<?= (count($production_data)+(10-fmod(count($production_data), 10))); ?>">
    	<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" border="1" rules="all" cellpadding="0" cellspacing="0">
    		<tr style="height: 8%;">
    			...
    			<td colspan="2" style="width: 25%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">KPI Dashboard</td>
    			<td colspan="6" style="width: 46%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">JK Group Of Industries</td>
			...
			<tr style="height: 7%;">
    			...
    			<td style="width: 13%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle; overflow: hidden;">Buyer</td>
    			<td style="width: 12%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle; overflow: hidden;">Style</td>
    			<td style="width: 13%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle; overflow: hidden;">PO</td>
    			...
    			<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle;">Target</td>
    			<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:bold; text-align: center; vertical-align: middle;">Actual</td>
			...
			foreach ($production_data as $line_name => $row)
			{
				...
				if (date('G') == $h) $line_wise_efficiency=$line_wise_efficiency=(($row['totalProdQnty']*$line_wise_total_smv)/(($row['man_power'])*$count_hour*$current_minute))*100;
				else $line_wise_efficiency=(($row['totalProdQnty']*$line_wise_total_smv)/(($row['man_power'])*$count_hour*60))*100;
				?>
				<tr style="height: 7%; width: 100%; background-color: #595959;" id="trr_<? if ($line_name != '') echo $k; ?>">
	    			<td style="width: 5%; color: white; font-size: 1.5vw; font-weight:bold; vertical-align: middle;"><?= $line_name; ?></td>
	    			<td class="std_st" style="width: 13%; height: 7%; color: white; font-size: 1.5vw; font-weight:bold; vertical-align: middle;"><?= $final_buyerName; ?></td>
	    			<td style="width: 12%; height: 7%; color: white; font-size: 1.5vw; font-weight:bold; vertical-align: middle;"><?= $final_styleRefNo; ?></td>
	    			<td style="width: 13%; height: 7%; color: white; font-size: 1.5vw; font-weight:bold; vertical-align: middle;"><p><?= $final_poNumber; ?></p></td>
	    			<td style="width: 6%; height: 7%; color: white; font-size: 1.5vw; font-weight:bold; text-align: right; vertical-align: middle;"><?= number_format($line_wise_total_smv,2); ?></td>
	    			...
	    			<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:bold; text-align: right; vertical-align: middle;"><?= $row['current_target']; ?></td>
	    			<?
	        		if ( $row['current_target'] <= $row['totalProdQnty'] )
	        		{
	        			?>
    					<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:bold; text-align: right; vertical-align: middle;"><p><span style="width: 80%; text-align: right;"><?= $row['totalProdQnty']; ?></span>&nbsp;<span style="width: 20%; text-align: right; color: green; font-weight:900;">&#8679;</span></p></td>
    					<?
    				}
    				else
    				{
    					?>
    					<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:bold; text-align: right; vertical-align: middle;"><p><span style="width: 80%; text-align: right;"><?= $row['totalProdQnty']; ?></span>&nbsp;<span style="width: 20%; text-align: right; color: red; font-weight:900;">&#8681;</span></p></td>
    					<?
    				}
    				?>
			...
			$blank_row=10-fmod(count($production_data), 10);
			//echo count($production_data).'**'.$blank_row.'system';
			for ($i=1; $i<=$blank_row; $i++)
			{				
				?>		
				<tr style="height: 7%;" id="trr_<? echo $k; ?>">
			...
			?>
			<tr style="height: 7%;">
    			<td colspan="5" style="width: 49%; color: white; font-size: 1.5vw; font-weight:900; text-align: right; vertical-align: middle;">Total&nbsp;</td>
    			...
    			<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:900; text-align: right; vertical-align: middle;"><?= $total_current_target; ?></td>
    			<td style="width: 7%; color: white; font-size: 1.5vw; font-weight:900; text-align: right; vertical-align: middle;"><?= $total_actual; ?></td>
