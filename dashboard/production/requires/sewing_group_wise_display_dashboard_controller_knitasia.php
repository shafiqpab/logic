...
{ 	
	...
	$cbo_sewing_group=str_replace("'","",trim($cbo_sewing_group));
	...
	if ($cbo_sewing_group != "")
	{
		$sql_sewing_group="select id from lib_sewing_line where company_name=$cbo_company_id and sewing_group='$cbo_sewing_group' and status_active=1 and is_deleted=0 $location_cond2 $floor_cond2";
		$sql_sewing_group_res=sql_select($sql_sewing_group);
		$line_ids='';
		foreach($sql_sewing_group_res as $row)
		{
			$line_id="'".$row[csf('id')]."'";
			$line_ids .=  $line_id.',';
		}
	...
	$line='';
	if($cbo_sewing_group !='') $line=" and a.sewing_line in($lineIds)";
	...
	$sql.=" FROM pro_garments_production_mst a, wo_po_details_master b, wo_po_break_down c
		where a.production_type in (5) and a.po_break_down_id=c.id and c.job_no_mst=b.job_no and a.status_active=1 and a.is_deleted=0 $company_cond $location_cond $floor_cond $txt_date_cond $line
	...
	//echo '<pre>';print_r($production_datas);
	//echo $total_smv;	\
	...
	{
		//echo $val['current_target'].'system';
	...
	//echo $totalProdQnty.'**'.$smv_average.'**'.$operator.'**'.$helper.'**'.$count_hour;
	...
	<div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="firsttime">
		<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" rules="all" cellpadding="0" cellspacing="0">
			<tr style="height: 8%;">    			
    			<td style="width: 30%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $cbo_sewing_group; ?></td>
    			<td style="width: 31%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $cbo_company_name; ?></td>
    			<td style="width: 19%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $cbo_location_name; ?></td>
			...
			<tr style="height: 8%;">
    			<td style="color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;">
    				<div style="font-size: 2vw; text-align: center; "><span>Line Nos:</span>&nbsp;<span style="font-weight:900;"><?= $countLineNumber; ?>,</span>&nbsp;<span>SMV Avg:</span>&nbsp;<span style="font-weight:900;"><?= number_format($smv_average,2); ?></span></div>
    			</td>
    ...
    <div style="width:100%; height: <? echo $max_height; ?>px; font-family: Arial, Helvetica, sans-serif; display: none;" id="secondtime">
    	<table style="width: 100%; height: 100%; background-color: #262626; overflow: hidden; clear: both; margin-left: 0; float: left;" class="rpt_table" border="1" rules="all" cellpadding="0" cellspacing="0">
    		<tr style="height: 8%;">    			
    			<td colspan="3" style="width: 30%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $cbo_sewing_group; ?></td>
    			...
    			<td colspan="3" style="width: 17%; color: white; font-size: 2vw; font-weight:bold; text-align: center; vertical-align: middle;"><?= $cbo_location_name; ?></td>
