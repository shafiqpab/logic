...
{ 	
	...
	foreach($start_time_line_wise_arr as $time_val)
	{
		...
		$line_wise_tot_mins=($today_current_hours[0]*60+$today_current_hours[1])-($line_wise_start_time[0]*60+$line_wise_start_time[1]);
	...
	$current_hour_avg_time=$count_prod_hours_mins/60;
	...
	$trend=$totalProdQnty/$current_hour_avg_time*11;
   ...
   //echo $total_poduce_min;
	...
	$efficiency=(($totalProdQnty*$smv_average)/(($operator+$helper)*$current_hour_avg_time*60))*100;
	?>
