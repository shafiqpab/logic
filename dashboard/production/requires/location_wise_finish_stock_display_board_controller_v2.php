...
{
	$data=explode("_",$data);
	echo create_drop_down( "cbo_location", "", "SELECT id,location_name from lib_location where company_id='$data[0]' and status_active =1 and is_deleted=0 order by location_name","id,location_name", 1, "-- Select Location --", 0, "load_drop_down('requires/location_wise_finish_stock_display_board_controller_v2', $data[0]+'_'+this.value, 'load_drop_down_store','store_td');" );
	exit();
}
