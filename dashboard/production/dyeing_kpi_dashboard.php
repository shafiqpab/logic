...
Update date     :   
Rim Pack Co.
http://localhost/platform-v3.5/dashboard/production/dyeing_kpi_dashboard.php?url=Fakir Fashion Ltd.
*/
//http://27.147.151.44/erp_test/dashboard/production/dyeing_kpi_dashboard.php?url=Fakir Fashion Ltd.
...
<script> 
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/dyeing_kpi_dashboard_controller.php',
                data:data,
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'";
        //alert(data);
        http.open("POST","requires/dyeing_kpi_dashboard_controller.php",true);
