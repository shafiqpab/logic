           	...
           	<legend>Job Card Details</legend>
                <table cellpadding="0" cellspacing="2" border="0" class="rpt_table" rules="all" id="tbl_dtls_emb">
                    ...
                    <tbody id="emb_details_container">
                        <tr id="row_1">
                            <td><input id="txtbuyerPo_1" name="txtbuyerPo[]" type="text" class="text_boxes" style="width:100px;" placeholder="Display" disabled="disabled" />
                            	<input id="txtbuyerPoId_1" name="txtbuyerPoId[]" type="hidden" class="text_boxes" style="width:70px" readonly />
                            </td>
                            <td><input id="txtstyleRef_1" name="txtstyleRef[]" type="text" class="text_boxes" style="width:100px" placeholder="Display"  disabled="disabled" /></td>
                            <td><input id="txtdescription_1" name="txtdescription[]" type="text" class="text_boxes" style="width:100px" placeholder="Click" disabled="disabled" /></td>
                            <td><input id="txtcolor_1" name="txtcolor[]" type="text" class="text_boxes" style="width:100px" placeholder="Display"  disabled="disabled" />
                            	<input id="txtcolorID_1" name="txtcolorID[]" type="hidden" class="text_boxes" style="width:100px" placeholder="Display"  disabled="disabled" /></td>
                            <td><input id="txtsize_1" name="txtsize[]" type="text" class="text_boxes" style="width:100px" placeholder="Display"  disabled="disabled" />
							<input id="txtsizeID_1" name="txtsizeID[]" type="hidden" class="text_boxes" style="width:100px" placeholder="Display"  disabled="disabled" />
                            </td>
							...
							<td><input id="txtImpression_1" name="txtImpression[]" type="text" class="text_boxes_numeric" style="width:100px" placeholder="Write"/></td>
