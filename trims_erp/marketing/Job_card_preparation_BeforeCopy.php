...
<script>
	...
	function openmypage_row_metarial(type,booking_dtls_id,row)
	{
		...
		var page_link = 'requires/Job_card_preparation_controller.php?within_group='+within_group+'&data_break='+data_break+'&order_qty='+order_qty+'&company='+company+'&txtJobQuantity='+txtJobQuantity+'&hdnDtlsUpdateId='+hdnDtlsUpdateId+'&action=row_metarial_popup';
