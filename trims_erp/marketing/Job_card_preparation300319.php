...
<script>
	...
	function fnc_job_order_entry( operation )
	{
		...
		$("#tbl_dtls_emb tbody tr").each(function()
		{
			...
			if(txtdescription=='' || txtcolor=='' || txtsize=='' || txtJobQuantity=='' || txtRawMat=='' || txtImpression=='' || txtImpression==0|| txtRawcolor=='')
			{
				...
				else if(txtImpression=='')
				{
					alert('Please Fill up Impression');
					check_field=1 ; return;
				}
				else if(txtRawcolor=='')
				{
					alert('Please Fill up Color');
					check_field=1 ; return;
				}
				return;
			}
			j++; i++;
			data_all += "&txtbuyerPoId_" + j + "='" + txtbuyerPoId + "'&txtbuyerPo_" + j + "='" + txtbuyerPo + "'&txtstyleRef_" + j + "='" + txtstyleRef + "'&txtdescription_" + j + "='" + txtdescription + "'&txtcolor_" + j + "='" + txtcolor + "'&txtcolorID_" + j + "='" + txtcolorID + "'&txtsize_" + j + "='" + "'&txtsizeID_" + j + "='" + txtsizeID + "'&cboUom_" + j + "='" + cboUom + "'&txtJobQuantity_" + j + "='" + txtJobQuantity + "'&txtRawMat_" + j + "='" + txtRawMat + "'&txtImpression_" + j + "='" + txtImpression + "'&txtRawcolor_" + j + "='" + txtRawcolor +"'&hdnDtlsdata_" + j + "='" + hdnDtlsdata +"'&hdnbookingDtlsId_" + j + "='" + hdnbookingDtlsId+"'&hdnDtlsUpdateId_" + j + "='" + hdnDtlsUpdateId+"'&bookConDtlsId_" + j + "='" + bookConDtlsId+"'&hdnRecDtlsIDs_" + j + "='" + hdnRecDtlsIDs+"'&hdnBreakIDs_" + j + "='" + hdnBreakIDs + "'";
		});
	...
	function openmypage_row_metarial(type,booking_dtls_id,row)
	{
		...
		var page_link = 'requires/Job_card_preparation_controller.php?within_group='+within_group+'&data_break='+data_break+'&order_qty='+order_qty+'&company='+company+'&action=row_metarial_popup';
           	...
           	<legend>Trims Order Receive Details Entry</legend>
                <table cellpadding="0" cellspacing="2" border="0" class="rpt_table" rules="all" id="tbl_dtls_emb">
                    <thead class="form_table_header">
                        ...
                        <th width="80" class="must_entry_caption">Impression</th>
