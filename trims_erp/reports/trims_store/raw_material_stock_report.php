                    ...
                    <tbody>
                        <tr class="general">
                            ...
                            <td>
								...
								<input type="button" name="search" id="search" value="MRR WISE" onClick="generate_report(2)" style="width:70px" class="formbutton" />
                            </td>
                        </tr>
                    </tbody>
                    <tfoot>
