											...
											foreach($job_id_data as $row_desc=> $row_desc_data)
											{
												...
												foreach($row_desc_data as $unit=> $row)
												{
													...
													<? } ?>
														...
														<? if($order_uom_rowspan==0){ ?> <td align="right" width="100" rowspan="<? echo $order_uom_rowspan_arr[$rcv_id][$order_id][$item_group_id][$item_id][$description][$color_id][$order_uom]; ?>"><p><?  echo $row['order_qty'] ; ?></p></td><? } ?>
														...
														<? if($order_uom_rowspan==0){ ?> <td align="right" width="100" rowspan="<? echo $order_uom_rowspan_arr[$rcv_id][$order_id][$item_group_id][$item_id][$description][$color_id][$order_uom]; ?>"><p><?  echo $del_qty ; ?></p></td><? } ?>
														<? if($order_uom_rowspan==0){ ?> <td align="right" rowspan="<? echo $order_uom_rowspan_arr[$rcv_id][$order_id][$item_group_id][$item_id][$description][$color_id][$order_uom]; ?>"><p><?  echo $del_bal ; ?></p></td><? } ?>
