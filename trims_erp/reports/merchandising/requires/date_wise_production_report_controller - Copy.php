...
{	
	...
	if ($data[0]!="") $woorder_cond=" and a.booking_no = '$data[0]' "; 
...
if($action=="generate_report")
{
	...
	//////////////////////////////////////////////////////////////////
		...
		if(trim($txt_order_no)!="")
		{
				...
				$sql_cond="and d.order_no='$txt_order_no'";
				$sql_order_no="and a.order_no='$txt_order_no'";
		}
	...
	//print_r($booked_array)."mahbub";
	   $trims_order_sql=" select a.party_id,a.production_date,a.received_id,a.section_id,b.qc_qty,b.job_dtls_id,b.uom as product_uom,c.sub_section,b.machine_id,c.conv_factor,c.job_quantity,c.uom ,c.buyer_po_no,c.item_description,c.job_no_mst,c.break_id,d.order_no from trims_production_mst a,trims_production_dtls b,trims_job_card_dtls c ,trims_job_card_mst d  where  a.id=b.mst_id and c.id=b.job_dtls_id  and   c.mst_id=d.id and  a.entry_form=269 and  d.entry_form=257  and   a.company_id =$cbo_company_id  and  a.status_active=1 and b.status_active=1 and c.status_active=1 $where_con $sql_cond  group by a.party_id,a.production_date,a.received_id,a.section_id,b.job_dtls_id,c.sub_section,c.conv_factor,c.job_quantity,c.uom,c.buyer_po_no,c.item_description,c.job_no_mst,b.qc_qty,c.break_id,b.uom,b.machine_id,d.order_no"; 
		$result = sql_select($trims_order_sql);
        $date_array=array();
        foreach($result as $row)
        {
       	 	$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['section_id']=$row[csf('section_id')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['sub_section']=$row[csf('sub_section')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['production_date']=$row[csf('production_date')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['job_dtls_id']=$row[csf('job_dtls_id')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['received_id']=$row[csf('received_id')];
       		$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['job_quantity']=$row[csf('job_quantity')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['uom']=$row[csf('uom')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['conv_factor']=$row[csf('conv_factor')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['buyer_po_no']=$row[csf('buyer_po_no')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['item_description']=$row[csf('item_description')];			            
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['job_no_mst']=$row[csf('job_no_mst')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['qc_qty']+=$row[csf('qc_qty')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['break_id']=$row[csf('break_id')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['product_uom']=$row[csf('product_uom')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['machine_id']=$row[csf('machine_id')];
			$date_array[$row[csf('section_id')]][$row[csf('sub_section')]][$row[csf('item_description')]][$row[csf('order_no')]][$row[csf('job_no_mst')]]['order_no']=$row[csf('order_no')];
 }
...
//print_r($date_array);
  ...
  $sammary_sql=" select a.party_id,a.production_date,a.received_id,a.section_id,b.qc_qty,b.job_dtls_id,b.uom as product_uom,c.sub_section,b.machine_id,c.conv_factor,c.job_quantity,c.uom ,c.buyer_po_no,c.item_description,c.job_no_mst,c.break_id,d.order_no from trims_production_mst a,trims_production_dtls b,trims_job_card_dtls c ,trims_job_card_mst d  where  a.id=b.mst_id and c.id=b.job_dtls_id  and   c.mst_id=d.id and  a.entry_form=269 and  d.entry_form=257  and   a.company_id =$cbo_company_id  and  a.status_active=1 and b.status_active=1 and c.status_active=1 $where_con $sql_cond  group by a.party_id,a.production_date,a.received_id,a.section_id,b.job_dtls_id,c.sub_section,c.conv_factor,c.job_quantity,c.uom,c.buyer_po_no,c.item_description,c.job_no_mst,b.qc_qty,c.break_id,b.uom,b.machine_id,d.order_no"; 
        ...
        foreach($sammary_result as $row)
        {
			...
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['qc_qty']+=$row[csf('qc_qty')];
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['break_id']=$row[csf('break_id')];
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['received_id']=$row[csf('received_id')];
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['conv_factor']=$row[csf('conv_factor')];
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['item_description']=$row[csf('item_description')];
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['job_no_mst']=$row[csf('job_no_mst')];
			$sammary_array[$row[csf('section_id')]][$row[csf('sub_section')]]['order_no']=$row[csf('order_no')];
 		}
	...
	<div align="center" style="height:auto; width:<? echo $width+20;?>px; margin:0 auto; padding:0;">
        	...
        	<table border="1" cellpadding="2" cellspacing="0" class="rpt_table" id="table_body_id" width="<? echo $width;?>" rules="all" align="left">
             <? 
						...
						foreach($sub_section_key_data as $item_description_id=>$item_description_data)
						{
							foreach($item_description_data as $order_no_id=>$order_no_data)
							{
								foreach($order_no_data as $job_no_mst_id=>$row)
								{
									...
									//$orderquantity=$booked_array[$row[csf('section')]][$row[csf('sub_section')]][$row[csf('description')]][$row[csf('order_no')]][$row[csf('subcon_job')]]['order_quantity'];
                ...
                <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                    ...
                    <td width="100" align="center"><? echo change_date_format($row[production_date]);?></td>
                    <td width="100" align="center"><? echo change_date_format($order_array[$row[received_id]]['receive_date']) ;?></td>
                    <td width="100" align="center"><? echo change_date_format($order_array[$row[received_id]]['delivery_date']); ?></td>
                    <td width="100" align="center"><? echo $order_array[$row[received_id]]['cust_order_no'] ;?></td>
                    <td width="100" align="center"><? echo 	 $party=($order_array[$row[received_id]]['within_group']==1)?$companyArr[$order_array[$row[received_id]]['party_id']]:$buyerArr[$order_array[$row[received_id]]['party_id']];?></td>
                    <td width="100" align="center"><? echo $buyerArr[$order_array[$row[received_id]]['buyer_buyer']];?>e</td>
                    <td width="100" align="center"><? echo $row[buyer_po_no];?></td>
                    <td width="150" align="center"><? echo $row[item_description];?></td>
                    <td width="100" align="right"><? echo number_format($orderquantity,4);?></td>
                    <td width="60" align="center"><? echo $unit_of_measurement[$row[uom]];?></td>  
                    <td width="60" align="center"><? echo $takarate;?></td>
                    <td width="60" align="center"><? echo $usdrate;?></td>
                    <td width="100" align="right"><? echo number_format($orderamounttaka,4); $total_orderamount_taka+=$orderamounttaka;//echo //$orderquantity*$takarate;?></td>
                    <td width="100" align="right"><? echo number_format($orderamountusd,4); $total_orderamount_usd+=$orderamountusd; ?></td>
                    <td width="100" align="center"><? echo $row[job_no_mst]; ?></td>
                    <td width="80" align="center"><? echo $row[conv_factor];?></td>
                    <td width="80" align="right"><? echo number_format($orderquantity*$row[conv_factor],4);//$booked_array[$row[break_id]]['booked_qty'];?></td>
                    <td width="80" align="center"><? echo $unit_of_measurement[$row[product_uom]];?></td>
                    <td width="100" align="right"><? echo number_format($row[qc_qty],4);?></td>
                    <td width="100" align="right"><? echo number_format($row[qc_qty]/$row[conv_factor],4);?></td>
                    <td width="150" align="center"><? echo $machine_noArr[$row[machine_id]];?></td>
                    <td width="100" align="right"><? echo number_format($product_valu_taka,4);$total_product_valu_taka+=$product_valu_taka;?></td>
                    <td width="100" align="right"><? echo number_format($product_valu_usd,4); $total_product_valu_usd+=$product_valu_usd;?></td>
        ...
        <table width="<? echo $width;?>" border="1" cellpadding="2" cellspacing="0" class="rpt_table" rules="all" id="table_body_footer" align="left">
				<tfoot>
                    ...
                    <th width="100"><? echo number_format($total_orderamount_taka,4);?></th>
                    <th width="100"><? echo number_format($total_orderamount_usd,4);?></th>
                    <th width="100"></th>
                    <th width="80"></th>
                    <th width="80"></th>
                    <th width="80"></th>
                    ...
                    <th width="100"></th>
                    <th width="150"></th>
                    <th width="100"><? echo number_format($total_product_valu_taka,4);?></th>
                    <th width="100"><? echo number_format($total_product_valu_usd,4);?></th>
                    <th width="100"></th>
                    <th></th>
				</tfoot>
			</table>
    ...
    <div align="left" style="height:auto; width:500px; margin:0 auto; padding:0;">
    	<table width="500" cellpadding="0" cellspacing="0" id="caption" align="left">
			...
			//$booked_sammary_array[$row[csf('section')]][$row[csf('sub_section')]]['amount']+=$row[csf('amount')];
						...
						//$orderquantity=$booked_sammary_array[$row[section_id]][$row[sub_section]]['order_quantity'];
						//$orderamount=$booked_sammary_array[$row[section_id]][$row[sub_section]]['amount'];
						
						
						$rate=number_format($orderamount/$orderquantity,4);
						$currency_id=$order_array[$row[received_id]]['currency_id'];
						
						//echo $orderquantity.'--'.$orderamount.'--'.$rate.'--'.$row[qc_qty].'--'.$row[conv_factor];
					...
					elseif($currency_id==2)
					{
						...
						?>
                           <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $t; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $t; ?>">
                            ...
                            <td width="100" align="center"><? echo $trims_section[$row[section_id]];?></td>
                            <td width="100" align="center"><? echo $trims_sub_section[$row[sub_section]];?></td>
                            <td align="right"><? echo number_format($product_valu_usd,2);  $section_total+=$product_valu_usd;?></td>
                           </tr>
                    ...
                    <tr style="background-color:#CCC">
                   	 	<td colspan="3" align="right"><? echo $trims_section[$row[section_id]];?></td>
                    	<td align="right"><? echo $section_total;?></td>
                    </tr>
                 	<?
				} 
				?>
