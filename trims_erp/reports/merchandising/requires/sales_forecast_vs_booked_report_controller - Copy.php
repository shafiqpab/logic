			...
			<table  border="1" cellpadding="2" cellspacing="0" class="rpt_table" width="<? echo $width;?>" rules="all" id="rpt_table_header" align="left">
				<thead>
                    <tr>
						...
						<th rowspan="2" width="120">Team Member</th>
						<th rowspan="2" width="120">Section</th>
			...
			<?
				...
				?>
				 <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
					...
					<td rowspan="<? echo count($section_row);?>" valign="middle" width="120"><? echo $trims_section[$section_id];?></td>
                    <td rowspan="<? echo count($section_row);?>" valign="middle" width="120"><? echo $trims_section[$section_id];?></td>
                    <td rowspan="<? echo count($section_row);?>" valign="middle" width="120"><? echo $trims_section[$section_id];?></td>
                    <td rowspan="<? echo count($section_row);?>" valign="middle" width="120"><? echo $trims_sub_section[$sub_section_id];?></td>
				<?
                $flag=1;
			...
			<table width="<? echo $width;?>" border="1" cellpadding="2" cellspacing="0" class="rpt_table" rules="all" id="table_body_footer" align="left">
				<tfoot>
					<tr>
						...
						<th width="120"></th>
                        <th width="120"></th>
                        <th align="right" width="120">Grand Total</th>
						<th width="120"></th>
						<? foreach($month_arr as $my){?>
