                ...
                <table class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
                    ...
                    <tbody>
                        <tr class="general">
                            <td>
                                <? 
									echo create_drop_down( "cbo_company_id",120,"select comp.id, comp.company_name from lib_company comp where comp.core_business!=1 and comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "--Select Company--", $selected, "load_drop_down( 'requires/order_wise_production_and_delivery_report_controller', this.value, 'load_drop_down_location', 'location_td');","","","","","",2);
                                ?>                            
                            </td>
                            <td>
                                <? 
                        ...
                        <td>
                            <input type="button" name="search" id="search" value="Without Rate" onClick="generate_report(2)" style="width:80px" class="formbutton" />
                        </td>
                        </tr>
                        <tr>
