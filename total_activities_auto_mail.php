...
$str_cond_a = "and  a.insert_date between '10-Oct-2017' and '17-Oct-2017 11:59:59 PM' ";
    ...
    <table width="920">
        <tr>
            <td valign="top" align="center">
                <strong><font size="+2">Total Activities of ( Date :<?  echo date("d-m-Y", strtotime($prev_date));  ?>)</font></strong>
            </td>
        </tr>
        <tr>
            <td valign="top" align="center">
                 ...
                 <table width="100%" cellpadding="0" cellspacing="0" rules="all" border="1">
                    ...
                    <tr>
                    	<tfoot bgcolor="#EEE">
                            ...
                            <th align="right"><? echo fn_remove_zero($totalQty[1]['po_val']+$totalQty[1]['po_val'],2);  ?></th>
                            <th align="right">
                            	<?
									$grand_rate=($totalQty[1]['po_val']+$totalQty[1]['po_val'])/($totalQty[1]['po_qty']+$totalQty[2]['po_qty']);
        ...
        <tr>
            <td valign="top" align="left">
                 <table width="100%" cellpadding="0" cellspacing="0" rules="all" border="1">
                 	<tr>
                 		<td colspan="7" height="40" align="center"><strong>Back to Back Open</strong></td>
                 	</tr>
                    <tr>
                    	<td width="50" align="center"><strong>SL</strong></td>
                        ...
                        <td width="100" align="center"><strong>LC Number </strong></td>
                        <td width="200" align="center"><strong>Catg Total</strong></td>
                        <td width="200" align="center"><strong>Supplier Total</strong></td>
                    </tr>
                    <?
						$i=0;$tot_bb_value=0;
						
                    	$sql_back_back="Select supplier_id, sum(lc_value) as lc_value, item_category_id, lc_number from com_btb_lc_master_details where importer_id like '$compid' and status_active=1 and is_deleted=0 $str_cond group by supplier_id,item_category_id,lc_number";  //echo $sql_back_back;
        ...
        <tr>
            <td valign="top" align="left">
                 <table width="100%" cellpadding="0" cellspacing="0" border="1" rules="all">
                 	<tr>
                 		<td colspan="9" height="40" align="center"><strong>Yarn Received</strong></td>
                 	</tr>
                    ...
                    <?
						...
						where d.id=a.supplier_id and c.id=a.mst_id and b.id=a.prod_id and c.entry_form=1 and a.company_id like '$compid' and a.item_category=1 and a.transaction_type=1 and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 $str_cond_a 
            ...
            <td valign="top" align="left">
                 <table width="100%" cellpadding="0" cellspacing="0" rules="all" border="1">
                    ...
                    <?
						...
						//$sql = "select c.buyer_name, a.production_quantity, a.reject_qnty, a.alter_qnty, a.spot_qnty, b.unit_price from pro_garments_production_mst a,wo_po_break_down b,wo_po_details_master c where a.po_break_down_id=b.id and b.job_no_mst=c.job_no and a.company_id like '$compid' and a.production_type=5 and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 and c.is_deleted=0 and c.status_active=1 $str_cond_a";and b.shiping_status=1
...
<?
		...
		$to="";
		$sql2 = "SELECT c.email_address FROM mail_group_mst a, mail_group_child b, user_mail_address c where b.mail_group_mst_id=a.id and a.mail_item=2 and b.mail_user_setup_id=c.id and a.company_id=$compid";
		...
		$subject="Total Activities of ( Date :".date("d-m-Y", strtotime($prev_date)).")";
