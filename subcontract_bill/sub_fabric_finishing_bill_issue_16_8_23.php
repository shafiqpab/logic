...
function openmypage_booking()
	{
		...
		var page_link='requires/sub_fabric_finishing_bill_issue_controller.php?action=booking_no_popup&companyID='+companyID+'&location_name='+location_name+'&cbo_booking_year='+cbo_booking_year+'&txt_book_no='+txt_book_no;
