...
<script type="text/javascript">
	...
	function fnc_knitting_bill_entry( operation )
	{
		...
		else
		{
			...
			var data1="action=save_update_delete&operation="+operation+"&tot_row="+tot_row+get_submitted_data_string('txt_bill_no*cbo_company_id*cbo_location_name*txt_bill_date*cbo_supplier_company*cbo_bill_for*txt_upcharge*txt_discount*txt_party_bill_no*cbo_party_source*cbo_party_name*update_id',"../");
	...
	function fnc_populate_list_view()
	{
		...
		show_list_view(document.getElementById('cbo_company_id').value+'***'+document.getElementById('cbo_location_name').value+'***'+document.getElementById('cbo_bill_for').value+'***'+document.getElementById('cbo_supplier_company').value+'***'+document.getElementById('txt_bill_form_date').value+'***'+document.getElementById('txt_bill_to_date').value+'***'+document.getElementById('update_id').value+'***'+document.getElementById('txt_job_id').value+'***'+document.getElementById('cbo_party_source').value+'***'+document.getElementById('cbo_party_name').value,'knitting_entry_list_view','knitting_info_list','requires/outside_knitting_bill_entry_controller','setFilterGrid("tbl_list_search",-1);','','');
	}
        ...
        <table style="border:none; width:980px;" cellpadding="0" cellspacing="1" border="0" id="tb_bill_ent">
            ...
            <tbody id="bill_issue_table">
                <tr align="center">				
					...
					<td><? echo create_drop_down( "cbouom_1", 50, $unit_of_measurement,"", 1, "-UOM-",$selected,"",0,'1,2,12',"" ); ?></td>                    
