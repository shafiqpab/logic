         ...
         <div id="content_search_panel" style="width:1130px" >      
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" align="center" rules="all" border="1">
                <thead>                    
					...
					<th width="" class="must_entry_caption">     <input type="reset" id="reset_btn" class="formbutton" style="width:50px" value="Reset" onClick="reset_form('machinewiseproduction_1','report_container*report_container2','','','')" /></th>
                </thead>
                <tbody>
                    <tr>
                        <td> 
