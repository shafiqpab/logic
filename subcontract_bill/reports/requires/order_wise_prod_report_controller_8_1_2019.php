...
{ 
    ...
    <div style="width:2250px"> 
        ...
        <div style="float:left; width:750px">
            <table width="890" cellspacing="0" border="1" class="rpt_table" rules="all" id="" >
                <thead>
                    <tr>
                        <th width="40">Sl.</th>    
            ...
            <div style="max-height:425px; width:910px" >
                <table cellspacing="0" border="1" class="rpt_table"  width="890" rules="all" id="" >
                    ...
                    <table border="1" class="tbl_bottom"  width="890" rules="all" id="" >
                        <tr> 
                            <td width="40">&nbsp;</td> 
                ...
                <div>
                    ...
                    <table width="2080" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
                        <thead>
                            <tr>
                                <th width="40">SL</th>    
                                <th width="100">Order Number</th>
                                ...
                                <th width="80">Total Sew In Qty.----</th>
                                <th width="80">Total Sew Qty</th>
                                <th width="80">Total Fini Qty.---</th>
                    ...
                    <div style="max-height:425px; width:2110px" id="scroll_body">
                        <table border="1" class="rpt_table"  width="2080" rules="all" id="table_body" >
					<? 
						...
						$order_sql="SELECT a.party_id,a.job_no_prefix_num,c.id, c.order_no,c.delivery_date, $cust_style_ref, sum(c.order_quantity) as order_quantity, sum(c.amount) as order_value from subcon_ord_mst a, subcon_ord_dtls c, lib_buyer d where c.job_no_mst=a.subcon_job and a.party_id=d.id and a.status_active=1 $company_name $buyer_name $location $floor $txt_date $order_no_cond group by a.party_id, c.id, c.order_no, a.job_no_prefix_num, c.delivery_date order by a.party_id ASC";
                                ...
                                <table border="1" class="tbl_bottom"  width="2080" rules="all" id="report_table_footer_1" >
                                    <tr>
                                        <td width="40"></td>
                                        <td width="100"></td>
                                        <td width="100"></td>
