...
{ 
	if ($type == 1 || $type == 2) 
	{
		...
		from subcon_delivery_mst a, subcon_delivery_dtls b where a.id=b.mst_id and a.status_active=1 and a.is_deleted=0 $del_date_cond group by b.order_id";
				...
				foreach ($job_sql_result as $row)
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" style="vertical-align:middle" height="25" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">	
						...
						<?
			                ...
			                {
			                    ?>
			                    <td width="80" align="right"><p><a href="##" onclick="show_progress_report_details('batch_qty_pop_up','<? echo $row[csf("id")]; ?>_summary','850px')"><? echo number_format($batch_qty,2); ?></a></p></td>
			            ...
			            <td width="80" align="right"><p><a href="##" onclick="show_progress_report_details('delivery_qty_pop_up','<? echo $row[csf("id")]; ?>_<? echo $row[csf('main_process_id')]; ?>_<?echo $date_from;?>_<?echo $date_to;?>','850px')"><? echo number_format($del_qty,2); ?></a></p></td>
	        ...
	        <table width="<? echo $tbl_width; ?>" border="1" cellpadding="0" cellspacing="0" rules="all" class="rpt_table">
	            <thead>
	            	<tr>
		                ...
		                <th width="80">Dyeing Production [Grey]</th>
		    ...
		    <div style="max-height:400px; overflow-y:scroll; width:<? echo $tbl_width+20; ?>px" id="scroll_body">
				...
				foreach ($job_sql_result as $row)
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" style="vertical-align:middle" height="25" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">	
			            ...
			            <td width="80" align="right"><p><a href="##" onclick="show_progress_report_details('delivery_qty_pop_up','<? echo $row[csf("id")]; ?>_<? echo $row[csf('main_process_id')]; ?>_summary','850px')"><? echo number_format($del_qty); ?></a></p></td>
			            <td width="80" align="right"><p><a href="##" onclick="show_progress_report_details('delivery_qty_fin_pop_up','<? echo $row[csf("id")]; ?>_<? echo $row[csf('main_process_id')]; ?>','850px')"><? echo number_format($del_qty_fin); ?></a></p></td>
