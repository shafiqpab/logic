<?
/*-------------------------------------------- Comments
Purpose			: 	This form will Create Order Wise Knitting Dyeing Reprot
Functionality	:	
JS Functions	:
...
<script>
	...
	function fn_report_generated()
	{
		...
		if(j_number!="" || job_number!="" || order_no!="" || hidden_order!="" || style_number!="")
		{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_buyer_id*cbo_year*txt_job_no*hid_job_id*txt_order_no*hid_order_id*txt_style_no*cbo_type*txt_date_from*txt_date_to',"../../");
		//alert(data);return;
		freeze_window(5);
		http.open("POST","requires/order_wise_knit_dyeing_report_controller.php",true);
	...
	{ 
		...
		var page_link="requires/order_wise_knit_dyeing_report_controller.php?action=job_no_popup&company_id="+company_name+"&cbo_buyer_name="+cbo_buyer_name+"&year="+year;
	...
	{ 
		...
		var page_link="requires/order_wise_knit_dyeing_report_controller.php?action=order_number_popup&company_name="+company_name+"&buyer_name="+buyer_name+"&year="+year+"&job_number="+job_number;
...
{ 
	...
	var page_link="requires/order_wise_knit_dyeing_report_controller.php?action=batch_no_popup&company_name="+company_name+"&hid_order_id="+hid_order_id;
	...
	{ 
		...
		var company_name=document.getElementById('cbo_company_name').value;
		var page_link="requires/order_wise_knit_dyeing_report_controller.php?action=batchextensionpopup&company_name="+company_name+"&buyer_name="+buyer_name+"&year="+year+"&job_number_show="+job_number_show+"&batch_number_show="+batch_number_show+"&batch_number_hidden="+batch_number_hidden;
		//var page_link="requires/order_wise_knit_dyeing_report_controller.php?action=batchextensionpopup&company_name="+company_name; 
		var title="Batch Number";
             ...
             <fieldset style="width:1050px;">
                 <table class="rpt_table" width="1050" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    <thead>
                        ...
                        <th>Style No</th>
                        <th>Report Type</th>
                        <th class="must_entry_caption">Ship Date</th>
                    ...
                    <tbody>
                        <tr class="general">
                            ...
                            <td>
								<?
									$search_by_arr=array(1=>"Order Wise Knitting",2=>"Order Wise Dyeing");
									echo create_drop_down( "cbo_type",150, $search_by_arr,"",0, "", "",'',0 );
                                ?>
                            </td>
