	...
	function window_close( uid )
	{
		...
		if(uid==0)
		{
			...
			for (var k=1; k<=list_tot_row; k++)
			{
				...
				if(bill_source==1)
				{
					trid=split_str[2]+"_"+split_str[3]+"_"+split_str[12]+"_"+split_str[10]+"_"+split_str[8]+"_"+split_str[24]+"_"+split_str[20]+"_"+split_str[25];
					//alert(trid);
				}
				...
				for(var i=1; i<=tot_row; i++)
				{
					...
					else
					{
						if(source==2)
						{
							...
							data2+="&deleverydate_" + z + "='" + $('#deleverydate_'+i).val()+"'"+"&challenno_" + z + "='" + $('#challenno_'+i).val()+"'"+"&ordernoid_" + z + "='" + $('#ordernoid_'+i).val()+"'"+"&stylename_" + z + "='" + $('#stylename_'+i).val()+"'"+"&buyername_" + z + "='" + $('#buyername_'+i).val()+"'"+"&itemid_" + z + "='" + $('#itemid_'+i).val()+"'"+"&compoid_" + z + "='" + $('#compoid_'+i).val()+"'"+"&bodypartid_" + z + "='" + $('#bodypartid_'+i).val()+"'"+"&cbouom_" + z + "='" + $('#cbouom_'+i).val()+"'"+"&numberroll_" + z + "='" + $('#numberroll_'+i).val()+"'"+"&deliveryqnty_" + z + "='" + $('#deliveryqnty_'+i).val()+"'"+"&deliveryqntypcs_" + z + "='" + $('#deliveryqntypcs_'+i).val()+"'"+"&libRateId_" + z + "='" + $('#libRateId_'+i).val()+"'"+"&txtrate_" + z + "='" + $('#txtrate_'+i).val()+"'"+"&amount_" + z + "='" + $('#amount_'+i).val()+"'"+"&remarksvalue_" + z + "='" + $('#remarksvalue_'+i).val()+"'"+"&deliveryid_" + z + "='" + $('#deliveryid_'+i).val()+"'"+"&curanci_" + z + "='" + $('#curanci_'+i).val()+"'"+"&updateiddtls_" + z + "='" + $('#updateiddtls_'+i).val()+"'"+"&collarcuff_" + z + "='" + $('#collarcuff_'+i).val()+"'"+"&recchallanno_" + z + "='" + $('#recchallanno_'+i).val()+"'";
						}
						else
						{
								data2+="&deleverydate_" + z + "='" + $('#deleverydate_'+i).val()+"'"+"&challenno_" + z + "='" + $('#challenno_'+i).val()+"'"+"&ordernoid_" + z + "='" + $('#ordernoid_'+i).val()+"'"+"&stylename_" + z + "='" + $('#stylename_'+i).val()+"'"+"&buyername_" + z + "='" + $('#buyername_'+i).val()+"'"+"&itemid_" + z + "='" + $('#itemid_'+i).val()+"'"+"&compoid_" + z + "='" + $('#compoid_'+i).val()+"'"+"&bodypartid_" + z + "='" + $('#bodypartid_'+i).val()+"'"+"&cbouom_" + z + "='" + $('#cbouom_'+i).val()+"'"+"&numberroll_" + z + "='" + $('#numberroll_'+i).val()+"'"+"&deliveryqnty_" + z + "='" + $('#deliveryqnty_'+i).val()+"'"+"&deliveryqntypcs_" + z + "='" + $('#deliveryqntypcs_'+i).val()+"'"+"&libRateId_" + z + "='" + $('#libRateId_'+i).val()+"'"+"&txtrate_" + z + "='" + $('#txtrate_'+i).val()+"'"+"&amount_" + z + "='" + $('#amount_'+i).val()+"'"+"&remarksvalue_" + z + "='" + $('#remarksvalue_'+i).val()+"'"+"&deliveryid_" + z + "='" + $('#deliveryid_'+i).val()+"'"+"&curanci_" + z + "='" + $('#curanci_'+i).val()+"'"+"&updateiddtls_" + z + "='" + $('#updateiddtls_'+i).val()+"'"+"&collarcuff_" + z + "='" + $('#collarcuff_'+i).val()+"'"+"&recchallanno_" + z + "='" + $('#recchallanno_'+i).val()+"'";
    ...
    <legend>Knitting Bill Info </legend>
        ...
        <table align="right" cellspacing="0" cellpadding="0" width="970"  border="1" rules="all" class="rpt_table" >
            ...
            <tfoot>
				...
				<tr>
                    <td colspan="14" height="15" align="center"><div id="bill_on" style="float:left; font-size:18px; color:#FF0000;"></div><div id="accounting_integration_div" style="float:center; font-size:18px; color:#FF0000;"></div></td>
                    <td>
