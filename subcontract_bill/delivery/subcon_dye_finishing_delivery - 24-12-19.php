...
<script>
	...
	function fnc_subcon_delivery_entry(operation)
	{
		...
		{
			var data="action=save_update_delete&operation="+operation+get_submitted_data_string('txt_sys_id*cbo_company_name*cbo_location*txt_order_id*cbo_party_name*cbo_process_name*txt_delivery_date*txt_item_id*txt_delivery_qnty*txt_carton_roll_no*txt_challan_no*txt_transport_company*cbo_forwarder*txt_remarks*update_id*update_id_dtls*txt_gsm*txt_dia*txt_color_id*txt_batch_id*hidden_dia_type*hid_sub_process*txt_gray_qnty*txt_reject_qty',"../");
			//alert (data);return;
