...
<script>
	...
	function fnc_gmts_delivery(operation)
	{
		if(operation==4)
		{
			 ...
			 print_report( $('#cbo_company_id').val()+'*'+$('#txt_sys_id').val()+'*'+report_title+'*'+$('#cbo_location_name').val(), "gmts_delivery_print", "requires/subcon_gmts_delivery_controller" ) 
			 return;
		}
		else if(operation==0 || operation==1 || operation==2)
		{
			if ( form_validation('cbo_company_id*cbo_party_name*txt_order_no*txt_delivery_qty*txt_delivery_date','Company Name*Party Name*Order No*Delivery Quantity*Delivery Date')==false )
				{
				return;
				}		
				...
				var data="action=save_update_delete&operation="+operation+"&colorIDvalue="+colorIDvalue+get_submitted_data_string('cbo_company_id*sewing_production_variable*cbo_location_name*cbo_party_name*cbo_process_name*cbo_item_name*hidden_po_break_down_id*hidden_colorSizeID*txt_delivery_date*txt_delivery_qty*txt_total_carton_qnty*txt_challan_no*txt_ctn_qnty*txt_transport_company*txt_vehical_no*txt_final_destination*txt_lock_no*txt_dl_no*txt_do_no*txt_attention*txt_driver_name*txt_mobile_no*txt_remarks*shipping_status*txt_remarks1*txt_prod_quantity*txt_cumul_quantity*txt_yet_quantity*txt_update_id*txt_sys_id*cbo_forwarder*txt_mst_id*txt_dtls_id',"../../");
				// alert (data); return;
	...
	{
	 	var data_control_status=$("#data_control_status").val();
...
<div style="width:100%;">
    ...
    <div style="width:930px; float:left" align="center">
        ...
        <input type="hidden" id="data_control_status" name="data_control_status">
                 ...
                 <table width="100%">
                    <tr>
                     ...
                     <tr>
                        ...
                        <td width="140">
                            <?
                                echo create_drop_down( "cbo_company_id", 152, "select id,company_name from lib_company comp where is_deleted=0 and status_active=1 and core_business not in(3) $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/subcon_gmts_delivery_controller', this.value, 'load_drop_down_location', 'location_td' ); load_drop_down( 'requires/subcon_gmts_delivery_controller', this.value, 'load_drop_down_party_name', 'party_td' );get_php_form_data(this.value,'load_variable_settings_control','requires/subcon_gmts_delivery_controller');",0 );	
                            ?>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                        	<input type="text" name="txt_final_destination" id="txt_final_destination" class="text_boxes" placeholder="Final Destination" style="width:140px;" />
                        </td>
                    </tr>
                    <tr>
                        <td>Lock No.</td>
                        <td>
                            <input type="text" name="txt_lock_no" id="txt_lock_no" class="text_boxes" placeholder="Lock No." style="width:140px;" />
                        </td>
                        <td>DL No.</td>
                        <td>
                        	<input type="text" name="txt_dl_no" id="txt_dl_no" class="text_boxes" placeholder="DL No." style="width:140px;" />
                        </td>                        
                        <td> DO No.</td>
                        <td>
                        	<input type="text" name="txt_do_no" id="txt_do_no" class="text_boxes" placeholder="DO No." style="width:140px;" />
                        </td>
                    </tr>
                    <tr>
                        <td>Attention</td>
                        <td>
                            <input type="text" name="txt_attention" id="txt_attention" class="text_boxes" placeholder="Attention" style="width:140px;" />
                        </td>
                        <td>Driver Name</td>
                        <td>
                    ...
                    <tr>
                        <td>Remarks</td>
                        <td colspan="5">
                            <textarea rows="2" name="txt_remarks" id="txt_remarks" style="width: 92%; margin-top: 10px;" placeholder="Remarks"></textarea>
                        </td>
                    </tr>
                 </table>
                </fieldset>
                        ...
                        <td width="30%" valign="top">
                          ...
                          <legend>New Entry</legend>
                            <table  cellpadding="0" cellspacing="2" width="100%">
								...
								<tr>
									<td class="must_entry_caption">Delivery Status<span id="completion_perc"></span></td>
									<td><?=create_drop_down("shipping_status", 110, $shipment_status, "", 0, "-- Select --", 2, "", 0, '2,3', '', '', '', ''); ?></td>
								</tr>
								<tr>
									<td>Remarks</td>  
                        			<td>
                            		<input name="txt_remarks1" id="txt_remarks1" class="text_boxes" type="text" style="width:100px;" placeholder="Remarks">      </td>
                    			</tr>
                           </table>
                        </fieldset>
                    </td>
                          ...
                          <legend>Display</legend>
                              <table cellpadding="0" cellspacing="2" width="100%" >
								...
								<tr>
                                    <td>Style No.</td>
                                    <td>	
                                    	<input name="txt_style_no" id="txt_style_no" style="width:100px;" type="text" class="text_boxes" readonly  />
                                    </td>
                                </tr>
                                <tr>
                                    <td>Order Qty.</td>
