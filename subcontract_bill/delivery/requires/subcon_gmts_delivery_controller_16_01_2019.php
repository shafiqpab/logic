  ...
  //      	 echo "pre";
	...
	if ($operation==0) // Insert Here----------------------------------------------------------
	{
		...
		if(str_replace("'","",$txt_update_id)=="")
		{
			...
			$field_array_delivery="id, delivery_prefix, delivery_prefix_num, delivery_no, company_id, location_id,process_id, challan_no, party_id, transport_company, delivery_date, vehical_no, forwarder, inserted_by, insert_date";
			...
			$data_array_delivery="(".$id.",'".$new_sys_number[1]."','".$new_sys_number[2]."','".$new_sys_number[0]."', ".$cbo_company_id.",".$cbo_location_name.",3,'".$challan_no."',".$cbo_party_name.",".$txt_transport_company.",".$txt_delivery_date.",".$txt_vehical_no.",".$cbo_forwarder.",".$user_id.",'".$pc_date_time."')";
		...
		else
		{
			...
			$data_array_delivery="".$cbo_location_name."*'".$mrr_no_challan."'*".$cbo_party_name."*".$txt_transport_company."*".$txt_delivery_date."*".$txt_vehical_no."*".$cbo_forwarder."*".$user_id."*'".$pc_date_time."'";
		}
		// $id=return_next_id("id", "subcon_delivery_mst", 1);
...
<div style="width:710px;">
    <table width="700" cellspacing="0" align="right" style="margin-bottom:20px;">
        ...
        <tr class="form_caption">
            ...
            ?>
        <tr>
            <td colspan="5" style="font-size:x-large; padding-left:252px; text-align:center;"><strong><? echo $data[2]; ?></strong></td>
