...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)  // Insert Start Here========================================================================================================================
	{
		...
		$field_array_dtls="id, mst_id, order_id, process_id, sub_process_id, item_id, gsm, dia, batch_id, color_id, width_dia_type, delivery_qty, carton_roll, remarks, gray_qty, reject_qty, moisture_gain";

		$data_array_dtls="(".$dtlsid.",".$id.",".$txt_order_id.",".$cbo_process_name.",".$hid_sub_process.",".$txt_item_id.",".$txt_gsm.",".$txt_dia.",".$txt_batch_id.",".$txt_color_id.",".$hidden_dia_type.",".$txt_delivery_qnty.",".$txt_carton_roll_no.",".$txt_remarks.",".$txt_gray_qnty.",".$txt_reject_qty.",".$txt_moisture_gain.")";
	...
	else if ($operation==1)   // Update Here==============================================================================================
	{
		...
		$return_no=$txt_sys_id;
		$field_array_dtls="order_id*process_id*sub_process_id*item_id*gsm*dia*batch_id*color_id*width_dia_type*delivery_qty*carton_roll*remarks*gray_qty*reject_qty*moisture_gain";

		$data_array_dtls="".$txt_order_id."*".$cbo_process_name."*".$hid_sub_process."*".$txt_item_id."*".$txt_gsm."*".$txt_dia."*".$txt_batch_id."*".$txt_color_id."*".$hidden_dia_type."*".$txt_delivery_qnty."*".$txt_carton_roll_no."*".$txt_remarks."*".$txt_gray_qnty."*".$txt_reject_qty."*".$txt_moisture_gain."";
