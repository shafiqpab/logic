...
<div style="width:710px;">
    <table width="700" cellspacing="0" align="right" style="margin-bottom:20px;">
		...
		$sql_master ="SELECT a.id,a.party_id,b.order_id,a.challan_no,b.item_id,a.delivery_date,a.transport_company,a.vehical_no,a.location_id,a.company_id,a.final_destination,a.lock_no,a.dl_no,a.do_no,a.attention,a.driver_name,a.mobile_no,a.remarks,b.process_id,b.total_carton_qnty,b.delivery_qty  from  subcon_delivery_mst a,  subcon_delivery_dtls b where a.id=b.mst_id and  a.delivery_no='".$data[1]."' and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by a.id";
