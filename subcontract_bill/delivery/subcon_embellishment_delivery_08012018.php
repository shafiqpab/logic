...
<script>
	...
	function calculate_amount(i)
	{
		...
		var hiddCurrentDelivery=$("#hiddenCurrentDelivery_"+i).val()*1;
                 ...
                 <table width="100%">
                    <tr>
                     ...
                     <tr>
                        ...
                        <td width="140">
                            <?php
                                echo create_drop_down( "cbo_company_id", 152, "select id,company_name from lib_company comp where is_deleted=0 and status_active=1 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/subcon_embellishment_delivery_controller', this.value, 'load_drop_down_location', 'location_td' );",0 );
