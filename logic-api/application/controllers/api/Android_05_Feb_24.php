...
//$response_arr='{"status":true,"mode":"save","UPDATE_ID":0,"data":{"index":{"company_id":"3","app_id":"14263","page_id":"1257","user_id":1}}}';  
	...
	{ 		
		...
		//$entry_form = $this->returnFieldValue("ENTRY_FORM","ELECTRONIC_APPROVAL_SETUP","page_id=$menu_id","ENTRY_FORM");
	...
	// @Base URL : http://localhost/platform-v3.5/logic-api/index.php/api/android/save_update_sewing
	// @Endpoint : save_update_sewing
	// @Request Body : The request body must be a JSON object
	// @Response : The response will be a JSON array of objects
	// @Objective: Data save from external data source (Fatulla Apparels)

	function save_update_sewing_POST()
    {
		 $this->load->model('android_model');

		// $response_arr='{"status":true,"mode":"save","production_type":5,"UPDATE_ID":0,"data":{"index":{"company_id":1,"shift_id":1,"location_id":130,"production_source":1,"serving_company":1,"floor_id":584,"sewing_line":759,"organic":"","user_id":"374","production_date":"18-01-2024","hour":"12-51","remarks":"no","mac":"AC:AF:B9:5A:34:CE"},"actual_reject":"106*1__108*1","list_data":[{"order_id":77171,"item_id":"179","country_id":"245","color_id":7,"size_id":3,"color_size_id":710193,"qnty":25,"reject":1,"qc_qnty":25,"color_type_id":0,"sewing_input_line":759},{"order_id":77171,"item_id":"179","country_id":"245","color_id":7,"size_id":3,"color_size_id":710194,"qnty":23,"reject":0,"qc_qnty":23,"color_type_id":0,"sewing_input_line":759}]}}'; 
	 

		$response_arr = file_get_contents("php://input");
		
		$save_info = $this->android_model->save_update_sewing_input_output($response_arr);
