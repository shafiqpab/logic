...
class Library_information extends REST_Controller {
	...
	function model_info_get() {
		...
		$data = $this->Library_information_model->model_info($this->get('model_id'));
	...
	function order_info_get() {
		...
		$data = $this->Library_information_model->order_info();
	...
	function knit_order_image_GET() {
		...
		$data = $this->Library_information_model->knit_order_image();
