...
class Dms extends REST_Controller {
    ...
    function purchase_requisition_details_get() {
		...
		$data = $this->purchase_requisition_details->purchase_requisition_details($requ_no);
    ...
    function purchase_order_details_get() {
		...
		$data = $this->purchase_order_details->purchase_order_details($order_no,$requ_id);
    ...
    function mrr_get() {
		...
		$data = $this->Mrr->Mrr($mrr,$parchase_order,$pi_ids);
    ...
    function Pi_info_get() {
		...
		$data = $this->Pi_info->Pi_info($pi_no,$work_order);
	...
	function lc_get() {
		...
		$data = $this->Lc_model->Lc($pi_no,$lc_number,$pi_id);
