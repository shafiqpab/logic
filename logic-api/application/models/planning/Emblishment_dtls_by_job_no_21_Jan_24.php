...
class Emblishment_dtls_by_job_no extends CI_Model
{
	...
	function Emblishment_dtls_by_job_no($job_no)
	{
		...
		$query_emb = "SELECT id, JOB_NO, EMB_NAME, EMB_TYPE, BODY_PART_ID, country, supplier_id, is_apply_last_update,cons_dzn_gmts, rate, amount, status_active, budget_on from wo_pre_cost_embe_cost_dtls where emb_name!=3 and job_no='$job_no' and is_deleted=0";
