...
class Android_model extends CI_Model {
	...
	public function array_ref_data($compId = "0", $arrs, $type, $qc_mst_tble_id) {
		...
		$knit_defect_array = return_library_array("select defect_name,short_name from  lib_defect_name", "defect_name", "short_name");
