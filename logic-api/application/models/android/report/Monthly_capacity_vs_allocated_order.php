<?php
class Monthly_capacity_vs_allocated_order extends CI_Model {
	...
	public function get_monthly_capacity_vs_allocated_order_info($fromDate, $toDate, $company, $location) {
