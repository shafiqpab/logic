...
class Knit_precosting_approval_notification extends CI_Model {
    ...
    {   
        ...
        //     LEFT JOIN LIB_ITEM_CATEGORY_LIST Y 
        //             ON X.ITEM_CATEGORY = Y.CATEGORY_ID
        //     LEFT JOIN USER_PASSWD D 
        //             ON A.INSERTED_BY = D.ID
        //     LEFT JOIN LIB_COMPANY B 
        //             ON A.COMPANY_ID = B.ID
        //     LEFT JOIN LIB_STORE_LOCATION C 
        //             ON A.STORE_NAME = C.ID
        //     LEFT JOIN LIB_LOCATION E 
        //             ON A.LOCATION_ID = E.ID
        //         WHERE A.ID =  $ref_id
    ...
    { 
        ...
        $response = $this->knit_precost_approval($user_id,$menu_id,$ref_id,$entry_form);
    ...
    public function knit_precost_approval($app_user_id,$menu_id,$ref_id,$entry_form)
    {
        ...
        try
        {
            ...
            $approval_data = $this->get_purchase_requisition_approval_data($ref_id,0,$pc_date_time);
    ...
    {
        $sql_res = sql_select("SELECT APPROVED,READY_TO_APPROVED FROM WO_PRE_COST_MST WHERE id = $ref_id");
        ...
        try
        {
            ...
            $rID=sql_multi_row_update("WO_PRE_COST_MST","APPROVED*READY_TO_APPROVED*APPROVED_SEQU_BY*APPROVED_GROUP_BY","0*0*0*0","id",$ref_id); 
