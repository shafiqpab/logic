			...
			for(var j=0; j<nchilds; j++)// this loop retrieves cell data
			{
				...
				if(SearchArgs[j]!="")
				{
					...
					{						
						...
						{
							var st_manual=document.getElementById('html_filter_type').value;
							regexp =rePattern(st,SearchArgs[j], st_manual);
						}
...
function rePattern(st,SearchArgs, st_manual){
	var regexp;
	if(st_manual==undefined) var st_manual=st;
	if(st_manual==1){
