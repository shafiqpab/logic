...
{ 
	...
	if($db_type==0)
	{
		...
		a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 and c.status_active=1 and c.is_deleted=0   and (c.entry_form_id is null or c.entry_form_id=0) $company_name_con 
