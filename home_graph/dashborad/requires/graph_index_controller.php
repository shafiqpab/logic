    ...
    <body>
        ...
        <form name="searchyarnfrm_1"  id="searchyarnfrm_1" autocomplete="off">
			<table width="280">
                <tbody>
                    <tr>
                        <td align="right"><b>Date Category :</b> </td>
                        <td>				
                            <?
                                echo create_drop_down( "cbo_date_type", 180, array(1=>"Ship date",2=>"Ext. ship date"),"", 1, "--Select--", 1, "",0 );
                            ?>                    
                        </td>  
                    </tr>
                    <tr style="display:none;">
                        <td align="right"><b>From date :</b></td>
                        <td><input type="tate" id="txt_from_date" style="width:170px;" class="datepicker"></td>
                    </tr>
                    <tr style="display:none;">
                        <td align="right"><b>To date :</b></td>
                        <td><input type="tate" id="txt_to_date" style="width:170px;" class="datepicker"></td>
                    </tr>
