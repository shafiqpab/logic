...
if($type==1){
	...
	if( $_SESSION['logic_erp']["data__"]=="")
	{
		...
		{ 
			...
			$subtitle_text_arr[$tem_leader_id]=$team_leader_arr[$tem_leader_id].':'.number_format((array_sum($dataArr['conf_qty'][$tem_leader_id])+array_sum($dataArr['proj_qty'][$tem_leader_id])),2,'.','').' PCS';
...
Highcharts.chart('chartdiv', {
  ...
  title: {
    text: 'ORDER IN HAND QTY TEAM LEADER WISE'
  },
  subtitle: {
