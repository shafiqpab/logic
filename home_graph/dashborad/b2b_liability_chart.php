   ...
   // echo $retun_sql;
    ...
    foreach($yr_mon_part as $key=>$val)
    {
        ...
        $html.='<td>'.date("M",strtotime($val))."'".date("y",strtotime($val)).'</td>
                ...
                <td align="right">'.number_format($all_graph_data[$year_no][$month_num]['EX_VALll22'],0).'</td>
        ...
        $totPackingQty +=$all_graph_data[$year_no][$month_num]['packing_qty66'];	
        ...
        $html.='<th align="right">'.number_format($totExFactoryVal,0).'</th>
                ...
                <th align="right">'.number_format($ddd,0).'</th>
                ...
                <div style="margin-left:5px; margin-top:45px">
                    <table class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" width="360" id="tableQty">
                        <thead>
                            ...
                            <th width="60">B2B LC Open</th>
                            <th width="55">Material received</th>
                            <th width="60">LC Value Paid </th>
                            <th width="60">Material  Due/LC Due</th>
                            <th width="60">Lc Liability as per Received</th>
                        </thead>
                        <? echo $html; ?>
                    </table>                  
                </div>
