...
class condition{
	...
	public  function _setGmtsitemRatioArr(){
		...
		while($gmtsitemRatioSqlRow=mysql_fetch_assoc($gmtsitemRatioSql)){
	...
	private function _setCostingPerArr(){
		...
		//$costingPerArrRow=mysql_fetch_assoc($costingPerArr)
		while($costingPerArrRow=mysql_fetch_assoc($costingPerArr)){
