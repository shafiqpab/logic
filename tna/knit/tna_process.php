			...
			<form name="tnaprocess_1" id="tnaprocess_1">	
				<table cellpadding="0" cellspacing="2" width="100%">
					<tr>
						...
						<td colspan="1">
						<?
							echo create_drop_down( "cbo_company", 170,"select id,company_name from lib_company where status_active=1 and is_deleted=0 order by company_name","id,company_name", 1, "-- All company --", 0, "load_drop_down( 'requires/tna_process_controller', this.value, 'load_drop_down_buyer', 'buyer_td')" );
						?>                     
						</td>
				...
				<tr>
						...
						<td>
							<input name="txt_date_from" id="txt_date_from" class="datepicker" style="width:160px">
						</td>
						<td align="right"><strong>Date To</strong></td>
						<td>
							<input name="txt_date_to" id="txt_date_to" class="datepicker" style="width:160px">
						</td>
				</tr>
				<tr>
					<tr>
						<td align="right"> <strong>Po Number/Style Reff</strong></td>
						<td colspan="3">
