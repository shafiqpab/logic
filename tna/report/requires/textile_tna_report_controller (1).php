...
if($action=="generate_tna_report")
{
	...
	{
		$sql ="select b.style_ref_no,b.season,b.sales_booking_no,b.buyer_id,b.within_group,a.po_number_id, a.job_no, max(a.shipment_date) as shipment_date,max(b.delivery_date) as pub_shipment_date,a.template_id, max(a.po_receive_date) as po_receive_date,b.insert_date,";
		$i=1; 
