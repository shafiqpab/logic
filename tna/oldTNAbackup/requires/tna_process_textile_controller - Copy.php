...
//(YD) Yarn Issue................................................................start;	
	...
	where a.id=b.mst_id and b.job_no=c.job_no  and b.item_category=1 and a.issue_purpose=2  and a.company_id=$cbo_company and a.is_deleted=0   and b.is_deleted=0    and c.is_deleted=0 and a.status_active=1 and b.status_active=1 and c.status_active=1 ";
			$p=1;
			foreach($job_no_list_arr as $job_no_process)
			{
				if($p==1){$sql .=" and (c.id in(".implode(',',$job_no_process).")";}
...
// (Y/D)Yarn receive................................................................start;	
	...
	where a.id=b.mst_id and b.job_no=c.job_no  and a.item_category=1 and a.receive_purpose=2 and b.item_category=1  and a.company_id=$cbo_company";
			$p=1;
			foreach($job_no_list_arr as $job_no_process)
			{
				if($p==1){$sql .=" and (c.id in(".implode(',',$job_no_process).")";}
