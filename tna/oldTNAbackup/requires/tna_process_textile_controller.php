...
if ( $action=="tna_process" )
{
	...
	foreach( $company_array as $cbo_company )
	{
		...
		if($textile_tna_process_base==2){//Sales Order Base
			...
			$sql = "select a.id as booking_id,a.delivery_date,a.booking_approval_date as booking_date,a.job_no as booking_no,a.buyer_id,b.color_type_id  ,sum(b.finish_qty) as fin_fab_qnty,sum(b.grey_qty) as grey_fab_qnty
			...
			group by a.id,a.booking_approval_date,a.delivery_date,a.job_no,a.buyer_id,b.color_type_id ORDER BY a.delivery_date asc";
			    //echo $sql;die;
