...
$prev_date = change_date_format(date('Y-m-d H:i:s', strtotime('60 day', strtotime($current_date))),'','',1); 
$prev_date2 = change_date_format(date('Y-m-d H:i:s', strtotime('-0 day', strtotime($current_date))),'','',1);
...
foreach($company_library as $compid=>$compname)
{
    ...
    if ($db_type == 0) {
        $str_cond_insert = " and b.pub_shipment_date between '" . $txt_date_from . "' and '" . $txt_date_to . "'";
    } else {
        $str_cond_insert = " and b.pub_shipment_date between '" . $txt_date_from . "' and '" . $txt_date_to . "'";
    }
    ...
    // if($to!=""){
    //     $header=mailHeader();
    //  $success = sendMailMailer( $to, $subject, $emailBody );
      
    // }else{ echo 'Sorry. Not Send';}
