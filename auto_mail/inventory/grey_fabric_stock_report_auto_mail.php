...
//Note: File patha => inventory\reports\grey_fabric_store\requires\grey_fabric_stock_report_for_youth_controller.php
// For Youth Group
...
if($action=="generated_report")
{
    ...
    foreach($company_arr as $company => $company_name)
    {
        ...
        if(count($main_data_arr)>0)
        {
            ...
            $REAL_FILE_NAME = 'grey_fabric_stock_'.$company .'_'. date('d-M-Y_h-iA',strtotime($txt_date_from)) . '.pdf';
