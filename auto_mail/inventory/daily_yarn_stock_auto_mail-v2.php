...
if ($action == "generate_report")
{
      		...
      		<table width="1780" border="1" cellpadding="2" cellspacing="0" class="rpt_table" style="font:'Arial Narrow'; font-size:14px"  rules="all" id="table_header_1" >
	      		<thead>
	      			<tr class="form_caption" style="border:none;">
	      				<td colspan="11" align="center" style="border:none;font-size:16px; font-weight:bold" >Daily Yarn Stock </td>
	      			</tr>
	      			...
	      			<tr style="border:none;">
						  ...
						  <?=change_date_format($previous_date, 'dd-mm-yyyy'); ?>
	      				</td>
	      			</tr>
	      			<tr>
	...
	if ($type == 10)
	{
		...
		SUM(case when transaction_type in (1) then cons_quantity else 0 end) as direct_mrr_total_recieved_quantity,
		...
		foreach ($mrr_info_sql as $row) 
		{
			...
			$mrr_info_arr[$row[csf("prod_id")]]['direct_mrr_total_recieved_quantity']=$row[csf("direct_mrr_total_recieved_quantity")];
			...
			<table width="<? echo $tblWidth;?>" border="1" cellpadding="2" cellspacing="0" class="rpt_table" rules="all" id="table_header_1" >
				<thead>
					...
					<tr  style="word-break:normal;">
						<th rowspan="2" width="40">SL</th>
						<th rowspan="2" width="120">Company Name</th>
						<th colspan="11" width="710">Description</th>
						<th rowspan="2" width="100">Stock In Hand</th>
								...
								if (number_format($stockInHand, 2) > 0.00)
								{
									if (!in_array($check_string, $checkArr)) 
									{
										...
										if ($i > 1) {
											?>
											<tr bgcolor="#CCCCCC" style="font-weight:bold">
												<td colspan="13" align="right">Sub Total</td>
											...
											$sub_stock_value_usd = 0;
											  ...
											  <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
												...
												<td width="100"><p><? echo $mrr_info_arr[$row[csf("id")]]['direct_mrr_total_recieved_quantity']; ?></p></td>
