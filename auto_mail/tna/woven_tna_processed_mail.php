...
$task_short_name = return_library_array("select task_name,task_short_name from lib_tna_task where status_active=1 and is_deleted=0 and task_type=6","task_name","task_short_name");
...
$res=sql_select("select id,user_id,tna_task_id,mail_type from tna_mail_setup where status_active=1 and is_deleted=0 AND TASK_TYPE=6");
foreach($res as $row)
{
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="1" rules="all">
							...
							{ 
								...
								<tr bgcolor="#CCCCCC">
									...
									<td align="center" colspan="3">Plan Start Date</td>
								</tr>
								<tr bgcolor="#DDDDDD">
						...
						<table width="100%" cellpadding="0" cellspacing="0" border="1" rules="all">
							...
							foreach($TaskComplitionReminderArr as $dealing_marchant_id=>$dealing_marchant_row)
							{
								...
								<tr bgcolor="#CCCCCC"><td colspan="2"><strong>Dealing Merchant :</strong></td>
									...
									<td>Mobile :</td>
									<td colspan="3">&nbsp;&nbsp;&nbsp;<strong><? echo $marchant_contact_no[$dealing_marchant_id]; ?></strong></td>
									<td align="center" colspan="3">Plan Finish Date</td>
