...
$task_short_name = return_library_array("select task_name,task_short_name from lib_tna_task where status_active=1 and is_deleted=0 and task_type=4","task_name","task_short_name");
...
$res=sql_select("select id,user_id,tna_task_id,mail_type from tna_mail_setup where status_active=1 and is_deleted=0 AND TASK_TYPE=4");
foreach($res as $row)
{
