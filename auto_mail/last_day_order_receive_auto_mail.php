...
<?
		...
		$subject = "New Order List of ".$company_arr[$compid];
		...
		elseif($compid==2){
			$to=$to.", ".'raihan.uddin@team.com.bd, mahbub@marsstitchltd.com, azmal.huda@team.com.bd, mainul.islam@team.com.bd, tuhin.Rasul@team.com.bd, shah.alam@marsstitchltd.com';
			if($to!=""){echo sendMailMailer( $to, $subject, $mail_body, $from_mail,$att_file_arr );}
		}
		elseif($compid==3){
			$to=$to.", ".'raihan.uddin@team.com.bd, pavel@brothersfashion-bd.com, emdad@brothersfashion-bd.com, tuhin.Rasul@team.com.bd, bfl_scm@brothersfashion-bd.com, abir@brothersfashion-bd.com';
			if($to!=""){echo sendMailMailer( $to, $subject, $mail_body, $from_mail,$att_file_arr );}
		}
		elseif($compid==4){
