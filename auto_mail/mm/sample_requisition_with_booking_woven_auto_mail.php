...
{ 
    ...
    <body>
        ...
        <table class="border-none" style="width:100%;border: none">
            <tr>
                <th style="text-align: center;" colspan="14">Sample Requisition with Booking Woven</th>
            <tr>
        </table>
        <br>
