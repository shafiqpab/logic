<?
		...
		$delivery_sql="select PO_BREAK_DOWN_ID,EX_FACTORY_QNTY from PRO_EX_FACTORY_MST where is_deleted=0 and status_active=1 ".where_con_using_array($order_data_arr['PO_BREAK_DOWN_ID'],0,'PO_BREAK_DOWN_ID')."";
		...
		foreach($delivery_sql_result as $rows)
		{
			...
			$order_data_arr['DELIVERY_QTY'][$key]+=$rows['EX_FACTORY_QNTY'];
		}
