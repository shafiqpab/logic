...
$previous_date = change_date_format(date('Y-m-d', strtotime('-10 day', time())),'','',1);
 
if(date("d-M-Y",time())){die;}
...
sum(a.CURRENT_ACCEPTANCE_VALUE) as  CURRENT_ACCEPTANCE_VALUE,b.IMPORTER_ID, b.SUPPLIER_ID,b.lc_value as BTB_LC_VALUE, b.lc_number as BTB_LC_NO,b.LC_DATE,b.TENOR,b.TOLERANCE,e.DOCUMENT_VALUE,e.INVOICE_NO,e.INVOICE_DATE,e.BILL_OF_ENTRY_NO,e.BILL_NO,e.BILL_DATE,e.COMPANY_ACC_DATE,e.BANK_ACC_DATE,
 0 as type
	...
	where e.id=a.IMPORT_INVOICE_ID and a.btb_lc_id=b.id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $dateCon 
        ...
        <table border="1" rules="all">
            ...
            <tbody>
                ...
                foreach($dataArr as $row){
                    ...
                    if($row['DOCUMENT_VALUE']> $bal ){continue;}
                ...
                <tr>
                    ...
                    <td align="right"><?=number_format($row['CURRENT_ACCEPTANCE_VALUE'],2);?></td>
                    <td align="right"><?=number_format($row['BTB_LC_VALUE']-$row['CURRENT_ACCEPTANCE_VALUE'],2);?></td>
