...
$company_library=return_library_array("select id,company_name from lib_company where status_active=1 and is_deleted=0 and id=17","id","company_name");
...
th{
  ...
  font-size: 12px;
			...
			<div>
				<p align="left"><b>Dear Concerns,</b></p>
				<p align="left"><b>Please check today's & tomorrow's Ex-factory schedule and take necessary steps immediately :</b></p>
		...
		?>
				<br>
				<h4 align="center" ><b>Daily Ex-factory Schedule of Date : &nbsp;<? echo $date;?></b></h4>
