...
*/
    ...
    foreach($company_arr as $cbo_company => $company_name){
        $cbo_type=0;
        $cbo_year=0;
        $txt_date_from = $prev_date;
        ...
        {
            $company_working_cond=" and a.knitting_company=$cbo_company";
        }
        ...
        <table cellpadding="0" cellspacing="0" width="1300">
            <tr>
                <td align="center" width="100%" colspan="<? echo $ship_count+23; ?>" class="form_caption" style="font-size:18px">Total Production Activity Report [Sales]</td>
            </tr>
            <tr>
                <td align="center" width="100%" colspan="<? echo $ship_count+23; ?>" class="form_caption" style="font-size:16px"><? echo $company_arr[$cbo_company]; ?></td>
            </tr>
            <tr> 
                <td align="center" width="100%" colspan="<? echo $ship_count+23; ?>" class="form_caption" style="font-size:12px" >
                <strong>
                <?
                    echo " Date: ". $prev_date;
                ?>
        ...
        <div style="width:1260px; font-size:12px;" id="scroll_body">
        ...
        <div style="width:850px;font-size:12px;" id="scroll_body2">
            <table width="830" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                ...
                <tbody>
                    ...
                    $f=1;
                    $grand_tot_inhouse_qnty = 0; $grand_tot_samplewith_qnty = 0;$grand_tot_samplewithout_qnty = 0;$grand_tot_subcon_in_qnty = 0;$grand_tot_total_qnty = 0;$grand_delivery_in_qnty = 0;
                    foreach($wcomp_floor_summary_arr as $wcompany=>$floorvalue)
                    {
                        ...
                        foreach($floorvalue as $key=>$value)
                        {
                            ...
                            <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr2_<? echo $f; ?>','<? echo $bgcolor; ?>')" id="tr2_<? echo $f; ?>" valign="top">
                                ...
                                <td width="" align="right"><? echo number_format($inhouse_qnty+$samplewith_qnty+$samplewithout_qnty+$subcon_in_qnty,2,'.',''); //echo number_format($delivery_in_qty_arr[$wcompany][$key],2,'.',''); ?></td>
                            </tr>
                            <?
                            $f++;
                            ...
                            $sub_tot_delivery_in_qnty+=$inhouse_qnty+$samplewith_qnty+$samplewithout_qnty+$subcon_in_qnty;
                            ...
                            $grand_delivery_in_qnty+=$inhouse_qnty+$samplewith_qnty+$samplewithout_qnty+$subcon_in_qnty;
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr2_<? echo $f; ?>','<? echo $bgcolor; ?>')" id="tr2_<? echo $f; ?>" valign="top">
                        ...
                        <td width="" align="right"><strong><? echo $delivery_out_qty; ?></strong></td>
                    </tr>
        ...
        <div style="width:1150px;font-size:12px;" id="scroll_body3">
            <table width="1130" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                ...
                <tbody>
                    <?
                    if($cbo_company>0) $company_working_cond=" and a.WORKING_COMPANY_ID=$cbo_company";
                    if($cbo_company>0) $company_working_cond2=" and a.SERVING_COMPANY=$cbo_company";
                   ...
                   // print_r($lay_qty_data_arr);die;
                    $i = 1;
                    $grand_total_lay_qty=$grand_total_cutting_qc=$grand_total_print_send=$grand_total_print_receive=$grand_total_emb_send=$grand_total_emb_rcv=$grand_total_sweing_input=$grand_total_sweing_output= $grand_total_packing_qty = 0;
                    foreach($lay_qty_data_arr as $working_company=>$working_company_val)
                    {
                        $sub_total_lay_qty=$sub_total_cutting_qc=$sub_total_print_send=$sub_total_print_receive=$sub_total_emb_send=$sub_total_emb_rcv=$sub_total_sweing_input=$sub_total_sweing_output=$sub_total_packing_qty= 0;
        ...
        <div style="width:560px;font-size:12px;" id="scroll_body4">
            <table width="540" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                ...
                <tbody>
                    <?
                    if($cbo_company>0) $company_working_cond=" and a.DELIVERY_COMPANY_ID=$cbo_company";
                    $ex_data_array = array();
                    $from_date = $txt_date_from;
                    if (str_replace("'", "", $txt_date_to) == "") $to_date = $from_date;
                    else $to_date = $txt_date_to;
                    ...
                    {	
                        ...
                        WHERE a.id = b.delivery_mst_id AND b.po_break_down_id=c.id and c.job_id=d.id and a.COMPANY_ID in($cbo_company) $date_con AND a.status_active = 1 AND a.is_deleted = 0 AND b.status_active = 1 AND b.is_deleted = 0 AND c.status_active = 1 AND c.is_deleted = 0 AND d.is_deleted = 0 AND d.status_active = 1";
                    }
                    ...
                    $i = 1;
                    $sub_tot_shipment_qty=0; $sub_tot_fob_value=0;$grand_tot_shipment_qty=0;$grand_tot_fob_value=0;
        ...
        <div style="width:450px;font-size:12px;" id="scroll_body5">
        ...
        <!-- Yarn Issued Start-->
        <div style="width:350px;font-size:12px;" id="scroll_body6">
            <table width="330" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                ...
                <tbody>
                    ...
                    $yIssue_data_arr = array();
                    $yarn_issue_sql_rst=sql_select($yarn_issue_sql);
                    $yRecv_data_arr=array();
                    foreach ($yarn_issue_sql_rst  as  $row) 
                    {
                        $yIssue_data_arr[$row['KNIT_DYE_COMPANY']]['CONS_QUANTITY']+=$row['CONS_QUANTITY'];

                        $yIssue_data_arr[$row['KNIT_DYE_COMPANY']]['USD_VALUE'] += ($row['CONS_QUANTITY'] * $row['ORDER_RATE']);
                    }
                    $i = 1;
                    ...
                    foreach($yIssue_data_arr as $dye_company=>$row)
                    {
                        ...
                        <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr6_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr6_<? echo $i; ?>" valign="top">
                            <td width="50" align="center"><?=$i; ?></td>
                            <td width="100" align="center" title="<?=$dye_company;?>"><?=$company_arr[$dye_company];?></td>
        ...
        <div style="width:350px;font-size:12px;" id="scroll_body7">
            <table width="330" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?
                    if($cbo_company>0) $company_working_cond=" and a.KNIT_DYE_COMPANY=$cbo_company";
                    ...
                    $chemial_issue_arr = array();
                    $dye_company_arr = array();
                    ...
                    $i = 1;$j=1;$sub_tot_issqty=0;$sub_tot_usd_issvalue=0;$grand_tot_issqty=0;$grand_tot_usd_issvalue=0;
                    ...
                    <tr class="tbl_bottom">
                        <th width="50">&nbsp;</th>
                        <th width="100">Grand Total</th>
                        <th width="100" align="right"><?=number_format($grand_tot_issqty, 2,'.',',');?></th>
        ...
        <div style="width:350px;font-size:12px;" id="scroll_body8">
            <table width="330" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                <thead>
                    <tr>
        ...
        <div style="width:350px;font-size:12px;" id="scroll_body9">
            <table width="330" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    foreach($finish_data_arr as $knitting_company=>$knitting_companyv)
                    {
                        ...
                        foreach ($knitting_companyv as $cbuyer => $row) 
                        {
                            ...
                            if($stock_qty > 0)
                            {
                                ...
                                <?
                                $i++;
                                $sub_tot_finish_stockQty+=$stock_qty;
                                $grand_tot_finish_stockQty+=$stock_qty;
                            }
                        }
                        ?>
                        <tr class="tbl_bottom">
                            ...
                            <td width="100"></td>
                            <td width="100" align="right">Total</td>
                            <td width="" align="right"><?=number_format($sub_tot_finish_stockQty, 2,'.',',');?></td>
                        </tr>
                        <?
                    }
                    ?>
                    <tr class="tbl_bottom">
                        ...
                        <th width="100">&nbsp;</th>
                        <th width="100">Grand Total</th>
                        <th width="" align="right"><?=number_format($grand_tot_finish_stockQty, 2,'.',',');?></th>
                    </tr>
                </tbody>
        ...
        $sql = "SELECT a.BRAND_IDS,a.BUYER_IDS,c.email_address FROM mail_group_mst a, mail_group_child b, user_mail_address c where b.mail_group_mst_id=a.id  and a.mail_item=b.MAIL_ITEM_MST and a.mail_item=$mail_item and b.mail_user_setup_id=c.id and a.company_id = $cbo_company)  and   A.IS_DELETED=0 and A.STATUS_ACTIVE=1 AND a.MAIL_TYPE=1 and b.IS_DELETED=0 and b.STATUS_ACTIVE=1  and c.IS_DELETED=0 and c.STATUS_ACTIVE=1";
        // echo $sql;die; 
        ...
        // echo $att_file_arr;die;
        // print_r($to) ;die;
        // echo $_REQUEST['isview'];die;
        
        $subject="Total Production Activity Report [Sales]";
        $header=mailHeader();
