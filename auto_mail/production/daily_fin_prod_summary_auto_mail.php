...
<b style="font-size:18px;">Daily Ex Factory Report as on  <? echo date('dS F-Y', time());?></b>
<table cellspacing="0" width="<? echo $tbl_width;?>" cellpadding="1" border="1" rules="all">
    ...
    <tr bgcolor="#FFD8B0" style="font-size:12px">
        ...
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='70' align='right'><b>".number_format($cum_up_to_current_arr['qty'][$compid]+$all_mon_ex_factory_qnty_arr[$compid])."</b></td><td width='70' align='right'><b>".number_format($cum_up_to_current_arr['val'][$compid]+$all_mon_ex_factory_value_arr[$compid])."</b></td>";
			}
		?>
    	<td align="right"><b><? echo number_format(array_sum($cum_up_to_current_arr['qty'])+array_sum($all_mon_ex_factory_qnty_arr));?></b></td>
    	<td align="right"><b><? echo number_format(array_sum($cum_up_to_current_arr['val'])+array_sum($all_mon_ex_factory_value_arr));?></b></td>
    </tr>
...
<br/>
<!--<b style="font-size:26px;">Asrotex Group</b><br/>-->
<b style="font-size:18px;">Daily Finish Gmts Production as on  <? echo date('dS F-Y', time());?></b>
<table cellspacing="0" width="<? echo $tbl_width;?>" cellpadding="1" border="1" rules="all">
    <thead>
    <tr style="font-size:12px" bgcolor="#EBEBEB">
    ...
    <tr bgcolor="#FFFFAA" style="font-size:12px">
    	<td><b>Current Week Total</b></td>
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='70' align='right'><b>".number_format($com_finish_qnty_arr[$compid])."</b></td><td width='70' align='right'><b>".number_format($com_finish_value_arr[$compid])."</b></td>";
			}
		?>
    ...
    <tr bgcolor="#5BFFAD" style="font-size:12px">
    	<td><b>Previous Week Total</b></td>
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='70' align='right'><b>".number_format($cum_up_to_current_arr['finish_qty'][$compid])."</b></td><td width='70' align='right'><b>".number_format($cum_up_to_current_arr['finish_val'][$compid])."</b></td>";
			}
		?>
    ...
    <tr bgcolor="<? echo $bgcolor;?>" style="font-size:12px">
		...
		foreach($company_short_library as $compid=>$company_name){
			...
			echo "<td width='70' align='right'>".number_format($month_finish_qnty)."</td><td width='70' align='right'>".number_format($month_finish_value)."</td>";
			}
		?>
    ...
    <tr bgcolor="#FFD8B0" style="font-size:12px">
    	<td><b>Grand Total</b></td>
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='70' align='right'><b>".number_format($cum_up_to_current_arr['finish_qty'][$compid]+$all_mon_finish_qnty_arr[$compid])."</b></td><td width='70' align='right'><b>".number_format($cum_up_to_current_arr['finish_val'][$compid]+$all_mon_finish_value_arr[$compid])."</b></td>";
			}
		?>
    	<td align="right"><b><? echo number_format(array_sum($cum_up_to_current_arr['finish_qty'])+array_sum($all_mon_finish_qnty_arr));?></b></td>
    	<td align="right"><b><? echo number_format(array_sum($cum_up_to_current_arr['finish_val'])+array_sum($all_mon_finish_value_arr));?></b></td>
    </tr>
