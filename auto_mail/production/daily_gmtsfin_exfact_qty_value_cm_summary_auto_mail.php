...
*/	
	...
	$tbl_width=140+($company_count*210)+210;
	ob_start();
	$flag=0;
?>
...
<table cellspacing="0" width="<? echo $tbl_width;?>" cellpadding="1" border="1" rules="all">
    ...
    <tr style="font-size:12px" bgcolor="#CCCCFF">
        ...
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<th colspan='4'>$company_name</th>";
			}
		?>
    ...
    <tr style="font-size:12px" bgcolor="#CCCCFF">    
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<th width='60'>Ex-Fact Qty</th><th width='60'>Ex-Fact Val</th><th width='60'>Ex-Fact CM</th><th width='30'>CM %</th>";
			}
		?>
	...
	if(date('m', strtotime($previous_saturday . " +$i day"))!=date('m', time())){
		continue;
	}
	?>
    <tr bgcolor="<? echo $bgcolor;?>" style="font-size:12px">
        ...
        <? 
		foreach($company_short_library as $compid=>$company_name){
			$ex_factory_qty=$result_data_arr[$compid][$dateKey]['ex_factory_qnty'];
			...
			$com_ex_factory_qty_arr[$compid]+=$ex_factory_qty;
			...
			$day_ex_factory_qty_arr[$dateKey]+=$ex_factory_qty;
			...
			echo "<td width='60' align='right'>".removeNullZero(number_format($ex_factory_qty))."</td>
				  <td width='60' align='right'>".removeNullZero(number_format($ex_factory_value))."</td> 
		...
		?>
        <td align="right"><? echo removeNullZero(number_format($day_ex_factory_qty_arr[$dateKey]));?></td>
    ...
    <tr bgcolor="#FFFFAA" style="font-size:12px">
        ...
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='60' align='right'><b>".removeNullZero(number_format($com_ex_factory_qty_arr[$compid]))."</b></td>
				  <td width='60' align='right'><b>".removeNullZero(number_format($com_ex_factory_value_arr[$compid]))."</b></td>
		...
		?>
        <td align="right"><b><? echo removeNullZero(number_format(array_sum($com_ex_factory_qty_arr)));?></b></td>
    ...
    <tr bgcolor="#5BFFAD" style="font-size:12px">
        ...
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='60' align='right'><b>".removeNullZero(number_format($cum_up_to_current_arr['qty'][$compid]))."</b></td>
				  <td width='60' align='right'><b>".removeNullZero(number_format($cum_up_to_current_arr['val'][$compid]))."</b></td>
		...
		?>
        <td align="right"><b><? echo removeNullZero(number_format(array_sum($cum_up_to_current_arr['qty'])));?></b></td>
    ...
    <tr bgcolor="<? echo $bgcolor;?>" style="font-size:12px">
		...
		foreach($company_short_library as $compid=>$company_name){
			...
			echo "<td width='60' align='right'>".removeNullZero(number_format($month_ex_factory_qnty))."</td>
				  <td width='60' align='right'>".removeNullZero(number_format($month_ex_factory_value))."</td>
		...
		?>
        <td align="right"><? echo removeNullZero(number_format($mon_ex_factory_qnty_arr[$monthDateKey]));?></td>
    ...
    <tr bgcolor="#FFD8B0" style="font-size:12px">
        ...
        <? foreach($company_short_library as $compid=>$company_name)
		{
echo "<td width='60' align='right'><b>".removeNullZero(number_format($com_ex_factory_qty_arr[$compid]+$cum_up_to_current_arr['qty'][$compid]+$all_mon_ex_factory_qnty_arr[$compid]))."</b></td>
<td width='60' align='right'><b>".removeNullZero(number_format($com_ex_factory_value_arr[$compid]+$cum_up_to_current_arr['val'][$compid]+$all_mon_ex_factory_value_arr[$compid]))."</b></td>
	  ...
	  <td width='30' align='right'><b>".removeNullZero(number_format(($com_ex_factory_cm_arr[$compid]+$cum_up_to_current_arr['exfact_cm'][$compid]+$all_mon_ex_factory_cm_arr[$compid])/($com_ex_factory_value_arr[$compid]+$cum_up_to_current_arr['val'][$compid]+$all_mon_ex_factory_value_arr[$compid])*100))."</b></td>";
		...
		?>
        <td align="right"><b><? echo removeNullZero(number_format(array_sum($com_ex_factory_qty_arr)+array_sum($cum_up_to_current_arr['qty'])+array_sum($all_mon_ex_factory_qnty_arr)));?></b></td>
    	...
    	<td align="right"><b><? echo removeNullZero(number_format((array_sum($com_ex_factory_cm_arr)+array_sum($cum_up_to_current_arr['exfact_cm'])+array_sum($all_mon_ex_factory_cm_arr))/(array_sum($com_ex_factory_value_arr)+array_sum($cum_up_to_current_arr['val'])+array_sum($all_mon_ex_factory_value_arr))*100));?></b></td>
...
<table cellspacing="0" width="<? echo $tbl_width;?>" cellpadding="1" border="1" rules="all">
    ...
    <tr style="font-size:12px" bgcolor="#CCCCFF">    
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<th width='60'>Finish Qty</th><th width='60'>Finish Value</th> <th width='60'>Finish CM</th><th width='30'>CM %</th>";
			}
		?>
        <th width="60">Finish Qty</th>
        <th width="60">Finish Value</th>
    ...
    <tr bgcolor="<? echo $bgcolor;?>" style="font-size:12px">
		...
		foreach($company_short_library as $compid=>$company_name)
		{
			...
			echo "<td width='60' align='right'>".removeNullZero(number_format($gmts_finish_qnty))."</td> 
				  <td width='60' align='right'>".removeNullZero(number_format($gmts_finish_value))."</td> 
		...
		?>
        <td align="right"><? echo removeNullZero(number_format($day_finish_qnty_arr[$dateKey]));?></td>  
    ...
    <tr bgcolor="#FFFFAA" style="font-size:12px">
    	<td><b>Current Week Total</b></td>
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='60' align='right'><b>".removeNullZero(number_format($com_finish_qnty_arr[$compid]))."</b></td>
				  <td width='60' align='right'><b>".removeNullZero(number_format($com_finish_value_arr[$compid]))."</b></td>
		...
		?>
        <td align="right"><b><? echo removeNullZero(number_format(array_sum($com_finish_qnty_arr)));?></b></td>
    ...
    <tr bgcolor="#5BFFAD" style="font-size:12px">
    	<td><b>Previous Week Total</b></td>
        <? foreach($company_short_library as $compid=>$company_name){
			echo "<td width='60' align='right'><b>".removeNullZero(number_format($cum_up_to_current_arr['finish_qty'][$compid]))."</b></td>
				  <td width='60' align='right'><b>".removeNullZero(number_format($cum_up_to_current_arr['finish_val'][$compid]))."</b></td>
		...
		?>
        <td align="right"><b><? echo removeNullZero(number_format(array_sum($cum_up_to_current_arr['finish_qty'])));?></b></td>
    ...
    <tr bgcolor="<? echo $bgcolor;?>" style="font-size:12px">
		...
		foreach($company_short_library as $compid=>$company_name){
			...
			echo "<td width='60' align='right'>".removeNullZero(number_format($month_finish_qnty))."</td>
				  <td width='60' align='right'>".removeNullZero(number_format($month_finish_value))."</td>
			...
			?>
        <td align="right"><? echo removeNullZero(number_format($mon_finish_qnty_arr[$monthDateKey]));?></td>
    ...
    <tr bgcolor="#FFD8B0" style="font-size:12px">
        ...
        <? 
		foreach($company_short_library as $compid=>$company_name){
echo "<td width='60' align='right'><b>".removeNullZero(number_format($com_finish_qnty_arr[$compid]+$cum_up_to_current_arr['finish_qty'][$compid]+$all_mon_finish_qnty_arr[$compid]))."</b></td>
<td width='60' align='right'><b>".removeNullZero(number_format($com_finish_value_arr[$compid]+$cum_up_to_current_arr['finish_val'][$compid]+$all_mon_finish_value_arr[$compid]))."</b></td>
	  ...
	  <td width='30' align='right'><b>".removeNullZero(number_format(($com_finish_cm_arr[$compid]+$cum_up_to_current_arr['finish_cm'][$compid]+$all_mon_finish_cm_arr[$compid])/($com_finish_value_arr[$compid]+$cum_up_to_current_arr['finish_val'][$compid]+$all_mon_finish_value_arr[$compid])*100))."</b></td>";
		...
		?>
        <td align="right"><b><? echo removeNullZero(number_format(array_sum($com_finish_qnty_arr)+array_sum($cum_up_to_current_arr['finish_qty'])+array_sum($all_mon_finish_qnty_arr)));?></b></td>
...
*/	 
	...
	$to='mainul@asrotex.com,
		 mis.ho@asrotex.com,
		 a.kashem@asrotex.com,
		 ausumon_fktl@asrotex.com,
