...
{ 	
	...
	$cbo_store_name= implode(',',$ftmlStorArr);
	...
	if(!empty($all_po_id_arr))
	{
		...
		fnc_tempenginepo("GBL_TEMP_ENGINE", $user_id, 993, 1,$all_po_id_arr, $empty_arr);//PO ID
