...
<?
	foreach($pqsForReadyToApprove as $pq_key => $pq){
		...
		echo '<tr><td><b>Material Cost</b></td><th>:</th><td>'.$material_cost.'</td></tr>';
		echo '<tr><td><b>Embellishment Cost</b></td><th>:</th><td>'.$pq['EMBEL_COST'].'</td></tr>';
		echo '<tr><td><b>Wash Cost</b></td><th>:</th><td>'.$pq['WASH_COST'].'</td></tr>';
		echo '<tr><td><b>Other Cost</b></td><th>:</th><td>'.$other_cost.'</td></tr>';			
		echo '<tr><td><b>CM Cost</b></td><th>:</th><td>'.$pq['CM_COST'].'</td></tr>';
		echo '<tr><td><b>Total Cost</b></td><th>:</th><td>'.$pq['TOTAL_COST'].'</td></tr>';
		echo '<tr><td><b>FOB Price/Pcs</b></td><th>:</th><td>'.$pq['FOB'].'</td></tr>';
		echo '<tr><td><b>Margin (%)</b></td><th>:</th><td>'.$pq['MARGIN_DZN_PERCENT'].'</td></tr>';
		echo "</table>";
	}
