 ...
 sum( CASE WHEN fabric_source=2  and c.fab_nature_id=2 THEN ((b.cons/b.pcs)*a.plan_cut_qnty) ELSE 0 END) as purchase_finish_req,
  ...
  from wo_po_color_size_breakdown a, wo_pre_cos_fab_co_avg_con_dtls b ,wo_pre_cost_fabric_cost_dtls c where b.pre_cost_fabric_cost_dtls_id=c.id and b.job_no=c.job_no   and a.job_no_mst=c.job_no and   a.po_break_down_id=b.po_break_down_id and a.color_number_id=b.color_number_id and a.size_number_id=b.gmts_sizes and a.is_deleted=0 and a.status_active=1 and a.po_break_down_id in ($all_po_id)");
			...
			$dataArrayTrans=sql_select("select
					...
					from order_wise_pro_details where status_active=1 and is_deleted=0 and entry_form in(11,83,13,15) and po_breakdown_id in($all_po_id)");
			...
			$issuedToCutQnty=$issueData[0][csf('issue_to_cut_qnty')]+$issueData[0][csf('issue_to_cut_qnty_roll_wise')];
			unset($issueData);	
        ...
        <table width="1000" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="right"><? echo number_format($under_over_issued,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($greyYarnIssueQnty,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($dyedYarnRecvQnty,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($dyed_yarn_balance,2,'.',''); ?>&nbsp;</td>
            </tr>
            <tr bgcolor="#E9F3FF">
            	<td>In %</td>
                <td>&nbsp;</td>
        ...
        <table width="1090" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="right"><? echo number_format($grey_avilable,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($process_loss,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($under_over_prod,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($issuedToDyeQnty,2,'.',''); ?>&nbsp;</td>
            ...
            <tr bgcolor="#E9F3FF">
                ...
                <td align="right"><? echo number_format($grey_avilable_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($process_loss_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($under_over_prod_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($issuedToDyeQnty_perc,2,'.',''); ?>&nbsp;</td>
        ...
        <table width="1250" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="right"><? echo number_format($finish_available,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($process_loss_finishing,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($under_over_finish_prod,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($fab_purchase_req_qnty,2,'.',''); ?>&nbsp;</td>
		...
		?>
            ...
            <table width="820" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
                ...
                <tr bgcolor="#FFFFFF">
                    <td>Quantity</td>
                    <td align="right"><? echo number_format($tot_po_qnty,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($print_issue_qnty_in,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($print_issue_qnty_out,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($total_print_issued,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($print_recv_qnty_in,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($print_recv_qnty_out,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($total_print_recv,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($print_reject_qnty,2,'.',''); ?>&nbsp;</td>
                </tr>
                <tr bgcolor="#E9F3FF">
                    <td>In %</td>
                    <td>&nbsp;</td>
                    ...
                    <td align="right"><? echo number_format($total_print_issued_perc,2,'.',''); ?>&nbsp;</td>
                    ...
                    <td align="right"><? echo number_format($total_print_recv_perc,2,'.',''); ?>&nbsp;</td>
		...
		?>
            ...
            <table width="820" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
                ...
                <tr bgcolor="#E9F3FF">
                    <td>In %</td>
                    <td>&nbsp;</td>
                    <td align="right"><? echo number_format($emb_issue_qnty_in_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($emb_issue_qnty_out_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($total_emb_issued_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($emb_recv_qnty_in_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($emb_recv_qnty_out_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($total_emb_recv_perc,2,'.',''); ?>&nbsp;</td>
		...
		?>
            ...
            <table width="550" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
                ...
                <tr bgcolor="#E9F3FF">
                    <td>In %</td>
                    <td>&nbsp;</td>
                    <td align="right"><? echo number_format($wash_recv_qnty_in_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($wash_recv_qnty_out_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($total_wash_recv_perc,2,'.',''); ?>&nbsp;</td>
                    <td align="right"><? echo number_format($wash_balance_qnty_perc,2,'.',''); ?>&nbsp;</td>
                 </tr>
            </table>
        <?
		}
        ...
        <table width="450" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
            ...
            <tr bgcolor="#E9F3FF">
                ...
                <td>&nbsp;</td>
                <td align="right"><? echo number_format($total_finish_qnty_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($tot_exfactory_qnty_perc,2,'.',''); ?>&nbsp;</td>
        ...
        <table width="450" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
            ...
            <tr bgcolor="#FFFFFF">
                ...
                <td align="right"><? echo number_format($finish_left_over,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($left_over_finish_gmts,0,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($tot_trims_left_over_qnty,2,'.',''); ?>&nbsp;</td>
            </tr>
            <tr bgcolor="#E9F3FF">
                <td>In %</td>
                <td align="right"><? echo number_format($left_over_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($finish_left_over_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($left_over_finish_gmts_perc,2,'.',''); ?>&nbsp;</td>
                <td align="right"><? echo number_format($tot_trims_left_over_qnty_perc,2,'.',''); ?>&nbsp;</td>
             </tr>
        </table> 
        <br />
        <table width="720" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all">
