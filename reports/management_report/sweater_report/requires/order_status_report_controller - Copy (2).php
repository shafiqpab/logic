...
$html="";
	foreach($dataArr as $ship_date => $customRow){
		...
		$flag_td=1;
		foreach($customRow as $data_row){
			$html.="<div style='float:left; margin:0px;vertical-align:top;' align='left'>
			...
			<td align='center'><strong>Particulars</strong></td>";
					...
					$html.="</tr><tr>
						<td>Color Size Ratio</td>";
					foreach($data_row as $row){
						$html.="<div style='margin:0px;vertical-align:top;'><td><table border='1' cellspacing='0' cellpadding='3' width='100%' style='border-collapse:collapse;'><thead><tr><th><strong>Color</strong></th>";
											foreach($po_size_arr[$row['PO_ID']] as $size_id => $sizeQty){
									...
									$html.="<tfoot><tr><td><strong>G. Total</strong></td>";
											...
											$html.="<td align='center'><strong>".array_sum($po_size_arr[$row['PO_ID']])."</strong></td></tr></tfoot></table></td></div>";
					}
