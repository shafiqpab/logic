 ...
 function fn_report_generated(type)
	{
		...
		{	
			...
			var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_year_name*cbo_month*cbo_month_end*cbo_end_year_name*cbo_style_owner',"../../../")+'&report_title='+report_title+'&type='+type;
			freeze_window(3);
                        ...
                        <table cellpadding="0" cellspacing="2" width="980" class="rpt_table" border="1" rules="all">
                          <thead>  
                            ...
                            <tr class="general">
                                <td>
                                <? 
                                echo create_drop_down( "cbo_company_name", 160, "select id,company_name from lib_company where status_active=1 and is_deleted=0 order by company_name","id,company_name", 0, "-- Select Company --", $selected,"fn_disable_com(1);fnc_load_report_format(this.value);" );
                                ?>
                                </td>
                                 <td >
							<? 
