...
<script>
	...
	function fn_report_generated()
	{
		...
		{	
			...
			freeze_window(3);
			http.open("POST","requires/comparative_woven_post_cost_report_controller.php",true);
	...
	function openmypage_job()
	{
		...
		{	
			...
			emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/comparative_woven_post_cost_report_controller.php?data='+data+'&action=job_no_popup', 'Job No Search', 'width=700px,height=420px,center=1,resize=0,scrolling=0','../../')
         ...
         <h3 align="left" id="accordion_h1" style="width:600px" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
            ...
            <fieldset style="width:600px;">
                <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    ...
                    <tbody>
                        <tr class="general">
                            <td><? echo create_drop_down( "cbo_company_name", 150, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/comparative_woven_post_cost_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" ); ?></td>
