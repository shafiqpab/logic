...
if($action=="report_generate")
{
	...
	if(str_replace("'","",$cbo_costcontrol_source)==1)
	{
		...
		$check_data=sql_select("select a.job_no from wo_po_details_master a,wo_pre_cost_mst f where  a.job_no=f.job_no  and a.company_name=$company_name and a.garments_nature=3 and a.job_no_prefix_num like '$job_no' $year_cond group by a.job_no");
	...
	/*
		...
		//	$fabStri=$fabPur_row[csf('id')];
		 ...
		 $sql = "select a.item_category, a.exchange_rate, b.pre_cost_fabric_cost_dtls_id as fab_dtls_id,b.uom,b.grey_fab_qnty, b.fin_fab_qnty, b.po_break_down_id, b.rate, b.amount from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and a.booking_type=1 and a.fabric_source=2 and b.po_break_down_id in(".implode(",",$poIdArr).") and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1";
			$data_fabPur=sql_select($sql);
			foreach($data_fabPur as $fabPur_row){
		...
		<div style="width:1302px; margin:0 auto">
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1300px; margin-top:10px" rules="all">
				...
				?>
				 <tr class="fbpur" bgcolor="<? echo $bgcolor;?>" onClick="change_color('trfab_<? echo $f; ?>','<? echo $bgcolor;?>')" id="trfab_<? echo $f; ?>">
					...
					<td width="100" align="right"><? echo number_format($fabPurArr[$fab_index]['mkt']['woven']['amount']/$fabPurArr[$fab_index]['mkt']['woven']['qty'],4); ?></td>
					...
					<td width="100" align="right"><? echo number_format($fabPurArr[$fab_index]['pre']['woven']['amount']/$fabPurArr[$fab_index]['pre']['woven']['qty'],4); ?></td>
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1200px; margin-top:5px" rules="all">
				...
				<tr>
					...
					<td width="100" align="right"  title="TotalMktValue/OfferValue*100"><? if($GrandTotalMktValue>0 && $quaOfferValue>0) echo number_format(($GrandTotalMktValue/$quaOfferValue)*100,4);else echo ""; ?></td>
					<td width="150" align="right"><? echo number_format($yarnTrimMktValue,4) ?></td>
					<td width="100" align="right" title="Total Expand/OfferValue*100"><? if($yarnTrimMktValue>0) echo number_format(($yarnTrimMktValue/$quaOfferValue)*100,4);else echo ""; ?></td>
                    <td width="150" align="right"><? echo number_format($total_mkt_amt,4) ?></td>
					<td width="100" align="right" title="Total Mkt Wash/OfferValue*100"><? if($total_mkt_amt>0) echo number_format(($total_mkt_amt/$quaOfferValue)*100,4);else echo ""; ?></td>
                    
					<td width="200" align="right" title="Offer Value-GrandTotal Mkt Value"><? echo number_format($quaOfferValue-$GrandTotalMktValue,4); ?></td>
					<td width="100" align="right" title="Offer Value-GrandTotal Mkt Value/OfferValue*100"><? if($quaOfferValue-$GrandTotalMktValue>0) echo number_format((($quaOfferValue-$GrandTotalMktValue)/$quaOfferValue)*100,4);else echo ""; ?></td>
				</tr>
				<tr>
					...
					<td width="100" align="right" title="TotalPreValue/JobValue*100"><? if($GrandTotalPreValue>0) echo number_format(($GrandTotalPreValue/$jobValue)*100,4);else echo ""; ?></td>
					...
					<td width="100" align="right" title="Total Pre Wash/JobValue*100"><? if($total_pre_amt>0) echo number_format(($total_pre_amt/$jobValue)*100,4);else echo ""; ?></td>
                    
					<td width="200" align="right" title="Job Value-GrandTotal Pre Value"><? echo number_format($jobValue-$GrandTotalPreValue,4);?></td>
					<td width="100" align="right" title="Job Value-GrandTotal Pre Value/PreValue*100"><? if($jobValue-$GrandTotalPreValue>0) echo number_format((($jobValue-$GrandTotalPreValue)/$jobValue)*100,4);else echo "";?></td>
				</tr>
				<tr>
					...
					<td width="100" align="right" title="TotalActualValue/Ex-FactValue*100"><? if($GrandTotalAclValue>0 && $exfactoryValue>0) echo number_format(($GrandTotalAclValue/$exfactoryValue)*100,4);else echo ""; ?></td>
					<td width="150" align="right"><? echo number_format($yarnTrimAclValue,4) ?></td>
					<td width="100" align="right" title="Total TrimsAcl/Ex-fact Value*100"><? if($yarnTrimAclValue>0) echo number_format(($yarnTrimAclValue/$exfactoryValue)*100,4);else echo ""; ?></td>
                     <td width="150" align="right"><? echo number_format($total_acl_amt,4) ?></td>
					<td width="100" align="right" title="Total Wash Acl/Ex-FactValue*100"><? if($total_acl_amt>0) echo number_format(($total_acl_amt/$exfactoryValue)*100,4);else echo ""; ?></td>
					...
					<td width="100" align="right" title="Ex-fact Value-GrandTotal Ex Value/AclValue*100"><? if($exfactoryValue-$GrandTotalAclValue>0) echo number_format((($exfactoryValue-$GrandTotalAclValue)/$exfactoryValue)*100,4);else echo "";?></td>
				</tr>
			</table>
            <br>
            <table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1200px; margin-top:5px" rules="all">
				...
				<tr>
					...
					<td width="100" align="right"  title="TotalMktValue/OfferValue*100"><? if($tot_mkt_val_pcs>0) echo number_format(($tot_mkt_val_pcs/$tot_offer_val_pcs)*100,4); else echo "";?></td>
					<td width="150" align="right"><? $tot_trim_val_pcs=$yarnTrimMktValue/$jobQty;echo number_format($tot_trim_val_pcs,4) ?></td>
					<td width="100" align="right" title="Total Trim/OfferValue*100"><? if($tot_trim_val_pcs>0) echo number_format(($tot_trim_val_pcs/$tot_offer_val_pcs)*100,4);else echo ""; ?></td>
                    <td width="150" align="right"><? $tot_wash_val_pcs=$total_mkt_amt/$jobQty; echo number_format($tot_wash_val_pcs,4) ?></td>
					<td width="100" align="right" title="Total Mkt Wash/OfferValue*100"><? if($tot_wash_val_pcs>0) echo number_format(($tot_wash_val_pcs/$tot_offer_val_pcs)*100,4);else echo ""; ?></td>
					...
					<td width="100" align="right" title="Offer Value-(GrandTotal Mkt Value/OfferValue*100)"><? if($profit_mkt_margin_pcs>0) echo number_format(($profit_mkt_margin_pcs/$tot_offer_val_pcs)*100,4);else echo ""; ?></td>
				</tr>
				<tr>
					<td width="200" >Pre Costing</td>
					...
					<td width="100" align="right" title="TotalPreValue/JobValue*100"><? 
				...
				<tr>
					...
					<td width="100" align="right" title="TotalActualValue/Ex-FactValue*100"><? if($tot_AclJob_ExpndPcs>0 && $tot_AclJob_valuePcs>0) echo number_format(($tot_AclJob_ExpndPcs/$tot_AclJob_valuePcs)*100,4);else echo ""; ?></td>
					<td width="150" align="right"><? $tot_AcltrimValue=$yarnTrimAclValue/$jobQty;echo number_format($tot_AcltrimValue,4) ?></td>
					<td width="100" align="right" title="Total TrimsAcl/Ex-fact Value*100"><? if($tot_AcltrimValue>0) echo number_format(($tot_AcltrimValue/$tot_AclJob_valuePcs)*100,4);else echo ""; ?></td>
                     <td width="150" align="right"><? $tot_AclJobWashPcs=$total_acl_amt/$jobQty; echo number_format($tot_AclJobWashPcs,4) ?></td>
					<td width="100" align="right" title="Total Wash Acl/Ex-FactValue*100"><? if($tot_AclJobWashPcs>0) echo number_format(($tot_AclJobWashPcs/$tot_AclJob_valuePcs)*100,4);else echo ""; ?></td>
					...
					<td width="100" align="right" title="Ex-fact Value-(GrandTotal Ex Value/AclValue*100)"><? if($profit_acl_margin_pcs>0) echo number_format(($profit_acl_margin_pcs/$tot_AclJob_valuePcs)*100,4);else echo "";?></td>
				</tr>
			</table>
             <br>
              <br>
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1300px; margin-top:10px" rules="all">
				...
				?>
				 <tr class="fbpur" bgcolor="<? echo $fab_bgcolor2;?>" onClick="change_color('trfab_<? echo $f1; ?>','<? echo $fab_bgcolor2;?>')" id="trfab_<? echo $f1; ?>">
					...
					<td width="100" align="right"><? if($fabPurArr['acl']['woven']['amount']>0) echo number_format($fabPurArr['acl']['woven']['amount']/$fabPurArr['acl']['woven']['qty'],4);else echo ""; ?></td>
