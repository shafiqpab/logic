...
if($action=="report_generate")
{
	...
	//$shiping_status=1;$shiping_status_id="";
		  ...
		  $wvn_booking_partial_result=sql_select($wvn_booking_partial);
		   foreach($wvn_booking_partial_result as $row)
			...
			//for test
				...
				//print_r($piQtyArr);
				 $grp_data_array=sql_select("SELECT a.id,b.job_no,c.fabric_description,a.id, a.booking_no, b.fabric_color_id, c.construction as construction, c.composition as copmposition, b.gsm_weight as weight, c.gsm_weight_type as fab_weight_type, c.width_dia_type as dia_or_width, b.dia_width as width, b.item_size as cutable_width, sum(b.fin_fab_qnty) as fin_fab_qnty, sum(b.fin_fab_qnty*b.rate) as amount, c.lib_yarn_count_deter_id as deter_id, c.body_part_id, c.uom, 0 as dtls_id
					from wo_booking_mst a, wo_booking_dtls b, wo_pre_cost_fabric_cost_dtls c 
					where a.booking_no=b.booking_no and b.pre_cost_fabric_cost_dtls_id=c.id $job_id_cond_in3 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 
					group by a.id, a.booking_no, b.fabric_color_id, c.fabric_description,b.job_no,c.construction, c.composition, b.gsm_weight, c.gsm_weight_type, c.width_dia_type, b.dia_width, b.item_size, c.lib_yarn_count_deter_id, c.body_part_id, c.uom
					...
					foreach($grp_data_array as $row)
					{
							...
							if($piDtlsId)
							{
							$pi_style_desc_arr[$job_no][$fab_desc]['fab_pi_data']=$piQtyArr[$job_no][$alls_data]['dtls_id'];
							}
	 ...
	 $sql_pi = "select a.id as pi_mst_id,a.item_category_id as cat_id,a.pi_number,b.work_order_no,b.color_id,b.work_order_id,b.determination_id,(b.quantity) as qty,b.rate,b.amount,b.item_group,b.item_description from com_pi_master_details a, com_pi_item_details b where a.id=b.pi_id  and a.pi_basis_id=1  and b.item_category_id in(3) and b.status_active=1 and b.is_deleted=0 $booking_cond_in ";//wo_id_arr
