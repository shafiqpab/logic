    ...
    <fieldset>
        ...
        <table id="table_header_1" class="rpt_table" width="<? echo $width;?>" cellpadding="0" cellspacing="0" border="1" rules="all">
            <thead>
                ...
                <tr style="font-size:12px"> 
                    ...
                    <th width="80" title="">Finish Qty</th>	
       ...
       <div style="width:<? echo $width+20;?>px; max-height:400px; overflow-y:scroll" id="scroll_body">
            <table class="rpt_table" width="<? echo $width;?>" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
				...
				<?php
                $i=1;$tot_fin_qty=$tot_fin_process_loss=$tot_ex_factQty=$tot_prod_qty=0;
            ...
            ?>	
                <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>" style="font-size:12px; cursor:pointer;" valign="middle">
                    ...
                    <td width="80" align="right" ><? 
					 if($sewing_prod_p_loss) 
					 echo  number_format((($sewing_prod_p_loss/$row[('sew_in')])*100),2).'% ' ;
					 else echo " ";?></td>	
                    ...
                    <td width="80" align="right"><a href="##" onClick="generate_ex_factory_popup('style_ex_factory_popup','<?=$job_no_prefix_num;?>','<?=$po_ids; ?>','<?=str_replace("'","",$txt_date_from) ?>','<?=str_replace("'","",$txt_date_to) ?>','650px')"><?=number_format($row['ex_factQty'],0,'.',''); ?></a><? //echo omitZero(number_format($row[('ex_factQty')],0));?></td>
					<?
			...
			//	$tot_ff_qnty+=round($ff_qnty_array[$row[csf('id')]]);
				...
				$tot_sewing_prod_p_loss+=$sewing_prod_p_loss;
