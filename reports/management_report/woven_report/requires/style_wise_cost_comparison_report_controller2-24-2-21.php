...
if($action=="report_generate")
{
	...
	if(str_replace("'","",$cbo_costcontrol_source)==2)
	{
		...
		c.from_order_id
		from inv_item_transfer_dtls a, order_wise_pro_details b,inv_item_transfer_mst c where a.id=b.dtls_id and c.id=a.mst_id and a.status_active=1 and a.is_deleted=0 and c.transfer_criteria!=2 and b.status_active=1 and b.is_deleted=0 and b.entry_form in(78) and b.trans_type in(5,6) and b.po_breakdown_id in(".implode(",",$poIdArr).") ";
		...
		$data_array=sql_select($sql);
		foreach($data_array as $row){
			$index="'".$emblishment_name_array[$row[csf("emb_name")]]."_".$emblishment_wash_type_arr[$row[csf("emb_type")]]."'";
			$washData[$index]['pre']['qty']+=$washQtyArr[$jobNumber][$row[csf('id')]];
			$washData[$index]['pre']['amount']+=$washAmtArr[$jobNumber][$row[csf('id')]];
		}
		if($quotationId){
			$sql = "select id, emb_name, emb_type, cons_dzn_gmts, rate, amount,status_active from wo_pri_quo_embe_cost_dtls where quotation_id='".$quotationId."' and emb_name =3";
			$data_array=sql_select($sql);
		...
		<div style="width:1302px; margin:0 auto">
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1300px" rules="all">
				...
				<tr>
					...
					<td align="right"  colspan="2"><? echo number_format($shortExcessValue,4); ?></td>
					<td>Ship. Status</td>
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1300px; margin-top:10px" rules="all">
				<thead>
                	...
                	<td> </td>
                    <td> </td>
                    <td colspan="4" align="center" bgcolor="#999999"> Buyer Cost</td>
                    <td colspan="4" align="center" bgcolor="#999966"> Booking Cost</td>
                    <td colspan="4" align="center" bgcolor="#99CCFF"> Post Cost</td>
               		</tr>
				...
				?>
				 <tr class="fbpur" bgcolor="<? echo $fab_bgcolor2;?>" onClick="change_color('trfab_<? echo $f1; ?>','<? echo $fab_bgcolor2;?>')" id="trfab_<? echo $f1; ?>">
					...
					<td width="100" align="right"><? echo number_format($fabPurArr['mkt']['woven']['amount'],4); ?></td>
                     <td width="100" align="right"><? echo number_format(($fabPurArr['mkt']['knit']['amount']/$jobValue)*100,4); ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($fabPurArr['pre']['woven']['amount']/$jobValue)*100,4); ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($fabPurArr['acl']['woven']['amount']/$jobValue)*100,4); ?></td>
				</tr>
				<tr style="font-weight:bold;background-color:#CCC">
                    ...
                    <td width="100" align="right"><? echo number_format(($fabPurMkt/$jobValue)*100,4); ?></td>
					<td width="100" align="right"></td>
					<td width="100" align="right"></td>
					<td width="100" align="right" bgcolor=" <? if($fabPurPre>$fabPurMkt){echo "yellow";} else{echo "";}?>">
                     ...
                     <td width="100" align="right"><? echo number_format(($fabPurPre/$jobValue)*100,4); ?></td>
					<td width="100"></td>
					<td width="100"></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($fabPurAcl/$jobValue)*100,4); ?></td>
				</tr>
				
				 <tr style="font-weight:bold" class="transc">
					<td colspan="14">Transfer Cost</td>
				</tr>
			  <?
				...
				?>
				 <tr class="transc" bgcolor="<? echo $trans_bgcolor1;?>" onClick="change_color('trtrans_<? echo $tt; ?>','<? echo $trans_bgcolor1;?>')" id="trtrans_<? echo $tt; ?>">
                        ...
                        <td width="100" align="right"><? //echo number_format(($aopData['acl']['amount']/$jobValue)*100,4); ?></td>
                        ...
                        <td width="100" align="right"><? echo number_format(($tot_grey_fab_cost_acl/$jobValue)*100,4); ?></td>
					</tr>
				...
				<tr style="font-weight:bold;background-color:#CCC">
                    ...
                    <td width="100" align="right"><? echo number_format((($tot_fin_fab_transfer_cost+$tot_grey_fab_cost_acl)/$jobValue)*100,4); ?></td>
				</tr>
				...
				foreach($trimData as $index=>$row ){
					...
					<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('trtrims_<? echo $t; ?>','<? echo $bgcolor;?>')" id="trtrims_<? echo $t; ?>">
						...
						<td width="100" align="right"><? echo number_format($row['mkt']['amount']/$row['mkt']['qty'],4); ?></td>
						<td width="100" align="right"><? echo number_format($row['mkt']['amount'],4); ?></td>
                        <td width="100" align="right"><? echo number_format(($row['mkt']['amount']/$jobValue)*100,4); ?></td>
				...
				<tr style="font-weight:bold;background-color:#CCC">
					...
					<td width="100" align="right">
                     ...
                     <td width="100" align="right"><? echo number_format(($totalTrimMktValue/$jobValue)*100,4); ?></td>
					<td width="100" align="right"></td>
					<td width="100" align="right"></td>
					<td width="100" align="right" bgcolor=" <? if($totalTrimPreValue>$totalTrimMktValue){echo "yellow";} else{echo "";}?>">
                     ...
                     <td width="100" align="right"><? echo number_format(($totalTrimPreValue/$jobValue)*100,4); ?></td>
					<td width="100"></td>
					<td width="100"></td>
					<td width="100" align="right" bgcolor=" <? if(number_format($totalTrimPreValue,4,".","")>number_format($totalTrimMktValue,4,".","")){echo "yellow";} else{echo "";}?>">
                     ...
                     <td width="100" align="right"><? echo number_format(($totalTrimAclValue/$jobValue)*100,4); ?></td>
				</tr>
				<?
				...
				?>
				 <tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('emblish_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="emblish_<? echo $embl; ?>">
                    ...
                    <td width="100" align="right"><? echo number_format(($embData['mkt']['amount']/$jobValue)*100,4); ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($embData['pre']['amount']/$jobValue)*100,4); ?></td>
					...
					<td width="100" align="right" bgcolor="<? if(number_format($embData['acl']['amount'],4,".","")>number_format($embData['pre']['amount'],4,".","")){echo "red";}else{ echo "";} ?>"><? echo number_format($embData['acl']['amount'],4); $totalOtherAclValue+=number_format($embData['acl']['amount'],4,".","");?></td>
                     <td width="100" align="right"><? echo number_format(($embData['acl']['amount']/$jobValue)*100,4); ?></td>
				</tr>
				...
				<tr  class="wash" bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('wash_<? echo $w; ?>','<? echo $bgcolor;?>')" id="wash_<? echo $w; ?>">
					...
					<td width="100" align="right"><? echo number_format($row['mkt']['qty'],4); ?></td>
					<td width="100" align="right"><? echo number_format($row['mkt']['amount']/$row['mkt']['qty'],4); ?></td>
					<td width="100" align="right"><? echo number_format($row['mkt']['amount'],4); $totalOtherMktValue+=number_format($row['mkt']['amount'],4,".","");?></td>
                    <td width="100" align="right"><? echo number_format(($row['mkt']['amount']/$jobValue)*100,4); ?></td>
					<td width="100" align="right"><? echo number_format($row['pre']['qty'],4); ?></td>
					<td width="100" align="right"><? echo number_format($row['pre']['amount']/$row['pre']['qty'],4); ?></td>
					<td width="100" align="right" bgcolor="<? if(number_format($row['pre']['amount'],4,".","")>number_format($row['mkt']['amount'],4,".","")){echo "yellow";}else{ echo "";} ?>"><? echo number_format($row['pre']['amount'],4);$totalOtherPreValue+=number_format($row['pre']['amount'],4,".",""); ?></td>
					<td width="100" align="right"><? echo number_format($row['acl']['qty'],4); ?></td>
                     <td width="100" align="right"><? echo number_format(($row['acl']['amount']/$jobValue)*100,4); ?></td>
					<td width="100" align="right"><? echo number_format($row['acl']['amount']/$row['acl']['qty'],4); ?></td>
					<td width="100" align="right" bgcolor="<? if(number_format($row['acl']['amount'],4,".","")>number_format($row['pre']['amount'],4,".","")){echo "red";}else{ echo "";} ?>"><? echo number_format($row['acl']['amount'],4);$totalOtherAclValue+=number_format($row['acl']['amount'],4,".",""); ?></td>
                     <td width="100" align="right"><? echo number_format(($row['acl']['amount']/$jobValue)*100,4); ?></td>
				</tr>
                <?
				$w++;
				...
				?>
                 <tr style="font-weight:bold;background-color:#CCC">
					...
					<td width="100" align="right"><? echo number_format($total_mkt_qty/$total_mkt_amt,4); ?></td>
					<td width="100" align="right"><? echo number_format($total_mkt_amt,4); $totalOtherMktValue+=number_format($total_mkt_amt,4,".","");?></td>
                    <td width="100" align="right"><? echo number_format(($total_mkt_amt/$jobValue)*100,4); ?></td>
				...
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('commi_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="commi_<? echo $embl; ?>">
					...
					<td width="100" align="right"><? echo number_format($commiData['mkt']['amount'],4); $totalOtherMktValue+=number_format($commiData['mkt']['amount'],4,".","");?></td>
                     <td width="100" align="right"><? echo number_format(($commiData['mkt']['amount']/$jobValue)*100,4); ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($commiData['pre']['amount']/$jobValue)*100,4); ?></td>
			...
			//echo "(".$commiData['pre']['rate']."/(".$costPerQty*$totalSetQnty."))*".$exfactoryQty;
					...
					<td width="100" align="right" bgcolor="<? if(number_format($aclCommiAmt,4,".","")>number_format($commiData['pre']['amount'],4,".","")){echo "red";}else{ echo "";} ?>">
                      ...
                      <td width="100" align="right"><? echo number_format(($aclCommiAmt/$jobValue)*100,4); ?></td>
				</tr>
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('commer_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="commer_<? echo $embl; ?>">
                    ...
                    <td width="100" align="right"><? echo number_format(($commaData['mkt']['amount']/$jobValue)*100,4); ?></td>
					...
					<td width="100" align="right" bgcolor="<? if(number_format($commaData['pre']['amount'],4,".","")>number_format($commaData['mkt']['amount'],4,".","")){echo "yellow";}else{ echo "";} ?>"><? echo number_format($commaData['pre']['amount'],4); $totalOtherPreValue+=number_format($commaData['pre']['amount'],4,".","");?></td>
                     <td width="100" align="right"><? echo number_format(($commaData['pre']['amount']/$jobValue)*100,4); ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($commer_act_cost/$jobValue)*100,4); ?></td>					
				</tr>
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('trfc_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="trfc_<? echo $embl; ?>">
                    ...
                    <td width="100" align="right"><? echo number_format(($otherData['mkt']['freight']['amount']/$jobValue)*100,4); ?></td>
					...
					<td width="100" align="right" bgcolor="<? if(number_format($otherData['pre']['freight']['amount'],4,".","")>number_format($otherData['mkt']['freight']['amount'],4,".","")){echo "yellow";}else{ echo "";} ?>"><? echo number_format($otherData['pre']['freight']['amount'],4); $totalOtherPreValue+=number_format($otherData['pre']['freight']['amount'],4,".","");?></td>
                     <td width="100" align="right"><? echo number_format(($otherData['pre']['freight']['amount']/$jobValue)*100,4); ?></td>
					<td width="100" align="right"><? echo $exfactoryQty; ?></td>
					...
					<td width="100" align="right"  bgcolor="<? if(number_format($otherData['acl']['freight']['amount'],4,".","")>number_format($otherData['pre']['freight']['amount'],4,".","")){echo "red";}else{ echo "";} ?>"><? echo number_format($otherData['acl']['freight']['amount'],4); $totalOtherAclValue+=number_format($otherData['acl']['freight']['amount'],4,".","");?></td>
                     <td width="100" align="right"><? echo number_format(($otherData['acl']['freight']['amount']/$jobValue)*100,4); ?></td>
				</tr>
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('trtc_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="trtc_<? echo $embl; ?>">
                    ...
                    <td width="100" align="right"><? echo number_format(($test_act_cost/$jobValue)*100,4); ?></td>
				</tr>
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('tric_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="tric_<? echo $embl; ?>">
					...
					<td width="100" align="right"><? echo number_format($otherData['mkt']['inspection']['amount'],4);$totalOtherMktValue+=number_format($otherData['mkt']['inspection']['amount'],4,".",""); ?></td>
                     <td width="100" align="right"><? echo number_format(($otherData['mkt']['inspection']['amount']/$jobValue)*100,4); ?></td>
					...
					<td width="100" align="right" bgcolor="<? if(number_format($otherData['pre']['inspection']['amount'],4,".","")>number_format($otherData['mkt']['inspection']['amount'],4,".","")){echo "yellow";}else{ echo "";} ?>"><? echo number_format($otherData['pre']['inspection']['amount'],4);$totalOtherPreValue+=number_format($otherData['pre']['inspection']['amount'],4,".",""); ?></td>
                     <td width="100" align="right"><? echo number_format(($otherData['pre']['inspection']['amount']/$jobValue)*100,4); ?></td>
					<td width="100" align="right"><? echo $exfactoryQty ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($otherData['acl']['inspection']['amount']/$jobValue)*100,4); ?></td>
				</tr>
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('trcc_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="trcc_<? echo $embl; ?>">
                    ...
                    <td width="100" align="right"><? echo number_format(($otherData['mkt']['currier_pre_cost']['amount']/$jobValue)*100,4); ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($otherData['pre']['currier_pre_cost']['amount']/$jobValue)*100,4); ?></td>
					<td width="100" align="right"><? echo $exfactoryQty ?></td>
                    ...
                    <td width="100" align="right"><? echo number_format(($otherData['acl']['currier_pre_cost']['amount']/$jobValue)*100,4); ?></td>
				</tr>
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('trmc_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="trmc_<? echo $embl; ?>">
                    ...
                    <td width="100" align="right"><? echo number_format(($otherData['mkt']['cm_cost']['amount']/$jobValue)*100,4); ?></td>
					...
					<td width="100" align="right" bgcolor="<? if(number_format($otherData['pre']['cm_cost']['amount'],4,".","")>number_format($otherData['mkt']['cm_cost']['amount'],4,".","")){echo "yellow";}else{ echo "";} ?>"><? echo number_format($otherData['pre']['cm_cost']['amount'],4); $totalOtherPreValue+=number_format($otherData['pre']['cm_cost']['amount'],4,".","");?></td>
                     <td width="100" align="right"><? echo number_format(($otherData['pre']['cm_cost']['amount']/$jobValue)*100,4); ?></td>
					<?
					...
					<td width="100" align="right"  bgcolor="<? if(number_format($otherData['acl']['cm_cost']['amount'],4,".","")>number_format($otherData['pre']['cm_cost']['amount'],4,".","")){echo "red";}else{ echo "";} ?>"><?  $totalOtherAclValue+=number_format($otherData['acl']['cm_cost']['amount'],4,".",""); echo number_format($otherData['acl']['cm_cost']['amount'],4);?></td>
                     <td width="100" align="right"><? echo number_format(($otherData['acl']['cm_cost']['amount']/$jobValue)*100,4); ?></td>
				...
				<tr style="font-weight:bold;background-color:#C60">
                   ...
                   <td width="100" align="right"><? echo number_format(($GrandTotalMktValue*100/$jobValue),2).'%'; ?></td>
				...
				<tr  bgcolor="<? echo $other_bgcolor;?>" onClick="change_color('trsv_<? echo $embl; ?>','<? echo $other_bgcolor;?>')" id="trsv_<? echo $embl; ?>">
					...
					<td width="100" align="right">
                     ...
                     <td width="100" align="right"><? echo number_format(($quaOfferValue*100/$jobValue),2).'%'; ?></td>
					...
					<td width="100" align="right"><? echo number_format($exfactoryValue,4) ?></td>
                      <td width="100" align="right"><? echo number_format(($exfactoryValue*100/$jobValue),2).'%'; ?></td>
				</tr>
			</table>
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1200px; margin-top:5px" rules="all">
				...
				<tr>
					<td width="200" >Booking Costing</td>
	...
	else if(str_replace("'","",$cbo_costcontrol_source)==1)
	{
		$company_name=str_replace("'","",$cbo_company_name);
		$job_no=str_replace("'","",$txt_job_no);
		$cbo_year=str_replace("'","",$cbo_year);
		...
		//echo $quaOfferQnty; die;
			...
			foreach ($sql_result_cons_rate as $rowConsRate)
			{
				...
				if($rowConsRate[csf("type")]==2 && $rowConsRate[csf("particular_type_id")]==3) //Wash
				{
					$index="'".$emblishment_wash_type_arr[$rowConsRate[csf("item_id")]]."'";
			...
			<table class="rpt_table" border="1" cellpadding="2" cellspacing="2" style="width:1300px; margin-top:10px" rules="all">
			  ...
			  <?
				...
				<tr style="font-weight:bold;background-color:#CCC">
                    ...
                    <td width="100" align="right"><? echo number_format((($tot_fin_fab_transfer_cost+$tot_grey_fab_cost_acl)*100/$jobValue),2).'%'; ?></td>
				</tr>
				<tr>
		...
		<table border="1" class="rpt_table" rules="all" width="750" cellpadding="0" cellspacing="0">
			...
			foreach ($result as $row) {
				...
				<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
					...
					<td align="right" title="Avg Rate: <? //echo number_format($avg_rate, 4); ?>"><? //echo number_format(($row[csf('transfer_qnty')]*$avg_rate)/$g_exchange_rate, 2);
			...
			foreach ($result as $row) {
				...
				<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
					...
					<td width="170"><p><? echo $row[csf('product_name_details')]; ?></p></td>
					<td  width="100" align="right"><? echo number_format($row[csf('transfer_qnty')], 2); ?> </td>
					 <td align="right" title="Avg Rate: <? //echo $avg_rate; ?>"><? //echo number_format(($row[csf('transfer_qnty')]*$avg_rate)/$g_exchange_rate, 2);
		...
		<table border="1" class="rpt_table" rules="all" width="750" cellpadding="0" cellspacing="0">
			...
			foreach ($result as $row) {
				...
				<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
					...
					<td align="right" title="Avg  Rate: <? echo $avg_rate; ?>"><? echo number_format(($row[csf('transfer_qnty')]*$avg_rate)/$g_exchange_rate, 2); ?> </td>
				</tr>
				<?
				$total_trans_in_qnty += $row[csf('transfer_qnty')];
				 $total_trans_in_amt += ($row[csf('transfer_qnty')]*$avg_rate)/$g_exchange_rate;
				$i++;
			}
			?>
			<tr style="font-weight:bold">
			...
			foreach ($result as $row) {
				...
				<?
				$total_trans_out_qnty += $row[csf('transfer_qnty')];
				$total_trans_out_amt += ($row[csf('transfer_qnty')]*$avg_rate)/$g_exchange_rate;
				$i++;
			}
			?>
			<tr style="font-weight:bold">
