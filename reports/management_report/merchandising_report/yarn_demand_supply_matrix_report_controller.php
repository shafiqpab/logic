...
{ 
	...
	/										main query 											/
	/==========================================================================================*/
	/*$sql_alloc = "SELECT b.po_break_down_id as PO_ID, c.YARN_COUNT_ID, c.YARN_COMP_TYPE1ST, c.YARN_COMP_TYPE2ND,b.QNTY from inv_material_allocation_mst a,inv_material_allocation_dtls b, product_details_master c where a.id=b.mst_id and b.item_id=c.id and b.item_category=1 and c.item_category_id=1 and a.status_active=1 and b.status_active=1 and c.status_active=1 and a.is_deleted=0 and b.is_deleted=0 and c.is_deleted=0 and c.company_id=$company_name and c.yarn_comp_type1st !=0 and c.yarn_count_id !=0 and a.allocation_date < '$current_date'";// $poCond and c.YARN_COMP_TYPE1ST = 451 and c.YARN_COUNT_ID = 188
	// echo $sql_alloc;die();
	...
	$poIdcon=where_con_using_array($po_id_arr,0,'b.id');*/
