...
/*-------------------------------------------- Comments
Version                  :  V1
Purpose			         : 	This form will create Month Capacity VS Allocated Order Report
Functionality	         :	
JS Functions	         :
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Month Capacity VS Allocated Order", "../../../", "", $popup, 1);
?>	
<script>
	...
	function fn_report_generated()
	{
		...
		{	
			...
			freeze_window(3);
			http.open("POST","requires/monthly_capacity_vs_allocated_order_report_controller.php",true);
	...
	function fn_report_generated_reponse()
	{
		if(http.readyState == 4) 
		{
			...
			document.getElementById('report_container').innerHTML=report_convert_button('../../../'); 
	 		show_msg('3');
			release_freezing();
			hs_chart("["+reponse[2]+"]","["+reponse[3]+"]","["+reponse[4]+"]");
		}
	}
...
function hs_chart(capacityVal,allocatedVal,Month){
	...
	$('#container').highcharts({
        ...
        title: {
            text: 'Monthly Capacity VS Allocated Order'
        },
        subtitle: {
            text: ''
        },
...
<body onLoad="set_hotkey()">
    <div style="width:100%;" align="center">
        ...
        <h3 align="left" id="accordion_h1" class="accordion_h" style="width:750px;" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
                ...
                <div style="width:750px">
                    <fieldset>  
                        <table cellpadding="0" cellspacing="0" width="750" class="rpt_table" border="1" rules="all">
                            ...
                            <tr class="general">
                                <td><? echo create_drop_down( "cbo_company_name", 150, "select id, company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "--Select Company--", $selected,"load_drop_down( 'requires/monthly_capacity_vs_allocated_order_report_controller', this.value, 'load_drop_down_location', 'location_id_td' )" ); ?></td>
