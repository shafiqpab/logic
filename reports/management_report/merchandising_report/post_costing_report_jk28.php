                	...
                	<thead>
                     ...
                     <tbody>
                        <tr class="general">
                            ...
                            <td><? echo create_drop_down( "cbo_year", 60, create_year_array(),"",0,"-- All --", 1, "",0,"" );//date("Y",time()) ?></td>
                            <td>
                            ...
                            <td><? echo create_drop_down( "shipping_status", 80, $shipment_status,"", 0, "-- Select --", 3, "",0,'','','','','' ); ?></td>
                            <td>
                                <?  
