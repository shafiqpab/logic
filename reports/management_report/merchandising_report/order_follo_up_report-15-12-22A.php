...
echo load_html_head_contents("Order Follow up Report","../../../", 1, 1, $unicode,1,1);
?>	
<script> 
	...
	var tableFilters = {
				...
				var tableFilters2 = 
				{
					...
					{
						id: ["value_po_qty_td","td_po_value","td_gf_qnty","td_yarn_alloc_qnty","td_yarn_issue_qnty","td_yarn_value","td_gp_qty","td_yarn_budget_value","td_grey_cost_value","td_gp_to_qty","td_daying_qnty","td_dying_cost","td_total_fabric_cost","td_ff_qnty","td_fabrics_avl_qnty","td_blance","td_lay_cut_qnty","td_cut_qnty","td_emb_issue_qnty","td_emb_rec_qnty","td_sewing_in_qnty","td_sewing_out_qnty","td_sewing_finish_qnty","td_ex_qnty"],
					  //col: [17,20,21,23,24,25,26,27,28,29,30,31], //25
						col: [10,12,15,16,17,18,19,20,21,22,24,25,26,27,28,29,30,32,34,35,36,37,38,39],
	...
	function fn_report_generated(str)
	{
		...
		else
		{
			...
			var data="action="+action+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_job_no*txt_style_ref*cbo_order_status*txt_order_no*cbo_date_type*txt_date_from*txt_date_to*cbo_agent_name*cbo_year*cbo_ship_status*cbo_fabric_nature*cbo_fabric_source*txt_file_no*txt_ref_no*tna_task_id',"../../../");
...
//alert(tableFilters);
	...
	function date_fill_change(str)
	{
		...
		{
			document.getElementById('search_date_td').innerHTML='Country Ship Date';
		} //Country Ship Date
		else
		{
...
function openmypage_task()
{
    ...
    {
        var page_link='requires/order_follo_up_report_controller.php?action='+action+'&mst_id='+mst_id+'&order_id='+order_id;
                    ...
                    <tr class="general">
                        ...
                        <td>
                         ...
                         <td>
                       	...
                       	<td>
							<? 
							$date_type_arr=array(1=>'Ship Date',2=>'Original Ship Date',3=>'PO Insert Date',4=>'Country Ship Date Wise');
