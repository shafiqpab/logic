...
if ($action=="get_defult_date")
{
	...
	// $report_datecatagory=sql_select( "select report_date_catagory from variable_order_tracking where company_namein ($data) and variable_list=42 and status_active=1 and is_deleted=0");
...
$sql_data=sql_select("select a.company_id,a.location_id,a.year_id,a.month_id, b.buyer_id,b.allocation_percentage from lib_capacity_allocation_mst a, lib_capacity_allocation_dtls b where a.id=b.mst_id and a.company_id in ($company_name) and b.buyer_id like '$buyer_name'  $year_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0");
...
<?  echo fn_number_format(($target_basic_qnty[$buyer]/$total_target_basic_qnty)*100,2); $percent_total+=($target_basic_qnty[$buyer]/$total_target_basic_qnty)*100; ?>
</td>
<td width="100" align="right" bgcolor="#CCCCCC"><? echo number_format($value1[booked_basic_qnty],0);?></td>
<td width="50" align="right" bgcolor="#CCCCCC"><? echo fn_number_format(($value1[booked_basic_qnty]/$target_basic_qnty[$buyer])*100,2); ?></td>
<td width="80" align="right" bgcolor="#CCCCCC"><? echo number_format($target_basic_qnty[$buyer]-$value1[booked_basic_qnty],0);?></td>
<td width="50" align="right" bgcolor="#CCCCCC"><? echo fn_number_format((($target_basic_qnty[$buyer]-$value1[booked_basic_qnty])/$target_basic_qnty[$buyer])*100,2);?></td> 
...
<?
		...
		else
		{
            ...
            <td width="100" align="right" bgcolor="#CCCCCC"><? echo number_format($target_basic_qnty[$buyer],0); $target_basic_qnty_tot+=$target_basic_qnty[$buyer];?></td>
			<td width="50" align="right" bgcolor="#CCCCCC"><?  echo fn_number_format(($target_basic_qnty[$buyer]/$total_target_basic_qnty)*100,2); $percent_total+=($target_basic_qnty[$buyer]/$total_target_basic_qnty)*100; ?></td>
			<td width="100" align="right" bgcolor="#CCCCCC"><? echo number_format($value1[booked_basic_qnty],0);?></td>
			<td width="50" align="right" bgcolor="#CCCCCC"><? echo fn_number_format(($value1[booked_basic_qnty]/$target_basic_qnty[$buyer])*100,2); ?></td>
			<td width="80" align="right" bgcolor="#CCCCCC"><? echo number_format($target_basic_qnty[$buyer]-$value1[booked_basic_qnty],0);?></td>
			<td width="50" align="right" bgcolor="#CCCCCC"><? echo fn_number_format((($target_basic_qnty[$buyer]-$value1[booked_basic_qnty])/$target_basic_qnty[$buyer])*100,2);?></td>
