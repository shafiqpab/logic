<?php
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This file for Order Follo up Report Controller.
Functionality	:	
JS Functions	:
...
{	
	...
	//echo $po_cond_for_in;die;
		if($db_type==0){$date_diff="DATEDIFF(b.shipment_date,b.po_received_date) as  date_diff,";}
		 ...
		 $sql="select $date_diff a.buyer_name,a.total_set_qnty,a.job_no_prefix_num ,a.job_no,a.style_ref_no,b.po_number,a.set_smv,a.set_break_down,a.order_uom,a.gmts_item_id,b.id,a.buyer_name,(b.po_quantity*a.total_set_qnty) as po_quantity,b.po_quantity as  po_qty,b.plan_cut,b.unit_price,$date_category as pub_shipment_date,b.po_received_date,b.insert_date,b.grouping, b.file_no,b.is_confirmed,b.inserted_by,b.po_total_price,b.details_remarks,a.id as job_id,b.unit_price  from wo_po_details_master a, wo_po_break_down b where a.job_no=b.job_no_mst $company_name and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 $search_text $buyer_id_cond $shipping_status_cond $po_cond_for_in $file_no_cond $ref_no_cond order by $date_category"; 
...
$po_job_cond=where_con_using_array($order_id_arr,0,"b.order_id");
	...
	foreach($order_data_arr as $rows)
	{
		...
		$buyer_summary_arr[$rows[csf('buyer_name')]]['lay_cut_qty']+=$lay_cut_data_dtls[$rows[csf("id")]]['lay_cut_qty'];//$lay_cut_data[$rows[csf('job_no')]][$rows[csf('buyer_name')]];
        ...
        <table width="100%" border="1" rules="all"  class="rpt_table"> 
            <thead>
                <tr style="font-size:12px"> 
                    ...
                    <th width="80">QTY</th>
                    <!-- <th width="80">test Order Value</th> -->
            ...
            <tbody>
                ...
                <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('str_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="str_<? echo $i; ?>" style="font-size:12px; cursor:pointer;" valign="middle">
                    ...
                    <!-- <td align="right">test<? //echo omitZero(number_format($rows['po_val'],0));?></td> -->
            ...
            <tfoot>
                ...
                <!-- <th align="right">test<? //echo omitZero(number_format($buyer_tot_arr['po_val']));?></th> -->
	...
	<div style="width:<?=$main_width+$new_column+20;?>px" align="left">	
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr><td colspan="30" align="center" style="font-size:22px;">Order Follow-Up Report Without Value</td></tr>
            <tr>
        ...
        <table width="<?=$main_width+$new_column+20;?>" border="1" rules="all"  class="rpt_table"> 
            <thead>
                <tr style="font-size:12px"> 
                    ...
                    <th width="80" style="word-break: break-all;">SMV</th>	
                    <th width="80" style="word-break: break-all;">Grey Req</th>
                    <th width="80" style="word-break: break-all;">Yarn Alloc</th>
                    <th width="80" style="word-break: break-all;">Yarn Issue</th>
                    <th width="80" style="word-break: break-all;">Grey Prod.</th>	
                    <th width="80" style="word-break: break-all;">Grey to Dye</th>	
                    <th width="80" style="word-break: break-all;">G2D (%)</th>	
                    <th width="80" style="word-break: break-all;">Dyeing</th>
                    <th width="80" style="word-break: break-all;">Fabrics Req.</th>	
                    <th width="80" style="word-break: break-all;" title="95% GREEN 75% - 95% YELLOW">Fabrics Avl.</th>	
                    <th width="80" style="word-break: break-all;">Balance</th>	
                    <th width="80" style="word-break: break-all;">Cut Lay Qty</th>	
                    <th width="80" style="word-break: break-all;">Cut Lay%</th>
                    <th width="80" style="word-break: break-all;">Cut Qc Qty</th>	
                    <th width="80" style="word-break: break-all;">Qc (%)</th>	
                    <th width="80" style="word-break: break-all;">Emb. Issue</th>	
                    <th width="80" style="word-break: break-all;">Emb. Receive</th>	
                    <th width="80" style="word-break: break-all;">Input</th>	
                    <th width="80" style="word-break: break-all;">Output</th>
                    <th width="80" style="word-break: break-all;" title="95% GREEN 75% - 95% YELLOW">Finish</th>
                    <th style="width:80px;word-break: break-all;">Ex- Factory</th>	
        ...
        <div style="width:<?=$main_width+$new_column+20;?>px; max-height:350px; overflow-y:scroll" id="report_div" > 
            <table id="report_tbl" width="<?=$main_width+$new_column;?>" border="1"  class="rpt_table" rules="all">
              <tbody>
				<?php
                $i=1;
            ...
            ?>	
                <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>" style="font-size:12px; cursor:pointer;" valign="middle">
                    ...
                    <td width="60" style="width:60px; word-wrap:break-word;" onClick="openmypage_image('requires/order_follo_up_report_without_value_controller.php?action=show_image&job_no=<? echo $row[csf("job_no")] ?>','Image View')" align="center"><img src="../../../<? echo $imge_arr[$row[csf('job_no')]];?>" height='25' width='25' /></td>	
                    <td width="100" style="word-break: break-all;" align="right"><? echo omitZero(number_format($row[csf('po_quantity')],0));?></td>
                    ...
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($row[csf('set_smv')],2));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($gf_qnty_array[$row[csf('id')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($yarn_allocation_arr[$row[csf('id')]],0));
					$issue_ret_qty=$dataArrayYarnIssues_ret_arr[$row[csf('id')]]['quantity'];
					?></td>	 
                    <td width="80" style="word-break: break-all;" title="<? echo 'Issue Qty-Issue Ret Qty('.$issue_ret_qty.')';?>" align="right">
                    	<? echo omitZero(number_format(($yarn_issue_array[$row[csf('id')]]-$issue_ret_qty),0));?>							
					</td>	
					
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($gp_qty_array[$row[csf('id')]],0));?></td>	

                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($issQty,0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero($gp_per);?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($daying_qnty_array[$row[csf('id')]],0));?></td>
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($ff_qnty_array[$row[csf('id')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right" <? echo $fabAvlBgColor;?> title="<? echo $fabAvlPer;?>%">
						<? echo omitZero(number_format($fabrics_avl_qnty_array[$row[csf('id')]]),0);?>
                    </td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo $blance=omitZero(number_format($ff_qnty_array[$row[csf('id')]]-$fabrics_avl_qnty_array[$row[csf('id')]],0));?></td>
                    <td width="80" style="word-break: break-all;" align="right"><? echo  omitZero(number_format($lay_cut_data_dtls[$row[csf("id")]]['lay_cut_qty']),0);//omitZero(number_format($lay_cut_data[$row[csf('job_no')]][$row[csf('buyer_name')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($lay_cut_per,2));?></td>

                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($cut_qnty_array[$row[csf('id')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($cut_per,2));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($emb_issue_qnty_array[$row[csf('id')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($emb_rec_qnty_array[$row[csf('id')]],0));?></td>
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($sewing_in_qnty_array[$row[csf('id')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($sewing_out_qnty_array[$row[csf('id')]],0));?></td>	
                    <td width="80" style="word-break: break-all;" align="right" <? echo $finfBgColor;?> title="<? echo $finFactoryPer;?>%">
                    	<? echo omitZero(number_format($sewing_finish_qnty_array[$row[csf('id')]],0));?>
                    </td>
					<td width="80" style="word-break: break-all;" align="right"><? echo omitZero(number_format($ex_qnty_array[$row[csf('id')]],0));?></td>
            ...
            <?
				...
				$tot_po_value+=$row[csf('po_quantity')]*$row[csf('unit_price')];
        ...
        <table width="<?=$main_width+$new_column;?>" border="1" cellpadding="0" cellspacing="0" class="tbl_bottom" rules="all">
         	<tfoot>
                <td width="35"></td>
                <td width="100"></td>
                <td width="70"></td>	
                ...
                <td width="130"></td>
                <td width="60"></td>	
                <td width="100"><p id="td_po_quantity_" style="width:60px; word-wrap:break-word;">
				<? echo number_format($tot_po_quantity,0);?></p></td>
                <td width="80"></td>
                <td width="80" id=""><? //echo round($tot_set_smv);?></td>	
                <td width="80"><p id="td_gf_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_gf_qnty,0);?></p></td>
                <td width="80"><p id="td_yarn_alloc_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_yarn_alloc_qnty,0);?></p></td>
                <td width="80"><p id="td_yarn_issue_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_yarn_issue_qnty,0);?></p></td>
                <td width="80"><p id="td_gp_qty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_gp_qty,0);?></p></td>
                <td width="80"><p id="td_gp_to_qty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_grey_to_dye,0);?></p></td>	
                <td width="80" id=""><? //echo round(($tot_gp_qty/$tot_gf_qnty)*100);?></td>	
                <td width="80"><p id="td_daying_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_daying_qnty,0);?></p></td>	
                <td width="80"><p id="td_ff_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_ff_qnty,0);?></p></td>	
                <td width="80"><p id="td_fabrics_avl_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_fabrics_avl_qnty,0);?></p></td>	
                <td width="80"><p id="td_blance_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_blance,0);?></p></td>	
                <td width="80"><p id="td_cut_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_lay_cut_qnty,0);?></p></td>	
                <td width="80" id=""></td>
                <td width="80"><p id="td_cut_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_cut_qnty,0);?></p></td>	
                <td width="80" id=""><? //echo round(($tot_cut_qnty/$tot_po_quantity)*100);?></td>	
                <td width="80"><p id="td_emb_issue_qnty_" style="width:50px; word-wrap:break-word;"><? echo number_format($tot_emb_issue_qnty,0);?></p></td>	
                <td width="80"><p id="td_emb_rec_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_emb_rec_qnty,0);?></p></td>	
                <td width="80"><p id="td_sewing_in_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_sewing_in_qnty,0);?></p></td>	
                <td width="80"><p id="td_sewing_out_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_sewing_out_qnty,0);?></p></td>
                <td width="80"><p id="td_sewing_finish_qnty_" style="width:60px; word-wrap:break-word;"><? echo number_format($tot_sewing_finish_qnty,0);?></p></td>
                <td width="80"><p id="td_ex_qnty_" style="width:50px; word-wrap:break-word;"><? echo number_format($tot_ex_qnty,0);?></p></td>	
               	<td width="">&nbsp;</td>	
      		</tfoot>
        </table>   
	</div>
