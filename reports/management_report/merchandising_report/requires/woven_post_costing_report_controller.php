...
if ($action=="load_drop_down_buyer")
{
	...
	exit();
		...
		echo create_drop_down( "cbo_buyer_name", 120, "select distinct buy.id, buy.buyer_name from lib_buyer buy, lib_buyer_tag_company b where buy.status_active =1 and buy.is_deleted=0 and b.buyer_id=buy.id $buyer_cond and buy.id in (select  buyer_id from  lib_buyer_party_type where party_type in (1,3,21,90)) order by buyer_name","id,buyer_name", 1, "-- Select Buyer --", $selected, "load_drop_down( 'requires/woven_post_costing_report_controller', this.value, 'load_drop_down_brand', 'brand_td');" );
		exit();
	}
}
...
if($action=="search_season_popup")
{
	...
	<script>
		...
		function js_set_value( str ) {
			...
			if(document.getElementById( 'tr_' + str[0] ).style.display!="none")
			{
...
if($action=="create_order_no_search_list_view")
{
	...
	{
		$entry_form_cond="and c.entry_from in (158,425)";
	}
...
if($action=="report_generate")
{
    ...
    <fieldset>
        ...
        <table style="margin-top:10px" id="table_header_1" class="rpt_table" width="3530" cellpadding="0" cellspacing="0" border="1" rules="all">
            <thead>
                <th width="40">SL</th>
    	...
    	<div style="width:3552px; max-height:400px; overflow-y:scroll" id="scroll_body">
            <table class="rpt_table" width="3530" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
            <?
				...
				foreach($resultReceive as $invRow)
				{
					...
					/*if($invRow[csf('receive_purpose')]==16 && $invRow[csf('currency_id')]==2) //Grey Yarn
					{
						$receive_array[$invRow[csf('prod_id')]]=$avg_rate/$exchange_rate;
					}
					else if($invRow[csf('receive_purpose')]==2 || $invRow[csf('receive_purpose')]==15  || $invRow[csf('receive_purpose')]==43) //Yarn Dyeing
					{
						$receive_array[$invRow[csf('prod_id')]]=$avg_rate/$exchange_rate;
					}
					else
				...
				foreach($result as $row)
				{
					...
					$fabric_purchase_cost_mkt=$fabric_costing_arr['knit']['grey'][$row[csf('id')]]+$fabric_costing_arr['woven']['grey'][$row[csf('id')]];
				...
				?>
                    ...
                    <tr bgcolor="#F5F5F5" onClick="change_color('tr_a<? echo $i; ?>','#F5F5F5')" id="tr_a<? echo $i; ?>">
                        ...
                        <td width="108" style="padding-right:2px" align="right"><a href="#report_details" onClick="openmypage_actual('<? echo $row[csf('id')]; ?>','dye_finish_cost_actual','Actual Dyeing & Finish Cost Details','1100px')"><? echo number_format($dye_finish_cost_actual,2,'.',''); ?></a></td>
                        <td width="108" style="padding-right:2px" align="right"><a href="#report_details" onClick="openmypage_actual('<? echo $row[csf('id')]; ?>','fabric_purchase_cost_actual','Fabric Purchase Cost Details','900px')"><? echo number_format($fabric_purchase_cost_actual,2,'.',''); ?></a></td>
        ...
        <table class="rpt_table" width="3530" cellpadding="0" cellspacing="0" border="1" rules="all">
            <tr bgcolor="#CCDDEE" onClick="change_color('tr_pt','#CCDDEE')" id="tr_pt" style="font-weight:bold;">
                ...
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_fabric_purchase_cost_mkt,2,'.',''); ?></td>
                ...
                <td width="100" style="padding-right:2px" align="right"><? echo number_format($tot_mkt_margin_perc,2,'.',''); ?></td>
            </tr>
            <tr bgcolor="#CCCCFF" onClick="change_color('tr_at','#CCCCFF')" id="tr_at" style="font-weight:bold;">
                ...
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_actual_all_cost,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_actual_margin,2,'.',''); ?></td>
                <td width="100" style="padding-right:2px" align="right"><? echo number_format($tot_actual_margin_perc,2,'.',''); ?></td>
            </tr>
            ...
            <tr bgcolor="#CCCCEE" onClick="change_color('tr_vpt','#CCCCEE')" id="tr_vpt" style="font-weight:bold;">
                ...
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_variance_fabric_purchase_cost_per ,2,'.',''); ?></td>
                ...
                <td width="100" style="padding-right:2px" align="right"><? echo number_format($tot_variance_per_cost_per,2,'.',''); ?></td>
            </tr>
        </table>
        <br />
        <table width="3370">
                    ...
                    <div id="summary_buyer">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="1" class="rpt_table" rules="all">
                            ...
                            <?
                                ...
                                ?>
                                    ...
                                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trTD4_<? echo $j; ?>','<? echo $bgcolor; ?>')" id="trTD4_<? echo $j; ?>">
                                        ...
                                        <td align="right"><? echo number_format(($emb_var/$mkt_emb_array[$key]*100),2); ?></td>
                            ...
                            <tr bgcolor="<? echo $bgcolor6; ?>" onClick="change_color('trTD8_<? echo $j; ?>','<? echo $bgcolor6; ?>')" id="trTD8_<? echo $j; ?>">
                                ...
                                <th align="right"><? echo number_format(($yvar/$tot_mkt_yarn_cost*100),2); ?></th>
                                <th align="right"><? echo number_format(($kvar/$tot_mkt_knit_cost*100),2); ?></th>
                                ...
                                <th align="right"><? echo number_format(($embvar/$tot_mkt_emb_cost*100),2); ?></th>
                                <th align="right"><? echo number_format(($washvar/$tot_mkt_wash_cost*100),2); ?></th>
...
if($action=="report_generate_actual_cost")
{
	...
	$sql="select a.job_no_prefix_num, a.job_no, $year_field, a.company_name, a.team_leader,a.buyer_name, a.style_ref_no, a.order_uom, a.gmts_item_id, a.total_set_qnty as ratio, a.set_smv, b.id, b.po_number,b.grouping,b.file_no, b.pub_shipment_date, b.po_quantity, b.plan_cut, b.unit_price, b.po_total_price, b.shiping_status from wo_po_details_master a, wo_po_break_down b,wo_pre_cost_mst c where a.job_no=b.job_no_mst and a.job_no=c.job_no and c.job_no=b.job_no_mst and c.entry_from=111 and a.company_name='$company_name' and a.job_no_prefix_num like '$job_no' and a.status_active=1 and a.is_deleted=0 and b.is_deleted=0 and b.status_active=$cbo_order_status $date_cond $buyer_id_cond $po_id_cond $ref_cond $file_cond $shipping_status_cond $year_cond $cbo_status_cond order by b.pub_shipment_date, a.job_no_prefix_num, b.id";
	//echo $sql; //die;
	$result=sql_select($sql);
	$all_po_id="";
	foreach($result as $row)
    ...
    <fieldset>
        ...
        <table style="margin-top:10px" id="table_header_1" class="rpt_table" width="3690" cellpadding="0" cellspacing="0" border="1" rules="all">
            <thead>
                ...
                <th width="100">Inspection Cost</th>
                <th width="100">Courier Cost</th>
<th width="100">Toal Mat & Serv.Cost</th>
                <th width="100">Commission Cost</th>
...
<th width="100">CM Value (Contribution)</th>
    	...
    	<div style="width:3712px; max-height:400px; overflow-y:scroll" id="scroll_body">
            ...
            <?
				...
				foreach($result as $row)
				{
					...
					$dzn_qnty=$dzn_qnty*$row[csf('ratio')];
					$yarn_cost_mkt=$yarn_costing_arr[$row[csf('id')]];
					$knit_cost_mkt=$conversion_costing_arr_process[$row[csf('id')]][1];
					$dye_finish_cost_mkt=0;
					foreach($conversion_cost_head_array as $process_id=>$val)
					{
						if(!in_array($process_id,$not_yarn_dyed_cost_arr))
					...
					$yarn_dye_cost_mkt=$conversion_costing_arr_process[$row[csf('id')]][30];
					$aop_cost_mkt=$conversion_costing_arr_process[$row[csf('id')]][35];
				...
				?>
                	<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
                        ...
                        <td width="108" style="padding-right:2px" align="right"><? echo  number_format($yarn_cost_mkt+$yarn_dye_cost_mkt,2); ?></td>
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($knit_cost_mkt,2); ?></td>
                        <td width="108" align="right" style="padding-right:2px"><? echo number_format($dye_finish_cost_mkt,2); ?></td>
                    ...
                    <tr bgcolor="#F5F5F5" onClick="change_color('tr_v<? echo $i; ?>','#F5F5F5')" id="tr_v<? echo $i; ?>">
                        ...
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format(($yarn_cost_mkt+$yarn_dye_cost_mkt)-$yarn_cost_actual,2); ?></td>

                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($knit_cost_mkt-$knit_cost_actual,2); ?></td>
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($dye_finish_cost_mkt-$dye_finish_cost_actual,2); ?></td>
                        ...
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($aop_cost_mkt-$aop_cost_actual,2); ?></td>
        ...
        <table class="rpt_table" width="3690" cellpadding="0" cellspacing="0" border="1" rules="all">
            <tr bgcolor="#CCDDEE" onClick="change_color('tr_pt','#CCDDEE')" id="tr_pt" style="font-weight:bold;">
                ...
                <td width="90"><? echo number_format($tot_po_qnty,0); ?></td>
                <td width="70">&nbsp;</td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_po_value,2); ?></td>
                <td width="98" style="padding-right:2px" align="right">&nbsp;</td>
                <td width="80">&nbsp;</td>
                ...
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_commission_cost_mkt,2); ?></td>
                <td width="100" align="right"><? echo number_format($tot_Net_PO_ex_Fact_Value_mkt,2);?></td>
                <td width="100" align="right"><? echo number_format($tot_CM_Value_Contribution_value_mkt,2);?></td>

                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_cm_cost_mkt,2); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($total_mkt_margin,2); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_mkt_margin_perc,2); ?></td>
				<td width="58" style="padding-right:2px" align="right"><? //echo number_format($tot_mkt_margin_perc,2); ?></td>
            </tr>
            <tr bgcolor="#CCCCFF" onClick="change_color('tr_at','#CCCCFF')" id="tr_at" style="font-weight:bold;">
...
if($action=="fabric_purchase_cost_actual")
{
	...
	extract($_REQUEST);
	$ex_rate=80;
	$print_report_format=return_field_value("format_id"," lib_report_template","template_name ='".$company_id."'  and module_id=2 and report_id=138 and is_deleted=0 and status_active=1");
	$suplier=return_library_array( "select id, supplier_name from lib_supplier",'id','supplier_name');
	$comp=return_library_array( "select id, company_name from lib_company",'id','company_name');
				$report_format=explode(",",$print_report_format);
				$report_action="";
				if($report_format[0]==143){ $report_action="show_fabric_booking_report_urmi";}
				if($report_format[0]==84){ $report_action="show_fabric_booking_report_urmi_per_job";}
				if($report_format[0]==85){ $report_action="print_booking_3";}
				if($report_format[0]==151){ $report_action="show_fabric_booking_report_advance_attire_ltd";}
				if($report_format[0]==160){ $report_action="print_booking_5";}
				if($report_format[0]==175){ $report_action="print_booking_6";}
				if($report_format[0]==241){ $report_action="print_booking_11";}
				if($report_format[0]==155){ $report_action="fabric_booking_report";}
				if($report_format[0]==274){ $report_action="print_booking_10";}
				if($report_format[0]==72){ $report_action="print6booking";}
				if($report_format[0]==428){ $report_action="print_booking_eg1";}
 ?>
 <script>
	...
	function generate_fabric_report(type,company_name,booking_no,order_no_id,fabric_source,approved_id,mail_data=0){

			var booking="'"+booking_no+"'";
		
			var report_title='Woven Partial Fabric Booking';
			var data="action="+type+'&txt_booking_no='+booking+'&cbo_company_name='+company_name+'&txt_order_no_id='+order_no_id+'&cbo_fabric_natu=3'+'&cbo_fabric_source='+fabric_source+'&id_approved_id='+approved_id+'&report_title='+report_title+'&mail_data='+mail_data+'&path=../../';
			
		
			http.open("POST","../../../../order/woven_gmts/requires/woven_partial_fabric_booking_controller.php",true);
			http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
			http.send(data);
			http.onreadystatechange = generate_fabric_report_reponse  = function(){
	...
	<fieldset style="width:860px; margin-left:7px">
    <div id="report_container">
            <u style="display:none;"><b>Woven WO Fabric Purchase</b></u>
            <table class="rpt_table" width="1080" cellpadding="0" cellspacing="0" border="1" rules="all" style="display:none;">
				<thead>
                	<th width="40">SL</th>
				...
				$sql="SELECT a.id, a.booking_no,a.booking_date,a.booking_date,a.supplier_id,a.currency_id,a.exchange_rate,a.booking_type,b.po_break_down_id as po_id,sum(b.grey_fab_qnty) as grey_fab_qnty,b.job_no,sum(b.amount) as amount,c.body_part_id as bpart_id,c.lib_yarn_count_deter_id as deter_id,c.construction,c.composition,c.uom,c.gsm_weight,a.fabric_source,a.is_approved,d.type
					from wo_booking_mst a,
					     wo_booking_dtls b,
						 wo_pre_cost_fabric_cost_dtls c  
						 left join lib_yarn_count_determina_mst d on c.lib_yarn_count_deter_id=d.id
					where a.booking_no=b.booking_no and
						  c.id=b.pre_cost_fabric_cost_dtls_id and
					 	  a.booking_type=1 and 
					 	  b.fin_fab_qnty>0 and 
						  a.is_deleted=0 and 
						  ...
						  b.po_break_down_id in ($po_id)
					 group by a.id, a.booking_no,a.booking_date,a.booking_date,a.supplier_id,a.currency_id,a.exchange_rate,a.booking_type,b.po_break_down_id ,b.job_no, c.body_part_id ,c.lib_yarn_count_deter_id ,c.construction,c.composition,c.uom,c.gsm_weight,a.fabric_source,a.is_approved,d.type";
                $result=sql_select($sql);
				foreach($result as $row)
				{
					if ($i%2==0)  
                    ...
                    <tr bgcolor="<? echo  $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                    	<td ><? echo $i; ?></td>
                        <td ><p><a href="#report_details" onClick="generate_fabric_report('<?=$report_action; ?>',<?=$company_id; ?>,'<?=$row[csf('booking_no')]; ?>','<?=$po_id; ?>','<?=$row[csf('fabric_source')]; ?>','<?=$row[csf('is_approved')]; ?>')"><? echo $row[csf('booking_no')]; ?></a></p></td>
                        <td  align="center"><? echo change_date_format($row[csf('booking_date')]); ?></td>
						<td ><p><? echo $body_part[$row[csf("bpart_id")]]; ?></p></td>
						<td ><p><? echo $row[csf("type")]; ?></p></td>
                        <td ><p><? echo $row[csf("construction")].','.$row[csf("composition")].','.$row[csf("gsm_weight")]; ?></p></td>
                        <td align="center" >
							<? 
						...
						<td align="center" ><?=$row[csf('exchange_rate')];?>
                        </td>
						<td align="center" ><?=$row[csf('grey_fab_qnty')]*$row[csf('exchange_rate')]; 
                           $total_wo_cost_tk+=$row[csf('grey_fab_qnty')]*$row[csf('exchange_rate')]; ?>
                        </td>
						<td align="center" >
							<? 
						...
						<td><? if($row[csf("pay_mode")]==3 || $row[csf("pay_mode")]==5) echo $comp[$row[csf("supplier_id")]]; else echo $suplier[$row[csf("supplier_id")]]; ?>
                        </td>
                    </tr>
                <?
                ...
                ?>
               	<tfoot>
					...
					<th>&nbsp;</th>
					<th>&nbsp;</th>
					<th align="right"><? echo number_format($total_wo_cost_tk,2); ?></th>
					<th>&nbsp;</th>
					<th>&nbsp;</th>
                </tfoot>
            </table>
		...
		<div id="report_container">
            ...
            <table class="rpt_table" width="855" cellpadding="0" cellspacing="0" border="1" rules="all">
                ...
                <?
                $i=1; $total_recv_qnty_w=0; $total_recv_cost_w=0;
				$sql="select a.id, a.recv_number,a.currency_id, a.receive_date, sum(b.quantity) as recv_qnty, sum(d.order_rate*b.quantity) as amnt,sum(d.order_amount) as order_amount,sum(d.cons_amount) as cons_amount, c.id, c.product_name_details from inv_receive_master a, order_wise_pro_details b, product_details_master c, inv_transaction d where a.id=d.mst_id and d.transaction_type=1 and d.item_category in(3,2) and c.item_category_id in(3,2) and d.id=b.trans_id and b.trans_type=1 and b.entry_form in(17,37) and a.entry_form in(17,37) and b.po_breakdown_id in($po_id) and b.prod_id=c.id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 group by a.id, c.id, a.recv_number, a.receive_date, c.product_name_details,a.currency_id";
                $result=sql_select($sql);
				foreach($result as $row)
				{
					if ($i%2==0)
                    ...
                    <tr bgcolor="<? echo  $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                        ...
                        <td align="right" width="110">
							<?
								...
								{
									$avg_rate=($row[csf('amnt')]/$row[csf('recv_qnty')]);
									echo number_format($avg_rate,2);
								}
								else
								{
									$avg_rate=($row[csf('order_amount')]/$row[csf('recv_qnty')])/$ex_rate;
									echo number_format($avg_rate,2);
								}
                            ?>&nbsp;
                        </td>
...
if($action=="fabric_purchase_cost_actual2")
{
	echo load_html_head_contents("Fabric Purchase Cost Info","../../../../", 1, 1, '','','');
	extract($_REQUEST);
	$print_report_format=return_field_value("format_id"," lib_report_template","template_name ='".$company_id."'  and module_id=2 and report_id=138 and is_deleted=0 and status_active=1");
 ...
 <script>
	...
	<fieldset style="width:1080px; margin-left:7px">
		<div id="report_container">
            <u><b>Woven Fabric Purchase</b></u>
...
if($action=="trims_cost_actual")
{
	...
	$report_format=explode(",",$print_report_format);
				$report_action="";
				if($report_format[0]==183){ $report_action="show_trim_booking_report2";}
				if($report_format[0]==67){ $report_action="show_trim_booking_report";}
				if($report_format[0]==177){ $report_action="show_trim_booking_report4";}
				if($report_format[0]==175){ $report_action="show_trim_booking_report5";}
				if($report_format[0]==235){ $report_action="show_trim_booking_report9";}
				if($report_format[0]==85){ $report_action="print_t";}
				if($report_format[0]==746){ $report_action="print_t7";}
				if($report_format[0]==774){ $report_action="show_trim_booking_report_wg";}
?>
	<script>

		function generate_fabric_report(type,company_name,booking_no,cbo_level,buyer_name,approved_id,is_mail_send=0){		

			var booking="'"+booking_no+"'";

			var report_title='Multiple Job Wise Trims Booking V2';
			var data="action="+type+'&txt_booking_no='+booking+'&cbo_company_name='+company_name+'&cbo_level='+cbo_level+'&cbo_buyer_name='+buyer_name+'&id_approved_id='+approved_id+'&report_title='+report_title+'&show_comment=1'+'&report_type=1'+'&is_mail_send=0';
	...
	<fieldset style="width:760px; margin-left:7px">
        ...
        <div style="width:755px; max-height:330px; overflow-y:scroll" id="scroll_body">
			<table border="1" class="rpt_table" rules="all" width="735" cellpadding="0" cellspacing="0">
                ...
                $sql="select a.booking_no, a.booking_date, a.currency_id, a.exchange_rate,a.company_id, sum(b.amount) as amount,a.supplier_id,a.cbo_level,a.buyer_id,a.is_approved from wo_booking_mst a, wo_booking_dtls b where a.booking_no=b.booking_no and b.po_break_down_id=$po_id and a.item_category=4 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 group by a.booking_no, a.booking_date, a.currency_id,a.company_id, a.exchange_rate,a.supplier_id,a.cbo_level,a.buyer_id,a.is_approved";
                $result=sql_select($sql); 
                foreach($result as $row)
                {
                    if($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
                    ...
                    <tr bgcolor="<? echo  $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                        <td width="40"><? echo $i; ?></td>
                        <td width="110"><p><a href="#report_details" onClick="generate_fabric_report('<?=$report_action; ?>',<?=$company_id; ?>,'<?=$row[csf('booking_no')]; ?>','<?=$row[csf('cbo_level')]; ?>','<?=$row[csf('buyer_id')]; ?>','<?=$row[csf('is_approved')]; ?>')"><?= $row[csf('booking_no')]; ?></a></p></td>
                        <td width="80" align="center"><? echo change_date_format($row[csf('booking_date')]); ?></td>
                        <td width="80"><p><? echo $currency[$row[csf('currency_id')]]; ?></p></td>
                        <td align="right" width="120">
                            <?
...
<?
	    ...
	    if(count($data_array))
	    {
	    	 $job_no_txt=$data_array[0][csf('job_no')];
	    }

	    $multiply_by=1;
	    $sql_cost=sql_select("SELECT a.costing_per  from wo_pre_cost_mst a where a.job_no='$job_no_txt' and a.status_active=1");
	    if(count($sql_cost))
	    {
	    	if($sql_cost[0][csf('costing_per')]==1)
	    	{
	    		$multiply_by=12;
	    	}
	    	else if($sql_cost[0][csf('costing_per')]==2)
	    	{
	    		$multiply_by=1;
	    	}
	    	else if($sql_cost[0][csf('costing_per')]==3)
	    	{
	    		$multiply_by=24;
	    	}
	    	else if($sql_cost[0][csf('costing_per')]==4)
	    	{
	    		$multiply_by=36;
	    	}
	    	else if($sql_cost[0][csf('costing_per')]==5)
	    	{
	    		$multiply_by=48;
	    	}
	    }

		 $fab_knit_qty_gray=($fabric_costing_qty_arr['knit']['grey'][$po_id]/$po_qty)*$multiply_by;
		 $fab_woven_qty_gray=($fabric_costing_qty_arr['woven']['grey'][$po_id]/$po_qty)*$multiply_by;

		 $fab_knit_qty_finish=($fabric_costing_qty_arr['knit']['finish'][$po_id]/$po_qty)*$multiply_by;
		 $fab_woven_qty_finish=($fabric_costing_qty_arr['woven']['finish'][$po_id]/$po_qty)*$multiply_by;
		 $yarn_req_qty_avg=($yarn_req_arr[$po_id]/$po_qty)*$multiply_by;
	...
	<div style="width:100%" align="center"> <input type="button" onClick="new_window()" value="Html Preview" name="Print" class="formbutton" style="width:120px;"/>
		...
		?>
            	<table class="rpt_table" border="1" cellpadding="1" cellspacing="1" style="width:850px" rules="all">
                    ...
                    <tr bgcolor="<? echo $bgcolor2;?>">
                    	<!-- <td>Avg Yarn Req</td>
                        <td><b><? echo $yarn_req_qty_avg; ?> (Kg)</b></td><td>Knit Fin Fabric Cons</td>
            ...
            <?
				...
				$exchange_rate=80;
				$sql_fin_purchase="select b.po_breakdown_id, sum(a.cons_rate*b.quantity) as finish_purchase_amnt from inv_transaction a, order_wise_pro_details b where a.id=b.trans_id and  a.status_active=1 and a.is_deleted=0 and b.status_active=1    and b.is_deleted=0 and b.po_breakdown_id=$po_id  and ( (a.receive_basis in(1,2) and a.item_category=2 and a.transaction_type=1 and b.entry_form=37) or (a.item_category=3 and a.transaction_type=1 and b.entry_form=17)) group by b.po_breakdown_id";
				//echo $sql_fin_purchase;
				$dataArrayFinPurchase=sql_select($sql_fin_purchase);
				foreach($dataArrayFinPurchase as $finRow)
				{
