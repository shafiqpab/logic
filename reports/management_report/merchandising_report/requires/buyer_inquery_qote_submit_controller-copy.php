...
if($action=="report_generate")
{
	...
	else
	{
 	...
 	if($txt_inqu_no!='') $inqu_no_cond="and buyer_request='$txt_inqu_no'";else $inqu_no_cond="";
	if($txt_department!='') $department_cond="and department_name='$txt_department'";else $department_cond="";
...
if($report_type==1)
{
 ...
 <?
		...
		if($cbo_season_id!=0) $session_cond="and season_buyer_wise='$cbo_season_id'"; else  $session_cond="";
		if(str_replace("'","",$txt_inq_no) != "") $inquery_cond="and system_number_prefix_num=$txt_inq_no"; else  $inquery_cond="";
		if(str_replace("'","",$txt_style_ref) != "") $style_cond="and style_refernce=$txt_style_ref"; else  $style_cond="";
            ...
            foreach($sql_result as $row)
            {
				if($inquery_confirm_date[$row[csf("id")]] =='' || $inquery_confirm_date[$row[csf("id")]] =='0000-00-00')
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i;?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                        ...
                        <td width="70"><p><? echo $lib_buyer_season[$row[csf('season_buyer_wise')]]; ?></p></td>
						...
						<td width="65"><p><? echo $insert_date; ?></p>
						<td width="65" bgcolor="<? echo $td_color_opd;?>"><p><? if($op_date!='0000-00-00' && $op_date!='') { echo $quot_op_date;} ?></p>
						</td>
...
else if($report_type==2) //Report 2 Start...
{
 ...
 -->     <div style="width:1770px; max-height:410px; overflow-y: scroll;" id="scroll_body">
		...
		foreach($data_img as $row)
		{
			...
			where company_id =$cbo_company_name and status_active=1 and is_deleted=0  $str_cond3 $buyer_cond $session_cond $date_cond $inqu_no_cond $department_cond $inquery_cond $style_cond order by inquery_date DESC";
			//echo $sql_inquery;
			$sql_result=sql_select($sql_inquery); $total_buyer_target_price=0; $total_buyer_submit_price=0;
            foreach($sql_result as $row)
            {
				...
				if($inquery_confirm_date[$row[csf("id")]] =='' || $inquery_confirm_date[$row[csf("id")]] =='0000-00-00')
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i;?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                        ...
                        <td width="60" title="<? echo $row[csf('id')];?>" align="center"><p><? echo $row[csf("buyer_request")]; ?></p></td>
                        <td width="80" align="center"><p><? echo $row[csf("department_name")]; ?></p></td>
                        <td width="100" align="center"><p><? echo $row[csf('style_refernce')];//$quatation_mst_arr[$row[csf("id")]]['id']; ?></p></td>
					   ...
					   ?>
                        ...
                        <td width="70" align="center"><p><? echo $row[csf("color")]; ?></p></td>
                        <td width="150" align="center"><p><? echo $fabrics_type; ?></p></td>
						...
						?>
                        <td width="70"><p><? echo change_date_format($row[csf("actual_sam_send_date")]); ?></p></td>


						<td width="60"><p><? echo  $dateToSub." Days"; ?></p></td>

                        <td width="60"><p><? echo $dateToConf." Days";//$con_sub_date; ?></p></td>
                        <td align="center" width="70"><p><? echo change_date_format($row[csf("req_quotation_date")]);  ?></p></td>
						<td width="70" align="right"><p><? echo $row[csf("offer_qty")];//number_format($quatation_mst_arr[$row[csf("id")]]['offer_qnty'],0,"","");
						$total_offer_qty +=$row[csf("offer_qty")];//$quatation_mst_arr[$row[csf("id")]]['offer_qnty'];//$$row[csf("offer_qty")]; ?></p></td>
						<td align="center" width="70"><p><? echo change_date_format($row[csf("est_ship_date")]);  ?></p></td>
                        <td align="center" width="70"><p><? echo change_date_format($row[csf("actual_req_quot_date")]); ?></p></td>
                        <td align="center" width="70"><p><? echo change_date_format($row[csf("target_sam_sub_date")]); ?></p></td>
                        <td align="center" width="70"><p><? echo $row[csf("buyer_target_price")]; ?></p></td> 					<td align="center" width="70"><p><? echo $row[csf("buyer_submit_price")]; ?></p></td>
		...
		foreach($data_img as $row)
		{
            ...
            foreach($sql_result as $row)
            {
				...
				if($inquery_confirm_date[$row[csf("id")]] =='' || $inquery_confirm_date[$row[csf("id")]] =='0000-00-00')
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i;?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
						<td width="30"><? echo $i; ?></td>
                        <td width="60" align="center"><p><? echo $buyer_arr[$row[csf("buyer_id")]]; //echo $months[$month_val]; ?></p></td>
                        <td width="60" title="<? echo $row[csf('id')];?>" align="center"><p><? echo $row[csf("buyer_request")];//echo $month_year_arr[0]; ?></p></td>
                        <td width="80" align="center"><p><? echo $months[$month_val];//echo $buyer_arr[$row[csf("buyer_id")]]; ?></p></td>
                        <td width="60"  align="center"><p><? echo $month_year_arr[0];//echo $row[csf("buyer_request")]; ?></p></td>
                        <td width="80" align="center"><p><? echo $row[csf('style_refernce')];//echo $row[csf("department_name")]; ?></p></td>
                        ...
                        <p>
						   ...
						   {
						    ?>
	                        <img  src='../../../<? echo $imge_arr[$row[csf('id')]]; ?>' height='100' width='120' />
	                       <?
						   }
						   else
						   {
						   ...
						   ?>
	                        ...
	                        <td width="80"><p><? echo $row[csf("color")]; ?></p></td>
	                        <td width="150" align="center"><p><?  echo $fabrics_type;//echo $row[csf("color")]; ?></p></td>
	                        <td width="70" align="center"><p><?  echo $gsm;//echo $row[csf("color")]; ?></p></td>
	                        <td width="100" align="center"><p><? echo $row[csf("department_name")];//echo $fabrics_type; ?></p></td>
	                        <td width="100"><p><? echo  $dateToSub." Days";//echo $ffl_merchandiser_arr[$row[csf("dealing_marchant")]]; ?></p></td>
	                        <td align="center" width="60"><p><? echo change_date_format($row[csf("inquery_date")]);  ?></p></td>
	                        <td align="center" width="70"><p><? echo change_date_format($row[csf("target_sam_sub_date")]); ?></p></td>
	                        <td align="center" width="60"><p><? echo change_date_format($row[csf("req_quotation_date")]);//echo change_date_format($row[csf("est_ship_date")]);  ?></p></td>
	                        <td width="60" align="right"><p><? echo $row[csf("offer_qty")];//number_format($quatation_mst_arr[$row[csf("id")]]['offer_qnty'],0,"","");
	                        $total_offer_qty +=$row[csf("offer_qty")];//$quatation_mst_arr[$row[csf("id")]]['offer_qnty'];//$$row[csf("offer_qty")]; ?></p></td>
	                        <td align="center" width="70"><p><? echo change_date_format($row[csf("est_ship_date")]);  ?></p></td>
	                        <td align="center" width="70"><p><? echo change_date_format($row[csf("actual_req_quot_date")]); ?></p></td>
	                        <td align="center" width="70"><p><? echo change_date_format($row[csf("actual_sam_send_date")]); ?></p></td>
	                        <td align="center" width="70"><p><? echo $row[csf("buyer_target_price")]; ?></p></td>
	                        <td align="center" width="70"><p><? echo $row[csf("buyer_submit_price")]; ?></p></td>
                            <?
								if($quatation_costing_mst_arr[$row[csf("id")]]['confirm_date'] !='0000-00-00' && $quatation_costing_mst_arr[$row[csf("id")]]['confirm_date']!='')
								{
									$status="Confirmed";
								...
								{
									?>
									<td width="70" align="center" ><p><? echo $status; ?></p></td>
									<?
		                        }
								else if($status=='Not Submitted')
								{
									...
									{
										?>
										<td width="70" align="center" bgcolor="#FF0000"><p><? echo $status; ?></p></td>
										<?
									}
									else
									{
										?>
										<td width="70" align="center" bgcolor="#FFFF00"><p><? echo $status; ?></p></td>
										<?
									}
		                        }
							?>
...
else if($report_type==4) //Zakaria joy (25/08/2020)
{
	...
	if($cbo_season_id!=0) $session_cond="and a.season_buyer_wise='$cbo_season_id'"; else  $session_cond="";
	if(str_replace("'","",$txt_inq_no)!="") $inquery_cond="and a.system_number_prefix_num=$txt_inq_no"; else  $inquery_cond="";
	if(str_replace("'","",$txt_inqu_no)!="") $binquery_cond="and a.buyer_request='$txt_inqu_no'"; else  $binquery_cond="";
	if(str_replace("'","",$txt_department) != "") $departmentCond="and a.department_name='$txt_department'"; else  $departmentCond="";
	if(str_replace("'","",$txt_style_ref) != "") $style_cond="and a.style_refernce=$txt_style_ref"; else  $style_cond="";
...
else if($report_type==5) //Helal (14/12/2020)
{
	...
	$buyer_arr=return_library_array( "select id, buyer_name from lib_buyer",'id','buyer_name');
	$color_arr=return_library_array( "select id, color_name from lib_color",'id','color_name');
	//echo "SELECT a.id, a.buyer_id, a.buyer_request, a.style_refernce, a.color_id, a.bh_merchant, a.offer_qty, a.inquery_date, a.est_ship_date, a.possible_order_con, a.lead_time, a.target_req_cout, a.actual_req_quot_date, a.target_sam_sub_date, a.remarks, a.fabrication, a.actual_sam_send_date, a.req_quotation_date, a.buyer_target_price, a.status_active, b.price_stage, b.stage, b.price_date, b.price, b.id as info_id,c.stage_id, c.sample_date , c.remarks as sample_remark, c.id as sample_id from wo_quotation_inquery a left join wo_quo_inq_price_info b on a.id=b.mst_id and b.status_active=1 and b.is_deleted=0 left join wo_quo_inq_sample_info c on a.id=c.mst_id and c.status_active=1 and c.is_deleted=0 where a.status_active=1 and a.is_deleted=0 and a.company_id=$cbo_company_name $buyer_cond $session_cond $inquery_cond $binquery_cond $departmentCond $style_cond $date_cond"; die;
	...
	foreach ($submitted_date_sql as $row) {
		...
		$date = date('Y-m-d H:i:s', strtotime($row[csf('price_date')]));
	


		$string=$row[csf('mst_id')]."*".$date."*".$row[csf('id')];

		$price_date_arr[$row[csf('mst_id')]][$date]= $date;
		$price_id_arr[$row[csf('mst_id')]][$date][$row[csf('id')]]=$row[csf('id')];
	...
	<table border="1" cellpadding="0" cellspacing="0" class="rpt_table" rules="all" width="2050" align="left">
        		...
        		<?
        			...
        			foreach ($inquery_data_arr as $id=>$value) {
						...
						{ 
							...
							$pdate=max($price_date_arr[$id]);
							$pminId=max($price_id_arr[$id][$pdate]);
							$string2=$id."*".$pdate."*".$pminId;
							// $data_arr[$cnt]['stage']=$inquery_stage_arr[$data['stage']];
							// $data_arr[$cnt]['price']=$data['price'];
							// $data_arr[$cnt]['price_date']=change_date_format($data['price_date']);
							// $data_arr[$cnt]['price_stage']=$inquery_price_arr[$data['price_stage']];
						...
						<tr>
							...
							<td><? echo $value['offer_qty']; ?></td>
							<td><? echo change_date_format($value['inquery_date']); ?></td>
							<td><? echo change_date_format($value['est_ship_date']); ?></td>
							<td><? echo change_date_format($value['possible_order_con']); ?></td>
							<td><? echo $lead_time; ?></td>
							<td><? echo change_date_format($value['target_sam_sub_date']); ?></td>
							<td><? echo change_date_format($value['actual_sam_send_date']); ?></td>
							<td><? echo change_date_format($value['req_quotation_date']); ?></td>
							...
							<td><? echo $inquery_stage_arr[$price_data_arr[$string2]['stage']];;//$data_arr[$cn]['stage']; ?></td>
							<td><? echo $price_data_arr[$string2]['price'];//$data_arr[$cn]['price']; ?></td>
							<td><? echo change_date_format($price_date); ?></td>
							<td><? echo $inquery_price_arr[$price_data_arr[$string2]['price_stage']];//$data_arr[$cn]['price_stage']; ?></td>
							<td><? echo $inquery_sample_arr[$sample_data_arr[$string3]['stage_id']];//$data_arr[$cn]['stage_id']; ?></td>
							<td><? echo  change_date_format($sdate); ?></td>
							<td><? echo $sample_data_arr[$string3]['sample_remark'];//$data_arr[$cn]['sample_remark']; ?></td>
					    </tr>
						<?
        				$sl++;
        			}
...
if($action=="show_image")
{
	...
	$data_array=sql_select("select image_location  from common_photo_library  where master_tble_id='$sys_id' and form_name='quotation_inquery' and is_deleted=0 and file_type=1");
	?>
    <table>
        <tr>
        <?
        ...
        {
        ?>
        <td><a href="<? $row[csf('image_location')] ?>" target="_new"><img src='../../../../<? echo $row[csf('image_location')]; ?>' height='800px' width='800px' align="middle" /></a></td>
        <?
        }
        ?>
        </tr>
