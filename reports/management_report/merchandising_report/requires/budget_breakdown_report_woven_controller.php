...
{
	echo create_drop_down( "cbo_buyer_name", 140, "select buy.id, buy.buyer_name from lib_buyer buy, lib_buyer_tag_company b where buy.status_active =1 and buy.is_deleted=0 and b.buyer_id=buy.id and b.tag_company='$data' $buyer_cond and buy.id in (select buyer_id from lib_buyer_party_type where party_type in (1,3,21,90)) group by buy.id, buy.buyer_name order by buy.buyer_name","id,buyer_name", 1, "-- All Buyer --", $selected, "load_drop_down( 'requires/budget_breakdown_report_woven_controller', this.value, 'load_drop_down_brand', 'brand_td');");
	exit();
}
            ...
            <table width="570" cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr>
                        ...
                        <td align="center">
                        	<input type="button" name="button" class="formbutton" value="Show" onClick="show_list_view ('<? echo $companyID; ?>'+'**'+document.getElementById('cbo_buyer_name').value+'**'+document.getElementById('cbo_search_by').value+'**'+document.getElementById('txt_search_common').value+'**'+'<? echo $cbo_year_id; ?>'+'**'+'<? echo $cbo_month_id; ?>', 'create_job_no_search_list_view', 'search_div', 'budget_breakdown_report_woven_controller', 'setFilterGrid(\'tbl_list_search\',-1)');" style="width:100px;" />
                    </td>
                    </tr>
            	</tbody>
           	</table>
...
if ($action=="order_no_popup")
{
	...
	echo  create_list_view("list_view", "Job No,Buyer,Style Ref.,Order No", "110,110,150,180","610","350",0, $sql, "js_set_value", "id,po_number", "", 1, "0,buyer_name,0,0,0", $arr , "job_no_prefix_num,buyer_name,style_ref_no,po_number", "budget_breakdown_report_woven_controller",'setFilterGrid("list_view",-1);','0,0,0,0,0','') ;
	disconnect($con);
	exit();
}
...
if($action=="report_generate")
{
	...
	$order_by="order by a.job_no desc";
	}
	...
	else if(str_replace("'","",$cbo_search_date)==5)// Country Ship Date
	{
		if(str_replace("'","",$txt_date_from)!="" && str_replace("'","",$txt_date_to)!="")
		{
			if($db_type==0)
	...
	if(str_replace("'","",$cbo_approved_status)==1){
		...
		$style="#FFFFFF";
/*
		$sql_budget2="select a.job_no_prefix_num, b.insert_date, a.job_no, a.buyer_name, a.style_ref_no, b.is_confirmed, a.agent_name, a.avg_unit_price, a.dealing_marchant, a.gmts_item_id, a.total_set_qnty as ratio, b.plan_cut, b.id as po_id, b.po_number, b.pub_shipment_date, b.po_received_date, b.po_quantity, b.unit_price, b.po_total_price, b.grouping, b.file_no, c.costing_date , a.order_uom, d.cm_cost from wo_po_details_master a join wo_po_break_down b on a.id=b.job_id and a.job_no=b.job_no_mst join wo_pre_cost_mst c on a.id=c.job_id and a.job_no = c.job_no join wo_pre_cost_dtls d on a.id=d.job_id and a.job_no = d.job_no join wo_po_color_size_breakdown e on e.job_no_mst=a.job_no and e.po_break_down_id =b.id where a.status_active=1 $company_con_name_a  and a.is_deleted=0 and b.status_active=$cbo_status and b.is_deleted=0 $date_cond $buyer_id_cond $year_cond $job_no_cond $order_id_cond_trans $order_no_cond $order_status_cond $season_cond $file_con_b $ref_con_b $approvalCon group by a.job_no_prefix_num, b.insert_date, a.job_no, a.buyer_name, a.style_ref_no, b.is_confirmed, a.agent_name, a.avg_unit_price, a.dealing_marchant, a.gmts_item_id, a.total_set_qnty , b.plan_cut, b.id , b.po_number, b.pub_shipment_date, b.po_received_date, b.po_quantity, b.unit_price, b.po_total_price, b.grouping, b.file_no, c.costing_date , a.order_uom, d.cm_cost $order_by";*/
		 $sql_budget2="select a.job_no_prefix_num, b.insert_date, a.job_no, a.buyer_name, a.brand_id,a.season_year,a.season_buyer_wise as season,a.style_ref_no, b.is_confirmed, a.agent_name, a.avg_unit_price, a.dealing_marchant, a.gmts_item_id, a.total_set_qnty as ratio, b.plan_cut, b.id as po_id, b.po_number, b.pub_shipment_date, b.po_received_date, b.po_quantity, b.unit_price, b.po_total_price, b.grouping, b.file_no, c.costing_date , a.order_uom, d.cm_cost from wo_po_details_master a join wo_po_break_down b on a.id=b.job_id and a.job_no=b.job_no_mst join wo_pre_cost_mst c on a.id=c.job_id and a.job_no = c.job_no join wo_pre_cost_dtls d on a.id=d.job_id and a.job_no = d.job_no  where a.status_active=1 $company_con_name_a  and a.is_deleted=0 and b.status_active=$cbo_status and b.is_deleted=0 $date_cond $buyer_id_cond $year_cond $job_no_cond $season_cond $order_id_cond_trans $order_no_cond $order_status_cond  $brand_cond $season_year_cond $file_con_b $ref_con_b $approvalCon group by a.job_no_prefix_num, b.insert_date, a.job_no, a.buyer_name, a.style_ref_no, b.is_confirmed, a.agent_name, a.avg_unit_price, a.dealing_marchant, a.gmts_item_id, a.total_set_qnty , b.plan_cut, b.id , b.po_number, b.pub_shipment_date, b.po_received_date, b.po_quantity, b.unit_price, b.po_total_price, b.grouping, b.file_no, c.costing_date ,a.brand_id,a.season_buyer_wise,a.season_year, a.order_uom, d.cm_cost $order_by";
		...
		?>
		<script>
		//var order_amt=document.getElementById('total_order_qnty').innerHTML.replace(/,/g ,'');
		var order_amt=document.getElementById('total_order_qnty').getAttribute("data-amount").replace(/,/g ,'');
		...
		document.getElementById('embelishment_cost').innerHTML=document.getElementById('total_gmts_deying_amount').getAttribute("data-amount");
		document.getElementById('embelishment_cost_per').innerHTML=number_format_common((document.getElementById('total_gmts_deying_amount').getAttribute("data-amount").replace(',','')/order_amt)*100,2) + ' %';

		document.getElementById('wash_cost').innerHTML=document.getElementById('total_wash_cost').innerHTML;
		document.getElementById('wash_cost_per').innerHTML=number_format_common((document.getElementById('total_wash_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		...
		document.getElementById('deffd_lc_cost').innerHTML=document.getElementById('total_deffdlc_cost').innerHTML;
		document.getElementById('deffd_lc_cost_percent').innerHTML=number_format_common((document.getElementById('total_deffdlc_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		document.getElementById('design_cost').innerHTML=document.getElementById('total_design_cost').innerHTML;
		document.getElementById('design_cost_per').innerHTML=number_format_common((document.getElementById('total_design_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		document.getElementById('studio_cost').innerHTML=document.getElementById('total_studio_cost').innerHTML;
		document.getElementById('studio_cost_per').innerHTML=number_format_common((document.getElementById('total_studio_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		...
		document.getElementById('interest_cost').innerHTML=document.getElementById('total_interest_cost').innerHTML;
		document.getElementById('interest_cost_per').innerHTML=number_format_common((document.getElementById('total_interest_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		document.getElementById('interest_cost').innerHTML=document.getElementById('total_interest_cost').innerHTML;
		document.getElementById('interest_cost_per').innerHTML=number_format_common((document.getElementById('total_interest_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		document.getElementById('income_tax_cost').innerHTML=document.getElementById('total_incometax_cost').innerHTML;
		document.getElementById('income_tax_cost_per').innerHTML=number_format_common((document.getElementById('total_incometax_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		document.getElementById('depc_cost').innerHTML=document.getElementById('total_deffdlc_cost').innerHTML;
		document.getElementById('depc_cost_per').innerHTML=number_format_common((document.getElementById('total_deffdlc_cost').innerHTML.replace(',','')/order_amt)*100,2) + ' %';
		document.getElementById('commission_cost').innerHTML=document.getElementById('total_local_amount').getAttribute("data-amount");
		document.getElementById('commission_cost_per').innerHTML=number_format_common((document.getElementById('total_local_amount').getAttribute("data-amount").replace(',','')/order_amt)*100,2) + ' %';
					...
					<td width="350" align="left">
						<table width="350" border="1" rules="all" class="rpt_table" cellpadding="0" cellspacing="2">
							...
							<tr bgcolor="<? echo $style1; ?>">
								<td>4</td>
								<td>Gmts. Wash</td>
								<td align="right" id="wash_cost"></td>
								<td align="right" id="wash_cost_per"></td>
							</tr>
							<tr bgcolor="<? echo $style; ?>">
								<td>5</td>
							...
							<tr bgcolor="<? echo $style1; ?>">
								<td>10</td>
								<td>Deffd. LC Cost</td>
								<td align="right" id="deffd_lc_cost"></td>
								<td align="right" id="deffd_lc_cost_percent"></td>
							</tr>
							<tr bgcolor="<? echo $style; ?>">
								<td>11</td>
								<td>Design Cost</td>
								<td align="right" id="design_cost"></td>
								<td align="right" id="design_cost_per"></td>
							</tr>
							<tr bgcolor="<? echo $style1; ?>">
								<td>12</td>
								<td>Studio Cost</td>
								<td align="right" id="studio_cost"></td>
								<td align="right" id="studio_cost_per"></td>
							</tr>
							...
							<tr bgcolor="<? echo $style; ?>">
								<td>15</td>
								<td>Interest</td>
								<td align="right" id="interest_cost"></td>
								<td align="right" id="interest_cost_per"></td>
							</tr>
							<tr bgcolor="<? echo $style1; ?>">
								<td>16</td>
								<td>Income Tax</td>
								<td align="right" id="income_tax_cost"></td>
								<td align="right" id="income_tax_cost_per"></td>
							</tr>
							<tr bgcolor="<? echo $style1; ?>">
								<td>17</td>
								<td>Depc. & Amort.</td>
								<td align="right" id="depc_cost"></td>
								<td align="right" id="depc_cost_per"></td>
							</tr>
							<tr bgcolor="<? echo $style1; ?>">
								<td>18</td>
		...
		<table width="3800">
		   ...
		   ?>
		<table id="table_header_1" class="rpt_table" width="4260" cellpadding="0" cellspacing="0" border="1" rules="all">
			<thead>
				<tr>
					<th width="40" rowspan="2">SL</th>
					<th width="70" rowspan="2">Company</th>
                    ...
                    <th width="70" rowspan="2">Season year</th>
					...
					<th width="90" rowspan="2">Fabric Purchase</th>
					<th width="100" rowspan="2">Trim Cost</th>
					<th colspan="4">Embell. Cost</th>
					<th width="90" rowspan="2">Gmts. Wash</th>
					...
					<th width="120" rowspan="2">Courier Cost</th>
					...
					<th width="100" rowspan="2">Depc. & Amort.</th>
		...
		<div style="width:4280px; max-height:400px; overflow-y:scroll" id="scroll_body">
		<table class="rpt_table" width="4260" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
		<?
		...
		$commercials= new commercial($condition);
		$commisions= new commision($condition);
		$emblishment= new emblishment($condition);
		$washes= new wash($condition);
		$fabrics= new fabric($condition);
		$others= new other($condition);
		$trims_costing_arr=$trims->getAmountArray_by_order();
		$others_costing_arr=$others->getAmountArray_by_order();
		$commercials_costing_arr=$commercials->getAmountArray_by_order();
		$commisions_costing_arr=$commisions->getAmountArray_by_orderAndItemid();
		$emblishment_costing_arr=$emblishment->getAmountArray_by_orderAndEmbname();
		$wash_costing_arr=$washes->getAmountArray_by_order();
		$fabric_costing_arr=$fabrics->getAmountArray_by_order_knitAndwoven_greyAndfinish();

$total_order_qty_pcs=0;
		...
		foreach($result_sql_budget2 as $row )
		{
			...
			$commercial_cost = $commercials_costing_arr[$row[csf('po_id')]];

			$fab_purchase = array_sum($fabric_costing_arr['woven']['finish'][$row[csf('po_id')]]);

			$trim_amount= $trims_costing_arr[$row[csf('po_id')]];

			$print_amount=$emblishment_costing_arr[$row[csf('po_id')]][1];
			$embroidery_amount=$emblishment_costing_arr[$row[csf('po_id')]][2];
			$special_amount=$emblishment_costing_arr[$row[csf('po_id')]][4];
			$gmts_deying_amount=$emblishment_costing_arr[$row[csf('po_id')]][5];
			//$other_amount=$emblishment_costing_arr[$row[csf('po_id')]][99];

			$wash_cost=$wash_costing_arr[$row[csf('po_id')]];

			$foreign = $commisions_costing_arr[$row[csf('po_id')]][1];
			$local = $commisions_costing_arr[$row[csf('po_id')]][2];

			$test_cost=$others_costing_arr[$row[csf('po_id')]]['lab_test'];
			$freight_cost=$others_costing_arr[$row[csf('po_id')]]['freight'];
			$inspection=$others_costing_arr[$row[csf('po_id')]]['inspection'];
			$certificate_cost=$others_costing_arr[$row[csf('po_id')]]['certificate_pre_cost'];
			$common_oh=$others_costing_arr[$row[csf('po_id')]]['common_oh'];
			$currier_cost=$others_costing_arr[$row[csf('po_id')]]['currier_pre_cost'];
			$cm_cost=$others_costing_arr[$row[csf('po_id')]]['cm_cost'];

			$deferred_lc_cost=$others_costing_arr[$row[csf('po_id')]]['deffdlc_cost'];
			$design_cost=$others_costing_arr[$row[csf('po_id')]]['design_cost'];
			$studio_cost=$others_costing_arr[$row[csf('po_id')]]['studio_cost'];
			$interest_cost = $others_costing_arr[$row[csf('po_id')]]['interest_cost'];
			$income_tax_cost = $others_costing_arr[$row[csf('po_id')]]['incometax_cost'];
			$depr_amor_pre_cost=$others_costing_arr[$row[csf('po_id')]]['depr_amor_pre_cost'];


			$cm_cost_dzn=$row[csf('cm_cost')];

			$total_cost = $commercial_cost+$fab_purchase+$trim_amount+$print_amount+$embroidery_amount+$special_amount+$gmts_deying_amount+$wash_cost+$foreign+$local+$test_cost+$freight_cost+$inspection+$certificate_cost+$common_oh+$currier_cost+$cm_cost+$deferred_lc_cost+$design_cost+$studio_cost+$interest_cost+$income_tax_cost+$depr_amor_pre_cost;

			?>
			 <tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
				 <td width="40"><? echo $i; ?></td>
				 <td width="70"><? echo $company_library[$company_name]; ?></td>
				 ...
				 <td width="110"><p><? echo $row[csf('style_ref_no')]; ?></p></td>
                  <td width="70"><p><? echo $season_library[$row[csf('season')]]; ?></p></td>
				 ...
				 <td width="70"><? echo change_date_format($row[csf('costing_date')]) ?></td>
				 <td width="90" align="right"><p><? echo number_format($row[csf('po_quantity')],2); ?></p></td>
				 <td width="90"><? echo $unit_of_measurement[$row[csf('order_uom')]] ?></td>
				 <td width="90"><? echo $row[csf('avg_unit_price')] ?></td>
				 <td width="90"><? echo $row[csf('po_quantity')]*$row[csf('ratio')]; ?></td>

				 <td width="90" align="right"><a href="##" onClick="generate_precost_fab_purchase_detail('<? echo $row[csf('po_id')]; ?>','<? echo $row[csf('job_no')];?>','<? echo $company_name; ?>','<? echo $row[csf('buyer_name')]; ?>','<? echo $fab_source_id; ?>','fab_purchase_detail')"><? echo number_format($fab_purchase,2); ?></a></td>
				 ...
				 <td width="80" align="right"><? echo number_format($gmts_deying_amount,2); ?></td>
				 <td width="90" align="right"><a href="##" onClick="generate_precost_embell_cost_detail('<? echo $row[csf('po_id')]; ?>','<? echo $row[csf('job_no')];?>','<? echo $company_name; ?>','<? echo $row[csf('buyer_name')]; ?>','<? echo $row[csf('style_ref_no')]; ?>','wash_cost_detail')"><? echo number_format($wash_cost,2); ?></a></td>
				 ...
				 <td width="120" align="right"><? echo number_format($currier_cost,2);?></td>
				 <td width="100" align="right"><? echo number_format($certificate_cost,2); ?></td>
				 <td width="100" align="right"><? echo number_format($deferred_lc_cost,2); ?></td>
				 ...
				 <td width="100" align="right"><? echo number_format($income_tax_cost,2); ?></td>
			...
			$total_order_qty_pcs+=$row[csf('po_quantity')]*$row[csf('ratio')];
			...
			$total_gmts_deying +=$gmts_deying_amount;

			$total_embelishment_cost+=$print_amount+$embroidery_amount+$special_amount+$gmts_deying_amount;
			...
			$total_deffdlc_cost += $deferred_lc_cost;
			...
			$total_incometax_cost += $income_tax_cost;
		...
		<table class="tbl_bottom" width="4260" id="report_table_footer" cellpadding="0" cellspacing="0" border="1" rules="all">
			<tr>
				<td width="40"></td>
				<td width="70"></td>
               <td width="70"></td>
				...
				<td width="70"></td>
				<td width="70"></td>
				<td width="90" align="right" id="total_order_qnty" data-amount="<? echo $total_order_amount; ?>"><? echo number_format($total_order_qty,2); ?></td>
				<td width="90"></td>
				<td width="90"></td>
				<td width="90" align="right"><? echo number_format($total_order_qty_pcs,2); ?></td>
				<td width="90" align="right" id="total_purchase_cost"><? echo number_format($total_purchase_cost,2); ?></td>
				...
				<td width="80" align="right" id="total_gmts_deying_amount" data-amount="<? echo $total_embelishment_cost; ?>"><? echo number_format($total_gmts_deying,2); ?></td>

				<td width="90" align="right" id="total_wash_cost"><? echo number_format($total_wash_cost,2); ?></td>
				...
				<td width="120" align="right" id="total_local_amount" data-amount="<? echo $total_commssion; ?>"><? echo number_format($total_local_amount,2); ?></td>
				...
				<td width="120" align="right" id="total_currier_amount"><? echo number_format($total_currier_amount,2); ?></td>
				<td width="100" align="right" id="total_certificate_amount"><? echo number_format($total_certificate_amount,2); ?></td>
				<td width="100" align="right" id="total_deffdlc_cost"><? echo number_format($total_deffdlc_cost,2); ?></td>
				<td width="100" align="right" id="total_design_cost"><? echo number_format($total_design_cost,2); ?></td>
				<td width="100" align="right" id="total_studio_cost"><? echo number_format($total_studio_cost,2); ?></td>
				<td width="100" align="right" id="total_common_oh_amount"><? echo number_format($total_common_oh_amount,2); ?></td>
				<td width="100" align="right" id="total_interest_cost"><? echo number_format($total_interest_cost,2); ?></td>
				<td width="100" align="right" id="total_incometax_cost"><? echo number_format($total_incometax_cost,2); ?></td>
				<td width="100" align="right" id="total_depr_amor_pre_cost"><? echo number_format($total_depr_amor_pre_cost,2); ?></td>
