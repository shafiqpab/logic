...
{	
    ...
    if(str_replace("'","",$cbo_working_factory)==0 || str_replace("'","",$cbo_working_factory)=="") $working_factory="";else $working_factory = "and b.supplier_id=$cbo_working_factory";
	...
	?>
	<fieldset>
	<div style="width:2530px" align="left">	
       <span style="background:red; padding:07px;">&nbsp;</span> Red meaning 2 days delay.
        <table width="2500" border="1" rules="all" class="rpt_table" > 
            <thead>
                <tr style="font-size:12px"> 
                    ...
                    <th width="70" style="word-break:break-all">Lead Time (days): OPD to Ship date</th>
        ...
        <div style="width:2530px; max-height:300px; overflow-y:scroll" id="report_div" > 
            <table id="report_tbl" width="2500" border="1" class="rpt_table" rules="all">
              <tbody>
				<?php
                ...
                <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>" style="font-size:12px">	
                    ...
                    <td width="100" style="word-break:break-all"><? echo $company_library[$row[csf('company_name')]]; ?></td>
                    <td width="100" style="word-break:break-all"><? echo $company_library[$row[csf('supplier_id')]]; ?></td>
                    ...
                    <td width="80" style="word-break:break-all"><? echo $prod_type_arr[$item_sting]['prod_type']; ?></td>
                    ...
                    <td width="70" align="left"><div style="word-wrap:break-word; width:50px"><? echo $unit_of_measurement[$row[csf('order_uom')]]; if($row[csf('order_uom')]!=1)echo '<br>('.$set_sting.')'; ?></div></td>
