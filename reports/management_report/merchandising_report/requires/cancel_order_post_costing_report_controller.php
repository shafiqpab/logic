            ...
            <table width="770" cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr>
                        ...
                        <td align="center">
                        	<input type="button" name="button" class="formbutton" value="Show" onClick="show_list_view ('<? echo $companyID; ?>'+'**'+document.getElementById('cbo_buyer_name').value+'**'+document.getElementById('cbo_search_by').value+'**'+document.getElementById('txt_search_common').value+'**'+document.getElementById('txt_date_from').value+'**'+document.getElementById('txt_date_to').value, 'create_order_no_search_list_view', 'search_div', 'cancel_order_post_costing_report_controller', 'setFilterGrid(\'tbl_list_search\',-1)');" style="width:100px;" />
                    	</td>
                    </tr>
                    <tr>
    ...
    <fieldset>
    	<table width="2330">
            <tr class="form_caption">
                <td colspan="23" align="center"><strong>Post Costing Report</strong></td>
            </tr>
            <tr class="form_caption">
                <td colspan="23" align="center"><strong><? echo $company_arr[$company_name];?></strong>
                <br>
                <strong>
        ...
        <table style="margin-top:10px" id="table_header_1" class="rpt_table" width="3420" cellpadding="0" cellspacing="0" border="1" rules="all">
            <thead>
                <th width="40">SL</th>
    	...
    	<div style="width:3442px; max-height:400px; overflow-y:scroll" id="scroll_body">
            <table class="rpt_table" width="3420" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
            <?
				...
				foreach($result as $row)
				{
					...
					$knit_cost_mkt=$conversion_costing_arr_process[$row[csf('id')]][1];//($plan_cut_qnty/$dzn_qnty)*$prodcostArray[$row[csf('job_no')]]['knit_charge'];
					...
					foreach($conversion_cost_head_array as $process_id=>$val)
					{
						...
						{
							$dye_finish_cost_mkt+=$conversion_costing_arr_process[$row[csf('id')]][$process_id];
						}
					...
					$aop_cost_mkt=$conversion_costing_arr_process[$row[csf('id')]][35];//($plan_cut_qnty/$dzn_qnty)*$prodcostArray[$row[csf('job_no')]]['aop_charge'];
					...
					if(is_infinite($mkt_margin_perc) || is_nan($mkt_margin_perc)){$mkt_margin_perc=0;}
					...
					if(is_infinite($knit_cost_actual) || is_nan($knit_cost_actual)){$knit_cost_actual=0;}
					...
					if(is_infinite($actual_margin_perc) || is_nan($actual_margin_perc)){$actual_margin_perc=0;}
				...
				?>
                	<tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
                        ...
                        <td width="100" rowspan="4" style="word-break:break-all;"><? echo $row[csf('po_number')]; ?></td>
                        ...
                        <td width="108" style="padding-right:2px" align="right"><? echo  number_format($yarn_cost_mkt+$yarn_dye_cost_mkt,2,'.',''); ?></td>
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($knit_cost_mkt,2,'.',''); ?></td>
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($dye_finish_cost_mkt,2,'.',''); ?></td>
                        <!--<td width="108" style="padding-right:2px" align="right"><?echo number_format($yarn_dye_cost_mkt,2,'.',''); ?></td>-->
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($aop_cost_mkt,2,'.',''); ?></td>
                        ...
                        <td style="padding-right:2px" align="right"><? echo number_format($mkt_margin_perc,2,'.',''); ?></td>
                    </tr>
                    <tr bgcolor="#F5F5F5" onClick="change_color('tr_a<? echo $i; ?>','#F5F5F5')" id="tr_a<? echo $i; ?>">
						...
						<a href="##" onClick="generate_ex_factory_popup('ex_factory_popup','<? echo $row[csf('job_no_prefix_num')];?>','<? echo $row[csf('id')]; ?>','550px')"><? echo  number_format($ex_factory_qty,0,'.',''); ?></a>
                        ...
                        <td width="108" style="padding-right:2px" align="right"><a href="#report_details" onClick="openmypage_actual('<? echo $row[csf('id')]; ?>','yarn_cost_actual','Actual Yarn Cost Details','900px')"><? echo number_format($yarn_cost_actual,2,'.',''); ?></a></td>
                        <td width="108" style="padding-right:2px" align="right"><a href="#report_details" onClick="openmypage_actual('<? echo $row[csf('id')]; ?>','knit_cost_actual','Actual Knitting Cost Details','900px')"><? echo number_format($knit_cost_actual,2,'.',''); ?></a></td>
                        <td width="108" style="padding-right:2px" align="right"><a href="#report_details" onClick="openmypage_actual('<? echo $row[csf('id')]; ?>','dye_finish_cost_actual','Actual Dyeing & Finish Cost Details','900px')"><? echo number_format($dye_finish_cost_actual,2,'.',''); ?></a></td>
                        <!--<td width="108" style="padding-right:2px" align="right"><?echo number_format($yarn_dye_cost_actual,2,'.',''); ?></td>-->
                        <td width="108" style="padding-right:2px" align="right"><a href="#report_details" onClick="openmypage_actual('<? echo $row[csf('id')]; ?>','aop_cost_actual','AOP Cost Details','800px')"><? echo number_format($aop_cost_actual,2,'.',''); ?></a></td>
                        ...
                        <td style="padding-right:2px" align="right"><? echo number_format($actual_margin_perc,2,'.',''); ?></td>
                    </tr>
                    <tr bgcolor="#E9E9E9" onClick="change_color('tr_v<? echo $i; ?>','#E9E9E9')" id="tr_v<? echo $i; ?>">
                    	...
                    	<td width="98" align="right" style="padding-right:2px">
							<? 
								...
								if(is_infinite($variance_qnty_per) || is_nan($variance_qnty_per)){$variance_qnty_per=0;}
                    	...
                    	<td width="108" align="right" style="padding-right:2px">
                        	<? 
								...
								if(is_infinite($variance_po_value_per) || is_nan($variance_po_value_per)){$variance_po_value_per=0;} 
                        ...
                        <td width="108" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_yarn_cost_per) || is_nan($variance_yarn_cost_per)){$variance_yarn_cost_per=0;}  
                        ...
                        <td width="108" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_knit_cost_per) || is_nan($variance_knit_cost_per)){$variance_knit_cost_per=0;}  
                        ...
                        <td width="108" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_dye_finish_cost_per) || is_nan($variance_dye_finish_cost_per)){$variance_dye_finish_cost_per=0;}  
                        ...
                        <td width="108" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_aop_cost_per) || is_nan($variance_aop_cost_per)){$variance_aop_cost_per=0;} 
                        ...
                        <td width="108" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_trims_cost_per) || is_nan($variance_trims_cost_per)){$variance_trims_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_embell_cost_per) || is_nan($variance_embell_cost_per)){$variance_embell_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_wash_cost_per) || is_nan($variance_wash_cost_per)){$variance_wash_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_commission_cost_per) || is_nan($variance_commission_cost_per)){$variance_commission_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_comm_cost_per) || is_nan($variance_comm_cost_per)){$variance_comm_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_freight_cost_per) || is_nan($variance_freight_cost_per)){$variance_freight_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_test_cost_per) || is_nan($variance_test_cost_per)){$variance_test_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_inspection_cost_per) || is_nan($variance_inspection_cost_per)){$variance_inspection_cost_per=0;}  
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_currier_cost_per) || is_nan($variance_currier_cost_per)){$variance_currier_cost_per=0;} 
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_cm_cost_per) || is_nan($variance_cm_cost_per)){$variance_cm_cost_per=0;} 
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_all_cost_per) || is_nan($variance_all_cost_per)){$variance_all_cost_per=0;} 
                        ...
                        <td width="98" style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_margin_cost_per) || is_nan($variance_margin_cost_per)){$variance_margin_cost_per=0;} 
                        ...
                        <td style="padding-right:2px" align="right">
                        	<? 
								...
								if(is_infinite($variance_per_cost_per) || is_nan($variance_per_cost_per)){$variance_per_cost_per=0;} 
                    ...
                    <tr bgcolor="#DFDFDF" onClick="change_color('tr_vp<? echo $i; ?>','#DFDFDF')" id="tr_vp<? echo $i; ?>">
                        ...
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($variance_yarn_cost_per,2,'.',''); ?></td>
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($variance_knit_cost_per,2,'.',''); ?></td>
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($variance_dye_finish_cost_per,2,'.',''); ?></td>
                        <!--<td width="108" style="padding-right:2px" align="right"><?echo number_format($variance_yarn_dye_cost_per,2,'.',''); ?></td>-->
                        <td width="108" style="padding-right:2px" align="right"><? echo number_format($variance_aop_cost_per,2,'.',''); ?></td>
                        ...
                        <td style="padding-right:2px" align="right"><? echo number_format($variance_per_cost_per,2,'.',''); ?></td>
                    </tr>
				<?
					$i++;
				}
				...
				if(is_infinite($tot_mkt_margin_perc) || is_nan($tot_mkt_margin_perc)){$tot_mkt_margin_perc=0;}
				$tot_actual_margin_perc=($tot_actual_margin/$tot_ex_factory_val)*100;
				if(is_infinite($tot_actual_margin_perc) || is_nan($tot_actual_margin_perc)){$tot_actual_margin_perc=0;}
				
				?>
            </table>
		</div>
        <table class="rpt_table" width="3420" cellpadding="0" cellspacing="0" border="1" rules="all">
            <tr bgcolor="#CCDDEE" onClick="change_color('tr_pt','#CCDDEE')" id="tr_pt" style="font-weight:bold;">
                ...
                <td width="88" style="padding-right:2px" align="right"><? echo number_format($tot_po_qnty,0,'.',''); ?></td>
                <td width="50">&nbsp;</td>
                <td width="70">&nbsp;</td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_po_value,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right">&nbsp;</td>
                <td width="80">&nbsp;</td>
                <td width="100">&nbsp;</td>
                <td width="100">Pre Costing Total</td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_po_qnty,0,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_po_value,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_yarn_cost_mkt+$tot_yarn_dye_cost_mkt,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_knit_cost_mkt,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_dye_finish_cost_mkt,2,'.',''); ?></td>
                <!--<td width="108" style="padding-right:2px" align="right"><?echo number_format($tot_yarn_dye_cost_mkt,2,'.',''); ?></td>-->
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_aop_cost_mkt,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_trims_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_embell_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_wash_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_commission_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_comm_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_freight_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_test_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_inspection_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_currier_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_cm_cost_mkt,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_mkt_all_cost,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_mkt_margin,2,'.',''); ?></td>
                <td width="101" style="padding-right:2px" align="right"><? echo number_format($tot_mkt_margin_perc,2,'.',''); ?></td>
            </tr>
            <tr bgcolor="#CCCCFF" onClick="change_color('tr_at','#CCCCFF')" id="tr_at" style="font-weight:bold;">
                ...
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_yarn_cost_actual,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_knit_cost_actual,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_dye_finish_cost_actual,2,'.',''); ?></td>
                <!--<td width="108" style="padding-right:2px" align="right"><?echo number_format($tot_yarn_dye_cost_actual,2,'.',''); ?></td>-->
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_aop_cost_actual,2,'.',''); ?></td>
            ...
            <tr bgcolor="#FFEEFF" onClick="change_color('tr_vt','#FFEEFF')" id="tr_vt" style="font-weight:bold;">
                ...
                <td width="98" align="right" style="padding-right:2px">
					<? 
						...
						if(is_infinite($tot_variance_qnty_per) || is_nan($tot_variance_qnty_per)){$tot_variance_qnty_per=0;}
                ...
                <td width="108" align="right" style="padding-right:2px">
                    <? 
						...
						if(is_infinite($tot_variance_po_value_per) || is_nan($tot_variance_po_value_per)){$tot_variance_po_value_per=0;} 
                ...
                <td width="108" style="padding-right:2px" align="right">
                    <? 
                        ...
                        if(is_infinite($tot_variance_yarn_cost_per) || is_nan($tot_variance_yarn_cost_per)){$tot_variance_yarn_cost_per=0;} 
                ...
                <td width="108" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_knit_cost_per) || is_nan($tot_variance_knit_cost_per)){$tot_variance_knit_cost_per=0;}  
                ...
                <td width="108" style="padding-right:2px" align="right">
                    <? 
                        ...
                        if(is_infinite($tot_variance_dye_finish_cost_per) || is_nan($tot_variance_dye_finish_cost_per)){$tot_variance_dye_finish_cost_per=0;} 
                ...
                <td width="108" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_aop_cost_per) || is_nan($tot_variance_aop_cost_per)){$tot_variance_aop_cost_per=0;} 
                ...
                <td width="108" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_trims_cost_per) || is_nan($tot_variance_trims_cost_per)){$tot_variance_trims_cost_per=0;}  
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_embell_cost_per) || is_nan($tot_variance_embell_cost_per)){$tot_variance_embell_cost_per=0;}  
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_wash_cost_per) || is_nan($tot_variance_wash_cost_per)){$tot_variance_wash_cost_per=0;}   
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_commission_cost_per) || is_nan($tot_variance_commission_cost_per)){$tot_variance_commission_cost_per=0;} 
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_comm_cost_per) || is_nan($tot_variance_comm_cost_per)){$tot_variance_comm_cost_per=0;} 
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_freight_cost_per) || is_nan($tot_variance_freight_cost_per)){$tot_variance_freight_cost_per=0;} 
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_test_cost_per) || is_nan($tot_variance_test_cost_per)){$tot_variance_test_cost_per=0;}  
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_inspection_cost_per) || is_nan($tot_variance_inspection_cost_per)){$tot_variance_inspection_cost_per=0;}  
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_currier_cost_per) || is_nan($tot_variance_currier_cost_per)){$tot_variance_currier_cost_per=0;} 
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_cm_cost_per) || is_nan($tot_variance_cm_cost_per)){$tot_variance_cm_cost_per=0;} 
                ...
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_all_cost_per) || is_nan($tot_variance_all_cost_per)){$tot_variance_all_cost_per=0;} 
                        echo number_format($variance_all_cost,2,'.','');
                    ?>
                </td>
                <td width="98" style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_margin_cost_per) || is_nan($tot_variance_margin_cost_per)){$tot_variance_margin_cost_per=0;}
                ...
                <td style="padding-right:2px" align="right">
                    <? 
						...
						if(is_infinite($tot_variance_per_cost_per) || is_nan($tot_variance_per_cost_per)){$tot_variance_per_cost_per=0;}
            ...
            <tr bgcolor="#CCCCEE" onClick="change_color('tr_vpt','#CCCCEE')" id="tr_vpt" style="font-weight:bold;">
                ...
                <td width="100">&nbsp;</td>
                <td width="100">Variance (%) Total</td>
                <td width="98" align="right" style="padding-right:2px"><? echo number_format($tot_variance_qnty_per,0,'.',''); ?></td>
                <td width="108" align="right" style="padding-right:2px"><? echo number_format($tot_variance_po_value_per,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_variance_yarn_cost_per,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_variance_knit_cost_per,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_variance_dye_finish_cost_per ,2,'.',''); ?></td>
                <!--<td width="108" style="padding-right:2px" align="right"><?echo number_format($tot_variance_yarn_dye_cost_per,2,'.',''); ?></td>-->
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_variance_aop_cost_per,2,'.',''); ?></td>
                <td width="108" style="padding-right:2px" align="right"><? echo number_format($tot_variance_trims_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_embell_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_wash_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_commission_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_comm_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_freight_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_test_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_inspection_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_currier_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_cm_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_all_cost_per,2,'.',''); ?></td>
                <td width="98" style="padding-right:2px" align="right"><? echo number_format($tot_variance_margin_cost_per,2,'.',''); ?></td>
                ...
                <td width="760" valign="top">
                    ...
                    <div id="summary_full"> <font color="#FF0000" style="display:none">*Yarn Dyeing Charge included with actual Yarn Cost</font>
                        ...
                        <table width="760" cellpadding="0" cellspacing="0" border="1" class="rpt_table" rules="all">
                            ...
                            <tr bgcolor="<? echo $bgcolor1; ?>" onClick="change_color('trtd_3','<? echo $bgcolor2; ?>')" id="trtd_3">
                                ...
                                <td align="right"><? 
									$cv=(($tot_yarn_cost_mkt+$tot_yarn_dye_cost_mkt)/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format((($tot_yarn_cost_mkt+$tot_yarn_dye_cost_mkt)/$tot_po_value)*100,2); 
								?></td>
                                ...
                                <td align="right"><? 
									$cv=($tot_yarn_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								
								//echo number_format(($tot_yarn_cost_actual/$tot_ex_factory_val)*100,2); 
								?></td>
                            ...
                            <tr bgcolor="<? echo $bgcolor2; ?>"  onclick="change_color('trtd_4','<? echo $bgcolor2; ?>')" id="trtd_4">
                                ...
                                <td align="right"><? 
									$cv=($tot_knit_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_knit_cost_mkt/$tot_po_value)*100,2); ?></td>
                                ...
                                <td align="right"><?  
									$cv=($tot_knit_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_knit_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_knit_cost_mkt-$tot_knit_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>"  onclick="change_color('trtd_5','<? echo $bgcolor1; ?>')" id="trtd_5">
                                <td align="center">4</td>
                                <td>Dye & Fin Cost</td>
                                <td align="right"><? echo number_format($tot_dye_finish_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_dye_finish_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_dye_finish_cost_mkt/$tot_po_value)*100,2); ?></td>
                                ...
                                <td align="right"><?  
									$cv=($tot_dye_finish_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_dye_finish_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                             ...
                             <!--<tr bgcolor="<?echo $bgcolor2; ?>"  onclick="change_color('trtd_6','<? echo $bgcolor2; ?>')" id="trtd_6">
                                ...
                                <td align="right"><?echo number_format($tot_yarn_dye_cost_mkt,2); ?></td>
                                <td align="right"><?echo number_format(($tot_yarn_dye_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><font color="#FF0000">*</font><?//echo number_format($tot_yarn_dye_cost_actual,2); ?></td>
                                <td align="right">&nbsp;<?//echo number_format(($tot_yarn_dye_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right">&nbsp;<?//echo number_format($tot_yarn_dye_cost_mkt-$tot_yarn_dye_cost_actual,2); ?></td>
                            </tr>-->
                            <tr bgcolor="<? echo $bgcolor2; ?>"  onclick="change_color('trtd_7','<? echo $bgcolor1; ?>')" id="trtd_7">
                                <td align="center">5</td>
                                <td>AOP & Others Cost</td>
                                <td align="right"><? echo number_format($tot_aop_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_aop_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_aop_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_aop_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_aop_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_aop_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_aop_cost_mkt-$tot_aop_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>" onClick="change_color('trtd_8','<? echo $bgcolor2; ?>')" id="trtd_8">
                                <td align="center">6</td>
                                <td>Trims Cost</td>
                                <td align="right"><? echo number_format($tot_trims_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_trims_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_trims_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_trims_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_trims_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_trims_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_trims_cost_mkt-$tot_trims_cost_actual,2); ?></td>
                            </tr> 
                            <tr bgcolor="<? echo $bgcolor2; ?>" onClick="change_color('trtd_9','<? echo $bgcolor1; ?>')" id="trtd_9">
                                <td align="center">7</td>
                                <td>Embellishment Cost</td>
                                <td align="right"><? echo number_format($tot_embell_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_embell_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_embell_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_embell_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_embell_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_embell_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_embell_cost_mkt-$tot_embell_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>" onClick="change_color('trtd_10','<? echo $bgcolor2; ?>')" id="trtd_10">
                                <td align="center">8</td>
                                <td>Wash Cost</td>
                                <td align="right"><? echo number_format($tot_wash_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_wash_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_wash_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_wash_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_wash_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_wash_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_wash_cost_mkt-$tot_wash_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor2; ?>"  onclick="change_color('trtd_11','<? echo $bgcolor1; ?>')" id="trtd_11">
                                <td align="center">9</td>
                                <td>Commission Cost</td>
                                <td align="right"><? echo number_format($tot_commission_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_commission_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_commission_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_commission_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_commission_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_commission_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_commission_cost_mkt-$tot_commission_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>" onClick="change_color('trtd_12','<? echo $bgcolor2; ?>')" id="trtd_12">
                                <td align="center">10</td>
                                <td>Commercial Cost</td>
                                <td align="right"><? echo number_format($tot_comm_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_comm_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_comm_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_comm_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_comm_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_comm_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_comm_cost_mkt-$tot_comm_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor2; ?>" onClick="change_color('trtd_13','<? echo $bgcolor1; ?>')" id="trtd_13">
                                <td align="center">11</td>
                                <td>Freight Cost</td>
                                <td align="right"><? echo number_format($tot_freight_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_freight_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_freight_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_freight_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_freight_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_freight_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_freight_cost_mkt-$tot_freight_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>"  onclick="change_color('trtd_14','<? echo $bgcolor2; ?>')" id="trtd_14">
                                <td align="center">12</td>
                                <td>Testing Cost</td>
                                <td align="right"><? echo number_format($tot_test_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_test_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_test_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_test_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_test_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_test_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_test_cost_mkt-$tot_test_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor2; ?>" onClick="change_color('trtd_15','<? echo $bgcolor1; ?>')" id="trtd_15">
                                <td align="center">13</td>
                                <td>Inspection Cost</td>
                                <td align="right"><? echo number_format($tot_inspection_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_inspection_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_inspection_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_inspection_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_inspection_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_inspection_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_inspection_cost_mkt-$tot_inspection_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>" onClick="change_color('trtd_16','<? echo $bgcolor2; ?>')" id="trtd_16">
                                <td align="center">14</td>
                                <td>Courier Cost</td>
                                <td align="right"><? echo number_format($tot_currier_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_currier_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_currier_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_currier_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_currier_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_currier_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_currier_cost_mkt-$tot_currier_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor2; ?>" onClick="change_color('trtd_17','<? echo $bgcolor1; ?>')" id="trtd_17">
                                <td align="center">15</td>
                                <td>CM</td>
                                <td align="right"><? echo number_format($tot_cm_cost_mkt,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_cm_cost_mkt/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_cm_cost_mkt/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_cm_cost_actual,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_cm_cost_actual/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_cm_cost_actual/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_cm_cost_mkt-$tot_cm_cost_actual,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor1; ?>" onClick="change_color('trtd_18','<? echo $bgcolor2; ?>')" id="trtd_18">
                                <td align="center">16</td>
                                <td>Total Cost</td>
                                <td align="right"><? echo number_format($tot_mkt_all_cost,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_mkt_all_cost/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_mkt_all_cost/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_actual_all_cost,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_actual_all_cost/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_actual_all_cost/$tot_ex_factory_val)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_mkt_all_cost-$tot_actual_all_cost,2); ?></td>
                            </tr>
                            <tr bgcolor="<? echo $bgcolor2; ?>" onClick="change_color('trtd_19','<? echo $bgcolor1; ?>')" id="trtd_19">
                                <td align="center">17</td>
                                <td>Margin/Loss</td>
                                <td align="right"><? echo number_format($tot_mkt_margin,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_mkt_margin/$tot_po_value)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_mkt_margin/$tot_po_value)*100,2); ?></td>
                                <td align="right"><? echo number_format($tot_actual_margin,2); ?></td>
                                <td align="right"><?  
									$cv=($tot_actual_margin/$tot_ex_factory_val)*100;
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
								//echo number_format(($tot_actual_margin/$tot_ex_factory_val)*100,2); ?></td>
                    ...
                    <div id="summary_buyer">
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="1" class="rpt_table" rules="all">
                            ...
                            <?
                                ...
                                ?>
                                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trTD_<? echo $j; ?>','<? echo $bgcolor; ?>')" id="trTD_<? echo $j; ?>">
                                        ...
                                        <!--<td align="right"><?echo number_format($mkt_yarn_dy_array[$key],2); $tot_mkt_yarn_dy_cost+=$mkt_yarn_dy_array[$key]; ?></td>-->
                                        ...
                                        <td align="right"><? $mkt_margin_perc=($mkt_margin_array[$key]/$mkt_po_val_array[$key])*100; if(is_infinite($mkt_margin_perc) || is_nan($mkt_margin_perc)){$mkt_margin_perc=0;} echo number_format($mkt_margin_perc,2); $tot_mkt_margin_perc_cost+=$mkt_margin_perc; ?></td> 
                                    </tr>
                                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trTD2_<? echo $j; ?>','<? echo $bgcolor; ?>')" id="trTD2_<? echo $j; ?>">
                                        ...
                                        <!--<td align="right"><?echo number_format($yarn_dyeing_cost_array[$key],2); $tot_buyer_yarn_dyeing_cost+=$yarn_dyeing_cost_array[$key];?></td>-->
                                        ...
                                        <td align="right"><? $margin_perc=($margin_array[$key]/$ex_factory_val_array[$key])*100; if(is_infinite($margin_perc) || is_nan($margin_perc)){$margin_perc=0;} echo number_format($margin_perc,2); $tot_buyer_margin_perc_cost+=$margin_perc; ?></td> 
                                    </tr>
                                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trTD3_<? echo $j; ?>','<? echo $bgcolor; ?>')" id="trTD3_<? echo $j; ?>">
                                        ...
                                        <!--<td align="right"><?$yarn_dy_var= $mkt_yarn_dy_array[$key]-$yarn_dyeing_cost_array[$key];echo number_format($yarn_dy_var,2);?></td>-->
                                        <td align="right">
                                        <?
                                    ...
                                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trTD4_<? echo $j; ?>','<? echo $bgcolor; ?>')" id="trTD4_<? echo $j; ?>">
                                        <td><b>Variance (%)</b></td>
                                        <td align="right"><? 
										$cv=($ex_var/$mkt_po_val_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($ex_var/$mkt_po_val_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($yarn_var/$mkt_yarn_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($yarn_var/$mkt_yarn_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($knit_var/$mkt_knit_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($knit_var/$mkt_knit_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($dy_var/$mkt_dy_fin_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($dy_var/$mkt_dy_fin_array[$key]*100),2); ?></td>
                                       <!-- <td align="right"><?echo number_format(($yarn_dy_var/$mkt_yarn_dy_array[$key]*100),2); ?></td>-->
                                        <td align="right"><?  
										$cv=($aop_var/$mkt_aop_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($aop_var/$mkt_aop_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($trims_var/$mkt_trims_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($trims_var/$mkt_trims_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($emb_var/$mkt_emb_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($emb_var/$mkt_emb_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($wash_var/$mkt_wash_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($wash_var/$mkt_wash_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($com_var/$mkt_commn_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($com_var/$mkt_commn_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($commer_var/$mkt_commercial_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($commer_var/$mkt_commercial_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($fr_var/$mkt_freight_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($fr_var/$mkt_freight_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($test_var/$mkt_test_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($test_var/$mkt_test_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($ins_var/$mkt_ins_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($ins_var/$mkt_ins_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($cour_var/$mkt_courier_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($cour_var/$mkt_courier_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($cm_var/$mkt_cm_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($cm_var/$mkt_cm_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($tot_var/$mkt_total_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($tot_var/$mkt_total_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($mar_var/$mkt_margin_array[$key]*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($mar_var/$mkt_margin_array[$key]*100),2); ?></td>
                                        <td align="right"><?  
										$cv=($margin_perc_to/$mkt_margin_perc*100);
										if(is_infinite($cv) || is_nan($cv)){$cv=0;}
										echo number_format($cv,2);
										//echo number_format(($margin_perc_to/$mkt_margin_perc*100),2); ?></td> 
                                    </tr>
                           	<?
                                $j++;
                                }
                            ...
                            <tr bgcolor="<? echo $bgcolor5; ?>" onClick="change_color('trTD5_<? echo $j; ?>','<? echo $bgcolor5; ?>')" id="trTD5_<? echo $j; ?>">
                                ...
                                <!--<th align="right"><?echo number_format($tot_mkt_yarn_dy_cost,2); ?></th>-->
                                ...
                                <th align="right"><? $mm=$tot_mkt_margin_cost/$tot_mkt_po_val*100; if(is_infinite($mm) || is_nan($mm)){$mm=0;} echo number_format($mm,2); ?></th>   
                            </tr>
                            <tr bgcolor="<? echo $bgcolor6; ?>" onClick="change_color('trTD6_<? echo $j; ?>','<? echo $bgcolor6; ?>')" id="trTD6_<? echo $j; ?>">
                                ...
                                <!--<th align="right"><?echo number_format($tot_buyer_yarn_dyeing_cost,2); ?></th>-->
                                ...
                                <th align="right"><? $pp=$tot_buyer_margin_cost/$tot_buyer_ex_factory_val*100; if(is_infinite($pp) || is_nan($pp)){$pp=0;} echo number_format($pp,2); ?></th>   
                            </tr>
                            <tr bgcolor="<? echo $bgcolor7; ?>" onClick="change_color('trTD7_<? echo $j; ?>','<? echo $bgcolor7; ?>')" id="trTD7_<? echo $j; ?>">
                                ...
                                <th align="right"><? $yvar=$tot_mkt_yarn_cost-$tot_buyer_yarn_cost;  echo number_format($yvar,2); ?></th>
                                <th align="right"><? $kvar=$tot_mkt_knit_cost-$tot_buyer_knit_cost;  echo number_format($kvar,2); ?></th>
                                <th align="right"><? $dfvar=$tot_mkt_dy_fin_cost-$tot_buyer_dye_cost;  echo number_format($dfvar,2); ?></th>
                                <!--<th align="right"><?$ydvar=$tot_mkt_yarn_dy_cost-$tot_buyer_yarn_dyeing_cost;  echo number_format($ydvar,2); ?></th>-->
                            ...
                            <tr bgcolor="<? echo $bgcolor6; ?>" onClick="change_color('trTD8_<? echo $j; ?>','<? echo $bgcolor6; ?>')" id="trTD8_<? echo $j; ?>">
                                <th colspan="3">Variance (%)</th>
                                <th align="right"><? 
									$cv=($evar/$tot_mkt_po_val*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($evar/$tot_mkt_po_val*100),2); ?></th>
                                <th align="right"><?  
									$cv=($yvar/$tot_mkt_yarn_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($yvar/$tot_mkt_yarn_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($kvar/$tot_mkt_knit_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($kvar/$tot_mkt_knit_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($dfvar/$tot_mkt_dy_fin_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($dfvar/$tot_mkt_dy_fin_cost*100),2); ?></th>
                                <!--<th align="right"><?echo number_format(($ydvar/$tot_mkt_yarn_dy_cost*100),2); ?></th>-->
                                <th align="right"><?  
									$cv=($aopvar/$tot_mkt_aop_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($aopvar/$tot_mkt_aop_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($trimvar/$tot_mkt_trims_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($trimvar/$tot_mkt_trims_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($embvar/$tot_mkt_emb_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($embvar/$tot_mkt_emb_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($washvar/$tot_mkt_wash_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($washvar/$tot_mkt_wash_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($comvar/$tot_mkt_commn_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($comvar/$tot_mkt_commn_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($commercialvar/$tot_mkt_commercial_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($commercialvar/$tot_mkt_commercial_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($fvar/$tot_mkt_freight_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($fvar/$tot_mkt_freight_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($tvar/$tot_mkt_test_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($tvar/$tot_mkt_test_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($ivar/$tot_mkt_ins_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($ivar/$tot_mkt_ins_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($courvar/$tot_mkt_courier_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($courvar/$tot_mkt_courier_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($cmvar/$tot_mkt_cm_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($cmvar/$tot_mkt_cm_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($totvar/$tot_mkt_total_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($totvar/$tot_mkt_total_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($mvar/$tot_mkt_margin_cost*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($mvar/$tot_mkt_margin_cost*100),2); ?></th>
                                <th align="right"><?  
									$cv=($mpvar/$mm*100);
									if(is_infinite($cv) || is_nan($cv)){$cv=0;}
									echo number_format($cv,2);
									//echo number_format(($mpvar/$mm*100),2); ?></th>   
                            </tr>
                        </table>
                    </div>
                </td>
...
?>
	...
	{
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'cancel_order_post_costing_report_controller.php?po_id='+po_id+'&action='+type, tittle, 'width=560px, height=350px, center=1, resize=0, scrolling=0', '../../../');
	}
    </script>
...
?>
	<fieldset style="width:870px; margin-left:7px">
        ...
        <div style="width:865px; max-height:330px; overflow-y:scroll" id="scroll_body">
			<table border="1" class="rpt_table" rules="all" width="845" cellpadding="0" cellspacing="0">  
            	<tr bgcolor="#CCDDEE">
					<td colspan="8"><b>Inside Dyeing Bill</b></td>
				</tr>  
				<?
                $i=1; $avg_rate=76;
				$total_in_knit_qnty=0; $total_in_knit_cost_tk=0; $total_in_knit_cost_usd=0;
                ...
                $sql="select a.id, a.bill_no, a.bill_date, b.item_id, b.rate, b.delivery_qty, b.amount as amount from subcon_inbound_bill_mst a, subcon_inbound_bill_dtls b where a.id=b.mst_id and b.order_id=$po_id and a.process_id=4 and a.party_source=1 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 order by a.id";
                $result=sql_select($sql);
                foreach($result as $row)
                {
                    if($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";	
                ...
                <tr bgcolor="#CCDDEE">
					<td colspan="8"><b>Outside Dyeing Bill</b></td>
				</tr>
                <?
                    ...
                    <tr bgcolor="<? echo  $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                        ...
                        <td align="right">
                            <?
								...
								{
                                	$amount=$row[csf('amount')]*$avg_rate;
								}
								else
								{
