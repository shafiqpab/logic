...
if($db_type==0)
{
	...
	else
	{
		...
		where a.job_no=b.job_no_mst and a.company_name like '$company_name' and a.buyer_name like '$buyer_name' and a.style_ref_no like '$style_ref_cond' and a.team_leader like '$team_leader'  and a.dealing_marchant like '$dealing_marchant' and a.factory_marchant like  '$factory_marchant' $date_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 
...
<th colspan="18">Projected and Confirmed Order - <?  echo date('M,Y',strtotime($start_date));?> </th>
</tr>
...
<?
		...
		else
		{
			...
			<td width="100" align="right"><? echo number_format($value1[order_qty_pcs],0);?></td>
			<td width="100" align="right" bgcolor="#CCCCCC"><? echo number_format($target_basic_qnty[$buyer],0); $target_basic_qnty_tot+=$target_basic_qnty[$buyer];?></td>
			<td width="50" align="right" bgcolor="#CCCCCC"><?  echo number_format(($target_basic_qnty[$buyer]/$total_target_basic_qnty)*100,2); $percent_total+=($target_basic_qnty[$buyer]/$total_target_basic_qnty)*100; ?></td>
			<td width="100" align="right" bgcolor="#CCCCCC"><? echo number_format($value1[booked_basic_qnty],0);?></td>
			<td width="50" align="right" bgcolor="#CCCCCC"><? echo number_format(($value1[booked_basic_qnty]/$target_basic_qnty[$buyer])*100,2); ?></td>
			<td width="80" align="right" bgcolor="#CCCCCC"><? echo number_format($target_basic_qnty[$buyer]-$value1[booked_basic_qnty],0);?></td>
			<td width="50" align="right" bgcolor="#CCCCCC"><? echo number_format((($target_basic_qnty[$buyer]-$value1[booked_basic_qnty])/$target_basic_qnty[$buyer])*100,2);?></td> 
...
<th colspan="8">Confirmed Order - <?  echo date('M,Y',strtotime($start_date));?></th>
</tr>
<tr>
<th width="50">SL</th>
<th width="70">Company Name</th>
...
<th colspan="8">Projected Order - <?  echo date('M,Y',strtotime($start_date));?></th>
</tr>
<tr>
<th width="50">SL</th>
<th width="70">Company Name</th>
...
<td>Shipment Date Over & Pending</td>
    ...
    <div id="content_report_panel"> 
        <table width="4100" id="table_header_1" border="1" class="rpt_table" rules="all">
            <thead>
                <tr>
                    <th width="50">SL</th>
                    ...
                    <? $category_type="";
						if($cbo_category_by==1) $category_type="Country Ship Date";
						else $category_type="Pub Ship Date";
					?>
                ...
                <div style=" max-height:400px; overflow-y:scroll; width:4100px"  align="left" id="scroll_body">
                    <table width="4080" border="1" class="rpt_table" rules="all" id="table-body">
                    <?
                    ...
                    foreach ($data_array as $row)
                    {
						...
						if($row['is_confirmed']==2) $color_font="#F00";
						else $color_font="#000";
                        ...
                        <tr bgcolor="<? echo $bgcolor; ?>" style="vertical-align:middle" height="25" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>" >
                            ...
                            <td width="30" onClick="openmypage_image('requires/capacity_and_order_booking_status2_controller.php?action=show_image&job_no=<? echo $row[csf("job_no")] ?>','Image View')" style="word-wrap: break-word;word-break: break-all;"><img  src='../../../<? echo $imge_arr[$row[csf('job_no')]]; ?>' height='25' width='30' /></td>
                            <td width="30">
                            ...
                            <td width="90" align="right"><p><? echo $ex_factory_qnty*$row[csf('unit_price')]; ?></p></td>
                            <td  width="90" align="right" style="word-wrap: break-word;word-break: break-all;">
                            <?
                            $short_over_shipment="";
                            ...
                            <td width="90"><p>
                            <? 
                                if(($poQtyPcs-$ex_factory_qnty)==0){echo "At Per";}
                                else if($poQtyPcs<$ex_factory_qnty){echo "Over Shipment";}
                                else if($poQtyPcs>$ex_factory_qnty){echo "Short Shipment";}
                            ?>
                            </p></td>
                ...
                <table width="4100" id="report_table_footer" border="1" class="rpt_table" rules="all">
                    <tfoot>
                        <tr>
                            <th width="50"></th>
                            <th width="65" ></th>
...
<div id="nevbar">
    <ul>
        ...
        <li><a href="capacity_and_order_booking_status2_controller.php?action=gmts_image&job_no=<? echo $job_no;?>">Gmts.Image</a></li>
        <li><a href="capacity_and_order_booking_status2_controller.php?action=size_color_dtls&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Size and Color Details</a></li>
        <li><a href="capacity_and_order_booking_status2_controller.php?action=cost_info&txt_job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>&cbo_company_name=<? echo $mst_data_arr[0][csf('company_name')];?>">Cost Info</a></li>
        <li><a href="capacity_and_order_booking_status2_controller.php?action=fab_info&txt_job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>&cbo_company_name=<? echo $mst_data_arr[0][csf('company_name')];?>">Fabric Info</a></li>
        
        <li><a href="capacity_and_order_booking_status2_controller.php?action=sample_approval&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Sample Approval</a></li>
        <li><a href="capacity_and_order_booking_status2_controller.php?action=labdip_approval&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Labdip Approval</a></li>
        <li><a href="capacity_and_order_booking_status2_controller.php?action=trims_approval&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Trims App</a></li>
...
if($action=="size_color_dtls")
{
	...
	$color_size_arr=sql_select("SELECT order_quantity,color_number_id,size_number_id FROM wo_po_color_size_breakdown WHERE job_no_mst='$job_no' and po_break_down_id='$po_id' and status_active=1 and is_deleted=0");
...
function open_febric_receive_status_order_wise_popup(order_id,type,color)
{
	...
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'capacity_and_order_booking_status2_controller.php?order_id='+order_id+'&action='+type+'&color='+color, 'Detail Veiw', 'width='+popup_width+', height=380px,center=1,resize=0,scrolling=0','../../../');
}
...
{ //alert(book_num);
	...
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'capacity_and_order_booking_status2_controller.php?po_id='+po_id+'&item_name='+item_name+'&job_no='+job_no+'&book_num='+book_num+'&trim_dtla_id='+trim_dtla_id+'&action='+action, 'Details Veiw', 'width='+popup_width+', height=350px,center=1,resize=0,scrolling=0','../../../');
}
	...
	{
		var popup_width='900px';
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'capacity_and_order_booking_status2_controller.php?po_id='+po_id+'&item_name='+item_name+'&action='+action, 'Details Veiw', 'width='+popup_width+', height=350px,center=1,resize=0,scrolling=0','../../../');
	}
...
if($action=="country_work_progress_report_details")
{
	...
	$mst_data_arr=sql_select("select a.id, a.company_name, a.job_no, a.buyer_name, a.style_ref_no, a.product_dept, a.product_category, c.item_number_id, a.set_smv, a.packing, b.po_number, b.po_received_date, b.pub_shipment_date, c.country_ship_date, c.order_quantity, c.order_rate, c.order_total, c.plan_cut_qnty from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c where a.job_no=b.job_no_mst and b.id=c.po_break_down_id and a.job_no='$job_no' and b.id='$po_id' and c.country_id='$country_id' and a.is_deleted=0 and c.is_deleted=0");
    ...
    <fieldset style="width:99%;">
        <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all">
        	<thead>
            	<th colspan="10">Po Details for <? echo $country_name_arr[$country_id]; ?></th>
        	</thead>
            <tr bgcolor="#FFFFFF">
    ...
    <div id="nevbar">
        <ul>
            ...
            <li><a href="capacity_and_order_booking_status2_controller.php?action=country_gmts_info&txt_job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>&cbo_company_name=<? echo $mst_data_arr[0][csf('company_name')];?>">Gmts. Info</a></li>
            <li><a href="capacity_and_order_booking_status2_controller.php?action=sample_approval&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Sample Approval</a></li>
            <li><a href="capacity_and_order_booking_status2_controller.php?action=labdip_approval&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Labdip Approval</a></li>
            <li><a href="capacity_and_order_booking_status2_controller.php?action=trims_approval&job_no=<? echo $job_no;?>&po_id=<? echo $po_id;?>">Trims App</a></li>
        </ul>
        <div id="order_details">
           ...
           /* $order_data_arr=sql_select("SELECT  a.dealing_marchant, b.job_no_mst, b.po_number, b.po_received_date, b.factory_received_date, c.item_number_id, c.country_ship_date, b.unit_price as order_rate, sum(c.order_quantity*a.total_set_qnty) as po_quantity, sum(c.order_rate) as order_rate, sum(c.order_total) as order_value
			...
			group by c.item_number_id, a.dealing_marchant, b.job_no_mst, b.po_number, c.country_ship_date, b.po_received_date, b.factory_received_date");*/
			 $order_data_arr=sql_select("SELECT  a.dealing_marchant, b.job_no_mst, b.po_number, b.po_received_date, b.factory_received_date, c.country_ship_date, b.unit_price  as order_rate, sum(c.order_quantity*a.total_set_qnty) as po_quantity, sum(c.order_rate) as order_rate, sum(c.order_total) as order_value
            FROM wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c
            WHERE b.id=$po_id and b.job_no_mst='$job_no' and c.country_id='$country_id' and a.job_no=b.job_no_mst and b.id=c.po_break_down_id and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 
			group by  a.dealing_marchant, b.job_no_mst, b.po_number, b.po_received_date, b.factory_received_date, c.country_ship_date, b.unit_price");
            ...
            $fb_des=implode(',',$fb_des);
            $yarn_req=implode(',',$yarn_req);
			if($db_type==0) $con_day=change_date_format($order_data_arr[0][csf('country_ship_date')],"yyyy-mm-dd"); else $con_day=change_date_format($order_data_arr[0][csf('country_ship_date')],"","",1);
			$day_of_year=sql_select("select id, week_date, week_day from  week_of_year where week_date='$con_day'");
            ?>
            <fieldset>	
                <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all">
                    <tr bgcolor="#FFFFFF">
                        <td width="150">Fabric Description</td> <td width="250"><? echo $fb_des; ?></td>
                        <td width="150">Fabric Consumption</td><td width="150"><? echo $fb_con;?></td>
                        <td width="150">Yarn Required</td><td><? echo $yarn_req;?></td>
                    </tr>
                    <tr bgcolor="#E9F3FF">  
                        <td >Country Po Qty</td> <td ><? echo number_format($order_data_arr[0][csf('po_quantity')],2); ?></td>
                    ...
                    <tr bgcolor="#FFFFFF">  
                        <td>Country Ship Date</td><td><? echo change_date_format($order_data_arr[0][csf('country_ship_date')]);?></td>
                        <td>Country Ship Day</td><td><? echo $day_of_year[0][csf("week_day")];?></td>
                    ...
                    <tr bgcolor="#FFFFFF"> 
                        <td>GSM</td><td><? echo 'Top: '.$gsm_top.' Bottom: '.$gsm_bottom;?></td>
...
if($action=="country_cost_info")
{
    ...
    <input type="button" id="report_btn" class="formbutton" style="width:120px" value="Pre Cost Rpt2" onClick="generate_report('preCostRpt2')" />
...
<style>
    ...
    <input type="button" id="report_btn" class="formbutton" style="width:120px" value="Show" onClick="fn_report_generated('report_generate')" />
    <div style="display:none" id="data_panel"></div>   
...
if($action=="country_gmts_info")
{
	...
	function fn_report_generated(re_type)
	{
		...
		var po_breack_down_id=$('#txt_po_breack_down_id').val();
		var type=1;
		var data="action="+re_type+"&type="+type+
		 			'&cbo_company_name='+"'"+company_name+"'"+
    ...
    <body onLoad="set_hotkey();">
        ...
        <input type="hidden" name="txt_costing_date" id="txt_costing_date" value="<? echo $ex_data[2]; ?>"/>
        <input type="hidden" name="txt_po_breack_down_id" id="txt_po_breack_down_id" value="<? echo $po_id; ?>"/>
        <input type="button" id="report_btn" class="formbutton" style="width:120px" value="Country Wise" onClick="fn_report_generated('report_generate')" />
        <div style="display:none" id="data_panel"></div>   
        <div id="report_container" align="center"></div>
        <div id="report_container2" align="left"></div>
    </body>
