...
{ 
	...
	if($reportType==1)
	{
		...
		$details_report .='<table width="3230" cellspacing="0" cellpadding="0"  border="1"  class="rpt_table" rules="all" id="table_body2"  align="left">';
		$i=1;
		...
		foreach($sql_result as $row)
		{
			...
			$budget_cm_per_pcs=$cm_cost_arr[$row[csf('job_no')]]/$dzn_qnty;
			...
			$details_report .=$inv_id.'</p></td>
								...
								$budget_cm_per_pcs_tot+=($budget_cm_per_pcs*$current_ex_Fact_Qty);
			...
			$details_report .=$item_name_all.'</p></td>
								...
								<td width="80" align="right"><p><a href="##" onclick="openmypage_ex_date('.$comapny_id.",'".$row[csf('po_id')]."','".$row[csf('ex_factory_date')]."','ex_date_popup2'".')">'. number_format($current_ex_Fact_Qty,0,'.', '').'</a></p></td>
								...
								<td width="50" align="right" title="CM per pcs: '.$budget_cm_per_pcs.'">'.number_format($budget_cm_per_pcs*$current_ex_Fact_Qty,2).'</td>
        ...
        <div style="width:3300x;">
            ...
            <div>
                ...
                <table width="3280" border="1" class="rpt_table" rules="all" id="table_header_2"  align="left">
                    <thead>
                        <th width="40">SL</th>
                        <th width="60">Job</th>
                        <th width="60">Year</th>
            ...
            <div style="width:3300px; overflow-y:scroll; overflow-x:hidden; max-height:300px;"  id="scroll_body" >
            <? echo $details_report; ?>
            <table width="3280" cellspacing="0" cellpadding="0"  border="1"  class="rpt_table" rules="all" id="table_footer" align="left">
                <tfoot>
                    <tr>
                    	<th width="40">&nbsp;</th>
                        <th width="60">&nbsp;</th>
                        ...
                        <th width="50" align="right" id="value_cm_cost"><? echo number_format($budget_cm_per_pcs_tot,2);?></th>
                        <th width="100">&nbsp;</th>
                        <th width="80">&nbsp;</th>
                        <th width="80">&nbsp;</th>
                        <th width="70">&nbsp;</th>
	...
	else if($reportType==2)
	{
		...
		from pro_ex_factory_mst a, wo_po_break_down b, wo_po_details_master c 
		where a.po_break_down_id=b.id and b.job_no_mst=c.job_no and c.company_name =$cbo_company_name $str_cond and a.entry_form!=85  and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active in(1,3) and c.is_deleted=0 and c.status_active=1 
