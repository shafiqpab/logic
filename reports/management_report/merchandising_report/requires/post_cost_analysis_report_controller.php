    ...
    <fieldset>
    	...
    	<div style="width:3552px; max-height:400px; overflow-y:scroll" id="scroll_body">
            ...
            <?
				...
				$receive_array=array();
				$sql_receive="select a.receive_purpose,b.prod_id, sum(b.order_qnty) as qty, sum(b.order_amount) as amnt from inv_receive_master a, inv_transaction b where  a.id=b.mst_id and b.transaction_type=1 and b.item_category=1 and b.status_active=1 and b.is_deleted=0 group by b.prod_id,a.receive_purpose";
				$resultReceive = sql_select($sql_receive);
				foreach($resultReceive as $invRow)
				{
					$avg_rate=$invRow[csf('amnt')]/$invRow[csf('qty')];
					if($invRow[csf('receive_purpose')]==2 || $invRow[csf('receive_purpose')]==15  || $invRow[csf('receive_purpose')]==43) //Yarn Dyeing
					{
