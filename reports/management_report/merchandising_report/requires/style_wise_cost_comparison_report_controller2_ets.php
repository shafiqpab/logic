	...
	<div align="center" style="width:100%;" >
		<form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
            <table width="1110" cellspacing="0" cellpadding="0" border="1" class="rpt_table" align="center" rules="all">
                ...
                <tr class="general">
                    <td><? echo create_drop_down( "cbo_company_mst", 120, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name",1, "-- Select Company --", $company_name,"load_drop_down( 'style_wise_cost_comparison_report_controller2_ets', this.value, 'load_drop_down_buyer', 'buyer_td' );" ); ?></td>
     ...
     <script>
        load_drop_down( 'style_wise_cost_comparison_report_controller2_ets', <? echo $company_name;?>, 'load_drop_down_buyer', 'buyer_td' );
    </script>
...
if($action=="create_po_search_list_view")
{
	...
	if($budget_version==1){
		 $budget_version_cond="and f.entry_from=111";	
	}
	else if($budget_version==2){
		$budget_version_cond="and f.entry_from=158";
	}
	else{
		$budget_version_cond="and f.entry_from=237";
	}
	...
	if ($data[2]==0)
	{
		...
		else
		{
			if($db_type==0)
			{
				$sql="select a.job_no_prefix_num, a.job_no,a.company_name,a.buyer_name,a.style_ref_no,a.job_quantity, b.id as po_id,b.po_number,sum(b.po_quantity) as  po_quantity,b.shipment_date,a.garments_nature,b.grouping,b.file_no,DATEDIFF(pub_shipment_date,po_received_date) as  date_diff,SUBSTRING_INDEX(a.`insert_date`, '-', 1) as year from wo_po_details_master a, wo_po_break_down b,wo_po_color_size_breakdown c,pro_ex_factory_mst d,production_logicsoft e,wo_pre_cost_mst f where a.job_no=b.job_no_mst and c.job_no_mst=a.job_no and c.po_break_down_id=b.id and c.po_break_down_id=d.po_break_down_id and b.id=d.po_break_down_id and a.job_no=f.job_no and b.job_no_mst=f.job_no and c.job_no_mst=f.job_no  and a.job_no=e.jobNo and c.job_no_mst=e.jobNo and b.job_no_mst=e.jobNo and a.garments_nature=$data[5] and a.status_active=1 and b.status_active=1 and e.is_self_order=1  $company $buyer $job_cond $order_cond $style_cond $shiping_status $file_no_cond $date_cond $internal_ref_cond $budget_version_cond ".set_user_lavel_filtering(' and a.buyer_name','buyer_id')."  group by a.job_no_prefix_num, a.job_no,a.company_name,a.buyer_name,a.style_ref_no,a.job_quantity, b.po_number,b.shipment_date,a.garments_nature,b.id,b.grouping,b.file_no,a.insert_date,b.pub_shipment_date,b.po_received_date order by a.job_no DESC";
			}
			if($db_type==2)
			{
				$sql="select a.job_no_prefix_num, a.job_no,a.company_name,a.buyer_name,a.style_ref_no,a.job_quantity, b.id as po_id,b.po_number,sum(b.po_quantity) as  po_quantity,b.shipment_date,a.garments_nature,b.grouping,b.file_no,(pub_shipment_date - po_received_date) as  date_diff,to_char(a.insert_date,'YYYY') as year from wo_po_details_master a, wo_po_break_down b,wo_po_color_size_breakdown c,pro_ex_factory_mst d,production_logicsoft e,wo_pre_cost_mst f where a.job_no=b.job_no_mst and c.job_no_mst=a.job_no and c.po_break_down_id=b.id  and c.po_break_down_id=d.po_break_down_id and b.id=d.po_break_down_id and a.job_no=f.job_no and b.job_no_mst=f.job_no and c.job_no_mst=f.job_no  and a.job_no=e.jobNo and c.job_no_mst=e.jobNo and b.job_no_mst=e.jobNo and a.garments_nature=$data[5] and a.status_active=1 and b.status_active=1  $company $buyer ".set_user_lavel_filtering(' and a.buyer_name','buyer_id')." and e.is_self_order=1 $job_cond $date_cond $order_cond $style_cond $shiping_status $file_no_cond $internal_ref_cond $date_cond $budget_version_cond group by a.job_no_prefix_num, a.job_no,a.company_name,a.buyer_name,a.style_ref_no,a.job_quantity, b.po_number,b.shipment_date,a.garments_nature,b.id,b.grouping,b.file_no,a.insert_date,b.pub_shipment_date,b.po_received_date order by a.job_no DESC";
			}
		}
		//echo $sql;
	}
	...
	if($cbo_search_by==3 && $data[13]==3)
	{
		...
		from wo_po_details_master a, wo_po_break_down b, pro_ex_factory_mst c,production_logicsoft d
		where a.job_no = b.job_no_mst and b.id = c.po_break_down_id and a.job_no=d.jobNo  and b.job_no_mst=d.jobNo and b.status_active = 1 and c.status_active=1 and d.is_self_order=1  $job_cond $order_cond $style_cond $shiping_status $file_no_cond $internal_ref_cond ");
...
if($action=="load_exchange_rate")
{
	...
	$sql_data=sql_select("select b.job_no,b.exchange_rate from wo_po_details_master a,wo_pre_cost_mst b,production_logicsoft d,wo_pre_cost_mst f where  a.job_no=b.job_no and a.job_no=f.job_no  and d.jobNo=f.job_no and a.job_no=d.jobNo  and a.job_no=d.jobNo  and b.job_no=d.jobNo and a.company_name=$company_id and a.job_no_prefix_num=$job_no and d.is_self_order=1 $year_cond $budget_version_cond");
...
/*$sql_conv_yarn="select b.id as po_id,c.job_no, d.composition  from   wo_po_break_down b,wo_pre_cost_fab_conv_cost_dtls c,wo_pre_cost_fabric_cost_dtls d  where  b.job_no_mst=c.job_no and c.job_no=d.job_no  and c.fabric_description=d.id  and b.status_active=1 and c.cons_process in(30) and b.is_deleted=0 and b.id in($po_id) and c.amount>0 ";
	...
	<table class="rpt_table" border="1" cellpadding="5" cellspacing="2" width="100%" rules="all">
		...
		if($m%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
			...
			$ret_issue_no=rtrim($issue_return_arr[$prod_id]['ret_issue_no'],',');
			$ret_issue_nos=implode(', ',array_unique(explode(",",$ret_issue_no)));
			...
			?>
			 <tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $m; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $m; ?>" style="font-size:11px">
				...
				<td align="right"  title="Ret Qty=<? echo $issue_return_arr[$prod_id]["qty"].' Return MRR='.$ret_issue_nos;?>">
					<?php
