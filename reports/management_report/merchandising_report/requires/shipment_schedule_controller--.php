...
if($action=="report_generate")
{
	...
	if($rpt_type==1)//Details
	{
	  ...
	  //echo  $sql_data; die;
		...
		{
			?>
			<table width="3830" id="table_header_1" border="1" class="rpt_table" rules="all">
				<thead>
					<tr>
						<th width="50">SL</th>
			...
			<div style=" max-height:400px; overflow-y:scroll; width:3850px"  align="left" id="scroll_body">
			<table width="3830" border="1" class="rpt_table" rules="all" id="table_body">
				<?
				...
				$i=1; $order_qnty_pcs_tot=0; $order_qntytot=0; $oreder_value_tot=0; $total_ex_factory_qnty=0; $total_short_access_qnty=0; $total_short_access_value=0; $yarn_req_for_po_total=0;
					...
					foreach ($po_wise_arr as $po_id=>$row)
					{
						...
						<tr bgcolor="<? echo $bgcolor;?>" style="vertical-align:middle" height="25" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
							...
							<td width="100" align="right"><p><? if($cm_for_shipment_schedule_arr[$row[('job_no')]]) echo number_format(($cm_for_shipment_schedule_arr[$row[('job_no')]]/$costing_per_pcs)*$row[('po_quantity')],2);else echo 0; //echo $cm_for_shipment_schedule_arr[$row[('job_no')]].'='.$costing_per_pcs;?></p></td>
				...
				<table width="3830" id="report_table_footer" border="1" class="rpt_table" rules="all">
					<tfoot>
						<tr>
							<th width="50"></th>
							<th width="70" ></th>
		...
		{
			?>
			<table width="4310" id="table_header_1" border="1" class="rpt_table" rules="all">
				<thead>
					<tr>
						<th width="50">SL</th>
						<th width="70" >Company</th>
			...
			<div style=" max-height:400px; overflow-y:scroll; width:4330px"  align="left" id="scroll_body">
			<table width="4310" border="1" class="rpt_table" rules="all" id="table_body">
				<?
				...
				foreach ($data_array_group as $row_group)
				{
					...
					if($db_type==2)
					{
						...
						from wo_po_details_master a, wo_po_break_down b
						where  a.job_no=b.job_no_mst and a.company_name in ($company_name)  $buyer_id_cond and a.team_leader like '$team_leader' $grouping  and a.dealing_marchant like '$dealing_marchant' $date_cond $pocond $year_cond and a.status_active=1 and b.status_active=1 $search_string_cond $file_cond  $style_owner_con $brand_cond $ref_cond
						group by a.job_no_prefix_num, a.job_no, a.insert_date, a.company_name, a.buyer_name, a.agent_name, a.style_ref_no, a.job_quantity, a.product_category, a.job_no, a.gmts_item_id, a.total_set_qnty, a.order_uom, a.team_leader, a.dealing_marchant,a.brand_id, a.season_buyer_wise
						order by a.style_ref_no");
					}
				...
				<table width="4310" id="report_table_footer" border="1" class="rpt_table" rules="all">
					<tfoot>
						<tr>
							<th width="50"></th>
							<th width="70" ></th>
				...
				$i=1; $order_qnty_pcs_tot=0; $order_qntytot=0; $oreder_value_tot=0; $total_ex_factory_qnty=0; $total_short_access_qnty=0; $total_short_access_value=0; $yarn_req_for_po_total=0;
					...
					foreach ($po_wise_arr as $po_id=>$row)
					{
						...
						<tr bgcolor="<? echo $bgcolor;?>" style="vertical-align:middle" height="25" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
							...
							<td width="100" align="right"><span class="break_word"><? echo number_format($row[('po_quantity')]*$row[('set_smv')],2);
							...
							<td width="100"><span class="break_word"><? echo implode("+",$job_wise_wash_rate_arr[$row[('job_no')]]);;?></span></td>
		...
		else
		{
			...
			<div style=" max-height:400px; overflow-y:scroll; width:4350px"  align="left" id="scroll_body">
				<table width="4330" border="1" class="rpt_table" rules="all" id="table_body_job_8">
					...
					$wash_data_array=sql_select("select id, job_no, emb_name, emb_type, rate, status_active, budget_on from wo_pre_cost_embe_cost_dtls where emb_name=3 ".where_con_using_array($job_arr,1,'job_no')." and status_active=1 and is_deleted=0 order by id");
					...
					foreach ($job_wise_data as $job_no=> $row)
					{
						...
						<tr bgcolor="<? echo $bgcolor;?>" style="vertical-align:middle" height="25" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
							...
							<td width="100"  align="left"><span class="break_word"><?  echo implode("+",$job_wash_rate_arr[$job_no]);?></span></td>
