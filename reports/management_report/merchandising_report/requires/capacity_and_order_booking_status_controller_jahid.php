...
else
{
	...
	$sql_data=sql_select("select a.company_id,a.location_id,a.year_id,a.month_id, b.buyer_id,b.allocation_percentage from lib_capacity_allocation_mst a, lib_capacity_allocation_dtls b where a.id=b.mst_id and a.company_id like '$company_name' and   b.buyer_id in($capBuyerId)  $year_cond and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0");
}
...
{
	/*$exfactory_data=sql_select("select po_break_down_id,sum(ex_factory_qnty) as ex_factory_qnty, MAX(ex_factory_date) as ex_factory_date from pro_ex_factory_mst  where 1=1 $po_cond_for_in and status_active=1 and is_deleted=0 group by po_break_down_id");*/
...
<td>Shipment Date Over & Pending</td>
    ...
    <div id="content_report_panel"> 
        <table width="4200" id="table_header_1" border="1" class="rpt_table" rules="all">
            <thead>
                <tr>
                    <th width="50">SL</th>
                ...
                <div style=" max-height:400px; overflow-y:scroll; width:4200px"  align="left" id="scroll_body">
                    <table width="4180" border="1" class="rpt_table" rules="all" id="table-body">
                    <?
                ...
                <table width="4200" id="report_table_footer" border="1" class="rpt_table" rules="all">
                    <tfoot>
                        <tr>
                            <th width="50"></th>
                            <th width="65" ></th>
