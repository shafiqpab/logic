            ...
            <table cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr>
                        ...
                        <td align="center">
                        	<input type="button" name="button" class="formbutton" value="Show" onClick="show_list_view ('<? echo $companyID; ?>'+'**'+document.getElementById('cbo_buyer_name').value+'**'+document.getElementById('cbo_search_by').value+'**'+document.getElementById('txt_search_common').value+'**'+document.getElementById('cbo_year').value+'**'+'<? echo $txt_style_ref_no; ?>'+'**'+'<? echo $txt_style_ref_id; ?>'+'**'+'<? echo $txt_style_ref; ?>', 'create_job_no_search_list_view', 'search_div', 'budget_breakdown_analysis_report_controller', 'setFilterGrid(\'list_view\',-1)');" style="width:80px;" />
                    </td>
                    </tr>
            	</tbody>
           	</table>
...
//style search------------------------------//
if($action=="create_job_no_search_list_view2")
{
	extract($_REQUEST);
            ...
            <table cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr>
						...
						<td><? echo create_drop_down( "cbo_year", 60, create_year_array(),"", 1,"-- All --", $selected_year, "",0,"" ); ?></td>
                        <td align="center">
                    	<?
                        ...
                        <td align="center">
                        	<input type="button" name="button" class="formbutton" value="Show" onClick="show_list_view ('<? echo $companyID; ?>'+'**'+document.getElementById('cbo_buyer_name').value+'**'+document.getElementById('cbo_search_by').value+'**'+document.getElementById('txt_search_common').value+'**'+document.getElementById('cbo_year').value+'**'+'<? echo $txt_style_ref_no; ?>'+'**'+'<? echo $txt_style_ref_id; ?>'+'**'+'<? echo $txt_style_ref; ?>', 'create_order_no_search_list_view', 'search_div', 'budget_breakdown_analysis_report_controller', 'setFilterGrid(\'list_view\',-1)');" style="width:80px;" />
                    </td>
                    </tr>
            	</tbody>
           	</table>
...
if($action=="create_order_no_search_list_view")
{
	...
	// $sql = "select a.id,a.style_ref_no,a.quotation_id,a.job_no,a.job_no_prefix_num,$select_date as job_year from wo_po_details_master a where a.company_name=$company $buyer_cond $year_cond $job_cond $search_con and is_deleted=0 order by job_no_prefix_num";
	$sql="select b.id, b.po_number, a.job_no_prefix_num, a.job_no, a.buyer_name, a.style_ref_no,$select_date as job_year from wo_po_details_master a, wo_po_break_down b  where a.job_no=b.job_no_mst and a.company_name=$company $buyer_cond $year_cond $job_cond $search_con and a.is_deleted=0  ORDER BY a.job_no";
	...
	echo create_list_view("list_view", "Job No,Buyer,Style Ref.,Order No","160,100,90,100","500","200",0, $sql , "js_set_value", "id,po_number", "", 1, "0,buyer_name,0,0", $arr, "job_no_prefix_num,buyer_name,style_ref_no,po_number", "","setFilterGrid('list_view',-1)","0,0,0,0",'',1) ;
...
if($cbo_search_type==2)
{
	...
	if($report_type==1)
	{
		...
		/* Red border */
			...
			<h3 align="left" id="accordion_h2" style="width:2000px" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel2', '')"> -Search Panel</h3>
			<fieldset style="width:100%;" id="content_search_panel2">
			<table width="1900">
					<tr class="form_caption">
						<td colspan="23" align="center"><strong>Cost Break Down Report</strong></td>
					</tr>
					<tr colspan="23" align="center" class="form_caption">
			   ...
			   ?>
			<table id="table_header_1" class="rpt_table" width="2060" cellpadding="0" cellspacing="0" border="1" rules="all">
				<thead>
					<tr>
						<th width="30" rowspan="2">SL</th>
						<th width="80" rowspan="2">Buyer</th>
						<th width="80" rowspan="2">Job No</th>
						<th width="80" rowspan="2">Ref No<hr>File No</th>
						<th width="100" rowspan="2">Team Leader<hr>Dealing Marchand</th>
						<th width="100" rowspan="2">Style<hr>Order No</th>
						<th width="100" rowspan="2">Item Name</th>
						<th width="60" rowspan="2">Avg Unit Price</th>
						<th width="80" rowspan="2">Order Date<hr>Shipment Date<? //echo $caption; ?></th>
						<th width="80" rowspan="2">Total Order Qty</th>
                        <th width="80" rowspan="2">Order Uom</th>
						
						<th width="80" rowspan="2">Cons/Dzn<hr>Total Cons.</th>
                        <th width="80" rowspan="2">Fabrics<hr> Rate/Kgs</th>
						<th width="80" rowspan="2">Fabrics Cost/Dz<hr>Total Fab. Cost</th>
						<th width="80" rowspan="2">Trim/Dz<hr>Trim Cost</th>
						<th width="80" rowspan="2">Print/Emb /Dz<hr>Total Print/Emb</th>
					
						<th width="80" rowspan="2">WashOther/ Dz<hr>Total WashOther</th>
						<th width="80" rowspan="2">Test/Dz<hr>Total Test</th>
						<th width="80" rowspan="2">Freight/Dz<hr>Total Freight</th>
                        <th width="80" rowspan="2">Comm/Dz<hr>Total Comm.</th>
                        <th width="80" rowspan="2">Commi/Dz<hr>Total Commi.</th>
						<th width="80" rowspan="2">CM/DZN<hr> Total CM</th>
                        <th width="80" rowspan="2">Total Cost</th>
                        <th width="80" rowspan="2">Total Price</th>
						<th rowspan="2"  width="">Total Margin</th>

					</tr>
					
				</thead>
			</table>
			<div style="width:2080px; max-height:400px; overflow-y:scroll" id="scroll_body">
			<table class="rpt_table" width="2060" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
			<?
			$dealing_merchant_array = return_library_array("select id, team_member_name from lib_mkt_team_member_info","id","team_member_name");
			
			$i=1; $total_order_qty=0; $total_yarn_cost=0; $total_order_value=0;$total_purchase_cost=0; $grand_tot_trims_cost=0; $total_washing_cost=0; $other_cost=0;
			 $total_trim_cost=0;$total_commercial_cost=0;
			...
			foreach($po_wise_arr as $po_id=>$row )
			{
				...
				$po_item_plan_qty=0;$po_item_qty=0;
				...
				$fab_purchase_knit_qty=($fabric_qty_arr['knit']['grey'][$row[('po_id')]]);
				$fab_purchase_woven_qty=($fabric_qty_arr['woven']['grey'][$row[('po_id')]]);
				$fab_purchase_qty=$fab_purchase_knit_qty+$fab_purchase_woven_qty;
				$fab_cons_dzn_req=($fab_purchase_qty/$po_item_plan_qty)*$dzn_qnty;
				
				$fab_purchase_knit=($fabric_costing_arr['knit']['grey'][$row[('po_id')]]);
				$fab_purchase_woven=($fabric_costing_arr['woven']['grey'][$row[('po_id')]]);
				...
				$conversion_cost=($po_conversion_cost_arr[$row[('po_id')]]);
				...
				?>
				 <tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>" style="font-size:11px">
					 ...
					 <td width="80"><div style="word-wrap:break-word; width:80px"><? echo $buyer_library[$row[('buyer_name')]]; ?></div></td>
					 <td width="80"><p><? echo $row[('job_no_prefix_num')]; ?></p></td>
					 <td width="80"><p><? echo $row[('file_no')]; ?></p></td>
					 <td width="100"><p><? echo $team_leader_arr[$row[('team_leader')]]; ?><hr>
                     <? echo $dealing_merchant_array[$row[('dealing_marchant')]]; ?></p></td> 
					 <td width="100"><div style="word-wrap:break-word; width:100px"><? echo $row[('style_ref_no')]; ?><hr>
                    	<a href="javascript:precost_bom_pop('<? echo $row[('po_id')]; ?>','<? echo $row[('job_no')]; ?>','<?  echo $company_name; ?>','<? echo $row[('buyer_name')]; ?>','<? echo $row[('style_ref_no')]; ?>','<? echo $costing_date; ?>');"><? echo $row[('po_number')]; ?></a></div>
                     </td>
					 <td width="100"><div style="word-wrap:break-word; width:100px"><? echo $gmts_item; ?></div></td>
					 <td width="60" title="<? echo $row[('unit_price')];?>"><div style="word-wrap:break-word; width:60px"><? echo $row[('avg_unit_price')]; ?></div></td>
					 <td width="80"><div style="word-wrap:break-word; width:80px"><? echo change_date_format($row[('po_received_date')]).'<hr>'.change_date_format($row[('pub_shipment_date')]); ?></div></td>
					 <td width="80" align="right"><p><? echo number_format($row[('po_quantity')],2); ?></p></td>
                     <td width="80"><p><? echo $unit_of_measurement[$row[('order_uom')]]; ?></p></td>
                     <td width="80" title="Fab Req/Plan Qty(<? echo $po_item_qty;?>)*<? echo $dzn_qnty;?>" bgcolor="<? echo $td_color;?>"><div style="word-wrap:break-word; width:80px"><? echo number_format($fab_cons_dzn_req,2).'<hr>'.number_format($fab_purchase_qty,2); ?></div></td> 
                     <td width="80" align="right"><p><? echo number_format($row[('unit_price')],2); ?></p></td>
                     <td width="80" align="right" title="Yarn+Fab+Conversion(Fab Req/PO Qty*<? echo $dzn_qnty;?>)"><p><? echo number_format($all_fab_cost_dzn,2).'<hr>'.number_format($all_fab_cost,2); ?></p></td>
                     <td width="80" align="right"><p><? echo number_format($trim_amount_dzn,2).'<hr>'.number_format($trim_amount,2);; ?></p></td>
                     <td width="80" align="right" title="Req Amt/PO Qty*<? echo $dzn_qnty;?>"><p><? echo number_format($print_emb_amount_dzn,2).'<hr>'.number_format($print_amount+$embroidery_amount,2);; ?></p></td>
                      <td width="80" align="right" title="Req Amt/PO Qty*<? echo $dzn_qnty;?>"><p><? echo number_format($wash_amount_dzn,2).'<hr>'.number_format($wash_cost+$other_amount,2); ?></p></td>
                      ...
                      <td width="80" align="right" title="Req Amt/PO Qty*<? echo $dzn_qnty;?>"><p><? echo number_format($freight_cost_dzn,2).'<hr>'.number_format($freight_cost,2); ?></p></td>
                       <td width="80" align="right" title="Req Amt/PO Qty*<? echo $dzn_qnty;?>"><p><? echo number_format($commercial_cost_dzn,2).'<hr>'.number_format($commercial_cost,2); ?></p></td>
                        <td width="80" align="right" title="Req Amt/PO Qty*<? echo $dzn_qnty;?>"><p><? echo number_format($commission_cost_dzn,2).'<hr>'.number_format(($foreign+$local),2); ?></p></td>
                       <td width="80" align="right" title="Req Amt/PO Qty*<? echo $dzn_qnty;?>"><p><? echo number_format($cm_cost_dzn,2).'<hr>'.number_format($cm_cost,2); ?></p></td>
					 <? 
					 ...
					 ?>
                     <td width="80" align="right"><p><? echo number_format($total_cost,2); ?></p></td>
                     <td width="80" align="right"><p><? echo number_format($row['po_total_price'],2); ?></p></td>
					 <td width="" align="right"><? echo number_format($tot_margin ,2); ?></td>
			...
			<table class="tbl_bottom" width="2060" id="report_table_footer" cellpadding="0" cellspacing="0" border="1" rules="all">
				<tr>
					<td width="30">&nbsp;</td>
					<td width="80">&nbsp;</td>
					<td width="80">&nbsp;</td>
                    ...
                    <td width="80" align="right" id="total_order_qnty"><? echo number_format($total_order_qty,2); ?></td>
                    <td width="80">&nbsp;</td>
					<td width="80" align="right" id="total_fab_purchase_qty"><? echo number_format($total_fab_purchase_qty,2); ?></td>
                    <td width="80" align="right" id=""></td>
					<td width="80" id="total_all_fab_cost"><? echo number_format($total_all_fab_cost,2); ?></td>
					<td width="80" align="right" id="total_trim_cost"><? echo number_format($total_trim_cost,2); ?></td>
					...
					<td width="80" align="right" id="total_freight_cost"><? echo number_format($total_freight_cost,2); ?></td>
					<td width="80" align="right" id="total_commercial_cost"><? echo number_format($total_commercial_cost,2); ?></td>
					<td width="80" align="right" id="total_commssion"><? echo number_format($total_commssion,2); ?></td>
					<td width="80" align="right" id="total_cm_cost"><? echo number_format($total_cm_cost,2); ?></td>
                    <td width="80" align="right" id="total_cm_cost"><? echo number_format($total_tot_cost,2); ?></td>
                    <td width="80" align="right" id="total_order_amount"><? echo number_format($total_order_amount,2); ?></td>
					<td width="" align="right" id="total_margin"><? echo number_format($total_margin,2); ?></td>
...
*/
	...
	else if($report_type==3)
	{
		...
		//------------------------------------------	
			...
			<?
			$i=1; $total_order_qty=0;  $total_yarn_dyeing_cost=0; $total_yarn_cost=0; $total_order_amount=0;$total_purchase_cost=0; $grand_tot_trims_cost=0; $total_fabric_dyeing_cost=0; $total_knitting_cost=0; $total_heat_setting_cost=0;$total_finishing_cost=0; $total_washing_cost=0; $fabric_dyeing_cost_dzn=0; $other_cost=0;
	$all_over_print_cost=0;$total_trim_cost=0;$total_commercial_cost=0;
	$total_foreign_amount=0;$total_local_amount=0;$total_other_amount=0;$total_wash_cost=0;$total_print_amount=0;$total_embroidery_amount=0;$total_special_amount=0;$total_plan_cut_qnty_pcs=0;
			...
			foreach($result_sql_budget as $row )
			{
				...
				?>
				 <tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>" style="font-size:11px">
                    ...
                    <td width="110"><p><? echo $team_member_arr[$row[csf('team_leader')]]; ?></p></td>
                    ...
                    <td width="110" align="right"><p><? echo $smv_eff_arr[$row[csf('job_no')]]['eff']; ?></p></td>
					<td width="100"><p><? echo $row[csf('po_number')]; ?></p></td>
					<td width="100"><p><? echo  $order_status[$row[csf('is_confirmed')]]; ?></p></td>
                    <td width="110" align="center"><p><? echo $costing_library[$row[csf('job_no')]]; ?></p></td>
                    <td width="70"><p><? echo  date("d-M-Y", strtotime($ship_po_recv_date)); ?></p></td>
                    ...
                    <td width="80" align="right"><p><? echo $row[csf('excess_cut')]; ?></p></td>
                    <td width="110" align="right"><p><? echo $row[csf('plan_cut')]; ?></p></td>
					...
					?>
                    <td width="60" align="right"><p><? echo number_format($yarn_req_qty_arr[$row[csf('po_id')]],2); ?></p></td>
                    ...
                    <p>
						<? 
							...
							echo number_format($fab_cost,2);$tot_fab_cost+=$fab_cost; 
                        ?>
                    </p>
                    </td>
                    ...
                    <td width="110" align="right"><? $tot_netFOB=$order_value-$tot_forg_local; echo number_format($tot_netFOB,2);?></td>
                    <!--<td width="100" align="right"><? //$tot_cmValue=$tot_netFOB-$total_material_cost; echo number_format($tot_cmValue,2);?></td>-->
                    ...
                    <td width="110" align="right"><p><? echo number_format($tot_margin/$order_qty_pcs,2); ?></p></td>
                    
                    <td width="60" align="right"><?php echo number_format(($tot_margin / $order_value) * 100, 2); ?></td>
                    
                    
                    <td width="110" align="center"><p><? echo $lib_user_arr[$preCostApprove_arr[$row[csf('job_no')]]['apprv_by']]; ?></p></td>
                    <td width="110" align="center"><p><? echo $preCostApprove_arr[$row[csf('job_no')]]['apprv_date']; ?></p></td>
			...
			<table class="tbl_bottom" width="<? echo $width;?>" id="report_table_footer" cellpadding="0" cellspacing="0" border="1" rules="all">
				<tr>
                    ...
                    <!--<td width="110" align="right"><? //echo number_format($total_meterial_amount,2); ?></td>-->
                    ...
                    <!--<td width="100" align="right"><? //echo number_format($total_cm_new_value,2); ?></td>-->
...
if($action=="print_button_variable_setting")
{
    ...
    $print_report_format=return_field_value("format_id","lib_report_template","template_name ='".$data."' and module_id=11 and report_id=247 and is_deleted=0 and status_active=1");
   	$printButton=explode(',',$print_report_format);
	
	$buttonHtml="";
	foreach($printButton as $id){
		if($id==108)$buttonHtml.='<input type="button"  id="show_button" class="formbutton" style="width:90px;" value="Show" onClick="fn_report_generated(1)" />&nbsp;';
		if($id==195)$buttonHtml.='<input type="button"  id="show_button" class="formbutton" style="width:90px;" value="Show 2" onClick="fn_report_generated(2)" />&nbsp;';
	}
