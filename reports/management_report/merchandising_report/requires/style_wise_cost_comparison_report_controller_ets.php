	...
	<div align="center" style="width:100%;" >
		<form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
            <table width="1110" cellspacing="0" cellpadding="0" border="1" class="rpt_table" align="center" rules="all">
                ...
                <tr class="general">
                    <td><? echo create_drop_down( "cbo_company_mst", 120, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name",1, "-- Select Company --", $company_name,"load_drop_down( 'style_wise_cost_comparison_report_controller_ets', this.value, 'load_drop_down_buyer', 'buyer_td' );" ); ?></td>
     ...
     <script>
        load_drop_down( 'style_wise_cost_comparison_report_controller_ets', <? echo $company_name;?>, 'load_drop_down_buyer', 'buyer_td' );
    </script>
            ...
            <table border="1" class="rpt_table" rules="all" width="750" cellpadding="0" cellspacing="0">
                ...
                foreach ($result as $row) {
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
						...
						$transfer_amount=$row[csf('transfer_amount')]/$g_exchange_rate; echo number_format($transfer_amount, 2);
						 ?> </td>
                    </tr>
                    <?
                ...
                foreach ($result as $row) {
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                        ...
                        <td width="170"><p><? echo $row[csf('product_name_details')]; ?></p></td>
                        <td  width="100" align="right"><? echo number_format($row[csf('transfer_qnty')], 2); ?> </td>
                         <td align="right" title="Avg Rate: <? //echo $avg_rate; ?>"><? 
...
?>
	<fieldset style="width:950px; margin-left:7px">
        ...
        <caption> <b>Making Cost (CM) Actaul</b></caption>
            <thead>
                <th width="30">SL</th>
                <th width="80">Order Closing Date</th>
		...
		$sql_std_para=sql_select("select cost_per_minute,applying_period_date, applying_period_to_date from lib_standard_cm_entry where company_id=$company and status_active=1 and is_deleted=0  order by id desc");
			foreach($sql_std_para as $row )
			{
                ...
                $i=1;  $total_cm=$total_available_min=$total_produce_min=$total_prod_qty=0;
				$sql_job="select  a.job_no,a.buyer_name,a.style_ref_no,a.set_smv,b.production_date,b.produce_min,b.available_min from wo_po_details_master a,production_logicsoft b where a.job_no=b.jobNo and a.job_no='$job_no' and a.status_active=1 and a.is_deleted=0 and b.is_self_order=1  order by b.production_date desc";
                ...
                foreach($result_job as $row)
                {
					...
					$prod_qty=$row[csf('produce_min')]/$sew_smv;

                    ?>
                    <tr bgcolor="<? echo  $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                        <td width="30"><? echo $i; ?></td>
                        <td width="80"><p><? echo change_date_format($row[csf('production_date')]) ?></p></td>
                        <td width="100" align="center"><? echo $buyer_array[$row[csf('buyer_name')]]; ?></td>
                        <td width="160"><p><? echo $row[csf('style_ref_no')]; ?></p></td>
                        <td width="110"><p><? echo $row[csf('job_no')]; ?></p></td>
                        <td width="80" title="Produced Min/SMV"><p><? echo number_format($prod_qty,2); ?></p></td>
                ...
                <tr bgcolor="#CCCCCC">
                    ...
                    <th width="160">&nbsp;</th>
                    <th width="110">&nbsp;</th>
					<th width="80"><?  echo number_format($total_prod_qty,2); ?></th>
                   ...
                   <th width="60"><?  echo number_format((($total_produce_min/$total_available_min)*100),2); ?></th>
                    <th width="60">&nbsp;</th>
                    <th align="right" style="color: #666;"> <b><?  echo number_format($total_cm,4); ?></b></th>
                </tr>
