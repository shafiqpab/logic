...
<script>
	...
	function fn_report_generated()
	{
		...
		{	
			var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_date_from*txt_date_to*cbo_team_name*cbo_team_member*cbo_year*txt_job_no*txt_job_id*txt_style*txt_style_id',"../../../");
			freeze_window(3);
	...
	if( form_validation('cbo_company_name','Company Name')==false )
		{
			...
			emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/style_wise_shipment_report_controller.php?data='+data+'&action=style_popup', 'style Search', 'width=480px,height=420px,center=1,resize=0,scrolling=0','../../')
			emailwindow.onclose=function()
			{
            ...
            <fieldset style="width:1160px;">
                <table class="rpt_table" width="1150" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    ...
                    <tr class="general">
                        ...
                        <td>
                        <input style="width:100px;" name="txt_style_id" id="txt_style_id" class="text_boxes" onDblClick="openmypage_style()" placeholder="Browse Style" readonly />
