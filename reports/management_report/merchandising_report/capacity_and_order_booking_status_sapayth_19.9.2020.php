...
<script>
	...
	var tableFilters4 = 
	{
		col_operation: 
		{
			id: ["value_smv_tot","total_order_qnty_pcs","value_total_order_value","value_total_commission","value_total_net_order_value","total_ex_factory_qnty","total_ex_factory_val","total_short_access_qnty","total_over_access_qnty","value_total_short_access_value","value_total_over_access_value"],
			col: [21,24,26,27,28,29,30,31,32,33,34],
	...
	function fn_report_generated_summary(type)
	{
		...
		{	
			...
			{
				var data="action=generate_report_summary4"+get_submitted_data_string('cbo_company_name*cbo_style_owner*cbo_buyer_name*cbo_year*cbo_team_name*cbo_team_member*cbo_category_by*cbo_capacity_source*txt_date_from*txt_date_to*cbo_product_category*cbo_location_id*txt_style_ref*cbo_agent',"../../../");
			}
			else if(type==5)
			{
				var data="action=generate_report_fabric_requirement"+get_submitted_data_string('cbo_company_name*cbo_style_owner*cbo_buyer_name*cbo_year*cbo_team_name*cbo_team_member*cbo_category_by*cbo_capacity_source*txt_date_from*txt_date_to*cbo_product_category*cbo_location_id*txt_style_ref*cbo_agent',"../../../");
			}
			else if(type==6)
			{
				var data="action=generate_report_summary5"+get_submitted_data_string('cbo_company_name*cbo_style_owner*cbo_buyer_name*cbo_year*cbo_team_name*cbo_team_member*cbo_category_by*cbo_capacity_source*txt_date_from*txt_date_to*cbo_product_category*cbo_location_id*txt_style_ref*cbo_agent',"../../../");
			}
			else
			{
			...
			<fieldset>
                <table align="center" class="rpt_table" width="1630" cellpadding="0" cellspacing="0" border="1" rules="all">
                    ...
                    <tr class="general">
                        ...
                        <td>
                        <? 
                                echo create_drop_down( "cbo_category_by", 80, $report_date_catagory,"", 0, "--Select--", $selected, "",'',"1,2,4" );
                            ?>	
                    ...
                    <tr>
                        <td colspan="16" align="center">
                            ...
                            <input type="button" name="summary4" id="summary4" value="Summary4[Mkt]" onClick="fn_report_generated_summary(4)" class="formbutton" />
                            <input type="button" name="summary6" id="summary6" value="Summary5[Mkt]" onClick="fn_report_generated_summary(6)" class="formbutton" />
                            <input type="button" name="summary5" id="summary5" value="Fabric Requirement" onClick="fn_report_generated_summary(5)" class="formbutton" />
