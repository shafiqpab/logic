...
function fnc_line_month_popup(string_data,action,type,width_th)
	{
		//alert(string_data);
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/line_wise_revenue_report_controller.php?string_data='+string_data+'&type='+type+'&cbo_location='+cbo_location+'&cbo_floor='+cbo_floor+'&cbo_line='+cbo_line+'&action='+action, 'Details View', 'width='+popup_width+', height=490px,center=1,resize=0,scrolling=0','../../');
		emailwindow.onclose=function()
		{
		}
	}
