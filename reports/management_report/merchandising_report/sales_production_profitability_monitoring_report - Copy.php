<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Sales Productions Monitoring Report
				
Functionality	:	
JS Functions	:
Created by		:	Aziz 
Creation date 	: 	2/03/2017
Updated by 		: 		
Update date		: 		   
QC Performed BY	:		
QC Date			:	
...
<script>
	...
	{
		if( form_validation('txt_prod_date','To Date')==false )
		{
			//return;
		}
		var report_title=$( "div.form_caption" ).html();
	 
		var data="action=report_generate"+get_submitted_data_string('cbo_company_id*txt_prod_date',"../../../")+'&report_title='+report_title;
		
		//alert (data);// return;
		freeze_window(3);
		http.open("POST","requires/sales_production_profitability_monitoring_report_controller.php",true);
        ...
        <fieldset style="width:300px" >
            <table class="rpt_table" width="300" cellpadding="0" cellspacing="0" border="1" rules="all">
                ...
                <tr class="general">
                    ...
                    <td>
                        <input type="text" name="txt_prod_date" id="txt_prod_date" value="<? echo date("d-m-Y",time());?>" class="datepicker" style="width:140px;" tabindex="6" />
                    </td>
                    <td>
