<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This file for BH daily order entry report info.
Functionality	:
JS Functions	:
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("BH Daily Order Entry","../../../", 1, 1, $unicode);
?>
<script>
	...
	{
		if (form_validation('cbo_company_name*cbo_working_factory','Please Select Comapny*Please Select Working Factory')==false)
		{
			return;
		}
		else
		{
			var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_working_factory*cbo_buyer_name*txt_job_no*txt_style_ref*cbo_order_status*txt_order_no*cbo_date_type*txt_date_from*txt_date_to',"../../../");
			//alert(data);
			freeze_window();
			http.open("POST","requires/bh_daily_order_entry_controller.php",true);
	...
	function fn_report_generated_reponse()
	{
		if(http.readyState == 4)
		{
			...
			/*var tableFilters = {
				col_operation: {
				id: ["tot_po_qty","tot_po_qty_pcs","tot_smv","tot_val"],
				col: [24,26,27,30],
    ...
    <div style="width:100%;" align="center">
        ...
        <div id="content_search_panel" >
            <fieldset style="width:1100px;">
                <table class="rpt_table" width="1250px" cellpadding="1" cellspacing="0" rules="all" border="1">
                    <thead>
                    ...
                    <tr class="general">
                        <td>
							<?
                           	 echo create_drop_down( "cbo_company_name", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/bh_daily_order_entry_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                            ?>
                        </td>
						<td>
                        ...
                        <td>
                       	...
                       	<td>
							...
							echo create_drop_down( "cbo_date_type", 100, $date_type_arr, "", 1, "----Select----",0, "date_fill_change(this.value);",0,"" );
							?>
                        </td>
                        <td>
                           <?
						   ...
						   ?>
                            <input name="txt_date_from" id="txt_date_from" class="datepicker" style="width:60px" placeholder="From Date" value="<? //echo $previous_date;?>" >&nbsp; To
                            <input name="txt_date_to" id="txt_date_to" class="datepicker" style="width:60px"  placeholder="To Date" value="<? //echo $current_date;?>"  ></td>
                        <td>
