...
<script>
	...
	function fn_report_generated(type)
	{
		...
		else
		{
			...
			var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*cbo_team_leader*cbo_year_selection',"../../../")+'&report_title='+report_title;
			//alert(data); return;
			freeze_window(3);
        ...
        <div style="100%" align="center">
            <form id="consolid_order_1" name="consolid_order_1">
                <div style="width:580px;">
                    ...
                    <h3 align="left" id="accordion_h1" style="width:580px" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
                        ...
                        <fieldset style="width:580px;">
                            <table class="rpt_table" width="100%" cellpadding="1" cellspacing="2" align="center" rules="all">
                                <thead>
                                    ...
                                    <th class="must_entry_caption">Pub. Ship/ S.Forecast Year</th>
                                ...
                                <tbody>
                                    ...
                                    <td align="center"><?=create_drop_down( "cbo_year_selection", 100, $year,"", 1, "-- Select --", date('Y'), "",0 );	?></td>
