...
<script>
	...
	function fn_report_generated(type)
	{
		...
		{	
			...
			freeze_window(3);
			http.open("POST","requires/working_company_wise_capacity_order_status_controller.php",true);
...
<script>
	...
	$("#multiselect_dropdown_table_headercbo_company_id").click(function(){
		...
		load_drop_down( 'requires/working_company_wise_capacity_order_status_controller',wcCompany, 'load_drop_down_location', 'wc_location_td' );
		set_multiselect('cbo_location_id','0','0','','0');
	});
	
	$("#multiselect_dropdown_table_headercbo_lc_company_id").click(function(){
		var lcCompany=$("#cbo_lc_company_id").val();
		load_drop_down( 'requires/working_company_wise_capacity_order_status_controller', lcCompany, 'lc_load_drop_down_location', 'lc_location_td' );
		set_multiselect('cbo_lc_location_id','0','0','','0');
	});
