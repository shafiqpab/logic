...
<script>
	...
	var tableFilters = 
	{
		col_operation: 
		{
			id: ["total_order_qnty_pcs","value_total_order_value","value_total_commission","value_total_net_order_value","value_smv_tot","value_smv_tot_iron","value_yarn_req_tot","total_ex_factory_qnty","value_total_ex_factory_value","total_short_access_qnty","total_over_access_qnty","value_total_short_access_value","value_total_over_access_value"],
			//col: [19,21,22,23,26,27,28,29,30,31,32,33,34],
			//col: [20,22,23,24,27,28,29,30,31,32,33,34,35],
			col: [21,23,24,25,28,29,30,31,32,33,34,35,36],
	...
	function generate_report(div,type)
	{
		...
		var data=cbo_company_name+"_"+cbo_buyer_name+"_"+txt_date_from+"_"+txt_date_to+"_"+cbo_team_name+"_"+cbo_team_member+"_"+cbo_category_by+"_"+zero_value+"_"+cbo_capacity_source+"_"+cbo_year+"_"+txt_style_ref+"_"+cbo_factory_merchant+"_"+cbo_agent_name+"_"+cbo_location_name;
		freeze_window(3);
...
function openmypage_file(action,job_no,type)
	...
	function fn_on_change()
	{
		...
		load_drop_down( 'requires/group_capacity_and_order_booking_status_controller', cbo_company_name, 'load_drop_down_buyer', 'buyer_td' );
		load_drop_down( 'requires/group_capacity_and_order_booking_status_controller', cbo_company_name, 'load_drop_down_agent', 'agent_td' ); 
		load_drop_down( 'requires/group_capacity_and_order_booking_status_controller', cbo_company_name, 'load_drop_down_location', 'location_td' );
		set_defult_date(cbo_company_name);
	}
                    ...
                    <div  style="width:100%" align="center">
                            <table class="rpt_table" width="1140" cellpadding="0" cellspacing="0" border="1" rules="all">
                                ...
                                <tr class="general">
                                    <td>
                                           <?
                                           echo create_drop_down( "cbo_company_name", 130, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 0, "-- Select Company --", $selected, " load_drop_down( 'requires/group_capacity_and_order_booking_status_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );load_drop_down( 'requires/group_capacity_and_order_booking_status_controller', this.value, 'load_drop_down_agent', 'agent_td' ); load_drop_down( 'requires/group_capacity_and_order_booking_status_controller', this.value, 'load_drop_down_location', 'location_td' );set_defult_date(this.value)" );
                                            ?> 
                                    </td>
                                    <td id="location_td">
                                     <? echo create_drop_down( "cbo_location_name", 110, $blank_array,"", 1, "-- Select --", $selected, "" ); ?>
                                    </td>
                                    <td id="buyer_td">
                                     <? 
                                        echo create_drop_down( "cbo_buyer_name", 100, $blank_array,"", 1, "-- Select Buyer --", $selected, "" );
                                     ?>	
                                    </td>
                                    <td id="agent_td">
                                     <? 
                                        echo create_drop_down( "cbo_agent_name", 100, $blank_array,"", 1, "-- Select agent --", $selected, "" );
                                     ?>	
                                    </td>
                                    <td align="center">
									...
									<? 
                                        echo create_drop_down( "cbo_factory_merchant", 130, $blank_array,"", 1, "-- Select --", $selected, "" );
                                    ?>	
                                    </td>
                                    <td><input name="txt_date_from" id="txt_date_from"  class="datepicker" style="width:55px">
                                    </td>
                                    <td><input name="txt_date_to" id="txt_date_to"  class="datepicker" style="width:55px">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                    <?
                                     echo create_drop_down( "cbo_capacity_source",120,$knitting_source,"", 1, "--All--", $selected, "","","1,3","","","","");
                                    ?>
                                    </td>
                                    <td><input type="button" name="search" id="search" value="Show" onClick="generate_report('report_container2','report_generate_gr')" style="width:50px" class="formbutton" />
