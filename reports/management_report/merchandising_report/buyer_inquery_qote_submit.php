...
<script>
	...
	function fn_report_generated(report_type)
	{
		...
		else
		{
			...
			var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*cbo_season_id*cbo_search_by*txt_inqu_no*txt_department*txt_date_from*txt_date_to*txt_inq_no*txt_style_ref*price_stage*cbo_customer_year*cbo_week',"../../../")+'&report_type='+report_type;
			freeze_window(3);
        ...
        <div id="content_search_panel">
            <form id="frm_inquery_vs_quatation" name="frm_inquery_vs_quatation" action="" autocomplete="off" method="post">
                <fieldset style="width:1190px;">
                    <table width="1350" cellpadding="0" cellspacing="2" border="1" rules="all" class="rpt_table" >
                        <thead>
							...
							<th width="80">C. S. Year </th>
							<th width="80">C. S. Week</th>
                        ...
                        <tr class="general">
							...
							<td><? echo create_drop_down( "cbo_customer_year", 80, create_year_array(),"", 1,"-Year-", 1, "",0,"" ); ?></td>
							<td> 
                                    <?
									$weekArr=array();
									$current_date=date("Y");
