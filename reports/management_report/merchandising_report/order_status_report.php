...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*cbo_year*txt_job_no*txt_file_no*txt_ref_no',"../../../")+'&report_title='+report_title;
		freeze_window(3);
            ...
            <fieldset style="width:720px;">
                <table class="rpt_table" width="720" cellpadding="0" cellspacing="0" align="center" rules="all">
                    ...
                    <tr class="general">                   
                        ...
                        <td>
                            <input type="text" name="txt_job_no" id="txt_job_no" class="text_boxes" readonly onDblClick="openmypage_job_info()" placeholder="Browse" style="width:140px;" />
                        </td>
                        <td>
