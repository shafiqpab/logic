...
<script>
	...
	function fn_report_generated(type)
	{
		...
		var data="action=report_generate&reporttype="+type+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_style_ref*txt_style_ref_id*txt_order*txt_order_id*txt_season*txt_season_id*txt_file_no*txt_quotation_id*txt_hidden_quot_id',"../../../")+'&comments_head='+comments_head+'&report_title='+report_title+'&sign='+sign;
		//alert(data);return;
		freeze_window(3);
		if(type==1 || type==2 || type==3 || type==4 || type==5 || type==6)
		{
			http.open("POST","requires/cost_breakup_report_woven_controller.php",true);
		}
	...
	function openmypage_quotation()
	{
		...
		var page_link='requires/cost_breakup_report_woven_controller.php?action=quotation_popup&companyID='+company+'&buyer_name='+buyer+'&txt_season_id='+txt_season_id+'&txt_season='+txt_season+'&cbo_year='+cbo_year;
	...
	function openmypage_style()
	{
		...
		var page_link='requires/cost_breakup_report_woven_controller.php?action=style_refarence_search&companyID='+company+'&buyer_name='+buyer+'&txt_style_ref_no='+txt_style_ref_no+'&txt_style_ref_id='+txt_style_ref_id+'&txt_style_ref='+txt_style_ref+'&cbo_year_id='+cbo_year;
	...
	function openmypage_order()
	{
		...
		var page_link='requires/cost_breakup_report_woven_controller.php?action=order_search&company='+company+'&buyer_name='+buyer+'&txt_order_id_no='+txt_order_id_no+'&txt_order_id='+txt_order_id+'&txt_order='+txt_order+'&txt_style_ref='+txt_style_ref+'&cbo_year='+cbo_year+'&style_ref_id='+style_ref_id;
		var title="Search Item Popup";
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=850px,height=370px,center=1,resize=0,scrolling=0','../../')
		emailwindow.onclose=function()
		{
	...
	function openmypage_file_order()
	{
		...
		var txt_order_id = $("#txt_order_id").val();
		var txt_order = $("#txt_order").val();
		var page_link='requires/cost_breakup_report_woven_controller.php?action=order_search_file&company='+company+'&buyer_name='+buyer+'&txt_order_id_no='+txt_order_id_no+'&txt_order_id='+txt_order_id+'&txt_order='+txt_order+'&txt_style_ref='+txt_style_ref+'&cbo_year='+cbo_year+'&style_ref_id='+style_ref_id;
	...
	function openmypage_season()
	{
		...
		var page_link='requires/cost_breakup_report_woven_controller.php?action=season_search_popup&companyID='+companyID+'&buyerID='+buyerID+'&job_no='+job_no;
                    ...
                    <tr class="general">
                        <td width="150">
							<?
                           		...
                           		echo create_drop_down( "cbo_company_name", 140, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/cost_breakup_report_woven_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                            ?>
                        </td>
                        ...
                        <td width="80">
                         ...
                         <td>
                            <input type="button" id="show_button_1" class="formbutton" value="Budget" onClick="fn_report_generated(1)" />
