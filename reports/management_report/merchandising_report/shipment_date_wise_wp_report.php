...
<script>
    ...
    function fn_report_generated(garmentBtn)
    {
       ...
       var budget_version=document.getElementById('cbo_budget_version').value;
        ...
        {
            var data = "action=report_generate" + get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_date_from*txt_date_to*txt_job_no*txt_style_ref*txt_order_no*txt_file_no*txt_ref_no*cbo_search_by*cbo_year*cbo_team_name*cbo_team_member*cbo_ls_sc*cbo_season_id*cbo_order_status*cbo_budget_version*cbo_group_by', "../../../") + "&garmentBtn=" + garmentBtn;
            //alert(data);
            freeze_window(3);
			if(budget_version==1)
			{
			...
			{
				 http.open("POST", "requires/shipment_date_wise_wp_report_controller2.php", true);
			}
    ...
    {
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', 'requires/shipment_date_wise_wp_report_controller2.php?action=' + action + '&job_number=' + job_number + '&type=' + type + '&country=' + country, 'Work Progress Report Details', 'width=' + width + ',height=400px,center=1,resize=0,scrolling=0', '../../');
    }
    ...
    {
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', 'requires/shipment_date_wise_wp_report_controller.php?action=' + action + '&job_number=' + job_number + '&country=' + country, 'Work Progress Report Details', 'width=' + width + ',height=370px,center=1,resize=0,scrolling=0', '../../');
    }
    ...
    function show_trims_rec(action, po_number, po_id, width)
    {
		...
		{
			 emailwindow = dhtmlmodal.open('EmailBox', 'iframe', 'requires/shipment_date_wise_wp_report_controller2.php?action=' + action + '&po_number=' + po_number + '&po_id=' + po_id, 'Trims Receive Details', 'width=' + width + ',height=400px,center=1,resize=0,scrolling=0', '../../');
		}
    }
    ...
    function openmypage_order(po_break_down_id, company_name, item_id, country_id, action)
    {
        ...
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', 'requires/shipment_date_wise_wp_report_controller.php?po_break_down_id=' + po_break_down_id + '&company_name=' + company_name + '&item_id=' + item_id + '&country_id=' + country_id + '&action=' + action, 'Order Quantity', 'width=750px,height=350px,center=1,resize=0,scrolling=0', '../../');
    }
...
<body onLoad="set_hotkey();">
    <form id="dateWiseProductionReport_1">
        <div style="width:100%;" align="center">    
            ...
            <h3 style="width:1741px; margin-top:20px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id, 'content_search_panel', '')"> -Search Panel</h3> 
            <div id="content_search_panel" >      
                <fieldset style="width:1741px;">
                    <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        ...
                        <tbody>
                            <tr class="general">
                                ...
                                <td align="center">
                                    <input name="txt_ref_no" id="txt_ref_no" class="text_boxes" style="width:70px" placeholder="Ref. No" >
                                </td>
								...
								<td width="" align="center">
									<?  
										$budget_version_arr = array(1=>'Pre Cost 1',2=>'Pre Cost 2',3=>'Pre Cost 3');
										//$dd="search_populate(this.value)";
										echo create_drop_down( "cbo_budget_version", 100, $budget_version_arr,"",0, "--Select--", 2,"",0 );
									?>
								</td>
                                <td width="" align="center">
									<?  
										$group_arr = array(1=>'Shipment Date',2=>'Job No');
										//$dd="search_populate(this.value)";
										echo create_drop_down( "cbo_group_by", 100, $group_arr,"",0, "--Select--", 1,"",0 );
									?>
								</td>
                                <td align="center">
