...
<script>
	...
	function generate_report(type)
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_from_year*cbo_to_year*exchange_rate',"../../../")+'&report_title='+report_title+'&type='+type;
	...
	function report_generate_by_year(year)
	{		
		var type = 2;
		var report_title="Monthly Revenue Report";
		var data="action=report_generate_by_year"+get_submitted_data_string('cbo_company_id*exchange_rate',"../../../")+'&report_title='+report_title+'&year='+year;
	...
	function report_generate_by_month(month_year)
	{	
		var company_name = $("#cbo_company_id").val();
		var exchange_rate = $("#exchange_rate").val();
		var report_title='Daily Revenue Report';
		var data="action=report_generate_by_month&report_title="+report_title+"&cbo_company_id="+company_name+"&month_year="+month_year;
