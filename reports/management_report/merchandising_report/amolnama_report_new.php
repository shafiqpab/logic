...
<script>
	...
	function generate_report(type)
	{
		...
		var data="action=report_generate_by_year"+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_client*cbo_order_status*cbo_from_year*cbo_to_year*cbo_order_status_value*cbo_row_status*cbo_buyer_name*cbo_buyer_season_name*txt_style_ref',"../../../")+'&report_title='+report_title+'&type='+type;
		
		freeze_window(3);
		http.open("POST","requires/amolnama_report_new_controller.php",true);
	...
	{	
		var company_name = $("#cbo_company_id").val();
		var report_title='Daily Revenue Report';
		var data="action=report_generate_by_buyer_month_year"+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_client*cbo_order_status*cbo_from_year*cbo_to_year*cbo_order_status_value*cbo_row_status*cbo_buyer_name*cbo_buyer_season_name*txt_style_ref',"../../../")+'&report_title='+report_title+'&month_year='+month_year+'&buyer='+buyer+'&client_id='+client_id;
	...
	function report_generate_by_intref_wise(buyer_id,season_id)
	{	
		var company_name = $("#cbo_company_id").val();
		var report_title='Daily Revenue Report';
		var data="action=report_generate_by_intref_wise"+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_client*cbo_order_status*cbo_from_year*cbo_to_year*cbo_order_status_value*cbo_row_status*cbo_buyer_name*cbo_buyer_season_name*txt_style_ref',"../../../")+'&report_title='+report_title+'&buyer_id='+buyer_id+'&season_id='+season_id;
	...
	function garments_popup(po_id,action)
	{
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/amolnama_report_new_controller.php?action='+action+'&po_id='+po_id, 'Batch Popup', 'width=1050px,height=450px,center=1,resize=1,scrolling=0','../../')
		emailwindow.onclose=function()
		{
		}
	}
	            ...
	            <table class="rpt_table" width="1200" cellpadding="0" cellspacing="0" border="1" rules="all">
	                <thead>
	                	<tr>
		                	...
		                	<th width="100" rowspan="2" class="must_entry_caption">Location Name</th>
							<th width="100" rowspan="2" class="must_entry_caption">Shipment Status</th>
		                	...
		                	<th width="100" rowspan="2" class="must_entry_caption">Client/BSU</th>
	                ...
	                <tr class="general">
	                    <td>
							<?
	                        	echo create_drop_down( "cbo_company_id", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/amolnama_report_new_controller',this.value,'load_drop_down_location', 'location_td' );load_drop_down( 'requires/amolnama_report_new_controller',this.value,'load_drop_down_buyer_client', 'client_td' );load_drop_down( 'requires/amolnama_report_new_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
	                        ?>                                     
	                    </td>
						...
						<td id=""  align="center">
                            ...
                            echo create_drop_down("cbo_order_status", 100, $order_Status, "", 0, "--Select Order Status--", 2, "", "", "");
                            ?>
                        </td>

                        <td   align="center">
						    <?
								echo create_drop_down("cbo_order_status_value", 100, $order_status, "", 0, "--Select Order Status--", 1, "", "", "");
                            ?>
                        </td>
                        <td   align="center"> 
						    <?
								echo create_drop_down("cbo_row_status", 100, $row_status, "", 0, "--Select Status--", 1, "", "", "");
                            ?>
                        </td>
                        <td id="buyer_td"  align="center">
						    <?
							    echo create_drop_down("cbo_buyer_name", 100, $blank_array, "", 1, "-- Select Buyer Name --", $selected, "", "", "");
                            ?>
                        </td>
                        <td id="buyer_season_td"  align="center">
						    <?
							 echo create_drop_down("cbo_buyer_season_name", 100, $blank_array, "", 1, "-- Select Buyer Season Name --", $selected, "", "", "");
                            ?> 
                        </td>
                
                        <td id="client_td">
                            <?
                            echo create_drop_down("cbo_client", 100, $blank_array, "", 1, "-- All -- ", $selected, "");
                            ?>  
                        </td>

						<td>
							<input type="text" name="txt_style_ref" id="txt_style_ref" class="text_boxes" style="width:100px" placeholder="Write" />
					    </td>
	                    <td>
	                       <select name="cbo_from_year" class="combo_boxes" id="cbo_from_year" style="width: 70px">
	                    ...
	                    <td>
	                       <select name="cbo_to_year" class="combo_boxes" id="cbo_to_year" style="width: 70px">
