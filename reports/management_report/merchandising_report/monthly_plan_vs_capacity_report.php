...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Month Capacity VS Plan", "../../../", "", $popup, 1);
?>	
<script>
	...
	function fn_report_generated()
	{
		...
		{	
			...
			freeze_window(3);
			http.open("POST","requires/monthly_plan_vs_capacity_report_controller.php",true);
                ...
                <div style="width:750px">
                    <fieldset>  
                        <table cellpadding="0" cellspacing="0" width="750" class="rpt_table" border="1" rules="all">
                            ...
                            <tr class="general">
                                <td><? echo create_drop_down( "cbo_company_name", 150, "select id, company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "--Select Company--", $selected,"load_drop_down( 'requires/monthly_plan_vs_capacity_report_controller', this.value, 'load_drop_down_location', 'location_id_td' )" ); ?></td>
