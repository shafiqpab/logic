...
<script>
	...
	function fn_report_generated()
	{
		...
		else
		{
			...
			//alert(data);
			freeze_window();
			http.open("POST","requires/daily_order_entry_report_controller.php",true);
            ...
            <fieldset style="width:1100px;">
                <table class="rpt_table" width="1100px" cellpadding="1" cellspacing="0" rules="all" border="1">
                    ...
                    <tr class="general">
                        <td>
							<?
                           	 echo create_drop_down( "cbo_company_name", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/daily_order_entry_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                            ?>
                        </td>
                        <td id="buyer_td">
							<?
