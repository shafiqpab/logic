...
function show_report_data ( lnk )
{
	...
	/*function shipment_pending_report_reponse()
	{	
		if(http.readyState == 4) 
		{
			var reponse=trim(http.responseText).split("####");
			$("#shipment_pending_report_container").html(reponse[0]);  
			//document.getElementById('report_container').innerHTML='<a href="requires/'+reponse[1]+'" style="text-decoration:none"><input type="button" value="Excel Preview" name="excel" id="excel" class="formbutton" style="width:100px"/></a>&nbsp;&nbsp;<input type="button" onclick="new_window()" value="Print Preview" name="Print" class="formbutton" style="width:100px"/>';
			//setFilterGrid("table_body",-1,tableFilters);
			//show_msg('3');
			//release_freezing();
			shipment_pending_new_window();
		}
	}*/
	
	/*function shipment_pending_new_window()
	{
		...
		var d = w.document.open();
		d.write ('<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01//EN""http://www.w3.org/TR/html4/strict.dtd">'+
		'<html><head><title></title><link rel="stylesheet" href="../../../css/style_common.css" type="text/css" media="print" /></head><body>'+document.getElementById('quotation_finalization_pending_report').innerHTML+'</body</html>');
		d.close(); 
...
<?
	...
	//$no_of_company=1;
	$no_of_company='';
	if($_SESSION['logic_erp']["data_str"]=="")
	{
		if($db_type==0) 
		{
...
//*********************************************************************		
		...
		$_SESSION['logic_erp']["data_str"]=$data;
	...
	{
		$data=$_SESSION['logic_erp']["data_str"];
            ...
            <td colspan="2">
                <table width="100%">
                    <tr>
                        <td width="100"></td>
                        <td  align="right" valign="top">Copyright</td>
                        <td align="right" valign="top" width="300"> <img src="images/logic/logic_bottom_logo.png" height="65" width="300" /> 
                        </td>
                    </tr>
                </table>
            </td>
