...
echo load_html_head_contents("Wash Delivery Return","../../", 1, 1, $unicode,'','');
?>
<script>
	...
	function fnc_wash_delivery_return( operation )
	{
			...
			if(within_group==1)
			{
				if ( form_validation('cbo_company_name*cbo_party_name*txt_delivery_return_date*txtJob_no', 'Company Name*Party*Delivery Date*Job No')==false )
				{
					return;
				}
			}
	...
	function fnc_production_qty_ability(value,i)
	{
		...
		var amount = (PrvCurrDelv-CurrReturnDelv);
                ...
                <table style="width:1000px;" cellpadding="0" cellspacing="2" border="1" class="rpt_table" rules="all">
                    ...
                    <tbody id="dtls_tbody">
                        ...
                        <input name="txtbuyerPoId_1" id="txtbuyerPoId_1" type="hidden" class="text_boxes" style="width:70px" value="" /></td>
                    		...
                    		<td align="right"><input type="text" name="txtTotCurrReturnDelv_1" id="txtTotCurrReturnDelv_1" class="text_boxes_numeric" style="width:70px;" onKeyUp="fnc_production_qty_ability(this.value,1); fnc_total_calculate();" /></td>
                    		<td align="right">
                    ...
                    <tfoot>
                    	<tr class="tbl_bottom" name="tr_btm" id="tr_btm">
                    		...
                    		<td align="right"><input type="text" name="TotCurrReturnDelvBalance" id="TotCurrReturnDelvBalance" class="text_boxes_numeric" style="width:70px;" placeholder="Display" readonly /></td>
                    	</tr>
                    </tfoot>                   
                </table>            
                <table width="1000" cellspacing="2" cellpadding="0" border="0">
                    <tr>
                        <td align="center" valign="middle" class="button_container">
                        	<? 
                         		echo load_submit_buttons( $permission, "fnc_wash_delivery_return", 0,0,"reset_form('washdeliveryreturn_1','delivery_list_view','','','')",1);
							?>	
							<!-- <input type="button" name="print" id="print" value="Print" onClick="fnc_wash_delivery_return(4)" style="width:100px;display:none;" class="formbuttonplasminus" /> -->
                           </td>
                    </tr>   
                </table>
            </fieldset>          
