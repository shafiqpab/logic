...
<script>
	...
	function fnc_batch_creation(operation)
	{
		...
		for (var i=1; i<=row_num; i++)
		{
			...
			data_all+=get_submitted_data_string('poId_'+i+'*cboItem_'+i+'*txtGmtsQty_'+i+'*txtBatchQnty_'+i+'*buyerPoId_'+i+'*updateIdDtls_'+i+'*txtbuyerPo_'+i,"../../",2);
		}
            ...
            <fieldset style="width:740px;">
                <table width="730" align="center" border="0">
                    ...
                    <tr>
                    	...
                    	<td>Remarks</td>
                        <td colspan="5"><input type="text" name="txt_remarks" id="txt_remarks" class="text_boxes" tabindex="15" style="width:94%;" /></td>
                    </tr>
                 </table>
            </fieldset>                 
