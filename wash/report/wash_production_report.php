...
<script>
	...
	function fn_report_generated(operation)
	{
		...
		else
		{
			...
			if(operation==2)
			{
				var data="action=report_generate_dynamic"+get_submitted_data_string('cbo_company_id*cbo_party_name*txt_job_no*txt_date_from*txt_date_to*txt_date_to*cbo_within_group*cboProcess*cbo_year_selection',"../../")+'&report_title='+report_title;
			}
			else
			{
				var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_party_name*txt_job_no*txt_date_from*txt_date_to*txt_date_to*cbo_within_group*cboProcess*cbo_year_selection',"../../")+'&report_title='+report_title;
			}
