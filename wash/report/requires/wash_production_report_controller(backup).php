...
{ 
	...
	if($db_type==0)
	{
		if( $from_date==0 && $to_date==0 ) $bproduction_date=""; else $bproduction_date= " and b.production_date  between '".change_date_format($from_date,'yyyy-mm-dd')."' and '".change_date_format($to_date,'yyyy-mm-dd')."'";	
 	}
	if($db_type==2)
	{
		if( $from_date==0 && $to_date==0 ) $bproduction_date=""; else $bproduction_date= " and b.production_date  between '".change_date_format($from_date,'','',1)."' and '".change_date_format($to_date,'','',1)."'";	
    ...
    a.entry_form=316   and b.po_id=c.po_id and c.mst_id=d.id and  d.entry_form=301 and a.id=d.recipe_id and a.is_deleted=0 
	...
	if($select_from_date=="" && $select_to_date=="") 
	{
			...
			$job_sql="select a.job_no $recipe_id_cond ,c.body_part,c.id as po_id,b.color_size_id,d.id,d.within_group,d.job_no_prefix_num, d.subcon_job, d.party_id, c.order_no,c.buyer_po_no, c.buyer_style_ref,c.gmts_item_id ,c.party_buyer_name,c.gmts_color_id,
			...
			$party_con $bproduction_date
			group by a.job_no ,c.body_part ,c.id,b.color_size_id,d.id,d.within_group,d.job_no_prefix_num, d.subcon_job, d.party_id, c.order_no,c.buyer_po_no, c.buyer_style_ref,c.gmts_item_id,c.party_buyer_name,c.gmts_color_id";
					...
					foreach($job_sql_result as $row)
					{
						...
						?>
                          ...
                          <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                            ...
                            <td  width="80" id="wrd_brk"><? echo $receeive_qty; ?></td>
                            <td  width="80" id="wrd_brk"><?php echo $row[csf('Whisker_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Hand_Sand_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Tagging_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Tieing_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Grinding_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $first_wash_qty; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Destroy_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('pp_spray_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $final_wash_qty; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('ythreeD_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Wrinkle_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Laser_Whisker_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Laser_Brush_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Laser_Destroy_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Laser_Chemo_Print_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $first_dyeing_qty; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $row[csf('Laser_Others_qty')]; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $delevery_qty; ?></td>
                            <td width="80" id="wrd_brk"><?php echo $blance_qty; ?></td>
