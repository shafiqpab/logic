...
<script>
	...
	function fn_report_generated(type)
	{
		...
		if(type==1){
			var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_within_group*cbo_party_id*cbo_party_location_id*cbo_year*txt_job_no*txt_wo_order_no*cbo_buyer_id*txt_buyer_po*txt_buyer_po_id*txt_style_ref*txt_date_from*cbo_shiping_status',"../../")+'&report_title='+report_title;
		}
		else if(type==2){
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr >
                        ...
                        <td align="center">
                            <input type="button" id="show_button" class="formbutton" style="width:70px" value="Show" onClick="fn_report_generated(1)" /><input type="button" id="show_button" class="formbutton" style="width:70px" value="Show2" onClick="fn_report_generated(2)" />
