...
if($action=="load_php_dtls_form")
{
   ...
   b.buyer_buyer from subcon_ord_mst a, subcon_ord_dtls b where a.subcon_job=b.job_no_mst and a.entry_form=295 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0";
	...
	if($db_type==0) $process_type_cond="group_concat(c.process,'*',c.embellishment_type)";
		...
		{
			$sql_job="select a.id, a.within_group, a.subcon_job, a.job_no_prefix_num, a.order_id, a.order_no, a.delivery_date, b.id as po_id, b.buyer_po_id, b.buyer_po_no,b.buyer_style_ref,b.party_buyer_name, b.gmts_item_id, 3 as main_process_id, b.order_uom, b.gmts_color_id as color_id, b.gmts_size_id, b.order_quantity as qnty,e.delivery_qty ,$process_type_cond as process_type,e.id as delivery_details_id,e.remarks
		from subcon_ord_mst a, subcon_ord_dtls b, subcon_ord_breakdown c,subcon_delivery_mst d,subcon_delivery_dtls e
		...
		group by a.id, a.within_group, a.subcon_job, a.job_no_prefix_num, a.order_id, a.order_no, b.buyer_po_no,b.buyer_style_ref,b.party_buyer_name, a.delivery_date, b.id, b.buyer_po_id, b.gmts_item_id, b.order_uom, b.gmts_color_id, b.gmts_size_id, b.order_quantity,e.delivery_qty,e.id,e.remarks
		order by b.id ASC";
			}
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0) // Insert Here----------------------------------------------------------
	{
		...
		$field_array_dtls="id, mst_id, buyer_po_id, order_id,color_size_id, delivery_qty,entry_form,delivery_dtls_id,process_id,remarks,inserted_by, insert_date, status_active, is_deleted";
		...
		for($i=1; $i<= str_replace("'","",$total_row); $i++)
		{
			...
			$data_arr_dtls.="(".$id_dtls.",".$id.",".$$txtbuyerPoId.",".$$txtpoid.",".$$txtColorSizeid.",".$$txtTotCurrReturnDelv.",360,".$$txtdeliverydtlsid.",360,".$$txtremarks.",'".$user_id."','".$pc_date_time."',1,0)"; 
			$id_dtls=$id_dtls+1;
		}
  	...
  	else if ($operation==1) // Update Here End------------------------------------------------------
	{
		...
		$field_array_dtls="id, mst_id, buyer_po_id, order_id,color_size_id, delivery_qty,entry_form,delivery_dtls_id,remarks,inserted_by, insert_date, status_active, is_deleted";
		$field_arr_up="buyer_po_id*order_id*color_size_id*delivery_qty*remarks*updated_by*update_date";
		for($i=1; $i<= str_replace("'","",$total_row); $i++)
		{
			$txtbuyerPoId="txtbuyerPoId_".$i;
			$txtCurrDelv="txtCurrDelv_".$i;
			...
			{
				if($data_arr_dtls!="") $data_arr_dtls.=","; 	
				$data_arr_dtls.="(".$id_dtls.",".$id.",".$$txtbuyerPoId.",".$$txtpoid.",".$$txtColorSizeid.",".$$txtTotCurrReturnDelv.",360,".$$txtdeliverydtlsid.",".$$txtremarks.",'".$user_id."','".$pc_date_time."',1,0)"; 
				$id_dtls=$id_dtls+1;
			}
			else if(str_replace("'","",$$txtDtlsUpdateId)!="")
			{
				$data_arr_up[str_replace("'","",$$txtDtlsUpdateId)]=explode("*",("".$$txtbuyerPoId."*".$$txtpoid."*".$$txtColorSizeid."*".$$txtTotCurrReturnDelv."*".$$txtremarks."*".$user_id."*'".$pc_date_time."'"));
