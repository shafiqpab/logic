...
<script>
	...
	function open_returnpopup()
	{
		...
		{ 
			...
			show_list_view(company+"**"+data[1],'populate_issue_no_data_update','item_description_list','requires/wash_chemical_dyes_issue_return_controller','');
			var hidden_posted_account = $("#hidden_posted_account").val();
				
			show_list_view(data[1]+"**"+hidden_posted_account,'show_dtls_list_view','list_container_dyes','requires/wash_chemical_dyes_issue_return_controller','');
	...
	function fnc_chemical_issue_return_entry(operation)
	{
		...
		else if(operation==0 || operation==1 || operation==2)
		{
			...
			var dataString = "txt_return_no*cbo_company_id*cbo_location*cbo_floor_name*txt_return_date*txt_return_challan_no*txt_item_description*cbo_issue_basis*cbo_shift*txt_return_qnty*total_issue*txt_issue_name*txt_remarks*txt_reject_qnty*cbo_uom*cbo_store_name*cbo_floor*cbo_room*txt_rack*txt_shelf*cbo_item_category*update_id*txt_prod_id*before_prod_id*txt_issue_id*txt_rate*txt_amount_qnty*hidden_trans_id*txt_lot*variable_lot";
	...
	{	
		...
		{	
			...
			else if(reponse[0]==0 || reponse[0]==1)
			{
				...
				set_button_status(0, permission, 'fnc_chemical_issue_return_entry',1,1);
				reset_form('','','txt_item_description*cbo_uom*txt_return_qnty*txt_reject_qnty*cbo_item_category*txt_issue_qty*txt_issue_challan*txt_rate*txt_amount_qnty*txt_net_used*txt_return_total*txt_lot*cbo_store_name*txt_remarks','','','');
				release_freezing();
			}
	...
	{
		$("#txt_issue_name").attr("disabled",false);
		$('#txt_issue_name').attr('placeholder','Browse');	
	...
	function openmypage_issueNo()
	{
		...
		{ 	
			var title = 'Issue No Selection Form';	
			var page_link = 'requires/wash_chemical_dyes_issue_return_controller.php?cbo_company_id='+cbo_company_id+'&action=batch_popup';
			...
			emailwindow.onclose=function()
			 {
				...
				var location_id=this.contentDoc.getElementById("hidden_location_id").value;
				var store_id=this.contentDoc.getElementById("hidden_store_id").value;
				
				//alert(location_id);
		        show_list_view(cbo_company_id+"**"+issue_id,'populate_issue_no_data','item_description_list','requires/wash_chemical_dyes_issue_return_controller','');
				freeze_window(5);
				
				load_drop_down( 'requires/wash_chemical_dyes_issue_return_controller', location_id+'_'+document.getElementById('cbo_company_id').value, 'load_drop_down_floor', 'floor_id_td');
				//location_select();
				//load_drop_down( 'requires/wash_material_issue_return_controller',document.getElementById('cbo_company_name').value, 'load_drop_down_location', 'location_td' );
   			
			    document.getElementById('txt_issue_name').value=issue_no;
				document.getElementById('txt_issue_id').value=issue_id;
				document.getElementById('cbo_location').value=location_id;
				document.getElementById('cbo_store_name').value=store_id;
				release_freezing();
	...
	function location_select()
	{
		if($('#cbo_location option').length==2)
		{
			if($('#cbo_location option:first').val()==0)
			{
				...
				load_drop_down('requires/wash_chemical_dyes_issue_return_controller',$('#cbo_location').val()+"_"+$('#cbo_company_id').val(), 'load_drop_down_floor', 'floor_id_td');
                ...
                <fieldset style="width:800px;">                                       
                    <table  width="100%" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                      ...
                      <tr>
							...
							<td width="160" id="floor_id_td"><? echo create_drop_down( "cbo_floor_name", 140, $blank_array,"", 1, "-- Select Floor --", $selected, "" ); ?></td>
                      ...
                      <tr>
                        ...
                        <td width="160">
							<? 
                               echo create_drop_down( "cbo_issue_basis", 140, $receive_basis_arr,"", 1, "- Select  Basis -", $selected, "fn_independent(this.value)","","17" );
                            ?>
                        </td>
                        <td align="right" >Issue No</td>
                        <td><input type="text" name="txt_issue_name" id="txt_issue_name" class="text_boxes" style="width:130px" onDblClick="openmypage_issueNo()" placeholder="No need" disabled/>
                            <input type="hidden" id="total_issue" name="total_issue" />
							<input type="hidden" name="txt_issue_id" id="txt_issue_id"/>
                      ...
                      <tr>
                       ...
                       $shift_arr = array(1 => "A", 2 => "B");
					    echo create_drop_down( "cbo_shift", 140, $shift_arr,"", 1, "-- Select--", "", "");
                        ?>
                        </td>
                      </tr>
                    </table>
                                  ...
                                  <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                    <tr>
                                       ...
                                       <td width="300" colspan="3">
                                            <input class="text_boxes" type="text" name="txt_item_description" id="txt_item_description" style="width:260px;" placeholder="Display"  readonly  />
                                     ...
                                     <tr>
                                        <td  align="right" width="100" id="lot_caption">Lot</td>
                                        <td >
                                  ...
                                  <table  width="100%" cellspacing="2" cellpadding="0" border="0">
                                    <tr>
                                       ...
                                       <td width="120" >
										...
										<td width="110" align="right" >Issue Challan No</td>
                                        <td width="120" >
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="text_boxes_numeric"   type="text" name="txt_amount_qnty" id="txt_amount_qnty" style="width:120px;" placeholder="Display"  readonly/>
                                        </td>
                                        <td  align="right">Net Used</td>
                                        <td>
                                       	  <input class="text_boxes_numeric" type="text" name="txt_net_used"  id="txt_net_used" style="width:100px;" placeholder="Display" readonly />
                                        </td>
                                    </tr>
