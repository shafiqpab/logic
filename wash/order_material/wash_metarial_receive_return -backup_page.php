...
var str_color = [<? echo substr(return_library_autocomplete( "select color_name from lib_color group by color_name", "color_name" ), 0, -1); ?>];
	...
	function fnc_material_receive_return( operation )
	{
		...
		{
			var data_str="";
			var data_str=get_submitted_data_string('txt_receive_return_no*cbo_company_name*cbo_location_name*cbo_party_name*txt_return_challan*txt_return_date*cbo_within_group*txt_receive_no*receive_id*txt_remarks*update_id*txtJob_no*txt_job_id*txt_order_id*txtBuyerName',"../../");
    ...
    <form name="WashmaterialreceiveReturn_1" id="WashmaterialreceiveReturn_1" autocomplete="off">  
    	...
    	<legend>Wash Material Issue Return</legend>
            <table  width="900" cellspacing="2" cellpadding="0" border="0">
                ...
                <tr>
                 <td align="right" class="must_entry_caption">Receive ID</td>
                  <td  align="left">
                    ...
                    <td colspan="3">
                    	<input class="text_boxes"  type="text" name="txt_remarks" id="txt_remarks"  placeholder="Write" style="width:455px;"/>
                    </td>
                </tr>
            </table>
      	</fieldset> 
                ...
                <thead class="form_table_header">
           			<tr>
                        ...
                        <th class="must_entry_caption" align="left">
                			<input type="text" name="txtJob_no" id="txtJob_no" value="" class="text_boxes"  style="width:120px"  readonly/>
