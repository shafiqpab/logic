...
<fieldset style="width:98%;">
    ...
    <marquee behavior="scroll" direction="up" height="450px" scrolldelay="1" scrollamount="1">
    <table border="1" class="rpt_table" rules="all" width="100%" cellpadding="0" cellspacing="0"  id="scroll_body">
    	<tbody>
                        ...
                        foreach($rack_val as $self_id=>$self_val)
                        {
                            foreach($self_val as $bin_id=>$val)
                            {
                                ...
                                <tr bgcolor="<? echo  $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
                                    ...
                                    <td width="25%"><p><? echo $val['product_name_details'];  ?></p></td>
...
//document.getElementById( 'scroll_body' ).scrollIntoView(); 
...
//alert($('#txt_test_field').val());
//alert($(document).height());
/*var tot_heighi=$(document).height();
$(document).ready(function () {
	for(var tot_jump=0; tot_jump <= tot_heighi; tot_jump+=10)
	{
