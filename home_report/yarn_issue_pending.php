...
{ 
   ...
   <div align="center"> <h3 style="top:1px;width:98%; text-align:center;" id="accordion_h1" class="accordion_h" align="center"> Yarn Issue Pending </h3></div>
	...
	<div align="center" style="height:160px;clear: both;">
		 <div id="summery_div_show" align="left" style="float:left; margin-left:200px; margin-top:20px;"></div>
		 <div style="width:32%; height:160px; float:right; position:relative; margin-right:120px; margin-top:5px; border:solid 1px; margin-bottom:20px;">
			...
			<canvas id="canvas" height="150%" width="500" style="position: absolute; left:0px;"></canvas>
