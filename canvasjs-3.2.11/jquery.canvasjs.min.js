/*
 CanvasJS jQuery Charting Plugin - https://logisoftbd.com/ 
 Copyright 2021 fenopix

  --------------------- License Information --------------------
 CanvasJS is a commercial product which requires purchase of license. Without a commercial license you can use it for evaluation purposes for upto 30 days. Please refer to the following link for further details.
     https://logicsoftbd/license/
...
/*
 CanvasJS HTML5 & JavaScript Charts - v3.2.11 GA - https://logicsoftbd.com/ 
 Copyright 2021 fenopix
...
*/
(function(){function oa(k,m){k.prototype=eb(m.prototype);k.prototype.constructor=k;k.base=m.prototype}function eb(k){function m(){}m.prototype=k;return new m}function Xa(k,m,u){"millisecond"===u?k.setMilliseconds(k.getMilliseconds()+1*m):"second"===u?k.setSeconds(k.getSeconds()+1*m):"minute"===u?k.setMinutes(k.getMinutes()+1*m):"hour"===u?k.setHours(k.getHours()+1*m):"day"===u?k.setDate(k.getDate()+1*m):"week"===u?k.setDate(k.getDate()+7*m):"month"===u?k.setMonth(k.getMonth()+1*m):"year"===u&&k.setFullYear(k.getFullYear()+
1*m);return k}function X(k,m){var u=!1;0>k&&(u=!0,k*=-1);k=""+k;for(m=m?m:1;k.length<m;)k="0"+k;return u?"-"+k:k}function Ga(k){if(!k)return k;k=k.replace(/^\s\s*/,"");for(var m=/\s/,u=k.length;m.test(k.charAt(--u)););return k.slice(0,u+1)}function Ba(k){k.roundRect=function(k,u,r,w,ra,D,y,F){y&&(this.fillStyle=y);F&&(this.strokeStyle=F);"undefined"===typeof ra&&(ra=5);this.lineWidth=D;this.beginPath();this.moveTo(k+ra,u);this.lineTo(k+r-ra,u);this.quadraticCurveTo(k+r,u,k+r,u+ra);this.lineTo(k+r,
u+w-ra);this.quadraticCurveTo(k+r,u+w,k+r-ra,u+w);this.lineTo(k+ra,u+w);this.quadraticCurveTo(k,u+w,k,u+w-ra);this.lineTo(k,u+ra);this.quadraticCurveTo(k,u,k+ra,u);this.closePath();y&&this.fill();F&&0<D&&this.stroke()}}function Ra(k,m){return k-m}function Q(k){var m=((k&16711680)>>16).toString(16),u=((k&65280)>>8).toString(16);k=((k&255)>>0).toString(16);m=2>m.length?"0"+m:m;u=2>u.length?"0"+u:u;k=2>k.length?"0"+k:k;return"#"+m+u+k}function fb(k,m){var u=this.length>>>0,r=Number(m)||0,r=0>r?Math.ceil(r):
Math.floor(r);for(0>r&&(r+=u);r<u;r++)if(r in this&&this[r]===k)return r;return-1}function r(k){return null===k||"undefined"===typeof k}function Ca(k){k.indexOf||(k.indexOf=fb);return k}function gb(k){if(T.fSDec)k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){T._fTWm&&T._fTWm(k)})}function Ya(k,m,u){u=u||"normal";var r=k+"_"+m+"_"+u,w=Za[r];if(isNaN(w)){try{k="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+
k+"; font-size:"+m+"px; font-weight:"+u+";";if(!wa){var ra=document.body;wa=document.createElement("span");wa.innerHTML="";var D=document.createTextNode("Mpgyi");wa.appendChild(D);ra.appendChild(wa)}wa.style.display="";wa.setAttribute("style",k);w=Math.round(wa.offsetHeight);wa.style.display="none"}catch(y){w=Math.ceil(1.1*m)}w=Math.max(w,m);Za[r]=w}return w}function N(k,m){var u=[];if(u={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,
2],dashDot:[4,2,1,2],longDash:[8,2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[k||"solid"])for(var r=0;r<u.length;r++)u[r]*=m;else u=[];return u}function J(k,m,u,w,Ha){w=w||[];Ha=r(Ha)?hb?{passive:!1,capture:!1}:!1:Ha;w.push([k,m,u,Ha]);return k.addEventListener?(k.addEventListener(m,u,Ha),u):k.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};u.call(k,m)},k.attachEvent("on"+
m,w),w):!1}function ib(k){if(k._menuButton)k.exportEnabled?Ma(k._menuButton):ua(k._menuButton);else if(k.exportEnabled&&w){var m=!1;k._menuButton=document.createElement("button");va(k,k._menuButton,"menu");k._toolBar.appendChild(k._menuButton);J(k._menuButton,"touchstart",function(k){m=!0},k.allDOMEventHandlers);J(k._menuButton,"click",function(){"none"!==k._dropdownMenu.style.display||k._dropDownCloseTime&&500>=(new Date).getTime()-k._dropDownCloseTime.getTime()||(k._dropdownMenu.style.display="block",
k._menuButton.blur(),k._dropdownMenu.focus())},k.allDOMEventHandlers,!0);J(k._menuButton,"mouseover",function(){m||(pa(k._menuButton,{backgroundColor:k.toolbar.backgroundColorOnHover,color:k.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&pa(k._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},k.allDOMEventHandlers,!0);J(k._menuButton,"mouseout",function(){m||(pa(k._menuButton,{backgroundColor:k.toolbar.backgroundColor,color:k.toolbar.fontColor}),0>=
navigator.userAgent.search("MSIE")&&pa(k._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},k.allDOMEventHandlers,!0)}if(!k._dropdownMenu&&k.exportEnabled&&w){m=!1;k._dropdownMenu=document.createElement("div");k._dropdownMenu.setAttribute("tabindex",-1);var u=-1!==k.theme.indexOf("dark")?"black":"#888888";k._dropdownMenu.style.cssText="position: absolute; z-index: 1; -webkit-user-select: none; -moz-user-select: none; -ms-user-select: none; user-select: none; cursor: pointer;right: 0px;top: 25px;min-width: 120px;outline: 0;font-size: 14px; font-family: Arial, Helvetica, sans-serif;padding: 5px 0px 5px 0px;text-align: left;line-height: 10px;background-color:"+
k.toolbar.backgroundColor+";box-shadow: 2px 2px 10px "+u;k._dropdownMenu.style.display="none";k._toolBar.appendChild(k._dropdownMenu);J(k._dropdownMenu,"blur",function(){ua(k._dropdownMenu);k._dropDownCloseTime=new Date},k.allDOMEventHandlers,!0);u=document.createElement("div");u.style.cssText="padding: 12px 8px 12px 8px";u.innerHTML=k._cultureInfo.printText;u.style.backgroundColor=k.toolbar.backgroundColor;u.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(u);J(u,"touchstart",function(k){m=
!0},k.allDOMEventHandlers);J(u,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);J(u,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0);J(u,"click",function(){k.print();ua(k._dropdownMenu)},k.allDOMEventHandlers,!0);u=document.createElement("div");u.style.cssText="padding: 12px 8px 12px 8px";u.innerHTML=
...
!0);J(u,"click",function(){k.exportChart({format:"jpeg",fileName:k.exportFileName});ua(k._dropdownMenu)},k.allDOMEventHandlers,!0);u=document.createElement("div");u.style.cssText="padding: 12px 8px 12px 8px";u.innerHTML=k._cultureInfo.savePNGText;u.style.backgroundColor=k.toolbar.backgroundColor;u.style.color=k.toolbar.fontColor;k._dropdownMenu.appendChild(u);J(u,"touchstart",function(k){m=!0},k.allDOMEventHandlers);J(u,"mouseover",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColorOnHover,
this.style.color=k.toolbar.fontColorOnHover)},k.allDOMEventHandlers,!0);J(u,"mouseout",function(){m||(this.style.backgroundColor=k.toolbar.backgroundColor,this.style.color=k.toolbar.fontColor)},k.allDOMEventHandlers,!0);J(u,"click",function(){k.exportChart({format:"png",fileName:k.exportFileName});ua(k._dropdownMenu)},k.allDOMEventHandlers,!0)}}function $a(k,m,u){k*=ga;m*=ga;k=u.getImageData(k,m,2,2).data;m=!0;for(u=0;4>u;u++)if(k[u]!==k[u+4]|k[u]!==k[u+8]|k[u]!==k[u+12]){m=!1;break}return m?k[0]<<
...
k.creditText=Y("B`ow`rKR/bnl")):(m=k.updateOption("creditText"),u=k.updateOption("creditHref"));if(k.creditHref&&k.creditText){k._creditLink||(k._creditLink=document.createElement("a"),k._creditLink.setAttribute("class","canvasjs-chart-credit"),k._creditLink.setAttribute("title","JavaScript Charts"),k._creditLink.setAttribute("style","outline:none;margin:0px;position:absolute;right:2px;top:"+(k.height-14)+"px;color:dimgrey;text-decoration:none;font-size:11px;font-family: Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"),
k._creditLink.setAttribute("tabIndex",-1),k._creditLink.setAttribute("target","_blank"));if(0===k.renderCount||m||u)k._creditLink.setAttribute("href","#"),k._creditLink.innerHTML=k.creditText;k._creditLink&&k.creditHref&&k.creditText?(k._creditLink.parentElement||k._canvasJSContainer.appendChild(k._creditLink),k._creditLink.style.top=k.height-14+"px"):k._creditLink.parentElement&&k._canvasJSContainer.removeChild(k._creditLink)}}}function ta(k,m){Ia&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var u=document.createElement("canvas");u.setAttribute("class","canvasjs-chart-canvas");Na(u,k,m);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(u);return u}function pa(k,m){for(var u in m)k.style[u]=m[u]}function va(k,m,u){m.getAttribute("state")||(m.style.backgroundColor=k.toolbar.backgroundColor,m.style.color=k.toolbar.fontColor,m.style.border="none",pa(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
u&&(m.setAttribute("state",u),m.setAttribute("type","button"),pa(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",k._cultureInfo[u+"Text"]),m.innerHTML="<img style='height:95%; pointer-events: none;' src='"+lb[u].image+"' alt='"+k._cultureInfo[u+"Text"]+"' />")}function Ma(){for(var k=null,m=0;m<arguments.length;m++)k=arguments[m],k.style&&(k.style.display="inline")}function ua(){for(var k=
null,m=0;m<arguments.length;m++)(k=arguments[m])&&k.style&&(k.style.display="none")}function Ta(k,m,u,r,w){if(null===k||"undefined"===typeof k)return"undefined"===typeof u?m:u;k=parseFloat(k.toString())*(0<=k.toString().indexOf("%")?m/100:1);"undefined"!==typeof r&&(k=Math.min(r,k),"undefined"!==typeof w&&(k=Math.max(w,k)));return!isNaN(k)&&k<=m&&0<=k?k:"undefined"===typeof u?m:u}function V(k,m,u,w,y){this._defaultsKey=k;this._themeOptionsKey=m;this._index=w;this.parent=y;this._eventListeners=[];
k={};this.theme&&r(this.parent)&&r(m)&&r(w)?k=r(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===w?k=this.parent.themeOptions[m]:0<this.parent.themeOptions[m].length&&(w=Math.min(this.parent.themeOptions[m].length-1,w),k=this.parent.themeOptions[m][w]));this.themeOptions=k;this.options=u?u:{_isPlaceholder:!0};this.setOptions(this.options,k)}function Da(k,m,u,r,w){"undefined"===
typeof w&&(w=0);this._padding=w;this._x1=k;this._y1=m;this._x2=u;this._y2=r;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ia(k,m){ia.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=k;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ua(k,m){Ua.base.constructor.call(this,"Toolbar","toolbar",m,null,k);this.chart=k;this.canvas=k.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function ya(k,m){ya.base.constructor.call(this,
"Title","title",m,null,k);this.chart=k;this.canvas=k.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(r(this.options.margin)&&k.options.subtitles)for(var u=k.options.subtitles,w=0;w<u.length;w++)if((r(u[w].horizontalAlign)&&"center"===this.horizontalAlign||u[w].horizontalAlign===this.horizontalAlign)&&(r(u[w].verticalAlign)&&"top"===this.verticalAlign||u[w].verticalAlign===this.verticalAlign)&&!u[w].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=0;break}"undefined"===typeof this.options.fontSize&&
(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Ja(k,m,u){Ja.base.constructor.call(this,"Subtitle","subtitles",m,u,k);this.chart=k;this.canvas=k.canvas;this.ctx=this.chart.ctx;this.optionsName="subtitles";this.isOptionsInArray=!0;"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Va(){this.pool=
[]}function Ka(k){var m;k&&La[k]&&(m=La[k]);Ka.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ia=!1,T={},w=!!document.createElement("canvas").getContext,qa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditHref:"",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",
...
includeZero:!1,tickLength:5,tickColor:"black",tickThickness:1,tickPlacement:"outside",lineColor:"black",lineThickness:1,lineDashType:"solid",gridColor:"#A0A0A0",gridThickness:0,gridDashType:"solid",interlacedColor:w?"transparent":null,valueFormatString:null,margin:2,publicProperties:{options:"readWrite",stripLines:"readWrite",scaleBreaks:"readWrite",crosshair:"readWrite",bounds:"readOnly",chart:"readOnly"}},StripLine:{value:null,startValue:null,endValue:null,color:"orange",opacity:null,thickness:2,
lineDashType:"solid",label:"",labelPlacement:"inside",labelAlign:"far",labelWrap:!0,labelMaxWidth:null,labelBackgroundColor:null,labelBorderColor:w?"transparent":null,labelBorderThickness:0,labelCornerRadius:0,labelFontFamily:"arial",labelFontColor:"orange",labelFontSize:12,labelFontWeight:"normal",labelFontStyle:"normal",labelFormatter:null,showOnTop:!1,publicProperties:{options:"readWrite",axis:"readOnly",bounds:"readOnly",chart:"readOnly"}},ScaleBreaks:{autoCalculate:!1,collapsibleThreshold:"25%",
...
theme2:bb,theme3:Wa},R={numberDuration:1,yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){T.fSDec=function(k){for(var m="",u=0;u<k.length;u++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(u));return m};T.obj={trVs:"B`ow`rKR!Ush`m",fntStr:"qy!B`mhcsh-!Mtbhe`!Fs`oed-!Mtbhe`!R`or!Tohbned-!@sh`m-!r`or,rdshg",
txtBl:"udyuC`rdmhod",fnt:"gnou",fSy:"ghmmRuxmd",fTx:"ghmmUdyu",grClr:"fsdx",cntx:"buy",tp:"unq",msTxt:"ld`rtsdUdyu"};delete qa[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")];T.pro={sCH:qa[T.fSDec("Bi`su")][T.fSDec("bsdehuIsdg")]};T.pos=["cm","cs","um"];T._fTWm=function(k){if("undefined"===typeof T.pro.sCH&&!db)try{var m=(new Date).getMonth()%3,u,r,w=k[T.fSDec(T.obj.cntx)];w[T.fSDec(T.obj.txtBl)]=T.fSDec(T.obj.tp);w[T.fSDec(T.obj.fnt)]=11+T.fSDec(T.obj.fntStr);w[T.fSDec(T.obj.fSy)]=T.fSDec(T.obj.grClr);
u="cm"===T.pos[m]||"um"===T.pos[m]?0:k.width-w[T.fSDec(T.obj.msTxt)](T.fSDec(T.obj.trVs)).width;r="um"===T.pos[m]?0:k.height-11;w[T.fSDec(T.obj.fTx)](T.fSDec(T.obj.trVs),u,r);"cs"===T.pos[m]&&(k[T.fSDec("^bsdehuMhoj")].style.right=T.fSDec("`tun"))}catch(y){}}})();var hb=function(){var k=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){k=!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(u){k=
!1}return k}(),Za={},wa=null,mb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},nb=function(k,m,u){m=Math.min(this.width,this.height);return Math.max("theme4"===this.theme?0:300<=m?12:11,Math.round(m*(k/400)))},Aa=function(){var k=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),
u="Sun Mon Tue Wed Thu Fri Sat".split(" "),r="January February March April May June July August September October November December".split(" "),w="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),y=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,D=/[^-+\dA-Z]/g;return function(F,N,M){var T=M?M.days:m,H=M?M.months:r,Q=M?M.shortDays:u,J=M?M.shortMonths:w;M="";var R=!1;F=F&&F.getTime?F:F?new Date(F):new Date;
if(isNaN(F))throw SyntaxError("invalid date");"UTC:"===N.slice(0,4)&&(N=N.slice(4),R=!0);M=R?"getUTC":"get";var V=F[M+"Date"](),L=F[M+"Day"](),W=F[M+"Month"](),a=F[M+"FullYear"](),d=F[M+"Hours"](),c=F[M+"Minutes"](),b=F[M+"Seconds"](),e=F[M+"Milliseconds"](),f=R?0:F.getTimezoneOffset();return M=N.replace(k,function(l){switch(l){case "D":return V;case "DD":return X(V,2);case "DDD":return Q[L];case "DDDD":return T[L];case "M":return W+1;case "MM":return X(W+1,2);case "MMM":return J[W];case "MMMM":return H[W];
...
d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return R?"UTC":(String(F).match(y)||[""]).pop().replace(D,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+X(Math.floor(Math.abs(f)/60),2)+X(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(k,m,u){if(null===k)return"";if(!isFinite(k))return k;k=Number(k);var r=0>k?!0:!1;r&&(k*=-1);var w=u?
...
R++):(T.push(m),"#"!==m&&"0"!==m||Q++)}J&&(m=Math.floor(k),F=-Math.floor(Math.log(k)/Math.LN10+1),V=0===k?0:0===m?-(H+F):String(m).length-H,D/=Math.pow(10,V));0>N&&(N=L);D=(k*D).toFixed(Q);m=D.split(".");D=(m[0]+"").split("");k=(m[1]+"").split("");D&&"0"===D[0]&&D.shift();for(J=F=L=Q=N=0;0<M.length;)if(m=M.pop(),"#"===m||"0"===m)if(N++,N===H){var W=D,D=[];if("0"===m)for(m=H-Q-(W?W.length:0);0<m;)W.unshift("0"),m--;for(;0<W.length;)u=W.pop()+u,J++,0===J%F&&(L===R&&0<W.length)&&(u=y+u)}else 0<D.length?
(u=D.pop()+u,Q++,J++):"0"===m&&(u="0"+u,Q++,J++),0===J%F&&(L===R&&0<D.length)&&(u=y+u);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(L++,F=J,J=0,0<D.length&&(u=y+u)):u=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+u:m+u:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),u+=m.replace(/[0]+/,function(a){return X(V,a.length)}));y="";for(M=!1;0<T.length;)m=T.shift(),"#"===m||"0"===m?0<k.length&&0!==Number(k.join(""))?
(y+=k.shift(),M=!0):"0"===m&&(y+="0",M=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?y+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?y+=m:(m=0>V?m.replace("+","").replace("-",""):m.replace("-",""),y+=m.replace(/[0]+/,function(a){return X(V,a.length)}));u+=(M?w:"")+y;return r?"-"+u:u},Pa=function(k){var m=0,u=0;k=k||window.event;k.offsetX||0===k.offsetX?(m=k.offsetX,u=k.offsetY):k.layerX||0==k.layerX?(m=k.layerX,u=
k.layerY):(m=k.pageX-k.target.offsetLeft,u=k.pageY-k.target.offsetTop);return{x:m,y:u}},ab=!0,Sa=window.devicePixelRatio||1,Oa=1,ga=ab?Sa/Oa:1,ca=function(k,m,u,r,w,y,D,F,N,M,T,Q,J){"undefined"===typeof J&&(J=1);D=D||0;F=F||"black";var H=15<r-m&&15<w-u?8:0.35*Math.min(r-m,w-u);k.beginPath();k.moveTo(m,u);k.save();k.fillStyle=y;k.globalAlpha=J;k.fillRect(m,u,r-m,w-u);k.globalAlpha=1;0<D&&(J=0===D%2?0:0.5,k.beginPath(),k.lineWidth=D,k.strokeStyle=F,k.moveTo(m,u),k.rect(m-J,u-J,r-m+2*J,w-u+2*J),k.stroke());
k.restore();!0===N&&(k.save(),k.beginPath(),k.moveTo(m,u),k.lineTo(m+H,u+H),k.lineTo(r-H,u+H),k.lineTo(r,u),k.closePath(),D=k.createLinearGradient((r+m)/2,u+H,(r+m)/2,u),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=D,k.fill(),k.restore());!0===M&&(k.save(),k.beginPath(),k.moveTo(m,w),k.lineTo(m+H,w-H),k.lineTo(r-H,w-H),k.lineTo(r,w),k.closePath(),D=k.createLinearGradient((r+m)/2,w-H,(r+m)/2,w),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, .4)"),k.fillStyle=
D,k.fill(),k.restore());!0===T&&(k.save(),k.beginPath(),k.moveTo(m,u),k.lineTo(m+H,u+H),k.lineTo(m+H,w-H),k.lineTo(m,w),k.closePath(),D=k.createLinearGradient(m+H,(w+u)/2,m,(w+u)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,k.fill(),k.restore());!0===Q&&(k.save(),k.beginPath(),k.moveTo(r,u),k.lineTo(r-H,u+H),k.lineTo(r-H,w-H),k.lineTo(r,w),D=k.createLinearGradient(r-H,(w+u)/2,r,(w+u)/2),D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=
D,D.addColorStop(0,y),D.addColorStop(1,"rgba(255, 255, 255, 0.1)"),k.fillStyle=D,k.fill(),k.closePath(),k.restore())},Y=function(k){for(var m="",r=0;r<k.length;r++)m+=String.fromCharCode(Math.ceil(k.length/57/5)^k.charCodeAt(r));return m},db=window&&window[Y("mnb`uhno")]&&window[Y("mnb`uhno")].href&&window[Y("mnb`uhno")].href.indexOf&&(-1!==window[Y("mnb`uhno")].href.indexOf(Y("b`ow`rkr/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gdonqhy/bnl"))||-1!==window[Y("mnb`uhno")].href.indexOf(Y("gheemd"))),
kb=db&&-1===window[Y("mnb`uhno")].href.indexOf(Y("gheemd")),lb={reset:{image:"data:image/png;base64,"},
...
V.prototype.setOptions=function(k,m){if(qa[this._defaultsKey]){var r=qa[this._defaultsKey],w;for(w in r)"publicProperties"!==w&&r.hasOwnProperty(w)&&(this[w]=k&&w in k?k[w]:m&&w in m?m[w]:r[w])}else Ia&&window.console&&console.log("defaults not set")};V.prototype.get=function(k){var m=qa[this._defaultsKey];if("options"===k)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(k)||m.publicProperties&&m.publicProperties.hasOwnProperty(k))return this[k];window.console&&
window.console.log('Property "'+k+"\" doesn't exist. Please check for typo.")};V.prototype.set=function(k,m,r){r="undefined"===typeof r?!0:r;var w=qa[this._defaultsKey];if("options"===k)this.createUserOptions(m);else if(w.hasOwnProperty(k)||w.publicProperties&&w.publicProperties.hasOwnProperty(k)&&"readWrite"===w.publicProperties[k])this.options._isPlaceholder&&this.createUserOptions(),this.options[k]=m;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(k)&&"readOnly"===w.publicProperties[k]?
window.console.log('Property "'+k+'" is read-only.'):window.console.log('Property "'+k+"\" doesn't exist. Please check for typo."));return}r&&(this.stockChart||this.chart||this).render()};V.prototype.addTo=function(k,m,r,w){w="undefined"===typeof w?!0:w;var y=qa[this._defaultsKey];y.hasOwnProperty(k)||y.publicProperties&&y.publicProperties.hasOwnProperty(k)&&"readWrite"===y.publicProperties[k]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[k]&&(this.options[k]=
[]),k=this.options[k],r="undefined"===typeof r||null===r?k.length:r,k.splice(r,0,m),w&&(this.stockChart||this.chart||this).render()):window.console&&(y.publicProperties&&y.publicProperties.hasOwnProperty(k)&&"readOnly"===y.publicProperties[k]?window.console.log('Property "'+k+'" is read-only.'):window.console.log('Property "'+k+"\" doesn't exist. Please check for typo."))};V.prototype.createUserOptions=function(k){if("undefined"!==typeof k||this.options._isPlaceholder)if(this.parent.options._isPlaceholder&&
...
this._eventListeners[k]||[],this._eventListeners[k].push({context:r||this,eventHandler:m}))};V.prototype.removeEventListener=function(k,m){if(k&&m&&this._eventListeners[k])for(var r=this._eventListeners[k],w=0;w<r.length;w++)if(r[w].eventHandler===m){r[w].splice(w,1);break}};V.prototype.removeAllEventListeners=function(){this._eventListeners=[]};V.prototype.dispatchEvent=function(k,m,r){if(k&&this._eventListeners[k]){m=m||{};for(var w=this._eventListeners[k],y=0;y<w.length;y++)w[y].eventHandler.call(w[y].context,
...
this._wrappedText.lines[r];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-F.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-F.width/2+this.leftPadding;this.ctx.fillText(F.text,w,y);y+=F.height}this.ctx.font=m;k&&this.ctx.restore()}};ia.prototype.setText=function(k){this.text=k;this._isDirty=!0;this._wrappedText=
null};ia.prototype.measureText=function(){this._lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ia.prototype._getLineWithWidth=function(k,m,r){k=String(k);if(!k)return{text:"",width:0};var w=r=0,y=k.length-1,F=Infinity;for(this.ctx.font=this._getFontString();w<=y;){var F=Math.floor((w+y)/2),D=k.substr(0,F+1);r=this.ctx.measureText(D).width;
if(r<m)w=F+1;else if(r>m)y=F-1;else break}r>m&&1<D.length&&(D=D.substr(0,D.length-1),r=this.ctx.measureText(D).width);m=!0;if(D.length===k.length||" "===k[D.length])m=!1;m&&(k=D.split(" "),1<k.length&&k.pop(),D=k.join(" "),r=this.ctx.measureText(D).width);return{text:D,width:r}};ia.prototype._wrapText=function(){var k=new String(Ga(String(this.text))),m=[],r=this.ctx.font,w=0,y=0;this.ctx.font=this._getFontString();if(0===this.frontSize)y=w=0;else for(;0<k.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),D=this._getLineWithWidth(k,this.maxWidth-(this.leftPadding+this.rightPadding),!1);D.height=this._lineHeight;m.push(D);var H=y,y=Math.max(y,D.width),w=w+D.height,k=Ga(k.slice(D.text.length,k.length));F&&w>F&&(D=m.pop(),w-=D.height,y=H)}this._wrappedText={lines:m,width:y,height:w};this.width=y+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=r};ia.prototype._getFontString=function(){var k;k=""+(this.fontStyle?this.fontStyle+" ":
"");k+=this.fontWeight?this.fontWeight+" ":"";k+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return k+=m};oa(Ua,V);oa(ya,V);ya.prototype.setLayout=function(){if(this.text){var k=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=k.layoutManager.getFreeSpace(),w=m.x1,y=m.y1,F=0,H=0,D=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,N,J;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-D*("center"===this.horizontalAlign?2:1)),H=0.5*m.height-this.margin-2,F=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),H=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),H=0.5*m.height-4));var M;r(this.padding)||"number"!==typeof this.padding?r(this.padding)||"object"!==
...
w;H.y=y;H.angle=F;H.horizontalAlign=N;this._textBlock=H;k.layoutManager.registerSpace(J,{width:this.width+("left"===J||"right"===J?this.margin+2:0),height:this.height+("top"===J||"bottom"===J?this.margin+2:0)});this.bounds={x1:w,y1:y,x2:w+this.width,y2:y+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};oa(Ja,V);Ja.prototype.setLayout=ya.prototype.setLayout;Ja.prototype.render=ya.prototype.render;Va.prototype.get=function(k,m){var w=
null;0<this.pool.length?(w=this.pool.pop(),Na(w,k,m)):w=ta(k,m);return w};Va.prototype.release=function(k){this.pool.push(k)};oa(Ka,V);var Qa={addTheme:function(k,m){cb[k]=m},addColorSet:function(k,m){za[k]=m},addCultureInfo:function(k,m){La[k]=m},formatNumber:function(k,m,w){w=w||"en";if(La[w])return ea(k,m||"#,##0.##",new Ka(w));throw"Unknown Culture Name";},formatDate:function(k,m,w){w=w||"en";if(La[w])return Aa(k,m||"DD MMM YYYY",new Ka(w));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
"undefined"!==typeof module.exports?module.exports=Qa:"function"===typeof define&&define.amd?define([],function(){return Qa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Qa);y=Qa.Chart=function(){function k(a,d){return a.x-d.x}function m(a,d,c){d=d||{};r(c)?(this.predefinedThemes=cb,this.optionsName=
...
this.toolTip=new X(this,this.options.toolTip),this.data=null,this.axisX=[],this.axisX2=[],this.axisY=[],this.axisY2=[],this.sessionVariables={axisX:[],axisX2:[],axisY:[],axisY2:[]})):window.console&&window.console.log('CanvasJS Error: Chart Container with id "'+this._containerId+'" was not found')}function u(a,d){for(var c=[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var f,l,t;t=e-1;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[l].x-a[t].x?0.01:a[l].x-a[t].x))*(d-1)/
...
this.options.data.length;c++)if(a++,!this.options.data[c].type||0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new H(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=r(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||"error"===this.options.data[b.linkedDataSeriesIndex].type)&&
...
for(var h=0;h<t.dataSeriesIndexes.length;h++)this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[h]]);this.animatedRender&&(t.targetCanvasCtx.miterLimit=e,A&&c.push(A))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&(e=ta(this.width,this.height).getContext("2d"),
...
p.dispatchEvent("dataAnimationIterationEnd",{chart:p})},function(){c=[];for(var a=0;a<p.plotInfo.plotTypes.length;a++)for(var e=p.plotInfo.plotTypes[a],d=0;d<e.plotUnits.length;d++)e.plotUnits[d].targetCanvas=null;b=null;p.disableToolTip=!1;p.dispatchEvent("dataAnimationEnd",{chart:p})});else{if(p._breaksCanvas)if(w)p.plotArea.ctx.drawImage(p._breaksCanvas,0,0,this.width,this.height);else for(h=0;h<p._axes.length;h++)p._axes[h].createMask();0<p._indexLabels.length&&p.renderIndexLabels();p.dispatchEvent("dataAnimationIterationEnd",
...
this.data[a.dataSeriesIndexes[p]],q=0,g=!1,v=!1,k;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var ka=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,s=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
...
b/n.dataPoints[q-1].x;1>x&&(x=1/x);c.minDiff>x&&1!==x&&(c.minDiff=x)}else x=b-n.dataPoints[q-1].x,0>x&&(x*=-1),c.minDiff>x&&0!==x&&(c.minDiff=x);null!==e&&null!==n.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(x=e/n.dataPoints[q-1].y,1>x&&(x=1/x),d.minDiff>x&&1!==x&&(d.minDiff=x)):(x=e-n.dataPoints[q-1].y,0>x&&(x*=-1),d.minDiff>x&&0!==x&&(d.minDiff=x)))}if(b<ka&&!g)null!==n.dataPoints[q].y&&(k=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>s&&!v)v=!0;else if(b>s&&v)continue;n.dataPoints[q].label&&
(a.axisX.labels[b]=n.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===n.dataPoints[q].y?c.viewPortMin===b&&k<b&&(c.viewPortMin=k):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,A=Math.min(e,A)):t[b]?t[b]+=e:(t[b]=e,h=Math.max(e,h)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?
(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,t)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=t));n.axisX.valueType=n.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,A)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=Math.min(a,A)),a>d.viewPortMax&&(d.viewPortMax=a)));for(q in t)t.hasOwnProperty(q)&&!isNaN(q)&&
(a=t[q],a<d.min&&(d.min=a),a>d.max&&(d.max=Math.max(a,h)),q<c.viewPortMin||q>c.viewPortMax||(a<d.viewPortMin&&(d.viewPortMin=a),a>d.viewPortMax&&(d.viewPortMax=Math.max(a,h))))}};m.prototype._processStacked100PlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=!1,t=!1,A=[],h=0;h<a.dataSeriesIndexes.length;h++){var p=this.data[a.dataSeriesIndexes[h]],n=0,q=!1,g=!1,v;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var k=
...
Infinity;if(p.dataPoints[n].x&&p.dataPoints[n].x.getTime||"dateTime"===p.xValueType)f=!0;for(n=0;n<p.dataPoints.length;n++){"undefined"===typeof p.dataPoints[n].x&&(p.dataPoints[n].x=n+(a.axisX.logarithmic?1:0));p.dataPoints[n].x.getTime?(f=!0,b=p.dataPoints[n].x.getTime()):b=p.dataPoints[n].x;e=r(p.dataPoints[n].y)?null:p.dataPoints[n].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<n){if(a.axisX.logarithmic){var s=b/p.dataPoints[n-1].x;1>s&&(s=1/s);c.minDiff>s&&1!==s&&(c.minDiff=s)}else s=b-p.dataPoints[n-
1].x,0>s&&(s*=-1),c.minDiff>s&&0!==s&&(c.minDiff=s);r(e)||null===p.dataPoints[n-1].y||(a.axisY.logarithmic?0<e&&(s=e/p.dataPoints[n-1].y,1>s&&(s=1/s),d.minDiff>s&&1!==s&&(d.minDiff=s)):(s=e-p.dataPoints[n-1].y,0>s&&(s*=-1),d.minDiff>s&&0!==s&&(d.minDiff=s)))}if(b<k&&!q)null!==e&&(v=b);else{if(!q&&(q=!0,0<n)){n-=2;continue}if(b>ka&&!g)g=!0;else if(b>ka&&g)continue;p.dataPoints[n].label&&(a.axisX.labels[b]=p.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);
null===e?c.viewPortMin===b&&v<b&&(c.viewPortMin=v):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(t=!0),A[b]=A[b]?A[b]+Math.abs(e):Math.abs(e))}}p.axisX.valueType=p.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=r(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=r(d.viewPortMin)?1:Math.min(d.viewPortMin,1)):l&&!t?(d.max=r(d.viewPortMax)?
...
c=a.axisX.dataInfo,b,e,f,l,t=!1,A=0;A<a.dataSeriesIndexes.length;A++){var h=this.data[a.dataSeriesIndexes[A]],p=0,n=!1,q=!1,g,v,k;if("normal"===h.axisPlacement||"xySwapped"===h.axisPlacement)var ka=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,s=a.axisX.sessionVariables.newViewportMaximum?
a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(h.dataPoints[p].x&&h.dataPoints[p].x.getTime||"dateTime"===h.xValueType)t=!0;for(p=0;p<h.dataPoints.length;p++){"undefined"===typeof h.dataPoints[p].x&&(h.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));h.dataPoints[p].x.getTime?(t=!0,b=h.dataPoints[p].x.getTime()):b=h.dataPoints[p].x;
if((e=h.dataPoints[p].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);v=!0;for(var x=0;x<e.length;x++)null===e.k&&(v=!1);v&&(n||(k=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<p&&(a.axisX.logarithmic?(v=b/h.dataPoints[p-1].x,1>v&&(v=1/v),c.minDiff>v&&1!==v&&(c.minDiff=v)):(v=b-h.dataPoints[p-1].x,0>v&&(v*=-1),c.minDiff>v&&0!==v&&(c.minDiff=v)),e&&(null!==e[0]&&h.dataPoints[p-1].y&&null!==h.dataPoints[p-1].y[0])&&(a.axisY.logarithmic?(v=e[0]/
h.dataPoints[p-1].y[0],1>v&&(v=1/v),d.minDiff>v&&1!==v&&(d.minDiff=v)):(v=e[0]-h.dataPoints[p-1].y[0],0>v&&(v*=-1),d.minDiff>v&&0!==v&&(d.minDiff=v))));if(!(b<ka)||n){if(!n&&(n=!0,0<p)){p-=2;g=k;continue}if(b>s&&!q)q=!0;else if(b>s&&q)continue;h.dataPoints[p].label&&(a.axisX.labels[b]=h.dataPoints[p].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(x=0;x<e.length;x++)if(null===e[x]&&g<b){c.viewPortMin=g;break}null===e?c.viewPortMin===b&&g<b&&
...
if(t.dataPoints[A].x&&t.dataPoints[A].x.getTime||"dateTime"===t.xValueType)f=!0;for(A=0;A<t.dataPoints.length;A++)"undefined"!==typeof t.dataPoints[A].isCumulativeSum&&!0===t.dataPoints[A].isCumulativeSum?(t.dataPointEOs[A].cumulativeSumYStartValue=0,t.dataPointEOs[A].cumulativeSum=0===A?0:t.dataPointEOs[A-1].cumulativeSum,t.dataPoints[A].y=0===A?0:t.dataPointEOs[A-1].cumulativeSum):"undefined"!==typeof t.dataPoints[A].isIntermediateSum&&!0===t.dataPoints[A].isIntermediateSum?(t.dataPointEOs[A].cumulativeSumYStartValue=
n,t.dataPointEOs[A].cumulativeSum=0===A?0:t.dataPointEOs[A-1].cumulativeSum,t.dataPoints[A].y=0===A?0:b,n=0===A?0:t.dataPointEOs[A-1].cumulativeSum,b=0):(e="number"!==typeof t.dataPoints[A].y?0:t.dataPoints[A].y,t.dataPointEOs[A].cumulativeSumYStartValue=0===A?0:t.dataPointEOs[A-1].cumulativeSum,t.dataPointEOs[A].cumulativeSum=0===A?e:t.dataPointEOs[A-1].cumulativeSum+e,b+=e);for(A=0;A<t.dataPoints.length;A++)if("undefined"===typeof t.dataPoints[A].x&&(t.dataPoints[A].x=A+(a.axisX.logarithmic?1:0)),
t.dataPoints[A].x.getTime?(f=!0,b=t.dataPoints[A].x.getTime()):b=t.dataPoints[A].x,e=t.dataPoints[A].y,b<c.min&&(c.min=b),b>c.max&&(c.max=b),t.dataPointEOs[A].cumulativeSum<d.min&&(d.min=t.dataPointEOs[A].cumulativeSum),t.dataPointEOs[A].cumulativeSum>d.max&&(d.max=t.dataPointEOs[A].cumulativeSum),0<A&&(a.axisX.logarithmic?(n=b/t.dataPoints[A-1].x,1>n&&(n=1/n),c.minDiff>n&&1!==n&&(c.minDiff=n)):(n=b-t.dataPoints[A-1].x,0>n&&(n*=-1),c.minDiff>n&&0!==n&&(c.minDiff=n)),null!==e&&null!==t.dataPoints[A-
1].y&&(a.axisY.logarithmic?(e=t.dataPointEOs[A].cumulativeSum/t.dataPointEOs[A-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=t.dataPointEOs[A].cumulativeSum-t.dataPointEOs[A-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||h){if(!h&&(h=!0,0<A)){A-=2;continue}if(b>g&&!p)p=!0;else if(b>g&&p)continue;t.dataPoints[A].label&&(a.axisX.labels[b]=t.dataPoints[A].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);0<A&&(t.dataPointEOs[A-
1].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[A-1].cumulativeSum),t.dataPointEOs[A-1].cumulativeSum>d.viewPortMax&&(d.viewPortMax=t.dataPointEOs[A-1].cumulativeSum));t.dataPointEOs[A].cumulativeSum<d.viewPortMin&&(d.viewPortMin=t.dataPointEOs[A].cumulativeSum);t.dataPointEOs[A].cumulativeSum>d.viewPortMax&&(d.viewPortMax=t.dataPointEOs[A].cumulativeSum)}t.axisX.valueType=t.xValueType=f?"dateTime":"number"}};m.prototype.calculateAutoBreaks=function(){function a(a,b,c,e){if(e)return c=
...
c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,h=f.min,l=f.max,p=d.min,q=d.max,f=f._dataRanges,d=d._dataRanges,n,t=0,A=0;A<a.dataSeriesIndexes.length;A++){var k=e.data[a.dataSeriesIndexes[A]];if(!(4>k.dataPoints.length))for(t=0;t<k.dataPoints.length;t++)if(b&&(n=(l+1-h)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=k.dataPoints[t].x.getTime?k.dataPoints[t].x.getTime():k.dataPoints[t].x,n=Math.floor((g-h)/n),g<f[n].min&&(f[n].min=g),g>f[n].max&&(f[n].max=g)),c){var m=
(q+1-p)*Math.max(parseFloat(a.axisY.scaleBreaks.collapsibleThreshold)||10,10)/100;if((g="waterfall"===a.type?k.dataPointEOs[t].cumulativeSum:k.dataPoints[t].y)&&g.length)for(var w=0;w<g.length;w++)n=Math.floor((g[w]-p)/m),g[w]<d[n].min&&(d[n].min=g[w]),g[w]>d[n].max&&(d[n].max=g[w]);else r(g)||(n=Math.floor((g-p)/m),g<d[n].min&&(d[n].min=g),g>d[n].max&&(d[n].max=g))}}}}function c(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)&&a.axisX.scaleBreaks&&a.axisX.scaleBreaks.autoCalculate&&1<=
a.axisX.scaleBreaks.maxNumberOfAutoBreaks)for(var b=a.axisX.dataInfo,c=b.min,d=b.max,f=b._dataRanges,g,h=0,l=0;l<a.dataSeriesIndexes.length;l++){var p=e.data[a.dataSeriesIndexes[l]];if(!(4>p.dataPoints.length))for(h=0;h<p.dataPoints.length;h++)g=(d+1-c)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,b=p.dataPoints[h].x.getTime?p.dataPoints[h].x.getTime():p.dataPoints[h].x,g=Math.floor((b-c)/g),b<f[g].min&&(f[g].min=b),b>f[g].max&&(f[g].max=b)}}for(var b,e=this,f=!1,l=0;l<
...
b=(this._axes[l].dataInfo.max+1-A)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var h=this._axes[l].dataInfo._dataRanges,p,n,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;p=h;for(t in q)if(q.hasOwnProperty(t)&&!isNaN(t)&&(n=q[t],!r(n))){var g=Math.floor((n-A)/b);n<p[g].min&&(p[g].min=n);n>p[g].max&&(p[g].max=n)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=
this._axes[l].dataInfo.dataPointYNegativeSums;p=h;for(t in q)q.hasOwnProperty(t)&&!isNaN(t)&&(n=-1*q[t],r(n)||(g=Math.floor((n-A)/b),n<p[g].min&&(p[g].min=n),n>p[g].max&&(p[g].max=n)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(t=0;t<h.length-1;t++)if(p=h[t].max,isFinite(p))for(;t<h.length-1;)if(A=h[t+1].min,isFinite(A)){n=A-p;n>b&&f.push({diff:n,start:p,end:A});break}else t++;if(this._axes[l].scaleBreaks.customBreaks)for(t=0;t<this._axes[l].scaleBreaks.customBreaks.length;t++)for(b=
...
(this.stockChart._rangeEventParameter.type="rangeChanged",this.stockChart.dispatchEvent("rangeChanged",this.stockChart._rangeEventParameter,this.stockChart)),l&&(this.zoomEnabled&&"none"===this._zoomButton.style.display)&&(Ma(this._zoomButton,this._resetButton),va(this,this._zoomButton,"pan"),va(this,this._resetButton,"reset")))}}this.isDrag=!1;if("none"!==this.plotInfo.axisPlacement){this.resetOverlayedCanvas();if(this.axisX&&0<this.axisX.length)for(l=0;l<this.axisX.length;l++)this.axisX[l].crosshair&&
...
n.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&n.scaleBreaks&&n.scaleBreaks._appliedBreaks.length)&&(n.logarithmic&&v<Math.pow(n.dataInfo.minDiff,3)||!n.logarithmic&&v<3*Math.abs(n.dataInfo.minDiff))||q<n.minimum||g>n.maximum))A.push(n),p.push({val1:q,val2:g}),t=!0;else if(!e){t=!1;break}}return{isValid:t,axesWithValidRange:A,axesRanges:p}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!w&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&
...
new Da(a.x1,a.y1,a.x2,a.y2,2)};m.prototype.renderIndexLabels=function(a){var d=a||this.plotArea.ctx,c=this.plotArea,b=0,e=0,f=0,l=0,t=b=l=e=f=0,A=0;for(a=0;a<this._indexLabels.length;a++){var h=this._indexLabels[a],p=h.chartType.toLowerCase(),n,q,t=la("indexLabelFontColor",h.dataPoint,h.dataSeries),A=la("indexLabelFontSize",h.dataPoint,h.dataSeries);n=la("indexLabelFontFamily",h.dataPoint,h.dataSeries);q=la("indexLabelFontStyle",h.dataPoint,h.dataSeries);var l=la("indexLabelFontWeight",h.dataPoint,
h.dataSeries),g=la("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),e=la("indexLabelMaxWidth",h.dataPoint,h.dataSeries),f=la("indexLabelWrap",h.dataPoint,h.dataSeries),v=la("indexLabelLineDashType",h.dataPoint,h.dataSeries),k=la("indexLabelLineColor",h.dataPoint,h.dataSeries),m=r(h.dataPoint.indexLabelLineThickness)?r(h.dataSeries.options.indexLabelLineThickness)?0:h.dataSeries.options.indexLabelLineThickness:h.dataPoint.indexLabelLineThickness,b=0<m?Math.min(10,("normal"===this.plotInfo.axisPlacement?
this.plotArea.height:this.plotArea.width)<<0):0,s={percent:null,total:null},x=null;if(0<=h.dataSeries.type.indexOf("stacked")||"pie"===h.dataSeries.type||"doughnut"===h.dataSeries.type)s=this.getPercentAndTotal(h.dataSeries,h.dataPoint);if(h.dataSeries.indexLabelFormatter||h.dataPoint.indexLabelFormatter)x={chart:this,dataSeries:h.dataSeries,dataPoint:h.dataPoint,index:h.indexKeyword,total:s.total,percent:s.percent};var E=h.dataPoint.indexLabelFormatter?h.dataPoint.indexLabelFormatter(x):h.dataPoint.indexLabel?
this.replaceKeywordsWithValue(h.dataPoint.indexLabel,h.dataPoint,h.dataSeries,null,h.indexKeyword):h.dataSeries.indexLabelFormatter?h.dataSeries.indexLabelFormatter(x):h.dataSeries.indexLabel?this.replaceKeywordsWithValue(h.dataSeries.indexLabel,h.dataPoint,h.dataSeries,null,h.indexKeyword):null;if(null!==E&&""!==E){var s=la("indexLabelPlacement",h.dataPoint,h.dataSeries),x=la("indexLabelOrientation",h.dataPoint,h.dataSeries),C=h.direction,z=h.dataSeries.axisX,B=h.dataSeries.axisY,u=!1,g=new ia(d,
{x:0,y:0,maxWidth:e?e:0.5*this.width,maxHeight:f?5*A:1.5*A,angle:"horizontal"===x?0:-90,text:E,padding:0,backgroundColor:g,horizontalAlign:"left",fontSize:A,fontFamily:n,fontWeight:l,fontColor:t,fontStyle:q,textBaseline:"middle"});g.measureText();h.dataSeries.indexLabelMaxWidth=g.maxWidth;if("stackedarea100"===p){if(h.point.x<c.x1||h.point.x>c.x2||h.point.y<c.y1-1||h.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(h.dataPoint.x<z.viewportMinimum||h.dataPoint.x>z.viewportMaximum||
...
e=l=2;"horizontal"===x?(t=g.width,A=g.height):(A=g.width,t=g.height);if("normal"===this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))s="auto",l=4;else if(0<=p.indexOf("stacked"))"auto"===s&&(s="inside");else if("bubble"===p||"scatter"===p)s="inside";n=h.point.x-("horizontal"===x?t/2:0);"inside"!==s?(e=c.y1,f=c.y2,0<C?(q=h.point.y-A/2-l-b,q<e&&(q="auto"===s?Math.max(h.point.y,e)+A/2+l+b:e+A/2+l+b,u=q+A>h.point.y)):(q=h.point.y+A/2+l+b,q>f-A-l-b&&(q="auto"===s?Math.min(h.point.y,
f)-A/2-l-b:f-A/2-l-b,u=q<h.point.y))):(e=Math.max(h.bounds.y1,c.y1),f=Math.min(h.bounds.y2,c.y2),b=0<=p.indexOf("range")||"error"===p?0<C?Math.max(h.bounds.y1,c.y1)+A/2+l:Math.min(h.bounds.y2,c.y2)-A/2-l:(Math.max(h.bounds.y1,c.y1)+Math.min(h.bounds.y2,c.y2))/2,0<C?(q=Math.max(h.point.y,b),q<e&&("bubble"===p||"scatter"===p)&&(q=Math.max(h.point.y-A-l,c.y1+l))):(q=Math.min(h.point.y,b),q>f-A-l&&("bubble"===p||"scatter"===p)&&(q=Math.min(h.point.y+l,c.y2-A-l))),q=Math.min(q,f))}else 0<=p.indexOf("line")||
0<=p.indexOf("area")||0<=p.indexOf("scatter")?(s="auto",e=4):0<=p.indexOf("stacked")?"auto"===s&&(s="inside"):"bubble"===p&&(s="inside"),q=h.point.y,"inside"!==s?(l=c.x1,f=c.x2,0>C?(n=h.point.x-("horizontal"===x?t:t/2)-e-b,n<l&&(n="auto"===s?Math.max(h.point.x,l)+e+b:l+e+b,u=n+t>h.point.x)):(n=h.point.x+("horizontal"===x?0:t/2)+e+b,n>f-t-e-b&&(n="auto"===s?Math.min(h.point.x,f)-("horizontal"===x?t:t/2)-e-b:f-t-e-b,u=n<h.point.x))):(l=Math.max(h.bounds.x1,c.x1),Math.min(h.bounds.x2,c.x2),b=0<=p.indexOf("range")||
"error"===p?0>C?Math.max(h.bounds.x1,c.x1)+t/2+e:Math.min(h.bounds.x2,c.x2)-t/2-e:(Math.max(h.bounds.x1,c.x1)+Math.min(h.bounds.x2,c.x2))/2,n=0>C?Math.max(h.point.x,b)-("horizontal"===x?t/2:0):Math.min(h.point.x,b)-t/2,n=Math.max(n,l));"vertical"===x&&(q+=A/2);g.x=n;g.y=q;g.render(!0);m&&("inside"!==s&&(0>p.indexOf("bar")&&("error"!==p||!h.axisSwapped)&&h.point.x>c.x1&&h.point.x<c.x2||!u)&&(0>p.indexOf("column")&&("error"!==p||h.axisSwapped)&&h.point.y>c.y1&&h.point.y<c.y2||!u))&&(d.lineWidth=m,d.strokeStyle=
k?k:"gray",d.setLineDash&&d.setLineDash(N(v,m)),d.beginPath(),d.moveTo(h.point.x,h.point.y),0<=p.indexOf("bar")||"error"===p&&h.axisSwapped?d.lineTo(n-(0<h.direction?0:-t)+("vertical"===x?-t/2:0),q+("vertical"===x?-A/2:0)):0<=p.indexOf("column")||"error"===p&&!h.axisSwapped?d.lineTo(n+("horizontal"===x?t/2:0),q+((0<h.direction?A:-A)+("vertical"===x?-A:0))/2):d.lineTo(n+("horizontal"===x?t/2:0),q+((q<h.point.y?A:-A)+("vertical"===x?-A:0))/2),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,
easingFunction:L.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)h=this._indexLabels[a],g=la("indexLabelBackgroundColor",h.dataPoint,h.dataSeries),h.dataSeries.indexLabelBackgroundColor=r(g)?w?"transparent":null:g;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx;c.save();var e=this.plotArea;c.beginPath();c.rect(e.x1,e.y1,
...
h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,s=0,x,r;c.beginPath();if(0<p.length){for(var C=!1,s=0;s<p.length;s++)if(x=p[s].x.getTime?p[s].x.getTime():p[s].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!C)))if("number"!==typeof p[s].y)0<s&&!(h.connectNullData||C||m)&&(c.stroke(),w&&b.stroke()),C=!0;else{x=a.axisX.convertValueToPixel(x);r=a.axisY.convertValueToPixel(p[s].y);var z=h.dataPointIds[s];this._eventManager.objectMap[z]={id:z,
objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:s,x1:x,y1:r};m||C?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||n===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),n=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,r),w&&b.lineTo(x,r)):(c.beginPath(),c.moveTo(x,r),w&&(b.beginPath(),b.moveTo(x,r))),C=m=!1):(c.lineTo(x,r),w&&b.lineTo(x,r),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(x,r),w&&(b.stroke(),b.beginPath(),
b.moveTo(x,r))));l={x:x,y:r};s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(N(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize){var B=h.getMarkerProperties(s,x,r,c);f.push(B);z=Q(z);w&&f.push({x:x,y:r,ctx:b,type:B.type,size:B.size,color:z,borderColor:z,borderThickness:B.borderThickness})}(p[s].indexLabel||
h.indexLabel||p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:p[s],dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();w&&b.stroke()}}W.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
4):0;var v=h._colorSet,k=v=h.lineColor=h.options.lineColor?h.options.lineColor:v[0];c.strokeStyle=v;var m=!0,s=0,x,r;c.beginPath();if(0<p.length){for(var C=!1,s=0;s<p.length;s++)if(x=p[s].getTime?p[s].x.getTime():p[s].x,!(x<a.axisX.dataInfo.viewPortMin||x>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!C)))if("number"!==typeof p[s].y)0<s&&!(h.connectNullData||C||m)&&(c.stroke(),w&&b.stroke()),C=!0;else{var z=r;x=a.axisX.convertValueToPixel(x);r=a.axisY.convertValueToPixel(p[s].y);var B=h.dataPointIds[s];
this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:s,x1:x,y1:r};m||C?(!m&&h.connectNullData?(c.setLineDash&&(h.options.nullDataLineDashType||n===h.lineDashType&&h.lineDashType!==h.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),n=h.nullDataLineDashType,c.setLineDash(q)),c.lineTo(x,z),c.lineTo(x,r),w&&(b.lineTo(x,z),b.lineTo(x,r))):(c.beginPath(),c.moveTo(x,r),w&&(b.beginPath(),b.moveTo(x,r))),C=m=!1):(c.lineTo(x,z),w&&b.lineTo(x,z),c.lineTo(x,
r),w&&b.lineTo(x,r),0==s%500&&(c.stroke(),c.beginPath(),c.moveTo(x,r),w&&(b.stroke(),b.beginPath(),b.moveTo(x,r))));l={x:x,y:r};s<p.length-1&&(k!==(p[s].lineColor||v)||n!==(p[s].lineDashType||h.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(x,r),k=p[s].lineColor||v,c.strokeStyle=k,c.setLineDash&&(p[s].lineDashType?(n=p[s].lineDashType,c.setLineDash(N(n,h.lineThickness))):(n=h.lineDashType,c.setLineDash(g))));if(0<p[s].markerSize||0<h.markerSize)z=h.getMarkerProperties(s,x,r,c),f.push(z),B=Q(B),
w&&f.push({x:x,y:r,ctx:b,type:z.type,size:z.size,color:B,borderColor:B,borderThickness:z.borderThickness});(p[s].indexLabel||h.indexLabel||p[s].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:p[s],dataSeries:h,point:{x:x,y:r},direction:0>p[s].y===a.axisY.reversed?1:-1,color:v})}c.stroke();w&&b.stroke()}}W.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=
...
if(0<p.length)for(x=!1,m=0;m<p.length;m++)if(s=p[m].getTime?p[m].x.getTime():p[m].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!x)))if("number"!==typeof p[m].y)0<m&&!x&&(h.connectNullData?b.setLineDash&&(0<r.length&&(h.options.nullDataLineDashType||!p[m-1].lineDashType))&&(r[r.length-1].newLineDashArray=q,n=h.nullDataLineDashType):(d(r),r=[])),x=!0;else{s=a.axisX.convertValueToPixel(s);x=a.axisY.convertValueToPixel(p[m].y);var C=h.dataPointIds[m];this._eventManager.objectMap[C]=
{id:C,objectType:"dataPoint",dataSeriesIndex:A,dataPointIndex:m,x1:s,y1:x};r[r.length]={x:s,y:x};m<p.length-1&&(k!==(p[m].lineColor||v)||n!==(p[m].lineDashType||h.lineDashType))&&(k=p[m].lineColor||v,r[r.length-1].newStrokeStyle=k,b.setLineDash&&(p[m].lineDashType?(n=p[m].lineDashType,r[r.length-1].newLineDashArray=N(n,h.lineThickness)):(n=h.lineDashType,r[r.length-1].newLineDashArray=g)));if(0<p[m].markerSize||0<h.markerSize){var z=h.getMarkerProperties(m,s,x,b);l.push(z);C=Q(C);w&&l.push({x:s,y:x,
ctx:e,type:z.type,size:z.size,color:C,borderColor:C,borderThickness:z.borderThickness})}(p[m].indexLabel||h.indexLabel||p[m].indexLabelFormatter||h.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:p[m],dataSeries:h,point:{x:s,y:x},direction:0>p[m].y===a.axisY.reversed?1:-1,color:v});x=!1}d(r)}W.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,
...
a.axisX.convertValueToPixel(A);t=a.axisY.convertValueToPixel(v[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:l-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var m=a.axisX.reversed?l-n<<0:l+n<<0,s;0<=v[f].y?s=h:(s=t,t=h);t>s&&(b=t,t=s,s=b);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];ca(c,l,t,m,s,b,0,null,k&&0<=v[f].y,0>v[f].y&&k,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:m,y2:s};b=Q(b);w&&ca(this._eventManager.ghostCtx,l,t,m,s,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||g.indexLabel||v[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:v[f],dataSeries:g,point:{x:l+(m-l)/2,y:0>v[f].y===a.axisY.reversed?t:s},direction:0>v[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(t,s),x2:m,y2:Math.max(t,s)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
p<h)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>p&&(g=p);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],s=m.dataPoints;if(0<s.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle=
"#4572A7 ";for(h=0;h<s.length;h++)if(b=s[h].x.getTime?s[h].x.getTime():s[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[h].y){p=a.axisX.convertValueToPixel(b);var r=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=r+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y)t[b]=s[h].y+(t[b]?t[b]:0),0<t[b]&&(n=a.axisY.convertValueToPixel(t[b]),z="undefined"!==typeof f[b]?f[b]:q,f[b]=n);else if(a.axisY.scaleBreaks&&
0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=s[h].y+(A[b]?A[b]:0),z=a.axisY.convertValueToPixel(A[b]),n="undefined"!==typeof l[b]?l[b]:q,l[b]=z;else if(n=a.axisY.convertValueToPixel(s[h].y),0<=s[h].y){var B="undefined"!==typeof f[b]?f[b]:0;n-=B;z=q-B;f[b]=B+(z-n)}else B=l[b]?l[b]:0,z=n+B,n=q+B,l[b]=B+(z-n);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ca(c,r,n,C,z,b,0,null,x&&0<=s[h].y,0>s[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]=
{id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:n,x2:C,y2:z};b=Q(b);w&&ca(this._eventManager.ghostCtx,r,n,C,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:s[h],dataSeries:m,point:{x:p,y:0<=s[h].y?n:z},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:r,y1:Math.min(n,z),x2:C,y2:Math.max(n,z)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,
this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,
animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=[],l=[],t=[],A=[],h=0,p,n,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),h=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?
this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>p&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,p));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&
p<h)&&(p=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>p&&(g=p);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],s=m.dataPoints;if(0<s.length)for(var x=5<g&&m.bevelEnabled?!0:!1,
h=0;h<s.length;h++)if(b=s[h].x.getTime?s[h].x.getTime():s[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[h].y){p=a.axisX.convertValueToPixel(b);n=0!==a.dataPointYSums[b]?100*(s[h].y/a.dataPointYSums[b]):0;var r=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=r+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y){t[b]=n+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;n=a.axisY.convertValueToPixel(t[b]);
z=f[b]?f[b]:q;f[b]=n}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=n+("undefined"!==typeof A[b]?A[b]:0),z=a.axisY.convertValueToPixel(A[b]),n=l[b]?l[b]:q,l[b]=z;else if(n=a.axisY.convertValueToPixel(n),0<=s[h].y){var B="undefined"!==typeof f[b]?f[b]:0;n-=B;z=q-B;a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.y1-n)&&(n=e.y1);f[b]=B+(z-n)}else B="undefined"!==typeof l[b]?l[b]:0,z=n+B,n=q+B,a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=
B+(z-n);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ca(c,r,n,C,z,b,0,null,x&&0<=s[h].y,0>s[h].y&&x,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:n,x2:C,y2:z};b=Q(b);w&&ca(this._eventManager.ghostCtx,r,n,C,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:s[h],dataSeries:m,
point:{x:p,y:0<=s[h].y?n:z},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:r,y1:Math.min(n,z),x2:C,y2:Math.max(n,z)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.yScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,A,h=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
n/2-(a.previousDataSeriesCount+p)*n<<0:t-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var m=a.axisX.reversed?t-n<<0:t+n<<0,s;0<=v[f].y?s=h:(s=l,l=h);b=v[f].color?v[f].color:g._colorSet[f%g._colorSet.length];ca(c,s,t,l,m,b,0,null,k,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:s,y1:t,x2:l,y2:m};b=Q(b);w&&ca(this._eventManager.ghostCtx,s,t,l,m,b,0,null,!1,!1,!1,!1);(v[f].indexLabel||
...
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:h<a.axisY.bounds.x1?a.axisY.bounds.x1:h>a.axisY.bounds.x2?a.axisY.bounds.x2:h}}};m.prototype.renderStackedBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,
...
typeof s[h].y){n=a.axisX.convertValueToPixel(b);var r=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,C=r+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y)t[b]=s[h].y+(t[b]?t[b]:0),0<t[b]&&(z=f[b]?f[b]:q,f[b]=p=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=s[h].y+(A[b]?A[b]:0),p=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(A[b]);else if(p=a.axisY.convertValueToPixel(s[h].y),
0<=s[h].y){var B=f[b]?f[b]:0;z=q+B;p+=B;f[b]=B+(p-z)}else B=l[b]?l[b]:0,z=p-B,p=q-B,l[b]=B+(p-z);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ca(c,z,r,p,C,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:z,y1:r,x2:p,y2:C};b=Q(b);w&&ca(this._eventManager.ghostCtx,z,r,p,C,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",
dataPoint:s[h],dataSeries:m,point:{x:0<=s[h].y?p:z,y:n},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,p),y1:r,x2:Math.max(z,p),y2:C},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
...
Math.log(a.axisX.range):Math.abs(g)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&h>n&&(h=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,n));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&n<h)&&(n=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,h));g<h&&(g=h);g>n&&(g=n);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var v=0;v<a.dataSeriesIndexes.length;v++){var k=a.dataSeriesIndexes[v],m=this.data[k],s=m.dataPoints;if(0<s.length){var x=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(h=0;h<s.length;h++)if(b=s[h].x.getTime?s[h].x.getTime():s[h].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof s[h].y){n=a.axisX.convertValueToPixel(b);var r;r=0!==a.dataPointYSums[b]?100*(s[h].y/a.dataPointYSums[b]):0;var C=
n-a.plotType.plotUnits.length*g/2+a.index*g<<0,z=C+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<s[h].y){t[b]=r+(t[b]?t[b]:0);if(0>=t[b])continue;r=f[b]?f[b]:q;f[b]=p=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=s[h].y)A[b]=r+(A[b]?A[b]:0),p=l[b]?l[b]:q,l[b]=r=a.axisY.convertValueToPixel(A[b]);else if(p=a.axisY.convertValueToPixel(r),0<=s[h].y){var B=f[b]?f[b]:0;r=q+B;p+=B;a.dataSeriesIndexes.length-
1===v&&1>=Math.abs(e.x2-p)&&(p=e.x2);f[b]=B+(p-r)}else B=l[b]?l[b]:0,r=p-B,p=q-B,a.dataSeriesIndexes.length-1===v&&1>=Math.abs(e.x1-r)&&(r=e.x1),l[b]=B+(p-r);b=s[h].color?s[h].color:m._colorSet[h%m._colorSet.length];ca(c,r,C,p,z,b,0,null,x,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[h];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:h,x1:r,y1:C,x2:p,y2:z};b=Q(b);w&&ca(this._eventManager.ghostCtx,r,C,p,z,b,0,null,!1,!1,!1,!1);(s[h].indexLabel||m.indexLabel||
s[h].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:s[h],dataSeries:m,point:{x:0<=s[h].y?p:r,y:n},direction:0>s[h].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(r,p),y1:C,x2:Math.max(r,p),y2:z},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.xScaleAnimation,easingFunction:L.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=function(a){var d,c;function b(){z&&(0<g.lineThickness&&
f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?C=E:0>a.axisY.viewportMaximum?C=t.y1:0<a.axisY.viewportMinimum&&(C=E),f.lineTo(m,C),f.lineTo(z.x,C),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,C),l.lineTo(z.x,C),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,s),l.beginPath(),l.moveTo(m,s),z={x:m,y:s})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,
t=a.axisY.lineCoordinates,A=[],h=this.plotArea,p;f.save();w&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();w&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=Q(A);l.fillStyle=A;A=[];d=!0;var k=0,m,s,r,E=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),
C,z=null;if(0<v.length){var B=g._colorSet[k%g._colorSet.length],u=g.lineColor=g.options.lineColor||B,y=u;f.fillStyle=B;f.strokeStyle=u;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var S=N(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var P=N(c,g.lineThickness);f.setLineDash(P)}for(var ja=!0;k<v.length;k++)if(r=v[k].x.getTime?v[k].x.getTime():v[k].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ja)))if("number"!==typeof v[k].y)g.connectNullData||
(ja||d)||b(),ja=!0;else{m=a.axisX.convertValueToPixel(r);s=a.axisY.convertValueToPixel(v[k].y);d||ja?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=s,m=p.x,s=p.y,b(),f.moveTo(p.x,p.y),m=d,s=c,z=p,c=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(m,s),w&&l.lineTo(m,s)):(f.beginPath(),f.moveTo(m,s),w&&(l.beginPath(),l.moveTo(m,s)),z={x:m,y:s}),ja=d=!1):(f.lineTo(m,s),w&&l.lineTo(m,s),0==k%250&&b());p={x:m,
y:s};k<v.length-1&&(y!==(v[k].lineColor||u)||c!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||u,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(c=v[k].lineDashType,f.setLineDash(N(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(P))));var aa=g.dataPointIds[k];this._eventManager.objectMap[aa]={id:aa,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:s};0!==v[k].markerSize&&(0<v[k].markerSize||0<g.markerSize)&&(r=g.getMarkerProperties(k,m,s,f),A.push(r),aa=Q(aa),
w&&A.push({x:m,y:s,ctx:l,type:r.type,size:r.size,color:aa,borderColor:aa,borderThickness:r.borderThickness}));(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:v[k],dataSeries:g,point:{x:m,y:s},direction:0>v[k].y===a.axisY.reversed?1:-1,color:B})}b();W.drawMarkers(A)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,
...
1].x,m);b.lineTo(s.x,m);b.closePath();b.globalAlpha=p.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,m),e.lineTo(s.x,m),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var A=
0;A<a.dataSeriesIndexes.length;A++){var h=a.dataSeriesIndexes[A],p=this.data[h],n=p.dataPoints,l=p.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:h};l=Q(l);e.fillStyle=l;var l=[],q=0,g,v,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),m,s=null,r=[];if(0<n.length){var E=p._colorSet[q%p._colorSet.length],C=p.lineColor=p.options.lineColor||E,z=C;b.fillStyle=E;b.strokeStyle=C;b.lineWidth=p.lineThickness;var B="solid";if(b.setLineDash){var y=N(p.nullDataLineDashType,
...
var S=p.dataPointIds[q];this._eventManager.objectMap[S]={id:S,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:q,x1:g,y1:v};r[r.length]={x:g,y:v};q<n.length-1&&(z!==(n[q].lineColor||C)||B!==(n[q].lineDashType||p.lineDashType))&&(z=n[q].lineColor||C,r[r.length-1].newStrokeStyle=z,b.setLineDash&&(n[q].lineDashType?(B=n[q].lineDashType,r[r.length-1].newLineDashArray=N(B,p.lineThickness)):(B=p.lineDashType,r[r.length-1].newLineDashArray=D)));if(0!==n[q].markerSize&&(0<n[q].markerSize||0<p.markerSize)){var P=
p.getMarkerProperties(q,g,v,b);l.push(P);S=Q(S);w&&l.push({x:g,y:v,ctx:e,type:P.type,size:P.size,color:S,borderColor:S,borderThickness:P.borderThickness})}(n[q].indexLabel||p.indexLabel||n[q].indexLabelFormatter||p.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:n[q],dataSeries:p,point:{x:g,y:v},direction:0>n[q].y===a.axisY.reversed?1:-1,color:E});v=!1}d();W.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
"source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(t.x1,t.y1,t.width,t.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:L.xClipAnimation,easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStepArea=
...
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,A=[],h=this.plotArea,p;f.save();w&&l.save();f.beginPath();f.rect(h.x1,h.y1,h.width,h.height);f.clip();w&&(l.beginPath(),l.rect(h.x1,h.y1,h.width,h.height),l.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],v=g.dataPoints,A=g.id;this._eventManager.objectMap[A]={objectType:"dataSeries",dataSeriesIndex:q};A=Q(A);l.fillStyle=A;A=[];d=!0;var k=0,m,s,r,E=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),C,z=null;c=!1;if(0<v.length){var B=g._colorSet[k%g._colorSet.length],u=g.lineColor=g.options.lineColor||B,y=u;f.fillStyle=B;f.strokeStyle=u;f.lineWidth=g.lineThickness;var S="solid";if(f.setLineDash){var P=N(g.nullDataLineDashType,g.lineThickness),S=g.lineDashType,D=N(S,g.lineThickness);f.setLineDash(D)}for(;k<v.length;k++)if(r=v[k].x.getTime?v[k].x.getTime():v[k].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var aa=s;"number"!==
typeof v[k].y?(g.connectNullData||(c||d)||b(),c=!0):(m=a.axisX.convertValueToPixel(r),s=a.axisY.convertValueToPixel(v[k].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||S===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=s,m=p.x,s=p.y,b(),f.moveTo(p.x,p.y),m=d,s=c,z=p,S=g.nullDataLineDashType,f.setLineDash(P)),f.lineTo(m,aa),f.lineTo(m,s),w&&(l.lineTo(m,aa),l.lineTo(m,s))):(f.beginPath(),f.moveTo(m,s),w&&(l.beginPath(),l.moveTo(m,s)),z={x:m,y:s}),c=
d=!1):(f.lineTo(m,aa),w&&l.lineTo(m,aa),f.lineTo(m,s),w&&l.lineTo(m,s),0==k%250&&b()),p={x:m,y:s},k<v.length-1&&(y!==(v[k].lineColor||u)||S!==(v[k].lineDashType||g.lineDashType))&&(b(),y=v[k].lineColor||u,f.strokeStyle=y,f.setLineDash&&(v[k].lineDashType?(S=v[k].lineDashType,f.setLineDash(N(S,g.lineThickness))):(S=g.lineDashType,f.setLineDash(D)))),r=g.dataPointIds[k],this._eventManager.objectMap[r]={id:r,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:k,x1:m,y1:s},0!==v[k].markerSize&&(0<
v[k].markerSize||0<g.markerSize)&&(aa=g.getMarkerProperties(k,m,s,f),A.push(aa),r=Q(r),w&&A.push({x:m,y:s,ctx:l,type:aa.type,size:aa.size,color:r,borderColor:r,borderThickness:aa.borderThickness})),(v[k].indexLabel||g.indexLabel||v[k].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:v[k],dataSeries:g,point:{x:m,y:s},direction:0>v[k].y===a.axisY.reversed?1:-1,color:B}))}b();W.drawMarkers(A)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
m.prototype.renderStackedArea=function(a){function d(){if(!(1>h.length)){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);w&&r.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(r.closePath(),r.fill(),r.beginPath());h=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,A=[],h=[],p=[],n=[],q=0,g,k,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?
...
u[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!aa)))if("number"!==typeof fa.y)B.connectNullData||(aa||x)||d(),aa=!0;else{g=a.axisX.convertValueToPixel(f);var ma=A[f]?A[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=fa.y+(n[f]?n[f]:0);if(0>=n[f]&&a.axisY.logarithmic)continue;k=a.axisY.convertValueToPixel(n[f])}else k=a.axisY.convertValueToPixel(fa.y),k-=ma;h.push({x:g,
y:m-ma});A[f]=m-k;x||aa?(!x&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||E===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(x=h.pop(),E=h[h.length-1],d(),b.moveTo(s.x,s.y),h.push(E),h.push(x),E=B.nullDataLineDashType,b.setLineDash(P)),b.lineTo(g,k),w&&r.lineTo(g,k)):(b.beginPath(),b.moveTo(g,k),w&&(r.beginPath(),r.moveTo(g,k))),aa=x=!1):(b.lineTo(g,k),w&&r.lineTo(g,k),0==q%250&&(d(),b.moveTo(g,k),w&&r.moveTo(g,k),h.push({x:g,y:m-ma})));s={x:g,y:k};q<u.length-1&&
(S!==(u[q].lineColor||y)||E!==(u[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,k),h.push({x:g,y:m-ma}),S=u[q].lineColor||y,b.strokeStyle=S,b.setLineDash&&(u[q].lineDashType?(E=u[q].lineDashType,b.setLineDash(N(E,B.lineThickness))):(E=B.lineDashType,b.setLineDash(D))));if(0<=B.dataPointIndexes[f]){var F=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:k}}0<=B.dataPointIndexes[f]&&
0!==fa.markerSize&&(0<fa.markerSize||0<B.markerSize)&&(ma=B.getMarkerProperties(B.dataPointIndexes[f],g,k,b),l.push(ma),f=Q(F),w&&l.push({x:g,y:k,ctx:r,type:ma.type,size:ma.size,color:f,borderColor:f,borderThickness:ma.borderThickness}));(fa.indexLabel||B.indexLabel||fa.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:fa,dataSeries:B,point:{x:g,y:k},direction:0>u[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,k);w&&r.moveTo(g,k)}delete B.dataPointIndexes}W.drawMarkers(l);
...
easingFunction:L.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<h.length;){var a=h.pop();b.lineTo(a.x,a.y);w&&E.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(E.closePath(),E.fill(),E.beginPath());h=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],k=[],h=[],p=[],n=[],q=
0,g,v,m,r,s,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),E=this._eventManager.ghostCtx;b.save();w&&E.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(E.beginPath(),E.rect(l.x1,l.y1,l.width,l.height),E.clip());for(var e=[],u=0;u<a.dataSeriesIndexes.length;u++){var z=a.dataSeriesIndexes[u],B=this.data[z],y=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<y.length;q++)z=y[q].x.getTime?y[q].x.getTime():y[q].x,B.dataPointIndexes[z]=q,e[z]||(p.push(z),e[z]=
!0);p.sort(Ra)}for(u=0;u<a.dataSeriesIndexes.length;u++){z=a.dataSeriesIndexes[u];B=this.data[z];y=B.dataPoints;r=!0;e=B.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:z};e=Q(e);E.fillStyle=e;h=[];if(0<p.length){var e=B._colorSet[q%B._colorSet.length],D=B.lineColor=B.options.lineColor||e,S=D;b.fillStyle=e;b.strokeStyle=D;b.lineWidth=B.lineThickness;s="solid";if(b.setLineDash){var P=N(B.nullDataLineDashType,B.lineThickness);s=B.lineDashType;var F=N(s,B.lineThickness);b.setLineDash(F)}for(var aa=
!0,q=0;q<p.length;q++){var f=p[q],fa=null,fa=0<=B.dataPointIndexes[f]?y[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!aa)))if("number"!==typeof fa.y)B.connectNullData||(aa||r)||d(),aa=!0;else{var ma;ma=0!==a.dataPointYSums[f]?100*(fa.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var ba=k[f]?k[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){n[f]=ma+(n[f]?n[f]:
0);if(0>=n[f]&&a.axisY.logarithmic)continue;v=a.axisY.convertValueToPixel(n[f])}else v=a.axisY.convertValueToPixel(ma),v-=ba;h.push({x:g,y:x-ba});k[f]=x-v;r||aa?(!r&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||s===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(r=h.pop(),s=h[h.length-1],d(),b.moveTo(m.x,m.y),h.push(s),h.push(r),s=B.nullDataLineDashType,b.setLineDash(P)),b.lineTo(g,v),w&&E.lineTo(g,v)):(b.beginPath(),b.moveTo(g,v),w&&(E.beginPath(),E.moveTo(g,v))),
aa=r=!1):(b.lineTo(g,v),w&&E.lineTo(g,v),0==q%250&&(d(),b.moveTo(g,v),w&&E.moveTo(g,v),h.push({x:g,y:x-ba})));m={x:g,y:v};q<y.length-1&&(S!==(y[q].lineColor||D)||s!==(y[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,v),h.push({x:g,y:x-ba}),S=y[q].lineColor||D,b.strokeStyle=S,b.setLineDash&&(y[q].lineDashType?(s=y[q].lineDashType,b.setLineDash(N(s,B.lineThickness))):(s=B.lineDashType,b.setLineDash(F))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[G]=
...
n.fillOpacity;W.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var s=n.dataPointIds[e];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:e,x1:f,y1:l,size:r};r=Q(s);w&&W.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,r,r,g.borderThickness);(q[e].indexLabel||n.indexLabel||q[e].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"bubble",dataPoint:q[e],dataSeries:n,point:{x:f,y:l},
...
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(b.x1,b.y1,b.width,b.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(b.x1,b.y1,
...
f,l,c);c.globalAlpha=h.fillOpacity;W.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((n-f)*(n-f)+(q-l)*(q-l))<Math.min(g.size,5)&&p.length>Math.min(this.plotArea.width,this.plotArea.height)||(n=h.dataPointIds[e],this._eventManager.objectMap[n]={id:n,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:e,x1:f,y1:l},n=Q(n),w&&W.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,n,n,g.borderThickness),(p[e].indexLabel||h.indexLabel||
...
this.dataPointMaxWidth&&e>f&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<e)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));v<e&&(v=e);v>f&&(v=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var ka=a.dataSeriesIndexes[m],s=this.data[ka],x=s.dataPoints;
if(0<x.length)for(var E=5<v&&s.bevelEnabled?!0:!1,t=0;t<x.length;t++)if(x[t].getTime?g=x[t].x.getTime():g=x[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(x[t].y)&&x[t].y.length&&"number"===typeof x[t].y[0]&&"number"===typeof x[t].y[1]&&"number"===typeof x[t].y[2]&&"number"===typeof x[t].y[3]){k=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[t].y[0]);p=a.axisY.convertValueToPixel(x[t].y[1]);n=a.axisY.convertValueToPixel(x[t].y[2]);q=a.axisY.convertValueToPixel(x[t].y[3]);
var u=k-v/2<<0,z=u+v<<0,f=s.options.fallingColor?s.fallingColor:s._colorSet[0],e=x[t].color?x[t].color:s._colorSet[0],B=Math.round(Math.max(1,0.15*v)),y=0===B%2?0:0.5,D=s.dataPointIds[t];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:ka,dataPointIndex:t,x1:u,y1:h,x2:z,y2:p,x3:k,y3:n,x4:k,y4:q,borderThickness:B,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=B;b.lineWidth=Math.max(B,4);"candlestick"===s.type?(c.moveTo(k-y,p),c.lineTo(k-y,Math.min(h,q)),c.stroke(),c.moveTo(k-
y,Math.max(h,q)),c.lineTo(k-y,n),c.stroke(),ca(c,u,Math.min(h,q),z,Math.max(h,q),x[t].y[0]<=x[t].y[3]?s.risingColor:f,B,e,E,E,!1,!1,s.fillOpacity),w&&(e=Q(D),b.strokeStyle=e,b.moveTo(k-y,p),b.lineTo(k-y,Math.min(h,q)),b.stroke(),b.moveTo(k-y,Math.max(h,q)),b.lineTo(k-y,n),b.stroke(),ca(b,u,Math.min(h,q),z,Math.max(h,q),e,0,null,!1,!1,!1,!1))):"ohlc"===s.type&&(c.moveTo(k-y,p),c.lineTo(k-y,n),c.stroke(),c.beginPath(),c.moveTo(k,h),c.lineTo(u,h),c.stroke(),c.beginPath(),c.moveTo(k,q),c.lineTo(z,q),
...
animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,t,k,h,p,n,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.015*this.width,v=a.axisX.dataInfo.minDiff;isFinite(v)||
(v=0.3*Math.abs(a.axisX.range));v=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(v)/Math.log(a.axisX.range):Math.abs(v)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));v<e&&(v=e);v>l&&(v=l);c.save();w&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,
f.height);c.clip();w&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,u=0;u<a.dataSeriesIndexes.length;u++){var s=a.dataSeriesIndexes[u],x=this.data[s],E=x.dataPoints;if(0<E.length)for(var C=5<v&&x.bevelEnabled?!0:!1,l=0;l<E.length;l++)if(E[l].getTime?g=E[l].x.getTime():g=E[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(E[l].y)&&E[l].y.length&&"number"===typeof E[l].y[0]&&"number"===typeof E[l].y[1]&&"number"===typeof E[l].y[2]&&
"number"===typeof E[l].y[3]&&"number"===typeof E[l].y[4]&&5===E[l].y.length){t=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(E[l].y[0]);h=a.axisY.convertValueToPixel(E[l].y[1]);p=a.axisY.convertValueToPixel(E[l].y[2]);n=a.axisY.convertValueToPixel(E[l].y[3]);q=a.axisY.convertValueToPixel(E[l].y[4]);var z=t-v/2<<0,B=t+v/2<<0,e=E[l].color?E[l].color:x._colorSet[0],y=Math.round(Math.max(1,0.15*v)),D=0===y%2?0:0.5,S=E[l].whiskerColor?E[l].whiskerColor:E[l].color?x.whiskerColor?x.whiskerColor:
E[l].color:x.whiskerColor?x.whiskerColor:e,P="number"===typeof E[l].whiskerThickness?E[l].whiskerThickness:"number"===typeof x.options.whiskerThickness?x.whiskerThickness:y,F=E[l].whiskerDashType?E[l].whiskerDashType:x.whiskerDashType,aa=r(E[l].whiskerLength)?r(x.options.whiskerLength)?v:x.whiskerLength:E[l].whiskerLength,aa="number"===typeof aa?0>=aa?0:aa>=v?v:aa:"string"===typeof aa?parseInt(aa)*v/100>v?v:parseInt(aa)*v/100:v,fa=1===Math.round(P)%2?0.5:0,ma=E[l].stemColor?E[l].stemColor:E[l].color?
x.stemColor?x.stemColor:E[l].color:x.stemColor?x.stemColor:e,ba="number"===typeof E[l].stemThickness?E[l].stemThickness:"number"===typeof x.options.stemThickness?x.stemThickness:y,G=1===Math.round(ba)%2?0.5:0,H=E[l].stemDashType?E[l].stemDashType:x.stemDashType,J=E[l].lineColor?E[l].lineColor:E[l].color?x.lineColor?x.lineColor:E[l].color:x.lineColor?x.lineColor:e,M="number"===typeof E[l].lineThickness?E[l].lineThickness:"number"===typeof x.options.lineThickness?x.lineThickness:y,T=E[l].lineDashType?
E[l].lineDashType:x.lineDashType,K=1===Math.round(M)%2?0.5:0,R=x.upperBoxColor,xa=x.lowerBoxColor,sa=r(x.options.fillOpacity)?1:x.fillOpacity,O=x.dataPointIds[l];this._eventManager.objectMap[O]={id:O,objectType:"dataPoint",dataSeriesIndex:s,dataPointIndex:l,x1:z,y1:k,x2:B,y2:h,x3:t,y3:p,x4:t,y4:n,y5:q,borderThickness:y,color:e,stemThickness:ba,stemColor:ma,whiskerThickness:P,whiskerLength:aa,whiskerColor:S,lineThickness:M,lineColor:J};c.save();0<ba&&(c.beginPath(),c.strokeStyle=ma,c.lineWidth=ba,
c.setLineDash&&c.setLineDash(N(H,ba)),c.moveTo(t-G,h),c.lineTo(t-G,k),c.stroke(),c.moveTo(t-G,n),c.lineTo(t-G,p),c.stroke());c.restore();b.lineWidth=Math.max(y,4);c.beginPath();ca(c,z,Math.min(q,h),B,Math.max(h,q),xa,0,e,m?C:!1,m?!1:C,!1,!1,sa);c.beginPath();ca(c,z,Math.min(p,q),B,Math.max(q,p),R,0,e,m?!1:C,m?C:!1,!1,!1,sa);c.beginPath();c.lineWidth=y;c.strokeStyle=e;c.rect(z-D,Math.min(h,p)-D,B-z+2*D,Math.max(h,p)-Math.min(h,p)+2*D);c.stroke();c.save();0<M&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&
c.setLineDash(N(T,M)),c.strokeStyle=J,c.lineWidth=M,c.moveTo(z,q-K),c.lineTo(B,q-K),c.stroke());c.restore();c.save();0<P&&(c.beginPath(),c.setLineDash&&c.setLineDash(N(F,P)),c.strokeStyle=S,c.lineWidth=P,c.moveTo(t-aa/2<<0,n-fa),c.lineTo(t+aa/2<<0,n-fa),c.stroke(),c.moveTo(t-aa/2<<0,k+fa),c.lineTo(t+aa/2<<0,k+fa),c.stroke());c.restore();w&&(e=Q(O),b.strokeStyle=e,b.lineWidth=ba,0<ba&&(b.moveTo(t-D-G,h),b.lineTo(t-D-G,Math.max(k,n)),b.stroke(),b.moveTo(t-D-G,Math.min(k,n)),b.lineTo(t-D-G,p),b.stroke()),
ca(b,z,Math.max(h,p),B,Math.min(h,p),e,0,null,!1,!1,!1,!1),0<P&&(b.beginPath(),b.lineWidth=P,b.moveTo(t+aa/2,n-fa),b.lineTo(t-aa/2,n-fa),b.stroke(),b.moveTo(t+aa/2,k+fa),b.lineTo(t-aa/2,k+fa),b.stroke()));(E[l].indexLabel||x.indexLabel||E[l].indexLabelFormatter||x.indexLabelFormatter)&&this._indexLabels.push({chartType:x.type,dataPoint:E[l],dataSeries:x,point:{x:z+(B-z)/2,y:a.axisY.reversed?k:n},direction:1,bounds:{x1:z,y1:Math.min(k,n),x2:B,y2:Math.max(k,n)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,
...
animationBase:0}}};m.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,k,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.03*this.width;var h=a.axisX.dataInfo.minDiff;isFinite(h)||(h=0.3*Math.abs(a.axisX.range));
h=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(h)/Math.log(a.axisX.range):Math.abs(h)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>l&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));h<f&&(h=f);h>l&&(h=l);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();
c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var n=a.dataSeriesIndexes[p],q=this.data[n],g=q.dataPoints;if(0<g.length)for(var v=5<h&&q.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?k=g[f].x.getTime():k=g[f].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&!r(g[f].y)&&g[f].y.length&&"number"===
typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(k);l=a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*h/2-(a.previousDataSeriesCount+p)*h<<0:b-a.plotType.totalDataSeries*h/2+(a.previousDataSeriesCount+p)*h<<0,u=a.axisX.reversed?m-h<<0:m+h<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var s=l;l=t;t=s}s=q.dataPointIds[f];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",
dataSeriesIndex:n,dataPointIndex:f,x1:m,y1:l,x2:u,y2:t};ca(c,m,l,u,t,b,0,b,v,v,!1,!1,q.fillOpacity);b=Q(s);w&&ca(this._eventManager.ghostCtx,m,l,u,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(u-m)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,t),x2:u,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(u-m)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,t),x2:u,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?u:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?u:1)))<<0:0.03*this.width);s=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(Fa)/Math.log(a.axisX.range):
...
s/100>s:s;S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;var P={color:z[t].stemColor?z[t].stemColor:z[t].color?C.stemColor?C.stemColor:z[t].color:C.stemColor?C.stemColor:e,thickness:z[t].stemThickness?z[t].stemThickness:C.stemThickness,dashType:z[t].stemDashType?z[t].stemDashType:C.stemDashType};P.thickness="number"===typeof P.thickness?0>P.thickness?0:Math.round(P.thickness):2;z[t].getTime?m=z[t].x.getTime():m=z[t].x;if(!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax)&&
!r(z[t].y)&&z[t].y.length&&"number"===typeof z[t].y[0]&&"number"===typeof z[t].y[1]){var ja=a.axisX.convertValueToPixel(m);b?h=ja:k=ja;ja=a.axisY.convertValueToPixel(z[t].y[0]);b?p=ja:q=ja;ja=a.axisY.convertValueToPixel(z[t].y[1]);b?n=ja:g=ja;b?(q=a.axisX.reversed?h+(B?u:1)*s/2-(B?D-1:0)*s<<0:h-(B?u:1)*s/2+(B?D-1:0)*s<<0,g=a.axisX.reversed?q-s<<0:q+s<<0):(p=a.axisX.reversed?k+(B?u:1)*s/2-(B?D-1:0)*s<<0:k-(B?u:1)*s/2+(B?D-1:0)*s<<0,n=a.axisX.reversed?p-s<<0:p+s<<0);!b&&q>g&&(ja=q,q=g,g=ja);b&&p>n&&
...
this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,t,k,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?
this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:Math.min(0.15*this.height,0.9*(this.plotArea.height/a.plotType.totalDataSeries))<<0;var p=a.axisX.dataInfo.minDiff;isFinite(p)||(p=0.3*Math.abs(a.axisX.range));p=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?Math.log(p)/Math.log(a.axisX.range):Math.abs(p)/Math.abs(a.axisX.range))/a.plotType.totalDataSeries)<<0;this.dataPointMaxWidth&&f>l&&(f=Math.min(this.options.dataPointWidth?this.dataPointWidth:
Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<f)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>l&&(p=l);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],
m=g.dataPoints;if(0<m.length){var Fa=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<m.length;f++)if(m[f].getTime?h=m[f].x.getTime():h=m[f].x,!(h<a.axisX.dataInfo.viewPortMin||h>a.axisX.dataInfo.viewPortMax)&&!r(m[f].y)&&m[f].y.length&&"number"===typeof m[f].y[0]&&"number"===typeof m[f].y[1]){l=a.axisY.convertValueToPixel(m[f].y[0]);t=a.axisY.convertValueToPixel(m[f].y[1]);k=a.axisX.convertValueToPixel(h);k=a.axisX.reversed?k+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+
n)*p<<0:k-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var u=a.axisX.reversed?k-p<<0:k+p<<0;l>t&&(b=l,l=t,t=b);b=m[f].color?m[f].color:g._colorSet[f%g._colorSet.length];ca(c,l,k,t,u,b,0,null,Fa,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:k,x2:t,y2:u};b=Q(b);w&&ca(this._eventManager.ghostCtx,l,k,t,u,b,0,null,!1,!1,!1,!1);if(m[f].indexLabel||g.indexLabel||m[f].indexLabelFormatter||
g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:m[f],dataSeries:g,indexKeyword:0,point:{x:m[f].y[1]>=m[f].y[0]?l:t,y:k+(u-k)/2},direction:m[f].y[1]>=m[f].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:k,x2:Math.max(l,t),y2:u},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:m[f],dataSeries:g,indexKeyword:1,point:{x:m[f].y[1]>=m[f].y[0]?t:l,y:k+(u-k)/2},direction:m[f].y[1]>=m[f].y[0]?1:-1,bounds:{x1:Math.min(l,t),y1:k,x2:Math.max(l,t),y2:u},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,
...
animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(x){for(var a=null,c=k.length-1;0<=c;c--)a=k[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=p.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<p.lineThickness){b.beginPath();b.moveTo(a.x,a.y2);for(c=0;c<k.length;c++)a=k[c],b.lineTo(a.x,a.y2);b.moveTo(k[0].x,k[0].y1);for(c=0;c<k.length;c++)a=k[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(m,r);e.beginPath();e.moveTo(m,r);x={x:m,y:r};k=[];k.push({x:m,
y1:r,y2:u})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var k=[],h=a.dataSeriesIndexes[t],p=this.data[h],n=p.dataPoints,f=p.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};
f=Q(f);e.fillStyle=f;var f=[],q=!0,g=0,m,r,u,s,x=null;if(0<n.length){var E=p._colorSet[g%p._colorSet.length],C=p.lineColor=p.options.lineColor||E,z=C;b.fillStyle=E;b.strokeStyle=C;b.lineWidth=p.lineThickness;var B="solid";if(b.setLineDash){var y=N(p.nullDataLineDashType,p.lineThickness),B=p.lineDashType,D=N(B,p.lineThickness);b.setLineDash(D)}for(var S=!0;g<n.length;g++)if(s=n[g].x.getTime?n[g].x.getTime():n[g].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!p.connectNullData||
!S)))if(null!==n[g].y&&n[g].y.length&&"number"===typeof n[g].y[0]&&"number"===typeof n[g].y[1]){m=a.axisX.convertValueToPixel(s);r=a.axisY.convertValueToPixel(n[g].y[0]);u=a.axisY.convertValueToPixel(n[g].y[1]);q||S?(p.connectNullData&&!q?(b.setLineDash&&(p.options.nullDataLineDashType||B===p.lineDashType&&p.lineDashType!==p.nullDataLineDashType)&&(k[k.length-1].newLineDashArray=D,B=p.nullDataLineDashType,b.setLineDash(y)),b.lineTo(m,r),w&&e.lineTo(m,r),k.push({x:m,y1:r,y2:u})):(b.beginPath(),b.moveTo(m,
r),x={x:m,y:r},k=[],k.push({x:m,y1:r,y2:u}),w&&(e.beginPath(),e.moveTo(m,r))),S=q=!1):(b.lineTo(m,r),k.push({x:m,y1:r,y2:u}),w&&e.lineTo(m,r),0==g%250&&d());s=p.dataPointIds[g];this._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:g,x1:m,y1:r,y2:u};g<n.length-1&&(z!==(n[g].lineColor||C)||B!==(n[g].lineDashType||p.lineDashType))&&(d(),z=n[g].lineColor||C,k[k.length-1].newStrokeStyle=z,b.strokeStyle=z,b.setLineDash&&(n[g].lineDashType?(B=n[g].lineDashType,k[k.length-
1].newLineDashArray=N(B,p.lineThickness),b.setLineDash(k[k.length-1].newLineDashArray)):(B=p.lineDashType,k[k.length-1].newLineDashArray=D,b.setLineDash(D))));if(0!==n[g].markerSize&&(0<n[g].markerSize||0<p.markerSize)){var P=p.getMarkerProperties(g,m,u,b);f.push(P);var F=Q(s);w&&f.push({x:m,y:u,ctx:e,type:P.type,size:P.size,color:F,borderColor:F,borderThickness:P.borderThickness});P=p.getMarkerProperties(g,m,r,b);f.push(P);F=Q(s);w&&f.push({x:m,y:r,ctx:e,type:P.type,size:P.size,color:F,borderColor:F,
borderThickness:P.borderThickness})}if(n[g].indexLabel||p.indexLabel||n[g].indexLabelFormatter||p.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:n[g],dataSeries:p,indexKeyword:0,point:{x:m,y:r},direction:n[g].y[0]>n[g].y[1]===a.axisY.reversed?-1:1,color:E}),this._indexLabels.push({chartType:"rangeArea",dataPoint:n[g],dataSeries:p,indexKeyword:1,point:{x:m,y:u},direction:n[g].y[0]>n[g].y[1]===a.axisY.reversed?1:-1,color:E})}else S||q||d(),S=!0;d();W.drawMarkers(f)}}w&&
...
this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var k=0;k<a.dataSeriesIndexes.length;k++){var m=a.dataSeriesIndexes[k],h=this.data[m],p=h.dataPoints,f=h.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:m};f=Q(f);e.fillStyle=f;var f=[],n=0,q,g,v,r=[],ka=[];if(0<p.length){var s=h._colorSet[n%h._colorSet.length],x=h.lineColor=h.options.lineColor||
s,E=x;b.fillStyle=s;b.lineWidth=h.lineThickness;var C="solid",z;if(b.setLineDash){var B=N(h.nullDataLineDashType,h.lineThickness),C=h.lineDashType;z=N(C,h.lineThickness)}for(g=!1;n<p.length;n++)if(q=p[n].x.getTime?p[n].x.getTime():p[n].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!h.connectNullData||!g)))if(null!==p[n].y&&p[n].y.length&&"number"===typeof p[n].y[0]&&"number"===typeof p[n].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(p[n].y[0]);v=a.axisY.convertValueToPixel(p[n].y[1]);
var y=h.dataPointIds[n];this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:n,x1:q,y1:g,y2:v};r[r.length]={x:q,y:g};ka[ka.length]={x:q,y:v};n<p.length-1&&(E!==(p[n].lineColor||x)||C!==(p[n].lineDashType||h.lineDashType))&&(E=p[n].lineColor||x,r[r.length-1].newStrokeStyle=E,b.setLineDash&&(p[n].lineDashType?(C=p[n].lineDashType,r[r.length-1].newLineDashArray=N(C,h.lineThickness)):(C=h.lineDashType,r[r.length-1].newLineDashArray=z)));if(0!==p[n].markerSize&&
(0<p[n].markerSize||0<h.markerSize)){var D=h.getMarkerProperties(n,q,g,b);f.push(D);var S=Q(y);w&&f.push({x:q,y:g,ctx:e,type:D.type,size:D.size,color:S,borderColor:S,borderThickness:D.borderThickness});D=h.getMarkerProperties(n,q,v,b);f.push(D);S=Q(y);w&&f.push({x:q,y:v,ctx:e,type:D.type,size:D.size,color:S,borderColor:S,borderThickness:D.borderThickness})}if(p[n].indexLabel||h.indexLabel||p[n].indexLabelFormatter||h.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:p[n],
dataSeries:h,indexKeyword:0,point:{x:q,y:g},direction:p[n].y[0]<=p[n].y[1]?-1:1,color:s}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:p[n],dataSeries:h,indexKeyword:1,point:{x:q,y:v},direction:p[n].y[0]<=p[n].y[1]?1:-1,color:s});g=!1}else 0<n&&!g&&(h.connectNullData?b.setLineDash&&(0<r.length&&(h.options.nullDataLineDashType||!p[n-1].lineDashType))&&(r[r.length-1].newLineDashArray=B,C=h.nullDataLineDashType):(d(z,x),r=[],ka=[])),g=!0;d(z,x);W.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,
...
(m=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,l));q<l&&(q=l);q>m&&(q=m);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var v=a.dataSeriesIndexes[g],r=this.data[v],u=r.dataPoints,e=r._colorSet[0];r.risingColor=r.options.risingColor?r.options.risingColor:
e;r.fallingColor=r.options.fallingColor?r.options.fallingColor:"#e40a0a";var s="number"===typeof r.options.lineThickness?Math.round(r.lineThickness):1,x=1===Math.round(s)%2?-0.5:0;if(0<u.length)for(var E=5<q&&r.bevelEnabled?!0:!1,C=!1,z=null,B=null,l=0;l<u.length;l++)if(u[l].getTime?p=u[l].x.getTime():p=u[l].x,"number"!==typeof u[l].y){if(0<l&&!C&&r.connectNullData)var y=r.options.nullDataLineDashType||!u[l-1].lineDashType?r.nullDataLineDashType:u[l-1].lineDashType;C=!0}else{k=a.axisX.convertValueToPixel(p);
m=0===r.dataPointEOs[l].cumulativeSum?n:a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSum);h=0===r.dataPointEOs[l].cumulativeSumYStartValue?n:a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSumYStartValue);k=a.axisX.reversed?k+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:k-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var D=a.axisX.reversed?k-q<<0:k+q<<0;m>h&&(e=m,m=h,h=e);a.axisY.reversed&&(e=m,m=h,h=e);e=r.dataPointIds[l];this._eventManager.objectMap[e]=
{id:e,objectType:"dataPoint",dataSeriesIndex:v,dataPointIndex:l,x1:k,y1:m,x2:D,y2:h};var S=u[l].color?u[l].color:0<u[l].y?r.risingColor:r.fallingColor;ca(c,k,m,D,h,S,0,S,E,E,!1,!1,r.fillOpacity);e=Q(e);w&&ca(this._eventManager.ghostCtx,k,m,D,h,e,0,null,!1,!1,!1,!1);var P,S=k;P="undefined"!==typeof u[l].isIntermediateSum&&!0===u[l].isIntermediateSum||"undefined"!==typeof u[l].isCumulativeSum&&!0===u[l].isCumulativeSum?0<u[l].y?m:h:0<u[l].y?h:m;0<l&&z&&(!C||r.connectNullData)&&(C&&c.setLineDash&&c.setLineDash(N(y,
s)),c.beginPath(),c.moveTo(z,B-x),c.lineTo(S,P-x),0<s&&c.stroke(),w&&(b.beginPath(),b.moveTo(z,B-x),b.lineTo(S,P-x),0<s&&b.stroke()));C=!1;z=D;B=0<u[l].y?m:h;S=u[l].lineDashType?u[l].lineDashType:r.options.lineDashType?r.options.lineDashType:"shortDash";c.strokeStyle=u[l].lineColor?u[l].lineColor:r.options.lineColor?r.options.lineColor:"#9e9e9e";c.lineWidth=s;c.setLineDash&&(S=N(S,s),c.setLineDash(S));(u[l].indexLabel||r.indexLabel||u[l].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",
dataPoint:u[l],dataSeries:r,point:{x:k+(D-k)/2,y:0<=u[l].y?m:h},direction:0>u[l].y===a.axisY.reversed?1:-1,bounds:{x1:k,y1:Math.min(m,h),x2:D,y2:Math.max(m,h)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:L.fadeInAnimation,easingFunction:L.easing.easeInQuad,animationBase:0}}};var Y=function(a,d,c,b,e,f,l,k,m){if(!(0>c)){"undefined"===typeof k&&(k=1);if(!w){var h=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===h&&(l-=1E-4)}a.save();a.globalAlpha=k;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,
c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.closePath(),a.fill()):"doughnut"===e&&(a.beginPath(),a.arc(d.x,d.y,c,f,l,!1),0<=m&&a.arc(d.x,d.y,m*c,l,f,!0),a.closePath(),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=2,a.fill());a.globalAlpha=1;a.restore()}};m.prototype.renderPie=function(a){function d(){if(h&&p){for(var a=0,b=0,c=0,d=0,e=0;e<p.length;e++){var f=p[e],l=h.dataPointIds[e];g[e].id=l;g[e].objectType="dataPoint";g[e].dataPointIndex=e;g[e].dataSeriesIndex=0;var k=g[e],n=
{percent:null,total:null},t=null,n=m.getPercentAndTotal(h,f);if(h.indexLabelFormatter||f.indexLabelFormatter)t={chart:m.options,dataSeries:h,dataPoint:f,total:n.total,percent:n.percent};n=f.indexLabelFormatter?f.indexLabelFormatter(t):f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,h,e):h.indexLabelFormatter?h.indexLabelFormatter(t):h.indexLabel?m.replaceKeywordsWithValue(h.indexLabel,f,h,e):f.label?f.label:"";m._eventManager.objectMap[l]=k;k.center={x:E.x,y:E.y};k.y=f.y;k.radius=B;k.percentInnerRadius=
F;k.indexLabelText=n;k.indexLabelPlacement=h.indexLabelPlacement;k.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:h.options.indexLabelLineColor?h.options.indexLabelLineColor:f.color?f.color:h._colorSet[e%h._colorSet.length];k.indexLabelLineThickness=r(f.indexLabelLineThickness)?h.indexLabelLineThickness:f.indexLabelLineThickness;k.indexLabelLineDashType=f.indexLabelLineDashType?f.indexLabelLineDashType:h.indexLabelLineDashType;k.indexLabelFontColor=f.indexLabelFontColor?f.indexLabelFontColor:
h.indexLabelFontColor;k.indexLabelFontStyle=f.indexLabelFontStyle?f.indexLabelFontStyle:h.indexLabelFontStyle;k.indexLabelFontWeight=f.indexLabelFontWeight?f.indexLabelFontWeight:h.indexLabelFontWeight;k.indexLabelFontSize=r(f.indexLabelFontSize)?h.indexLabelFontSize:f.indexLabelFontSize;k.indexLabelFontFamily=f.indexLabelFontFamily?f.indexLabelFontFamily:h.indexLabelFontFamily;k.indexLabelBackgroundColor=f.indexLabelBackgroundColor?f.indexLabelBackgroundColor:h.options.indexLabelBackgroundColor?
h.options.indexLabelBackgroundColor:h.indexLabelBackgroundColor;k.indexLabelMaxWidth=f.indexLabelMaxWidth?f.indexLabelMaxWidth:h.indexLabelMaxWidth?h.indexLabelMaxWidth:0.33*q.width;k.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?f.indexLabelWrap:h.indexLabelWrap;k.startAngle=0===e?h.startAngle?h.startAngle/180*Math.PI:0:g[e-1].endAngle;k.startAngle=(k.startAngle+2*Math.PI)%(2*Math.PI);k.endAngle=k.startAngle+2*Math.PI/y*Math.abs(f.y);f=(k.endAngle+k.startAngle)/2;f=(f+2*Math.PI)%(2*Math.PI);
k.midAngle=f;if(k.midAngle>Math.PI/2-s&&k.midAngle<Math.PI/2+s){if(0===a||g[c].midAngle>k.midAngle)c=e;a++}else if(k.midAngle>3*Math.PI/2-s&&k.midAngle<3*Math.PI/2+s){if(0===b||g[d].midAngle>k.midAngle)d=e;b++}k.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";k.indexLabelTextBlock=new ia(m.plotArea.ctx,{fontSize:k.indexLabelFontSize,fontFamily:k.indexLabelFontFamily,fontColor:k.indexLabelFontColor,fontStyle:k.indexLabelFontStyle,fontWeight:k.indexLabelFontWeight,horizontalAlign:"left",backgroundColor:k.indexLabelBackgroundColor,
maxWidth:k.indexLabelMaxWidth,maxHeight:k.indexLabelWrap?5*k.indexLabelFontSize:1.5*k.indexLabelFontSize,text:k.indexLabelText,padding:0,textBaseline:"top"});k.indexLabelTextBlock.measureText()}l=f=0;n=!1;for(e=0;e<p.length;e++)k=g[(c+e)%p.length],1<a&&(k.midAngle>Math.PI/2-s&&k.midAngle<Math.PI/2+s)&&(f<=a/2&&!n?(k.hemisphere="right",f++):(k.hemisphere="left",n=!0));n=!1;for(e=0;e<p.length;e++)k=g[(d+e)%p.length],1<b&&(k.midAngle>3*Math.PI/2-s&&k.midAngle<3*Math.PI/2+s)&&(l<=b/2&&!n?(k.hemisphere=
"left",l++):(k.hemisphere="right",n=!0))}}function c(a){var b=m.plotArea.ctx;b.clearRect(q.x1,q.y1,q.width,q.height);b.fillStyle=m.backgroundColor;b.fillRect(q.x1,q.y1,q.width,q.height);for(b=0;b<p.length;b++){var c=g[b].startAngle,d=g[b].endAngle;if(d>c){var e=0.07*B*Math.cos(g[b].midAngle),f=0.07*B*Math.sin(g[b].midAngle),l=!1;if(p[b].exploded){if(1E-9<Math.abs(g[b].center.x-(E.x+e))||1E-9<Math.abs(g[b].center.y-(E.y+f)))g[b].center.x=E.x+e*a,g[b].center.y=E.y+f*a,l=!0}else if(0<Math.abs(g[b].center.x-
E.x)||0<Math.abs(g[b].center.y-E.y))g[b].center.x=E.x+e*(1-a),g[b].center.y=E.y+f*(1-a),l=!0;l&&(e={},e.dataSeries=h,e.dataPoint=h.dataPoints[b],e.index=b,m.toolTip.highlightObjects([e]));Y(m.plotArea.ctx,g[b].center,g[b].radius,p[b].color?p[b].color:h._colorSet[b%h._colorSet.length],h.type,c,d,h.fillOpacity,g[b].percentInnerRadius)}}a=m.plotArea.ctx;a.save();a.fillStyle="black";a.strokeStyle="grey";a.textBaseline="middle";a.lineJoin="round";for(b=b=0;b<p.length;b++)c=g[b],c.indexLabelText&&(c.indexLabelTextBlock.y-=
...
else c=null;return c}function f(a,c,d){d=(d||0)+1;if(1E3<d)return 0;c=c||0;var h=0,l=E.y-1*w,k=E.y+1*w;if(0<=a&&a<p.length){var n=g[a];if(0>c&&n.indexLabelTextBlock.y<l||0<c&&n.indexLabelTextBlock.y>k)return 0;var q=0,m=0,m=q=q=0;0>c?n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2>l&&n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2+c<l&&(c=-(l-(n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2+c))):n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/2<l&&n.indexLabelTextBlock.y+
n.indexLabelTextBlock.height/2+c>k&&(c=n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/2+c-k);c=n.indexLabelTextBlock.y+c;l=0;l="right"===n.hemisphere?E.x+Math.sqrt(Math.pow(w,2)-Math.pow(c-E.y,2)):E.x-Math.sqrt(Math.pow(w,2)-Math.pow(c-E.y,2));m=E.x+B*Math.cos(n.midAngle);q=E.y+B*Math.sin(n.midAngle);q=Math.sqrt(Math.pow(l-m,2)+Math.pow(c-q,2));m=Math.acos(B/w);q=Math.acos((w*w+B*B-q*q)/(2*B*w));c=q<m?c-n.indexLabelTextBlock.y:0;l=null;for(k=1;k<p.length;k++)if(l=(a-k+g.length)%g.length,g[l].hemisphere!==
g[a].hemisphere){l=null;break}else if(g[l].indexLabelText&&g[l].hemisphere===g[a].hemisphere&&l!==a&&(0>b(g[l],g[a])||("right"===g[a].hemisphere?g[l].indexLabelTextBlock.y<=g[a].indexLabelTextBlock.y:g[l].indexLabelTextBlock.y>=g[a].indexLabelTextBlock.y)))break;else l=null;m=l;q=e(a);k=l=0;0>c?(k="right"===n.hemisphere?m:q,h=c,null!==k&&(m=-c,c=n.indexLabelTextBlock.y-n.indexLabelTextBlock.height/2-(g[k].indexLabelTextBlock.y+g[k].indexLabelTextBlock.height/2),c-m<v&&(l=-m,k=f(k,l,d+1),+k.toFixed(x)>
+l.toFixed(x)&&(h=c>v?-(c-v):-(m-(k-l)))))):0<c&&(k="right"===n.hemisphere?q:m,h=c,null!==k&&(m=c,c=g[k].indexLabelTextBlock.y-g[k].indexLabelTextBlock.height/2-(n.indexLabelTextBlock.y+n.indexLabelTextBlock.height/2),c-m<v&&(l=m,k=f(k,l,d+1),+k.toFixed(x)<+l.toFixed(x)&&(h=c>v?c-v:m-(l-k)))));h&&(d=n.indexLabelTextBlock.y+h,c=0,c="right"===n.hemisphere?E.x+Math.sqrt(Math.pow(w,2)-Math.pow(d-E.y,2)):E.x-Math.sqrt(Math.pow(w,2)-Math.pow(d-E.y,2)),n.midAngle>Math.PI/2-s&&n.midAngle<Math.PI/2+s?(l=(a-
1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"left"===n.hemisphere&&"right"===l.hemisphere&&c>l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x-15:"right"===n.hemisphere&&("left"===a.hemisphere&&c<a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x+15)):n.midAngle>3*Math.PI/2-s&&n.midAngle<3*Math.PI/2+s&&(l=(a-1+g.length)%g.length,l=g[l],a=g[(a+1+g.length)%g.length],"right"===n.hemisphere&&"left"===l.hemisphere&&c<l.indexLabelTextBlock.x?c=l.indexLabelTextBlock.x+15:"left"===n.hemisphere&&
("right"===a.hemisphere&&c>a.indexLabelTextBlock.x)&&(c=a.indexLabelTextBlock.x-15)),n.indexLabelTextBlock.y=d,n.indexLabelTextBlock.x=c,n.indexLabelAngle=Math.atan2(n.indexLabelTextBlock.y-E.y,n.indexLabelTextBlock.x-E.x))}return h}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(h.radius||!h.radius&&"undefined"!==typeof h.innerRadius&&null!==h.innerRadius&&B-d<=D)l=!1;l&&(B-=
d);d=0;if("inside"!==h.indexLabelPlacement){w=B*u;for(a=0;a<p.length;a++){var k=g[a];k.indexLabelTextBlock.x=E.x+w*Math.cos(k.midAngle);k.indexLabelTextBlock.y=E.y+w*Math.sin(k.midAngle);k.indexLabelAngle=k.midAngle;k.radius=B;k.percentInnerRadius=F}for(var t,r,a=0;a<p.length;a++){var k=g[a],s=e(a);if(null!==s){t=g[a];r=g[s];var z=0,z=b(t,r)-v;if(0>z){for(var y=r=0,C=0;C<p.length;C++)C!==a&&g[C].hemisphere===k.hemisphere&&(g[C].indexLabelTextBlock.y<k.indexLabelTextBlock.y?r++:y++);r=z/(r+y||1)*y;
var y=-1*(z-r),H=C=0;"right"===k.hemisphere?(C=f(a,r),y=-1*(z-C),H=f(s,y),+H.toFixed(x)<+y.toFixed(x)&&+C.toFixed(x)<=+r.toFixed(x)&&f(a,-(y-H))):(C=f(s,r),y=-1*(z-C),H=f(a,y),+H.toFixed(x)<+y.toFixed(x)&&+C.toFixed(x)<=+r.toFixed(x)&&f(s,-(y-H)))}}}}else for(a=0;a<p.length;a++)k=g[a],w="pie"===h.type?0.7*B:0.8*B,s=E.x+w*Math.cos(k.midAngle),r=E.y+w*Math.sin(k.midAngle),k.indexLabelTextBlock.x=s,k.indexLabelTextBlock.y=r;for(a=0;a<p.length;a++)if(k=g[a],s=k.indexLabelTextBlock.measureText(),0!==s.height&&
...
q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<p.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=p[c].color?p[c].color:h._colorSet[c%h._colorSet.length];e>d&&Y(m.plotArea.ctx,g[c].center,g[c].radius,l,h.type,d,e,h.fillOpacity,g[c].percentInnerRadius);if(f)break}k();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});1<=a&&m.dispatchEvent("dataAnimationEnd",{chart:m})},function(){m.disableToolTip=!1;m._animator.animate(0,
...
f=d+f;for(var d=[],g=0,h=0;h<x.length;h++){if("undefined"===typeof x[h].y)return-1;x[h].y="number"===typeof x[h].y?x[h].y:0;g+=Math.abs(x[h].y)}if(0===g)return-1;for(var l=d[0]=0,k=0,n,p,b=b-a,l=!1,h=0;h<x.length;h++)a=Math.abs(x[h].y)*f/g,l?n=0==Number(c.toFixed(3))?0:a/c:(p=$*$*b*b-4*Math.abs($)*a,0>p?(p=c,l=(b+p)*(e-k)/2,a-=l,n=e-k,k+=e-k,n+=0==p?0:a/p,k+=a/p,l=!0):(n=(Math.abs($)*b-Math.sqrt(p))/2,p=b-2*n/Math.abs($),k+=n,k>e&&(k-=n,p=c,l=(b+p)*(e-k)/2,a-=l,n=e-k,k+=e-k,n+=a/p,k+=a/p,l=!0),b=
p)),d.push(n);return d}function b(){if(s&&x){for(var a,b,c,d,e,f,h,l,k,n,p,q,m,t,v=[],A=[],u={percent:null,total:null},B=null,z=0;z<x.length;z++)t=O[z],t="undefined"!==typeof t.x5?(t.y2+t.y4)/2:(t.y2+t.y3)/2,t=g(t).x2+1,v[z]=J-t-V;t=0.5*V;for(var z=0,E=x.length-1;z<x.length||0<=E;z++,E--){b=s.reversed?x[E]:x[z];a=b.color?b.color:s.reversed?s._colorSet[(x.length-1-z)%s._colorSet.length]:s._colorSet[z%s._colorSet.length];c=b.indexLabelPlacement||s.indexLabelPlacement||"outside";d=b.indexLabelBackgroundColor||
...
s.indexLabelLineThickness:2;p=b.indexLabelLineDashType||s.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof s.indexLabelWrap?s.indexLabelWrap:!0;m=s.dataPointIds[z];y._eventManager.objectMap[m]={id:m,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:O[s.reversed?x.length-1-z:z]};"inside"===s.indexLabelPlacement&&(v[z]=z!==ca?s.reversed?O[z].x2-O[z].x1:O[z].x3-O[z].x4:O[z].x3-O[z].x6,20>v[z]&&(v[z]=z!==ca?s.reversed?
O[z].x3-O[z].x4:O[z].x2-O[z].x1:O[z].x2-O[z].x1,v[z]/=2));m=b.indexLabelMaxWidth?b.indexLabelMaxWidth:s.options.indexLabelMaxWidth?s.indexLabelMaxWidth:v[z];if(m>v[z]||0>m)m=v[z];A[z]="inside"===s.indexLabelPlacement?O[z].height:!1;u=y.getPercentAndTotal(s,b);if(s.indexLabelFormatter||b.indexLabelFormatter)B={chart:y.options,dataSeries:s,dataPoint:b,total:u.total,percent:u.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(B):b.indexLabel?y.replaceKeywordsWithValue(b.indexLabel,b,s,z):s.indexLabelFormatter?
s.indexLabelFormatter(B):s.indexLabel?y.replaceKeywordsWithValue(s.indexLabel,b,s,z):b.label?b.label:"";0>=n&&(n=0);1E3>m&&1E3-m<t&&(m+=1E3-m);R.roundRect||Ba(R);c=new ia(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:h,fontWeight:k,horizontalAlign:c,backgroundColor:d,maxWidth:m,maxHeight:!1===A[z]?q?4.28571429*f:1.5*f:A[z],text:b,padding:da});c.measureText();I.push({textBlock:c,id:s.reversed?E:z,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,
width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,h=J-Z-V/2,h=s.options.indexLabelMaxWidth?s.indexLabelMaxWidth>h?h:s.indexLabelMaxWidth:h,l=I.length-1;0<=l;l--){g=x[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<O.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||h;if(c>h||0>c)c=h;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=O[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=
J-h,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,s.reversed?(I[l].textBlock.y+I[l].height>na+C&&(I[l].textBlock.y=na+C-I[l].height),I[l].textBlock.y<sa-C&&(I[l].textBlock.y=sa-C)):(I[l].textBlock.y<na-C&&(I[l].textBlock.y=na-C),I[l].textBlock.y+
I[l].height>sa+C&&(I[l].textBlock.y=sa+C-I[l].height))}function f(){var a,b,c,d;if("inside"!==s.indexLabelPlacement)for(var e=0;e<O.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=O[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=s.reversed?"undefined"!==typeof a.x5?c>xa?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<xa?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+V,I[e].textBlock.y=c-I[e].height/2,s.reversed?(I[e].textBlock.y+I[e].height>
...
c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=n(b);d=k(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=k(b,e);if(d>=c)return f.y+=c,c;if(b==O.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,h;f=(Q-M+2*C)/p;h=p;for(var l,k=1;k<h;k++){e=k*f;for(var m=I.length-1;0<=m;m--)!I[m].isDirty&&(I[m].textBlock.y<e&&I[m].textBlock.y+I[m].height>e)&&(l=q(m),!(l>=I.length-1)&&
I[m].textBlock.y+I[m].height+da>I[l].textBlock.y&&(I[m].textBlock.y=I[m].textBlock.y+I[m].height-e>e-I[m].textBlock.y?e+1:e-I[m].height-1))}for(l=O.length-1;0<l;l--)if(!I[l].isDirty){e=n(l);if(0>e&&(e=0,I[e].isDirty))break;if(I[l].textBlock.y<I[e].textBlock.y+I[e].height){d=d||l;f=l;for(h=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;h+=I[f].height;h+=da;f=e;if(0>=f){f=0;h+=I[f].height;break}e=n(f);if(0>e){f=0;h+=I[f].height;break}}if(f!=l){g=I[f].textBlock.y;
a-=g;a=h-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(O[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,h,l,p=1,m=0;m<2*p;m++){for(var s=I.length-1;0<=s&&!(0<=n(s)&&n(s),f=I[s],g=f.textBlock,l=(h=q(s)<O.length?I[q(s)]:null)?h.textBlock:null,d=
+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(h&&e+d+da>+l.y.toFixed(6))&&(d=g.y+d+da-l.y,e=a(s,-d),e<d&&(0<e&&(d-=e),e=a(q(s),d),e!=d)));s--);b()}}function k(a,b){return(b<O.length?I[b].textBlock.y:s.reversed?na+C:sa+C)-(0>a?s.reversed?sa-C:na-C:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],k=C,n=[];-1!==b&&(0<=Y.indexOf(b)?(e=Y.indexOf(b),Y.splice(e,1)):(Y.push(b),Y=Y.sort(function(a,b){return a-b})));if(0===Y.length)l=ga;else{e=C*(1!=Y.length||0!=Y[0]&&Y[0]!=O.length-
1?2:1)/h();for(var q=0;q<O.length;q++){if(1==Y.length&&0==Y[0]){if(0===q){l.push(ga[q]);d=k;continue}}else 0===q&&(d=-1*k);l.push(ga[q]+d);if(0<=Y.indexOf(q)||q<O.length&&0<=Y.indexOf(q+1))d+=e}}g=function(){for(var a=[],b=0;b<O.length;b++)a.push(l[b]-O[b].y1);return a}();var t={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return L.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<O.length;d++)b=g[d],c=O[d],b*=a,"undefined"===typeof n[d]&&
...
Y.push(x.length-1-G):Y.push(G));R.clearRect(E.x1,E.y1,E.width,E.height);R.fillStyle=y.backgroundColor;R.fillRect(E.x1,E.y1,E.width,E.height);if(H&&s.visible&&(b(),f(),e(),"inside"!==s.indexLabelPlacement)){l();for(G=0;G<x.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(J-a)/2,0==G&&(B=a),B>a&&(B=a));for(G=0;G<O.length;G++)O[G].x1+=B,O[G].x2+=B,O[G].x3+=B,O[G].x4+=B,O[G].x5&&(O[G].x5+=B,O[G].x6+=B),I[G].textBlock.x+=B}for(G=0;G<O.length;G++)B=O[G],qa(R,B,s.fillOpacity),ga.push(B.y1);u(R);
H&&s.visible&&("inside"===s.indexLabelPlacement||y.animationEnabled||p(R),y.animationEnabled||v());if(!H)for(G=0;G<x.length;G++)B=s.dataPointIds[G],a={id:B,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:O[s.reversed?x.length-1-G:G]},y._eventManager.objectMap[B]=a;!y.animationEnabled&&P?m(y,-1,0):y.animationEnabled&&!y.animatedRender&&m(y,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ha&&!y.isAnimating&&(r(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&
(b=s.reversed?x.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===s.type||"pyramid"===s.type)s.reversed?x[x.length-1-a].exploded=x[x.length-1-a].exploded?!1:!0:x[a].exploded=x[a].exploded?!1:!0;m(y,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){L.fadeInAnimation(a,b);1<=a&&(m(y,-1,500),u(y.plotArea.ctx||y.ctx))},easingFunction:L.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||
...
a.dataPoints.length;c++)isNaN(a.dataPoints[c].y)||(b+=a.dataPoints[c].y);e=isNaN(d.y)?0:100*(d.y/b)}return{percent:e,total:b}};m.prototype.replaceKeywordsWithValue=function(a,d,c,b,e){var f=this;e="undefined"===typeof e?0:e;if((0<=c.type.indexOf("stacked")||"pie"===c.type||"doughnut"===c.type||"funnel"===c.type||"pyramid"===c.type)&&(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))){var l="#percent",k="#total",m=this.getPercentAndTotal(c,d),k=isNaN(m.total)?k:m.total,l=isNaN(m.percent)?l:m.percent;
do{m="";if(c.percentFormatString)m=c.percentFormatString;else{var m="#,##0.",h=Math.max(Math.ceil(Math.log(1/Math.abs(l))/Math.LN10),2);if(isNaN(h)||!isFinite(h))h=2;for(var p=0;p<h;p++)m+="#";c.percentFormatString=m}a=a.replace("#percent",ea(l,m,f._cultureInfo));a=a.replace("#total",ea(k,c.yValueFormatString?c.yValueFormatString:"#,##0.########",f._cultureInfo))}while(0<=a.indexOf("#percent")||0<=a.indexOf("#total"))}return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g,function(a){if('"'===a[0]&&'"'===a[a.length-
1]||"'"===a[0]&&"'"===a[a.length-1])return a.slice(1,a.length-1);a=Ga(a.slice(1,a.length-1));a=a.replace("#index",e);var h=null;try{var g=a.match(/(.*?)\s*\[\s*(.*?)\s*\]/);g&&0<g.length&&(h=Ga(g[2]),a=Ga(g[1]))}catch(l){}g=null;if("color"===a)return"waterfall"===c.type?d.color?d.color:0<d.y?c.risingColor:c.fallingColor:"error"===c.type?c.color?c.color:c._colorSet[h%c._colorSet.length]:d.color?d.color:c.color?c.color:c._colorSet[b%c._colorSet.length];if(d.hasOwnProperty(a))g=d;else if(c.hasOwnProperty(a))g=
c;else return"";g=g[a];null!==h&&(g=g[h]);if("x"===a)if("dateTime"===c.axisX.valueType||"dateTime"===c.xValueType||d.x&&d.x.getTime){if(!c.axisX.logarithmic)return Aa(g,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString=f.axisX&&f.axisX.autoValueFormatString?f.axisX.autoValueFormatString:"DD MMM YY",f._cultureInfo)}else return ea(g,d.xValueFormatString?d.xValueFormatString:c.xValueFormatString?c.xValueFormatString:c.xValueFormatString="#,##0.########",
f._cultureInfo);else return"y"===a?ea(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?ea(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};oa(F,V);F.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,k=this.markerMargin=
this.chart.options.legend&&!r(this.chart.options.legend.markerMargin)?this.chart.options.legend.markerMargin:0.3*this.fontSize;this.height=0;var m=[],h=[];"top"===this.verticalAlign||"bottom"===this.verticalAlign?(this.orientation="horizontal",c=this.verticalAlign,f=this.maxWidth=null!==this.maxWidth?this.maxWidth:d.width,l=this.maxHeight=null!==this.maxHeight?this.maxHeight:0.5*d.height):"center"===this.verticalAlign&&(this.orientation="vertical",c=this.horizontalAlign,f=this.maxWidth=null!==this.maxWidth?
this.maxWidth:0.5*d.width,l=this.maxHeight=null!==this.maxHeight?this.maxHeight:d.height);this.errorMarkerColor=[];for(var p=0;p<this.dataSeries.length;p++){var n=this.dataSeries[p];if(n.dataPoints&&n.dataPoints.length)if("pie"!==n.type&&"doughnut"!==n.type&&"funnel"!==n.type&&"pyramid"!==n.type){var q=n.legendMarkerType=n.legendMarkerType?n.legendMarkerType:"line"!==n.type&&"stepLine"!==n.type&&"spline"!==n.type&&"scatter"!==n.type&&"bubble"!==n.type||!n.markerType?"error"===n.type&&n._linkedSeries?
n._linkedSeries.legendMarkerType?n._linkedSeries.legendMarkerType:H.getDefaultLegendMarker(n._linkedSeries.type):H.getDefaultLegendMarker(n.type):n.markerType,g=n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:null}):n.name,v=n.legendMarkerColor=n.legendMarkerColor?n.legendMarkerColor:n.markerColor?n.markerColor:"error"===n.type?r(n.whiskerColor)?n._colorSet[0]:n.whiskerColor:n._colorSet[0],w=n.markerSize||"line"!==
n.type&&"stepLine"!==n.type&&"spline"!==n.type?0.75*this.lineHeight:0,u=n.legendMarkerBorderColor?n.legendMarkerBorderColor:n.markerBorderColor,s=n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:n.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0;"error"===n.type&&this.errorMarkerColor.push(v);g=this.chart.replaceKeywordsWithValue(g,n.dataPoints[0],n,p);q={markerType:q,markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:w,lineColor:n._colorSet[0],dataSeriesIndex:n.index,
dataPointIndex:null,markerBorderColor:u,markerBorderThickness:s};m.push(q)}else for(var x=0;x<n.dataPoints.length;x++){var y=n.dataPoints[x],q=y.legendMarkerType?y.legendMarkerType:n.legendMarkerType?n.legendMarkerType:H.getDefaultLegendMarker(n.type),g=y.legendText?y.legendText:n.legendText?n.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:n,dataPoint:y}):y.name?y.name:"DataPoint: "+(x+1),v=y.legendMarkerColor?y.legendMarkerColor:n.legendMarkerColor?
n.legendMarkerColor:y.color?y.color:n.color?n.color:n._colorSet[x%n._colorSet.length],w=0.75*this.lineHeight,u=y.legendMarkerBorderColor?y.legendMarkerBorderColor:n.legendMarkerBorderColor?n.legendMarkerBorderColor:y.markerBorderColor?y.markerBorderColor:n.markerBorderColor,s=y.legendMarkerBorderThickness?y.legendMarkerBorderThickness:n.legendMarkerBorderThickness?n.legendMarkerBorderThickness:y.markerBorderThickness||n.markerBorderThickness?Math.max(1,Math.round(0.2*w)):0,g=this.chart.replaceKeywordsWithValue(g,
y,n,x),q={markerType:q,markerColor:v,text:g,textBlock:null,chartType:n.type,markerSize:w,dataSeriesIndex:p,dataPointIndex:x,markerBorderColor:u,markerBorderThickness:s};(y.showInLegend||n.showInLegend&&!1!==y.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){n=null;v=g=y=x=0;y=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=
f;w=0===w?0.75*this.lineHeight:w;y-=w+k;for(p=0;p<m.length;p++){q=m[p];u=y;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)u-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=u||"undefined"===typeof u)){if("horizontal"===this.orientation){q.textBlock=new ia(this.ctx,{x:0,y:0,maxWidth:u,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,
fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(w+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!n||n.width+Math.round(q.textBlock.width+w+k+(0===n.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))>f)n={items:[],width:0},h.push(n),this.height+=g,g=0;g=Math.max(g,q.textBlock.height)}else q.textBlock=
new ia(this.ctx,{x:0,y:0,maxWidth:y,maxHeight:!0===this.itemWrap?l:1.5*this.fontSize,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"}),q.textBlock.measureText(),null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(w+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))),this.height<l-this.lineHeight?(n={items:[],
width:0},h.push(n)):(n=h[x],x=(x+1)%h.length),this.height+=q.textBlock.height;q.textBlock.x=n.width;q.textBlock.y=0;n.width+=Math.round(q.textBlock.width+w+k+(0===n.width?0:this.horizontalSpacing)+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));n.items.push(q);this.width=Math.max(n.width,this.width);v=q.textBlock.width+(w+k+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=v;this.height=
...
r=d+k,w=g;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,d,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(g-0.1*this.lineHeight,r+this.lineHeight/2),this.ctx.lineTo(g+0.85*this.lineHeight,r+this.lineHeight/2),this.ctx.stroke(),w-=
...
2}k+=p}};oa(H,V);H.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===
...
Math.abs(q.x1-a);q<=m?m=q:0<l?h++:p++;r<=w/2&&(k=!0);break;case "rangeArea":case "rangeSplineArea":w=la("markerSize",g,this)||4;u=c?20:w;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=u&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?h++:p++;r<=w/2&&(k=!0);break;case "bubble":w=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=w/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
distance:r}),k=!0);break;case "pie":case "doughnut":w=q.center;u="doughnut"===this.type?q.percentInnerRadius*q.radius:0;r=Math.sqrt(Math.pow(w.x-a,2)+Math.pow(w.y-d,2));r<q.radius&&r>u&&(r=Math.atan2(d-w.y,a-w.x),0>r&&(r+=2*Math.PI),r=Number(((180*(r/Math.PI)%360+360)%360).toFixed(12)),w=Number(((180*(q.startAngle/Math.PI)%360+360)%360).toFixed(12)),u=Number(((180*(q.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===u&&1<q.endAngle&&(u=360),w>=u&&0!==g.y&&(u+=360,r<w&&(r+=360)),r>w&&r<u&&(b.push({dataPoint:g,
...
Math.abs(q.x2-a),Math.abs(q.y2-d),Math.abs(q.y3-d))}),k=!0}if(k||1E3<h&&1E3<p)break}}else if(0>n-e&&n+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}a=null;for(d=0;d<b.length;d++)a?b[d].distance<=a.distance&&(a=b[d]):a=b[d];return a};H.prototype.getMarkerProperties=function(a,d,c,b){var e=this.dataPoints;return{x:d,y:c,ctx:b,type:e[a].markerType?e[a].markerType:this.markerType,size:e[a].markerSize?e[a].markerSize:this.markerSize,color:e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:
...
-25,this.sessionVariables.labelMaxWidth=p):b>5*f&&(this.sessionVariables.labelWrap=!0,this.sessionVariables.labelMaxWidth=f,this.sessionVariables.labelFontSize=g,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelAngle=this.labelAngle));else if(u===c&&(0===u&&q+this._labels[u+1].textBlock.measureText().width-2*f>n||u===this._labels.length-1&&q+this._labels[u-1].textBlock.measureText().width-2*f>n||0<u&&u<this._labels.length-1&&q+this._labels[u+1].textBlock.measureText().width-2*f>n&&
...
l=Math.round(f.x1+O+K);m=Math.round(f.x2-$-Z>p.width-n?p.width-n:f.x2-$-Z);if(a&&0<a.length)for(x=[],g=U=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(m-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),x.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),U+=x[g],e+=a[g]&&!p.isNavigator?a[g].margin:0;else x.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
...
0;g<a.length;g++)a[g]&&(a[g].lineCoordinates.x1=l,m=Math.round(f.x2-$-Z>p.width-n?p.width-n:f.x2-$-Z),a[g]._labels&&1<a[g]._labels.length&&(k=h=0,h=a[g]._labels[1],k="dateTime"===a[g].valueType?a[g]._labels[a[g]._labels.length-2]:a[g]._labels[a[g]._labels.length-1],u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),s=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-
k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||r(B)||r(D)||p.isNavigator||p.stockChart)||(k=0,0<a[g].labelAngle?D+s>m&&(k+=0<a[g].labelAngle?D+s-m-$:0):0>a[g].labelAngle?B-u<l&&B-u<a[g].viewportMinimum&&(F=l-(K+a[g].tickLength+C+B-u+a[g].labelFontSize/2)):0===a[g].labelAngle&&(D+s>m&&(k=D+s/2-m-$),B-u<l&&B-u<a[g].viewportMinimum&&(F=l-K-a[g].tickLength-C-B+u/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<k?m-=k:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<F?l+=F:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<F&&(l+=F),0<k&&(m-=k))),p.panEnabled?U=r(p.sessionVariables.axisX.height)?p.sessionVariables.axisX.height=U:p.sessionVariables.axisX.height:p.sessionVariables.axisX.height=U,k=Math.round(f.y2-U-e+G),h=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
k,a[g].lineCoordinates.y2=k+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+x[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:k,x2:m,y2:h-(U+e-x[g]-G),width:m-l,height:h-k}),G+=x[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+O+K),d[g].lineCoordinates.x2=
Math.round(f.x2-$-Z>p.width-n?p.width-n:f.x2-$-Z),d[g].lineCoordinates.width=Math.abs(m-l),d[g]._labels&&1<d[g]._labels.length&&(h=d[g]._labels[1],k="dateTime"===d[g].valueType?d[g]._labels[d[g]._labels.length-2]:d[g]._labels[d[g]._labels.length-1],u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)),s=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-
k.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle))),p.panEnabled?W=r(p.sessionVariables.axisX2.height)?p.sessionVariables.axisX2.height=W:p.sessionVariables.axisX2.height:p.sessionVariables.axisX2.height=W,k=Math.round(f.y1),h=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=k+W+X-T,d[g].lineCoordinates.y2=k,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-y[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:k+(W+
X-y[g]-T),x2:m,y2:h,width:m-l,height:h-k},T+=y[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)K=p.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),K=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:n,k=Math.round(f.y1+W+X<Math.max(K,n)?Math.max(K,n):f.y1+W+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),K=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:n,h=Math.round(f.y2-U-e-K),c[g].lineCoordinates={x1:l-V,y1:k,x2:m-V,y2:h,height:Math.abs(h-k)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(C[g]-c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(C[g]+V),y1:k,x2:m,y2:h,width:m-l,height:h-k},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),V+=C[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),K=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,k=Math.round(f.y1+W+X<Math.max(K,n)?Math.max(K,n):f.y1+W+X),K=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,h=Math.round(f.y2-(U+e+K)),b[g].lineCoordinates=
{x1:l+Y,y1:k,x2:l+Y,y2:h,height:Math.abs(h-k)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(z[g]-b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:k,x2:m+(z[g]+Y),y2:h,width:m-l,height:h-k},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)v=M[w-1][g]===M[w][g]?!0:!1;else v=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=N[w-1][g]===N[w][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=Q[w-1][g]===Q[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)L=R[w-
...
0));N.push(u);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+Y+e),m=Math.round(f.x2-U-X>p.width-10?p.width-10:f.x2-U-X),c[g].labelAutoFit&&!r(x)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,x):0===c[g].labelAngle?Math.max(l,x/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-y/2:0===c[g].labelAngle?m-y/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+Y+e),m=Math.round(f.x2-U-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-U-X),b[g]&&b[g].labelAutoFit&&!r(C)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,C):0===b[g].labelAngle?Math.max(l,C/2):l),0<!d.length&&(m-=z/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
...
p.sessionVariables.axisY.height=n[g]:p.sessionVariables.axisY.height;else for(g=0;g<c.length;g++)p.sessionVariables.axisY.height=n[g];if(c&&0<c.length)for(g=c.length-1;0<=g;g--)k=Math.round(f.y2),h=Math.round(f.y2>c[g].chart.height?c[g].chart.height:f.y2),c[g].lineCoordinates.y1=k-(n[g]+c[g].margin+W),c[g].lineCoordinates.y2=k-(n[g]+c[g].margin+W),"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.y1=c[g].lineCoordinates.y1+n[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0)-("inside"===
c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:k-(n[g]+W+c[g].margin),x2:m,y2:h-(W+c[g].margin),width:m-l,height:n[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),W+=n[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(k=Math.round(f.y1),h=Math.round(f.y1+(B[g]+b[g].margin+G)),b[g].lineCoordinates.y1=
h,b[g].lineCoordinates.y2=h,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=h-B[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)),b[g].bounds={x1:l,y1:k+(b[g].margin+G),x2:m,y2:h,width:m-l,height:T},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),G+=B[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){K=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/
2:0;l=Math.round(f.x1+e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(K,10)?Math.max(K,10):f.y1):f.y1<Math.max(K,10)?Math.max(K,10):f.y1;m=Math.round(f.x1+Y+e);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-V>p.height-Math.max(K,10)?p.height-Math.max(K,10):f.y2-V):f.y2>p.height-Math.max(K,10)?p.height-Math.max(K,10):f.y2;if(c&&0<c.length)for(K=0;K<c.length;K++)c[K]&&c[K].labelAutoFit&&(m=0>c[K].labelAngle?Math.max(m,x):0===c[K].labelAngle?Math.max(m,x/2):m,l=
0>c[K].labelAngle||0===c[K].labelAngle?m-Y:l);if(b&&0<b.length)for(K=0;K<b.length;K++)b[K]&&b[K].labelAutoFit&&(m=b[K].lineCoordinates.x1,l=m-Y);a[g].lineCoordinates={x1:m-Q,y1:k,x2:m-Q,y2:h,height:Math.abs(h-k)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(F[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(F[g]+
Q),y1:k,x2:m,y2:h,width:m-l,height:h-k};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();Q+=F[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){K=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);k=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(K,10)?Math.max(K,10):f.y1):f.y1<Math.max(K,10)?Math.max(K,10):f.y1;m=Math.round(f.x2-U-X);h=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-V>p.height-Math.max(K,10)?p.height-Math.max(K,10):f.y2-V):f.y2>p.height-Math.max(K,10)?p.height-Math.max(K,10):f.y2;if(c&&0<c.length)for(K=0;K<c.length;K++)c[K]&&c[K].labelAutoFit&&(m=0>c[K].labelAngle?Math.max(m,x):0===c[K].labelAngle?Math.max(m,x/2):m,l=0>c[K].labelAngle||0===c[K].labelAngle?m-U:l);if(b&&0<b.length)for(K=0;K<b.length;K++)b[K]&&
b[K].labelAutoFit&&(m=b[K].lineCoordinates.x2,l=m-U);d[g].lineCoordinates={x1:m+R,y1:k,x2:m+R,y2:h,height:Math.abs(h-k)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(u[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:k,x2:m+u[g]+R,y2:h,width:m-l,height:h-k};d[g].title&&(d[g]._titleTextBlock.maxWidth=
...
this.chart.toolTip&&this.chart.toolTip._entries&&this.chart.toolTip.highlightObjects(this.chart.toolTip._entries);return c};$.prototype.hide=function(){this.chart.resetOverlayedCanvas();this.chart.renderCrosshairs(this.parent);this._hidden=!0};$.prototype.render=function(a,d,c){var b,e,f,k,m=null,w=null,h=null,p="";if(!this.valueFormatString)if("dateTime"===this.parent.valueType)this.valueFormatString=this.parent.valueFormatString;else{var n=0,n="xySwapped"===this.chart.plotInfo.axisPlacement?50<
...
for(v=s=0;v<x.dataPoint.y.length;v++)s=Math.abs(a-this.parent.convertValueToPixel(x.dataPoint.y[v])),s<u&&(u=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;this.value=x.dataPoint.y[b];h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):r(this.options.label)?ea(c?c:x.dataPoint.y[b],this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[y].type){u=Math.abs(a-this.parent.convertValueToPixel(p[0].dataPoint.y));E=s=0;for(v=y;0<=v;v--)E+=p[v].dataPoint.y,s=Math.abs(a-this.parent.convertValueToPixel(E)),s<u&&(u=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(E)<<0)+0.5:this.parent.convertValueToPixel(E)<<0;this.value=E;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y}):r(this.options.label)?
ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[y].type){u=Math.abs(a-this.parent.convertValueToPixel(p[0].dataPoint.y));C=E=s=0;for(v=y;0<=v;v--)E+=p[v].dataPoint.y,C=p[v].dataPoint.x.getTime?p[v].dataPoint.x.getTime():p[v].dataPoint.x,C=100*(E/p[v].dataSeries.plotUnit.dataPointYSums[C]),s=Math.abs(a-this.parent.convertValueToPixel(C)),s<u&&(u=s,b=v);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<
0;this.value=C;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):r(this.options.label)?ea(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y)<<0,this.value=x.dataPoint.y,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:c?c:x.dataPoint.y}):r(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;k=this.chart.plotArea.y2;this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:k};h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2?h.x=this.chart.bounds.x2-h.width:h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);h.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-h.height+this.parent.tickLength:h.fontSize/2)+2;h.y+h.height>
this.chart.bounds.y2?h.y=this.chart.bounds.y2-h.height:h.y<this.chart.bounds.y1&&(h.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){f=k=w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-n/2,x2:e,y2:k+n/2};C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=
p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:d}),u=null,y=0;y<this.parent.dataSeries.length;y++)(u=this.parent.dataSeries[y].getDataPointAtX(v,!0))&&0<=u.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):r(this.options.label)?Aa(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.x}):r(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=x.dataPoint.x;h.y=k+h.fontSize/2-h.measureText().height/
2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2+2:h.y+h.measureText().height-h.fontSize/2>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.measureText().height+h.fontSize/2);"left"===this.parent._position?h.x=this.parent.lineCoordinates.x2-h.measureText().width:"right"===this.parent._position&&(h.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){v=this.parent.convertPixelToValue({x:a});for(y=0;y<this.parent.dataSeries.length;y++)(u=
this.parent.dataSeries[y].getDataPointAtX(v,!0))&&0<=u.index&&(u.dataSeries=this.parent.dataSeries[y],null!==u.dataPoint.y&&u.dataSeries.visible&&p.push(u));if(0===p.length)return;p.sort(function(a,b){return a.distance-b.distance});x=p[0];b=e=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.x)<<0;f=this.chart.plotArea.y1;k=this.chart.plotArea.y2;this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:k};C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),
...
h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?Aa(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.x}):r(this.options.label)?ea(c?c:x.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
...
Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[0]));for(v=s=0;v<x.dataPoint.y.length;v++)s=Math.abs(d-this.parent.convertValueToPixel(x.dataPoint.y[v])),s<u&&(u=s,b=v);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(x.dataPoint.y[b])<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataPoint.y[b]}):r(this.options.label)?ea(c?c:x.dataPoint.y[b],this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=x.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[y].type||"stackedArea"===this.parent.dataSeries[y].type){u=Math.abs(d-this.parent.convertValueToPixel(p[0].dataPoint.y));E=s=0;for(v=y;0<=v;v--)E+=p[v].dataPoint.y,s=Math.abs(d-this.parent.convertValueToPixel(E)),s<u&&(u=s,b=v);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(E)<<0)+0.5:this.parent.convertValueToPixel(E)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
...
s=Math.abs(d-this.parent.convertValueToPixel(C)),s<u&&(u=s,b=v);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(C)<<0)+0.5:this.parent.convertValueToPixel(C)<<0;h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:C}):r(this.options.label)?ea(c?c:C,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=C}else"waterfall"===this.parent.dataSeries[y].type?(w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<
0)+0.5:this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum}):r(this.options.label)?ea(c?c:x.dataSeries.dataPointEOs[x.index].cumulativeSum,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataSeries.dataPointEOs[x.index].cumulativeSum):(w=1===q.lineWidth%2?(r(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<
0)+0.5:r(a)?d:this.parent.convertValueToPixel(x.dataPoint.y)<<0,h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:x.dataPoint.y}):r(this.options.label)?ea(c?c:x.dataPoint.y,this.valueFormatString,this.chart._cultureInfo):this.label,this.value=x.dataPoint.y);f=k=w;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-n/2,x2:e,y2:k+n/2};h.y=k+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?
...
2),"bottom"===this.parent._position&&this.parent.lineCoordinates.y2-h.fontSize/2+h.measureText().height>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.height+h.fontSize/2+2),b>=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMaximum:this.parent.viewportMinimum)&&e<=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMinimum:this.parent.viewportMaximum)&&(0<n&&(q.moveTo(b,f),q.lineTo(e,k),q.stroke(),this._hidden=!1),q.restore(),!r(h.text)&&("number"===
typeof h.text.valueOf()||0<h.text.length)&&h.render(!0));if("left"===this.parent._position||"right"===this.parent._position)"left"===this.parent._position&&h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1),"right"===this.parent._position&&h.x+h.measureText().width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.measureText().width),k>=this.parent.convertValueToPixel(this.parent.reversed?this.parent.viewportMinimum:this.parent.viewportMaximum)&&f<=this.parent.convertValueToPixel(this.parent.reversed?
this.parent.viewportMaximum:this.parent.viewportMinimum)&&(0<n&&(q.moveTo(b,f),q.lineTo(e,k),q.stroke(),this._hidden=!1),q.restore(),!r(h.text)&&("number"===typeof h.text.valueOf()||0<h.text.length)&&h.render(!0))}else{if("bottom"===this.parent._position||"top"===this.parent._position)b=e=m=1===q.lineWidth%2?(a<<0)+0.5:a<<0,f=this.chart.plotArea.y1,k=this.chart.plotArea.y2,this.bounds={x1:b-n/2,y1:f,x2:e+n/2,y2:k};else if("left"===this.parent._position||"right"===this.parent._position)f=k=w=1===q.lineWidth%
2?(d<<0)+0.5:d<<0,b=this.chart.plotArea.x1,e=this.chart.plotArea.x2,this.bounds={x1:b,y1:f-n/2,x2:e,y2:k+n/2};if("xySwapped"===this.chart.plotInfo.axisPlacement)if("left"===this.parent._position||"right"===this.parent._position){C=!1;if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({y:d}),u=null,y=0;y<this.parent.dataSeries.length;y++)(u=
this.parent.dataSeries[y].getDataPointAtX(v,!0))&&0<=u.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(a)}):r(this.options.label)?u.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):r(this.options.label)?Aa(c?
c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):r(this.options.label)?ea(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label);h.y=d+h.fontSize/2-h.measureText().height/2+2;h.y-h.fontSize/2<this.chart.bounds.y1?h.y=
...
value:c?c:this.parent.convertPixelToValue(a)}):r(this.options.label)?ea(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label,h.x=b-h.measureText().width/2,h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width),h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1),"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("bottom"===
this.parent._position||"top"===this.parent._position){C=!1;p="";if(this.parent.labels)for(p=Math.ceil(this.parent.interval),v=0;v<this.parent.viewportMaximum;v+=p)if(this.parent.labels[v])C=!0;else{C=!1;break}if(C){if("axisX"===this.parent.type)for(v=this.parent.convertPixelToValue({x:a}),u=null,y=0;y<this.parent.dataSeries.length;y++)(u=this.parent.dataSeries[y].getDataPointAtX(v,!0))&&0<=u.index&&(h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
...
axis:this.parent.options,crosshair:this.options,value:c?c:0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):""}):r(this.options.label)?ea(c?c:this.parent.convertPixelToValue(a),this.valueFormatString,this.chart._cultureInfo):this.label);h.x=b-h.measureText().width/2;h.x+h.width>this.chart.bounds.x2&&(h.x=this.chart.bounds.x2-h.width);h.x<this.chart.bounds.x1&&(h.x=this.chart.bounds.x1);"bottom"===this.parent._position?h.y=this.parent.lineCoordinates.y2+h.fontSize/2+2:"top"===this.parent._position&&
(h.y=this.parent.lineCoordinates.y1-h.height+h.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position)h.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:c?c:this.parent.convertPixelToValue(d)}):r(this.options.label)?ea(c?c:this.parent.convertPixelToValue(d),this.valueFormatString,this.chart._cultureInfo):this.label,h.y=d+h.fontSize/2-h.measureText().height/2+2,h.y-h.fontSize/2<this.chart.bounds.y1?h.y=
...
h.measureText().width:"top"===this.parent._position&&h.y-h.fontSize/2<this.chart.bounds.y1?h.y=this.chart.bounds.y1+h.fontSize/2:"bottom"===this.parent._position&&this.parent.lineCoordinates.y2-h.fontSize/2+h.measureText().height>this.chart.bounds.y2&&(h.y=this.chart.bounds.y2-h.height+h.fontSize/2+2);0<n&&(q.moveTo(b,f),q.lineTo(e,k),q.stroke(),this._hidden=!1);q.restore();!r(h.text)&&("number"===typeof h.text.valueOf()||0<h.text.length)&&h.render(!0);this.value="bottom"===this.parent._position||
"top"===this.parent._position?this.parent.convertPixelToValue(a):this.parent.convertPixelToValue(d)}if("bottom"===this.parent._position||"top"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(m);if("left"===this.parent._position||"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(w);q.globalAlpha=g};oa(X,V);X.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");
...
this.chart.resetOverlayedCanvas(),this._updateToolTip(a,d))};X.prototype._updateToolTip=function(a,d,c){c="undefined"===typeof c?!0:c;this.container||this._initialize();this.enabled||(this.hide(),this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this));if(!this.chart.disableToolTip){if("undefined"===typeof a||"undefined"===typeof d){if(isNaN(this._prevX)||isNaN(this._prevY))return;a=this._prevX;d=this._prevY}else this._prevX=a,this._prevY=d;var b=null,e=null,f=[],k=0;if(this.shared&&this.enabled&&
"none"!==this.chart.plotInfo.axisPlacement){if("xySwapped"===this.chart.plotInfo.axisPlacement){var m=[];if(this.chart.axisX)for(var u=0;u<this.chart.axisX.length;u++){for(var k=this.chart.axisX[u].convertPixelToValue({y:d}),h=null,b=0;b<this.chart.axisX[u].dataSeries.length;b++)(h=this.chart.axisX[u].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&(h.dataSeries=this.chart.axisX[u].dataSeries[b],null!==h.dataPoint.y&&m.push(h));h=null}if(this.chart.axisX2)for(u=0;u<this.chart.axisX2.length;u++){k=
this.chart.axisX2[u].convertPixelToValue({y:d});h=null;for(b=0;b<this.chart.axisX2[u].dataSeries.length;b++)(h=this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&(h.dataSeries=this.chart.axisX2[u].dataSeries[b],null!==h.dataPoint.y&&m.push(h));h=null}}else{m=[];if(this.chart.axisX)for(u=0;u<this.chart.axisX.length;u++)for(k=this.chart.axisX[u].convertPixelToValue({x:a}),h=null,b=0;b<this.chart.axisX[u].dataSeries.length;b++)(h=this.chart.axisX[u].dataSeries[b].getDataPointAtX(k,
c))&&0<=h.index&&(h.dataSeries=this.chart.axisX[u].dataSeries[b],null!==h.dataPoint.y&&m.push(h));if(this.chart.axisX2)for(u=0;u<this.chart.axisX2.length;u++)for(k=this.chart.axisX2[u].convertPixelToValue({x:a}),h=null,b=0;b<this.chart.axisX2[u].dataSeries.length;b++)(h=this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k,c))&&0<=h.index&&(h.dataSeries=this.chart.axisX2[u].dataSeries[b],null!==h.dataPoint.y&&m.push(h))}if(0===m.length)return;m.sort(function(a,b){return a.distance-b.distance});c=m[0];
for(b=0;b<m.length;b++)m[b].dataPoint.x.valueOf()===c.dataPoint.x.valueOf()&&f.push(m[b]);m=null}else{if(h=this.chart.getDataPointAtXY(a,d,c))this.currentDataPointIndex=h.dataPointIndex,this.currentSeriesIndex=h.dataSeries.index;else if(w)if(h=$a(a,d,this.chart._eventManager.ghostCtx),0<h&&"undefined"!==typeof this.chart._eventManager.objectMap[h]){h=this.chart._eventManager.objectMap[h];if("legendItem"===h.objectType)return;this.currentSeriesIndex=h.dataSeriesIndex;this.currentDataPointIndex=0<=
...
else{if(!this.enabled||"line"!==e.type&&"stepLine"!==e.type&&"spline"!==e.type&&"area"!==e.type&&"stepArea"!==e.type&&"splineArea"!==e.type&&"stackedArea"!==e.type&&"stackedArea100"!==e.type&&"rangeArea"!==e.type&&"rangeSplineArea"!==e.type&&"candlestick"!==e.type&&"ohlc"!==e.type&&"boxAndWhisker"!==e.type)return;k=e.axisX.convertPixelToValue({x:a});h=e.getDataPointAtX(k,c);r(h)||(h.dataSeries=e,this.currentDataPointIndex=h.index,b=h.dataPoint)}if(!r(h)&&!r(h.dataPoint)&&!r(h.dataPoint.y))if(h.dataSeries.axisY)if(0<
...
c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();y.version="v3.2.11 GA";window.CanvasJS&&(y&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=y)})();
