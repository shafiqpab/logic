...
<script>
	...
	{      
        ...
        var data1="action=save_update_delete&operation="+operation+"&row_num="+row_num+get_submitted_data_string('update_id*update_tbl_id*txt_job_no*txt_batch_no*cbo_company_name*cbo_working_company_name*cbo_floor_name*cbo_location_name*txt_cutting_no*txt_table_no*txt_entry_date*txt_marker_length*txt_other_fabric_weight*txt_marker_width*txt_fabric_width*txt_gsm*txt_cutting_no*txt_in_time_hours*txt_in_time_minuties*txt_out_time_hours*txt_out_time_minuties*txt_end_date*cbo_width_dia*cbo_shift_name*txt_marker_cons*roll_maintained',"../../");
		//alert(row_num)
	    var data2='';
		for(var i=1; i<=row_num; i++)
		{
	...
	function openmypage_roll(row_no)
	{
		...
		var page_link = 'requires/cut_and_lay_ratio_wise_entry_controller_urmi.php?roll_maintained='+roll_maintained+'&order_no='+order_no+'&color='+color+'&rollData='+rollData+'&action=roll_popup';
                        ...
                        <table  width="1050" cellspacing="2" cellpadding="0" border="0">
                         <tr>
                          ...
                          <tr>
                               ...
                               <td><input style="width:130px;" type="text"  class="text_boxes" name="txt_other_fabric_weight" id="txt_other_fabric_weight" /></td>
                          ...
                          <tr>
                               <td  width="" >Shift</td>
                                <td width="" >
                                	<? echo create_drop_down( "cbo_shift_name", 152, $shift_name,"", 1, "-- Select --", "", "",$disabled,"" ); ?>
                                </td>
                            </tr>
                      </table>
                 </fieldset>
