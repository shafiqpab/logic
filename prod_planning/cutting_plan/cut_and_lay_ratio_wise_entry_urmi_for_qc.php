...
<script>
	...
	function openmypage_jobNo(id)
	{
		...
		var page_link = 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php?cbo_company_id='+cbo_company_id+'&action=job_search_popup';
		...
		emailwindow.onclose=function()
		{
			...
			load_drop_down('requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', job_no[0]+'_'+1, 'load_drop_down_color','color_1');
			load_drop_down('requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', job_no[0]+'_'+1, 'load_drop_down_order_garment','garment_1');
	...
	function openmypage_po(row_no)
	{
		...
		var page_link = 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php?txt_job='+txt_job+'&cbocolor='+cbocolor+'&gmt_id='+gmt_id+'&poId='+poId+'&action=po_popup';
		...
		emailwindow.onclose=function()
		{
			...
			load_drop_down('requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', po_id+"_"+cbocolor+"_"+row_no, 'load_drop_down_batch', 'batch_'+row_no);
			
			
			load_drop_down( 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', po_id+"_"+row_no+"_"+cbocolor+"_"+gmt_id, 'load_drop_down_color_type', 'colorTypeId_'+row_no);
			...
			get_php_form_data( po_id+"_"+gmt_id+"_"+cbocolor+"_"+row_no, "load_drop_down_order_qty", "requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc" );
		}
	}
    ...
    { 
		...
		load_drop_down( 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', value+"_"+ship_id, 'load_drop_down_ship', ship_id);
		load_drop_down( 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', value+"_"+gmt_id, 'load_drop_down_order_garment', gmt_id);
	...
	function change_color(id,value)
	{
		...
		load_drop_down('requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', order_id+"_"+value+"_"+id[1], 'load_drop_down_color', color_id);
	...
	function change_marker(id,value)
	{
		...
		get_php_form_data( order_id+"_"+gmt_id+"_"+value+"_"+id[1], "load_drop_down_order_qty", "requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc" );
		load_drop_down('requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', order_id+"_"+value+"_"+id[1], 'load_drop_down_batch', 'batch_'+id[1]);
	...
	//	$("#tbl_order_details tbody tr_"+size).css({"background-color":"red"});
		...
		var page_link = 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php?cbo_company_id='+cbo_company_id+'&job_id='+job_id+'&mst_id='+mst_id+'&details_id='+details_id+'&cbo_gmt_id='+cbo_gmt_id+'&cbo_color_id='+cbo_color_id+'&size='+size+'&txt_piles='+piles+'&cutting_no='+cutting_no+'&order_id='+order_id+'&marker_quantity='+marker_quantity+'&order_quantity='+order_quantity+'&total_lay_qty='+total_lay_qty+'&total_lay_balance='+total_lay_balance+'&rollData='+rollData+'&action=size_popup'+'&cbo_color_type='+cbo_color_type;//+'&size_wise_repeat_cut_no='+size_wise_repeat_cut_no
		//alert(page_link)
	...
	{      
		...
		var tna_date=return_ajax_request_value(tna_data, "tna_date_status", "requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc");
		if(tna_date!=2)
		{
		...
		http.open("POST","requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php",true);
	...
	function fnc_cut_lay_info_reponse()
	{
		if(http.readyState == 4) 
		{
			...
			if(reponse[0]==0 || reponse[0]==1)
			{
				...
				show_list_view( reponse[1], 'order_details_list', 'cut_details_container', 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', '' ) ;
	...
	{ 
		...
		var page_link='requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php?action=cutting_number_popup&company_id='+company_id; 
		...
		emailwindow.onclose=function()
		{
			...
			get_php_form_data( sysNumber[0], "load_php_mst_form", "requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc" );
			show_list_view( sysNumber[0], 'order_details_list', 'cut_details_container', 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', '' ) ;
			$("#cbo_company_name").attr("disabled",true);
			$("#txt_job_no").attr("disabled",true);
	...
	function openmypage_roll(row_no)
	{
		...
		var page_link = 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php?roll_maintained='+roll_maintained+'&order_no='+order_no+'&color='+color+'&rollData='+rollData+'&company_name='+company_name+'&job_no='+job_no+'&action=roll_popup';
...
// for report lay chart
 	function generate_report_lay_chart(data,action)
	{
		...
		window.open("requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc.php?data=" + data+'&action='+action, true );
	}
                         ...
                         <tr>
                           ...
                           <tr>
                                ...
                                <td  width="150" align="" colspan="2">
                                 <? 
                                    //echo create_drop_down( "cbo_company_name", 152, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0  order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', this.value, 'load_drop_down_location', 'location_td' );get_php_form_data(this.value,'roll_maintained','requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc');" );// get_php_form_data(this.value,'size_wise_repeat_cut_no','requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc' ); //old
									echo create_drop_down( "cbo_company_name", 152, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0  order by company_name","id,company_name", 1, "-- Select Company --", $selected, "get_php_form_data(this.value,'roll_maintained','requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc');change_type_color(this.value);" ); //new
                                ?>
                                </td>
	                                <td  width="110"  align="left" class="must_entry_caption">Working Company</td>              <!-- 11-00030  -->
	                                <td  width="150" align="">
	                                 <? 
	                                    echo create_drop_down( "cbo_working_company_name", 142, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0  order by company_name","id,company_name", 1, "-- Select Working Company --", $selected, "load_drop_down( 'requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc', this.value, 'load_drop_down_location', 'location_td' );" );// get_php_form_data(this.value,'size_wise_repeat_cut_no','requires/cut_and_lay_ratio_wise_entry_controller_urmi_for_qc' );
	                                ?>
	                                </td>
