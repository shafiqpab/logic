...
<script>
	...
	function openmypage_po(row_no)
	{
		...
		var page_link = 'requires/woven_cut_and_lay_ratio_wise_entry_controller.php?txt_job='+txt_job+'&cbocolor='+cbocolor+'&gmt_id='+gmt_id+'&poId='+poId+'&action=po_popup';
                           ...
                           <tr>
                                ...
                                <td  width="150" align="" colspan="2">
                                 <? 
									...
									echo create_drop_down( "cbo_company_name", 152, "select id,company_name from lib_company comp where status_active=1 and is_deleted=0  order by company_name","id,company_name", 1, "-- Select Company --", $selected, "get_php_form_data(this.value,'roll_maintained','requires/woven_cut_and_lay_ratio_wise_entry_controller');change_type_color(this.value);get_php_form_data(this.value,'size_wise_repeat_cut_no','requires/woven_cut_and_lay_ratio_wise_entry_controller' );" ); //new
                                ?>
                                </td>
