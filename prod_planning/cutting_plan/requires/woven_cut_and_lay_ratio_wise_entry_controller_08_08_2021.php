	                        ...
	                        <table>
	                            ...
	                            <tr>
	                                <td align="center" colspan="7" >
	                                    ...
	                                    <input type="button" id="btn11" name="btn11" value="Sticker 1/Page V4" class="formbutton" onClick="fnc_bundle_report_one_urmi(3);"/>
	                                    <input type="button" id="btn11" name="btn11" value="Sticker 1/Page V5" class="formbutton" onClick="fnc_bundle_report_one_urmi(4);"/>
	...
	if(count($sql_bundle_copy)!=0)
	{
		foreach($sql_bundle_copy as $inf)
		{
			...
			foreach($color_sizeID_arr as $val)
			{
				...
				$pdf->Code40($i, $j-2, "Byr#".$buyer_name_str, $ext = true, $cks = false, $w = 0.7, $h = 1, $wide = true, true,7);
				$pdf->Code40($i+35, $j-2, "Bun# ".$val[csf("bundle_no")], $ext = true, $cks = false, $w = 0.7, $h = 1, $wide = true, true,7);
...
{	 
	...
	if( $operation==0 ) // Insert Here----------------------------------------------------------
	{
		...
		// echo "<pre>"; print_r($sizeRatioBlArr);echo "</pre>";die();
		$erange=0;
...
if($action=="cutting_number_popup")
{
	...
	<script>
		...
		{   
			...
			if(str==1)
			{
				field_type='<input type="text" style="width:130px" class="text_boxes"  name="txt_job_search" id="txt_job_search" />';
	...
	<form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
	            ...
	            <thead>
	                <tr>                	 
	                    ...
	                    <th width="130" id="search_by_td_up">Job No</th>
