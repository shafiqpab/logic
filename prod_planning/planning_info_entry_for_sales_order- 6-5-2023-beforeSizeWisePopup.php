...
<script>
	...
	function show_details(type) {
		...
		var data = "action=booking_item_details" + get_submitted_data_string('cbo_company_name*cbo_within_group*cbo_buyer_name*hide_job_id*txt_booking_no*txt_internal_ref*cbo_planning_status*txt_barcode*txt_date_from*txt_date_to', "../") + '&type=' + type;
		freeze_window(5);
