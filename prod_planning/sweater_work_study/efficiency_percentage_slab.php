...
<script type="text/javascript">
    ...
    {   
       ...
       data_all=data_all+get_submitted_data_string('slabNo_'+i+'*txtSmvLowerLimit_'+i+'*txtSmvUpperLimit_'+i+'*txtLearningCubPercentage_'+i+'*updateDtls_'+i,"../../");
        }
...
<body onLoad="set_hotkey();">
    ...
    <center>
        <div style="width:450px;">
            ...
            <br>
               <fieldset style="width:450px;" id="dtls_part">
