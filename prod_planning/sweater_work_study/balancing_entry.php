    ...
    <fieldset style="width:870px; margin-top:10px">
        <table cellpadding="0" cellspacing="0" border="1" rules="all" width="100%" class="rpt_table" id="tbl_operation_list">
            <thead>
                ...
                <th width="75">Cycle Time(s)</th>
                <th width="80" title="smv/pitch time">Theoretical MP</th>
                <th width="65">Layout MP</th>
                <th width="65">W. Load %</th>
                <th width="65">Weight</th>
                <th>W. Track</th>
            </thead>
        ...
        <table cellpadding="0" cellspacing="2" width="100%" border="1" class="rpt_table">
            <tr>
                <td width="70%" align="center" class="button_container">
                    ...
                    <input type="button" class="formbutton" style="width:80px" name="print2" id="print2" value="Print2" onclick="print_balancing()" />
                </td>
            </tr>
        </table>
