...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Yarn Requisition Entry Sales V2", "../", 1, 1, '', '', '');
?>
<script>
    ...
    function fn_report_generated(type)
	{
		...
		isClickShowBtn = 1;
        var data = "action=report_generate" + get_submitted_data_string('cbo_type*cbo_company_name*cbo_within_group*cbo_buyer_name*txt_machine_dia*cbo_planning_status*txt_job_no*hide_job_id*txt_booking_no*txt_barcode', "../");
        freeze_window(4);
        http.open("POST", "requires/yarn_requisition_entry_sales_v2_controller.php", true);
    ...
    function openmypage_yarnReq(row_no, knit_dtlsId, companyID, comps, job_no, reqs_no, sale_order_id, cbo_within_group, booking_no)
	{
        var page_link = 'requires/yarn_requisition_entry_sales_v2_controller.php?action=yarn_req_qnty_popup&knit_dtlsId=' + knit_dtlsId + '&companyID=' + companyID + '&comps=' + comps + '&job_no=' + job_no + '&reqs_no=' + reqs_no + '&sale_order_id=' + sale_order_id + '&cbo_within_group=' + cbo_within_group + '&booking_no=' + booking_no;
        var title = 'Yarn Requisition Info';
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=1220px,height=430px,center=1,resize=1,scrolling=0', '');
    ...
    function openmypage_job()
	{
        ...
        var page_link = 'requires/yarn_requisition_entry_sales_v2_controller.php?action=style_ref_search_popup&companyID=' + companyID + '&buyerID=' + buyerID + '&within_group=' + within_group;
    ...
    function openmypage_booking()
	{
        ...
        var buyerID = $("#cbo_buyer_name").val();
        var within_group = $("#cbo_within_group").val();
        var page_link = 'requires/yarn_requisition_entry_sales_v2_controller.php?action=get_program_by_booking_for_req&companyID=' + companyID + '&buyerID=' + buyerID + '&within_group=' + within_group;
        var title = 'Style Ref./ Job No. Search';
    ...
    function openmypage_barcode()
	{
        ...
        var companyID = $("#cbo_company_name").val();
        var within_group = $("#cbo_within_group").val();
        var page_link = 'requires/yarn_requisition_entry_sales_v2_controller.php?action=barcode_popup&companyID=' + companyID + '&within_group=' + within_group;
        ;
        var title = 'Style Ref./ Job No. Search';
