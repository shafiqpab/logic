...
if ($action == "report_generate")
{
	...
	if ($template == 1) 
    {
       ...
       if ($db_type == 0)
		...
		from wo_booking_mst a, tmp_booking_id b where a.id = b.booking_id and b.userid=".$user_name." and a.entry_form in(86,88,118) and a.booking_type=1 and a.is_short in(1,2) and a.status_active=1 and a.is_deleted=0";
