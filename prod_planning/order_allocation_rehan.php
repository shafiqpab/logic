...
function set_value_po_qty(data)
{
...
{
	 //open_list_view('requires/order_allocation_controller.php?action=list_view_popup','List View')
	//page_link=page_link+"";
	
	show_list_view ( '', 'list_view_popup', 'un_allocated_job', 'requires/order_allocation_controller', 'setFilterGrid(\'list_view\',-1)')
...
function fnc_section_response()
{
	if(http.readyState == 4)
	{
		...
		show_list_view(reponse[1],'section_list_view_action','section_list_view','requires/order_allocation_controller','setFilterGrid("list_views",-1)');
     ...
     <table width="90%" cellpadding="0" cellspacing="2" align="center"  >
     	<tr>
        	<td width="70%" align="center" valign="top">  <!--   Form Left Container -->
                ...
                <legend> Order Allocation Info  <span style="margin-left:710px;"> Un Allocated Job </span> </legend>
               
            		<table  width="1000" cellspacing="2" cellpadding="0" border="0" height="140">
                       <tr>
                            <td  width="80" height="" align="right" class="must_entry_caption">Job No</td>              <!-- 11-00030  -->
                                <td  width="170" >
                                ...
                                <td  width="80" align="right">Company Name </td>
                                <td width="170">
                               		<?
...
<!--	
<button class="button" id="button" type="button" onClick="open_list_view('requires/order_allocation_controller.php?action=list_view_popup','List View')">List View</button>
-->

<div id="un_allocated_job" ></div>
...
<td width="80" align="right" >Buyer Name</td>
                            ...
                            <td  width="80" align="right">Team Leader</td>
                            <td width="170">
                            		<?  
                          	...
                          	<tr>
                          	<td width="80" align="right">Dealing Merchant</td>
                          	<td id="marchant_td">
                          		<? 
                          ...
                          <td width="80" align="right">Prod. Dept </td>
                           <td>
                              <?
                         ...
                         <tr>
                         		<td width="80" align="right" >Job Qty</td>
                               	<td>
                               ...
                               <tr>
                                 <td width="80" align="right" >Entry Date</td>
                               	 <td colspan="2">
                              		<input  value="" name="txt_entry_date" id="txt_entry_date" style="width:160px " class="text_boxes" readonly disabled/>
                              	 </td>
                                 <td> <input type="button" name="list_view_button" id="list_view_button" onClick="show_unallocated_jobs()" value="Show Styles" class="formbutton" style="width:175px;"> </td>
	               ...
	               <legend> Order Allocation Entry </legend>
                      ...
                      <table  cellspacing="0" cellpadding="0" border="0" class="rpt_table" align="center" width="100%">
                  	 	<thead>  
	                        ...
	                        <th width="389">Sewing Date Range</th>
                    ...
                    <input class="text_boxes_numeric" type="text" style="width:30px;" name="tot_smv_qnty" id="tot_smv_qnty" readonly onKeyUp="total_smv();"/>                          
                      ...
                      <td align="center">
                      	<input name="txt_shipment_date" id="txt_shipment_date" readonly class="datepicker" style="width:45px;">
                      </td> 
