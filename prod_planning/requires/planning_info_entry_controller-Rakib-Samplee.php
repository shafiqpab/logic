...
if ($action == "booking_item_details")
{
	...
	else
	{
		...
		{
			$sql = "SELECT x.id, x.company_id, x.item_category, x.booking_prefix,x.fabric_source, x.booking_type, x.is_short, x.booking_no, x.booking_date, x.job_no, x.buyer_id, x.is_approved, x.construction, x.copmposition, x.pre_cost_fabric_cost_dtls_id, x.po_break_down_id, x.gsm_weight, x.dia_width, x.qnty, x.style_ref_no from (SELECT a.id, a.company_id, a.item_category, a.booking_no_prefix_num as booking_prefix,a.fabric_source, a.booking_type, a.is_short, a.booking_no, a.booking_date, a.job_no, a.buyer_id, a.is_approved, b.construction, b.copmposition, b.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, sum(b.grey_fab_qnty) as qnty, c.style_ref_no from wo_booking_mst a, wo_booking_dtls b, wo_po_details_master c where a.entry_form!=140 and a.booking_no=b.booking_no and b.job_no=c.job_no and a.company_id=$company_name and a.item_category=2  and (a.fabric_source=1 or b.fabric_source=1) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and b.grey_fab_qnty>0 and a.pay_mode in(3,5) $booking_cond $job_no_cond $buyer_id_cond $po_id_cond $po_data_file_ref $booking_date $booking_type_cond and a.ref_closing_status=0 group by a.id, a.company_id, a.fabric_source, a.booking_no_prefix_num,a.booking_type, a.is_short, a.booking_no, a.booking_date, a.job_no, a.buyer_id, a.is_approved, a.item_category, b.construction, b.copmposition, b.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, c.style_ref_no 
			union all 
			SELECT a.id, a.company_id, a.item_category, a.booking_no_prefix_num as booking_prefix,b.fabric_source, a.booking_type, b.is_short, a.booking_no, a.booking_date, c.job_no, a.buyer_id, a.is_approved, d.construction, d.composition as copmposition, h.pre_cost_fabric_cost_dtls_id as pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, sum(b.grey_fab_qnty) as qnty, c.style_ref_no from wo_booking_mst a, wo_booking_dtls b, wo_po_details_master c ,wo_pre_cost_fabric_cost_dtls d,wo_pre_cos_fab_co_avg_con_dtls h where b.entry_form_id=140 and a.booking_no=b.booking_no and b.job_no=c.job_no and c.job_no=d.job_no  and d.job_no=h.job_no and b.po_break_down_id= h.po_break_down_id and a.company_id=$company_name and a.item_category=2 and (a.fabric_source=1 or b.fabric_source=1) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and b.grey_fab_qnty>0 and a.pay_mode in(3,5) $booking_cond $job_no_cond $buyer_id_cond $po_id_cond $po_data_file_ref $booking_date $booking_type_cond and a.ref_closing_status=0 group by a.id, a.company_id, b.fabric_source, a.booking_no_prefix_num,a.booking_type, b.is_short, a.booking_no, a.booking_date, c.job_no, a.buyer_id, a.is_approved, a.item_category, d.construction, d.composition, h.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, c.style_ref_no ) x order by x.dia_width, x.booking_no";
				//--,SAMPLE_DEVELOPMENT_MST e,SAMPLE_DEVELOPMENT_DTLS f,SAMPLE_DEVELOPMENT_FABRIC_ACC g,WO_PRE_COS_FAB_CO_AVG_CON_DTLS h
				//--and d.id=h.pre_cost_fabric_cost_dtls_id and c.style_ref_no=e.style_ref_no and e.id=f.sample_mst_id and f.sample_mst_id=g.sample_mst_id

			$sqlColor = "SELECT x.id, x.company_id, x.item_category, x.booking_prefix,x.fabric_source, x.booking_type, x.is_short, x.booking_no, x.booking_date, x.job_no, x.buyer_id, x.is_approved, x.construction, x.copmposition, x.pre_cost_fabric_cost_dtls_id, x.po_break_down_id, x.gsm_weight, x.dia_width, x.fabric_color_id, x.qnty, x.style_ref_no from (SELECT a.id, a.company_id, a.item_category, a.booking_no_prefix_num as booking_prefix,a.fabric_source, a.booking_type, a.is_short, a.booking_no, a.booking_date, a.job_no, a.buyer_id, a.is_approved, b.construction, b.copmposition, b.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, b.fabric_color_id, sum(b.grey_fab_qnty) as qnty, c.style_ref_no from wo_booking_mst a, wo_booking_dtls b, wo_po_details_master c where a.entry_form!=140 and a.booking_no=b.booking_no and b.job_no=c.job_no and a.company_id=$company_name and a.item_category=2  and (a.fabric_source=1 or b.fabric_source=1) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and b.grey_fab_qnty>0 and a.pay_mode in(3,5) $booking_cond $job_no_cond $buyer_id_cond $po_id_cond $po_data_file_ref $booking_date $booking_type_cond group by a.id, a.company_id, a.fabric_source, a.booking_no_prefix_num, a.booking_type, a.is_short, a.booking_no, a.booking_date, a.job_no, a.buyer_id, a.is_approved, a.item_category, b.construction, b.copmposition, b.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, b.fabric_color_id, c.style_ref_no 
			union all 
				SELECT a.id, a.company_id, a.item_category, a.booking_no_prefix_num as booking_prefix,b.fabric_source, b.booking_type, b.is_short, a.booking_no, a.booking_date, b.job_no, a.buyer_id, a.is_approved, d.construction, d.composition as copmposition, h.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, h.color_number_id as  fabric_color_id, sum(b.grey_fab_qnty) as qnty, c.style_ref_no from wo_booking_mst a, wo_booking_dtls b, wo_po_details_master c,wo_pre_cost_fabric_cost_dtls d,wo_pre_cos_fab_co_avg_con_dtls h where b.entry_form_id=140 and a.booking_no=b.booking_no and b.job_no=c.job_no and c.job_no=d.job_no  and d.job_no=h.job_no and b.po_break_down_id= h.po_break_down_id and a.company_id=$company_name and a.item_category=2 and (a.fabric_source=1 or b.fabric_source=1) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and b.grey_fab_qnty>0 and a.pay_mode in(3,5) $booking_cond $job_no_cond $buyer_id_cond $po_id_cond $po_data_file_ref $booking_date $booking_type_cond group by a.id, a.company_id, b.fabric_source, a.booking_no_prefix_num, b.booking_type, b.is_short, a.booking_no, a.booking_date, b.job_no, a.buyer_id, a.is_approved, a.item_category, d.construction, d.composition, h.pre_cost_fabric_cost_dtls_id, b.po_break_down_id, b.gsm_weight, b.dia_width, h.color_number_id, c.style_ref_no) x order by x.dia_width, x.booking_no";
		}
	}
	//echo $sql; die;
			...
			<fieldset style="width:630px; margin-top:10px; margin-left:20px">
				...
				<div>
					...
					<div style="width:600px; overflow-y:scroll; max-height:210px;" id="buyer_list_view" align="center">
						...
						union all 
						select b.po_break_down_id,c.body_part_id,d.color_number_id as fabric_color_id, sum(b.grey_fab_qnty) as qnty 
						from wo_booking_mst a, wo_booking_dtls b,WO_PRE_COST_FABRIC_COST_DTLS c,wo_pre_cos_fab_co_avg_con_dtls d 
						where b.entry_form_id=140 and a.booking_no=b.booking_no and b.job_no=c.job_no and c.job_no=d.job_no and b.po_break_down_id= d.po_break_down_id and b.booking_type=4 and b.is_short=2 and b.job_no=c.job_no and c.body_part_id in($bodypartId ) and a.company_id=$companyID and a.item_category=2 and a.booking_no='$booking_no' and $dia_cond and b.po_break_down_id in ($po_id) and d.pre_cost_fabric_cost_dtls_id in ($pre_cost_id) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 group by  b.po_break_down_id,c.body_part_id,d.color_number_id");
						...
						union all  
						select d.color_number_id as fabric_color_id, sum(b.grey_fab_qnty) as qnty 
						from wo_booking_mst a, wo_booking_dtls b,WO_PRE_COST_FABRIC_COST_DTLS c,wo_pre_cos_fab_co_avg_con_dtls d  
						where b.entry_form_id=140 and a.booking_no=b.booking_no and b.job_no=c.job_no and c.job_no=d.job_no and b.po_break_down_id= d.po_break_down_id and b.booking_type=4 and b.is_short=2 and b.job_no=c.job_no and c.body_part_id in($bodypartId ) and a.company_id=$companyID and a.item_category=2 and a.booking_no='$booking_no' and $dia_cond and b.po_break_down_id in ($po_id) and d.pre_cost_fabric_cost_dtls_id in ($pre_cost_id) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 group by d.color_number_id";
