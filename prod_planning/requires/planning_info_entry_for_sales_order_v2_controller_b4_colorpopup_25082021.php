...
if ($action == "save_update_delete")
{
	...
	if ($operation == 0)  // Insert Here
	{
		...
		$field_array_dtls = "id, mst_id, knitting_source, knitting_party, color_id, color_range, machine_dia, width_dia_type, machine_gg, fabric_dia, program_qnty, stitch_length, spandex_stitch_length, draft_ratio,  machine_id, machine_capacity, distribution_qnty, status, start_date, end_date, program_date, feeder, remarks, save_data, location_id, advice, is_sales, batch_no, no_of_ply, inserted_by, insert_date";

		$data_array_dtls = "(" . $dtls_id . "," . $id . "," . $cbo_knitting_source . "," . $cbo_knitting_party . "," . $hidden_color_id . "," . $cbo_color_range . "," . $txt_machine_dia . "," . $cbo_dia_width_type . "," . $txt_machine_gg . "," . $txt_fabric_dia . "," . $txt_program_qnty . "," . $txt_stitch_length . "," . $txt_spandex_stitch_length . "," . $txt_draft_ratio . "," . $machine_id . "," . $txt_machine_capacity . "," . $txt_distribution_qnty . "," . $cbo_knitting_status . "," . $txt_start_date . "," . $txt_end_date . "," . $txt_program_date . "," . $cbo_feeder . "," . $txt_remarks . "," . $save_data . "," . $cbo_location_name . "," . $hidden_advice_data . ",1," . $txt_batch_no . "," . $txt_no_of_ply . "," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "')";

		$plan_dtls_id = return_next_id("id", "ppl_planning_entry_plan_dtls", 1);
		$field_array_plan_dtls = "id, mst_id, dtls_id, company_id, within_group, buyer_id, booking_no, po_id, body_part_id, color_type_id, determination_id, fabric_desc, gsm_weight, dia, width_dia_type, color_id,program_qnty, is_sales,sales_order_dtls_ids,pre_cost_fabric_cost_dtls_id, customer_buyer, inserted_by, insert_date";
		...
		if ($data != "")
		{
			...
			for ($i = 0; $i < count($data); $i++) {
				...
				$data_array_plan_dtls .= "(" . $plan_dtls_id . "," . $id . "," . $dtls_id . "," . $companyID . "," . $withinGroup . "," . $buyer_id . ",'" . $booking_no . "'," . $job_id . "," . $body_part_id . "," . $color_type_id . "," . $determination_id . ",'" . $desc . "'," . $gsm . ",'" . $dia_width . "'," . $dia_width_type . ",0," . $prog_qnty . ",1,'" . $sales_dtls_id[$i] . "','" . $pre_cost[$i] . "'," . $customer_buyer_id . "," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "')";
		...
		echo "5**0**00**".$flag;
		die;*/
		//echo "10**".$rID . "_" . $rID2 . "_" . $rID3 . "_" . $rID4 . "_" . $rID5."_".$rID8; die();
	...
	else if ($operation == 1)   // Update Here
	{
		...
		*/
		...
		$color_id = 0;
		$field_array_update = "knitting_source*knitting_party*color_id*color_range*machine_dia*width_dia_type*machine_gg*fabric_dia*program_qnty*stitch_length*spandex_stitch_length*draft_ratio*machine_id*machine_capacity*distribution_qnty*status*start_date*end_date*program_date*feeder*remarks*save_data*location_id*advice*batch_no*no_of_ply*updated_by*update_date";

		$data_array_update = $cbo_knitting_source . "*" . $cbo_knitting_party . "*" . $hidden_color_id . "*" . $cbo_color_range . "*" . $txt_machine_dia . "*" . $cbo_dia_width_type . "*" . $txt_machine_gg . "*" . $txt_fabric_dia . "*" . $txt_program_qnty . "*" . $txt_stitch_length . "*" . $txt_spandex_stitch_length . "*" . $txt_draft_ratio . "*" . $machine_id . "*" . $txt_machine_capacity . "*" . $txt_distribution_qnty . "*" . $cbo_knitting_status . "*" . $txt_start_date . "*" . $txt_end_date . "*" . $txt_program_date . "*" . $cbo_feeder . "*" . $txt_remarks . "*" . $save_data . "*" . $cbo_location_name . "*" . $hidden_advice_data . "*" . $txt_batch_no . "*" . $txt_no_of_ply . "*" . $_SESSION['logic_erp']['user_id'] . "*'" . $pc_date_time . "'";

		$plan_dtls_id = return_next_id("id", "ppl_planning_entry_plan_dtls", 1);
		$field_array_plan_dtls = "id, mst_id, dtls_id, company_id, within_group, buyer_id, booking_no, po_id, body_part_id, color_type_id, determination_id, fabric_desc, gsm_weight, dia, width_dia_type, color_id, program_qnty, is_sales,sales_order_dtls_ids,pre_cost_fabric_cost_dtls_id, customer_buyer, inserted_by, insert_date,update_sl";
		...
		if ($data != "") {
			...
			for ($i = 0; $i < count($data); $i++) {
				...
				if ($data_array_plan_dtls != "") $data_array_plan_dtls .= ",";
				$data_array_plan_dtls .= "(" . $plan_dtls_id . "," . $updateId . "," . $update_dtls_id . "," . $companyID . "," . $withinGroup . "," . $buyer_id . ",'" . $booking_no . "'," . $job_id . "," . $body_part_id . "," . $color_type_id . "," . $determination_id . ",'" . $desc . "'," . $gsm . ",'" . $dia_width . "'," . $dia_width_type . ",0," . $prog_qnty . ",1,'" . $sales_dtls_id[$i] . "','" . $pre_cost[$i] . "'," . $customer_buyer_id . "," . $_SESSION['logic_erp']['user_id'] . ",'" . $pc_date_time . "',".$update_sl.")";
...
if ($action == "prog_qnty_popup") 
{
	...
	<script>
		...
		function openpage_machine()
		{
			...
			var page_link = 'planning_info_entry_for_sales_order_v2_controller.php?action=machine_info_popup&save_string=' + save_string + '&companyID=' + '<? echo $companyID; ?>' + '&txt_machine_dia=' + txt_machine_dia + '&update_dtls_id=' + update_dtls_id + '&txt_program_qnty='+txt_program_qnty + '&txt_machine_gg='+txt_machine_gg;
			...
			<table width="900" align="center" border="0">
				...
				<tr>
					...
					<td>
						...
						class="text_boxes">
						<span style="font-weight: bold;margin-left: 10px;">Program No / Tube</span>
					</td>
						...
						if (!empty($collarCuff_data))
						{
							...
							for ($i = 0; $i < count($collarCuff_data); $i++)
							{
								...
								<tr align="center" bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>">
									...
									<td width="100">
										<input type="text" name="txtNeedlePerCm[]" id="txtNeedlePerCm_<? echo $i; ?>"
...
if ($action == "planning_info_details")
{
	...
	<div style="width:960px; max-height:140px; overflow-y:scroll" id="list_container_batch" align="left">
		...
		foreach ($result as $row) {
			...
			?>
			<tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer"
				onClick="get_php_form_data(<? echo $row[csf('id')]; ?>,'populate_data_from_planning_info', 'planning_info_entry_for_sales_order_v2_controller' );">
...
if ($action == "populate_data_from_planning_info")
{
	...
	$sql = "select id, knitting_source, knitting_party, color_id, color_range, machine_dia, width_dia_type, machine_gg, fabric_dia, program_qnty, stitch_length, spandex_stitch_length, draft_ratio, machine_id, machine_capacity, distribution_qnty, status, start_date, end_date, program_date, feeder, remarks, save_data, no_fo_feeder_data, location_id, advice, batch_no, no_of_ply from ppl_planning_info_entry_dtls where id=$data";
...
if ($action == "color_info_popup")
{
	...
	extract($_REQUEST);
	$is_color_mixing = return_field_value("color_mixing_in_knitting_plan", "variable_settings_production", "company_name=".$companyID." and variable_list=53"); 
	if($is_color_mixing == 1)
	{
		$is_color_mixing = 1;
	}
	else
	...
	<script>
		...
		//for color mixing
		function func_close(isColorMixing) 
		{
			var colorIdArr = [];
			var colorId_str = $('#txt_selected_id').val();
			var colorIdArr = colorId_str.split(',');
			if(isColorMixing !=1 )
			{				
				if(colorIdArr.length > 1 )
				{
	...
	<div align="center" style="width:390px;">
				...
				<div>
					...
					<div style="width:360px; overflow-y:scroll; max-height:210px;" id="buyer_list_view" align="center">
						...
						<tbody>
							...
							$color_library = return_library_array("select id,color_name from lib_color", "id", "color_name");
							$sql = "select color_id, sum(grey_qty) as qty from fabric_sales_order_dtls where status_active=1 and is_deleted=0 and mst_id=$job_id and id in($sales_dtls_id) and body_part_id in(".$body_part_id.") and trim(fabric_desc) = '".$desc."' and dia = '".$dia."' and gsm_weight = '".$gsm."' and width_dia_type = '".$width_dia_type."' group by color_id";
							//echo $sql;
							$result = sql_select($sql);
		...
		<div style="width:100%; margin-left:10px; margin-top:5px">
			...
			<div style="width:57%; float:left" align="left">
				<input type="button" name="close" onClick="func_close(<? echo $is_color_mixing; ?>);" class="formbutton"
