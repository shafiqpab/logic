...
{
	echo create_drop_down( "cbo_location_name", 150, "select id,location_name from lib_location where company_id='$data' and status_active =1 and is_deleted=0 order by location_name","id,location_name", 1, "-- Select --", '', "load_drop_down( 'requires/sewing_planning_board_display_controller', this.value, 'load_drop_down_floor', 'floor_td' );" );	
	die;	 
}
            	...
            	<table  cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" >
        			...
        			<tr>
                        ...
                        <input type="hidden" id="garments_nature" value="<? echo $garments_nature; ?>">
							<?
							//echo $company_id;
								echo create_drop_down( "cbo_company_mst", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name",1, "-- Select Company --", $company_id,"load_drop_down( 'sewing_planning_board_display_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );" );
							?>
                    </td>
                   	<td id="buyer_td">
                     <?
                	...
                	<table width="450" class="rpt_table" id="tbl_lag">
                    	<thead> 
                        	<tr>
                                ...
                                <th colspan="3">
								<?
								echo create_drop_down( "cbo_complexity_type", 210, $complexity_type_tmp, "", 0, "-- Select --",'', "fnc_change_complx(this.value)",0 ); ?></th>
