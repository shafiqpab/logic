				...
				<div>
					...
					<div style="width:600px; overflow-y:scroll; max-height:210px;" id="buyer_list_view" align="center">
						...
						<tbody>
							...
							$sql_colorRange = "SELECT color_id AS COLOR_ID, COLOR_RANGE_ID FROM fabric_sales_order_dtls WHERE status_active=1 AND is_deleted=0 AND mst_id=".$job_id." AND id IN(".$sales_dtls_id.") AND body_part_id IN(".$body_part_id.") AND trim(fabric_desc) = '".$desc."' AND dia = '".$dia."' AND gsm_weight = '".$gsm."' AND width_dia_type = '".$width_dia_type."' GROUP BY color_id,color_range_id";
