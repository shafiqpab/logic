										...
										<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>', '<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>" style="text-decoration:none;" >
											...
											<td align="right" width="100">
												<input type="text" name="txt_machine_no[]" id="txt_machine_no_<? echo $i; ?>" class="text_boxes"
													...
													onDblClick="openpage_machine2('<? echo $i.'_'.$row[csf('plan_id')].'_'.$programNo.'_'.$company_name.'_'.$row[csf('knitting_party')].'_'.$row[csf('machine_gg')].'_'.$row[csf('machine_dia')].'_'.$program_qnty.'_'.$determination_id.'_'.$row[csf('booking_id')]; ?>');" value="<? echo $mc_machine_no; ?>" readonly/>
						...
						*/
						...
						foreach ($vs_result as $row)
						{
							...
							<td align="center" width="100">
								...
								onDblClick="openpage_yarn_distr('<? echo $i.'_'.$row[csf('id')]; ?>');" readonly="readonly"/>
							</td>
