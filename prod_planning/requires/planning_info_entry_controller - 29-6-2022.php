...
if ($action == "save_update_delete")
{
	...
	if ($operation == 0)
	{
		...
		//echo "5**$rID##$rID2##$rIDdtls##$rID3##$rID4##$rID5##$rID6";die;
	...
	else if ($operation == 1)   // Update Here
	{
		...
		*/
		...
		if ($knit_qty > 0)
		{
			...
			if ($db_type == 0) {
				if ($rID && $rID2 && $deletem && $delete_datewise && $rID3 && $rID4 && $rID7 && $rID8 && $posted_flag_updated) {
					mysql_query("COMMIT");
