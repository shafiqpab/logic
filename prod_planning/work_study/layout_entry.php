        ...
        <table cellpadding="0" cellspacing="2" width="100%">
            <tr>
                <td colspan="5" align="center" class="button_container">
                    ...
                    <input type="button" class="formbutton" style="width:80px" name="print2" id="print2" value="Print 2" onclick="print_report( $('#lo_update_id').val()+'**'+$('#balanceId').val(), 'layout_print2','requires/layout_entry_controller' )" />

                    <input type="button" class="formbutton" style="width:80px" name="print3" id="print3" value="Print 3" onclick="print_report( $('#lo_update_id').val()+'**'+$('#balanceId').val(), 'layout_print3','requires/layout_entry_controller' )" />

                    <input type="button" value="Excel Print" onClick="fnc_excle_layout_entry()" style="width:160px" name="excel_print" id="excel_print" class="formbutton" /><a id="print_excel" href="" style="text-decoration:none" download hidden>PP</a>
