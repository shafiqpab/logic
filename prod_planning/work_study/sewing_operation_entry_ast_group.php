...
<script>
	...
	function fnc_sewing_operation_entry( operation )
	{
		...
		var data="action=save_update_delete&operation="+operation+get_submitted_data_string('cbo_product_dept*cbo_garment_item*cbo_bodypart*txt_code*txt_operation*txt_rate*fabric_desc_id*cbo_smv_basis*txt_seam_length*cbo_resource*txt_operator_smv*smv_data_operator*txt_helper_smv*smv_data_helper*cbo_department_code*cbo_uom*cbo_status*update_id*smv_data*txt_product_code*txt_gmts_code*txt_body_part_code',"../../");
	...
	function fnc_sewing_operation_entry_reponse()
	{
		if(http.readyState == 4) 
		{
			...
			if(response[0]==0 || response[0]==1)
			{
				...
				reset_form('sewingoperationentry_1','','','','','cbo_product_dept*cbo_garment_item*cbo_bodypart*txt_fabric_description*fabric_desc_id*cbo_smv_basis*cbo_resource');
	...
	function show_operation(type)
	{
		if(type==2)
		{
			var data=$('#productDept').val()+"__"+$('#garmentItem').val()+"__"+$('#bodypart').val()+"__"+$('#resource').val();
	...
	function fnc_smv_active()
	{
		...
		if(resource==40 || resource==41 || resource==43 || resource==44 || resource==48 || resource==53 || resource==54 || resource==55 || resource==56 || resource==68 || resource==69 || resource==70 || resource==90)
		{
	...
	function openmypage_smv_calculation()
	{
		...
		emailwindow.onclose=function()
		{
			...
			//if(cbo_resource==40)
			if(cbo_resource==40 || cbo_resource==41 || cbo_resource==43 || cbo_resource==44 || cbo_resource==48 || cbo_resource==53 || cbo_resource==54 || cbo_resource==55 || cbo_resource==56)
			{
...
<body onLoad="set_hotkey();show_operation(1);">
    	...
    	<form name="sewingoperationentry_1" id="sewingoperationentry_1" autocomplete="off">	
            <table width="95%">
                ...
                <tr>
                	<td>Code</td>
                    <td>
                    	<input type="text" name="txt_product_code" id="txt_product_code" class="text_boxes" maxlength="2" style="width:20px"/>
                        <input type="text" name="txt_gmts_code" id="txt_gmts_code" class="text_boxes" maxlength="4"  style="width:30px"/>
                        <input type="text" name="txt_body_part_code" id="txt_body_part_code" class="text_boxes" maxlength="4" style="width:30px"/>
                    	<input type="text" name="txt_code" id="txt_code" class="text_boxes" style="width:34px;" readonly />
                    </td>
                ...
                <tr>
                    ...
                    <td><? echo create_drop_down( "cbo_department_code", 172, $machine_category,'', '', '','8','fnc_smv_active();','','4,7,8' ); ?></td>
                    <td>UOM</td>
            ...
            <div id="sewing_operation_list"></div>
           <!-- <table width="100%">
                 <tr>
