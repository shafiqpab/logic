...
{ 
	...
	$sqlDtls="SELECT a.PROCESS_ID,b.id, b.mst_id, b.row_sequence_no, b.lib_sewing_id, b.resource_gsd, b.total_smv from PPL_GSD_ENTRY_MST a,ppl_gsd_entry_dtls b where a.id=b.mst_id and b.mst_id=$update_id and b.is_deleted=0 order by b.row_sequence_no asc";
	...
	?>
		<tr bgcolor="<? echo $bgcolor; ?>" id="trBl2_<? echo $i; ?>">
            ...
            <td><? echo $production_resource_arr[$slectResult[csf('resource_gsd')]]; ?><input type="hidden" name="rescId[]" id="rescId_<? echo $i; ?>" value="<? echo $slectResult[csf('resource_gsd')]; ?>"></td>
...
if ($action=="save_update_delete")
{
	...
	{ 
		...
		$data_array = "(".$id.",".$breakdown_id2.",".$txt_worker.",".$txt_pitch_time2.",".$txt_tgt_per_day.",".$txt_efficiency_bl2.",".$txt_max_wl.",".$txt_min_wl.",".$txt_tot_smv2.",2,".$cbo_learning_cub_method_bl2.",".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."', 1)";
		...
		for($j=0;$j<str_replace("'", '', $txt_worker);$j++)
		{
			...
			$data_array_dtls_wk.="(".$dtls_id_wk.",".$breakdown_id2.",".$id.",'".$smv."','".$target."','".$work_load."')";
		...
		{ 	
			...
			for($k=1;$k<=str_replace("'", '', $txt_worker);$k++)
			{
				...
				$data_array_dtls.="(".$dtls_id.",".$breakdown_id2.",'".$$gsdDtlsId."',".$id.",'".$$seqNo."','".$$sewingId."','".$$rescId."','".str_replace("'", '',$$smv)."', 1)";
				$dtls_id = $dtls_id+1;
			}
		}
...
if($action=="load_graph_data")
{
	...
	$sql="select a.max_work_load, a.min_work_load, b.target, b.work_load from ppl_balancing_mst_entry a, ppl_bl_wk_dtls_entry b where a.id=b.mst_id and b.mst_id=$data and a.entry_form=1 and b.entry_form=1 and a.balancing_page=2";
            ...
            <?
				...
				?>
					<tr bgcolor="<? //echo $bgcolor; ?>">
						...
						<td style="word-wrap:break-word"><? echo $production_resource_arr[$slectResult[csf('resource_gsd')]]; ?></td>
