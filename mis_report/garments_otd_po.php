...
//OTD Details ..................................................
$sql = "select d.COMPANY_SHORT_NAME as BU,e.BUYER_NAME,a.JOB_NO_MST,a.ID,a.PO_NUMBER,b.COMPANY_NAME,
...
(case when
a.EXTENDED_SHIP_DATE is null then a.PUB_SHIPMENT_DATE 
else a.EXTENDED_SHIP_DATE  end) between '19-Dec-2019' and '25-Dec-2019'
	            ...
	            <tbody>
					...
					
					{
	                    ...
	                    <tr style="font-size:14px" bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                            ...
                            <td width="85" align="center"><? echo $row[LAST_SHIP_DATE];?></td>                            
                            <td width="90" align="left"><? echo $row[SHIPPING_STATUS];?></td>
                            <td width="90" align="left"><? echo $row[OTD_STATUS];?></td>                     
	                    </tr>
						<?
