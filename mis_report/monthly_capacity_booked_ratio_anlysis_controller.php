...
round(sum(d.PO_QUANTITY *c.TOTAL_SET_QNTY)) as PO_QTY_PCS,
round(sum(d.PLAN_CUT *c.TOTAL_SET_QNTY)) as PLN_CUT_QTY_PCS,
sum((d.UNIT_PRICE/c.TOTAL_SET_QNTY )*(d.PO_QUANTITY *c.TOTAL_SET_QNTY)) as PO_VALUE,
round(sum(case 
when
B.COSTING_PER=1 then
(((d.UNIT_PRICE/c.TOTAL_SET_QNTY)*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
-(((NVL(a.FABRIC_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.TRIMS_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.EMBEL_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.WASH_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.COMM_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMISSION,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.LAB_TEST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INSPECTION,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.FREIGHT,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMON_OH,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CURRIER_PRE_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CERTIFICATE_PRE_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEPR_AMOR_PRE_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INTEREST_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INCOMETAX_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEFFDLC_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.STUDIO_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DESIGN_COST,0)/(12*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))))
when
B.COSTING_PER=2 then
(((d.UNIT_PRICE/c.TOTAL_SET_QNTY)*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
-(((NVL(a.FABRIC_COST,0)/(c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.TRIMS_COST,0)/(c.TOTAL_SET_QNTY))*(d.PLAN_CUT*c.TOTAL_SET_QNTY))
+((NVL(a.EMBEL_COST,0)/(c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.WASH_COST,0)/(c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.COMM_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMISSION,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.LAB_TEST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INSPECTION,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.FREIGHT,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMON_OH,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CURRIER_PRE_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CERTIFICATE_PRE_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEPR_AMOR_PRE_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INTEREST_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INCOMETAX_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEFFDLC_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.STUDIO_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DESIGN_COST,0)/(c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))))
when
B.COSTING_PER=3 then
(((d.UNIT_PRICE/c.TOTAL_SET_QNTY)*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
-(((NVL(a.FABRIC_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.TRIMS_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PLAN_CUT*c.TOTAL_SET_QNTY))
+((NVL(a.EMBEL_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.WASH_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.COMM_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMISSION,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.LAB_TEST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INSPECTION,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.FREIGHT,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMON_OH,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CURRIER_PRE_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CERTIFICATE_PRE_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEPR_AMOR_PRE_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INTEREST_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INCOMETAX_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEFFDLC_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.STUDIO_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DESIGN_COST,0)/(24*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))))
when
B.COSTING_PER=4 then
(((d.UNIT_PRICE/c.TOTAL_SET_QNTY)*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
-(((NVL(a.FABRIC_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.TRIMS_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PLAN_CUT*c.TOTAL_SET_QNTY))
+((NVL(a.EMBEL_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.WASH_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.COMM_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMISSION,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.LAB_TEST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INSPECTION,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.FREIGHT,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMON_OH,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CURRIER_PRE_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CERTIFICATE_PRE_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEPR_AMOR_PRE_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INTEREST_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INCOMETAX_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEFFDLC_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.STUDIO_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DESIGN_COST,0)/(36*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))))
when
B.COSTING_PER=5 then
(((d.UNIT_PRICE/c.TOTAL_SET_QNTY)*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
-(((NVL(a.FABRIC_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.TRIMS_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PLAN_CUT*c.TOTAL_SET_QNTY))
+((NVL(a.EMBEL_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.WASH_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PLAN_CUT *c.TOTAL_SET_QNTY))
+((NVL(a.COMM_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMISSION,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.LAB_TEST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INSPECTION,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.FREIGHT,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.COMMON_OH,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CURRIER_PRE_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.CERTIFICATE_PRE_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEPR_AMOR_PRE_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INTEREST_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.INCOMETAX_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DEFFDLC_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.STUDIO_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))
+((NVL(a.DESIGN_COST,0)/(48*c.TOTAL_SET_QNTY))*(d.PO_QUANTITY *c.TOTAL_SET_QNTY))))
end),2) as BOOKED_CM_VALUE
from WO_PRE_COST_DTLS a, WO_PRE_COST_MST b, WO_PO_DETAILS_MASTER c,WO_PO_BREAK_DOWN d
where 
d.PUB_SHIPMENT_DATE between $dateCondition $compcond3
and A.JOB_NO=B.JOB_NO
...
and D.STATUS_ACTIVE=1 and D.IS_DELETED=0 
and C.STATUS_ACTIVE=1 and C.IS_DELETED=0
group by c.COMPANY_NAME,d.T_YEAR,TO_CHAR(d.PUB_SHIPMENT_DATE,'Mon')
order by C.COMPANY_NAME,d.T_YEAR,TO_CHAR(d.PUB_SHIPMENT_DATE,'Mon')";
	...
	<div style="width:1210px; margin-bottom:5px;" align="left">
		<fieldset>
            <table class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="">
                <thead>
                    <tr>
                     	<th style="font-size:24px" align="center" colspan="21">ASROTEX GROUP</th>
                	 </tr>
                    <tr>
                    	<td style="font-size:14px" align="center" colspan="21"> <strong>BU WISE CAPACITY VS BOOKED RATIO ANALYSIS FOR FISCAL YEAR-2020 </strong></td>
                    </tr>
                   <tr>
                    	<td style="font-size:14px" align="center" colspan="21"><strong> AS ON [ <? $d=strtotime("now"); echo date('d-M-Y h:i:sA',$d);?> ]</strong></td>
                    </tr>
                    <tr>
                    	<td style="font-size:14px" bgcolor="#FFFF00" colspan="6" align="center"> <strong> BASIC INFO </strong></td>              
                    	<td style="font-size:14px" bgcolor="#00FF99" colspan="5" align="center"> <strong> CAPACITY INFO </strong></td>
                        <td style="font-size:14px" bgcolor="#00CCFF" colspan="6" align="center"> <strong> BOOKED INFO </strong></td>
                        <td style="font-size:14px" bgcolor="#FF9900" colspan="4" align="center"> <strong> BOOKED % ON CAPACITY </strong></td>
                    </tr>
	            ...
	            <tbody>
					...
					foreach($sql_result as $row)
					{
						...
						?>
	                    <tr style="font-size:18px" bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                         ...
                         <td width="80" align="right"><? echo fn_number_format(($dataArr[TARGET_CM][$key]*75/100)+(($dataArr[TARGET_CM][$key]*25/100)/26*$row[WOD]),0).'<br>';?></td>
                           ...
                           <?php /*?> <td width="70" align="right"><? echo fn_number_format($dataArr[PLN_CUT_QTY_PCS][$key],0);?></td><?php */?>
                            ...
                            <td width="50" align="center"><? echo fn_number_format((($dataArr[BOOKED_CM_VALUE][$key])/$dataArr[BOOKED_VALUE][$key])*100,0);?></td>  
                            <td width="60" align="center"><? echo fn_number_format($dataArr[AVE_PRICE_BASIC][$key],2);?></td>
                            <td width="40" align="center"><? echo fn_number_format((($dataArr[BOOKED_SAH][$key]/$row[CAPACITY_SAH])*100),0);?></td>
                            <td width="40" align="center"><? echo fn_number_format((($dataArr[BKD_QTY_PCS][$key]/$row[CAPACITY_QTY])*100),0);?></td>
                            <td width="40" align="center"><? echo fn_number_format((($dataArr[BOOKED_VALUE][$key]/$row[CAPACITY_VALUE])*100),0);?></td>                      
                            <td width="40" align="center"><? echo fn_number_format((($dataArr[BOOKED_CM_VALUE][$key])/$targetCM[TARGET_CM_CALC][$key])*100,0);?></td>                              
