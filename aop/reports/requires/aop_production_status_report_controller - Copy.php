...
{    
    ...
    //===============================================================start=====================================================================================
        ...
        from subcon_ord_mst a, subcon_ord_dtls b, tmp_poid tmp
        ...
        $order_no_cond $style_ref_cond $job_no_cond $location_id_cond  $within_group_cond $buyer_id_cond $reference_no_cond $buyer_style_cond $buyer_po_cond $buyer_buyer_cond $machine_flooR_cond $order_id_cond
        ...
        foreach ($job_sql_result as $row) {
            ...
            if ($cbo_delevery_status == 2) {
                ...
                if( ($tot_delv < $row[csf('order_quantity')]) &&  ($row[csf('delivery_status')] != 3) ) {
                    $jobs_arr[$job_dtls_id]['job_dtls_id'] = $job_dtls_id;
                    $jobs_arr[$job_dtls_id]['id'] = $row[csf('id')];
                    $jobs_arr[$job_dtls_id]['subcon_job'] = $row[csf('subcon_job')];
                    $jobs_arr[$job_dtls_id]['within_group'] = $row[csf('within_group')];
                    $jobs_arr[$job_dtls_id]['party_id'] = $row[csf('party_id')];
                    $jobs_arr[$job_dtls_id]['order_no'] = $row[csf('order_no')];
                    $jobs_arr[$job_dtls_id]['delivery_status'] = $row[csf('delivery_status')];
                    $jobs_arr[$job_dtls_id]['order_quantity'] = $row[csf('order_quantity')];
                    $jobs_arr[$job_dtls_id]['amount'] = $row[csf('amount')];
                    $jobs_arr[$job_dtls_id]['order_uom'] = $row[csf('order_uom')];
                    $jobs_arr[$job_dtls_id]['buyer_po_id'] = $row[csf('buyer_po_id')];
                    $jobs_arr[$job_dtls_id]['buyer_style_ref'] = $row[csf('buyer_style_ref')];
                    $jobs_arr[$job_dtls_id]['delivery_date'] = $row[csf('delivery_date')];
                    $jobs_arr[$job_dtls_id]['buyer_buyer'] = $row[csf('buyer_buyer')];
                    $jobs_arr[$job_dtls_id]['aop_reference'] = $row[csf('aop_reference')];
                }
        ...
        <div style="max-height:400px; overflow-y:scroll; width:<? echo $tbl_width+20; ?>px" id="scroll_body">
                ...
                foreach ($jobs_arr as $row)
                {
                 ...
                 <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">   
                   ...
                   <td width="60" align="center"><p><? echo $unit_of_measurement[$row['order_uom']]; ?></p></td>
                    ...
                    <td width="80" align="right"><p><? echo number_format($total_delv_quantity,2); ?></p></td>
            ...
            ////////////////////////////////////////////////////////////////////        
                ...
                <tr class="tbl_bottom">
                    ...
                    <td width="120" align="right"><?php echo number_format($totalRec, 2); ?></td>
                    <td width="120" align="right"></td>
                    ...
                    <td width="80" align="right"><?php echo number_format($totalProd, 2); ?></td>
                    <td width="80" align="right"></td>
                    <td width="80" align="right" id="value_tot_total_qc_qty"><? echo number_format($tot_total_qc_qty); ?></td>
                    <td width="80" align="right" id="value_total_reject_quantity"><? echo number_format($total_reject_quantity); ?></td>
                    <td width="80" align="right"><?php echo number_format($totalQc, 2); ?></td>
                    <td width="80" align="right"></td>
                    <td width="80" align="right"></td>
                    <td width="80" align="right" id="value_tot_delv_today_quantity"><? echo number_format($tot_delv_today_quantity); ?></td>
                    <td width="80" align="right"></td>
                    <td width="80" align="right" id="value_tot_delv_balance"><? echo number_format($tot_delv_balance); ?></td>
                    <td width="80"></td>
                    <td width="80"></td>
    ...
    $r_id3=execute_query("delete from tmp_poid where userid=$user_id and type='985'");
    if($db_type==0) {
        if($r_id3) {
            mysql_query("COMMIT");  
        }
