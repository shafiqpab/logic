...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Aop Machine wise Daily AOP Printing Production Report", "../../", 1, 1,$unicode,1,1);
?>	
...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../../logout.php";  
	...
	function fn_report_generated(type)
	{
		...
		else
		{
			...
			freeze_window(3);
			http.open("POST","requires/machine_wise_daily_aop_printing_production_report_controller.php",true);
	...
	{ 
		 emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/machine_wise_daily_aop_printing_production_report_controller.php?action='+action+'&order_id='+order_id, 'AOP Production Status Report', 'width='+width+',height=400px,center=1,resize=0,scrolling=0','../');
	...
	function fnc_load_party(type)
	{
		...
		load_drop_down( 'requires/machine_wise_daily_aop_printing_production_report_controller', company+'_'+cbo_within_group, 'load_drop_down_buyer', 'buyer_td' );
		load_drop_down( 'requires/machine_wise_daily_aop_printing_production_report_controller', company+'_'+cbo_within_group, 'load_drop_down_buyer_buyer', 'buyer_buye_td' );
	}
	...
	{ 
		...
		var page_link="requires/machine_wise_daily_aop_printing_production_report_controller.php?action=job_no_popup&company_id="+company_name+"&cbo_buyer_name="+cbo_buyer_name;
	...
	{ 
		...
		var page_link="requires/machine_wise_daily_aop_printing_production_report_controller.php?action=order_no_popup&company_id="+company_name+"&cbo_buyer_name="+cbo_buyer_name+"&job_no="+job_no;
