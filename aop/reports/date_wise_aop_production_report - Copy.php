...
<script>
	...
	function fn_report_generated(type)
	{
		...
		else
		{
			...
			var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_party_name*cbo_within_group*txt_buyer_po*txt_buyer_style*txt_int_ref*txt_job_no*txt_order_no*txt_date_from*txt_date_to*txt_order_id',"../../")+'&type='+type;
			freeze_window(3);
