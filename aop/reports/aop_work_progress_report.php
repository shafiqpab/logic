...
<script>
	...
	function fn_report_generated(type)
	{
		...
		else
		{
			...
			var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_party_name*cbo_within_group*txt_buyer_po*txt_buyer_style*txt_job_no*txt_order_no*txt_date_from*txt_date_to*txt_order_id*cbo_year_selection',"../../")+'&type='+type;
			freeze_window(3);
			http.open("POST","requires/aop_work_progress_report_controller.php",true);
	...
	{ 
		 emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/aop_work_progress_report_controller.php?action='+action+'&order_id='+order_id, 'AOP Work Progress Report Details', 'width='+width+',height=400px,center=1,resize=0,scrolling=0','../');
	...
	function fnc_load_party(type)
	{
		...
		load_drop_down( 'requires/aop_work_progress_report_controller', company+'_'+cbo_within_group, 'load_drop_down_buyer', 'buyer_td' );
	}
	...
	{ 
		...
		var page_link="requires/aop_work_progress_report_controller.php?action=job_no_popup&company_id="+company_name+"&cbo_buyer_name="+cbo_buyer_name;
	...
	{ 
		...
		var page_link="requires/aop_work_progress_report_controller.php?action=order_no_popup&company_id="+company_name+"&cbo_buyer_name="+cbo_buyer_name+"&job_no="+job_no;
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr class="general">
                        ...
                        <td>
                            <? 
                                echo create_drop_down( "cbo_within_group",80, $yes_no,"", 1, "--All--", 0, "fnc_load_party(1);" );
                            ?>
                        </td>
                        <td id="buyer_td">
                            <? 
