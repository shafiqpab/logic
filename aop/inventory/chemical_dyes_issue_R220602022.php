...
<script>
	...
	function fnc_chemical_dyes_issue_entry(operation)
	{
		...
		else if(operation==0 || operation==1 || operation==2)
		{
			...
			var dataString = "txt_mrr_no*update_id*cbo_company_name*cbo_location_name*cbo_issue_basis*cbo_issue_purpose*cbo_loan_party*txt_req_no*txt_req_id*txt_issue_date*txt_recipe_no*txt_recipe_id*txt_job_no*txt_order_no*hidden_order_id*cbo_store_name*txt_buyer_po*hidden_buyer_po_id*cbo_sub_process*txt_buyer_style*txt_batch_no*hidden_batch_id*txt_apo_ref*txt_remarks";
                    ...
                    <table  width="950" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                        ...
                        <tr>
                         ...
                         <tr>
                            ...
                            <td>
                            <? 
                            echo create_drop_down( "cbo_issue_purpose", 170, $yarn_issue_purpose,"", 1, "-- Select Purpose --", 53, "fn_active_inactive(this.value)", "","3,5,26,30,32,33,40,53");
                            ?>
                            </td>
