            ...
            <form id="locationdetailsform_1"  name=""action="locationdetailsform_1" >
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td><input type="text" name="txt_location_name" style="width:265px;" id="txt_location_name" class="text_boxes" value="" width="400" maxlength="64" title="Maximum 64 Character" />
