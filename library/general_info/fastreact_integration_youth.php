<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Fast React Integration.
Functionality	:	
JS Functions	:
Created by		:	Kausar 
...
function fnc_store_location( operation )
{
	...
	http.open("POST","requires/fastreact_integration_youth_controller.php",true);
        ...
        <fieldset style="width:600px;">
            ...
            <form name="storelocation_1" id="storelocation_1" autocomplete = "off">	
              <table cellpadding="0" cellspacing="2" width="100%">
              	<tr>
                  	<td width="121">Export PO Country Ship Date</td>
