		 ...
		 if( $db_type==0 )
			{
				...
				$shipment_date="and b.po_received_date >= '2015-03-09'";
			}
			if($db_type==2)
			{
				$shipment_date="and b.po_received_date >= '01-Oct-2014'";
			}
...
group by b.po_break_down_id,b.item_number_id,b.cutup,b.color_number_id,b.country_ship_date order by b.id,b.po_break_down_id,b.country_ship_date" ); 
		...
		foreach($sql as $name)
		{
			...
			else 
			{
				...
				$str_po=$name[csf('po_break_down_id')]."::".$color_lib[$name[csf('color_number_id')]]."::".$name[csf('cutup')]."".$str_item;  
				$str_po_cut=$name[csf('cutup')]."::"; 
			}
