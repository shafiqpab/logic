...
//$fr_product_type=array(1=>"T-Shirt", 2   =>"T-Shirt", 3   =>"Polo Shirt", 4   =>"Polo Shirt", 5   =>"Tank Top", 6   =>"T-Shirt", 7   =>"Hoodies", 8   =>"Henley", 9   =>"T-Shirt", 10  =>"", 11  =>"T-Shirt", 12  =>"Scarf", 14  =>"Blazer", 15  =>"Jacket", 16  =>"Nightwear-Top", 17  =>"", 18  =>"Dress", 19  =>"Dress", 20  =>"Pant", 21  =>"Short Pant", 22  =>"Trouser", 23  =>"Legging", 24  =>"Romper", 25  =>"Romper", 26  =>"Romper", 27  =>"Romper", 28  =>"Legging", 29  =>"Three Quater", 30  =>"Skirts", 31  =>"Cardigan", 32  =>"Cap", 33  =>"Legging", 34  =>"Legging", 35  =>"Pant", 36  =>"", 37  =>"", 38  =>"", 39  =>"Sweat Shirt", 40  =>"", 41  =>"", 42  =>"Boxer", 43  =>"Boxer", 44  =>"Boxer", 45  =>"Boxer", 46  =>"", 47  =>"", 48  =>"", 49  =>"", 50  =>"", 51  =>"", 52  =>"", 53  =>"", 54  =>"", 60  =>"", 61  =>"", 62  =>"", 63  =>"", 64  =>"", 65  =>"", 66  =>"", 67  =>"Sweat Pant", 68  =>"", 69  =>"", 70  =>"Pant", 71  =>"Pant", 72  =>"", 73  =>"Strap Top", 74  =>"", 75  =>"", 76  =>"", 77  =>"", 78  =>"", 79  =>"", 80  =>"Romper", 81  =>"Romper", 82  =>"Romper", 83  =>"", 84  =>"", 85  =>"", 86  =>"", 87  =>"", 88  =>"", 89  =>"", 90  =>"", 91  =>"Jogger", 92  =>"Jogger", 93  =>"Jogger", 94  =>"Jogger", 95  =>"Jogger", 96  =>"Nightwear-Top", 97  =>"Shirt", 98  =>"Romper", 99  =>"Tank Top", 100 =>"Tank Top", 101 =>"T-Shirt", 102 =>"T-Shirt", 103 =>"T-Shirt", 104 =>"Blanket", 105 =>"", 106 =>"Sweater", 107 =>"Sweater", 108 =>"Cardigan", 109 =>"Nightwear-Top", 110 =>"Nightwear-Bottom", 111 =>"T-Shirt", 112 =>"T-Shirt", 113 =>"", 114 =>"", 115 =>"Boxer", 116 =>"Boxer", 117 =>"", 118 =>"", 119 =>"", 120 =>"", 121 =>"", 122 =>"", 123 =>"Boxer", 124 =>"T-Shirt", 126 =>"", 129 =>"", 130 =>"", 131 =>"", 132 =>"T-Shirt", 133 =>"T-Shirt", 134 =>"T-Shirt", 135 =>"", 136 =>"Hair Band", 137 =>"Pull Over", 138 =>"Hoodies", 139 =>"T-Shirt", 140 =>"Short Pant", 141 =>"Overall", 142 =>"Legging", 143 =>"Shirt");
...
if ( $action=="save_update_delete" )
{
	...
	if ( $cbo_fr_integrtion==0 )
	{
		...
		$cmArr=return_library_array("select job_no, cm_cost from wo_pre_cost_dtls where is_deleted=0 and status_active=1","job_no","cm_cost");
					...
					foreach($item_data as $item_id=>$color_data)
					{
						foreach($color_data as $color_id=>$other_val)
						{
							if($other_val['order_qty']>1)
							{
								...
								$str_po=$ft_data_arr[$jobno][style_ref_no]."::".$po_no."::".$color_lib[$color_id]."::".$jobno."::".$shipdate."".$str_item;  
	...
	//	print_r($deleted_po_list);
		...
		$txt .=str_pad("U.ORDER",0," ")."\t".str_pad("U.DATE",0," ")."\t".str_pad("U.OPERATION",0," ")."\t".str_pad("U.LINE_EXTERNAL_ID",0," ")."\t".str_pad("U.QTY",0," ")."\t".str_pad("U.NOTE",0," ")."\t".str_pad("U.OPN_COMPLETE",0," ")."\r\n";
		foreach($production_qty as $oid=>$prodctn)
		{
			foreach($prodctn as $prod_typ=>$prodflr)
			{
				foreach($prodflr as $line=>$sdata)
				{
					...
					if(  $prod_type_n>0)
						$txt .=str_pad($oid,0," ")."\t ".str_pad($sdate,0," ")."\t".str_pad($prod_type_n,0," ")."\t".str_pad($line,0," ")."\t".str_pad($sdata['qnty'],0," ")."\t".str_pad('',0," ")."\t".str_pad('',0," ")."\r\n";
				}
			}	
		}
