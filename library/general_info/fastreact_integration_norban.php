<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Fast React Integration[NORBAN].
Functionality	:	
JS Functions	:
Created by		:	Kausar 
...
function fnc_store_location( operation )
{
	...
	http.open("POST","requires/fastreact_integration_norban_controller.php",true);
        ...
        <fieldset style="width:600px;">
            ...
            <form name="storelocation_1" id="storelocation_1" autocomplete = "off">	
              <table cellpadding="0" cellspacing="2" width="100%">
              	<tr>
                  	<td width="121">Export PO Org. Shipment Date</td>
                  	<td width="375"><input type="text" class="datepicker" id="received_date" style="width:100px"> </td>            
                </tr>
                <tr>
                  	<td width="121">Export Module </td>
                  	<td width="375"><? 
					 	$fr_item_list= array( 0=>"All Modules",1=>"Customer",2=>"Products",3=>"Orders",4=>"Production Updates",5=>"Attendance"); 
