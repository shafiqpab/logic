   ...
   $process = array( &$_POST );
	...
	if ($operation==0)  // Insert Here
	{
		...
		else
		{
			...
			$field_array="id, supplier_name, short_name,contact_person, contact_no, party_type, designation, tag_company, country_id, web_site,email, address_1, address_2, address_3, address_4,remark,buyer, credit_limit_days, credit_limit_amount,credit_limit_amount_currency, discount_method, securitye_deducted, vat_to_be_deducted, ait_to_be_deducted, 	individual,supplier_nature,tag_buyer,supplier_ref, inserted_by, insert_date, status_active,is_deleted";
				$data_array="(".$id.",".$txt_supplier_name.",".$txt_short_name.",".$txt_contact_person.",".$txt_contact_no.",".$txt_party_type_id.",".$txt_desination.",".$cbo_tag_company.",".$cbo_country.",".$txt_web_site.",".$txt_email.",".$txt_address_1st.",".$txt_address_2nd.",".$txt_address_3rd.",".$txt_address_4th.",".$txt_remark.",".$cbo_buyer.",".$txt_credit_limit_days.",".$txt_credit_limit_amount.",".$cbo_credit_limit_amount_curr.",".$cbo_discount_method.",".$cbo_security_deducted.",".$cbo_vat_to_be_deducted.",".$cbo_ait_to_be_deducted.",".$cbo_individual.",".$cbo_supplier_nature.",".$txt_tag_buyer_id.",".$txt_supplier_ref.",".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',".$cbo_status.",'0')";
	...
	else if ($operation==1)   // Update Here
	{
		...
		else
		{
			...
			{
				$field_array="contact_person*contact_no*party_type*designation*country_id*web_site*email*address_1*address_2*address_3* address_4*remark*buyer*credit_limit_days*credit_limit_amount*credit_limit_amount_currency*discount_method*securitye_deducted*vat_to_be_deducted*ait_to_be_deducted*individual*supplier_nature*tag_buyer*supplier_ref*updated_by* update_date";
				$data_array="".$txt_contact_person."*".$txt_contact_no."*".$txt_party_type_id."*".$txt_desination."*".$cbo_country."*".$txt_web_site."*".$txt_email."*".$txt_address_1st."*".$txt_address_2nd."*".$txt_address_3rd."*".$txt_address_4th."*".$txt_remark."*".$cbo_buyer."*".$txt_credit_limit_days."*".$txt_credit_limit_amount."*".$cbo_credit_limit_amount_curr."*".$cbo_discount_method."*".$cbo_security_deducted."*".$cbo_vat_to_be_deducted."*".$cbo_ait_to_be_deducted."*".$cbo_individual."*".$cbo_supplier_nature."*".$txt_tag_buyer_id."*".$txt_supplier_ref."*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'";
			}
			else
			{
				$field_array="supplier_name* short_name*contact_person*contact_no*party_type*designation*tag_company*country_id*web_site*email*address_1*address_2*address_3* address_4*remark*buyer*credit_limit_days*credit_limit_amount*credit_limit_amount_currency*discount_method*securitye_deducted*vat_to_be_deducted*ait_to_be_deducted*individual*supplier_nature*tag_buyer*supplier_ref*updated_by* update_date*status_active*is_deleted";
...
if ($action=="load_php_data_to_form")
{
	...
	$nameArray=sql_select( "select id, supplier_name, short_name, contact_person, contact_no, party_type, designation, tag_company, country_id, web_site, email, address_1, address_2, address_3,address_4,remark,buyer,credit_limit_days, credit_limit_amount, credit_limit_amount_currency, discount_method, securitye_deducted, vat_to_be_deducted, ait_to_be_deducted,individual,supplier_nature,tag_buyer,supplier_ref, status_active,is_posted_account from lib_supplier  where id='$data'" );
