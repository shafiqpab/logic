...
echo load_html_head_contents("Marketing Team Info", "../../", 1, 1,$unicode,1,1);
...
function fnc_marchant_team_info( operation )
{
  if (form_validation('txt_team_name*txt_team_leader_name*txt_team_leader_desig*cbo_project_type','Team Name*Team Leader Name*Team Leader Designation*Project Type')==false)
    ...
    //var data="action=save_update_delete&operation="+operation+get_submitted_data_string('txt_team_name*txt_team_leader_name*txt_team_leader_desig*cbo_team_status*txt_team_leader_email*update_id*id_lib_mkt_team_member_info*txt_capacity_smv_leader*txt_capacity_basic_leader*txt_team_contact_no*hidden_user_id',"../../");

    var data="action=save_update_delete&operation="+operation+get_submitted_data_string('txt_team_name*txt_team_leader_name*txt_team_leader_desig*cbo_team_status*txt_team_leader_email*update_id*id_lib_mkt_team_member_info*txt_team_contact_no*hidden_user_id*txt_team_leader_desig_id*cbo_project_type*team_type*cbo_cad_user',"../../");
...
function fnc_marchant_team_info_reponse()
{
   ...
   // console.log(http.responseText);
  	...
  	show_msg(reponse[0]);
		...
		if(reponse[0]==2){
      reset_form('marchantteaminfo_1*marchantteaminfodet_2','member_list_view','');
    }
...
function fnc_marchant_team_info_det( operation )
{
    ...
    //var data="action=save_update_delete_dtl&operation="+operation+get_submitted_data_string('txt_member_name*txt_member_designation*txt_member_email*cbo_team_member_status*update_id_dtl*update_id*txt_capacity_smv_member*txt_capacity_basic_member*txt_member_contact_no*hidden_user_id_member',"../../");

    var data="action=save_update_delete_dtl&operation="+operation+get_submitted_data_string('txt_member_name*txt_member_designation*txt_member_email*cbo_team_member_status*update_id_dtl*update_id*txt_member_contact_no*hidden_user_id_member*txt_member_designation_id*member_type*data_level_security*cbo_cad_user',"../../");
...
function fnc_marchant_team_info_det_response()
{
    ...
    show_msg(reponse[0]);
		...
		show_list_view(document.getElementById('update_id').value, 'marchant_team_info_det_list_view', 'member_list_view', 'requires/marchant_team_info_controller', 'setFilterGrid(\'list_view1\',-1)');
		show_list_view('','marchant_team_info_list_view','team_list_view','requires/marchant_team_info_controller','setFilterGrid("list_view",-1)');
...
function popup_user_tag_info_leader()
{
	//alert('kaiyum');
	var title = 'User List';	
	var page_link ='requires/marchant_team_info_controller.php?action=user_tag_popup_leader';
...
function popup_user_tag_info_member()
{
	//alert('kaiyum');
	var title = 'User List';	
	var page_link ='requires/marchant_team_info_controller.php?action=user_tag_popup_member';
	var popup_width="420px";
	emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width='+popup_width+',height=300px,center=1,resize=1,scrolling=0','../');
	emailwindow.onclose=function()
	{
   ...
   // var designation =JSON.parse('<?// echo $lib_designation_arr; ?>');
    $("#txt_member_designation").val(ddata[6]);
...
<body onLoad="set_hotkey()">
    <div align="center" style="width:100%;">
	  <? echo load_freeze_divs ("../../",$permission);  ?>
         <?php $team_types=array(1=>"H/O",2=>" Factory",3=>"B/H"); ?>       
                            ...
                            <form name="marchantteaminfo_1" id="marchantteaminfo_1" autocomplete="off">	
                                ...
                                <table align="center" cellpadding="3" cellspacing="3">
                                    <tr>
                                        ...
                                        <td width="230">
                                          <Input name="txt_team_name" class="text_boxes" ID="txt_team_name" style="width:200px" maxlength="50" title="Maximum 50 Character" placeholder="Write">
                                        </td>
                                        <td width="90" class="must_entry_caption" align="right"> Team Leader </td>                          
                                        <td width="230">
                                          <input type="text" name="txt_team_leader_name" id="txt_team_leader_name" placeholder="Browse" readonly class="text_boxes" onDblClick="popup_user_tag_info_leader()" style="width:200px;" />
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                          <Input name="txt_team_leader_desig" class="text_boxes" ID="txt_team_leader_desig" style="width:200px" maxlength="50" title="Maximum 50 Character" readonly>
                                          <Input type="hidden" name="txt_team_leader_desig_id" class="text_boxes" ID="txt_team_leader_desig_id">
                                        </td> 
                                       
                                        <td align="right">Email</td>
                                        <td>
                                          <Input name="txt_team_leader_email" class="text_boxes" ID="txt_team_leader_email" style="width:200px" maxlength="50" title="Maximum 50 Character" >
                                        </td>
                                    </tr>
                                     ...
                                     <tr>
                                        ...
                                        <td >
                                        	 <Input name="txt_team_contact_no" class="text_boxes_numeric" ID="txt_team_contact_no" style="width:200px" maxlength="50" title="Maximum 50 Character">
                                        </td> 
                                        <td align="right" class="must_entry_caption">Project Type</td>                          
                                        <td >
                                        <? 
                                        echo create_drop_down( "cbo_project_type", 213, $project_type_arr,'', '', '', 1, '', "",'','' );
                                        ?>
                                        </td>
                                    </tr>
                                     <tr>
                                        ...
                                        <td > <? 
                                        echo create_drop_down( "team_type", 213, $team_types,'', 1,'--Select--',  0, "setmembertype();", "",'','' );
                                        ?></td> 
                                    </tr>
                                    <tr>
                                            ...
                                            <tr>
                                               ...
                                               <td  width="" align="right">Contact No.</td>
                                                ...
                                                <td align="right">Member Type</td>                          
                                                  <td > <? 
                                                  echo create_drop_down( "member_type", 150, $team_types,'', 1,'--Select--',  0,'',1,'','' );
                                                  ?></td> 
                                            </tr>
                                            

                                            <tr>
                                              <td align="right">Data Level Security</td>
                                              <td> <? 
                                                    echo create_drop_down( "data_level_security", 150, $yes_no,'', '', '', 1, '', "",'','' );
                                                    ?></td>
                                                    
                                                    
                                                    <td align="right">CAD User Name</td>
                                             	 <td> <? 
                                                
                                          echo create_drop_down( "cbo_cad_user", 150, "select id,user_name from  user_passwd where is_deleted=0 and status_active=1 order by user_name","id,user_name", 0,"-- Select --", $selected, "",0,"" ); 
											        ?>
                                                 </td>
                                             </tr>
                                            <tr>
                        ...
                        <tr>
                            ...
                            <fieldset style="width:800px">
                                    <legend>Leader Info</legend>
                                        ...
                                        $sql= "select project_type,team_name,team_leader_name,team_leader_desig,team_leader_email,total_member,status_active,id from lib_marketing_team where is_deleted=0 order by team_name";
...
<script>
	set_multiselect('cbo_cad_user','0','0','','0');
</script>
