...
<body onLoad="set_hotkey()">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="2">
                <tr>
                    ...
                    <td width="90" colspan="3">
                        <? 
                            echo create_drop_down( "cbo_rel_buyer",220, "select buyer_name,id from  lib_buyer where is_deleted=0 and status_active=1 order by buyer_name", "id,buyer_name", 1, '--Select--','', "show_list_view(this.value,'on_change_data','trim_cost_container','requires/woven_trims_cost_template_controller','')",''); 
                        ?>
                    </td>
                    ...
                    <table width="1110" cellpadding="0" cellspacing="0"  class="rpt_table" border="1" rules="all">
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                status_active=1 order by item_name", "id,item_name", 1, '--Select--', 0,"load_drop_down( 'requires/woven_trims_cost_template_controller', this.value, 'set_cons_uom', 'cons_uom_td' )" );
                                ?></td>
                            <td>
                            ...
                            <td align="center">
                            	<input type="text" name="txt_cons_dzn_gmts" id="txt_cons_dzn_gmts" class="text_boxes_numeric" style="width:80px" onBlur="fnc_ex_calculation(2); math_operation('txt_amount','txt_tot_cons*txt_purchase_rate','*','',{dec_type:1,comma:0,currency:2})">						
                            </td>
                              <td align="center">
                ...
                <tr>
                    <fieldset>
                        ...
                        <td width="90">
                            <? 
                                echo create_drop_down( "cbo_buyer",220, "select buyer_name,id from  lib_buyer where is_deleted=0 and  status_active=1 order by buyer_name", "id,buyer_name", 1, '--Select--','',"load_drop_down( 'requires/woven_trims_cost_template_controller', this.value, 'load_drop_down_template', 'td_template' );"); 
                            ?>
                        </td>
                        <td><b  style="color: blue">Template Name</b></td>
                        <td> <span id="td_template"><? 
                            echo create_drop_down("cbo_template_name",150,"select template_name from wo_lib_trim_cost_temp where is_deleted=0 group by template_name ORDER BY template_name ASC","template_name,template_name",1,'--Select--',0,'');
                         ?></span></td>
    ...
    function show_temp_list()
    {
        ...
        {
        show_list_view(document.getElementById('cbo_template_name').value+'_'+document.getElementById('cbo_buyer').value,'on_change_data','trim_cost_container','requires/woven_trims_cost_template_controller','setFilterGrid(\'list_view\',-1)');
        }
    ...
    function fnc_trim_cost_temp( operation )
    {
        ...
        {
            eval(get_submitted_variables('cbo_rel_buyer*txt_user_code*cbo_trims_group*cbo_cons_uom*txt_cons_dzn_gmts*txt_tot_cons*txt_ex_per*txt_purchase_rate*txt_amount*cbo_apvl_req*cbo_supplyer*cbo_status*update_id*template_name'));
            ...
            http.open("POST","requires/woven_trims_cost_template_controller.php",true);
    ...
    function fnc_trim_cost_temp_reponse()
    {
        ...
        if(http.readyState == 4) 
        {
            ...
            load_drop_down('requires/woven_trims_cost_template_controller','', 'get_template_dropdown', 'td_template' );
             $('#cbo_template_name').val(reponse[3]);
             $('#hidden_template_name').val(reponse[3]);
           
            
            show_list_view(data,'on_change_data','trim_cost_container','requires/woven_trims_cost_template_controller','setFilterGrid("list_view",-1)');
            reset_form('','','txt_user_code*txt_desc*cbo_trims_group*cbo_cons_uom*txt_cons_dzn_gmts*txt_ex_per*txt_tot_cons*txt_purchase_rate*txt_amount*cbo_supplyer*update_id*txt_sub_ref','','','');
    ...
    {        
        var page_link='requires/woven_trims_cost_template_controller.php?action=copy_template_popup';
        emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=320px,height=150px,center=1,resize=1,scrolling=0','../')
            ...
            {   var theform = this.contentDoc.forms[0];
                ...
                show_list_view(hidden_template_name,'on_change_data','trim_cost_container','requires/woven_trims_cost_template_controller','setFilterGrid("list_view",-1)'); 
