...
<script>
	...
	function fnc_body_part_title( operation )
	{
		...
		if (form_validation('cbo_company_name*txt_body_part_title_name','Comany Name*Body Part Title Name')==false)
		{
			return;
		}
		else
		{
			var data="action=save_update_delete&operation="+operation+get_submitted_data_string('cbo_company_name*txt_body_part_title_name*update_id*txt_copy_to_company_id',"../../");
	...
	function fn_company()
	{
		...
		else
		{
			...
			emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/body_part_title_entry_controller.php?cbo_company_name='+cbo_company_name+'&txt_copy_to_company_id='+txt_copy_to_company_id+'&action=company_popup','Copy Company', 'width=400px,height=400px,center=1,resize=0,scrolling=0','../')
	...
	<fieldset style="width:500px;">
		...
		<form name="bodyparttitle" id="bodyparttitle"  autocomplete="off">	
			<table cellpadding="0" cellspacing="2" width="75%">
				...
				<tr>
					<td width="109">Copy To Company</td>
	                <td colspan="3">
