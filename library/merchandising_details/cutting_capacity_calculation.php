...
var permission='<? echo $permission; ?>';
	...
	{
		if ( form_validation('cbo_company_id*cbo_location_id*cbo_year*cbo_month*txt_manpower*txt_working_hour*txt_sam','Company Name*Location*Year*Month*Manpower*Working Hour*CM')==false )
		{
			return;
		}
		var data=document.getElementById('cbo_year').value+"_"+document.getElementById('cbo_month').value+"_"+document.getElementById('cbo_company_id').value+"_"+document.getElementById('cbo_location_id').value+"_"+document.getElementById('txt_manpower').value+"_"+document.getElementById('txt_working_hour').value+"_"+document.getElementById('txt_sam').value;
...
<div align="center" style="width:100%;">
    ...
    <legend>Capacity Calculation</legend>
        <table cellpadding="0" cellspacing="2" width="100%">
            ...
            <tr>
            	<td width="59" class="must_entry_caption">Manpower</td>
                <td width="155">
					<input type="text" name="txt_manpower" id="txt_manpower" class="text_boxes" style="width:150px" />                             
                </td>
                <td width="59" class="must_entry_caption">Working Hour</td>
                <td width="155">
					<input type="text" name="txt_working_hour" id="txt_working_hour" class="text_boxes" style="width:150px" /> 
                </td>
                
                
            </tr>
            <tr>
                <td class="must_entry_caption">SAM</td>
                <td>
                    <input type="text" name="txt_sam" id="txt_sam" class="text_boxes" style="width:150px" />
                </td>
                <td >Table No</td>
                <td>
        ...
        <table cellpadding="0" cellspacing="2" width="100%">
            <tr>
                <td align="center" colspan="9" valign="middle" class="button_container">
					<input type="button" value="Generate" class="formbutton" onclick="daysInMonth();">
                    <?
