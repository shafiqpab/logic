...
if ($action=="load_php_dtls_form")
{
	...
	?>
		<tr align="center" <?php echo $style; ?>>
			...
			<td>
				<input type="text" name="txt_sew_capacity_min_<? echo $i; ?>" id="txt_sew_capacity_min_<? echo $i; ?>" class="text_boxes" class="text_boxes_numeric" style="width:80px" readonly="readonly"/>
			</td>
			<td>
				<input type="text" name="txt_sew_capacity_pcs_<? echo $i; ?>" id="txt_sew_capacity_pcs_<? echo $i; ?>" class="text_boxes" class="text_boxes_numeric" style="width:80px" readonly="readonly"/>
			</td>
			<td>
...
if ($action=="load_php_dtls_form_update_val")
{
	...
	else
	{
		...
		foreach ($sql_result as $inf)
		{
			...
			echo "document.getElementById('txt_sew_capacity_min_".$i."').value 	= '".$inf[csf("capacity_min")]."';\n";
