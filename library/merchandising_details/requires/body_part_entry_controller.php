...
if ($action == "load_php_data_to_form") 
{
	...
	if(count($division)>0 ){
		echo "$('#body_part_full_name').attr('disabled','disabled');\n";
		echo "$('#body_part_short_name').attr('disabled','disabled');\n";
		echo "$('#body_part_type').attr('disabled','disabled');\n";
        echo "$('#txt_entry_page').attr('disabled','disabled');\n";
        echo "$('#cbo_status').attr('disabled','disabled');\n";
	}
	else
	{
		echo "$('#body_part_full_name').removeAttr('disabled','disabled');\n";
		echo "$('#body_part_short_name').removeAttr('disabled','disabled');\n";
		echo "$('#body_part_type').removeAttr('disabled','disabled');\n";
