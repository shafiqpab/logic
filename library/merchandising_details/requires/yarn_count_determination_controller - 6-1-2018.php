				...
				if ( count($data_array)>0)
				{
					...
					foreach( $data_array as $row )
					{
						...
						<tr id="yarncost_1" align="center">
                            <td width="150"><? echo create_drop_down( "cbocompone_".$i, 150, $composition,"", 1, "-- Select --", $row[csf("copmposition_id")], "check_duplicate(".$i.",this.id )",'','' ); ?></td>
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0)  // Insert Here
	{
		...
		$data_array1="(".$id.",".$cbofabricnature.",".$txtconstruction.",".$txtgsmweight.",".$cbocolortype.",".$stichlength.",".$processloss.",".$txt_sequence.",".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."',".$cbo_status.",'0')";
	...
	else if ($operation==1)   // Update Here
	{
		...
		$data_array1="".$cbofabricnature."*".$txtconstruction."*".$txtgsmweight."*".$cbocolortype."*".$stichlength."*".$processloss."*".$txt_sequence."*".$_SESSION['logic_erp']['user_id']."*'".$pc_date_time."'*".$cbo_status."*'0'";
