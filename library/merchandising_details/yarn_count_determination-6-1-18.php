...
<script type="text/javascript">
	...
	function fnc_yarn_count_determination( operation )
	{
		...
		{
			if (form_validation('cbofabricnature*txtconstruction*cbocompone_'+i+'*percentone_'+i,'Fab Nature*Constrution*Composition*Percent')==false)
			{
				return;
			}
			data_all=data_all+get_submitted_data_string('cbofabricnature*txtconstruction*txtgsmweight*cbocolortype*stichlength*processloss*cbo_status*txt_sequence*update_mst_id*cbocompone_'+i+'*percentone_'+i+'*cbocountcotton_'+i+'*cbotypecotton_'+i+'*updateid_'+i,"../../");
		}
		//alert(data_all)
        ...
        <form name="yarncountdetermination_1" id="yarncountdetermination_1" autocomplete="off">
            <fieldset style="width:680px;">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="2">
                    <tr>
                        <td width="100" class="must_entry_caption">Fab Nature</td>
                        <td width="210"><?  echo create_drop_down( "cbofabricnature",200, $item_category,"", 0, "", '', "",$disabled,"2,3" ); ?></td>
                    ...
                    <table width="100%" border="0" id="tbl_yarn_count" cellpadding="0" cellspacing="0" class="rpt_table" rules="all" >
                        ...
                        <tbody>
                            <tr id="yarncost_1" align="center">
                                <td width="150"><? echo create_drop_down( "cbocompone_1", 150, $composition,"", 1, "-- Select --", '', "check_duplicate(1,this.id)",'','' ); ?></td>
