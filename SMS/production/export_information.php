...
//Delivery part start...............................................................
	...
	foreach($delivery_sql_res as $row)
	{
		...
		if($row[INVOICE_NO]){$all_invoice_id_array[$row[INVOICE_NO]]=$row[INVOICE_NO];}
...
//Invoice part start...............................................................
	...
	foreach($sqlEx as $row)
	{
		...
		$grand_total_exfactory_val_arr[$row[BENIFICIARY_ID]]+=$row[CURRENT_INVOICE_VALUE];
...
foreach($company_lib as $company_id=>$company_name){
	...
	foreach($deliveryDataArr[$company_id] as $buyer_id=>$rows){
		$rows[EX_FACTORY_VAL]=$current_inv_val_arr[$company_id][$buyer_id];
	...
	if($total_exfactory_qty_arr[$company_id]){
		...
		$smsBody.="Grand Total Gross Value : $ ".number_format(array_sum($current_inv_val_arr[$company_id]),2)."\n";
		//$total_exfactory_val_arr[$company_id]
		...
		$smsBody_short.="Grand Total Gross Value : $ ".number_format(array_sum($current_inv_val_arr[$company_id]),2)."\n";
