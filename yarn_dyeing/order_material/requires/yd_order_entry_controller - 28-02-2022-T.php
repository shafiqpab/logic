        ...
        <table width="840" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
            ...
            <tbody>
                <tr class="general">
                    ...
                    <td align="center">
                        <input type="button" name="button2" class="formbutton" value="Show" onClick="show_list_view ( document.getElementById('cbo_company_name').value+'_'+document.getElementById('cbo_party_name').value+'_'+document.getElementById('txt_date_from').value+'_'+document.getElementById('txt_date_to').value+'_'+document.getElementById('cbo_type').value+'_'+document.getElementById('txt_search_string').value+'_'+document.getElementById('cbo_within_group').value+'_'+document.getElementById('cbo_year_selection').value+'_'+'<? echo $data[4];?>', 'create_yd_search_list_view', 'search_div', 'yd_order_entry_controller', 'setFilterGrid(\'tbl_po_list\',-1)')" style="width:70px;" /></td>
                    </tr>
                    <tr>
...
if( $action=='order_dtls_list_view' ) 
{
    ...
    foreach($data_array as $row)
    {
        ...
        <tr bgcolor="<? echo $bgcolor; ?>" id="row_<? echo $tblRow; ?>" align="center">
            ...
            <td><input name="txtnoBag[]" id="txtnoBag_<? echo $tblRow; ?>" type="text" class="text_boxes_numeric" style="width:70px" value="<? echo $no_of_bag; ?>" readonly/></td>
            ...
            <td><input name="txtOrderqty[]" id="txtOrderqty_<? echo $tblRow; ?>" type="text" style="width:50px"  class="text_boxes_numeric" value="<? echo $orderQty; ?>" onKeyUp="sum_total_qnty(<? echo $tblRow;?>);" readonly /></td> 
            <td><input name="txtRate[]" id="txtRate_<? echo $tblRow; ?>" type="text" style="width:50px"  class="text_boxes_numeric"  value="<? echo $rate; ?>" onBlur="fnc_amount_cal(1)" /></td> 
            ...
            <td><input type="text" name="txtTotalqty[]" id="txtTotalqty_<? echo $tblRow; ?>" class="text_boxes_numeric" style="width:50px" value="<? echo $totalQty; ?>" readonly />
...
if ($action=="save_update_delete")
{
    ...
    if ($operation==0) // Insert Start Here
    {
        ...
        else
        {
            ...
            $rID3=true;
            $field_array="id, entry_form, yd_job, job_no_prefix, job_no_prefix_num, company_id, location_id, within_group, party_id, party_location, currency_id, receive_date, delivery_date, rec_start_date, rec_end_date, order_id, order_no, booking_without_order, booking_type, remarks,check_box_id, inserted_by, insert_date";
            $data_array="(".$id.", 374, '".$new_job_no[0]."', '".$new_job_no[1]."', '".$new_job_no[2]."', '".$cbo_company_name."', '".$cbo_location_name."', '".$cbo_within_group."', '".$cbo_party_name."', '".$cbo_party_location."', '".$cbo_currency."', '".$txt_order_receive_date."', '".$txt_delivery_date."','".$txt_rec_start_date."','".$txt_rec_end_date."', '".$hid_order_id."', '".$txt_order_no."', '".$is_without_order."','".$hid_booking_type."', '".$txt_remarks."', '".$txt_check_box."', ".$_SESSION['logic_erp']['user_id'].", '".$pc_date_time."')";
