        ...
        <table width="840" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
            ...
            <tbody>
                <tr class="general">
                    ...
                    <td align="center">
                        <input type="button" name="button2" class="formbutton" value="Show" onClick="show_list_view ( document.getElementById('cbo_company_name').value+'_'+document.getElementById('cbo_party_name').value+'_'+document.getElementById('txt_date_from').value+'_'+document.getElementById('txt_date_to').value+'_'+document.getElementById('cbo_type').value+'_'+document.getElementById('txt_search_string').value+'_'+document.getElementById('cbo_within_group').value+'_'+document.getElementById('cbo_year_selection').value+'_'+document.getElementById('txt_search_order').value+'_'+'<? echo $data[4];?>', 'create_yd_search_list_view', 'search_div', 'yd_order_entry_controller', 'setFilterGrid(\'tbl_list_search\',-1)')" style="width:70px;" /></td>
                    </tr>
                    <tr>
...
if ($action == "create_yd_search_list_view")
{
    ...
    $sql= "select a.id, a.yd_job, a.job_no_prefix_num,a.within_group, $ins_year_cond as year, a.party_id, a.location_id, a.party_id, a.receive_date, a.order_no, a.delivery_date ,a.booking_without_order, a.booking_type,a.order_type, 
   a.yd_process, a.yd_type,a.pro_type from yd_ord_mst a where a.entry_form=374 and a.status_active =1 and a.is_deleted =0 $sql_cond order by a.id DESC";
    ...
    <div style="width:1150px;"  align="left">
        ...
        <div style="width:1150px;  overflow-y:scroll; max-height:300px;" id="buyer_list_view">
            <table cellspacing="0" cellpadding="0" border="1" rules="all" width="1100" class="rpt_table"
            id="tbl_list_search">
            <?
            $i = 1;
            foreach ($data_array as $selectResult)
            {
                ...
                <tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer"
                    ...
                    <td width="150" align="center"><p> <? echo $com_buyer; ?></p></td>
                    <td width="100" align="center"><p> <? echo $w_pro_type_arr[$selectResult[csf('pro_type')]]; ?></p></td>
                    <td width="100" align="center"><p> <? echo $w_order_type_arr[$selectResult[csf('order_type')]]; ?></p></td>
                    <td width="100" align="center"><p> <? echo $yd_type_arr[$selectResult[csf('yd_type')]]; ?></p></td>
                    <td width="100" align="center"><p> <? echo $yd_process_arr[$selectResult[csf('yd_process')]]; ?></p></td>
                    <td width="100"><p><? echo change_date_format($selectResult[csf('receive_date')]); ?></p></td>
...
if ($action=="populate_master_from_data")
{
    ...
    $nameArray=sql_select( "select id, ydw_no, supplier_id, company_id, currency, booking_without_order from  wo_yarn_dyeing_mst where status_active=1 and is_deleted=0 and id='$data[0]' and  status_active =1 and  is_deleted =0" );
    $booking_type=1;
    foreach ($nameArray as $row) 
    {   
...
if ($action=="populate_job_master_from_data")
{
    ...
    {   
        ...
        echo "document.getElementById('order_type').value         = '".$row[csf("order_type")]."';\n";
        echo "document.getElementById('yd_type').value         = '".$row[csf("yd_type")]."';\n";
        echo "document.getElementById('yd_process').value         = '".$row[csf("yd_process")]."';\n";
        ...
        echo "document.getElementById('pro_type').value     = '".$row[csf("pro_type")]."';\n";
...
if( $action=='order_dtls_list_view' ) 
{
        ...
        foreach($data_array as $row)
        {
            ...
            <tr bgcolor="<? echo $bgcolor; ?>" id="row_<? echo $tblRow; ?>" align="center">
               ...
               <input type="hidden" name="txtprocess[]" id="txtprocess_<? echo $tblRow; ?>" class="text_boxes" style="width:80px;" value="<?php echo $process;?>" readonly />
                ...
                <? 
                    echo create_drop_down( "txtItemColor_".$tblRow, 90, $color_range,"", 1, "-- Select --",$itemColor,"",0,'','','','','','',"txtItemColor[]"); ?>
    ...
    else
    {
        ...
        <tr id="row_1">
            ...
            <td>  <? echo   create_drop_down( "txtItemColor_1", 90, $color_range,"", 1, "-- Select --",0,"",0,'','','','','','',"txtItemColor[]")   ?>
...
if ($action=="save_update_delete")
{
    ...
    if ($operation==0) // Insert Start Here
    {
        ...
        else
        {
            ...
            $rID3=true;
            $field_array="id, entry_form, yd_job, job_no_prefix, job_no_prefix_num, company_id, location_id, within_group, party_id, party_location, currency_id, receive_date, delivery_date, rec_start_date, rec_end_date, order_id, order_no, booking_without_order, booking_type, remarks,check_box_id,exchange_rate,tag_pi_no,order_type,yd_type,yd_process,attention,team_leader,team_member,party_ref,pro_type,check_box_confirm, check_box_advance,inserted_by, insert_date";


            $data_array="(".$id.", 374, '".$new_job_no[0]."', '".$new_job_no[1]."', '".$new_job_no[2]."', '".$cbo_company_name."', '".$cbo_location_name."', '".$cbo_within_group."', '".$cbo_party_name."', '".$cbo_party_location."', '".$cbo_currency."', '".$txt_order_receive_date."', '".$txt_delivery_date."','".$txt_rec_start_date."','".$txt_rec_end_date."', '".$hid_order_id."', '".$txt_order_no."', '".$is_without_order."','".$hid_booking_type."', '".$txt_remarks."', '".$txt_check_box."', '".$txt_exchange_rate."', '".$txt_tag_pi_no."', '".$order_type."', '".$yd_type."', '".$yd_process."', '".$attention."', '".$cbo_team_leader."', '".$cbo_team_member."', '".$party_ref."', '".$pro_type."','".$txt_check_box_confirm."','".$txt_check_box_advance."', ".$_SESSION['logic_erp']['user_id'].", '".$pc_date_time."')";
            
            $txt_job_no=$new_job_no[0];
            $field_array2="id, mst_id, job_no_mst, order_id, order_no, style_ref, sales_order_no, sales_order_id, product_id, process_id, process_name,lot, count_id, yarn_type_id, yarn_composition_id, item_color_id, yd_color_id, csp, no_bag, cone_per_bag, no_cone, avg_wgt, uom, order_quantity,  rate, amount, process_loss, total_order_quantity,count_type,buyer_buyer,adj_type,use_for,app_ref, inserted_by, insert_date";
