...
<script>
    ...
    function fnc_yarn_dyeing( operation )
    {
        ...
        var cbo_within_group = $("#cbo_within_group").val(); 
		 ...
		 {
			if ( form_validation('cbo_company_name*cbo_within_group*cbo_party_name*cbo_currency*txt_order_receive_date*order_type','Company*Within Group*Party*Currency*Order Receive Date*Order Type')==false )
			{
				return;
			} 
		 }
	...
	function fnc_wo_check_confirm(type)
	{
		...
		var order_type = $('#order_type').val();
		fnc_load_order_type(order_type);
	...
	function fnc_wo_check_advance(type)
	{
        ...
        $("#tbl_dtls_yarn_dyeing tbody tr").each(function()
        {
            ...
            if( (txtlot=='' || cboCount==0 || cboYarnType==0 || txtcounttype==0 || cboComposition==0 || txtItemColor==0 || txtYarnColor==''|| cboUom==0 || txtOrderqty==''))
            {   
    ...
    function openmypage_job(){
        ...
        emailwindow=dhtmlmodal.open('EmailBox','iframe', page_link, title, 'width=1190px, height=420px, center=1, resize=0, scrolling=0','../')
...
//alert(type);
    ...
    function openmypage_process(row_no)
    {
        ...
        var page_link = 'requires/yd_order_entry_controller.php?action=process_popup&txtprocess='+txtprocess+'&txtprocessname='+txtprocessname+'&yd_process='+yd_process+'&yd_type='+yd_type;
	...
	<div style="width:100%;" align="center">
            ...
            <legend>Yarn Dyeing Order Entry</legend>
                <table width="1330" cellspacing="2" cellpadding="0" border="0" id="tbl_master">
                    ...
                    <tr>
						...
						<b id="td_check_box_advance" style="display:none">
                        <input class="text_boxes" type="checkbox" name="txt_check_box_advance" id="txt_check_box_advance"  style="width:60px;" value="0" onClick="fnc_wo_check_advance(3);"  />Advance</b>
						</td>
                    </tr>
                    <tr>
                        ...
                        <td id="order_type_td">
                            ...
                            echo create_drop_down("pro_type", 150, $w_pro_type_arr,"", 1, "-- Select Type --",$selected,"", "","","","","",7 ); 
                            ?>
                        </td>
                        <td >Order Type</td>                                              
                        <td id="order_type_td">
                    ...
                    <tr>
                        ...
                        <td id="yd_process_td">
                            ...
                            echo create_drop_down("yd_process", 150, $yd_process_arr,"", 1, "-- Select Y/D Process --",$selected,"change_sub_process(this.value);", "","","","","",7 ); 
                            ?>
                        </td>
                        <td>Attention By</td> 
                    ...
                    <tr>
                        <td>Party Ref.</td> 
                         ...
                         <td >Remarks</td>
                        <td colspan="3"><input type="text" name="txt_remarks" id="txt_remarks" class="text_boxes" style="width:410px"  placeholder="Write" />
                        </td>
        ...
        <fieldset style="width:2100px;">
           <legend>YD Order Entry Details</legend>
                <table width="2080px" cellpadding="0" cellspacing="2" border="0" class="rpt_table" rules="all" id="tbl_dtls_yarn_dyeing">
                    ...
                    <tbody id="dyeing_details_container">
                        <tr id="row_1">
                           ...
                           <input type="hidden" name="txtprocess[]" id="txtprocess_1" class="text_boxes" value="" style="width:80px;"  readonly />
                            ...
                            <td>
                            <? echo   create_drop_down( "txtItemColor_1", 90, $color_range,"", 1, "-- Select --",0,"",0,'','','','','','',"txtItemColor[]")   ?>
                            ...
                            <td><input name="txtOrderqty[]" onKeyUp="fnc_amount_cal(1)" id="txtOrderqty_1" type="text" style="width:50px"  class="text_boxes_numeric" readonly placeholder="" /></td> 
