...
<script>
    ...
    function fnc_yarn_dyeing( operation )
    {
        ...
        $("#tbl_dtls_yarn_dyeing tbody tr").each(function()
        {
            ...
            var txtNoCone           = $(this).find('input[name="txtNoCone[]"]').val();
           ...
           <legend>YD Order Entry Details</legend>
                <table width="1550px" cellpadding="0" cellspacing="2" border="0" class="rpt_table" rules="all" id="tbl_dtls_yarn_dyeing">
                    <thead class="form_table_header">
                        ...
                        <th width="90" id="" class="must_entry_caption" >Count</th>
                    ...
                    <tbody id="dyeing_details_container">
                        <tr>
                        	...
                        	<td><input id="txtcount_1" name="txtcount[]" type="text" class="text_boxes_numeric" style="width:80px" placeholder=""/></td>
                        	<td><input id="txtydtype_1" name="txtydtype[]" type="text" class="text_boxes" style="width:60px" placeholder=""/></td>
                        	<td><input id="txtydComposition_1" name="txtydComposition[]" type="text" class="text_boxes" style="width:60px" placeholder=""/></td>
                            <td><input name="txtItemcolor[]" id="txtItemcolor_1" type="text" class="text_boxes" style="width:50px" placeholder="" readonly />
                            	<input name="txtItemcolor[]" id="txtItemcolor_1" type="hidden" class="text_boxes" style="width:50px" />
                            </td>
                            <td><input name="txtYdcolor[]" id="txtYdcolor_1" type="text" class="text_boxes" style="width:50px" placeholder="" readonly /></td>
                            ...
                            <td><input name="txtNoCone_1" id="txtNoCone_1" class="text_boxes_numeric" type="text"  style="width:50px"  placeholder="Write" /></td>
                            <td><input name="txtAVG_1" id="txtAVG_1" type="text"  class="text_boxes_numeric" style="width:50px" placeholder="Write" /></td>
                            <td><? echo create_drop_down( "cboUom_1", 60, $unit_of_measurement,"", 1, "-- Select --",2,"", "","2,1,12,23" ); ?></td>
                            <td><input name="txtOrderqty_1" id="txtOrderqty_1" type="text" style="width:50px"  class="text_boxes_numeric" readonly placeholder="" /></td> 
                            <td><input name="txtRate_1" id="txtRate_1" type="text" style="width:50px"  class="text_boxes_numeric"  placeholder="" /></td> 
                            <td><input name="txtAmount_1" id="txtAmount_1" type="text" style="width:50px"  class="text_boxes_numeric"  placeholder="" /></td> 
                            <td><input name="txtProcessLoss_1" id="txtProcessLoss_1" type="text"  class="text_boxes_numeric" style="width:50px" placeholder="" /></td> 
                            <td><input type="text" name="txtTotalqty_1" id="txttxtTotalqty_1_1" class="text_boxes_numeric" style="width:50px"  placeholder="" /></td>
