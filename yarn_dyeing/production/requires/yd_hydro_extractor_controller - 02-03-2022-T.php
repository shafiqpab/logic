...
if($action == "create_sales_order_list_view") {
   ...
   $sql= "select a.id, a.yd_job, a.order_no, b.other_party_name,c.yd_batch_id , c.batch_number from yd_ord_mst a, lib_other_party b ,yd_batch_mst c where c.yd_job_id=a.id and a.is_deleted=0 and a.status_active=1 and c.is_deleted=0 and c.status_active=1  $condition  and a.party_id=b.id order by id ";
    
    /*echo $sql;die;*/
    echo create_list_view("list_view", "Job No,WO No,Batch No", "140,140", "500","300", 0, $sql, "js_set_value", "id", "", 1, "0,0,0", $arr, "yd_job,order_no,batch_number", "",'','0,0,0,0');
    exit();
}
                ...
                <table width="870" cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
                    ...
                    <tbody>
                        <tr class="general">
                            ...
                            <td>
                                <?
                                    $search_by_arr=array(1=>"Batch No",2=>"Style No",3=>"Sales Order No");
                                    echo create_drop_down( "cbo_type",100, $search_by_arr,"",0, "",1,'search_by(this.value)',0 );
                                ?>
                            </td>
                            <td align="center">
