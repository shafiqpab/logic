...
<script>
	...
	function put_data_into_form(id, action, controller_path) { // function copied from gray_production_entry put_data_dtls_part
		...
		reset_form('','','txtWindingCone*txtPrdctnQty*txtRemarks','','');
		get_php_form_data(id, 'populate_saved_data_from_list', 'requires/yd_soft_conning_production_entry_controller');
        ...
        emailwindow.onclose=function()
        {
           ...
           /* alert(splt_val);*/
            if (splt_val[0]!='') {
				...
				/*alert("hello");return;*/
				/*show_list_view(job_id_mst, 'create_sales_order_list', 'sales_order_list', 'requires/yd_soft_conning_production_entry_controller', '');*/
				...
				<tr>
					<td>
						...
						<table border="0">
							...
							<tr>
								<td align="right" class="must_entry_caption">Sales Order No</td>
								<td>
							...
							<tr>
								...
								<td id="company_td">
									<? echo create_drop_down( "cbo_company_name", 117, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/yd_soft_conning_production_entry_controller', '', 'load_drop_down_buyer', 'party_td' );"); ?>
								</td>
							</tr>
							<tr>
								<td align="right">Party</td>
								<td id="party_td">
									<? echo create_drop_down( "cbo_party_name", 117, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, ""); ?>
								</td>
							</tr>
							<tr>
								<td align="right" class="must_entry_caption">Production Date</td>
								<td>
									<input class="datepicker" type="text"  name="txtProductionDate" id="txtProductionDate" style="width:105px;" placeholder="Click to show calendar" />
								</td>
							</tr>
							<tr>
								<td align="right" class="must_entry_caption">Start Date</td>
								<td>
									<input class="datepicker" type="text"  name="txtStartDate" id="txtStartDate" style="width:105px;" placeholder="Click to show calendar" />
								</td>
							</tr>
							<tr>
								<td align="right" class="must_entry_caption">End Date</td>
								<td>
									<input class="datepicker" type="text"  name="txtEndDate" id="txtEndDate" style="width:105px;" placeholder="Click to show calendar" />
								</td>
							</tr>
							<tr>
								...
								<td>
									<?php
										// $yarn_arr = array("Yarn type 1", "Yarn type 2", "Yarn type 3");
									 	echo create_drop_down('cbo_yarn_type', 117, $yarn_type_for_entry, '', 1, '-- Yarn Type --', $selected, '', '', '', '', '', 212);
