...
<script>
    ...
    function fnc_chemical_dyes_issue_requisition(operation)
    {
        ...
        else if(operation==0 || operation==1 || operation==2)
        {
            ...
            var mst_data=get_submitted_data_string('txt_req_no*update_id*cbo_company_name*cbo_location_name*txt_requisition_date*cbo_receive_basis*txt_recipe_id*cbo_store_name*is_apply_last_update*cbo_machine_no',"");
            //alert(mst_data);
