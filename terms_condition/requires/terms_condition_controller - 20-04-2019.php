            ...
            <table width="650" cellspacing="0" class="rpt_table" border="0" id="tbl_termcondi_details" rules="all">
                ...
                <table width="650" cellspacing="0" class="" border="0">
                	<tr>
                        ...
                        <input type="button" id="set_button" class="image_uploader" style="width:160px;" value="Add More.." onClick="open_extra_terms_popup('terms_condition_controller.php?action=extra_terms_popup','Terms Condition')" /> 
                        </td>
                    </tr>
                	<tr>
