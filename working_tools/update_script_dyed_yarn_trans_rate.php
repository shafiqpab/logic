...
from inv_transaction b where b.prod_id in(select b.PROD_ID from inv_receive_master a, INV_TRANSACTION b
where a.id=b.mst_id and a.receive_basis=2 and a.entry_form=1 and b.ITEM_CATEGORY = 1 AND b.RECEIVE_BASIS = 2  AND b.TRANSACTION_TYPE = 1 AND b.DYE_CHARGE > 0 and b.status_active=1 group by  b.PROD_ID) 
