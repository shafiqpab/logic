...
from inv_transaction b where b.prod_id in(194432) and b.status_active=1 and b.is_deleted=0 
...
foreach($result as $row)
{
	...
	else if($row["TRANSACTION_TYPE"]==3 || $row["TRANSACTION_TYPE"]==4 || $row["TRANSACTION_TYPE"]==5 || $row["TRANSACTION_TYPE"]==6)
	{
