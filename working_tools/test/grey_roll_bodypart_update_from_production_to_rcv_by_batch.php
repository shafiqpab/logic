...
from  pro_roll_details c, pro_grey_batch_dtls d 
 where  c.dtls_id = d.id and c.mst_id=d.mst_id and  c.entry_form = 62 and c.status_active =1 and d.status_active=1 and (d.BODY_PART_ID=0 or d.body_part_id is null) and c.barcode_no !=0
 order by d.id desc");
