...
foreach ($dtls_arr as  $dtls_id) 
{
	...
	echo "update pro_finish_fabric_rcv_dtls set original_gsm = '".$weight. "', updated_by = 999 where id = ".$dtls_id." <br>";
	//execute_query("update pro_finish_fabric_rcv_dtls set original_gsm = '".$weight. "', updated_by = 999 where id = ".$dtls_id,0);
