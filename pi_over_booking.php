<?
	...
	$pi_sql=sql_select("select a.id as pi_id, a.pi_number, b.work_order_id, b.work_order_no, b.booking_without_order, b.amount as pi_amount
	from com_pi_master_details a, com_pi_item_details b 
	where a.id=b.pi_id and a.entry_form=1 and a.item_category_id=4 and b.work_order_id>0 and a.pi_number is not null and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0");
	$pi_data=array();
			...
			foreach($book_val as $booking_without_order=>$val)
			{
				...
				if($wo_amt>0 && $diff>1)
				{
					...
					<tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" id="tr_<? echo $i;?>"> 				
						...
						<td align="right"><? echo number_format($wo_amt,2,".",""); ?></td>
