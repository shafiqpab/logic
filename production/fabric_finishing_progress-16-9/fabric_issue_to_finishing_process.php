...
<script>
	...
	{ 
		...
		emailwindow.onclose=function()
		{
			...
			if(issue_id!="")
			{
				...
				show_list_view(issue_id+"_"+cbo_company_id+"_"+cbo_service_source, 'grey_item_details_update', 'scanning_tbody','requires/fabric_issue_to_finishing_process_controller', '' );	
	...
	function fnc_grey_roll_issue_to_subcon( operation )
	{
		...
		var j=0; var dataString=''; var error=0; var totIssueQnty=0;
		$("#scanning_tbl").find('tbody tr').each(function()
		{
				...
				var gsm=$(this).find("td:eq(6)").text();
			...
			if(cbo_basis==2)
			{
				...
				emailwindow.onclose=function()
				{
					...
					if(cbo_service_source!=1)
					{
						...
						//alert(booking_format+','+process_id);
						var color_id=1;
						...
						if(book_id!="")
						{
							...
							create_row_wo(0,book_id,book_no,booking_type,booking_date);
	...
	function fnc_reset_form(type)
	{
		...
		var html='<tr id="tr_1" align="center" valign="middle"><td width="30" id="sl_1"></td><td width="90" id="batchNo_1" class="wo_dtls_td" style="display: none;"></td><td width="60" id="prodId_1" class="wo_dtls_td" style="display: none;"></td><td width="90" align="right" id=""><input type="text" id="txtBatchNo_1" name="txtBatchNo[]"  style=" width:70px" class="text_boxes_numeric"/></td><td style="word-break:break-all;" width="90" id="bodyPart_1"></td><td style="word-break:break-all;" width="130" id="cons_1" align="left"></td><td style="word-break:break-all;" width="50" id="gsm_1"></td><td style="word-break:break-all;" width="50" id="dia_1"></td><td style="word-break:break-all;" width="70" id="color_1"></td><td style="word-break:break-all;" width="70" id="diaType_1"></td><td width="100" align="right" id=""><? echo create_drop_down( "cboProcess_1", 120, $conversion_cost_head_array,"", 1, "-- Select Process --", 11, "","1","","","","","","","cboProcess[]" ); ?></td><td width="70" align="right" id="batchWeight_1"></td><td width="80" align="right" id=""><input type="text" id="txtRollNo_1" name="txtRollNo[]"  style=" width:68px" class="text_boxes_numeric"/></td><td width="80" align="right" id=""><input type="text" id="txtIssueQty_1" name="txtIssueQty[]"  style=" width:68px" class="text_boxes_numeric"/></td><td style="word-break:break-all;" width="100" id="bookingNoShow_1"></td><td style="word-break:break-all;" width="60" id="buyer_1"></td><td style="word-break:break-all;" width="80" id="job_1"></td><td style="word-break:break-all;" width="80" id="order_1"></td><td width="80" align="right" id=""><input type="text" id="txtRemarks_1" name="txtRemarks[]" style=" width:80px" class="text_boxes"/></td><td id="button_1" align="center"><input type="button" id="decrease_1" name="decrease[]" style="width:20px" class="formbuttonplasminus" value="-" onClick="fnc_remove_row(1);" /> &nbsp;<input type="hidden" name="recvBasis[]" id="recvBasis_1"/><input type="hidden" name="progBookPiId[]" id="progBookPiId_1"/><input type="hidden" name="productId[]" id="productId_1"/><input type="hidden" name="orderId[]" id="orderId_1"/><input type="hidden" name="batchWgt[]" id="batchWgt_1"/><input type="hidden" name="colorId[]" id="colorId_1"/><input type="hidden" name="dtlsId[]" id="dtlsId_1"/><input type="hidden" name="batchId[]" id="batchId_1"/><input type="hidden" name="finDia[]" id="finDia_1"/><input type="hidden" name="finGsm[]" id="finGsm_1"/><input type="hidden" name="bookingNo[]" id="bookingNo_1"/><input type="hidden" name="woRate[]" id="woRate_1"/><input type="hidden" name="determinationId[]" id="determinationId_1"/><input type="hidden" name="widthTypeId[]" id="widthTypeId_1"/><input type="hidden" name="bodypartId[]" id="bodypartId_1"/><input type="hidden" name="buyerId[]" id="buyerId_1"/><input type="hidden" name="processId[]" id="processId_1"/><input type="hidden" name="bookingDate[]" id="bookingDate_1"/><input type="hidden" name="bookingType[]" id="bookingType_1"/><input type="hidden" name="bookingDtls[]" id="bookingDtls_1"/></td></tr>'; //$("#processId_"+row_num).val(process_id);

		//<input type="button" id="increase_1" name="increase[]" style="width:20px" class="formbuttonplasminus" value="+" onClick="fn_add_row(1);" />
	...
	{
		var report_title=$( "div.form_caption" ).html();
		generate_report_file( $('#cbo_company_id').val()+'*'+$('#update_id').val()+'*'+report_title+'*'+$('#txt_issue_no').val(),'subprocess_issue_print','requires/fabric_issue_to_finishing_process_controller');
			return;
...
function fn_fab_issueToFinishingProcess_print(){
	...
	emailwindow.onclose=function()
	{
		...
		var report_title=$( "div.form_caption" ).html();
		print_report( $('#cbo_company_id').val()+'*'+$('#update_id').val()+'*'+report_title+'*'+returnNumber+'*'+$('#cbo_service_source').val()+'*'+$('#cbo_service_company').val(), "subprocess_issue_print_3", "requires/fabric_issue_to_finishing_process_controller" ) 
		return; 
	}
}
...
<body onLoad="set_hotkey();">
    <div align="center" style="width:100%;">
        ...
        <form name="rollscanning_1" id="rollscanning_1"  autocomplete="off"  >
			...
			<br>
			<fieldset style="width:1220px;text-align:left">
				<style>
                    #scanning_tbl tr td
                    {
				...
				<table cellpadding="0" width="1380" cellspacing="0" border="1" id="scanning_tbl_top" class="rpt_table" rules="all">
                    <thead>
                    	<th width="30">SL</th>
                ...
                <div style="width:1400px; max-height:250px; overflow-y:scroll" align="left">
                 	<table cellpadding="0" cellspacing="0" width="1380" border="1" id="scanning_tbl" rules="all" class="rpt_table">
                ...
                <br>
                <table width="1380" cellpadding="0" cellspacing="0" border="1" id="" rules="all">
                    <tr>
                        <td align="center" class="button_container">
                            ...
                            <? 
                            	echo load_submit_buttons($permission,"fnc_grey_roll_issue_to_subcon",0,1,"fnc_reset_form(1)",1);
                            ?>
                            
                            <input type="button" id="print_report" name="print_report" style="width:60px" class="formbuttonplasminus" value="Print 2" onClick="fnc_process_issue_to_subcon(4);" />

                           <input type="button" name="print3" value="Print Multiple Subcon Issue No" id="print3" class="formbutton" style="width: 180px;" onClick="fn_fab_issueToFinishingProcess_print()" />
