...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../../logout.php";
	...
	function check_batch()
	{
		...
		if(batch_no!="")
		{
			...
			else
			{
				...
				get_php_form_data(response[1]+'_'+response[2], "populate_data_from_batch", "requires/drying_stentering_controller" );
	...
	function check_re_stenter()
	{
		...
		get_php_form_data(batch_id, "populate_restenter_from_data", "requires/drying_stentering_controller" );
