            ...
            <div style="width:350px; overflow-y:scroll; max-height:280px;" id="buyer_list_view" align="center">
                ...
                <?
                    ...
                    foreach($conversion_cost_head_array as $id=>$name)
                    {
                    	...
                    	if($id==35 || $id==67 || $id==68  || $id==100 || $id==194 || $id==201 || $id==202 || $id==203 || $id==204 || $id==60 || $id==64 || $id==206 || $id==209 || $id==127)
                    	{
...
{
	  $sql_result=sql_select("SELECT  a.re_stenter_no, a.id,a.batch_id,a.company_id,a.service_source,a.service_company,a.received_chalan,a.issue_chalan,issue_challan_mst_id,a.process_end_date,a.production_date,a.process_start_date,a.process_id,a.end_hours,a.end_minutes,a.start_minutes,a.start_hours,a.floor_id,a.machine_id,a.result,a.shift_name,a.remarks,a.booking_no,b.currency_id,b.exchange_rate from pro_fab_subprocess a,pro_fab_subprocess_dtls b where a.id=b.mst_id and a.id=$data and entry_form=34 and a.status_active=1 and a.is_deleted=0 ");
...
//echo  $sql_batch=("select id,batch_no,width_dia_type,process_end_date,process_start_date,start_hours,start_minutes,end_hours,end_minutes,machine_id,floor_id,process_id,temparature,stretch,over_feed,feed_in,pinning,speed_min,chemical_name,production_date,shift_name,remarks from pro_fab_subprocess where entry_form=31 and batch_id='$data' ");
 //echo  $sql_result[0][csf("process_id")];die;
			...
			*/
			...
			echo "load_drop_down( 'requires/special_finish_controller', ".$sql_result[0][csf("service_source")]."+'**'+".$sql_result[0][csf("company_id")].", 'load_drop_down_knitting_com', 'dyeing_company_td' );\n";
