            ...
            <form name="finishingentry_1" id="finishingentry_1" autocomplete="off" >
                ...
                <table width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td><? echo create_drop_down( "cbo_company_name", 170, "select id,company_name from lib_company where status_active =1 and is_deleted=0 $company_credential_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "get_php_form_data(this.value,'load_variable_settings','requires/finishing_entry_controller');" ); ?>	 
