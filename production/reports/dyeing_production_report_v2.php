...
<script>
    ...
    function fn_dyeing_report_generated(operation)
    {
       ...
       /* if (j_number != "" || j_number_hidden != "" || b_number != "" || batch_no != "" || order_no != "" || file_no != "" || ref_no != "" || order_no_hidden != "")
        ...
        if (operation == 1)
        {
            var data = "action=generate_report_machine_wise_new&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_date_from*txt_date_to*cbo_result_name*txt_machine_name*txt_machine_id*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id', "../../");
            //alert(data);
        }
        else if (operation == 2) 
        {
            var data = "action=generate_report_machine_wise_akh2&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_date_from*txt_date_to*cbo_result_name*txt_machine_name*txt_machine_id*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id', "../../");
            //alert(data);
        }
            
        http.open("POST", "requires/dyeing_production_report_controller_v2.php", true);
    ...
    function batchnumber()
    {
       ...
       // var batch_type = document.getElementById('cbo_batch_type').value;
        var page_link = "requires/dyeing_production_report_controller_v2.php?action=batchnumbershow&company_name=" + company_name + "&batch_number=" + batch_number;
    ...
    function jobnumber(id)
    {
     ...
     //   var batch_type = document.getElementById('cbo_batch_type').value;
        ...
        var page_link = "requires/dyeing_production_report_controller_v2.php?action=jobnumbershow&company_id=" + company_name + "&cbo_buyer_name=" + cbo_buyer_name + "&year=" + year;
    ...
    function openmypage_order(id)
    {
      ...
      //  var batch_type = document.getElementById('cbo_batch_type').value;
        var year = document.getElementById('cbo_year').value;
        var page_link = "requires/dyeing_production_report_controller_v2.php?action=order_number_popup&company_name=" + company_name + "&buyer_name=" + buyer_name + "&year=" + year
    ...
    function openmypage_machine()
    {
        ...
        emailwindow = dhtmlmodal.open('EmailBox', 'iframe', 'requires/dyeing_production_report_controller_v2.php?action=machine_no_popup&data=' + data, 'Machine Name Popup', 'width=470px,height=420px,center=1,resize=0', '../')
...
<body onLoad="set_hotkey();">
    <div style="width:100%;" align="center">
        ...
        <form name="dailyYarnStatusReport_1" id="dailyYarnStatusReport_1"> 
            <h3 style="width:1300px; margin-top:10px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id, 'content_search_panel', '')">-Search Panel</h3>         <div id="content_search_panel" >      
                    ...
                    <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> 
                                    <?
                                    echo create_drop_down("cbo_company_name", 80, "select id,company_name from lib_company where status_active=1 and is_deleted=0  order by company_name", "id,company_name", 1, "-- Select Company --", 0, "load_drop_down('requires/dyeing_production_report_controller_v2',this.value+'_'+document.getElementById('cbo_type').value, 'load_drop_down_buyer','cbo_buyer_name_td' );load_drop_down( 'requires/dyeing_production_report_controller_v2', this.value, 'load_drop_down_floor', 'floor_td' );");
                                    ?>
                                </td>
                                
                                <td id="">
                                    <?
                                     echo create_drop_down("cbo_prod_type",70,$knitting_source,"", 1, "-- Select Source --", 1,"load_drop_down( 'requires/dyeing_production_report_controller_v2',this.value,'load_drop_down_knitting_com','cbo_party_td' );",0,'1,3');
                                    ?>
                                </td>
                                <td id="cbo_party_td">
                                    <?
                                ...
                                <td>
                                    ...
                                    echo create_drop_down("cbo_group_by", 70, $group_type_arr, "", 1, "-Select-", 3, "", 0, "", "", "", "", "");
                                    ?>
                                </td>
                                <td>
                                    <?
                            ...
                            <tr>
                                <td colspan="14" align="center">
                                    ...
                                    <input type="button" id="show_button" class="formbutton" style="width:50px" value="AKH" onClick="fn_dyeing_report_generated(1)" />
                                    <input type="button" id="show_button" class="formbutton" style="width:50px" value="AKH 2" onClick="fn_dyeing_report_generated(2)" />
                                </td>
                            </tr>
                        </tbody>
