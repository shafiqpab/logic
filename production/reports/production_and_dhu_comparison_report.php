<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create PRODUCTION & DHU COMPARISON Report
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Production & DHU Comparison Report","../../", 1, 1,$unicode,1,1);
?>
<script>
	...
	function generate_report(type)
	{
		...
		freeze_window(3);
		http.open("POST","requires/production_and_dhu_comparison_report_controller.php",true);
             ...
             <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr class="general">
                       <td>
							<? 
                                echo create_drop_down( "cbo_company_id", 200, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 0, "-- Select Working Company --", $selected,"" );
                            ?>                            
                        </td>
                        <td>
