...
var permission = '<? echo $permission; ?>';
	...
	var tableFilters1 = 
	{
		col_0: "none",col_9: "select",display_all_text: " -- All --",col_10: "select",display_all_text: " -- All --",col_12: "select",display_all_text: " -- All --",col_37: "select",display_all_text: " -- All --",
		col_operation: { 
			id: ["total_order_quantity","order_value","tot_plan_cut","total_cutting","total_cutting_bal","total_emb_issue","total_emb_receive","total_sewing_input","total_sewing_out","total_fin_rcv","total_iron_qnty","total_re_iron_qnty","total_finish_qnty","total_rej_value_td","total_out","ship_out_value"],
			col: [14,16,23,24,25,27,28,29,30,31,32,33,34,36,37,38],
...
var tableFilters11 =
    {
        ...
        col_operation: {
            ...
            col: [14,16,23,24,25,27,28,29,30,31,32,33,34,36,37,38,39],
...
var tableFilters13 =
    {
        ...
        col_operation: {
            id: ["total_order_quantity","total_cutting","total_cutting_bal","total_emb_issue","total_emb_receive","total_cutting_delivery","total_sewing_input","total_sewing_out","total_iron_qnty","total_re_iron_qnty","total_finish_qnty","total_rej_value_td","total_out","total_shortage","ship_status"],
            //col: [7,12,14,15,16,17,18,19,20,22,23,24],
            col: [10,15,16,18,19,20,21,22,23,24,25,27,28,29,30],
            operation: ["sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum"],
            write_method: ["innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML"]
        }
    }
...
var tableFilters14 =
    {
        ...
        col_operation: {
            id: ["total_order_quantity","total_cutting","total_cutting_bal","total_emb_issue","total_emb_receive","total_cutting_delivery","total_sewing_input","total_sewing_out","total_iron_qnty","total_re_iron_qnty","total_finish_qnty","total_rej_value_td","total_out","total_shortage","ship_status"],
            //col: [7,14,16,17,18,19,20,21,22,24,25,26],
            col: [10,17,18,20,21,22,23,24,25,26,28,29,30,31,32],
            operation: ["sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum"],
            write_method: ["innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML"]
        }
    }
...
var tableFilters15 =
    {
        ...
        col_operation: {
            ...
            //col: [6,11,13,14,15,16,17,18,19,21,22,23],
            //col: [10,15,16,18,19,20,21,22,23,24,26,27,28],
            col: [10,17,18,20,21,22,23,24,25,26,27,29,30,31],
            operation: ["sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum"],
            write_method: ["innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML"]
        }
    }
...
var tableFilters16 =
    {
        ...
        col_operation: {
            id: ["total_order_quantity","total_cutting","total_cutting_bal","total_emb_issue","total_emb_receive","total_sewing_input","total_sewing_out","total_iron_qnty","total_re_iron_qnty","total_finish_qnty","total_rej_value_td","total_out","total_shortage","ship_status"],
            col: [15,20,21,23,24,25,26,27,28,29,30,32,33,34,45],
            // col: [13,18,19,21,22,23,24,25,26,27,29,30,31,42],
            operation: ["sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum","sum"],
            write_method: ["innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML","innerHTML"]
        }
	...
	function fn_report_generated_reponse()
	{
		if(http.readyState == 4) 
		{
            ...
            if(reponse[2] == '1') {
                ...
                if (type == 1) setFilterGrid("table_body", -1, tableFilters11);
                else if (type == 2) setFilterGrid("table_body", -1, tableFilters12);
                else if (type == 3) setFilterGrid("table_body", -1, tableFilters13);
                else if (type == 4) setFilterGrid("table_body", -1, tableFilters14);
                else if (type == 5 || type == 7) setFilterGrid("table_body", -1, tableFilters15);
                else if (type == 6) setFilterGrid("table_body", -1, tableFilters16);
            }
		}
	}
                ...
                <th colspan="19" align="center"><? echo create_drop_down( "cbo_string_search_type", 130, $string_search_type,'', 1, "-- Searching Type --" ); ?></th>
                    ...
                    <tbody>
                        <tr class="general">
                            <td> 
								<?
                               		echo create_drop_down( "cbo_company_name", 110, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 and comp.core_business not in(3) $company_cond order by comp.company_name","id,company_name", 1, "-Select Company-", $selected, "load_drop_down( 'requires/order_wise_production_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );load_drop_down( 'requires/order_wise_production_report_controller', this.value, 'load_drop_down_location', 'location_td'); load_drop_down( 'requires/order_wise_production_report_controller', this.value, 'load_drop_down_agent', 'agent_td');" );
                                ?>
                            </td>
                            <td> 
								<?
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <td>
                                <input type="button" id="show_button" class="formbutton" style="width:60px" value="Show2" onClick="fn_report_generated(2)" />
                            </td>
