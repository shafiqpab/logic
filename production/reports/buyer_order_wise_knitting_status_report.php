...
<script>
	...
	function fn_report_generated(type)
	{
		...
		if(txt_search_common!="" || txt_job_no!="" || txt_order_no!="")
		{
		...
		{
			if(form_validation('cbo_company_name*txt_date_from*txt_date_to','Company Name*TNA Form Date*TNA To Date')==false)
			{
				return;
			}
		}
