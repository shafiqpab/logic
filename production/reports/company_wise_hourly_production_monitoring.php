...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	/*    var cbo_get_upto = $("#cbo_get_upto").val();
		...
		var report_title=$( "div.form_caption" ).html();
			...
			//alert(data);
		freeze_window(3);
		http.open("POST","requires/company_wise_hourly_production_monitoring_controller.php",true);
	...
	function generate_in_out_popup(po_id,action,floor_id,line,i,company_id,date)
	{
		 ...
		 popup_width='1020px'; 
		//var company_id = $("#cbo_company_id").val();	
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/company_wise_hourly_production_monitoring_controller.php?po_id='+po_id+'&company_id='+company_id+'&action='+action+'&type='+i+'&production_date='+date+'&floor='+floor_id+'&sewing_line='+line, 'Detail Veiw', 'width='+popup_width+', height=390px,center=1,resize=0,scrolling=0','../');
	...
	function openmypage_company()
	{
		...
		var page_link='requires/company_wise_hourly_production_monitoring_controller.php?action=company_search_popup&company='+company; 
		...
		emailwindow.onclose=function()
		{
			...
			load_drop_down( 'requires/company_wise_hourly_production_monitoring_controller',prodID, 'load_drop_down_buyer', 'buyer_td_id' );
	...
	function openmypage_location()
	{
		...
		var page_link='requires/company_wise_hourly_production_monitoring_controller.php?action=location_search_popup&company='+company+'&location='+location; 
	...
	function openmypage_floor()
	{
		...
		var page_link='requires/company_wise_hourly_production_monitoring_controller.php?action=floor_search_popup&location='+location+'&floor='+floor_id; 
	...
	function openmypage_line()
	{
		...
		var page_link='requires/company_wise_hourly_production_monitoring_controller.php?action=line_search_popup&company='+company+'&location='+location+'&floor_id='+floor_id+'&txt_date='+txt_date+'&line_id='+line_id; 
	...
	function show_line_remarks(company_id,order_id,floor_id,line_no,action,prod_date)
	{
		//alert(action)
		popup_width='550px'; 
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/company_wise_hourly_production_monitoring_controller.php?po_id='+order_id+'&company_id='+company_id+'&floor_id='+floor_id+'&sewing_line='+line_no+'&prod_date='+prod_date+'&action='+action, 'Detail Veiw','width='+popup_width+', height=270px,center=1,resize=0,scrolling=0','../');
         ...
         <fieldset style="width:1450px;">
             <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
             	<thead>
                    ...
                    <th colspan="3" width="180"><input type="reset" name="res" id="res" value="Reset" style="width:100px" class="formbutton" onClick="reset_form('LineWiseProductivityAnalysis_1','report_container','','','')" /></th>
                </thead>
                <tbody>
                    <tr class="general">
                       <td>
                        ...
                        <td>
                            ...
                            <input type="button" name="search" id="search" value="Show" onClick="generate_report(0)" style="width:50px" class="formbutton" />

                        </td>
                        <td>
                            <!--Not Use --hidden button> --> 
       
                            <input type="button" name="search" id="search" value="Line Wise Summary" onClick="generate_report(1)" style="width:120px" class="formbutton" />
                            
                        </td>
                        <td>
       
                            <input type="button" name="search" id="search" value="Short" onClick="generate_report(2)" style="width:50px" class="formbutton" />
