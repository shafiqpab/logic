...
<script>
	...
	function fn_report_generated(report_type)
	{
		...
		var data="action="+action+get_submitted_data_string('cbo_company_name*cbo_type*cbo_buyer_name*cbo_year*txt_job*txt_order*txt_int_ref*cbo_knitting_source*cbo_floor_id*txt_date_from*txt_date_to*cbo_working_company_id*cbo_location_id*cbo_booking_type',"../../")+'&report_title='+report_title+'&report_type='+report_type+'&machine_wise_section='+machine_wise_section;
		//alert(data);return;
		freeze_window(5);
...
function fn_disable_com(str){
	...
	function getCompanyId()
	{
		...
		load_drop_down( 'requires/daily_knitting_production_report_controller', company_id, 'load_drop_down_floor', 'floor_td');
		fn_disable_com(1);
		get_php_form_data(company_id,'print_button_variable_setting','requires/daily_knitting_production_report_controller' );
	}
</script>
</head>
...
<body onLoad="set_hotkey();">
	...
	<? echo load_freeze_divs ("../../",''); ?>
         ...
         <h3 style="width:1820px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')"> -Search Panel</h3>
                        ...
                        <tbody>
                            <tr class="general">
                                ...
                                <td width="150" align="center">
			                        <?
			                            echo create_drop_down( "cbo_working_company_id", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/daily_knitting_production_report_controller', $('#cbo_working_company_id').val(), 'load_drop_down_floor', 'floor_td');fn_disable_com(2);get_php_form_data(this.value,'print_button_variable_setting','requires/daily_knitting_production_report_controller' );load_drop_down('requires/daily_knitting_production_report_controller', this.value, 'load_drop_down_location', 'location_td' );" );
			                        ?>
                      			</td>
                                ...
                                <td align="center">
									<?
                                        ...
                                        echo create_drop_down("cbo_type",70,$order_source,"", 1, "-- All --", 0,"load_drop_down( 'requires/daily_knitting_production_report_controller', $('#cbo_company_name').val()+'**'+this.value, 'load_drop_down_buyer', 'buyer_td'); fnc_active_inactive(this.value);",0,'1,2');
                                    ?>
                            	</td>
                                <td id="buyer_td">
                                	<?
                                ...
                                <td><input type="text" name="txt_job" id="txt_job" value="" class="text_boxes" style="width:75px" placeholder="Wr/Br Job" onDblClick="openmypage_job();" disabled /> </td>

                                <td><input type="text" id="txt_order" name="txt_order" class="text_boxes" style="width:75px;" placeholder="Wr/Br Order" onDblClick="openmypage_order();" disabled /></td>

                                <td><input type="text" id="txt_int_ref" name="txt_int_ref" class="text_boxes" style="width:75px;" placeholder="Wr/Br Order" onDblClick="openmypage_int_ref();" disabled/></td>
                                <td>
                                	<?
                            ...
                            <tr>
                                ...
                                <input type="button" id="show_button" class="formbutton" style="width:110px;" value="Today Production2" onClick="fn_report_generated_today(2)" /> &nbsp;
                                ...
                                <input type="button" id="show_button4" class="formbutton" style="width:100px;" value="MachineWise3" onClick="fn_report_generated(6)" />
