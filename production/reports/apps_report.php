 ...
 function open_order_no()
	 {
	    ...
	    var page_link='requires/apps_report_controller.php?action=order_wise_search&company='+company+'&buyer='+buyer+'&style_id='+style_id+'&job_id='+job_id+'&job_no='+job_no; 
	 ...
	 function open_style_ref()
	{
		...
		var page_link='requires/apps_report_controller.php.php?action=style_wise_search&company='+company+'&buyer='+buyer+'&job_no='+job_no+'&job_id='+job_id+'&cbo_year='+cbo_year; 
...
function generate_report()
	{
		...
		freeze_window(3);
		http.open("POST","requires/apps_report_controller.php",true);
	...
	function open_popup(order_id,title)
	{
		...
		var page_link='requires/apps_report_controller.php?action=order_inspection_details&order_id='+order_id; 
	...
	{
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/apps_report_controller.php?company='+company+'&po_id='+po_id+'&item_id='+item_id+'&action='+type, 'Bill Qnty Info', 'width=700px,height=350px,center=1,resize=0,scrolling=0','../');
            ...
            <table class="rpt_table" width="1150px" cellpadding="0" cellspacing="0" align="center">
               <thead>                    
                       <tr>
                        ...
                        <th>Bundle No </th>
                        <th>Worker Id</th>
                        <th id="search_by_th_up" > Operation Date Range </th>
                        <!-- <th>Status</th> -->
                        <!-- <th>Result</th> -->
                ...
                <tr class="general">
                    <td> 
                        <?
                            echo create_drop_down( "cbo_company_name", 120, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 and core_business not in(3) $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/apps_report_controller.php',this.value, 'load_drop_down_buyer', 'buyer_td' )" );
                        ?>
                    </td>
                    <td id="buyer_td" style="display:none">
                        <? 
