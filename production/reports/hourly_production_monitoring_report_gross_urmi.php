...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function generate_report()
	{
		...
		freeze_window(3);
		http.open("POST","requires/hourly_production_monitoring_report_gross_controller_urmi.php",true);
 ...
 function open_job_no()
	 {
	    ...
	    var page_link='requires/hourly_production_monitoring_report_gross_controller_urmi.php?action=job_wise_search&company='+company+'&location='+location+'&floor_id='+floor_id+'&txt_date='+txt_date; 
