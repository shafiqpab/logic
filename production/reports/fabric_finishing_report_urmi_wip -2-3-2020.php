				...
				<fieldset style="width:1200px;">
					<table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
						...
						<tbody>
                            ...
                            <td>
                            	<input type="text"  name="batch_number_show" id="batch_number_show" readonly="readonly" class="text_boxes" style="width:70px;" tabindex="1" placeholder="Browse" onDblClick="batchnumber();"  >
