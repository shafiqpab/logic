...
if($action=="batch_report")
{
	...
	$sales_po_sql=sql_select("select  a.job_no as po_number,a.buyer_id as buyer_name,a.style_ref_no,a.id from fabric_sales_order_mst a, pro_batch_create_mst b where a.id=b.sales_order_id and b.is_sales=1  and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $buyer_cond2 $year_cond ");
	$sales_poid='';
	...
	$sql_dyeing_subcon=sql_select("select batch_id,entry_form from  pro_fab_subprocess where entry_form in(38,35,32,47,31,48) and status_active=1 and is_deleted=0 and batch_id>0 $batch_num2");
		...
		if($cbo_type==1)
		{
			...
			*/
			if($batch_type==0)
			{
				...
				{
			  		$sql="select a.id,a.batch_against,a.entry_form,a.batch_no, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.po_id,count(b.roll_no) as roll_no,b.prod_id,b.width_dia_type,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a where  a.entry_form=0 and a.batch_against!=3 and a.id=b.mst_id  and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $comp_cond $working_comp_cond $dates_com $po_id_cond $batch_num $booking_num $ext_no $floor_num $year_cond  GROUP BY a.id,a.batch_against,a.batch_no, b.item_description,b.prod_id,a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no,b.po_id, b.prod_id, b.width_dia_type,a.entry_form, a.process_id, a.remarks order by a.batch_date";
			  		/*echo $sql;die;*/
				}
				else
				{
					...
					//echo $po_id_cond ;
					$sql="(select a.id,a.batch_against,a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, SUM(b.batch_qnty) AS batch_qnty, b.item_description, listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, b.prod_id, b.width_dia_type,count(b.roll_no) as roll_no, a.process_id, a.remarks from pro_batch_create_dtls b, pro_batch_create_mst a where a.entry_form=0 and a.batch_against!=3 and a.id=b.mst_id and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $dates_com $batch_num $booking_num $po_id_cond $ext_no $floor_num $year_cond $comp_cond GROUP BY a.id,a.batch_against, a.batch_no, b.item_description,b.prod_id,a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no,b.po_id, b.prod_id, b.width_dia_type, a.entry_form, a.process_id, a.remarks)
					union
					(select a.id,a.batch_against,a.entry_form,a.batch_no, a.batch_date, a.batch_weight,a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, SUM(b.batch_qnty) AS batch_qnty, b.item_description, listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, b.prod_id, b.width_dia_type,count(b.roll_no) as roll_no, a.process_id, a.remarks from pro_batch_create_dtls b, pro_batch_create_mst a where a.entry_form=0 and a.batch_against!=3 and a.id=b.mst_id and b.po_id=0 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $comp_cond $dates_com $booking_num $batch_num $floor_num $ext_no $year_cond GROUP BY a.id,a.batch_against,a.batch_no, b.item_description,b.prod_id,a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.extention_no,b.po_id,b.prod_id,b.width_dia_type,a.entry_form, a.process_id, a.remarks) order by batch_date ";	
				}

				//Sub
				if($job_number_id!="" || $txt_order!="" || $file_no!="" || $ref_no!="")
				{
					 $sub_cond="select a.id,a.batch_against,a.entry_form,b.rec_challan,a.batch_no,a.batch_date,booking_no,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.extention_no, SUM(b.batch_qnty) AS sub_batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,b.grey_dia,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a where a.entry_form=36 and a.id=b.mst_id and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0  $dates_com  $batch_num $booking_num $year_cond  $sub_po_id_cond $ref_cond $file_cond $working_comp_cond $comp_cond  GROUP BY  a.id,a.batch_against,a.batch_no, a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, a.batch_against, b.item_description, b.po_id, b.prod_id, b.width_dia_type,b.grey_dia, a.entry_form,b.rec_challan, a.process_id, a.remarks order by a.batch_date ";	
				}
				else
				{ 
					  $sub_cond="(select a.id,a.batch_against,a.entry_form,b.rec_challan,a.batch_no,a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no, SUM(b.batch_qnty) AS sub_batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,b.grey_dia,b.gsm,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b, pro_batch_create_mst a where  a.entry_form=36 and a.id=b.mst_id and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0  $dates_com  $batch_num $booking_num $year_cond $sub_po_id_cond $ref_cond $file_cond $working_comp_cond  $comp_cond GROUP BY a.id,a.batch_against,a.batch_no, a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, a.batch_against, b.item_description, b.po_id, b.prod_id, b.width_dia_type,b.gsm,b.grey_dia,a.entry_form,b.rec_challan,a.process_id, a.remarks)
					union
					(select a.id,a.batch_against,a.entry_form,b.rec_challan,a.batch_no, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS sub_batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,b.grey_dia,b.gsm,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks  from pro_batch_create_dtls b,pro_batch_create_mst a where   a.entry_form=36 and a.id=b.mst_id and b.po_id=0 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $comp_cond $dates_com  $batch_num $booking_num $ext_no $floor_num $year_cond  GROUP BY  a.id,a.batch_against, a.batch_no, b.item_description,b.prod_id,a.batch_date,a.batch_weight,b.gsm,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.extention_no,b.po_id,b.prod_id,b.width_dia_type,b.grey_dia,a.entry_form,b.rec_challan, a.process_id, a.remarks) order by batch_date ";
				...
				{*/
				 ...
				 $sql_sam="(SELECT a.id,a.batch_against,a.entry_form, a.batch_no,a.booking_without_order, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks  from pro_batch_create_dtls b,pro_batch_create_mst a where  a.entry_form=0 and a.id=b.mst_id  and b.status_active=1 and b.is_deleted=0 and a.batch_against=3 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $non_booking_cond_for $comp_cond $dates_com  $batch_num $booking_num $po_id_cond  $ext_no $floor_num $year_cond  GROUP BY a.id,a.batch_against,a.batch_no,a.booking_without_order, b.item_description,b.prod_id,a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, b.prod_id, b.width_dia_type,a.entry_form, a.process_id, a.remarks)
					union
					(select a.id,a.batch_against,a.entry_form,a.batch_no,a.booking_without_order, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a,wo_non_ord_samp_booking_mst c where a.id=b.mst_id  and a.booking_no=c.booking_no and  a.entry_form=0 and a.batch_against=2 and  b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $comp_cond $dates_com $non_booking_cond_for $samp_buyercond $ref_cond2  $batch_num $booking_num $ext_no $floor_num $floor_num $year_cond GROUP BY a.id,a.batch_against,a.batch_no,a.booking_without_order, b.item_description,b.prod_id,a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.extention_no,b.prod_id,b.width_dia_type,a.entry_form, a.process_id, a.remarks) order by batch_date ";	
			...
			*/
			else if($batch_type==1)
			{
				...
				{
					//echo $order_no;
			  		$sql="select a.id,a.batch_against,a.entry_form,a.batch_no, a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.po_id,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a where  a.entry_form=0 and a.batch_against!=3 and a.id=b.mst_id  and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $comp_cond $working_comp_cond $dates_com $po_id_cond $batch_num $booking_num $ext_no $floor_num $year_cond  GROUP BY a.id,a.batch_against,a.batch_no, b.item_description,b.prod_id,a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no,b.po_id, b.prod_id, b.width_dia_type,a.entry_form, a.process_id, a.remarks order by a.batch_date";
				}
				else
				{
					//echo $$job_number_id .'aaaa';listagg(b.po_id ,',') within group (order by b.po_id) AS 
					//echo $po_id_cond ;
					$sql="(select a.id,a.batch_against,a.entry_form, a.batch_no, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a where   a.entry_form=0 and a.batch_against!=3 and a.id=b.mst_id  and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $dates_com  $batch_num $booking_num $po_id_cond $ext_no $floor_num $year_cond $comp_cond  GROUP BY a.id,a.batch_against, a.batch_no, b.item_description,b.prod_id,a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no,b.po_id, b.prod_id, b.width_dia_type,a.entry_form, a.process_id, a.remarks)
					union
					(select a.id,a.batch_against,a.entry_form,a.batch_no, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a where  a.entry_form=0 and a.batch_against!=3 and a.id=b.mst_id and b.po_id=0 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $comp_cond $dates_com $booking_num  $batch_num $ext_no $floor_num $year_cond GROUP BY a.id,a.batch_against,a.batch_no, b.item_description,b.prod_id,a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.extention_no,b.po_id,b.prod_id,b.width_dia_type,a.entry_form, a.process_id, a.remarks) order by batch_date ";	
				}
			}
			...
			*/
			else if($batch_type==2)
			{
				if($job_number_id!="" || $txt_order!="" || $file_no!="" || $ref_no!="")
				{
					$sub_cond="select a.id,a.batch_against,a.entry_form,b.rec_challan,a.batch_no,a.batch_date,booking_no,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.extention_no, SUM(b.batch_qnty) AS sub_batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a where a.entry_form=36 and a.id=b.mst_id and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0  $dates_com  $batch_num $booking_num $year_cond  $sub_po_id_cond $ref_cond $file_cond $working_comp_cond $comp_cond  GROUP BY  a.id,a.batch_against,a.batch_no, a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, a.batch_against, b.item_description, b.po_id, b.prod_id, b.width_dia_type, a.entry_form,b.rec_challan, a.process_id, a.remarks order by a.batch_date ";	
				}
				else
				{ 
					$sub_cond="(select a.id,a.batch_against,a.entry_form,b.rec_challan,a.batch_no,a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no, SUM(b.batch_qnty) AS sub_batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b, pro_batch_create_mst a where  a.entry_form=36 and a.id=b.mst_id   and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0  $dates_com  $batch_num $booking_num $year_cond $sub_po_id_cond $ref_cond $file_cond $working_comp_cond  $comp_cond GROUP BY a.id,a.batch_against,a.batch_no, a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no, a.extention_no, a.batch_against, b.item_description, b.po_id, b.prod_id, b.width_dia_type,a.entry_form,b.rec_challan, a.process_id, a.remarks)
					union
					(select a.id,a.batch_against,a.entry_form,b.rec_challan,a.batch_no, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS sub_batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks  from pro_batch_create_dtls b,pro_batch_create_mst a where   a.entry_form=36 and a.id=b.mst_id and b.po_id=0 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $comp_cond $dates_com  $batch_num $booking_num $ext_no $floor_num $year_cond  GROUP BY  a.id,a.batch_against, a.batch_no, b.item_description,b.prod_id,a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.extention_no,b.po_id,b.prod_id,b.width_dia_type,a.entry_form,b.rec_challan, a.process_id, a.remarks) order by batch_date ";
			...
			*/
			else if($batch_type==3)
			{
				...
				{*/
					//echo $$job_number_id .'aaaa';
				  	$sql_sam="(SELECT a.id,a.batch_against,a.entry_form, a.batch_no,a.booking_without_order, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks  from pro_batch_create_dtls b,pro_batch_create_mst a where  a.entry_form=0 and a.id=b.mst_id  and b.status_active=1 and b.is_deleted=0 and a.batch_against=3 and a.status_active=1 and a.is_deleted=0 $working_comp_cond  $po_id_cond $comp_cond $dates_com  $batch_num $booking_num $po_id_cond  $non_booking_cond_for $ext_no $floor_num $year_cond  GROUP BY a.id,a.batch_against,a.batch_no, b.item_description,b.prod_id,a.batch_date, a.batch_weight, a.color_id,a.floor_id,a.style_ref_no, a.booking_no,a.booking_without_order, a.extention_no, b.prod_id, b.width_dia_type,a.entry_form, a.process_id, a.remarks)
					union
					(select a.id,a.batch_against,a.entry_form,a.batch_no,a.booking_without_order, a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(b.po_id ,',') within group (order by b.po_id) AS po_id, a.process_id, a.remarks from pro_batch_create_dtls b,pro_batch_create_mst a ,wo_non_ord_samp_booking_mst c where  a.id=b.mst_id and c.booking_no=a.booking_no  and a.entry_form=0 and a.batch_against=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $working_comp_cond $samp_buyercond  $comp_cond $dates_com  $ref_cond2 $batch_num $booking_num $ext_no $floor_num $year_cond $non_booking_cond_for GROUP BY a.id,a.batch_against,a.batch_no, b.item_description,b.prod_id,a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.style_ref_no,a.booking_no,a.booking_without_order,a.extention_no,b.prod_id,b.width_dia_type,a.entry_form, a.process_id, a.remarks) order by batch_date ";	
			...
			if($batch_type==0) //Self Batch and SubCon Batch
			{
				...
				if($w_dyeing_arr!=0)
				{
					...
					if($row_d>0)
					{
						...
						$sql .=" GROUP BY a.id,a.batch_no,a.batch_against, b.item_description,a.batch_date, a.batch_weight, a.color_id,a.floor_id,d.style_ref_no, a.booking_no, a.extention_no,b.po_id, b.prod_id, b.width_dia_type,c.job_no_mst, d.job_no_prefix_num, d.buyer_name,a.entry_form, a.process_id, a.remarks)
						union
						(select a.id,a.entry_form,a.batch_no,a.batch_against,a.batch_date,a.batch_weight,a.floor_id,a.color_id,d.style_ref_no,a.booking_no,a.extention_no,SUM(b.batch_qnty) AS batch_qnty,b.item_description,b.po_id,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(cast(c.po_number as varchar2(4000)),',') within group (order by c.po_number) AS po_number,c.job_no_mst,d.job_no_prefix_num,d.buyer_name, a.process_id, a.remarks from pro_batch_create_mst a,pro_batch_create_dtls b,wo_po_break_down c,wo_po_details_master d where  a.id=b.mst_id and b.po_id=c.id and d.job_no=c.job_no_mst  $working_comp_cond $dates_com $jobdata $batch_num $booking_num $comp_cond $buyerdata $po_id_cond $ext_no $floor_num $year_cond and a.entry_form=0 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $find_cond_not GROUP BY a.id,a.batch_no, a.batch_against,b.item_description,a.batch_date, a.batch_weight,floor_id, a.color_id,d.style_ref_no, a.booking_no, a.extention_no,b.po_id, b.prod_id, b.width_dia_type,c.job_no_mst, d.job_no_prefix_num,d.buyer_name,a.entry_form, a.process_id, a.remarks) order by batch_date "; 
					echo $sql;//die;
				}
				...
				if($w_dyeing_arr!=0)
				{
					...
					$sub_cond .=" GROUP BY a.id, a.batch_no,a.batch_against,a.batch_date,a.batch_weight,a.floor_id,a.color_id,a.style_ref_no,a.extention_no,a.booking_no,d.party_id,b.item_description,b.po_id,b.prod_id,b.width_dia_type,d.subcon_job,d.job_no_prefix_num,d.party_id,a.entry_form,b.rec_challan, a.process_id, a.remarks)
					union
					(select a.id,a.entry_form,a.batch_no,a.batch_against,a.batch_date,a.booking_no,a.batch_weight,a.color_id,a.style_ref_no,a.extention_no,SUM(b.batch_qnty) AS sub_batch_qnty,null,b.item_description,b.rec_challan,b.po_id,b.prod_id,b.width_dia_type,count(b.roll_no) as roll_no,listagg(cast(c.order_no as varchar2(4000)),',') within group (order by c.order_no) AS po_number,c.job_no_mst,d.job_no_prefix_num,null, a.process_id, a.remarks from pro_batch_create_dtls b,  subcon_ord_dtls c, subcon_ord_mst d, pro_batch_create_mst a where  a.entry_form=36 and a.id=b.mst_id and b.po_id=c.id and d.subcon_job=c.job_no_mst and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $find_cond_not  $working_comp_cond $batch_num $booking_num $sub_buyer_cond $sub_job_cond $suborder_no $year_cond $dates_com  $comp_cond  ";
					$p2=1;
					foreach($w_dyeing_arr as $d_batch_id)
					{
						if($p2==1) $sub_cond .=" and (a.id not in(".implode(',',$d_batch_id).")"; else  $sub_cond .=" OR a.id not in(".implode(',',$d_batch_id).")";
					...
					$sub_cond .=")";
					$sub_cond .=" GROUP BY a.id,a.batch_no,a.batch_against,a.batch_date,a.batch_weight,a.color_id,a.floor_id,a.extention_no,d.party_id,b.item_description,b.po_id,b.prod_id,
					b.width_dia_type,d.subcon_job, d.job_no_prefix_num,d.party_id,a.booking_no,c.job_no_mst,a.entry_form,b.rec_challan, a.process_id, a.remarks) order by a.batch_date "; 
				}//echo $sub_cond;
			}
		}
	...
	if($batch_type==0)
  	{
	 	...
	 	<div align="left"><b>Self Batch</b>
		 	<table class="rpt_table" width="1940" id="table_header_1" cellpadding="0" cellspacing="0" border="1" rules="all">
		        <thead>
		            <tr>
		                <th width="30">SL</th>
			...
			<div style=" max-height:350px; width:1940px; overflow-y:scroll;" id="scroll_body">
				<table class="rpt_table" id="table_body" width="1920" cellpadding="0" cellspacing="0" border="1" rules="all">
			 		<tbody>
					<? 
                    ...
                    $b=0;
                    $btq=0;
                    $tot_book_qty=0;  $tot_batch_wgt=0;$total_tot_batch_wgt=0;
                    $tot_grey_req_qty=0;
                    $batch_chk_arr=array();
                    ...
                    { 	
                        ...
                        {					
                           ...
                           <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
                            ...
                            <td style="word-break:break-all;" width="150"><div style="width:150px; word-wrap:break-word;"><? echo $desc[1]; ?></div></td>
                            <td style="word-break:break-all;"  width="50"><p><? echo $desc[3]; ?></p></td>
                            <td style="word-break:break-all;"  width="50"><p><? echo $desc[2]; ?></p></td>
				...
				<table class="rpt_table" width="1920"  cellpadding="0" cellspacing="0" border="1" rules="all">
			        <tfoot>
			            <tr>
			                <th width="30">&nbsp;</th>
			                <th width="75">&nbsp;</th>
		...
		<div align="left"><b>Sample Batch</b>
			...
			<div style=" max-height:350px; width:1830px; overflow-y:scroll;" id="scroll_body">
			 	<table class="rpt_table" id="table_body3" width="1810" cellpadding="0" cellspacing="0" border="1" rules="all">
			 		<tbody>
						<? 
						...
						$btq=0;
						$tot_book_qty2=0;
						$tot_grey_req_qty=$samp_tot_batch_wgt=0;
						$batch_chk_arr=array();
				...
				<table class="rpt_table" width="1810" cellpadding="0" cellspacing="0" border="1" rules="all">
			        <tfoot>
			            <tr>
			                <th width="30">&nbsp;</th>
			                <th width="75">&nbsp;</th>
                    ...
                    if($sam_booking!=$batch[csf('booking_no')])
                        {					
                           ...
                           <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
                            ...
                            <td width="150" style="word-break:break-all;"><div style="width:150px; word-wrap:break-word;"><? echo $desc[1]; ?></div></td>
                            <td width="50" style="word-break:break-all;"><p><? echo $desc[3]; ?></p></td>
                            <td width="50" style="word-break:break-all;"><p><? echo $desc[2]; ?></p></td>
                            <td style="word-break:break-all;" title="<? echo 'Prod Id'.$batch[csf('prod_id')].'=PO ID'.$order_id;?>" align="left" width="60"><div style="width:60px; word-wrap:break-word;"><? echo $yarn_lots; ?></div></td>
	...
	*/
	if($batch_type==3)
	{
		if($cbo_type==1)
		{
			...
			<table class="rpt_table" id="table_header_1" width="1830" cellpadding="0" cellspacing="0" border="1" rules="all">
                <thead>
                    <tr>
                        <th width="30">SL</th>
                        <th width="75">Batch Date</th>
