...
if($action=="report_generate")
{
	...
	where a.booking_no=b.booking_no  and b.booking_type=1 $po_cond_in $com_con and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0";
