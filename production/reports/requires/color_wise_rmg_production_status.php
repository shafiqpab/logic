...
<script>
	...
	function fn_generate_report(type)
	{
		...
		var data="action=generate_report"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_job_no*hidden_job_id*txt_order_no*hidden_order_id*cbo_process*txt_production_date*cbo_shipment_status',"../../")+'&type='+type+'&report_title='+report_title;
   ...
   <? echo load_freeze_divs ("../../",'');  ?>
    ...
    <form id="dateWiseProductionReport_1">    
      <fieldset style="width:1090px;">
            <table class="rpt_table" width="1090" cellpadding="0" cellspacing="0" align="center" border="1" rules="all">
               <thead>                    
                    <tr>
                ...
                <tr class="general">
                    ...
                    <!-- <td align="center"> 
                        <?
                            //echo create_drop_down( "cbo_work_company_name", 120, "SELECT id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 0, "-- Select --", $selected, "load_drop_down( 'requires/color_wise_rmg_production_status_controller',this.value, 'load_drop_down_location', 'location_td' );" );
                        ?>
                    </td>
