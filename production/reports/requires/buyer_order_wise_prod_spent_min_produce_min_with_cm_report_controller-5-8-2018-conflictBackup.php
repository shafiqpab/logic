	...
	if(str_replace("'","",$txt_date_from)!="" && str_replace("'","",$txt_date_to)!="")
		...
		//echo $report_type.'dd';die;
         ...
         WHERE a.job_no=b.job_no_mst  and  c.po_break_down_id=b.id   and b.is_deleted=0 and b.status_active=1 and c.is_deleted=0 and c.status_active=1 $ex_fact_date_cond $po_cond_for_in2   $buyer_id_cond $year_cond $style_no_cond  $style_id_cond  $product_cat_cond  group by c.po_break_down_id order by c.po_break_down_id";
				...
				$img_data_array=sql_select("select image_location  from common_photo_library  where master_tble_id='$company_name' and form_name='company_details' and is_deleted=0 and file_type=1");
		...
		?>
           <br/> <br/>
			 ...
			 <div style="float:left">
				<?
					foreach($img_data_array as $img_row)
					{
						?>
						<img src='../../<? echo $img_row[csf('image_location')]; ?>' height='40' width='70' align="middle" />	
						<? 
					}
					?>
			 </div>
				...
				<b>
				Buyer Order Wise Prod Spent Min Produce Min With CM Report Summary</b><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				 <? echo $company_arr[$company_name].'<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$start_date.' To '.$end_date; ?>
				 </b>
			 </div>
			 </tr>
			 <tr>
>>>>>>> 885cb68b3f843cc2e72c7f52eb44fc13df647427
			 <thead>
				 <th width="30"> SL</th>
            ...
            <?
				...
				foreach($po_wise_prod_data_arr as $po_key=>$val)
				{
                       ...
                       <tr bgcolor="<? echo $bgcolor;?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i; ?>">
                            ...
                            <td width="90"  title="Production(Sewing Out)*PO Unit price"  align="right"> <div style="word-break:break-all"><? $fob_earning=$val['unit_price']*$prod_sew_out_qty; echo number_format($fob_earning,2); ?> </div>	</td>
