...
{ 
	...
	{		
		...
		{			
			...
			$prod_sql= "SELECT c.po_break_down_id, a.color_number_id,a.size_number_id,c.floor_id,c.sewing_line,c.production_type,c.PROD_RESO_ALLO,
			...
			where  c.id=d.mst_id     and a.job_id=e.id  and a.id=d.color_size_break_down_id and 
				c.status_active=1 and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0  and e.status_active=1 and e.is_deleted=0  and c.serving_company=$cbo_company_name $po_product_cond $internal_ref_cond_prod $location_cond $floor_cond $date_con
				group by c.po_break_down_id, a.color_number_id,a.size_number_id,c.floor_id,c.sewing_line,c.production_type,c.PROD_RESO_ALLO";
		...
		foreach($res_gmtsData as $gmtsRow)
		{
			...
			if($gmtsRow[csf('production_type')]==4)
			{
				$gmts_prod_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('color_number_id')]][$gmtsRow[csf('size_number_id')]]['sewing_line'].=$gmtsRow[csf('sewing_line')]."**".$gmtsRow[csf('PROD_RESO_ALLO')]."==";
			}
        ...
        where c.mst_id=a.id and c.status_active=1 $all_po_ids_cond  $location_cond_qc $floor_cond_qc $date_con_qc
			...
			<table width="4000" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
				<thead>
					<tr>
						...
						<th width="60"><p> Today Cutting</p></th> 
				...
				<table border="1" class="rpt_table" width="4000" rules="all" id="table_body">
					...
					{					
						...
						foreach ($po_data as $color_id => $color_data) 
						{
											...
											<td  rowspan="<? echo $rowSpanArray[$po_id][$color_id];?>"  width="30"><? echo $s;?></td>
											 <td  valign="middle" rowspan="<? echo $rowSpanArray[$po_id][$color_id];?>" width="100"><p><?= $buyer_short_library[$row['buyer_name']]; ?><p></td>  
											   ...
											   <td  width="60" align="right"><p><? echo number_format($embel_rcv,0); ?></p></td>
												...
												<td width="60" align="right"><p><?=number_format($today_sewingin_qnty) ;?></p></td>
							...
							<tr class="gd-color2">
								...
								<td align="right"><? echo number_format($co_today_sewingin_qnty);?></td>
                        ...
                        <tr class="gd-color3">
                                ...
                                <td align="right"><? echo number_format($po_today_sewingin_qnty);?></td>
					...
					<tfoot>
						<tr class="gd-color3">
                                ...
                                <th align="right"><? echo number_format($gr_today_sewingin_qnty);?></th>
