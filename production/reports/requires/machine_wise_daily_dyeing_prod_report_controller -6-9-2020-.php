										...
										foreach ($prod_date_data as $machine_id => $machine_data)
										{
											...
											foreach ($machine_data as $batch_id => $row)
											{
												...
												<tr id="<? echo 'v_'.$i; ?>" onClick="change_color('v_<? echo $i; ?>','#FFFFFF')" bgcolor="<? echo $bgcolor; ?>">
													...
													{
														$sub_prod_qty_aop=$wash_qty_array[$machine_id][$batch_id][$row[("batch_ext_no")]]["prod_qty_aop"];
														$sub_prod_qty_normal=$wash_qty_array[$machine_id][$batch_id][$row[("batch_ext_no")]]["prod_qty_normal"];
