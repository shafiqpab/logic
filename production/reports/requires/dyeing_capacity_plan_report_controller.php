...
if ($action == "report_generate")
{
	...
	if ($txt_date_from != "" && $txt_date_to != "") 
	{
		...
		$date_cond = "and A.TASK_FINISH_DATE between '".$start_date."' and '".$end_date."'";
	}
	// echo $year_month;die;
	// ================================================================================
	            ...
	            <table width="<?= $tbl_width4; ?>" class="rpt_table" cellpadding="0" cellspacing="0" border="1" rules="all" id="table_body">
					<tbody>
						<tr>
							...
							{ 
								?>
								<td width="80" align="right"><? echo number_format($booked_qty_arr[$month_year]['BOOKED_QTY'],2,".",""); ?></td>
								<td width="80" align="right"><? echo number_format($booked_qty_arr[$month_year]['BOOKED_QTY']-$mc_capacity,2,".",""); ?></td>
								<?
								//$tot_booked_qty[$month_year]+=$booked_qty_arr[$month_year]['BOOKED_QTY'];
								$tot_varience+=$booked_qty_arr[$month_year]['BOOKED_QTY']-$mc_capacity;
							}
							?>
					...
					<!-- <tfoot>
						<tr class="tbl_bottom">
							...
							//{
								?>
								<th width="100" align="right"><? //echo number_format($tot_booked_qty[$month_year],2,".",""); ?></th>
