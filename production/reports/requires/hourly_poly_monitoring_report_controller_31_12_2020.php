...
{ 
		...
		foreach($production_data_arr as $f_id=>$fname)
		{
			...
			foreach($fname as $l_id=>$ldata)
			{
				...
				$html.='<td width="40">'.$i.'&nbsp;</td>
							...
							<td align="right" width="80"><a href="##" onclick="openmypage('."'".$cbo_company_id."'".",'".$order_no_total."',".$f_id.",".$l_id.",'tot_prod','".$smv_for_item."',".$txt_date.',11,'."'".implode(',',$garment_item_id_arr)."'".')">'.$today_product.'</a></td>
	...
	else if($type==2) // sewing out button
	{		
	 ...
	 // print_r($last_pro_hour);
	    ...
	    <fieldset style="width:2680px">
	        ...
	        <div style="width:2750px; max-height:400px; overflow-y:scroll" id="scroll_body_2">
