...
{ 
	...
	if($report_type==1)
	{
						...
						//echo $sql_sample_samary;die;
							...
							?>
								<tr bgcolor="<? echo $bgcolor; ?>">
									...
									<td width="90" align="right"><? echo number_format($rows[csf('qtyoutbound')],2,'.',''); ?>&nbsp;</td>
		...
		<fieldset style="width:<? echo $tbl_width+20; ?>px;">
			<table cellpadding="0" cellspacing="0" width="<? echo $tbl_width; ?>">
				<tr>
				   <td align="center" width="100%" colspan="34" class="form_caption" style="font-size:18px"><? echo $report_title; ?></td>
				</tr>
				<tr>
				   <td align="center" width="100%" colspan="34" class="form_caption" style="font-size:16px"><? echo $company_arr[str_replace("'","",$cbo_company_name)]; ?></td>
				</tr>
				<tr> 
				   <td align="center" width="100%" colspan="34" class="form_caption" style="font-size:12px" ><strong><? echo "From ".str_replace("'","",$txt_date_from)." To ".str_replace("'","",$txt_date_to); ?></strong></td>
				</tr>
			</table>
			<?
		if($cbo_type==1 || $cbo_type==0)
					...
					<table cellspacing="0" cellpadding="0" border="1" rules="all" width="<? echo $tbl_width+140; ?>" class="rpt_table" id="table_head" >
						<thead>
							<tr>
								...
								?>
								<!--<th width="150" colspan="2">No Shift xx</th>-->
							...
							<tr>
								...
								?>
								<!--<th width="50" rowspan="2">Roll xx</th>
								<th width="100" rowspan="2">Qnty xx</th>-->
								<th width="50" rowspan="2">Roll</th>
								<th width="100" rowspan="2">Qnty</th>
							</tr>
						</thead>
		...
		<fieldset style='width:".$widths."px;'>
				<table cellpadding='0' cellspacing='0' width='".$tbl_width."'>
					<tr>
					   <td align='center' width='100%' colspan='34' class='form_caption' style='font-size:18px'>".$report_title."</td>
					</tr>
					<tr>
					   <td align='center' width='100%' colspan='34' class='form_caption' style='font-size:16px'>".$company_arr[str_replace("'","",$cbo_company_name)]."</td>
					</tr>
					<tr> 
					   <td align='center' width='100%' colspan='34' class='form_caption' style='font-size:12px' ><strong>"."From ".str_replace("'","",$txt_date_from)." To ".str_replace("'","",$txt_date_to)."</strong></td>
					</tr>
				</table>					
					...
					<div style="width:<? echo $tbl_width+160; ?>px; overflow-y:scroll; max-height:330px;" id="scroll_body">
						<table cellspacing="0" cellpadding="0" border="1" rules="all" width="<? echo $tbl_width+140; ?>" class="rpt_table" id="table_body">
							...
							// echo $sql_wout_order;
								...
								?>
									<tr  bgcolor="#CCCCCC">
										<td colspan="35" align="left" ><b>In-House</b></td>
									</tr>    
								<?
								$html.="<tr  bgcolor='#CCCCCC'>
									...
									foreach ($nameArray_inhouse as $row)
									{
										...
										if(!in_array($row[csf('floor_id')],$floor_array))
										{
											...
											?>
												<tr class="tbl_bottom">
													...
													<td align="right"><? //echo number_format($noshift_total,2,'.',''); ?> xx</td>-->
													<td align="right">&nbsp;</td>
										...
										<?
										$html.="<tr><td colspan='34' style='font-size:14px' bgcolor='#CCCCAA'>&nbsp;<b></b></td></tr>";
										...
										<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>"> 
											...
											<td width="100" id="color_<? echo $i; ?>"><p>&nbsp;<? echo $color_details[$row[csf("color_id")]]; ?></p></td>
											...
											<td width='100'><p>&nbsp;".$color_details[$row[csf('color_id')]]."</p></td>
											...
											?>
											<!--<td width="50" align="right" id="noqty_<? //echo $i; ?>"><? //echo $row[csf('rollnoshift')]; ?> xx</td>
											<td width="100" align="right" id="noqty_<? //echo $i; ?>"><? //echo number_format($row[csf('qntynoshift')],2); ?> xx</td>-->
								...
								?>
									...
									<tr class="tbl_bottom">
										...
										?>
										<!--<td align="right">&nbsp; xx</td>
										<td align="right"><? //echo number_format($total_qty_noshift,2,'.',''); ?> xx</td>-->
										<td align="right">&nbsp;</td>
								...
								?>
									<tr  bgcolor="#CCCCCC">
										<td colspan="35" align="left"><b>Outbound-Subcontract</b></td>
									</tr>  
									  
								<?
								$html.="<tr  bgcolor='#CCCCCC'>
										<td colspan='34' align='left'><b>Outbound-Subcontract</b></td>
									</tr>";
									...
									?>  
										<tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>"> 
											...
											<td width="100"><p>&nbsp;<? echo $color_details[$row[csf("color_id")]]; ?></p></td>
											...
											?>
											<!--<td width="50" align="right"><? //echo $row_tot_roll; ?> xx</td>
											<td width="100" align="right"><? //echo number_format($row[csf('outqntyshift')],2); ?> xx</td>-->
								...
								?>
									<tr  bgcolor="#CCCCCC">
										<td colspan="35" align="left" ><b>Sample Wothout Order</b></td>
									</tr>    
								<?
								$html.="<tr  bgcolor='#CCCCCC'>
										<td colspan='34' align='left' ><b>Sample Wothout Order</b></td>
									</tr>";
								...
								?></tbody>
									...
									<tr class="tbl_bottom">
										<td colspan="26" align="right"><b> Sample Wothout Order Total</b></td>
										<?
									...
									<tr>
										<td colspan='25' align='right'><b> Sample Wothout Order Total</b></td>";
										//$source_tot_qnty_row=0;
										foreach($shift_name as $key=>$val)
										{
											$source_tot_qnty+=$source_tot_roll[$key]['qty'];
							...
							<tfoot>
								...
								?>
								<!--<th align="right">&nbsp; xx</th>
								<th align="right"><? //echo number_format($total_qty_noshift,2,'.',''); ?> xx</th>-->
								<th align="right">&nbsp;</th>
	...
	//var_dump($ymcpacityWO_arr);	
		...
		<br>
				...
				$ymcpacityWO_arr=return_library_array( "select d.machine_no,sum(b.grey_receive_qnty) as quantity  from inv_receive_master a, pro_grey_prod_entry_dtls b, lib_machine_name d where a.entry_form=2 and a.item_category=13 and a.id=b.mst_id  and a.knitting_source=1 and a.company_id=$cbo_company_name and a.knitting_source like '$source' and b.machine_no_id=d.id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and a.booking_without_order=1 $date_con_2 $floor_id  $buyer_cond group by d.machine_no", "machine_no", "quantity" );
				  ...
				  $mcpacity_arr=return_library_array( "select machine_no, prod_capacity from lib_machine_name", "machine_no", "prod_capacity"  );
	...
	else
	{
		...
		$tbl_width=1550+count($shift_name)*100;
		ob_start();
		?>
		<fieldset style="width:<? echo $tbl_width+20; ?>px;">
			<table cellpadding="0" cellspacing="0" width="<? echo $tbl_width; ?>">
            ...
            <table cellspacing="0" cellpadding="0" border="1" rules="all" width="<? echo $tbl_width; ?>" class="rpt_table" id="table_head" >
                <thead>
                    <tr>
                        ...
                        <th width="100" rowspan="2">Yarn Count</th>
                        ...
                        <th width="100" rowspan="2">Ship Total</th>
            ...
            <div style="width:<? echo $tbl_width+20; ?>px; overflow-y:scroll; max-height:330px;" id="scroll_body">
                <table cellspacing="0" cellpadding="0" border="1" rules="all" width="<? echo $tbl_width; ?>" class="rpt_table" id="table_body">
					...
					//die;
                        ...
                        $sql_inhouse="select a.receive_basis, a.receive_date, a.buyer_id, a.remarks, b.id, b.prod_id, b.febric_description_id, b.gsm, b.width, b.yarn_lot, b.yarn_count, b.stitch_length, b.brand_id, b.machine_no_id, b.floor_id $select_color, c.po_breakdown_id, d.machine_no as machine_name, e.po_number,e.file_no,e.grouping";
                        foreach($shift_name as $key=>$val)
                        {
                            $sql_inhouse.=", sum(case when b.shift_name=$key then c.quantity else 0 end ) as qntyshift".strtolower($val);
                        }
                        $sql_inhouse.=" from inv_receive_master a, pro_grey_prod_entry_dtls b, order_wise_pro_details c, lib_machine_name d, wo_po_break_down e,  wo_po_details_master f where a.id=b.mst_id and b.id=c.dtls_id and b.machine_no_id=d.id and e.job_no_mst=f.job_no and  c.po_breakdown_id=e.id and a.entry_form=2 and a.item_category=13 and c.entry_form=2 and c.trans_type=1 and a.knitting_source=1 and a.company_id=$cbo_company_name and a.knitting_source like '$source' and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $date_con $floor_id $buyer_cond $job_cond $order_cond $job_year_cond
                        group by a.receive_basis, a.receive_date, a.buyer_id, a.remarks, b.id, b.prod_id, b.febric_description_id, b.gsm, b.width, b.yarn_lot, b.yarn_count, b.stitch_length, b.brand_id, b.machine_no_id, b.floor_id $group_color, c.po_breakdown_id, d.machine_no, e.po_number,e.file_no,e.grouping 
                        ...
                        //$nameArray_subcontract=sql_select( $sql_subcontract);
                        $nameArray_without_order=sql_select( $sql_wout_order);
						$machine_inhouse_array=array();
                        foreach ($nameArray_inhouse as $row)
						{
							$machine_inhouse_array[$row[csf('machine_no_id')]]++;
							foreach($shift_name as $key=>$val)
                        	{
                        ...
                        foreach ($nameArray_without_order as $row)
						{
							$machine_without_array[$row[csf('machine_no_id')]]++;
							foreach($shift_name as $key=>$val)
                        	{
                        ...
                        if (count($nameArray_inhouse)>0)
                        {
                            ...
                            foreach ($nameArray_inhouse as $row)
                            {
                                ...
                                <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
									...
									if(!in_array($row[csf('machine_no_id')],$temp_arr))
                                	{
										$km++;
										?>
                                         <td width="30" align="center" rowspan="<? echo ($machine_inhouse_array[$row[csf('machine_no_id')]]); ?>"><? echo $km; ?></td>
                                        <td width="90" valign="top" rowspan="<? echo ($machine_inhouse_array[$row[csf('machine_no_id')]]); ?>"><p><? echo $row[csf('machine_name')]; ?></p></td>
                                        <?
                                    ...
                                    <td width="60"><p><? echo $machine_details[$row[csf('machine_no_id')]]['dia']." ".$machine_details[$row[csf('machine_no_id')]]['gauge']; ?></p></td>
                                    <td width="70"><? echo $floor_details[$row[csf('floor_id')]]; ?></td>
                                    ...
                                    <td width="100" align="center"><p><? echo $count; ?></p></td>
                                    <td width="80"><p><? //echo $row[csf('po_number')];//$po_array[$row[csf('po_breakdown_id')]]['no']; ?></p></td>
                                    <td width="80"><P><? echo $brand_details[$row[csf('brand_id')]]; ?>&nbsp;</P></td>
                                    <td width="80" align="center"><P><? echo $row[csf('yarn_lot')]; ?>&nbsp;</P></td>
                                    <td width="150"><P><? echo $composition_arr[$row[csf('febric_description_id')]]; ?>&nbsp;</P></td>
                                    <td width="100"><P><? echo $color_details[$row[csf("color_id")]]; ?>&nbsp;</P></td>
									...
									if(!in_array($row[csf('machine_no_id')],$temp_arr))
                                	{
										$temp_arr[]=$row[csf('machine_no_id')];
										?>
                                        <td width="100" valign="top" align="right" rowspan="<? echo $machine_inhouse_array[$row[csf('machine_no_id')]]; ?>"><? echo number_format($machine_inhouse_qty[$row[csf('machine_no_id')]],2,'.',''); ?></td>
                                        <?
                        ...
                        if (count($nameArray_without_order)>0)
                        {
                            ...
                            foreach ($nameArray_without_order as $row)
                            {
                                ...
                                <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>"> 
                                    ...
                                    <?
									if(!in_array($row[csf('machine_no_id')],$temp_ono_order_arr))
                                	{
										$j++;
										?>
                                        <td width="30"><? echo $j; ?></td>
                                        <td width="90" valign="top" rowspan="<? echo $machine_without_array[$row[csf('machine_no_id')]]; ?>"><p><? echo $row[csf('machine_name')]; ?></p></td>
                                        <?
									}
									?>
                                    
                                    <td width="70"><p><? if($row[csf('receive_date')]!="" && $row[csf('receive_date')]!="0000-00-00") echo change_date_format($row[csf('receive_date')]); ?>&nbsp;</p></td>
                                    <td width="60"><p><? echo $machine_details[$row[csf('machine_no_id')]]['dia']." ".$machine_details[$row[csf('machine_no_id')]]['gauge']; ?></p></td>
                                    <td width="70"><? echo $row[csf('floor_id')]; ?></td>
                                    <td width="70"><? echo $buyer_arr[$row[csf('buyer_id')]]; ?></td>
                                    <td width="70"><p><? echo $row[csf('file_no')]; ?></p></td>
                                    <td width="70" id="buyer_id_<? echo $i; ?>"><p>&nbsp;<? echo $row[csf('grouping')]; ?></p></td>
                                    <td width="100"><p><? echo $count; ?></p></td>
                                    <td width="80"><p><? //echo $row[csf('po_number')];//$po_array[$row[csf('po_breakdown_id')]]['no']; ?></p></td>
                                    <td width="80"><P><? echo $brand_details[$row[csf('brand_id')]]; ?>&nbsp;</P></td>
									...
									if(!in_array($row[csf('machine_no_id')],$temp_ono_order_arr))
                                	{
										$temp_ono_order_arr[]=$row[csf('machine_no_id')];
										?>
                                        <td width="100" valign="top" align="right" rowspan="<? echo $machine_without_array[$row[csf('machine_no_id')]]; ?>"><? echo number_format($machine_inhouse_qty[$row[csf('machine_no_id')]],2,'.',''); ?></td>
                                        <?
										$grand_machine_total+=$machine_inhouse_qty[$row[csf('machine_no_id')]];
										$machine_total_non_order+=$machine_inhouse_qty[$row[csf('machine_no_id')]];
									}
									?>
                                    <td><p><? echo $row[csf('remarks')]; ?>&nbsp;</p></td>
                                </tr>
            ...
            <table cellspacing="0" cellpadding="0" border="1" rules="all" width="<? echo $tbl_width; ?>" class="rpt_table" id="rpt_tbl_footer">
                <tfoot>
                    <tr>
                        ...
                        {
                        ?>
                        <th align="right" width="100"><? echo number_format($grand_total_ship[$key],2,'.',''); ?></th>
                        <?
                        }
                        ?>
