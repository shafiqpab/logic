...
{
	//echo $data;die;
	$sql="select id,location_name from lib_location where status_active =1 and is_deleted=0 and company_id in (".$data.") order by location_name";
	//echo $sql;die;
	echo create_drop_down( "cbo_location", 100,$sql ,"id,location_name", 1, "-Select Location-", $selected, "load_drop_down( 'requires/date_wise_production_report_controller', this.value, 'load_drop_down_floor', 'floor_td' );",0 );     					
	exit();
}
...
// {
// 	echo create_drop_down( "cbo_buyer_name", 110, "select buy.id,buy.buyer_name from lib_buyer buy, lib_buyer_tag_company b where buy.status_active =1 and buy.is_deleted=0 and b.buyer_id=buy.id and b.tag_company='$data' and buy.id in (select  buyer_id from  lib_buyer_party_type where party_type in (1,3,21,90)) $buyer_cond order by buyer_name","id,buyer_name", 1, "-Select Buyer-", $selected, "load_drop_down( 'requires/order_wise_production_report__multi_company_order_wise_controller', this.value, 'load_drop_down_season', 'season_td');" );     	 
// 	exit();
// }
if ($action=="load_drop_down_buyer")
{  

	echo create_drop_down( "cbo_buyer_name", 110, "SELECT buy.id,buy.buyer_name from lib_buyer buy, lib_buyer_tag_company b where buy.status_active =1 and buy.is_deleted=0 and b.buyer_id=buy.id and b.tag_company in($data) and buy.id in (select  buyer_id from  lib_buyer_party_type where party_type in (1,3,21,90))  $buyer_cond group by buy.id,buy.buyer_name order by buyer_name","id,buyer_name", 1, "- All Buyer -", $selected,"load_drop_down( 'requires/order_wise_production_report__multi_company_order_wise_controller', this.value, 'load_drop_down_season', 'season_td');" );     	 
	exit();
}
...
{ 
	...
	$query_cond="variable_list=31 and company_name in (".$cbo_company_name.")";
	$tna_process_type=return_field_value("tna_process_type"," variable_order_tracking",$query_cond); 
	...
	if(str_replace("'","",$cbo_company_name)==0) $company_name=""; else $company_name=" and b.company_name in (".$cbo_company_name.")";
	...
	*/	
    ...
    if($type==1) //order wise
    {
		...
		if($db_type==0){$select_job_year="year(b.insert_date) as job_year";} else{ $select_job_year="to_char(b.insert_date,'YYYY') as job_year";}
	 	...
	 	$order_sql="SELECT a.pub_shipment_date_prev, a.is_confirmed, a.insert_date as po_insert_date, b.order_uom,a.id, b.job_no_prefix_num, $select_job_year , b.job_no, b.team_leader, b.dealing_marchant, b.agent_name, a.po_number,a.status_active, a.po_quantity, a.unit_price, a.pub_shipment_date as shipment_date, a.shiping_status, a.excess_cut, a.plan_cut, a.file_no, a.grouping, a.details_remarks, b.company_name, b.buyer_name, b.set_break_down, b.style_ref_no, b.total_set_qnty as ratio, c.smv_pcs, c.gmts_item_id from wo_po_details_master b, wo_po_break_down a,wo_po_details_mas_set_details c where a.job_no_mst=b.job_no and b.job_no=c.job_no  $po_tbl_cond and a.is_deleted=0 and LOWER(a.po_number) like LOWER('$search_string') and b.status_active=1 and b.is_deleted=0 $txt_date $company_name $buyer_name $season_cond $garmentsNature $team_name_cond $team_member_cond   $year_cond $file_no $ref_no $ship_status_cond $agent_cond $order_status_cond $item_cat_cond   order by b.company_name,a.pub_shipment_date, b.job_no_prefix_num, a.id";
		//echo $order_sql;die;
		...
		foreach($result as $orderRes)
		{
			...
			$orderWiseDataArr[$orderRes[csf("id")]]=$orderRes[csf("job_no_prefix_num")]."##".$orderRes[csf("job_no")]."##".$orderRes[csf("team_leader")]."##".$orderRes[csf("dealing_marchant")]."##".$orderRes[csf("agent_name")]."##".$orderRes[csf("po_number")]."##".$orderRes[csf("po_quantity")]."##".$orderRes[csf("unit_price")]."##".$orderRes[csf("shipment_date")]."##".$orderRes[csf("shiping_status")]."##".$orderRes[csf("excess_cut")]."##".$orderRes[csf("plan_cut")]."##".$orderRes[csf("file_no")]."##".$orderRes[csf("grouping")]."##".$orderRes[csf("company_name")]."##".$orderRes[csf("buyer_name")]."##".$orderRes[csf("set_break_down")]."##".$orderRes[csf("style_ref_no")]."##".$orderRes[csf("ratio")]."##".$orderRes[csf("job_year")]."##".$orderRes[csf("details_remarks")]."##".$orderRes[csf("po_insert_date")]."##".$orderRes[csf("is_confirmed")]."##".$orderRes[csf("status_active")]."##".$orderRes[csf("order_uom")]."##".$orderRes[csf("pub_shipment_date_prev")];
		
			$smvArr[$orderRes[csf("job_no")].$orderRes[csf("gmts_item_id")]]=$orderRes[csf("smv_pcs")];
			$poIds[$orderRes[csf("id")]]=$orderRes[csf("id")];

			/*$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('id')]]=$orderRes[csf('id')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('job_no')]]=$orderRes[csf('job_no')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('job_no_prefix_num')]]=$orderRes[csf('job_no_prefix_num')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('team_leader')]]=$orderRes[csf('team_leader')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('dealing_marchant')]]=$orderRes[csf('dealing_marchant')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('agent_name')]]=$orderRes[csf('agent_name')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('po_number')]]=$orderRes[csf('po_number')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('po_quantity')]]=$orderRes[csf('po_quantity')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('unit_price')]]=$orderRes[csf('unit_price')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('shipment_date')]]=$orderRes[csf('shipment_date')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('shiping_status')]]=$orderRes[csf('shiping_status')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('excess_cut')]]=$orderRes[csf('excess_cut')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('plan_cut')]]=$orderRes[csf('plan_cut')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('grouping')]]=$orderRes[csf('grouping')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('company_name')]]=$orderRes[csf('company_name')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('buyer_name')]]=$orderRes[csf('buyer_name')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('set_break_down')]]=$orderRes[csf('set_break_down')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('style_ref_no')]]=$orderRes[csf('style_ref_no')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('ratio')]]=$orderRes[csf('ratio')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('job_year')]]=$orderRes[csf('job_year')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('details_remarks')]]=$orderRes[csf('details_remarks')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('po_insert_date')]]=$orderRes[csf('po_insert_date')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('is_confirmed')]]=$orderRes[csf('is_confirmed')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('status_active')]]=$orderRes[csf('status_active')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('order_uom')]]=$orderRes[csf('order_uom')];
			$main_array[$orderRes[csf('company_name')]][$orderRes[csf('buyer_name')]][$orderRes[csf('pub_shipment_date_prev')]]=$orderRes[csf('pub_shipment_date_prev')];*/
		}
		
		unset($result);
		//$poIds=chop($poIds,','); 
		//echo "<table style='border: 1px solid black;' border='1' >";
		//echo "<thead><th>Id></th><th>Company></th><th>Buyer</th><th>Order Qty.(Pcs)</th><</thead>";
		...
		$prod_loc_con = str_replace("c.location", "a.location", $location);
		$prod_floor_con = str_replace("c.floor_id", "a.floor_id", $floor);
		// ================================== WHEN REJECT QUANTITY ENTRY GROSS LEVEL NOT COLOR SIZE LEVEL ===============================
		$rej_sql= "SELECT a.po_break_down_id, a.item_number_id, a.production_type, a.reject_qnty as reject_qnty from pro_garments_production_mst a where a.status_active=1 and a.is_deleted=0  $poIds_cond $location $floor";
		$rej_res = sql_select($rej_sql);
		$rej_arr = array();
		foreach ($rej_res as $key => $val) 
		{
			$rej_arr[$val[csf('po_break_down_id')]][$val[csf('item_number_id')]][$val[csf('production_type')]] += $val[csf('reject_qnty')];
		}
		...
		foreach($res_gmtsData as $gmtsRow)
		{
			...
			if($gmtsRow[csf('break_down_type_rej')]==3)
			{
			...
			{
				$gmts_prod_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]]['crQty'] = $rej_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]];
				$gmts_prod_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]]['embQty'] = $rej_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]];
				$gmts_prod_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]]['sorQty'] = $rej_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]];
				$gmts_prod_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]]['irnQty'] = $rej_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]];
				$gmts_prod_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]]['frQty'] = $rej_arr[$gmtsRow[csf('po_break_down_id')]][$gmtsRow[csf('item_number_id')]][$gmtsRow[csf('production_type')]];
			}
		...
		// var_dump($orderWiseDataArr);die();
		
		$buyer_array=array();
		$i=0; $k=0; $date=date("Y-m-d");

		
		$company_list=explode(",", $cbo_company_name);
/* 
	testing start from here
		...
		foreach ($company_list as $key) {
			//echo $key ." : ";
			$sql="SELECT buy.id from lib_buyer buy, lib_buyer_tag_company b where buy.status_active =1 and buy.is_deleted=0 and b.buyer_id=buy.id and b.tag_company ='".$key."' and buy.id in (select  buyer_id from  lib_buyer_party_type where party_type in (1,3,21,90))   group by buy.id";
			$res=sql_select($sql);
			//print_r($res);die;
			$buyer_arr=array();
			foreach ($res as $buyer_id_in_company) {
				array_push($buyer_arr, $buyer_id_in_company);
				//echo $buyer_id_in_company."<br>";
			}
			//echo "<br><br>";
			//print_r($buyer_arr);die;
			array_push($company_array, $buyer_arr);
		}
		//die;
	...
	testing end
*/
		// echo count($orderWiseDataArr) ;die();
		...
		{ 
			...
			$status_active=$po_data_arr[23];
			$pub_shipment_date_prev=$po_data_arr[25];
			//echo "<pre>";
			...
			{				 
				...
				{  //echo $unit_price.'/'.$ratio.'*'.$set_qnty.',';
					...
					$plan_cut = ($order_uom==58) ? $po_data_arr[11]*$set_qnty : $po_data_arr[11];
					...
					$buyer_array[$company_name][$buyer_name]['buyer_name']=$buyer_name;
					$buyer_array[$company_name][$buyer_name]['company_name']=$company_name;
					$buyer_array[$company_name][$buyer_name]['poQty']+=$po_quantity_in_pcs;
					$buyer_array[$company_name][$buyer_name]['poVal']+=$po_quantity_in_pcs*$unitPrice;
					$buyer_array[$company_name][$buyer_name]['ex']+=$ex_factory_qnty;
					$buyer_array[$company_name][$buyer_name]['ex_val']+=$ex_factory_qnty*$unitPrice;
					$buyer_array[$company_name][$buyer_name]['cQty']+=$cutting_qnty;
					$buyer_array[$company_name][$buyer_name]['prQty']+=$embl_recv_qnty;
					$buyer_array[$company_name][$buyer_name]['sQty']+=$sewingin_qnty;
					$buyer_array[$company_name][$buyer_name]['soQty']+=$sewingout_qnty;
					$buyer_array[$company_name][$buyer_name]['iQty']+=$iron_qnty;
					$buyer_array[$company_name][$buyer_name]['reiQty']+=$re_iron_qnty;
					$buyer_array[$company_name][$buyer_name]['fQty']+=$finish_qnty;
					...
					$td_colors="";
					if($pub_shipment_date_prev && $pub_shipment_date_prev!='0000-00-00') $td_colors='bgcolor="yellow"';
					...
					$html.='<td  style="word-wrap: break-word;word-break: break-all;"  width="30">'.$display_font_color.$i.$font_end.'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="130" align="left"><p><a href="##" onclick="progress_comment_popup('.$po_id.",'".$template_id."',".$tna_process_type.')">'.$display_font_color.$po_number.$font_end.'</a></p></td>

								<td  style="word-wrap: break-word;word-break: break-all;"   width="100" align="left"><p>'.$display_font_color.$company_library[$company_name].$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="60" align="left"><p>'.$display_font_color.$buyer_short_library[$buyer_name].$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="50" align="center"><p>'.$display_font_color.$job_year.$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="center"><p>'.$display_font_color.$job_no_prefix_num.$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="120" '.$td_colors.' align="left"><p>'.$display_font_color.$style_ref_no.$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="100" align="left"><p>'.$display_font_color.$file_no.$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="100" align="left"><p>'.$display_font_color.$grouping.$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="left"><p>'.$display_font_color.$team_name_arr[$team_leader].$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="90" align="left"><p>'.$display_font_color.$team_member_arr[$dealing_marchant].$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="60" align="left"><p>'.$display_font_color.$buyer_short_library[$agent_name].$font_end.'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="35" onclick="openmypage_image(\'requires/order_wise_production_report__multi_company_order_wise_controller.php?action=show_image&job_no='.$job_no.'\',\'Image View\')"><img src="../../'.$imge_arr[$job_no].'" height="25" width="30" /></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="130" align="left"><p>'.$garments_item[$item_id].'</p></td>

								<td  style="word-wrap: break-word;word-break: break-all;"   width="50" align="center"><p>'.$smvArr[$job_no.$item_id].'</p></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage_order('.$po_id.",".$company_name.",".$item_id.",0,'OrderPopup'".')">'.$po_quantity_in_pcs.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="60" align="right"><p>'.number_format($unitPrice,2).'</p></td>
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right" title=" Unite Price='.number_format($unitPrice,2).'">'.number_format($po_quantity_in_pcs*$unitPrice,2).'</td>
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="center">'.change_date_format($po_insert_date).'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="center" bgcolor="'.$color.'">'.change_date_format($shipment_date).'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'exfactory','','','','0'".')">'.$ex_factory_date.'</a></td>
								
								
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="center">'.change_date_format($ppApprovalDateArr[$po_id]['approval_status_date']).'</a></td>



								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="center">'.$days_remian.'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.number_format($excess_cut,2)." %".'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.$plan_cut.'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'1','','','$type',''".')">'.$cutting_qnty.'</a></td>
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.($po_quantity_in_pcs-$cutting_qnty).'</td>
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"'.$excess_bgcolor.'>'.$actual_exces_cut_per.'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><font color="$bgcolor" style="display:none">'.$embl_iss_qty.'</font><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'2','','','$type',''".')">'.$embl_issue_total.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><font color="$bgcolor" style="display:none">'.$embl_recv_qty.'</font><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'3','','','$type',''".')">'.$embl_receive_total.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'4','','','$type',''".')">'.$sewingin_qnty.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'5','','','$type',''".')">'.$sewingout_qnty.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'7','','','$type',''".')">'.$iron_qnty.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'9','','','$type',''".')">'.$re_iron_qnty.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage('.$po_id.",".$item_id.",'8','','','$type',''".')">'.$finish_qnty.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.number_format($finish_status,2)." %".'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right"><a href="##" onclick="openmypage_rej('.$po_id.",".$item_id.",'reject_qty','','','$type',''".')">'.$rej_value.'</a></td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.$ex_factory_qnty.'</td>
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.number_format($ex_factory_qnty*$unitPrice,2).'</td>
								
								<td  style="word-wrap: break-word;word-break: break-all;"   width="80" align="right">'.$shortage.'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="60">'.$order_status[$po_status].'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="60">'.$row_status[$status_active].'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="85">'.$shipment_status[$shiping_status].'</td>
								<td  style="word-wrap: break-word;word-break: break-all;"   width="85" align="center"><a href="##" onclick="openmypage_remark('.$po_id.",".$item_id.",0,'date_wise_production_report'".')">Veiw</a></td>
								<td width="175"  style="word-wrap: break-word;word-break: break-all;"   align="center">'.$details_remarks.'</td>
							</tr>';
				}
			} //end for loop
		}// end main foreach 
	    ...
	    <div>
	   		<div>
		    	<table width="1500" cellspacing="0" >
		            <tr class="form_caption" style="border:none;">
		                <td  style="word-wrap: break-word;word-break: break-all;"  colspan="20" align="center" style="border:none;font-size:16px; font-weight:bold" >
		                    <?  echo "Multi Company Order wise Production Report"; ?>    
		                </td>
		            </tr>
		            <tr style="border:none;">
		                <td  style="word-wrap: break-word;word-break: break-all;"  colspan="20" align="center" style="border:none; font-size:14px;">
		            ...
		            <tr style="border:none;">
		                <td  style="word-wrap: break-word;word-break: break-all;"  colspan="20" align="center" style="border:none;font-size:12px; font-weight:bold">
		                    <?
	        ...
	        <div style="float:left; width:1530px" id="details_reports">
		        	<table width="1510" cellspacing="0" border="1" class="rpt_table" rules="all" id="" >
		        		<thead>
		        			<tr>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  colspan="17">In-House Order Production 
		        					<br />
		        					<?
		        					if(str_replace("'","",trim($txt_date_from))!="" && str_replace("'","",trim($txt_date_to))!="")
		        					{
		        	...
		        	<table width="1510" cellspacing="0" border="1" class="rpt_table" rules="all" id="" >
		        		<thead>
		        			<tr style="font-size:11px">
		        				...
		        				<th style="word-wrap: break-word;word-break: break-all;" width="100">Company Name</th>   
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="100">Buyer Name</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="110">Order Qty.(Pcs)</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="110">Order Value</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Cut Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Cutting balance</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Emb. Rcv. Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Sew Input Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Sew Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Iron Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Re-Iron Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Finish Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Fin Goods Status %</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Ex-Fac Qty</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Ex-Fac-Balance</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;"  width="80">Ex-Fac-Value</th>
		        				<th  style="word-wrap: break-word;word-break: break-all;" >Ex-Fac%</th>
		        			</tr>
		        		</thead>
		        	</table>
	            <div style="max-height:425px; overflow-y:scroll; width:1530px" id="scroll_body1">
	                <table cellspacing="0" border="1" class="rpt_table"  width="1510" rules="all">
	                <?
						...
						foreach($buyer_array as $buyer_val)
						{
							foreach($buyer_val as $row)
							{
					...
					foreach ($buyer_array as $buyer_val) {
						...
						$com_total_po_quantity=0;$com_total_po_value=0; $com_total_cut=0; $com_total_print_iss=0;
						$com_total_print_re=0; $com_total_sew_input=0; $com_total_sew_out=0; $com_total_iron=0; $com_total_re_iron=0; $com_total_finish=0;$com_total_ex_factory=0;
						
						$com_total_ex_factory_balance=0;
						
						foreach($buyer_val as $buyer_id=>$value)
	                    {
	                        if ($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
	                        ...
	                        <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>">
	                            ...
	                            <?php if($row_span==1){ ?>
	                            <td style="vertical-align: middle;text-align: center;" width="30" rowspan="<?php echo count($buyer_val);?>"><? echo $com_sl;?></td>
	                            <td style="vertical-align: middle;text-align: center;" width="100" rowspan="<?php echo count($buyer_val);?>"> <?php echo $company_library[$value["company_name"]]; ?></td>
	                            <?php $row_span++;} ?>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="100"><? echo $buyer_short_library[$value["buyer_name"]]; ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="110" align="right"><? echo number_format($value["poQty"]);?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="110" align="right"><? echo number_format($value["poVal"],2);?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["cQty"]); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["poQty"]-$value["cQty"]); ?></td>
	                           
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["prQty"]); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["sQty"]); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["soQty"]); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["iQty"]); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["reiQty"]); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["fQty"]); ?></td>
	                            <? $finish_gd_status = ($value["fQty"]/$value["poQty"])*100; ?>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($finish_gd_status,2); ?></td>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["ex"]); ?></td>
	                             <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right" title="PO Qty-Ex-Fac Qty"><? echo number_format($value["poQty"]-$value["ex"]); ?></td>
	                              <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($value["ex_val"]); ?></td>
	                            <? $ex_gd_status = ($value["ex"]/$value["poQty"])*100; ?>
	                            <td  style="word-wrap: break-word;word-break: break-all;"  align="right"><? echo  number_format($ex_gd_status,2); ?></td>
	                        </tr>	
	                        <?		
	                            $com_total_po_quantity+=$value["poQty"];
	                            $com_total_po_value+=$value["poVal"];
	                            $com_total_cut+=$value["cQty"];
	                            $com_total_print_re+=$value["prQty"];
	                            $com_total_sew_input+=$value["sQty"];
	                            $com_total_sew_out+=$value["soQty"];
	                            $com_total_iron+=$value["iQty"];
	                            $com_total_re_iron+=$value["reiQty"];
	                            $com_total_finish+=$value["fQty"];
	                            $com_total_ex_factory+=$value["ex"];
								$com_total_ex_factory_balance+=$value["poQty"]-$value["ex"];
								$com_total_ex_factory_val+=$value["ex_val"];
	                           
	                        $i++;
	                    }//end foreach 1st
	                    $com_sl++;
	                    $total_po_quantity+=$com_total_po_quantity;
                        $total_po_value+=$com_total_po_value;
                        $total_cut+=$com_total_cut;
                        $total_print_re+=$com_total_print_re;
                        $total_sew_input+=$com_total_sew_input;
                        $total_sew_out+=$com_total_sew_out;
                        $total_iron+=$com_total_iron;
                        $total_re_iron+=$com_total_re_iron;
                        $total_finish+=$com_total_finish;
                        $total_ex_factory+=$com_total_ex_factory;
						$total_ex_factory_balance+=$com_total_ex_factory_balance;
						$total_ex_factory_val+=$com_total_ex_factory_val;

						?>
							<tr  style="background: #ddd;"> 
	                        <!-- <td  style="word-wrap: break-word;word-break: break-all;"  width="30">&nbsp;</td> 
	                        <td width="100"></td> -->
	                        <td colspan="3" style="word-wrap: break-word;word-break: break-all;"  width="230" align="right">Sub Total</td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="110" id="tot_po_quantity" align="right"><? echo number_format($com_total_po_quantity); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="110" id="tot_po_value" align="right"><? echo number_format($com_total_po_value,2); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_cutting" align="right"><? echo number_format($com_total_cut); ?></td>
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_cutting" align="right"><? echo number_format($com_total_po_quantity-$com_total_cut); ?></td>
	                        
	                        
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_emb_rcv" align="right"><? echo number_format($com_total_print_re); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_sew_in" align="right"><? echo number_format($com_total_sew_input); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_sew_out" align="right"><? echo number_format($com_total_sew_out); ?></td>   
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_iron" align="right"><? echo number_format($com_total_iron); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_re_iron" align="right"><? echo number_format($com_total_re_iron); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_finish" align="right"><? echo number_format($com_total_finish); ?></td>
	                        <? $com_total_finish_gd_status = ($com_total_finish/$com_total_po_quantity)*100; ?>
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($com_total_finish_gd_status,2); ?></td >
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($com_total_ex_factory); ?></td >
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($com_total_ex_factory_balance); ?></td >
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($com_total_ex_factory_val); ?></td >
	                        <? $com_total_ex_status = ($com_total_ex_factory/$com_total_po_quantity)*100; ?>
	                        <td  style="word-wrap: break-word;word-break: break-all;"  align="right"><? echo number_format($com_total_ex_status,2); ?></td>
	                    </tr>
	            ...
	            <?php    
	                ...
	                <tr style="background: #808080;"> 
	                        <!-- <td  style="word-wrap: break-word;word-break: break-all;"  width="30">&nbsp;</td> 
	                        <td width="100"></td> -->
	                        <td colspan="3" style="word-wrap: break-word;word-break: break-all;"  width="230" align="right">Grand Total</td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="110" id="tot_po_quantity" align="right"><? echo number_format($total_po_quantity); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="110" id="tot_po_value" align="right"><? echo number_format($total_po_value,2); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_cutting" align="right"><? echo number_format($total_cut); ?></td>
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_cutting" align="right"><? echo number_format($total_po_quantity-$total_cut); ?></td>
	                        
	                        
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_emb_rcv" align="right"><? echo number_format($total_print_re); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_sew_in" align="right"><? echo number_format($total_sew_input); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_sew_out" align="right"><? echo number_format($total_sew_out); ?></td>   
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_iron" align="right"><? echo number_format($total_iron); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_re_iron" align="right"><? echo number_format($total_re_iron); ?></td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_finish" align="right"><? echo number_format($total_finish); ?></td>
	                        <? $total_finish_gd_status = ($total_finish/$total_po_quantity)*100; ?>
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($total_finish_gd_status,2); ?></td >
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($total_ex_factory); ?></td >
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($total_ex_factory_balance); ?></td >
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right"><? echo number_format($total_ex_factory_val); ?></td >
	                        <? $total_ex_status = ($total_ex_factory/$total_po_quantity)*100; ?>
	                        <td  style="word-wrap: break-word;word-break: break-all;"  align="right"><? echo number_format($total_ex_status,2); ?></td>
	                    </tr>
	                </table>
	        ...
	        <div style="float:left; width:600px">   
	            <table>
	                <tr>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  height="22" width="600"><div id="chartdiv"> </div></td>
	                </tr>    
	            </table>
	        </div> 
	        <div style="clear:both"></div>
	        <table width="3660" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
	            <thead>
	                <tr style="font-size:11px">
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="30">SL</th>    
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="130">Order Number</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="100">Company Name</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="60">Buyer Name</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="50">Job Year</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Job Number</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="120">Style Name</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="100">File No</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="100">Internal Ref</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Team Name</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="90">Team Member</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="60">Agent Name</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="35">Img</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="130">Item Name</th>
	                    ...
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="60">Unit Price</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Order Value</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">PO insert Date</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Ship Date</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Ex-Factory Date</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">PP Approved Date</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Days in Hand</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Stan. Exc. Cut %</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Plan Cut Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Cut Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Cutting balance</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Actual Exc. Cut %</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Emb. Issue Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Emb. Rcv. Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Sew Input Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Sew Output Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Iron Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Re-Iron Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Finish Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Fin Goods Status</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Reject Qty</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Total Ship Out</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Ship Out Value</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="80">Shortage/ Excess</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="60">Order Status</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="60">Active Status</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="85">Shipping Status</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="85">production remarks</th>
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="175">Order Remarks</th>
	                 </tr>
	            </thead>
	        </table>
	        <div style="max-height:425px; overflow-y:scroll; width:3680px" id="scroll_body">
	            <table border="1" class="rpt_table" width="3660" rules="all" id="table_body">
				<? echo $html; ?>  
	            </table>	
	            

				<table border="1" class="tbl_bottom" width="3660" rules="all" id="report_table_footer_1" >
	                <tr>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="30"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="130"></td>
	                    ...
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="60"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="35"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="130"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="50">Total</td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_order_quantity"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="60"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="order_value"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="tot_plan_cut"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_cutting"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_cutting_bal"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_emb_issue"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_emb_receive"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_sewing_input"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_sewing_out"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_iron_qnty"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_re_iron_qnty"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_finish_qnty"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" ></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" align="right" id="total_rej_value_td"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_out"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="ship_out_value"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="80" id="total_shortage"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="60"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="60"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="85" id="ship_status"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="85" id="ship_status"></td>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="175"></td>
	                 </tr>
				</table>
	        </div>
	...
	else if($type==2)//Order Location & Floor Wise
    {
		...
		if($shipping_status!=0) $ship_status_cond=" and a.shiping_status=$shipping_status";
		if($db_type==0) $select_job_year="year(b.insert_date) as job_year"; else $select_job_year="to_char(b.insert_date,'YYYY') as job_year";
		 $order_sql="SELECT  a.pub_shipment_date_prev,  a.id, b.job_no_prefix_num, $select_job_year, b.team_leader, b.dealing_marchant, a.po_number, sum(a.po_quantity) as po_quantity, a.unit_price, a.po_total_price, a.job_no_mst, a.pub_shipment_date as shipment_date, a.shiping_status, a.excess_cut, a.plan_cut, b.company_name, b.buyer_name, b.set_break_down, b.style_ref_no, c.location, c.floor_id from wo_po_details_master b,wo_po_break_down a left join pro_garments_production_mst c on c.po_break_down_id=a.id and c.status_active=1 and c.is_deleted=0 $location $floor where a.job_no_mst=b.job_no $po_tbl_cond and b.status_active=1 and LOWER(a.po_number) like LOWER('$search_string') $txt_date $company_name $buyer_name $season_cond $garmentsNature $team_name_cond $team_member_cond $ship_status_cond $order_status_cond $item_cat_cond 
		group by a.pub_shipment_date_prev, a.id, b.job_no_prefix_num, b.insert_date, b.team_leader, b.dealing_marchant, a.po_number, a.job_no_mst, a.pub_shipment_date, a.shiping_status, a.excess_cut, a.unit_price, a.po_total_price, a.plan_cut, b.company_name, b.buyer_name, b.set_break_down, b.style_ref_no, c.location, c.floor_id order by a.id, c.location, c.floor_id";
		...
		{ 
			...
			{	
			   ...
			   if($item_id>0)
			   {
					...
					$pub_shipment_date_prev=$orderRes[csf("pub_shipment_date_prev")];
					$td_colors="";
					if($pub_shipment_date_prev && $pub_shipment_date_prev!='0000-00-00') $td_colors='bgcolor="yellow"';
					...
					$html.='<td width="30">'.$display_font_color.$i.$font_end.'</td>
								...
								<td width="120" align="left" '.$td_colors.'><p>'.$display_font_color.$orderRes[csf("style_ref_no")].$font_end.'</p></td>
								<td width="80" align="left"><p>'.$display_font_color.$team_name_arr[$orderRes[csf("team_leader")]].$font_end.'</p></td>
								<td width="90" align="left"><p>'.$display_font_color.$team_member_arr[$orderRes[csf("dealing_marchant")]].$font_end.'</p></td>
								<td width="130" align="left"><p>'.$garments_item[$item_id].'</p></td>
								<td width="50" align="left"><p>'.$smv_arr[$item_id].'</p></td>
                                ...
                                <td width="80" align="left"><p>'.$location_library[$orderRes[csf("location")]].'</p></td>
                                <td width="80" align="left"><p>'.$floor_library[$orderRes[csf("floor_id")]].'</p></td>
	...
	else if($type==5 || $type==7)// 5 is Style Wise and 7 is Job wise
	{
		...
		if($db_type==0)
		{
			$prod_sql="SELECT c.po_break_down_id, c.item_number_id,
				...
				IFNULL(sum(CASE WHEN c.production_type ='1' and d.production_type ='1' THEN d.reject_qty ELSE 0 END),0) AS cutting_rej_qnty,
				IFNULL(sum(CASE WHEN c.production_type ='3' and d.production_type ='3' THEN d.reject_qty ELSE 0 END),0) AS emb_rej_qnty,
				IFNULL(sum(CASE WHEN c.production_type ='5' and d.production_type ='5' THEN d.reject_qty ELSE 0 END),0) AS sewingout_rej_qnty,
				IFNULL(sum(CASE WHEN c.production_type ='7' and d.production_type ='7' THEN d.reject_qty ELSE 0 END),0) AS iron_rej_qnty,
				IFNULL(sum(CASE WHEN c.production_type ='8' and d.production_type ='8' THEN d.reject_qty ELSE 0 END),0) AS finish_rej_qnty
		...
		else
		{
			$prod_sql= "SELECT c.po_break_down_id, c.item_number_id, 
				...
				NVL(sum(CASE WHEN c.production_type ='1' and d.production_type ='1' THEN d.reject_qty ELSE 0 END),0) AS cutting_rej_qnty,
				NVL(sum(CASE WHEN c.production_type ='3' and d.production_type ='3' THEN d.reject_qty ELSE 0 END),0) AS emb_rej_qnty,
				NVL(sum(CASE WHEN c.production_type ='5' and d.production_type ='5' THEN d.reject_qty ELSE 0 END),0) AS sewingout_rej_qnty,
				NVL(sum(CASE WHEN c.production_type ='7' and d.production_type ='7' THEN d.reject_qty ELSE 0 END),0) AS iron_rej_qnty,
				NVL(sum(CASE WHEN c.production_type ='8' and d.production_type ='8' THEN d.reject_qty ELSE 0 END),0) AS finish_rej_qnty
		   ...
		   for($j=0;$j<$countArr;$j++)
		   {
			   ...
			   if($item_id>0)
			   {
					...
					// echo $td_colors;
				   	...
				   	$html.="<tr bgcolor='$bgcolor' onclick=change_color('tr_2nd$k','$bgcolor') id=tr_2nd$k>";
					$html.='<td style="word-wrap: break-word;word-break: break-all;" width="30">'.$display_font_color.$i.$font_end.'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="120" title="'.$pub_shipment_date_prev.'" align="left" '.$td_colors.'><p>'.$display_font_color.$orderRes[csf("style_ref_no")].$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="50" align="center"><p>'.$display_font_color.$orderRes[csf("job_year")].$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="center"><p>'.$display_font_color.$orderRes[csf("job_no_prefix_num")].$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="130" align="left"><p>'.$display_font_color.$new_string.$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="60" align="left"><p>'.$display_font_color.$buyer_short_library[$orderRes[csf("buyer_name")]].$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="left"><p>'.$display_font_color.$team_name_arr[$orderRes[csf("team_leader")]].$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="90" align="left"><p>'.$display_font_color.$team_member_arr[$orderRes[csf("dealing_marchant")]].$font_end.'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="130" align="left"><p>'.$garments_item[$item_id].'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="50" align="center"><p>'.$smvArr[$orderRes[csf("job_no_mst")].$item_id].'</p></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right"><a href="##" onclick="openmypage_order('."'".$po_id."',".$company_name.",".$item_id.",0,'OrderPopup'".')">'.$po_quantity_in_pcs.'</a></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="center">'.change_date_format($orderRes[csf("po_insert_date")]).'</td>

								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="center" bgcolor="'.$color.'">'.change_date_format($orderRes[csf("shipment_date")]).'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right"><a href="##" onclick="openmypage('."'".$po_id."',".$item_id.",'exfactory','','','','0'".')">'.$ex_factory_date.'</a></td>
								
								
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="center"><a href="##" onclick="openmypage('."'".$po_id."',".$item_id.",'pp_approved_date_popup','','','','0'".')">'.change_date_format($ppApprovalDateArr[$orderRes[csf("job_no_mst")]]['approval_status_date']).'</a></td>
								
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="center">'.$days_remian.'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right">'.number_format($orderRes[csf("excess_cut")],2)." %".'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right"><a href="##" onclick="openmypage('."'".$po_id."',".$item_id.",'1','','','$type',''".')">'.$cutting_qnty.'</a></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right">'.($po_quantity_in_pcs-$cutting_qnty).'</td>
								...
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right"><a href="##" onclick="openmypage_rej('."'".$po_id."',".$item_id.",'reject_qty','','','$type',''".')">'.$rej_value.'</a></td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right">'.$ex_factory_qnty.'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="80" align="right">'.$shortage_ex.'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="85">'.$shipment_status[$orderRes[csf("shiping_status")]].'</td>
								<td style="word-wrap: break-word;word-break: break-all;" width="175"><a href="##" onclick="openmypage_remark('."'".$po_id."',".$item_id.",0,'date_wise_production_report'".')">Veiw</a></td>
							</tr>';
				}
			} //end for loop
		}// end main foreach 
		...
		<div>
	        ...
	        <div style="clear:both"></div>
	        <table  style="word-wrap: break-word;word-break: break-all;" width="2760" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
	            <thead>
	                <tr>
	                    <th style="word-wrap: break-word;word-break: break-all;" width="30">SL</th>
	                    <th style="word-wrap: break-word;word-break: break-all;" width="120">Style Name</th>  
	                    ...
	                    <th style="word-wrap: break-word;word-break: break-all;" width="80">Shortage/ Excess</th>
	                    <th style="word-wrap: break-word;word-break: break-all;" width="85">Shipping Status</th>
	                    <th style="word-wrap: break-word;word-break: break-all;" width="175">Remarks</th>
	                 </tr>
	            </thead>
	        </table>
	        <div style="max-height:425px; overflow-y:scroll; width:2780px" id="scroll_body">
	            <table style="word-wrap: break-word;word-break: break-all;" border="1" class="rpt_table" width="2760" rules="all" id="table_body">
					<? echo $html; ?>  
	            </table>	
	            <table style="word-wrap: break-word;word-break: break-all;" border="1" class="tbl_bottom" width="2760" rules="all" id="report_table_footer_1" >
	                <tr>
	                    <td style="word-wrap: break-word;word-break: break-all;" width="30"></td>
	                    <td style="word-wrap: break-word;word-break: break-all;" width="120"></td>
	                    <td style="word-wrap: break-word;word-break: break-all;" width="50"></td>
	...
	else if($type==3)//Order Country Wise
	{
		...
		$order_sql="SELECT  a.pub_shipment_date_prev, a.id, b.job_no_prefix_num, $select_job_year, b.job_no, b.team_leader, b.dealing_marchant, b.agent_name, a.po_number, a.po_quantity, a.unit_price, a.pub_shipment_date as shipment_date, a.shiping_status, a.excess_cut, a.plan_cut, a.file_no, a.grouping, a.details_remarks, b.company_name, b.buyer_name, b.set_break_down, b.style_ref_no, b.total_set_qnty as ratio 
			from wo_po_details_master b, wo_po_break_down a 
			where a.job_no_mst=b.job_no $po_tbl_cond and a.is_deleted=0 and LOWER(a.po_number) like LOWER('$search_string') and b.status_active=1 and b.is_deleted=0 $txt_date $company_name $buyer_name $season_cond $garmentsNature $team_name_cond $team_member_cond $file_no $ref_no $ship_status_cond $agent_cond $order_status_cond $item_cat_cond  order by a.pub_shipment_date, b.job_no_prefix_num, a.id";
		...
		foreach($result as $orderRes)
		{
			$tot_rows++;
			$poIds.=$orderRes[csf("id")].",";
			$orderWiseDataArr[$orderRes[csf("id")]]=$orderRes[csf("job_no_prefix_num")]."##".$orderRes[csf("job_no")]."##".$orderRes[csf("team_leader")]."##".$orderRes[csf("dealing_marchant")]."##".$orderRes[csf("agent_name")]."##".$orderRes[csf("po_number")]."##".$orderRes[csf("po_quantity")]."##".$orderRes[csf("unit_price")]."##".$orderRes[csf("shipment_date")]."##".$orderRes[csf("shiping_status")]."##".$orderRes[csf("excess_cut")]."##".$orderRes[csf("plan_cut")]."##".$orderRes[csf("file_no")]."##".$orderRes[csf("grouping")]."##".$orderRes[csf("details_remarks")]."##".$orderRes[csf("company_name")]."##".$orderRes[csf("buyer_name")]."##".$orderRes[csf("set_break_down")]."##".$orderRes[csf("style_ref_no")]."##".$orderRes[csf("ratio")]."##".$orderRes[csf("job_year")]."##".$orderRes[csf("pub_shipment_date_prev")];
		}
		...
		{ 
		   ...
		   $po_data_arr=explode("##",$po_data);
			...
			$pub_shipment_date_prev=$po_data_arr[21];
			   	...
			   	if($item_id>0)
			   	{
					...
					foreach($country as $country_id)
					{
						...
						if($ship_status_id>0)
						{
							...
							$html.="<tr bgcolor='$bgcolor' onclick=change_color('tr_2nd$k','$bgcolor') id=tr_2nd$k>";
							$html.='<td width="30">'.$display_font_color.$i.$font_end.'</td>
										<td width="130" align="left"><p>'.$display_font_color.$po_number.$font_end.'</p></td>
										<td width="60" align="left"><p>'.$display_font_color.$buyer_short_library[$buyer_name].$font_end.'</p></td>
										...
										<td width="120" align="left" '.$td_colors.'><p>'.$display_font_color.$style_ref_no.$font_end.'</p></td>
										<td width="80" align="left"><p>'.$display_font_color.$team_name_arr[$team_leader].$font_end.'</p></td>
										<td width="90" align="left"><p>'.$display_font_color.$team_member_arr[$dealing_marchant].$font_end.'</p></td>
										<td width="130" align="left"><p>'.$garments_item[$item_id].'</p></td>
										<td width="80" align="left"><p>'.$country_library[$country_id].'</p></td>
	...
	else if ($type==6)//Order Country Shipdate Wise
	{
		...
		$smv_sql=sql_select(" SELECT a.company_name,a.buyer_name,a.set_smv, a.agent_name,a.style_ref_no,a.job_no_prefix_num,a.set_break_down,b.po_number from wo_po_details_master a ,wo_po_break_down b where a.job_no=b.job_no_mst  and  a.status_active=1 and  a.is_deleted=0   $po_tbl_cond2 and  b.is_deleted=0 and (a.company_name!=0 or a.company_name is not null) and (a.buyer_name!=0 or a.buyer_name is not null)  and (b.po_number!=0 or b.po_number is not null)   and (a.job_no_prefix_num!=0 or a.job_no_prefix_num is not null)"); 
		...
		if($db_type==2)
		{
			 $order_sql="SELECT   a.pub_shipment_date_prev,a.id,a.file_no,a.grouping as ref_no, b.job_no_prefix_num, $select_job_year, b.agent_name, a.po_number, b.insert_date, a.job_no_mst,
			...
			where a.job_no_mst=b.job_no and c.po_break_down_id=a.id and a.job_no_mst=c.job_no_mst $po_tbl_cond and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0   and c.is_deleted=0 and LOWER(a.po_number) like LOWER('$search_string') and b.status_active=1 and b.is_deleted=0 $country_ship_date $company_name $buyer_name $garmentsNature $team_name_cond $team_member_cond $ship_status_cond $year_cond $file_no $ref_no $order_status_cond $item_cat_cond  
			group by  a.pub_shipment_date_prev, a.id, a.file_no,a.grouping,b.job_no_prefix_num, b.insert_date, b.agent_name, a.po_number, b.insert_date, a.job_no_mst, b.company_name, b.buyer_name, b.style_ref_no, b.team_leader, b.dealing_marchant, c.country_ship_date order by a.id,c.country_ship_date";
		}
		else
		{
			 $order_sql="SELECT  a.pub_shipment_date_prev,a.id,a.file_no,a.grouping as ref_no, b.job_no_prefix_num, $select_job_year, b.agent_name, a.po_number, b.insert_date, a.job_no_mst,
		...
		{ 
		   $i++;
			...
			$po_country_data_arr[$orderRes[csf("id")]][$orderRes[csf("shipment_date")]][pub_shipment_date_prev]=$orderRes[csf("pub_shipment_date_prev")];
        ...
        <div style="clear:both"></div>
        <table width="3020" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
            <thead>
                <tr>
                    <th width="30">SL</th>    
                    <th width="130">Order Number</th>
        ...
        <div style="max-height:425px; overflow-y:scroll; width:3040px" id="scroll_body">
            <table border="1" class="rpt_table" width="3020" rules="all" id="table_body">
			  <?
              $date=date("Y-m-d");
				...
				foreach($po_country_data_arr as $po_id=>$po_value)
				{
					foreach($po_value as $c_date=>$date_value)
					{
					   ...
					   // $days_remian=datediff("d",$shipment_date,$date)-1; 
						...
						$pub_shipment_date_prev=$date_value[pub_shipment_date_prev]; 
						$td_colors="";
						if($pub_shipment_date_prev && $pub_shipment_date_prev!='0000-00-00') $td_colors='bgcolor="yellow"';
					 ...
					 ?>
					  <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_2nd<? echo $sl; ?>','<? echo $bgcolor; ?>')" id="tr_2nd<? echo $sl; ?>">
                            ...
                            <td width="120" align="center" <? echo $td_colors;?>><p><? echo $date_value[style_name]; ?></p></td>
                            ...
                            <td width="50" onclick="openmypage_image('requires/order_wise_production_report__multi_company_order_wise_controller.php?action=show_image&job_no=<? echo $date_value[full_job]; ?>','Image View')"><img src="../../<? echo $imge_arr[$date_value[full_job]]; ?>" height="25" width="30" /></td>
                            ...
                            ?>
                             ...
                             <td width="100">
                             	<? 
                             		$country_name = "";
                             		$country_id_arr = array_unique(explode(",", $date_value['country_id']));
            ...
            <table border="1" class="tbl_bottom" width="3020" rules="all" id="report_table_footer_1" >
                <tr>
                    <td width="30"></td>
                    <td width="130"></td>
                    <td width="60"></td>
			   	...
			   	if($item_id>0)
			   	{
					...
					foreach($country as $country_id)
					{
						...
						if($ship_status_id>0)
						{
							...
							$html.="<tr bgcolor='$bgcolor' onclick=change_color('tr_2nd$k','$bgcolor') id=tr_2nd$k>";
							$html.='<td width="30">'.$display_font_color.$i.$font_end.'</td>
										<td width="130" align="left"><p>'.$display_font_color.$orderRes[csf("po_number")].$font_end.'</p></td>
										<td width="60" align="left"><p>'.$display_font_color.$buyer_short_library[$orderRes[csf("buyer_name")]].$font_end.'</p></td>
										<td width="50" align="center"><p>'.$display_font_color.$orderRes[csf("job_year")].$font_end.'</p></td>
										<td width="80" align="center"><p>'.$display_font_color.$orderRes[csf("job_no_prefix_num")].$font_end.'</p></td>
        ...
        <legend>Cutting</legend>
            <? 
				...
				foreach( $total_cutting_qty as $cuttingQty)
				{
                 ...
                 echo  create_list_view ( "list_view_1", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ...
            <? 
               ...
               if($db_type==0)
				...
				foreach( $total_printEmbrIssue_arr as $printEmbrIssueQty)
				{
                 ...
                 echo  create_list_view ( "list_view_2", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ?>
        ...
        <legend>Print/Embr Receive</legend>
            <? 
				...
				foreach( $total_printEmbrRec_arr as $printEmbrRecQty)
				{
                 ...
                 echo  create_list_view ( "list_view_3", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ?>
             <table>
             	<tfoot>
                <tr>
        ...
        <legend>Sewing Input</legend>
            <? 
				...
				foreach( $total_sewing_arr as $printSewingQty)
				{
                 ...
                 echo  create_list_view ( "list_view_4", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ?>
             <table>
             	<tfoot>
                <tr>
        ...
        <legend style="width:480px">Sewing Output</legend>
            <? 
				...
				foreach( $total_sewingOut_arr as $printSewingOutQty)
				{
                 ...
                 echo  create_list_view ( "list_view_5", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ?>
             <table>
             	<tfoot>
                <tr>
        ...
        <legend>Finish Input</legend>
            <? 
				...
				foreach( $total_finishIn_arr as $printFinishInQty)
				{
                 ...
                 echo  create_list_view ( "list_view_6", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ?>
             <table>
             	<tfoot>
                <tr>
        ...
        <legend>Finish Output</legend>
            <? 
				...
				foreach( $total_finishOut_arr as $printFinishOutQty)
				{
                  ...
                  echo  create_list_view ( "list_view_7", "Date,Production Qnty,Remarks", "100,120,280","470","220",1, $sql, "", "","", 1, '0,0,0', $arr, "production_date,production_quantity,remarks", "../requires/order_wise_production_report__multi_company_order_wise_controller", '','3,1,0');
            ?>
             <table>
             	<tfoot>
                <tr>
...
<div style="width:700px" align="center" id="details_reports"> 
    ...
    <?
	  ...
	  $color_library=sql_select("SELECT distinct(color_number_id) from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and color_mst_id!=0  and country_ship_date='$country_id' and item_number_id in ($item_id)");
	  $size_library=sql_select("SELECT distinct(size_number_id) from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and size_mst_id!=0  and country_ship_date='$country_id' and item_number_id in ($item_id)");
...
/*		  echo "select avg(excess_cut_perc) as avg_excess_cut_perc,". $sqlPart ." from wo_po_color_size_breakdown where status_active=1 and po_break_down_id in ($po_break_down_id) and item_number_id in($item_id) and country_ship_date='$country_id'";die;*/
				$sql = sql_select("select avg(excess_cut_perc) as avg_excess_cut_perc,". $sqlPart ." from wo_po_color_size_breakdown where   po_break_down_id in ($po_break_down_id)  and item_number_id in($item_id) and country_ship_date='$country_id'");
				//echo $sql;die;
...
{
	echo load_html_head_contents("Multi Company Order wise Production Report", "../../../", 1, 1,$unicode,'','');
	$po_break_down_id=$_REQUEST['po_break_down_id'];
	$item_id=$_REQUEST['item_id'];
...
<div style="width:700px" align="center" id="details_reports"> 
       	...
       	<?
			...
			if($db_type==0)
			{
 				$sql = "SELECT a.job_no_mst,group_concat(distinct(a.po_number)) as po_number,a.pub_shipment_date, sum(a.po_quantity) as po_quantity,a.packing,b.set_break_down, b.company_name, b.order_uom, b.buyer_name, b.style_ref_no,c.set_item_ratio 
					...
					where a.job_no_mst=b.job_no and b.job_no=c.job_no and a.id in ($po_break_down_id) and c.gmts_item_id=$item_id $po_tbl_cond  and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0";
			}
			else
			{
				$sql = "SELECT a.job_no_mst, LISTAGG(a.po_number, ',') WITHIN GROUP (ORDER BY a.id) as po_number,max(a.pub_shipment_date) as pub_shipment_date, sum(a.po_quantity) as po_quantity,a.packing,b.set_break_down, b.company_name, b.order_uom, b.buyer_name, b.style_ref_no,c.set_item_ratio 
					from wo_po_break_down a, wo_po_details_master b, wo_po_details_mas_set_details c 
					where a.job_no_mst=b.job_no and b.job_no=c.job_no and a.id in ($po_break_down_id) and c.gmts_item_id=$item_id $po_tbl_cond and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 group by a.job_no_mst, a.packing,b.set_break_down, b.company_name, b.order_uom, b.buyer_name, b.style_ref_no,c.set_item_ratio";
			}
			//echo $sql;die;
    ...
    <?
	  ...
	  $color_library=sql_select("SELECT distinct(color_number_id) as color_number_id from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and color_mst_id!=0 ");
	  $size_library=sql_select("SELECT distinct(size_number_id) as size_number_id from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and size_number_id!=0 ");
	  $count = count($size_library);	
	  $width= $count*70+350; 		
	?>
    <table id="tblDtls_id" class="rpt_table" width="<? echo $width; ?>" border="1" rules="all" >
		  ...
		  foreach($color_library as $colorRes)
		  {
			...
			<tr>
 			...
 			<?
				...
				$sql = sql_select("select avg(excess_cut_perc) as avg_excess_cut_perc,max(excess_cut_perc) as excess_cut_perc,". $sqlPart ." from wo_po_color_size_breakdown where   po_break_down_id in ($po_break_down_id) and item_number_id=$item_id ");
				//echo $sql;die;
				foreach($sql as $resRow); 
 					$bgcolor1="#E9F3FF"; 
					$bgcolor2="#FFFFFF";
...
<div style="width:700px" align="center" id="details_reports"> 
    ...
    <?
	  ...
	  $colorSizeData=sql_select("SELECT color_number_id, size_number_id, order_quantity, plan_cut_qnty, excess_cut_perc from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and item_number_id=$item_id and status_active=1 and is_deleted=0 order by size_order");
...
<div style="width:700px" align="center" id="details_reports"> 
    ...
    <table id="tbl_id" class="rpt_table" width="680" border="1" rules="all" >
    	<thead>
       	...
       	<?
			...
			$po_qnty=return_field_value("sum(order_quantity) as qnty","wo_po_color_size_breakdown","po_break_down_id in ($po_break_down_id) and item_number_id='$item_id' and country_id='$country_id'  and is_deleted=0","qnty");	
 		?> 
        <tr>
        	<td><? echo $buyer_short_library[$resultRow[csf("buyer_name")]]; ?></td>
            <td><p><? echo $resultRow[csf("job_no_mst")]; ?></p></td>
    ...
    <?
	  ...
	  $color_library=sql_select("select distinct(color_number_id) from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and color_mst_id!=0  ");
	  $size_library=sql_select("select distinct(size_number_id) from wo_po_color_size_breakdown where po_break_down_id in ($po_break_down_id) and size_mst_id!=0 ");
	  $count = count($size_library);	
	  $width= $count*70+350; 		
	?>
    <table id="tblDtls_id" class="rpt_table" width="<? echo $width; ?>" border="1" rules="all" >
		  ...
		  foreach($color_library as $colorRes)
		  {
			...
			<tr>
 			...
 			<?
				...
				$sql = sql_select("select avg(excess_cut_perc) as avg_excess_cut_perc,excess_cut_perc,". $sqlPart ." from wo_po_color_size_breakdown where   po_break_down_id in ($po_break_down_id) and item_number_id=$item_id and country_id='$country_id' ");
				//echo $sql;die;
				foreach($sql as $resRow); 
 					$bgcolor1="#E9F3FF"; 
					$bgcolor2="#FFFFFF";
            ...
            <label><h3>Balance</h3></label>
 			...
 			<?
 				$sql_order = sql_select("SELECT 
					...
					WHERE
						a.id in ($po_break_down_id) and a.job_no_mst=b.job_no $po_tbl_cond");
...
if ($action==1 || $action==5) 
{
    ...
    <script>
		...
		function openmypage(po_break_down_id,item_id,prod_type,location_id,floor_id,dateOrLocWise,country_id,prod_date,action,sewing_line)
		{
			var popupWidth = "width=550px,height=320px,";	
			emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'order_wise_production_report__multi_company_order_wise_controller.php?po_break_down_id='+po_break_down_id+'&item_id='+item_id+'&action='+action+'&location_id='+location_id+'&floor_id='+floor_id+'&dateOrLocWise='+dateOrLocWise+'&country_id='+country_id+'&prod_date='+prod_date+'&prod_type='+prod_type+'&sewing_line='+sewing_line, 'Production Quantity', popupWidth+'center=1,resize=0,scrolling=0','../../');
		}
	</script>
    ...
    <div style="" align="center" id="details_reports"> 
         ...
         <table id="tbl_id" class="rpt_table" width="" border="1" rules="all" >
            ...
            <?
                ...
                if($db_type==0)
                {
                    $sql = "SELECT a.job_no_mst,group_concat(distinct(a.po_number)) as po_number,a.pub_shipment_date, sum(a.po_quantity) as po_quantity,a.packing,b.set_break_down, b.company_name, b.order_uom, b.buyer_name, b.style_ref_no,c.set_item_ratio,a.grouping 
                        from wo_po_break_down a, wo_po_details_master b, wo_po_details_mas_set_details c 
                        where a.job_no_mst=b.job_no and b.job_no=c.job_no and a.id in ($po_break_down_id) and c.gmts_item_id=$item_id $po_tbl_cond and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0";
                }
                else
                {
                    $sql = "SELECT a.job_no_mst, LISTAGG(a.po_number, ',') WITHIN GROUP (ORDER BY a.id) as po_number,max(a.pub_shipment_date) as pub_shipment_date, sum(a.po_quantity) as po_quantity,a.packing,b.set_break_down, b.company_name, b.order_uom, b.buyer_name, b.style_ref_no,c.set_item_ratio ,a.grouping
                        from wo_po_break_down a, wo_po_details_master b, wo_po_details_mas_set_details c 
                        where a.job_no_mst=b.job_no and b.job_no=c.job_no and a.id in ($po_break_down_id) and c.gmts_item_id=$item_id $po_tbl_cond and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 group by a.job_no_mst, a.packing,b.set_break_down, b.company_name, b.order_uom, b.buyer_name, b.style_ref_no,c.set_item_ratio,a.grouping";
                }
                //echo $sql;die;
                $resultRow=sql_select($sql);
    	...
    	<br/>
        <table width="800" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
            <thead>
                 <? if($action==1){ ?>
        ...
        <div style="max-height:300px; overflow-y:scroll; width:800px;" id="scroll_body">
            <table cellspacing="0" border="1" class="rpt_table" width="780" rules="all" id="table_body" >
            <?
             $total_in_quantity=0;$total_out_quantity=0;
             $i=1;
 			 $company_library=return_library_array( "select id,company_name from lib_company", "id", "company_name"  );
			 ...
			 if($action==5)
			 {  
				$sql_prod=sql_select("SELECT a.prod_reso_allo,a.floor_id, a.sewing_line,a.po_break_down_id, a.production_date, a.production_source, a.serving_company, a.location,c.color_number_id,
					  ...
					  from pro_garments_production_mst a ,pro_garments_production_dtls b,wo_po_color_size_breakdown c where a.id=b.mst_id and a.po_break_down_id=c.po_break_down_id and c.id=b.color_size_break_down_id and a.po_break_down_id in ($po_break_down_id) and a.item_number_id=$item_id and a.production_type=$action and b.production_type=$action and a.status_active=1 and b.status_active=1 and c.status_active in(1,2,3) and c.is_deleted=0 $location $floor $country_cond group by a.prod_reso_allo,a.floor_id, a.sewing_line,a.po_break_down_id,a.serving_company,a.location,a.production_date,a.production_source,c.color_number_id  order by a.production_date");
			 ...
			 {
				 $sql_prod=sql_select("SELECT a.po_break_down_id, a.production_date, a.production_source, a.serving_company, a.location,
					  ...
					  from pro_garments_production_mst a ,pro_garments_production_dtls b where a.id=b.mst_id and a.po_break_down_id in ($po_break_down_id) and a.item_number_id=$item_id and a.production_type=$action and b.production_type=$action and a.status_active=1 and b.status_active=1 $location $floor $country_cond group by a.po_break_down_id,a.serving_company,a.location,a.production_date,a.production_source  order by a.production_date");
			 }
            ...
            foreach($sql_prod as $row)
            {
                 ...
                 <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>" style="font-size:12px">
                    ...
                    <td width="80" align="center"><a href="##" onclick="openmypage('<? echo $po_break_down_id ?>','<? echo $item_id ?>','<? echo $action ?>','<? echo $location_id ?>','<? echo $floor_id ?>','<? echo $dateOrLocWise ?>','<? echo $country_id ?>','<? echo $row[csf("production_date")]; ?>','challanPopup','<? echo $row[csf('sewing_line')] ?>')"><? echo change_date_format($row[csf("production_date")]); ?></a></td>
                    <td width="80" align="center"><? echo $floor_arr[$row[csf("floor_id")]]; ?></td>
                    <td width="80" align="center"><? echo $sewing_line; ?></td>
                    <td width="80" align="center"><? echo $colorArr[$row[csf("color_number_id")]]; ?></td>
            ...
            <table cellspacing="0" cellpadding="0" border="1" class="rpt_table" width="780" rules="all">
            <?
			if($action==5)
			{
			?>
    ...
    <div style="margin-left:60px" id="details_reports">
                ...
                <thead>
                    ...
                    <? } else if($action==8){ ?>
                        ...
                        <tr style="font-size:12px">
                            ...
                            <th width="100" rowspan="2">Unit Name</th>
        ...
        <div style="max-height:425px; overflow-y:scroll; width:720px;" id="scroll_body">
            ...
            <?
			 ...
			 {
			 	$sql=sql_select("SELECT a.po_break_down_id,a.production_date,a.prod_reso_allo,a.sewing_line,a.production_source,a.serving_company,a.location,a.floor_id, c.color_number_id,
			 		...
			 		where  a.id=b.mst_id and a.po_break_down_id=c.po_break_down_id and b.color_size_break_down_id=c.id and a.po_break_down_id in ($po_break_down_id) and a.item_number_id=$item_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active in(1,2,3) and c.is_deleted=0 and a.production_type=$action   $location1  $floor1  $country_cond1 group by a.po_break_down_id,a.production_date,a.prod_reso_allo,a.sewing_line,a.production_source,a.serving_company,a.location,a.floor_id, c.color_number_id order by production_date");
				/* 
			 ...
			 {
				 $sql=sql_select("SELECT po_break_down_id,production_date,prod_reso_allo,production_source,serving_company,location,floor_id,
				 sum(case when production_source=1 then production_quantity else 0 end) as in_quantity,
				 sum(case when production_source=3 then production_quantity else 0 end) as out_quantity
				 from pro_garments_production_mst 
				 where po_break_down_id in ($po_break_down_id) and item_number_id=$item_id and status_active=1 and is_deleted=0 and production_type=$action $location $floor $country_cond group by po_break_down_id,production_date,prod_reso_allo,production_source,serving_company,location,floor_id order by production_date");
            ...
            foreach($sql as $resultRow)
            {
				...
				if ($action==4)
				{
					...
					if($resultRow[csf('prod_reso_allo')]==1)
					{
                     ...
                     <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>" style="font-size:12px">
                        ...
                        <td width="70" align="center"><? echo $color_Arr_library[$resultRow[csf("color_number_id")]] ?></td>
				...
				else if ($action==7 || $action==8)
				{
                     ...
                     <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>" style="font-size:12px">
                        ...
                        <td width="100" align="center"><? echo $floor_library[$resultRow[csf("floor_id")]]; ?></td>
...
if ($action=="reject_qty")
{
	...
	{
		$sql_cutting=sql_select("SELECT a.po_break_down_id, sum(b.reject_qty)  AS cutting_rej_qnty
					from pro_garments_production_mst a, pro_garments_production_dtls b
					where a.id=b.mst_id and a.production_type=b.production_type and a.production_type =1 and a.po_break_down_id in ($po_id) and a.item_number_id='$item_id' and a.status_active=1 
					and a.is_deleted=0 $location_cond  $floor_cond $country_cond group by po_break_down_id");
	}
	else
	{		
		$sql_cutting=sql_select("SELECT a.po_break_down_id, sum(b.reject_qty)  AS cutting_rej_qnty,c.color_number_id, c.size_number_id
					from pro_garments_production_mst a, pro_garments_production_dtls b, wo_po_color_size_breakdown c
					where a.id=b.mst_id and  a.production_type=b.production_type and b.color_size_break_down_id=c.id and a.production_type=1 and a.po_break_down_id in ($po_id) and a.item_number_id='$item_id' and a.status_active=1 and a.is_deleted=0 $location_cond   
		$floor_cond 
	...
	{
		$sql_printing=sql_select("SELECT a.po_break_down_id, sum(b.reject_qty)  AS printing_rej_qnty
					from pro_garments_production_mst a, pro_garments_production_dtls b
					where a.id=b.mst_id and  a.production_type=b.production_type and a.production_type =3 and a.po_break_down_id in ($po_id) and a.item_number_id='$item_id' and a.status_active=1 and a.is_deleted=0 $location_cond   
		$floor_cond 
	...
	if($iron_variable==1)
	{
		$sql_iron=sql_select("SELECT a.po_break_down_id, sum(b.reject_qty)  AS iron_rej_qnty
					from pro_garments_production_mst a, pro_garments_production_dtls b
					where a.id=b.mst_id and  a.production_type=b.production_type and a.production_type =7 and a.po_break_down_id in ($po_id) and a.item_number_id='$item_id' and a.status_active=1 and a.is_deleted=0 $location_cond   
		$floor_cond 
		$country_cond  group by po_break_down_id");
	}
	else
	...
	{
		$sql_finishing=sql_select("SELECT a.po_break_down_id, sum(b.reject_qty)  AS finish_rej_qnty
					from pro_garments_production_mst a, pro_garments_production_dtls b
					where a.id=b.mst_id and  a.production_type=b.production_type and a.production_type =8 and a.po_break_down_id in ($po_id) and a.item_number_id='$item_id' and a.status_active=1 and a.is_deleted=0 $location_cond   
		$floor_cond 
		$country_cond  group by po_break_down_id");
	}
	else
            ...
            <div style="max-height:260px; overflow-y:scroll; width:520px;" id="scroll_body">
                ...
                <?
					$floorArr=return_library_array( "select id,floor_name from lib_prod_floor", "id", "floor_name"); 
					 ...
					 $sql=sql_select("select a.production_date, a.challan_no, a.floor_id, SUM(b.production_qnty) as production_quantity from pro_garments_production_mst a,pro_garments_production_dtls b where a.id=b.mst_id and  a.po_break_down_id in ($po_break_down_id) and a.item_number_id=$item_id and a.production_type=$prod_type and a.sewing_line=$sewing_line and a.status_active=1 and a.production_date='$prod_date' $location $floor $country_cond group by a.production_date, a.challan_no, a.floor_id");
					foreach($sql as $resultRow)
					{
						if ($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
                    ?>
...
?>
	...
	<fieldset style="width:1010px"> 
        ...
        <table style="margin-top:10px" width="1000" border="1" rules="all" class="rpt_table">
            <?php
			$sql ="SELECT b.company_name,b.buyer_name,a.po_number,b.job_no,b.style_ref_no,b.gmts_item_id,a.po_received_date,a.shipment_date from wo_po_break_down a,wo_po_details_master b where a.id=$po_id and a.job_no_mst=b.job_no $po_tbl_cond ";
