...
//	if ($txt_file_no=="") $file_cond=""; else $file_cond="  and b.file_no=$txt_file_no";
	...
	if($cbo_search_date==1)
	{
		...
		{
			$sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond $type_cond $po_cond_for_in group by a.batch_no,a.floor_id,a.batch_against,a.entry_form,a.id,a.batch_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id)";
		}
		else if ($batch_type==2) // Subcon
		{
			$sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.gsm,b.item_description,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $batch_no_cond $date_cond $booking_no_cond $sub_conCompany_cond $type_cond $sub_po_cond_for_in ) order by a.id";
		...
		else if ($batch_type==3) // Sample
		{
			...
			from pro_batch_create_dtls b, pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.entry_form=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond $po_cond_for_in
			group by a.batch_no,a.batch_against,a.floor_id,a.entry_form,a.id,a.batch_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id
			union
			SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a 
		...
		else if ($batch_type==4) // Sales
		{
			  ...
			  $sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,c.within_group,c.sales_booking_no,c.buyer_id,c.po_buyer,c.po_job_no, a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a ,fabric_sales_order_mst c
			where a.id=b.mst_id and c.id=a.sales_order_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.is_sales=1 and a.entry_form=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond   group by a.batch_no,a.batch_against,a.entry_form,a.floor_id,a.id,a.batch_date,a.batch_weight,a.color_id,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,c.within_group,c.sales_booking_no,c.buyer_id,c.po_buyer,c.po_job_no,a.total_trims_weight,a.color_range_id)";
		}
		else // All
		{
			// Self
			$self_sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.is_sales=0 and a.entry_form=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond  $po_cond_for_in group by a.batch_no,a.batch_against,a.entry_form,a.floor_id,a.id,a.batch_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id)";
			...
			// Subcon
			 $subc_sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.gsm,b.item_description,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.entry_form=36 $batch_no_cond $date_cond $booking_no_cond $sub_conCompany_cond  $sub_po_cond_for_in ) order by a.id";
			...
			// Sample
			 $samp_sql_data="SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.entry_form=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond $po_cond_for_in
			group by a.batch_no,a.batch_against,a.floor_id,a.entry_form,a.id,a.batch_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id 
			union
			...
			//echo $samp_sql_data.'<br>';
			 ...
			 $sales_sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,c.within_group,c.sales_booking_no,c.buyer_id,c.po_buyer,c.po_job_no, a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a ,fabric_sales_order_mst c
			where a.id=b.mst_id and c.id=a.sales_order_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.is_sales=1 and a.entry_form=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond group by a.batch_no,a.batch_against,a.entry_form,a.floor_id,a.id,a.batch_date,a.batch_weight,a.color_id,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,c.within_group,c.sales_booking_no,c.buyer_id,c.po_buyer,c.po_job_no,a.total_trims_weight,a.color_range_id)";
		}	
		//echo $sql_data;
	...
	else if($cbo_search_date==2)
	{
		if ($batch_type==1) // Self
		{
			$sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c 
			where  a.id=b.mst_id  and c.batch_id=a.id and c.batch_id=b.mst_id and c.entry_form=35 and a.batch_against !=3 and a.is_sales=0 and c.load_unload_id=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0  $batch_no_cond  $date_cond $booking_no_cond $workingCompany_cond $type_cond $po_cond_for_in group by a.batch_no,a.floor_id,a.batch_against,a.entry_form,a.id,c.process_end_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type, a.total_trims_weight,a.color_range_id)";
			/*$p=1;
		...
		{
			$sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.sales_order_no,a.sales_order_id,d.within_group,d.sales_booking_no,d.buyer_id,d.po_buyer,d.po_job_no, a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c,fabric_sales_order_mst d 
			where  a.id=b.mst_id  and c.batch_id=a.id and c.batch_id=b.mst_id and d.id=a.sales_order_id  and c.entry_form=35 and a.batch_against !=3 and a.is_sales=1 and c.load_unload_id=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0  $batch_no_cond  $date_cond $booking_no_cond $workingCompany_cond $type_cond group by a.batch_no,a.floor_id,a.batch_against,a.entry_form,a.id,c.process_end_date,a.batch_weight,a.color_id,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,d.sales_booking_no,d.buyer_id,d.po_buyer,d.within_group,d.po_job_no, a.total_trims_weight,a.color_range_id)";
		
		}

		else if ($batch_type==2) // Subcon
		{
			$sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.gsm,b.item_description,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c 
			where  a.id=b.mst_id  and c.batch_id=a.id  and c.batch_id=b.mst_id and c.entry_form=38 and a.batch_against !=3 and c.load_unload_id=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 $batch_no_cond $date_cond $booking_no_cond $sub_conCompany_cond $type_cond $sub_po_cond_for_in ) order by a.id";
			/*$p=1;
			foreach($po_id_cond_split as $po_row)
			{
			if($p==1) $sql_data .=" and (b.po_id  in(".implode(',',$po_row).")"; else  $sql_data .=" OR b.po_id in(".implode(',',$po_row).")";
		...
		{
			$sql_data="SELECT a.id,a.batch_no,a.entry_form,a.floor_id,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c
			...
			group by a.batch_no,a.floor_id,a.batch_against,a.entry_form,a.id,c.process_end_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id";
		}

		else // All
		{
			// Self
			 $self_sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c 
			where  a.id=b.mst_id  and c.batch_id=a.id  and c.batch_id=b.mst_id and c.entry_form=35 and a.batch_against !=3 and c.load_unload_id=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0  $batch_no_cond  $date_cond $booking_no_cond $workingCompany_cond $type_cond $po_cond_for_in  group by a.batch_no,a.batch_against,a.entry_form,a.id,a.floor_id,c.process_end_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id)";
			/*$p=1;
			foreach($self_po_id_cond_split as $po_row)
			{
			if($p==1) $self_sql_data .=" and (b.po_id  in(".implode(',',$po_row).")"; else  $self_sql_data .=" OR b.po_id in(".implode(',',$po_row).")";
			...
			// Subcon
			$subc_sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.gsm,b.width_dia_type,b.item_description,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c 
			...
			// Sample
			  $samp_sql_data="SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c
			where a.id=b.mst_id  and c.batch_id=a.id and c.batch_id=b.mst_id and a.batch_against=3 and c.entry_form=35 and c.load_unload_id=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.entry_form=0 $batch_no_cond $date_cond $booking_no_cond $workingCompany_cond $po_cond_for_in
			group by a.batch_no,a.batch_against,a.floor_id,a.entry_form,a.id,c.process_end_date,a.batch_weight,a.color_id,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id 
			union
			SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c
			...
			$sales_sql_data="(SELECT a.id,a.batch_no,a.floor_id,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, c.process_end_date as batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.booking_no,a.extention_no,a.sales_order_no,a.sales_order_id,d.within_group,d.sales_booking_no,d.buyer_id,d.po_buyer,d.po_job_no, a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a,pro_fab_subprocess c,fabric_sales_order_mst d 
			where  a.id=b.mst_id  and c.batch_id=a.id and c.batch_id=b.mst_id and d.id=a.sales_order_id  and c.entry_form=35 and a.batch_against !=3 and a.is_sales=1 and c.load_unload_id=2 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0 $batch_no_cond  $date_cond $booking_no_cond $workingCompany_cond $type_cond group by a.batch_no,a.floor_id,a.batch_against,a.entry_form,a.id,c.process_end_date,a.batch_weight,a.color_id,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,d.sales_booking_no,d.buyer_id,d.po_buyer,d.within_group,d.po_job_no,a.total_trims_weight,a.color_range_id)";
		}
		//echo $sql_data;
...
{
	?>
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2980" class="rpt_table" id="table_header_1">
	...
	<div style="width:2980px; overflow-y:scroll; max-height:450px;" id="scroll_body">
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2960" class="rpt_table" id="table_body">
 ...
 <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trself_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="trself_<? echo $i; ?>"> 
	...
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2960" class="rpt_table" id="report_table_footer">
	 <tfoot>
	    <th width="30"></th>
	    <th width="80"></th>
	    <th width="80"></th>
...
{
	?>
    <table cellspacing="0" cellpadding="0" border="1" rules="all" width="2920" class="rpt_table" id="table_header_1">
	 ...
	 <div style="width:2940px; overflow-y:scroll; max-height:450px;" id="scroll_body">
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2920" class="rpt_table" id="table_body2">
 ...
 <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trsubcon_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="trsubcon_<? echo $i; ?>"> 
	...
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2920" class="rpt_table" id="report_table_footer">
	 <tfoot>
	    <th width="40"></th>
	    <th width="80"></th>
	    <th width="80"></th>
        ...
        <th width="70"></th>
	    <th width="80" id="total_trims_weight_gt2"><? echo number_format($total_trims_weight_gt,2,'.',''); ?></th>
        <th width="80" id="total_batch_qty2"><? echo number_format($total_batch_qty,2,'.',''); ?></th>
	    <th width="70" ></th>
        <th width="100"></th>
         <th width="80"></th>
	    <th width="70"  id="total_load_qty"><? echo number_format($total_load_deying_qty,2,'.',''); ?></th>
	    <th width="80"  id="total_unload_qty"><? echo number_format($total_unload_deying_qty,2,'.',''); ?></th>
	    <th width="60"></th>
	    <th width="80"  id="total_sliting_qty"><? echo number_format($total_slitting_qty,2,'.',''); ?></th>
	    <th width="80" id="total_stenter_qty"><? echo number_format($total_stentering_qty,2,'.',''); ?></th>
	    ...
	    <th width="60" id="total_process_loss_qty"><? echo number_format($total_process_loss_qty,2); ?></th>
	    <th width="100"></th>
	   <th width="80" id="total_delivery_qty2"><? echo number_format($total_delivery_qty,2); ?></th>
...
{
	?>
    <table cellspacing="0" cellpadding="0" border="1" rules="all" width="2940" class="rpt_table" id="table_header_1">
	...
	<div style="width:2940px; overflow-y:scroll; max-height:450px;" id="scroll_body">
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2920" class="rpt_table" id="table_body3">
	<?	
    $i=1;
	$roll_arr=array();
    ...
    //$desc=implode(',',explode(",",$fabric_desc_arr));
	$po_ids=rtrim($row[('po_id')],',');
    $po_number=''; $job_no="";  $file="";$buyer=""; $refNo="";
    $po_id=array_unique(explode(",",$po_ids));
    foreach($po_id as $id)
    {
		if($row[('entry_form')]==36) //SubCon
...
if($batch_type==0 || $batch_type==4 ) //Sales
{
	?>
    <table cellspacing="0" cellpadding="0" border="1" rules="all" width="2960" class="rpt_table" id="table_header_1">
	 ...
	 <div style="width:2940px; overflow-y:scroll; max-height:450px;" id="scroll_body">
	<table cellspacing="0" cellpadding="0" border="1" rules="all" width="2920" class="rpt_table" id="table_body4">
