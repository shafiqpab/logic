...
if($action=="report_generate2")
{
	...
	if ($order_type==0 || $order_type==1) // Self Order sql and array
	{
		...
		from pro_fab_subprocess a, pro_fab_subprocess_dtls b, lib_machine_name c
		where a.service_company=$cbo_company_id $location_id $batch_cond $floor_id_cond $machine_cond
		and a.id=b.mst_id and a.machine_id=c.id and a.entry_form in(35,424) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0  order by a.batch_id";
		...
		and a.batch_id=q.id and q.booking_no_id=p.id and q.booking_without_order!=1
		and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 order by a.system_no";*/
		 $self_sql_result="(SELECT a.id, a.batch_no, a.batch_id,a.system_no,a.entry_form, a.batch_ext_no, a.machine_id, a.load_unload_id, a.end_hours, a.end_minutes, a.result, a.remarks,a.process_end_date, a.production_date,
		a.water_flow_meter,a.incomplete_result,a.redyeing_needed,a.shade_matched, b.batch_qty,b.production_qty, b.const_composition, c.machine_no, c.prod_capacity,
		p.buyer_id, q.color_id, q.booking_no, q.color_range_id, q.total_trims_weight,q.double_dyeing, q.process_id
		from wo_booking_mst p, pro_batch_create_mst q, pro_fab_subprocess a, pro_fab_subprocess_dtls b, lib_machine_name c
		where a.service_company=$cbo_company_id $booking_no_cond $location_id $batch_cond $floor_id_cond $machine_cond $sql_cond $buyer_name_cond $batch_color_cond $color_range_cond
		and a.id=b.mst_id and a.machine_id=c.id and a.entry_form=35 and q.entry_form=0 and a.load_unload_id=2
		...
		and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0
		union
		SELECT a.id, a.batch_no, a.batch_id,a.system_no,a.entry_form, a.batch_ext_no, a.machine_id, a.load_unload_id, a.end_hours, a.end_minutes, a.result, a.remarks,a.process_end_date, a.production_date,
		a.water_flow_meter,a.incomplete_result,a.redyeing_needed,a.shade_matched, b.batch_qty,b.production_qty, b.const_composition, c.machine_no, c.prod_capacity,
		p.buyer_id, q.color_id, q.booking_no, q.color_range_id, q.total_trims_weight,q.double_dyeing, q.process_id
		from wo_booking_mst p, pro_batch_create_mst q, pro_fab_subprocess a, pro_fab_subprocess_dtls b, lib_machine_name c
 ...
 /* echo $sql_prod2="select aa.batch_no,aa.result,max(aa.batch_ext_no) as batch_ext_no,b.batch_id,sum(b.receive_qnty) as receive_qnty,b.machine_no_id from inv_receive_master a,pro_finish_fabric_rcv_dtls b,pro_fab_subprocess aa where a.id=b.mst_id and aa.batch_id=b.batch_id and b.receive_qnty>0 and aa.load_unload_id=2 and a.status_active=1 and a.is_deleted=0 and a.entry_form=7 $batch_no_cond_for_in group by aa.batch_no,aa.result,b.batch_id,b.machine_no_id";//batch_no
			...
			foreach ($prod_date_data as $machine_id => $machine_data)
			{
				foreach ($machine_data as $batch_id => $row)
				{
					...
					if($entry_form_wash==424)
					{
						...
						$tot_self_summ_normal_wash+=$normal_wash_qty;
						$tot_self_summ_aop_wash+=$aop_wash_qty;
	...
	if ($order_type==0 || $order_type==2) // Subcontract Order sql and array
	{
	  ...
	  $sub_sql_wash=" SELECT a.batch_id, a.batch_ext_no,a.process_id, a.machine_id,a.end_hours,a.entry_form, a.end_minutes, a.process_end_date as prod_date, a.remarks,b.production_qty
		...
		// Main query
		$subcon_sql_result="(SELECT a.id, a.batch_no, a.system_no, a.batch_id, a.batch_ext_no, a.machine_id, a.load_unload_id, a.end_hours, a.end_minutes, a.result, a.remarks,a.process_end_date, a.production_date,a.incomplete_result,a.redyeing_needed, a.water_flow_meter, b.batch_qnty, b.item_description, c.machine_no, c.prod_capacity, f.party_id, p.order_no, q.color_id, q.color_range_id,q.double_dyeing, q.total_trims_weight, q.process_id
		from subcon_ord_dtls p, subcon_ord_mst f, pro_batch_create_mst q, pro_fab_subprocess a, pro_batch_create_dtls b, lib_machine_name c
		...
		union 
		SELECT a.id, a.batch_no, a.system_no, a.batch_id, a.batch_ext_no, a.machine_id, a.load_unload_id, a.end_hours, a.end_minutes, a.result, a.remarks,a.process_end_date, a.production_date,a.incomplete_result,a.redyeing_needed, a.water_flow_meter, b.batch_qnty, b.item_description, c.machine_no, c.prod_capacity, f.party_id, p.order_no, q.color_id, q.color_range_id,q.double_dyeing, q.total_trims_weight, q.process_id
		from subcon_ord_dtls p, subcon_ord_mst f, pro_batch_create_mst q, pro_fab_subprocess a, pro_batch_create_dtls b, lib_machine_name c
...
*/
	...
	if ($order_type==0 || $order_type==3) // Sample Without Order  sql and array
	{
		...
		union
		SELECT a.id, a.batch_no, a.batch_id, a.batch_ext_no, a.machine_id, a.load_unload_id, a.end_hours, a.production_date, a.end_minutes, a.result, a.remarks,a.process_end_date, a.water_flow_meter, a.system_no,a.incomplete_result,a.redyeing_needed,a.shade_matched, b.batch_qty, b.const_composition, c.machine_no, c.prod_capacity,
		p.buyer_id, q.color_id,q.double_dyeing, q.booking_no, q.color_range_id, q.total_trims_weight, q.process_id
		from wo_non_ord_samp_booking_mst p, pro_batch_create_mst q, pro_fab_subprocess a, pro_fab_subprocess_dtls b, lib_machine_name c
		where a.service_company=$cbo_company_id $booking_no_cond $location_id $batch_cond $floor_id_cond $machine_cond $sql_cond $buyer_name_cond $batch_color_cond $color_range_cond
			...
			<div style="width:2588px; overflow-y:scroll; max-height:300px;" id="scroll_body">
				<table cellspacing="0" width="2570"  border="1" rules="all" class="rpt_table" >
					...
					<tr id="<? echo 'v_'.$i; ?>" onClick="change_color('v_<? echo $i; ?>','#FFFFFF')" bgcolor="<? echo $bgcolor; ?>">
						...
						if(($bext*1)<=0) $bext='';
							 ...
							 if($entry_form_wash==424)
							{
								 $normal_wash_qty=$wash_qty_array[$p_date][$machine_id][$batch_id][$row['batch_ext_no']]["prod_qty_normal"];
								$aop_wash_qty=$wash_qty_array[$p_date][$machine_id][$batch_id][$row['batch_ext_no']]["prod_qty_aop"];
								//$white_batch_qty=$wash_batch_qty=$avarage_batch_qty=0;
								
							}
								//echo $entry_form_wash.'X='.$aop_wash_qty.',';
						...
						//if (($row['result']==1 || $row['result']==2) && $row['batch_ext_no']>0 && $re_process_qty3>0 ) //Shade match/Redyeing Needed/Re Process /Fin Prod Available
							...
							<td width="60" valign="middle" align="right"><? echo $white_batch_qty; $white_mcw_wise_total+=$white_batch_qty;?></td>
							<td width="60" valign="middle" align="right"><? echo $wash_batch_qty; $wash_mcw_wise_total+=$wash_batch_qty;?></td>
							<td width="60" valign="middle" align="right"><? echo $normal_wash_qty; $normal_wash_mcw_wise_total+=$normal_wash_qty;?></td>
							<td width="60" valign="middle" align="right" title="<? echo $machine_id.'='.$batch_id;?>"><? echo $aop_wash_qty; $aop_wash_mcw_wise_total+=$aop_wash_qty;?></td>
							<td width="60" valign="middle" align="right"><? echo $re_pro_qty; $total_pro_qty+=$re_pro_qty;?></td>
							<td width="60" valign="middle" align="right"><? echo $trims_weight; $total_trims_weight+=$trims_weight;?></td>
							<td width="70" valign="middle" align="right"><? echo $total_self_production=$row['batch_qty']+$row['total_trims_weight'];//($avarage_batch_qty+$white_batch_qty+$wash_batch_qty+$re_pro_qty+$trims_weight);
							$total_self_production_qty+=$total_self_production; ?></td>
					...
					<tr class="tbl_bottom">
						...
						<td><strong><? echo $white_mcw_wise_total;?></strong></td>
						<td><strong><? echo $wash_mcw_wise_total;?></strong></td>
						<td><strong><? echo $normal_wash_mcw_wise_total;?></strong></td>
						<td><strong><? echo $aop_wash_mcw_wise_total;?></strong></td>
								<td><strong><? echo $total_pro_qty;?></strong></td>
									<td><strong><? echo $total_trims_weight;?></strong></td>
										<td><strong><? echo $total_self_production_qty;?></strong></td>
											<td><strong><? echo $total_actual_prod_qty;?></strong></td>
										...
										<tfoot>
											<tr class="tbl_bottom">
												...
												<td width="60"><strong><? echo $white_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $wash_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $normal_wash_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $aop_wash_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $pro_qty_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $trims_weight_grnd_total;?></strong></td>
												<td width="70"><strong><? echo $self_production_grnd_total;?></strong></td>
												<td width="70"><strong><? echo $self_actual_production_grnd_total;?></strong></td>
				...
				<table align="center" cellspacing="0" width="2470"  border="1" rules="all" class="rpt_table" >
					...
					foreach ($subcon_date_data_arr as $p_date=>$prod_date_data)
					{
						...
						//echo $sub_re_process_qty3.'DDD'.$row['batch_ext_no'].'<br>';
							...
							<td width="60" valign="middle" align="right" title="<? echo $machine_id.',BatchId='.$batch_id;?>"><? echo $sub_prod_qty_normal; $subcon_normal_wash_mcw_wise_total+=$sub_prod_qty_normal;?></td>
							<td width="60" valign="middle" align="right"><? echo $sub_prod_qty_aop; $subcon_aop_wash_mcw_wise_total+=$sub_prod_qty_aop;?></td>
									...
									<td><strong><? echo $subcon_trims_weight_total;?></strong></td>
										...
										<tfoot>
											<tr class="tbl_bottom">
												...
												<td width="60"><strong><? echo $subcon_white_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $subcon_wash_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $subcon_normal_wash_grnd_total;?></strong></td>
												<td width="60"><strong><? echo $subcon_aop_wash_grnd_total;?></strong></td>
						...
						//echo $row['batch_ext_no'];
							...
							//}
								...
								//echo "B";
										...
										//echo $samp_wash_entry_form.'='.$samp_prod_qty_aop.', ';
							...
							<td width="60" valign="middle" align="right"><? echo $white_pro_qty; $white_mcw_wise_total+=$white_pro_qty;?></td>
							<td width="60" valign="middle" align="right"><? echo $wo_wash_pro_qty; $wo_wash_mcw_wise_total+=$wo_wash_pro_qty;?></td>
							<td width="60" valign="middle" align="right" title="<? echo $machine_id.'=BatchId='.$batch_id;?>"><? echo $samp_prod_qty_normal; $wo_normal_wash_mcw_wise_total+=$samp_prod_qty_normal;?></td>
							<td width="60" valign="middle" align="right"><? echo $samp_prod_qty_aop; $wo_aop_wash_mcw_wise_total+=$samp_prod_qty_aop;?></td>
							<td width="60" valign="middle" align="right"><? echo $samp_pro_qty; $wo_pro_qty_total+=$samp_pro_qty;?></td>
							<td width="60" valign="middle"><? echo $trims_weight; $wo_trims_weight_total+=$trims_weight;?></td>
							<td width="70" valign="middle" align="right"><? echo $total_production=$row['batch_qty']+$row['total_trims_weight'];//($other_pro_qty+$white_pro_qty+$wo_wash_pro_qty+$samp_pro_qty+$trims_weight+$samp_incomplete_qty);
							$total_samp_production+=$total_production; ?></td>
