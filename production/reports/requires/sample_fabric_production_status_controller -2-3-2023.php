							...
							foreach($clrArr as $clrType=>$clrTypeArr)
							{
								foreach($clrTypeArr as $fabId=>$fabArr)
								{
									...
									if($isFirst == 1)
									{
										...
										<?php
										if(isset($dataBatchArr[$bookinNo][$bodyPart][$clr]))
										{
											foreach($dataBatchArr[$bookinNo][$bodyPart][$clr] as $batchNo=>$batchNoArr)
											{
												?>
												<td width="70" style="word-break:break-all;" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>" align="center" ><?php echo $batchNo; ?></td>
												<td width="70" style="word-break:break-all;" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>" align="center"><?php echo $batchNoArr['BATCH_DATE']; ?></td>
												<td width="70" style="word-break:break-all;" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>" align="right"><?php echo number_format($batchNoArr['BATCH_WEIGHT'], 2); ?></td>
												<td width="70" style="word-break:break-all;" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>" align="center"><?php echo $dataDyeingArr[$batchNo]['PROCESS_END_DATE']; ?></td>
												<?php
												$total_batch_qnty += number_format($batchNoArr['BATCH_WEIGHT'], 2, '.', '');
											}
										}
										else
										{
										...
										<tr valign="middle">
											...
											if($row_span_batch < $isFirst)
											{
												if(isset($dataBatchArr[$bookinNo][$bodyPart][$clr]))
												{
													...
													{
														?>
														<td width="70" align="center" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>"><?php echo $batchNo; ?></td>
														<td width="70" align="center" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>"><?php echo $batchNoArr['BATCH_DATE']; ?></td>
														<td width="70" align="right" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>"><?php echo number_format($batchNoArr['BATCH_WEIGHT'], 2); ?></td>
														<td width="70" align="center" rowspan="<?php echo ($row_span_batch==0?1:$row_span_batch); ?>"><?php echo $dataDyeingArr[$batchNo]['PROCESS_END_DATE']; ?></td>
														<?php
														$total_batch_qnty += number_format($batchNoArr['BATCH_WEIGHT'], 2, '.', '');
													}
												}
