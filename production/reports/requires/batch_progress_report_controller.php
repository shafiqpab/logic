...
if($action=="report_generate")
{
	...
	if($cbo_search_date==1) // Batch Date
	{
		...
		{
			$sql_data1="SELECT a.id,a.batch_no,a.floor_id,a.save_string,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,a.total_trims_weight,a.color_range_id
			from pro_batch_create_dtls b, pro_batch_create_mst a 
			...
			if($job_no == "" &&  $order_no == "" && $txt_file_no == "" && $txt_ref_no == "" )
			{
				$sql_data2="SELECT a.id,a.batch_no,a.floor_id,a.save_string,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.style_ref_no,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id 
				from pro_batch_create_dtls b,pro_batch_create_mst a 
			...
			if(count(sql_select($sql_data2))>0)
			{
				$sql_data = $sql_data1." UNION ". $sql_data2;
			}
			else
			{
				$sql_data = $sql_data1;
		...
		{			
			...
			where a.id=b.mst_id and c.id=a.sales_order_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.is_sales=1 and a.entry_form=0 $batch_no_cond $floor_num $date_cond $booking_no_cond $workingCompany_cond  $po_cond_for_in
		...
		else // All
		{
			...
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.is_sales=0 and a.entry_form=0 $batch_no_cond $date_cond $floor_num $booking_no_cond $workingCompany_cond  $po_cond_for_in 
			group by a.batch_no,a.batch_against,a.entry_form,a.floor_id,a.save_string,a.id,a.batch_date,a.batch_weight,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id";
			...
			// echo $subc_sql_data;die;

			// Sample
			$samp_sql_data1="SELECT a.id,a.batch_no,a.floor_id,a.save_string,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.style_ref_no,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id  
			from pro_batch_create_dtls b,pro_batch_create_mst a 
			where a.id=b.mst_id and a.batch_against=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.entry_form=0 $batch_no_cond $floor_num $date_cond $booking_no_cond $workingCompany_cond  $po_cond_for_in
			group by a.batch_no,a.batch_against,a.floor_id,a.entry_form,a.save_string,a.id,a.batch_date,a.batch_weight,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id 
			";
			...
			if($job_no == "" &&  $order_no == "" && $txt_file_no == "" && $txt_ref_no == "" )
			{
				$samp_sql_data2="SELECT a.id,a.batch_no,a.floor_id,a.save_string,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.style_ref_no,a.booking_no,a.extention_no, a.total_trims_weight,a.color_range_id  
				from pro_batch_create_dtls b,pro_batch_create_mst a 
				where a.id=b.mst_id and a.batch_against=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1  and a.is_deleted=0 and a.entry_form=0 and b.po_id=0
				$batch_no_cond $floor_num $date_cond $booking_no_cond $workingCompany_cond  
				group by a.batch_no,a.batch_against,a.floor_id,a.entry_form,a.save_string,a.id,a.batch_date,a.batch_weight,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id";
			}
			if(count(sql_select($samp_sql_data2))>0)
			{
				$samp_sql_data = $samp_sql_data1." UNION ". $samp_sql_data2;
			}
			else
			{
				$samp_sql_data = $samp_sql_data1;
			}
			 //echo $samp_sql_data;die;
			
			$sales_sql_data="SELECT a.id,a.batch_no,a.floor_id,a.save_string,a.entry_form,a.batch_against,sum(b.batch_qnty) as batch_qty, a.batch_date,a.batch_weight,b.prod_id,b.po_id,b.width_dia_type,a.color_id,a.style_ref_no,a.booking_no,a.sales_order_no,a.sales_order_id,a.extention_no,c.within_group,c.sales_booking_no,c.buyer_id,c.po_buyer,c.po_job_no, a.total_trims_weight,a.color_range_id 
			from pro_batch_create_dtls b,pro_batch_create_mst a ,fabric_sales_order_mst c
			where a.id=b.mst_id and c.id=a.sales_order_id and a.batch_against !=3 and b.status_active=1 and b.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and a.is_sales=1 and a.entry_form=0 $batch_no_cond $date_cond $floor_num $booking_no_cond $workingCompany_cond  $po_cond_for_in 
			...
			// echo $sales_sql_data;die;
		}	
		//echo $sql_data;
	}
	else if($cbo_search_date==2) // Dyeing Date
	{
		if ($batch_type==1) // Self
		{
		...
		else // All
		{
			...
			group by a.batch_no,a.batch_against,a.entry_form,a.id,a.floor_id,a.save_string,c.process_end_date,a.batch_weight,a.color_id,a.style_ref_no,a.booking_no,a.extention_no,b.prod_id,b.po_id,b.width_dia_type,a.total_trims_weight,a.color_range_id";
			// echo $self_sql_data;die;
	...
	$con = connect();
	execute_query("delete from GBL_TEMP_ENGINE where user_id=$user_id and entry_form in (123)");
	oci_commit($con);

	fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 123, 1,$batch_id_arr, $empty_arr);
	

	$slitting_arr=array();$stentering_arr=array();$compacting_arr=array();$drying_arr=array();$special_arr=array();
	$sql_slitting=sql_select("SELECT a.batch_id,sum(b.batch_qty) AS slitting_qty,a.machine_id  
	from GBL_TEMP_ENGINE g, pro_fab_subprocess a, pro_fab_subprocess_dtls b 
	where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(30)  and a.status_active=1 and a.is_deleted=0 and a.batch_id>0 $dyeing_company_cond  group by a.batch_id,a.machine_id");
	foreach($sql_slitting as $row_s)
	{
		$slitting_arr[$row_s[csf('batch_id')]]['slitting']=$row_s[csf('slitting_qty')];
	}

	$sql_stenter=sql_select("SELECT a.batch_id,sum(b.production_qty) AS stentering_qty 
	from GBL_TEMP_ENGINE g, pro_fab_subprocess a,pro_fab_subprocess_dtls b 
	where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(48) and a.status_active=1 and a.is_deleted=0 and a.batch_id>0 $dyeing_company_cond group by a.batch_id"); //  and a.re_stenter_no=0
	foreach($sql_stenter as $row_st)
	{
		$stentering_arr[$row_st[csf('batch_id')]]['stentering']=$row_st[csf('stentering_qty')];
	}
	
	$sql_compect=sql_select("SELECT a.batch_id,sum(b.production_qty) AS compact_qty  
	from  GBL_TEMP_ENGINE g, pro_fab_subprocess a,pro_fab_subprocess_dtls b 
	where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(33)  and a.status_active=1 and a.is_deleted=0 and a.batch_id>0 $dyeing_company_cond group by a.batch_id"); // and a.re_stenter_no=0  
	foreach($sql_compect as $row_com)
	{
		$compacting_arr[$row_com[csf('batch_id')]]['compact']=$row_com[csf('compact_qty')];
	}

	$sql_drying=sql_select("SELECT a.batch_id,sum(b.production_qty) AS drying_qty 
	from  GBL_TEMP_ENGINE g, pro_fab_subprocess a,pro_fab_subprocess_dtls b 
	where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(31) and a.status_active=1 and a.is_deleted=0 and a.batch_id>0  $dyeing_company_cond 
		group by a.batch_id");
	...
	$sql_special=sql_select("SELECT a.batch_id,sum(b.production_qty) AS special_qty 
	from GBL_TEMP_ENGINE g, pro_fab_subprocess a, pro_fab_subprocess_dtls b 
	where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(34) and a.status_active=1 and a.is_deleted=0 and a.batch_id>0 $dyeing_company_cond group by a.batch_id");
	...
	{	
		...
		from GBL_TEMP_ENGINE g, pro_fab_subprocess a, pro_batch_create_mst c 
		where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.batch_id=c.id and a.load_unload_id in(1,2) and a.entry_form in(35,38) $date_cond_dyeing and a.status_active=1 and a.is_deleted=0 $dyeing_company_cond  group by c.id ");
	}
	else
	{
		$load_data=sql_select("SELECT c.id, sum(CASE WHEN a.load_unload_id=1 THEN c.batch_weight ELSE 0 END) AS deying_load_qty,sum(CASE WHEN a.load_unload_id=2 THEN c.batch_weight ELSE 0 END) AS deying_unload_qty 
	...
	$load_data=sql_select("SELECT a.batch_id,a.floor_id,a.result,a.machine_id,a.remarks 
	from GBL_TEMP_ENGINE g, pro_fab_subprocess a 
	where g.ref_val=a.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.load_unload_id in(2) and a.entry_form in(35,38) and a.status_active=1 and a.is_deleted=0  $dyeing_company_cond $floor_num  
	group by a.batch_id,a.floor_id,a.result,a.machine_id,a.remarks ");
	foreach($load_data as $row_dyeing)// for Loading time
	{
	...
	from GBL_TEMP_ENGINE g, inv_receive_master a, pro_finish_fabric_rcv_dtls b 
	where g.ref_val=b.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id  and a.entry_form in(7,66)  and a.item_category=2 and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $knit_company_cond 
	group by b.batch_id");
	...
	$sql_dtls_status=sql_select("SELECT b.batch_id,a.recv_number as recv_number,b.batch_status as batch_status	
	from GBL_TEMP_ENGINE g, inv_receive_master a,pro_finish_fabric_rcv_dtls b 
	where g.ref_val=b.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(7,66) and a.item_category=2 and  a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $knit_company_cond   order by b.id ");
	...
	where g.ref_val=b.batch_id and g.user_id=$user_id and g.entry_form=123 and g.ref_from=1 and a.id=b.mst_id and a.entry_form in(54,67) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 $knit_company_cond");
		...
		<div style="width:3310px; overflow-y:scroll; max-height:450px;" id="scroll_body">
			<table cellspacing="0" cellpadding="0" border="1" rules="all" width="3290" class="rpt_table" id="table_body">
				...
				foreach($batch_wise_arr as $batch_id=>$row)
				{
					...
					//print_r( $result);
				    $heat_qty=$heat_setting_arr[$batch_id]['qty'];//self
	...
	if($batch_type==0 || $batch_type==2 ) // subcon Start
	{
	    ...
	    foreach($sub_batch_wise_arr as $batch_id=>$row)
	    {
			...
			$gsm=$finish_data_arr[$batch_id]['gsm'];
			//print_r( $result);
		    $heat_qty=$heat_setting_arr[$batch_id]['qty'];//subcon
			$load_deying_qty=$loading_data_arr[$batch_id]['load'];
			$unload_deying_qty=$loading_data_arr[$batch_id]['unload'];
			//$loading_data_arr[$batch_id]['load_qty']=$row_dyeing[csf('deying_load_id')];
			//$loading_data_arr[$batch_id]['unload_qty']=$row_dyeing[csf('deying_unload_id')];
	...
	if($batch_type==0 || $batch_type==3 ) // Sample Start
	{
	    ...
	    foreach($samp_batch_wise_arr as $batch_id=>$row)
		{
			...
			$gsm=$finish_data_arr[$batch_id]['gsm'];
			//print_r( $result);
		    $heat_qty=$heat_setting_arr[$batch_id]['qty'];//sample
			$load_deying_qty=$loading_data_arr[$batch_id]['load'];
			$unload_deying_qty=$loading_data_arr[$batch_id]['unload'];
			//$loading_data_arr[$batch_id]['load_qty']=$row_dyeing[csf('deying_load_id')];
			//$loading_data_arr[$batch_id]['unload_qty']=$row_dyeing[csf('deying_unload_id')];
	...
	if($batch_type==0 || $batch_type==4 ) // Sales Start
	{
		...
		<table cellspacing="0" cellpadding="0" border="1" rules="all" width="3200" class="rpt_table" id="table_body4">
		    ...
		    foreach($sales_batch_wise_arr as $batch_id=>$row)
			{
				...
				$gsm=$finish_data_arr[$batch_id]['gsm'];
				//print_r( $result);
			    $heat_qty=$heat_setting_arr[$batch_id]['qty'];//FSO
				$load_deying_qty=$loading_data_arr[$batch_id]['load'];
				$unload_deying_qty=$loading_data_arr[$batch_id]['unload'];
				//$loading_data_arr[$batch_id]['load_qty']=$row_dyeing[csf('deying_load_id')];
				//$loading_data_arr[$batch_id]['unload_qty']=$row_dyeing[csf('deying_unload_id')];
