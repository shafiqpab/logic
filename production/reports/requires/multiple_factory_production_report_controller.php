      ...
      <?
		...
		foreach($job_sql_result as $row)
		{
		 ...
		 $dtls_sql="SELECT a.production_date, a.po_break_down_id as po_breakdown_id, a.item_number_id,c.buyer_name,a.company_id,a.serving_company,c.product_category,
					...
					sum(CASE WHEN a.production_type =1 and c.product_category in(1,3,4,5,6) THEN a.production_quantity END) AS cutting_qnty_all,
					sum(CASE WHEN a.production_type =1 and c.product_category in(1,3,4,5,6) and a.production_source=1 THEN a.production_quantity END) AS cutting_qnty_inhouse_all,
					sum(CASE WHEN a.production_type =1 and c.product_category in(1,3,4,5,6) and a.production_source=3 THEN a.production_quantity END) AS cutting_qnty_outbound_all,
					sum(CASE WHEN a.production_type =3 and c.product_category in(1,3,4,5,6) and a.embel_name=1 THEN a.production_quantity END) AS printing_qnty_all,
					sum(CASE WHEN a.production_type =3 and c.product_category in(1,3,4,5,6) and a.embel_name=1 and a.production_source=1 THEN a.production_quantity END) AS printing_qnty_inhouse_all,
					sum(CASE WHEN a.production_type =3 and c.product_category in(1,3,4,5,6) and a.embel_name=1 and a.production_source=3 THEN a.production_quantity END) AS printing_qnty_outbound_all,
					sum(CASE WHEN a.production_type =3 and c.product_category in(1,3,4,5,6) and a.embel_name=2 THEN a.production_quantity END) AS emb_qnty_all,
					sum(CASE WHEN a.production_type =3 and c.product_category in(1,3,4,5,6) and a.embel_name=2 and a.production_source=1 THEN a.production_quantity END) AS emb_qnty_inhouse_all,
					sum(CASE WHEN a.production_type =3 and c.product_category in(1,3,4,5,6) and a.embel_name=2 and a.production_source=3 THEN a.production_quantity END) AS emb_qnty_outbound_all,
					sum(CASE WHEN a.production_type =5 and c.product_category in(1,3,4,5,6) THEN a.production_quantity END) AS sewing_qnty_all,
					sum(CASE WHEN a.production_type =5 and c.product_category in(1,3,4,5,6) and a.production_source=1 THEN a.production_quantity END) AS sewingout_qnty_inhouse_all,
					sum(CASE WHEN a.production_type =5 and c.product_category in(1,3,4,5,6) and a.production_source=3 THEN a.production_quantity END) AS sewingout_qnty_outbound_all,
					sum(CASE WHEN a.production_type =4 and c.product_category in(1,3,4,5,6) THEN a.production_quantity END) AS sewing_input_qnty_all,
					sum(CASE WHEN a.production_type =4 and c.product_category in(1,3,4,5,6) and a.production_source=1 THEN a.production_quantity END) AS sewing_input_qnty_inhouse_all,
					sum(CASE WHEN a.production_type =4 and c.product_category in(1,3,4,5,6) and a.production_source=3 THEN a.production_quantity END) AS sewing_input_qnty_outbound_all,
					sum(CASE WHEN a.production_type =8 and c.product_category in(1,3,4,5,6) THEN a.production_quantity END) AS finish_qnty_all,
					sum(CASE WHEN a.production_type =8 and c.product_category in(1,3,4,5,6) and a.production_source=1 THEN a.production_quantity END) AS finish_qnty_inhouse_all,
					sum(CASE WHEN a.production_type =8 and c.product_category in(1,3,4,5,6) and a.production_source=3 THEN a.production_quantity END) AS finish_qnty_outbound_all,
					sum(CASE WHEN a.production_type =8 and c.product_category in(1,3,4,5,6) THEN a.carton_qty END) AS carton_qty_all,

					sum(CASE WHEN a.production_type =1 and c.product_category in(2,7) THEN a.production_quantity END) AS cutting_qnty_lin,
					sum(CASE WHEN a.production_type =1 and c.product_category in(2,7) and a.production_source=1 THEN a.production_quantity END) AS cutting_qnty_inhouse_lin,
					sum(CASE WHEN a.production_type =1 and c.product_category in(2,7) and a.production_source=3 THEN a.production_quantity END) AS cutting_qnty_outbound_lin,
					sum(CASE WHEN a.production_type =3 and c.product_category in(2,7) and a.embel_name=1 THEN a.production_quantity END) AS printing_qnty_lin,
					sum(CASE WHEN a.production_type =3 and c.product_category in(2,7) and a.embel_name=1 and a.production_source=1 THEN a.production_quantity END) AS printing_qnty_inhouse_lin,
					sum(CASE WHEN a.production_type =3 and c.product_category in(2,7) and a.embel_name=1 and a.production_source=3 THEN a.production_quantity END) AS printing_qnty_outbound_lin,
					sum(CASE WHEN a.production_type =3 and c.product_category in(2,7) and a.embel_name=2 THEN a.production_quantity END) AS emb_qnty_lin,
					sum(CASE WHEN a.production_type =3 and c.product_category in(2,7) and a.embel_name=2 and a.production_source=1 THEN a.production_quantity END) AS emb_qnty_inhouse_lin,
					sum(CASE WHEN a.production_type =3 and c.product_category in(2,7) and a.embel_name=2 and a.production_source=3 THEN a.production_quantity END) AS emb_qnty_outbound_lin,
					sum(CASE WHEN a.production_type =5 and c.product_category in(2,7) THEN a.production_quantity END) AS sewing_qnty_lin,
					sum(CASE WHEN a.production_type =5 and c.product_category in(2,7) and a.production_source=1 THEN a.production_quantity END) AS sewingout_qnty_inhouse_lin,
					sum(CASE WHEN a.production_type =5 and c.product_category in(2,7) and a.production_source=3 THEN a.production_quantity END) AS sewingout_qnty_outbound_lin,
					sum(CASE WHEN a.production_type =4 and c.product_category in(2,7) THEN a.production_quantity END) AS sewing_input_qnty_lin,
					sum(CASE WHEN a.production_type =4 and c.product_category in(2,7) and a.production_source=1 THEN a.production_quantity END) AS sewing_input_qnty_inhouse_lin,
					sum(CASE WHEN a.production_type =4 and c.product_category in(2,7) and a.production_source=3 THEN a.production_quantity END) AS sewing_input_qnty_outbound_lin,
					sum(CASE WHEN a.production_type =8 and c.product_category in(2,7) THEN a.production_quantity END) AS finish_qnty_lin,
					sum(CASE WHEN a.production_type =8 and c.product_category in(2,7) and a.production_source=1 THEN a.production_quantity END) AS finish_qnty_inhouse_lin,
					sum(CASE WHEN a.production_type =8 and c.product_category in(2,7) and a.production_source=3 THEN a.production_quantity END) AS finish_qnty_outbound_lin,
					sum(CASE WHEN a.production_type =8 and c.product_category in(2,7) THEN a.carton_qty END) AS carton_qty_lin
			...
			//and b.id in(29714,29715)
			 ...
			 foreach($dtls_sql_result as $row)
			 {
				...
				else
				{
				 ...
				 if($row[csf("product_category")]==1 || $row[csf("product_category")]==3 || $row[csf("product_category")]==4 || $row[csf("product_category")]==5 || $row[csf("product_category")]==6)
				 {
				 ...
				 else if($row[csf("product_category")]==2 || $row[csf("product_category")]==7)
				 {
				 ...
				 if($row[csf("product_category")]==1 || $row[csf("product_category")]==2 || $row[csf("product_category")]==3 || $row[csf("product_category")]==4 || $row[csf("product_category")]==5 || $row[csf("product_category")]==6)
				 {
			...
			sum(case when a.entry_form!=85 and c.product_category in(1,3,4,5,6,7) then a.ex_factory_qnty else 0 end)-sum(case when a.entry_form=85 then a.ex_factory_qnty else 0 end) as ex_factory_qnty_all,
			sum(case when a.entry_form!=85 and (d.delivery_company_id=0 OR d.delivery_company_id=c.company_name) and c.product_category in(1,3,4,5,6,7) then a.ex_factory_qnty else 0 end)-sum(case when a.entry_form=85 and (d.delivery_company_id=0 OR d.delivery_company_id=c.company_name) then a.ex_factory_qnty else 0 end) as ex_factory_qnty_inhouse_all,
			sum(case when a.entry_form!=85 and c.product_category in(1,3,4,5,6,7) and d.delivery_company_id!=0 and d.delivery_company_id!=c.company_name then a.ex_factory_qnty else 0 end)-sum(case when a.entry_form=85 and d.delivery_company_id!=0 and d.delivery_company_id!=c.company_name then a.ex_factory_qnty else 0 end) as ex_factory_qnty_outbound_all,
			...
			foreach($exfactory_res as $ex_row)
			{
				 ...
				 if($ex_row[csf("product_category")]==1 || $ex_row[csf("product_category")]==3 || $ex_row[csf("product_category")]==4 || $ex_row[csf("product_category")]==5 || $ex_row[csf("product_category")]==6 || $ex_row[csf("product_category")]==7)
				 {
				...
				if($ex_row[csf("product_category")]==1 || $ex_row[csf("product_category")]==2 || $ex_row[csf("product_category")]==3 || $ex_row[csf("product_category")]==4 || $ex_row[csf("product_category")]==5 || $ex_row[csf("product_category")]==6 || $ex_row[csf("product_category")]==7)
				{
