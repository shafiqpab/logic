	...
	if ($order_type==0 || $order_type==1) // Self Order
	{
				...
				foreach ($prod_date_data as $machine_id => $machine_data) 
				{
					...
					foreach ($machine_data as $batch_id => $row) 
					{
						...
						<tr id="<? echo 'v_'.$i; ?>" onClick="change_color('v_<? echo $i; ?>','#FFFFFF')" bgcolor="<? echo $bgcolor; ?>">
							...
							?>
							<td width="80" align="right"><? echo $avarage_batch_qty; $other_mcw_wise_total+=$avarage_batch_qty; $tot_batch_weight+=$row['batch_weight'];?></td> 
							<? 
					...
					<tr class="tbl_bottom">
						...
						<td><strong><? echo $tot_batch_weight;?></strong></td>
					...
					<tr class="tbl_bottom">
						...
						<td><strong><? echo $tot_batch_weight_total;?></strong></td>
	    ...
	    <tfoot>
	        <tr class="tbl_bottom">
	            ...
	            <td width="80"><strong><? echo $batch_weight_grnd_total;?></strong>&nbsp;</td>
	...
	if ($order_type==0 || $order_type==2) // Subcontract Order
	{
				...
				foreach ($prod_date_data as $machine_id => $machine_data) 
				{
					...
					foreach ($machine_data as $batch_id => $row) 
					{
						...
						<tr id="<? echo 'v_'.$i; ?>" onClick="change_color('v_<? echo $i; ?>','#FFFFFF')" bgcolor="<? echo $bgcolor; ?>">
							...
							?>
							<td style="word-break: break-all;" width="80" align="right"><? echo $subcon_other_pro_qty; $subcon_other_mcw_wise_total+=$subcon_other_pro_qty;$subcon_wgt_mcw_wise_total+=$row['batch_weight'];
							...
							?> 
							<td style="word-break: break-all;" width="80" align="right"><? echo $subcon_white_pro_qty; $subcon_white_mcw_wise_total+=$subcon_white_pro_qty;?></td>
							<? 
								if ($row['color_range_id']==7 && $row['result']==1)
								{
							...
							?>
							<td style="word-break: break-all;" width="80" align="right"><? echo $subcon_wash_pro_qty; $subcon_wash_mcw_wise_total+=$subcon_wash_pro_qty;?></td> 							
							<?
								if ($row['result']==2) 
								{
							...
							?>
							<td style="word-break: break-all;" width="80" align="right"><?echo $pro_qty; $subcon_pro_qty_total+=$pro_qty;?></td>
					...
					<tr class="tbl_bottom">
						...
						<td style="word-break: break-all;"><strong><? echo $subcon_wgt_mcw_wise_total;?></strong></td>
                        <td style="word-break: break-all;"><strong><? echo $subcon_other_mcw_wise_total;?></strong></td>
						<td style="word-break: break-all;"><strong><? echo $subcon_white_mcw_wise_total;?></strong></td>
						<td style="word-break: break-all;"><strong><? echo $subcon_wash_mcw_wise_total;?></strong></td>
						<td style="word-break: break-all;"><strong><? echo $subcon_pro_qty_total;?></strong></td>
					...
					<tr class="tbl_bottom">
						...
						<td style="word-break: break-all;"><strong><? echo $subcon_subcon_wgt_mcw_wise_total;?></strong></td>
                        <td style="word-break: break-all;"><strong><? echo $subcon_other_date_wise_total;?></strong></td>
						<td style="word-break: break-all;"><strong><? echo $subcon_white_date_wise_total;?></strong></td>
						<td style="word-break: break-all;"><strong><? echo $subcon_wash_date_wise_total;?></strong></td>
						<td style="word-break: break-all;"><strong><? echo $subcon_pro_qty_date_wise_total;?></strong></td>
						<td style="word-break: break-all;" colspan="10"></td>
					</tr>
					<?
	    ...
	    <tfoot>
	        <tr class="tbl_bottom">
	            ...
	            <td style="word-break: break-all;" width="80"><strong><? echo $subcon_subcon_wgt_mcw_wise_grnd_total;?></strong>&nbsp;</td>
                <td style="word-break: break-all;" width="80"><strong><? echo $subcon_other_grnd_total;?></strong>&nbsp;</td>
	            <td style="word-break: break-all;" width="80"><strong><? echo $subcon_white_grnd_total;?></strong></td>
	            <td style="word-break: break-all;" width="80"><strong><? echo $subcon_wash_grnd_total;?></strong></td>
	            <td style="word-break: break-all;" width="80"><strong><? echo $subcon_pro_qty_grnd_total;?></strong></td>
