...
if($action=="batch_report")
{
	...
	if($batch_type==0 || $batch_type==1)
	{
		...
		if($operation==1 || $operation==2) // Show and show 2 sql
		{
			...
			{
				/*$sql="SELECT x.*, max(e.load_unload_id) as load_unload_id
				from
				( select a.id,a.batch_against,a.entry_form,a.batch_no,a.batch_date,a.batch_weight,a.total_trims_weight,a.color_id,a.color_range_id,a.booking_no,a.extention_no, a.batch_sl_no,a.working_company_id, a.booking_no_id, b.item_description,b.prod_id,b.po_id,sum(b.batch_qnty) as batch_qnty,c.job_no as fso_no,c.style_ref_no,a.dyeing_machine,listagg(d.dtls_id, ',') within group (order by d.dtls_id) as dtls_ids,c.po_buyer,c.buyer_id,c.within_group,b.body_part_id,LISTAGG (b.color_type, ',') WITHIN GROUP (ORDER BY b.color_type) AS color_type_ids,count(b.id) as roll_no, a.remarks, a.process_id,a.floor_id,a.shift_id,c.customer_buyer,c.booking_id, b.program_no
				from pro_batch_create_mst a,pro_batch_create_dtls b,fabric_sales_order_mst c,pro_roll_details d
				where a.company_id=$company and a.status_active=1 $dates_com $batch_num $ext_no $all_fso_no_cond $batch_against_cond $style_no_cond_2 $bookingIdsCond and a.is_sales=1 and a.id=b.mst_id and b.po_id=c.id and b.barcode_no=d.barcode_no and b.is_deleted=0 and d.entry_form in(2,22) and d.status_active=1 and c.status_active=1 and b.barcode_no!=0
				group by a.id,a.batch_against,a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.color_id, a.color_range_id, a.booking_no,a.extention_no, a.batch_sl_no,a.working_company_id, a.booking_no_id, b.item_description, b.prod_id,b.po_id, c.job_no,c.style_ref_no,a.dyeing_machine,a.total_trims_weight, c.po_buyer,c.buyer_id, c.within_group, b.body_part_id, a.remarks, a.process_id,a.floor_id,a.shift_id,c.customer_buyer,c.booking_id, b.program_no
				order by a.batch_no
				) x  left join pro_fab_subprocess e on x.id = e.batch_id and e.status_active =1
				group by x.id,x.batch_against,x.entry_form,x.batch_no,x.batch_date,x.batch_weight,x.total_trims_weight,x.color_id,x.color_range_id,x.booking_no,x.extention_no, x.batch_sl_no,x.working_company_id, x.booking_no_id, x.item_description, x.prod_id, x.po_id, x.batch_qnty, x.fso_no, x.style_ref_no, x.dyeing_machine, x.dtls_ids, x.po_buyer, x.buyer_id, x.within_group, x.body_part_id,x.color_type_ids, x.remarks, x.process_id,x.floor_id,x.shift_id, x.roll_no,x.customer_buyer,x.booking_id, x.program_no $load_unload_cond  order by x.batch_no,x.prod_id,x.extention_no desc";*/
		...
		else if($operation==3) // show 3 sql
		{
			if((($all_booking_no_cond != "" || $sales_orders_cond != "" || $style_no_cond != "") && $all_fso_no_cond != "") || ($all_booking_no_cond == "" && $sales_orders_cond == "" && $style_no_cond =="" && $all_fso_no_cond == ""))
			{
				...
				$sql="SELECT x.*, max(e.load_unload_id) as load_unload_id
				from
				( select a.id,a.batch_against,a.entry_form,a.batch_no,a.batch_date,a.batch_weight,a.total_trims_weight,a.color_id,a.color_range_id,a.booking_no,a.extention_no, a.batch_sl_no,a.working_company_id, a.booking_no_id, b.item_description,b.prod_id,b.po_id,sum(b.batch_qnty) as batch_qnty,c.job_no as fso_no,c.style_ref_no,a.dyeing_machine,c.po_buyer,c.buyer_id,c.within_group,b.body_part_id,count(b.id) as roll_no, a.remarks, a.process_id,a.floor_id,a.shift_id,c.customer_buyer
				from pro_batch_create_mst a,pro_batch_create_dtls b,fabric_sales_order_mst c
				where a.company_id=$company and a.status_active=1 $dates_com $batch_num $ext_no $all_fso_no_cond $batch_against_cond $style_no_cond_2 and a.is_sales=1 and a.id=b.mst_id and b.po_id=c.id and b.is_deleted=0 and  c.status_active=1 and b.barcode_no  is null
				group by a.id,a.batch_against,a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.color_id, a.color_range_id, a.booking_no,a.extention_no, a.batch_sl_no,a.working_company_id, a.booking_no_id, b.item_description, b.prod_id,b.po_id, c.job_no,c.style_ref_no,a.dyeing_machine,a.total_trims_weight, c.po_buyer,c.buyer_id, c.within_group, b.body_part_id, a.remarks, a.process_id,a.floor_id,a.shift_id,c.customer_buyer
				order by a.batch_no
				) x  left join pro_fab_subprocess e on x.id = e.batch_id and e.status_active =1
				group by x.id,x.batch_against,x.entry_form,x.batch_no,x.batch_date,x.batch_weight,x.total_trims_weight,x.color_id,x.color_range_id,x.booking_no,x.extention_no, x.batch_sl_no,x.working_company_id, x.booking_no_id, x.item_description, x.prod_id, x.po_id, x.batch_qnty, x.fso_no, x.style_ref_no, x.dyeing_machine, x.po_buyer, x.buyer_id, x.within_group, x.body_part_id, x.remarks, x.process_id,x.floor_id,x.shift_id, x.roll_no,x.customer_buyer $load_unload_cond  order by x.batch_no,x.prod_id,x.extention_no desc";
		...
		if(!empty($programNoArr)) // for stitch_length
		{	
		...
		if(!empty($bookingIdArr)) // for int_ref
		{
			fnc_tempengine("GBL_TEMP_ENGINE", $user_name, 180, 2,$bookingIdArr, $empty_arr); //recv id

			$int_ref_sql = "SELECT a.booking_mst_id,a.po_break_down_id, b.grouping 
			FROM GBL_TEMP_ENGINE g, wo_booking_dtls a, wo_po_break_down b 
			WHERE g.ref_val=a.booking_mst_id and g.user_id=$user_name and g.entry_form=180 and g.ref_from=2 and a.po_break_down_id = b.id  group by a.booking_mst_id,a.booking_no,a.po_break_down_id, b.grouping";//".where_con_using_array($bookingIdArr,0,'a.booking_mst_id')."
			//echo $int_ref_sql;
			$int_ref_sql_rslt=sql_select($int_ref_sql);
			$int_ref_arr = array();
			foreach($int_ref_sql_rslt as $row)
		...
		if($operation==1 || $operation==2) // for yarn_lot_arr
		{
			...
			{
				fnc_tempengine("GBL_TEMP_ENGINE", $user_name, 180, 3,$grey_production_dtls_id_arr, $empty_arr);
				...
				where g.ref_val=a.id and g.user_id=$user_name and g.entry_form=180 and g.ref_from=3 and a.id=b.dtls_id and b.entry_form in(2,22) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 
				group by a.id,a.prod_id,a.yarn_lot, b.po_breakdown_id,a.yarn_prod_id,a.machine_no_id,a.machine_dia, a.machine_gg"); //and a.yarn_prod_id is not null
		...
		else if($operation==3) // show 3 for gross_yarn_lot_arr
		{

			if(!empty($all_sales_id_arr))
			{
				$gross_yarn_lot_data=sql_select("SELECT a.id dtls_id, a.order_id,b.po_breakdown_id as po_id, a.prod_id,a.yarn_lot as yarnlot,a.yarn_prod_id, a.machine_no_id, a.machine_dia, a.machine_gg from pro_grey_prod_entry_dtls a, order_wise_pro_details b where a.id=b.dtls_id and b.entry_form in(2,22) and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  ".where_con_using_array($all_sales_id_arr,1,'a.order_id')." group by a.id,a.order_id,a.prod_id,a.yarn_lot, b.po_breakdown_id,a.yarn_prod_id,a.machine_no_id,a.machine_dia, a.machine_gg");
				//and a.yarn_prod_id is not null


				foreach($gross_yarn_lot_data as $rows)
				{
					$gross_yarn_lot_arr[$rows[csf('order_id')]][$rows[csf('prod_id')]]['yarn_prod_id'] 	.= $rows[csf('yarn_prod_id')].',';
					$gross_yarn_lot_arr[$rows[csf('order_id')]][$rows[csf('prod_id')]]['machine_no_id'] 	.= $rows[csf('machine_no_id')].',';
					$gross_yarn_lot_arr[$rows[csf('order_id')]][$rows[csf('prod_id')]]['machine_dia'] 	.= $rows[csf('machine_dia')].',';
					$gross_yarn_lot_arr[$rows[csf('order_id')]][$rows[csf('prod_id')]]['machine_gg'] 	.= $rows[csf('machine_gg')].',';
					$yarn_prod_id_arr[$rows[csf('yarn_prod_id')]] = $rows[csf('yarn_prod_id')];
				}
			}
		}
		...
		where g.ref_val=a.id and g.user_id=$user_name and g.entry_form=180 and g.ref_from=5 and a.sales_booking_no=c.booking_no and c.job_no=b.job_no and a.company_id=$company $fso_no_cond and a.within_group=1 and a.booking_id = d.id and c.booking_no = d.booking_no
		union all
		...
		where g.ref_val=a.id and g.user_id=$user_name and g.entry_form=180 and g.ref_from=5 and a.within_group=1 and a.sales_booking_no=b.booking_no and a.company_id=$company $fso_no_cond");
	    ...
	    <div align="left">
	        <fieldset style="width:2585px;">
	            ...
	            <div align="left">
	                    ...
	                    <table class="rpt_table" width="3035" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
	                        <thead>
	                            <tr>
	                                ...
	                                <th width="100" class="word_wrap_break">Floor</th>
	                                <th width="40" class="word_wrap_break">Shift</th>
	                                ...
	                                <th width="80" class="word_wrap_break">Customer Buyer</th>
	                        ...
	                        <table class="rpt_table" id="table_body" width="3035" cellpadding="0" cellspacing="0" border="1" rules="all">
	                            <tbody>
	                                ...
	                                foreach($batch_data_arr as $batch)
	                                {
	                                    ...
	                                    {
	                                        /*$yarn_prod_ids .= $yarn_lot_arr[$dtlid][$batch[('prod_id')]][$batch[('po_id')]]['yarn_prod_id'].',';
	                                        $machine_gg_no .= $yarn_lot_arr[$dtlid][$batch[('prod_id')]][$batch[('po_id')]]['machine_gg'].',';
	                                        $machine_dia .= $yarn_lot_arr[$dtlid][$batch[('prod_id')]][$batch[('po_id')]]['machine_dia'].',';
	                                        $machine_no_id .= $yarn_lot_arr[$dtlid][$batch[('prod_id')]][$batch[('po_id')]]['machine_no_id'].',';*/
	                                    ...
	                                    <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
	                                    	<?
	                                    	if (!in_array($batch[('id')],$batch_chk_arr) )
					            			{
		                                    	?>
		                                        <td class="word_wrap_break" width="30"><? echo $f; ?></td>
												<?
												$batch_chk_arr[]=$batch[('id')];
												$f++;
											}
											else
		                        			{
	                                       ...
	                                       <td class="word_wrap_break" align="center" width="75" title="<? echo change_date_format($batch[('batch_date')]); ?>"><p><? echo change_date_format($batch[('batch_date')]); ?></p></td>
	                                        ...
	                                        <td class="word_wrap_break" width="60" title="<? echo $batch[('batch_no')]; ?>">
											<a href="##" onClick="generate_batch_print_report('<? echo $print_btn;?>','<? echo $company;?>','<? echo $batch[('id')]?>','<? echo $batch[('batch_no')]?>','<? echo $batch[('working_company_id')]?>','<? echo $extention_no;?>','<? echo $batch[('batch_sl_no')]?>','<? echo $batch[('booking_no_id')]?>','<? echo $roll_maintained;?>')"><?echo $batch[('batch_no')]; ?></a>
											</td>
											<td class="word_wrap_break" width="100" title="<? echo $batch[('floor_id')]; ?>"><p><? echo $floor_name_arr[$batch[('floor_id')]]; ?></p></td>
	                                    	<td class="word_wrap_break"  width="40"><p><? echo $shift_name[$batch[('shift_id')]]; ?></p></td>
	                                        ...
	                                        <td width="80"><p class="word_wrap_break"><? echo $color_range[$batch[('color_range_id')]]; ?></p></td>
											<td width="80"><p class="word_wrap_break"><? echo $color_type_name; ?></p></td>
	                                        <td width="80">
	                                        ...
	                                        <td width="80">
	                                        	<p class="word_wrap_break">
	                                        	<?
													$buyer_id = $batch[('customer_buyer')];
													echo $buyer_arr[$buyer_id];
	                                        	?>
	                                        	</p>
	                                        </td>
	                                        <td class="word_wrap_break" width="60" align="center"><p><? echo chop($job_from_fso_arr[$batch[('fso_no')]]["job_no"],","); ?></p></td>
	                                        <td width="70"><p class="word_wrap_break"><? echo $batch[('style_ref_no')]; ?></p></td>
	                                        <td class="word_wrap_break" width="110"><p><?  echo $batch[('fso_no')]; ?></p></td>
	                                        <td class="word_wrap_break" width="120"><p><? echo $batch[('booking_no')]; ?></p></td>
	                                        <td class="word_wrap_break" width="100"><p><? echo $int_ref_no; ?></p></td>
	                                        <td class="word_wrap_break" width="50"><p><? echo $booking_type_arr[$batch[('booking_no')]]; ?></p></td>
	                                        <td class="word_wrap_break" width="70"><p><? echo $short_booking_type_arr[$batch[("booking_no")]]; ?></p></td>
	                                        ...
	                                        <td width="50" align="center"><p class="word_wrap_break"><? echo $machine_names; ?></p></td>
	                ...
	                if(($batch_type==0 || $batch_type==2) && count($subbatchdata)>0)
	                { ?>
	...
	else if($operation==2) // Show 2
	{
		$con = connect();
		execute_query("delete from GBL_TEMP_ENGINE where user_id=$user_name and entry_form in (1122)");
		oci_commit($con);

		fnc_tempengine("GBL_TEMP_ENGINE", $user_name, 1122, 1,$all_batch_arr, $empty_arr);
		// fnc_tempengine("GBL_TEMP_ENGINE", $user_name, 1122, 2,$all_subcon_batch_id_arr, $empty_arr);

		$dyeing_production_sql="SELECT B.BATCH_ID, B.MACHINE_ID, B.PROCESS_END_DATE as PROCESS_START_DATE, B.PRODUCTION_DATE AS PROCESS_END_DATE, B.END_HOURS, B.END_MINUTES, B.LOAD_UNLOAD_ID, B.SHIFT_NAME, B.FLOOR_ID
		FROM GBL_TEMP_ENGINE A, PRO_FAB_SUBPROCESS B WHERE a.ref_val=B.BATCH_ID and a.user_id=$user_name and a.entry_form=1122 and a.ref_from=1 and B.ENTRY_FORM=35";
		// echo $dyeing_production_sql;die;
		$dyeing_production_sql_data=sql_select($dyeing_production_sql);
		foreach ($dyeing_production_sql_data as $key => $val)
		{
			if ($val['LOAD_UNLOAD_ID']==1)
			{
				$dyeing_start_arr[$val['BATCH_ID']]['PROCESS_START_DATE']=$val['PROCESS_START_DATE'];
				$dyeing_start_arr[$val['BATCH_ID']]['START_HOURS_MIN']=$val['END_HOURS'].':'.$val['END_MINUTES'];
			}
			else
			{
				$dyeing_end_arr[$val['BATCH_ID']]['PROCESS_END_DATE']=$val['PROCESS_END_DATE'];
				$dyeing_end_arr[$val['BATCH_ID']]['END_HOURS_MIN']=$val['END_HOURS'].':'.$val['END_MINUTES'];
				$dyeing_shift_name_arr[$val['BATCH_ID']]=$val['SHIFT_NAME'];
			}
			$dyeing_floor_id_arr[$val['BATCH_ID']]=$val['FLOOR_ID'];
			$dyeing_machine_id_arr[$val['BATCH_ID']]=$val['MACHINE_ID'];
		}
		// echo "<pre>";print_r($dyeing_start_arr);die;
	        ...
	        <fieldset style="width:2585px;">
	            ...
	            <div align="left">
	                ...
	                { ?>
	                    ...
	                    <table class="rpt_table" width="3085" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
	                        <thead>
	                            <tr>
	                                <th width="30" class="word_wrap_break">SL</th>
	                                <th width="75" class="word_wrap_break">Batch Date</th>
	                               ...
	                               <!--  <th width="50">Booking Dia</th> -->
	                                ...
	                                <th width="70" class="word_wrap_break">Yarn Brand</th>
	                                <th width="100" class="word_wrap_break">Y.Lot No</th>
	                                <th width="100" class="word_wrap_break">Dyeing Floor and Shift</th>
	                                <th width="70" class="word_wrap_break">Dyeing Machine</th>
	                                <th width="100" class="word_wrap_break">Process Start Date and Time</th>
	                                <th width="100" class="word_wrap_break">Process End Date and Time</th>
	                                <th width="70" class="word_wrap_break">Fabric Weight.</th>
	                                <th width="70" class="word_wrap_break">Trims Weight</th>
	                                <th width="70" class="word_wrap_break">Total Batch Weight</th>
	                                <th width="40" class="word_wrap_break">No of Roll</th>
	                    ...
	                    <div style=" max-height:350px; width:3105px; overflow-y:scroll;" id="scroll_body">
	                        <table class="rpt_table" id="table_body" width="3085" cellpadding="0" cellspacing="0" border="1" rules="all">
	                            <tbody>
	                                <?
	                                $i=1;$btq=0;$f=1;
	                                foreach($batch_data_arr as $batch)
	                                {
										...
										$dyeing_start_date=$dyeing_start_arr[$batch[('id')]]['PROCESS_START_DATE'];
										$dyeing_start_time=$dyeing_start_arr[$batch[('id')]]['START_HOURS_MIN'];
										$dyeing_end_date=$dyeing_end_arr[$batch[('id')]]['PROCESS_END_DATE'];
										$dyeing_end_time=$dyeing_end_arr[$batch[('id')]]['END_HOURS_MIN'];

										$dyeing_shift=$dyeing_shift_name_arr[$batch[('id')]];
										$dyeing_floor=$dyeing_floor_id_arr[$batch[('id')]];
										$dyeing_machine=$dyeing_machine_id_arr[$batch[('id')]];
	                                    ...
	                                    <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
	                                       ...
	                                       <td class="word_wrap_break" align="center" width="75" title="<? echo change_date_format($batch[('batch_date')]); ?>"><p><? echo change_date_format($batch[('batch_date')]); ?></p></td>
	                                        ...
	                                        <td title="<?=$val['BATCH_ID'];?>" class="word_wrap_break" width="100" align="left"><div style="width:60px; word-wrap:break-word;"><? echo $shift_name[$dyeing_shift].'<br>'.$floor_name_arr[$dyeing_floor]; ?></div></td>
	                                        <td class="word_wrap_break" width="70" align="center"><? echo $machine_name_arr[$dyeing_machine];?></td>
	                                        <td class="word_wrap_break" width="100" align="left"><div style="width:60px; word-wrap:break-word;"><? echo $dyeing_start_date.'<br>'.$dyeing_start_time; ?></div></td>
	                                        <td class="word_wrap_break" width="100" align="left"><div style="width:60px; word-wrap:break-word;"><? echo $dyeing_end_date.'<br>'.$dyeing_end_time;; ?></div></td>
	                    ...
	                    <table class="rpt_table" width="3085" cellpadding="0" cellspacing="0" border="1" rules="all">
	                        <tfoot>
	                            <tr>
	                            	<th width="30">&nbsp;</th>
	                                <th width="75">&nbsp;</th>
	        ...
	        <fieldset style="width:2585px;">
	            ...
	            <div align="left">
	                ...
	                { ?>
	                    ...
	                    <table class="rpt_table" width="2785" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
	                        <thead>
	                            <tr>
	                                <th width="30" class="word_wrap_break">SL</th>
	                                <th width="75" class="word_wrap_break">Batch Date</th>
	                    ...
	                    <div style=" max-height:350px; width:2805px; overflow-y:scroll;" id="scroll_body">
	                        <table class="rpt_table" id="table_body" width="2785" cellpadding="0" cellspacing="0" border="1" rules="all">
	                            <tbody>
	                                <?
	                                $i=1;$btq=0;$f=1;
	                                foreach($batchdata as $batch)
	                                {
										...
										$yarn_prod_ids = $gross_yarn_lot_arr[$batch[csf('po_id')]][$batch[csf('prod_id')]]['yarn_prod_id'];
										$machine_gg_no = $gross_yarn_lot_arr[$batch[csf('po_id')]][$batch[csf('prod_id')]]['machine_gg'];
										$machine_dia = $gross_yarn_lot_arr[$batch[csf('po_id')]][$batch[csf('prod_id')]]['machine_dia'];
										$machine_no_id = $gross_yarn_lot_arr[$batch[csf('po_id')]][$batch[csf('prod_id')]]['machine_no_id'];
	                                   ...
	                                   //echo $machine_no_id;
	                                    ...
	                                    $yarn_brand_name=implode(",",array_filter(array_unique(explode("*",$yarn_brand_name))));
	                                    $machine_names=implode(",",array_filter(array_unique(explode("*",$machine_names))));
	                                    $batch_status = ($batch[csf("load_unload_id")]) ? $batch[csf("load_unload_id")] : "3";
	                                    ...
	                                    <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
											...
											?>
	                                       <td class="word_wrap_break" align="center" width="75" title="<? echo change_date_format($batch[csf('batch_date')]); ?>"><p><? echo change_date_format($batch[csf('batch_date')]); ?></p></td>


	                                        <td class="word_wrap_break" width="60" title="<? echo $batch[csf('batch_no')]; ?>">
											...
											<td class="word_wrap_break" width="100" title="<? echo $batch[csf('floor_id')]; ?>"><p><? echo $floor_name_arr[$batch[csf('floor_id')]]; ?></p></td>
	                                    	<td class="word_wrap_break"  width="40"><p><? echo $shift_name[$batch[csf('shift_id')]]; ?></p></td>
	                                        <td class="word_wrap_break"  width="40" title="<? echo $batch[csf('extention_no')]; ?>"><p><? echo $batch[csf('extention_no')]; ?></p></td>
	                                        <td  width="80"><p><? echo $batch_against[$batch[csf('batch_against')]]; ?></p></td>
	                                        <td width="80"><p class="word_wrap_break"><? echo $color_library[$batch[csf('color_id')]]; ?></p></td>
	                                        <td width="80"><p class="word_wrap_break"><? echo $color_range[$batch[csf('color_range_id')]]; ?></p></td>
	                                        <td width="80">
	                                        	<p class="word_wrap_break">
	                                        	<?
	                                        		if($batch[csf('within_group')] == 1)
	                                        		{
														$buyer_id = $batch[csf('po_buyer')];
													}
													else
													{
														$buyer_id = $batch[csf('buyer_id')];
													}
														echo $buyer_arr[$buyer_id];
	                                        	?>
	                                        	</p>
	                                        ...
	                                        <td width="80">
	                                        	<p class="word_wrap_break">
	                                        	<?
													$buyer_id = $batch[csf('customer_buyer')];
													echo $buyer_arr[$buyer_id];
	                                        	?>
	                                        	</p>
	                                        </td>
	                                        <td class="word_wrap_break" width="60" align="center"><p><? echo chop($job_from_fso_arr[$batch[csf('fso_no')]]["job_no"],","); ?></p></td>
	                                        <td width="70"><p class="word_wrap_break"><? echo $batch[csf('style_ref_no')]; ?></p></td>
	                                        <td class="word_wrap_break" width="110"><p><?  echo $batch[csf('fso_no')]; ?></p></td>
	                                        <td class="word_wrap_break" width="120"><p><? echo $batch[csf('booking_no')]; ?></p></td>
	                                        <td class="word_wrap_break" width="50"><p><? echo $booking_type_arr[$batch[csf('booking_no')]]; ?></p></td>
	                                        <td class="word_wrap_break" width="70"><p><? echo $short_booking_type_arr[$batch[csf("booking_no")]]; ?></p></td>
	                                        <td class="word_wrap_break" width="70"><p><? echo $body_part[$batch[csf("body_part_id")]]; ?></p></td>
	                                        <td width="100" align="center"><p class="word_wrap_break"><? echo $desc[0]; ?></p></td>
	                                        <td width="150" align="center"><p class="word_wrap_break"><? echo $desc[1]; ?></p></td>
	                                        <td width="50" align="center"><p class="word_wrap_break"><? echo $desc[3]; ?></p></td>
	                                        <td width="50" align="center"><p class="word_wrap_break"><? echo $desc[2]; ?></p></td>
	                                        ...
	                                        <td class="word_wrap_break" width="100" title="<? echo 'Prod Id'.$batch[csf('prod_id')].'=PO ID'.$order_id;?>" align="left"><div style="width:60px; word-wrap:break-word;"><? echo $lot_no; ?></div></td>
	                                        <td class="word_wrap_break" width="70" align="center"><? echo $machine_name_arr[$batch[csf('dyeing_machine')]];?></td>
	                                        <td class="word_wrap_break" align="right" width="70" title="<? echo $batch[csf('batch_qnty')];  ?>"><? echo number_format($batch[csf('batch_qnty')],2);  ?></td>
	                                        <?
	                                        if($batch_chk[$batch[csf('id')]]=="")
	                                        {
	                                            ?>
	                                            <td class="word_wrap_break" align="right" width="70" title="<? echo $batch[csf('total_trims_weight')]; ?>">
	                                                <?
	                                                echo $batch[csf('total_trims_weight')];
	                                                ?>
	                                            </td>
	                                            <td class="word_wrap_break" align="right" width="70" title="<? echo $batch[csf('batch_weight')]; ?>">
	                                                <?
	                                        ...
	                                        ?>
	                                        <td class="word_wrap_break" width="40" align="center"><? echo $batch[csf("roll_no")];?></td>
	                                        <td class="word_wrap_break" align="center" width="70"><? echo $load_unload_arr[$batch_status];?></td>
	                                        <td width="100" class="word_wrap_break" align="center"><? echo $batch[csf("remarks")];?></td>
	                                        <td width="100" class="word_wrap_break" align="center"><? echo $process_name;?></td>
	                                    </tr>
	                                    <?
	                                    $i++;
	                                    ...
	                                    $tot_batch_roll_no += $batch[csf("roll_no")];
	                                }
	                                ?>
	                            </tbody>
	                        </table>
	                    </div>
	                    <table class="rpt_table" width="2785" cellpadding="0" cellspacing="0" border="1" rules="all">
	                        <tfoot>
	                            <tr>
	                            	<th width="30">&nbsp;</th>
	                                <th width="75">&nbsp;</th>
	                    ...
	                    <table class="rpt_table" width="1740" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
	                        <thead>
	                            <tr>
	                                ...
	                                <th class="word_wrap_break" width="75">Batch Date</th>
	                                <th class="word_wrap_break" width="60">Batch No</th>
	                                <th class="word_wrap_break" width="100">Floor Name</th>
	                                <th class="word_wrap_break" width="40">Ext. No</th>
	                                <th class="word_wrap_break" width="80">Batch Against</th>
	                                <th class="word_wrap_break" width="80">Batch Color</th>
	                                <th class="word_wrap_break" width="80">Party</th>
