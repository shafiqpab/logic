...
{ 
	 ...
	 if($type==1) //order and size wise 
	{
		...
		//$sql_result = sql_select("select cutting_update,sewing_production from  variable_settings_production where company_name=$data and variable_list=1 and status_active=1");
		 $sql_po="SELECT e.company_id,e.party_id,d.cust_style_ref as style_ref_no,d.order_no,a.order_id as po_break_down_id,a.item_id as item_number_id, a.color_id as color_number_id, a.size_id as size_number_id, sum(a.qnty) as order_quantity from subcon_ord_breakdown a,subcon_ord_dtls d,subcon_ord_mst e 
