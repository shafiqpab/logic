    ...
    <div style="width:100%">
        <div style="width:100%; font-weight:bold;"> <? echo $floor_library[$cbo_floor]; ?>: Sewing Production Status (
        	<?php 
                if(str_replace("'","",trim($txt_date))=="")
                	...
                	$txt_date=date("l, F d", strtotime(str_replace("'", "",  $txt_date)));
                echo $txt_date;			        
        	?>)
        </div>
		...
		if($db_type==0)
		{
			...
			$sql.="	from pro_garments_production_mst a, wo_po_details_master b, wo_po_break_down c
					where a.entry_form=349 and a.production_type=13 and a.po_break_down_id=c.id and c.job_no_mst=b.job_no and a.status_active=1 and a.is_deleted=0 $company_name $location $floor $line $txt_date_from $style_no_cond  $order_no_cond $job_no_cond group by a.prod_reso_allo, a.floor_id, a.sewing_line, b.job_no order by a.floor_id, a.sewing_line"; 
		...
		if($db_type==2)
		{
			...
			$sql.=" FROM pro_garments_production_mst a, wo_po_details_master b, wo_po_break_down c
				 where a.entry_form=349 and a.production_type=13 and a.po_break_down_id=c.id and c.job_no_mst=b.job_no and a.status_active=1 and a.is_deleted=0 $company_name $location $floor $line $txt_date_from $style_no_cond  $order_no_cond $job_no_cond 
		...
		if($db_type==0)
		{
			...
			$sql_qcAlterSpotReject.=" from pro_garments_production_mst a, wo_po_details_master b, wo_po_break_down c
					where a.production_type=5 and a.po_break_down_id=c.id and c.job_no_mst=b.job_no and a.status_active=1 and a.is_deleted=0 and a.po_break_down_id in($poIds) $txt_date_from and c.status_active=1 and b.status_active=1 group by a.floor_id, a.location, a.prod_reso_allo, a.sewing_line, a.po_break_down_id, b.job_no, a.item_number_id";
		...
		else
		{
			...
			$sql_qcAlterSpotReject.=" from pro_garments_production_mst a, wo_po_details_master b, wo_po_break_down c
					where a.production_type=5 and a.po_break_down_id=c.id and c.job_no_mst=b.job_no and a.status_active=1 and a.is_deleted=0 and a.po_break_down_id in($poIds) and c.status_active=1 and b.status_active=1 $txt_date_from group by a.floor_id, a.location, a.prod_reso_allo, a.sewing_line, a.po_break_down_id, b.job_no, a.item_number_id";
		}
            ...
            <table width="100%" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
                ...
                <thead> 	 	 	 	 	 	
                    <tr>
						...
						<th width="4%" style="vertical-align:middle; word-break:break-all" align="center">Total Production</th>
                    ...
                    <tr>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
                        	    ...
                        	    if ($prod_09 != 0){
                                    echo $prod_09.'/'.number_format($percent_cal_09).'%';
                        	    } else {
                        	    	echo 0;
                        	    }
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
                        	    ...
                        	    if ($prod_10 != 0){
                                    echo $prod_10.'/'.number_format($percent_cal_10).'%';
                        	    } else {
                        	    	echo 0;
                        	    }
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_11 != 0){
	                                echo $prod_11.'/'.number_format($percent_cal_11).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_12 != 0){
	                                echo $prod_12.'/'.number_format($percent_cal_12).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_13 != 0){
	                                echo $prod_13.'/'.number_format($percent_cal_13).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_14 != 0){
	                                echo $prod_14.'/'.number_format($percent_cal_14).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_15 != 0){
	                                echo $prod_15.'/'.number_format($percent_cal_15).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_16 != 0){
	                                echo $prod_16.'/'.number_format($percent_cal_16).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_17 != 0){
	                                echo $prod_17.'/'.number_format($percent_cal_17).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_18 != 0){
	                                echo $prod_18.'/'.number_format($percent_cal_18).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_19 != 0){
	                                echo $prod_19.'/'.number_format($percent_cal_19).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_20 != 0){
	                                echo $prod_20.'/'.number_format($percent_cal_20).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_21 != 0){
	                                echo $prod_21.'/'.number_format($percent_cal_21).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_22 != 0){
	                                echo $prod_22.'/'.number_format($percent_cal_22).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_23 != 0){
	                                echo $prod_23.'/'.number_format($percent_cal_23).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
                        ...
                        <th width="3%" style="vertical-align:middle; word-break:break-all;">
                        	<?php 
	                        	...
	                        	if ($prod_24 != 0){
	                                echo $prod_24.'/'.number_format($percent_cal_24).'%';
	                        	} else {
	                        	   echo 0;
	                        	}
                        	?>
							...
							foreach($val as $gmts_id => $row)
							{
								...
								<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>" >
									...
									<td width="4%" style="vertical-align:middle; word-break:break-all" align="center">
								    	<? 
                                            if ($prodAlterReject_Spot_arr[$flowre_id][$line_name][$job_id][$gmts_id]['reject_qnty_new'] == '0' && $prodAlterReject_Spot_arr[$flowre_id][$line_name][$job_id][$gmts_id]['alter_qnty_new'] == '0' && $row[("spot_qnty")] == '0')
								    	        echo '';
								    	    else
								    	        echo $prodAlterReject_Spot_arr[$flowre_id][$line_name][$job_id][$gmts_id]['reject_qnty_new'].'<br/>'.$prodAlterReject_Spot_arr[$flowre_id][$line_name][$job_id][$gmts_id]['alter_qnty_new'].'/'.$prodAlterReject_Spot_arr[$flowre_id][$line_name][$job_id][$gmts_id]['spot_qnty_new'];    
								    	?>
									</td>
