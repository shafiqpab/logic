...
if($action == "load_drop_down_supplier"){
	...
	if($data==3)
	{
			echo create_drop_down( "cbo_supplier", 110, "select a.id,a.supplier_name from lib_supplier a, lib_supplier_party_type b where a.id=b.supplier_id and b.party_type=23 and a.status_active=1 group by a.id,a.supplier_name order by a.supplier_name","id,supplier_name", 1, "--Select--", $selected, "" ); //Removed fnc_workorder_search(this.value); from load_location(); 's right side
		//}
	}
	else if($data==1)
		...
		echo create_drop_down( "cbo_supplier", 110, $blank_array,"", 1, "--- Select ---", $selected, "",0,0 ); //Removed fnc_workorder_search(this.value); from load_location(); 's right side

	exit();
	// echo create_drop_down( "cbo_supplier", 110, "select a.id,a.supplier_name from lib_supplier a, lib_supplier_party_type b where a.id=b.supplier_id and b.party_type=23 and a.status_active=1 group by a.id,a.supplier_name order by a.supplier_name", 1, "-- Select --", $selected, "" );    	 
	// exit();
}
...
<div style="width:1230px;">
    <table width="750" cellspacing="0" align="center">
        ...
        <tr>
            ...
            ?> 
        	<td><strong>Embel.Company<span style="float: right;">: &nbsp;</span> </strong></td>
        	<td>
        		<? 
		...
		?> 
	<div style="width:100%;">
	    <table align="right" cellspacing="0" width="1230"  border="1" rules="all" class="rpt_table" >
	        <thead bgcolor="#dddddd" align="center">
	            <th width="30">SL</th>
	            <th width="60">Sys. Chln. ID</th>
	            ...
	            <th width="80" align="center">Color/Size</th>
	                ...
	                ?>
	            <th width="80" align="center">Total Recv. Qty.</th>
