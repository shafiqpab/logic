...
//Knitting Production..................................................................
	...
	//$sql="select a.id,b.no_of_roll,b.grey_receive_qnty,a.booking_id,a.knitting_source,b.order_id,a.knitting_company, b.prod_id,b.yarn_lot,b.brand_id from inv_receive_master a, pro_grey_prod_entry_dtls b where a.id=b.mst_id and a.receive_basis=2 and a.company_id=$company_name and a.entry_form=2 and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 $po_con_knitting_pro";
       ...
       $sql="select a.booking_id,c.po_breakdown_id as order_id, c.quantity as grey_receive_qnty from inv_receive_master a, pro_grey_prod_entry_dtls b, order_wise_pro_details c where a.id=b.mst_id and b.id=c.dtls_id and a.entry_form=2 and c.entry_form=2  and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0  $po_con_knitting_pro";
...
//receive,issue.........................................................................
	...
	where a.prod_id=b.prod_id and c.dtls_id=b.id and a.id=b.trans_id and a.mst_id=c.mst_id and c.mst_id=b.mst_id and a.transaction_type in(1,4) and c.entry_form in(58,84) and a.company_id=$company_name and a.item_category=13 $po_con_rec_iss
	...
	where a.prod_id=b.prod_id and c.dtls_id=b.id and a.id=b.trans_id and a.mst_id=c.mst_id and c.mst_id=b.mst_id and a.transaction_type in(2) and c.entry_form in(61) and a.company_id=$company_name and a.item_category=13 $po_con_rec_iss
	group by c.booking_no,c.po_breakdown_id	,b.rack,b.self,c.barcode_no
	";
...
<?
	...
	$sql="select a.knitting_source,a.recv_number,a.receive_date,a.challan_no,1 as no_of_roll,b.brand_id,b.yarn_lot,c.qnty,c.booking_no,c.po_breakdown_id from inv_receive_master a, pro_grey_prod_entry_dtls b,pro_roll_details c where a.id=c.mst_id and b.id=c.dtls_id and a.id=b.mst_id and a.receive_basis =11 and a.company_id=3 and a.entry_form =22 and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1 and c.status_active=1 and c.is_deleted=0 and c.po_breakdown_id=$po_id and c.booking_no=$data and a.knitting_source=3";
	$sql_result=sql_select($sql);
		foreach( $sql_result as $row )
		{
			$key=$row[csf('recv_number')].'*'.$row[csf('receive_date')].'*'.$row[csf('challan_no')];
