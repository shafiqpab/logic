...
{ 
	...
	where a.id=b.mst_id and b.id=c.dtls_id and a.id=c.mst_id  and a.entry_date=$txt_date and company_id=$company_name $str_com_cond_lay and a.status_active in(1,2,3) and a.is_deleted=0 and b.status_active in(1,2,3) and b.is_deleted=0 and c.status_active in(1,2,3) and c.is_deleted=0 " ; 
	...
	$lay_sql = "SELECT e.color_id as color_number_id,b.id as po_id,a.style_ref_no,a.job_no, c.item_number_id,d.cutting_no,b.po_number,d.working_company_id,d.location_id,d.floor_id,a.buyer_name,b.pub_shipment_date,b.shiping_status  
		...
		where a.job_no=b.job_no_mst and b.id=c.po_break_down_id and d.job_no=a.job_no and b.id=f.order_id and d.id=e.mst_id  and a.job_no=c.job_no_mst and e.mst_id=f.mst_id and f.order_id=b.id and f.status_active=1 and f.is_deleted=0 and a.status_active=1 and a.is_deleted=0 and b.status_active in(1,2,3)  and b.is_deleted=0 and c.status_active in(1,2,3) and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0 and e.status_active=1  and e.is_deleted=0  $str_po_cond $company_cond_lay $color_ids_cond  $prod_po_id_lay 
		group by e.color_id,b.id  ,a.style_ref_no,a.job_no, c.item_number_id,d.cutting_no,b.po_number,d.working_company_id,d.location_id,d.floor_id,a.buyer_name,b.pub_shipment_date,b.shiping_status ";
		...
		$order_qnty_sqls="SELECT po_break_down_id,color_number_id,order_quantity,item_number_id from wo_po_color_size_breakdown where status_active=1 and is_deleted=0 $prod_po_id_lay $prod_color_id_lay ";
		...
		{
			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["today_cutting"]+=$vals[csf("today_cutting")];			 

			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["total_cutting"]+=$vals[csf("total_cutting")];
			 

			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["today_sewing_input"]+=$vals[csf("today_sewing_input")];

			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["total_sewing_input"]+=$vals[csf("total_sewing_input")];

			 
			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["today_emb_send_qnty"]+=$vals[csf("today_emb_send_qnty")];

			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["total_emb_send_qnty"]+=$vals[csf("total_emb_send_qnty")];


			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["today_emb_rcv_qnty"]+=$vals[csf("today_emb_rcv_qnty")];

			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["total_emb_rcv_qnty"]+=$vals[csf("total_emb_rcv_qnty")];

			$cutting_sewing_data[$vals[csf("style_ref_no")]][$vals[csf("job_no")]][$vals[csf("po_id")]][$vals[csf("item_number_id")]][$vals[csf("color_number_id")]]["order_quantity"]+=$vals[csf("order_quantity")];
		...
		<style type="text/css">
			...
			.gd-color3
			{
                ...
                <div>
                    ...
                    <div style="max-height:425px; overflow-y:auto; width:3060px" id="scroll_body">
                        <table border="1" cellpadding="0" cellspacing="0" class="rpt_table"  width="3040" rules="all" id="table_body" >
                        <?
                        $i=1;
						$jj=1;							
						$grand_color_total = 0;
									...
									foreach($item_data as $item_id=>$color_data)
									{
										foreach($color_data as $color_id=>$row)
										{
											...
											$possible_cut_pcs=$issue_qty/$result_consumtion[$job_id];
										 	...
										 	$order_qty = $order_qnty_array[$po_id][$item_id][$color_id];
											$today_cutting_qnty= $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_cutting"];
											$total_cutting_qnty= $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["total_cutting"];
											$color_wise_today_cutting+=$today_cutting_qnty;
											$color_wise_total_cutting+=$total_cutting_qnty;

											$today_sewing_input = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_sewing_input"];
											$total_sewing_input = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["total_sewing_input"];
											$today_emb_send_qnty = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_emb_send_qnty"];

											$total_emb_send_qnty = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["total_emb_send_qnty"];

											$today_emb_rcv_qnty = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_emb_rcv_qnty"];

											$total_emb_rcv_qnty = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["total_emb_rcv_qnty"];
											...
											$order_wise_lay_balance += ($order_qty - $order_wise_total_lay);

											$order_wise_today_input += $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_sewing_input"];
											...
											$grand_today_input += $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_sewing_input"];
											...
											$grand_inhand_qty += ($total_cutting_qnty-$total_sewing_input);
				                            	...
				                            	<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $jj; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $jj; ?>">
					                            	...
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100">
					                            		<a href="javascript:void(0)" onclick="openmypage_production_popup(<? echo $po_id;?>,<? echo $item_id;?>,<? echo $color_id;?>,0,'A','production_qnty_popup','Today Lay','600','300');">
					                            			<? echo $today_lay_qnty;?>					                            			
					                            		</a>
					                            	</td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100">
					                            		<a href="javascript:void(0)" onclick="openmypage_production_popup(<? echo $po_id;?>,<? echo $item_id;?>,<? echo $color_id;?>,0,'B','production_qnty_popup','Total Lay','730','300');">
					                            		<? echo $total_lay_qnty;?>	
					                            		</a>
					                            	</td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100"><? echo $lay_balance = $order_qty-$total_lay_qnty;?></td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100">
					                            		<a href="javascript:void(0)" onclick="openmypage_production_popup(<? echo $po_id;?>,<? echo $item_id;?>,<? echo $color_id;?>,1,'A','production_qnty_popup','Today Cutting','600','300');">
					                            			<? echo $today_cutting_qnty;?>					                            			
					                            		</a>
					                            	</td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100">
					                            		<a href="javascript:void(0)" onclick="openmypage_production_popup(<? echo $po_id;?>,<? echo $item_id;?>,<? echo $color_id;?>,1,'B','production_qnty_popup','Total Cutting','730','300');">
					                            	...
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100"><? echo number_format($today_emb_send_qnty,0); ?></td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100"><? echo number_format($total_emb_send_qnty,0); ?></td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100"><? echo number_format($today_emb_rcv_qnty,0) ;?></td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100"><? echo number_format($total_emb_rcv_qnty,0); ?></td> 
					                            	...
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100">
					                            		<a href="javascript:void(0)" onclick="openmypage_production_popup(<? echo $po_id;?>,<? echo $item_id;?>,<? echo $color_id;?>,4,'A','production_qnty_popup','Today Sewing Input','800','300');">
					                            			<? echo $today_input = $cutting_sewing_data[$style_id][$job_id][$po_id][$item_id][$color_id]["today_sewing_input"];?>					                            			
					                            		</a>
					                            	</td> 
					                            	<td align="right" style="word-wrap: break-word;word-break: break-all;" width="100">
					                            		<a href="javascript:void(0)" onclick="openmypage_production_popup(<? echo $po_id;?>,<? echo $item_id;?>,<? echo $color_id;?>,4,'B','production_qnty_popup','Total Sewing Input','730','300');">
						...
						?>
							<tr class="gd-color2">
				            	<td style="word-wrap: break-word;word-break: break-all;" width="960" colspan="9" align="right">Grand Total:</td>  
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="80"><b><? echo number_format($grand_color_total,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="160">&nbsp;</td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="90"><b><? echo number_format($grand_fab_req,2); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="90"><b><? echo number_format($grand_fin_fab_req,2); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="90"><b><? echo number_format($grand_fab_issued_balance,2); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="90"><b><? echo number_format($grand_fab_possible_qty,2); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_today_lay,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_total_lay,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_lay_balance,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_today_cutting,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_total_cutting,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_cut_balance,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_today_send,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_total_send,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_today_rcv,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_total_rcv,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_embl_balance,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_today_input,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_total_input,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_input_balance,0); ?></b></td> 
				            	<td style="word-wrap: break-word;word-break: break-all;" align="right" width="100"><b><? echo number_format($grand_inhand_qty,0); ?></b></td>
				        	</tr>
						</table>
