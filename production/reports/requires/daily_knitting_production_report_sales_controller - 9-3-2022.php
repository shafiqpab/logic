...
if($action=="report_generate")
{
	...
	else
	{
		...
		$tbl_width=2500+$width+count($shift_name)*60;
		ob_start();
		?>
		<table cellpadding="0" cellspacing="0" width="<? echo $tbl_width; ?>">
			<tr>
                            ...
                            foreach ($nameArray_inhouse as $row)
                            {
								...
								if($row[csf("knitting_source")]==3) // Out-bound
								{
									if($p==1)
									{
                                        ...
                                        <tr  bgcolor="#CCCCCC">
                                            <td colspan="<? echo $ship_count+30+$colspan; ?>" align="left" ><b>Outbound Subcontract</b></td>
                                        </tr>
                                        <?
                                        $total_grand_rejectQnty+=$grand_reject_qty;
								...
								else // In-house
								{
									if($q==1)
									{
										?>
                                        <tr  bgcolor="#CCCCCC">
                                            <td colspan="<? echo $ship_count+30+$colspan; ?>" align="left" ><b>In-House</b></td>
                                        </tr>
                                        <?
									}
									if($row[csf('machine_no_id')] != 0)
