...
if($action=="batch_report")
{
	...
	if($batch_type==0 || $batch_type==1)
	{
		...
		if((($all_booking_no_cond != "" || $sales_orders_cond != "" || $style_no_cond != "") && $all_fso_no_cond != "") || ($all_booking_no_cond == "" && $sales_orders_cond == "" && $style_no_cond =="" && $all_fso_no_cond == ""))
	   	{
			...
			from
			( select a.id,a.batch_against,a.entry_form,a.batch_no,a.batch_date,a.batch_weight,a.total_trims_weight,a.color_id,a.booking_no,a.extention_no, b.item_description,b.prod_id,b.po_id,sum(b.batch_qnty) as batch_qnty,c.job_no as fso_no,c.style_ref_no,a.dyeing_machine,listagg(d.dtls_id, ',') within group (order by d.dtls_id) as dtls_ids,c.po_buyer,c.buyer_id,c.within_group,b.body_part_id,count(b.id) as roll_no
				...
				group by a.id,a.batch_against,a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.color_id, a.booking_no,a.extention_no, b.item_description, b.prod_id,b.po_id, c.job_no,c.style_ref_no,a.dyeing_machine,a.total_trims_weight, c.po_buyer,c.buyer_id, c.within_group, b.body_part_id
				order by a.batch_no
			) x  left join pro_fab_subprocess e on x.id = e.batch_id and e.status_active =1
	    	group by x.id,x.batch_against,x.entry_form,x.batch_no,x.batch_date,x.batch_weight,x.total_trims_weight,x.color_id,x.booking_no,x.extention_no, x.item_description, x.prod_id, x.po_id, x.batch_qnty, x.fso_no, x.style_ref_no, x.dyeing_machine, x.dtls_ids, x.po_buyer, x.buyer_id, x.within_group, x.body_part_id, x.roll_no $load_unload_cond  order by x.batch_no,x.prod_id,x.extention_no desc";*/
	    	$sql="select x.*, max(e.load_unload_id) as load_unload_id
			from
			( select a.id,a.batch_against,a.entry_form,a.batch_no,a.batch_date,a.batch_weight,a.total_trims_weight,a.color_id,a.booking_no,a.extention_no, b.item_description,b.prod_id,b.po_id,sum(b.batch_qnty) as batch_qnty,c.job_no as fso_no,c.style_ref_no,a.dyeing_machine,c.po_buyer,c.buyer_id,c.within_group,b.body_part_id,count(b.id) as roll_no, a.remarks, a.process_id
				from pro_batch_create_mst a,pro_batch_create_dtls b,fabric_sales_order_mst c
				where a.company_id=$company and a.status_active=1 $dates_com $batch_num $ext_no $all_fso_no_cond $batch_against_cond $style_no_cond_2 and a.is_sales=1 and a.id=b.mst_id and b.po_id=c.id and b.is_deleted=0 and c.status_active=1
				group by a.id,a.batch_against,a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.color_id, a.booking_no,a.extention_no, b.item_description, b.prod_id,b.po_id, c.job_no,c.style_ref_no,a.dyeing_machine,a.total_trims_weight, c.po_buyer,c.buyer_id, c.within_group, b.body_part_id, a.remarks, a.process_id
				order by a.batch_no
			) x  left join pro_fab_subprocess e on x.id = e.batch_id and e.status_active =1
	    	group by x.id,x.batch_against,x.entry_form,x.batch_no,x.batch_date,x.batch_weight,x.total_trims_weight,x.color_id,x.booking_no,x.extention_no, x.item_description, x.prod_id, x.po_id, x.batch_qnty, x.fso_no, x.style_ref_no, x.dyeing_machine, x.po_buyer, x.buyer_id, x.within_group, x.body_part_id, x.roll_no, x.remarks, x.process_id $load_unload_cond  order by x.batch_no,x.prod_id,x.extention_no desc";
	    	// echo $sql;
		...
		if($batch_type==0 || $batch_type==1)
		{
			...
			{
				$grey_production_dtls_id_arr[] = $batch[csf("po_id")];
		...
		if(!empty($grey_production_dtls_id_arr))
		{
			...
			{
				/*$yarn_lot_arr[$rows[csf('dtls_id')]][$rows[csf('prod_id')]][$rows[csf('po_id')]]['yarn_prod_id'].=$rows[csf('yarn_prod_id')].',';
				$yarn_lot_arr[$rows[csf('dtls_id')]][$rows[csf('prod_id')]][$rows[csf('po_id')]]['machine_no_id'].=$rows[csf('machine_no_id')].',';
				$yarn_lot_arr[$rows[csf('dtls_id')]][$rows[csf('prod_id')]][$rows[csf('po_id')]]['machine_dia'].=$rows[csf('machine_dia')].',';
				$yarn_lot_arr[$rows[csf('dtls_id')]][$rows[csf('prod_id')]][$rows[csf('po_id')]]['machine_gg'].=$rows[csf('machine_gg')].',';*/
		...
		if($db_type==2)
		{
			$machine_name_arr  = return_library_array("select id,machine_no || '-' || brand as machine_name from lib_machine_name where status_active=1 and is_deleted=0 and is_locked=0 order by seq_no","id","machine_name");
		}
		else if($db_type==0)
		{
			$machine_name_arr  = return_library_array("select id,concat(machine_no,'-',brand) as machine_name from lib_machine_name where status_active=1 and is_deleted=0 and is_locked=0 order by seq_no","id","machine_name");
		}
	...
	if(($batch_type==0 || $batch_type==2) && ($txt_booking_no_show == "" && $fso_number_show == ""))
	{
	    ...
	    if((($cust_style_cond != "" || $jobdata != "" || $party_cond != "") && $all_search_ord_cond != "") || ($cust_style_cond == "" && $jobdata == "" && $party_cond == ""))
	    {
			...
			from (select a.id, a.batch_against, a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.total_trims_weight, a.color_id, a.booking_no, a.extention_no, b.item_description, b.grey_dia, b.gsm, b.prod_id, b.po_id, sum(b.batch_qnty) as batch_qnty, '' as fso_no, '' as style_ref_no, a.machine_no, '' as dtls_ids, 0 as po_buyer, count(b.roll_no) as roll_no, a.remarks, a.process_id from pro_batch_create_mst a, pro_batch_create_dtls b
			...
			group by a.id, a.batch_against, a.entry_form, a.batch_no, a.batch_date, a.batch_weight, a.color_id, a.booking_no, a.extention_no, b.item_description, b.grey_dia, b.gsm, b.prod_id, b.po_id,  a.machine_no, a.total_trims_weight, a.remarks, a.process_id
			order by a.batch_no
			) x left join pro_fab_subprocess e on x.id = e.batch_id and e.status_active =1
			group by x.id, x.batch_against, x.entry_form, x.batch_no, x.batch_date, x.batch_weight, x.total_trims_weight, x.color_id, x.booking_no, x.extention_no, x.item_description, x.grey_dia, x.gsm, x.prod_id, x.po_id, x.batch_qnty,  x.fso_no,  x.style_ref_no, x.machine_no,  x.dtls_ids,  x.po_buyer,  x.roll_no, x.remarks, x.process_id $load_unload_cond";
        ...
        <fieldset style="width:2285px;">
            ...
            <div align="left">
                ...
                { ?>
                    ...
                    <table class="rpt_table" width="2465" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
                        <thead>
                            <tr>
                                ...
                                <th class="word_wrap_break" width="80">Buyer</th>
                                <th class="word_wrap_break" width="60">Job No</th>
                                <th class="word_wrap_break" width="70">Style No</th>
                                <th class="word_wrap_break" width="110">FSO No</th>
                                <th class="word_wrap_break" width="120">Fabric Booking No.</th>
                                <th class="word_wrap_break" width="50">Booking Type</th>
                                <th class="word_wrap_break" width="70">Short Booking Type</th>
                                <th class="word_wrap_break" width="70">Body Part</th>
                                <th class="word_wrap_break" width="100">Construction</th>
                                <th class="word_wrap_break" width="150">Fab. Composition</th>
                               <!--  <th width="50">Booking Dia</th> -->
                                ...
                                <th class="word_wrap_break" width="50">M/C No</th>
                                <th class="word_wrap_break" width="50">M/C Dia & Gauge</th>
                                <th class="word_wrap_break" width="70">Yarn Count</th>
                                <th class="word_wrap_break" width="120">Yarn Composition</th>
                                <th class="word_wrap_break" width="70">Yarn Type</th>
                                <th class="word_wrap_break" width="70">Yarn Brand</th>
                                <th class="word_wrap_break" width="100">Y.Lot No</th>
                                ...
                                <th class="word_wrap_break" width="40">No of Roll</th>
                    ...
                    <div style=" max-height:350px; width:2485px; overflow-y:scroll;" id="scroll_body">
                        <table class="rpt_table" id="table_body" width="2465" cellpadding="0" cellspacing="0" border="1" rules="all">
                            <tbody>
                                <?
                                $i=1;$btq=0;
                                foreach($batchdata as $batch)
                                {
                                    ...
                                    {
                                        /*$yarn_prod_ids .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]][$batch[csf('po_id')]]['yarn_prod_id'].',';
                                        $machine_gg_no .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]][$batch[csf('po_id')]]['machine_gg'].',';
                                        $machine_dia .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]][$batch[csf('po_id')]]['machine_dia'].',';
                                        $machine_no_id .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]][$batch[csf('po_id')]]['machine_no_id'].',';*/
                                        $yarn_prod_ids .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]]['yarn_prod_id'].',';
                                        $machine_gg_no .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]]['machine_gg'].',';
                                        $machine_dia .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]]['machine_dia'].',';
                                        $machine_no_id .= $yarn_lot_arr[$dtlid][$batch[csf('prod_id')]]['machine_no_id'].',';
                                    }
                                    ...
                                    <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
                                        ...
                                        <td class="word_wrap_break" width="60" title="<? echo $batch[csf('id')]; ?>"><p><? echo $batch[csf('batch_no')]; ?></p></td>
                                        <td class="word_wrap_break" width="40" title="<? echo $batch[csf('extention_no')]; ?>"><p><? echo $batch[csf('extention_no')]; ?></p></td>
                                        <td class="word_wrap_break" width="80"><p><? echo $batch_against[$batch[csf('batch_against')]]; ?></p></td>
                                        ...
                                        <td width="70" class="word_wrap_break" align="center"><? echo $load_unload_arr[$batch_status];?></td>
                    ...
                    <table class="rpt_table" width="2465" cellpadding="0" cellspacing="0" border="1" rules="all">
                        <tfoot>
                            <tr>
                            	<th width="30">&nbsp;</th>
                                <th width="75">&nbsp;</th>
                ...
                { ?>
                    <div align="center" style="width:1658px;"><b>Inbound Subcontract</b></div>
                    <table class="rpt_table" width="1640" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
                        <thead>
                            <tr>
                                <th class="word_wrap_break" width="30">SL</th>
                                <th class="word_wrap_break" width="75">Batch Date</th>
                    ...
                    <div style="max-height:350px; width:1658px; overflow-y:scroll;" id="scroll_body_subcon">
                        <table class="rpt_table" width="1640" id="table_body2" cellpadding="0" cellspacing="0" border="1" rules="all">
                            <tbody>
                                <?
                                ...
                                foreach($subbatchdata as $row)
                                {
                                    ...
                                    <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<? echo $i; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')">
                                        ...
                                        <td class="word_wrap_break" width="60" title="<? echo $row[csf('id')]; ?>"><p><? echo $row[csf('batch_no')]; ?></p></td>
                                        ...
                                        <td width="100"><p class="word_wrap_break"><? echo $sub_ord_arr[$row[csf('po_id')]]['job']; ?></p></td>
                                        ...
                                        <td width="50" align="center"><p class="word_wrap_break"><? echo $row[csf('grey_dia')]; ?></p></td>
