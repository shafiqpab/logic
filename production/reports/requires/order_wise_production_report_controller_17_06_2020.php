			...
			{				 
				...
				{  //echo $unit_price.'/'.$ratio.'*'.$set_qnty.',';
					...
					$html.='<td  style="word-wrap: break-word;word-break: break-all;"  width="30">'.$display_font_color.$i.$font_end.'</td>
								...
								<td  style="word-wrap: break-word;word-break: break-all;"   width="35" onclick="openmypage_image(\'requires/order_wise_production_report_controller.php?action=show_image&job_no='.$job_no.'\',\'Image View\')"><img src="../../'.$imge_arr[$job_no].'" height="25" width="30" /></td>
	    ...
	    <div>
	        ...
	        <div style="float:left; width:1430px" id="details_reports">
	            ...
	            <div style="max-height:425px; overflow-y:scroll; width:1430px" id="scroll_body1">
	                <table cellspacing="0" border="1" class="rpt_table"  width="1410" rules="all">
	                <?
						...
						foreach($buyer_array as $buyer_id=>$value)
	                    {
	                        ...
	                        <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_1nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_1nd<? echo $i; ?>">
	                            <td  style="word-wrap: break-word;word-break: break-all;"  width="30"><? echo $i;?></td>
	                ...
	                <table border="1" class="tbl_bottom"  width="1410" rules="all">
	                    <tr> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="30">&nbsp;</td> 
	                        <td  style="word-wrap: break-word;word-break: break-all;"  width="100" align="right">Total</td> 
	        ...
	        <table width="3560" cellspacing="0" border="1" class="rpt_table" rules="all" id="table_header_1">
	            <thead>
	                <tr style="font-size:11px">
	                    <th  style="word-wrap: break-word;word-break: break-all;"  width="30">SL</th>    
	        ...
	        <div style="max-height:425px; overflow-y:scroll; width:3580px" id="scroll_body">
	            <table border="1" class="rpt_table" width="3560" rules="all" id="table_body">
					<? echo $html; ?>  
	            </table>	
	            

				<table border="1" class="tbl_bottom" width="3560" rules="all" id="report_table_footer_1" >
	                <tr>
	                    <td  style="word-wrap: break-word;word-break: break-all;"  width="30"></td>
