...
if($action=="generate_report")
{
 ...
 if($cbo_status)
 {
   ...
   <script>  hs_chart(1,<? echo $total_po_qty;?>,<? echo $total_pass_qty;?>,<? echo ($total_po_qty-$total_pass_qty);?>); </script>
   </div>
    </fieldset>
   </td>
                ...
                <table class="rpt_table" border="1" rules="all" width="<?= $width;?>" align="left">
                    <thead>
                        <tr>
                            ...
                            <th width="100">Order Qty</th>
                            <th width="100">Inspec. Qty</th>
                            <th width="100">Passed Qty</th>
                            <th width="100">Yet to Inspect</th>
                            <th width="100">Inspec. Status</th>
                            <th width="80">Inspection Date</th>
                            <th width="60">Re-Check Count</th>
                            <th width="60">Fail Count</th>
                            <th width="60">Fail Reason</th>
                            <th width="60">Exf. Qty.</th>
                            <th width="60">Date</th>
                    ...
                    $i=1;
					   ...
					   $bgcolor=($i%2==0)?"#E9F3FF":"#FFFFFF" ; 
	                    ...
	                    <tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
	                        ...
	                        <td width="40" align="center" onclick="openmypage_image('requires/inspection_followup_report_controller.php?action=show_image&job_no=<? echo $row["job_no"] ?>','Image View')" style="word-wrap: break-word;word-break: break-all;"><img  src='../../<? echo $imge_arr[$row['job_no']]; ?>' height='25' width='30' />
	                        </td>
	                        ...
	                        <td align="right" width="100">
								<?
									echo "<a href='#report_details' style='color:#990000' onclick= \"open_popup('".$row['po_id']."','Inspection Quantity');\">".$ins_data_arr[$row['po_id']]['ins_qty']."</a>";
								?>
	                        </td>
	                        <td align="right" width="100">
								<?
									echo "<a href='#report_details' style='color:#990000' onclick= \"open_popup('".$row['po_id']."','Pass Quantity');\">".$ins_data_arr[$row['po_id']]['pass_qty']."</a>";
								?>
	                        </td>
	                        ...
	                        <td align="right" width="60"><? echo $ins_data_arr[$row['po_id']]['fail_count'];?></td>
	                         <td align="right" width="60"><?= implode(',',$ins_data_arr[$row['po_id']]['INS_REASON']);?></td>
                            
                            
                            
                            <td align="right" width="60"><? echo number_format($exQty,0);?></td>
	                        <td align="center" width="60"><? echo change_date_format($exDate);?></td>
	                        <td align="center" width="100"><? echo $ins_status;?></td>
	                        <td width="100"><p><? echo $ins_data_arr[$row['po_id']]['ins_by'];?></p></td>
	                         <td><?= implode(',',$ins_data_arr[$row['po_id']]['COMMENTS']);?></td>
...
if($action=="order_inspection_details")
{
	...
	$sql= "select a.week_id,a.po_break_down_id,a.inspected_by,a.inspection_company,a.inspection_date,a.inspection_qnty,a.inspection_status, a.inspection_level, a.inspection_cause,a.week_id,a.country_id,a.comments,b.pub_shipment_date from  pro_buyer_inspection a,wo_po_break_down b  where a.status_active=1 and b.status_active in(1,2,3) and a.is_deleted=0 and a.po_break_down_id=$order_id and a.po_break_down_id=b.id"; 
//echo $sql;
...
<table width="1000" class="rpt_table" border="1" rules="all">
    <thead>
        ...
        <th width="100">Inspection By</th>
        <th width="100">Inspection Level</th>
...
?>
    <tr bgcolor="<? echo $bgcolor;?>" id="tr_<? echo $i;?>" style="cursor:pointer;">
        ...
        <td><? echo $inpLevelArray[$row[csf('inspection_level')]];?></td>
