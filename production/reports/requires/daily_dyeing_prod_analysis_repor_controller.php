...
if($action=="report_generate") // show
{
    ...
    <div>
        ...
        if ($type==1) // SELF SQL
        {
			$sql_data="SELECT b.id,b.extention_no,a.batch_id, a.company_id as dyeing_company,a.service_company , a.process_end_date as production_date, a.production_date as process_end_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min,b.total_trims_weight, min(c.prod_id) as prod_id, c.po_id, sum(c.batch_qnty) as qnty
			...
			group by b.id,b.extention_no, a.batch_id, a.company_id,a.service_company , a.process_end_date, a.production_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min,b.total_trims_weight, c.po_id order by a.process_end_date";
			// echo $sql_data;die;
        }
        else if ($type==2) // SUBCON SQL
        {
        ...
        else if ($type==4) // OTHERS SQL
        {
            ...
            group by b.id,b.extention_no, a.batch_id, a.company_id,a.service_company , a.process_end_date, a.production_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min, c.po_id order by a.process_end_date";            
            //echo $others_sql; die;
        }
        else // All SQL
        {
        	// SELF
        	$self_sql="SELECT b.id,b.extention_no,a.batch_id, a.company_id as dyeing_company,a.service_company , a.process_end_date as production_date, a.production_date as process_end_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min,b.total_trims_weight, min(c.prod_id) as prod_id, c.po_id, sum(c.batch_qnty) as qnty
			from pro_fab_subprocess a, pro_batch_create_mst b, pro_batch_create_dtls c 
			where a.batch_id=b.id and a.entry_form=35 and a.load_unload_id=2 and b.id=c.mst_id   and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and b.batch_against  in(1,2) and b.is_sales!=1 $date_cond $floor_cond $working_company_cond $lc_company_cond $batch_cond $book_cond 
			group by b.id,b.extention_no, a.batch_id, a.company_id,a.service_company , a.process_end_date, a.production_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min,b.total_trims_weight, c.po_id order by a.process_end_date";
			// echo $self_sql;die;
			...
			// SUBCON
			$subcon_sql="SELECT b.id,b.extention_no, a.batch_id, a.company_id as dyeing_company,a.service_company, a.process_end_date as production_date, a.production_date as process_end_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.color_range_id, b.dur_req_hr, b.dur_req_min, b.total_trims_weight, min(c.prod_id), c.po_id, sum(c.batch_qnty) as qnty 
            FROM pro_fab_subprocess a, pro_batch_create_mst b,  pro_batch_create_dtls c 
            WHERE a.batch_id=b.id and a.entry_form=38 and a.load_unload_id=2 and b.id=c.mst_id  and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0  $batch_cond $book_cond $date_cond $floor_cond  $lc_company_cond $working_company_cond 
            GROUP BY b.id, b.extention_no,a.batch_id, a.company_id,a.service_company, a.process_end_date, a.production_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.color_range_id, b.dur_req_hr, b.dur_req_min, b.total_trims_weight, c.po_id order by a.process_end_date";

            // SAMPLE
            $sample_sql="SELECT b.id,b.extention_no,a.batch_id, a.company_id as dyeing_company,a.service_company , a.process_end_date as production_date, a.production_date as process_end_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_without_order,b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min, min(c.prod_id) as prod_id, c.po_id, sum(c.batch_qnty) as qnty
            from pro_fab_subprocess a, pro_batch_create_mst b, pro_batch_create_dtls c 
            where a.batch_id=b.id and a.entry_form=35 and a.load_unload_id=2 and b.id=c.mst_id  and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and b.batch_against in(3,2) and b.is_sales!=1 $floor_cond $working_company_cond $lc_company_cond  $date_cond $batch_cond $book_cond 
            group by b.id,b.extention_no, a.batch_id, a.company_id,a.service_company , a.process_end_date, a.production_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id,b.booking_without_order, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min, c.po_id order by  a.process_end_date";

            // OTHERS
            $others_sql="SELECT b.id,b.extention_no,a.batch_id, a.company_id as dyeing_company,a.service_company , a.process_end_date as production_date, a.production_date as process_end_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min, min(c.prod_id) as prod_id, c.po_id, sum(c.batch_qnty) as qnty
            from pro_fab_subprocess a, pro_batch_create_mst b, pro_batch_create_dtls c 
            where a.batch_id=b.id and a.entry_form=35 and a.load_unload_id=2 and b.id=c.mst_id  and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and b.batch_against  in(5,7) and b.is_sales!=1  $floor_cond $working_company_cond $lc_company_cond $date_cond $batch_cond $book_cond 
            group by b.id,b.extention_no, a.batch_id, a.company_id,a.service_company , a.process_end_date, a.production_date, a.machine_id, a.end_hours, a.end_minutes, a.remarks, b.batch_no, b.color_id, b.booking_no, b.color_range_id, b.dur_req_hr, b.dur_req_min, c.po_id order by a.process_end_date";
        }

        if ($type==0) // ALL TYPE ARRAY
		{
			$self_nameArray=sql_select($self_sql); 
			$tot_rows=count($self_nameArray);
			$sql_sub_result=sql_select($subcon_sql);
			$tot_rows=count($sql_sub_result);
			$samp_nameArray=sql_select($sample_sql);
			$others_nameArray=sql_select($others_sql);
			$tot_rows=count($others_nameArray);

			$batch_id_array = array();
			$all_prod_id="";
            foreach ( $self_nameArray as $row ) // SELF ARRAY
            {
                ...
                if($fb_booking_no=='FB' || $fb_booking_no=='Fb') //echo $fb_booking_no.'A';else echo $fb_booking_no.'B';
                {
					...
					$bulk_po_arr[$row[csf('po_id')]]=$row[csf('po_id')];
                }
            }

			foreach( $sql_sub_result as $row) // SUBCON ARRAY
			{
				$batch_id_array[$row[csf('id')]]=$row[csf('id')];
				$subc_batch_wise_array[$row[csf('batch_id')]]['id']= $row[csf('id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['batch_id']= $row[csf('batch_id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['extention_no']= $row[csf('extention_no')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['company_id']= $row[csf('company_id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['dyeing_company']= $row[csf('dyeing_company')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['service_company']= $row[csf('service_company')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['production_date']= $row[csf('production_date')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['process_end_date']= $row[csf('process_end_date')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['machine_id']= $row[csf('machine_id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['end_hours']= $row[csf('end_hours')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['end_minutes']= $row[csf('end_minutes')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['remarks']= $row[csf('remarks')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['batch_no']= $row[csf('batch_no')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['color_id']= $row[csf('color_id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['color_range_id']= $row[csf('color_range_id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['dur_req_hr']= $row[csf('dur_req_hr')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['dur_req_min']= $row[csf('dur_req_min')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['trims_qty']+= $row[csf('total_trims_weight')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['prod_id']= $row[csf('prod_id')];
                $subc_batch_wise_array[$row[csf('batch_id')]]['po_id'].= $row[csf('po_id')].',';
                $subc_batch_wise_array[$row[csf('batch_id')]]['qnty']= $row[csf('qnty')];

                $subcon_po_id_arr[$row[csf('po_id')]]=$row[csf('po_id')];
			}

            foreach ( $samp_nameArray as $row ) // SAMPLE ARRAY
            {
                $batch_id_array[$row[csf('batch_id')]] = $row[csf('batch_id')];
                ...
                if($sm_booking_no=='SM' || $sm_booking_no=='SMN') 
                {
                    ...
                    $smn_booking_id_arr[$row[csf('po_id')]]=$row[csf('po_id')];
                }
            }

            foreach ( $others_nameArray as $row ) // OTHERS ARRAY
            {
                $batch_id_array[$row[csf('batch_id')]] = $row[csf('batch_id')];
                $booking_no_arr=explode("-",$row[csf('booking_no')]);
                $fb_booking_no=$booking_no_arr[1];
		...
		else // INDIVIDUAL ARRAY
		{
	    	...
	    	{
	    		if($type==1) // SELF ARRAY
	    		{
		            $batch_id_array[$row[csf('batch_id')]] = $row[csf('batch_id')];
					$prod_id_array[$row[csf('prod_id')]] = $row[csf('prod_id')];
	                $booking_no_arr=explode("-",$row[csf('booking_no')]);
	                $fb_booking_no=$booking_no_arr[1];
	                if($fb_booking_no=='FB' || $fb_booking_no=='Fb') //echo $fb_booking_no.'A';else echo $fb_booking_no.'B';
	                {
		...
		// echo '<pre>';print_r($self_batch_wise_array);die;

		fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 139, 2, $batch_id_array, $empty_arr);//batch id
		fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 139, 3, $bulk_po_arr, $empty_arr);//bulk po
		fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 139, 4, $smn_booking_id_arr, $empty_arr);//smn book id
		fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 139, 5, $subcon_po_id_arr, $empty_arr);//sub po id
		fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 139, 6, $prod_id_array, $empty_arr);//Prod id

		if($type==0 || $type==1 || $type==3 || $type==4) // PO data arr
        {
            $gsm_library=return_library_array( "select b.id,b.gsm from  product_details_master b ,GBL_TEMP_ENGINE g where b.status_active=1 and g.ref_val=b.id and g.user_id=$user_id and g.ref_from=6 and g.entry_form=139", "id", "gsm");

            $order_arr=array();
            $sql_order="SELECT b.id as ID, a.job_no as JOB_NO, a.buyer_name as BUYER_NAME, a.style_ref_no as STYLE_REF_NO, b.po_number as PO_NUMBER, b.po_quantity as PO_QUANTITY 
            from GBL_TEMP_ENGINE g, wo_po_break_down b, wo_po_details_master a 
            where g.ref_val=b.id and g.user_id=$user_id and g.ref_from=3 and g.entry_form=139 and b.job_id=a.id and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1";
            $result_sql_order=sql_select($sql_order);//and b.id=48911
            ...
            where g.ref_val=a.id and g.user_id=$user_id and g.ref_from=4 and g.entry_form=139 and a.booking_no=b.booking_no and a.booking_type=4 and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1";
            ...
            $job_arr=array();
            $sql_job="SELECT b.id, a.subcon_job, a.party_id, b.cust_style_ref, b.order_no, b.order_quantity
            from GBL_TEMP_ENGINE g, subcon_ord_dtls b, subcon_ord_mst a 
            where g.ref_val=b.id and g.user_id=$user_id and g.ref_from=5 and g.entry_form=139 and b.job_no_mst=a.subcon_job and a.is_deleted=0 and a.status_active=1 and b.is_deleted=0 and b.status_active=1";
			...
			unset($result_sql_job);
        }

		// LOAD SQL================START
		$load_time_data=sql_select("SELECT a.id,a.batch_id, a.entry_form,a.batch_no,a.load_unload_id,a.process_end_date,a.end_hours,a.end_minutes 
		from GBL_TEMP_ENGINE g, pro_fab_subprocess a 
		where g.ref_val=a.batch_id and g.user_id=$user_id and g.ref_from=2 and g.entry_form=139 and a.load_unload_id=1 and a.entry_form=35 and  a.status_active=1  and a.is_deleted=0 $working_company_cond $lc_company_cond");
		$load_data=array();$load_data_sub=array();
		foreach($load_time_data as $row_time)// for Loading time
        {
        	if ($row_time[csf('entry_form')]==35) 
        	{
		...
		// ==============================START============================
		$batch_quantity_arr=return_library_array( "SELECT a.id,sum(b.batch_qnty) as  batch_qnty from  GBL_TEMP_ENGINE g, pro_batch_create_mst a, pro_batch_create_dtls b 
		where g.ref_val=a.id and g.user_id=$user_id and g.ref_from=2 and g.entry_form=139 and a.id=b.mst_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 
		group by a.id", "id", "batch_qnty");

		$sql_recipe= "SELECT a.entry_form, b.batch_against, b.id as batch_id,b.batch_weight,b.batch_no,b.booking_no,b.color_id,b.color_range_id,c.id as recipe_id,d.sub_process_id,d.sub_seq,d.liquor_ratio 
		from pro_fab_subprocess a, pro_batch_create_mst b, pro_recipe_entry_mst c, pro_recipe_entry_dtls d 
		where a.batch_id=b.id and b.id=c.batch_id and c.id=d.mst_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 $date_cond $floor_cond $working_company_cond $lc_company_cond $batch_cond $book_cond  order by d.sub_seq";
		// echo $sql_recipe; die;
		$result_data_recipe=sql_select($sql_recipe);
		foreach ($result_data_recipe as $row)
		{
			if ($row[csf("entry_form")]==38) // subcon
			{
			...
			elseif ($row[csf("entry_form")]==35) // sample
			{
			...
			elseif ($row[csf("entry_form")]==35 && ($row[csf("entry_form")]==5 || $row[csf("entry_form")]==7)) // others
			{
        ...
        if($batch_id) $batch_idCond1=" and b.batch_id like '%$batch_id%' ";else $batch_idCond1="";
	 	...
	 	/*$chem_dye_cost_sql="SELECT a.mst_id, b.batch_id,a.item_category, sum(a.cons_amount) as cons_amount 
	 	from inv_transaction a, dyes_chem_issue_dtls b, inv_issue_master c 
	 	where a.id=b.trans_id  and c.id=a.mst_id  and c.id=b.mst_id and c.entry_form in(5) AND b.item_category in (5,6,7) AND b.is_deleted=0 AND b.status_active=1 $lc_company_cond_issue2 $working_company_cond_issue $batch_idCond1 
	 	group by a.mst_id, b.batch_id,a.item_category ";*/ // shlow

	 	// and c.ISSUE_NUMBER='BKL-DCI-23-82766'
		$chem_dye_cost_sql="SELECT a.id, a.mst_id, a.batch_id, a.item_category, a.cons_amount as cons_amount
		from inv_transaction a, inv_issue_master c, DYES_CHEM_ISSUE_REQU_DTLS d, DYES_CHEM_ISSUE_REQU_DTLS_CHILD e, GBL_TEMP_ENGINE g
		where a.mst_id=c.id and c.req_no=d.mst_id and d.id=e.DTLS_ID and to_char(g.ref_val)=e.batch_id and g.user_id=$user_id and g.ref_from=2
		and c.entry_form in(5) AND A.ITEM_CATEGORY in (5,6,7) AND A.RECEIVE_BASIS=7
		$lc_company_cond_issue2 $working_company_cond_issue
		group by a.id, a.mst_id, a.batch_id, a.item_category, a.cons_amount
		union all
		SELECT a.id, a.mst_id, a.batch_id, a.item_category, a.cons_amount as cons_amount
		from GBL_TEMP_ENGINE g, inv_transaction a, inv_issue_master c
		where to_char(g.ref_val)=a.batch_id and g.user_id=$user_id and g.ref_from=2 and g.entry_form=139 and a.mst_id=c.id
		and c.entry_form in(5) AND A.ITEM_CATEGORY in (5,6,7) AND A.RECEIVE_BASIS!=7
		$lc_company_cond_issue2 $working_company_cond_issue
		group by a.id, a.mst_id, a.batch_id, a.item_category, a.cons_amount";
		//and c.ISSUE_NUMBER='MKD-DCI-23-65510'
        ...
        // echo '<pre>';print_r($chem_dye_cost_array);die;
        ...
        {
            fnc_tempengine("GBL_TEMP_ENGINE", $user_id, 139, 1, $all_issue_id, $empty_arr);//mst_id
        
      		//  if($batch_id) $batch_idCond=" and p.batch_no like '%$batch_id%' ";else $batch_idCond="";
            $sql_return_cost="SELECT a.mst_id as MST_ID,p.batch_no as BATCH_ID,a.ITEM_CATEGORY, (a.cons_amount) as CONS_AMOUNT  
            from inv_issue_master p, inv_transaction a, inv_receive_master b, GBL_TEMP_ENGINE g 
            where p.id=a.issue_id and b.id=a.mst_id and a.item_category in(5,6,7) $lc_company_cond  and b.is_deleted=0 and b.status_active=1   and a.issue_id=g.ref_val  and g.user_id = ".$user_id." and g.ref_from=1 and g.entry_form=139  ";

            // echo $sql_return_cost;die;
            $cost_return_data_arr=array();
            $others_cost_return_data_arr=array();
            ...
            foreach ($sql_return_res as $row)
            {
                ...
                foreach($batch_id_arr as $batch_id)
                {
                    if($batch_quantity_arr[$batch_id]>0)
                    {
                        ...
                        $others_cost_return_data_arr[$batch_id][$row[('ITEM_CATEGORY')]]+=$row[('CONS_AMOUNT')];
                    }                                
                }
            }
           	// echo "<pre>"; print_r($cost_return_data_arr);die;
        }
        // ==============================END=====================================
            ...
            <div style="width:2790px; overflow-y:scroll; max-height:275px;" id="scroll_body" >
                ...
                foreach ( $self_batch_wise_array as $batch_id=>$row )
                {
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                        ...
                        ?></p></td>
                        <td width="120"><p><? echo $buyer_all; echo $buyer_library[$non_order_arr[$row[('booking_no')]]['buyer_name']]; //C?></p></td>
                        ...
                        <td width="60" align="center"><p><? echo $gsm_library[$row[('prod_id')]];//A ?></p></td>
                        <td width="100"><p><? echo $color_library[$row[('color_id')]];//D ?></p></td>
        ...
        if($type==0 || $type==2) // Subcon
        {
            ...
            <div style="width:2590px; overflow-y:scroll; max-height:275px;" id="scroll_body" >
                <table width="2570" border="1" rules="all" class="rpt_table" cellpadding="0" cellspacing="0" id="table_body1">
	                ...
	                foreach ( $subc_batch_wise_array as $row )
	                {
	                    ...
	                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color_sub('row_<? echo $k; ?>','<? echo $bgcolor; ?>')" id="row_<? echo $k; ?>">
							...
							$sub_liquor_ratio=$sub_liquor_ratio_allArr[0]; 
	                        ?></p></td>
	                        <td width="120"><p><? echo $buyer_library[$buyer_all]; ?></p></td>
	                        <td width="130"><p><? echo $style_all;  ?></p></td>
	                        <td width="140"><p><? echo $po_all;?></p></td>
	                        <td width="100" align="right"><p><? echo number_format($po_qnty,0);  ?></p></td>
	                        <td width="100"><p><? echo $row[('batch_no')]; ?></p></td>
	                        <td width="50"><p><? echo $row[('extention_no')]; ?></p></td>
	                        <td width="100"><p><? echo $color_library[$row[('color_id')]];//C ?></p></td>
	                        <td width="100" align="center"><p><? echo $machine_cap_array[$row[('machine_id')]]["machine_no"]; ?></p></td>
	                        <td width="90" align="right"><p><? $machine_capacity=$machine_cap_array[$row[('machine_id')]]["prod_capacity"]; echo number_format($machine_capacity,2,'.',''); ?></p></td>
	                        <td width="70" align="right"><p><? echo change_date_format($row[('production_date')]); ?></p></td>
	                        <td width="100" align="right"><p><? echo number_format($row[('qnty')],2,'.',''); $total_sub_dyeing_qnty+=$row[('qnty')]; ?></p></td>
	                        <td width="100" align="right"><p><? echo number_format($row[('total_trims_weight')],2,'.',''); $total_trims_qnty+=$row[('total_trims_weight')]; ?></p></td>
	                        <td width="60" align="right"><p><? $ul_percent=$row[('qnty')]/$machine_capacity*100; echo number_format($ul_percent,2,'.',''); ?></p></td>
	                        <td width="60" align="center"><p><? $req_hour=""; $req_hour=$row[('dur_req_hr')].":".$row[('dur_req_min')]; echo $req_hour; ?></p></td>
	                        <td width="80" align="center"><p><? $start_time=''; $start_time=$load_data_sub[$row[('id')]]['end_hours'].':'.$load_data_sub[$row[('id')]]['end_minutes']; echo  $start_time; ?></p></td>
	                        <td width="80" align="center"><p><? $end_time=''; $end_time=$row[('end_hours')].':'.$row[('end_minutes')]; echo $end_time; ?></p></td>
	                         <td width="100" align="center" title="<? echo $sub_sid_ratio_all;?>"><p><?  echo $sub_liquor_ratio; ?></p></td>
	                         
	                        <td width="70" align="right"><p><? $start_time=strtotime($load_data_sub[$row[('id')]]['process_end_date']." ".$start_time); $end_time=strtotime($row[('process_end_date')]." ".$end_time);  $timeDiffin=($end_time-$start_time)/60;
	                         if($timeDiffin>0)
	                         {  
	                             $time_used=convertMinutes2Hours($timeDiffin); 
	                             echo $time_used ;
	                        ...
	                        <td width="110" align="right"><p><? $subcon_dye_cost =$chem_dye_cost_array[$row[('batch_id')]][6]; echo number_format($subcon_dye_cost,2,'.',''); ?></p></td>
	                        <td width="90" align="right" title="Total Dye Cost/Dyeing Qty"><p><?  $subcon_dye_cost_kg=$subcon_dye_cost/$row[('qnty')];
	                        echo number_format($subcon_dye_cost_kg,2,'.','');
	                        $total_sub_dye_cost+=$subcon_dye_cost;$total_sub_dye_cost_kg+=$subcon_dye_cost_kg; ?></p></td>

	                        <td width="110" align="right"><p><? $subcon_chem_cost =$chem_dye_cost_array[$row[('batch_id')]][5]; echo number_format($subcon_chem_cost,2,'.',''); ?></p></td>
	                        <td width="90" align="right" title="Total Chemical Cost/Dyeing Qty"><p><?  $subcon_chemi_cost_kg=$subcon_chem_cost/$row[('qnty')];
            ...
            <div style="width:2690px; overflow-y:scroll; max-height:275px;" id="scroll_body" >
                ...
                foreach ( $sample_batch_wise_arr as $batch_id=>$row )
                {
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_<? echo $i; ?>">
                        ...
                        ?></p></td>
                        <td width="120"><p><? echo $buyer_all; echo $buyer_library[$non_order_arr[$row[('booking_no')]]['buyer_name']]; //B?></p></td>
                        <td width="130"><p><? echo $style_all;  ?></p></td>
                        <td width="140"><p><? echo $po_all;?></p></td>
                        <td width="100" align="right"><p><? echo number_format($po_qnty,0);  ?></p></td>
                        <td width="60" align="center"><p><? echo $gsm_library[$row[('prod_id')]];//B ?></p></td>
                        <td width="100"><p><? echo $color_library[$row[('color_id')]];//B ?></p></td>
                        <td width="100"><p><? echo $row[('batch_no')]; ?></p></td>
                        <td width="50"><p><? echo $row[('extention_no')]; ?></p></td>
                        <td width="100" align="center"><p><? echo $machine_cap_array[$row[('machine_id')]]["machine_no"]; ?></p></td>
                        <td width="90" align="right"><p><? $machine_capacity=$machine_cap_array[$row[('machine_id')]]["prod_capacity"]; echo number_format($machine_capacity,2,'.',''); ?></p></td>
            ...
            <div style="width:2690px; overflow-y:scroll; max-height:275px;" id="scroll_body" >
                ...
                foreach ( $other_batch_wise_array as $batch_id=>$row )
                {
                    ...
                    <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('trother_<? echo $m; ?>','<? echo $bgcolor; ?>')" id="trother_<? echo $m; ?>">
                        ...
                        ?></p></td>
                        <td width="120"><p><? echo $buyer_all; echo $buyer_library[$non_order_arr[$row[('booking_no')]]['buyer_name']]; //A?></p></td>
                        <td width="130"><p><? echo $style_all;  ?></p></td>
                        <td width="140"><p><? echo $po_all;?></p></td>
                        <td width="100" align="right"><p><? echo number_format($po_qnty,0);  ?></p></td>
                        <td width="60" align="center"><p><? echo $gsm_library[$row[('prod_id')]];//C ?></p></td>
                        <td width="100"><p><? echo $color_library[$row[('color_id')]];//A ?></p></td>
                        <td width="100"><p><? echo $row[('batch_no')]; ?></p></td>
                        <td width="50"><p><? echo $row[('extention_no')]; ?></p></td>
                        <td width="100" align="center"><p><? echo $machine_cap_array[$row[('machine_id')]]["machine_no"]; ?></p></td>
                        <td width="90" align="right"><p><? $machine_capacity=$machine_cap_array[$row[('machine_id')]]["prod_capacity"]; echo number_format($machine_capacity,2,'.',''); ?></p></td>
                        ...
                        <td width="110" align="right" title="Batch ID=<? echo $row[('batch_id')];?>"><p><? $other_dye_cost =$chem_dye_cost_array[$row[('batch_id')]][6] - $others_cost_return_data_arr[$row[('batch_id')]][6]; echo number_format($other_dye_cost,2,'.','');?></p></td>
                        <td width="90" align="right" title="Tot Dye Cost/Dyeing Qty"><p><? 
                        $tot_dye_cost_kg=$other_dye_cost/$row[('qnty')]; echo number_format($tot_dye_cost_kg,2,'.','');
                        //echo number_format(($chem_dye_cost_kg_array[$row[('batch_id')]]-$others_cost_return_data_arr[$row[('batch_id')]]),2,'.','');
                         $total_other_dye_cost+=$other_dye_cost;$total_other_dye_cost_kg+=$tot_dye_cost_kg;?> </p></td>

                        <td width="110" align="right" title="Batch ID=<? echo $row[('batch_id')];?>"><p><? $other_chem_cost =$chem_dye_cost_array[$row[('batch_id')]][5] - $others_cost_return_data_arr[$row[('batch_id')]][5]; echo number_format($other_chem_cost,2,'.','');?></p></td>
