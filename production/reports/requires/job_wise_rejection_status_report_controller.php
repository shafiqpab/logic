...
if($action=="report_generate")
{
    ...
    {	
		...
		foreach($job_wise_order as $row)
		{
			...
			$po_wise_job_id_arr[$row[csf('po_id')]] = $row[csf('job_id')];
		...
		$sql="SELECT b.id as po_id,b.job_no_mst as job_id,c.embel_name,c.production_type, c.po_break_down_id,d.reject_qty,d.production_qnty from  wo_po_details_master a,wo_po_break_down b, pro_garments_production_mst c, pro_garments_production_dtls d WHERE a.id=b.job_id and b.id=c.po_break_down_id and c.id=d.mst_id and  a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0 and c.production_type in(1,3,5,8,11) and d.production_type=1 AND d.cut_no is not null $sql_cond $buyer_name $location_name_one $job_cond_id $style_cond $season_cond $year_cond $order_cond $order_status_cond $pro_company_name";
		...
		foreach($res as $row)
		{
			...
			if($row['PRODUCTION_TYPE']==3 && $row['EMBEL_NAME']==1)
			{
			...
			if($row['PRODUCTION_TYPE']==3 && $row['EMBEL_NAME']==2)
			{
			...
			if($row['PRODUCTION_TYPE']==3 && $row['EMBEL_NAME']==3)
			{
			...
			if($row['PRODUCTION_TYPE']==3 && $row['EMBEL_NAME']==4)
			{
	   ...
	   $fabric_issue_out="SELECT b.job_no_mst as job_id,b.id as po_id,c.issue_qnty,e.knit_dye_source from  wo_po_details_master a,wo_po_break_down b,  inv_grey_fabric_issue_dtls c,order_wise_pro_details d,inv_issue_master e where a.id=b.job_id and b.id=d.po_breakdown_id and c.id = d.dtls_id and c.prod_id=d.prod_id and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 and e.id=c.mst_id and c.status_active=1 and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0 and e.status_active=1 and e.is_deleted=0 and e.knit_dye_source in(1,3)  $sql_cond $buyer_name $location_name_one $job_cond_id $style_cond $season_cond  $year_cond $order_cond $order_status_cond";
	...
	<fieldset width="100%">
	 <table class="rpt_table" width="2610" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
		<thead>
              <tr>
	 ...
	 <div style="width: 2630px;overflow-y:auto;max-height:250px;">
		<table class="rpt_table" width="2610" cellpadding="0" cellspacing="0" border="1" rules="all" align="left" id="table_body_id">
			<tbody id="">
			<?
				$i=1;
						foreach($job_summary_arr as $job_id=>$val)
						{
							...
							<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo  $bgcolor; ?>')" id="tr_<? echo $i; ?>">
								...
								<td width="120"><? echo $buyerArr[$val['buyer_name']] ;?></td>
								<td width="120" align="right"> <? echo number_format($val['grey_fab_qnty'],2);?></td>
								<td width="120" align="right"><? echo number_format($job_wise_order_arr[$job_id]['order_qty'],2);?></td>
								<td width="100" align="right"><? echo $kniting_arr[$job_id]['reject_qty'];?></td>
								<td width="100" align="right"><? $cut_knit=($kniting_arr[$job_id]['reject_qty']/$kniting_arr[$job_id]['grey_receive_qnty'])*100;echo fn_number_format($cut_knit,2);?></td>
								<td width="100" align="right"><? echo $dyeing_arr[$job_id]['reject_qty'];?></td>
								<td width="100" align="right"><? $cut_dyeing=($dyeing_arr[$job_id]['reject_qty']/$dyeing_arr[$job_id]['roll_weight'])*100;echo fn_number_format($cut_dyeing);?></td>
								<td width="100" align="right"><? echo $cutting_arr[$job_id]['reject_qty'];?></td>
								<td width="100" align="right"><? $cut_per=( $cutting_arr[$job_id]['reject_qty']/$cutting_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per,2); ?> </td>
								<td width="100" align="right"><?  echo $printing_r_arr[$job_id]['reject_qty']; ?></td>
								<td width="100" align="right"><? $cut_per_print=( $printing_r_arr[$job_id]['reject_qty']/$printing_r_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_print,2); ?></td>
								<td width="100" align="right"><?  echo $em_arr[$job_id]['reject_qty']; ?></td>
								<td width="100" align="right"><? $cut_per_em=( $em_arr[$job_id]['reject_qty']/$em_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_em,2) ?></td>
								<td width="100" align="right"><?  echo $sp_arr[$job_id]['reject_qty']; ?></td>
								<td width="100" align="right"><? $cut_per_sp=( $sp_arr[$job_id]['reject_qty']/$sp_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_sp,2); ?></td>
								<td width="100" align="right"><?  echo $sewing_arr[$job_id]['reject_qty']; ?></td>
								<td width="100" align="right"><? $cut_per_sew=( $sewing_arr[$job_id]['reject_qty']/$sewing_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_sew,2); ?></td>
								<td width="100" align="right"><? echo $wash_arr[$job_id]['reject_qty']; ?></td>
								<td width="100" align="right"><? $cut_per_wash=( $wash_arr[$job_id]['reject_qty']/$wash_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_wash,2); ?></td>
								<td width="100" align="right"><?  echo $poly_arr[$job_id]['reject_qty']; ?></td>
								<td width="100" align="right"><? $cut_per_poly=( $poly_arr[$job_id]['reject_qty']/$poly_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_poly,2); ?></td>
								<td width="100" align="right"> <?  echo $finish_arr[$job_id]['reject_qty']; ?> </td>
								<td width="100"  align="right"><? $cut_per_finish=( $finish_arr[$job_id]['reject_qty']/$finish_arr[$job_id]['production_qnty'])*100; echo fn_number_format($cut_per_finish,2); ?></td>
								<td width="100" align="right"><?  echo $total_ex_factory_arr[$job_id]['ex_factory_qnty']; ?></td>
								<td width="100" align="right"><? $balance=$job_wise_order_arr[$job_id]['order_qty']-$total_ex_factory_arr[$job_id]['ex_factory_qnty']; echo fn_number_format($balance,2); ?></td>
		...
		<table  cellspacing="0" cellpadding="0" border="1" class="rpt_table" rules="all" width="2610" id="" align="left">
			<tfoot>
				<tr>
					<th width="50"></th>
					<th width="120"></th>
					...
					<th width="100"><? echo number_format($tot_kniting_qty,2);?></th>
					<th width="100"><? echo fn_number_format($tot_cut_knit,2);?></th>
					<th width="100"><? echo number_format($tot_dying_qty,2);?></th>
					<th width="100"><? echo fn_number_format($tot_cut_dyeing);?></th>
					<th width="100"><? echo fn_number_format($tot_cutting_qty,2);?></th>
					<th width="100"><? echo number_format($tot_cut_per,2); ?></th>
					<th width="100"><? echo fn_number_format($tot_printing,2);?></th>
					<th width="100"><? echo fn_number_format($tot_cut_print,2);?></th>
					<th width="100"><? echo fn_number_format($tot_em,2);?></th>
					<th width="100"><? echo fn_number_format($tot_em_per,2);?></th>
					<th width="100"><? echo fn_number_format($tot_sp,2);?></th>
					<th width="100"><? echo fn_number_format($tot_sp_per,2);?></th>
					<th width="100"><? echo fn_number_format($tot_sewing,2);?></th>
					<th width="100"><? echo fn_number_format($tot_per_sew,2);?></th>
					<th width="100"><? echo fn_number_format($tot_wash,2);?></th>
					<th width="100"><? echo fn_number_format($tot_per_wash,2);?></th>
					<th width="100"><? echo fn_number_format($tot_poly,2);?></th>
					<th width="100"><? echo fn_number_format($tot_per_poly,2);?></th>
					<th width="100"><? echo fn_number_format($tot_finish,2);?></th>
					<th width="100"><? echo fn_number_format($tot_per_finish,2);?></th>
					<th width="100"><? echo fn_number_format($tot_ex_factory,2);?></th>
					<th width="100"><? echo fn_number_format($tot_balance,2);?></th>
	...
	<br><br>
	<div style="width:5870">
		<table class="rpt_table" width="5850" cellpadding="0" cellspacing="0" border="1" rules="all" align="left">
			<thead>
				<tr>
				<th width="650" colspan="7">Basic Info</th>
				<th width="1100" colspan="11">Knitting</th>
				<th width="1100" colspan="11">Dyeing Finishing</th>
				<th width="600" colspan="6">Cutting</th>
				<th width="300" colspan="3">Print</th>
				<th width="300" colspan="3">Embrodiery</th>
				<th width="300" colspan="3">Special Work</th>
				<th width="300" colspan="3">Sewing</th>
				<th width="300" colspan="3">Washing</th>
				<th width="300" colspan="3">Poly</th>
				<th width="300" colspan="3">Finishing</th>
				<th width="300" colspan="3">Ex-Factory</th>
				</tr>
				<tr>
					<th width="50">SI</th>
					...
					<th width="100">Grey Fabric Req.  Qty. (KG)</th>
					<th width="100">Yarn Issue to Knitting (Inhouse)</th>
					<th width="100">Knitting Production (Inhouse) (Kg)</th>
					<th width="100">Fabric Rej. Qty. (kg)</th>
					<th width="100">Rejection %</th>
					<th width="100">Yarn Issue to Knitting (Outbound)</th>
					<th width="100">Knitting Production (Outbound)-(Kg)</th>
					<th width="100">Rejection Qty. (kg)</th>
					<th width="100">Rejection %</th>
					<th width="100">Total Knit Rejection Qty. (kg)</th>
					<th width="100">Total Knit Rejection %</th>
					<th width="100">Fin. Fabric Req.  Qty. (KG)</th>
					<th width="100">Fabric Issue to Dyeing (Inhouse)</th>
					<th width="100">D.F Production (Inhouse) (Kg)</th>
					<th width="100">Rejection Qty. (kg)</th>
					<th width="100">Rejection %</th>
					<th width="100">Fabric Issue to Dyeing (Outbound)</th>
					<th width="100">D.F Production (Outbound)-(Kg)</th>
					<th width="100">Rejection Qty. (kg)</th>
					<th width="100">Rejection %</th>
					<th width="100">Total D.F Rejection Qty. (kg)</th>
					<th width="100">Rejection %</th>
					<th width="100">Order Qty. (Pcs)</th>
					<th width="100">Required Qty with Plan cut</th>
					<th width="100">Cutting Production</th>
					<th width="100">Cutting QC Pass</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Print Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Embroidery Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Spacial Work Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Sewing Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Washing Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Poly Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Finishing Production</th>
					<th width="100">Rejection Qty. (Pcs)</th>
					<th width="100">Rejection %</th>
					<th width="100">Ex-Factory Qty (Pcs)</th>
					<th width="100">Ex-Factory Balance</th>
		...
		<div style="width: 5870px;overflow-y:auto;max-height:300px;">
			<table class="rpt_table" width="5850" cellpadding="0" cellspacing="0" border="1" rules="all" align="left" id="table_body_id_two">
				<tbody>
					<?
						$i=1;
						foreach($purpose_arr as $job_id=>$job_val)
						{
							...
							<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo  $bgcolor; ?>')" id="tr_<? echo $i; ?>">
							<td width="50"><? echo $i;?></td>
							<td width="100"><? echo $buyerArr[$val['buyer_name']] ;?></td>
							<td width="100"><? echo $job_id; ?></td>
							<td width="100"><p><? echo $val['po_number']; ?></p></td>
							<td width="100"><? echo $order_status[$val['is_confirmed']]; ?></td>
							<td width="100"><p><? echo $val['style_ref_no']; ?></p></td>
							<td width="100" align="center"><? echo change_date_format($val['pub_shipment_date']); ?></td>
							<td width="100" align="right"><? echo fn_number_format($total_grey_arr[$po_id][$job_id]['grey_qnty'],2); ?></td>
							<td width="100" align="right"><? echo $total_yarn_arr[$po_id][$job_id]['cons_quantity'];  ?></td>
							<td width="100" align="right"><? echo $kniting_main_arr[$po_id][$job_id]['grey_receive_qnty']; ?></td>
							<td width="100"  align="right"><? echo $kniting_main_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_kn_per=($kniting_main_arr[$po_id][$job_id]['reject_qty']/$kniting_main_arr[$po_id][$job_id]['grey_receive_qnty'])*100; echo fn_number_format($cut_kn_per,2); ?></td>
							<td width="100" align="right"><? echo $yarn_tot_arr[$po_id][$job_id]['quantity']; ?></td>
							<td width="100" align="right"><? echo $knit_out_arr[$po_id][$job_id]['grey_receive_qnty']; ?></td>
							<td width="100" align="right"><? echo $knit_out_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_knit=($knit_out_arr[$po_id][$job_id]['reject_qty']/ $knit_out_arr[$po_id][$job_id]['grey_receive_qnty'])*100; echo fn_number_format($cut_knit,2); ?></td>
							<td width="100" align="right"><? $tot_rej=$kniting_main_arr[$po_id][$job_id]['reject_qty']+$knit_out_arr[$po_id][$job_id]['reject_qty']; echo fn_number_format($tot_rej,2);  ?></td>
							<td width="100" align="right"><? $tot_cut_knit=$cut_knit_per+$cut_knit;echo fn_number_format($tot_cut_knit,2); ?></td>
							<td width="100" align="right"><? echo fn_number_format($fabric_tot_arr[$po_id][$job_id]['fin_fab_qnty'],2) ?></td>
							<td width="100" align="right"><? echo fn_number_format($fabric_issue_tot_in_arr[$po_id][$job_id]['issue_qnty'],2) ?></td>
							<td width="100" align="right"><? echo fn_number_format($dyeing_in_arr[$po_id][$job_id]['roll_weight'],2);  ?></td>
							<td width="100" align="right"><? echo fn_number_format($dyeing_in_arr[$po_id][$job_id]['reject_qty'],2);  ?></td>
							<td width="100" align="right"><? $cut_fabric=($dyeing_in_arr[$po_id][$job_id]['reject_qty']/$dyeing_in_arr[$po_id][$job_id]['roll_weight'])*100; echo fn_number_format($cut_fabric,2); ?></td>
							<td width="100" align="right"><? echo $fabric_issue_tot_out_arr[$po_id][$job_id]['issue_qnty']; ?></td>
							<td width="100" align="right"><? echo fn_number_format($dyeing_out_arr[$po_id][$job_id]['roll_weight'],2); ?></td>
							<td width="100" align="right"><? echo fn_number_format($dyeing_out_arr[$po_id][$job_id]['reject_qty'],2);   ?></td>
							<td width="100" align="right"><?  $dying_out_per=($dyeing_out_arr[$po_id][$job_id]['reject_qty']/$dyeing_out_arr[$po_id][$job_id]['roll_weight'])*100;echo fn_number_format($dying_out_per,2); ?></td>
							<td width="100" align="right"><?  $tot_dying_reject=$dyeing_in_arr[$po_id][$job_id]['reject_qty']+$dyeing_out_arr[$po_id][$job_id]['reject_qty']; echo fn_number_format($tot_dying_reject,2); ?></td>
							<td width="100" align="right"><? $tot_dying_weight=$dyeing_in_arr[$po_id][$job_id]['roll_weight']+$dyeing_out_arr[$po_id][$job_id]['roll_weight']; $tot_dying_reject_per=($tot_dying_reject/$tot_dying_weight)*100; echo fn_number_format($tot_dying_reject_per,2); ?></td>
							<td width="100" align="right"><? echo $order_arr[$po_id][$job_id]['po_quantity']; ?></td>
							<td width="100" align="right"><?  echo $order_arr[$po_id][$job_id]['plan_cut']; ?></td>
							<td width="100" align="right"><? echo $plan_arr[$po_id][$job_id]['marker_qty'];  ?></td>
							<td width="100" align="right"><? echo $cutting_main_arr[$po_id][$job_id]['production_qnty']; ?></td>
							<td width="100"  align="right"><? echo $cutting_main_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_qc_per=($cutting_main_arr[$po_id][$job_id]['reject_qty']/ $cutting_main_arr[$po_id][$job_id]['production_qnty'])*100; echo fn_number_format($cut_qc_per,2); ?></td>
							<td width="100" align="right"><?  echo $printing_rcv_arr[$po_id][$job_id]['production_qnty'];  ?></td>
							<td width="100" align="right"><?  echo $printing_rcv_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_print=($printing_rcv_arr[$po_id][$job_id]['reject_qty']/ $printing_rcv_arr[$po_id][$job_id]['production_qnty'])*100; echo fn_number_format($cut_print,2) ?></td>
							<td width="100" align="right"><? echo  $em_tot_arr[$po_id][$job_id]['production_qnty'];  ?></td>
							<td width="100" align="right"><?  echo  $em_tot_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_em_per=($em_tot_arr[$po_id][$job_id]['reject_qty']/ $em_tot_arr[$po_id][$job_id]['production_qnty'])*100; echo fn_number_format($cut_em_per,2); ?></td>
							<td width="100" align="right"><? echo  $sp_tot_arr[$po_id][$job_id]['production_qnty']; ?></td>
							<td width="100" align="right"><? echo  $sp_tot_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100"  align="right"><? $cut_sp_per=( $sp_tot_arr[$po_id][$job_id]['reject_qty']/$sp_tot_arr[$po_id][$job_id]['production_qnty'])*100; echo fn_number_format($cut_sp_per,2); ?></td>
							<td width="100" align="right"><?  echo  $total_sewing_arr[$po_id][$job_id]['production_qnty']; ?></td>
							<td width="100" align="right"><?   echo  $total_sewing_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_sewing_per=( $total_sewing_arr[$po_id][$job_id]['reject_qty']/ $total_sewing_arr[$po_id][$job_id]['production_qnty'])*100;echo fn_number_format($cut_sewing_per,2); ?></td>
							<td width="100" align="right"><? echo  $wash_tot_arr[$po_id][$job_id]['production_qnty']; ?></td>
							<td width="100" align="right"><? echo  $wash_tot_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_wash_per=( $wash_tot_arr[$po_id][$job_id]['reject_qty']/ $wash_tot_arr[$po_id][$job_id]['production_qnty'])*100;echo fn_number_format($cut_wash_per,2);  ?></td>
							<td width="100" align="right"><?  echo  $poly_tot_arr[$po_id][$job_id]['production_qnty']; ?></td>
							<td width="100" align="right"><?  echo  $poly_tot_arr[$po_id][$job_id]['reject_qty'];  ?></td>
							<td width="100" align="right"><? $cut_poly_per=( $poly_tot_arr[$po_id][$job_id]['reject_qty']/ $poly_tot_arr[$po_id][$job_id]['production_qnty'])*100;echo fn_number_format($cut_poly_per,2);  ?></td>
							<td width="100" align="right"><?  echo  $finish_tot_arr[$po_id][$job_id]['production_qnty']; ?></td>
							<td width="100" align="right"><? echo  $finish_tot_arr[$po_id][$job_id]['reject_qty']; ?></td>
							<td width="100" align="right"><? $cut_finish_per=( $finish_tot_arr[$po_id][$job_id]['reject_qty']/ $finish_tot_arr[$po_id][$job_id]['production_qnty'])*100; echo fn_number_format($cut_finish_per,2);?></td>
							<td width="100" align="right"><?   echo  $ex_factory_arr[$po_id][$job_id]['ex_factory_qnty']; ?></td>
							<td width="100" align="right"><? $balance=$order_arr[$po_id][$job_id]['po_quantity']- $ex_factory_arr[$po_id][$job_id]['ex_factory_qnty']; echo fn_number_format($balance,2); ?></td>
