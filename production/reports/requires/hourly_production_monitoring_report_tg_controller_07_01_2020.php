...
if($action=="report_generate")
{
	...
	else if($db_type==2)
	{
		...
		WHERE a.production_type=5 and a.po_break_down_id=c.id and c.job_no_mst=b.job_no and a.id=d.mst_id and a.status_active=1 and a.is_deleted=0 and b.is_deleted=0 and c.is_deleted=0 and d.status_active=1 and d.is_deleted=0 $company_name $location $floor $line $buyer_id_cond  $txt_date_from 
	...
	{	
		...
		if ($val[csf('remarks')] !="") 
		{
		 	if($production_data_arr[$val[csf('floor_id')]][$val[csf('sewing_line')]]['remarks']!="")
			{
				$production_data_arr[$val[csf('floor_id')]][$val[csf('sewing_line')]]['remarks'].=",".$val[csf('remarks')]; 
			}
		 	else
			{
				$production_data_arr[$val[csf('floor_id')]][$val[csf('sewing_line')]]['remarks']=$val[csf('remarks')]; 
		...
		{
			$production_data_arr[$val[csf('floor_id')]][$val[csf('sewing_line')]]['item_number_id'].="****".$val[csf('po_break_down_id')]."**".$val[csf('item_number_id')]."**".$val[csf('unit_price')]; 
		}
		else
		{
			 $production_data_arr[$val[csf('floor_id')]][$val[csf('sewing_line')]]['item_number_id']=$val[csf('po_break_down_id')]."**".$val[csf('item_number_id')]."**".$val[csf('unit_price')]; 
	...
	// echo "<pre>"; print_r($job_no_arr);die();
	/*===================================================================================== /
	/										po item wise smv 								/
	/===================================================================================== */
		...
		{			
			foreach($s_data as $l_id=>$ldata)
			{
			  ...
			  {				
					...
					if(!in_array($f_id, $check_arr))
					{
						if($j%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";
						 $html.='<tr  bgcolor="#B6B6B6">
								...
								<td class="break_all" width="100">&nbsp;</td>
								<td class="break_all" width="100">&nbsp;</td>
								<td class="break_all" width="120" title="'.$f_id.'"><p><b>Floor Total('.$floorArr[current($f_chk_arr)].')</b><p></td>

								<td class="break_all" align="right" width="80">&nbsp;</td>
								<td class="break_all" align="right" width="80">'.$floor_tgt_h.'</td>
								<td class="break_all" align="right" width="80">'. $floor_working_hour.'</td>
								<td class="break_all" align="right" width="80">'. $floor_prod_hour.'</td>
								<td class="break_all" align="right" width="80">'. $floor_operator.'</td>
								<td class="break_all" align="right" width="80">'. $floor_helper.'</td>					
								<td class="break_all" align="right" width="80">'. $floor_man_power.'</td>					
								<td class="break_all" align="right" width="80">'. $floor_days_run.'</td>
								...
								$html.='<td class="break_all" align="right" width="80">'.number_format($floor_tot_prod,0).'</td>
								<td class="break_all" align="right" width="80">'.number_format((($floor_tot_prod/$eff_target_floor)*100),0).'%</td>
								<td class="break_all" align="right" width="80">'.number_format($floor_target_gap,0).'</td>
								<td class="break_all" align="right" width="80">'.number_format($floor_target_min,0).'</td>
								<td class="break_all" align="right" width="80">'.number_format($floor_produc_min,0).'</td>
								<td class="break_all" align="right" width="80">'.number_format((($floor_target_min/$floor_avale_minute)*100),0).'%</td>
								<td class="break_all" align="right" width="80">'. number_format((($floor_produc_min/$floor_avale_minute)*100),0).'%</td>
								<td class="break_all" align="right" width="80">'. number_format((($floor_target_min/$floor_avale_minute)*100) - (($floor_produc_min/$floor_avale_minute)*100),0).'%</td>
								<td class="break_all" align="right" width="80">'. number_format($floor_style_change,0).'</td>
								<td class="break_all" align="right" width="180"></td>
								<td class="break_all" align="right" width="80">'.number_format($floor_avale_minute,2).'</td>
								
								<td class="break_all" width="80" align="right">'.number_format($floor_avg_cm,2).'</td>
								<td class="break_all" width="80" align="right">'.number_format($floor_ttl_cm,2).'</td>
								<td class="break_all" width="80" align="right">'.number_format($floor_target_cm,2).'</td>
								<td class="break_all" width="80" align="right">'.number_format($floor_avg_rate,2).'</td>
				...
				$po_id_arr = array_unique(explode(",", $production_data_arr[$f_id][$ldata]['po_id']));
				$po_rate ="";
				...
				$job_arr = array_unique(explode(",", rtrim($production_data_arr[$f_id][$ldata]['job_no'])));
				$job__no = '';
				...
				$line_acv = (($line_production_hour/$eff_target)*100); 
				...
				$achive_effi = ($produce_minit / $efficiency_min)*100; 
				...
				$joNos_arr = explode(",", $production_data_arr[$f_id][$ldata]['job_no']);
				...
				$html.='<td class="break_all" width="40">'.$i.'&nbsp;</td>
						<td class="break_all" align="center" width="80" ><p>'. $sewing_line.'&nbsp; </p></td>
						<td class="break_all" width="100"><p>'.$buyer_name.'&nbsp;</p></td>
						<td class="break_all" width="100"><p>'.$style_name.'&nbsp;</p></td>
						<td class="break_all" width="100"><p>'.$job__no.'&nbsp;</p></td>
						<td class="break_all" width="120" style="word-wrap:break-word; word-break: break-all;"><p>'.implode(",",array_unique(explode(",",$garment_itemname))).'</p></td>

						<td class="break_all" align="center" width="80"><p>'.implode("/",array_unique(explode("/",$item_smv))).'</p></td>
						<td class="break_all" align="right" width="80"><p>'.$terget_hour.'</p></td>
						<td class="break_all" align="right" width="80"><p>'.$working_hour.'</p></td>
						<td class="break_all" align="right" width="80"><p>'.$prod_hours.'</p></td>
						<td class="break_all" align="right" width="80"><p>'.$operator.'</p></td>
						<td class="break_all" align="right" width="80"><p>'.$helper.'</p></td> 
						<td class="break_all" align="right" width="80"><p>'.$man_power.'</p></td> 
						<td class="break_all" align="right" width="80"><p>'.$days_run.'</p></td>
						<td class="break_all" align="right" width="80"><p>'.$eff_target.'</p></td>';
						$p=1;
						for($k=$hour; $k<=$last_hour; $k++)
						{
							$prod_hour="prod_hour".substr($start_hour_arr[$k],0,2)."";
						...
						$html.='<td class="break_all" align="right" width="80">'.$line_production_hour.'</td>
						<td class="break_all" align="right" width="80">'.number_format($line_acv,0).'%</td>
						<td class="break_all" align="right" width="80">'.number_format($target_gap,0).'</td>
						<td class="break_all" align="right" width="80">'.number_format($target_min,0).'</td>
						<td class="break_all" width="85" align="right"><a href="##" onclick="openmypage('.$company_id.",'".$order_no_total."','".$subcon_order_id."',".$f_id.",".$ldata.",'tot_prod','".$smv_for_item."','".$acturl_hour_minute."','".$line_start."',".$txt_date.')">'.$produce_minit.'</a></td>
						<td class="break_all" align="right" width="80">'.number_format($target_effi,0).'%</td>
						<td class="break_all" align="right" width="80">'.number_format($achive_effi,0).'%</td>
						<td class="break_all" align="right" width="80">'.number_format($efficiency_gap,0).'%</td>
						<td class="break_all" width="80" align="right">'.number_format($style_change,0).'</td>

						<td class="break_all" align="right" width="180" ><p>'.$production_data_arr[$f_id][$ldata]['remarks'].'</p></td>
						 
						<td class="break_all" align="right" width="80">'.number_format($efficiency_min,0).'</td>						
						<td class="break_all" width="80" align="right">'.number_format($avg_cm,2).'</td>
						<td class="break_all" align="right" width="80">'.number_format($ttl_cm,2).'</td>
						<td class="break_all" align="right" width="80">'.number_format($target_cm,2).'</td>
						<td class="break_all" align="right" width="80">'.number_format($avg_rate,2).'</td>
			...
			$html.='<tr  bgcolor="#B6B6B6">
					...
					<td class="break_all" width="100">&nbsp;</td>
					<td class="break_all" width="100">&nbsp;</td>
					<td class="break_all" width="120" title="'.$f_id.'"><p><b>Floor Total('.$floorArr[$f_id].')</b><p></td>
					...
					$smv_for_item="";
					$tbl_width = 2720+($last_hour - ($hour+1))*70;
					// echo $tbl_width;die();
        ...
        <table id="table_header_1" class="rpt_table" width="<? echo $tbl_width;?>" cellpadding="0" cellspacing="0" border="1" rules="all">
            <thead>
                <tr height="50">
                    ...
                    <th class="break_all" width="80">SMV</th>
                    <th class="break_all" width="80">Hourly Target (Pcs)</th>
                    <th class="break_all" width="80">Plan/W.Hour</th>
                    <th class="break_all" width="80">Prod. Hour</th>
                    <th class="break_all" width="80">Operator</th>
                    <th class="break_all" width="80">Helper</th>
                    <th class="break_all" width="80"> Man Power</th>
                    <th class="break_all" width="80">Days Run</th>
                   ...
                   // print_r($production_hour);
                    ...
                    <th class="break_all" width="80">Line Acv.</th>                   
                    <th class="break_all" width="80">Target Gap</th>                   
                    <th class="break_all" width="80">Target Min</th>                   
                    <th class="break_all" width="80">Produce/Earn Min</th>                   
                    <th class="break_all" width="80">Target Eff.%</th>                   
                    <th class="break_all" width="80">Acv. Eff.%</th>                   
                    <th class="break_all" width="80">Eff. Gap</th>                   
                    <th class="break_all" width="80">Style Change</th>                   
                    <th class="break_all" width="180">Remarks</th> 
                    <th class="break_all" width="80">Available Min.</th>
                    <th class="break_all" width="80">CM/PC</th>
                    <th class="break_all" width="80">TTL CM</th>
                    <th class="break_all" width="80">Target CM</th>
                    <th class="break_all" width="80">Unit Price</th>
              ...
              <? echo $html;  ?>
                <tfoot>
                   <tr>
                        ...
                        <th class="break_all" width="100">&nbsp;</th>
                        <th class="break_all" width="100">&nbsp;</th>
                        <th class="break_all" width="120">Grand Total</th>

                        <th class="break_all" align="right" width="80">&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format($gnd_total_tgt_h,0); ?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo $total_working_hour; ?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo $total_prod_hour; ?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><?  echo $total_operator; ?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><?  echo $total_helper; ?></th>
                        <th class="break_all" align="right" width="80"><?  echo $total_man_power; ?></th>
                        <th class="break_all" align="right" width="80"><?  echo $total_days_run; ?></th>
                        ...
                        ?>
                        <th class="break_all" align="right" width="80"><? echo number_format($total_tot_prod,0); ?></th>
                        <th class="break_all" align="right" width="80"><? echo number_format((($total_tot_prod/$total_terget)*100),0); ?>%</th>
                        <th class="break_all" align="right" width="80"><? echo number_format($total_target_gap,0); ?></th>
                        <th class="break_all" align="right" width="80"><? echo number_format($total_target_min,0); ?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format($gnd_product_min,0); ?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format((($total_target_min/$gnd_avable_min)*100),0); ?>%</th>
                        <th class="break_all" align="right" width="80"><? echo number_format((($gnd_product_min/$gnd_avable_min)*100),0); ?>%&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format((($total_target_min/$gnd_avable_min)*100)-(($gnd_product_min/$gnd_avable_min)*100) ,0); ?>%&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format($total_style_change,0); ?>&nbsp;</th>
                        ...
                        <th class="break_all" align="right" width="80"><? echo number_format($total_avg_cm,2);?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format($total_ttl_cm,2);?>&nbsp;</th>
                        <th class="break_all" align="right" width="80"><? echo number_format($total_target_cm,2);?>&nbsp;</th>

                        <th class="break_all" align="right" width="80"><? echo number_format($total_avg_rate,2);?>&nbsp;</th>
