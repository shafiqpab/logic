...
if ($action == "report_generate") // Show
{
	...
	if (!empty($salesOrderDataResult)) 
	{
		...
		from ppl_planning_entry_plan_dtls a 
		inner join ppl_yarn_requisition_entry b on a.dtls_id = b.knit_id 
		inner join inv_transaction d on (b.requisition_no=d.requisition_no and d.transaction_type=2 and b.prod_id=d.prod_id) where a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and d.status_active=1 and d.is_deleted=0 and a.po_id in($sales_ids)   and a.is_sales=1
		...
		foreach ($salesOrderDataResult as $row) 
		{
			...
			foreach ($grey_fabric_status_details as $grey_fabric_row) 
			{
				...
				<td width='100' $fab_rowspan><a  href='##' onclick=\"open_febric_receive_status_order_wise_popup('" . $sales_id . "','yarn_trans_popup',''," . $determination_id . ")\">" . $net_transfer . "</a></td>
	...
	<fieldset width="3000">
		<table cellpadding="5" cellspacing="0" width="3000">
			<tr>
		...
		<!-- Details part Start -->
		<table class="rpt_table" border="1" rules="all" width="3000" cellpadding="5" cellspacing="0"
		id="tbl_list_search">
		<thead>
			<tr>
			...
			<tr>
				...
				<th width="100" rowspan="2">Grey Available<br/>
					<small>(Grey Production + Net Transfer)</small>
				</th>
...
if($action == "report_generate_2") // Report 2
{
	...
	<fieldset width="4590">
	<table cellpadding="5" cellspacing="0" width="4570">
		<tr>
		...
		<table class="rpt_table" border="1" rules="all" width="4570" cellpadding="1" cellspacing="0" id="tbl_list_search" align="left">
			<thead>
				<tr>
		...
		<div style="width:4590px; max-height:240px; overflow-y:scroll"  align="left" id="scroll_body">
			<table class="rpt_table" border="1" rules="all" width="4570" cellpadding="1" cellspacing="0" id="tbl_list_search" align="left">
				<tbody>
					<?
					$i=1;
					...
					{
						$within_group = ($row[csf('within_group')] == 1) ? "Yes" : "No";
						$sales_order = "<a href='##' style='color:#000' onclick=\"fnc_fabric_sales_order_print('" . $company_name . "','" . $row[csf('booking_id')] . "','" . $row[csf('booking_no')] . "','" . $row[csf('sales_job_no')] . "','" . $row[csf('mst_entry_form')] . "','2','','')\"><font style='font-weight:bold' $wo_color>" . $row[csf('sales_job_no')] . "</font></a>";
						$po_ids = rtrim($row[csf('po_break_down_id')], ',');
					...
					//$grey_receive_balance = $knitting_balance - $transfer_in_qnty+ $transfer_out_qnty;
						...
						<tr bgcolor='<? echo $bgcolor;?>' onClick="change_color('tr_<? echo $i; ?>','#FFFFFF')" id="tr_<? echo $i;?>">
							...
							<td class="alignment_css" width="105" align="center" rowspan="<? echo $rowspan;?>">
								<b>
									<?
									if($row[csf('within_group')]==1)
									{
						...
						<td class="alignment_css" width="50" align="center" rowspan="<? echo $rowspan;?>"><? echo $within_group?></td>
						<td class="alignment_css" width="105" rowspan="<? echo $rowspan;?>"><? echo $sales_order;?></td>
						<td class="alignment_css" width="50" align="center" rowspan="<? echo $rowspan;?>"><? echo date("Y", strtotime($row[csf('sales_order_dt')]));?></td>
						<td class="alignment_css" width="100" align="center" rowspan="<? echo $rowspan;?>"><? echo date("d-m-Y", strtotime($row[csf('sales_order_dt')]));?></td>
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>"><? echo $company_arr[$company_name];?></td>
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>"><? echo $company_arr[$style_owner];?></td>
						<td class="alignment_css" width="130" rowspan="<? echo $rowspan;?>"><? echo $job_no;?></td>

						<td class="alignment_css" width="100" rowspan="<? echo $rowspan;?>" ><a href='#' data-job='<? echo $job_no;?>' class='view_order' title='Click here to view Order numbers'>view</a></td>
						<td class="alignment_css" width="100" rowspan="<? echo $rowspan;?>"><? echo $buyer_name_array[$buyer];?></td>
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>"><? echo $row[csf('style_ref_no')] ?> </td>
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>"><? echo $gmts_item;?></td>
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>"><? echo date("d-m-Y", strtotime($row[csf('delivery_date')])); ?></td>

						<td class="alignment_css" width="430"  rowspan="<? echo $rowspan;?>" >
						...
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','grey_required_popup','', '' )"><? echo number_format($grey_required,2,".","");?></a></td>

						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','grey_receive_popup','', '' )"><? echo number_format($grey_production_qnty,2,".","");?></a></td>

						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><? echo number_format($knitting_balance,2,".","");?></td>

						<td class="alignment_css" width='80' rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>_9','grey_purchase_delivery','','')"><? echo number_format($grey_delivery_qnty,2,".",""); ?></a></td>


						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><? echo number_format($grey_in_knit_floor,2,".","");?></td>

						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>_9','grey_purchase_popup','','')"><? echo number_format($grey_receive_qnty,2,".","");?></a></td>

						<td class="alignment_css" width="50" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','yarn_trans_in_popup','','')"><? echo number_format($transfer_in_qnty,2,".","");?></a></td>

						<td class="alignment_css" width="50" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','yarn_trans_out_popup','','')"><? echo number_format($transfer_out_qnty,2,".","");?></a></td>

						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><? echo number_format($grey_receive_balance,2,".","");?></td>

						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>_2','grey_issue_popup','','')"><? echo number_format($grey_issue_without_return,2,".","");?></a></td>
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><? echo number_format($grey_in_hand,2,".","");?></td>

						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','grey_receive_by_batch_popup','','')"><? echo number_format($receive_by_batch_qnty,2,".","");?></a></td>
						<?
						$t= 0;
						foreach ($grey_fabric_status_details as $grey_fabric_row) {
							...
							<td class="alignment_css" width="80" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','batch_popup','','<? echo $grey_fabric_row['color_id'];?>')"><? echo number_format($batch_qnty,2,".","");?></a></td>
							...
							if($t==0)
							{
								...
								?>
								<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><? echo $yet_to_batch; ?></td>
								<?
							}
							?>
							...
							if($t==0)
							{
								...
								?>
								<td class="alignment_css" width="80" align="right" rowspan="<? echo $rowspan;?>"><? echo number_format($bill_amount,2,".","");?></td>
								<td class="alignment_css" width="80" align="right" rowspan="<? echo $rowspan;?>"><? echo number_format($fso_upcharge,2,".","");?></td>
								<td class="alignment_css" width="80" align="right" rowspan="<? echo $rowspan;?>"><? echo number_format($fso_discount,2,".","");?></td>
								<td class="alignment_css" width="80" align="right" rowspan="<? echo $rowspan;?>"><? echo number_format($fso_total_amount,2,".","");?></td>
								<?
	...
	<table class="rpt_table" border="1" rules="all" width="4570" cellpadding="1" cellspacing="0" align="left">
		<tfoot>
			<tr>
...
if($action == "report_generate_3") // Report 3
{
	...
	<fieldset width="4830">
		<table cellpadding="5" cellspacing="0" width="4810">
			<tr>
				<td width="100%"  colspan="<? echo $colspan + 21; ?>" style="font-size:16px; text-align: left !important;">
				<strong><?php echo $company_library[$company_name]; ?></strong></td>
			</tr>
		...
		<table class="rpt_table" border="1" rules="all" width="4810" cellpadding="1" cellspacing="0" id="tbl_list_search" align="left">
			<thead>
				<tr>
					<th class="alignment_css" colspan="13">Order Details</th>
					<th class="alignment_css" colspan="5">Yarn Status</th>
		...
		<div style="width:4830px; max-height:240px; overflow-y:scroll"  align="left" id="scroll_body">
			<table class="rpt_table" border="1" rules="all" width="4810" cellpadding="1" cellspacing="0" id="tbl_list_search" align="left">
				<tbody>
					<?
					$i=1;
					foreach ($salesOrderDataResult as $row)
					{
						...
						<td class="alignment_css" width="80" rowspan="<? echo $rowspan;?>" align="right"><a  href='##' onClick="open_febric_receive_status_order_wise_popup('<? echo $row[csf('id')];?>','knitting_balance_popup','', '' )"><? echo number_format($knitting_balance,2,".","");?></a></td>
		...
		<table class="rpt_table" border="1" rules="all" width="4810" cellpadding="1" cellspacing="0" align="left">
			<tfoot>
				<tr>
					<th class="alignment_css" width="40">&nbsp;</th>
					<th class="alignment_css" width="105">&nbsp;</th>
			...
			<div id="report_container">
				...
				<div style="width:873px; max-height:330px; overflow-y:scroll" id="scroll_body">
					...
					id="tbl_list_search">
						...
						// ===================================== FSO Info Start ====================
						$style_breakdown_sql="SELECT a.style_breakdown, d.id as job_id, b.fabric_color_id, d.style_ref_no, d.buyer_name, e.body_part_id, e.construction, e.composition, e.lib_yarn_count_deter_id as deter_id, sum(b.grey_fab_qnty) as grey_qty, b.gsm_weight, b.dia_width
						...
						and b.is_deleted=0 and a.is_sales=1 and a.sales_order_id=$order_id and a.style_breakdown is not null
						group by a.style_breakdown, d.id, c.job_no_mst, d.style_ref_no, d.buyer_name,  b.fabric_color_id, e.body_part_id, e.construction, e.composition, e.lib_yarn_count_deter_id, b.gsm_weight, b.dia_width order by d.id, e.body_part_id, e.lib_yarn_count_deter_id asc";
				...
				<table border="1" class="rpt_table" rules="all" width="855" cellpadding="0" cellspacing="0">
					<tfoot>
						...
						<th class='alignment_css' width="60">&nbsp;</th>
						<th class='alignment_css' width="60">&nbsp;</th>
						<th class='alignment_css' id="td_grey_qty" width="60"></th>
			...
			<div id="scroll_body">
				<table border="1" class="rpt_table" rules="all" width="970" cellpadding="0" cellspacing="0">
					<tbody>
						...
						$delivery_sql = "SELECT b.body_part_id, b.uom, c.quantity, e.detarmination_id, e.dia_width, e.gsm, e.color, d.color_id
						from inv_issue_master a,inv_finish_fabric_issue_dtls b, order_wise_pro_details c, pro_batch_create_mst d, product_details_master e
						where a.id = b.mst_id and b.id = c.dtls_id and b.batch_id = d.id and b.prod_id = e.id  and a.entry_form = 224 and c.entry_form = 224 and c.is_sales = 1 and c.po_breakdown_id  =  $order_id[0] and d.color_id= $color and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0 and c.status_active=1 and c.is_deleted=0";
						// echo $delivery_sql;
