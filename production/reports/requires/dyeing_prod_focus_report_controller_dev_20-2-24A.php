...
//dyes B2
	...
	// Only for Self Batch -- Following Batch Progress Report
	   $sql_data_sub="SELECT a.id,a.batch_no,a.floor_id,c.entry_form,a.batch_against,(b.batch_qnty) as batch_qty, c.process_end_date as prod_date,a.batch_weight, a.working_company_id,b.prod_id,b.po_id,b.width_dia_type,b.gsm,b.grey_dia,b.fin_dia,a.color_id,a.booking_no,a.extention_no, b.item_description, a.booking_without_order 
...
//	print_r($finish_data_arr);
    ...
    <style type="text/css">
        ...
        <table width="1970" cellspacing="0" cellpadding="0" border="0" rules="all" >
		...
		<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1970" class="rpt_table">
			...
			<tr style="height:30px">
				...
				<td colspan="7" align="center" style="background-color:#ffccb3"><b>Finising</b></td>
				<td colspan="5" align="center" style="background-color: #ffd9b3"><b>Summery</b></td>
			</tr>
             <tr>
         ...
         <div style="max-height:300px; overflow-y:scroll; width:1990px" id="scroll_body">
			<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1970" class="rpt_table" id="table_body">
				...
				foreach($prod_date_arr as $date_key=>$row)
				{
                	...
                	<!-- example --><td width="100"  style="word-break: break-all; word-wrap: break-word;" align="right"><p><a href="##"  onClick="fnc_dyeing_popup('<? echo $date_key; ?>','<? echo $special_batch_idArr; ?>','<? echo $working_company; ?>','special_qty_inhouse_popup',9)"><? echo number_format($special_finish_qty,2); ?></a></p></td>
                                    ...
                                    <td width="100"  style="word-break: break-all; word-wrap: break-word;" align="right"><p><a href="##"  onClick="fnc_dyeing_popup('<? echo $date_key; ?>','<? echo $special_batch_idArr; ?>','<? echo $working_company; ?>','special_qty_inhouse_popup',2)"><? echo number_format($special_finish_amt,2); ?></a></p></td>
									...
									echo number_format($total_finising,2);
									...
									<td width="100" align="right" title="Tot Dyeing Earn+Tot SubCon Finish Earn"><p><? 
										...
										echo number_format($total_grand,2);
									// echo number_format($tot_dyeing_fin_earn,2)+number_format($special_finish_amt,2); 
									?></p></td>
									
					<!-- work -->	<td width="100" align="right" title="Wash=<? echo $wash_dyes_chemical_cost;?>"><p><a href="##"  onClick="fnc_dyeing_popup('<? echo $date_key; ?>','<? echo $chemical_batch_ids; ?>','<? echo $working_company; ?>','dyes_chemical_cost_earn_popup',5,'<? echo $all_re_batch_idspopup;?>')"><? echo number_format($all_tot_dye_chemical_cost,2); ?></a></p></td>
									...
									echo number_format($tot_income,2); ?></p></td>
									<td width="100" align="right"  title="Tot Dyes Chemical Cost(<? echo $all_tot_dye_chemical_cost;?>)/Tot Dyeing  Earn(<? echo $tot_dying_earning;?>)*100"><p><?  $conj_per=$all_tot_dye_chemical_cost/$tot_dying_earning*100;  if($tot_dye_chemical_cost) echo number_format($conj_per,2);else echo 0;?>	</p></td>
									<td width="100" align="right" title="Tot Dyes Chemical Cost/Tot Dyeing Kg"><?  $avg_cost_per=$tot_dye_chemical_cost/$tot_dying_qty_kg;  echo number_format($avg_cost_per,2);?>  </td>
