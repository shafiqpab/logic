...
if($action=="report_generate_month") 
{
	...
	{
		$sql="SELECT  a.company_id, a.location, a.floor_id, a.prod_reso_allo, a.production_date, a.sewing_line, b.buyer_name  as buyer_name, b.job_no, b.style_ref_no, a.po_break_down_id, a.item_number_id, c.po_number as po_number, c.file_no, c.unit_price, c.grouping as ref, sum(a.production_quantity) as good_qnty,
	...
	$production_po_data_arr=array(); $lineHoursArr=array(); $sewingOutputQtyArr=array();
	$reso_line_ids=''; $all_po_id=""; $lineWiseJobGmtsItemArr=array();
	...
	if($all_po_id!='' || $all_po_id!=0)
	{
		...
		else $poIds_cond=" and  b.id  in($all_po_id)";
	}
					...
					foreach($jobItemStr as $jobData)
					{
					   ...
					   //********************************* calclution floor total    *******************$txt_date],$sewing_day
						...
						$html.='<td width="40" align="center">'.$i.'&nbsp;</td>
								...
								<td align="center" width="60" bgcolor="'.$smvTd.'"><p>'.$item_smv.'</p></td>
    ...
    <div>
    	...
    	<fieldset>
	    	...
	    	<?php $table_width=2260+($last_hour-$hour)*50; ?>
		...
		$floor_line_num=0; $floor_name=""; $floor_smv=0; $floor_row=0; $floor_operator=0; $floor_helper=0; $floor_tgt_h=0; $floor_man_power=0; $floor_days_run=0; $eff_target_floor=0; $floor_working_hour=0; $line_floor_production=0; $floor_today_product=0; $floor_avale_minute=0; $floor_produc_min=0; $floor_efficency=0; $floor_man_power=0; $floor_capacity=0; $floor_sewing_input=0; $floor_action_machine=0; $floor_target_efficiency=0; $floor_extra_hour=0; $floor_extra_worker=0; $floor_target_efficiency_manual=0; $floor_production=array(); 
	foreach($production_serial_arr[$txt_date] as $f_id=>$fname)
	{
		ksort($fname); 
		$floor_line_num=0; $floot_line_total=0;
					   ...
					   //********************************* calclution floor total    *******************$txt_date],$sewing_day
						...
						$shtml.='<td width="40" align="center">'.$i.'&nbsp;</td>
								...
								$shtml.='<td align="center" width="80"><a href="##" onclick="openmypage('.$cbo_company_id.",'".$jobData."','sub',".$f_id.",".$ldata.",'tot_prod','".$item_smv."','".$actual_time_hour."','".$line_start."','".$txt_date."'".')">'.$line_production_hour.'</a></td>
									...
									$shtml.='<td align="center" width="60" >'.number_format($target_efficiency,0).'</td>
			...
			foreach($pop_val as $po_id=>$pop_val)
			{
			   if ($i%2==0) $bgcolor="#E9F3FF"; else $bgcolor="#FFFFFF";	
				...
				<tr bgcolor="<? echo $bgcolor; ?>" onclick="change_color('tr_<? echo $i; ?>','<? echo $bgcolor;?>')" id="tr_<? echo $i;?>">
					...
					<td align="right"> <? echo $producd_min; ?>&nbsp;</td>
				</tr>
				<?
                $i++;
			}
