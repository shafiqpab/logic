...
if($action=="report_generate")
{
	...
	if($txt_date_from && $txt_date_to)
	{
		...
		$get_batch_ids_by_batch_date=sql_select("select b.id,b.process_id from pro_batch_create_mst b where b.status_active=1 $batch_cond $batch_date_cond $floor_cond3");
