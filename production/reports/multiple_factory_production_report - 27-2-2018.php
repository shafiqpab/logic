...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	{
		if( form_validation('cbo_working_company_id*txt_date_from*txt_date_to','Working Company Name*Date From* Date To')==false )
		{
			return;
		}
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_product_cat*cbo_location*txt_date_from*txt_date_to*cbo_working_company_id',"../../")+'&report_title='+report_title+'&datediff='+datediff+'&type='+type;
		//alert(data);
		freeze_window(3);
...
<div style="width:100%;" align="center">
    <? echo load_freeze_divs ("../../",$permission); ?>   		 
        ...
        <h3 style="width:810px; margin-top:20px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel','')"> -Search Panel</h3> 
         <div id="content_search_panel" style="width:810px" align="center" >      
            <fieldset>  
                ...
                <tbody>
                    <tr class="general">
                       ...
                       <!-- </td>-->
                         ...
                         <td id="cbo_working_company_id_td" width="150" align="center"> 
			                        <?
...
/*set_multiselect('cbo_company_id','0','0','','0');
	...
	setTimeout[($("#cbo_working_company_id_td a").attr("onclick","disappear_list(cbo_working_company_id,'0');getCompanyId();") ,3000)];
</script>
