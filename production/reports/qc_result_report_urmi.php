...
Purpose			: 	This form will Create Qc Result Report
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Qc Result Report", "../../", 1, 1,'','','');
...
<script>
	...
	function fn_report_generated()
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*txt_batch_no*txt_system_id*txt_system_hidden_id',"../../")+'&report_title='+report_title;
		
		freeze_window(5);
		http.open("POST","requires/qc_result_report_urmi_controller.php",true);
	...
	function openmypage_system_id()
	{
		...
		var page_link='requires/qc_result_report_urmi_controller.php?action=system_id_popup&batch_no='+batch_no;
		var title='System Id Search';
		...
		emailwindow.onclose=function()
		{
			...
			var system_no=this.contentDoc.getElementById("hide_system_no").value;
			var system_id=this.contentDoc.getElementById("hide_system_id").value;
			$('#txt_system_id').val(system_no);
			$('#txt_system_hidden_id').val(system_id);	 
		}
	}
             ...
             <fieldset style="width:550px;">
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        <thead>
                            ...
                            <th class="must_entry_caption">Batch No</th>
                        ...
                        <tbody>
                            <tr class="general">
                               <td> 
                                ...
                                <td align="center">
                                     <input type="text" name="txt_batch_no" id="txt_batch_no" class="text_boxes" style="width:110px"   />
                                </td>
                                <td align="center">
                                     <input type="text" placeholder="Write/Browse" name="txt_system_id" id="txt_system_id" class="text_boxes" onclick="openmypage_system_id();"  style="width:110px" />

                                     <input type="hidden"  name="txt_system_hidden_id" id="txt_system_hidden_id" />
                                </td>
