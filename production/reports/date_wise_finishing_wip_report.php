...
function open_job_no()
{
    ...
    var page_link='requires/date_wise_finishing_wip_report_controller.php?action=job_popup&buyer_name='+buyer_name+'&cbo_year='+cbo_year;
...
function open_order_no()
{
	...
	var page_link='requires/date_wise_finishing_wip_report_controller.php?action=order_wise_search&company='+company+'&buyer='+buyer+'&style_id='+style_id+'&job_id='+job_id+'&job_no='+job_no;
...
function open_style_ref()
 	{
		...
		var job_id=$("#hidden_job_id").val();
		var cbo_year=$("#cbo_year").val();
		var page_link='requires/date_wise_finishing_wip_report_controller.php?action=style_wise_search&company='+company+'&buyer='+buyer+'&job_no='+job_no+'&job_id='+job_id+'&cbo_year='+cbo_year;
...
function fn_report_generated(type)
{
       ...
       if($("#txt_job_no").val()=="" && $("#txt_int_ref").val()=="" && $("#txt_order_no").val()==""  && $("#txt_style_no").val()=="")
       {
        ...
        var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_buyer_name*cbo_location*cbo_floor*txt_job_no*txt_int_ref*txt_date_from*txt_date_to*txt_order_no*txt_style_no',"../../")+'&report_title='+report_title+'&type='+type;
        freeze_window(3);
        http.open("POST","requires/date_wise_finishing_wip_report_controller.php",true);
...
function openmypage_sewingoutput(floor_id,job_no_prefix_num,id,item_number_id,color_number_id,action,width,height)
	{
		var popup_width=width;
		var popup_height=height;
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/date_wise_finishing_wip_report_controller.php?&id='+id+'&item_number_id='+item_number_id+'&floor_id='+floor_id+'&job_no_prefix_num='+job_no_prefix_num+'&color_number_id='+color_number_id+'&action='+action, 'Total Popup', 'width='+popup_width+','+'height='+popup_height+',center=1,resize=0,scrolling=0','../');
...
<form id="sewingQcReport_1">
    <div style="width:980px; margin:1px auto;">
        <? echo load_freeze_divs ("../../",'');  ?>
         <h3 style="width:980px;" align="center" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
         <div id="content_search_panel" style="width:750px" >
         <fieldset style="width:980px;">
            <table class="rpt_table" width="980" cellpadding="0" cellspacing="0" align="center" rules="all" border="1">
               <thead>
                    <tr>
