...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Machine Wise Finishing Report", "../../", 1, 1,'','','');
...
<script>
	...
	function fn_report_generated(type)
	{
		...
		if(txt_job_no=='' && booking_number=='' && batch_number=='')
		{
		...
		freeze_window(5);
		var report_title ="Machine Wise Compacting Report";
		var data="action=report_generate&type="+type+get_submitted_data_string('cbo_type*cbo_process_type*cbo_company_name*cbo_location_id*txt_job_no*booking_number*cbo_buyer_name*batch_number*batch_id*cbo_floor_id*cbo_machine_name*txt_date_from*txt_date_to',"../../")+'&report_title='+report_title;

		http.open("POST","requires/machine_wise_finishing_report_controller.php",true);
	...
	function bookingnumber()
	{
		...
		var batch_id=document.getElementById('batch_number').value;
		var page_link="requires/machine_wise_finishing_report_controller.php?action=bookingnumbershow&company_name="+company_name;
		...
		emailwindow.onclose=function()
		{
			...
			document.getElementById('booking_id').value=batch[0];
			document.getElementById('booking_number').value=batch[1];
			release_freezing();
		}
	}
	<!--BatchNumber -->
	function batchnumber()
	{
		...
		var page_link="requires/machine_wise_finishing_report_controller.php?action=batchnumbershow&company_name="+company_name;
				...
				<fieldset style="width:1300px;">
					<table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
						<thead>
							...
							<th class="must_entry_caption">Process Type</th>
						...
						<tr>
							<td align="center">
                                <?
                                $report_type=array('1,0'=>"Buyer Order",'3,0' =>'Sample With Order','3,1'=>'Sample Without Order');
                                echo create_drop_down( "cbo_type",120, $report_type,"",0, "", "","",0 );
                                ?>
                            </td>
                            <td align="center">
								<? 
                                echo create_drop_down( "cbo_process_type",90, $conversion_cost_head_array,"",0, "", "","",0,"33,94,63,171,65,156,179,200,170" );
                            	?>
                            </td>

                            <td align="center">
                            	<?
                            	echo create_drop_down( "cbo_company_name", 120, "select id,company_name from lib_company where status_active=1 and is_deleted=0  order by company_name","id,company_name", 1, "-- Select Company --", 0, "load_drop_down('requires/machine_wise_finishing_report_controller', this.value, 'load_drop_down_location','location_td');load_drop_down('requires/machine_wise_finishing_report_controller', this.value, 'load_drop_down_buyer', 'buyer_name_td');" );
                            	?>
                            </td>
                           ...
                           <td align="center">
                            ...
                            <td align="center">
                            	<input type="text"  name="booking_number" id="booking_number" class="text_boxes" style="width:70px;" tabindex="1" placeholder="Write/Browse" onDblClick="bookingnumber();">
                            ...
                            <td align="center">
                            	<input type="text"  name="batch_number" id="batch_number" class="text_boxes" style="width:70px;" tabindex="1" placeholder="Browse/Write" onDblClick="batchnumber();"  >
