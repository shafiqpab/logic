...
//------------------------------------------------------------------------------------
echo load_html_head_contents("Display Board", "../../", 1, 1,$unicode,1,1,1);
?>  
...
<script>
    ...
    {   
        ...
        {*/    
            ...
            // freeze_window(3);
            http.open("POST","requires/display_board_controller.php",true);
    ...
    function get_sewing_line()
    {
        ...
        // alert(floor_ids.join(", "));
        var floorIds = floor_ids.join(",");
        load_drop_down( 'requires/display_board_controller',floorIds+'_'+document.getElementById('cbo_company_id').value+'_'+document.getElementById('txt_sewing_date').value, 'load_drop_down_sewing_line_floor', 'sewing_line' );
        get_php_form_data( floorIds, 'eval_multi_select', 'requires/display_board_controller' );
    }
    ...
    function openmypage_line() // For Line
    {
        ...
        var page_link='requires/display_board_controller.php?action=line_search_popup&wo_company_name='+wo_company_name+'&floor_name='+floorIds+'&date_from='+date_from;  
               ...
               <div class="menu_icon" id="menu_icon"> Open </div>
                <div id="searchPanel">
                    <div id="searchPanelInner">
                        ...
                        <span>Refress Time(s) : <input type="number" name="refresh_time" id="refresh_time" value="5" style="width: 70px;"></span>
                        <p>Sewing Unit:</p>
