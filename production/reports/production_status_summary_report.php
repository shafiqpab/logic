...
<script>
	...
	function fn_report_generated(type)
	{
		...
		var internal_style_no=document.getElementById('txt_internal_style_no').value;
		var file_no=document.getElementById('txt_file_no').value;
	
		
		if (type==1 || type==2 || type==3 || type==4 || type==5)
		{
			if(job_no!="" || order_no!="" || style_no!="" || internal_style_no!="" || file_no!="")
			{
		...
		var data="action=report_generate&reporttype="+type+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_date_from*txt_date_to*txt_job_no*txt_job_id*txt_order_id*txt_order_no*cbo_year*cbo_search_date*txt_style_no*txt_style_id*txt_internal_style_no*txt_internal_style_id*txt_file_no*txt_file_id',"../../")+'&report_title='+report_title;
		//alert(data);return;
		freeze_window(3);
		if(type==1 || type==2 ||  type==3 || type==4 ||  type==5)
		{
	...
	function openmypage_job(search_type)
	{
		...
		emailwindow.onclose=function()
		{
			...
			{
				$('#txt_internal_style_no').val(job_no);
				$('#txt_internal_style_id').val(job_id);	
			}
			else if(search_type==5)
			{
				$('#txt_file_no').val(job_no);
				$('#txt_file_id').val(job_id);	
			}
			else
			{
                    ...
                    <tr class="general">
                        ...
                        <td>
                         ...
                         <td>
                            ...
                            <input type="text" id="txt_internal_style_no" name="txt_internal_style_no" class="text_boxes" style="width:70px"  placeholder="Write Int.Ref. No" />
                            <input type="hidden" id="txt_internal_style_id" name="txt_internal_style_id"/>
                        
                        </td>
                         <td>
                        
                            <input type="text" id="txt_file_no" name="txt_file_no" class="text_boxes" style="width:70px"  placeholder="Write File" />
