...
<script>
	...
	function fn_report_generated(operation)
	{
		...
		freeze_window(5);
	 	var data="action=batch_report&operation="+operation+get_submitted_data_string('cbo_company_name*cbo_working_company_id*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*txt_ext_no*hidden_ext_no*cbo_year*cbo_batch_type*txt_style_no*fso_number_show*fso_number*txt_booking_no_show*txt_booking_no*txt_date_from*txt_date_to*cbo_batch_against*cbo_load_unload*txt_int_ref_no', "../../");

		http.open("POST","requires/batch_report_for_sales_v2_controller.php",true);
	...
	function batchnumber()
	{
		...
		var page_link="requires/batch_report_for_sales_v2_controller.php?action=batchnumbershow&company_name="+company_name+"&year="+year;
	...
	function jobnumber()
	{
		...
		var page_link="requires/batch_report_for_sales_v2_controller.php?action=jobnumbershow&company_id="+company_name+"&cbo_buyer_name="+cbo_buyer_name+"&year="+year+"&batch_type="+batch_type;
	...
	function openmypage_order(id)
	{
		...
		var year=document.getElementById('cbo_year').value;
		var batch_type=document.getElementById('cbo_batch_type').value;
		var page_link="requires/batch_report_for_sales_v2_controller.php?action=order_number_popup&company_name="+company_name+"&buyer_name="+buyer_name+"&year="+year+"&batch_type="+batch_type;
	...
	function batch_extension()
	{
		...
		var company_name=document.getElementById('cbo_company_name').value;
		var page_link="requires/batch_report_for_sales_v2_controller.php?action=batchextensionpopup&company_name="+company_name+"&buyer_name="+buyer_name+"&year="+year+"&job_number_show="+job_number_show+"&batch_number_show="+batch_number_show+"&batch_number_hidden="+batch_number_hidden;
		//var page_link="requires/batch_report_for_sales_v2_controller.php?action=batchextensionpopup&company_name="+company_name;
	...
	function fsoNumber()
	{
	 	...
	 	else
	 	{
 			...
 			var page_link = 'requires/batch_report_for_sales_v2_controller.php?cbo_company_id=' + cbo_company_id + '&action=FSO_No_popup';
 	...
 	function openmypage_booking()
	{
		...
		var page_link='requires/batch_report_for_sales_v2_controller.php?action=booking_no_popup&companyID='+companyID+ '&cbo_year='+cbo_year;
	...
	function generate_batch_print_report(print_btn,company_id,sys_id,batch_no,working_company,ext_no,batch_sl_no,booking_no_id,roll_maintained)
	{
		...
		if(print_btn==419)// batch card 22
		{

			window.open("../requires/batch_creation_controller.php?data=" + company_id+'*'+sys_id+'*'+batch_sl_no+'*'+batch_no+'*'+ext_no+'*'+report_title+'*'+booking_no_id+'*'+working_company+'*'+roll_maintained+'&action=batch_card_print_23', true );
		}
	}
	...
	function generate_booking_report(txt_booking_no, cbo_company_name, txt_order_no_id, cbo_fabric_natu, cbo_fabric_source, id_approved_id, txt_job_no, booking_entry_form, report_print_btn) 
    {
        ...
        {
			if(report_print_btn==502) // Print B26
	        {
	            var show_yarn_rate='';
	...
	function openmypage_roll(batch_id, product_ids,po_id, body_part_id,width_dia_type)
	{
		...
		var data=document.getElementById('cbo_company_name').value+"_"+batch_id+"_"+product_ids+"_"+po_id+"_"+body_part_id+"_"+width_dia_type;
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/batch_report_for_sales_v2_controller.php?action=roll_no_popup&data='+data,'Roll No Popup', 'width=850px,height=420px,center=1,resize=0','../');
	}
    ...
    {    
        ...
        load_drop_down( 'requires/batch_report_for_sales_v2_controller', company_id+'_'+cbo_batch_type, 'load_drop_down_buyer', 'cbo_buyer_name_td');
    }
</script>
</head>
                            ...
                            <tr class="general">
                                <td id="td_company">
                                    <?
                                        ...
                                        // load_drop_down('requires/batch_report_for_sales_v2_controller',this.value+'_'+document.getElementById('cbo_batch_type').value, 'load_drop_down_buyer','cbo_buyer_name_td' );
                                    ?>
                                </td>
                                <td align="center">
		                            <?
								 ...
								 <td>
                                    <?
                                        ...
                                        echo create_drop_down( "cbo_batch_type",70, $batch_type_arr,"",0, "--All--", 1,"load_drop_down('requires/batch_report_for_sales_v2_controller',document.getElementById('cbo_company_name').value+'_'+this.value, 'load_drop_down_buyer', 'cbo_buyer_name_td' );",1,1 );
                                    ?>
                                </td>
