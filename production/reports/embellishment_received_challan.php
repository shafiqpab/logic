<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Emb. Received Callan Report.
Functionality	:	
JS Functions	:
Created by		:	Kaiyum 
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Embellishment Received Challan Report", "../../", 1, 1,$unicode,'','');
...
var permission = '<? echo $permission; ?>';
	...
	function fn_report_generated()
	{
		...
		freeze_window(3);
		http.open("POST","requires/embellishment_received_challan_controller.php",true);
	...
	function fn_with_source_report(operation) 
	{
	 	if(operation==4) // Print
		{
			 ...
			 freeze_window(3);
			 var report_title="Embellishment Receive Challan";
			 print_report( $('#cbo_company_name').val()+'*'+master_ids+'*'+report_title+'*'+$('#txt_delivery_date').val(), "delivery_challan_print", "requires/embellishment_received_challan_controller" );
			 release_freezing(); 
			 return;
		}
	}
    ...
    <div style="width:100%;" align="center"> 
        ...
        <? echo load_freeze_divs ("../../",'');  ?>  
         ...
         <fieldset style="width:1000px;">
            ...
            <table class="rpt_table" width="1270px" cellpadding="0" cellspacing="0" align="center">
               <thead>                    
                    <tr>
                ...
                <tr class="general">
                    <td width="150"> 
                        <?
                            echo create_drop_down( "cbo_company_name", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/embellishment_received_challan_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                        ?>
                    </td>
					...
					<td width="110"> 
						...
						$knitting_source_2 = array(1=>"In-house", 3=>"Out-BoundSubcontract");
                            echo create_drop_down( "cbo_source", 150,$knitting_source_2 ,"", 1, "-- Select Source --", $selected, "load_drop_down( 'requires/embellishment_received_challan_controller',this.value, 'load_drop_down_supplier', 'supplier_td' );" );
                            // echo create_drop_down( "cbo_source", 150,$knitting_source, 1, "-- Select Company --", $selected, "load_drop_down( 'requires/embellishment_received_challan_controller',this.value, 'load_drop_down_buyer', 'supplier' );" );
                        ?>
                    </td>
