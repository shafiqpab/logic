...
<script>
    ...
    function fn_report_generated(report_type) {
        ...
        var data = "action=report_generate" + get_submitted_data_string('cbo_company_name*cbo_type*cbo_year*txt_sales_order*cbo_knitting_source*cbo_floor_id*txt_date_from*txt_date_to*txt_booking_no*cbo_within_group*cbo_booking_type*cbo_working_company_id*cbo_location_id', "../../") + '&report_title=' + report_title + '&report_type=' + report_type;

        freeze_window(5);
        http.open("POST", "requires/daily_knitting_production_report_sales_controller.php", true);
    ...
    function generate_delivery_challan_report() {
        ...
        //alert (program_ids)
        print_report(program_ids + '_' + source_ids + '_' + company + '_' + from_date + '_' + to_date, "delivery_challan_print", "requires/daily_knitting_production_report_sales_controller");
    }
    ...
    function openmypage_booking_no() {
        ...
        var page_link = 'requires/daily_knitting_production_report_sales_controller.php?action=booking_no_search_popup&companyID=' + companyID + '&yearID=' + yearID + '&ordType=' + ordType+'&cbo_booking_type='+cbo_booking_type;
    ...
    function openmypage_sales_order() {
        ...
        var page_link = 'requires/daily_knitting_production_report_sales_controller.php?action=sales_order_no_search_popup&companyID=' + companyID + '&yearID=' + yearID + '&ordType=' + ordType + '&cbo_within_group=' + cbo_within_group;
    ...
    {    
        ...
        load_drop_down( 'requires/daily_knitting_production_report_sales_controller', company_id, 'load_drop_down_floor', 'floor_td');
        fn_disable_com(1);
    }
                ...
                <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all"
                    ...
                    <tr class="general">
                        ...
                        <td width="150" align="center">
                            <?
                                echo create_drop_down( "cbo_working_company_id", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/daily_knitting_production_report_sales_controller', $('#cbo_working_company_id').val(), 'load_drop_down_floor', 'floor_td');fn_disable_com(2);load_drop_down('requires/daily_knitting_production_report_sales_controller', this.value, 'load_drop_down_location', 'location_td' );" );
                            ?>
                        </td>
                        ...
                        <td align="center">
							...
							echo create_drop_down("cbo_type", 70, $gen_type, "", 1, "-- All --", 0, "load_drop_down( 'requires/daily_knitting_production_report_sales_controller', $('#cbo_company_name').val()+'**'+this.value,); fnc_active_inactive(this.value);", 0, '');
							?>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <input type="button" id="show_button" class="formbutton"   title="Select single day" style="width:80px" value="Machine Wise2" onClick="fn_report_generated(3)"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="9" align="center"><? echo load_month_buttons(1); ?></td>
                        <td colspan="2" align="center">
                            <!-- <input type="button" id="show_button" class="formbutton" style="width:110px" value="Today Production" onClick="fn_report_generated_today()" /> --></td>
                    </tr>
                    </tbody>
                </table>
            </fieldset>
