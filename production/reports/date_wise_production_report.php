...
var permission = '<? echo $permission; ?>';
	...
	function fn_report_generated(excel_type)
	{
		...
		else
		{
			...
			if((excel_type==1 || excel_type==2 || excel_type==3) && cbo_type !=2)
			{
				alert("Total CM Value Button Only Allow For Show Date Location & Floor Wise Type.");return;
			}
			
			
			if(excel_type==2)
			{
				var data="action=report_generate_cm_value"+get_submitted_data_string('cbo_garments_nature*cbo_company_name*cbo_buyer_name*cbo_location*cbo_floor*txt_file_no*txt_internal_ref*cbo_type*txt_date_from*txt_date_to',"../../")+'&excel_type='+excel_type;
			}
			else if(excel_type==3)
			{
				var data="action=report_generate_cm_value3"+get_submitted_data_string('cbo_garments_nature*cbo_company_name*cbo_buyer_name*cbo_location*cbo_floor*txt_file_no*txt_internal_ref*cbo_type*txt_date_from*txt_date_to',"../../")+'&excel_type='+excel_type;
			}
			else if(excel_type==4)
			{
				var data="action=report_generate_cm_value4"+get_submitted_data_string('cbo_garments_nature*cbo_company_name*cbo_buyer_name*cbo_location*cbo_floor*txt_file_no*txt_internal_ref*cbo_type*txt_date_from*txt_date_to',"../../")+'&excel_type='+excel_type;
			}
			else if(excel_type==5)
			{
				var data="action=report_generate_cm_value5"+get_submitted_data_string('cbo_garments_nature*cbo_company_name*cbo_buyer_name*cbo_location*cbo_floor*txt_file_no*txt_internal_ref*cbo_type*txt_date_from*txt_date_to',"../../")+'&excel_type='+excel_type;
			}
			else
			{
	...
	function print_report_button_setting(report_ids) 
    {
        ...
        report_id.forEach(function(items){
            ...
            else if(items==743){$('#show_button1').show();}
            else if(items==744){$('#show_button2').show();}
            else if(items==745){$('#show_button3').show();}
            else if(items==752){$('#show_button4').show();}
            });
    }
    ...
    <div style="width:100%;" align="center">    
        <? echo load_freeze_divs ("../../",'');  ?>
         <fieldset style="width:1090px;">
            ...
            <table class="rpt_table" width="1090px" cellpadding="0" cellspacing="0" align="center" rules="all" border="1">
               <thead>                    
                    <tr>
                        ...
                        <th width="220"><input type="reset" id="reset_btn" class="formbutton" style="width:70px" value="Reset" /></th>
                    </tr>    
                 </thead>
                <tbody>
                <tr class="general">
                    ...
                    <td width="170">
                    	...
                    	<input type="button" id="show_button1" class="formbutton" style="width:70px;display: none;" value="CM Value" onClick="fn_report_generated(1)" />
                    </td>
                </tr>
                <tr class="general">
                	<td colspan="10" align="center"><? echo load_month_buttons(1); ?></td>
                    <td colspan="8">
                    <input type="button" id="show_button2" class="formbutton" style="width:80px;display: none;" value="CM Value 2" onClick="fn_report_generated(2)" />
                    <input type="button" id="show_button4" class="formbutton" style="width:80px;display: none;" value="CM Value 3" onClick="fn_report_generated(3)" />
					...
					<input type="button" id="show_button5" class="formbutton" style="width:100px;display: block;" value="Daily CM Status" onClick="fn_report_generated(4)" />
					
					<input type="button" id="show_button6" class="formbutton" style="width:100px;display: block;" value="Monthly CM Status" onClick="fn_report_generated(5)" />
                    </td>
                </tr>
                </tbody>
            </table>
