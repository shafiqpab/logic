<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	Issue Id: 2382
Functionality	:	
JS Functions	:
Created by		:	Md Rakib Hasan Mondal
Creation date 	: 	14-February-2023
Updated by 		: 		
Update date		: 		   
QC Performed BY	:		
QC Date			:	
...
<script>
    ...
    function fn_report_generated()
    {
        ...
        {            
            var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_location*cbo_buyer_name*cbo_line_id*cbo_search_by*txt_search_common*cbo_year*txt_date',"../../");
            freeze_window(3);
            http.open("POST","requires/cutting_to_input_report_controller.php",true);
            ...
            <table class="rpt_table" width="750px" cellpadding="0" cellspacing="0" border="1" align="center">
               <thead>                    
                    <tr>
                        ...
                        <th width="200" id="search_text_td">Date</th>
                ...
                <tr >
                    <td width="150"> 
                        <?
                            echo create_drop_down( "cbo_company_name", 150, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/cutting_to_input_report_controller', this.value, 'load_drop_down_location', 'location_td' );load_drop_down( 'requires/cutting_to_input_report_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                        ?>
                    </td>                   
                    <td width="150" id="location_td">
                        <? 
                            echo create_drop_down( "cbo_location", 150, $blank_array,"", 1, "-- Select Location --", $selected, " load_drop_down( 'requires/cutting_to_input_report_controller', this.value, 'load_drop_down_floor', 'floor_td' );", 1, "" );
                        ?>
                    </td>
                    ...
                    <td width="150" id="line_id">
                        <? 
                             echo create_drop_down( "cbo_line_id", 150, $blank_array,"", "", "-- Select Line --", "", "" );
                        ?>
                    </td>
                    ...
                    <td width="200">
                        <input name="txt_date" id="txt_date" class="datepicker" style="width:70px"  placeholder="Date"  >
                    </td>                  
                    <td width="100">
