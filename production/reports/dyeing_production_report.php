...
<script>
    ...
    function print_button_setting(company)
	{
		...
		get_php_form_data(company,'print_button_variable_setting','requires/dyeing_production_report_controller' );
	}
       ...
       /* if (j_number != "" || j_number_hidden != "" || b_number != "" || batch_no != "" || order_no != "" || file_no != "" || ref_no != "" || order_no_hidden != "")
        ...
        else if(txt_date_from=="" || txt_date_to=="")
        {
           ...
           freeze_window(5);
            ...
            {
                var data = "action=dyeing_production_report5&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
                //alert(data);
            }

            else if (operation == 6)
            {
                var data = "action=dyeing_production_report6&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
            }
            ...
            else if (operation == 7) //reProcess
            {
                var data = "action=generate_report_6&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
            }
            else if (operation == 8) // Report 7, Month wise
            {
                var data = "action=generate_report_7&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
            }
            else if (operation == 9) //Summery Button
            {
                var data = "action=generate_summery_report&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
            }
            else if (operation == 10)
            {
                var data = "action=dyeing_production_reportshow6&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
            }
            else if (operation == 11) //report 3A
            {
                var data = "action=generate_report3A&operation=" + operation + get_submitted_data_string('cbo_company_name*cbo_buyer_name*job_number_show*job_number*batch_number*batch_number_show*order_no*hidden_order_no*cbo_type*cbo_year*txt_color*txt_date_from*txt_date_to*cbo_result_name*cbo_batch_type*txt_machine_name*txt_machine_id*cbo_floor_id*cbo_shift_name*cbo_group_by*search_type*file_no*ref_no*cbo_prod_type*cbo_party_id*cbo_working_company_name*txt_hide_booking_id*txt_booking_no', "../../");
            }
            //alert(data);
        //}
    ...
    function search_populate(str)
    {
        ...
        function openmypage_booking()
        {
            ...
            var page_link='requires/dyeing_production_report_controller.php?action=booking_no_popup&companyID='+companyID+'&buyer_name='+buyer_name+'&cbo_year_id='+cbo_year_id;
...
<body onLoad="set_hotkey();">
    <div style="width:100%;" align="center">
        ...
        <form name="dailyYarnStatusReport_1" id="dailyYarnStatusReport_1">
            <h3 style="width:1770px; margin-top:10px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id, 'content_search_panel', '')">-Search Panel</h3>         <div id="content_search_panel" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="19" align="center">
                                    ...
                                    <!-- <input type="button" id="show_button" class="formbutton" style="width:54px" value="Summery" onClick="fn_dyeing_report_generated(9)" /> -->
