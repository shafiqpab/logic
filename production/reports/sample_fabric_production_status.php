...
<script>
	...
	function openmypage(batchId,bookingNo,bodypart,color,action)
	{
		var companyID = $("#cbo_company_name").val();
		var popup_width='380px';
		alert(batchId+'='+action);

		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/sample_fabric_production_status_controller.php?companyID='+companyID+'&action='+action+'&batchId='+batchId+'&bookingNo='+bookingNo+'&color='+color+'&bodypart='+bodypart, 'Details Veiw', 'width='+popup_width+', height=300px,center=1,resize=0,scrolling=0','../');
	}
</script>
</head>
