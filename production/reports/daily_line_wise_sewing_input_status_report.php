...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function generate_report()
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_floor_id*cbo_line_id*cbo_shift_name*txt_date_from*txt_date_to',"../../")+'&report_title='+report_title;
	
		freeze_window(3);
		http.open("POST","requires/daily_line_wise_sewing_input_status_report_controller.php",true);
	...
	{
  		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/daily_line_wise_sewing_input_status_report_controller.php?datas='+datas+'&action='+action, 'Prod. Qty View', 'width=720px,height=450px,center=1,resize=0,scrolling=0','../');
	}
	function openmypage_cut_no_qty(datas,action)
	{
  		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/daily_line_wise_sewing_input_status_report_controller.php?datas='+datas+'&action='+action, 'System Cut No', 'width=610px,height=330px,center=1,resize=0,scrolling=0','../');
	}
