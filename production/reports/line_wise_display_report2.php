...
http://localhost/platform-v3.1/production/reports/line_wise_display_report2.php?url=company name/line Name/
http://118.179.205.12/jk_erp/production/reports/line_wise_display_report2.php?url=JK Knit Composite Ltd./33/
*/
...
<script> 
    ...
    $(document).ready(function() {
        ...
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/line_wise_display_report2_controller.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_line='"+cbo_line+"'";
        //alert(data);
        http.open("POST","requires/line_wise_display_report2_controller.php",true);
