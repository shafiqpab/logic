...
<script>
    ...
    {   
        ...
        {            
            ...
            freeze_window(3);
            http.open("POST","requires/display_controller.php",true);
    ...
    {   
        ...
        {            
            var data="action=report_generate2"+get_submitted_data_string('cbo_company_name*cbo_location*cbo_floor*cbo_line*cbo_buyer_name*txt_style_no*txt_order_no*txt_job_no*txt_date',"../../");
            freeze_window(3);
            http.open("POST","requires/display_controller.php",true);
            http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
            http.send(data);
                ...
                <table class="rpt_table" width="1050px" cellpadding="0" cellspacing="0" border="1" align="center">
                    ...
                    <tbody>
                        <tr>
                            <td width="140"> 
                                <?
                                    echo create_drop_down( "cbo_company_name", 140, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/display_controller', this.value, 'load_drop_down_location', 'location_td' );load_drop_down( 'requires/display_controller', this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                                ?>
                            </td>  
                            <td width="">
                                <input name="txt_date" id="txt_date" class="datepicker" style="width:114px" onChange="load_drop_down( 'requires/display_controller',document.getElementById('cbo_floor').value+'_'+document.getElementById('cbo_location').value+'_'+document.getElementById('cbo_company_name').value+'_'+this.value, 'load_drop_down_line', 'line_td' );" readonly >
                            </td>                  
                            ...
                            <td width="70">
                                <input type="button" id="show_button" class="formbutton" style="width:70px" value="Input Req" onClick="fn_report_generated2()" />
                            </td>
