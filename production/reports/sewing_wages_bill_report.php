...
function fn_report_generated()
{
	...
	else
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_location*cbo_division*cbo_department*cbo_shift*txt_date_from*txt_date_to*cbo_line',"../../");
		freeze_window(3);
		http.open("POST","requires/sewing_wages_bill_report_controller.php",true);
		 ...
		 var tableFilters = 
				{
					col_17: "none",
					col_operation: {
									id: ["tot_po_qty","tot_wo_qty","tot_prev_bill_qty","tot_pro_qty","tot_bill_qty","tot_amount"],
									//col: [10,11,12,13,14,16],
									col: [11,12,13,14,15,17],
...
'<html><head><title></title><link rel="stylesheet" href="../../css/style_common.css" type="text/css"/></head><body>'+document.getElementById('report_container2').innerHTML+'</body</html>'); 
	...
	$('.scroll_body').css('max-height', '300px');
            ...
            <table class="rpt_table" width="850px" cellpadding="0" cellspacing="0" border="1" align="center">
               <thead>                    
                ...
                <tr >
                    <td> 
                        <?
                            echo create_drop_down( "cbo_company_name", 140, $company_arr,"id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/sewing_wages_bill_report_controller', this.value, 'load_drop_down_location', 'location_td' );",0,"1,3" );
                        ?>
                    </td>  
                    <td id="location_td">
                    	<? 
                    ...
                    <td id="line_td">
                    	<? 
                            echo create_drop_down( "cbo_line", 80, $line_lib,"", 1, "-- Select --", $selected, "", 1, "" );
                        ?>
                    </td>
