<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	Iron Wages Bill Report
Functionality	:	
JS Functions	:
Created by		:	REZA 
...
function fn_report_generated()
{
	...
	else
	{
		...
		freeze_window(3);
		http.open("POST","requires/ironing_wages_bill_report_controller.php",true);
            ...
            <table class="rpt_table" width="850px" cellpadding="0" cellspacing="0" border="1" align="center">
               <thead>                    
                ...
                <tr >
                    <td> 
                        <?
                            echo create_drop_down( "cbo_company_name", 140, $company_arr,"id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/ironing_wages_bill_report_controller', this.value, 'load_drop_down_location', 'location_td' );",0,"1,3" );
                        ?>
                    </td>  
                    <td id="location_td">
                    	<? 
