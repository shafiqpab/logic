...
//alert(cbo_line_id);
	...
	function fn_on_change_line()
	{
		...
		//var cbo_working_company_name = $("#cbo_working_company_name").val();
		load_drop_down( 'requires/date_wise_sewing_defect_report_controller', wk_floor_name, 'load_drop_down_floor_line', 'line_wk_td' );
...
<body onLoad="set_hotkey();">
	...
	<h3 style="width:1400px; margin-top:20px;" align="center" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3>
   	    <div style="width:100%;" align="center" id="content_search_panel">
			<form id="dateWiseProductionReport_1">    
  			<fieldset style="width:1400px;">
        		<table class="rpt_table" width="1400" cellpadding="0" cellspacing="0" align="center" border="1" rules="all">
	                <thead>                    
	                    <tr>
                       ...
                       placeholder="Wr./Br. Order"  />    <input type="hidden" name="txt_style_id" id="txt_style_id" readonly>
                           ...
                           $date=date('d-m-Y', strtotime('-1 day', strtotime(date('d-m-Y'))))
		                    ...
		                    <td>
                                ...
                                <input type="button" id="show_button" class="formbutton" style="width:50px" value="Sewing" onClick="fn_generate_report(2)" />                       
		                    </td>
		                </tr>
            		</tbody>
            		<tfoot>
