...
function fn_report_generated()
{
	...
	else
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_name*cbo_location*cbo_floor*cbo_line*txt_style_no*txt_file_no*txt_internal_no*txt_date*cbo_subcon',"../../");
		freeze_window(3);
            ...
            <table class="rpt_table" width="1050px" cellpadding="0" cellspacing="0" border="1" align="center">
               <thead>                    
                ...
                <tr >
                    <td width="140"> 
                        <?
                            echo create_drop_down( "cbo_company_name", 140, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/line_wise_hourly_production_report_controller', this.value, 'load_drop_down_location', 'location_td' );" );
                        ?>
                    </td>  
                    <td width="">
                    ...
                    <td width="100">
                         <input type="text" id="txt_internal_no" name="txt_internal_no" class="text_boxes" style="width:105px" />
                    </td> 
                    <td width="100">
                         <input type="text" id="txt_file_no" name="txt_file_no" class="text_boxes" style="width:105px" />
                    </td> 
