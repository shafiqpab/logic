...
<script>
	...
	{		
		...
		// alert(data); return;
		freeze_window(3);
		http.open("POST","requires/qi_wise_report_controller.php",true);
    ...
    {
        var page_link='requires/qi_wise_report_controller.php?action=operator_popup';
    ...
    {
        var page_link='requires/qi_wise_report_controller.php?action=supervisor_popup';
	...
	function openmypage_order_no() 
	{
		...
		var page_link='requires/qi_wise_report_controller.php?action=order_no_popup&lc_company='+lc_company+'&buyer='+buyer+'&job_no='+job_no;  
	...
	{ 
		...
		var page_link='requires/qi_wise_report_controller.php?action=lotratio_popup&company_id='+company_id; 
	...
	function fnc_bundelDtls(companyid,bundleNo,action)
	{
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/qi_wise_report_controller.php?companyid='+companyid+'&bundleNo='+bundleNo+'&action='+action, 'Details View', 'width='+popup_width+', height=350px,center=1,resize=0,scrolling=0','../');
	}

function showChart(inspectorName, totalmark) 
{
    // $("#chart_container").show('fast');
    var inspector_name_arr = inspectorName.split('__');
    // var inspector_name_arr = inspector_name_arr.toString();
    var defect_mark_arr = totalmark.split('__');
    var defect_mark_arr = defect_mark_arr.map(Number);
    ...
    Highcharts.chart('report_container2', {
        ...
        title: 
        {
            text: 'QI Wise Mark Report Chart',
            style:
                {
                    color: 'black',
                    fontSize: '22px',
...
<form id="bundleTrackReport_1">
    <div style="width:100%;" align="center">    
        <? echo load_freeze_divs ("../../../",'');  ?>
         <h3 style="width:970px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')">-Search Panel</h3> 
         ...
         <fieldset style="width:970px;">
             <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
             	<thead>
                    ...
                    <th width="135">Inspection Supervisor</th>
                    <th width="120">Operator ID</th>  
                ...
                <tbody>
                    <tr class="general">
                        ...
                        <td>
                        	<input type="button" name="search1" id="search1" value="Show" onClick="generate_report(1);" style="width:90px" class="formbutton" />
                        	<input type="button" name="search1" id="search1" value="Mark" onClick="generate_report(3);" style="width:70px" class="formbutton" />
