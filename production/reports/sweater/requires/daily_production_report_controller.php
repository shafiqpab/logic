	...
	// else $shipping_status_cond="";
  	...
  	if($type==1)
  	{
		 ...
		 $po_number_id=array();
			  ...
			  b.style_ref_no as style,d.color_number_id,d.item_number_id,b.company_name,a.excess_cut,b.gauge
			  ...
			  b.status_active=1 $company_name $buyer_name $style_cond  $job_cond_id order by a.job_no_mst,a.po_number,d.country_ship_date";
			 // echo $po_sql;
			...
			//echo $production_sql;
			$prod_sql="SELECT *FROM(SELECT a.po_break_down_id,a.production_date,a.serving_company,a.production_source,
			...
			//echo $prod_sql;
             $production_mst_sql=sql_select($prod_sql);
			   ...
			   {
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['knitting_complete_qnty']+=$val[csf('knitting_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['wash_complete_qnty']+=$val[csf('wash_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['inline_inspection_qnty']+=$val[csf('inline_inspection_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['sewing_complete_qnty']+=$val[csf('sewing_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['iron_complete_qnty']+=$val[csf('iron_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['re_iron_qnty']+=$val[csf('re_iron_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['linking_complete_qnty']+=$val[csf('linking_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['attachment_complete_qnty']+=$val[csf('attachment_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['packing_complete_qnty']+=$val[csf('packing_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['trimming_complete_qnty']+=$val[csf('trimming_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['mending_complete_qnty']+=$val[csf('mending_complete_qnty')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['pqc_complete_qnty']+=$val[csf('pqc_complete_qnty')];

					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['serving_company']=$val[csf('serving_company')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['production_date']=$val[csf('production_date')];
					$production_data_arr[$val[csf('production_date')]][$val[csf('serving_company')]][$val[csf('production_source')]][$job_no_arr[$val[csf('po_break_down_id')]]]['production_source']=$val[csf('production_source')];
			...
			// 	print_r($production_data_arr);die;
				...
				foreach ($production_data_arr as $production_date => $pro_data)
					{

					foreach($pro_data as $ser_com=>$ser_com_arr)
					{
						foreach($ser_com_arr as $source=>$source_arr)
						{
							foreach($source_arr as $job_no=>$job_arr)
							{

								$serving_company=$job_arr['serving_company'];
								$knitting_complete_qnty=$job_arr['knitting_complete_qnty'];
								$wash_complete_qnty=$job_arr['wash_complete_qnty'];

								$inline_inspection_qnty=$job_arr['inline_inspection_qnty'];
								$sewing_complete_qnty=$job_arr['sewing_complete_qnty'];
								$iron_complete_qnty=$job_arr['iron_complete_qnty'];
								$re_iron_qnty=$job_arr['re_iron_qnty'];
								$linking_complete_qnty=$job_arr['linking_complete_qnty'];
								$attachment_complete_qnty=$job_arr['attachment_complete_qnty'];
								$production_source=$job_arr['production_source'];
								$packing_complete_qnty=$job_arr['packing_complete_qnty'];
								$trimming_complete_qnty=$job_arr['trimming_complete_qnty'];
								$mending_complete_qnty=$job_arr['mending_complete_qnty'];
								$pqc_complete_qnty=$job_arr['pqc_complete_qnty'];
  		...
  		<fieldset style="width:1730px;">
             ...
             <table cellspacing="0" border="1" class="rpt_table"   rules="all"     align="center">
             	...
             	<tbody>
             		...
             		foreach ($buyer_wise_data as $buyer=>$buyer_data)
             		{
	             		...
	             		<tr  bgcolor="<? echo $bgcolor; ?>">
	             			...
	             			<td align="right" ><?php echo $buyer_data['knitting_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['inline_inspection_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['linking_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['trimming_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['mending_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['wash_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['attachment_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['sewing_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['pqc_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['iron_complete_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['re_iron_qnty']; ?></td>
	             			<td align="right"><?php echo $buyer_data['packing_complete_qnty']; ?></td>
             	...
             	<tbody>
	              	<tr>
	              		...
	              		<td align="right"><?php echo $knitting_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $inline_inspection_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $linking_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $trimming_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $mending_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $wash_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $attachment_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $sewing_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $pqc_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $iron_complete_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $re_iron_qnty_buyer; ?></td>
	              		<td align="right"><?php echo $packing_complete_qnty_buyer; ?></td>
	              	</tr>
	              </tbody>
             </table>
             ...
             <div style="width:1720px; margin-left:18px" >
                    <table cellspacing="0" border="1" class="rpt_table"  width="1700" rules="all" id="table_body"  style="max-height: 400px;overflow-y: auto;overflow-x: hidden;"  id="scroll_body">
                    	<thead >
                    		<tr>
                    			<td colspan="23" style="justify-content: left;text-align: left;font-size: 18px;font-weight:bold;"><strong>In House Production</strong></td>
                    		</tr>
		                	<tr >
		                       <th width="40" >SL</th>
		                ...
		                <tbody >
										...
										foreach($source_arr as $job_no=>$job_arr)
										{
												...
												if($production_source==1)
												{
									                ...
									                <tr bgcolor="<? echo $bgcolor; ?>" onClick="change_color('tr_2nd<? echo $i; ?>','<? echo $bgcolor; ?>')" id="tr_2nd<? echo $i; ?>">
									                    ...
									                    <td align="right"> <?php echo number_format($order_qty,0) ?></td>
									                    <td align="right" > <?php echo number_format($plan_qty,0) ?></td>
									                    <td align="right"> <?php echo $excess_cut; ?></td>
									                    <td align="right"> <?php echo number_format($knitting_complete_qnty,0);$knit+=$knitting_complete_qnty; ?></td>
									                    <td align="right"> <?php echo number_format($inline_inspection_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($linking_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($trimming_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($mending_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($wash_complete_qnty,0) ?></td>
									                    <td align="right" > <?php echo number_format($attachment_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($sewing_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($pqc_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($iron_complete_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($re_iron_qnty,0) ?></td>
									                    <td align="right"> <?php echo number_format($packing_complete_qnty,0) ?></td>
	                      ...
	                      <tbody>
		                      	<tr>
		                      		...
		                      		<td align="right"><?php echo $knit; ?></td>
		                      		<td align="right"><?php echo $inline_inspection_qnty_total; ?></td>
		                      		<td align="right"><?php echo $linking_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $trimming_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $mending_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $wash_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $attachment_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $sewing_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $pqc_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $iron_complete_qnty_total; ?></td>
		                      		<td align="right"><?php echo $re_iron_qnty_total; ?></td>
		                      		<td align="right"><?php echo $packing_complete_qnty_total; ?></td>
		                      	</tr>
	                      </tbody>
	                ...
	                <br>
	                 ...
	                 <table cellspacing="0" border="1" class="rpt_table"  width="1700" rules="all" id="table_body"  style="max-height: 400px;overflow-y: auto;overflow-x: hidden;"  id="scroll_body">
                    	<thead >
                    		<tr>
                    			<td colspan="23"  style="justify-content: left;text-align: left;font-size: 18px;font-weight:bold"><strong>Sub-Contract Production</strong></td>
                    		</tr>
		                	<tr >
		                       <th width="40" >SL</th>
		                       <th width="120" >Company</th>
