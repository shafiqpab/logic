<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Create  Style and Color Wise knitting Production Report.
Functionality	:	
JS Functions	:
...
echo load_html_head_contents("Style and Color Wise knitting Production Report","../../../", 1, 1, $unicode,1,1);
?>	
<script>
	...
	function fn_report_generated(type)
	{
		...
		var order_no=document.getElementById('cbo_status').value;
		...
		var data="action=report_generate&reporttype="+type+get_submitted_data_string('cbo_company_name*cbo_buyer_name*txt_style_ref*txt_style_ref_id*cbo_status*cbo_year*txt_job_no*txt_job_no_id*txt_date_from*txt_date_to',"../../../")+'&report_title='+report_title;
		//alert(data);return;
		freeze_window(3);
		if(type==1 || type==2) 
		{
			http.open("POST","requires/style_and_color_wise_knitting_production_report_controller.php",true);
		}
	...
	function openmypage_style(type)
	{
		...
		var page_link='requires/style_and_color_wise_knitting_production_report_controller.php?action=job_no_popup&companyID='+companyID+'&buyer_name='+buyer_name+'&cbo_year_id='+cbo_year_id+'&txt_job_no='+txt_job_no+'&txt_job_no_id='+txt_job_no_id+'&type='+type;
	...
	function openmypage_order() 
	{
		...
		//alert (data);
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/style_and_color_wise_knitting_production_report_controller.php?action=order_no_popup&data='+data,'Order No Popup', 'width=630px,height=420px,center=1,resize=0','../../')
		emailwindow.onclose=function()
		{
         ...
         <fieldset style="width:1100px;" id="content_search_panel">
            <table class="rpt_table" width="1100" cellpadding="1" cellspacing="2" align="center" border="1" rules="all">
                <thead>                    
                    ...
                    <th title="Pub Ship date" colspan="2">Shipment Date</th>
                    ...
                    <tr class="general">
                        <td width="150"> 
							<?
                           		...
                           		echo create_drop_down( "cbo_company_name", 140, "select comp.id, comp.company_name from lib_company comp where comp.status_active =1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-- Select Company --", $selected, "load_drop_down( 'requires/style_and_color_wise_knitting_production_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );" );
                            ?>
                        </td>
                        ...
                        <td width="110">
                            <?
                                $shipment_status=array(1=>"Pending and Partial Shipment",2=>"Full Shipment");
                                echo create_drop_down( "cbo_status", 110, $shipment_status,"", 1, "--Select--", $selected, "",0,"" );
                            ?> 
                        </td>
                        <td width="80" colspan="2">
                         ...
                         <td>
                            ...
                            <input type="button" id="show_button_2" class="formbutton" style="width:90px;" value="Lot Ratio Dtls" onClick="fn_report_generated(2)" />
