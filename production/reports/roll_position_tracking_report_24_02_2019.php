	...
	function openmypage_booking()
	{
		...
		{ 	
			...
			emailwindow.onclose=function()
			{
				...
				document.getElementById('hdn_booking_no').value = this.contentDoc.getElementById("selected_booking_no").value;
				//document.getElementById('hdn_booking_id').value = this.contentDoc.getElementById("selected_booking_id").value;
			}
		}
	}
                               ...
                               <td> 
                                ...
                                <td align="center">
                                     <input type="text" name="txt_booking_no" id="txt_booking_no" class="text_boxes" placeholder="Browse" onDblClick="openmypage_booking();" style="width:90px" readonly />
                                      ...
                                      <input type="hidden" name="hdn_booking_no" id="hdn_booking_no" class="text_boxes"  onDblClick="" style="width:90px" />
                                </td>
                                <td>
								<? 
