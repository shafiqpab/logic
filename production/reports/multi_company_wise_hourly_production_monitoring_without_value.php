<?
/*==========================Comments======================
Purpose					: This form will create Multi-Company Hourly Production Monitoring Report V2 Report
...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function generate_report(type)
	{
	 ...
	 /*    var cbo_get_upto = $("#cbo_get_upto").val();
		...
		if(type==0 || type==1 ){
			...
			//alert(data);
		freeze_window(3);
		http.open("POST","requires/multi_company_wise_hourly_production_monitoring_without_value_controller.php",
		true);
	...
	function generate_in_out_popup(po_id,action,floor_id,line,i,company_id,date)
	{
		 ...
		 popup_width='1020px'; 
		//var company_id = $("#cbo_company_id").val();	
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/multi_company_wise_hourly_production_monitoring_without_value_controller.php?po_id='+po_id+'&company_id='+company_id+'&action='+action+'&type='+i+'&production_date='+date+'&floor='+floor_id+'&sewing_line='+line, 'Detail Veiw', 'width='+popup_width+', height=390px,center=1,resize=0,scrolling=0','../');
	...
	function openmypage_company()
	{
		...
		var page_link='requires/multi_company_wise_hourly_production_monitoring_without_value_controller.php?action=company_search_popup&company='+company; 
	...
	function openmypage_location()
	{
		...
		var page_link='requires/multi_company_wise_hourly_production_monitoring_without_value_controller.php?action=location_search_popup&company='+company+'&location='+location; 
	...
	function openmypage_floor()
	{
		...
		var page_link='requires/multi_company_wise_hourly_production_monitoring_without_value_controller.php?action=floor_search_popup&location='+location+'&floor='+floor_id; 
	...
	function openmypage_line()
	{
		...
		var page_link='requires/multi_company_wise_hourly_production_monitoring_without_value_controller.php?action=line_search_popup&company='+company+'&location='+location+'&floor_id='+floor_id+'&txt_date='+txt_date+'&line_id='+line_id; 
...
<form id="LineWiseProductivityAnalysis_1">
    <div style="width:100%;" align="center">    
        ...
        <? echo load_freeze_divs ("../../",'');  ?>
         ...
         <h3 style="width:1475px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')">-Search Panel</h3> 
         ...
         <fieldset style="width:1470px;">
             <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                    ...
                    <th colspan="2" ><input type="reset" name="res" id="res" value="Reset" style="width:100px" class="formbutton" onClick="reset_form('LineWiseProductivityAnalysis_1','report_container','','','')" /></th>
                	</thead>
                	<tbody>
                    <tr class="general">
                       <td>
                        ...
                        <td>
                            ...
                            <input type="button" name="search" id="search" value="Line Wise Summary" onClick="generate_report(1)" style="width:130px" class="formbutton" />  
                        </td>
