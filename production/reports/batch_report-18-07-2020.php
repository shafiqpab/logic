...
function fn_report_generated(operation)
{
	...
	if(j_number!="" || job_number!="" || order_no!="" || file_no!="" || ref_no!="" || hidden_order!="" || ext_no!="" || hidden_ext!="" || batch_no!="" || booking_no!="" || repot_type==2 || repot_type==3 || repot_type==4)
	{
                 ...
                 <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td> 
                                    <?
                                        echo create_drop_down( "cbo_working_company_id", 100, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name",'id,company_name', 1, '--Select Working--', 0,"",'','','','','',3);
                                    ?>
                                </td>
