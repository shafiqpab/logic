   ...
   <? echo load_freeze_divs ("../../",'');  ?>
    ...
    <form id="dateWiseProductionReport_1">    
      <fieldset style="width:1250px;">
            <table class="rpt_table" width="1450" cellpadding="0" cellspacing="0" align="center" border="1" rules="all">
               <thead>                    
                       <tr>
                ...
                <tr class="general">
                    ...
                    <td align="center">
                        <? 
                        echo create_drop_down( "cbo_buyer_name", 140, "SELECT a.id,a.buyer_name from lib_buyer a where a.status_active=1 and a.is_deleted=0 group by  a.id,a.buyer_name  order by a.buyer_name","id,buyer_name", 1, "-- Select Buyer --", $selected, "",0,"" );
                        ?>
                    </td>
                     <td>
                        <?
