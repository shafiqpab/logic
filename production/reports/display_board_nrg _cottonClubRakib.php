   ...
   // alert(5);
    ...
    {  
        ...
        //var ajax_call = function(){
            $.ajax({
                type: "POST",
                url: "requires/display_board_nrg_controller.php",
                data:data,
        ...
        //}
        //setInterval(ajax_call,refresh_time);
        //setInterval(refreshTimer,refresh_time);
    }   
    ...
    {
        var cbo_company_name = $("#cbo_company_id").val();
        var data="action=show_floor_listview&cbo_company_name="+cbo_company_name;
        $.ajax({
            type: "POST",
            url: "requires/display_board_nrg_controller.php",
            data:data,
            success: function(response){
                $('#floor_container').html(response);
            }
        });
    }
               ...
               <div class="menu_icon" id="menu_icon"> Open </div>
                <div id="searchPanel">
                    <div id="searchPanelInner">
                        ...
                        <p>Working Company:</p>
                        <? 
                            echo create_drop_down( "cbo_company_id", "", "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", 0, "fn_floor();reset_floor_and_line();",0 );
                            ?>
                        <p>Sewing Date:</p>
...
<script>
    $(document).ready(function(){
        ...
        setInterval(function() {loadServerTime();},1000*60);
