<?
/*-------------------------------------------- Comments
Purpose			: 	This form will create Line Wise Productivity Analysis Without CM
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Line Wise Productivity Analysis Without CM","../../", 1, 1, $unicode,1,1); 
?>	
<script>
...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function generate_report(type)
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_location_id*cbo_floor_id*cbo_line*cbo_buyer_name*txt_date',"../../")+'&report_title='+report_title+'&type='+type;
		freeze_window(3);
		http.open("POST","requires/line_wise_productivity_analysis_report_without_cm_controller.php",true);
 ...
 function show_line_remarks(company_id,order_id,floor_id,line_no,action,prod_date)
	{
		//alert(action)
		popup_width='550px'; 
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/line_wise_productivity_analysis_report_without_cm_controller.php?po_id='+order_id+'&company_id='+company_id+'&floor_id='+floor_id+'&sewing_line='+line_no+'&prod_date='+prod_date+'&action='+action, 'Detail Veiw','width='+popup_width+', height=270px,center=1,resize=0,scrolling=0','../');
	}
</script>
...
<form id="LineWiseProductivityAnalysis_1">
    <div style="width:100%;" align="center">    
        ...
        <? echo load_freeze_divs ("../../",'');  ?>
         ...
         <h3 style="width:990px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu(this.id,'content_search_panel','')">-Search Panel</h3> 
                    ...
                    <tr class="general">
                       <td>
                        ...
                        <td>
                            ...
                            &nbsp;
                            <input type="button" name="search" id="search" value="Only Manpower" onClick="generate_report(2)" style="width:110px" class="formbutton" />
                        </td>
                    </tr>
                </tbody>
            </table>
