...
http://localhost/platform-v3.5/production/reports/floor_wise_display_dashboard.php?url=company name/line Name/
http://118.179.205.12/production/reports/floor_wise_display_dashboard.php?url=JK Knit Composite Ltd./33/
*/
...
<script>
    ...
    $(document).ready(function() {
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_floor='"+cbo_floor+"'";

        var numSuccessfullAjaxCallCount = 0;
        var ajax_call = function(){
            $.ajax({
                type:'POST',
                url:'requires/floor_wise_display_dashboard_controller.php',
                data:data,
                /*beforeSend:function(){
                    $('#loading').fadeIn('fast');
                },*/
    ...
    {  
        ...
        var data="action=report_generate"+"&max_height='"+max_height+"'"+"&cbo_company_name='"+cbo_company_name+"'"+"&txt_date='"+txt_date+"'"+"&cbo_floor='"+cbo_floor+"'";
        //alert(data);
        http.open("POST","requires/floor_wise_display_dashboard_controller.php",true);
