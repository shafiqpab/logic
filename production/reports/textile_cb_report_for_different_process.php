<?
/*-------------------------------------------- Comments -----------------------
Purpose			: 	This Form Will Create Textile CB Report For Different Process
Functionality	:	
JS Functions	:
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Textile CB Report For Different Process", "../../", 1, 1,$unicode,1,1);
?>	
<script>
...
var permission = '<? echo $permission; ?>';
	...
	{
        var cbo_to_month=$('#cbo_to_month').val();
		
        if( form_validation('cbo_company_id*cbo_year*cbo_to_month','Company Name*Year*Month')==false )
        {
            return;
        }
		...
		if (operation==1) 
		{
			var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_year*cbo_within_group*cbo_inbound_subcon*cbo_to_month',"../../")+'&report_title='+report_title;
		}
        //alert(data);return;
		
		freeze_window(3);
		http.open("POST","requires/textile_cb_report_for_different_process_controller.php",true);
...
<div style="width:100%;" align="center">
    <? echo load_freeze_divs ("../../",$permission);  ?>    		 
        <form name="TextileCBReport_1" id="TextileCBReport_1" autocomplete="off" > 
         <h3 style="width:655px; margin-top:20px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel', '')"> -Search Panel</h3> 
         <div id="content_search_panel" style="width:655px" >      
            <fieldset>  
