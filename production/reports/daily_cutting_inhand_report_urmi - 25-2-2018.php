...
<script>
	...
	function fn_generate_report(type)
	{
		...
		var data="action=generate_report"+get_submitted_data_string('cbo_work_company_name*cbo_buyer_name*cbo_year*txt_job_no*hidden_job_id*txt_order_no*hidden_order_id*txt_production_date',"../../")+'&type='+type+'&report_title='+report_title;
		//alert(data);return;
		freeze_window(3);
   ...
   <? echo load_freeze_divs ("../../",'');  ?>
    ...
    <form id="dateWiseProductionReport_1">    
      <fieldset style="width:1000px;">
            <table class="rpt_table" width="1000" cellpadding="0" cellspacing="0" align="center" border="1" rules="all">
               <thead>                    
                       <tr>
