...
<script>
	...
	function fn_report_generated(type)
	{
		...
		var cboYearSelection=$('#cboYearSelection').val();
		...
		var data="action=report_generate&&report_format="+type+get_submitted_data_string('cbo_company_name*cbo_within_group*cbo_po_company*cbo_buyer_name*cboYearSelection*txt_sales_order_no*cbo_based_on*txt_date_from*txt_date_to',"../../");
		freeze_window(3);
...
{
 	var cbo_company_id = $('#cbo_po_company').val();
 	var cbo_within_group = $('#cbo_within_group').val();
 	var color_from_library = $('#color_from_library').val();

 	if (form_validation('cbo_po_company', 'Company') == false) {
 		return;
 	}
 	else {
		...
		<fieldset style="width:960px;">
            <table class="rpt_table" width="1030" cellpadding="1" cellspacing="2" align="center">
                ...
                <tr class="general">
                    ...
                    <td><?php echo create_drop_down( "cbo_within_group", 80, $yes_no,"", 1, "-- All --",str_replace("'","",$within_group), "","0" ); ?></td>
                    ...
                    <td align="center"><? echo create_drop_down( "cboYearSelection", 80, $year,"", 1, "-- All --", date('Y'), "",0 ); ?></td>
                    <td>
