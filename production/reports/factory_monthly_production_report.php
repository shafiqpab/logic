...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../logout.php";
	...
	function fn_report_generated(type)
	{
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_location*txt_date_from*txt_date_to*cbo_working_company_id',"../../")+'&report_title='+report_title+'&datediff='+datediff+'&type='+type;
		//alert(data);
		freeze_window(3);
		http.open("POST","requires/factory_monthly_production_report_controller.php",true);
	...
	function openmypage2(date,company_id,po_id,location,action,source)
	{
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe', 'requires/factory_monthly_production_report_controller.php?date='+date+'&company_id='+company_id+'&po_id='+po_id+'&location_id='+location+'&action='+action+'&sewing_source='+source, 'Production Quantity Details', popupWidth+'center=1,resize=0,scrolling=0','../');
	...
	function fnc_load_report_format(data)
 	{
 		//alert(data);//die;
 		var report_ids = return_global_ajax_value( data, 'load_report_format', '', 'requires/factory_monthly_production_report_controller');
	...
	{
		var page_link='requires/factory_monthly_production_report_controller.php?action=party_popup&type='+type;
		...
		emailwindow.onclose=function()
		{
			...
			else if (poptype==2)
			{
				...
				load_drop_down( 'requires/factory_monthly_production_report_controller', party_id, 'load_drop_down_location', 'location_td' );
			}
		}
	}
...
<div style="width:100%;" align="center">
    <? echo load_freeze_divs ("../../",$permission); ?>   		 
        ...
        <h3 style="width:1110px; margin-top:20px;" align="left" id="accordion_h1" class="accordion_h" onClick="accordion_menu( this.id,'content_search_panel','')"> -Search Panel</h3> 
            ...
            <table class="rpt_table" width="100%" cellpadding="0" cellspacing="0" border="1" rules="all" align="center">
                ...
                <tbody>
                    <tr class="general">
                        ...
                        <td align="center">
                        	<input type="button" id="show_button1" class="formbutton" style="width:80px" value="Gmt Prod Sew" onClick="fn_report_generated(3)" />
                        	<input type="button" id="show_button2" class="formbutton" style="width:80px" value="Gmt Prod Fin" onClick="fn_report_generated(5)" />
                        	<input type="button" id="show_button3" class="formbutton" style="width:80px" value="Fabric Prod" onClick="fn_report_generated(4)" />
                        	<input type="button" id="show_button4" class="formbutton" style="width:80px" value="Short Form" onClick="fn_report_generated(6)" />

                        	<input type="button" id="show_button5" class="formbutton" style="width:100px" value="Gmt Prod Sew2" onClick="fn_report_generated(7)" />
                        	<input type="button" id="show_button5" class="formbutton" style="width:110px" value="F.Rcv & Gmts Prod" onClick="fn_report_generated(8)" />
                        </td>
                    </tr>
                </tbody>
                <tr>
