...
var permission = '<? echo $permission; ?>';
	...
	var tableFilters1 = 
	{
		...
		col_operation: { 
			...
			col: [14,15,22,23,24,26,27,28,29,30,31,32,34,35,36],
	...
	//alert(4);return;
		...
		var data="action=report_generate"+get_submitted_data_string('cbo_garments_nature*cbo_company_name*cbo_buyer_name*cbo_team_name*cbo_team_member*cbo_location*cbo_floor*cbo_year*cbo_type*txt_date_from*txt_date_to*txt_order_no*txt_file_no*txt_ref_no*shipping_status*cbo_agent*cbo_order_status*txt_item_catgory*cbo_season_name*cbo_string_search_type',"../../");
		freeze_window(3);
                ...
                <th colspan="18" align="center"><? echo create_drop_down( "cbo_string_search_type", 130, $string_search_type,'', 1, "-- Searching Type --" ); ?></th>
                    ...
                    <tbody>
                        <tr class="general">
                            <td> 
								<?
                               		echo create_drop_down( "cbo_company_name", 110, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by comp.company_name","id,company_name", 1, "-Select Company-", $selected, "load_drop_down( 'requires/order_wise_production_report_controller',this.value, 'load_drop_down_buyer', 'buyer_td' );load_drop_down( 'requires/order_wise_production_report_controller', this.value, 'load_drop_down_location', 'location_td'); load_drop_down( 'requires/order_wise_production_report_controller', this.value, 'load_drop_down_agent', 'agent_td');" );
                                ?>
                            </td>
                            <td id="buyer_td">
								<? 
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th colspan="4"><font color="blue"><strong>Shipment Date:</strong></font>
