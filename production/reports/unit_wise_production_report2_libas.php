...
var permission = '<? echo $permission; ?>';
	...
	function fn_report_generated(operation)
	{
		...
		else
		{
			...
			var data="action=report_generate"+get_submitted_data_string('cbo_company_id*cbo_location_id*txt_date_from*txt_date_to*cbo_production_type',"../../")+'&report_title='+report_title+'&datediff='+datediff;
			//alert(data);
			freeze_window(3);
...
/*	function fn_report_generated_reponse()
	...
	'<html><head><link rel="stylesheet" href="../../css/style_common.css" type="text/css" media="print" /><title></title></head><body>'+document.getElementById('report_container2').innerHTML+'</body</html>');
		d.close();
		document.getElementById('scroll_body').style.overflow="auto";
		document.getElementById('scroll_body').style.height="1200px";
