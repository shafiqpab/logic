                    ...
                    <fieldset>
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <? 
                                    echo create_drop_down( "cbo_company_name", 180, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select --", $selected, "load_drop_down( 'requires/bundle_wise_cutting_delevar_to_input_controller', $('#cbo_source').val()+'**'+this.value, 'load_drop_down_embro_issue_source', 'emb_company_td' );load_drop_down( 'requires/bundle_wise_cutting_delevar_to_input_controller', this.value, 'load_drop_down_location', 'location_td' );change_mode($('#cbo_source').val());" );//
                                    ?>
                                ...
                                <td>
                                    <? 
                                    echo create_drop_down( "cbo_source", 180, $knitting_source,"", 1, "-- Select Source --", 1, "load_drop_down( 'requires/bundle_wise_cutting_delevar_to_input_controller', this.value+'**'+$('#cbo_company_name').val(), 'load_drop_down_embro_issue_source', 'emb_company_td' );load_drop_down( 'requires/bundle_wise_cutting_delevar_to_input_controller', $('#cbo_company_name').val(), 'load_drop_down_location', 'location_td' );change_mode(this.value);", 0, '1,3' );
                    ...
                    <table cellpadding="0" cellspacing="1" width="100%">
                        <tr>
                            <td align="center" colspan="9" valign="middle" class="button_container">
                                ...
                                <input id="Print7" class="formbutton" type="button" style="width:80px;" onClick="fnc_issue_print_embroidery_entry(7)" name="print3" value="Print 7">
                            </td>
                            <td>&nbsp;</td>				
                        </tr>
                    </table>
