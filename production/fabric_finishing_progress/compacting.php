...
if( $('#index_page', window.parent.document).val()!=1) window.location.href = "../../logout.php";
	...
	function check_batch()
	{
		...
		if(batch_no!="")
		{
			...
			var response=return_global_ajax_value( batch_no, 'check_batch_deying', '', 'requires/compacting_controller');
	...
	{ 	
		...
		//alert( data_all);return;
	    var data="action=save_update_delete&operation="+operation+get_submitted_data_string('cbo_company_id*txt_batch_no*txt_batch_ID*hidden_batch_id*txt_process_id*cbo_previous_process*txt_process_end_date*txt_end_hours*txt_end_minutes*cbo_machine_name*txt_remarks*txt_ext_id*txt_update_id*cbo_floor*txt_length_shrinkage*txt_width_shrinkage*txt_spirality*txt_process_date*cbo_shift_name*txt_process_start_date*txt_start_hours*txt_start_minutes*txt_recevied_chalan*cbo_service_company*cbo_service_source*txt_issue_chalan*roll_maintained*txt_roll_id*txt_issue_mst_id*txt_restenter_no*txt_booking_no*txt_trims_weight*hidden_exchange_rate*hidden_currency*cbo_result_name*txt_steam*txt_temparature*txt_speed*txt_feed*cbo_next_process*txt_advance_prod*re_checkbox',"../../")+data_all+'&total_row='+row_num;
		//alert (data);return;
	...
	function checkbox_all2(type)
	{
	    ...
	    var jj=1;
	   	for (var j=1; j<=row_num; j++)
		{
			diawidthTypeid=$('#txtdiawidthtypeid_'+jj).val();
...
<? echo load_freeze_divs ("../../",$permission); ?>
    ...
    <div style="width:1190px; float:left;">   
        ...
        <table cellpadding="0" cellspacing="1" width="1190" border="0" align="left">
            <tr>
                    ...
                    <table cellpadding="0" cellspacing="2" width="100%" id="main_tbl">
                        ...
                        <tr> 
                         ...
                         <tr> 
                            ...
                            <td id="re_stenter_td">
                                <input type="text" name="txt_restenter_no" id="txt_restenter_no" class="text_boxes_numeric" style="width:122px;"  value="0"    />  <!--onChange="check_re_stenter();"  issue id-13551  -->  
                    ...
                    <table cellpadding="0" cellspacing="1" width="100%" border="0" align="left">
                        ...
                        <tr>
                            <td width="45%" valign="top">
                                <fieldset>
                                    <table width="920" align="left" id="tbl_body1">
                                        <tr>
