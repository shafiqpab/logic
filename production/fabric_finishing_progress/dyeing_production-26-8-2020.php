...
function openmypage_process()
	...
	function calculate_production_qnty()
	{
		...
		var dyeing_type=$("#cbo_dyeing_type").val();
		//alert(numRow);
		...
		math_operation( "total_production_qnty", "txtprodqnty_", "+",numRow,ddd );
			...
			{
				var p_qty=$("#txtprodqnty_"+i).val()*1;
				var previ_prodqnty=$("#hiddenprodqnty_"+i).val()*1;
				//alert(p_qty);
				...
				if(batch_qty<p_qty)
				{
					...
					if(dyeing_type==2)
					{
						$("#txtprodqnty_"+i).val(previ_prodqnty);
					}
					else {
                        ...
                        <tr>
                            <td width="45%" valign="top">
                                <fieldset style="height:auto;">
                                    ...
                                    <tr>
                                    <td colspan="4" align="center"><strong>Functional Batch No :</strong> &nbsp;<input type="text" name="txt_system_no" id="txt_system_no" class="text_boxes_numeric" onDblClick="open_syspopup()" style="width:100px;" placeholder="Double Click To Browse" /> </td>
                                    </tr>
                                        <tr>
