...
<script>
	...
	{ 
		...
		emailwindow.onclose=function()
		{
			...
			if(reqn_id!="")
			{
				...
				var list_view = trim(return_global_ajax_value(reqn_id+'**'+entry_break_down_type, 'populate_list_view', '', 'requires/woven_fabric_requisition_for_cutting_entry_controller'));
	...
	{
		var varible_data=return_global_ajax_value( data, 'varible_setting_fabric_requisition_cutting_variable', '', 'requires/woven_fabric_requisition_for_cutting_entry_controller');
		// alert(varible_data);
	...
	function openmypage_po()
	{
		...
		{ 	
			...
			var page_link ='requires/woven_fabric_requisition_for_cutting_entry_controller.php?company_id='+cbo_company_id+'&buyerId='+buyerId+'&entry_break_down_type='+entry_break_down_type+'&hdn_variable_setting_status='+hdn_variable_setting_status+'&action=po_popup';
	...
	function fnc_fabric_requisition_for_cutting_Reply_info()
	{
		if(http.readyState == 4) 
		{
			...
			if((response[0]==0 || response[0]==1))
			{
				...
				var entry_break_down_type = $("#entry_break_down_type").val();
				var list_view = trim(return_global_ajax_value(response[1]+'**'+entry_break_down_type, 'populate_list_view', '', 'requires/woven_fabric_requisition_for_cutting_entry_controller'));
				$("#scanning_tbl tbody").html(list_view);
