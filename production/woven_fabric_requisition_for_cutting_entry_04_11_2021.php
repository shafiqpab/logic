...
<script>
	...
	{ 
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/woven_fabric_requisition_for_cutting_entry_controller.php?action=requisition_popup&company_id='+cbo_company_id+'&buyerId='+buyerId,'Requisition Popup', 'width=780px,height=350px,center=1,resize=1,scrolling=0','')
		emailwindow.onclose=function()
		{
			...
			{
				freeze_window(5);
				reset_form('requisitionEntry_1','','','','','hdn_variable_setting_status');
				...
				var list_view = trim(return_global_ajax_value(reqn_id+"**"+hdn_variable_setting_status, 'populate_list_view', '', 'requires/woven_fabric_requisition_for_cutting_entry_controller'));
	...
	function openmypage_po()
	{
		...
		{ 	
			...
			var page_link ='requires/woven_fabric_requisition_for_cutting_entry_controller.php?company_id='+cbo_company_id+'&buyerId='+buyerId+'&hdn_variable_setting_status='+hdn_variable_setting_status+'&action=po_popup';
			...
			emailwindow.onclose=function()
			{
				...
				for(var k=0; k<data.length; k++)
				{
					...
					{*/
						...
						var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40" style="word-break:break-all;">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50" style="word-break:break-all;">'+row_data[2]+'</td><td width="60" style="word-break:break-all;">'+row_data[3]+'</td><td width="100" style="word-break:break-all;">'+row_data[24]+'</td><td width="80" style="word-break:break-all;">'+row_data[5]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;">'+row_data[25]+'</td><td width="60" style="word-break:break-all;">'+row_data[26]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" style="word-break:break-all;">'+row_data[28]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="60" style="word-break:break-all;">'+row_data[29]+'</td><td width="80" style="word-break:break-all;">'+row_data[15]+'</td><td width="60" style="word-break:break-all;">'+row_data[17]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center"><input type="text" class="text_boxes_numeric" style="width:80px" id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" /><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[25]+'" id="fabricRef'+num_row+'" name="fabricRef[]"/><input type="hidden" value="'+row_data[26]+'" id="rdNo'+num_row+'" name="rdNo[]"/><input type="hidden" value="'+row_data[27]+'" id="weightType'+num_row+'" name="weightType[]"/><input type="hidden" value="'+row_data[29]+'" id="cutableWidth'+num_row+'" name="cutableWidth[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[30]+'" id="hdnPoRatioRef'+num_row+'" name="hdnPoRatioRef[]"/><input type="hidden" value="'+row_data[21]+'" id="hdnBudgtQty'+num_row+'" name="hdnBudgtQty[]"/><input type="hidden" value="'+row_data[31]+'" id="hdnPoRatioQty'+num_row+'" name="hdnPoRatioQty[]"/></td></tr>';
					/*}
					else
					{
						var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40" style="word-break:break-all;">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50" style="word-break:break-all;">'+row_data[2]+'</td><td width="60" style="word-break:break-all;">'+row_data[3]+'</td><td width="100" style="word-break:break-all;">'+row_data[24]+'</td><td width="80" style="word-break:break-all;">'+row_data[5]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="80">'+row_data[15]+'</td><td width="60">'+row_data[17]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center"><input type="text" class="text_boxes_numeric" style="width:80px" id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" /><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/></td></tr>';
					}*/
					num_row++;
				}
	...
	function fnc_fabric_requisition_for_cutting( operation )
	{
		...
		{cbo_template_id
			 ...
			 print_report( $('#cbo_company_id').val()+'*'+$('#txt_requisition_no').val()+'*'+$('#update_id').val()+'*'+$('#txt_layPlan_No').val()+'*'+$('#cbo_template_id').val(), "grey_delivery_print", "requires/woven_fabric_requisition_for_cutting_entry_controller" );
			return;
		}
		...
		for (var i=1; i<=row_num; i++)
		{
			...
			{
				j++;
				dataString+='&buyerId' + j + '=' + buyerId + '&jobNo' + j + '=' + jobNo + '&poId' + j + '=' + poId + '&itemId' + j + '=' + itemId + '&bodyPartId' + j + '=' + bodyPartId + '&deterId' + j + '=' + deterId + '&gsm' + j + '=' + gsm + '&dia' + j + '=' + dia + '&colorId' + j + '=' + colorId + '&sizeId' + j + '=' + sizeId + '&reqsnQty' + j + '=' + reqsnQty + '&dtlsId' + j + '=' + dtlsId + '&fabricRef' + j + '=' + fabricRef + '&weightType' + j + '=' + weightType + '&cutableWidth' + j + '=' + cutableWidth + '&rdNo' + j + '=' + rdNo + '&hdnPoRatioQty' + j + '=' + hdnPoRatioQty;
			}
		}
		...
		var data="action=save_update_delete&operation="+operation+'&tot_row='+j+get_submitted_data_string('cbo_company_id*layPlan_id*txt_requisition_date*txt_requisition_no*update_id*hdn_variable_setting_status',"../")+dataString;
		//alert(data);//return;
	...
	function fnc_fabric_requisition_for_cutting_Reply_info()
	{
		if(http.readyState == 4) 
		{
			...
			if((response[0]==0 || response[0]==1))
			{
				...
				var hdn_variable_setting_status= $('#hdn_variable_setting_status').val();
				var list_view = trim(return_global_ajax_value(response[1]+"**"+hdn_variable_setting_status, 'populate_list_view', '', 'requires/woven_fabric_requisition_for_cutting_entry_controller'));
				$("#scanning_tbl tbody").html(list_view);
	...
	function generate_print_report_2()
	{
		...
		print_report( $('#cbo_company_id').val()+'*'+$('#txt_requisition_no').val()+'*'+$('#update_id').val()+'*'+$('#txt_layPlan_No').val()+'*'+$('#cbo_template_id').val(), "grey_delivery_print2", "requires/woven_fabric_requisition_for_cutting_entry_controller" );
			return;
	}
	function generate_print_report_3() //for style wiese
	{
		...
		print_report( $('#cbo_company_id').val()+'*'+$('#txt_requisition_no').val()+'*'+$('#update_id').val()+'*'+$('#txt_layPlan_No').val()+'*'+$('#cbo_template_id').val(), "grey_delivery_print3", "requires/woven_fabric_requisition_for_cutting_entry_controller" );
			return;
	}
            ...
            <fieldset style="width:810px;">
                ...
                <table cellpadding="0" cellspacing="2" width="800">
                    ...
                    <tr>
                        ...
                        <td>
                            <? 
                                echo create_drop_down( "cbo_company_id", 152, "select comp.id, comp.company_name from lib_company comp where comp.status_active=1 and comp.is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select Company --", 0, "wvn_finish_fabric_po_to_style_wise_fnc(this.value);com_variable_data(this.value);",0 );
                            ?>
