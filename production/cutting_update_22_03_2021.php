 	...
 	if(http.readyState == 4)
	{
		...
		else if(reponse[0]==0)//insert
		{
			...
			show_list_view(po_id+'**'+$("#cbo_item_name").val()+'**'+country_id,'show_dtls_listview','cutting_production_list_view','requires/cutting_update_controller','setFilterGrid(\'tbl_list_search\',-1)');
			 	//cbo_produced_by*
			reset_form('','','txt_cutting_qty*txt_reject_qty*hidden_break_down_html*hidden_colorSizeID*txt_remark*txt_mst_id','','','txt_cutting_date*txt_reporting_hour');
...
function show_print_report(type,title)
{
	...
	else
	{
		...
		var data= $('#cbo_company_name').val()+'*'+master_ids+'*'+report_title+'*'+$('#cbo_location').val()+'*'+$('#cbo_source').val()+'*'+$('#cbo_cutting_company').val()+'*'+$('#txt_cutting_date').val()+'*'+$('#cbo_item_name').val()+'*'+$('#txt_order_no').val()+'*'+$('#cbo_buyer_name').val()+'*'+$('#hid_job_num').val()+'*'+$('#txt_style_no').val()+'*'+$('#txt_remark').val()+'*'+$('#txt_challan_no').val();
                        ...
                        <table cellpadding="0" cellspacing="1" width="100%">
                         ...
                         <tr>
                            <td align="center" colspan="9" valign="middle" class="button_container">
                                ...
                                <input type="button" id="btn_print" value="Cutting Qnty Challan" class="formbutton" style="width:120px;" onClick="show_print_report(2,'Cutting Qnty Challan');" >
