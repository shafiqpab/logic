...
<script>
	...
	function pdf_print_demo()
	{
		...
		var pdf_path=return_ajax_request_value(data, "auto_create_and_print_pdf_file", "requires/roll_splitting_entry_controller");
		printPDF(pdf_path);
	...
	<div align="center" style="width:100%;">
		...
		<form name="rollscanning_1" id="rollscanning_1"  autocomplete="off"  >
			<fieldset style="width:810px;">
				...
				<table cellpadding="0" cellspacing="2" width="800">
					...
					<tr>
						...
						<td  align="left">
							...
							<input type="hidden" name="hidden_coller_cuff_size" id="hidden_coller_cuff_size"/>
				...
				<br>
				<table cellpadding="0" width="720" cellspacing="0" border="1" id="scanning_tbl_top" class="rpt_table" rules="all">
					<thead>
						<th width="40">SL</th>
					...
					<tbody id="scanning_tbody">
						<tr id="tr_1" align="center" valign="middle">
							...
							<td width="60" >
								<input type="text" name="collerCuffSize[]" id="collerCuffSize_1" style="width:50px" class="text_boxes"  placeholder="Display" readonly/>
							</td>
							<td width="180" >
