	    ...
	    <form name="searchorderfrm_1"  id="searchorderfrm_1" autocomplete="off">
	        <table width="990" cellspacing="0" cellpadding="0" class="rpt_table" align="center" border="1" rules="all">
	    		<tr>
	        		<td align="center" width="100%">
	            		<table cellspacing="0" cellpadding="0" border="1" rules="all" class="rpt_table" align="center">
	                   		 <thead>
								<tr>
									<th colspan="9"><? echo create_drop_down( "cbo_string_search_type", 130, $string_search_type,''); ?></th>
								</tr>
	        	...
	        	<tr>
					...
					<? echo create_drop_down( "cbo_year_selection", 120, $year,"", 1, "-- Select Year --","", "",0 ); ?>
...
if($action=="create_po_search_list_view")
{
	...
	else
	{
 		$sql = "select b.id,a.order_uom,a.buyer_name,b.grouping,b.file_no,a.company_name,a.total_set_qnty,a.set_break_down, a.job_no,a.style_ref_no,a.gmts_item_id,a.location_name,b.shipment_date,b.po_number,b.po_quantity ,b.plan_cut
			...
			b.is_deleted=0 and			 
			a.garments_nature=$garments_nature
			$sql_cond $sql_shipment_year_cond order by b.shipment_date desc"; // to_char(b.insert_date,'YYYY')='$year' and
	}
	// echo $sql;die;
	...
	$total_cut_qty_arr=sql_select("select po_break_down_id, item_number_id, country_id, sum(production_quantity) as production_quantity from pro_garments_production_mst where status_active=1 and is_deleted=0 and production_type=1 group by po_break_down_id, item_number_id, country_id");
...
if($action=="show_dtls_listview")
{
	...
	<style type="text/css">
		...
		<div style="width:100%;">
			<table cellspacing="0" cellpadding="0" border="1" rules="all" width="1020" class="rpt_table" align="left">
	            <thead>
	                <th width="20">SL</th>
	                ...
	                <th width="" align="center">Table</th>
	            </thead>
			</table>
		</div>
		<div style="width:1040px;max-height:250px; overflow-y:auto; overflow-x: auto;" id="sewing_production_list_view" align="left">
			...
			?>
				...
				<tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" onClick="get_php_form_data('<? echo $selectResult[csf('id')]."_".$selectResult[csf('color_id')]; ?>','populate_cutting_form_data','requires/cutting_update_controller');" >
	                ...
	                <td width="60" align="right"><?php  echo $selectResult[csf('reject_qnty')]; ?></td>

	                <td width="60" align="center"><?php echo $selectResult[csf('production_hour')]; ?></td>
					<?php
	                ...
	                ?>
	                <td width="120" align="left"><p><?php echo $serving_company; ?></p></td>
	                <td width="50" align="left"><p><?php echo $color_type[$color_type_arrs[$selectResult[csf("id")]]]; ?></p></td>
	 				<?php
					...
					?>
	                <td width="100" align="left"><? echo $location_name; ?></td>
	                <td width="100" align="left"><? echo $floorn_name; ?></td>
	                <td width="" align="left"><? echo $table_name; ?></td>
				</tr>
				<?php
				$i++;
				}
...
if ($action=="save_update_delete")
{
  	...
  	else if ($operation==1) // Update Here------------------------------------------------------
	{
		...
		$field_array1="company_id*challan_no*production_source*serving_company*location*produced_by*production_date*production_quantity*production_type* entry_break_down_type*break_down_type_rej*production_hour*remarks*floor_id*table_no*reject_qnty*total_produced*yet_to_produced*wo_order_id*currency_id*exchange_rate*rate*amount*updated_by*update_date";
