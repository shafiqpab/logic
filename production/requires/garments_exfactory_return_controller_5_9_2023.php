...
{
	$sql_mst=sql_select("select id, sys_number, company_id, location_id, challan_no, buyer_id, transport_supplier, delivery_date, lock_no, driver_name, truck_no, dl_no,destination_place,forwarder,mobile_no, do_no, gp_no,source
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0) // Insert Here----------------------------------------------------------
	{
		...
		if(str_replace("'","",$txt_return_id)=="")
		{
			...
			$field_array_delivery="id, sys_number_prefix, sys_number_prefix_num, sys_number, company_id,buyer_id, location_id, challan_no,transport_supplier, delivery_date, lock_no, driver_name, truck_no, dl_no, mobile_no, do_no, gp_no,source, destination_place, forwarder,entry_form,inserted_by,insert_date";
			$data_array_delivery="(".$return_mst_id.",'".$new_sys_number[1]."','".$new_sys_number[2]."','".$new_sys_number[0]."',".$cbo_company_name.",".$buyer_id.",".$cbo_location_name.",".$txt_challan_no.",".$cbo_transport_company.",".$txt_return_date.",".$txt_lock_no.",".$txt_driver_name.",".$txt_truck_no.",".$txt_dl_no.",".$txt_mobile_no.",".$txt_do_no.",".$txt_gp_no.",".$txt_source.",".$txt_destination.",".$cbo_forwarder.",85,".$user_id.",'".$pc_date_time."')";
	...
	<div style="width:810px; margin-top:5px;">
	    <table width="800" cellspacing="0" align="right" style="margin-bottom:20px;">
	        ...
	        <tr >
	            ...
	            <td width="140" valign="top" style="font-size:16px;"><? echo $system_num; ?> </td>
