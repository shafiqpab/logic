...
?>	 
	...
	<div style="width:100%;max-height:180px; overflow:y-scroll" id="iron_list_view" align="left">
		...
		<?php  
			...
			if($db_type==0)
			{
				$sqlResult =sql_select("SELECT id,po_break_down_id,item_number_id, country_id, production_date, production_quantity, reject_qnty, production_source, TIME_FORMAT( production_hour, '%H:%i' ) as production_hour,serving_company, location from pro_garments_production_mst where po_break_down_id='$po_id' and item_number_id='$item_id' and production_type='8' and status_active=1 and is_deleted=0 order by production_date");
			}
			else
			{
				$sqlResult =sql_select("SELECT id,po_break_down_id,item_number_id, country_id, production_date, production_quantity, reject_qnty, production_source, TO_CHAR(production_hour,'HH24:MI') as production_hour,serving_company, location from pro_garments_production_mst where po_break_down_id='$po_id' and item_number_id='$item_id' and production_type='8' and status_active=1 and is_deleted=0 order by production_date");
			}
