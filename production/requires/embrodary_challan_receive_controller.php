...
if($action=="load_mst_data_bundle_scan")
{
	...
	$sql_mst_data=sql_select("select a.sys_number, a.company_id,a.location_id, a.embel_name, a.embel_type, a.serving_company, a.floor_id, a.organic, a.production_source, a.working_company_id, a.working_location_id, a.remarks,a.body_part
	...
	group by a.sys_number, a.company_id,a.location_id, a.embel_name, a.embel_type, a.serving_company, a.floor_id, a.organic, a.production_source, a.working_company_id, a.working_location_id, a.remarks,a.body_part");
...
if ($action=="save_update_delete")
{
  	...
  	else if ($operation==1) // Update Here End------------------------------------------------------
	{
		...
		if(str_replace("'","",$delivery_basis)==3)
		{
			...
			// echo "10**";
			 //  echo "5***"."abc";
			// $non_delete_arr=production_validation($mst_id,'3_2'); // getting rcv data
	...
	else if ($operation==2)  // Delete Here----------------------------------------------------------
	{
		...
		$sysrID = sql_delete("PRO_GMTS_DELIVERY_MST","status_active*is_deleted","0*1",'id',$mst_id,1);
