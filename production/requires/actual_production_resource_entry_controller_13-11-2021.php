...
if($action=="job_no_popup")
{
    ...
    <div align="center">
		...
		<fieldset style="width:870px;">
            ...
            <table width="820" cellspacing="0" cellpadding="0" border="1" rules="all" align="center" class="rpt_table" id="tbl_list">
                ...
                <tbody>
                	<tr class="general">
                        ...
                        <td align="center">
                        	<input type="button" name="button" class="formbutton" value="Show" onClick="show_list_view ('<? echo $company_name; ?>'+'**'+document.getElementById('cbo_buyer_name').value+'**'+document.getElementById('cbo_year').value+'**'+document.getElementById('hide_prod_update_var').value+'**'+document.getElementById('cbo_search_by').value+'**'+document.getElementById('txt_search_common').value+'**'+document.getElementById('txt_date_from').value+'**'+document.getElementById('txt_date_to').value+'**'+'<? echo $sid; ?>'+'**'+'<? echo $from_date; ?>'+'**'+'<? echo $to_date; ?>'+'**'+'<? echo $mst_dtls_id; ?>'+'**'+document.getElementById('cbo_order_type').value, 'create_job_no_search_list_view', 'search_div', 'actual_production_resource_entry_controller', 'setFilterGrid(\'tbl_list_search\',-1)'); set_all();" style="width:60px;" />
                    </td>
                    </tr>
                    <tr>
			...
			{
				$sql_colSiz="SELECT dtls_id, po_id, gmts_item_id, color_id, size_id, target_per_line as target,country_id,helper,operator,order_type,working_hour,actual_smv from  prod_resource_color_size where  po_id>0 and dtls_id=$mst_dtls_id and status_active=1 and is_deleted=0";
				// echo $sql_colSiz;die;
				...
				{			
		            ...
		            <div style="width:1100px;">
		                <table cellspacing="0" width="1080" border="1" rules="all" class="rpt_table">
		                    <thead>
		                        <tr>
		                            <th width="30">SL</th>
		                            <th width="50">Job</th>
		                            ...
		                            <th width="">Actual SMV</th>
		                        </tr>
		                    </thead>
		                </table>  
		            </div>         
		            <div style="width:1110px; max-height:260px; overflow-y:auto;">
		                <table cellspacing="0" width="1080"  border="1" rules="all" class="rpt_table" id="tbl_list_search" >
		                    <tbody>  
		                    <?
		                   // echo $sql_update;
		                    $sl=1; 
			...
			else // for color size level
			{
				...
				{			
		            ...
		            <div style="width:1380px; max-height:260px; overflow-y:auto;">
		                <table cellspacing="0" width="1362"  border="1" rules="all" class="rpt_table" id="tbl_list_search" >
		                    <tbody>  
		                    <?
		                   // echo $sql_update;
		                    $sl=1; 
		...
		{ 			
			...
			$("#tbl_list_search").find('tbody tr').each(function()
			{
				if($(this).find('input[name="tr_selection[]"]').is(":checked"))
				{
					...
					j++;
					dataString+='&po_data_' + j + '=' + po_data + '&target_' + j + '=' + target+ '&operator_' + j + '=' + operator+ '&helper_' + j + '=' + helper+ '&working_hour_' + j + '=' + working_hour+ '&actual_smv_' + j + '=' + actual_smv;
				}
			});
...
if($action=='create_job_no_search_list_view')
{
	...
	// ========================== get variable setting 
	$variable_settings=return_field_value("production_entry","variable_settings_production","company_name =$comp_id and variable_list=60 and is_deleted=0 and status_active=1");
	if($variable_settings ==0) $variable_settings=1;

	if($variable_settings == 1) // order level
	{
		$sql_colSiz="SELECT dtls_id, po_id, gmts_item_id, color_id, size_id, target_per_line as target,country_id,helper,operator,order_type,working_hour,actual_smv from  prod_resource_color_size where  po_id>0 and dtls_id=$mst_details_id and status_active=1 and is_deleted=0";
		//echo $sql_colSiz;die;
		...
		else if ($search_by==2) 
		{
			...
			else
			{
			 	...
			 	$src_cond=" and b.cust_style_ref Like '%$search_common%'";
		...
		{
			$sqlAllo = "SELECT JOB_NO,PO_NO,ITEM from ppl_order_allocation_mst where company_id=$comp_id and status_active=1 and is_deleted=0";
			// echo $sqlAllo;
			...
			if($prod_update_var==1)//gross level
			{
				$sql="SELECT a.company_name,a.job_no_prefix_num, a.job_no,a.set_smv, $year_field as year, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date,  sum(c.order_quantity) as po_qty from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c where a.id=b.job_id and b.id=c.po_break_down_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  and c.status_active=1 and c.is_deleted=0 and a.company_name='$comp_id' $buyer_id_cond $src_cond $year_cond $ship_date_cond group by a.company_name,a.job_no_prefix_num, a.job_no,a.set_smv, a.insert_date, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date order by id Desc";
				 
				if(count($po_id_all[1])>0)
				{
					$sql_update="SELECT a.company_name,a.job_no_prefix_num, a.job_no,a.set_smv, $year_field as year, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date,  sum(c.order_quantity) as po_qty from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c where a.id=b.job_id and b.id=c.po_break_down_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  and c.status_active=1 and c.is_deleted=0 and a.company_name='$comp_id' and b.id in (".implode(",",$po_id_all[1]).") group by a.company_name,a.job_no_prefix_num, a.job_no,a.set_smv, a.insert_date, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date order by id Desc";
		...
		<form>
	        <div style="width:1100px;">
	            <table cellspacing="0" width="1080" border="1" rules="all" class="rpt_table" align="left">
	                <thead>
	                    <tr>
	                        <th width="30">SL</th>
	        ...
	        <div style="width:1110px; max-height:260px; overflow-y:auto;">
	            <table cellspacing="0" width="1080"  border="1" rules="all" class="rpt_table" id="tbl_list_search" align="left">
	                <tbody>  
					<?
	                //echo $sql;
	...
	else // color and size level
	{
		...
		if($order_type==0 || $order_type==1)	
		{
			...
			if($prod_update_var==1)//gross level
			{
				$sql="SELECT a.company_name,a.job_no_prefix_num, a.job_no, $year_field as year, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date, c.item_number_id, c.country_id,  sum(c.order_quantity) as po_qty from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c where a.id=b.job_id and b.id=c.po_break_down_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  and c.status_active=1 and c.is_deleted=0 and a.company_name='$comp_id' $buyer_id_cond $src_cond $year_cond $ship_date_cond group by a.company_name,a.job_no_prefix_num, a.job_no, a.insert_date, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date, c.item_number_id, c.country_id order by id Desc";
				 
				if(count($po_id_all[1])>0)
				{
					$sql_update="SELECT a.company_name,a.job_no_prefix_num, a.job_no, $year_field as year, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date, c.item_number_id, c.country_id,  sum(c.order_quantity) as po_qty from wo_po_details_master a, wo_po_break_down b, wo_po_color_size_breakdown c where a.id=b.job_id and b.id=c.po_break_down_id and a.status_active=1 and a.is_deleted=0 and b.status_active=1 and b.is_deleted=0  and c.status_active=1 and c.is_deleted=0 and a.company_name='$comp_id' and b.id in (".implode(",",$po_id_all[1]).") group by a.company_name,a.job_no_prefix_num, a.job_no, a.insert_date, a.buyer_name, a.style_ref_no, b.id, b.po_number, b.pub_shipment_date, c.item_number_id, c.country_id order by id Desc";
		...
		<form>
	        <div style="width:1380px;">
	            <table cellspacing="0" width="1360" border="1" rules="all" class="rpt_table" align="left">
	                <thead>
	                    <tr>
	                        <th width="30">SL</th>
	                        <th width="80">LC Company</th>
	        ...
	        <div style="width:1380px; max-height:260px; overflow-y:auto;">
	            <table cellspacing="0" width="1360"  border="1" rules="all" class="rpt_table" id="tbl_list_search" align="left">
	                <tbody>  
					<?
	                //echo $sql;
...
{  
	...
	if ($operation==0) // Insert Here----------------------------------------------------------
	{
		...
		$field_colSiz="id, mst_id, dtls_id, po_id, gmts_item_id, country_id, color_id, size_id,order_type,target_per_line,operator,helper,working_hour,actual_smv,variable_setting, inserted_by, insert_date";
		for($j=1;$j<=$tot_row;$j++)
		{ 	
			$po_data="po_data_".$j;
			...
			$data_colSiz.="(".$id_colSiz.",".$system_id.",".$mst_dtls_id.",'".$po_id."','".$item_id."','".$country_id."','".$color_id."','".$size_id."','".$order_type."','".$$target_line."','".$$operator."','".$$helper."','".$$working_hour."','".$$actual_smv."','".$variable_settings."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
...
{ 
	...
	if ($operation==0) // Insert Here----------------------------------------------------------
	{
		...
		$field_array="id, mst_id, mast_dtl_id, dtl_id, pr_date, adjustment_source, number_of_emp, adjust_hour, total_smv,style_ref_no,remarks, inserted_by, insert_date";
		...
		for($i=1; $i <= $total_row ; $i++)
		{
			...
			$data_array.="(".$id.",".$system_id.",".$h_dtl_mst_id.",'".$dtls_id."','".$pr_date."',".$$adjust_type.",'".$$employee."','".$$hours."',".$$minutes.",'".$$cbostyle."','".$$remarks."',".$_SESSION['logic_erp']['user_id'].",'".$pc_date_time."')";
			$id++;
		}
             	...
             	<tr>
                	<td>
                    	<div style="width:620px;max-height:250px;" align="left">
                            ...
                            <table cellspacing="0" width="650" cellpadding="0" class="rpt_table" rules="all" border="1" id="tbl_list_search">
                                <thead>
                                    <th width="30">SL</th>
                                ...
                                <tbody id="tbl_particulars_details">
                                    <tr bgcolor="<? echo $bgcolor; ?>" id="tr_1" align="center" valign="middle"> 
                                        ...
                                        <td>
                                        <? 
                                            echo create_drop_down( "cboSmvAdjustSource_1",100, $smv_adjustment_head,"", 1, "-- Select --", $selected,"calculate_adjust_minit_total()", "" ,"","","","","","","cboSmvAdjustSource[]" );
                                        ?>
                                        </td>
                                        <td>
                                            <input class="text_boxes_numeric" type="text" style="width:60px" name="txtNoOfEmployee[]" id="txtNoOfEmployee_1" value=""  onKeyUp="calculate_adjust_minit(1,1)"/>
                                        </td>
                                        <td>
...
if($action=='show_particulars_details')
{
	...
	?>	
        <tr bgcolor="<? echo $bgcolor; ?>" id="tr_<?php echo $i; ?>" align="center" valign="middle"> 
            ...
            <td>
            <? 
                echo create_drop_down( "cboSmvAdjustSource_".$i,100, $smv_adjustment_head,"", 1, "-- Select --", $val[csf("adjustment_source")],"calculate_adjust_minit_total()", "" ,"","","","","","","cboSmvAdjustSource[]" );
            ?>
            </td>
            <td>
                <input class="text_boxes_numeric" type="text" style="width:60px" name="txtNoOfEmployee[]" id="txtNoOfEmployee_<?php echo $i; ?>" value="<?php echo $val[csf("number_of_emp")]; ?>" onKeyUp="calculate_adjust_minit(<?php echo $i; ?>,1)"/>
            </td>
            <td>
