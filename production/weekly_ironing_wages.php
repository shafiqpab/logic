<?
/*-------------------------------------------- Comments
Purpose			: 	This form created Weekly Ironing wages
...
//--------------------------------------------------------------------------------------------------------------------
echo load_html_head_contents("Weekly Ironing Wages Entry Info","../", 1, 1, "",'1','');
?>
...
<script>
	...
	{ 
		...
		else
		{
			...
			var page_link = 'requires/weekly_ironing_wages_controller.php?cbo_company_id='+cbo_company_id+'&action=systemId_popup';
			...
			emailwindow.onclose=function()
			{
				...
				get_php_form_data(mst_id[0], "populate_ironing_wages_mst_form_data", "requires/weekly_ironing_wages_controller" );
				$("#txt_system_id").val(mst_id[1]);
				show_list_view(mst_id[0],'show_weekly_wages_bill_listview','list_container','requires/weekly_ironing_wages_controller','');
	...
	function openpage_emp_id()
	{
		...
		else
		{
			...
			var page_link = 'requires/weekly_ironing_wages_controller.php?cbo_company_id='+cbo_company_id+'&cbo_bill_for='+cbo_bill_for+'&action=employee_info_popup';
			...
			emailwindow.onclose=function()
			{
				...
				get_php_form_data(emp_id, "populate_emp_info", "requires/weekly_ironing_wages_controller");
			}
		}
	}
	...
	function openpage_search_order()
	{
		...
		else
		{
			...
			var page_link = 'requires/weekly_ironing_wages_controller.php?action=order_info_popup&mst_data='+cbo_company_id+'_'+cbo_bill_for+'_'+txt_week_date_from+'_'+txt_week_date_to+'_'+cbo_location+'_'+cbo_shift+'_'+txt_emp_code+'&txt_order_id='+txt_order_id+'&txt_gmt_item_id='+txt_gmt_item_id;
			...
			emailwindow.onclose=function()
			{
				...
				get_php_form_data(data, "populate_order_data", "requires/weekly_ironing_wages_controller");
			}
		}
	}
	...
	{ 
		...
		if(operation==0 || operation==1 || operation==2)
		{
			...
			http.open("POST","requires/weekly_ironing_wages_controller.php",true);
	...
	function fnc_weekly_wages_bill_entry_reponse()
	{
		if(http.readyState == 4) 
		{
			...
			if((reponse[0]==0 || reponse[0]==1))
			{
				...
				show_list_view(reponse[1],'show_weekly_wages_bill_listview','list_container','requires/weekly_ironing_wages_controller','');
...
<? echo load_freeze_divs ("../",$permission); ?>
    <form name="weekly_wages_bill_1" id="weekly_wages_bill_1" autocomplete="off" >
        <fieldset>
        <legend>&nbsp;  Weekly Ironing Wages</legend>
     <fieldset>
    ...
    <table cellpadding="0" cellspacing="2" width="100%">
           <tr>
                ...
                <td colspan="4" align="left">
                    ...
                    <input name="txt_system_id" id="txt_system_id" class="text_boxes" style="width:150px" placeholder="Double Click to Search" readonly value="" onDblClick="popuppage_system_id(); return false" tabindex="12" />
                    <input type="hidden" id="cbo_bill_for" name="cbo_bill_for" value="35"/>
                 </td>
           </tr>
           ...
           <tr>
            ...
            <tr>
                ...
                <td width="170">
					<?
                        echo create_drop_down( "cbo_company_id", 160, $company_arr,"", 1, "--Select Company--", 0, "load_drop_down('requires/weekly_ironing_wages_controller', this.value, 'load_drop_down_location', 'location_td' );","","1,3" );
                    ?>
                </td>
        ...
        <legend>&nbsp;  New Entry</legend>
              <table cellpadding="0" cellspacing="2" width="850" border="0">
                    ...
                    <tr>
                        ...
                        <td width="120" align="right">Iron/Bill Qty.</td>
                        <td width="100">
                    ...
                    <tr>
                        <td width="130" align="right">Gmt. Item</td>
                        <td width="170">
                    ...
                    <tr>
                        <td colspan="7" align="center" class="button_container">
                            <?
                                echo load_submit_buttons($permission, "fnc_weekly_wages_bill_entry", 0,1,"reset_form('weekly_wages_bill_1','list_container','','','fnc_enable()','cbo_bill_for')",1);
                            ?>
                        </td>
                    </tr>
			</table>        
