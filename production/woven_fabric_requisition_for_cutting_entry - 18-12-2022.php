				...
				for(var k=0; k<data.length; k++)
				{
					...
					if(hdn_variable_setting_status==1) // style wise 
					{
						if(hdn_variable_colorSize_status==2) // color level
						{
							...
							var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40" style="word-break:break-all;">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50" style="word-break:break-all;">'+row_data[2]+'</td><td width="60" style="word-break:break-all;">'+row_data[3]+'</td><td width="100" style="word-break:break-all;">'+row_data[24]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;">'+row_data[25]+'</td><td width="60" style="word-break:break-all;">'+row_data[26]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" style="word-break:break-all;">'+row_data[28]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="60" style="word-break:break-all;">'+row_data[29]+'</td><td width="80" style="word-break:break-all;">'+row_data[15]+'</td><td width="80" style="word-break:break-all;">'+row_data[32]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center" width="80"><input type="text" class="text_boxes_numeric" style="width:90px"  id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" placeholder="'+row_data[22]+'"/><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[33]+'" id="fabColorId'+num_row+'" name="fabColorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[25]+'" id="fabricRef'+num_row+'" name="fabricRef[]"/><input type="hidden" value="'+row_data[26]+'" id="rdNo'+num_row+'" name="rdNo[]"/><input type="hidden" value="'+row_data[27]+'" id="weightType'+num_row+'" name="weightType[]"/><input type="hidden" value="'+row_data[29]+'" id="cutableWidth'+num_row+'" name="cutableWidth[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[30]+'" id="hdnPoRatioRef'+num_row+'" name="hdnPoRatioRef[]"/><input type="hidden" value="'+row_data[21]+'" id="hdnBudgtQty'+num_row+'" name="hdnBudgtQty[]"/><input type="hidden" value="'+row_data[31]+'" id="hdnPoRatioQty'+num_row+'" name="hdnPoRatioQty[]"/><input type="hidden" value="'+row_data[24]+'" id="styleRef'+num_row+'" name="styleRef[]"/><input type="hidden" value="'+row_data[20]+'" id="cons'+num_row+'" name="cons[]"/></td></tr>';
						}
						else
						{

							var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40" style="word-break:break-all;">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50" style="word-break:break-all;">'+row_data[2]+'</td><td width="60" style="word-break:break-all;">'+row_data[3]+'</td><td width="100" style="word-break:break-all;">'+row_data[24]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;">'+row_data[25]+'</td><td width="60" style="word-break:break-all;">'+row_data[26]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" style="word-break:break-all;">'+row_data[28]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="60" style="word-break:break-all;">'+row_data[29]+'</td><td width="80" style="word-break:break-all;">'+row_data[15]+'</td><td width="80" style="word-break:break-all;">'+row_data[32]+'</td><td width="60" style="word-break:break-all;">'+row_data[17]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center" width="80"><input type="text" class="text_boxes_numeric" style="width:90px"  id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" placeholder="'+row_data[22]+'"/><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[33]+'" id="fabColorId'+num_row+'" name="fabColorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[25]+'" id="fabricRef'+num_row+'" name="fabricRef[]"/><input type="hidden" value="'+row_data[26]+'" id="rdNo'+num_row+'" name="rdNo[]"/><input type="hidden" value="'+row_data[27]+'" id="weightType'+num_row+'" name="weightType[]"/><input type="hidden" value="'+row_data[29]+'" id="cutableWidth'+num_row+'" name="cutableWidth[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[30]+'" id="hdnPoRatioRef'+num_row+'" name="hdnPoRatioRef[]"/><input type="hidden" value="'+row_data[21]+'" id="hdnBudgtQty'+num_row+'" name="hdnBudgtQty[]"/><input type="hidden" value="'+row_data[31]+'" id="hdnPoRatioQty'+num_row+'" name="hdnPoRatioQty[]"/><input type="hidden" value="'+row_data[24]+'" id="styleRef'+num_row+'" name="styleRef[]"/><input type="hidden" value="'+row_data[20]+'" id="cons'+num_row+'" name="cons[]"/></td></tr>';
						}
					}
					else
					{
						if(hdn_variable_colorSize_status==2)
						{
							...
							var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40" style="word-break:break-all;">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50" style="word-break:break-all;">'+row_data[2]+'</td><td width="60" style="word-break:break-all;">'+row_data[3]+'</td><td width="80" style="word-break:break-all;">'+row_data[5]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="80" style="word-break:break-all;">'+row_data[15]+'</td><td width="80" style="word-break:break-all;">'+row_data[25]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center" width="80"><input type="text" class="text_boxes_numeric" style="width:90px" style="width:80px" id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" placeholder="'+row_data[22]+'" /><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[26]+'" id="fabColorId'+num_row+'" name="fabColorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[25]+'" id="fabricRef'+num_row+'" name="fabricRef[]"/><input type="hidden" value="'+row_data[26]+'" id="rdNo'+num_row+'" name="rdNo[]"/><input type="hidden" value="'+row_data[27]+'" id="weightType'+num_row+'" name="weightType[]"/><input type="hidden" value="'+row_data[29]+'" id="cutableWidth'+num_row+'" name="cutableWidth[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[30]+'" id="hdnPoRatioRef'+num_row+'" name="hdnPoRatioRef[]"/><input type="hidden" value="'+row_data[21]+'" id="hdnBudgtQty'+num_row+'" name="hdnBudgtQty[]"/><input type="hidden" value="'+row_data[31]+'" id="hdnPoRatioQty'+num_row+'" name="hdnPoRatioQty[]"/><input type="hidden" value="'+row_data[24]+'" id="styleRef'+num_row+'" name="styleRef[]"/><input type="hidden" value="'+row_data[20]+'" id="cons'+num_row+'" name="cons[]"/></td></tr>';
						}
						else
						{
						
							var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40" style="word-break:break-all;">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50" style="word-break:break-all;">'+row_data[2]+'</td><td width="60" style="word-break:break-all;">'+row_data[3]+'</td><td width="80" style="word-break:break-all;">'+row_data[5]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="80" style="word-break:break-all;">'+row_data[15]+'</td><td width="80" style="word-break:break-all;">'+row_data[25]+'</td><td width="60" style="word-break:break-all;">'+row_data[17]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center" width="80"><input type="text" class="text_boxes_numeric" style="width:90px" style="width:80px" id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" placeholder="'+row_data[22]+'" /><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[26]+'" id="fabColorId'+num_row+'" name="fabColorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[25]+'" id="fabricRef'+num_row+'" name="fabricRef[]"/><input type="hidden" value="'+row_data[26]+'" id="rdNo'+num_row+'" name="rdNo[]"/><input type="hidden" value="'+row_data[27]+'" id="weightType'+num_row+'" name="weightType[]"/><input type="hidden" value="'+row_data[29]+'" id="cutableWidth'+num_row+'" name="cutableWidth[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[30]+'" id="hdnPoRatioRef'+num_row+'" name="hdnPoRatioRef[]"/><input type="hidden" value="'+row_data[21]+'" id="hdnBudgtQty'+num_row+'" name="hdnBudgtQty[]"/><input type="hidden" value="'+row_data[31]+'" id="hdnPoRatioQty'+num_row+'" name="hdnPoRatioQty[]"/><input type="hidden" value="'+row_data[24]+'" id="styleRef'+num_row+'" name="styleRef[]"/><input type="hidden" value="'+row_data[20]+'" id="cons'+num_row+'" name="cons[]"/></td></tr>';
						}
					}
					num_row++;
				}
