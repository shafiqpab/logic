...
<script>
	...
	{
		var title = 'Iron Info';	
		var page_link = 'requires/iron_entry_controller.php?action=system_number_popup';
 		...
 		<fieldset style="width:1050px;">
            ...
            <form name="ironentry_1" id="ironentry_1" method="" autocomplete="off" >
                <fieldset>
                    <table width="100%">
                        <tr>
                            <td colspan="4" align="right"><b>Iron NO : </b></td>
                ...
                <fieldset style="width:1200px">
                    <legend>Iron Details List</legend>
                    <div>
                        <table cellpadding="0" width="1200" cellspacing="0" border="1" class="rpt_table" rules="all">
                            <thead>
                                <tr>
                                    ...
                                    <th width="70">Re-Iron Qty. (PCS)</th>
