 			...
 			?>
                <tr 
                    ...
                    <td width="100" align="center"><p><?
                     ...
                     ?></p></td>
                    <td width="200" align="center" style="word-break:break-all"><p><?php  echo $color_library[$selectResult[csf('yarn_color')]]; ?></p></td>
                     <td width="100" align="right"><p><?php echo number_format($selectResult[csf('required_qty')],4,".",""); ?></p></td>
                    		
                    <td width="100" align="right"><p><?php echo number_format($selectResult[csf('returanable_qty')]+$selectResult[csf('issue_qty')],4,".",""); ?></p></td>
                    <td width="100" align="right" id="returanable_qty_<? echo $i; ?>"><p><?php //echo $selectResult[csf('number_end')]; ?></p></td>
                    ...
                    <td width="100" align="center">
                        ...
                        <input
                            ...
                            value="<?php echo $selectResult[csf('yarn_color')]; ?>">
                        <input
                        	type="hidden" 
                            id="hidden_sample_color_<? echo $i; ?>" 
                            name="hidden_sample_color[]"
                            value="<?php echo $selectResult[csf('sample_color_ids')]; ?>">
                    ...
                    <td width="" align="right"><?php //echo number_format(($total_consumption*$selectResult[csf('size_qty')]*2.2046226)/12,4,".","");?></td>
                </tr>
            	<?php
                $i++;
                $total_required_qty    	+=$selectResult[csf('required_qty')];
                $total_issue_qty		+=$selectResult[csf('returanable_qty')]+$selectResult[csf('issue_qty')];
			}
			?>
            </tbody>
            <tfoot>
            	<tr>
                    ...
                    <th width="100"  id="total_receive_qty"></th>
...
if($action=="show_dtls_listview_from_issue")
{
	...
	$data_array_strip=sql_select("select a.sample_color_id as sample_color, a.sample_color_ids as sample_color_ids, a.yarn_color_id as stripe_color, a.sample_color_percentage, a.production_color_percentage, a.actual_consumption, a.consumption, b.sample_ref from ppl_size_set_consumption a, ppl_size_set_mst b where b.job_no='".$job_no."' and b.sizeset_no='".$size_set_no."' and b.id=a.mst_id and a.color_id=$color_id and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 order by a.id ");
			...
			foreach($sqlResult as $selectResult)
			{
 			...
 			?>
                <tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" onClick="" > 
                    ...
                    <?php
						$total_consumption=0; $total_consumption_wpl=0;						
						foreach($data_array_strip as $scolor)
						{
							if($scolor[csf("sample_color_ids")])
                    		{
...
if ($action=="save_update_delete")
{
	...
	if ($operation==0) // Insert Here----------------------------------------------------------
	{
		...
		$field_array_delivery=" id, sys_number_prefix, sys_number_prefix_num, sys_number, company_id, issue_challan_id, production_type, location_id, operator_id, delivery_basis, production_source, serving_company, floor_id, delivery_date, body_part_type, body_part_ids, working_company_id, working_location_id, remarks, size_set_no, inserted_by, insert_date";

		$mst_id = return_next_id_by_sequence( "pro_gmts_delivery_mst_seq",  "pro_gmts_delivery_mst", $con );

		$data_array_delivery="(".$mst_id.", '".$new_sys_number[1]."', '".(int)$new_sys_number[2]."', '".$new_sys_number[0]."', ".$cbo_company_name.", ".$txt_issue_id.", 51, ".$cbo_location.", ".$txt_operator_id.", ".$delivery_basis.", ".$cbo_source.", ".$cbo_working_company.", ".$cbo_floor.", ".$txt_receive_date.", ".$cbo_bodypart_type.", ".$txt_bodyPart_id.", ".$cbo_working_company.", ".$cbo_working_location.", ".$txt_remarks.", ".$txt_size_set_no.", ".$user_id.", '".$pc_date_time."')";
       ...
       // echo "10**".$receive_sql;die;
        ...
        $field_array_dtls="  id, delivery_mst_id, mst_id, production_type, color_size_break_down_id, production_qnty, bundle_qty, bundle_qtygm, cut_no, bundle_no, barcode_no, is_rescan, operator_id, machine_id, bodypart_type_id, body_part_ids";
		...
		$field_array_color_dtls="   id, delivery_mst_id, production_type, operator_id, gmts_color, sample_color, sample_color_ids, yarn_color, required_qty, issue_qty, receive_qty, returanable_qty, wastage, lot_ratio_no, bodypart_type_id, body_part_ids, inserted_by, insert_date";
		...
		foreach($dtlsArr as $bundle_no=>$qty)
		{
			...
			$data_array_dtls.= "(".$dtls_id.", ".$mst_id.", ".$gmtsMstId.", 51, '".$dtlsArrColorSize[$bundle_no]."', '".$qty."', '".$dtlsArrCons[$bundle_no]."','".$dtlsArrConsgm[$bundle_no]."', ".$txt_lot_ratio.", '".$bundle_no."', '".$bundleBarcodeArr[$bundle_no]."', '".$bundleRescanArr[$bundle_no]."', ".$txt_operator_id.", '".$bundleMachineArr[$bundle_no]."', ".$cbo_bodypart_type.", ".$txt_bodyPart_id.")";
		...
		{ 	
			...
			$data_array_color_dtls.= "(".$yarn_dtls_id.", ".$mst_id.", 51, ".$txt_operator_id.", '".$gmts_color_id."', '".$sample_color_id."', '".$$sampleColor."', '".$$yarnColor."', '".$$requiredQty."', '".$$issueQty."', '".$$receiveQty."', '".$$returnableQty."', '".$$wastage."', ".$txt_lot_ratio.", ".$cbo_bodypart_type.", ".$txt_bodyPart_id.", ".$user_id.", '".$pc_date_time."')";
  	...
  	else if ($operation==1) // Update Here End------------------------------------------------------
	{
       ...
       // echo "10**".$receive_sql;die;
		...
		foreach($mstArr as $orderId=>$orderData)
		{
		 ...
		 $field_array_dtls="  id, delivery_mst_id, mst_id, production_type, color_size_break_down_id, production_qnty, bundle_qty, bundle_qtygm, cut_no, bundle_no, barcode_no, is_rescan, operator_id, machine_id, bodypart_type_id, body_part_ids";
        $field_array_bodypart_dtls="id, mst_id, dtls_id, delivery_mst_id, bundle_no, is_rescan, barcode_no, bodypart_type_id, machine_id, body_part_id, production_type";
		$field_array_color_dtls="operator_id* gmts_color* sample_color* sample_color_ids* yarn_color* required_qty* issue_qty* receive_qty* returanable_qty* wastage* lot_ratio_no* bodypart_type_id* updated_by* update_date";
		...
		{ 	
			...
			$data_array_color_dtls[$color_dtls_id]= explode("*",($txt_operator_id."* '".$gmts_color_id."'* '".$sample_color_id."'* '".$$sampleColor."'* '".$$yarnColor."'* '".$$requiredQty."'* '".$$issueQty."'* '".$$receiveQty."'* '".$$returnableQty."'* '".$$wastage."'* ".$txt_lot_ratio."* ".$cbo_bodypart_type."* ".$user_id."* '".$pc_date_time."'"));
		}
...
if($action=="create_challan_search_list_view")
{
	...
	if($company_id==0)
	{
		echo "<h2> Please Select Company First. </h2>";die;
	}
...
if($action=="show_dtls_listview_update")
{
	...
	$data_array_strip=sql_select("select a.sample_color_ids as sample_color_ids, a.sample_color_id as sample_color, a.yarn_color_id as stripe_color, a.sample_color_percentage, a.production_color_percentage, a.actual_consumption, a.consumption, b.sample_ref from ppl_size_set_consumption a, ppl_size_set_mst b where b.job_no='".$job_no."' and b.sizeset_no='".$size_set_no."' and b.id=a.mst_id and a.color_id=$color_id and a.status_active=1 and a.is_deleted=0  and b.status_active=1 and b.is_deleted=0 order by a.id ");
			...
			foreach($sqlResult as $selectResult)
			{
 			...
 			?>
                <tr bgcolor="<? echo $bgcolor; ?>" style="text-decoration:none; cursor:pointer" onClick="" > 
                    ...
                    <td width="50" align="center"><?php echo $size_library[$selectResult[csf('size_id')]]; ?></td>
                    <td width="50" align="center"><?php echo $selectResult[csf('size_qty')]; ?></td>
                    <td width="50" align="center"><input type="text"id="txt_knit_qty_<? echo $i; ?>"onkeyup="fnc_check_knit_qty();"name="txt_knit_qty[]"style="width:38px;"class="text_boxes_numeric"value="<?php  echo $selectResult[csf('production_qnty')]; ?>"></td>
             		<td width="70" align="right">
                    <?php
						$total_consumption=0; $total_consumption_wpl=0;
						foreach($data_array_strip as $scolor)
                    ...
                    <td width="70" align="right"><?=number_format(($total_consumption_wpl*$selectResult[csf('size_qty')]*2.2046226)/12,4,".","");?></td>
 			...
 			?>
                <tr 
                    ...
                    <td 
                    	width="100" 
                    	align="right"
                        id="required_qty_<? echo $i; ?>"><?php  echo number_format($selectResult[csf('required_qty')],4,".",""); ?></td>
                    		
                    <td width="100" align="right"><p><?php echo number_format($selectResult[csf('issue_qty')],4,".",""); ?></p></td>
                    <td width="100" align="right" id="returanable_qty_<? echo $i; ?>"><?php echo number_format($selectResult[csf('receive_qty')],4,".",""); ?></td>
                    <td width="100" align="center">
                    	<input 
                    		onkeyup="fnc_total_issue_balance() "
                        	type="text" 
                            ...
                            style="width:80px;"
                            class="text_boxes_numeric"
                            value="<?php echo $selectResult[csf('returanable_qty')]; ?>">
                    ...
                    <td width="" align="right"><?php echo number_format($selectResult[csf('wastage')],4,".","");?></td>
                </tr>
            <?php
            	...
            	$total_wastage_qty 			+=$selectResult[csf('wastage')];
            	$total_receive_qty 			+=$selectResult[csf('receive_qty')];
                $i++;
			}
			?>
            </tbody>
