...
<script>
    ...
    function openmypage_sysNo()
    {
        ...
        if(cbo_source==1)
        {
            if (form_validation('cbo_company_name*cbo_source*cbo_emb_company*cbo_location*cbo_floor', 'Company Name*Source*Sewing Company*Location*Floor') == false)
            {
                return;
            }
        }
        ...
        emailwindow.onclose = function()
        {
            ...
            if (mst_id != "")
            {
                ...
                if (delivery_basis == 3)
                {
                    ...
                    var response_data = return_global_ajax_value(trim(bundle_nos[0]) + "**0**" + mst_id + "**" + $('#cbo_company_name').val() + "**" + $('#cbo_line_no').val(), 'populate_bundle_data_update', '', 'requires/bundle_wise_sewing_input_controller');
    ...
    function fnc_issue_print_embroidery_entry(operation)
    {
        ...
        if (operation == 4)
        {
            ...
            generate_report_file($('#cbo_company_name').val() + '*' + $('#txt_system_id').val() + '*' + $('#delivery_basis').val() + '*' + report_title, 'emblishment_issue_print', 'requires/bundle_wise_sewing_input_controller');
            release_freezing();
            return;
        }
        else if (operation == 5)
        {
            var report_title = $("div.form_caption").html();
            generate_report_file($('#cbo_company_name').val() + '*' + $('#txt_system_id').val() + '*' + $('#delivery_basis').val() + '*' + report_title,'emblishment_issue_print_2', 'requires/bundle_wise_sewing_input_controller');
            release_freezing();
            return;
        }
        else if (operation == 6)
        {
            var report_title = $("div.form_caption").html();
            generate_report_file($('#cbo_company_name').val() + '*' + $('#txt_system_id').val() + '*' + $('#delivery_basis').val() + '*' + report_title,'emblishment_issue_print_3', 'requires/bundle_wise_sewing_input_controller');
            release_freezing();
            return;
        }
    ...
    function create_row(bundle_nos, vscan, hidden_source_cond)
    {
        ...
        var response_data = return_global_ajax_value(bundle_nos + "**" + row_num + "****" + $('#cbo_company_name').val() + "**" + vscan + "**" + hidden_source_cond, 'populate_bundle_data', '', 'requires/bundle_wise_sewing_input_controller');
    ...
    function fnc_bundle_wise_input_print(type)
    {
        ...
        var report_title = $("div.form_caption").html();
			...
			{
				generate_report_file($('#cbo_company_name').val() + '*' + $('#txt_system_id').val() + '*' + $('#delivery_basis').val() + '*' + report_title+'*'+$('#cbo_emb_company').val(), 'sewing_input_challan_print7', 'requires/bundle_wise_sewing_input_controller');
			}
            else if(type==10)
            {
                generate_report_file($('#cbo_company_name').val() + '*' + $('#txt_system_id').val() + '*' + $('#delivery_basis').val() + '*' + report_title,
                    ...
                    <fieldset>
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <? 
                                    echo create_drop_down( "cbo_company_name", 180, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select --", $selected, "get_php_form_data( this.value, 'company_wise_report_button_setting','requires/bundle_wise_sewing_input_controller');" );//
                                    ?>
                                ...
                                <td>
                                    <? 
                                    echo create_drop_down( "cbo_source", 180, $knitting_source,"", 1, "-- Select Source --", $selected, "fnc_company_check(this.value);load_drop_down( 'requires/bundle_wise_sewing_input_controller', this.value+'**'+$('#cbo_company_name').val(), 'load_drop_down_embro_issue_source', 'emb_company_td' );load_drop_down( 'requires/bundle_wise_sewing_input_controller', $('#cbo_company_name').val(), 'load_drop_down_location', 'location_td' );change_mode(this.value);", 0, '1,3' );
                            ...
                            <tr>
                                ...
                                <td style="display:none;">
                                    <? 
                                    echo create_drop_down( "cbo_working_company_name", 180, "select id,company_name from lib_company comp where status_active =1 and is_deleted=0 $company_cond order by company_name","id,company_name", 1, "-- Select --",$selected,"load_drop_down( 'requires/bundle_wise_sewing_input_controller', $('#cbo_working_company_name').val(), 'load_drop_down_working_location', 'working_location_td' );" );
                                    ?>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <table cellpadding="0" cellspacing="1" width="100%">
                        <tr>
                            <td align="center" colspan="9" valign="middle" class="button_container">
                                ...
                                <input id="Print4" class="formbutton" type="button" style="width:80px;" onClick="fnc_bundle_wise_input_print()" name="print4" value="Print 4">
                                <input id="Print5" class="formbutton" type="button" style="width:80px;" onClick="fnc_bundle_wise_input_print(7)" name="print4" value="Print 5">
                                <input id="Print6" class="formbutton" type="button" style="width:80px;" onClick="fnc_bundle_wise_input_print(8)" name="print6" value="Print 6">
                                <input id="Print7" class="formbutton" type="button" style="width:80px;" onClick="fnc_bundle_wise_input_print(9)" name="print7" value="Print 7">
                                <input id="Print8" class="formbutton" type="button" style="width:80px;" onClick="fnc_bundle_wise_input_print(10)" name="print8" value="Print 8">
                            </td>
                            <td>&nbsp;</td>				
                        </tr>
                    </table>
