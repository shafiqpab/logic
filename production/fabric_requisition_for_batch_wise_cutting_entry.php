...
<script>
	...
	{ 
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/fabric_requisition_for_batch_wise_cutting_entry_controller.php?action=requisition_popup&company_id='+cbo_company_id+'&buyerId='+buyerId,'Requisition Popup', 'width=780px,height=350px,center=1,resize=1,scrolling=0','')
		emailwindow.onclose=function()
		{
			...
			if(reqn_id!="")
			{
				...
				get_php_form_data(reqn_id, "populate_data_from_requisition", "requires/fabric_requisition_for_batch_wise_cutting_entry_controller" );
				var list_view = trim(return_global_ajax_value(reqn_id+'**'+entry_break_down_type, 'populate_list_view', '', 'requires/fabric_requisition_for_batch_wise_cutting_entry_controller'));
	...
	{
		var varible_data=return_global_ajax_value( data, 'varible_setting_wvn_style_wise', '', 'requires/fabric_requisition_for_batch_wise_cutting_entry_controller');
		if(varible_data==1)
		{
	...
	{
		var varible_data=return_global_ajax_value( data, 'varible_setting_fabric_requisition_cutting_variable', '', 'requires/fabric_requisition_for_batch_wise_cutting_entry_controller');
		// alert(varible_data);
		if(varible_data=="")
		{
			varible_data=0;
	...
	{ 
		...
		emailwindow=dhtmlmodal.open('EmailBox', 'iframe','requires/fabric_requisition_for_batch_wise_cutting_entry_controller.php?action=layPlan_popup&company_id='+cbo_company_id,'Lay Plan Popup', 'width=780px,height=350px,center=1,resize=1,scrolling=0','')
		emailwindow.onclose=function()
		{
			var theform=this.contentDoc.forms[0]//("search_order_frm"); //Access the form inside the modal window
	...
	function com_variable_data(data){
		...
		//var varible_data=return_global_ajax_value( data, 'varible_setting_wvn_style_wise', '', 'requires/fabric_requisition_for_batch_wise_cutting_entry_controller');
		var varible_data_colorSize=return_global_ajax_value( data, 'varible_setting_fabric_requisition_cutting_variable', '', 'requires/fabric_requisition_for_batch_wise_cutting_entry_controller');


		if(varible_data_colorSize==2)
		{
			$("#entry_break_down_type").val(varible_data_colorSize);
			var table_heading='<thead><th style="word-break:break-all;" width="40"><p>SL</p></th><th style="word-break:break-all;" width="60"><p>Buyer</p></th><th style="word-break:break-all;" width="50"><p>Job Year</p></th><th style="word-break:break-all;" width="60"><p>Job No</p></th><th style="word-break:break-all;" width="80"><p>Order No</p></th><th style="word-break:break-all;" width="100"><p>Gmts. Item</p></th><th style="word-break:break-all;" width="100"><p>Body part</p></th><th style="word-break:break-all;" width="150"><p>Const/Composition</p></th><th style="word-break:break-all;" width="60"><p>GSM</p></th><th style="word-break:break-all;" width="60"><p>Dia</P></th><th style="word-break:break-all;" width="80"><p>Gmts. Color</p></th><th style="word-break:break-all;" width="80"><p>Uom</p></th><th style="word-break:break-all;" width="80"><p>Consumption</p></th><th style="word-break:break-all;" width="80"><p>Budget Qty</p></th><th style="word-break:break-all;" width="80"><p>Cumulative Qty</p></th><th style="word-break:break-all;"><p>Reqn. Qty</p></th></thead>';
			$("#scanning_tbl_top").html(table_heading);
		}
		else
		{
			$("#entry_break_down_type").val(varible_data_colorSize);
			var table_heading='<thead><th style="word-break:break-all;" width="40"><p>SL</p></th><th style="word-break:break-all;" width="60"><p>Buyer</p></th><th style="word-break:break-all;" width="50"><p>Job Year</p></th><th style="word-break:break-all;" width="60"><p>Job No</p></th><th style="word-break:break-all;" width="80"><p>Order No</p></th><th style="word-break:break-all;" width="100"><p>Gmts. Item</p></th><th style="word-break:break-all;" width="100"><p>Body part</p></th><th style="word-break:break-all;" width="150"><p>Const/Composition</p></th><th style="word-break:break-all;" width="60"><p>GSM</p></th><th style="word-break:break-all;" width="60"><p>Dia</P></th><th style="word-break:break-all;" width="80"><p>Gmts. Color</p></th><th style="word-break:break-all;" width="60"><p>Size</p></th><th style="word-break:break-all;" width="80"><p>Uom</p></th><th style="word-break:break-all;" width="80"><p>Consumption</p></th><th style="word-break:break-all;" width="80"><p>Budget Qty</p></th><th style="word-break:break-all;" width="80"><p>Cumulative Qty</p></th><th style="word-break:break-all;"><p>Reqn. Qty</p></th></thead>';
			$("#scanning_tbl_top").html(table_heading);
		}
	...
	function openmypage_po()
	{
		...
		{ 	
			...
			var page_link ='requires/fabric_requisition_for_batch_wise_cutting_entry_controller.php?company_id='+cbo_company_id+'&buyerId='+buyerId+'&entry_break_down_type='+entry_break_down_type+'&action=po_popup';
			...
			emailwindow.onclose=function()
			{
				...
				for(var k=0; k<data.length; k++)
				{
					...
					{
						var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50">'+row_data[2]+'</td><td width="60">'+row_data[3]+'</td><td width="80" style="word-break:break-all;">'+row_data[5]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="80">'+row_data[15]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center"><input type="text" class="text_boxes_numeric" style="width:80px" id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" /><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[21]+'" id="budgetQty'+num_row+'" name="budgetQty[]"/><input type="hidden" value="'+row_data[24]+'" id="uom'+num_row+'" name="uom[]"/><input type="hidden" value="'+row_data[20]+'" id="consumption'+num_row+'" name="consumption[]"/></td></tr>';
					}
					else
					{
						var html=html+'<tr bgcolor="'+bgcolor+'" id="tr_'+num_row+'"><td width="40">'+num_row+'</td><td width="60" style="word-break:break-all;">'+row_data[0]+'</td><td width="50">'+row_data[2]+'</td><td width="60">'+row_data[3]+'</td><td width="80" style="word-break:break-all;">'+row_data[5]+'</td><td width="100" style="word-break:break-all;">'+row_data[8]+'</td><td width="100" style="word-break:break-all;">'+row_data[10]+'</td><td width="150" style="word-break:break-all;">'+row_data[11]+'</td><td width="60" style="word-break:break-all;" id="gsm'+num_row+'">'+row_data[13]+'</td><td width="60" id="dia'+num_row+'" style="word-break:break-all;">'+row_data[14]+'</td><td width="80">'+row_data[15]+'</td><td width="60">'+row_data[17]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[19]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[20]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[21]+'</td><td width="80" align="right" style="word-break:break-all;">'+row_data[23]+'</td><td align="center"><input type="text" class="text_boxes_numeric" style="width:80px" id="reqsnQty'+num_row+'" name="reqsnQty[]" value="'+row_data[22]+'" onblur="fn_check_qnty(this.id,this.value,'+row_data[21]+','+num_row+')" /><input type="hidden" value="'+row_data[1]+'" id="buyerId'+num_row+'" name="buyerId[]"/><input type="hidden" value="'+row_data[6]+'" id="poId'+num_row+'" name="poId[]"/><input type="hidden" value="'+row_data[12]+'" id="deterId'+num_row+'" name="deterId[]"/><input type="hidden" value="'+row_data[16]+'" id="colorId'+num_row+'" name="colorId[]"/><input type="hidden" value="'+row_data[7]+'" id="itemId'+num_row+'" name="itemId[]"/><input type="hidden" value="'+row_data[9]+'" id="bodyPartId'+num_row+'" name="bodyPartId[]"/><input type="hidden" value="'+row_data[4]+'" id="jobNo'+num_row+'" name="jobNo[]"/><input type="hidden" value="'+row_data[18]+'" id="sizeId'+num_row+'" name="sizeId[]"/><input type="hidden" value="" id="dtlsId'+num_row+'" name="dtlsId[]"/><input type="hidden" value="'+row_data[23]+'" id="prevReqQty'+num_row+'" name="prevReqQty[]"/><input type="hidden" value="'+row_data[21]+'" id="budgetQty'+num_row+'" name="budgetQty[]"/><input type="hidden" value="'+row_data[24]+'" id="uom'+num_row+'" name="uom[]"/><input type="hidden" value="'+row_data[20]+'" id="consumption'+num_row+'" name="consumption[]"/></td></tr>';
	...
	function fnc_fabric_requisition_for_cutting( operation )
	{
		...
		{cbo_template_id
			 ...
			 print_report( $('#cbo_company_id').val()+'*'+$('#txt_requisition_no').val()+'*'+$('#update_id').val()+'*'+$('#txt_layPlan_No').val()+'*'+$('#cbo_template_id').val(), "grey_delivery_print", "requires/fabric_requisition_for_batch_wise_cutting_entry_controller" );
			 release_freezing();
			return;
		}
		...
		for (var i=1; i<=row_num; i++)
		{
			...
			{
				j++;
				dataString+='&buyerId' + j + '=' + buyerId + '&jobNo' + j + '=' + jobNo + '&poId' + j + '=' + poId + '&itemId' + j + '=' + itemId + '&bodyPartId' + j + '=' + bodyPartId + '&deterId' + j + '=' + deterId + '&gsm' + j + '=' + gsm + '&dia' + j + '=' + dia + '&colorId' + j + '=' + colorId + '&sizeId' + j + '=' + sizeId + '&reqsnQty' + j + '=' + reqsnQty + '&budgetQty' + j + '=' + budgetQty + '&uom' + j + '=' + uom + '&consumption' + j + '=' + consumption + '&dtlsId' + j + '=' + dtlsId;
			}
		}
		...
		http.open("POST","requires/fabric_requisition_for_batch_wise_cutting_entry_controller.php",true);
	...
	function fnc_fabric_requisition_for_cutting_Reply_info()
	{
		if(http.readyState == 4) 
		{
			...
			if((response[0]==0 || response[0]==1))
			{
				...
				var entry_break_down_type = $("#entry_break_down_type").val();
				var list_view = trim(return_global_ajax_value(response[1]+'**'+entry_break_down_type, 'populate_list_view', '', 'requires/fabric_requisition_for_batch_wise_cutting_entry_controller'));
				$("#scanning_tbl tbody").html(list_view);
	...
	function generate_print_report_2()
	{
		...
		print_report( $('#cbo_company_id').val()+'*'+$('#txt_requisition_no').val()+'*'+$('#update_id').val()+'*'+$('#txt_layPlan_No').val()+'*'+$('#cbo_template_id').val(), "grey_delivery_print2", "requires/fabric_requisition_for_batch_wise_cutting_entry_controller" );
			return;
	}
