...
<script>
	...
	function openmypage_sysNo()
	{
		...
		var page_link = 'requires/bundle_wise_sewing_output_controller.php?cbo_company_name='+cbo_company_name+'&cbo_source='+cbo_source+'&cbo_serving_company='+cbo_serving_company+'&action=challan_no_popup';
		...
		{
			emailwindow=dhtmlmodal.open('EmailBox', 'iframe', page_link, title, 'width=860px,height=420px,center=1,resize=0,scrolling=0','')
                               ...
                               <table  cellpadding="0" cellspacing="2" width="100%">
                                  <tr>
                                       ...
                                       <td colspan="2" width="110"> 
                                           <input name="txt_bundle_rescan" placeholder="Browse/Write/Scan" onDblClick="openmypage_bundle_rescan('requires/bundle_wise_sewing_output_controller.php?action=bundle_popup_rescan&company='+document.getElementById('cbo_company_name').value+'&garments_nature='+document.getElementById('garments_nature').value,'Search Bundle For Rescan')"  id="txt_bundle_rescan" class="text_boxes" style="width:212px" />
                                       </td>
                                    </tr>
                                </table>
                            </fieldset>
