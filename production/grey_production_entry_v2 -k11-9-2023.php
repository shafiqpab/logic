	...
	$('#txt_booking_no').live('keydown', function (e)
	{
    	if (e.keyCode === 13)
		{
    		...
    		if(cbo_receive_basis==2)
    		{
				...
				if($('#process_costing_maintain').val()*1==1)
				{
					disable_enable_fields('cbo_com_location_name*cbo_company_id*cbo_com_location_name*cbo_location_name*txt_service_booking*txt_shift_name*txt_stitch_length*cbo_floor_id*txt_color*cbo_color_range*txt_brand*cbo_uom*cbo_floor*cbo_room*txt_rack*txt_shelf*txt_roll_no',1); //cbo_store_name
					//length*cbo_machine_name*txt_gsm*txt_width
				}
				else
				{
					disable_enable_fields('cbo_com_location_name*cbo_company_id*cbo_com_location_name*cbo_location_name*txt_service_booking*txt_shift_name*txt_stitch_length*cbo_floor_id*txt_color*txt_yarn_lot*cbo_color_range*show_textcbo_yarn_count*txt_brand*cbo_uom*cbo_floor*cbo_room*txt_rack*txt_shelf*txt_roll_no',1); //cbo_store_name
					//length*cbo_machine_name*txt_gsm*txt_width
				}
