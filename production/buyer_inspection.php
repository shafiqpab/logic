...
$inpLevelArray = array(1=>'In-line Inspection',2=>'Mid-line Inspection',3=>'Final Inspection',4=>'Pre-Final Inspection',5=>"Inter Line Inspection",6=>"PPM/Sizeset Inspection",7=>"Initial Inspection",8=>"Packing Inspection");
//--------------------------------------------------------------------------------------------------------------------
...
<script>
	...
	<?php   
	if($_SESSION['logic_erp']['data_arr'][470]){
		echo "var field_level_data= " . json_encode($_SESSION['logic_erp']['data_arr'][470]). ";\n";
	}
	?>
	...
	function openmypage_order(page_link,title)
	{
		...
		emailwindow.onclose=function()
		{
			...
			if (job.value!="")
			{
				...
				reset_form('','','cbo_order_id*cbo_order_val*actual_order_id*txt_po_quantity*txt_pub_shipment_date*txt_inspection_qnty*txt_cum_inspection_qnty*cbo_inspection_status*cbo_cause*txt_comments*txt_mst_id*cbo_week_no*cbo_country_id*txt_finishing_qnty*txt_ins_reason','','');
		...
		{	
			...
			emailwindow.onclose=function()
			{
				 ...
				 {	
				 	...
				 	get_php_form_data( hidden_order_id+','+document.getElementById('cbo_week_no').value+','+document.getElementById('cbo_country_id').value+','+document.getElementById('cbo_inspection_level').value+','+document.getElementById('cbo_company_name').value, 'set_po_qnty_ship_date', 'requires/buyer_inspection_controller');
	...
	{	
		// alert('ok');return;		
		if (form_validation('txt_job_no*cbo_order_id*txt_finishing_qnty','Job No*PO number*Qty')==false)
		{
			return;   
		}
		else
		{	
			...
			var inspection_status=document.getElementById('cbo_inspection_status').value;
			
			var data = txt_job_no+"_____"+cbo_order_id+"_____"+cbo_country_id+"_____"+hidden_ins_data+"_____"+garments_nature+"_____"+company_name+"_____"+inspection_level+"_____"+inspection_status;
			// alert(data);
	...
	{ 
		...
		let hidden_order_id = $('#cbo_order_id').val();
		if (hidden_order_id) 
		{
			get_php_form_data( hidden_order_id+','+document.getElementById('cbo_week_no').value+','+document.getElementById('cbo_country_id').value+','+insLevel+','+document.getElementById('cbo_company_name').value, 'set_po_qnty_ship_date', 'requires/buyer_inspection_controller');
		}
	}
                ...
                <fieldset>
                    <table width="100%">
                         <tr>
                         	<td width="130" class="must_entry_caption" align="right">Job No</td>
                                ...
                                <td width="">
                                	<?
                    					echo create_drop_down( "cbo_source", 210, $knitting_source,"", 0, "-- Select Source --", $selected, "load_drop_down( 'requires/buyer_inspection_controller', this.value+'**'+$('#cbo_company_name').val(), 'load_drop_working_company', 'working_company_td' );", 0, '1,3' );
                    				?> 
                                </td>
                          </tr>
                          <tr>  
                          ...
                          <tr>  
                                 ...
                                 <td width="170">
                                 <? 
                                 echo create_drop_down( "cbo_order_uom",60, $unit_of_measurement, "",0, "", 1, "change_caption_cost_dtls( this.value, 'change_caption_pcs' )",1,"1,57,58" );
                                 ?>
                                 ...
                                 <td width="170">
									 <? 
										echo create_drop_down( "cbo_inspection_by", 210, $inspected_by_arr,"", 1, "--- Select ---", $selected, "load_drop_down( 'requires/buyer_inspection_controller', this.value+','+document.getElementById('cbo_buyer_name').value+','+document.getElementById('cbo_company_name').value+','+document.getElementById('cbo_working_company').value, 'load_drop_down_buyer_party_company', 'cutt_company_td' );" );     	 
                                     ?> 
                                 </td>
                          </tr>
                          <tr> 
                    ...
                    <table cellpadding="0" cellspacing="1" width="100%" class="rpt_table" rules="all">
                        <thead>
                            ...
                            <th width="80" id="qtyField">Finishing Qty</th>
